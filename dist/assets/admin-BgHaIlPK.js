import{j as m,L as ie,z as ba,k as pi,A as mi,U as gi,_ as bi}from"./supabase-client-DvCmNkpI-BBtcpOs0-B154SqIU.js";import{v as Ee,B as yi,h as hi,D as fi}from"./localization-B_HxL1KQ-B_HxL1KQ-C9a7KFzV.js";import{listLocalShowroomListings as tt,patchLocalShowroomListing as vt,getLocalShowroomListingById as Ne,removeLocalShowroomListing as vi,upsertLocalShowroomListing as xt}from"./local-showroom-store-mzP0nSoS-DaE1u71h-TY-Le2a_.js";import{l as ya,C as xi,T as wi,g as _i,k as ki}from"./payment-settings-DAIw4D2k-BaImmvy0-CuRs7Lbj.js";import{P as ha,a as fa,T as va,M as xa}from"./motorhome-data-CupbOvk0--c7gbSNU--c7gbSNU.js";import{getCatalogCategories as $i}from"./catalog-qysuyAKK-CoyDMFKy-BjQqGiZL.js";import{g as Si}from"./app-promo-banner-VTpzwpvR-CiDTzVNv-Dv-62U_4.js";import{i as Pi,t as Ei,m as Ii}from"./categories-BEuiwWw5-Dd8DYwb8-Dd8DYwb8.js";import{loadHiddenCatalogIds as Dt,getHiddenCatalogIds as at,saveCatalogHidden as wa,resetHiddenCatalogIds as Ai}from"./catalog-hidden-store-BAMgfUuU-D15H80aw-CVNMN3iV.js";const H=1,X=5e6,Ci=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Ti=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],_a=[...Ci,...Ti];function Rt(e){return yi[e]||"USD"}function ka(e,a){return _a.filter(t=>t.listingType!==e?!1:a?t.category===a:!0)}function Li(e,a){const t=Math.max(H,Math.min(X,Number(e)||H));return new Intl.NumberFormat("en-US",{style:"currency",currency:a,maximumFractionDigits:0}).format(t)}function Bi(e,a,t,i,n){const o=Li(i,t);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function $a({templateId:e,listingType:a,category:t,countryCode:i,currency:n,price:o}){const r=_a.find(g=>g.id===e&&g.listingType===a);if(!r)return null;const l=hi(i)||Ee[0],d=n||Rt(l.code),c=[l.name].filter(Boolean).join(", "),u={category:r.category||t||(a==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:a==="property"?`${r.label} in ${l.name}`:r.label,description:Bi(r,l,d,o,c),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...a==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return a==="property"?{...u,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...u,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}let yt=null;async function Mi(){return yt||(yt=mi(()=>gi(()=>bi(()=>import("./pdf-ksa_hnld-e4gfyq7P-BjdFN6ln.js"),[]),[]),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy-yatZIOMy-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),yt}function Ni(e,a){return e.toDataURL("image/jpeg",a)}async function Di(e,a){const t=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,a/Math.max(t.width,t.height))),n=e.getViewport({scale:i}),o=document.createElement("canvas");o.width=Math.max(1,Math.round(n.width)),o.height=Math.max(1,Math.round(n.height));const r=o.getContext("2d",{alpha:!1});return r.fillStyle="#ffffff",r.fillRect(0,0,o.width,o.height),await e.render({canvasContext:r,viewport:n}).promise,Ni(o,.78)}async function Ri(e,{maxDim:a=1300,maxPages:t=0,onProgress:i=()=>{}}={}){const n=await(await Mi()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,o=n.numPages,r=t>0?Math.min(o,t):o,l=[];try{for(let d=1;d<=r;d++){i(d,r);const c=await n.getPage(d);l.push(await Di(c,a))}}finally{try{await n.destroy()}catch{}}return l}function it(e){const a=String(e||"").toLowerCase();return a.endsWith(".pdf")||a.includes(".pdf?")||a.includes(".pdf#")}const Sa="weverseonlineshop@gmail.com",Pa="Weverse Online Shop",Ea="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",Fi="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ji=`${Fi}/functions/v1/ai-admin-assistant`,qi=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Ui={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Ia=[...fi].sort();let B={user:null,section:"dashboard"};function s(e){if(e==null)return"";const a=document.createElement("div");return a.textContent=String(e),a.innerHTML}function Aa(e,a="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${a}`}function oe(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function fe(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function ot(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Oi=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents","language_info"];function me(e){const a={};if(!e||typeof e!="object")return a;for(const t of Oi)t in e&&(a[t]=e[t]);return a}function p(e,a="success"){const t=document.getElementById("toast"),i=document.getElementById("toast-msg"),n=t.querySelector("i[data-lucide]");if(!t||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",o[a]||"info"),n.className=`w-4 h-4 shrink-0 ${r[a]||"text-blue-400"}`),t.style.transform="translateY(0)",t.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(t._t),t._t=setTimeout(()=>{t.style.transform="translateY(20px)",t.style.opacity="0"},3e3)}function ee(e){const a={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[t,i]=a[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",s(e)||"â€”"];return`<span class="badge ${t}">${i}</span>`}function ce(){document.getElementById("modal-container").innerHTML=""}function W(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function K(e,a,t,i,n=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){B.section=e;const a=Ui[e]||e,t=document.getElementById("page-title");t&&(t.textContent=a),Ca(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Ie()),window.lucide&&lucide.createIcons(),({dashboard:io,products:O,properties:dt,catalog:Te,orders:Qa,customers:No,reviews:Oe,messages:Xa,coupons:ct,ads:Ce,notifications:Fo,ai:Hi,"ai-settings":ai,"homepage-branding":mt,"promo-bg":Fe,content:zo,"content-settings":ni,seo:Zo,email:en,analytics:Xo,security:pt,activity:tn,brand:gt,"payment-settings":Nt,backup:an,settings:on,publish:bt}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=ve("construction","Coming Soon",`${a} is being built.`))}))()};async function Hi(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Se="kco_admin_remember",Ft="kco_login_attempts",wt=5,Gi=15*60*1e3;function V(e){const a=document.getElementById("login-error"),t=document.getElementById("login-error-text");!a||!t||(t.textContent=e,a.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function zi(e){const a=document.getElementById("login-success"),t=document.getElementById("login-success-text");!a||!t||(t.textContent=e,a.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function nt(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function je(e){return String(e||"").trim().toLowerCase()}function Vi(){try{const e=JSON.parse(localStorage.getItem(Se)||"{}");e?.email&&!je(e.email)&&localStorage.removeItem(Se)}catch{localStorage.removeItem(Se)}}function Wi(){try{const e=JSON.parse(localStorage.getItem(Se)||"{}");return je(e?.email)}catch{return""}}function jt(){Vi();const e=Wi(),a=document.getElementById("login-email");a&&(a.value=e||a.value||Sa,a.removeAttribute("readonly"));const t=document.getElementById("reset-email");t&&(t.value=e||t.value||"",t.removeAttribute("readonly"))}function Yi(){return`${window.location.origin}/admin.html`}function we(e){const a=document.getElementById("login-header-title"),t=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),nt(),e==="login"&&(a&&(a.textContent="Admin Access"),t&&t.setAttribute("data-lucide","shield-check")),e==="2fa"&&(a&&(a.textContent="Two-Factor Auth"),t&&t.setAttribute("data-lucide","smartphone")),e==="forgot"&&(a&&(a.textContent="Reset Password"),t&&t.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function z(e,a,t=""){const i=document.getElementById(e);i&&(i.disabled=a,a?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':t&&(i.innerHTML=t),window.lucide&&lucide.createIcons())}function Ta(){try{return JSON.parse(localStorage.getItem(Ft)||'{"count":0}')}catch{return{count:0}}}function La(){const e=Ta();return e.count=(e.count||0)+1,e.count>=wt&&(e.lockedUntil=Date.now()+Gi),localStorage.setItem(Ft,JSON.stringify(e)),e}function Ba(){localStorage.removeItem(Ft)}function Ma(){const e=Ta();if(!e.lockedUntil)return null;const a=e.lockedUntil-Date.now();return a<=0?(Ba(),null):Math.ceil(a/6e4)}async function le(e,a,t={}){try{await m.from("admin_security_logs").insert({user_id:e,event_type:a,ip_address:await Ki(),user_agent:navigator.userAgent.slice(0,200),...t})}catch{}}async function Ki(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Na(e){if(!e)return!1;let a=!1,t=!1;try{const{data:i}=await m.rpc("is_current_user_admin");a=!0,t=!!i}catch{a=!1}return a?t:je(e.email)===Sa}async function Ji(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){We(),ao();return}const{data:{session:a}}=await m.auth.getSession();if(a?.user&&await Na(a.user)){const{data:{currentUser:t}}=await m.auth.getUser(),i=await m.auth.mfa.getAuthenticatorAssuranceLevel(),n=i.data?.currentLevel;if(i.data?.nextLevel==="aal2"&&n!=="aal2"){B.user=a.user,We(),we("2fa"),qt();return}B.user=a.user,rt();return}Qi()}function We(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Qi(){We(),we("login"),jt(),Da(),Ra(),qt(),Xi();const e=Ma();e&&(V(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Xi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),a=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",a&&a.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Da(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Zi),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>we("forgot")))}async function Zi(e){e.preventDefault();const a=Ma();if(a){V(`Account locked. Try again in ${a} minute${a>1?"s":""}.`);return}const t=document.getElementById("login-email"),i=je(t?.value);if(!i){V("Enter your admin email address."),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;z("login-btn",!0),nt();const{data:r,error:l}=await m.auth.signInWithPassword({email:i,password:n});if(l||!r.user){const d=String(l?.message||"").toLowerCase();if(d.includes("missing supabase credentials")||d.includes("authentication service is unavailable")){V("Authentication is temporarily unavailable due to configuration. Please contact support."),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(d.includes("failed to fetch")||d.includes("network request failed")){V("Network error while signing in. Check your connection and try again."),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(d.includes("email not confirmed")){V("Your admin email is not confirmed yet. Open your verification email and confirm first."),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const c=La(),u=wt-c.count,g=c.lockedUntil?`Account locked for 15 minutes after ${wt} failed attempts.`:`Invalid email or password. ${u>0?u+" attempt"+(u!==1?"s":"")+" remaining.":""}`;V(g),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await le(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Na(r.user)){await m.auth.signOut(),V(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await le(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Se,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Se),Ba(),B.user=r.user,(await m.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){z("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),we("2fa"),qt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await le(r.user.id,"login_success"),z("login-btn",!1),rt()}function qt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ia));const a=document.getElementById("totp-code");a&&!a._bound&&(a._bound=!0,a.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ia()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await m.auth.signOut(),B.user=null,we("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const i=document.getElementById("backup-code");i&&i.focus()});const t=document.getElementById("verify-backup-btn");t&&!t._bound&&(t._bound=!0,t.addEventListener("click",eo))}async function ia(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){V("Enter the 6-digit code from your authenticator app.");return}z("verify-2fa-btn",!0),nt();try{const{data:a}=await m.auth.mfa.listFactors(),t=(a?.totp||[])[0];if(!t){V("No 2FA factor found. Please re-login."),z("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await m.auth.mfa.challenge({factorId:t.id});if(n)throw n;const{error:o}=await m.auth.mfa.verify({factorId:t.id,challengeId:i.id,code:e});if(o)throw o;await le(B.user.id,"login_2fa_success"),z("verify-2fa-btn",!1),rt()}catch(a){La(),V(a.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":a.message),z("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function eo(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){V("Enter a backup recovery code.");return}z("verify-backup-btn",!0);try{const{data:a}=await m.from("admin_2fa").select("backup_codes").eq("user_id",B.user.id).maybeSingle();if(!a?.backup_codes?.length){V("No backup codes found."),z("verify-backup-btn",!1,"Use Backup Code");return}if(!a.backup_codes.find(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!i.used)){V("Backup code not found or already used."),z("verify-backup-btn",!1,"Use Backup Code");return}const t=a.backup_codes.map(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof i=="object"?i:{code:i},used:!0}:i);await m.from("admin_2fa").update({backup_codes:t}).eq("user_id",B.user.id),await le(B.user.id,"login_backup_code_used"),rt()}catch(a){V(a.message),z("verify-backup-btn",!1,"Use Backup Code")}}function Ra(){document.getElementById("back-to-login")?.addEventListener("click",()=>we("login")),document.getElementById("send-reset-btn")?.addEventListener("click",to)}async function to(){const e=document.getElementById("reset-email"),a=je(e?.value);if(!a){V("Enter your admin email address to receive a reset link.");return}z("send-reset-btn",!0),nt();const{error:t}=await m.auth.resetPasswordForEmail(a,{redirectTo:Yi()});if(z("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),t){V(t.message);return}zi("Reset link sent! Check your inbox and open it from this device to continue.")}function ao(){const e=document.getElementById("login-screen");if(!e)return;const a=e.querySelector(".login-card");a&&(a.innerHTML=`
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,a=document.getElementById("confirm-pw-reset")?.value,t=document.getElementById("reset-pw-error");if(e!==a){t&&(t.textContent="Passwords do not match.",t.classList.remove("hidden"));return}if((e||"").length<8){t&&(t.textContent="Password must be at least 8 characters.",t.classList.remove("hidden"));return}const{error:i}=await m.auth.updateUser({password:e});if(i){t&&(t.textContent=i.message,t.classList.remove("hidden"));return}p("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function rt(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const a=document.getElementById("admin-user-email");a&&B.user&&(a.textContent=B.user.email||"Admin"),jt(),navigate("dashboard")}window.adminSignOut=async function(){B.user&&await le(B.user.id,"logout"),await m.auth.signOut(),B.user=null,We(),we("login"),jt(),Da(),Ra()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(B.user&&await le(B.user.id,"logout_all_devices"),await m.auth.signOut({scope:"global"}),B.user=null,p("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function io(){const e=document.getElementById("content");try{const[a,t,i,n]=await Promise.all([m.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),m.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),m.from("profiles").select("user_id,created_at",{count:"exact"}),m.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=a.data||[],r=t.data||[],l=r.filter(f=>["approved","payment_approved","delivered"].includes(f.status)).reduce((f,$)=>f+(parseFloat($.amount)||0),0),d=r.filter(f=>["pending","pending_verification","processing"].includes(f.status)).length,c=o.filter(f=>f.listing_type!=="property").length,u=o.filter(f=>f.listing_type==="property").length,g=o.filter(f=>f.listing_type!=="property"&&f.is_active).length,y=i.count||0,b=n.count||0,h=(n.data||[]).filter(f=>!f.is_approved).length,v=new Date,_=r.filter(f=>{const $=new Date(f.created_at);return $.getMonth()===v.getMonth()&&$.getFullYear()===v.getFullYear()}).filter(f=>["approved","payment_approved","delivered"].includes(f.status)).reduce((f,$)=>f+(parseFloat($.amount)||0),0),k=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${co()}, Admin</h2>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,Fa(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(a.message)}</div>`)}}function ue(e){const a=parseFloat(e);return Number.isFinite(a)?a:0}function _t(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function oo(e){const a=ue(e.price),t=parseFloat(e.real_price);if(Number.isFinite(t)&&t>0&&t>a)return`${Math.round((1-a/t)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function no(e){const a=ue(e.price),t=parseFloat(e.real_price),i=`$${a.toLocaleString()}`;return Number.isFinite(t)&&t>0&&t>a?`<span class="block text-xs text-gray-400 price-strike line-through">$${t.toLocaleString()}</span><span class="text-emerald-300 font-black">$${a.toLocaleString()}</span>`:i}function Ut(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function kt(e){return parseInt(e.views??e.view_count??0,10)||0}function $t(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Ot(e){return e.sku||e.property_id||"N/A"}function ro(e){const a=e.images&&e.images[0]?e.images[0]:"/fallback.svg",t=_t(e),i=Ut(e),n=window._productSelection?.has(e.property_id),o=ee(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=oe(e.created_at),l=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",u=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${s(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${s(oo(e))}</p></div>
    ...
    ${t.length?`<div class="flex flex-wrap gap-1.5">${t.slice(0,6).map(g=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${s(g)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function so(e,a){const t=[...e],i=n=>new Date(n||0).getTime()||0;return a==="oldest"?t.sort((n,o)=>i(n.created_at)-i(o.created_at)):a==="price-high"?t.sort((n,o)=>ue(o.price)-ue(n.price)):a==="price-low"?t.sort((n,o)=>ue(n.price)-ue(o.price)):a==="sales-high"?t.sort((n,o)=>$t(o)-$t(n)):a==="views-high"?t.sort((n,o)=>kt(o)-kt(n)):t.sort((n,o)=>i(o.created_at)-i(n.created_at)),t}function Fa(e){const a=document.getElementById("products-grid"),t=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!a)return;const n=window._productsCardLimit||60,o=e.slice(0,n);a.innerHTML=o.map(ro).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const l=e.length-o.length;l>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}t&&t.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function ja(e){const a=document.getElementById("products-table-body"),t=document.getElementById("products-result-count");a&&(a.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const n=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=Ut(i),r=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
          ...
          <td>${ee(o==="archived"?"inactive":o==="active"?"active":"inactive")}</td>
    ...
    </div>`)};window.quickEditProduct=async function(e){const a=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),t=(window._productsData||[]).find(n=>n.property_id===e)||a.data;if(!t)return p("Product not found","error");const i=Array.isArray(t.images)?t.images:[];W(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Ht(),Gt(),Ae(),ke(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,a){e.preventDefault();const t=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb")].map(u=>u.dataset.url||(u.querySelector("img")?u.querySelector("img").getAttribute("src"):"")).filter(u=>u&&!String(u).startsWith("blob:")),n={title:t.get("title")||"Untitled Product",price:Math.max(H,Math.min(X,parseFloat(t.get("price"))||0)),stock_quantity:t.get("stock_quantity")===""?null:parseInt(t.get("stock_quantity"),10),availability_status:t.get("availability_status")||"In Stock",is_featured:t.get("is_featured")==="on",is_active:t.get("is_active")==="on"||i.length>=24,images:i},o=String(t.get("real_price")||"").trim(),r=o===""?null:parseFloat(o);if(r!=null&&!Number.isFinite(r)){p("Real Price must be a number.","error");return}const l=me((window._productsData||[]).find(u=>u.property_id===a)),d=l.specifications&&typeof l.specifications=="object"?l.specifications:{};n.specifications={...d,real_price:r!=null&&r>0?Math.round(r):null};const{error:c}=await m.from("showroom_listings").upsert({...l,...n,property_id:a},{onConflict:"property_id"});if(c){if(J(c)){p("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),ce(),O();return}vt(a,n),p("Quick edit saved locally","info")}else p(n.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");ce(),O()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const a=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(a),p("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",a)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const a=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||Ne(e),{error:t}=await m.from("showroom_listings").delete().eq("property_id",e);if(t&&!J(t))return p("Delete failed: "+t.message,"error");vi(e);try{const i=await wa(e,!0);i&&i.error&&J(i.error)?p("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Product deleted")}catch{p("Product deleted")}a&&a.listing_type==="property"?dt():O()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:a}=await m.from("showroom_listings").delete().neq("property_id","__none__");if(a)return J(a)?p("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Clear failed: "+a.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}p("All products deleted. The manager now shows your showroom catalog."),O()};window.openProductMoreActions=function(e){W(`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.filterProductCategoryChoices=function(e){const a=String(e||"").trim().toLowerCase();document.querySelectorAll("#product-category-grid [data-category]").forEach(t=>{const i=!a||t.dataset.category.includes(a);t.classList.toggle("hidden",!i)})};window.showAddProductStep2=function(e,a={}){const t=!!a.property_id,i=ka("product",e),n=a.currency||"USD";W(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${s(e)}','${t?a.property_id:""}')" class="space-y-6">
          ...
          <div class="space-y-3">
            ...
            <div id="image-url-inputs">
              ${(a.images||[]).map((o,r)=>`<input type="hidden" name="images" id="img-url-${r}" value="${s(o)}">`).join("")}
            </div>
          </div>
            ...
            <div class="flex flex-wrap gap-2.5">
              ${["New Arrival","Best Seller","Hot Deal","Featured","Limited Stock"].map(o=>`
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" name="tags" value="${o}" ${(a.tags||[]).includes(o)?"checked":""} class="accent-blue-500 w-5 h-5">
          ...
          <div class="form-grid form-grid-2">
            <div>
              ...
              <select class="input-field" name="availability_status" id="pf-availability_status">
                ${["In Stock","Out of Stock","Pre-order","Limited Stock"].map(o=>`<option value="${o}" ${a.availability_status===o?"selected":""}>${o}</option>`).join("")}
              </select>
            </div>
    ...
    </div>`),Ht(),Gt(),Pt("pf-price"),Pt("pf-real_price"),Et(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Et(e,"pricing")),yo(e,a.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),window._productPublishInFlight=!1,Re=-1,ce(),O()};window.switchProductFormCategory=function(e){const a=document.getElementById("product-form");if(!a)return;const t={},i=new FormData(a);for(const[n,o]of i.entries())n==="images"?(t.images=t.images||[],o&&!String(o).startsWith("blob:")&&t.images.push(String(o))):n==="tags"?(t.tags=t.tags||[],t.tags.push(o)):t[n]=o;t.is_featured=a.querySelector('[name="is_featured"]')?.checked||!1,t.is_active=a.querySelector('[name="is_active"]')?.checked||!1,t.property_id&&String(t.property_id).trim()?showAddProductStep2(e,t):showAddProductStep2(e,{images:t.images||[],...t})};function _e(e,a){const t=it(e)?'<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-300 select-none"><span class="text-2xl leading-none">📄</span><span class="text-[10px] font-bold mt-1">PDF</span></div>':`<img src="${s(e)}" onerror="this.src='/fallback.svg'">`;return`<div class="img-thumb ${a===0?"cover-img":""}" data-index="${a}" data-url="${s(e)}" title="${a===0?"Cover Image (main photo)":"Image "+(a+1)}">
    ${t}
  ...
  </div>`}function Ht(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",a=>{a.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{a.preventDefault(),e.classList.remove("drag-over"),mo(a.dataTransfer.files)}))}function Gt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Ae()})}window.handleImageUpload=async function(e){await Ga(e.target.files)};async function mo(e){await Ga(e)}async function Ga(e){const a=document.getElementById("image-preview");if(a){for(const t of e){const i=t.type==="application/pdf"||it(t.name);if(!t.type.startsWith("image/")&&!i)continue;const n=await zt(t);if(n){const o=a.children.length,r=document.createElement("div");r.innerHTML=_e(n,o),a.appendChild(r.firstElementChild),Ae()}}qe(),ke(),window.lucide&&lucide.createIcons()}}async function zt(e){try{const{data:{session:a}}=await m.auth.getSession(),t=(e.name||"photo.jpg").split(".").pop()||"jpg",i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`;for(let n=0;n<2;n++){const o=`${i}${n?"-"+Math.random().toString(36).slice(2,7):""}.${t}`,{error:r}=await m.storage.from("product-images").upload(o,e,{contentType:e.type,upsert:!1});if(r)console.warn("product-images upload failed (attempt "+(n+1)+"):",r.message||r);else{const{data:l}=m.storage.from("product-images").getPublicUrl(o);if(l&&l.publicUrl)return l.publicUrl}}try{const n=await q._downscaleImage(e,1200);if(n)return n}catch{}return URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const a=document.getElementById("image-preview");if(!a)return;const t=[...a.children];t[e]&&t[e].remove(),Ae(),qe(),ke()};window.replaceImage=async function(e,a){const t=document.getElementById("image-preview");if(!t||!a||!a.files||!a.files[0])return;const i=a.files[0],n=i.type==="application/pdf"||it(i.name);if(!i.type.startsWith("image/")&&!n){p("Please choose an image or PDF file.","error");return}const o=await zt(i);if(!o)return;const r=[...t.querySelectorAll(".img-thumb")][e];r&&(r.outerHTML=_e(o,e),Ae(),qe(),ke(),p(n?"Document replaced. Save changes to apply.":"Image replaced. Save changes to apply.","info"))};function Ae(){const e=document.getElementById("image-preview"),a=document.getElementById("image-url-inputs");!e||!a||(a.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((t,i)=>{const n=t.dataset.url||(t.querySelector("img")?t.querySelector("img").src:"");if(!n)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=n,a.appendChild(o),t.dataset.index=i;const r=t.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=t.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=t.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function qe(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((a,t)=>{a.classList.toggle("cover-img",t===0),a.title=t===0?"Cover Image":`Image ${t+1}`})}function ke(){const e=document.getElementById("image-preview"),a=document.getElementById("gallery-counter");if(!e||!a)return;const t=e.querySelectorAll(".img-thumb").length;a.textContent=t?`${t} image${t>1?"s":""} â€” you can save and publish anytime`:"No images yet â€” you can still save and publish anytime",a.className="text-sm mt-1 font-bold text-gray-400"}function De(e,a){return`kco_product_form_autosave_${e}_${a||"new"}`}function go(e){const a=new FormData(e),t={images:[],tags:[],fields:{}};for(const[i,n]of a.entries())i==="images"?n&&!String(n).startsWith("blob:")&&t.images.push(String(n)):i==="tags"?t.tags.push(String(n)):t.fields[i]=String(n);return t.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",t.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",t}function bo(e,a){if(!a||typeof a!="object")return!1;const t=a.fields||{};Object.entries(t).forEach(([n,o])=>{const r=e.querySelector(`[name="${n}"]`);r&&(r.type==="checkbox"?r.checked=o==="on"||o===!0:r.value=o==null?"":String(o))});const i=Array.isArray(a.tags)?a.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(n=>{n.checked=i.includes(n.value)}),Array.isArray(a.images)){const n=document.getElementById("image-preview");n&&(n.innerHTML=a.images.map((o,r)=>_e(o,r)).join(""),Ae(),qe(),ke())}return!0}function At(){const e=document.getElementById("product-review-content"),a=document.getElementById("product-form");if(!e||!a)return;const t=a.querySelector('[name="title"]')?.value||"Untitled Product",i=a.querySelector('[name="brand"]')?.value||"N/A",n=parseFloat(a.querySelector('[name="price"]')?.value||"0")||0,o=parseFloat(a.querySelector('[name="real_price"]')?.value||"0")||0,r=a.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,d=B.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",c=[...a.querySelectorAll('input[name="tags"]:checked')].map(y=>y.value),u=document.querySelectorAll("#image-preview .img-thumb").length,g=a.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const a=document.querySelector("#image-preview img")?.src||"/fallback.svg",t=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,l=e.dataset.category||"Product",d=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",c=e.querySelector('[name="is_active"]')?.checked;W(`
    ...
    </div>`)};function yo(e,a){const t=document.getElementById("product-form");if(!t)return;t.dataset.category=e;const i=De(e,a),n=document.getElementById("product-autosave-note");if(!a)try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);bo(t,c)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(go(t))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}At()};let r;const l=()=>{clearTimeout(r),r=setTimeout(o,500)};t.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",l),d.addEventListener("change",l)}),At(),ke()}const ho=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],fo=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],vo=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],xo=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],wo=["FWD","RWD","AWD","4WD"],ft=["title","description","brand","model","model_year","color","condition","subcategory","engine","transmission","fuel_type","drive_type","horsepower","mileage","seating_capacity","doors","body_type","safety_features","storage","ram","processor","display","graphics","os","material","size","gender","platform","voltage","type","dimensions","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","country_code","latitude","longitude","listing_status","interior_features","exterior_features","home_systems","author","publisher","language","format","isbn","pages","edition","quantity","age_range","skin_type","ingredients","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","warranty","availability_status"],Je=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function na(e){const a=e.id?`label[for="${e.id}"]`:null,t=a?document.querySelector(a):null;if(t)return t.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function _o(e){const a=typeof e=="string"?document.querySelector(e):e;if(!a)return[];const t=new Set,i=[];return a.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const o=String(n.name||"");if(!o||o==="images"||t.has(o)||["hidden","file","submit","button"].includes(n.type))return;if(t.add(o),n.type==="checkbox"){const l=[...a.querySelectorAll(`input[name="${o}"]`)];i.push({key:o,label:na(n),type:"checkbox-group",options:l.map(d=>d.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const r=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:o,label:na(n),type:r,options:n.tagName==="SELECT"?[...n.options].map(l=>l.value).filter(Boolean):null,required:!!n.required})}),i}function ko(e){return!e||!e.length?"":`
...
`)}
`}const za=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function ra(e,a){const t={...a||{}},i=new Set(Array.isArray(t.estimated)?t.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(t.missing_fields)?t.missing_fields.map(u=>String(u)):[]),o=[],r=[],l=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(y=>y!=null&&String(y).trim()!=="").join(", "));let g=String(u).replace(/\s+/g," ").trim();return g=g.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),g},d=u=>{const g=l(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),y=parseFloat(g);return Number.isFinite(y)?y:NaN};for(const u of e||[]){if(Je.has(u.key))continue;const g={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const b=Array.isArray(t[u.key])?t[u.key].map(l).filter(Boolean):[],h=u.options&&u.options.length?b.filter(v=>u.options.includes(v)):b;h.length?(t[u.key]=h,g.status="filled",g.value=h.join(", ")):(delete t[u.key],b.length&&(g.status="flagged",g.note="values not in the allowed badge list were dropped",r.push(`${u.label}: invalid selection ignored`))),o.push(g);continue}if(!(t[u.key]!=null&&l(t[u.key])!=="")){g.status=n.has(u.key)?"missing":"empty-ok",o.push(g);continue}if(za.test(l(t[u.key]))){delete t[u.key],n.add(u.key),g.status="missing",g.note="document/AI said the value is unavailable",o.push(g);continue}if(u.type==="number"){const b=l(t[u.key]),h=d(t[u.key]);if(!Number.isFinite(h)){delete t[u.key],n.add(u.key),g.status="flagged",g.note=`"${b}" is not a valid number`,r.push(`${u.label}: not a valid number`),o.push(g);continue}if(/year/.test(u.key)&&(h<1800||h>new Date().getFullYear()+2)){delete t[u.key],n.add(u.key),g.status="flagged",g.note=`${h} is outside the plausible range`,r.push(`${u.label}: implausible value ${h}`),o.push(g);continue}t[u.key]=h,g.status="filled",g.value=String(h),i.has(u.key)&&(g.status="estimated",g.note="AI estimate â€” confirm"),o.push(g);continue}if(u.type==="select"&&u.options&&u.options.length){const b=Va({options:u.options.map(h=>({value:h}))},l(t[u.key]));if(b==null){g.status="flagged",g.note=`"${l(t[u.key])}" does not match any option â€” left empty`,r.push(`${u.label}: no matching option`),delete t[u.key],n.add(u.key),o.push(g);continue}t[u.key]=b,g.status="filled",g.value=b,b!==l(a?.[u.key])&&(g.note="matched to the closest option"),o.push(g);continue}let y=l(t[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&y.length>120&&!["title"].includes(u.key)&&(g.status="flagged",g.note="unusually long â€” check it landed in the right field",r.push(`${u.label}: suspiciously long value`)),t[u.key]=y,g.status="filled",g.value=y.length>48?y.slice(0,48)+"â€¦":y,i.has(u.key)&&(g.status="estimated",g.note="AI estimate â€” confirm"),o.push(g)}if(e&&e.length){const u=new Set([...e.map(g=>g.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(t).forEach(g=>{u.has(g)||delete t[g]})}t.missing_fields=o.filter(u=>u.status==="missing").map(u=>u.key),t.estimated=o.filter(u=>u.status==="estimated").map(u=>u.key);const c={total:o.length,filled:o.filter(u=>u.status==="filled").length,estimated:o.filter(u=>u.status==="estimated").length,flagged:o.filter(u=>u.status==="flagged").length,missing:o.filter(u=>u.status==="missing").length};return{specs:t,checklist:o,flags:r,summary:c}}function Vt(e,a){if(!e||!e.length)return"";const t={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${t[o.status]||""}</span><span><b>${s(o.label)}</b> <span class="text-gray-600">(${s(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${s(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${s(o.note)}</span>`:""}</span></li>`).join(""),n=a.total-a.filled-a.estimated-a.flagged-a.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${a}">
    ...
    <div class="space-y-3">
      ...
      ${G.map((a,t)=>Eo(a,t)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const a=G[e];if(!a)return;Re=e;const t=Wt(a,he),i=lt(a.category);if(a.listing_type==="property"||i&&i.listing_type==="property"){(Z==="s1-scan-status"||Z==="scanner-scan-status")&&(ce(),be=[]),Ao(a,t);return}const n=i.category||a.category||"Other";if(Z==="s1-scan-status"||Z==="scanner-scan-status"){try{localStorage.removeItem(De(n,""))}catch{}be=[];let o=a.property_id?xe[a.property_id]:null;o&&o.specifications&&typeof o.specifications=="object"&&(o={...o,...o.specifications}),showAddProductStep2(n,o?{...o,images:t}:{images:t}),await la(a,t,n)}else{const o=document.getElementById("product-form"),r=o&&o.dataset.category||"";if(n!==r){try{localStorage.removeItem(De(n,""))}catch{}switchProductFormCategory(n);const l=document.getElementById(Z);l&&(l.classList.remove("hidden"),l.classList.add("text-blue-300"),l.textContent=`Category changed to ${n} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await la(a,t,n)}};window.scanReviewEdit=function(e){const a=G[e];if(!a)return;const t=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!t)return;const i=lt(a.category),n=a.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||a.category||"Other",o=ge.map(r=>`<option value="${s(r)}" ${r===n?"selected":""}>${s(r)}</option>`).join("");t.innerHTML=`
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const a=G[e];if(!a)return;const t=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,n=document.getElementById(`sr-model-${e}`)?.value,o=document.getElementById(`sr-cat-${e}`)?.value;t&&(a.detected_name=t),i&&(a.brand=i),n&&(a.model=n),o&&(a.category=o),scanReviewRender()};window.scanReviewRemove=function(e){G.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(Z);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled â€” nothing was changed.")};window.scanReviewContinueAll=async function(){const e=document.getElementById(Z),a=(c,u)=>{e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400","text-gray-100"),u&&e.classList.add(u),e.innerHTML=c,window.lucide&&lucide.createIcons())};if(!G.length)return;const t=document.getElementById("btn-scan-continue-all");t&&(t.disabled=!0,t.textContent="Saving everythingâ€¦");const i=G.length;let n=0,o=0,r=0;const l=[];for(let c=0;c<i;c++){const u=G[c];if(!u)continue;const g=lt(u.category);if(u.listing_type==="property"||g&&g.listing_type==="property"){l.push(c);continue}const y=g.category||u.category||"Other",b=Wt(u,he);a(`<p class="flex items-center gap-2"><i data-lucide="loader" class="w-4 h-4 animate-spin text-blue-300"></i> Completing ${c+1} of ${i}: <b>${s(u.detected_name||"product")}</b>â€¦</p>`,"text-blue-300");try{const h=await q.completeSpecsAndPrice(b,u,{category:y,maxImages:ye.maxImages}).catch(()=>null);let v=h&&h.specs||{},_=h?h.price:null;if(Ue()){const I=await q.verifyExtraction(b,u,v,[],{maxImages:ye.maxImages}).catch(()=>null);if(I&&I.corrections&&typeof I.corrections=="object"){for(const[U,w]of Object.entries(I.corrections))w==null||String(Array.isArray(w)?w.join(", "):w).trim()===""||ft.includes(U)&&(v[U]=w);for(const[U,w]of Array.isArray(I.wrong_mapping)?I.wrong_mapping:[])ft.includes(w)&&v[U]!=null&&(v[w]==null||String(v[w]).trim()==="")&&(v[w]=v[U],delete v[U])}}const k={};for(const[I,U]of Object.entries(v)){if(!ft.includes(I)||Je.has(I))continue;const w=Array.isArray(U)?U.map(D=>String(D??"").replace(/\s+/g," ").trim()).filter(Boolean):String(U??"").replace(/\s+/g," ").trim();if(!(!w.length||(Array.isArray(w)?w.join(" "):w).match(za))){if(/^(model_)?year/.test(I)){const D=parseInt(w,10);if(!Number.isFinite(D)||D<1800||D>new Date().getFullYear()+2)continue}k[I]=w}}v=k;const f=v||{},$=u.property_id&&xe[u.property_id]||null,x=$?$.specifications&&typeof $.specifications=="object"?{...$,...$.specifications}:$:null,P=[u.year||f.year,u.brand||f.brand,u.model||f.model].filter(Boolean).join(" ")||u.detected_name||"Product",A=_?Number(_.estimated_price??_.price??_.estimate):NaN;let j=Number.isFinite(A)&&A>0?A:x?Number(x.price):NaN;(!Number.isFinite(j)||j<=0)&&(j=H),j=Math.max(H,Math.min(X,j));const S=new Set(["title","description","brand","color","size","condition","warranty","availability_status"]),E={};for(const[I,U]of Object.entries({...Object.fromEntries(Ct.filter(w=>w!=="year_estimated"&&w!=="listing_status").map(w=>[w,u[w]??null])),...f})){if(S.has(I)||Je.has(I))continue;const w=Array.isArray(U)?U.filter(D=>D!=null&&String(D).trim()!==""):U;w==null||typeof w=="string"&&!w.trim()||(E[I]=w)}const M={...x&&x.specifications&&typeof x.specifications=="object"?x.specifications:{},...E},te={listing_type:"product",category:y,subcategory:x?.subcategory||f.subcategory||null,title:f.title||x&&x.title||P,description:f.description||x&&x.description||"",price:j,currency:x&&x.currency||"USD",country:x&&x.country||"",country_code:x&&x.country_code||"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:!0,is_featured:!!(x&&x.is_featured),brand:u.brand||f.brand||x&&x.brand||null,color:f.color||x&&x.color||null,size:f.size||x&&x.size||null,condition:x&&x.condition||null,warranty:x&&x.warranty||null,availability_status:x&&x.availability_status||"In Stock",stock_quantity:x&&x.stock_quantity?parseInt(x.stock_quantity):null,images:b.length?b:x&&x.images||[],features:Array.isArray(f.features)&&f.features.length?f.features:x&&x.features||[],tags:Array.isArray(f.tags)&&f.tags.length?f.tags:x&&x.tags||[],highlights:Array.isArray(f.highlights)&&f.highlights.length?f.highlights:x&&x.highlights||[],seo_keywords:Array.isArray(f.seo_keywords)&&f.seo_keywords.length?f.seo_keywords:x&&x.seo_keywords||[],is_ai_generated:!0,ai_generated_fields:["title","description","specifications","price"],specifications:M,updated_at:new Date().toISOString()};if(x&&x.property_id){te.property_id=x.property_id;const{error:I}=await Ye(te);if(I)throw I;o++}else{te.property_id=ot();const{error:I}=await Ye(te);if(I)throw I;n++}}catch(h){r++,a(`<p class="text-amber-300">Could not save "${s(u.detected_name||"product")}": ${s(String(h?.message||h))} â€” continuing with the restâ€¦</p>`,"text-amber-300")}}G=G.filter((c,u)=>l.includes(u));const d=`${o} updated, ${n} new${r?`, ${r} failed`:""}`;if(!G.length)xe={},he=[],a(`<div class="space-y-1">
    ...
    </div>`,"text-emerald-300"),p(`All done â€” ${d} saved & published.`,"success");else{scanReviewRender();const c=document.getElementById(Z);if(c){const u=document.createElement("p");u.className="text-xs font-bold text-emerald-300",u.textContent=`Saved & published: ${d}. Property cards below still need Continue.`,c.prepend(u)}p(`Saved ${d}.`,r?"info":"success")}O()};function Ya(e){const a=e&&e.identification&&e.identification.identified!==!1?e.identification:{},t=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,n=[],o=C=>Array.isArray(C)?C.join(", "):String(C??"").trim(),r=(C,N)=>{if(N==null||o([N])==="")return;const Q=document.querySelector(`#property-form [name="${C}"]`);Q&&(Q.value=String(N),n.push(C))},l=a.property_type||t.property_type;if(l){const C=Po(l);C&&r("property_type",C)}r("title",t.title||a.detected_name),r("description",t.description),r("subcategory",a.subcategory||t.subcategory);const d=a.bedrooms??t.bedrooms;d!=null&&d!==""&&r("bedrooms",parseInt(d,10)||d);const c=a.bathrooms??t.bathrooms;c!=null&&c!==""&&r("bathrooms",parseInt(c,10)||c),r("building_size",a.building_size||t.building_size),r("land_size",a.land_size||t.land_size);const u=a.parking_spaces??t.parking_spaces;u!=null&&u!==""&&r("parking_spaces",parseInt(u,10)||u);const g=String(a.furnished||t.furnished||"").toLowerCase();/furnished|yes/.test(g)?r("furnished","Furnished"):/unfurnished|no|empty/.test(g)&&r("furnished","Unfurnished");const y=String(a.listing_status||t.listing_status||"").toLowerCase();/rent|lease/.test(y)?r("listing_status","rent"):/sale|buy|purchase/.test(y)&&r("listing_status","sale");const b=a.area||t.area;b&&!(a.town||t.town)&&r("town",b),r("town",a.town||t.town),r("city",a.city||t.city),r("state",a.state||t.state);const h=a.country||t.country;if(r("country",h),h){const C=(Ee||[]).find(N=>String(N.name||"").toLowerCase()===String(h).toLowerCase()||String(N.code||"").toLowerCase()===String(h).toLowerCase());if(C&&C.code){const N=document.querySelector('#property-form [name="country_code"]');N&&(N.value=C.code,n.push("country_code"))}}const v=a.address||t.address;r("product_location",v||[b||a.town||t.town,a.city||t.city,a.state||t.state,h].filter(Boolean).join(", ")),r("address",a.address||t.address),r("zip_code",a.zip_code||t.zip_code);const _=Number(a.latitude??t.latitude),k=Number(a.longitude??t.longitude);Number.isFinite(_)&&_>=-90&&_<=90&&_!==0&&r("latitude",String(_)),Number.isFinite(k)&&k>=-180&&k<=180&&k!==0&&r("longitude",String(k)),r("features_text",o(t.features)),r("highlights_text",o(a.highlights||t.highlights)),r("seo_keywords_text",o(t.seo_keywords));const f=a.half_bathrooms??t.half_bathrooms;f!=null&&f!==""&&r("half_bathrooms",parseInt(f,10)||f);const $=a.floors??t.floors;$!=null&&$!==""&&r("floors",parseInt($,10)||$),r("garage",a.garage||t.garage);const x=a.year_built??t.year_built;x!=null&&x!==""&&r("year_built",parseInt(x,10)||x);const P=a.year_renovated??t.year_renovated;P!=null&&P!==""&&r("year_renovated",parseInt(P,10)||P);const A=a.condition||t.condition,j=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(A){const C=String(A).toLowerCase(),N=j.find(Q=>C.includes(Q.toLowerCase())||Q.toLowerCase().includes(C));N&&r("condition",N)}r("interior_features_text",o(t.interior_features)),r("exterior_features_text",o(t.exterior_features)),r("home_systems_text",o(t.home_systems));const S=o(a.landmarks||t.landmarks);S&&r("landmarks_text",S);const E=t.floor_plan;if(E&&typeof E=="object"){E.image&&r("floor_plan_image",E.image),E.levels&&r("floor_plan_levels",E.levels),E.total_area&&r("floor_plan_total_area",E.total_area);const C=Array.isArray(E.rooms)?E.rooms.map(N=>{const Q=String(N).match(/^(.*?):\s*(.*)$/);return Q?`${Q[1].trim()}: ${Q[2].trim()}`:String(N)}):[];C.length&&r("floor_plan_rooms",C.join(", "))}const M=t.nearby_area;M&&typeof M=="object"&&(Array.isArray(M.schools)&&M.schools.length&&r("nearby_schools_text",M.schools.join(", ")),Array.isArray(M.hospitals)&&M.hospitals.length&&r("nearby_hospitals_text",M.hospitals.join(", ")),Array.isArray(M.shopping)&&M.shopping.length&&r("nearby_shopping_text",M.shopping.join(", ")),Array.isArray(M.transportation)&&M.transportation.length&&r("nearby_transportation_text",M.transportation.join(", ")),Array.isArray(M.distances)&&M.distances.length&&r("nearby_distances_text",M.distances.join(", ")));const te=Array.isArray(t.legal_info)?t.legal_info.join(", "):o(t.legal_info);te&&r("legal_info_text",te),t.inspection_info&&r("inspection_info",t.inspection_info),t.risk_notes&&r("risk_notes",t.risk_notes);const I=document.querySelector('#property-form [name="verification_status"]');I&&(I.value="Not verified",n.push("verification_status"));const U=new Set((Array.isArray(t.missing_fields)?t.missing_fields:[]).map(C=>String(C))),w=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);U.forEach(C=>{if(w.has(C))return;const N=document.querySelector(`#property-form [name="${C}"]`);if(!(!N||N.type==="checkbox"||N.type==="radio"||N.type==="number")&&String(N.value||"").trim()===""){if(N.tagName==="SELECT"&&![...N.options].some(Q=>Q.value==="Not specified")){const Q=document.createElement("option");Q.value="Not specified",Q.textContent="Not specified",N.appendChild(Q)}N.value="Not specified",n.push(`${C} (Not specified)`)}});const D=Number.isFinite(Number(H))?Number(H):0,R=Number.isFinite(Number(X))?Number(X):999999999,re=C=>Math.max(D,Math.min(R,Math.round(C))),Le=i?Number(i.estimated_price):NaN,Ge=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(Le)&&Le>0){const C=document.querySelector('#property-form [name="real_price"]');C&&(C.value=String(re(Le)),n.push("real_price"));const N=Number.isFinite(Ge)&&Ge>0&&Ge<Le?Ge:Le;r("price",String(re(N)))}const ta=String(t.title||a.detected_name||"Property").trim()||"Property",ui=t.description||`${ta} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,aa=Wa("#property-form",{titleFallback:ta,descriptionFallback:ui});return aa&&n.push(`${aa} auto-completed (Not specified / safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:n}}const Ct=["brand","model","year","year_estimated","body_type","color","condition","subcategory","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","latitude","longitude","listing_status"];function Yt(){return Date.now()<(typeof q<"u"&&q._geminiQuotaUntil||0)?'<p class="text-[11px] text-amber-300 mt-1">⚠ Your Gemini key hit its FREE rate limit during this scan — parts were completed from saved details only. Wait ~1 minute and scan again for full AI reading.</p>':""}function Ue(){try{return localStorage.getItem("weverse_scan_verify")==="on"}catch{return!1}}function Io(e){try{localStorage.setItem("weverse_scan_verify",e?"on":"off")}catch{}}window.scanVerifyPassEnabled=Ue;window.setScanVerifyPass=Io;async function Kt(e){q.beginScanSession();try{const a=await q.preflight(),t=a.gemini,i=a.groq;t&&t.ok&&i&&i.ok?e(`<span class="inline-flex items-center gap-1"><i data-lucide="check-circle-2" class="w-3.5 h-3.5 text-emerald-300"></i> AI ready — Gemini primary + Groq backup verified (${s(t.model||"")}).</span>`,"text-emerald-300"):t&&t.ok?e(`AI ready via Gemini${t.model?` (${s(t.model)})`:""}. Groq backup not available${i&&i.error?": "+s(i.error):"."} Scans continue on Gemini alone.`,"text-emerald-300"):i&&i.ok?e(`Gemini unavailable${t&&t.error?" ("+s(t.error)+")":""} — scans will run on the Groq backup only.`,"text-amber-300"):a.error?e(`AI service unreachable (${s(a.error)}) — results will be filled from saved details only, clearly marked.`,"text-red-400"):e("No working vision provider found. Add a Google Gemini key (primary) and optionally a Groq key (backup) in AI Settings.","text-red-400")}catch{e("AI preflight failed — continuing anyway.","text-amber-300")}}async function Jt({imageUrls:e,identification:a,category:t,formSelector:i,verify:n=Ue()}){const o=_o(i),r=ko(o),l=await q.completeSpecsAndPrice(e,a,{category:t||"",maxImages:ye.maxImages,fieldsSchema:r}),d=l?l.price:null,c=l&&l.specs||{};let u={};for(const v of Ct)a&&a[v]!=null&&a[v]!==""&&(u[v]=a[v]);u={...u,...c};let g=ra(o,u),y=!1;const b=`${l&&l.specs&&l.specs._aiProvider||""} ${l&&l.specs&&l.specs._aiModel||""}`,h=!/pollinations|free ai/i.test(b);if(n&&h)try{const v=await q.verifyExtraction(e,a,g.specs,o,{maxImages:ye.maxImages});if(v){const _=v.corrections&&typeof v.corrections=="object"?v.corrections:{},k=Object.keys(_);if(k.length){const f={...g.specs};for(const[$,x]of Object.entries(_))o.some(P=>P.key===$)&&(x==null||String(Array.isArray(x)?x.join(", "):x).trim()===""||(f[$]=x));for(const[$,x]of Array.isArray(v.wrong_mapping)?v.wrong_mapping:[])f[$]!=null&&(f[x]==null||String(f[x]).trim()==="")&&(f[x]=f[$],delete f[$]);g=ra(o,f),a={...a};for(const $ of k)Ct.includes($)&&g.specs[$]!=null&&(a[$]=g.specs[$])}y=!0,g.verificationNotes=Array.isArray(v.notes)?v.notes.slice(0,4):[]}}catch{}return{specs:g.specs,price:d,checklist:g.checklist,summary:g.summary,verified:y,verificationNotes:g.verificationNotes||[],identification:a,visionUsed:h,verifyRequested:!!n,providerLabel:b.trim()||"unknown"}}async function la(e,a,t){const i=document.getElementById("scan-ai-status"),n=(o,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=o)};try{n("Reading every image/page, completing all specifications and pricesâ€¦","text-blue-300");let o=e;const r=await Jt({imageUrls:a,identification:o,category:t,formSelector:"#product-form"});o=r.identification||o;const l=So({identification:o,specs:r.specs,price:r.price}),d=[o.year,o.brand,o.model].filter(Boolean).join(" ")||o.detected_name||"the product";let c=`${s(d)} â€” ${l.filled.length} field${l.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;o.year_estimated&&(c+=" Confirm the model year before saving."),r.visionUsed?r.verifyRequested&&(c+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>'):c+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photo was NOT read by AI (${s(r.providerLabel||"text fallback")}) — the values below did NOT come from your images. Re-scan when the key/quota is available.</p>`,r.summary.flagged&&(c+=`<p class="text-[11px] text-red-300 mt-1">${r.summary.flagged} value${r.summary.flagged>1?"s need":" needs"} your attention below.</p>`),c+=Yt(),c+=Vt(r.checklist,r.summary),n(c,"text-emerald-300"),p(`Review ${d}, then press SAVE / UPDATE.`,"success")}catch(o){const r=String(o?.message||o),l=/key|api|configured|settings|vision/i.test(r);n(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),p("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){p("Open the product form first.","error");return}const a=document.getElementById("btn-scan-ai"),t=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(d=>d.value).filter(Boolean);if(!i.length){p("Upload at least one product image before scanning.","error");return}const n=a?a.innerHTML:"",o=(d,c)=>{t&&(t.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&t.classList.add(c),t.innerHTML=d)};await Kt(o),a&&(a.disabled=!0,a.innerHTML="Scanningâ€¦"),o("Detecting every distinct product in your imagesâ€¦","text-blue-300");let r;try{r=await q.detectProducts(i,{category:e.dataset.category||"",maxImages:ye.maxImages})}catch(d){const c=String(d?.message||d),u=/key|api|configured|settings|vision/i.test(c);o(u?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),p("AI scan failed.","error"),a&&(a.disabled=!1,a.innerHTML=n);return}a&&(a.disabled=!1,a.innerHTML=n);let l=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];l.length||(l=[{detected_name:"Product from your photos",category:e.dataset.category||"Other",listing_type:"product",confidence:"low",image_indices:i.map((d,c)=>c)}],o("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),G=l,he=i,xe={},Z="scan-ai-status",scanReviewRender(),p(`${l.length} distinct product${l.length>1?"s":""} detected â€” review each one, then continue.`,"info")};function Ao(e,a){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const t=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");t&&i&&(t.innerHTML=a.map((r,l)=>_e(r,l)).join(""),i.innerHTML=a.map((r,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${s(r)}">`).join(""),qe(),ke());const n=document.getElementById("scan-ai-prop-status"),o=(r,l)=>{n&&(n.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&n.classList.add(l),n.innerHTML=r)};o("Reading every page, completing property details and valueâ€¦","text-blue-300"),(async()=>{try{const r=await Jt({imageUrls:a,identification:e,category:"Real Estate",formSelector:"#property-form"}),l=r.identification||e,d=Ya({identification:l,specs:r.specs,price:r.price});let c;r.price?c=`${s(l.detected_name||"Property")} â€” ${d.filled.length} field${d.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`:c=`${s(l.detected_name||"Property")} â€” ${d.filled.length} fields ready. Price estimate skipped â€” set the price manually, then press Publish Property.`,r.visionUsed?r.verifyRequested&&(c+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>'):c+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photo was NOT read by AI (${s(r.providerLabel||"text fallback")}) — these values did NOT come from your images.</p>`,c+=Yt(),c+=Vt(r.checklist,r.summary),o(c,r.price?"text-emerald-300":"text-amber-300"),p("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}catch(r){const l=/key|api|configured|settings|vision/i.test(String(r?.message||r));o(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),p("AI scan failed.","error")}})()}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){p("Open the property form first.","error");return}const e=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),t=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(l=>l.value).filter(Boolean);if(!t.length){p("Upload at least one property image before scanning.","error");return}const i=e?e.innerHTML:"",n=(l,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=l)};await Kt(n),e&&(e.disabled=!0,e.innerHTML="Scanningâ€¦"),n("Identifying this property from your imagesâ€¦","text-blue-300");let o;try{o=await q.identifyProduct(t,{category:"Real Estate",maxImages:ye.maxImages})}catch(l){const d=String(l?.message||l),c=/key|api|configured|settings|vision/i.test(d);n(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),p("AI scan failed.","error"),e&&(e.disabled=!1,e.innerHTML=i);return}if(!o||o.identified===!1){n(o&&o.reason?`Could not identify the property: ${s(o.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),p("The property could not be identified from the images.","error"),e&&(e.disabled=!1,e.innerHTML=i);return}e&&(e.disabled=!1,e.innerHTML=i);const r=await new Promise(l=>{Qe=g=>{Qe=null,l(g)};const d=document.getElementById("scan-ai-prop-status");if(!d){l({choice:"continue"});return}if(!window._propFormDirty){l({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const c=o.confidence||"medium",u={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[c]||"text-amber-400 border-amber-500/20";d.innerHTML=`
    ...
    </div>`).join("");const a=document.getElementById("btn-s1-scan");a&&(a.disabled=be.length===0,a.style.opacity=be.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=be.slice();if(!e.length){p("Upload at least one product image before scanning.","error");return}const a=document.getElementById("btn-s1-scan"),t=document.getElementById("s1-scan-status"),i=a?a.innerHTML:"",n=(l,d)=>{t&&(t.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&t.classList.add(d),t.innerHTML=l)};await Kt(n),a&&(a.disabled=!0,a.innerHTML="Scanningâ€¦"),n("Detecting every distinct product in your imagesâ€¦","text-blue-300");let o;try{o=await q.detectProducts(e,{category:"",maxImages:ye.maxImages})}catch(l){const d=/key|api|configured|settings|vision/i.test(String(l?.message||l));n(d?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),a&&(a.disabled=!1,a.innerHTML=i);return}a&&(a.disabled=!1,a.innerHTML=i);let r=o&&o.identified!==!1&&Array.isArray(o.products)&&o.products.length?o.products:[];r.length||(r=[{detected_name:"Product from your photos",category:"Other",listing_type:"product",confidence:"low",image_indices:e.map((l,d)=>d)}],n("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),G=r,he=e,xe={},Z="s1-scan-status",scanReviewRender(),p(`${r.length} distinct product${r.length>1?"s":""} detected â€” review each one, then continue.`,"info")};let xe={};async function Ja(){const e=new Set,a=[],t=i=>{!i||!i.property_id||i.listing_type==="property"||e.has(i.property_id)||!Array.isArray(i.images)||!i.images.length||(e.add(i.property_id),a.push(i))};try{const{data:i,error:n}=await m.from("showroom_listings").select("*").neq("listing_type","property");(n?[]:i||[]).forEach(t)}catch{}return tt().forEach(t),a}window.returnToScanReviewAfterSave=function(e=Re){return Re=-1,G.length?(Number.isInteger(e)&&e>=0&&e<G.length&&G.splice(e,1),G.length?(Z="scanner-scan-status",W(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="rounded-2xl border border-violet-500/25 bg-violet-500/10 p-4 space-y-3">
          <label class="flex items-start gap-2 text-[11px] text-gray-400 select-none cursor-pointer">
            <input type="checkbox" class="accent-violet-500 mt-0.5" ${Ue()?"checked":""} onchange="setScanVerifyPass(this.checked)">
    ...
    </div>`),window.lucide&&lucide.createIcons()};function da(e,a){const t=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(t),a))]).then(i=>{if(i===t)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await da(Ja(),15e3)}catch{e=[]}if(!e.length){p("No products with photos are in the Product Manager yet â€” add a product first.","error");return}const a=document.getElementById("btn-scanner-scan"),t=document.getElementById("scanner-scan-status"),i=a?a.innerHTML:"",n=(S,E)=>{t&&(t.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),E&&t.classList.add(E),t.innerHTML=S)};try{const S=await q.getConfig();String(S.gemini_key||S.gemini_api_key||"").trim()||n("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}a&&(a.disabled=!0,a.innerHTML="Scanningâ€¦"),n(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300");const o=[],r=[],l={};let d=0,c=0;const u=e.length,g=new Set;let y=0,b=0;window.__scanDupContinue=function(){const S=window.__scanDupResolve;window.__scanDupResolve=null;const E=document.getElementById("btn-scan-dup-continue");E&&(E.disabled=!0),S&&S()};const h=2,v=12e4;let _=0,k=0;const f=async S=>{const E=(S.images||[]).filter(Boolean);if(!E.length)return;const M=E.map(R=>String(R||"").trim()).filter(Boolean),te=M.length>0&&M.every(R=>g.has(R));for(const R of M)g.add(R);if(te){y++;return}const I=o.length;o.push(...E);const U=E.map((R,re)=>I+re);let w=[],D=null;try{const R=await da(q.detectProducts(E,{category:S.category||"",maxImages:ye.maxImages}),v);w=R&&R.identified!==!1&&Array.isArray(R.products)?R.products:[]}catch(R){D=R}w.length||(D&&c++,w=[{detected_name:S.title||S.property_id||"Product",category:S.category||"Other",listing_type:S.listing_type||"product",brand:S.brand||null,model:S.specifications&&S.specifications.model||S.model||null,confidence:"medium",_photoNotRead:!0,_fallbackReason:D?"scan-failed":"no-identification"}],b++),d++,l[S.property_id]=S;for(const R of w)r.push({...R,property_id:S.property_id,image_indices:Array.isArray(R.image_indices)&&R.image_indices.length?R.image_indices.map(re=>U[Number(re)]).filter(re=>re!==void 0):U,detected_name:R.detected_name||S.title||S.property_id,category:R.category||S.category||"Other",listing_type:R.listing_type||S.listing_type||"product"})},$=async()=>{for(;_<e.length;){const S=e[_++];n(`Scanning ${k+1} of ${u} product${u===1?"":"s"} (fast parallel mode)â€¦`,"text-blue-300"),await f(S),k++,k<u&&n(`Scanned ${k} of ${u} â€” continuingâ€¦`,"text-blue-300")}};if(await Promise.all(Array.from({length:Math.min(h,Math.max(1,e.length))},$)),a&&(a.disabled=!1,a.innerHTML=i),!r.length){n(c?`The scan could not read any product (${c} scan${c>1?"s":""} failed or timed out${y?`; ${y} duplicate product${y>1?"s":""} skipped`:""}). Make sure your products have clear photos and that your free Gemini key is active in AI Settings, then try again.`:`No product could be identified from the photos on your existing products${y?` (${y} duplicate product${y>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),p("No products could be scanned.","error");return}G=r,he=o,xe=l,Z="scanner-scan-status",scanReviewRender();const x=q.sessionReport(),P=Date.now()<(q._geminiQuotaUntil||0),A=x.issues.length?x.issues[x.issues.length-1]:null,j=[`${d} product${d===1?"":"s"} processed`,y?`${y} duplicate${y>1?"s":""} skipped`:"",b?`${b} filled from saved details (photo NOT read)`:"",c?`${c} scan error${c>1?"s":""}`:"",x.providers.map(S=>`${S.count} by ${S.name}`).join(", ")].filter(Boolean);n(`
    <p class="font-bold ${c?"text-amber-300":"text-emerald-300"}">Scan finished: ${j.join(" · ")}.</p>
  ...
  `,c||P?"text-amber-300":"text-emerald-300"),p(`Scan complete â€” ${j.join(", ")}.${P?" Gemini free limit hit mid-scan; the scanner will wait out short limits and retry.":""}${A?` Last issue: ${A.reason}.`:""} Press "Continue with ALL" to save & publish everything at once.`,b||c?"info":"success")};window.saveProduct=async function(e,a,t){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=t?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const l=document.createElement("style");l.id="_pubspin-style",l.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(l)}}catch{}const r=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=o)};try{const l=new FormData(i),d={};let c=0;for(const[h,v]of l.entries())if(h==="images"){d.images=d.images||[];const _=String(v);v&&!_.startsWith("blob:")?d.images.push(_):_.startsWith("blob:")&&c++}else h==="tags"?(d.tags=d.tags||[],d.tags.push(v)):d[h]=v;if(c&&!(d.images||[]).length){r(),p("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}d.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",d.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const u=l.get("action")==="draft",g=h=>St(h),y=h=>{const v=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],_={};for(const k of v){const f=h[k];if(k==="real_price"){const $=f!=null&&String(f).trim()!==""?parseFloat(f):null;_[k]=$!=null&&Number.isFinite($)&&$>0?Math.round($):null;continue}_[k]=f!=null&&String(f).trim()!==""?f:null}if(h.safety_features){const k=g(h.safety_features);_.safety_features=k.length?k:null}return _};if(t){let h=null;try{const{data:w}=await m.from("showroom_listings").select("*").eq("property_id",t).maybeSingle();w&&(h=me(w))}catch{}if(h||(h=me((window._productsData||[]).find(w=>w.property_id===t))),h||(h=me(Ne?Ne(t):null)),!h)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const v=(w,D)=>{const R=w===""||w==null?"":w,re=D===""||D==null?"":D;return String(R).trim()===String(re).trim()},_={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(w=>{v(d[w],h[w])||(_[w]=d[w]==null||d[w]===""?null:d[w])});const k=d.price===""||d.price==null?null:parseFloat(d.price);v(k,h.price)||(_.price=k==null?h.price:Math.max(H,Math.min(X,k)));const f=d.stock_quantity===""||d.stock_quantity==null?null:parseInt(d.stock_quantity,10);v(f,h.stock_quantity)||(_.stock_quantity=Number.isFinite(f)?f:null);const $=g(d.features_text);v($.join("||"),(Array.isArray(h.features)?h.features:[]).join("||"))||(_.features=$);const x=d.tags||[];v(x.join("||"),(Array.isArray(h.tags)?h.tags:[]).join("||"))||(_.tags=x);const P=g(d.highlights_text);v(P.join("||"),(Array.isArray(h.highlights)?h.highlights:[]).join("||"))||(_.highlights=P);const A=g(d.seo_keywords_text);v(A.join("||"),(Array.isArray(h.seo_keywords)?h.seo_keywords:[]).join("||"))||(_.seo_keywords=A);const j=d.images||[];v(j.join("||"),(Array.isArray(h.images)?h.images:[]).join("||"))||(_.images=j);const S=d.is_featured==="on";!!h.is_featured!==S&&(_.is_featured=S);const E=u?!1:d.is_active==="on";!!h.is_active!==E&&(_.is_active=E);const M=y(d),te={...h.specifications&&typeof h.specifications=="object"?h.specifications:{},...M};if(JSON.stringify(te)!==JSON.stringify(h.specifications||{})&&(_.specifications=te),Object.keys(_).length===0){p("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(De(a,t))}catch{}p("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),O();return}const I={...h,..._,property_id:t,updated_at:new Date().toISOString()};delete I.id;const U=await Ye(I);if(U.error){r();const w=ht(U.error,u?"Draft save":"Product publish");p(w,"error");try{let D=i.querySelector(".__publish-error-banner");D||(D=document.createElement("div"),D.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(D)),D.textContent=w}catch{}return}try{xt(I)}catch{}try{const w=(window._productsData||[]).findIndex(D=>D.property_id===t);w>=0&&(window._productsData[w]=I)}catch{}p(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(_).length} change${Object.keys(_).length>1?"s":""}).`)}else{if(!d.title||!d.title.trim())throw new Error("A product title is required.");if(d.price===""||d.price==null||!isFinite(parseFloat(d.price)))throw new Error("A price is required.");if(i.querySelector('[name="condition"]')&&!d.condition)throw new Error("Please choose the product condition.");const h={listing_type:"product",category:a,subcategory:d.subcategory||null,title:d.title.trim(),description:d.description||"",price:Math.max(H,Math.min(X,parseFloat(d.price)||0)),currency:d.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:d.is_active==="on",is_featured:d.is_featured==="on",brand:d.brand||null,color:d.color||null,size:d.size||null,condition:d.condition||null,warranty:d.warranty||null,availability_status:d.availability_status||"In Stock",stock_quantity:d.stock_quantity?parseInt(d.stock_quantity):null,images:d.images||[],features:g(d.features_text).length?g(d.features_text):d.tags||[],tags:d.tags||[],highlights:g(d.highlights_text),seo_keywords:g(d.seo_keywords_text),is_ai_generated:!!d.catalog_template_id,ai_generated_fields:d.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:y(d)},v=ot();h.property_id=v;const _=await Ye(h);if(_.error){r();const k=ht(_.error,"Product publish");p(k,"error");try{let f=i.querySelector(".__publish-error-banner");f||(f=document.createElement("div"),f.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(f)),f.textContent=k}catch{}return}try{xt({...h,property_id:h.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...h})}catch{}p(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}r();try{localStorage.removeItem(De(a,t))}catch{}const b=Re;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(b)){O();return}O()}catch(l){const d=l&&l.message&&!/failed to fetch|networkerror/i.test(String(l.message))?l.message:ht(l,"Product publish");r(),p(d,"error")}};window.editProduct=async function(e){const{data:a,error:t}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=t?null:a;if(i||(i=Ne(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,a){let t=null;try{const{data:n}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(t=me(n))}catch{}if(t||(t=me((window._productsData||[]).find(n=>n.property_id===e))),!t||!t.property_id){vt(e,{is_active:a,availability_status:a?"In Stock":"Out of Stock"}),p(a?"Product published locally":"Product unpublished locally","info"),O();return}delete t.id,t.property_id=e,t.is_active=a,t.availability_status=a?"In Stock":"Out of Stock";const{error:i}=await m.from("showroom_listings").upsert(t,{onConflict:"property_id"});if(i){if(J(i))return p(`âšï¸ ${a?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");vt(e,{is_active:a,availability_status:a?"In Stock":"Out of Stock"}),p(a?"Product published locally":"Product unpublished locally","info"),O();return}p(a?"Product published":"Product unpublished"),O()};window.duplicateProduct=async function(e,a=!1){const{data:t}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!t)return;const{id:i,property_id:n,created_at:o,updated_at:r,...l}=t,d=ot();await m.from("showroom_listings").insert({...l,property_id:d,title:t.title+" (Copy)",is_active:!1}),a||(p("Product duplicated"),O())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await m.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),O())};const Tt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function dt(){const e=document.getElementById("content");try{const{data:a,error:t}=await m.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=t?tt().filter(o=>o.listing_type==="property"):a||[];if(Array.isArray(ie)){const o=new Set(i.map(l=>l.property_id)),r=ie.filter(l=>l.listing_type==="property"&&l.property_id&&!o.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await Dt()}catch{}const n=new Set(at());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(o=>`<tr>
                    ...
                    <td>${ee(o.listing_status||"sale")} ${ee(o.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const a=!!e.property_id,t=ka("property","Real Estate"),i=e.country_code||"US",n=e.currency||Rt(i);W(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),Ht(),Gt(),Pt("ppf-price"),window._propFormDirty=!!a;const o=document.getElementById("property-form");if(o){const r=()=>{window._propFormDirty=!0};o.addEventListener("input",r),o.addEventListener("change",r)}window.syncPropertyCountry=function(){oa("ppf")},oa("ppf"),It("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>It("pricing")),Lo()};let ae=null,Ve=null,ca=null;function Co(){const e=document.querySelector("#property-form");if(!e)return"";const a=t=>(e.querySelector(`[name="${t}"]`)?.value||"").trim();return[a("product_location"),a("town"),a("city"),a("state"),a("country")].filter(Boolean).join(", ")}function de(e,a){const t=document.getElementById("property-map-status");t&&(t.textContent=e,t.style.color=a?"#dc2626":"")}function Me(e,a,{reverse:t=!1}={}){if(!ae||!Number.isFinite(e)||!Number.isFinite(a))return;const i=[e,a];Ve?Ve.setLatLng(i):Ve=L.marker(i,{draggable:!0}).addTo(ae),ae.setView(i,Math.max(ae.getZoom(),13));const n=document.querySelector('#property-form [name="latitude"]'),o=document.querySelector('#property-form [name="longitude"]');n&&(n.value=String(Number(e.toFixed(6)))),o&&(o.value=String(Number(a.toFixed(6)))),t&&To(e,a);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${a.toFixed(6)}`)}async function Be(){const e=Co();if(!e){de("Enter a location (address, area, city, state, country), then press Locate from fields.");return}de("Searching locationâ€¦");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Me(parseFloat(a[0].lat),parseFloat(a[0].lon)),de("Located: "+a[0].display_name)):de("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{de("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function To(e,a){const t=document.querySelector("#property-form");if(t)try{const i=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${a}&zoom=16`)).json(),n=i&&i.address||{},o=(y,b)=>{if(!b)return;const h=t.querySelector(`[name="${y}"]`);return h&&!String(h.value||"").trim()?(h.value=b,!0):!1},r=[n.road||"",n.house_number||""].filter(Boolean).join(" "),l=n.suburb||n.neighbourhood||n.quarter||n.district||n.borough||"",d=n.town||n.village||n.municipality||n.city_district||"",c=n.city||n.county||"",u=n.state||n.region||"",g=n.country||"";if(o("product_location",r||l||d),o("town",l||d),o("city",c),o("state",u),g){o("country",g);const y=t.querySelector('[name="country_code"]');if(y){const b=(Ee||[]).find(h=>String(h.name||"").toLowerCase()===String(g).toLowerCase());b&&b.code&&!y.value&&(y.value=b.code)}}de("Pin set at "+e.toFixed(5)+", "+a.toFixed(5)+(i.display_name?" â€” "+i.display_name:""))}catch{de("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!ae)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(a)&&(e||a)?(Me(e,a),de("Map updated from coordinates.")):Be()};function Lo(){const e=document.getElementById("property-map-preview");if(!e||!window.L){de("Map unavailable right now â€” your location fields still save normally.");return}ae&&(ae.remove(),ae=null,Ve=null);const a=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(a)&&Number.isFinite(t)&&(a||t);ae=L.map(e,{scrollWheelZoom:!1}).setView(i?[a,t]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(ae),ae.on("click",n=>Me(n.latlng.lat,n.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Be),["product_location","town","city","state","country","latitude","longitude"].forEach(n=>{const o=document.querySelector(`#property-form [name="${n}"]`);o&&(o.addEventListener("input",()=>{if(n==="latitude"||n==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(l)&&(r||l)&&Me(r,l);return}clearTimeout(ca),ca=setTimeout(Be,900)}),o.addEventListener("change",()=>{n!=="latitude"&&n!=="longitude"&&Be()}))}),i?Me(a,t):Be()}window.fixPropertyMaps=async function(){const e=(window._propertiesData||[]).filter(i=>{const n=parseFloat(i.latitude),o=parseFloat(i.longitude),r=[i.product_location,i.town,i.city,i.state,i.country].filter(Boolean).join(", ");return!(Number.isFinite(n)&&Number.isFinite(o)&&(n!==0||o!==0))&&!!r});if(!e.length){p("All properties already have map coordinates.","success");return}p(`Fixing maps for ${e.length} propert${e.length>1?"ies":"y"}â€¦`,"success");let a=0,t=0;for(const i of e){const n=[i.product_location,i.town,i.city,i.state,i.country].filter(Boolean).join(", ");try{const o=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(n))).json();if(o&&o[0]){const r={latitude:parseFloat(o[0].lat),longitude:parseFloat(o[0].lon)},{error:l}=await m.from("showroom_listings").update(r).eq("property_id",i.property_id);l?t++:(Object.assign(i,r),a++)}else t++}catch{t++}await new Promise(o=>setTimeout(o,1100))}p(`Map fix done: ${a} updated, ${t} failed.`,t?"error":"success"),dt()};window.saveProperty=async function(e,a){e.preventDefault();const t=new FormData(e.target),i=Object.fromEntries(t.entries()),n=t.getAll("images").filter(y=>y&&!y.startsWith("blob:")),o=(i.features_text||"").split(",").map(y=>y.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(H,Math.min(X,parseFloat(i.real_price)||0)),l=y=>(y||"").split(",").map(b=>b.trim()).filter(Boolean),d=y=>y===""||y==null||!isFinite(parseInt(y,10))?null:parseInt(y,10),c=l(i.floor_plan_rooms).map(y=>{const b=String(y).match(/^(.*?):\s*(.*)$/);return b?{name:b[1].trim(),dimensions:b[2].trim()}:{name:y,dimensions:""}}),u={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(H,Math.min(X,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:d(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:d(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:d(i.year_built),year_renovated:d(i.year_renovated),landmarks:l(i.landmarks_text),interior_features:l(i.interior_features_text),exterior_features:l(i.exterior_features_text),home_systems:l(i.home_systems_text),legal_info:l(i.legal_info_text).map(y=>{const b=String(y).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return b?{label:b[1].trim(),value:b[2].trim(),source:b[3]}:{label:y,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:c,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:l(i.nearby_schools_text),hospitals:l(i.nearby_hospitals_text),shopping:l(i.nearby_shopping_text),transportation:l(i.nearby_transportation_text),distances:l(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:l(i.documents_text),features:o,images:n,highlights:St(i.highlights_text),seo_keywords:St(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let g;if(a){u.property_id=a;const y=me((window._propertiesData||[]).find(b=>b.property_id===a)||(window._productsData||[]).find(b=>b.property_id===a));u.specifications={...y.specifications&&typeof y.specifications=="object"?y.specifications:{},real_price:r},{error:g}=await m.from("showroom_listings").upsert({...y,...u},{onConflict:"property_id"})}else u.property_id=ot(),u.specifications={real_price:r},{error:g}=await m.from("showroom_listings").insert(u);g&&lo(g,()=>xt({...u,property_id:a||u.property_id}),a?"Property update":"Property publish")||(p(a?"Property updated!":"Property published!"),ce(),dt())};window.editProperty=async function(e){const{data:a,error:t}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=t?null:a;i||(i=Ne(e)),i||(i=(Array.isArray(ie)?ie.find(n=>n.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Bo=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Qa(){const e=document.getElementById("content");try{const{data:a}=await m.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),t=a||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let n="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${t.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':t.map(o=>Mo(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=t,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}function Mo(e){return`<tr class="order-row" data-status="${e.status}" data-search="${s(e.order_number)} ${s(e.full_name)} ${s(e.email)}">
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Bo.map(t=>`<option value="${t}" ${a.status===t?"selected":""}>${t.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const a=document.getElementById("order-status-select")?.value;if(!a)return;const{error:t}=await m.from("payment_receipts").update({status:a}).eq("id",e);if(t){p(t.message,"error");return}p("Order status updated"),ce(),Qa()};async function No(){const e=document.getElementById("content");try{const{data:a}=await m.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),t=a||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      <div class="modal-box">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${oe(a.created_at)} Â· ${s(a.country_code||"Unknown country")}</p>
          </div>
        </div>
    ...
    </div>`)};async function Oe(){const e=document.getElementById("content");try{const{data:a}=await m.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),t=a||[],i=t.filter(l=>!l.is_approved).length,{data:n}=await m.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),o=n||[],r=o.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${t.length===0?ve("star","No Reviews","Customer reviews will appear here."):t.map(l=>Ro(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${o.length===0?ve("message-square","No Feedback Yet","Site feedback will appear here."):o.map(l=>Do(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}function Do(e){const a=Array.from({length:5},(t,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:a}=await m.from("site_feedback").update({is_approved:!0}).eq("id",e);a?p(a.message,"error"):p("Feedback approved â€” it now shows on every page."),Oe()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:a}=await m.from("site_feedback").delete().eq("id",e);a?p(a.message,"error"):p("Feedback deleted."),Oe()};function Ro(e){const a=Array.from({length:5},(t,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const a=new FormData(e.target),t=Object.fromEntries(a.entries()),i={code:t.code.toUpperCase(),discount_type:t.discount_type,discount_value:parseFloat(t.discount_value),min_amount:t.min_amount?parseFloat(t.min_amount):null,usage_limit:t.usage_limit?parseInt(t.usage_limit):null,expires_at:t.expires_at||null,is_active:!0},{error:n}=await m.from("coupons").insert(i);if(n){p(n.message,"error");return}p("Coupon created!"),ce(),ct()};window.toggleCoupon=async function(e,a){await m.from("coupons").update({is_active:a}).eq("id",e),p(a?"Coupon activated":"Coupon deactivated"),ct()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await m.from("coupons").delete().eq("id",e),p("Coupon deleted"),ct())};async function Fo(){const e=document.getElementById("content");try{const{data:a}=await m.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),t=a||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}const Za=["Featured","Sponsored","Featured Collection","Discover","Promotion"],jo=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let ze=null;function qo(e){const a={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${a[e]||a.Featured}">${s(e)}</span>`}function Uo(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${s(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${s(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${s(e.link_target||"")}</span>`}function Oo(e){return e.video_url?`<video src="${s(e.video_url)}" ${e.poster_url?`poster="${s(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${s(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function ei(){if(ze)return ze;const e=[],a=new Set,t=[],i=n=>{if(!n||!n.property_id)return;e.push({id:n.property_id,title:n.title||n.property_id});const o=n.category||"";o&&!a.has(o)&&(a.add(o),t.push(o))};try{ie.forEach(i)}catch{}try{const{data:n,error:o}=await m.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!o&&n&&n.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(n=>{a.has(n)||(a.add(n),t.push(n))}),ze={products:e,categories:t,sections:jo},ze}async function Ho(e){try{const{data:{session:a}}=await m.auth.getSession();if(!a)return p("Sign in to upload media","error"),null;const t=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(t)||e.type.startsWith("video/"),n=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${t}`,{error:o}=await m.storage.from("advertisements").upload(n,e,{contentType:e.type,upsert:!1});if(o)return p("Upload failed: "+o.message,"error"),null;const{data:r}=m.storage.from("advertisements").getPublicUrl(n);return{url:r.publicUrl,isVideo:i}}catch{return p("Upload failed","error"),null}}function Xe(e,a){const t=document.getElementById("ad-media-preview");if(!t)return;const i=document.getElementById("ad-hidden-video"),n=document.getElementById("ad-hidden-image");i&&(i.value=a?e:""),n&&(n.value=a?"":e),t.innerHTML=a?`<video src="${s(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${s(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const a=e.files&&e.files[0];if(!a)return;if(!(a.type.startsWith("image/")||a.type.startsWith("video/"))){p("Choose an image or video file","error");return}const t=await Ho(a);if(!t){e.value="";return}Xe(t.url,t.isVideo);const i=document.getElementById("ad-media-url");i&&(i.value=t.url)};window.onAdMediaUrl=function(e){const a=(e.value||"").trim();if(!a)return;const t=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(a);Xe(a,t)};function Qt(e,a,t){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!a||a==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let n="";a==="product"?n='<option value="">Select a productâ€¦</option>'+e.products.map(o=>`<option value="${s(o.id)}" ${String(t)===String(o.id)?"selected":""}>${s(o.id)} â€” ${s((o.title||"").slice(0,60))}</option>`).join(""):a==="category"?n='<option value="">Select a categoryâ€¦</option>'+e.categories.map(o=>`<option value="${s(o)}" ${t===o?"selected":""}>${s(o)}</option>`).join(""):a==="section"&&(n='<option value="">Select a sectionâ€¦</option>'+e.sections.map(o=>`<option value="${s(o.id)}" ${t===o.id?"selected":""}>${s(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${n}</select>`}function ti(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
      ...
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.renderAds=Ce;const ut=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],se={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function ai(){const e=document.getElementById("content");try{let a=function(o){const r=n===o.id,l=i[o.kf],d=i[o.mf]||o.dm;return`
        ...
        </div>`};const{data:t}=await m.from("ai_settings").select("*").limit(1).maybeSingle(),i=t||{},n=i.active_provider||"gemini";e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.highlightAI=function(e){ut.forEach(a=>{const t=document.getElementById("apc-"+a.id);if(!t)return;const i=a.id===e;t.className=`glass-soft border ${i?se.border[a.color]+" "+se.bg[a.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const n=t.querySelector("input[type=radio] + span");n&&(n.className=`text-[9px] font-bold ${i?se.text[a.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const a=new FormData(e.target),t=Object.fromEntries(a.entries()),i={active_provider:t.active_provider||"gemini",product_ai_enabled:t.product_ai_enabled==="on",ai_code_assist:t.ai_code_assist==="on",ai_moderation:t.ai_moderation==="on"};ut.forEach(o=>{t[o.mf]&&(i[o.mf]=t[o.mf]);const r=(t[o.kf]||"").trim();r&&!r.startsWith("â€¢â€¢â€¢â€¢")&&r!==""&&(i[o.kf]=r)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key),t.groq_vision_model&&(i.groq_vision_model=t.groq_vision_model);const n=(t.groq_key||"").trim();n&&!/^[•\u2022]{4}/.test(n)&&(i.groq_key=n);try{const{data:o}=await m.from("ai_settings").select("id").limit(1).maybeSingle();let r;if(o?.id?{error:r}=await m.from("ai_settings").update(i).eq("id",o.id):{error:r}=await m.from("ai_settings").insert(i),r){p("Save failed: "+r.message,"error"),console.error("[AI Save]",r);return}await q.reload(),p("âœ… AI settings saved!","success"),setTimeout(()=>ai(),600)}catch(o){p("Unexpected error: "+o.message,"error"),console.error("[AI Save]",o)}};const q={_cfg:null,async reload(){const{data:e,error:a}=await m.from("ai_settings").select("*").limit(1).maybeSingle();if(a){console.warn("[aiClient] Could not load settings:",a.message),this._cfg={};return}const t=e||{};!t.gemini_key&&t.gemini_api_key&&(t.gemini_key=t.gemini_api_key),this._cfg=t},async getConfig(){return this._cfg||await this.reload(),this._cfg},async freeChat(e,{maxTokens:a=2e3,timeoutMs:t=6e4}={}){const i=await fetch("https://text.pollinations.ai/openai",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"openai",messages:e.map(r=>({role:r.role==="assistant"?"assistant":r.role==="system"?"system":"user",content:String(r.content||"").slice(0,12e3)})),max_tokens:a}),signal:AbortSignal.timeout(t)});if(!i.ok)throw new Error(`Free AI provider error (${i.status}).`);const n=await i.json(),o=String(n?.choices?.[0]?.message?.content||"").trim();if(!o)throw new Error("Free AI provider returned an empty reply.");return{text:o,provider:"Free AI (Pollinations)",model:String(n?.model||"openai-fast")}},async chat(e,{maxTokens:a=2e3}={}){const t=await this.getConfig();if(!String(t.gemini_key||"").trim())return this.freeChat(e,{maxTokens:a});const i=e[e.length-1],n={action:"chat",message:String(i?.content||"").trim(),history:e.slice(0,-1).map(o=>({role:o.role,content:String(o.content||"")})),provider_override:"gemini",max_tokens:a};try{const o=await this._callEdge(n);if(o&&o.response)return{text:o.response,provider:"Google Gemini",model:o.model||t.gemini_model};throw new Error(String(o?.error||"Gemini is unavailable."))}catch(o){try{const r=await this.freeChat(e,{maxTokens:a});return r.note="gemini-unavailable",r}catch{throw o}}},async prompt(e,a={}){return this.chat([{role:"user",content:e}],a)},async getStatus(){const e=await this.getConfig();return ut.map(a=>({id:a.id,name:a.name,color:a.color,hasKey:!!e[a.kf]?.trim(),isActive:e.active_provider===a.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,a={}){const t=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is â€” the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
- Respond with valid JSON only.`,i=(await Promise.all((e||[]).slice(0,a.maxImages||3).map(n=>this._fetchImageAsDataUrl(n,768)))).filter(Boolean);if(!i.length)throw new Error("Could not read the uploaded images.");try{const n=await this._callEdge({action:"vision",images:i,prompt:t,max_tokens:4096});if(n&&n.success&&n.text){const o=ua(n.text);if(o)return n.provider&&this._noteProvider(n.provider),{...o,_aiProvider:n.provider==="groq"?"Groq vision (backup)":"Gemini vision",_aiModel:n.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(n&&n.error||"Vision service unavailable.")}catch(n){this._noteIssue("identify",`server vision: ${n&&n.message||n}`)}return null},async _runVisionPrompt(e,a,{maxImages:t=5,maxTokens:i=4096,mergeResults:n=null,onProgress:o=()=>{},stageLabel:r="vision"}={}){const l=Math.max(1,Number(t)||5),d=await this._collectScanImages(a,{onProgress:o});if(!d.length)throw new Error("Could not read the uploaded images.");const c=async g=>this._runSingleVisionCall(e,g,{maxTokens:i,stageLabel:r});let u;if(d.length<=l)u=await c(d);else{const g=[];for(let k=0;k<d.length;k+=l)g.push(d.slice(k,k+l));o(0,g.length);const y=3,b=new Array(g.length).fill(null);let h=0;const v=async()=>{for(;h<g.length;){const k=h++;b[k]=await c(g[k]).catch(()=>null),o(Math.min(h,g.length),g.length)}};await Promise.all(Array.from({length:Math.min(y,g.length)},v));const _=[];if(b.forEach((k,f)=>{k&&_.push({result:k,startIndex:f*l})}),!_.length)return null;u=n?n(_,{batchSize:l,totalImages:d.length}):_.reduce((k,f)=>this._mergeJsonResults(k,f.result),null)}return u||null},async _runSingleVisionCall(e,a,{maxTokens:t=4096,stageLabel:i="vision"}={}){if(!await this._waitForQuotaWindow(7e4,i))return null;try{const n=await this._paceGeminiCall(()=>this._callEdge({action:"vision",images:a,prompt:e,max_tokens:t},45e3));if(n&&n.success&&n.text){const o=ua(n.text);if(o)return n.provider&&this._noteProvider(n.provider),{...o,_aiProvider:n.provider==="groq"?"Groq vision (backup)":"Gemini vision",_aiModel:n.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(n&&n.error||"Vision service unavailable.")}catch(n){this._noteIssue(i,`vision: ${n&&n.message||n}`)}return null},_pdfPageCache:new Map,async _collectScanImages(e,{onProgress:a=()=>{}}={}){const t=(Array.isArray(e)?e:[e]).map(o=>String(o||"")).filter(Boolean);if(!t.length)return[];const i=await Promise.all(t.map(async o=>{try{if(/^data:application\/pdf/.test(o)||it(o)){let l=this._pdfPageCache.get(o)||null;return l||(l=await Ri(o,{maxDim:1300}).catch(()=>[]),l.length&&this._pdfPageCache.set(o,l)),l}const r=await this._fetchImageAsDataUrl(o,1024);return r?[r]:[]}catch{return[]}})),n=[];for(const o of i)n.push(...o);return n},_mergeJsonResults(e,a){if(!e)return a?{...a}:null;if(!a)return e;const t={...e};for(const[i,n]of Object.entries(a))if(!i.startsWith("_")&&!(n==null||typeof n=="string"&&!n.trim())){if(!(i in t)||t[i]==null||t[i]===""){t[i]=n;continue}if(Array.isArray(t[i])||Array.isArray(n)){const o=[...Array.isArray(t[i])?t[i]:[t[i]],...Array.isArray(n)?n:[n]].map(r=>typeof r=="string"?r.trim():r).filter(r=>r!=null&&r!=="");t[i]=[...new Set(o)]}else typeof t[i]=="object"&&typeof n=="object"?t[i]={...t[i],...n}:(String(t[i]).trim(),String(n).trim())}return t},async identifyProduct(e,a={}){const t=`STAGE 1 â€” IDENTIFY THE EXACT PRODUCT.
...
}`;return this._runVisionPrompt(n,e,{maxImages:t.maxImages||5,stageLabel:"specs"})},async estimateProductPrice(e,a,t={},i={}){const n=a||{},o=t||{},r=`STAGE 3 â€” ESTIMATE THE REAL MARKET PRICE AND A PROMOTIONAL DISCOUNT PRICE.
...
}`;return this._runVisionPrompt(r,e,{maxImages:i.maxImages||5,stageLabel:"price"})},async completeSpecsAndPrice(e,a,t={}){const i=a||{},n=`STAGES 2+3 â€” COMPLETE THE SPECIFICATIONS AND ESTIMATE THE PRICE IN ONE STEP.
...
{ "corrections": { "<key>": <corrected or newly found value â€” exact JSON type for that field> }, "still_missing": ["key"], "wrong_mapping": [["from_key","to_key"]], "notes": ["short factual observations, e.g. 'VIN appears on page 2 footer'"] }`;try{return await this._runVisionPrompt(d,e,{maxImages:n.maxImages||5,maxTokens:2500,stageLabel:"verify",mergeResults:c=>{const u={corrections:{},still_missing:[],wrong_mapping:[],notes:[]};for(const{result:g}of c){const y=g||{};y.corrections&&typeof y.corrections=="object"&&Object.assign(u.corrections,y.corrections);for(const b of Array.isArray(y.still_missing)?y.still_missing:[]){const h=String(b);h&&!u.still_missing.includes(h)&&u.still_missing.push(h)}for(const b of Array.isArray(y.wrong_mapping)?y.wrong_mapping:[])Array.isArray(b)&&b.length>=2&&!u.wrong_mapping.some(h=>h[0]===b[0]&&h[1]===b[1])&&u.wrong_mapping.push([String(b[0]),String(b[1])]);for(const b of Array.isArray(y.notes)?y.notes:[]){const h=String(b||"").trim();h&&!u.notes.includes(h)&&u.notes.push(h)}}return u}})}catch{return null}},async _callEdge(e,a=6e4){let t="";try{t=(await m.auth.getSession())?.data?.session?.access_token||""}catch{}return await(await fetch(ji,{method:"POST",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}},body:JSON.stringify(e),signal:AbortSignal.timeout(a)})).json().catch(()=>({}))},_imageCache:new Map,async _fetchImageAsDataUrl(e,a=768){const t=String(e);if(this._imageCache.has(t))return this._imageCache.get(t);const i=(async()=>{try{const o=await fetch(e,{signal:AbortSignal.timeout(15e3)}).then(r=>r.blob());return!o||!o.size?null:o.size<15e4?`data:${o.type||"image/jpeg"};base64,${await Go(o)}`:await this._downscaleImage(o,a)}catch{return null}})();this._imageCache.set(t,i);const n=await i;return n||this._imageCache.delete(t),n},async _downscaleImage(e,a){const t=URL.createObjectURL(e);try{const i=new Image;await new Promise((d,c)=>{i.onload=d,i.onerror=c,i.src=t});const n=Math.min(1,a/Math.max(i.width,i.height)),o=Math.max(1,Math.round(i.width*n)),r=Math.max(1,Math.round(i.height*n)),l=document.createElement("canvas");return l.width=o,l.height=r,l.getContext("2d").drawImage(i,0,0,o,r),l.toDataURL("image/jpeg",.72)}finally{URL.revokeObjectURL(t)}},_visionIssues:[],_providerCounts:{},beginScanSession(){this._visionIssues=[],this._providerCounts={},this._lastGoodModel=""},_noteProvider(e){const a=String(e||"").toLowerCase().includes("groq")?"groq":"gemini";this._providerCounts[a]=(this._providerCounts[a]||0)+1,a==="groq"&&this._noteIssue("vision","Gemini did not answer — Groq vision backup handled this request")},_noteIssue(e,a){const t=String(a||"").slice(0,220);if(!t)return;const i=this._visionIssues||(this._visionIssues=[]),n=i[i.length-1];if(n&&n.stage===e&&n.reason===t){n.count=(n.count||1)+1;return}i.push({stage:e,reason:t,count:1})},sessionReport(){return{providers:Object.entries(this._providerCounts||{}).map(([e,a])=>({name:e,count:a})),issues:(this._visionIssues||[]).slice(),lastGoodModel:this._lastGoodModel||""}},async _waitForQuotaWindow(e=7e4,a="vision"){const t=(this._geminiQuotaUntil||0)-Date.now();return t<=0?!0:t>e?(this._noteIssue(a,`quota cooldown ${Math.round(t/1e3)}s > ${Math.round(e/1e3)}s budget — completed without photo reading`),!1):(await new Promise(i=>setTimeout(i,t+300)),!0)},async preflight(){const e={gemini:null,groq:null,error:null};try{const a=await this._callEdge({action:"test_providers"},25e3);a&&a.providers?(e.gemini=a.providers.gemini||null,e.groq=a.providers.groq||null):e.error=a&&a.error||"Unexpected response from the AI service."}catch(a){e.error=String(a&&a.message||a)}return e},_geminiCallChain:Promise.resolve(),_lastGeminiCallAt:0,_paceGeminiCall(e){const a=this._geminiCallChain.then(async()=>{const t=(this._lastGeminiCallAt||0)+6e3-Date.now();return t>0&&await new Promise(i=>setTimeout(i,t)),this._lastGeminiCallAt=Date.now(),e()});return this._geminiCallChain=a.then(()=>{},()=>{}),a}};function Go(e){return new Promise(a=>{const t=new FileReader;t.onload=()=>{const i=t.result;if(typeof i=="string"){const n=i.indexOf(",");a(n>=0?i.slice(n+1):i)}else a("")},t.onerror=()=>a(""),t.readAsDataURL(e)})}window.aiClient=q;window.showAiStatusModal=async function(){const e=await q.getStatus(),a=e.filter(t=>t.hasKey);W(`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const a=document.getElementById("ai-test-output");a.classList.remove("hidden"),a.textContent="⏳ Asking Gemini…";try{const t=await q.prompt(e);a.textContent=`✓ [${t.provider} · ${t.model}]

${t.text}`}catch(t){a.textContent=`✖ ${t.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),a=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),a.disabled=!0;const t=(n,o,r,l)=>`
    ...
    </div>`;e.innerHTML='<p class="text-[11px] text-gray-400">Testing providers…</p>';let i="";try{const n=await q.preflight(),o=n.gemini||{};i+=o.ok?t("✓","bg-emerald-400","Gemini (Product Scanner — primary)",`Working${o.model?" · "+o.model:""}`):t("✖","bg-red-500","Gemini (Product Scanner — primary)",o.error||n.error||"Not working");const r=n.groq||{};i+=r.ok?t("✓","bg-emerald-400","Groq (Product Scanner — backup)",`Working · ${r.model||"vision model found"}`):r.configured?t("✖","bg-red-500","Groq (Product Scanner — backup)",r.error||"Key saved but not usable"):t("—","bg-yellow-400","Groq (Product Scanner — backup)","Optional backup not configured (no key)")}catch(n){i+=t("✖","bg-red-500","Cloud providers (server test)",String(n&&n.message||n))}i+=t("✓","bg-purple-400","General AI Scanner (via edge function)","Uses Gemini primary + Groq backup through server — no local install needed."),e.innerHTML=i,a.disabled=!1,window.lucide&&lucide.createIcons()};function ua(e){if(!e)return null;let a=String(e).trim();const t=a.match(/```(?:json)?\s*([\s\S]*?)```/i);t&&(a=t[1].trim());const i=a.indexOf("{"),n=a.lastIndexOf("}");if(i===-1||n===-1||n<=i)return null;const o=a.slice(i,n+1);try{return JSON.parse(o)}catch{return null}}async function zo(){const e=document.getElementById("content");try{const[{data:a},t]=await Promise.all([m.from("site_settings").select("*").limit(1).maybeSingle(),Vo()]),i=a||{},n=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),o=t.length?`
        <div class="mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-1.5 max-h-72 overflow-y-auto pr-1" id="promo-picker-list">
            ${t.map(r=>{const l=r.property_id||r.id,d=n.has(l)?"checked":"";return`<label class="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-xl px-3 py-2 cursor-pointer hover:border-blue-400/40 transition" data-promo-search="${s((r.title||r.name||"")+" "+(r.category||""))}">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const a=document.getElementById("val-"+e),t=document.getElementById("url-"+e);a&&(a.value=""),t&&(t.value=""),p("Cleared. Save to apply.","info"),ni()};window.handleContentMediaUpload=async function(e,a){const t=e.target.files?.[0];if(t){t.type.startsWith("video/"),p(`Uploading ${t.name}â€¦`,"info");try{const{data:{session:i}}=await m.auth.getSession();if(!i){p("Sign in to upload media","error");return}const n=(t.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),o=`content/${a}-${Date.now()}.${n}`,{error:r}=await m.storage.from("product-images").upload(o,t,{contentType:t.type,upsert:!1});if(r){p("Upload failed: "+r.message,"error");return}const{data:l}=m.storage.from("product-images").getPublicUrl(o),d=l.publicUrl,c=document.getElementById("val-"+a),u=document.getElementById("url-"+a);c&&(c.value=d),u&&(u.value=d);const g=document.getElementById("slot-"+a);if(g){const y=Xt.flatMap(b=>b.fields||[]).find(b=>b.key===a);y&&(g.outerHTML=ii(y,d))}p("âœ“ Uploaded â€” save to apply","success")}catch{p("Upload failed","error")}}};const Wo=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function ne(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function He(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(ne()))}function $e(){He();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=oi(ne()),window.lucide&&lucide.createIcons())}function Yo(e,a){const t=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),n=t&&pa(t)||i&&pa(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}function oi(e){return(e||[]).map((a,t)=>{const i=String(a&&a.buttonText||"SHOP NOW"),n=Wo.map(o=>`<button type="button" onclick="heroVideoPreset(${t},'${o}')" class="px-2.5 py-1 rounded-full text-[9px] font-black ${i===o?"bg-indigo-600 text-white":"bg-white/5 text-gray-400"} border ${i===o?"border-indigo-500":"border-white/10"} transition">${o}</button>`).join("");return`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,a){const t=document.createElement("input");t.type="file",t.accept=a==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",t.onchange=()=>{const i=t.files&&t.files[0];i&&Jo(e,a,i)},t.click()};window.heroVideoField=function(e,a,t){const i=ne();i[e]&&(i[e][a]=t,He())};window.heroVideoPreset=function(e,a){const t=ne();t[e]&&(t[e].buttonText=a,$e())};window.heroVideoToggle=function(e){const a=ne();a[e]&&(a[e].enabled=a[e].enabled===!1,$e())};window.heroVideoMove=function(e,a){const t=ne(),i=e+a;i<0||i>=t.length||([t[e],t[i]]=[t[i],t[e]],$e())};window.heroVideoDelete=function(e){const a=ne();e<0||e>=a.length||confirm("Delete this hero video slide?")&&(a.splice(e,1),$e())};window.heroVideoRemoveMedia=function(e,a){const t=ne();t[e]&&(a==="video"?t[e].video="":a==="poster"&&(t[e].poster=""),$e())};window.addHeroVideoSlide=function(){ne().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),$e(),p("New slide added â€” upload a video and press Save to show it.","info")};async function Ko(e,a){try{const{data:{session:t}}=await m.auth.getSession();if(!t)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(a==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${a}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:o}=await m.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(o)return{url:URL.createObjectURL(e),persisted:!1,error:o.message};const{data:r}=m.storage.from("product-images").getPublicUrl(n),l=r&&r.publicUrl;return l?{url:l,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(t){return{url:URL.createObjectURL(e),persisted:!1,error:String(t&&t.message||t)}}}function pa(e){return/^blob:/i.test(String(e||""))}async function Jo(e,a,t){const i=ne();if(!t||!i[e])return;if(a==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(t.type+" "+t.name)){p("Please choose an MP4 or WebM video file.","error");return}}else if(!t.type.startsWith("image/")){p("Please choose an image for the poster.","error");return}p("â³ Uploading "+(a==="video"?"video":"poster")+"â€¦","info");const n=await Ko(t,a);a==="video"?i[e].video=n.url:i[e].poster=n.url,$e(),n.persisted?p("âœ“ "+(a==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):p("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function Qo(e){const a=Array.isArray(e)?e.map(t=>({...t})):[];return window._heroVideoDraft=a,He(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${Xt.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?Qo(t.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
      ...
      </div>`,He(),window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const a=new FormData(e.target),t={};for(const[n,o]of a.entries())t[n]=o;for(const n of Xt)if(n.fields)for(const o of n.fields)o.type==="checkbox"&&!(o.key in t)?t[o.key]=!1:o.type==="checkbox"&&(t[o.key]=!0);let i=[];try{const n=a.get("hero_video_slides");if(String(n||"").trim()){const o=JSON.parse(n);Array.isArray(o)&&(i=o)}}catch{i=[]}t.hero_video_slides=i;try{const{data:n}=await m.from("site_settings").select("id").limit(1).maybeSingle();let o;if(n?.id?{error:o}=await m.from("site_settings").update(t).eq("id",n.id):{error:o}=await m.from("site_settings").insert({id:1,...t}),o)throw new Error(o.message);ba(),p("Content updated â€” the banners now use your new words and uploads.","success")}catch(n){p(n.message||"Could not save content. Please try again.","error")}};async function Xo(){const e=document.getElementById("content");try{const[a,t,i]=await Promise.all([m.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),m.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),m.from("profiles").select("user_id,created_at",{count:"exact"})]),n=a.data||[],o=n.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,u)=>c+(parseFloat(u.amount)||0),0),r=n.length>0?(n.filter(c=>c.status!=="cancelled").length/n.length*100).toFixed(1):0,l={};(t.data||[]).forEach(c=>{l[c.category]=(l[c.category]||0)+1});const d=Object.entries(l).sort((c,u)=>u[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),qa(n)}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}async function Zo(){const e=document.getElementById("content"),{data:a}=await m.from("site_settings").select("*").limit(1).maybeSingle(),t=a||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <i data-lucide="${y.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${y.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const a=document.getElementById("current-pw").value,t=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(t!==i){p("Passwords do not match","error");return}if(t.length<8){p("Password must be at least 8 characters","error");return}const{error:n}=await m.auth.signInWithPassword({email:B.user.email,password:a});if(n){p("Current password is incorrect","error");return}const{error:o}=await m.auth.updateUser({password:t});if(o){p(o.message,"error");return}await le(B.user.id,"password_changed"),p("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){W(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons();try{const{data:e,error:a}=await m.auth.mfa.enroll({factorType:"totp",friendlyName:"Weverse Admin"});if(a)throw a;const t=e.totp.qr_code,i=e.totp.secret,n=e.id;document.getElementById("2fa-setup-content").innerHTML=`
      <div class="space-y-5">
...
Each code works once. Store securely.`],{type:"text/plain"}),t=document.createElement("a");t.href=URL.createObjectURL(a),t.download="kco-admin-backup-codes.txt",t.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=ri(10);await m.from("admin_2fa").update({backup_codes:e}).eq("user_id",B.user.id),p("New backup codes generated"),si(e.map(a=>a.code)),pt()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await m.auth.mfa.listFactors(),a=(e?.totp||[])[0];if(a){const{error:t}=await m.auth.mfa.unenroll({factorId:a.id});if(t)throw t}await m.from("admin_2fa").update({enabled:!1}).eq("user_id",B.user.id),await le(B.user.id,"2fa_disabled"),p("2FA has been disabled"),pt()}catch(e){p(e.message,"error")}};async function tn(){const e=document.getElementById("content");try{const{data:a}=await m.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}async function an(){const e=document.getElementById("content");try{const{data:a}=await m.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.exportProducts=async function(){const{data:e}=await m.from("showroom_listings").select("*"),a=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),t=document.createElement("a");t.href=URL.createObjectURL(a),t.download=`kco-products-${new Date().toISOString().slice(0,10)}.json`,t.click(),p("Products exported!")};window.exportOrders=async function(){const{data:e}=await m.from("payment_receipts").select("*").order("created_at",{ascending:!1});if(!e||!e.length){p("No orders to export","info");return}const a=Object.keys(e[0]).join(","),t=e.map(o=>Object.values(o).map(r=>`"${String(r||"").replace(/"/g,'""')}"`).join(",")).join(`
`),i=new Blob([a+`
`+t],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),p("Orders exported!")};async function on(){const e=document.getElementById("content"),{data:a}=await m.from("site_settings").select("*").limit(1).maybeSingle(),t=a||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const a=new FormData(e.target),t={};for(const[i,n]of a.entries())t[i]=n;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{t[i]=i in t}),await m.from("site_settings").upsert({id:1,...t}),p("Settings saved!")};async function mt(){const e=document.getElementById("content");e&&(e.innerHTML=Ie());try{const{data:a}=await m.from("site_settings").select("*").limit(1).maybeSingle(),t=a||{},i=t.homepage_banner_image||"",n=t.homepage_banner_alt||"Homepage header banner",o=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
        ...
        </div>`};const{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),i=t||{},n=i.brand_name||i.site_name||Pa,o=i.brand_slogan||i.site_tagline||Ea,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){a&&(a.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}function nn(e,a){const t=e.key+"_bg_image",i=e.key+"_bg_video",n=a[t]||"",o=a[i]||"",r=!!(n&&n.trim()),l=!!(o&&o.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function ma(e,a,t,i,n){const o=n==="image",r=o?"blue":"violet",l=o?"image-plus":"video",d=o?"text-blue-400":"text-violet-400";return`
    <div>
      ...
      ${i?`<div class="relative group w-full h-28 rounded-xl overflow-hidden bg-gray-900 border border-${r}-500/15 flex items-center justify-center">
             ${o?`<img src="${s(t)}" class="w-full h-full object-cover" onerror="this.style.display='none'">`:`<video src="${s(t)}" class="w-full h-full object-cover" muted playsinline preload="metadata"></video>`}
             <div class="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-2">
      ...
      <input type="file" id="file-${a}" class="hidden" accept="${o?"image/*":"video/*"}" onchange="handlePromoBgUpload(event,'${a}')">
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function li(){const e={};for(const a of et)e[a.key+"_bg_image"]=document.getElementById("val-"+a.key+"_bg_image")?.value||"",e[a.key+"_bg_video"]=document.getElementById("val-"+a.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const a=li();a[e]="";const t=document.getElementById("val-"+e),i=document.getElementById("url-"+e);t&&(t.value=""),i&&(i.value=""),Fe(a),p("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,a){const t=e.target.files?.[0];if(!t)return;const i=document.getElementById("promo-bg-status"),n=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),n&&(n.textContent=`Uploading ${t.name}â€¦`);try{const o=(t.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${a}-${Date.now()}.${o}`,{error:l}=await m.storage.from("product-images").upload(r,t,{contentType:t.type,upsert:!0});let d;if(l)d=URL.createObjectURL(t),n&&(n.textContent=`Preview only (storage: ${l.message})`);else{const{data:y}=m.storage.from("product-images").getPublicUrl(r);d=y.publicUrl,n&&(n.textContent=`âœ“ ${t.name} uploaded`)}const c=document.getElementById("val-"+a),u=document.getElementById("url-"+a);c&&(c.value=d),u&&(u.value=d,u.classList.remove("hidden"));const g=li();Fe(g)}catch(o){n&&(n.textContent=`Upload failed: ${o.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const a={};for(const o of et)a[o.key+"_bg_image"]=document.getElementById("val-"+o.key+"_bg_image")?.value||"",a[o.key+"_bg_video"]=document.getElementById("val-"+o.key+"_bg_video")?.value||"";const t=e.target.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:i}=await m.from("site_settings").select("id").limit(1).maybeSingle();let n;i?.id?{error:n}=await m.from("site_settings").update(a).eq("id",i.id):{error:n}=await m.from("site_settings").insert(a),Si(),n?(p("Publish failed â€” the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),Fe(a)):(p("Promo & backgrounds published across all pages.","success"),setTimeout(()=>Fe(),500))};window._manualPaymentAccounts=[];function Zt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:ya("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function ea(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function rn(e,a){const t=e.country_code||"US";return`
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((a,t)=>rn(a,t)).join("")}
    ...
    </div>`,ea(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Zt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Zt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,a,t){const i=window._manualPaymentAccounts[e];i&&(i[a]=t,a==="currency"&&(i.currencyName=t),ea())};window.updateManualPaymentCountry=function(e,a){const t=window._manualPaymentAccounts[e];if(!t)return;const i=Ee.find(n=>n.code===a);t.country_code=a,t.country=i?.name||"",t.flag=i?.flag||ya(a),ea(),renderManualPaymentAccountsEditor()};async function Nt(){const e=document.getElementById("content");e&&(e.innerHTML=Ie());try{const{data:a}=await m.from("site_settings").select("*").limit(1).maybeSingle(),t={...xi()||{},...a||{}};window._manualPaymentAccounts=wi(t).map(i=>({...i})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${s(_i(t))}</textarea>
              </div>
              <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const a=e.target?.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML="Savingâ€¦");const t=new FormData(e.target),i=Object.fromEntries(t.entries()),n={},o=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,d]of Object.entries(i))o.includes(l)?d&&!d.startsWith("â€¢")&&d.trim()!==""&&(n[l]=d.trim()):n[l]=d;const{error:r}=await m.from("site_settings").upsert({id:1,...n});if(a&&(a.disabled=!1,a.innerHTML="ðŸ’¾ Save Deploy & Payment Settings"),r){p(r.message,"error");return}p("Deploy & payment settings saved!"),bt()};async function di(e="deploy"){const{data:a}=await m.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!a?.deploy_webhook)return p("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let t=a.deploy_webhook;try{const i=new URL(t);e==="rebuild"&&i.searchParams.set("rebuild","1"),t=i.toString()}catch{e==="rebuild"&&(t+=(t.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:a,hookUrl:t}}async function pe(e,a={}){const t=a.version||new Date().toISOString(),i={source:"admin-dashboard",mode:a.mode||"deploy",production_url:a.productionUrl||null,github_repo:a.githubRepo||null,webhook:a.webhook||null,message:a.message||null},{data:n,error:o}=await m.from("deployment_history").insert({version:t,status:e,triggered_by_email:B.user?.email||null,metadata:i,error_message:a.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:n,error:o}}function Pe(e,a,t,i){if(!e)return;e.disabled=a;const n=e.querySelector("p.text-xs.font-black");n&&(n.textContent=a?t:i)}window.triggerDeploy=async function(e){const a=e?.currentTarget||document.querySelector("[data-deploy-btn]");Pe(a,!0,"Deployingâ€¦","Deploy Now");try{const t=await di("deploy");if(!t.ok)return;const{settings:i,hookUrl:n}=t;await pe("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Deployment queued from admin UI"});const o=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)p("ðŸš€ Deployment triggered! Your site will be live in ~2 minutes."),await pe("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted deployment request"}),setTimeout(()=>bt(),400);else{const r=`Webhook returned error: ${o.status}`;p(r,"error"),await pe("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(t){p("Deploy failed: "+t.message,"error"),await pe("failed",{mode:"deploy",errorMessage:t.message})}finally{Pe(a,!1,"Deployingâ€¦","Deploy Now")}};window.triggerRebuild=async function(e){const a=e?.currentTarget||document.querySelector("[data-rebuild-btn]");Pe(a,!0,"Rebuildingâ€¦","Rebuild Site");try{const t=await di("rebuild");if(!t.ok)return;const{settings:i,hookUrl:n}=t;await pe("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Rebuild requested from admin UI"});const o=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)p("ðŸ”„ Rebuild triggered successfully."),await pe("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted rebuild request"}),setTimeout(()=>bt(),400);else{const r=`Rebuild webhook error: ${o.status}`;p(r,"error"),await pe("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(t){p("Rebuild failed: "+t.message,"error"),await pe("failed",{mode:"rebuild",errorMessage:t.message})}finally{Pe(a,!1,"Rebuildingâ€¦","Rebuild Site")}};window.publishAndDeploy=async function(e){const a=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");Pe(a,!0,"Publishingâ€¦","One-Click Publish");try{const t=document.getElementById("deploy-form");if(!t){p("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:t}),await window.triggerDeploy()}catch(t){p("Publish failed: "+t.message,"error")}finally{Pe(a,!1,"Publishingâ€¦","One-Click Publish")}};window.reindexSearch=async function(){const e=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=e?.textContent||"";e&&(e.textContent="Reindexingâ€¦");try{const{data:t,error:i}=await m.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(i)return J(i)?p("âš ï¸ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):p("Could not load listings to reindex: "+i.message,"error");const n=t||[];if(!n.length){p("No listings to reindex.");return}let o=0,r=0,l=!1;const d=40;for(let c=0;c<n.length;c+=d){const u=n.slice(c,c+d),{error:g}=await m.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",u.map(y=>y.id));g?(J(g)&&(l=!0),r+=u.length):o+=u.length,e&&(e.textContent=`Reindexingâ€¦ ${Math.min(c+d,n.length)}/${n.length}`)}if(l){p(`âš ï¸ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${o}/${n.length} done)`,"error");return}p(`Search index rebuilt for ${o} listing${o!==1?"s":""}${r?` (${r} failed)`:""}.`,r?"error":"success")}catch(t){p("Reindex failed: "+t.message,"error")}finally{e&&(e.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(ie)||!ie.length){p("No static showroom listings found to sync.","info");return}const e=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=e?.textContent||"";e&&(e.textContent="Syncingâ€¦");try{const{data:t,error:i}=await m.from("showroom_listings").select("property_id");if(i)return J(i)?p("âš ï¸ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):p("Could not load existing listings: "+i.message,"error");const n=new Set((t||[]).map(u=>u.property_id)),o=ie.filter(u=>u&&u.property_id&&!n.has(u.property_id));if(!o.length){p("Showroom already in sync â€” no new listings to add.");return}let r=0,l=0,d=!1;const c=20;for(let u=0;u<o.length;u+=c){const g=o.slice(u,u+c).map(b=>({property_id:b.property_id,listing_type:b.listing_type||"product",category:b.category||null,subcategory:b.subcategory||null,title:b.title||"Untitled Listing",description:b.description||"",price:parseFloat(b.price)||0,currency:b.currency||"USD",country:b.country||"",country_code:b.country_code||"",state:b.state||"",city:b.city||"",town:b.town||"",product_location:b.product_location||"",latitude:b.latitude??null,longitude:b.longitude??null,property_type:b.property_type||null,listing_status:b.listing_status||"sale",bedrooms:b.bedrooms??null,bathrooms:b.bathrooms??null,building_size:b.building_size||"",land_size:b.land_size||"",parking_spaces:b.parking_spaces??null,furnished:b.furnished||"",features:Array.isArray(b.features)?b.features:[],tags:Array.isArray(b.tags)?b.tags:[],highlights:Array.isArray(b.highlights)?b.highlights:[],seo_keywords:Array.isArray(b.seo_keywords)?b.seo_keywords:[],images:Array.isArray(b.images)?b.images:[],brand:b.brand||null,color:b.color||null,size:b.size||null,condition:b.condition||null,warranty:b.warranty||null,availability_status:b.availability_status||"In Stock",stock_quantity:b.stock_quantity!=null?parseInt(b.stock_quantity,10):null,is_active:b.is_active!==!1,is_featured:!!b.is_featured,is_ai_generated:!!b.is_ai_generated,ai_generated_fields:Array.isArray(b.ai_generated_fields)?b.ai_generated_fields:[],specifications:b.specifications||{},created_at:b.created_at||new Date().toISOString()})),{error:y}=await m.from("showroom_listings").insert(g);y?(J(y)&&(d=!0),l+=g.length):r+=g.length,e&&(e.textContent=`Syncingâ€¦ ${Math.min(u+c,o.length)}/${o.length}`)}if(d){p(`âš ï¸ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${r}/${o.length} added)`,"error");return}p(`Showroom synced: ${r} new listing${r!==1?"s":""} added to the database${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(t){p("Sync failed: "+t.message,"error")}finally{e&&(e.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),a=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!a){p("Enter your GitHub username and repo name first","info");return}try{const t=await fetch(`https://api.github.com/repos/${e}/${a}`);if(t.ok){const i=await t.json();p(`âœ“ Connected: ${i.full_name} (${i.visibility})`)}else t.status===404?p("Repository not found. Check username and repo name.","error"):p("GitHub API error: "+t.status,"error")}catch{p("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ci=30,Y={category:null,page:0,query:""};async function Te(){const e=document.getElementById("content");if(!e)return;await Dt();const a=new Set(at()),t=$i();Y.category||(Y.category=t[0]?.slug||null);const i=0,n=Y.query.trim().toLowerCase(),o=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',u=n?1:Math.max(1,Math.ceil(i/ci)),g=`
    <div class="flex flex-wrap items-center justify-between gap-3">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${g}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){Y.category=e,Y.page=0,Y.query="",Te()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");Y.query=e?e.value:"",Y.page=0,Te()};window.catalogPage=function(e){const a=Y.query.trim()?1:Math.max(1,Math.ceil(0/ci));Y.page=Math.max(0,Math.min(a-1,Y.page+e)),Te()};window.catalogToggle=async function(e){const a=!at().includes(e),t=await wa(e,a);p(a?"Listing hidden from storefront":"Listing restored",t.ok?"success":"info"),Te()};window.catalogResetHidden=async function(){await Ai(),p("All hidden catalog listings restored"),Te()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(e){e.state&&e.state.adminGuard===1&&window.location.replace("/")})}})();async function ga(){window.lucide&&lucide.createIcons(),Ca(),await Ji(),m.auth.onAuthStateChange((e,a)=>{if(e==="SIGNED_OUT"){B.user=null;const t=document.getElementById("login-screen");t&&(t.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ga):ga();
