import{D as q,l as g,b}from"./promo-backgrounds-BZhAn4aI.js";import{d as H,W as B,D as G,l as j,a as P,g as F,p as D,e as u,c as w,b as v}from"./promo-pool-CZD5oU4b.js";import{D as x,l as k,g as M}from"./site-content-DxInYU0I.js";const I="support@weverseonlineshop.com",U="weverse_brand_v1";function o(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function O(){try{const e=JSON.parse(localStorage.getItem(U)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function R(){const e=O(),t=e.brand_name||e.site_name||H;return`
