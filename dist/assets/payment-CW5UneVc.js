...
`),v=r.amountLabel||"",$=r.orderNumber||"";return`
  ...
  `}async function _e(){const e=document.getElementById("payment-content"),t=new URLSearchParams(window.location.search).get("guest")==="1",r=t?null:await ce();if(!r&&!t){window.location.href="/";return}const i=he();let o=await te(i)||H(i)||oe(i)||se(i)||ne(i)||de(i)||ve(i);if(!o){const[{generateListingById:I},{loadHiddenCatalogIds:N}]=await Promise.all([D(()=>import("./catalog-CelQP4mF.js"),__vite__mapDeps([0,1,2])),D(()=>import("./catalog-hidden-store-DQ-29SYy.js"),__vite__mapDeps([1,2]))]);await N(),o=I(i)}if(o||(o=H(i)),!o){e.innerHTML=`
