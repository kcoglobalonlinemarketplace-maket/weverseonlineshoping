(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=a(i);fetch(i.href,o)}})();const xe="modulepreload",ve=function(e){return"/"+e},K={},m=function(t,a,r){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),s=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(a.map(c=>{if(c=ve(c),c in K)return;K[c]=!0;const d=c.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":xe,d||(l.as="script"),l.crossOrigin="",l.href=c,s&&l.setAttribute("nonce",s),document.head.appendChild(l),d)return new Promise((g,y)=>{l.addEventListener("load",g),l.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return i.then(n=>{for(const s of n||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})};let L=null;function A(){return L?Promise.resolve(L):m(()=>import("./supabase-client-nvpjTmO6.js"),[]).then(e=>(L=e.supabase,L))}const _e="/verified-badge.svg",z="Weverse Online Shop",ke="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Se="/w-logo.svg",Ce=(e="weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")=>`<svg viewBox="0 0 24 24" class="${e}" aria-label="Verified" role="img" data-weverse-badge="true"><circle cx="12" cy="12" r="11" fill="#3b82f6"/><path d="M10.8 15.6 7.4 12.2l1.5-1.5 1.9 1.9 3.9-3.9 1.5 1.5-5.4 5.4z" fill="#fff"/></svg>`,se=(e="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8")=>`  <svg viewBox="0 0 24 24" class="${e}" fill="none" aria-hidden="true"><path d="M3 5l4.5 14L12 8l4.5 11L21 5" stroke="#ffffff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/></svg>`,F="weverse_brand_v1",Te="weverse_brand_override_v1",Ae=5*60*1e3;async function V(){try{const e=JSON.parse(localStorage.getItem(Te)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(F)||"{}");if(e.ts&&Date.now()-e.ts<Ae&&e.data)return e.data}catch{}try{const e=await A(),{data:t}=await e.from("site_settings").select("brand_name,brand_slogan,brand_logo,brand_badge,brand_favicon,brand_mobile_logo,brand_header_logo,brand_footer_logo,brand_primary_color,brand_secondary_color,brand_tagline_color1,brand_tagline_color2,brand_font,brand_custom_font,brand_website_url,brand_email,site_name,site_tagline,homepage_banner_image,homepage_banner_alt").limit(1).maybeSingle(),a=t||{};return localStorage.setItem(F,JSON.stringify({ts:Date.now(),data:a})),a}catch{return{}}}function j(e){if(!e)return;const t=e.brand_name||e.site_name||z,a=e.brand_slogan||e.site_tagline||ke,r=e.brand_logo||e.brand_header_logo||Se,i=e.brand_badge||_e,o=e.brand_favicon||"",n=e.brand_custom_font||e.brand_font||"",s=e.brand_primary_color||"",c=e.brand_secondary_color||"",d=e.brand_tagline_color1||"",p=e.brand_tagline_color2||"";if(Ee(e.homepage_banner_image||"",e.homepage_banner_alt||"Homepage header banner"),(d||p)&&(document.querySelectorAll(".brand-tagline-1").forEach(l=>{d&&(l.style.color=d)}),document.querySelectorAll(".brand-tagline-2").forEach(l=>{p&&(l.style.color=p)})),document.title&&!document.title.startsWith(t)&&(document.title=document.title.replace(/^[^|]+\|/,t+" |").replace(/^[^–]+–/,t+" – ")),o){let l=document.querySelector("link[rel~='icon']");l||(l=document.createElement("link"),l.rel="icon",document.head.appendChild(l)),l.href=o}if(s||c||n){const l=n?`'${n}'`:null,g=document.getElementById("brand-css-vars")||(()=>{const y=document.createElement("style");return y.id="brand-css-vars",document.head.appendChild(y),y})();if(g.textContent=`:root {
      ${s?`--brand-primary: ${s};`:""}
      ${c?`--brand-secondary: ${c};`:""}
      ${l?`--brand-font: ${l}, system-ui, sans-serif;`:""}
    }`,n){const y="brand-gf-link";if(!document.getElementById(y)){const E=document.createElement("link");E.id=y,E.rel="stylesheet",E.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(n)}:wght@400;600;700;900&display=swap`,document.head.appendChild(E)}}}document.querySelectorAll("[data-brand]").forEach(l=>{const g=l.dataset.brand;g==="name"&&(l.textContent=t,!l.querySelector("[data-weverse-badge]")&&!l.parentElement?.querySelector("[data-weverse-badge]")&&l.appendChild(Object.assign(document.createElement("span"),{className:"inline-flex items-center ml-1 align-middle",innerHTML:Ce("weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")}))),g==="slogan"&&(l.textContent=a),g==="logo"&&(l.src=r,l.alt=t,l.style.display=""),g==="badge"&&(l.src=i,l.alt="Verified",l.style.display=""),g==="tagline"&&(l.textContent=a),g==="footer-logo"&&(e.brand_footer_logo?(l.src=e.brand_footer_logo,l.alt=t):(l.src=r,l.alt=t)),g==="mobile-logo"&&(e.brand_mobile_logo?(l.src=e.brand_mobile_logo,l.alt=t):(l.src=r,l.alt=t))}),document.querySelectorAll('img[data-brand="logo"]').forEach(l=>{const y=l.closest(".text-center")?.querySelector('h1[data-brand="name"]');y&&(y.style.display="none")}),Le(t,a,r,i),Be(t,a,r),I()}function Ee(e,t){const a=document.getElementById("homepage-banner-shell"),r=document.getElementById("homepage-banner-image");if(!(!a||!r)){if(!e){r.removeAttribute("src"),r.alt=t,a.classList.add("hidden");return}r.alt=t,r.onload=()=>I(),r.onerror=()=>{a.classList.add("hidden"),I()},r.src!==e&&(r.src=e),a.classList.remove("hidden")}}function I(){const e=document.getElementById("site-header"),t=document.getElementById("site-categories-nav"),a=document.querySelector("main");if(!e||!t||!a)return;const r=Math.ceil(e.getBoundingClientRect().height||e.offsetHeight||0),i=Math.ceil(t.getBoundingClientRect().height||t.offsetHeight||0);t.style.top=`${r}px`;const o=window.innerWidth<640?20:12;a.style.paddingTop=`${r+i+o}px`}function Le(e,t,a,r,i){document.querySelectorAll('header a[href="/"], header a[href="./"], header a[href="index.html"], .brand-link, #brand-link').forEach(n=>{le(n,e,t),n.querySelectorAll('img.brand-logo, img[data-brand="logo"]').forEach(s=>{s.src=a,s.alt=e})}),document.querySelectorAll("header span").forEach(n=>{if(n.classList.contains("brand-tagline-1")||n.classList.contains("brand-tagline-2"))return;const s=n.textContent.trim();(s==="Weverse Online Shop"||s==="KCO Global Online Marketplace"||n.classList.contains("brand-name"))&&(n.textContent=e),(s==="Your Trusted Global Shop"||s.includes("Globally")||s.includes("Worldwide")||n.classList.contains("brand-slogan"))&&(n.textContent=t)}),document.querySelectorAll('[data-brand="badge"], .brand-badge, #brand-badge').forEach(n=>{n.tagName==="IMG"&&(n.src=r,n.alt="Verified",n.style.display="")}),document.querySelectorAll("span").forEach(n=>{if(n.textContent.includes("Verified")&&!n.querySelector("img.brand-badge-img")){const s=document.createElement("img");s.src=r,s.alt="Verified",s.className="brand-badge-img w-4 h-4 inline-block ml-1",s.onerror=()=>s.remove(),n.appendChild(s)}}),document.querySelectorAll('header a[href="/"] .relative.shrink-0, header a .relative.w-7').forEach(n=>{if(!n.querySelector("img.injected-logo")){const s=document.createElement("img");s.src=a,s.alt=e,s.className="injected-logo w-8 h-8 sm:w-9 sm:h-9 object-contain rounded-lg",s.onerror=()=>s.style.display="none",n.style.display="flex",n.style.alignItems="center",n.innerHTML="",n.appendChild(s)}})}function Be(e,t,a){document.querySelectorAll("footer").forEach(r=>{le(r,e,t),r.querySelectorAll("img.brand-logo, img[data-brand], .footer-logo img").forEach(i=>{i.src=a,i.alt=e})})}function le(e,t,a){const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT),i=[];let o;for(;o=r.nextNode();){const n=o.textContent.trim();(n==="Weverse Online Shop"||n==="KCO Global Online Marketplace")&&i.push({node:o,value:t}),(n==="Your Trusted Global Shop"||n==="Global Shopping • Worldwide Delivery")&&i.push({node:o,value:a})}i.forEach(({node:n,value:s})=>{n.textContent=n.textContent.replace(n.textContent.trim(),s)})}V().then(j);window.addEventListener("load",()=>V().then(j));window.addEventListener("resize",()=>I());window.addEventListener("storage",e=>{e.key===F&&V().then(j)});const k={trust_promo_bg_image:"",trust_promo_bg_video:"",app_banner_bg_image:"",app_banner_bg_video:"",reviews_bg_image:"",reviews_bg_video:""},Ie=Object.keys(k).join(","),Y="kco_promo_backgrounds_v1",Me=60*1e3;function Pe(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");if(e.ts&&Date.now()-e.ts<Me&&e.data&&typeof e.data=="object")return e.data}catch{}return null}function De(e){try{localStorage.setItem(Y,JSON.stringify({ts:Date.now(),data:e}))}catch{}}async function M(){const e=Pe();if(e)return{...k,...e};try{const t=await A(),{data:a,error:r}=await t.from("site_settings").select(Ie).limit(1).maybeSingle(),i={...k,...r||!a?{}:a};return De(i),i}catch{return{...k}}}function wt(){try{localStorage.removeItem(Y)}catch{}window.dispatchEvent(new CustomEvent("promo-backgrounds-updated"))}function U(e,t){const a=(e||"").trim(),r=(t||"").trim(),i=[];return r&&i.push(`<video class="absolute inset-0 w-full h-full object-cover" autoplay muted loop playsinline webkit-playsinline preload="metadata" poster="${Q(a)}"><source src="${Q(r)}" type="video/mp4"></video>`),a&&i.push(`<div class="absolute inset-0 bg-cover bg-center" style="background-image:url('${Oe(a)}')"></div>`),(r||a)&&i.push('<div class="absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-900/70 to-slate-900/45"></div>'),i.join("")}function Q(e){return String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Oe(e){return String(e).replace(/\\/g,"\\\\").replace(/'/g,"\\'")}const $e="weverse_brand_v1";function w(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ce(){try{const e=JSON.parse(localStorage.getItem($e)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function He(){const e=ce(),t=e.brand_name||e.site_name||z;return`
      ...
      <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-16 lg:py-20">
        <div class="max-w-2xl relative rounded-3xl bg-slate-950/55 border border-white/10 p-6 sm:p-8 md:p-10 backdrop-blur-md shadow-2xl shadow-slate-950/50">
          ...
          <p class="text-[15px] sm:text-base text-slate-200 mt-4 leading-relaxed max-w-xl">
            ...
            200+ countries worldwide — so shopping with ${w(t)} is always fast, safe and worry-free.
          </p>
    ...
    </div>`}function We(){const e=J.slice(0,6),t=J.slice(6),a=r=>r.map(Ue).join("");return`
    ...
    </section>`}const qe=[{name:"Amina K.",country:"Nigeria",text:"My order arrived ahead of schedule and the quality was exactly as described. I shop here without any doubt.",verified:!0},{name:"Sarah & James",country:"United States",text:"Ordered for our whole family — tracking updates made it feel safe and reliable from checkout to delivery.",verified:!0},{name:"Priya S.",country:"India",text:"The customer support team answered my questions in minutes. Genuinely trustworthy shopping experience.",verified:!0}];function Ge(e){return[1,2,3,4,5].map(t=>`<i data-lucide="star" class="w-3.5 h-3.5 ${t<=e?"fill-amber-400 text-amber-400":"text-slate-500"}"></i>`).join("")}function W(e){const t=String(e.name||"Verified shopper").trim()||"Verified shopper",a=(t.charAt(0)||"V").toUpperCase(),r=[e.country||"",e.verified?"Verified buyer":"",e.date||""].filter(Boolean).join(" · ");return`
    ...
    </section>`}function h(e,t,a){return`<li><a href="${e}"  class="text-xs text-gray-600 hover:text-blue-600 transition">${t}</a></li>`}function ze(){const e=ce(),t=e.brand_name||e.site_name||z,a=e.brand_logo||e.brand_header_logo||e.brand_footer_logo||"/w-logo.svg",r=e.brand_slogan||e.site_tagline||"GLOBAL SHOPPING · WORLDWIDE DELIVERY";return`
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-9 pb-7 border-b border-gray-200">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center overflow-hidden">
              ...
              <span style="display:none">${se("w-7 h-7")}</span>
            </div>
            <div>
  ...
  <svg viewBox="0 0 560 720" class="w-full h-full block" aria-hidden="true">
  ...
  </svg>`}function dt(e){const t=e[0],a=e[1],r=(i,o)=>{const n=f(P(i)),s=f((i.title||i.name||"").slice(0,34));return`
      <a href="/details.html?id=${encodeURIComponent(i.property_id||i.id)}"
        ...
        <div class="aspect-square bg-gray-100 overflow-hidden">
          <img src="${n}" alt="${s}" loading="lazy" decoding="async"
               class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${R}'">
        </div>
        <div class="p-2">
          <p class="text-[10px] text-gray-700 font-bold leading-tight line-clamp-2 min-h-[26px]">${s}</p>
          <div class="flex items-center justify-between mt-1">
            <span class="text-[11px] text-blue-600 font-black">${D(i)}</span>
    ...
    </div>`}function ut(e,t){const a=ye(t,e,12),r=(e.app_play_store_url||"").trim(),i=(e.app_banner_headline||T.app_banner_headline).trim(),o=r?`<a href="${f(r)}" target="_blank" rel="noopener" class="inline-flex items-center gap-2.5 bg-white text-blue-900 font-black text-sm px-6 py-3.5 rounded-2xl shadow-xl shadow-blue-900/30 hover:scale-[1.03] active:scale-[.98] transition">
    ...
    <section class="relative overflow-hidden bg-[#060c1c] text-white">
        ...
        <div class="grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-6 items-center">
          ...
          <div class="max-w-xl lg:pr-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-7 max-w-lg">
              ${[{icon:"shopping-bag",label:"Shop Products"},{icon:"sparkles",label:"New Arrivals"},{icon:"package-search",label:"Manage Orders"},{icon:"heart",label:"Save Favorites"}].map(n=>`
                <div class="bg-white/[.06] border border-white/10 rounded-2xl px-3 py-3.5 text-center backdrop-blur">
                  <i data-lucide="${n.icon}" class="w-4.5 h-4.5 w-5 h-5 text-cyan-300 mx-auto"></i>
                  <p class="text-[10px] font-bold text-slate-200 mt-2">${n.label}</p>
                </div>`).join("")}
            </div>
          ...
          <div class="relative mx-auto w-full max-w-[300px] sm:max-w-[340px] lg:max-w-[400px] aspect-[560/720]">
            <div class="absolute inset-0 woman-back" aria-hidden="true">${lt()}</div>
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="translate-y-[34%] scale-[.92] sm:scale-100">${pt(a)}</div>
            </div>
            <div class="absolute inset-0 hands-front pointer-events-none" aria-hidden="true">${ct()}</div>
          </div>
        </div>
      </div>
    </section>`}function ht(e){const t=document.getElementById("promo-phone-screen"),a=document.getElementById("promo-phone-grid");if(!t||!a||!e.length)return;const r=e.slice();let i=0;const o=()=>{if(!a||!r.length)return;const n=r[i%r.length],s=r[(i+1)%r.length],c=f(P(n)),d=f(P(s)),p=f((n.title||n.name||"").slice(0,34)),l=f((s.title||s.name||"").slice(0,34));if(a.innerHTML=`
      <a href="/details.html?id=${encodeURIComponent(n.property_id||n.id)}" class="block bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition active:scale-[.98]">
        <div class="aspect-square bg-gray-100 overflow-hidden"><img src="${c}" alt="${p}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${R}'"></div>
        <div class="p-2"><p class="text-[10px] text-gray-700 font-bold leading-tight line-clamp-2 min-h-[26px]">${p}</p>
        <div class="flex items-center justify-between mt-1"><span class="text-[11px] text-blue-600 font-black">${D(n)}</span><span class="bg-blue-500 text-white text-[9px] font-black px-2 py-1 rounded-lg">Buy</span></div></div>
      </a>
      <a href="/details.html?id=${encodeURIComponent(s.property_id||s.id)}" class="block bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition active:scale-[.98]">
        <div class="aspect-square bg-gray-100 overflow-hidden"><img src="${d}" alt="${l}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${R}'"></div>
        <div class="p-2"><p class="text-[10px] text-gray-700 font-bold leading-tight line-clamp-2 min-h-[26px]">${l}</p>
        <div class="flex items-center justify-between mt-1"><span class="text-[11px] text-blue-600 font-black">${D(s)}</span><span class="bg-blue-500 text-white text-[9px] font-black px-2 py-1 rounded-lg">Buy</span></div></div>
      </a>`,window.lucide)try{lucide.createIcons()}catch{}};o(),setInterval(()=>{i+=2,o()},4500)}async function ne(){const e=st();if(!e)return;let t={...T};try{t=await fe()}catch{}if(t.app_banner_enabled===!1)return;let a=[];try{await me(),a=G()||[]}catch{}const r=a.length?a:[{property_id:"browse",title:"Browse the full Weverse Online Shop",price:0,currency:"USD",images:["/fallback.svg"]}];if(e.innerHTML=ut(t,r),window.lucide)try{lucide.createIcons()}catch{}ht(r),window.dispatchEvent(new CustomEvent("app-promo-banner-ready"));let i={...k};try{i=await M()}catch{}const o=n=>{const s=e.querySelector('[data-bg-slot="app_banner"]');s&&(s.innerHTML=U(n.app_banner_bg_image,n.app_banner_bg_video))};o(i),window.addEventListener("promo-backgrounds-updated",()=>{M().then(o).catch(()=>{})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ne):ne();const gt="/fallback.svg",N=()=>document.getElementById("live-promo-alerts"),be="kco_live_promo_dismissed_v1";function we(){try{return JSON.parse(localStorage.getItem(be)||"{}")}catch{return{}}}function mt(e){const a=we()[e];return a?Date.now()-a<2*60*60*1e3:!1}function ft(e){try{const t=we();t[e]=Date.now(),localStorage.setItem(be,JSON.stringify(t))}catch{}}function yt(e){const t=f(e.title||e.name||"Featured product"),a=e.listing_type==="vehicle"?e.category||"Featured Vehicle":e.listing_type==="property"?"Featured Property":e.subcategory||e.category||"Featured Product";return`
    <div class="live-promo-toast pointer-events-auto flex items-center gap-3 bg-white border border-gray-200 rounded-2xl shadow-2xl shadow-black/15 p-3 pr-4 cursor-pointer hover:shadow-black/25 transition" data-promo-id="${f(e.property_id||e.id||"")}">
      <div class="shrink-0 w-16 h-16 rounded-xl overflow-hidden bg-gray-100 border border-gray-100">
        <img src="${f(P(e))}" alt="${t}" loading="lazy" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${gt}'">
      </div>
      <div class="min-w-0 flex-1">
        ...
        <div class="flex items-center justify-between mt-1">
          <span class="text-[12px] font-black text-blue-600">${D(e)}</span>
    ...
    </div>`}function bt(e){const t=N();if(!t)return;const a=e.property_id||e.id;if(mt(a))return;t.querySelectorAll(".live-promo-toast").forEach(s=>s.remove()),t.insertAdjacentHTML("beforeend",yt(e));const r=t.querySelector(".live-promo-toast");if(!r)return;r.style.opacity="0",r.style.transform="translateY(14px)";const i=`/details.html?id=${encodeURIComponent(a)}`,o=r.querySelector(".live-promo-close"),n=s=>{s.preventDefault(),s.stopPropagation(),r.style.transform="translateY(12px)",r.style.opacity="0",setTimeout(()=>{r.remove()},220),window.location.href=i};if(o.addEventListener("click",s=>{s.preventDefault(),s.stopPropagation(),a&&ft(a),r.style.transform="translateY(12px)",r.style.opacity="0",setTimeout(()=>r.remove(),220)}),r.addEventListener("click",n),window.lucide)try{lucide.createIcons()}catch{}requestAnimationFrame(()=>{r.style.transition="transform .35s ease, opacity .35s ease",r.style.transform="translateY(0)",r.style.opacity="1"}),setTimeout(()=>{r.isConnected&&(r.style.transform="translateY(12px)",r.style.opacity="0",setTimeout(()=>r.remove(),260))},7e3)}async function oe(){if(!N())return;let t={...T};try{t=await fe()}catch{}if(t.live_promo_enabled===!1)return;let a=[];try{await me(),a=G()||[]}catch{}if(!a.length)return;const r=ye(a,t,10);if(!r.length)return;let i=0;const o=Math.max(3,Number(t.live_promo_first_delay_seconds)||12)*1e3,n=Math.max(20,Number(t.live_promo_interval_seconds)||60)*1e3,s=()=>{if(N()&&G().length){const c=r[i%r.length];bt(c),i+=1}};setTimeout(()=>{s(),setInterval(s,n)},o)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oe):oe();(()=>{if(typeof window>"u"||document.getElementById("scroll-progress-rail"))return;const e=document.createElement("div");e.id="scroll-progress-rail",e.setAttribute("role","scrollbar"),e.setAttribute("aria-label","Scroll progress — tap to jump to top or down the page"),e.innerHTML=`
    ...
    </button>`,document.body.appendChild(e);const t=e.querySelector("#scroll-progress-fill"),a=e.querySelector("#scroll-progress-top");let r=!1;const i=`
    ...
    }`,o=document.createElement("style");o.textContent=i,document.head.appendChild(o);function n(){return Math.max(0,(document.documentElement.scrollHeight||document.body.scrollHeight||0)-window.innerHeight)}function s(){const d=n(),p=d>0?Math.min(1,window.scrollY/d):0;t&&(t.style.height=`${(p*100).toFixed(2)}%`),a.style.opacity=window.scrollY>300?"1":"0",a.style.pointerEvents=window.scrollY>300?"auto":"none"}function c(d){const p=e.getBoundingClientRect(),l=Math.min(1,Math.max(0,(d-p.top)/Math.max(1,p.height)));window.scrollTo({top:l*n(),behavior:"smooth"})}a.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),e.addEventListener("pointerdown",d=>{d.target!==a&&(r=!0,c(d.clientY),e.setPointerCapture(d.pointerId),d.preventDefault())}),e.addEventListener("pointermove",d=>{r&&c(d.clientY)}),["pointerup","pointercancel"].forEach(d=>{e.addEventListener(d,()=>{r=!1})}),s(),window.addEventListener("scroll",s,{passive:!0}),window.addEventListener("resize",s,{passive:!0})})();export{O as S,m as _,M as a,U as b,de as c,q as d,Je as e,rt as f,he as g,A as h,wt as i,pe as j,Xe as k,ue as l,xt as s};
