...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Te="kco_admin_remember",Jt="kco_login_attempts",Tt=5,cn=15*60*1e3;function H(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function un(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function yt(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Ye(e){return String(e||"").trim().toLowerCase()}function pn(){try{const e=JSON.parse(localStorage.getItem(Te)||"{}");e?.email&&!Ye(e.email)&&localStorage.removeItem(Te)}catch{localStorage.removeItem(Te)}}function mn(){try{const e=JSON.parse(localStorage.getItem(Te)||"{}");return Ye(e?.email)}catch{return""}}function Qt(){pn();const e=mn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Da,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function gn(){return`${window.location.origin}/admin.html`}function Ee(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),yt(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function q(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Ga(){try{return JSON.parse(localStorage.getItem(Jt)||'{"count":0}')}catch{return{count:0}}}function Va(){const e=Ga();return e.count=(e.count||0)+1,e.count>=Tt&&(e.lockedUntil=Date.now()+cn),localStorage.setItem(Jt,JSON.stringify(e)),e}function za(){localStorage.removeItem(Jt)}function Wa(){const e=Ga();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(za(),null):Math.ceil(t/6e4)}async function de(e,t,a={}){try{await g.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await bn(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function bn(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Ka(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await g.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Ye(e.email)===Da}async function yn(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){rt(),_n();return}const{data:{session:t}}=await g.auth.getSession();if(t?.user&&await Ka(t.user)){const{data:{currentUser:i}}=await g.auth.getUser(),n=await g.auth.mfa.getAuthenticatorAssuranceLevel(),o=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&o!=="aal2"){I.user=t.user,rt(),Ee("2fa"),Xt();return}I.user=t.user,ft();return}fn()}function rt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function fn(){rt(),Ee("login"),Qt(),Ya(),Ja(),Xt(),hn();const e=Wa();e&&(H(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function hn(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Ya(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",vn),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Ee("forgot")))}async function vn(e){e.preventDefault();const t=Wa();if(t){H(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Ye(a?.value);if(!i){H("Enter your admin email address."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;q("login-btn",!0),yt();const{data:r,error:l}=await g.auth.signInWithPassword({email:i,password:n});if(l||!r.user){const y=String(l?.message||"").toLowerCase();if(y.includes("missing supabase credentials")||y.includes("authentication service is unavailable")){H("Authentication is temporarily unavailable due to configuration. Please contact support."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("failed to fetch")||y.includes("network request failed")){H("Network error while signing in. Check your connection and try again."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("email not confirmed")){H("Your admin email is not confirmed yet. Open your verification email and confirm first."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const h=Va(),b=Tt-h.count,f=h.lockedUntil?`Account locked for 15 minutes after ${Tt} failed attempts.`:`Invalid email or password. ${b>0?b+" attempt"+(b!==1?"s":"")+" remaining.":""}`;H(f),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await de(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Ka(r.user)){await g.auth.signOut(),H(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await de(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Te,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Te),za(),I.user=r.user,(await g.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Ee("2fa"),Xt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await de(r.user.id,"login_success"),q("login-btn",!1),ft()}function Xt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ga));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ga()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await g.auth.signOut(),I.user=null,Ee("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",wn))}async function ga(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){H("Enter the 6-digit code from your authenticator app.");return}q("verify-2fa-btn",!0),yt();try{const{data:t}=await g.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){H("No 2FA factor found. Please re-login."),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await g.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:o}=await g.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await de(I.user.id,"login_2fa_success"),q("verify-2fa-btn",!1),ft()}catch(t){Va(),H(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function wn(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){H("Enter a backup recovery code.");return}q("verify-backup-btn",!0);try{const{data:t}=await g.from("admin_2fa").select("backup_codes").eq("user_id",I.user.id).maybeSingle();if(!t?.backup_codes?.length){H("No backup codes found."),q("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){H("Backup code not found or already used."),q("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await g.from("admin_2fa").update({backup_codes:i}).eq("user_id",I.user.id),await de(I.user.id,"login_backup_code_used"),ft()}catch(t){H(t.message),q("verify-backup-btn",!1,"Use Backup Code")}}function Ja(){document.getElementById("back-to-login")?.addEventListener("click",()=>Ee("login")),document.getElementById("send-reset-btn")?.addEventListener("click",xn)}async function xn(){const e=document.getElementById("reset-email"),t=Ye(e?.value);if(!t){H("Enter your admin email address to receive a reset link.");return}q("send-reset-btn",!0),yt();const{error:a}=await g.auth.resetPasswordForEmail(t,{redirectTo:gn()});if(q("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){H(a.message);return}un("Reset link sent! Check your inbox and open it from this device to continue.")}function _n(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
`}const Gn=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function ha(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(u=>String(u)):[]),o=[],r=[],l=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(y=>y!=null&&String(y).trim()!=="").join(", "));let m=String(u).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},d=u=>{const m=l(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),y=parseFloat(m);return Number.isFinite(y)?y:NaN};for(const u of e||[]){if(ii.has(u.key))continue;const m={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const b=Array.isArray(a[u.key])?a[u.key].map(l).filter(Boolean):[],f=u.options&&u.options.length?b.filter(w=>u.options.includes(w)):b;f.length?(a[u.key]=f,m.status="filled",m.value=f.join(", ")):(delete a[u.key],b.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",r.push(`${u.label}: invalid selection ignored`))),o.push(m);continue}if(!(a[u.key]!=null&&l(a[u.key])!=="")){m.status=n.has(u.key)?"missing":"empty-ok",o.push(m);continue}if(Gn.test(l(a[u.key]))){delete a[u.key],n.add(u.key),m.status="missing",m.note="document/AI said the value is unavailable",o.push(m);continue}if(u.type==="number"){const b=l(a[u.key]),f=d(a[u.key]);if(!Number.isFinite(f)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`"${b}" is not a valid number`,r.push(`${u.label}: not a valid number`),o.push(m);continue}if(/year/.test(u.key)&&(f<1800||f>new Date().getFullYear()+2)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`${f} is outside the plausible range`,r.push(`${u.label}: implausible value ${f}`),o.push(m);continue}a[u.key]=f,m.status="filled",m.value=String(f),i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m);continue}if(u.type==="select"&&u.options&&u.options.length){const b=oi({options:u.options.map(f=>({value:f}))},l(a[u.key]));if(b==null){m.status="flagged",m.note=`"${l(a[u.key])}" does not match any option â€” left empty`,r.push(`${u.label}: no matching option`),delete a[u.key],n.add(u.key),o.push(m);continue}a[u.key]=b,m.status="filled",m.value=b,b!==l(t?.[u.key])&&(m.note="matched to the closest option"),o.push(m);continue}let h=l(a[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&h.length>120&&!["title"].includes(u.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",r.push(`${u.label}: suspiciously long value`)),a[u.key]=h,m.status="filled",m.value=h.length>48?h.slice(0,48)+"â€¦":h,i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m)}if(e&&e.length){const u=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(m=>{u.has(m)||delete a[m]})}a.missing_fields=o.filter(u=>u.status==="missing").map(u=>u.key),a.estimated=o.filter(u=>u.status==="estimated").map(u=>u.key);const c={total:o.length,filled:o.filter(u=>u.status==="filled").length,estimated:o.filter(u=>u.status==="estimated").length,flagged:o.filter(u=>u.status==="flagged").length,missing:o.filter(u=>u.status==="missing").length};return{specs:a,checklist:o,flags:r,summary:c}}function ni(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[o.status]||""}</span><span><b>${s(o.label)}</b> <span class="text-gray-600">(${s(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${s(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${s(o.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  `,"text-blue-300"),p(`Scan done — auto-publishing ${r.length} product${r.length>1?"s":""}â€¦`,"info"),He(r[0],0)};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const l=document.createElement("style");l.id="_pubspin-style",l.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(l)}}catch{}const r=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=o)};try{const l=new FormData(i),d={};let c=0;for(const[b,f]of l.entries())if(b==="images"){d.images=d.images||[];const w=String(f);f&&!w.startsWith("blob:")?d.images.push(w):w.startsWith("blob:")&&c++}else b==="tags"?(d.tags=d.tags||[],d.tags.push(f)):d[b]=f;if(c&&!(d.images||[]).length){r(),p("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}d.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",d.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const u=l.get("action")==="draft",m=b=>Nt(b),y=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],w={};for(const x of f){const S=b[x];if(x==="real_price"){const v=S!=null&&String(S).trim()!==""?parseFloat(S):null;w[x]=v!=null&&Number.isFinite(v)&&v>0?Math.round(v):null;continue}w[x]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const x=m(b.safety_features);w.safety_features=x.length?x:null}return w};if(a){let b=null;try{const{data:_}=await g.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();_&&(b=he(_))}catch{}if(b||(b=he((window._productsData||[]).find(_=>_.property_id===a))),b||(b=he(Ve?Ve(a):null)),!b)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const f=(_,j)=>{const et=_===""||_==null?"":_,ke=j===""||j==null?"":j;return String(et).trim()===String(ke).trim()},w={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(_=>{f(d[_],b[_])||(w[_]=d[_]==null||d[_]===""?null:d[_])});const x=d.price===""||d.price==null?null:parseFloat(d.price);f(x,b.price)||(w.price=x==null?b.price:Math.max(O,Math.min(Q,x)));const S=d.stock_quantity===""||d.stock_quantity==null?null:parseInt(d.stock_quantity,10);f(S,b.stock_quantity)||(w.stock_quantity=Number.isFinite(S)?S:null);const v=m(d.features_text);f(v.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(w.features=v);const P=d.tags||[];f(P.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(w.tags=P);const E=m(d.highlights_text);f(E.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(w.highlights=E);const M=m(d.seo_keywords_text);f(M.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(w.seo_keywords=M);const k=d.images||[];f(k.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(w.images=k);const U=k.find(_=>typeof _=="string"&&Le(_))||null;f(U,b.video_url)||(w.video_url=U);const N=d.is_featured==="on";!!b.is_featured!==N&&(w.is_featured=N);const B=u?!1:d.is_active==="on";!!b.is_active!==B&&(w.is_active=B);const Ie=y(d),pe={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Ie};if(JSON.stringify(pe)!==JSON.stringify(b.specifications||{})&&(w.specifications=pe),Object.keys(w).length===0){p("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(ze(t,a))}catch{}p("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),R();return}const ee={...b,...w,property_id:a,updated_at:new Date().toISOString()};delete ee.id;const me=await ba(ee);if(me.error){r();const _=At(me.error,u?"Draft save":"Product publish");p(_,"error");try{let j=i.querySelector(".__publish-error-banner");j||(j=document.createElement("div"),j.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(j)),j.textContent=_}catch{}return}try{It(ee)}catch{}try{const _=(window._productsData||[]).findIndex(j=>j.property_id===a);_>=0&&(window._productsData[_]=ee)}catch{}p(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(w).length} change${Object.keys(w).length>1?"s":""}).`)}else{if(!d.title||!d.title.trim())throw new Error("A product title is required.");if(d.price===""||d.price==null||!isFinite(parseFloat(d.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!d.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:d.subcategory||null,title:d.title.trim(),description:d.description||"",price:Math.max(O,Math.min(Q,parseFloat(d.price)||0)),currency:d.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:d.is_active==="on",is_featured:d.is_featured==="on",brand:d.brand||null,color:d.color||null,size:d.size||null,condition:d.condition||null,warranty:d.warranty||null,availability_status:d.availability_status||"In Stock",stock_quantity:d.stock_quantity?parseInt(d.stock_quantity):null,images:d.images||[],video_url:(d.images||[]).find(S=>typeof S=="string"&&Le(S))||null,features:m(d.features_text).length?m(d.features_text):d.tags||[],tags:d.tags||[],highlights:m(d.highlights_text),seo_keywords:m(d.seo_keywords_text),is_ai_generated:!!d.catalog_template_id,ai_generated_fields:d.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:y(d)},w=Yt();f.property_id=w;const x=await ba(f);if(x.error){r();const S=At(x.error,"Product publish");p(S,"error");try{let v=i.querySelector(".__publish-error-banner");v||(v=document.createElement("div"),v.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(v)),v.textContent=S}catch{}return}try{It({...f,property_id:f.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...f})}catch{}p(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}be&&ge++,r();try{localStorage.removeItem(ze(t,a))}catch{}const h=Be;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(h)){R();return}R()}catch(l){const d=l&&l.message&&!/failed to fetch|networkerror/i.test(String(l.message))?l.message:At(l,"Product publish");be&&Z++,r(),p(d,"error")}};window.editProduct=async function(e){const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Ve(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){let a=null;try{const{data:n}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(a=he(n))}catch{}if(a||(a=he((window._productsData||[]).find(n=>n.property_id===e))),!a||!a.property_id){Ct(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),R();return}delete a.id,a.property_id=e,a.is_active=t,a.availability_status=t?"In Stock":"Out of Stock";const{error:i}=await g.from("showroom_listings").upsert(a,{onConflict:"property_id"});if(i){if(X(i))return p(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Ct(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),R();return}p(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:o,updated_at:r,...l}=a,d=Yt();await g.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await g.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),R())};const jt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function wt(){const e=document.getElementById("content");try{const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?mt().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(ie)){const o=new Set(i.map(l=>l.property_id)),r=ie.filter(l=>l.listing_type==="property"&&l.property_id&&!o.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await zt()}catch{}const n=new Set(gt());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Ba("property","Real Estate"),i=e.country_code||"US",n=e.currency||Wt(i);G(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
