import"./preload-helper-CS1eXPs2.js";import{a as Ma,g as Ra,C as _e,A as Da}from"./localization-DxUGQRcV.js";import{supabase as p}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as ja,upsertLocalShowroomListing as Fe,getLocalShowroomListingById as St,listLocalShowroomListings as At}from"./local-showroom-store-JrQn_yOW.js";import{g as It,s as Fa,l as Ua,a as Oa,b as qa}from"./payment-settings-R0jbexV2.js";import{S as j}from"./showroom-data-BT2ougk1.js";import{getCatalogCategory as Pt,getCatalogCategories as Na,generateProduct as vt}from"./catalog-BzyCL9ZE.js";import{getHiddenCatalogIds as Et,saveCatalogHidden as Ha,resetHiddenCatalogIds as Ga,loadHiddenCatalogIds as za}from"./catalog-hidden-store-BJoPnRIT.js";const F=1,J=5e6,Wa=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Va=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Ct=[...Wa,...Va];function Xe(e){return Ma[e]||"USD"}function Tt(e,t){return Ct.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Ka(e,t){const a=Math.max(F,Math.min(J,Number(e)||F));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Ja(e,t,a,s,i){const r=Ka(s,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${i}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Bt({templateId:e,listingType:t,category:a,countryCode:s,currency:i,price:r}){const n=Ct.find(h=>h.id===e&&h.listingType===t);if(!n)return null;const o=Ra(s)||_e[0],d=i||Xe(o.code),c=[o.name].filter(Boolean).join(", "),m={category:n.category||a||(t==="property"?"Real Estate":"Other"),subcategory:n.subcategory||n.label,title:t==="property"?`${n.label} in ${o.name}`:n.label,description:Ja(n,o,d,r,c),currency:d,features:[...n.features],highlights:[...n.highlights||[]],seo_keywords:[...new Set([n.category,n.subcategory,n.label,...t==="property"?[o.name]:[],...n.keywords||[]].filter(Boolean))],requiredImageCount:n.requiredImageCount||0};return t==="property"?{...m,country:o.name,country_code:o.code,product_location:o.name,property_type:n.propertyType||n.label,bedrooms:n.bedrooms??null,bathrooms:n.bathrooms??null,building_size:n.buildingSize||"",land_size:n.landSize||"",furnished:n.furnished||""}:{...m,brand:n.brand||"",model:n.model||"",color:n.color||"",size:n.size||"",condition:n.condition||"New"}}const Lt="weverseonlineshop@gmail.com",Mt="kco_ai_ad_override_fallback_v1",Rt="Weverse Online Shop",Dt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Qa="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),Ya=`${Qa}/functions/v1/ai-admin-assistant`,Xa=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Za={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},jt=[...Da].sort();let k={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Ft(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function N(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function W(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function Ze(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const es=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function Q(e){const t={};if(!e||typeof e!="object")return t;for(const a of es)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),s=document.getElementById("toast-msg"),i=a.querySelector("i[data-lucide]");if(!a||!s)return;s.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};i&&(i.setAttribute("data-lucide",r[t]||"info"),i.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function R(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,s]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"—"];return`<span class="badge ${a}">${s}</span>`}function z(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function M(e,t,a,s,i=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=Za[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ut(),closeSidebar();const s=document.getElementById("content");s&&(s.innerHTML=ce()),window.lucide&&lucide.createIcons(),({dashboard:ys,products:C,properties:Ae,catalog:ne,orders:oa,customers:Ns,reviews:ot,messages:na,coupons:Ie,ads:re,notifications:Gs,ai:ts,n8n:is,"ai-settings":ua,"ai-marketing":Te,"homepage-branding":Le,content:vi,seo:wi,email:_i,analytics:xi,security:Be,activity:ki,brand:Me,"payment-settings":Ye,backup:$i,settings:Si,publish:Re,"general-ai":as}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=ae("construction","Coming Soon",`${t} is being built.`))}))()};async function ts(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}async function as(){const e=document.getElementById("content");if(e)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=(t||[]).map(r=>({id:r.property_id,title:r.title,category:r.category,listing_type:r.listing_type,price:r.price,brand:r.brand,features:r.features,tags:r.tags,is_active:r.is_active,description:r.description,images:r.images})).slice(0,50);e.innerHTML=`
      ...
      </div>`,window.aiChatHistory=[],Ot(),ss(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${l(t.message)}</div>`)}}function Ot(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function ss(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function is(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Z="kco_admin_remember",et="kco_login_attempts",Ue=5,rs=15*60*1e3;function T(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function os(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ke(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function ue(e){return String(e||"").trim().toLowerCase()}function ns(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");e?.email&&!ue(e.email)&&localStorage.removeItem(Z)}catch{localStorage.removeItem(Z)}}function ls(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");return ue(e?.email)}catch{return""}}function tt(){ns();const e=ls(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Lt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function ds(){return`${window.location.origin}/admin.html`}function X(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ke(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function E(e,t,a=""){const s=document.getElementById(e);s&&(s.disabled=t,t?s.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(s.innerHTML=a),window.lucide&&lucide.createIcons())}function qt(){try{return JSON.parse(localStorage.getItem(et)||'{"count":0}')}catch{return{count:0}}}function Nt(){const e=qt();return e.count=(e.count||0)+1,e.count>=Ue&&(e.lockedUntil=Date.now()+rs),localStorage.setItem(et,JSON.stringify(e)),e}function Ht(){localStorage.removeItem(et)}function Gt(){const e=qt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Ht(),null):Math.ceil(t/6e4)}async function q(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await cs(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function cs(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function zt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:s}=await p.rpc("is_current_user_admin");t=!0,a=!!s}catch{t=!1}return t?a:ue(e.email)===Lt}async function us(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){he(),fs();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await zt(t.user)){const{data:{currentUser:s}}=await p.auth.getUser(),i=await p.auth.mfa.getAuthenticatorAssuranceLevel(),r=i.data?.currentLevel;if(i.data?.nextLevel==="aal2"&&r!=="aal2"){k.user=t.user,he(),X("2fa"),at();return}k.user=t.user,$e();return}ps()}function he(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function ps(){he(),X("login"),tt(),Wt(),Vt(),at(),ms();const e=Gt();e&&(T(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function ms(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Wt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",gs),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>X("forgot")))}async function gs(e){e.preventDefault();const t=Gt();if(t){T(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),s=ue(a?.value);if(!s){T("Enter your admin email address."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const i=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;E("login-btn",!0),ke();const{data:n,error:o}=await p.auth.signInWithPassword({email:s,password:i});if(o||!n.user){const b=String(o?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){T("Authentication is temporarily unavailable due to configuration. Please contact support."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){T("Network error while signing in. Check your connection and try again."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){T("Your admin email is not confirmed yet. Open your verification email and confirm first."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Nt(),g=Ue-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${Ue} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;T(v),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await q(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await zt(n.user)){await p.auth.signOut(),T(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await q(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(Z,JSON.stringify({email:s,ts:Date.now()})):localStorage.removeItem(Z),Ht(),k.user=n.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),X("2fa"),at(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await q(n.user.id,"login_success"),E("login-btn",!1),$e()}function at(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",xt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",s=>{s.target.value=s.target.value.replace(/\D/g,"").slice(0,6),s.target.value.length===6&&xt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,X("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const i=document.getElementById("backup-code");i&&i.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",bs))}async function xt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){T("Enter the 6-digit code from your authenticator app.");return}E("verify-2fa-btn",!0),ke();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){T("No 2FA factor found. Please re-login."),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:s,error:i}=await p.auth.mfa.challenge({factorId:a.id});if(i)throw i;const{error:r}=await p.auth.mfa.verify({factorId:a.id,challengeId:s.id,code:e});if(r)throw r;await q(k.user.id,"login_2fa_success"),E("verify-2fa-btn",!1),$e()}catch(t){Nt(),T(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function bs(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){T("Enter a backup recovery code.");return}E("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){T("No backup codes found."),E("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!i.used)){T("Backup code not found or already used."),E("verify-backup-btn",!1,"Use Backup Code");return}const s=t.backup_codes.map(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof i=="object"?i:{code:i},used:!0}:i);await p.from("admin_2fa").update({backup_codes:s}).eq("user_id",k.user.id),await q(k.user.id,"login_backup_code_used"),$e()}catch(t){T(t.message),E("verify-backup-btn",!1,"Use Backup Code")}}function Vt(){document.getElementById("back-to-login")?.addEventListener("click",()=>X("login")),document.getElementById("send-reset-btn")?.addEventListener("click",hs)}async function hs(){const e=document.getElementById("reset-email"),t=ue(e?.value);if(!t){T("Enter your admin email address to receive a reset link.");return}E("send-reset-btn",!0),ke();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:ds()});if(E("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){T(a.message);return}os("Reset link sent! Check your inbox and open it from this device to continue.")}function fs(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:s}=await p.auth.updateUser({password:e});if(s){a&&(a.textContent=s.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function $e(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&k.user&&(t.textContent=k.user.email||"Admin"),tt(),navigate("dashboard")}window.adminSignOut=async function(){k.user&&await q(k.user.id,"logout"),await p.auth.signOut(),k.user=null,he(),X("login"),tt(),Wt(),Vt()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(k.user&&await q(k.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),k.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function ys(){const e=document.getElementById("content");try{const[t,a,s,i]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),r=t.data||[],n=a.data||[],o=n.filter(w=>["approved","payment_approved","delivered"].includes(w.status)).reduce((w,G)=>w+(parseFloat(G.amount)||0),0),d=n.filter(w=>["pending","pending_verification","processing"].includes(w.status)).length,c=r.filter(w=>w.listing_type!=="property").length,m=r.filter(w=>w.listing_type==="property").length,h=r.filter(w=>w.listing_type!=="property"&&w.is_active).length,b=s.count||0,f=i.count||0,g=(i.data||[]).filter(w=>!w.is_approved).length,v=new Date,H=n.filter(w=>{const G=new Date(w.created_at);return G.getMonth()===v.getMonth()&&G.getFullYear()===v.getFullYear()}).filter(w=>["approved","payment_approved","delivered"].includes(w.status)).reduce((w,G)=>w+(parseFloat(G.amount)||0),0),V=n.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${_s()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${M("Total Orders",n.length,"shopping-bag","blue",`${d} pending`)}
            ...
            ${V.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':V.map(w=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${W(w.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),Qt(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}async function C(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),s=new Set,i=[];for(const o of a?[]:t||[])o&&o.property_id&&!s.has(o.property_id)&&(s.add(o.property_id),i.push(o));for(const o of At().filter(d=>d.listing_type!=="property"))o&&o.property_id&&!s.has(o.property_id)&&(s.add(o.property_id),i.push(o));if(Array.isArray(j))for(const o of j.filter(d=>d.listing_type!=="property"&&d.property_id))s.has(o.property_id)||(s.add(o.property_id),i.push(o));i.sort((o,d)=>new Date(d.created_at||0)-new Date(o.created_at||0));const r=[...new Set(i.map(o=>o.category).filter(Boolean))].sort((o,d)=>o.localeCompare(d)),n=[...new Set(i.flatMap(o=>Array.isArray(o.tags)?o.tags:[]).filter(Boolean))].sort((o,d)=>o.localeCompare(d));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ${M("Total Products",i.length,"package","blue")}
          ${M("Published",i.filter(o=>!!o.is_active).length,"badge-check","emerald")}
          ${M("Draft / Hidden",i.filter(o=>!o.is_active).length,"file-clock","amber")}
          ${M("Featured",i.filter(o=>!!o.is_featured).length,"sparkles","violet")}
          ${M("Inventory Units",i.reduce((o,d)=>o+(parseInt(d.stock_quantity,10)||0),0),"boxes","blue")}
          ${M("Avg Price",`$${Math.round(i.reduce((o,d)=>o+(parseFloat(d.price)||0),0)/Math.max(i.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(r.length?r:Yt).map(o=>`<option value="${l(o)}" ${(window._productFilters.category||"")===o?"selected":""}>${l(o)}</option>`).join("")}
            </select>
            <select id="prod-tag-filter" class="input-field" onchange="filterProducts()">
              <option value="">All Tags</option>
              ${n.map(o=>`<option value="${l(o)}" ${(window._productFilters.tag||"")===o?"selected":""}>${l(o)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=i,Kt(i),filterProducts(),updateBulkBar(),fa(),_a(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function Y(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Oe(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function vs(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function st(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function qe(e){return parseInt(e.views??e.view_count??0,10)||0}function Ne(e){return parseInt(e.sales??e.sales_count??0,10)||0}function it(e){return e.sku||e.property_id||"N/A"}function xs(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Oe(e),s=st(e),i=window._productSelection?.has(e.property_id),r=R(s==="archived"?"inactive":s==="active"?"active":"inactive"),n=N(e.created_at),o=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${s}" data-featured="${o?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${i?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      <input type="checkbox" class="prod-check accent-blue-500 w-5 h-5 mt-1 shrink-0" value="${e.property_id}" ${i?"checked":""} onclick="event.stopPropagation()" onchange="toggleProductSelection('${e.property_id}', this.checked)">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${l(it(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${l(vs(e))}</p></div>
    ...
    <div class="flex flex-wrap gap-2 mt-auto">
      ...
      <button onclick="event.stopPropagation();${d}" class="btn-press px-4 py-3.5 rounded-2xl text-sm font-bold ${m} transition">${c}</button>
  ...
  </article>`}function ws(e,t){const a=[...e],s=i=>new Date(i||0).getTime()||0;return t==="oldest"?a.sort((i,r)=>s(i.created_at)-s(r.created_at)):t==="price-high"?a.sort((i,r)=>Y(r.price)-Y(i.price)):t==="price-low"?a.sort((i,r)=>Y(i.price)-Y(r.price)):t==="sales-high"?a.sort((i,r)=>Ne(r)-Ne(i)):t==="views-high"?a.sort((i,r)=>qe(r)-qe(i)):a.sort((i,r)=>s(r.created_at)-s(i.created_at)),a}function Kt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),s=document.getElementById("products-result-count");t&&(t.innerHTML=e.map(xs).join(""),s&&(s.textContent=String(e.length)),a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons())}function Jt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(s=>{const i=s.images&&s.images[0]?s.images[0]:"/fallback.svg",r=st(s),n=window._productSelection?.has(s.property_id),o=s.is_active?`unpublishProduct('${s.property_id}')`:`publishProduct('${s.property_id}')`,d=s.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${s.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${s.property_id}')">
              <input type="checkbox" class="prod-check accent-blue-500" value="${s.property_id}" ${n?"checked":""} onclick="event.stopPropagation()" onchange="toggleProductSelection('${s.property_id}', this.checked)">
              <img src="${l(i)}" class="w-9 h-9 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">
              <div class="min-w-0">
                <p class="text-xs font-bold text-white truncate max-w-[160px]">${l(s.title||"Untitled Product")}</p>
                <p class="text-[10px] font-mono text-gray-500">${l(it(s))}</p>
              </div>
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${l(s.category||"Uncategorized")}</span></td>
          <td><span class="text-xs font-bold text-emerald-400">$${Y(s.price).toLocaleString()}</span></td>
          <td><span class="text-xs text-gray-300">${s.stock_quantity!=null?l(s.stock_quantity):"Unlimited"}</span></td>
          <td>${R(r==="archived"?"inactive":r==="active"?"active":"inactive")}</td>
          <td><span class="text-xs text-gray-500">${N(s.created_at)}</span></td>
          <td>
            <div class="flex gap-1">
              <button onclick="editProduct('${s.property_id}')" class="btn-press p-1.5 text-blue-400 hover:bg-blue-500/10 rounded-lg transition" title="Edit"><i data-lucide="pencil" class="w-3.5 h-3.5"></i></button>
              <button onclick="openProductAiAssistant('${s.property_id}','products')" class="btn-press p-1.5 text-fuchsia-400 hover:bg-fuchsia-500/10 rounded-lg transition" title="AI Assistant"><i data-lucide="sparkles" class="w-3.5 h-3.5"></i></button>
              <button onclick="quickEditProduct('${s.property_id}')" class="btn-press p-1.5 text-indigo-400 hover:bg-indigo-500/10 rounded-lg transition" title="Quick Edit"><i data-lucide="sliders-horizontal" class="w-3.5 h-3.5"></i></button>
              <button onclick="${o}" class="btn-press p-1.5 ${s.is_active?"text-amber-400 hover:bg-amber-500/10":"text-emerald-400 hover:bg-emerald-500/10"} rounded-lg transition" title="${d}"><i data-lucide="${s.is_active?"eye-off":"eye"}" class="w-3.5 h-3.5"></i></button>
              <button onclick="archiveProduct('${s.property_id}')" class="btn-press p-1.5 text-red-400 hover:bg-red-500/10 rounded-lg transition" title="Archive"><i data-lucide="archive" class="w-3.5 h-3.5"></i></button>
            </div>
          </td>
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),s=document.getElementById("view-card-btn"),i=document.getElementById("view-table-btn"),r=document.getElementById("products-empty"),n=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&Jt(n)),s&&s.classList.toggle("active",e!=="table"),i&&i.classList.toggle("active",e==="table"),r&&r.classList.toggle("hidden",n.length>0)};window.filterProducts=function(){const e=window._productFilters||{};e.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),e.category=document.getElementById("prod-cat-filter")?.value||"",e.tag=document.getElementById("prod-tag-filter")?.value||"",e.status=document.getElementById("prod-status-filter")?.value||"",e.featured=document.getElementById("prod-featured-filter")?.value||"",e.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=e;const t=(window._productsData||[]).filter(s=>{const i=[s.title,s.brand,s.category,it(s),Oe(s).join(" "),s.description].join(" ").toLowerCase();return!(e.search&&!i.includes(e.search)||e.category&&(s.category||"")!==e.category||e.tag&&!Oe(s).includes(e.tag)||e.status&&st(s)!==e.status||e.featured&&e.featured==="featured"!=!!s.is_featured)}),a=ws(t,e.sort);Kt(a),window._productView==="table"&&Jt(a)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const s=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(s):window._productSelection.delete(s)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function Se(){return window._productSelection?[...window._productSelection]:[]}function D(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function He(e,t,a){return e&&D(e)?(u(`⚠️ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),u(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=Se();if(!t.length)return;const a=await Promise.all(t.map(r=>{const n=Q((window._productsData||[]).find(o=>o.property_id===r));return p.from("showroom_listings").upsert({...n,property_id:r,is_active:e},{onConflict:"property_id"})}));if(a.some(r=>r.error&&D(r.error))){u(`⚠️ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,C();return}const i=a.filter(r=>r.error).length;u(`${t.length-i}/${t.length} products ${e?"published":"unpublished"}${i?` (${i} failed: ${a.find(r=>r.error)?.error?.message||"error"})`:""}`,i?"error":"success"),window._productSelection=new Set,C()};window.bulkDuplicateProducts=async function(){const e=Se();if(e.length){for(const t of e)await duplicateProduct(t,!0);u(`${e.length} products duplicated`),window._productSelection=new Set,C()}};window.bulkArchive=async function(){const e=Se();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(i=>p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",i)));if(t.some(i=>i.error&&D(i.error))){u("⚠️ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,C();return}const s=t.filter(i=>i.error).length;u(`${e.length-s}/${e.length} products archived${s?` (${s} failed)`:""}`,s?"error":"success"),window._productSelection=new Set,C()};window.bulkDeleteProducts=async function(){const e=Se();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(i=>p.from("showroom_listings").delete().eq("property_id",i)));if(t.some(i=>i.error&&D(i.error))){u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,C();return}const s=t.filter(i=>i.error).length;u(`${e.length-s}/${e.length} products deleted${s?` (${s} failed)`:""}`,s?"error":"success"),window._productSelection=new Set,C()};window.previewProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(s=>s.property_id===e)||t.data;if(!a)return u("Product not found","error");B(`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">${(a.images||[]).slice(0,8).map(s=>`<img src="${l(s)}" class="w-12 h-12 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">`).join("")}</div>
          </div>
          <div class="space-y-2">
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(s=>s.property_id===e)||t.data;if(!a)return u("Product not found","error");B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`)};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),s={title:a.get("title")||"Untitled Product",price:Math.max(F,Math.min(J,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"},i=Q((window._productsData||[]).find(n=>n.property_id===t)),{error:r}=await p.from("showroom_listings").upsert({...i,...s,property_id:t},{onConflict:"property_id"});if(r){if(D(r)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),z(),C();return}ja(t,s),u("Quick edit saved locally","info")}else u("Quick edit saved");z(),C()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await p.from("showroom_listings").delete().eq("property_id",e);if(t)return D(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Delete failed: "+t.message,"error");u("Product deleted"),C()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?

This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return D(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),C()};window.openProductMoreActions=function(e){B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`)};window.filterProductCategoryChoices=function(e){const t=String(e||"").trim().toLowerCase();document.querySelectorAll("#product-category-grid [data-category]").forEach(a=>{const s=!t||a.dataset.category.includes(t);a.classList.toggle("hidden",!s)})};window.showAddProductStep2=function(e,t={}){const a=!!t.property_id,s=Tt("product",e),i=t.currency||"USD";B(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div class="sm:col-span-2"><label class="lbl">Catalog Template</label><select class="input-field" name="catalog_template_id" id="pf-catalog_template_id" onchange="applyProductCatalogTemplate('${l(e)}')"><option value="">Choose a template...</option>${s.map(r=>`<option value="${r.id}">${l(r.label)} - ${l(r.subcategory||r.category)}</option>`).join("")}</select></div>
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Zt(i)}</select></div>
            </div>
          ...
          <div class="space-y-3">
            ...
            <div id="image-url-inputs">
              ${(t.images||[]).map((r,n)=>`<input type="hidden" name="images" id="img-url-${n}" value="${l(r)}">`).join("")}
            </div>
          </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-4 glass-soft border border-blue-500/15 rounded-2xl">
              ...
              <p class="text-sm text-gray-500 mt-1">Allowed price range is ${F} to ${J} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),aa(),sa(),ea("pf-price"),ze(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>ze(e,"pricing")),Fs(e,t.property_id||""),window._pfEscapeHandler=r=>{r.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),z(),C()};const Ss=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],As=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Is=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Ps=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Es=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Cs(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Ss:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?As:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Is:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Ps:Es}function O(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function ve(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&O(t)}function Ts(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(O("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",s=[...t.querySelectorAll('input[name="images"]')].map(i=>i.value).filter(i=>i&&!String(i).startsWith("blob:"));if(!s.length){e||O("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",ve(!0,"AI is analyzing your images…");try{const i=await S.analyzeImages(s,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!i){O("AI analysis unavailable — add a Gemini, Groq, or OpenRouter API key in AI Settings (or install Ollama locally).","warn");return}Bs(i,a),O("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(i){O("AI analysis failed: "+(i.message||i),"error"),e||u("AI analysis failed: "+(i.message||i),"error")}finally{t.dataset.aiBusy="0",ve(!1)}};function Bs(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const s=(d,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c))},i=(d,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};s("title",e.title),s("description",e.description),s("subcategory",e.subcategory),s("brand",e.brand),s("model",e.model),s("color",e.color),s("size",e.size),s("material",e.material),s("storage",e.storage),s("ram",e.ram),s("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||s("condition",e.condition),i("features_text",e.features),i("highlights_text",e.highlights),i("seo_keywords_text",e.seo_keywords);const r=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(d=>{r[d]!=null&&String(r[d]).trim()!==""&&s(d,r[d])}),Array.isArray(r.safety_features)&&i("safety_features",r.safety_features);const n=e.category?String(e.category).trim():"",o=document.getElementById("pf-ai-detected");o&&n&&n.toLowerCase()!==String(t||"").toLowerCase()&&(o.classList.remove("hidden"),o.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
      <span class="text-[11px] text-amber-200">AI detected category: <b>${l(n)}</b></span>
      <button type="button" onclick="switchProductFormCategory('${l(n).replace(/'/g,"\\'")}')" class="btn-press px-2 py-1 rounded-lg text-[10px] font-bold bg-amber-500 text-[#111827] hover:bg-amber-400 transition">Switch category</button>
    ...
    </div>`),window.lucide&&lucide.createIcons(),Ve()}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},s=new FormData(t);for(const[i,r]of s.entries())i==="images"?(a.images=a.images||[],r&&!String(r).startsWith("blob:")&&a.images.push(String(r))):i==="tags"?(a.tags=a.tags||[],a.tags.push(r)):a[i]=r;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),s=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),r=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!r||r==="/fallback.svg"){O("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const n=Cs(t),o=Math.min(s,n.length);e.dataset.aiBusy="1";const d=document.getElementById("pf-ai-generated");d&&(d.innerHTML="");let c=0;try{for(let m=0;m<o;m++){ve(!0,`Generating ${m+1}/${o} — ${n[m]}…`);try{const h=await S.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${n[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,r,1);if(h&&h[0]){const b=await Ms(h[0]);b&&(Ls(b),c+=1)}}catch(h){O(`Stopped at ${m}/${o}: ${h.message||h}`,"error");break}}c?(O(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):O("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",ve(!1)}};function Ls(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,s=document.createElement("div");s.innerHTML=pe(e,a),t.appendChild(s.firstElementChild),se(),ge(),ie();const i=document.getElementById("pf-ai-generated");if(i){const r=document.createElement("div");r.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",r.innerHTML=`<img src="${l(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,i.appendChild(r)}}async function Ms(e){try{const a=await(await fetch(e)).blob(),s=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),i=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${s}`;return await me(new File([a],i,{type:a.type}))}catch{return e}}function pe(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function aa(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Rs(t.dataTransfer.files)}))}function sa(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>se()})}window.handleImageUpload=async function(e){await ia(e.target.files)};async function Rs(e){await ia(e)}async function ia(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const s=await me(a);if(s){const i=t.children.length,r=document.createElement("div");r.innerHTML=pe(s,i),t.appendChild(r.firstElementChild),se()}}ge(),ie(),window.lucide&&lucide.createIcons(),Ts()}}async function me(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),s=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:i}=await p.storage.from("product-images").upload(s,e,{contentType:e.type,upsert:!1});if(i)return URL.createObjectURL(e);const{data:r}=p.storage.from("product-images").getPublicUrl(s);return r.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),se(),ge(),ie()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const s=t.files[0];if(!s.type.startsWith("image/")){u("Please choose an image file.","error");return}const i=await me(s);if(!i)return;const n=[...a.querySelectorAll(".img-thumb")][e];if(!n)return;const o=n.querySelector("img");o&&(o.src=i),se(),ge(),ie(),u("Image replaced. Save changes to apply.","info")};function se(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,s)=>{const i=a.querySelector("img");if(!i)return;const r=document.createElement("input");r.type="hidden",r.name="images",r.id=`img-url-${s}`,r.value=i.src,t.appendChild(r),a.dataset.index=s;const n=a.querySelector(".rm");n&&n.setAttribute("onclick",`removeImage(${s})`);const o=a.querySelector(".rp");o&&o.setAttribute("onclick",`document.getElementById('rp-input-${s}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${s}`,d.onchange=()=>replaceImage(s,d))}))}function ge(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ie(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,s=a>=24;t.textContent=s?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(s?"text-emerald-300":"text-gray-400");const i=document.querySelector('#product-form [name="is_active"]');s&&i&&!i.checked&&(i.checked=!0)}function ra(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Ds(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[s,i]of t.entries())s==="images"?i&&!String(i).startsWith("blob:")&&a.images.push(String(i)):s==="tags"?a.tags.push(String(i)):a.fields[s]=String(i);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function js(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([i,r])=>{const n=e.querySelector(`[name="${i}"]`);n&&(n.type==="checkbox"?n.checked=r==="on"||r===!0:n.value=r==null?"":String(r))});const s=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(i=>{i.checked=s.includes(i.value)}),Array.isArray(t.images)){const i=document.getElementById("image-preview");i&&(i.innerHTML=t.images.map((r,n)=>pe(r,n)).join(""),se(),ge(),ie())}return!0}function Ve(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",s=t.querySelector('[name="brand"]')?.value||"N/A",i=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,n=r===""||r==null?"Unlimited":r,o=k.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(h=>h.value),c=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
      <div><span class="text-gray-500">Title</span><p class="text-white font-semibold">${l(a)}</p></div>
      <div><span class="text-gray-500">Brand</span><p class="text-white font-semibold">${l(s)}</p></div>
      <div><span class="text-gray-500">Price</span><p class="text-emerald-300 font-semibold">$${i.toLocaleString()}</p></div>
    ...
    ${o?`<div class="text-gray-500 mt-1">Category: ${l(o)}</div>`:""}
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",s=e.querySelector('[name="description"]')?.value||"No description yet.",i=e.querySelector('[name="brand"]')?.value||"N/A",r=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,n=e.dataset.category||"Product",o=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${R(d?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${l(n)}</span></div>
            <p class="text-sm text-gray-400">${l(s)}</p>
            <div class="grid grid-cols-2 gap-2 text-xs">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Stock</span><p class="text-gray-200 font-bold">${l(o)}</p></div>
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2 col-span-2"><span class="text-gray-500">Brand</span><p class="text-gray-200 font-bold">${l(i)}</p></div>
            </div>
          </div>
        </div>
      </div>
    </div>`)};function Fs(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const s=ra(e,t),i=document.getElementById("product-autosave-note");try{const d=localStorage.getItem(s);if(d){const c=JSON.parse(d);js(a,c)&&i&&(i.textContent="Autosave restored from your last session.",i.classList.remove("hidden"))}}catch{}const r=()=>{try{localStorage.setItem(s,JSON.stringify(Ds(a))),i&&(i.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,i.classList.remove("hidden"))}catch{}Ve()};let n;const o=()=>{clearTimeout(n),n=setTimeout(r,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",o),d.addEventListener("change",o)}),Ve(),ie()}window.saveProduct=async function(e,t,a){e.preventDefault();const s=e.target,i=s.querySelector("[type=submit][name=action][value=publish]"),r=a?"One-Click Publish Changes":"One-Click Publish Product";i&&(i.disabled=!0,i.textContent="Saving…");try{const n=new FormData(s),o={};for(const[b,f]of n.entries())b==="images"?(o.images=o.images||[],f&&!String(f).startsWith("blob:")&&o.images.push(String(f))):b==="tags"?(o.tags=o.tags||[],o.tags.push(f)):o[b]=f;o.is_featured=s.querySelector('[name="is_featured"]')?.checked?"on":"",o.is_active=s.querySelector('[name="is_active"]')?.checked?"on":"";const d=n.get("action")==="draft",c=b=>Ge(b),m=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],g={};for(const v of f){const $=b[v];g[v]=$!=null&&String($).trim()!==""?$:null}if(b.safety_features){const v=c(b.safety_features);g.safety_features=v.length?v:null}return g};let h;if(a){let b=Q((window._productsData||[]).find(L=>L.property_id===a));if(!b){const{data:L}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=L?Q(L):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(L,De)=>{const Ba=L===""||L==null?"":L,La=De===""||De==null?"":De;return String(Ba).trim()===String(La).trim()},g={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(L=>{f(o[L],b[L])||(g[L]=o[L]==null||o[L]===""?null:o[L])});const v=o.price===""||o.price==null?null:parseFloat(o.price);f(v,b.price)||(g.price=v==null?b.price:Math.max(F,Math.min(J,v)));const $=o.stock_quantity===""||o.stock_quantity==null?null:parseInt(o.stock_quantity,10);f($,b.stock_quantity)||(g.stock_quantity=Number.isFinite($)?$:null);const H=c(o.features_text);f(H.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(g.features=H);const V=o.tags||[];f(V.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(g.tags=V);const w=c(o.highlights_text);f(w.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(g.highlights=w);const G=c(o.seo_keywords_text);f(G.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(g.seo_keywords=G);const gt=o.images||[];f(gt.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(g.images=gt);const bt=o.is_featured==="on";!!b.is_featured!==bt&&(g.is_featured=bt);const ht=d?!1:o.is_active==="on"||(o.images||[]).length>=24;!!b.is_active!==ht&&(g.is_active=ht);const Ta=m(o),ft={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Ta};if(JSON.stringify(ft)!==JSON.stringify(b.specifications||{})&&(g.specifications=ft),Object.keys(g).length===0){u("No changes detected — nothing was saved.","info"),i&&(i.disabled=!1,i.textContent=r);return}const yt={...b,...g,property_id:a,updated_at:new Date().toISOString()};if({error:h}=await p.from("showroom_listings").upsert(yt,{onConflict:"property_id"}),h&&He(h,()=>Fe(yt),"Product update")){i&&(i.disabled=!1,i.textContent=r);return}u(d?"Draft saved!":`Product updated — ${Object.keys(g).length} change(s) saved.`)}else{const b=parseInt(o.required_image_count||"0",10)||(rt.includes(t)?24:0);if(ta(b,o.images||[],"This listing"),!o.title||!o.title.trim())throw new Error("A product title is required.");if(o.price===""||o.price==null||!isFinite(parseFloat(o.price)))throw new Error("A price is required.");if(!o.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:o.subcategory||null,title:o.title.trim(),description:o.description||"",price:Math.max(F,Math.min(J,parseFloat(o.price)||0)),currency:o.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:o.is_active==="on"||(o.images||[]).length>=24,is_featured:o.is_featured==="on",brand:o.brand||null,color:o.color||null,size:o.size||null,condition:o.condition||null,warranty:o.warranty||null,availability_status:o.availability_status||"In Stock",stock_quantity:o.stock_quantity?parseInt(o.stock_quantity):null,images:o.images||[],features:c(o.features_text).length?c(o.features_text):o.tags||[],tags:o.tags||[],highlights:c(o.highlights_text),seo_keywords:c(o.seo_keywords_text),is_ai_generated:!!o.catalog_template_id,ai_generated_fields:o.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(o)},g=Ze();if(f.property_id=g,{error:h}=await p.from("showroom_listings").insert(f),h&&He(h,()=>Fe({...f,property_id:f.property_id}),"Product publish")){i&&(i.disabled=!1,i.textContent=r);return}u(d?"Draft saved!":"Product published!")}try{localStorage.removeItem(ra(t,a))}catch{}closeProductFormModal()}catch(n){u("Error: "+n.message,"error"),i&&(i.disabled=!1,i.textContent=r)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let s=a?null:t;if(s||(s=St(e)),s||(s=(Array.isArray(j)?j.find(i=>i.property_id===e):null)||null),!s)return u("Product not found","error");showAddProductStep2(s.category||"Other",s)};window.toggleProductActive=async function(e,t){const a=Q((window._productsData||[]).find(i=>i.property_id===e)),{error:s}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(s)return D(s)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${s.message}`,"error");u(t?"Product published":"Product unpublished"),C()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:s,property_id:i,created_at:r,updated_at:n,...o}=a,d=Ze();await p.from("showroom_listings").insert({...o,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),C())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),C())};const Us=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ae(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let s=a?At().filter(i=>i.listing_type==="property"):t||[];if(Array.isArray(j)){const i=new Set(s.map(n=>n.property_id)),r=j.filter(n=>n.listing_type==="property"&&n.property_id&&!i.has(n.property_id));r.length&&(s=s.concat(r))}s.sort((i,r)=>new Date(r.created_at||0)-new Date(i.created_at||0)),window._propertiesData=s,e.innerHTML=`
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody>
                ${s.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':s.map(i=>`<tr>
                    <td>
                      <div class="flex items-center gap-2.5">
                        <img src="${l((i.images||[])[0]||"/fallback.svg")}" class="w-9 h-9 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">
                        <div><p class="text-xs font-bold text-white truncate max-w-[160px]">${l(i.title)}</p><p class="text-[10px] font-mono text-gray-500">${l(i.property_id)}</p></div>
                      </div>
                    </td>
                    <td><span class="text-xs text-gray-300">${l(i.property_type||i.category)}</span></td>
                    <td class="hidden sm:table-cell"><span class="text-xs text-gray-400">${l([i.city,i.state,i.country].filter(Boolean).join(", ")||"—")}</span></td>
                    <td class="hidden md:table-cell"><span class="text-xs font-bold text-emerald-400">$${parseFloat(i.price||0).toLocaleString()}</span></td>
                    <td>${R(i.listing_status||"sale")} ${R(i.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
                        <button onclick="editProperty('${i.property_id}')" class="btn-press p-1.5 text-blue-400 hover:bg-blue-500/10 rounded-lg transition"><i data-lucide="pencil" class="w-3.5 h-3.5"></i></button>
                        <button onclick="openProductAiAssistant('${i.property_id}','properties')" class="btn-press p-1.5 text-fuchsia-400 hover:bg-fuchsia-500/10 rounded-lg transition" title="AI Assistant"><i data-lucide="sparkles" class="w-3.5 h-3.5"></i></button>
                        <button onclick="archiveProduct('${i.property_id}')" class="btn-press p-1.5 text-red-400 hover:bg-red-500/10 rounded-lg transition"><i data-lucide="archive" class="w-3.5 h-3.5"></i></button>
                      </div>
                    </td>
                  </tr>`).join("")}
              </tbody>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Tt("property","Real Estate"),s=e.country_code||"US",i=e.currency||Xe(s);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${Xt(s)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${Zt(i)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Us.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    </div>`),aa(),sa(),ea("ppf-price"),window.syncPropertyCountry=function(){wt("ppf")},wt("ppf"),We("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>We("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),s=Object.fromEntries(a.entries()),i=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),r=(s.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),n=t?0:parseInt(s.required_image_count||"24",10)||24;ta(n,i,"This property");const o={listing_type:"property",category:s.property_type||"Real Estate",subcategory:s.subcategory||null,title:s.title,description:s.description||"",price:Math.max(F,Math.min(J,parseFloat(s.price)||0)),currency:s.currency||"USD",country:s.country||"",country_code:(s.country_code||"").toUpperCase(),state:s.state||"",city:s.city||"",town:s.town||"",product_location:s.product_location||"",latitude:s.latitude?parseFloat(s.latitude):null,longitude:s.longitude?parseFloat(s.longitude):null,property_type:s.property_type||"",listing_status:s.listing_status||"sale",bedrooms:s.bedrooms?parseInt(s.bedrooms):null,bathrooms:s.bathrooms?parseInt(s.bathrooms):null,building_size:s.building_size||"",land_size:s.land_size||"",parking_spaces:s.parking_spaces?parseInt(s.parking_spaces):null,furnished:s.furnished||"",features:r,images:i,highlights:Ge(s.highlights_text),seo_keywords:Ge(s.seo_keywords_text),is_ai_generated:!!s.catalog_template_id,ai_generated_fields:s.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:s.is_active==="on"};let d;if(t){o.property_id=t;const c=Q((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:d}=await p.from("showroom_listings").upsert({...c,...o},{onConflict:"property_id"}))}else o.property_id=Ze(),{error:d}=await p.from("showroom_listings").insert(o);d&&He(d,()=>Fe({...o,property_id:t||o.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),z(),Ae())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let s=a?null:t;s||(s=St(e)),s||(s=(Array.isArray(j)?j.find(i=>i.property_id===e):null)||null),s&&showAddPropertyModal(s)};const Os=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function oa(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],s=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let i="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Orders Manager</h2>
        <div class="flex gap-2 flex-wrap" id="order-tabs">
          ${s.map(r=>`<button class="tab-btn ${r==="All"?"active":""}" onclick="filterOrders('${r}')">${r}</button>`).join("")}
        </div>
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(r=>qs(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function qs(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
  ...
  </tr>`}window.filterOrders=function(e){document.querySelectorAll("#order-tabs .tab-btn").forEach(t=>t.classList.toggle("active",t.textContent===e)),document.querySelectorAll(".order-row").forEach(t=>{const a=t.dataset.status||"",s=e==="All"||e==="Pending"&&["pending_verification","payment_received","order_placed"].includes(a)||e==="Paid"&&["payment_approved"].includes(a)||e==="Processing"&&["processing"].includes(a)||e==="Shipped"&&["shipped","in_transit","out_for_delivery"].includes(a)||e==="Delivered"&&a==="delivered"||e==="Cancelled"&&["cancelled","rejected"].includes(a);t.style.display=s?"":"none"})};window.searchOrders=function(e){const t=e.toLowerCase();document.querySelectorAll(".order-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewOrder=async function(e){const t=(window._ordersData||[]).find(a=>a.id===e);t&&B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Ft(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",W(t.created_at)]].map(([a,s])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(s)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Os.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),z(),oa()};async function Ns(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(s=>`<tr class="cust-row" data-search="${l(s.display_name)} ${l(s.user_id)}">
                    <td>
                      <div class="flex items-center gap-2.5">
                        ...
                        <div>
                          <p class="text-xs font-bold text-white">${l(s.display_name||"Anonymous")}</p>
                          <p class="text-[10px] font-mono text-gray-500">${l(s.user_id?.slice(0,12))}…</p>
                        </div>
                      </div>
                    </td>
                    <td class="hidden sm:table-cell"><span class="text-xs text-gray-300">${l(s.country_code||"—")}</span></td>
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${N(s.created_at)}</span></td>
                    <td>
                      <button onclick="viewCustomer('${s.user_id}')" class="btn-press p-1.5 text-blue-400 hover:bg-blue-500/10 rounded-lg transition"><i data-lucide="eye" class="w-3.5 h-3.5"></i></button>
                    </td>
                  </tr>`).join("")}
              </tbody>
            </table>
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(s=>s.user_id===e);if(!t)return;const{data:a}=await p.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${N(t.created_at)} · ${l(t.country_code||"Unknown country")}</p>
          </div>
        </div>
        <h4 class="text-xs font-bold text-gray-400 uppercase mb-3">Purchase History</h4>
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(s=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${l(s.order_number)}</p><p class="text-[10px] text-gray-500">${W(s.created_at)}</p></div>
            <div class="flex items-center gap-2">${R(s.status)}<span class="text-xs font-bold text-emerald-400">$${parseFloat(s.amount).toLocaleString()}</span></div>
          </div>`).join("")}
      </div>
    </div>`)};async function ot(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],s=a.filter(i=>!i.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="flex gap-2">
          ...
          <button onclick="filterReviewTab('pending')" class="tab-btn" id="rtab-pending">Pending (${s})</button>
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?ae("star","No Reviews","Customer reviews will appear here."):a.map(i=>Hs(i)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Hs(e){const t=Array.from({length:5},(a,s)=>s<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),ot()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),ot())};async function na(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?ae("message-circle","No Messages","Customer support messages will appear here."):a.map(s=>`
              <div class="glass-soft border ${s.is_read?"border-blue-500/10":"border-blue-400/30"} rounded-xl p-4 ${s.is_read?"":"ring-1 ring-blue-500/10"}">
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      <span class="text-xs font-black text-white">${l(s.full_name||s.name||"Anonymous")}</span>
                      ${s.is_read?"":'<span class="badge bg-blue-500/15 text-blue-400 border-blue-500/20">New</span>'}
                      <span class="text-[10px] text-gray-500 ml-auto">${W(s.created_at)}</span>
                    </div>
                    <p class="text-[11px] text-blue-400 mb-1">${l(s.email||"—")}</p>
                    <p class="text-xs text-gray-300">${l(s.message||s.body||"—")}</p>
                    ${s.subject?`<p class="text-[11px] text-gray-500 mt-1">Subject: ${l(s.subject)}</p>`:""}
                  </div>
                  <div class="flex gap-1 shrink-0">
                    <button onclick="markMsgRead('${s.id}')" class="btn-press p-1.5 text-emerald-400 hover:bg-emerald-500/10 rounded-lg transition" title="Mark Read"><i data-lucide="check" class="w-4 h-4"></i></button>
                  </div>
                </div>
              </div>`).join("")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(s=>`<tr>
                    <td><code class="text-xs font-mono font-black text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded">${l(s.code)}</code></td>
                    <td><span class="text-xs text-gray-300">${s.discount_type==="percent"?"Percentage":"Fixed Amount"}</span></td>
                    <td><span class="text-xs font-bold text-emerald-400">${s.discount_type==="percent"?s.discount_value+"%":"$"+s.discount_value}</span></td>
                    <td class="hidden sm:table-cell"><span class="text-xs text-gray-400">${s.min_amount?"$"+s.min_amount:"—"}</span></td>
                    <td>${R(s.is_active?"active":"inactive")}</td>
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${N(s.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
                        <button onclick="toggleCoupon('${s.id}',${!s.is_active})" class="btn-press p-1.5 ${s.is_active?"text-amber-400 hover:bg-amber-500/10":"text-emerald-400 hover:bg-emerald-500/10"} rounded-lg transition"><i data-lucide="${s.is_active?"eye-off":"eye"}" class="w-3.5 h-3.5"></i></button>
                        <button onclick="deleteCoupon('${s.id}')" class="btn-press p-1.5 text-red-400 hover:bg-red-500/10 rounded-lg transition"><i data-lucide="trash-2" class="w-3.5 h-3.5"></i></button>
                      </div>
                    </td>
                  </tr>`).join("")}
              </tbody>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddCouponModal=function(){B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),s={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:i}=await p.from("coupons").insert(s);if(i){u(i.message,"error");return}u("Coupon created!"),z(),Ie()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Ie()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Ie())};async function Gs(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?ae("bell","No Notifications","System notifications will appear here."):a.map(s=>`
              <div class="glass-soft border border-blue-500/10 rounded-xl p-3.5 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-0.5">
                    <span class="text-xs font-bold text-white">${l(s.subject||s.event_type||"Notification")}</span>
                    ${R(s.status)}
                    <span class="text-[10px] text-gray-500 ml-auto">${W(s.created_at)}</span>
                  </div>
                  <p class="text-[11px] text-gray-400">${l(s.recipient||s.order_number)}</p>
                </div>
              </div>`).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const la=["Featured","Sponsored","Featured Collection","Discover","Promotion"],zs=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let be=null;function Ws(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function Vs(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${l(e.link_target||"")}</span>`}function Ks(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function da(){if(be)return be;const e=[],t=new Set,a=[],s=r=>{if(!r||!r.property_id)return;e.push({id:r.property_id,title:r.title||r.property_id});const n=r.category||"";n&&!t.has(n)&&(t.add(n),a.push(n))};try{j.forEach(s)}catch{}try{const{data:r,error:n}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!n&&r&&r.forEach(s)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(r=>{t.has(r)||(t.add(r),a.push(r))}),be={products:e,categories:a,sections:zs},be}async function Js(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),s=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),i=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:r}=await p.storage.from("advertisements").upload(i,e,{contentType:e.type,upsert:!1});if(r)return u("Upload failed: "+r.message,"error"),null;const{data:n}=p.storage.from("advertisements").getPublicUrl(i);return{url:n.publicUrl,isVideo:s}}catch{return u("Upload failed","error"),null}}function xe(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const s=document.getElementById("ad-hidden-video"),i=document.getElementById("ad-hidden-image");s&&(s.value=t?e:""),i&&(i.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const s=await Js(t);if(!s){e.value="";return}xe(s.url,s.isVideo);const i=document.getElementById("ad-media-url");i&&(i.value=s.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);xe(t,a)};function nt(e,t,a){const s=document.getElementById("ad-link-target-wrap");if(!s)return;if(!t||t==="none"){s.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let i="";t==="product"?i='<option value="">Select a product…</option>'+e.products.map(r=>`<option value="${l(r.id)}" ${String(a)===String(r.id)?"selected":""}>${l(r.id)} — ${l((r.title||"").slice(0,60))}</option>`).join(""):t==="category"?i='<option value="">Select a category…</option>'+e.categories.map(r=>`<option value="${l(r)}" ${a===r?"selected":""}>${l(r)}</option>`).join(""):t==="section"&&(i='<option value="">Select a section…</option>'+e.sections.map(r=>`<option value="${l(r.id)}" ${a===r.id?"selected":""}>${l(r.name)}</option>`).join("")),s.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${i}</select>`}function ca(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";nt(e,a,"")};window.showAddAdModal=async function(){const e=await da();window._adLinkCache=e,B(ca(null)),nt(e,"none","")};window.showEditAdModal=async function(e){const t=await da();window._adLinkCache=t;const{data:a}=await p.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}B(ca(a)),a.image_url?xe(a.image_url,!1):a.video_url&&xe(a.video_url,!0),nt(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),s=a.id||"",i={title:a.title,description:a.description||"",ad_label:la.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!i.image_url&&!i.video_url){u("Add an image or video for the ad","error");return}const r=e.target.querySelector('button[type="submit"]');r&&(r.disabled=!0);try{if(s){const{error:n}=await p.from("promotions").update(i).eq("id",s);if(n)throw n;u("Ad updated!")}else{const{error:n}=await p.from("promotions").insert(i);if(n)throw n;u("Ad created!")}}catch(n){u(n.message||"Save failed","error"),r&&(r.disabled=!1);return}z(),re()};window.togglePromo=async function(e,t){const{error:a}=await p.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),re()};window.moveAd=async function(e,t){try{const{data:a,error:s}=await p.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(s)throw s;const i=a||[],r=i.findIndex(c=>c.id===e),n=r+t;if(r<0||n<0||n>=i.length){u("Already at the edge","info");return}const o=i[r],d=i[n];await p.from("promotions").update({sort_order:d.sort_order}).eq("id",o.id),await p.from("promotions").update({sort_order:o.sort_order}).eq("id",d.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}re()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await p.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const s=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(i=>{const r=/\/object\/public\/advertisements\/(.+)$/.exec(i);return r?decodeURIComponent(r[1]):null}).filter(Boolean);if(s.length)try{await p.storage.from("advertisements").remove(s)}catch{}}const{error:a}=await p.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}re()}};async function re(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border ${d?U.border[o.color]+" "+U.bg[o.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${o.id}">
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${o.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${U.text[o.color]} hover:underline flex items-center gap-0.5">
        ...
        </div>`};const{data:a}=await p.from("ai_settings").select("*").limit(1).maybeSingle(),s=a||{},i=s.active_provider||"gemini",r=ee.slice(0,10),n=ee.slice(10);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
            ...
            ${[{key:"customer_ai_enabled",label:"Customer AI Chatbot",desc:"Customers can chat with AI on your website",val:s.customer_ai_enabled},{key:"product_ai_enabled",label:"AI Product Creation",desc:"AI auto-fills product descriptions",val:s.product_ai_enabled!==!1},{key:"ai_code_assist",label:"AI Code Assistant",desc:"AI helps build and edit your website code",val:s.ai_code_assist!==!1},{key:"ai_moderation",label:"AI Content Moderation",desc:"Auto-approve/reject customer reviews using AI",val:s.ai_moderation}].map(o=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.highlightAI=function(e){ee.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const s=t.id===e;a.className=`glass-soft border ${s?U.border[t.color]+" "+U.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const i=a.querySelector("input[type=radio] + span");i&&(i.className=`text-[9px] font-bold ${s?U.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),s={active_provider:a.active_provider||"gemini",customer_ai_enabled:a.customer_ai_enabled==="on",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};ee.forEach(i=>{a[i.mf]&&(s[i.mf]=a[i.mf]);const r=(a[i.kf]||"").trim();r&&!r.startsWith("••••")&&r!==""&&(s[i.kf]=r)}),s.gemini_key&&(s.gemini_api_key=s.gemini_key),s.openai_key&&(s.openai_api_key=s.openai_key);try{const{data:i}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let r;if(i?.id?{error:r}=await p.from("ai_settings").update(s).eq("id",i.id):{error:r}=await p.from("ai_settings").insert(s),r){u("Save failed: "+r.message,"error"),console.error("[AI Save]",r);return}await S.reload(),u("✅ AI settings saved! Keys are active and auto-switch is ON.","success"),setTimeout(()=>ua(),600)}catch(i){u("Unexpected error: "+i.message,"error"),console.error("[AI Save]",i)}};const je="kco_ai_cooldowns",Qs=60*1e3,S={_cfg:null,async reload(){const{data:e,error:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.openai_key&&a.openai_api_key&&(a.openai_key=a.openai_api_key),!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async getOrderedProviders(){const e=await this.getConfig(),t=e.active_provider||"gemini",a=this._getCooldowns(),s=Date.now(),i=ee.filter(d=>e[d.kf]&&e[d.kf].trim()),r=i.filter(d=>d.id===t),n=i.filter(d=>d.id!==t);return[...r,...n].sort((d,c)=>{const m=(a[d.id]||0)>s?1:0,h=(a[c.id]||0)>s?1:0;return m-h})},_getCooldowns(){try{return JSON.parse(localStorage.getItem(je)||"{}")}catch{return{}}},_setCooldown(e){const t=this._getCooldowns();t[e]=Date.now()+Qs,localStorage.setItem(je,JSON.stringify(t))},_clearCooldown(e){const t=this._getCooldowns();delete t[e],localStorage.setItem(je,JSON.stringify(t))},_buildRequest(e,t,a,s){const i=t[e.kf],r=t[e.mf]||e.dm;switch(e.id){case"gemini":{const n=`https://generativelanguage.googleapis.com/v1beta/models/${r}:generateContent?key=${i}`,o={contents:a.map(d=>({role:d.role==="assistant"?"model":"user",parts:[{text:d.content}]}))};return{url:n,method:"POST",headers:{"Content-Type":"application/json"},body:o,parse:d=>d.candidates?.[0]?.content?.parts?.[0]?.text||""}}case"groq":{const n="https://api.groq.com/openai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"deepseek":{const n="https://api.deepseek.com/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"mistral":{const n="https://api.mistral.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"cohere":{const n="https://api.cohere.com/v2/chat",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.message?.content?.[0]?.text||d.text||""}}case"huggingface":{const n=`https://api-inference.huggingface.co/models/${r}/v1/chat/completions`,o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"together":{const n="https://api.together.xyz/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"openrouter":{const n="https://openrouter.ai/api/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`,"HTTP-Referer":window.location.origin},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"cerebras":{const n="https://api.cerebras.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"fireworks":{const n="https://api.fireworks.ai/inference/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"github":{const n="https://models.inference.ai.azure.com/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"cloudflare":{const[n,o]=(i||"").split("|"),d=`https://api.cloudflare.com/client/v4/accounts/${n}/ai/run/${r}`,c={messages:a};return{url:d,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o||i}`},body:c,parse:m=>m.result?.response||""}}case"sambanova":{const n="https://api.sambanova.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"hyperbolic":{const n="https://api.hyperbolic.xyz/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"novita":{const n="https://api.novita.ai/v3/openai/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"perplexity":{const n="https://api.perplexity.ai/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"replicate":{const n="https://openai-compat.replicate.com/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"ai21":{const n="https://api.ai21.com/studio/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"lepton":{const n=`https://${r.replace(/[^a-z0-9-]/g,"")}.lepton.run/api/v1/chat/completions`,o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:d=>d.choices?.[0]?.message?.content||""}}case"ollama":return{url:`${(i||"http://localhost:11434").replace(/\/$/,"")}/api/chat`,method:"POST",headers:{"Content-Type":"application/json"},body:{model:r,messages:a,stream:!1},parse:c=>c.message?.content||""};default:return null}},async chat(e,{maxTokens:t=2e3,onProviderSwitch:a=null}={}){const s=await this.getOrderedProviders(),i=await this.getConfig(),r=this._getCooldowns(),n=Date.now();if(s.length===0)throw new Error("No AI providers configured. Go to AI Settings and add at least one API key.");let o=null;for(const d of s){if((r[d.id]||0)>n){const c=Math.ceil(((r[d.id]||0)-n)/1e3);console.log(`[AI] Skipping ${d.name} — rate limited for ${c}s more`);continue}if(d.id==="ollama"){const c=this._buildRequest(d,i,e,t);if(!c)continue;try{a&&a(d.name);const m=await fetch(c.url,{method:c.method,headers:c.headers,body:JSON.stringify(c.body),signal:AbortSignal.timeout(6e4)});if(m.status===429||m.status===503){this._setCooldown(d.id),console.warn(`[AI] ${d.name} rate limited (${m.status}), switching to next provider…`),o=new Error(`${d.name} rate limited`);continue}if(!m.ok){const f=await m.text().catch(()=>"");o=new Error(`${d.name} error ${m.status}: ${f.slice(0,100)}`),console.warn(`[AI] ${d.name} failed:`,o.message);continue}const h=await m.json(),b=c.parse(h);if(!b){o=new Error(`${d.name} returned empty response`);continue}return this._clearCooldown(d.id),console.log(`[AI] ✓ Response from ${d.name}`),{text:b,provider:d.name,model:i[d.mf]||d.dm}}catch(m){m.name==="TimeoutError"?(this._setCooldown(d.id),o=new Error(`${d.name} timed out`)):o=m,console.warn(`[AI] ${d.name} exception:`,m.message)}continue}try{a&&a(d.name);const c=e[e.length-1],m={action:"chat",message:String(c?.content||"").trim(),history:e.slice(0,-1).map(g=>({role:g.role,content:String(g.content||"")})),provider_override:d.id,max_tokens:t},h=await this._callEdge(m);if(h&&h.response)return this._clearCooldown(d.id),console.log(`[AI] ✓ Response from ${d.name} (via edge function)`),{text:h.response,provider:d.name,model:h.model||i[d.mf]||d.dm};const b=String(h?.error||"empty response"),f=b.toLowerCase();f.includes("429")||f.includes("rate limit")||f.includes("quota")?(this._setCooldown(d.id),console.warn(`[AI] ${d.name} rate limited (${b.slice(0,80)}), switching to next provider…`),o=new Error(`${d.name} rate limited`)):(o=new Error(`${d.name} error: ${b.slice(0,200)}`),console.warn(`[AI] ${d.name} failed:`,o.message))}catch(c){c.name==="TimeoutError"?(this._setCooldown(d.id),o=new Error(`${d.name} timed out`)):o=c,console.warn(`[AI] ${d.name} exception:`,c.message)}}throw new Error(o?.message||"All AI providers failed or are rate limited. Add more API keys in AI Settings.")},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig(),t=this._getCooldowns(),a=Date.now();return ee.map(s=>({id:s.id,name:s.name,color:s.color,hasKey:!!e[s.kf]?.trim(),isActive:e.active_provider===s.id,cooldownUntil:t[s.id]||0,isCoolingDown:(t[s.id]||0)>a,remainingSec:Math.max(0,Math.ceil(((t[s.id]||0)-a)/1e3))}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is.
...
- Respond with valid JSON only.`,s=[];for(const i of(e||[]).slice(0,4)){const r=await this._fetchImageAsDataUrl(i);r&&s.push(r)}if(!s.length)throw new Error("Could not read the uploaded images.");try{const i=await this._callEdge({action:"vision",images:s,prompt:a,max_tokens:4096});if(i&&i.success&&i.text){const r=de(i.text);if(r)return{...r,_aiProvider:i.provider,_aiModel:i.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(i&&i.error||"Vision service unavailable.")}catch{try{const o=await this._tryLocalOllamaVision(a,s);if(o)return o}catch{}const r=`

(No image analysis is available right now. The product is currently categorized as "${t.category||"Unknown"}"${t.existingTitle?` and titled "${t.existingTitle}"`:""}. Base your content on that plus general knowledge of typical products in this category. Do not invent specific specs or prices you cannot know.)`,n=await this.chat([{role:"user",content:a+r}],{maxTokens:4e3});return de(n.text)}},async _callEdge(e){let t="";try{t=(await p.auth.getSession())?.data?.session?.access_token||""}catch{}return await(await fetch(Ya,{method:"POST",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}},body:JSON.stringify(e),signal:AbortSignal.timeout(12e4)})).json().catch(()=>({}))},async _fetchImageAsDataUrl(e){try{const t=await fetch(e).then(a=>a.blob());return!t||!t.size?null:t.size<18e5?`data:${t.type||"image/jpeg"};base64,${await _t(t)}`:await this._downscaleImage(t,1200)}catch{return null}},async _downscaleImage(e,t){const a=URL.createObjectURL(e);try{const s=new Image;await new Promise((d,c)=>{s.onload=d,s.onerror=c,s.src=a});const i=Math.min(1,t/Math.max(s.width,s.height)),r=Math.max(1,Math.round(s.width*i)),n=Math.max(1,Math.round(s.height*i)),o=document.createElement("canvas");return o.width=r,o.height=n,o.getContext("2d").drawImage(s,0,0,r,n),o.toDataURL("image/jpeg",.82)}finally{URL.revokeObjectURL(a)}},async _tryLocalOllamaVision(e,t){const a=await this.getConfig(),s=String(a.ollama_url||"http://localhost:11434").replace(/\/$/,""),i=[a.ollama_model,"llava","llama3.2-vision","moondream"].filter(Boolean);for(const r of i)try{const n=await fetch(`${s}/api/generate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:r,prompt:e,images:t.map(m=>String(m).split(",")[1]||m),stream:!1,options:{temperature:.3,num_predict:4096}}),signal:AbortSignal.timeout(12e4)});if(!n.ok)continue;const o=await n.json(),d=String(o?.response||"").trim();if(!d)continue;const c=de(d);return c?{...c,_aiProvider:"Ollama (Local)",_aiModel:r}:{description:d,_aiProvider:"Ollama (Local)",_aiModel:r}}catch{}return null},async generateImages(e,t,a=1){let s=null;if(t)try{s=await this._fetchImageAsDataUrl(t)}catch{}try{const i=await this._callEdge({action:"generate_images",prompt:e,reference_url:s,count:a||1});if(i&&i.success&&Array.isArray(i.images)&&i.images.length)return i.images;throw new Error(i&&i.error||"Image generation service unavailable.")}catch(i){try{const r=await this._tryLocalComfyUI(e);if(r&&r.length)return r}catch{}try{const r=await this._tryLocalOllamaImage(e);if(r&&r.length)return r}catch{}throw new Error(`AI image generation failed: ${i.message||i}. Add a Google Gemini API key in AI Settings, or configure local ComfyUI/Ollama.`)}},async _tryLocalComfyUI(e){const t=await this.getConfig(),a=String(t.comfyui_workflow||"").trim();if(!a)return null;let s;try{s=JSON.parse(a)}catch{return null}const i=String(t.comfyui_url||"http://127.0.0.1:8188").replace(/\/$/,""),r=String(t.comfyui_input_node||"image");String(t.comfyui_output_node||"image");const n=s[r]||Object.values(s)[0];if(!n)return null;n.inputs={...n.inputs||{},text:e};const o=`web-${Date.now()}`,d=await fetch(`${i}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:s,client_id:o}),signal:AbortSignal.timeout(6e4)});if(!d.ok)return null;const{prompt_id:c}=await d.json();if(!c)return null;const m=Date.now()+18e4;for(;Date.now()<m;){await new Promise(h=>setTimeout(h,1e3));try{const h=await fetch(`${i}/history/${c}`,{signal:AbortSignal.timeout(1e4)});if(!h.ok)continue;const f=(await h.json())[c];if(!f)continue;const v=Object.values(f.outputs||{}).flatMap($=>Array.isArray($.images)?$.images:[]);if(v.length)return Promise.all(v.slice(0,4).map(async $=>{const H=await fetch(`${i}/view?filename=${encodeURIComponent($.filename)}&subfolder=${encodeURIComponent($.subfolder||"")}&type=${encodeURIComponent($.type||"output")}`,{signal:AbortSignal.timeout(3e4)});if(!H.ok)return null;const V=await H.blob();return await _t(V).then(w=>`data:${V.type||"image/png"};base64,${w}`)})).then($=>$.filter(Boolean))}catch{}}return null},async _tryLocalOllamaImage(e){const t=await this.getConfig(),a=String(t.ollama_url||"http://localhost:11434").replace(/\/$/,""),s=[t.ollama_image_model||t.ollama_model,"llava"].filter(Boolean);for(const i of s)try{const r=await fetch(`${a}/api/generate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:i,prompt:e,stream:!1,options:{num_predict:512}}),signal:AbortSignal.timeout(12e4)});if(!r.ok)continue;const n=await r.json(),o=String(n?.images?.[0]||"").trim();if(o)return[`data:image/png;base64,${o}`]}catch{}return null}};function _t(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const s=a.result;if(typeof s=="string"){const i=s.indexOf(",");t(i>=0?s.slice(i+1):s)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=S;window.showAiStatusModal=async function(){const e=await S.getStatus(),t=e.filter(a=>a.hasKey);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const pa=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function Ys(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function ma(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const s of t)s in e&&(a[s]=e[s]);return a}function de(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const s=t.indexOf("{"),i=t.lastIndexOf("}");if(s===-1||i===-1||i<=s)return null;const r=t.slice(s,i+1);try{return JSON.parse(r)}catch{return null}}function kt(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=Ys(e);if(!a)try{const{data:s}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();s&&(a=s)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},A()};function A(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",s=e.busy===!0,r=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    ...
    </div>`).join(""),m=e.suggestions?Zs():"",h=Xs();B(`
    <div class="fixed inset-0 z-[100] bg-[#030712]/92 backdrop-blur-sm flex flex-col" onclick="if(event.target===this)closeModal()">
      ...
      <div class="relative group w-20 h-20 rounded-lg overflow-hidden border ${c?"border-amber-400/70":"border-white/10"}">
        ...
        ${d?`<button onclick="productAiRemoveImageNow(${o})" class="absolute top-0.5 right-0.5 w-5 h-5 rounded-full bg-black/70 hover:bg-red-600 text-white text-[10px] flex items-center justify-center" title="Remove this image from the card now">✕</button>`:""}
      </div>`}).join("");return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    </div>`}function Zs(){const e=y;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
      ...
      <div class="flex items-start gap-3 p-3 rounded-xl bg-white/5 border ${c?"border-emerald-500/25":"border-white/10"}">
        ...
        <div class="min-w-0 flex-1">
          <p class="text-[10px] font-black uppercase tracking-wide text-gray-400">${l(a[n]||n)}</p>
          <p class="text-[11px] text-gray-500 line-through decoration-red-400/60 mt-0.5 break-words">${l(o)}</p>
          <p class="text-[11px] text-emerald-300 font-semibold mt-1 break-words">${l(d)}</p>
        </div>
      </div>`)}const s=Array.isArray(e.product.images)?e.product.images:[],i=Array.isArray(e.suggestions.images_to_remove)?e.suggestions.images_to_remove.filter(n=>s.includes(n)):[],r=[...new Set([...e.removedImages,...i])];if(r.length){const n=e.approved.has("images_to_remove")?"checked":"";t.push(`
      <div class="flex items-start gap-3 p-3 rounded-xl bg-white/5 border ${n?"border-emerald-500/25":"border-white/10"}">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex flex-wrap gap-1.5 mt-1.5">${r.slice(0,12).map(o=>`<img src="${l(o)}" class="w-10 h-10 rounded-md object-cover border border-red-500/40" onerror="this.src='/fallback.svg'">`).join("")}</div>
        </div>
      ...
      <div class="flex items-start gap-3 p-3 rounded-xl bg-white/5 border border-emerald-500/25">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex flex-wrap gap-1.5 mt-1.5">${e.addedImages.map(n=>`<img src="${l(n)}" class="w-10 h-10 rounded-md object-cover border border-emerald-500/40" onerror="this.src='/fallback.svg'">`).join("")}</div>
        </div>
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){y&&(y.instruction=e)};window.productAiQuickAction=function(e){const t=pa.find(a=>a.key===e);!t||!y||(y.instruction=t.prompt,y.quickLabel=t.label,y.quickMode=t.mode||"edit",runProductAiInstruction())};window.productAiToggleApproved=function(e,t){y&&(t?y.approved.add(e):y.approved.delete(e),A())};window.productAiApproveAll=function(){if(!(!y||!y.suggestions)){for(const e of Object.keys(y.suggestions))y.approved.add(e);y.removedImages.size&&y.approved.add("images_to_remove"),A()}};window.productAiToggleRemoveImage=function(e){if(!y)return;const t=Array.isArray(y.product.images)?y.product.images:[],s=[...t,...y.addedImages][e];s&&(e<t.length?y.removedImages.has(s)?y.removedImages.delete(s):y.removedImages.add(s):y.addedImages=y.addedImages.filter(i=>i!==s),A())};window.productAiDetectDuplicates=async function(){if(!y)return;const e=y,t=Array.isArray(e.product.images)?e.product.images:[],a={};t.forEach(i=>{a[i]=(a[i]||0)+1});const s=t.filter((i,r)=>!(a[i]>1&&t.indexOf(i)!==r));if(s.length===t.length){u("No duplicate images found.","info");return}await oe(s,`Removed ${t.length-s.length} duplicate image(s) from the card.`)};window.productAiUploadImages=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=y,a=[...e.files];t.busy=!0,A();const i=[...Array.isArray(t.product.images)?t.product.images:[]];let r=0;for(const n of a){if(!n.type.startsWith("image/"))continue;const o=await me(n);o&&(i.push(o),r+=1)}if(e.value="",t.busy=!1,r){await oe(i,`${r} image(s) uploaded to the card.`);return}u("Upload failed.","error"),A()};function ei(e,t){const a=String(e).toLowerCase();if(/\b(generate|create|make|draw|produce|imagine)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner)\b/.test(a)||/\b(change|swap|replace|edit|remove)\b[\s\S]*\b(background|color|colour)\b/.test(a))return"gen";if(/\bshowroom\b/.test(a)||/\bcompare\b[\s\S]*\b(showroom|product|other|card)\b/.test(a)||/\bscan\b[\s\S]*\b(showroom|product|card|listing|shop|match)\b/.test(a)||/\bmatch(es|ing)?\b/.test(a))return"scan";const s=/\b(rewrite|rephrase|update|fix|improve|optimize|change|make|rename|retitle|set|clean up|cleanup|remove|delete|add)\b/,i=/\b(title|description|price|stock|category|subcategory|brand|name|images?|features|tags|highlights|seo)\b/;return s.test(a)&&i.test(a)?"edit":t?"vision":"chat"}function ti(){const e=y;return(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const s=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",i=`${a.content||""}${s}`.trim();return{role:a.role==="user"?"user":"assistant",content:i}}).filter(a=>a.content)}window.runProductAiInstruction=async function(){const e=y;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const s=e.quickMode||"";e.quickMode="";const i=(e.chatImages||[]).length>0;if(!t&&!a&&!s&&!i)return;const r=t||"Improve this product listing professionally.",n=a||t||(i?"Look at these photos and tell me what you see.":"Improve this product listing professionally."),o=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.messages.push({role:"user",content:n,images:o}),e.busy=!0,A();const d=s||ei(r,i);try{d==="gen"?await ha(r,o):d==="scan"?await oi():d==="edit"?await ai(r,o):d==="vision"?await ii(r,o):await si(r),ga()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`AI error: ${c.message}`,"error")}finally{e.busy=!1,A()}};async function ai(e,t){const a=y,s=ni(a,e);let i="";if(t&&t.length){const o=await S._callEdge({action:"vision",images:t.slice(0,4),prompt:s,max_tokens:4096});if(i=o&&o.text?String(o.text):"",!i)throw new Error(o&&o.error||"The AI could not read the attached photos.")}else i=(await S.prompt(s,{maxTokens:4e3,onProviderSwitch:()=>{}})).text;const r=de(i);if(!r)throw new Error("The AI did not return valid JSON suggestions.");a.suggestions=r,a.approved=new Set(Object.keys(r)),a.approved.add("images_to_remove");const n=(r.summary||"Changes are ready for this product.").trim();a.messages.push({role:"assistant",content:`${n}

✅ Changes are ready below. Tick what you want, then press Save.`}),u("Suggestions ready — review and approve before saving.","info")}async function si(e){const t=y,a=ti(),s=await S._callEdge({action:"chat",message:e,history:a,max_tokens:1200});if(s&&s.response){t.messages.push({role:"assistant",content:String(s.response)});return}throw new Error(s&&s.error||"The AI did not respond.")}async function ii(e,t){const a=y,s=`${e}

If you recognize the product in these photos, say yes and identify exactly what it is, give a typical price range for it, and offer to generate more product photos for this listing. Be friendly and helpful.`,i=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:s,max_tokens:1200}),r=i&&i.text?String(i.text):"";if(!r)throw new Error(i&&i.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:r})}async function ri(){let e=Array.isArray(window._productsData)?window._productsData:[];if(!e.length)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").limit(500);!a&&Array.isArray(t)&&(e=t)}catch{}return(e||[]).filter(t=>t&&t.property_id!==y.pid)}async function oi(){const e=y,t=await ri(),a=JSON.stringify(ma(e.product),null,2),s=t.slice(0,15).map(m=>({title:m.title,category:m.category,subcategory:m.subcategory,price:m.price,currency:m.currency,brand:m.brand,images:Array.isArray(m.images)?m.images.length:0,listing_type:m.listing_type})),i=`You are the AI product manager for the product ${e.pid} in the Weverse Online Shop showroom.
THIS PRODUCT (JSON):
${a}

OTHER PRODUCTS IN THE SAME SHOWROOM (${t.length} found, showing ${s.length}):
...
- Respond with valid JSON only.`,r=await S._callEdge({action:"chat",message:i,history:[],max_tokens:3e3}),n=r&&r.response?String(r.response):"";if(!n)throw new Error(r&&r.error||"The showroom scan returned nothing.");const o=de(n),d=Array.isArray(o&&o.mismatches)?o.mismatches:[],c=Array.isArray(o&&o.matches)?o.matches:[];if(o&&(d.length||c.length||o.summary)){const m={};d.forEach(b=>{b&&b.field&&b.suggested_value!==void 0&&b.suggested_value!==null&&(m[b.field]=b.suggested_value)});const h=["Showroom scan complete:"];c.length&&h.push(...c.map(b=>`✅ ${b}`)),d.length&&h.push(...d.map(b=>`⚠️ ${b.field}: ${b.issue}`)),d.length||h.push("✅ Everything matches the other products in this showroom."),d.length?(m.summary=o.summary||`${d.length} issue(s) found with the showroom.`,e.suggestions=m,e.approved=new Set(Object.keys(m)),e.approved.add("images_to_remove"),h.push("Fixes are ready below. Tick what you want, then press Save.")):e.suggestions=null,e.messages.push({role:"assistant",content:h.join(`
`)}),u("Showroom scan complete.","info");return}e.messages.push({role:"assistant",content:n||"Showroom scan complete."})}async function ha(e,t){const a=y,s=a.product,i=`${e}

(Generate a clean, professional product photo for "${String(s.title||"").trim()||"this product"}" in the Weverse Online Shop.)`;let r=null;t&&t.length?r=t[0]:Array.isArray(s.images)&&s.images[0]&&(r=await S._fetchImageAsDataUrl(s.images[0]));const n=await S._callEdge({action:"generate_images",prompt:i,reference_url:r,count:2});if(n&&Array.isArray(n.images)&&n.images.length){a.generatedImages=n.images,a.lastGenPrompt=e,a.lastGenReference=r,a.messages.push({role:"assistant",content:"Here are your generated images. Tap one to add it to the card, or Regenerate for new variations.",generated:n.images,provider:`${n.provider||"AI"}/${n.model||""}`});return}throw new Error(n&&n.error||"Image generation returned nothing.")}async function Pe(e){try{const t=await fetch(e).then(s=>s.blob());if(!t||!t.size)return null;const a=new File([t],`ai-${Date.now()}.png`,{type:t.type||"image/png"});return await me(a)}catch{return null}}window.productAiUseGeneratedImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const s=await Pe(a);if(t.busy=!1,!s){u("Could not upload the generated image.","error"),A();return}const i=Array.isArray(t.product.images)?t.product.images:[];await oe([...i,s],"Generated image added to the card.")};window.productAiReplaceMainImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const s=await Pe(a);if(t.busy=!1,!s){u("Could not upload the generated image.","error"),A();return}const i=Array.isArray(t.product.images)?t.product.images:[],r=i.length?[s,...i.slice(1)]:[s];await oe(r,"Old main image replaced with the generated one.")};window.productAiUseAllGeneratedImages=async function(){const e=y;if(!e||e.busy||!Array.isArray(e.generatedImages)||!e.generatedImages.length)return;e.busy=!0,A();const a=[...Array.isArray(e.product.images)?e.product.images:[]];let s=0;for(const i of e.generatedImages){const r=await Pe(i);r&&(a.push(r),s+=1)}if(e.busy=!1,s){e.generatedImages=[],await oe(a,`${s} generated image(s) added to the card.`);return}u("Upload failed.","error"),A()};window.productAiRemoveImageNow=async function(e){const t=y;if(!t||t.busy)return;const a=Array.isArray(t.product.images)?t.product.images:[];e<0||e>=a.length||await oe(a.filter((s,i)=>i!==e),"Image removed from the card.")};async function oe(e,t){const a=y;if(!a)return;a.busy=!0,A();const s=Q({...a.product,images:e,property_id:a.pid,updated_at:new Date().toISOString()});try{const{error:i}=await p.from("showroom_listings").upsert(s,{onConflict:"property_id"});if(i)throw i;a.product.images=e,a.removedImages.clear(),u(t,"success"),a.from==="properties"?Ae():C()}catch(i){i&&D(i)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration.","error"):u(`Save failed: ${i&&i.message||"unknown error"}`,"error")}finally{a.busy=!1,A()}}window.productAiRegenerateImage=async function(){const e=y;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,A();try{await ha(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,A()}}};function ni(e,t){const a=e.product;return`You are the AI product manager assistant for the Weverse Online Shop admin dashboard, working on ONE product.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(o=>o!=="images_to_remove"),a={};if(e.suggestions)for(const o of e.approved)o!=="images_to_remove"&&o in e.suggestions&&e.suggestions[o]!==void 0&&(a[o]=e.suggestions[o]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const s=Array.isArray(e.product.images)?e.product.images:[],i=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(o=>i.add(o));const r=[...s.filter(o=>!i.has(o)),...e.addedImages],n=Q({...e.product,...a,images:r,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,A();try{const{error:o}=await p.from("showroom_listings").upsert(n,{onConflict:"property_id"});if(o)throw o;u("Changes saved to Supabase.","success");const d=e.from;y=null,z(),d==="properties"?Ae():C()}catch(o){e.busy=!1,o&&D(o)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${o&&o.message||"unknown error"}`,"error"),A()}};let x=null;const lt=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Scan this photo and publish it in the matching section of my showroom — show me a preview first so I can approve it."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function li(){const e=x;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const s=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",i=`${a.content||""}${s}`.trim();return{role:a.role==="user"?"user":"assistant",content:i}}).filter(a=>a.content):[]}function di(e,t){const a=String(e||"").toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":t?a?"vision":"execute":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":"execute"}function ci(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function fa(){return x||(x={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Upload a photo and tell me what you want: I'll scan it and list the brand, model, year and real details, generate a matching image, or publish it to the showroom (I'll always show you a preview and ask if it's good before publishing). I always scan your showroom first so trucks go where the trucks are, cars where the cars are, homes where the homes are — I never guess or make new sections unless you ask me to. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null,pendingPublish:null},x)}window.openGeneralAi=async function(){fa(),I()};function ui(e){if(!e)return"";const t=(Number(e.price)||0)>0?`$${Number(e.price).toLocaleString()}`:"",a=Array.isArray(e.images)?e.images.slice(0,3):[],s=Array.isArray(e.features)?e.features.slice(0,8):[],i=[e.brand,e.model,e.year,e.property_type].filter(Boolean);return`
    <div class="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4">
      ...
      ${a.length?`<div class="flex flex-wrap gap-2 mb-3">${a.map(r=>`<img src="${l(r)}" class="w-28 h-28 rounded-xl object-cover border border-emerald-500/40 shadow-lg" onerror="this.src='/fallback.svg'">`).join("")}</div>`:""}
      <p class="text-base font-black text-white leading-tight">${l(e.title||"New Product")}</p>
      ${i.length?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${i.map(r=>l(String(r))).join(" · ")}${t?` · ${t}`:""}</p>`:t?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${t}</p>`:""}
      <p class="text-[11px] text-gray-300 mt-2 leading-relaxed whitespace-pre-wrap break-words">${l(e.description||"")}</p>
      ${s.length?`<div class="flex flex-wrap gap-1.5 mt-3">${s.map(r=>`<span class="px-2 py-1 rounded-lg bg-white/5 border border-white/10 text-[9px] text-gray-200">${l(String(r))}</span>`).join("")}</div>`:""}
    ...
    <div class="flex gap-3 items-start">
      ...
      <div class="glass border border-sky-500/20 rounded-3xl rounded-tl-md px-5 py-3.5 min-w-0 max-w-[85%]">
        ...
        ${e.previewDraft?ui(e.previewDraft):""}
    ...
    </div>`}function xa(){const e=x;return!e||!e.pendingPlan?"":`
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${l(ci(e.pendingPlan))}</p>
    ...
    </div>`}function wa(){const e=x;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,s)=>`
    <div class="relative w-14 h-14 rounded-xl overflow-hidden border border-sky-500/40 shrink-0">
      ...
      <button onclick="generalAiRemoveChatImage(${s})" class="absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full bg-red-500 text-white text-xs leading-none flex items-center justify-center shadow" title="Remove image">✕</button>
    </div>`).join(""):""}function I(){document.getElementById("general-ai-embed-scroll")&&_a(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&pi(),Ee()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function pi(){const e=x;if(!e)return;const t=e.busy===!0,s=(Array.isArray(e.messages)?e.messages:[]).map(c=>ya(c)).join(""),i=t?va():"",r=lt.map(c=>`
    ...
    </div>`);const d=document.getElementById("general-ai-input");d&&(d.value=e.instruction||"",d.addEventListener("input",()=>{x&&(x.instruction=d.value)}),d.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Ee()}function _a(){const e=x,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,s=Array.isArray(e.messages)?e.messages:[],i=lt.map(d=>`
    ...
    <div class="flex flex-wrap gap-1.5">${i}</div>
    ${s.map(d=>ya(d)).join("")}
    ${a?va():""}
    ${xa()}
  `;const r=document.getElementById("general-ai-embed-thumbs");r&&(r.innerHTML=wa());const n=document.getElementById("general-ai-embed-send-btn");n&&(n.classList.toggle("opacity-40",a),n.classList.toggle("pointer-events-none",a));const o=document.getElementById("general-ai-embed-input");o&&(o.value=e.instruction||"",o.dataset.gaiBound||(o.dataset.gaiBound="1",o.addEventListener("input",()=>{x&&(x.instruction=o.value)}),o.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),runGeneralAiInstruction())}))),window.lucide&&lucide.createIcons(),Ee()}function Ee(){const e=["general-ai-chat-scroll","general-ai-embed-scroll"];requestAnimationFrame(()=>{for(const t of e){const a=document.getElementById(t);a&&a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}})}window.generalAiChatAttach=function(){document.getElementById("general-ai-chat-image")?.click()};window.generalAiChatImagePicked=async function(e){if(!x||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const s of t){if(!s.type.startsWith("image/"))continue;const i=await ba(s);i&&(x.chatImages.push(i),a+=1)}if(e.value="",a){u(`${a} photo(s) attached. Now type what you want me to do with it (e.g. "scan this and list everything about it", "generate an image exactly like this", or "publish this to the showroom").`,"info");const s=document.getElementById("general-ai-embed-input")||document.getElementById("general-ai-input");s&&s.focus()}I()};window.generalAiRemoveChatImage=function(e){x&&(x.chatImages.splice(e,1),I())};window.generalAiQuickAction=function(e){const t=lt.find(a=>a.key===e);!t||!x||(x.instruction=t.prompt,x.quickLabel=t.label,x.quickMode=t.mode,runGeneralAiInstruction())};window.runGeneralAiInstruction=async function(){const e=x;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const s=e.quickMode||"";e.quickMode="";const i=(e.chatImages||[]).length>0;if(!t&&!a&&!s)return;const r=t||"",n=a||t||(i?"Photo attached — please scan it and list everything you can identify about it.":r),o=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.pendingPlan=null,e.messages.push({role:"user",content:n,images:o}),e.busy=!0,I();const d=s||di(r,i);try{d==="publish"?await ka(r,o):d==="gen"?await $a(r,o):d==="monitor"?await mi():d==="vision"?await gi(r,o):await bi(r,o),Ee()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`General AI error: ${c.message}`,"error")}finally{e.busy=!1,I()}};async function ka(e,t){const a=x,s=await S._callEdge({action:"general_publish",message:e,images:t.slice(0,4),max_tokens:2048});if(!s||s.success!==!0)throw new Error(s&&s.error||"Could not prepare the product card.");if(s.pending&&s.draft){a.pendingPublish={draft:s.draft,instruction:e},a.messages.push({role:"assistant",content:String(s.response||"Here is the card I prepared. Is it good?"),previewDraft:s.preview||s.draft,images:(s.images||[]).slice(0,2)}),I();return}a.messages.push({role:"assistant",content:String(s.response||"Published."),images:(s.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Ce()}window.generalAiConfirmPublish=async function(){const e=x;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=e.pendingPublish.draft;e.pendingPublish=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_publish",mode:"publish",draft:t});if(!a||a.success!==!0)throw new Error(a&&a.error||"Could not publish the product.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||"Published to the showroom.")}`,images:(a.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Ce()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPublish=function(){x&&(x.pendingPublish=null,x.messages.push({role:"assistant",content:"Cancelled — nothing was published."}),I())};window.generalAiOpenPublishFix=function(){const e=document.getElementById("general-ai-publish-fix-box");e&&e.classList.remove("hidden")};window.generalAiRevisePublish=async function(){const e=x;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=document.getElementById("general-ai-publish-fix-input"),a=t?String(t.value||"").trim():"",s=e.pendingPublish.draft,i=e.pendingPublish.instruction||"";e.pendingPublish=null,e.busy=!0,I();try{const r=await S._callEdge({action:"general_publish",mode:"preview",message:i,draft:s,feedback:a||"Make this card more professional and match the showroom style."});if(!r||r.success!==!0)throw new Error(r&&r.error||"Could not revise the card.");if(!r.pending||!r.draft)throw new Error("The AI could not produce a revised card.");e.pendingPublish={draft:r.draft,instruction:i},e.messages.push({role:"assistant",content:String(r.response||"Here is the revised card. Is it good now?"),previewDraft:r.preview||r.draft,images:(r.images||[]).slice(0,2)}),I()}catch(r){e.messages.push({role:"assistant",content:`⚠️ ${r.message}`})}finally{e.busy=!1,I()}};async function $a(e,t){const a=x;let s=null;t&&t.length&&(s=t[0]);const i=s?"The attached image is your SUBJECT — study it carefully and reproduce the SAME thing: the same type of object, subject, brand, model, look, colors, style and background. Keep the identical subject; only improve quality and lighting for a professional look. Do NOT change the subject and do NOT draw a person, woman, man, or face unless the attached image actually shows one. You must match what is in the reference photo.":`Generate a beautiful, high-quality image based on this request: "${e}". Follow the request exactly. If it asks for a specific object, product, vehicle, or scene, draw exactly that — never swap in a different subject, a person, or a random image.`,r=await S._callEdge({action:"generate_images",prompt:`${e}

${i}`,reference_url:s,count:2});if(!r||!Array.isArray(r.images)||!r.images.length)throw new Error(r&&r.error||"Image generation returned nothing.");a.generatedImages=r.images,a.lastGenPrompt=e,a.lastGenReference=s,a.messages.push({role:"assistant",content:"Here are your images — generated to match your reference photo. Tap one to save it to your showroom product images.",generated:r.images,provider:`${r.provider||"AI"}/${r.model||""}`})}async function mi(){const e=x,t=await S._callEdge({action:"general_monitor",max_tokens:3e3});if(!t||t.success!==!0||!t.report)throw new Error(t&&t.error||"Could not scan the showroom.");const a=t.report||{},s=["Showroom scan complete:"];(Array.isArray(a.good)?a.good:[]).forEach(i=>s.push(`✅ ${i}`)),(Array.isArray(a.issues)?a.issues:[]).forEach(i=>s.push(`⚠️ ${i.property_id} (${i.severity||"low"}): ${i.issue}`)),(Array.isArray(a.suggestions)?a.suggestions:[]).forEach(i=>s.push(`💡 ${i}`)),Array.isArray(a.issues)&&a.issues.length||s.push("Everything looks good."),e.messages.push({role:"assistant",content:s.join(`
`)})}async function gi(e,t){const a=x,s=`${e}
...
- Keep it a clean, readable list. You manage the whole showroom, so stay professional and factual.`,i=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:s,max_tokens:1500}),r=i&&i.text?String(i.text):"";if(!r)throw new Error(i&&i.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:r,provider:i.provider?`${i.provider}/${i.model}`:""})}async function bi(e,t){const a=x,s=li(),i=await S._callEdge({action:"general_execute",message:e,images:(t||[]).slice(0,4),history:s,max_tokens:1200});if(!i||i.success!==!0)throw new Error(i&&i.error||"Could not handle that request.");if(i.needs_confirmation){a.pendingPlan=i.plan||null,a.messages.push({role:"assistant",content:String(i.response||"I found something I can fix.")});return}a.messages.push({role:"assistant",content:String(i.response||i.reply||"Done.")}),i.plan&&i.plan.action!=="chat"&&i.plan.action!=="monitor"&&Ce()}window.generalAiConfirmPlan=async function(){const e=x;if(!e||!e.pendingPlan||e.busy)return;const t=e.pendingPlan;e.pendingPlan=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_execute",confirm_plan:t,confirmed:!0});if(!a||a.success!==!0)throw new Error(a&&a.error||"The action failed.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||a.reply||"Done.")}`}),Ce()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPlan=function(){x&&(x.pendingPlan=null,x.messages.push({role:"assistant",content:"Cancelled — nothing was changed."}),I())};window.generalAiUseGeneratedImage=async function(e){const t=x;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,I();const s=await Pe(a);if(t.busy=!1,!s){u("Could not upload the generated image.","error"),I();return}u("Image saved to showroom storage. Use it on any card or ask the AI to attach it.","success"),I()};window.generalAiPublishGeneratedImage=async function(e){const t=x;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];a&&(t.instruction="Publish this generated image in the matching section of my showroom.",t.messages.push({role:"user",content:"Publish this generated image in the matching section of my showroom.",images:[a]}),t.chatImages=[],t.generatedImages=[],await ka("Publish this generated image in the matching section of my showroom.",[a]))};window.generalAiRegenerateImage=async function(){const e=x;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,I();try{await $a(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,I()}}};async function Ce(){try{await C()}catch{}}const dt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],hi=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function ct(e){return Array.isArray(e)?e:[]}function Sa(e=[]){const t=new Map(ct(e).map(a=>[a.id,a]));return dt.map(a=>{const s=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!s.enabled,apiKey:s.apiKey||"",model:s.model||"",baseUrl:s.baseUrl||""}})}async function Aa(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function ut(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...ct(t?.ai_ad_generation_history)].slice(0,120);await Aa({ai_ad_generation_history:a})}async function Ia(e){try{const{data:s,error:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(i)throw i;let r;if(s?.id?{error:r}=await p.from("site_settings").update(e).eq("id",s.id):{error:r}=await p.from("site_settings").insert(e),r)throw r;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:s}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let i;if(s?.id?{error:i}=await p.from("public_live_state").update(a).eq("id",s.id):{error:i}=await p.from("public_live_state").insert(a),!i)return}catch{}try{localStorage.setItem(Mt,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function fi(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function yi(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=fi(e.description),s=a?.startsAt||e.started_at||null,i=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:s,ai_ad_ends_at:i,ai_ad_duration_seconds:i&&s?Math.max(5,Math.round((new Date(i).getTime()-new Date(s).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(Mt),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function Te(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),yi()]),s=t||{},i=a||{},r=Sa(s.ai_ad_video_providers),n=ct(s.ai_ad_generation_history).sort((d,c)=>new Date(c.created_at||0).getTime()-new Date(d.created_at||0).getTime()).slice(0,12),o=!!i.ai_ad_enabled&&!!i.ai_ad_video_url&&(!i.ai_ad_ends_at||new Date(i.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <form id="ai-ad-generator-form" onsubmit="activateAiAdvertisement(event)" class="glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-4">
          ...
          <div>
            ...
            <textarea id="ai-ad-script" class="input-field text-xs" name="script" rows="6" placeholder="Click Generate Script with AI, then edit if needed.">${l(n[0]?.script||"")}</textarea>
          </div>

          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              <label class="lbl">AI Video URL</label>
              <input id="ai-ad-video-url" type="url" class="input-field text-xs" name="video_url" placeholder="https://...mp4" value="${l(o&&i.ai_ad_video_url||"")}" required>
            </div>
            <div>
              <label class="lbl">Playback Duration (seconds)</label>
              <input id="ai-ad-duration" type="number" class="input-field text-xs" name="duration_seconds" min="5" max="900" value="${l(String(i.ai_ad_duration_seconds||30))}" required>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
            <div>
              ...
              <input id="ai-ad-badge" type="text" class="input-field text-xs" name="badge" value="${l(i.ai_ad_badge||"AI Advertisement")}" placeholder="AI Advertisement">
            </div>
            <div>
              <label class="lbl">Headline</label>
              <input id="ai-ad-title" type="text" class="input-field text-xs" name="title" value="${l(i.ai_ad_title||"")}" placeholder="Campaign headline">
            </div>
            <div>
              <label class="lbl">CTA Label</label>
              <input id="ai-ad-cta" type="text" class="input-field text-xs" name="cta_label" value="${l(i.ai_ad_cta_label||"Shop Now")}" placeholder="Shop Now">
            </div>
          </div>

          <label class="flex items-center gap-2 text-xs text-gray-400">
            <input type="checkbox" name="muted" ${i.ai_ad_muted!==!1?"checked":""}>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody>
                ${n.length===0?'<tr><td colspan="5" class="text-center text-gray-500 py-8">No AI ad jobs yet.</td></tr>':n.map(d=>`
                    <tr>
                      <td><span class="text-xs text-gray-400">${l(W(d.created_at))}</span></td>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`}}window.saveAiAdProviders=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());try{const{data:s}=await p.from("ai_settings").select("ai_ad_video_providers").limit(1).maybeSingle(),i=Sa(s?.ai_ad_video_providers),r=new Map(i.map(o=>[o.id,o])),n=dt.map(o=>{const d=o.id,c=r.get(d)||{},m=String(a[`provider_${d}_api_key`]||"").trim();return{id:d,name:o.name,enabled:t.get(`provider_${d}_enabled`)==="on",apiKey:m||c.apiKey||"",model:String(a[`provider_${d}_model`]||"").trim(),baseUrl:String(a[`provider_${d}_base_url`]||"").trim()}});await Aa({ai_ad_video_providers:n}),u("AI advertisement provider settings saved.","success"),Te()}catch(s){u("Failed to save providers: "+s.message,"error")}};window.generateAiAdScript=async function(){const e=document.getElementById("ai-ad-brief")?.value?.trim(),t=document.getElementById("ai-ad-goal")?.value||"Product launch",a=document.getElementById("ai-ad-provider"),s=document.getElementById("ai-ad-script");if(!e){u("Enter campaign brief first.","error");return}if(s){s.value="Generating script...";try{const i=["Create a short video advertisement script for an ecommerce marketplace.",`Goal: ${t}`,`Brief: ${e}`,"Return only plain text in this exact structure:","Headline:","Voiceover:","On-screen text:","CTA:"].join(`
`),r=await S.prompt(i,{onProviderSwitch:n=>{s.value=`Generating with ${n}...`}});s.value=r.text||"",await ut({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:r.provider,provider_id:a?.value||"",status:"script_generated",script:r.text||"",video_url:null}),u(`Script generated with ${r.provider}.`,"success")}catch(i){s.value="",u("Script generation failed: "+i.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),s=String(t.get("provider_id")||""),i=dt.find(b=>b.id===s)?.name||s,r=String(t.get("brief")||"").trim(),n=String(t.get("script")||"").trim(),o=String(t.get("video_url")||"").trim(),d=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),h=new Date(c+d*1e3).toISOString();if(!o){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:o,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:d,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:s,ai_ad_starts_at:m,ai_ad_ends_at:h,ai_ad_updated_at:new Date().toISOString()};await Ia(b),await ut({created_at:m,goal:a,brief:r,provider_name:i,provider_id:s,status:"active",script:n,video_url:o,ends_at:h}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Te()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Ia({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await ut({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Te()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function vi(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveContent=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),{error:s}=await p.from("site_settings").upsert({id:1,...a});if(s){u(s.message,"error");return}u("Content settings saved!")};async function xi(){const e=document.getElementById("content");try{const[t,a,s]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),i=t.data||[],r=i.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,m)=>c+(parseFloat(m.amount)||0),0),n=i.length>0?(i.filter(c=>c.status!=="cancelled").length/i.length*100).toFixed(1):0,o={};(a.data||[]).forEach(c=>{o[c.category]=(o[c.category]||0)+1});const d=Object.entries(o).sort((c,m)=>m[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          ${M("Total Orders",i.length,"shopping-bag","blue")}
          ${M("Customers",s.count||0,"users","violet")}
      ...
      </div>`,window.lucide&&lucide.createIcons(),Qt(i)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function wi(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          ${[{key:"email_order_placed",label:"Order Confirmation Email",desc:"Send confirmation when order is placed"},{key:"email_order_shipped",label:"Shipping Notification",desc:"Notify customer when order is shipped"},{key:"email_order_delivered",label:"Delivery Confirmation",desc:"Confirm when order is delivered"},{key:"email_review_request",label:"Review Request",desc:"Ask for review after delivery"}].map(s=>`
            <div class="flex items-center justify-between p-3 glass-soft border border-blue-500/10 rounded-xl">
              ...
              <label class="toggle-switch"><input type="checkbox" name="${s.key}" ${a[s.key]!==!1?"checked":""}><span class="toggle-slider"></span></label>
            </div>`).join("")}
        </div>
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveEmailSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[s,i]of t.entries())a[s]=i;["email_order_placed","email_order_shipped","email_order_delivered","email_review_request"].forEach(s=>{s in a?a[s]=!0:a[s]=!1}),await p.from("site_settings").upsert({id:1,...a}),u("Email settings saved!")};async function Be(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{const[t,a,s]=await Promise.all([p.from("admin_security_logs").select("*").order("created_at",{ascending:!1}).limit(50),p.from("admin_2fa").select("enabled,backup_codes,created_at").eq("user_id",k.user?.id).maybeSingle(),p.auth.mfa.listFactors()]),i=t.data||[],r=a.data||{},n=(s.data?.totp||[])[0],o=!!n&&n.status==="verified",d=(r.backup_codes||[]).filter(c=>!c.used).length;e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${o?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${o?`Backup codes available: ${d} · Enrolled: ${N(r.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <i data-lucide="${b.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${b.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,s=document.getElementById("confirm-pw").value;if(a!==s){u("Passwords do not match","error");return}if(a.length<8){u("Password must be at least 8 characters","error");return}const{error:i}=await p.auth.signInWithPassword({email:k.user.email,password:t});if(i){u("Current password is incorrect","error");return}const{error:r}=await p.auth.updateUser({password:a});if(r){u(r.message,"error");return}await q(k.user.id,"password_changed"),u("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons();try{const{data:e,error:t}=await p.auth.mfa.enroll({factorType:"totp",friendlyName:"Weverse Admin"});if(t)throw t;const a=e.totp.qr_code,s=e.totp.secret,i=e.id;document.getElementById("2fa-setup-content").innerHTML=`
      <div class="space-y-5">
        ...
        <div class="flex flex-col items-center gap-4">
          ...
          <div class="w-full">
            ...
            <div class="flex gap-2">
              <code class="flex-1 input-field font-mono text-xs text-emerald-300 select-all">${l(s)}</code>
              <button onclick="navigator.clipboard.writeText('${l(s)}').then(()=>showToast('Copied!'))" class="btn-press p-2 bg-blue-500/10 hover:bg-blue-500/20 rounded-xl transition text-blue-400"><i data-lucide="copy" class="w-4 h-4"></i></button>
            </div>
          </div>
        </div>
        <div>
        ...
        <button onclick="confirm2FAEnrollment('${l(i)}')" class="btn-press w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold py-2.5 rounded-xl text-sm transition flex items-center justify-center gap-2">
          <i data-lucide="shield-check" class="w-4 h-4"></i> Verify & Enable 2FA
        </button>
      </div>`,window.lucide&&lucide.createIcons(),setTimeout(()=>document.getElementById("setup-totp-code")?.focus(),100),document.getElementById("setup-totp-code")?.addEventListener("input",r=>{r.target.value=r.target.value.replace(/\D/g,"").slice(0,6)})}catch(e){document.getElementById("2fa-setup-content").innerHTML=`<div class="text-red-400 text-sm text-center py-4">${l(e.message)}</div>`}};window.confirm2FAEnrollment=async function(e){const t=document.getElementById("setup-totp-code")?.value?.trim(),a=document.getElementById("setup-2fa-error");if(!t||t.length!==6){a&&(a.textContent="Enter the 6-digit code.",a.classList.remove("hidden"));return}try{const{data:s,error:i}=await p.auth.mfa.challenge({factorId:e});if(i)throw i;const{error:r}=await p.auth.mfa.verify({factorId:e,challengeId:s.id,code:t});if(r)throw r;const n=Pa(10);await p.from("admin_2fa").upsert({user_id:k.user.id,enabled:!0,backup_codes:n}),await q(k.user.id,"2fa_enrolled"),z(),Ea(n.map(o=>o.code)),Be()}catch(s){const i=document.getElementById("setup-2fa-error");i&&(i.textContent=s.message?.includes("Invalid")?"Wrong code. Check your app and try again.":s.message,i.classList.remove("hidden")),document.getElementById("setup-totp-code").value="",document.getElementById("setup-totp-code").focus()}};function Pa(e){const t=[];for(let a=0;a<e;a++){const s=Array.from({length:16},()=>"ABCDEFGHJKLMNPQRSTUVWXYZ23456789"[Math.floor(Math.random()*32)]).join("");t.push({code:`${s.slice(0,4)}-${s.slice(4,8)}-${s.slice(8,12)}-${s.slice(12,16)}`,used:!1})}return t}function Ea(e){B(`
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Pa(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Ea(e.map(t=>t.code)),Be()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await q(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Be()}catch(e){u(e.message,"error")}};async function ki(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function $i(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${l(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${W(a.created_at)}</p></div>
...
`),s=new Blob([t+`
`+a],{type:"text/csv"}),i=document.createElement("a");i.href=URL.createObjectURL(s),i.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,i.click(),u("Orders exported!")};async function Si(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="form-grid form-grid-2">
            <div><label class="lbl">Default Currency</label><select class="input-field" name="default_currency">
              ${["USD","EUR","GBP","NGN","KES","ZAR","GHS"].map(s=>`<option value="${s}" ${(a.default_currency||"USD")===s?"selected":""}>${s}</option>`).join("")}
            </select></div>
            <div><label class="lbl">Default Language</label><select class="input-field" name="default_language">
              ${["en","fr","es","de","pt","ar","sw"].map(s=>`<option value="${s}" ${(a.default_language||"en")===s?"selected":""}>${s}</option>`).join("")}
            </select></div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[s,i]of t.entries())a[s]=i;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(s=>{a[s]=s in a}),await p.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function Le(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},s=a.homepage_banner_image||"",i=a.homepage_banner_alt||"Homepage header banner",r=s?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
        ...
        <div id="homepage-banner-preview-panel" class="glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-3 hidden">
          ...
          <div class="rounded-2xl overflow-hidden border border-blue-500/10 bg-[#0f172a]">
            ...
            <div class="bg-[#070b16] p-3 sm:p-4">
              <div class="overflow-hidden rounded-xl border border-white/10 bg-[#111827] shadow-2xl shadow-black/20" style="aspect-ratio: 1600 / 320;">
                ${s?`<img id="homepage-banner-preview-img" src="${l(s)}" alt="${l(i)}" class="h-full w-full object-cover">`:'<div class="flex h-full w-full items-center justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900"><div class="text-center"><i data-lucide="image-off" class="mx-auto w-8 h-8 text-gray-500"></i><p class="mt-2 text-xs font-semibold text-gray-500">No banner selected</p></div></div>'}
              </div>
            </div>
          ...
          <p id="homepage-banner-preview-note" class="text-[10px] text-gray-500">${l(r)}</p>
        </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="grid gap-4 lg:grid-cols-[1.1fr_.9fr]">
              <div class="space-y-3">
                <div class="group relative overflow-hidden rounded-2xl border border-dashed border-blue-500/25 bg-[#0b1020] transition hover:border-blue-500/50">
                  <div class="p-3 sm:p-4">
                    <div class="overflow-hidden rounded-xl border border-white/10 bg-[#111827]" style="aspect-ratio: 1600 / 320;">
                      ${s?`<img id="homepage-banner-image" src="${l(s)}" alt="${l(i)}" class="h-full w-full object-cover">`:'<div class="flex h-full w-full items-center justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900"><div class="text-center"><i data-lucide="image-plus" class="mx-auto w-8 h-8 text-blue-400"></i><p class="mt-2 text-xs font-semibold text-gray-400">Upload a homepage banner</p></div></div>'}
                    </div>
                    <div class="mt-3 flex flex-wrap gap-2">
                      <button type="button" onclick="triggerImgUpload('homepage_banner_image')" class="text-xs font-bold text-white bg-blue-600 px-3 py-1.5 rounded-lg">${s?"Replace Image":"Upload Image"}</button>
                ...
                <input type="hidden" name="homepage_banner_image" id="val-homepage_banner_image" value="${l(s)}">
                <input type="text" id="url-homepage_banner_image" value="${l(s)}" placeholder="Or paste image URL" oninput="document.getElementById('val-homepage_banner_image').value=this.value;updateHomepageBannerPreview()" class="input-field text-xs">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <textarea class="input-field" id="homepage_banner_alt" name="homepage_banner_alt" rows="4" placeholder="Accessible description for the banner image">${l(i)}</textarea>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Me(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{let t=function(o,d,c,m="",h="blue"){const b=!!(c&&c.trim());return`
        <div class="glass-soft border border-${h}-500/15 rounded-xl p-4 space-y-3">
          <div class="flex items-center justify-between">
            <p class="text-xs font-black text-white">${l(o)}</p>
          ...
          ${b?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
                <img src="${l(c)}" alt="${l(o)}" class="max-h-20 max-w-full object-contain p-2" onerror="this.closest('div').innerHTML='<p class=&quot;text-xs text-gray-600 text-center&quot;>Image broken</p>'">
        ...
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),s=a||{},i=s.brand_name||s.site_name||Rt,r=s.brand_slogan||s.site_tagline||Dt,n=s.brand_logo||s.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <div id="live-preview-panel" class="hidden glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-3">
          ...
          <div class="rounded-xl overflow-hidden border border-blue-500/10">
            <div id="preview-header" class="flex items-center gap-3 px-4 py-3" style="background:#0f172a">
              <div id="preview-logo-wrap" class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 overflow-hidden" style="background:var(--preview-primary,#f97316)">
                ${n?`<img src="${l(n)}" alt="${l(i)}" class="w-full h-full object-contain p-1">`:'<i data-lucide="globe" class="w-4 h-4 text-white"></i>'}
              </div>
              <div>
                <p id="preview-name" class="text-sm font-black text-white leading-none">${l(i)}</p>
                <p id="preview-slogan" class="text-[10px] text-blue-400 font-semibold mt-0.5">${l(r)}</p>
              </div>
              <div id="preview-badge-wrap" class="ml-auto ${s.brand_badge?"":"hidden"}">
                <img id="preview-badge" src="${l(s.brand_badge||"")}" alt="Verified" class="w-6 h-6 object-contain">
              </div>
            </div>
            <div class="px-4 py-2 border-t border-gray-800 text-[11px] text-gray-500" style="background:#070b16">
              <span id="preview-btn" style="background:${l(s.brand_primary_color||"#f97316")};color:#000;padding:4px 12px;border-radius:8px;font-weight:700;font-size:11px">Shop Now</span>
              <span class="ml-3" style="color:${l(s.brand_secondary_color||"#3b82f6")}">All Products →</span>
            </div>
          </div>
          <!-- Footer preview -->
          <div id="preview-footer" class="rounded-xl px-4 py-3 border border-gray-800 flex items-center gap-3" style="background:#0f172a">
            ...
            <div>
              <p id="preview-footer-name" class="text-xs font-black text-white">${l(i)}</p>
              <p id="preview-footer-slogan" class="text-[10px] text-gray-500">${l(r)}</p>
            </div>
            <p class="ml-auto text-[10px] text-gray-600">© 2026 <span id="preview-copy-name">${l(i)}</span></p>
          </div>
        ...
        <form id="brand-form" onsubmit="saveBrandSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <input class="input-field" name="brand_name" id="inp-brand-name" value="${l(i)}" placeholder="Your brand name" required oninput="updateLivePreview()">
              </div>
              <div>
                <label class="lbl">Short Name</label>
                <input class="input-field" name="brand_short_name" value="${l(s.brand_short_name||"")}" placeholder="e.g. Weverse">
              </div>
              <div class="sm:col-span-2">
                <label class="lbl">Slogan / Tagline *</label>
                <input class="input-field" name="brand_slogan" id="inp-brand-slogan" value="${l(r)}" placeholder="e.g. Global Shopping • Worldwide Delivery" oninput="updateLivePreview()">
              </div>
              <div class="sm:col-span-2">
                <label class="lbl">Brand Description</label>
                <textarea class="input-field" name="brand_description" rows="2" placeholder="Short description…">${l(s.brand_description||"")}</textarea>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-primary" value="${l(s.brand_primary_color||"#f97316")}" oninput="document.getElementById('ct-primary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-primary" name="brand_primary_color" value="${l(s.brand_primary_color||"#f97316")}" placeholder="#f97316" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-primary').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Secondary Color (links, highlights)</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-secondary" value="${l(s.brand_secondary_color||"#3b82f6")}" oninput="document.getElementById('ct-secondary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-secondary" name="brand_secondary_color" value="${l(s.brand_secondary_color||"#3b82f6")}" placeholder="#3b82f6" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-secondary').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Tagline Color 1 (e.g. "GLOBAL SHOPPING")</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-tag1" value="${l(s.brand_tagline_color1||"#22d3ee")}" oninput="document.getElementById('ct-tag1').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-tag1" name="brand_tagline_color1" value="${l(s.brand_tagline_color1||"#22d3ee")}" placeholder="#22d3ee" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-tag1').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Tagline Color 2 (e.g. "WORLDWIDE DELIVERY")</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-tag2" value="${l(s.brand_tagline_color2||"#a3e635")}" oninput="document.getElementById('ct-tag2').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-tag2" name="brand_tagline_color2" value="${l(s.brand_tagline_color2||"#a3e635")}" placeholder="#a3e635" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-tag2').value=this.value;updateLivePreview()">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <select class="input-field" name="brand_font" id="brand-font-select" onchange="previewFont(this.value)">
                  ${["Inter","Poppins","Roboto","Montserrat","Nunito","Raleway","Lato","Open Sans","Outfit","Plus Jakarta Sans","DM Sans","Urbanist","Sora","Manrope","Work Sans","Space Grotesk"].map(o=>`<option value="${o}" ${(s.brand_font||"Inter")===o?"selected":""}>${o}</option>`).join("")}
                </select>
              </div>
              <div>
                <label class="lbl">Custom Google Font (overrides above)</label>
                <input class="input-field" name="brand_custom_font" value="${l(s.brand_custom_font||"")}" placeholder="e.g. Space Grotesk">
              </div>
            </div>
            <div id="font-preview" class="p-3 rounded-xl bg-gray-900 border border-blue-500/10">
              <p id="font-sample" class="text-sm text-white font-bold" style="font-family:'${l(s.brand_font||"Inter")}',sans-serif">The quick brown fox jumps — 0123456789 · Weverse Online Shop</p>
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="p-4 bg-blue-500/5 border border-blue-500/20 rounded-2xl space-y-3">
              ...
              ${t("Verification Badge Image","brand_badge",s.brand_badge,"Upload your blue checkmark or any verification badge. Recommended: 64×64px PNG with transparent background.","blue")}
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              ${t("Favicon / Tab Icon","brand_favicon",s.brand_favicon,"Browser tab icon. 32×32 or 64×64px.")}
              ${t("Mobile Logo","brand_mobile_logo",s.brand_mobile_logo,"Smaller logo for phones. 120×40px.")}
              ${t("Header Logo","brand_header_logo",s.brand_header_logo,"Top navigation bar.")}
              ${t("Footer Logo","brand_footer_logo",s.brand_footer_logo,"Website footer.")}
              ${t("Login Page Logo","brand_login_logo",s.brand_login_logo,"Shown on auth/login page.")}
              ${t("Admin Dashboard Logo","brand_admin_logo",s.brand_admin_logo,"Admin sidebar header.")}
              ${t("OG / Social Image","brand_og_image",s.brand_og_image,"1200×630px — shown when sharing links.")}
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div><label class="lbl">Website URL</label><input class="input-field" name="brand_website_url" value="${l(s.brand_website_url||s.production_url||"https://weverseonlineshop.com")}" placeholder="https://…"></div>
              <div><label class="lbl">Support Email</label><input type="email" class="input-field" name="brand_email" value="${l(s.brand_email||s.contact_email||"")}" placeholder="support@…"></div>
              <div><label class="lbl">Phone / WhatsApp</label><input class="input-field" name="brand_phone" value="${l(s.brand_phone||s.contact_phone||"")}" placeholder="+1 234…"></div>
              <div><label class="lbl">Business Address</label><input class="input-field" name="brand_address" value="${l(s.brand_address||s.contact_address||"")}" placeholder="City, Country"></div>
            </div>
          </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.toggleLivePreview=function(){document.getElementById("live-preview-panel")?.classList.toggle("hidden"),updateLivePreview()};window.updateLivePreview=function(){const e=document.getElementById("live-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("inp-brand-name")?.value||Rt,a=document.getElementById("inp-brand-slogan")?.value||Dt,s=document.getElementById("ct-primary")?.value||"#f97316",i=document.getElementById("ct-secondary")?.value||"#3b82f6",r=document.getElementById("ct-tag1")?.value||"#22d3ee",n=document.getElementById("ct-tag2")?.value||"#a3e635",o=document.getElementById("val-brand_logo")?.value||DEFAULT_BRAND_LOGO,d=document.getElementById("val-brand_badge")?.value||"";["preview-name","preview-footer-name","preview-copy-name"].forEach(g=>{const v=document.getElementById(g);v&&(v.textContent=t)}),["preview-slogan","preview-footer-slogan"].forEach(g=>{const v=document.getElementById(g);v&&(v.textContent=a)});const c=document.getElementById("preview-slogan");if(c&&a){const g=a,v=g.indexOf(","),$=v>-1?g.slice(0,v+1):g,H=v>-1?g.slice(v+1):"";c.innerHTML=`<span style="color:${r};font-weight:800">${l($)}</span><span style="color:${n};font-weight:700">${l(H)}</span>`}const m=document.getElementById("preview-btn");m&&(m.style.background=s);const h=e.querySelector('[style*="color:"]');h&&(h.style.color=i),["preview-logo-wrap","preview-footer-logo-wrap"].forEach(g=>{const v=document.getElementById(g);v&&(o?(v.innerHTML=`<img src="${o}" alt="${t}" class="w-full h-full object-contain p-1">`,v.style.background="transparent"):(v.innerHTML='<i data-lucide="globe" class="w-4 h-4 text-white"></i>',v.style.background=s,window.lucide&&lucide.createIcons()))});const b=document.getElementById("preview-badge-wrap"),f=document.getElementById("preview-badge");b&&f&&(d?(f.src=d,b.classList.remove("hidden")):b.classList.add("hidden"))};window.triggerImgUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearBrandImg=function(e){document.getElementById("val-"+e).value="";const t=document.getElementById("url-"+e);t&&(t.value=""),(e&&e.startsWith("homepage_")?Le:Me)()};window.clearHomepageBannerImg=function(){const e=document.getElementById("val-homepage_banner_image"),t=document.getElementById("url-homepage_banner_image"),a=document.getElementById("homepage_banner_alt");e&&(e.value=""),t&&(t.value=""),a&&(a.value=""),Le()};window.restoreHomepageBannerDefault=function(){window.clearHomepageBannerImg()};window.syncColor=function(e,t){const a=document.getElementById("color-"+e);a&&/^#[0-9a-fA-F]{6}$/.test(t)&&(a.value=t)};window.previewFont=function(e){const t=document.getElementById("font-sample");t&&(t.style.fontFamily=`'${e}', sans-serif`);const a="gf-preview";let s=document.getElementById(a);s||(s=document.createElement("link"),s.id=a,s.rel="stylesheet",document.head.appendChild(s)),s.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e)}:wght@400;700;900&display=swap`};const Ke="weverse_brand_v1",Je="weverse_brand_override_v1";function Qe(){try{const e=JSON.parse(localStorage.getItem(Je)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(Ke)||"null");if(e&&typeof e=="object")return e.data&&typeof e.data=="object"?e.data:e}catch{}return{}}function we(e){const t={...Qe(),...e};try{localStorage.setItem(Je,JSON.stringify(t))}catch{}try{localStorage.setItem(Ke,JSON.stringify({ts:Date.now(),data:t}))}catch{}return window.dispatchEvent(new StorageEvent("storage",{key:Je})),window.dispatchEvent(new StorageEvent("storage",{key:Ke})),window.dispatchEvent(new CustomEvent("brand-updated",{detail:t})),t}window.handleBrandImgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const s=t&&t.startsWith("homepage_"),i=document.getElementById(s?"homepage-banner-status":"brand-upload-status"),r=document.getElementById(s?"homepage-banner-msg":"brand-upload-msg");i&&i.classList.remove("hidden"),r&&(r.textContent=`Uploading ${a.name}…`);try{const n=a.name.split(".").pop(),o=`brand/${t}-${Date.now()}.${n}`,{error:d}=await p.storage.from("product-images").upload(o,a,{contentType:a.type,upsert:!0});let c;if(d)c=URL.createObjectURL(a),r&&(r.textContent=`Preview only (storage: ${d.message})`);else{const{data:b}=p.storage.from("product-images").getPublicUrl(o);c=b.publicUrl,r&&(r.textContent=`✓ ${a.name} uploaded`)}const m=document.getElementById("val-"+t),h=document.getElementById("url-"+t);m&&(m.value=c),h&&(h.value=c,h.classList.remove("hidden")),s?updateHomepageBannerPreview():(updateLivePreview(),setTimeout(()=>Me(),1e3))}catch(n){r&&(r.textContent=`Upload failed: ${n.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.saveBrandSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[o,d]of t.entries())o.endsWith("_url")||(a[o]=d);a.brand_name&&(a.site_name=a.brand_name),a.brand_slogan&&(a.site_tagline=a.brand_slogan),a.brand_description&&(a.site_description=a.brand_description),a.brand_email&&(a.contact_email=a.brand_email),a.brand_phone&&(a.contact_phone=a.brand_phone),a.brand_address&&(a.contact_address=a.brand_address),a.brand_website_url&&(a.production_url=a.brand_website_url);const s=a.brand_custom_font||a.brand_font;s&&previewFont(s);const i=e.target.querySelector("[type=submit]");i&&(i.disabled=!0,i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Saving…',window.lucide&&lucide.createIcons());const{data:r}=await p.from("site_settings").select("id").limit(1).maybeSingle();let n;r?.id?{error:n}=await p.from("site_settings").update(a).eq("id",r.id):{error:n}=await p.from("site_settings").insert(a),n?(we(a),u("Brand saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(we(a),u("✅ Brand saved! All pages will now show your updated brand.","success")),setTimeout(()=>Me(),500)};window.toggleHomepageBannerPreview=function(){document.getElementById("homepage-banner-preview-panel")?.classList.toggle("hidden"),updateHomepageBannerPreview()};window.updateHomepageBannerPreview=function(){const e=document.getElementById("homepage-banner-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("val-homepage_banner_image")?.value||"",a=document.getElementById("homepage_banner_alt")?.value||"Homepage header banner",s=document.getElementById("homepage-banner-image"),i=document.getElementById("homepage-banner-preview-img");[s,i].forEach(n=>{n&&(t?(n.src=t,n.alt=a,n.classList.remove("hidden")):n.classList.add("hidden"))});const r=document.getElementById("homepage-banner-preview-note");r&&(r.textContent=t?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.")};window.saveHomepageBranding=async function(e){e.preventDefault();const t={homepage_banner_image:document.getElementById("url-homepage_banner_image")?.value||"",homepage_banner_alt:document.getElementById("homepage_banner_alt")?.value||"Homepage header banner"},a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();let i;s?.id?{error:i}=await p.from("site_settings").update(t).eq("id",s.id):{error:i}=await p.from("site_settings").insert(t),i?(we({...Qe(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),u("Homepage banner saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(we({...Qe(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),u("Homepage banner published.","success")),setTimeout(()=>Le(),500)};window._manualPaymentAccounts=[];function pt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:It("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function mt(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Ai(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${jt.map(s=>`<option value="${s}" ${e.currency===s?"selected":""}>${s}</option>`).join("")}</select></div>
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${Xt(a)}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[pt()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Ai(t,a)).join("")}
    ...
    </div>`,mt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(pt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[pt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const s=window._manualPaymentAccounts[e];s&&(s[t]=a,t==="currency"&&(s.currencyName=a),mt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const s=_e.find(i=>i.code===t);a.country_code=t,a.country=s?.name||"",a.flag=s?.flag||It(t),mt(),renderManualPaymentAccountsEditor()};async function Ye(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),s={...Ua()||{},...t||{}};window._manualPaymentAccounts=Oa(s).map(i=>({...i})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <h2 class="text-xl font-black text-white">Payment Settings</h2>
          <div class="flex items-center gap-2 flex-wrap">
            ${s.payment_gateway?`<span class="badge bg-emerald-500/10 text-emerald-400 border-emerald-500/20">Active: ${l(s.payment_gateway)}</span>`:'<span class="badge bg-amber-500/10 text-amber-400 border-amber-500/20">Not configured</span>'}
            ${s.payment_mode==="live"?'<span class="badge bg-red-500/10 text-red-400 border-red-500/20">🔴 LIVE MODE</span>':'<span class="badge bg-blue-500/10 text-blue-400 border-blue-500/20">🔧 Test Mode</span>'}
          </div>
        </div>
        ...
        <form id="payment-form" onsubmit="savePaymentSettings(event)" class="space-y-5">
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            <div class="flex items-center justify-between p-4 border-b border-blue-500/10">
              ...
              <label class="toggle-switch shrink-0">
                <input type="checkbox" name="manual_payment_enabled" id="manual-toggle" ${s.manual_payment_enabled!==!1?"checked":""}>
                <span class="toggle-slider"></span>
              </label>
            </div>
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(qa(s))}</textarea>
              </div>
              <div>
                <label class="lbl">ATM Transfer Instructions (optional, shown separately)</label>
                <textarea class="input-field" name="atm_transfer_instructions" rows="3" placeholder="Optional ATM-specific instructions.">${l(s.atm_transfer_instructions||"")}</textarea>
              </div>
          ...
          <div class="glass-soft border border-amber-500/15 rounded-2xl overflow-hidden">
            <div class="flex items-center justify-between p-4 border-b border-amber-500/10">
              ...
              <label class="toggle-switch shrink-0">
                <input type="checkbox" name="flutterwave_enabled" ${s.flutterwave_enabled?"checked":""}>
                <span class="toggle-slider"></span>
              </label>
            </div>
            <div class="p-5 space-y-4">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label class="flex items-center gap-3 p-3 glass-soft border ${(s.payment_mode||"test")==="test"?"border-blue-500/40 bg-blue-500/5":"border-blue-500/10"} rounded-xl cursor-pointer">
                  <input type="radio" name="payment_mode" value="test" ${(s.payment_mode||"test")==="test"?"checked":""} class="accent-blue-500">
                ...
                <label class="flex items-center gap-3 p-3 glass-soft border ${s.payment_mode==="live"?"border-red-500/40 bg-red-500/5":"border-blue-500/10"} rounded-xl cursor-pointer">
                  <input type="radio" name="payment_mode" value="live" ${s.payment_mode==="live"?"checked":""} class="accent-red-500">
              ...
              <div class="form-grid form-grid-2">
                <div><label class="lbl">Public Key *</label><div class="relative"><input type="password" class="input-field pr-16" name="flutterwave_public_key" placeholder="${s.flutterwave_public_key?"••••"+s.flutterwave_public_key.slice(-4):"FLWPUBK_TEST-… or FLWPUBK-…"}">${s.flutterwave_public_key?'<span class="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] font-bold text-emerald-500">✓ Saved</span>':""}</div></div>
                <div><label class="lbl">Secret Key *</label><div class="relative"><input type="password" class="input-field pr-16" name="flutterwave_secret_key" placeholder="${s.flutterwave_secret_key?"••••"+s.flutterwave_secret_key.slice(-4):"FLWSECK_TEST-… or FLWSECK-…"}">${s.flutterwave_secret_key?'<span class="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] font-bold text-emerald-500">✓ Saved</span>':""}</div></div>
                <div><label class="lbl">Encryption Key</label><div class="relative"><input type="password" class="input-field pr-16" name="flutterwave_encryption_key" placeholder="${s.flutterwave_encryption_key?"••••"+s.flutterwave_encryption_key.slice(-4):"Encryption key from dashboard"}">${s.flutterwave_encryption_key?'<span class="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] font-bold text-emerald-500">✓ Saved</span>':""}</div></div>
                <div><label class="lbl">Webhook Secret</label><div class="relative"><input type="password" class="input-field pr-16" name="flutterwave_webhook_secret" placeholder="${s.flutterwave_webhook_secret?"••••"+s.flutterwave_webhook_secret.slice(-4):"Secret hash for webhook verification"}">${s.flutterwave_webhook_secret?'<span class="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] font-bold text-emerald-500">✓ Saved</span>':""}</div></div>
                <div><label class="lbl">Accepted Currency</label><select class="input-field" name="flutterwave_currency">${["NGN","USD","GBP","EUR","GHS","KES","ZAR","ZMW","TZS","UGX","XAF","XOF"].map(i=>`<option value="${i}" ${(s.flutterwave_currency||"NGN")===i?"selected":""}>${i}</option>`).join("")}</select></div>
                <div><label class="lbl">Redirect URL (after payment)</label><input class="input-field" name="flutterwave_redirect_url" value="${l(s.flutterwave_redirect_url||"")}" placeholder="${window.location.origin}/payment.html"></div>
              </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ${[{id:"manual",label:"Manual / Bank Transfer",icon:"landmark",color:"blue"},{id:"flutterwave",label:"Flutterwave",icon:"zap",color:"amber"},{id:"both",label:"Both (customer chooses)",icon:"layers",color:"emerald"}].map(i=>`<label class="flex items-center gap-3 p-3 glass-soft border ${(s.payment_gateway||"manual")===i.id?"border-blue-500/40 bg-blue-500/5":"border-blue-500/10"} rounded-xl cursor-pointer hover:border-blue-500/30 transition"><input type="radio" name="payment_gateway" value="${i.id}" ${(s.payment_gateway||"manual")===i.id?"checked":""} class="accent-blue-500"><div><i data-lucide="${i.icon}" class="w-4 h-4 text-${i.color}-400 mb-0.5"></i><p class="text-xs font-bold text-white">${i.label}</p></div></label>`).join("")}
            </div>
          </div>
      ...
      </div>`,renderManualPaymentAccountsEditor(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.savePaymentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),s=["flutterwave_public_key","flutterwave_secret_key","flutterwave_encryption_key","flutterwave_webhook_secret"],i={};for(const[m,h]of Object.entries(a))s.includes(m)?h&&!h.startsWith("••••")&&h.trim()!==""&&(i[m]=h.trim()):i[m]=h;i.manual_payment_enabled=a.manual_payment_enabled==="on",i.flutterwave_enabled=a.flutterwave_enabled==="on";let r=[];try{r=JSON.parse(a.manual_payment_accounts_json||"[]")}catch{}i.manual_payment_accounts=r;const n=r[0]||{},o=r[1]||{};i.bank1_account_name=n.beneficiary||"",i.bank1_account_number=n.accountNumber||"",i.bank1_bank_name=n.bankName||"",i.bank1_transfer_type=n.transferType||"",i.bank1_sort_code=n.sortCode||n.routing||"",i.bank1_currency=n.currency||"USD",i.bank2_account_name=o.beneficiary||"",i.bank2_account_number=o.accountNumber||"",i.bank2_bank_name=o.bankName||"",i.bank2_transfer_type=o.transferType||"",i.bank2_sort_code=o.sortCode||o.routing||"",i.bank2_currency=o.currency||"USD",Fa(i);const{data:d}=await p.from("site_settings").select("id").limit(1).maybeSingle();let c;if(d?.id?{error:c}=await p.from("site_settings").update(i).eq("id",d.id):{error:c}=await p.from("site_settings").insert(i),c){const m=String(c.message||"");if(/manual_payment_accounts|column|schema cache/i.test(m)){u("Payment settings saved locally. Run the latest migration to persist them to Supabase.","info"),console.warn(c),setTimeout(()=>Ye(),500);return}u("Save failed: "+c.message,"error"),console.error(c);return}u("✅ Payment settings saved successfully!","success"),setTimeout(()=>Ye(),500)};window.testFlutterwaveKeys=async function(){const{data:e}=await p.from("site_settings").select("flutterwave_public_key").limit(1).maybeSingle();if(!e?.flutterwave_public_key){u("Save your Flutterwave public key first","info");return}u("Flutterwave key is saved. Use test mode + test card to verify a payment flow.","info")};async function Re(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <form id="deploy-form" onsubmit="saveDeploySettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ${[{id:"netlify",name:"Netlify",icon:"cloud",color:"teal"},{id:"vercel",name:"Vercel",icon:"triangle",color:"white"},{id:"github-pages",name:"GitHub Pages",icon:"github",color:"gray"},{id:"railway",name:"Railway",icon:"train",color:"violet"},{id:"render",name:"Render",icon:"server",color:"blue"}].map(s=>`
                <label class="flex items-center gap-2 p-3 glass-soft border ${(a.hosting_provider||"netlify")===s.id?"border-blue-500/40 bg-blue-500/5":"border-blue-500/10"} rounded-xl cursor-pointer hover:border-blue-500/30 transition">
                  <input type="radio" name="hosting_provider" value="${s.id}" ${(a.hosting_provider||"netlify")===s.id?"checked":""} class="accent-blue-500">
                  <i data-lucide="${s.icon}" class="w-4 h-4 text-gray-400"></i>
          ...
          <div class="glass-soft border border-amber-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ${[{id:"flutterwave",name:"Flutterwave",color:"amber"},{id:"stripe",name:"Stripe",color:"blue"},{id:"paypal",name:"PayPal",color:"blue"},{id:"paystack",name:"Paystack",color:"blue"},{id:"razorpay",name:"Razorpay",color:"blue"},{id:"manual",name:"Manual Bank Transfer",color:"gray"}].map(s=>`
                <label class="flex items-center gap-2 p-2.5 glass-soft border ${(a.payment_gateway||"flutterwave")===s.id?"border-amber-500/40 bg-amber-500/5":"border-blue-500/10"} rounded-xl cursor-pointer hover:border-amber-500/30 transition">
                  <input type="radio" name="payment_gateway" value="${s.id}" ${(a.payment_gateway||"flutterwave")===s.id?"checked":""} class="accent-amber-500">
                  <span class="text-xs font-bold text-white">${s.name}</span>
                </label>`).join("")}
            </div>
            <div id="payment-key-fields" class="form-grid form-grid-2">
              ...
              <div>
                ...
                <select class="input-field" name="payment_currency">
                  ${["USD","EUR","GBP","NGN","KES","ZAR","GHS","ZMW","TZS","UGX"].map(s=>`<option value="${s}" ${(a.payment_currency||"USD")===s?"selected":""}>${s}</option>`).join("")}
                </select>
              </div>
              <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),s=Object.fromEntries(a.entries()),i={},r=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[o,d]of Object.entries(s))r.includes(o)?d&&!d.startsWith("•")&&d.trim()!==""&&(i[o]=d.trim()):i[o]=d;const{error:n}=await p.from("site_settings").upsert({id:1,...i});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),n){u(n.message,"error");return}u("Deploy & payment settings saved!"),Re()};async function Ca(e="deploy"){const{data:t}=await p.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return u("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const s=new URL(a);e==="rebuild"&&s.searchParams.set("rebuild","1"),a=s.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function K(e,t={}){const a=t.version||new Date().toISOString(),s={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:i,error:r}=await p.from("deployment_history").insert({version:a,status:e,triggered_by_email:k.user?.email||null,metadata:s,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:i,error:r}}function te(e,t,a,s){if(!e)return;e.disabled=t;const i=e.querySelector("p.text-xs.font-black");i&&(i.textContent=t?a:s)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");te(t,!0,"Deploying…","Deploy Now");try{const a=await Ca("deploy");if(!a.ok)return;const{settings:s,hookUrl:i}=a;await K("preparing",{mode:"deploy",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,message:"Deployment queued from admin UI"});const r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await K("deploying",{mode:"deploy",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,message:"Webhook accepted deployment request"}),setTimeout(()=>Re(),400);else{const n=`Webhook returned error: ${r.status}`;u(n,"error"),await K("failed",{mode:"deploy",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,errorMessage:n})}}catch(a){u("Deploy failed: "+a.message,"error"),await K("failed",{mode:"deploy",errorMessage:a.message})}finally{te(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");te(t,!0,"Rebuilding…","Rebuild Site");try{const a=await Ca("rebuild");if(!a.ok)return;const{settings:s,hookUrl:i}=a;await K("building",{mode:"rebuild",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,message:"Rebuild requested from admin UI"});const r=await fetch(i,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🔄 Rebuild triggered successfully."),await K("deploying",{mode:"rebuild",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,message:"Webhook accepted rebuild request"}),setTimeout(()=>Re(),400);else{const n=`Rebuild webhook error: ${r.status}`;u(n,"error"),await K("failed",{mode:"rebuild",productionUrl:s.production_url,githubRepo:s.github_repo,webhook:i,errorMessage:n})}}catch(a){u("Rebuild failed: "+a.message,"error"),await K("failed",{mode:"rebuild",errorMessage:a.message})}finally{te(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");te(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){u("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){u("Publish failed: "+a.message,"error")}finally{te(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:s,error:i}=await p.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(i)return D(i)?u("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load listings to reindex: "+i.message,"error");const r=s||[];if(!r.length){u("No listings to reindex.");return}let n=0,o=0,d=!1;const c=40;for(let m=0;m<r.length;m+=c){const h=r.slice(m,m+c),{error:b}=await p.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",h.map(f=>f.id));b?(D(b)&&(d=!0),o+=h.length):n+=h.length,t&&(t.textContent=`Reindexing… ${Math.min(m+c,r.length)}/${r.length}`)}if(d){u(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${n}/${r.length} done)`,"error");return}u(`Search index rebuilt for ${n} listing${n!==1?"s":""}${o?` (${o} failed)`:""}.`,o?"error":"success")}catch(s){u("Reindex failed: "+s.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(j)||!j.length){u("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:s,error:i}=await p.from("showroom_listings").select("property_id");if(i)return D(i)?u("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load existing listings: "+i.message,"error");const r=new Set((s||[]).map(h=>h.property_id)),n=j.filter(h=>h&&h.property_id&&!r.has(h.property_id));if(!n.length){u("Showroom already in sync — no new listings to add.");return}let o=0,d=0,c=!1;const m=20;for(let h=0;h<n.length;h+=m){const b=n.slice(h,h+m).map(g=>({property_id:g.property_id,listing_type:g.listing_type||"product",category:g.category||null,subcategory:g.subcategory||null,title:g.title||"Untitled Listing",description:g.description||"",price:parseFloat(g.price)||0,currency:g.currency||"USD",country:g.country||"",country_code:g.country_code||"",state:g.state||"",city:g.city||"",town:g.town||"",product_location:g.product_location||"",latitude:g.latitude??null,longitude:g.longitude??null,property_type:g.property_type||null,listing_status:g.listing_status||"sale",bedrooms:g.bedrooms??null,bathrooms:g.bathrooms??null,building_size:g.building_size||"",land_size:g.land_size||"",parking_spaces:g.parking_spaces??null,furnished:g.furnished||"",features:Array.isArray(g.features)?g.features:[],tags:Array.isArray(g.tags)?g.tags:[],highlights:Array.isArray(g.highlights)?g.highlights:[],seo_keywords:Array.isArray(g.seo_keywords)?g.seo_keywords:[],images:Array.isArray(g.images)?g.images:[],brand:g.brand||null,color:g.color||null,size:g.size||null,condition:g.condition||null,warranty:g.warranty||null,availability_status:g.availability_status||"In Stock",stock_quantity:g.stock_quantity!=null?parseInt(g.stock_quantity,10):null,is_active:g.is_active!==!1,is_featured:!!g.is_featured,is_ai_generated:!!g.is_ai_generated,ai_generated_fields:Array.isArray(g.ai_generated_fields)?g.ai_generated_fields:[],specifications:g.specifications||{},created_at:g.created_at||new Date().toISOString()})),{error:f}=await p.from("showroom_listings").insert(b);f?(D(f)&&(c=!0),d+=b.length):o+=b.length,t&&(t.textContent=`Syncing… ${Math.min(h+m,n.length)}/${n.length}`)}if(c){u(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${o}/${n.length} added)`,"error");return}u(`Showroom synced: ${o} new listing${o!==1?"s":""} added to the database${d?` (${d} failed)`:""}.`,d?"error":"success")}catch(s){u("Sync failed: "+s.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){u("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const s=await a.json();u(`✓ Connected: ${s.full_name} (${s.visibility})`)}else a.status===404?u("Repository not found. Check username and repo name.","error"):u("GitHub API error: "+a.status,"error")}catch{u("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const le=30,P={category:null,page:0,query:""};async function ne(){const e=document.getElementById("content");if(!e)return;await za();const t=new Set(Et()),a=Na();P.category||(P.category=a[0]?.slug||null);const s=Pt(P.category),i=s?s.count:0,r=P.query.trim().toLowerCase(),n=`
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(f=>`<button onclick="catalogSetCategory('${f.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${P.category===f.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${l(f.name)}</button>`).join("")}
    </div>`,d=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${l(P.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(s)if(r){const f=Math.min(i,8e3);for(let g=0;g<f&&c.length<le;g++){const v=vt(s.slug,g);if(!v)continue;`${v.property_id} ${v.title} ${v.subcategory||""} ${v.category||""}`.toLowerCase().includes(r)&&c.push(v)}}else{const f=P.page*le,g=Math.min(f+le,i);for(let v=f;v<g;v++){const $=vt(s.slug,v);$&&c.push($)}}const m=c.length?c.map(f=>{const g=t.has(f.property_id),v=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${g?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${l(f.property_id)} · ${l(f.subcategory||f.category||"")} · ${Ft(f.price,"USD")}</p>
            </div>
            ${R(!g)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',h=r?1:Math.max(1,Math.ceil(i/le)),b=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${r?`${c.length} match`:`${i.toLocaleString()} items in ${l(s?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
        <button onclick="catalogPage(-1)" ${P.page<=0?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Prev</button>
        <span class="text-xs text-gray-500">Page ${P.page+1} / ${h}</span>
        <button onclick="catalogPage(1)" ${P.page>=h-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${n}
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){P.category=e,P.page=0,P.query="",ne()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");P.query=e?e.value:"",P.page=0,ne()};window.catalogPage=function(e){const t=Pt(P.category),a=t?t.count:0,s=P.query.trim()?1:Math.max(1,Math.ceil(a/le));P.page=Math.max(0,Math.min(s-1,P.page+e)),ne()};window.catalogToggle=async function(e){const t=!Et().includes(e),a=await Ha(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),ne()};window.catalogResetHidden=async function(){await Ga(),u("All hidden catalog listings restored"),ne()};async function $t(){window.lucide&&lucide.createIcons(),Ut(),await us(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$t):$t();window.aiChatHistory=[];window.aiProductType="product";async function Ii(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),Ot();const s=document.getElementById("ai-prompt");s&&(s.value=""),u("AI is analyzing...");try{let i=null;a&&(i=await fileToDataUrl(a));const r={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:i,catalog_context:await Pi()},o=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(r)})).json();o.success&&o.product?(openListingReviewCard(o.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(o.error||"AI generation failed")}catch(i){u("Error: "+i.message),console.error("[AI] Generate product error:",i)}}async function Pi(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&Ii()});
