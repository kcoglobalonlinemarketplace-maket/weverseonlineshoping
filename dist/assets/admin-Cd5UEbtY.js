import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as Ci,S as me}from"./showroom-data-CWPni_TB.js";import{supabase as b,SUPABASE_URL as On}from"./supabase-client-2BLZ9Gaw.js";import{a as Hn,g as Gn,C as $e}from"./country-data-BSZ5lE1h.js";import{A as Vn}from"./localization-DSfm6ZR4.js";import{patchLocalShowroomListing as Ea,getLocalShowroomListingById as nt,removeLocalShowroomListing as Pt,upsertLocalShowroomListing as Ht,listLocalShowroomListings as Qt}from"./local-showroom-store-mzP0nSoS.js";import{g as Ga,s as Wn,l as zn,a as Kn}from"./payment-settings-BPlsZ55u.js";import{P as Ii,a as Ti,T as Li,M as Ri}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as Yn}from"./catalog-Gzr5neLB.js";import{i as Jn}from"./promo-backgrounds-DwRPd5l7.js";import{i as Mi,D as Qn}from"./site-content-CvSp2XGR.js";import{M as Xn,n as Zn,a as es}from"./categories-5zVhBEjq.js";import{l as Xt,v as Zt,a as Bi,b as Ni}from"./video-frames-q6gaiMMW.js";import{saveCatalogHidden as ct,loadHiddenCatalogIds as Va,getHiddenCatalogIds as ea,resetHiddenCatalogIds as ts}from"./catalog-hidden-store-GylTxrT1.js";/* empty css                                       */const U=1,Y=5e6,as=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],is=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Fi=[...as,...is];function st(e){return Hn[e]||"USD"}function Di(e,t){return Fi.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ns(e,t){const a=Math.max(U,Math.min(Y,Number(e)||U));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function ss(e,t,a,i,n){const s=ns(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${s}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${s}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${s}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${s}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${s}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${s}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${s}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${s}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${s}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${s}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Ui({templateId:e,listingType:t,category:a,countryCode:i,currency:n,price:s}){const o=Fi.find(m=>m.id===e&&m.listingType===t);if(!o)return null;const r=Gn(i)||$e[0],l=n||st(r.code),d=[r.name].filter(Boolean).join(", "),u={category:o.category||a||(t==="property"?"Real Estate":"Other"),subcategory:o.subcategory||o.label,title:t==="property"?`${o.label} in ${r.name}`:o.label,description:ss(o,r,l,s,d),currency:l,features:[...o.features],highlights:[...o.highlights||[]],seo_keywords:[...new Set([o.category,o.subcategory,o.label,...t==="property"?[r.name]:[],...o.keywords||[]].filter(Boolean))],requiredImageCount:o.requiredImageCount||0};return t==="property"?{...u,country:r.name,country_code:r.code,product_location:r.name,property_type:o.propertyType||o.label,bedrooms:o.bedrooms??null,bathrooms:o.bathrooms??null,building_size:o.buildingSize||"",land_size:o.landSize||"",furnished:o.furnished||""}:{...u,brand:o.brand||"",model:o.model||"",color:o.color||"",size:o.size||"",condition:o.condition||"New"}}let xa=null;async function os(){return xa||(xa=Ci(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),xa}function rs(e,t){return e.toDataURL("image/jpeg",t)}async function ls(e,t){const a=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,t/Math.max(a.width,a.height))),n=e.getViewport({scale:i}),s=document.createElement("canvas");s.width=Math.max(1,Math.round(n.width)),s.height=Math.max(1,Math.round(n.height));const o=s.getContext("2d",{alpha:!1});return o.fillStyle="#ffffff",o.fillRect(0,0,s.width,s.height),await e.render({canvasContext:o,viewport:n}).promise,rs(s,.78)}async function Wa(e,{maxDim:t=1300,maxPages:a=0,onProgress:i=()=>{}}={}){const s=await(await os()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,o=s.numPages,r=a>0?Math.min(o,a):o,l=[];try{for(let d=1;d<=r;d++){i(d,r);const u=await s.getPage(d);l.push(await ls(u,t))}}finally{try{await s.destroy()}catch{}}return l}function Ke(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const za="".replace(/\/$/,""),Aa=[{id:"overview",label:"Overview",icon:"layout-dashboard"},{id:"accounts",label:"Connected Accounts",icon:"link-2"},{id:"auto",label:"Automatic Posting",icon:"bot"},{id:"manual",label:"Manual Posting",icon:"pen-line"},{id:"schedule",label:"Posting Schedule",icon:"calendar-clock"},{id:"queue",label:"Content Queue",icon:"list-checks"},{id:"published",label:"Published Posts",icon:"check-circle-2"},{id:"failed",label:"Failed Posts",icon:"alert-triangle"},{id:"logs",label:"Post Logs",icon:"scroll-text"},{id:"platforms",label:"Platform Settings",icon:"settings-2"},{id:"apistatus",label:"API Connection Status",icon:"server"}];let Ut="overview";function k(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function C(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg");if(!a||!i){alert(e);return}i.textContent=e;const n=a.querySelector("i[data-lucide]"),s={success:"check-circle",error:"alert-circle",info:"info"},o={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",s[t]||"info"),n.className=`w-4 h-4 shrink-0 ${o[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3200)}function cs(){return'<div class="flex items-center justify-center py-28"><div class="flex items-center gap-3 text-gray-400 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function we(e,t="inbox"){return`<div class="flex flex-col items-center justify-center py-16 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${t}" class="w-8 h-8 text-blue-400"></i></div><p class="text-sm text-gray-500 max-w-xs">${k(e)}</p></div>`}function Z(){if(window.lucide)try{lucide.createIcons()}catch{}}function Ee(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function ji(){const{data:e}=await b.auth.getSession();return e?.session?.access_token||""}async function Me(e,t={}){const i={authorization:`Bearer ${await ji()}`,"content-type":"application/json",...t.headers||{}},n=await fetch(`${za}${e}`,{...t,headers:i});let s={};try{s=await n.json()}catch{s={}}if(!n.ok)throw Object.assign(new Error(s?.error||`Request failed (HTTP ${n.status})`),{status:n.status,code:s.code});return s}async function ds(e){const t=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),a=`uploads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${t}`,{error:i}=await b.storage.from("social-posts").upload(a,e,{contentType:e.type,upsert:!1,cacheControl:"3600"});if(i)throw i;const{data:n}=b.storage.from("social-posts").getPublicUrl(a),s=(e.type||"").startsWith("video/")||/\.(mp4|webm|mov|m4v)$/i.test(e.name);return{url:n.publicUrl,type:s?"video":"image"}}const re={tiktok:{label:"TikTok",icon:"music-2",tone:"text-white"},telegram:{label:"Telegram",icon:"send",tone:"text-sky-400"},facebook:{label:"Facebook Pages",icon:"thumbs-up",tone:"text-blue-400"},instagram:{label:"Instagram",icon:"camera",tone:"text-pink-400"},youtube:{label:"YouTube",icon:"youtube",tone:"text-red-400"},x:{label:"X (Twitter)",icon:"twitter",tone:"text-gray-300"},pinterest:{label:"Pinterest",icon:"pinterest",tone:"text-red-500"},linkedin:{label:"LinkedIn",icon:"linkedin",tone:"text-sky-500"},whatsapp:{label:"WhatsApp Channels",icon:"message-circle",tone:"text-emerald-400"}};function xe(e){return re[e]?.icon||"share-2"}function W(e){return re[e]?.label||e}function us(e){const t={connected:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disconnected:"bg-gray-500/15 text-gray-300 border-gray-500/30",error:"bg-red-500/15 text-red-300 border-red-500/30",revoked:"bg-red-500/15 text-red-300 border-red-500/30",requires_approval:"bg-amber-500/15 text-amber-300 border-amber-500/30",expired:"bg-amber-500/15 text-amber-300 border-amber-500/30",not_connected:"bg-gray-500/10 text-gray-400 border-gray-500/20",draft:"bg-gray-500/15 text-gray-300 border-gray-500/30",scheduled:"bg-amber-500/15 text-amber-300 border-amber-500/30",queued:"bg-sky-500/15 text-sky-300 border-sky-500/30",publishing:"bg-violet-500/15 text-violet-300 border-violet-500/30",published:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",failed:"bg-red-500/15 text-red-300 border-red-500/30",cancelled:"bg-gray-500/10 text-gray-400 border-gray-500/20",paused:"bg-amber-500/15 text-amber-300 border-amber-500/30",enabled:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disabled:"bg-gray-500/15 text-gray-400 border-gray-500/25"};return t[e]||t.not_connected}function et(e){return`<span class="badge ${us(e)}">${k(e.replace(/_/g," "))}</span>`}function Pa(e="overview"){Ut=Aa.find(a=>a.id===e)?e:"overview";const t=document.getElementById("content");t.innerHTML=`
    ...
    <p class="text-xs text-gray-500 uppercase tracking-wide mt-1 font-bold">${k(a)}</p>
      ...
      <div class="space-y-3">
        ...
        <div id="acct-grid" class="grid md:grid-cols-2 xl:grid-cols-3 gap-3">
          ${i.map(s=>ps(s,n.find(o=>o.platform===s.id))).join("")}
        </div>
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}window.socialAccountsFilter=function(){const e=document.getElementById("acct-filter")?.value||"";document.querySelectorAll("#acct-grid > [data-platform]").forEach(t=>{t.style.display=!e||t.dataset.platform===e?"":"none"})};window.socialRefresh=()=>{Ct(document.getElementById("social-body"))};function ps(e,t){const a=t?.status==="connected";return`
    <div data-platform="${e.id}" class="glass-soft border ${a?"border-emerald-500/25":"border-blue-500/15"} rounded-2xl p-4 space-y-3">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
        ...
        ${wt.length?wt.map(gs).join(""):we("No automation rules yet. Create one to automatically publish products, promotions or news on a schedule.","bot")}
  ...
  </div>`}window.socialToggleGlobal=async function(e){try{const t=qi?.settings||{},a={...t,[e]:!t[e]},{error:i}=await b.from("social_settings").upsert({id:1,...a});if(i)throw i;C(e==="automation_paused"?a[e]?"Automation paused.":"Automation resumed.":"Saved."),It(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};function gs(e){const t=e.enabled&&!e.paused?"enabled":e.paused?"paused":"disabled",a={products:"New products (auto-pick new arrivals)",selected_products:"Selected products",promotions:"Promotions",content_items:"News / articles (Content Items)"},i={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},n=e.next_run_at?`Next run ${Ee(e.next_run_at)}`:"First run pending";return`
...
{{link}}`,hashtags:document.getElementById("rule-hashtags").value.trim(),include_price:document.getElementById("rule-price").checked,include_link:document.getElementById("rule-link").checked,next_run_at:new Date().toISOString()};e?await b.from("social_automation_rules").update(r).eq("id",e):await b.from("social_automation_rules").insert(r),document.querySelector(".modal-overlay")?.remove(),C("Rule saved. Enable it when ready."),It(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};let S={sourceType:"product",sourceId:"",caption:"",hashtags:"",platform:"",media:[],linkUrl:"",allowDuplicate:!1};async function Hi(e){try{const t=await Ye(),a=(t.platforms||[]).filter(l=>l.connected&&l.enabled),i=(t.accounts||[]).filter(l=>l.status==="connected"),{data:n}=await b.from("showroom_listings").select("property_id,title,category,price,currency,images,video_url,listing_type").eq("is_active",!0).limit(600),{data:s}=await b.from("promotions").select("id,title,image_url,video_url").eq("is_active",!0).limit(50),{data:o}=await b.from("social_content_items").select("*").order("created_at",{ascending:!1}).limit(50),{data:r}=await b.from("social_posts").select("*").eq("status","draft").order("created_at",{ascending:!1}).limit(40);S.platform=S.platform||a[0]?.id||"",S.sourceType=S.sourceType||(r?.length?"draft":"product"),e.innerHTML=`
      <div class="grid lg:grid-cols-3 gap-4">
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div><label class="lbl">Source</label>
            <select id="mp-source" onchange="window.socialManualSource()" class="input-field">
              <option value="product" ${S.sourceType==="product"?"selected":""}>Marketplace product</option>
              <option value="promo" ${S.sourceType==="promo"?"selected":""}>Promotion</option>
              <option value="content" ${S.sourceType==="content"?"selected":""}>News / article (Content Item)</option>
              <option value="text" ${S.sourceType==="text"?"selected":""}>Custom text / announcement</option>
              <option value="draft" ${S.sourceType==="draft"?"selected":""}>Saved draft</option>
            </select>
          </div>

          <div id="mp-source-picker">${bs(S.sourceType,n,s,o,r)}</div>

          <div><label class="lbl">Caption</label><textarea id="mp-caption" class="input-field" placeholder="Write your post caption…">${k(S.caption)}</textarea></div>
          <div><label class="lbl">Hashtags</label><input id="mp-hashtags" class="input-field" value="${k(S.hashtags)}" placeholder="#newarrival #marketplace"></div>
          <div><label class="lbl">Link (optional)</label><input id="mp-link" class="input-field" value="${k(S.linkUrl)}" placeholder="https://…"></div>

          <div>
            <label class="lbl">Media</label>
            <div id="mp-media" class="space-y-2">${S.media.length?S.media.map((l,d)=>Gi(l,d)).join(""):'<p class="text-[11px] text-gray-500">Media auto-fills from the source. Add extra image/video below.</p>'}</div>
        ...
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div id="mp-platforms" class="space-y-2">
            ${a.length?a.map(l=>`
              <label class="flex items-center gap-3 p-3 rounded-xl bg-white/[.03] border ${S.platform===l.id?"border-blue-500/50":"border-white/10"} cursor-pointer transition" onclick="window.socialManualPlatform('${l.id}')">
                <input type="radio" name="mp-p" class="accent-blue-600" ${S.platform===l.id?"checked":""}>
        ...
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div id="mp-preview" class="border border-white/10 rounded-2xl overflow-hidden bg-black/30">
            ${Vi(S.media,S.caption,S.hashtags,S.platform)}
          </div>
          <label class="flex items-center gap-2 text-xs text-gray-300 mt-3"><input type="checkbox" id="mp-dup" ${S.allowDuplicate?"checked":""} style="accent-color:#2563eb"> Allow duplicate (bypass duplicate-post protection)</label>
      ...
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}function bs(e,t,a,i,n){return e==="product"?`<div class="grid grid-cols-2 gap-2 max-h-44 overflow-y-auto scrollbar-thin border border-white/10 rounded-xl p-2 bg-white/[.02]">
    ...
    </div>`:`<p class="text-[11px] text-gray-500">Write a custom announcement — remember to comply with each platform's rules.</p>`}window.socialManualSource=function(){S.sourceType=document.getElementById("mp-source").value,S.caption="",S.linkUrl="",S.media=[],Hi(document.getElementById("social-body"))};window.socialPickProduct=function(e,t){b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle().then(({data:a})=>{if(!a)return;S.sourceId=e,S.linkUrl=`${window.location.origin}/product/${encodeURIComponent(e)}`;const i=Array.isArray(a.images)?a.images.filter(o=>/^https?:\/\//i.test(o)).slice(0,6).map(o=>({url:o,type:"image"})):[];a.video_url&&/^https?:\/\//i.test(a.video_url)&&i.push({url:a.video_url,type:"video"}),S.media=i;const n=a.currency||"USD",s=a.price!=null?`${Number(a.price).toLocaleString("en-US")} ${n}`:"";S.caption=`${a.title}
${s?`${s}
`:""}${S.linkUrl}`,document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne(),document.querySelectorAll("#mp-source-picker button").forEach(o=>{o.classList.remove("bg-blue-500/10","text-white","border-blue-500/30"),o.classList.add("border-transparent")}),t&&(t.classList.add("bg-blue-500/10","text-white","border-blue-500/30"),t.classList.remove("border-transparent"))})};window.socialPickPromo=function(e,t){b.from("promotions").select("*").eq("id",e).maybeSingle().then(({data:a})=>{a&&(S.sourceType="promo",S.sourceId=e,S.media=[],a.image_url&&/^https?:\/\//i.test(a.image_url)&&S.media.push({url:a.image_url,type:"image"}),a.video_url&&/^https?:\/\//i.test(a.video_url)&&S.media.push({url:a.video_url,type:"video"}),S.caption=a.title||"Special offer",document.getElementById("mp-caption").value=S.caption,Je(),Ne())})};window.socialPickContent=function(e,t){b.from("social_content_items").select("*").eq("id",e).maybeSingle().then(({data:a})=>{a&&(S.sourceType="content",S.sourceId=e,S.media=[],a.image_url&&/^https?:\/\//i.test(a.image_url)&&S.media.push({url:a.image_url,type:"image"}),a.video_url&&/^https?:\/\//i.test(a.video_url)&&S.media.push({url:a.video_url,type:"video"}),S.caption=`${a.title}
${a.body||""}`.trim(),S.linkUrl=a.link_url||"",document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne())})};window.socialLoadDraft=async function(e){const{data:t}=await b.from("social_posts").select("*").eq("id",e).maybeSingle();t&&(window.socialNav("manual"),setTimeout(()=>{S={sourceType:"text",sourceId:t.id,caption:t.caption||"",hashtags:(t.hashtags||"").replace(/#/g,""),platform:t.platform,media:Array.isArray(t.media)?t.media:[],linkUrl:t.metadata?.link_url||"",allowDuplicate:!0},document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-hashtags").value=S.hashtags,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne()},200))};window.socialManualPlatform=function(e){S.platform=e,document.querySelectorAll("#mp-platforms label").forEach((a,i,n)=>{a.classList.toggle("border-blue-500/50",a.querySelector(".accent-blue-600")?.value===e)}),document.querySelectorAll("#mp-platforms label").forEach(a=>a.classList.remove("border-blue-500/50"));const t=Array.from(document.querySelectorAll("#mp-platforms label")).find(a=>a.textContent.includes(W(e)));t&&t.classList.add("border-blue-500/50"),Ne()};window.socialAddMediaUrl=function(){const e=document.getElementById("mp-media-url").value.trim();if(!e)return;const t=/\.(mp4|webm|mov|m4v)(\?|$)/i.test(e)?"video":"image";S.media.push({url:e,type:t}),document.getElementById("mp-media-url").value="",Je(),Ne()};window.socialAddMediaFile=async function(e){const t=e.target.files?.[0];if(t){try{C("Uploading media…","info");const a=await ds(t);S.media.push(a),Je(),Ne(),C("Media added.")}catch(a){C(a.message,"error")}e.target.value=""}};function Gi(e,t){return`<div class="flex items-center gap-2 p-2 rounded-lg bg-white/[.03] border border-white/10">
  ...
  </div>`}window.socialRemoveMedia=function(e){S.media.splice(e,1),Je(),Ne()};function Je(){const e=document.getElementById("mp-media");e&&(e.innerHTML=S.media.length?S.media.map(Gi).join(""):'<p class="text-[11px] text-gray-500">No media. Add an image or video URL, or upload a file.</p>'),Z()}function Vi(e,t,a,i){const n=e?.[0],s=[t,a?a.split(/[ ,]+/).map(o=>"#"+o.replace(/^#/,"")).join(" "):""].filter(Boolean).join(`
`);return`
    ...
    </div>`}function Ne(){S.caption=document.getElementById("mp-caption")?.value??S.caption,S.hashtags=document.getElementById("mp-hashtags")?.value??S.hashtags;const e=document.getElementById("mp-preview");e&&(e.innerHTML=Vi(S.media,S.caption,S.hashtags,S.platform)),Z()}function ys(){S.caption=document.getElementById("mp-caption")?.value||"",S.hashtags=document.getElementById("mp-hashtags")?.value||"",S.linkUrl=document.getElementById("mp-link")?.value||"",S.allowDuplicate=document.getElementById("mp-dup")?.checked||!1;const e=S.hashtags.split(/[\s,]+/).filter(Boolean).map(t=>t.replace(/^#/,"")).filter(Boolean);return{platform:S.platform,caption:S.caption,hashtags:e,media:S.media,linkUrl:S.linkUrl,contentType:S.sourceType==="draft"?"manual":S.sourceType,sourceType:fs(S.sourceType),sourceId:S.sourceId,allowDuplicate:S.allowDuplicate}}function fs(e){return e==="promo"?"promotions":e==="content"?"social_content_item":e==="product"?"showroom_listing":null}window.socialManualGo=async function(e){const t=ys();if(!t.platform)return C("Select a platform first.","error");if(!t.caption.trim()&&t.sourceType==="text")return C("Write a caption.","error");if(t.sourceType==="showroom_listing"&&!t.sourceId)return C("Pick a product first.","error");if(S.sourceType==="draft"&&S.sourceId)try{await Me("/api/social/posts",{method:"POST",body:JSON.stringify({action:"trigger",post_id:S.sourceId})}),C("Draft published."),window.socialNav("published");return}catch(a){return C(a.message,"error")}if(e==="schedule"){const a=document.getElementById("mp-when")?.value;if(!a)return C("Choose a date and time to schedule.","error");t.mode="schedule",t.scheduledFor=new Date(a).toISOString()}else e==="draft"?t.mode="draft":t.mode="publish_now";try{const a=document.getElementById("social-body")?.querySelector("button");a&&(a.disabled=!0);const i=await Me("/api/social/publish",{method:"POST",body:JSON.stringify(t)});C(i.message||"Done."),S.media=[],window.socialNav(e==="publish_now"?"published":e==="schedule"?"schedule":"queue")}catch(a){C(a.message,"error")}};async function hs(e){try{const[t,a]=await Promise.all([b.from("social_automation_rules").select("*").eq("enabled",!0).order("next_run_at"),b.from("social_posts").select("*").eq("status","scheduled").order("scheduled_for")]),i=t.data||[],n=a.data||[];e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
    ...
    <div class="space-y-4">
      ${["publishing","queued","draft"].map(n=>`
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          ...
          ${i[n].length?i[n].map(s=>vs(s)).join(""):'<p class="text-[11px] text-gray-600 py-2">Empty.</p>'}
        </div>`).join("")}
    </div>`,Z()}function vs(e){const t=e.status==="draft";return`
    <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
    ...
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      ...
      ${a.length?`<div class="space-y-2">${a.map(xs).join("")}</div>`:we("No published posts yet. Post manually or enable automation.","check-circle-2")}
    </div>`,Z()}function xs(e){const t=(e.media||[])[0];return`
    <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
    ...
    </div>`}async function _s(e){const{data:t}=await b.from("social_posts").select("*").eq("status","failed").order("updated_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
    <div class="glass-soft border border-red-500/20 rounded-2xl p-5 space-y-3">
      ...
      ${a.length?a.map(ks).join(""):we("No failed posts.","check-circle-2")}
    </div>`,Z()}function ks(e){const t=e.next_retry_at;return`
    ...
    </div>`}async function Ss(e){const[t,a]=await Promise.all([b.from("social_post_logs").select("*").order("created_at",{ascending:!1}).limit(300),b.from("social_posts").select("id,caption,platform")]),i=t.data||[],n=new Map((a.data||[]).map(o=>[o.id,o])),s={info:"text-sky-300",warn:"text-amber-300",error:"text-red-300"};e.innerHTML=`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
    ...
    </div>`}function As(e){const t=aa.find(i=>i.platform===e.id)||{},a=t.config||{};return e.account,`
    ...
    </div>`}function Ps(e,t,a){const i=[];if(e==="tiktok"&&i.push(`<div><label class="lbl">Post privacy</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="tiktok_privacy_level">
    ...
    </select></div>`),i.length?`<div class="grid grid-cols-2 gap-2">${i.join("")}</div>`:""}window.socialTogglePlatform=async function(e,t){await Cs(e,{enabled:t})};async function Cs(e,t){const a=aa.find(n=>n.platform===e),{error:i}=await b.from("social_platform_settings").upsert({id:a?.id,platform:e,...t,updated_at:new Date().toISOString()},{onConflict:"platform"});if(i){C(i.message,"error");return}C(`${W(e)} ${t.enabled!==void 0?t.enabled?"enabled":"disabled":"saved"}.`)}window.socialSavePlatform=async function(e){const t=Array.from(document.querySelectorAll(`[onchange="window.socialSavePlatform('${e}')"]`)),a={};for(const s of t){const o=s.dataset.f;o&&(a[o]=s.value)}const i=aa.find(s=>s.platform===e),{error:n}=await b.from("social_platform_settings").upsert({id:i?.id,platform:e,config:{...i?.config||{},...a},updated_at:new Date().toISOString()},{onConflict:"platform"});if(n){C(n.message,"error");return}C(`${W(e)} settings saved.`)};window.socialCopy=function(e){const t=e.dataset.text||"";navigator.clipboard?.writeText(t).then(()=>C("Copied.")).catch(()=>C("Copy failed.","error"))};async function Is(e){try{const t=await Ye(),a=t.serverConfigured||{};e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){B.section=e;const t=Ms[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ji(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=dt()),window.lucide&&lucide.createIcons(),({dashboard:Js,products:T,properties:ma,catalog:yt,orders:si,customers:Qo,reviews:Mt,messages:An,coupons:ga,ads:gt,notifications:er,ai:Ns,"ai-settings":Tn,"homepage-branding":fa,"promo-bg":At,content:rr,"content-settings":Mn,seo:br,email:yr,analytics:gr,security:ya,activity:fr,brand:bt,"payment-settings":Ha,backup:hr,settings:vr,publish:va,social:()=>Pa("overview"),"social-settings":()=>Pa("platforms")}[e]||(()=>{const o=document.getElementById("content");o&&(o.innerHTML=We("construction","Coming Soon",`${t} is being built.`))}))()};async function Ns(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const tt="kco_admin_remember",Ja="kco_login_attempts",Ca=5,Fs=15*60*1e3;function X(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Ds(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function sa(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Tt(e){return String(e||"").trim().toLowerCase()}function Us(){try{const e=JSON.parse(localStorage.getItem(tt)||"{}");e?.email&&!Tt(e.email)&&localStorage.removeItem(tt)}catch{localStorage.removeItem(tt)}}function js(){try{const e=JSON.parse(localStorage.getItem(tt)||"{}");return Tt(e?.email)}catch{return""}}function Qa(){Us();const e=js(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Wi,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function qs(){return`${window.location.origin}/admin.html`}function Qe(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),sa(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function V(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Qi(){try{return JSON.parse(localStorage.getItem(Ja)||'{"count":0}')}catch{return{count:0}}}function Xi(){const e=Qi();return e.count=(e.count||0)+1,e.count>=Ca&&(e.lockedUntil=Date.now()+Fs),localStorage.setItem(Ja,JSON.stringify(e)),e}function Zi(){localStorage.removeItem(Ja)}function en(){const e=Qi();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Zi(),null):Math.ceil(t/6e4)}async function fe(e,t,a={}){try{await b.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Os(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Os(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function tn(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await b.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Tt(e.email)===Wi}async function Hs(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Gt(),Ys();return}const{data:{session:t}}=await b.auth.getSession();if(t?.user&&await tn(t.user)){const{data:{currentUser:i}}=await b.auth.getUser(),n=await b.auth.mfa.getAuthenticatorAssuranceLevel(),s=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&s!=="aal2"){B.user=t.user,Gt(),Qe("2fa"),Xa();return}B.user=t.user,oa();return}Gs()}function Gt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Gs(){Gt(),Qe("login"),Qa(),an(),nn(),Xa(),Vs();const e=en();e&&(X(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Vs(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function an(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Ws),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Qe("forgot")))}async function Ws(e){e.preventDefault();const t=en();if(t){X(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Tt(a?.value);if(!i){X("Enter your admin email address."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,s=document.getElementById("remember-me")?.checked;V("login-btn",!0),sa();const{data:o,error:r}=await b.auth.signInWithPassword({email:i,password:n});if(r||!o.user){const f=String(r?.message||"").toLowerCase();if(f.includes("missing supabase credentials")||f.includes("authentication service is unavailable")){X("Authentication is temporarily unavailable due to configuration. Please contact support."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("failed to fetch")||f.includes("network request failed")){X("Network error while signing in. Check your connection and try again."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("email not confirmed")){X("Your admin email is not confirmed yet. Open your verification email and confirm first."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const v=Xi(),p=Ca-v.count,g=v.lockedUntil?`Account locked for 15 minutes after ${Ca} failed attempts.`:`Invalid email or password. ${p>0?p+" attempt"+(p!==1?"s":"")+" remaining.":""}`;X(g),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),o?.user&&await fe(o.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await tn(o.user)){await b.auth.signOut(),X(`Access denied for ${o.user.email}. This account is signed in but does not have administrator privileges.`),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await fe(o.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(s?localStorage.setItem(tt,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(tt),Zi(),B.user=o.user,(await b.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Qe("2fa"),Xa(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await fe(o.user.id,"login_success"),V("login-btn",!1),oa()}function Xa(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",gi));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&gi()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await b.auth.signOut(),B.user=null,Qe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",zs))}async function gi(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){X("Enter the 6-digit code from your authenticator app.");return}V("verify-2fa-btn",!0),sa();try{const{data:t}=await b.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){X("No 2FA factor found. Please re-login."),V("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await b.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:s}=await b.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(s)throw s;await fe(B.user.id,"login_2fa_success"),V("verify-2fa-btn",!1),oa()}catch(t){Xi(),X(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),V("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function zs(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){X("Enter a backup recovery code.");return}V("verify-backup-btn",!0);try{const{data:t}=await b.from("admin_2fa").select("backup_codes").eq("user_id",B.user.id).maybeSingle();if(!t?.backup_codes?.length){X("No backup codes found."),V("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){X("Backup code not found or already used."),V("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await b.from("admin_2fa").update({backup_codes:i}).eq("user_id",B.user.id),await fe(B.user.id,"login_backup_code_used"),oa()}catch(t){X(t.message),V("verify-backup-btn",!1,"Use Backup Code")}}function nn(){document.getElementById("back-to-login")?.addEventListener("click",()=>Qe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Ks)}async function Ks(){const e=document.getElementById("reset-email"),t=Tt(e?.value);if(!t){X("Enter your admin email address to receive a reset link.");return}V("send-reset-btn",!0),sa();const{error:a}=await b.auth.resetPasswordForEmail(t,{redirectTo:qs()});if(V("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){X(a.message);return}Ds("Reset link sent! Check your inbox and open it from this device to continue.")}function Ys(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,on(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${c(t.message)}</div>`)}}function Te(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function St(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Qs(e){const t=Te(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Xs(e){const t=Te(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function ra(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Ia(e){return parseInt(e.views??e.view_count??0,10)||0}function Ta(e){return parseInt(e.sales??e.sales_count??0,10)||0}function la(e){return e.sku||e.property_id||"N/A"}function Zs(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=St(e),i=ra(e),n=window._productSelection?.has(e.property_id),s=ie(i==="archived"?"inactive":i==="active"?"active":"inactive"),o=ge(e.created_at),r=!!e.is_featured,l=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",u=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${c(e.category||"")}" data-status="${i}" data-featured="${r?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${c(Qs(e))}</p></div>
...
<input type="file" id="img-upload" class="hidden" multiple accept="image/*,video/mp4,video/webm,video/*,application/pdf" onclick="event.stopPropagation()" onchange="handleImageUpload(event)">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,o=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,r=e.dataset.category||"Product",l=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;j(`
    ...
    </div>`)};function po(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=at(e,t),n=document.getElementById("product-autosave-note");if(!t)try{const l=localStorage.getItem(i);if(l){const d=JSON.parse(l);uo(a,d)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const s=()=>{try{localStorage.setItem(i,JSON.stringify(co(a))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}Na()};let o;const r=()=>{clearTimeout(o),o=setTimeout(s,500)};a.querySelectorAll("input, textarea, select").forEach(l=>{l.addEventListener("input",r),l.addEventListener("change",r)}),Na(),Xe()}const mo=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],go=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],bo=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],yo=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],fo=["FWD","RWD","AWD","4WD"],gn=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function fi(e){const t=e.id?`label[for="${e.id}"]`:null,a=t?document.querySelector(t):null;if(a)return a.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function ho(e){const t=document.querySelector(e);if(!t)return[];const a=new Set,i=[];return t.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const s=String(n.name||"");if(!s||s==="images"||a.has(s)||["hidden","file","submit","button"].includes(n.type))return;if(a.add(s),n.type==="checkbox"){const r=[...t.querySelectorAll(`input[name="${s}"]`)];i.push({key:s,label:fi(n),type:"checkbox-group",options:r.map(l=>l.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const o=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:s,label:fi(n),type:o,options:n.tagName==="SELECT"?[...n.options].map(r=>r.value).filter(Boolean):null,required:!!n.required})}),i}function vo(e){return!e||!e.length?"":`
...
`}const wo=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function $a(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(u=>String(u)):[]),s=[],o=[],r=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(f=>f!=null&&String(f).trim()!=="").join(", "));let m=String(u).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},l=u=>{const m=r(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),f=parseFloat(m);return Number.isFinite(f)?f:NaN};for(const u of e||[]){if(gn.has(u.key))continue;const m={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const p=Array.isArray(a[u.key])?a[u.key].map(r).filter(Boolean):[],g=u.options&&u.options.length?p.filter(h=>u.options.includes(h)):p;g.length?(a[u.key]=g,m.status="filled",m.value=g.join(", ")):(delete a[u.key],p.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",o.push(`${u.label}: invalid selection ignored`))),s.push(m);continue}if(!(a[u.key]!=null&&r(a[u.key])!=="")){m.status=n.has(u.key)?"missing":"empty-ok",s.push(m);continue}if(wo.test(r(a[u.key]))){delete a[u.key],n.add(u.key),m.status="missing",m.note="document/AI said the value is unavailable",s.push(m);continue}if(u.type==="number"){const p=r(a[u.key]),g=l(a[u.key]);if(!Number.isFinite(g)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`"${p}" is not a valid number`,o.push(`${u.label}: not a valid number`),s.push(m);continue}if(/year/.test(u.key)&&(g<1800||g>new Date().getFullYear()+2)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`${g} is outside the plausible range`,o.push(`${u.label}: implausible value ${g}`),s.push(m);continue}a[u.key]=g,m.status="filled",m.value=String(g),i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),s.push(m);continue}if(u.type==="select"&&u.options&&u.options.length){const p=bn({options:u.options.map(g=>({value:g}))},r(a[u.key]));if(p==null){m.status="flagged",m.note=`"${r(a[u.key])}" does not match any option â€” left empty`,o.push(`${u.label}: no matching option`),delete a[u.key],n.add(u.key),s.push(m);continue}a[u.key]=p,m.status="filled",m.value=p,p!==r(t?.[u.key])&&(m.note="matched to the closest option"),s.push(m);continue}let v=r(a[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&v.length>120&&!["title"].includes(u.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",o.push(`${u.label}: suspiciously long value`)),a[u.key]=v,m.status="filled",m.value=v.length>48?v.slice(0,48)+"â€¦":v,i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),s.push(m)}if(e&&e.length){const u=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(m=>{u.has(m)||delete a[m]})}a.missing_fields=s.filter(u=>u.status==="missing").map(u=>u.key),a.estimated=s.filter(u=>u.status==="estimated").map(u=>u.key);const d={total:s.length,filled:s.filter(u=>u.status==="filled").length,estimated:s.filter(u=>u.status==="estimated").length,flagged:s.filter(u=>u.status==="flagged").length,missing:s.filter(u=>u.status==="missing").length};return{specs:a,checklist:s,flags:o,summary:d}}const zt={activeProvider:"gemini",maxImages:4,PROVIDERS:{gemini:{label:"Google Gemini (Free Tier)",scan:async(e,t)=>{const a=typeof t.onProgress=="function"?t.onProgress:()=>{};a(1,"Identifying the exact product from your imagesâ€¦");const i=await J.identifyProduct(e,t);if(!i||i.identified===!1)return{identification:i,specs:null,price:null};a(2,"Completing specifications and estimating a fair market priceâ€¦");const n=await J.completeSpecsAndPrice(e,i,t).catch(()=>null);return{identification:i,specs:n?n.specs:null,price:n?n.price:null}}}},async scan(e,t){const a=this.PROVIDERS[this.activeProvider];if(!a)throw new Error(`Scanner provider "${this.activeProvider}" is not configured.`);return a.scan(e||[],t)}};function bn(e,t){const a=[...e.options||[]].map(o=>o.value).filter(Boolean);if(a.includes(String(t)))return String(t);const i={petrol:"Gasoline",gas:"Gasoline",gasoline:"Gasoline",unleaded:"Gasoline",ev:"Electric",electric:"Electric","fully electric":"Electric",hybrid:"Hybrid","hybrid electric":"Hybrid","plug-in hybrid":"Plug-in Hybrid",phev:"Plug-in Hybrid",auto:"Automatic",automatic:"Automatic","automatic transmission":"Automatic",manual:"Manual","manual transmission":"Manual",cvt:"CVT","continuously variable":"CVT","dual clutch":"Dual-Clutch",dct:"Dual-Clutch",fwd:"FWD","front-wheel drive":"FWD","front wheel drive":"FWD",rwd:"RWD","rear-wheel drive":"RWD","rear wheel drive":"RWD",awd:"AWD","all-wheel drive":"AWD","all wheel drive":"AWD","4wd":"4WD","four-wheel drive":"4WD","four wheel drive":"4WD","4x4":"4WD",sedan:"Sedan",saloon:"Sedan",suv:"SUV",hatchback:"Hatchback",coupe:"Coupe","coupÃ©":"Coupe",convertible:"Convertible",wagon:"Wagon",estate:"Wagon",pickup:"Pickup","pick up":"Pickup",van:"Van",truck:"Truck","sports car":"Sports Car",motorcycle:"Motorcycle",yacht:"Yacht","like new":"Used - Like New","used - like new":"Used - Like New"},n=String(t).toLowerCase().trim();return i[n]?i[n]:a.find(o=>o.toLowerCase().includes(n)||n.includes(o.toLowerCase()))||null}function xo(e,t,a,i){const n={},s=[],o=new Map((i||[]).map(v=>[v.key,v])),r=v=>o.has(v),l=v=>t[v]==null||String(Array.isArray(t[v])?t[v].join(", "):t[v]).trim()==="",d=(v,p)=>{if(p==null||String(p).trim()==="")return;const g=o.get(v);!g||!l(v)||g.type==="select"&&g.options&&g.options.length&&!g.options.includes(p)||(n[v]=p,s.push(v))},u=a||{},m=/cars?|trucks?|vehicle|motor|marine/i.test(String(e||""))||u.listing_type==="vehicle"||!!u.body_type,f=/estate|propert|real|house|villa|home|land/i.test(String(e||""))||u.listing_type==="property"||!!u.property_type;if(m){const v=String(t.body_type||u.body_type||""),p=v.toLowerCase(),g=[t.engine,t.trim,t.mileage,t.fuel_economy,t.title,u.model,u.brand,v,t.wheels_tires].filter(Boolean).join(" ").toLowerCase(),h=parseInt(String(t.model_year||u.year||""),10);let _="";/plug[ -]?in|phev/.test(g)?_="Plug-in Hybrid":/hybrid|hev|mhev/.test(g)?_="Hybrid":/electric|tesla|\bbev\b|single[- ]?speed/.test(g)?_="Electric":/lpg|gpl|autogas|cng/.test(g)?_="LPG":/bio[- ]?diesel/.test(g)?_="Bio-diesel":/diesel|tdi|\bhdi\b|\bcrdi\b|\bcdti\b|\bd4d\b|\bdci\b|turbo[- ]?d/.test(g)?_="Diesel":(/gasoline|petrol|\bgas\b|unleaded/.test(g),_="Gasoline"),d("fuel_type",_);let x="";/manual|\bstick\b/.test(g)?x="Manual":/cvt|continuously/.test(g)?x="CVT":/dual[- ]?clutch|\bdct\b/.test(g)?x="Dual-Clutch":/semi[- ]?automatic|\bamt\b/.test(g)?x="Semi-Automatic":/automatic|\bauto\b|shift[- ]?tronic|torque[- ]?converter|\d[ -]?speed/.test(g)?x="Automatic":x=Number.isFinite(h)&&h<2014?"Manual":"Automatic",d("transmission",x);let w="";/4wd|\b4x4\b|four[- ]?wheel|quad/.test(g)?w="4WD":/awd|all[- ]?wheel/.test(g)?w="AWD":/rwd|rear[- ]?wheel/.test(g)?w="RWD":/fwd|front[- ]?wheel/.test(g)?w="FWD":/pickup|truck/.test(p)?w="4WD":/suv/.test(p)?w="AWD":/motorcycle/.test(p)?w="RWD":w="FWD",d("drive_type",w);const E={sedan:5,hatchback:5,coupe:4,convertible:4,wagon:5,suv:5,"sports car":2,"luxury sedan":5,pickup:5,truck:3,van:8,bus:20,motorhome:6,motorcycle:2,yacht:6,"jet ski":2},P={sedan:4,hatchback:5,coupe:2,convertible:2,wagon:5,suv:5,"sports car":2,"luxury sedan":4,pickup:4,truck:4,van:5,bus:2,motorhome:3,motorcycle:0,"jet ski":0};for(const[N,G]of[["seating_capacity",E],["doors",P]]){if(!r(N))continue;const ue=Object.entries(G).find(([ne])=>p.includes(ne));ue&&d(N,String(ue[1]))}const $=String(t.vehicle_type||u.vehicle_type||"").toLowerCase();!v&&r("body_type")&&(/motorhome|rv/.test($)?d("body_type","Motorhome"):/jet/.test($)?d("body_type","Jet Ski"):/marine|boat|yacht/.test($)?d("body_type","Yacht"):/bus/.test($)?d("body_type","Bus"):/motorcycle/.test($)?d("body_type","Motorcycle"):/truck/.test($)&&d("body_type","Truck"));const A=String(t.condition||"").toLowerCase();!t.mileage&&/new/.test(A)&&r("mileage")&&d("mileage","0 mi"),!t.condition&&r("condition")&&d("condition","Used - Good"),!t.previous_owners&&r("previous_owners")&&d("previous_owners",/new/.test(A)?"None (new)":"1"),!t.registration_status&&r("registration_status")&&d("registration_status","Registered"),!t.inspection_status&&r("inspection_status")&&d("inspection_status","Not Inspected"),!t.warranty&&r("warranty")&&d("warranty","Manufacturer warranty - confirm remaining coverage with the seller")}if(f){const v=String(t.property_type||u.property_type||"").toLowerCase(),p=String(t.building_size||t.floor_plan_total_area||""),g=parseFloat(p.replace(/[^0-9.]/g,""));let h=null,_=null;if(Number.isFinite(g)&&g>100&&(h=Math.max(2,Math.min(6,Math.round(g/600))),_=Math.max(1,Math.min(4,h>4?3:h-1))),l("bedrooms")&&r("bedrooms")&&h&&d("bedrooms",String(h)),l("bathrooms")&&r("bathrooms")&&_&&d("bathrooms",String(_)),l("listing_status")&&r("listing_status")){const x=String(t.title||"")+" "+String(t.description||"");d("listing_status",/for rent|lease|\brent\b/.test(x.toLowerCase())?"rent":"sale")}if(l("furnished")&&r("furnished")&&d("furnished",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Unfurnished":"Furnished"),l("condition")&&r("condition")&&d("condition","Good"),l("floors")&&r("floors")){const x=/mansion|villa|townhouse/.test(v)?"2":/apartment|condo|single/.test(v)?"1":null;x&&d("floors",x)}l("kitchens")&&r("kitchens")&&d("kitchens","1"),l("parking_spaces")&&r("parking_spaces")&&/car|garage|parking/.test(String(t.garage||"").toLowerCase())&&d("parking_spaces","1"),l("property_type")&&r("property_type")&&d("property_type",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Land":"Single-Family Home")}return{specs:n,estimated:s}}function hi(e){const t=[];return e.year&&t.push(e.year),e.brand&&t.push(e.brand),e.model&&t.push(e.model),!e.model&&e.body_type&&t.push(e.body_type),t.join(" ")||e.detected_name||""}const ti=new Set(["images","tags","currency","catalog_template_id","country_code","listing_type","category","property_id","id","slug","user_id","latitude","longitude","cover_image","video_url"]);function ai(e,{titleFallback:t="Product",descriptionFallback:a="",visionUsed:i=!0}={}){const n=document.querySelector(e);if(!n||!i)return 0;let s=0;return n.querySelectorAll("input, textarea, select").forEach(o=>{const r=String(o.name||"").trim();if(!r||ti.has(r))return;const l=String(o.type||"").toLowerCase();if(!["hidden","checkbox","radio","file","submit","button","image","password"].includes(l)&&!o.disabled&&String(o.value||"").trim()===""){if(r==="price"||r==="real_price"){const d=Number.isFinite(Number(U))?Number(U):1;o.value=String(d),s++;return}if(r==="stock_quantity"){o.value="1",s++;return}if(r==="title"){o.value=t,s++;return}if(r==="description"){o.value=a||`${t} â€” full details to be confirmed by the seller. Review and edit everything before publishing.`,s++;return}if(l==="number"||l==="range"||l==="tel"){o.value="0",s++;return}}}),s}function _o(e,t={}){const a=e&&e.identification&&e.identification.identified!==!1?e.identification:{},i=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,s=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,o=[],r=P=>Array.isArray(P)?P.join(", "):String(P??"").trim(),l=(P,$,A)=>{if($==null||r([$])==="")return;const N=document.querySelector(`#product-form [name="${P}"]`);if(!N)return;let G=String($);if(A&&!A.includes(G)){const ue=bn(N,G);if(ue===null)return;G=ue}N.value=G,o.push(P)};l("brand",a.brand),l("model",a.model),l("color",a.color),l("condition",a.condition,mo),l("subcategory",a.subcategory),l("body_type",a.body_type||i.body_type,go),l("model_year",i.model_year||a.year),l("title",i.title||hi(a)),l("description",i.description),l("engine",i.engine),l("transmission",i.transmission,bo),l("fuel_type",i.fuel_type,yo),l("drive_type",i.drive_type,fo),l("horsepower",i.horsepower),l("mileage",i.mileage),l("seating_capacity",i.seating_capacity),l("doors",i.doors),l("safety_features",r(i.safety_features)),l("storage",i.storage),l("ram",i.ram),l("processor",i.processor),l("display",i.display),l("graphics",i.graphics),l("os",i.os),l("material",i.material),l("size",i.size),l("gender",i.gender),l("platform",i.platform),l("type",i.type||a.type),l("age_range",i.age_range),l("skin_type",i.skin_type),l("ingredients",i.ingredients),l("dimensions",i.dimensions),l("author",i.author),l("publisher",i.publisher),l("language",i.language),l("format",i.format),l("isbn",i.isbn),l("pages",i.pages),l("edition",i.edition),l("quantity",i.quantity),l("pet_type",i.pet_type),l("lens",i.lens),l("sensor",i.sensor),l("megapixels",i.megapixels),l("video",i.video),l("license",i.license),l("version",i.version),l("duration",i.duration),l("followers",i.followers),l("engagement",i.engagement),l("niche",i.niche),l("usage",i.usage),l("shelf_life",i.shelf_life),l("assembly",i.assembly),l("weatherproof",i.weatherproof),l("warranty",i.warranty||a.warranty),l("availability_status",i.availability_status),l("features_text",r(i.features)),l("highlights_text",r(a.highlights||i.highlights)),l("seo_keywords_text",r(i.seo_keywords));const d=new Set((Array.isArray(i.tags)?i.tags:[]).map(P=>String(P).trim()));document.querySelectorAll('#product-form input[name="tags"]').forEach(P=>{d.has(P.value)&&(P.checked=!0,o.push("tags"))});const u=Number(i.stock_quantity);Number.isFinite(u)&&u>0&&l("stock_quantity",u);const m=document.querySelector('#product-form [name="price"]'),f=document.querySelector('#product-form [name="real_price"]'),v=n?Number(n.estimated_price):NaN,p=n?Number(n.suggested_discount_price):NaN,g=Number.isFinite(Number(U))?Number(U):0,h=Number.isFinite(Number(Y))?Number(Y):999999999,_=P=>Math.max(g,Math.min(h,Math.round(P)));if(Number.isFinite(v)&&v>0){f&&(f.value=String(_(v)),o.push("real_price"));const P=Number.isFinite(p)&&p>0&&p<v?p:v;m&&(m.value=String(_(P)),o.push("price"))}const x=hi(a)||a.detected_name||"Product",w=i.description||`${x} for sale on Weverse Online Shop. Review the details below and edit anything before publishing.`,E=ai("#product-form",{titleFallback:x,descriptionFallback:w,visionUsed:s});return E&&o.push(`${E} auto-completed (safe defaults)`),Na(),{filled:o}}function pt(e){const t=String(e||"").trim().toLowerCase(),a=Re.find(o=>o.toLowerCase()===t);if(a)return{category:a,listing_type:null};if(/(house|villa|apartment|condo|mansion|land|estate|real estate|property|building|bungalow|townhouse|ranch|farmhouse)/.test(t))return{category:null,listing_type:"property"};const i={bag:"Fashion",bags:"Fashion",handbag:"Fashion",handbags:"Fashion",backpack:"Fashion",backpacks:"Fashion",purse:"Fashion",wallet:"Fashion",wallets:"Fashion",luggage:"Travel & Luggage",sneaker:"Fashion",sneakers:"Fashion",shoe:"Fashion",shoes:"Fashion",boot:"Fashion",boots:"Fashion",footwear:"Fashion",sandal:"Fashion",sandals:"Fashion",heel:"Fashion",heels:"Fashion",phone:"Phones",smartphone:"Phones",smartphones:"Phones",iphone:"Phones","mobile phone":"Phones",laptop:"Computers",laptops:"Computers",computer:"Computers",notebook:"Computers",macbook:"Computers",pc:"Computers",desktop:"Computers",electronics:"Electronics",electronic:"Electronics",gadget:"Electronics",gadgets:"Electronics",tv:"Electronics",television:"Electronics",headphones:"Electronics",speaker:"Electronics",speakers:"Electronics",soundbar:"Electronics",tablet:"Electronics",earbuds:"Electronics",camera:"Cameras & Photography",cameras:"Cameras & Photography",dslr:"Cameras & Photography",drone:"Cameras & Photography",jewelry:"Jewelry",jewellery:"Jewelry",ring:"Jewelry",necklace:"Jewelry",earring:"Jewelry",earrings:"Jewelry",bracelet:"Jewelry",watch:"Watches & Accessories",watches:"Watches & Accessories",wristwatch:"Watches & Accessories","smart watch":"Watches & Accessories",clothing:"Fashion",clothes:"Fashion",fashion:"Fashion",shirt:"Fashion",shirts:"Fashion",dress:"Fashion",dresses:"Fashion",jacket:"Fashion",jackets:"Fashion",hoodie:"Fashion",jeans:"Fashion","t-shirt":"Fashion",tshirt:"Fashion",apparel:"Fashion","men's fashion":"Men","mens fashion":"Men","women's fashion":"Women","womens fashion":"Women",car:"Cars",cars:"Cars",vehicle:"Cars",vehicles:"Cars",automobile:"Cars",suv:"Cars",sedan:"Cars","luxury car":"Cars","luxury cars":"Cars",truck:"Trucks",trucks:"Trucks",trailer:"Trucks",bus:"Trucks",motorcycle:"Motorcycles",motorbike:"Motorcycles","motor bike":"Motorcycles",bicycle:"Bicycles",bicycles:"Bicycles",cycling:"Bicycles",bike:"Bicycles",motorhome:"RV & Camper Accessories",motorhomes:"RV & Camper Accessories",camper:"RV & Camper Accessories",rv:"RV & Camper Accessories",boat:"Marine & Boating",boats:"Marine & Boating",yacht:"Marine & Boating",jet:"Marine & Boating",beauty:"Beauty",skincare:"Beauty",cosmetics:"Beauty",makeup:"Beauty",perfume:"Beauty",kitchen:"Kitchen",appliance:"Home Appliances",appliances:"Home Appliances",blender:"Kitchen",kettle:"Kitchen",cookware:"Kitchen",vacuum:"Home Appliances",furniture:"Furniture",sofa:"Furniture",chair:"Furniture",chairs:"Furniture",table:"Furniture",tables:"Furniture",bed:"Furniture",mattress:"Furniture",desk:"Furniture",toy:"Toys & Hobbies",toys:"Toys & Hobbies",game:"Gaming",games:"Gaming",gaming:"Gaming",console:"Gaming",food:"Food & Groceries",groceries:"Food & Groceries",snack:"Food & Groceries",snacks:"Food & Groceries",beverage:"Food & Groceries",baby:"Baby",kids:"Kids",stroller:"Baby",health:"Health & Medical",medical:"Health & Medical",supplement:"Health & Medical",fitness:"Sports",sport:"Sports",sports:"Sports",gym:"Sports",dumbbell:"Sports",book:"Books",books:"Books",textbook:"Books",novel:"Books",stationery:"Office",office:"Office",printer:"Office",pen:"Office",pet:"Pets",pets:"Pets",dog:"Pets",cat:"Pets",musical:"Musical Instruments",guitar:"Musical Instruments",piano:"Musical Instruments",instrument:"Musical Instruments",drum:"Musical Instruments",software:"Software & Digital Products",digital:"Software & Digital Products",account:"Software & Digital Products",accounts:"Software & Digital Products",instagram:"Software & Digital Products",tiktok:"Software & Digital Products",camping:"Camping & Hiking",tent:"Camping & Hiking",hiking:"Camping & Hiking",flower:"Flowers & Gifts",flowers:"Flowers & Gifts",gift:"Flowers & Gifts",gifts:"Flowers & Gifts",wedding:"Wedding Supplies",party:"Party & Event Supplies",coin:"Coins & Bullion",coins:"Coins & Bullion",art:"Arts & Crafts",painting:"Arts & Crafts",craft:"Arts & Crafts"},n=i[t]||i[t.replace(/s$/,"")]||i[t.replace(/\s+/g," ")];if(n)return{category:n,listing_type:null};for(const o of Re)if(t.includes(o.toLowerCase())||t.length>2&&o.toLowerCase().includes(t))return{category:o,listing_type:null};return{category:Zn(t)||"Other",listing_type:null}}function ko(e){const t=String(e||"").toLowerCase().trim();if(!t)return null;const a=Ua.find(n=>n.toLowerCase()===t);return a||Ua.find(n=>n.toLowerCase().includes(t)||t.includes(n.toLowerCase()))||null}window._resolveScanConfirm=function(e,t){};let I=[],Ae=[],oe="",de=-1;const Fa="scanner-scan-status";let te=!1,yn=0,Ie=0,ae=0,qe=!1,vi=0,So=0,fn=0,it=0;function pa(e,t){const i=(Array.isArray(e.image_indices)?e.image_indices:[]).map(n=>t[n]).filter(Boolean);return i.length?i:t}function ii(e,t,a,i){const n=pt(e.category),s=e.listing_type==="property"||n&&n.listing_type==="property",o=s?"Real Estate":n.category||e.category||"Other",r=e.confidence||"medium",l={high:"bg-emerald-500/10 text-emerald-400 border-emerald-500/20",medium:"bg-amber-500/10 text-amber-400 border-amber-500/20",low:"bg-red-500/10 text-red-400 border-red-500/20"}[r]||"bg-amber-500/10 text-amber-400 border-amber-500/20",d=pa(e,Ae).slice(0,3);return`
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    </div>`,window.lucide&&lucide.createIcons()};window.scanReviewContinue=async function(e){const t=I[e];if(!t)return;de=e;const a=pa(t,Ae),i=pt(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(oe==="s1-scan-status"||oe==="scanner-scan-status")&&(le(),Pe=[]),jo(t,a);return}const s=i.category||t.category||"Other";if(oe==="s1-scan-status"||oe==="scanner-scan-status"){try{localStorage.removeItem(at(s,""))}catch{}Pe=[];let o=t.property_id?ze[t.property_id]:null;o&&o.specifications&&typeof o.specifications=="object"&&(o={...o,...o.specifications}),showAddProductStep2(s,o?{...o,images:a}:{images:a}),await $t(t,a,s)}else{const o=document.getElementById("product-form"),r=o&&o.dataset.category||"";if(s!==r){try{localStorage.removeItem(at(s,""))}catch{}switchProductFormCategory(s);const l=document.getElementById(oe);l&&(l.classList.remove("hidden"),l.classList.add("text-blue-300"),l.textContent=`Category changed to ${s} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await $t(t,a,s)}};window.scanReviewEdit=function(e){const t=I[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=pt(t.category),s=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",o=Re.map(r=>`<option value="${c(r)}" ${r===s?"selected":""}>${c(r)}</option>`).join("");a.innerHTML=`
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function xt(e,t){const a=pa(e,Ae),i=pt(e.category),n=e.listing_type==="property"||i&&i.listing_type==="property",s=n?"Real Estate":i.category||e.category||"Other",o=yn,r=o-I.length;((d,u)=>{const m=document.getElementById("scanner-scan-status");m&&(m.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),m.classList.add(u),m.innerHTML=d)})(`Processing ${r+1} of ${o}: ${c(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){ae++,I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1);return}let d=e.property_id?ze[e.property_id]:null;d&&d.specifications&&typeof d.specifications=="object"&&(d={...d,...d.specifications}),showAddProductStep2(s,d?{...d,images:a}:{images:a}),await new Promise(f=>setTimeout(f,250)),await $t(e,a,s);const m=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");m?(de=t,m.click()):(ae++,closeProductFormModal(),I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1))}catch{ae++,closeProductFormModal(),I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(){ni=!0;const e=await En();j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> Scan Missing Prices</h3>
        ...
        <form id="vehicle-form" onsubmit="saveVehicle(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Body Type</label><select class="input-field" name="body_type">${["",...Ko].map(r=>`<option value="${r}" ${n("body_type","")===r?"selected":""}>${r||"General"}</option>`).join("")}</select></div>
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(s=>Jo(s)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function Jo(e){return`<tr class="order-row" data-status="${e.status}" data-search="${c(e.order_number)} ${c(e.full_name)} ${c(e.email)}">
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Yo.map(i=>`<option value="${i}" ${t.status===i?"selected":""}>${i.replace(/_/g," ")}</option>`).join("")}
              </select>
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?We("star","No Reviews","Customer reviews will appear here."):a.map(r=>Zo(r)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${s.length===0?We("message-square","No Feedback Yet","Site feedback will appear here."):s.map(r=>Xo(r)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function Xo(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await b.from("site_feedback").update({is_approved:!0}).eq("id",e);t?y(t.message,"error"):y("Feedback approved â€” it now shows on every page."),Mt()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await b.from("site_feedback").delete().eq("id",e);t?y(t.message,"error"):y("Feedback deleted."),Mt()};function Zo(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
...
${a.text}`}catch(a){t.textContent=`✖ ${a.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const a=(n,s,o,r)=>`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&pr(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=be();i[e]&&(i[e][t]=a,Bt())};window.heroVideoPreset=function(e,t){const a=be();a[e]&&(a[e].buttonText=t,Ze())};window.heroVideoToggle=function(e){const t=be();t[e]&&(t[e].enabled=t[e].enabled===!1,Ze())};window.heroVideoMove=function(e,t){const a=be(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],Ze())};window.heroVideoDelete=function(e){const t=be();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),Ze())};window.heroVideoRemoveMedia=function(e,t){const a=be();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),Ze())};window.addHeroVideoSlide=function(){be().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),Ze(),y("New slide added â€” upload a video and press Save to show it.","info")};async function ur(e,t){try{const{data:{session:a}}=await b.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:s}=await b.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(s)return{url:URL.createObjectURL(e),persisted:!1,error:s.message};const{data:o}=b.storage.from("product-images").getPublicUrl(n),r=o&&o.publicUrl;return r?{url:r,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function Ei(e){return/^blob:/i.test(String(e||""))}async function pr(e,t,a){const i=be();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){y("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){y("Please choose an image for the poster.","error");return}y("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await ur(a,t);t==="video"?i[e].video=n.url:i[e].poster=n.url,Ze(),n.persisted?y("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):y("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function mr(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Bt(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${ri.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?mr(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            <div class="flex items-end gap-1 h-32">
              ${E.map($=>`<div class="flex-1 flex flex-col items-center justify-end gap-1"><div class="w-full rounded-t bg-emerald-500/70 hover:bg-emerald-400 transition" style="height:${Math.round($.n/P*100)+2}px" title="${$.d}: ${$.n} visit(s)"></div><span class="text-[9px] text-gray-500">${$.d.slice(5)}</span></div>`).join("")}
            </div>
          </div>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${l.length===0?'<p class="text-xs text-gray-500 text-center py-8">No data</p>':l.map(([$,A])=>`
              <div class="flex items-center gap-3 py-1.5">
                <span class="text-xs text-gray-300 flex-1 truncate">${c($)}</span>
      ...
      </div>`,window.lucide&&lucide.createIcons(),cn(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}async function br(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Bn(10);await b.from("admin_2fa").update({backup_codes:e}).eq("user_id",B.user.id),y("New backup codes generated"),Nn(e.map(t=>t.code)),ya()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await b.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await b.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await b.from("admin_2fa").update({enabled:!1}).eq("user_id",B.user.id),await fe(B.user.id,"2fa_disabled"),y("2FA has been disabled"),ya()}catch(e){y(e.message,"error")}};async function fr(){const e=document.getElementById("content");try{const{data:t}=await b.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}async function hr(){const e=document.getElementById("content");try{const{data:t}=await b.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),y("Orders exported!")};async function vr(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${c(a.message)}</div>`)}}function wr(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",n=t[a]||"",s=t[i]||"",o=!!(n&&n.trim()),r=!!(s&&s.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
      <div class="flex items-center justify-between flex-wrap gap-2">
        <div class="flex items-center gap-3">
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>xr(t,a)).join("")}
    ...
    </div>`,ci(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(li()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[li()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ci())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=$e.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Ga(t),ci(),renderManualPaymentAccountsEditor()};window._bankAccounts=[];async function _r(){try{const{data:e,error:t}=await b.from("bank_accounts").select("*").order("sort_order",{ascending:!0}).order("currency",{ascending:!0});if(t)return y(t.message,"error"),[];window._bankAccounts=e||[]}catch{window._bankAccounts=[]}return window._bankAccounts}async function ha(){const e=document.getElementById("bank-accounts-manager");e&&(e.innerHTML='<div class="flex items-center justify-center py-6 text-blue-300 text-sm"><i data-lucide="loader-2" class="w-4 h-4 animate-spin mr-2"></i> Loading accounts…</div>',window.lucide&&lucide.createIcons(),await _r(),e.innerHTML=`
    <div class="space-y-3">
      <div class="flex items-center justify-between">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${c(Kn(i))}</textarea>
              </div>
              <div>
    ...
    <div class="space-y-4 fade-in">
      ...
      ${m}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){ee.category=e,ee.page=0,ee.query="",yt()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");ee.query=e?e.value:"",ee.page=0,yt()};window.catalogPage=function(e){const a=ee.query.trim()?1:Math.max(1,Math.ceil(0/Un));ee.page=Math.max(0,Math.min(a-1,ee.page+e)),yt()};window.catalogToggle=async function(e){const t=!ea().includes(e),a=await ct(e,t);y(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),yt()};window.catalogResetHidden=async function(){await ts(),y("All hidden catalog listings restored"),yt()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Pi(){window.lucide&&lucide.createIcons(),Ji(),await Hs(),b.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){B.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pi):Pi();
