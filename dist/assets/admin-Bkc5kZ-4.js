import"./preload-helper-CS1eXPs2.js";import{a as Ma,g as Ra,C as _e,A as Da}from"./localization-BpWHAK5B.js";import{supabase as p}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as ja,upsertLocalShowroomListing as Fe,getLocalShowroomListingById as St,listLocalShowroomListings as At}from"./local-showroom-store-JrQn_yOW.js";import{g as It,s as Fa,l as Oa,a as Ua,b as qa}from"./payment-settings-CV_OsQnG.js";import{S as U,P as Na,a as Ha,T as Ga,M as za}from"./motorhome-data-BMuZzdMb.js";import{getCatalogCategory as Pt,getCatalogCategories as Wa,generateProduct as vt}from"./catalog-BzyCL9ZE.js";import{getHiddenCatalogIds as Et,saveCatalogHidden as Va,resetHiddenCatalogIds as Ka,loadHiddenCatalogIds as Ja}from"./catalog-hidden-store-BJoPnRIT.js";const j=1,J=5e6,Qa=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Ya=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Ct=[...Qa,...Ya];function Xe(e){return Ma[e]||"USD"}function Tt(e,t){return Ct.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Xa(e,t){const a=Math.max(j,Math.min(J,Number(e)||j));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Za(e,t,a,s,i){const r=Xa(s,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${i}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Bt({templateId:e,listingType:t,category:a,countryCode:s,currency:i,price:r}){const n=Ct.find(h=>h.id===e&&h.listingType===t);if(!n)return null;const o=Ra(s)||_e[0],l=i||Xe(o.code),c=[o.name].filter(Boolean).join(", "),m={category:n.category||a||(t==="property"?"Real Estate":"Other"),subcategory:n.subcategory||n.label,title:t==="property"?`${n.label} in ${o.name}`:n.label,description:Za(n,o,l,r,c),currency:l,features:[...n.features],highlights:[...n.highlights||[]],seo_keywords:[...new Set([n.category,n.subcategory,n.label,...t==="property"?[o.name]:[],...n.keywords||[]].filter(Boolean))],requiredImageCount:n.requiredImageCount||0};return t==="property"?{...m,country:o.name,country_code:o.code,product_location:o.name,property_type:n.propertyType||n.label,bedrooms:n.bedrooms??null,bathrooms:n.bathrooms??null,building_size:n.buildingSize||"",land_size:n.landSize||"",furnished:n.furnished||""}:{...m,brand:n.brand||"",model:n.model||"",color:n.color||"",size:n.size||"",condition:n.condition||"New"}}const Lt="weverseonlineshop@gmail.com",Mt="kco_ai_ad_override_fallback_v1",Rt="Weverse Online Shop",Dt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",es="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ts=`${es}/functions/v1/ai-admin-assistant`,as=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],ss={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},jt=[...Da].sort();let k={user:null,section:"dashboard"};function d(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Ft(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function N(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function W(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function Ze(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const is=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function Q(e){const t={};if(!e||typeof e!="object")return t;for(const a of is)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),s=document.getElementById("toast-msg"),i=a.querySelector("i[data-lucide]");if(!a||!s)return;s.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};i&&(i.setAttribute("data-lucide",r[t]||"info"),i.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function R(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,s]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",d(e)||"—"];return`<span class="badge ${a}">${s}</span>`}function z(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function M(e,t,a,s,i=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=ss[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ot(),closeSidebar();const s=document.getElementById("content");s&&(s.innerHTML=ce()),window.lucide&&lucide.createIcons(),({dashboard:_s,products:C,properties:Ae,catalog:ne,orders:oa,customers:Ws,reviews:ot,messages:na,coupons:Ie,ads:re,notifications:Ks,ai:rs,n8n:ls,"ai-settings":ua,"ai-marketing":Te,"homepage-branding":Le,content:ki,seo:Si,email:Ai,analytics:$i,security:Be,activity:Ii,brand:Me,"payment-settings":Ye,backup:Pi,settings:Ei,publish:Re,"general-ai":os}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=ae("construction","Coming Soon",`${t} is being built.`))}))()};async function rs(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
      ...
      </div>`,window.aiChatHistory=[],Ut(),ns(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${d(t.message)}</div>`)}}function Ut(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function ns(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function ls(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Z="kco_admin_remember",et="kco_login_attempts",Oe=5,ds=15*60*1e3;function T(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function cs(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ke(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function ue(e){return String(e||"").trim().toLowerCase()}function us(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");e?.email&&!ue(e.email)&&localStorage.removeItem(Z)}catch{localStorage.removeItem(Z)}}function ps(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");return ue(e?.email)}catch{return""}}function tt(){us();const e=ps(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Lt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function ms(){return`${window.location.origin}/admin.html`}function X(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ke(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function E(e,t,a=""){const s=document.getElementById(e);s&&(s.disabled=t,t?s.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(s.innerHTML=a),window.lucide&&lucide.createIcons())}function qt(){try{return JSON.parse(localStorage.getItem(et)||'{"count":0}')}catch{return{count:0}}}function Nt(){const e=qt();return e.count=(e.count||0)+1,e.count>=Oe&&(e.lockedUntil=Date.now()+ds),localStorage.setItem(et,JSON.stringify(e)),e}function Ht(){localStorage.removeItem(et)}function Gt(){const e=qt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Ht(),null):Math.ceil(t/6e4)}async function q(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await gs(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function gs(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function zt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:s}=await p.rpc("is_current_user_admin");t=!0,a=!!s}catch{t=!1}return t?a:ue(e.email)===Lt}async function bs(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){he(),xs();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await zt(t.user)){const{data:{currentUser:s}}=await p.auth.getUser(),i=await p.auth.mfa.getAuthenticatorAssuranceLevel(),r=i.data?.currentLevel;if(i.data?.nextLevel==="aal2"&&r!=="aal2"){k.user=t.user,he(),X("2fa"),at();return}k.user=t.user,$e();return}hs()}function he(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function hs(){he(),X("login"),tt(),Wt(),Vt(),at(),fs();const e=Gt();e&&(T(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function fs(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Wt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",ys),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>X("forgot")))}async function ys(e){e.preventDefault();const t=Gt();if(t){T(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),s=ue(a?.value);if(!s){T("Enter your admin email address."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const i=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;E("login-btn",!0),ke();const{data:n,error:o}=await p.auth.signInWithPassword({email:s,password:i});if(o||!n.user){const b=String(o?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){T("Authentication is temporarily unavailable due to configuration. Please contact support."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){T("Network error while signing in. Check your connection and try again."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){T("Your admin email is not confirmed yet. Open your verification email and confirm first."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Nt(),g=Oe-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${Oe} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;T(v),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await q(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await zt(n.user)){await p.auth.signOut(),T(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await q(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(Z,JSON.stringify({email:s,ts:Date.now()})):localStorage.removeItem(Z),Ht(),k.user=n.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),X("2fa"),at(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await q(n.user.id,"login_success"),E("login-btn",!1),$e()}function at(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",wt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",s=>{s.target.value=s.target.value.replace(/\D/g,"").slice(0,6),s.target.value.length===6&&wt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,X("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const i=document.getElementById("backup-code");i&&i.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",vs))}async function wt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){T("Enter the 6-digit code from your authenticator app.");return}E("verify-2fa-btn",!0),ke();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){T("No 2FA factor found. Please re-login."),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:s,error:i}=await p.auth.mfa.challenge({factorId:a.id});if(i)throw i;const{error:r}=await p.auth.mfa.verify({factorId:a.id,challengeId:s.id,code:e});if(r)throw r;await q(k.user.id,"login_2fa_success"),E("verify-2fa-btn",!1),$e()}catch(t){Nt(),T(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function vs(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){T("Enter a backup recovery code.");return}E("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){T("No backup codes found."),E("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!i.used)){T("Backup code not found or already used."),E("verify-backup-btn",!1,"Use Backup Code");return}const s=t.backup_codes.map(i=>(i.code||i).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof i=="object"?i:{code:i},used:!0}:i);await p.from("admin_2fa").update({backup_codes:s}).eq("user_id",k.user.id),await q(k.user.id,"login_backup_code_used"),$e()}catch(t){T(t.message),E("verify-backup-btn",!1,"Use Backup Code")}}function Vt(){document.getElementById("back-to-login")?.addEventListener("click",()=>X("login")),document.getElementById("send-reset-btn")?.addEventListener("click",ws)}async function ws(){const e=document.getElementById("reset-email"),t=ue(e?.value);if(!t){T("Enter your admin email address to receive a reset link.");return}E("send-reset-btn",!0),ke();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:ms()});if(E("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){T(a.message);return}cs("Reset link sent! Check your inbox and open it from this device to continue.")}function xs(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Qt(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${d(t.message)}</div>`)}}async function C(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),s=new Set,i=[];for(const l of a?[]:t||[])l&&l.property_id&&!s.has(l.property_id)&&(s.add(l.property_id),i.push(l));for(const l of At().filter(c=>c.listing_type!=="property"))l&&l.property_id&&!s.has(l.property_id)&&(s.add(l.property_id),i.push(l));if(Array.isArray(U))for(const l of U.filter(c=>c.listing_type!=="property"&&c.property_id))s.has(l.property_id)||(s.add(l.property_id),i.push(l));const r=[...Na,...Ha,...Ga,...za];for(const l of r)l&&l.property_id&&l.listing_type!=="property"&&!s.has(l.property_id)&&(s.add(l.property_id),i.push(l));i.sort((l,c)=>new Date(c.created_at||0)-new Date(l.created_at||0));const n=[...new Set(i.map(l=>l.category).filter(Boolean))].sort((l,c)=>l.localeCompare(c)),o=[...new Set(i.flatMap(l=>Array.isArray(l.tags)?l.tags:[]).filter(Boolean))].sort((l,c)=>l.localeCompare(c));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${M("Published",i.filter(l=>!!l.is_active).length,"badge-check","emerald")}
          ${M("Draft / Hidden",i.filter(l=>!l.is_active).length,"file-clock","amber")}
          ${M("Featured",i.filter(l=>!!l.is_featured).length,"sparkles","violet")}
          ${M("Inventory Units",i.reduce((l,c)=>l+(parseInt(c.stock_quantity,10)||0),0),"boxes","blue")}
          ${M("Avg Price",`$${Math.round(i.reduce((l,c)=>l+(parseFloat(c.price)||0),0)/Math.max(i.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(n.length?n:Yt).map(l=>`<option value="${d(l)}" ${(window._productFilters.category||"")===l?"selected":""}>${d(l)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${d(ks(e))}</p></div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(h=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${d(h)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Ss(e,t){const a=[...e],s=i=>new Date(i||0).getTime()||0;return t==="oldest"?a.sort((i,r)=>s(i.created_at)-s(r.created_at)):t==="price-high"?a.sort((i,r)=>Y(r.price)-Y(i.price)):t==="price-low"?a.sort((i,r)=>Y(i.price)-Y(r.price)):t==="sales-high"?a.sort((i,r)=>Ne(r)-Ne(i)):t==="views-high"?a.sort((i,r)=>qe(r)-qe(i)):a.sort((i,r)=>s(r.created_at)-s(i.created_at)),a}function Kt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),s=document.getElementById("products-result-count");if(!t)return;const i=window._productsCardLimit||60,r=e.slice(0,i);t.innerHTML=r.map($s).join(""),s&&(s.textContent=String(e.length));const n=document.getElementById("products-more");if(n){const o=e.length-r.length;o>0?n.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,o)} more (${o} left)</button>`:n.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Jt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(s=>{const i=s.images&&s.images[0]?s.images[0]:"/fallback.svg",r=st(s),n=window._productSelection?.has(s.property_id),o=s.is_active?`unpublishProduct('${s.property_id}')`:`publishProduct('${s.property_id}')`,l=s.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${s.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${s.property_id}')">
              ...
              <img src="${d(i)}" class="w-9 h-9 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">
              <div class="min-w-0">
                <p class="text-xs font-bold text-white truncate max-w-[160px]">${d(s.title||"Untitled Product")}</p>
                <p class="text-[10px] font-mono text-gray-500">${d(it(s))}</p>
              </div>
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${d(s.category||"Uncategorized")}</span></td>
          <td><span class="text-xs font-bold text-emerald-400">$${Y(s.price).toLocaleString()}</span></td>
          <td><span class="text-xs text-gray-300">${s.stock_quantity!=null?d(s.stock_quantity):"Unlimited"}</span></td>
          ...
          <td>
            <div class="flex gap-1">
              ...
              <button onclick="${o}" class="btn-press p-1.5 ${s.is_active?"text-amber-400 hover:bg-amber-500/10":"text-emerald-400 hover:bg-emerald-500/10"} rounded-lg transition" title="${l}"><i data-lucide="${s.is_active?"eye-off":"eye"}" class="w-3.5 h-3.5"></i></button>
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">${(a.images||[]).slice(0,8).map(s=>`<img src="${d(s)}" class="w-12 h-12 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">`).join("")}</div>
          </div>
          <div class="space-y-2">
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return D(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),C()};window.openProductMoreActions=function(e){B(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${d(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div class="sm:col-span-2"><label class="lbl">Catalog Template</label><select class="input-field" name="catalog_template_id" id="pf-catalog_template_id" onchange="applyProductCatalogTemplate('${d(e)}')"><option value="">Choose a template...</option>${s.map(r=>`<option value="${r.id}">${d(r.label)} - ${d(r.subcategory||r.category)}</option>`).join("")}</select></div>
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${d(e)}')">${Zt(i)}</select></div>
            </div>
    ...
    </div>`),aa(),sa(),ea("pf-price"),ze(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>ze(e,"pricing")),Ns(e,t.property_id||""),window._pfEscapeHandler=r=>{r.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),z(),C()};const Es=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Cs=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Ts=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Bs=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Ls=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Ms(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Es:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Cs:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Ts:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Bs:Ls}function O(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function ve(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&O(t)}function Rs(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(O("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",s=[...t.querySelectorAll('input[name="images"]')].map(i=>i.value).filter(i=>i&&!String(i).startsWith("blob:"));if(!s.length){e||O("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",ve(!0,"AI is analyzing your images…");try{const i=await S.analyzeImages(s,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!i){O("AI analysis unavailable — add a Gemini, Groq, or OpenRouter API key in AI Settings (or install Ollama locally).","warn");return}Ds(i,a),O("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(i){O("AI analysis failed: "+(i.message||i),"error"),e||u("AI analysis failed: "+(i.message||i),"error")}finally{t.dataset.aiBusy="0",ve(!1)}};function Ds(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const s=(l,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${l}"]`);m&&(String(m.value||"").trim()||(m.value=c))},i=(l,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${l}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};s("title",e.title),s("description",e.description),s("subcategory",e.subcategory),s("brand",e.brand),s("model",e.model),s("color",e.color),s("size",e.size),s("material",e.material),s("storage",e.storage),s("ram",e.ram),s("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||s("condition",e.condition),i("features_text",e.features),i("highlights_text",e.highlights),i("seo_keywords_text",e.seo_keywords);const r=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(l=>{r[l]!=null&&String(r[l]).trim()!==""&&s(l,r[l])}),Array.isArray(r.safety_features)&&i("safety_features",r.safety_features);const n=e.category?String(e.category).trim():"",o=document.getElementById("pf-ai-detected");o&&n&&n.toLowerCase()!==String(t||"").toLowerCase()&&(o.classList.remove("hidden"),o.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
    ...
    </div>`),window.lucide&&lucide.createIcons(),Ve()}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},s=new FormData(t);for(const[i,r]of s.entries())i==="images"?(a.images=a.images||[],r&&!String(r).startsWith("blob:")&&a.images.push(String(r))):i==="tags"?(a.tags=a.tags||[],a.tags.push(r)):a[i]=r;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),s=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),r=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!r||r==="/fallback.svg"){O("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const n=Ms(t),o=Math.min(s,n.length);e.dataset.aiBusy="1";const l=document.getElementById("pf-ai-generated");l&&(l.innerHTML="");let c=0;try{for(let m=0;m<o;m++){ve(!0,`Generating ${m+1}/${o} — ${n[m]}…`);try{const h=await S.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${n[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,r,1);if(h&&h[0]){const b=await Fs(h[0]);b&&(js(b),c+=1)}}catch(h){O(`Stopped at ${m}/${o}: ${h.message||h}`,"error");break}}c?(O(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):O("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",ve(!1)}};function js(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,s=document.createElement("div");s.innerHTML=pe(e,a),t.appendChild(s.firstElementChild),se(),ge(),ie();const i=document.getElementById("pf-ai-generated");if(i){const r=document.createElement("div");r.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",r.innerHTML=`<img src="${d(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,i.appendChild(r)}}async function Fs(e){try{const a=await(await fetch(e)).blob(),s=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),i=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${s}`;return await me(new File([a],i,{type:a.type}))}catch{return e}}function pe(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",s=e.querySelector('[name="description"]')?.value||"No description yet.",i=e.querySelector('[name="brand"]')?.value||"N/A",r=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,n=e.dataset.category||"Product",o=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",l=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <p class="text-sm text-gray-400">${d(s)}</p>
                ...
                ${s.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':s.map(i=>`<tr>
                    <td>
                      <div class="flex items-center gap-2.5">
                        <img src="${d((i.images||[])[0]||"/fallback.svg")}" class="w-9 h-9 rounded-lg object-cover border border-blue-500/20" onerror="this.src='/fallback.svg'">
                        <div><p class="text-xs font-bold text-white truncate max-w-[160px]">${d(i.title)}</p><p class="text-[10px] font-mono text-gray-500">${d(i.property_id)}</p></div>
                      </div>
                    </td>
                    <td><span class="text-xs text-gray-300">${d(i.property_type||i.category)}</span></td>
                    <td class="hidden sm:table-cell"><span class="text-xs text-gray-400">${d([i.city,i.state,i.country].filter(Boolean).join(", ")||"—")}</span></td>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Tt("property","Real Estate"),s=e.country_code||"US",i=e.currency||Xe(s);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Hs.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    </div>`),aa(),sa(),ea("ppf-price"),window.syncPropertyCountry=function(){xt("ppf")},xt("ppf"),We("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>We("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),s=Object.fromEntries(a.entries()),i=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),r=(s.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),n=t?0:parseInt(s.required_image_count||"24",10)||24;ta(n,i,"This property");const o={listing_type:"property",category:s.property_type||"Real Estate",subcategory:s.subcategory||null,title:s.title,description:s.description||"",price:Math.max(j,Math.min(J,parseFloat(s.price)||0)),currency:s.currency||"USD",country:s.country||"",country_code:(s.country_code||"").toUpperCase(),state:s.state||"",city:s.city||"",town:s.town||"",product_location:s.product_location||"",latitude:s.latitude?parseFloat(s.latitude):null,longitude:s.longitude?parseFloat(s.longitude):null,property_type:s.property_type||"",listing_status:s.listing_status||"sale",bedrooms:s.bedrooms?parseInt(s.bedrooms):null,bathrooms:s.bathrooms?parseInt(s.bathrooms):null,building_size:s.building_size||"",land_size:s.land_size||"",parking_spaces:s.parking_spaces?parseInt(s.parking_spaces):null,furnished:s.furnished||"",features:r,images:i,highlights:Ge(s.highlights_text),seo_keywords:Ge(s.seo_keywords_text),is_ai_generated:!!s.catalog_template_id,ai_generated_fields:s.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:s.is_active==="on"};let l;if(t){o.property_id=t;const c=Q((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:l}=await p.from("showroom_listings").upsert({...c,...o},{onConflict:"property_id"}))}else o.property_id=Ze(),{error:l}=await p.from("showroom_listings").insert(o);l&&He(l,()=>Fe({...o,property_id:t||o.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),z(),Ae())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let s=a?null:t;s||(s=St(e)),s||(s=(Array.isArray(U)?U.find(i=>i.property_id===e):null)||null),s&&showAddPropertyModal(s)};const Gs=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function oa(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],s=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let i="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(r=>zs(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function zs(e){return`<tr class="order-row" data-status="${e.status}" data-search="${d(e.order_number)} ${d(e.full_name)} ${d(e.email)}">
      ...
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Ft(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",W(t.created_at)]].map(([a,s])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${d(s)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Gs.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),z(),oa()};async function Ws(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(s=>`<tr class="cust-row" data-search="${d(s.display_name)} ${d(s.user_id)}">
                    <td>
                      <div class="flex items-center gap-2.5">
                        ...
                        <div>
                          <p class="text-xs font-bold text-white">${d(s.display_name||"Anonymous")}</p>
                          <p class="text-[10px] font-mono text-gray-500">${d(s.user_id?.slice(0,12))}…</p>
                        </div>
                      </div>
                    </td>
                    <td class="hidden sm:table-cell"><span class="text-xs text-gray-300">${d(s.country_code||"—")}</span></td>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(s=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${d(s.order_number)}</p><p class="text-[10px] text-gray-500">${W(s.created_at)}</p></div>
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?ae("star","No Reviews","Customer reviews will appear here."):a.map(i=>Vs(i)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function Vs(e){const t=Array.from({length:5},(a,s)=>s<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
          ...
          ${a.length===0?ae("message-circle","No Messages","Customer support messages will appear here."):a.map(s=>`
              <div class="glass-soft border ${s.is_read?"border-blue-500/10":"border-blue-400/30"} rounded-xl p-4 ${s.is_read?"":"ring-1 ring-blue-500/10"}">
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      <span class="text-xs font-black text-white">${d(s.full_name||s.name||"Anonymous")}</span>
                    ...
                    <p class="text-[11px] text-blue-400 mb-1">${d(s.email||"—")}</p>
                    <p class="text-xs text-gray-300">${d(s.message||s.body||"—")}</p>
                    ${s.subject?`<p class="text-[11px] text-gray-500 mt-1">Subject: ${d(s.subject)}</p>`:""}
                  </div>
                  <div class="flex gap-1 shrink-0">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(s=>`<tr>
                    <td><code class="text-xs font-mono font-black text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded">${d(s.code)}</code></td>
              ...
              <div class="glass-soft border border-blue-500/10 rounded-xl p-3.5 flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-0.5">
                    <span class="text-xs font-bold text-white">${d(s.subject||s.event_type||"Notification")}</span>
                    ${R(s.status)}
                    <span class="text-[10px] text-gray-500 ml-auto">${W(s.created_at)}</span>
                  </div>
                  <p class="text-[11px] text-gray-400">${d(s.recipient||s.order_number)}</p>
                </div>
              </div>`).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}const la=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Js=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let be=null;function Qs(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${d(e)}</span>`}function Ys(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${d(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${d(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${d(e.link_target||"")}</span>`}function Xs(e){return e.video_url?`<video src="${d(e.video_url)}" ${e.poster_url?`poster="${d(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${d(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function da(){if(be)return be;const e=[],t=new Set,a=[],s=r=>{if(!r||!r.property_id)return;e.push({id:r.property_id,title:r.title||r.property_id});const n=r.category||"";n&&!t.has(n)&&(t.add(n),a.push(n))};try{U.forEach(s)}catch{}try{const{data:r,error:n}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!n&&r&&r.forEach(s)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(r=>{t.has(r)||(t.add(r),a.push(r))}),be={products:e,categories:a,sections:Js},be}async function Zs(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),s=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),i=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:r}=await p.storage.from("advertisements").upload(i,e,{contentType:e.type,upsert:!1});if(r)return u("Upload failed: "+r.message,"error"),null;const{data:n}=p.storage.from("advertisements").getPublicUrl(i);return{url:n.publicUrl,isVideo:s}}catch{return u("Upload failed","error"),null}}function we(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const s=document.getElementById("ad-hidden-video"),i=document.getElementById("ad-hidden-image");s&&(s.value=t?e:""),i&&(i.value=t?"":e),a.innerHTML=t?`<video src="${d(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${d(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const s=await Zs(t);if(!s){e.value="";return}we(s.url,s.isVideo);const i=document.getElementById("ad-media-url");i&&(i.value=s.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);we(t,a)};function nt(e,t,a){const s=document.getElementById("ad-link-target-wrap");if(!s)return;if(!t||t==="none"){s.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let i="";t==="product"?i='<option value="">Select a product…</option>'+e.products.map(r=>`<option value="${d(r.id)}" ${String(a)===String(r.id)?"selected":""}>${d(r.id)} — ${d((r.title||"").slice(0,60))}</option>`).join(""):t==="category"?i='<option value="">Select a category…</option>'+e.categories.map(r=>`<option value="${d(r)}" ${a===r?"selected":""}>${d(r)}</option>`).join(""):t==="section"&&(i='<option value="">Select a section…</option>'+e.sections.map(r=>`<option value="${d(r.id)}" ${a===r.id?"selected":""}>${d(r.name)}</option>`).join("")),s.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${i}</select>`}function ca(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="grid gap-3">
          ${a.length===0?ae("megaphone","No Ads","Create your first showcase ad — add a title, image or video, label, and optional product link.",'<button onclick="showAddAdModal()" class="btn-press flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2.5 rounded-xl transition"><i data-lucide="plus" class="w-4 h-4"></i> Add Advertisement</button>'):a.map((s,i)=>`
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 flex-wrap">
                    <p class="text-sm font-black text-white truncate">${d(s.title||s.name)}</p>
                    ${Qs(s.ad_label||"Featured")}
                  </div>
                  <p class="text-xs text-gray-400 mt-0.5 line-clamp-1">${d(s.description||"")}</p>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.highlightAI=function(e){ee.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const s=t.id===e;a.className=`glass-soft border ${s?F.border[t.color]+" "+F.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const i=a.querySelector("input[type=radio] + span");i&&(i.className=`text-[9px] font-bold ${s?F.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),s={active_provider:a.active_provider||"gemini",customer_ai_enabled:a.customer_ai_enabled==="on",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};ee.forEach(i=>{a[i.mf]&&(s[i.mf]=a[i.mf]);const r=(a[i.kf]||"").trim();r&&!r.startsWith("••••")&&r!==""&&(s[i.kf]=r)}),s.gemini_key&&(s.gemini_api_key=s.gemini_key),s.openai_key&&(s.openai_api_key=s.openai_key);try{const{data:i}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let r;if(i?.id?{error:r}=await p.from("ai_settings").update(s).eq("id",i.id):{error:r}=await p.from("ai_settings").insert(s),r){u("Save failed: "+r.message,"error"),console.error("[AI Save]",r);return}await S.reload(),u("✅ AI settings saved! Keys are active and auto-switch is ON.","success"),setTimeout(()=>ua(),600)}catch(i){u("Unexpected error: "+i.message,"error"),console.error("[AI Save]",i)}};const je="kco_ai_cooldowns",ei=60*1e3,S={_cfg:null,async reload(){const{data:e,error:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.openai_key&&a.openai_api_key&&(a.openai_key=a.openai_api_key),!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async getOrderedProviders(){const e=await this.getConfig(),t=e.active_provider||"gemini",a=this._getCooldowns(),s=Date.now(),i=ee.filter(l=>e[l.kf]&&e[l.kf].trim()),r=i.filter(l=>l.id===t),n=i.filter(l=>l.id!==t);return[...r,...n].sort((l,c)=>{const m=(a[l.id]||0)>s?1:0,h=(a[c.id]||0)>s?1:0;return m-h})},_getCooldowns(){try{return JSON.parse(localStorage.getItem(je)||"{}")}catch{return{}}},_setCooldown(e){const t=this._getCooldowns();t[e]=Date.now()+ei,localStorage.setItem(je,JSON.stringify(t))},_clearCooldown(e){const t=this._getCooldowns();delete t[e],localStorage.setItem(je,JSON.stringify(t))},_buildRequest(e,t,a,s){const i=t[e.kf],r=t[e.mf]||e.dm;switch(e.id){case"gemini":{const n=`https://generativelanguage.googleapis.com/v1beta/models/${r}:generateContent?key=${i}`,o={contents:a.map(l=>({role:l.role==="assistant"?"model":"user",parts:[{text:l.content}]}))};return{url:n,method:"POST",headers:{"Content-Type":"application/json"},body:o,parse:l=>l.candidates?.[0]?.content?.parts?.[0]?.text||""}}case"groq":{const n="https://api.groq.com/openai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"deepseek":{const n="https://api.deepseek.com/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"mistral":{const n="https://api.mistral.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"cohere":{const n="https://api.cohere.com/v2/chat",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.message?.content?.[0]?.text||l.text||""}}case"huggingface":{const n=`https://api-inference.huggingface.co/models/${r}/v1/chat/completions`,o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"together":{const n="https://api.together.xyz/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"openrouter":{const n="https://openrouter.ai/api/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`,"HTTP-Referer":window.location.origin},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"cerebras":{const n="https://api.cerebras.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"fireworks":{const n="https://api.fireworks.ai/inference/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"github":{const n="https://models.inference.ai.azure.com/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"cloudflare":{const[n,o]=(i||"").split("|"),l=`https://api.cloudflare.com/client/v4/accounts/${n}/ai/run/${r}`,c={messages:a};return{url:l,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o||i}`},body:c,parse:m=>m.result?.response||""}}case"sambanova":{const n="https://api.sambanova.ai/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"hyperbolic":{const n="https://api.hyperbolic.xyz/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"novita":{const n="https://api.novita.ai/v3/openai/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"perplexity":{const n="https://api.perplexity.ai/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"replicate":{const n="https://openai-compat.replicate.com/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"ai21":{const n="https://api.ai21.com/studio/v1/chat/completions",o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"lepton":{const n=`https://${r.replace(/[^a-z0-9-]/g,"")}.lepton.run/api/v1/chat/completions`,o={model:r,messages:a,max_tokens:s};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:o,parse:l=>l.choices?.[0]?.message?.content||""}}case"ollama":return{url:`${(i||"http://localhost:11434").replace(/\/$/,"")}/api/chat`,method:"POST",headers:{"Content-Type":"application/json"},body:{model:r,messages:a,stream:!1},parse:c=>c.message?.content||""};default:return null}},async chat(e,{maxTokens:t=2e3,onProviderSwitch:a=null}={}){const s=await this.getOrderedProviders(),i=await this.getConfig(),r=this._getCooldowns(),n=Date.now();if(s.length===0)throw new Error("No AI providers configured. Go to AI Settings and add at least one API key.");let o=null;for(const l of s){if((r[l.id]||0)>n){const c=Math.ceil(((r[l.id]||0)-n)/1e3);console.log(`[AI] Skipping ${l.name} — rate limited for ${c}s more`);continue}if(l.id==="ollama"){const c=this._buildRequest(l,i,e,t);if(!c)continue;try{a&&a(l.name);const m=await fetch(c.url,{method:c.method,headers:c.headers,body:JSON.stringify(c.body),signal:AbortSignal.timeout(6e4)});if(m.status===429||m.status===503){this._setCooldown(l.id),console.warn(`[AI] ${l.name} rate limited (${m.status}), switching to next provider…`),o=new Error(`${l.name} rate limited`);continue}if(!m.ok){const f=await m.text().catch(()=>"");o=new Error(`${l.name} error ${m.status}: ${f.slice(0,100)}`),console.warn(`[AI] ${l.name} failed:`,o.message);continue}const h=await m.json(),b=c.parse(h);if(!b){o=new Error(`${l.name} returned empty response`);continue}return this._clearCooldown(l.id),console.log(`[AI] ✓ Response from ${l.name}`),{text:b,provider:l.name,model:i[l.mf]||l.dm}}catch(m){m.name==="TimeoutError"?(this._setCooldown(l.id),o=new Error(`${l.name} timed out`)):o=m,console.warn(`[AI] ${l.name} exception:`,m.message)}continue}try{a&&a(l.name);const c=e[e.length-1],m={action:"chat",message:String(c?.content||"").trim(),history:e.slice(0,-1).map(g=>({role:g.role,content:String(g.content||"")})),provider_override:l.id,max_tokens:t},h=await this._callEdge(m);if(h&&h.response)return this._clearCooldown(l.id),console.log(`[AI] ✓ Response from ${l.name} (via edge function)`),{text:h.response,provider:l.name,model:h.model||i[l.mf]||l.dm};const b=String(h?.error||"empty response"),f=b.toLowerCase();f.includes("429")||f.includes("rate limit")||f.includes("quota")?(this._setCooldown(l.id),console.warn(`[AI] ${l.name} rate limited (${b.slice(0,80)}), switching to next provider…`),o=new Error(`${l.name} rate limited`)):(o=new Error(`${l.name} error: ${b.slice(0,200)}`),console.warn(`[AI] ${l.name} failed:`,o.message))}catch(c){c.name==="TimeoutError"?(this._setCooldown(l.id),o=new Error(`${l.name} timed out`)):o=c,console.warn(`[AI] ${l.name} exception:`,c.message)}}throw new Error(o?.message||"All AI providers failed or are rate limited. Add more API keys in AI Settings.")},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig(),t=this._getCooldowns(),a=Date.now();return ee.map(s=>({id:s.id,name:s.name,color:s.color,hasKey:!!e[s.kf]?.trim(),isActive:e.active_provider===s.id,cooldownUntil:t[s.id]||0,isCoolingDown:(t[s.id]||0)>a,remainingSec:Math.max(0,Math.ceil(((t[s.id]||0)-a)/1e3))}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is.
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const pa=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function ti(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function ma(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const s of t)s in e&&(a[s]=e[s]);return a}function de(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const s=t.indexOf("{"),i=t.lastIndexOf("}");if(s===-1||i===-1||i<=s)return null;const r=t.slice(s,i+1);try{return JSON.parse(r)}catch{return null}}function kt(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=ti(e);if(!a)try{const{data:s}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();s&&(a=s)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},A()};function A(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",s=e.busy===!0,r=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    ...
    </div>`).join(""),m=e.suggestions?si():"",h=ai();B(`
    ...
    </div>`}function si(){const e=y;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(o=>o!=="images_to_remove"),a={};if(e.suggestions)for(const o of e.approved)o!=="images_to_remove"&&o in e.suggestions&&e.suggestions[o]!==void 0&&(a[o]=e.suggestions[o]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const s=Array.isArray(e.product.images)?e.product.images:[],i=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(o=>i.add(o));const r=[...s.filter(o=>!i.has(o)),...e.addedImages],n=Q({...e.product,...a,images:r,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,A();try{const{error:o}=await p.from("showroom_listings").upsert(n,{onConflict:"property_id"});if(o)throw o;u("Changes saved to Supabase.","success");const l=e.from;y=null,z(),l==="properties"?Ae():C()}catch(o){e.busy=!1,o&&D(o)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${o&&o.message||"unknown error"}`,"error"),A()}};let w=null;const lt=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Scan this photo and publish it in the matching section of my showroom — show me a preview first so I can approve it."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function pi(){const e=w;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const s=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",i=`${a.content||""}${s}`.trim();return{role:a.role==="user"?"user":"assistant",content:i}}).filter(a=>a.content):[]}function mi(e,t){const a=String(e||"").toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":t?a?"vision":"execute":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":"execute"}function gi(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function fa(){return w||(w={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Upload a photo and tell me what you want: I'll scan it and list the brand, model, year and real details, generate a matching image, or publish it to the showroom (I'll always show you a preview and ask if it's good before publishing). I always scan your showroom first so trucks go where the trucks are, cars where the cars are, homes where the homes are — I never guess or make new sections unless you ask me to. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null,pendingPublish:null},w)}window.openGeneralAi=async function(){fa(),I()};function bi(e){if(!e)return"";const t=(Number(e.price)||0)>0?`$${Number(e.price).toLocaleString()}`:"",a=Array.isArray(e.images)?e.images.slice(0,3):[],s=Array.isArray(e.features)?e.features.slice(0,8):[],i=[e.brand,e.model,e.year,e.property_type].filter(Boolean);return`
    <div class="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4">
      ...
      ${i.length?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${i.map(r=>d(String(r))).join(" · ")}${t?` · ${t}`:""}</p>`:t?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${t}</p>`:""}
      <p class="text-[11px] text-gray-300 mt-2 leading-relaxed whitespace-pre-wrap break-words">${d(e.description||"")}</p>
      ${s.length?`<div class="flex flex-wrap gap-1.5 mt-3">${s.map(r=>`<span class="px-2 py-1 rounded-lg bg-white/5 border border-white/10 text-[9px] text-gray-200">${d(String(r))}</span>`).join("")}</div>`:""}
    ...
    <div class="flex gap-3 items-start">
      ...
      <div class="glass border border-sky-500/20 rounded-3xl rounded-tl-md px-5 py-3.5 min-w-0 max-w-[85%]">
        ...
        ${e.previewDraft?bi(e.previewDraft):""}
    ...
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${d(gi(e.pendingPlan))}</p>
    ...
    </div>`}function xa(){const e=w;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,s)=>`
    ...
    </div>`).join(""):""}function I(){document.getElementById("general-ai-embed-scroll")&&_a(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&hi(),Ee()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function hi(){const e=w;if(!e)return;const t=e.busy===!0,s=(Array.isArray(e.messages)?e.messages:[]).map(c=>ya(c)).join(""),i=t?va():"",r=lt.map(c=>`
    ...
    </div>`);const l=document.getElementById("general-ai-input");l&&(l.value=e.instruction||"",l.addEventListener("input",()=>{w&&(w.instruction=l.value)}),l.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Ee()}function _a(){const e=w,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,s=Array.isArray(e.messages)?e.messages:[],i=lt.map(l=>`
        ...
        <form id="ai-ad-generator-form" onsubmit="activateAiAdvertisement(event)" class="glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <select id="ai-ad-goal" class="input-field text-xs" name="goal">
                ${wi.map(l=>`<option value="${d(l)}">${d(l)}</option>`).join("")}
              </select>
            </div>
            <div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <input id="ai-ad-video-url" type="url" class="input-field text-xs" name="video_url" placeholder="https://...mp4" value="${d(o&&i.ai_ad_video_url||"")}" required>
            </div>
            <div>
              <label class="lbl">Playback Duration (seconds)</label>
              <input id="ai-ad-duration" type="number" class="input-field text-xs" name="duration_seconds" min="5" max="900" value="${d(String(i.ai_ad_duration_seconds||30))}" required>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
            <div>
              ...
              <input id="ai-ad-badge" type="text" class="input-field text-xs" name="badge" value="${d(i.ai_ad_badge||"AI Advertisement")}" placeholder="AI Advertisement">
            </div>
            <div>
              <label class="lbl">Headline</label>
              <input id="ai-ad-title" type="text" class="input-field text-xs" name="title" value="${d(i.ai_ad_title||"")}" placeholder="Campaign headline">
            </div>
            <div>
              <label class="lbl">CTA Label</label>
              <input id="ai-ad-cta" type="text" class="input-field text-xs" name="cta_label" value="${d(i.ai_ad_cta_label||"Shop Now")}" placeholder="Shop Now">
            </div>
          </div>
...
`),r=await S.prompt(i,{onProviderSwitch:n=>{s.value=`Generating with ${n}...`}});s.value=r.text||"",await ut({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:r.provider,provider_id:a?.value||"",status:"script_generated",script:r.text||"",video_url:null}),u(`Script generated with ${r.provider}.`,"success")}catch(i){s.value="",u("Script generation failed: "+i.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),s=String(t.get("provider_id")||""),i=dt.find(b=>b.id===s)?.name||s,r=String(t.get("brief")||"").trim(),n=String(t.get("script")||"").trim(),o=String(t.get("video_url")||"").trim(),l=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),h=new Date(c+l*1e3).toISOString();if(!o){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:o,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:l,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:s,ai_ad_starts_at:m,ai_ad_ends_at:h,ai_ad_updated_at:new Date().toISOString()};await Ia(b),await ut({created_at:m,goal:a,brief:r,provider_name:i,provider_id:s,status:"active",script:n,video_url:o,ends_at:h}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Te()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Ia({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await ut({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Te()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function ki(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
              ...
              <div class="form-grid form-grid-2">
                ${s.fields.map(i=>`
                  <div ${i.type==="textarea"?'class="sm:col-span-2"':""}>
                    ...
                    ${i.type==="textarea"?`<textarea class="input-field" name="${i.key}" placeholder="${d(i.placeholder)}" rows="2">${d(a[i.key]||"")}</textarea>`:`<input type="${i.type}" class="input-field" name="${i.key}" value="${d(a[i.key]||"")}" placeholder="${d(i.placeholder)}">`}
                  </div>`).join("")}
              </div>
            </div>`).join("")}
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.saveContent=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),{error:s}=await p.from("site_settings").upsert({id:1,...a});if(s){u(s.message,"error");return}u("Content settings saved!")};async function $i(){const e=document.getElementById("content");try{const[t,a,s]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),i=t.data||[],r=i.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,m)=>c+(parseFloat(m.amount)||0),0),n=i.length>0?(i.filter(c=>c.status!=="cancelled").length/i.length*100).toFixed(1):0,o={};(a.data||[]).forEach(c=>{o[c.category]=(o[c.category]||0)+1});const l=Object.entries(o).sort((c,m)=>m[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Qt(i)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Si(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5">
        ...
        <div class="flex flex-col items-center gap-4">
          ...
          <div class="w-full">
            ...
            <div class="flex gap-2">
              <code class="flex-1 input-field font-mono text-xs text-emerald-300 select-all">${d(s)}</code>
              <button onclick="navigator.clipboard.writeText('${d(s)}').then(()=>showToast('Copied!'))" class="btn-press p-2 bg-blue-500/10 hover:bg-blue-500/20 rounded-xl transition text-blue-400"><i data-lucide="copy" class="w-4 h-4"></i></button>
            </div>
          </div>
        </div>
        <div>
        ...
        <button onclick="confirm2FAEnrollment('${d(i)}')" class="btn-press w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold py-2.5 rounded-xl text-sm transition flex items-center justify-center gap-2">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Pa(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Ea(e.map(t=>t.code)),Be()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await q(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Be()}catch(e){u(e.message,"error")}};async function Ii(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Pi(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),s=new Blob([t+`
`+a],{type:"text/csv"}),i=document.createElement("a");i.href=URL.createObjectURL(s),i.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,i.click(),u("Orders exported!")};async function Ei(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
          ...
          <div class="rounded-2xl overflow-hidden border border-blue-500/10 bg-[#0f172a]">
            ...
            <div class="bg-[#070b16] p-3 sm:p-4">
              <div class="overflow-hidden rounded-xl border border-white/10 bg-[#111827] shadow-2xl shadow-black/20" style="aspect-ratio: 1600 / 320;">
                ${s?`<img id="homepage-banner-preview-img" src="${d(s)}" alt="${d(i)}" class="h-full w-full object-cover">`:'<div class="flex h-full w-full items-center justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900"><div class="text-center"><i data-lucide="image-off" class="mx-auto w-8 h-8 text-gray-500"></i><p class="mt-2 text-xs font-semibold text-gray-500">No banner selected</p></div></div>'}
              </div>
            </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="grid gap-4 lg:grid-cols-[1.1fr_.9fr]">
              <div class="space-y-3">
                ...
                <input type="hidden" name="homepage_banner_image" id="val-homepage_banner_image" value="${d(s)}">
                <input type="text" id="url-homepage_banner_image" value="${d(s)}" placeholder="Or paste image URL" oninput="document.getElementById('val-homepage_banner_image').value=this.value;updateHomepageBannerPreview()" class="input-field text-xs">
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <textarea class="input-field" id="homepage_banner_alt" name="homepage_banner_alt" rows="4" placeholder="Accessible description for the banner image">${d(i)}</textarea>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Me(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{let t=function(o,l,c,m="",h="blue"){const b=!!(c&&c.trim());return`
      ...
      <div class="space-y-5 fade-in">
        ...
        <div id="live-preview-panel" class="hidden glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-3">
          ...
          <div class="rounded-xl overflow-hidden border border-blue-500/10">
            <div id="preview-header" class="flex items-center gap-3 px-4 py-3" style="background:#0f172a">
              <div id="preview-logo-wrap" class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 overflow-hidden" style="background:var(--preview-primary,#f97316)">
                ${n?`<img src="${d(n)}" alt="${d(i)}" class="w-full h-full object-contain p-1">`:'<i data-lucide="globe" class="w-4 h-4 text-white"></i>'}
              </div>
              <div>
                <p id="preview-name" class="text-sm font-black text-white leading-none">${d(i)}</p>
              ...
              <div id="preview-badge-wrap" class="ml-auto ${s.brand_badge?"":"hidden"}">
                <img id="preview-badge" src="${d(s.brand_badge||"")}" alt="Verified" class="w-6 h-6 object-contain">
              </div>
            </div>
            <div class="px-4 py-2 border-t border-gray-800 text-[11px] text-gray-500" style="background:#070b16">
              <span id="preview-btn" style="background:${d(s.brand_primary_color||"#f97316")};color:#000;padding:4px 12px;border-radius:8px;font-weight:700;font-size:11px">Shop Now</span>
              <span class="ml-3" style="color:${d(s.brand_secondary_color||"#3b82f6")}">All Products →</span>
            </div>
          </div>
          <!-- Footer preview -->
          <div id="preview-footer" class="rounded-xl px-4 py-3 border border-gray-800 flex items-center gap-3" style="background:#0f172a">
            ...
            <div>
              <p id="preview-footer-name" class="text-xs font-black text-white">${d(i)}</p>
              <p id="preview-footer-slogan" class="text-[10px] text-gray-500">${d(r)}</p>
            </div>
            <p class="ml-auto text-[10px] text-gray-600">© 2026 <span id="preview-copy-name">${d(i)}</span></p>
          </div>
        ...
        <form id="brand-form" onsubmit="saveBrandSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <input class="input-field" name="brand_name" id="inp-brand-name" value="${d(i)}" placeholder="Your brand name" required oninput="updateLivePreview()">
              </div>
              <div>
                <label class="lbl">Short Name</label>
                <input class="input-field" name="brand_short_name" value="${d(s.brand_short_name||"")}" placeholder="e.g. Weverse">
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <textarea class="input-field" name="brand_description" rows="2" placeholder="Short description…">${d(s.brand_description||"")}</textarea>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-primary" value="${d(s.brand_primary_color||"#f97316")}" oninput="document.getElementById('ct-primary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-primary" name="brand_primary_color" value="${d(s.brand_primary_color||"#f97316")}" placeholder="#f97316" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-primary').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Secondary Color (links, highlights)</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-secondary" value="${d(s.brand_secondary_color||"#3b82f6")}" oninput="document.getElementById('ct-secondary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-secondary" name="brand_secondary_color" value="${d(s.brand_secondary_color||"#3b82f6")}" placeholder="#3b82f6" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-secondary').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Tagline Color 1 (e.g. "GLOBAL SHOPPING")</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-tag1" value="${d(s.brand_tagline_color1||"#22d3ee")}" oninput="document.getElementById('ct-tag1').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-tag1" name="brand_tagline_color1" value="${d(s.brand_tagline_color1||"#22d3ee")}" placeholder="#22d3ee" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-tag1').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Tagline Color 2 (e.g. "WORLDWIDE DELIVERY")</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-tag2" value="${d(s.brand_tagline_color2||"#a3e635")}" oninput="document.getElementById('ct-tag2').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-tag2" name="brand_tagline_color2" value="${d(s.brand_tagline_color2||"#a3e635")}" placeholder="#a3e635" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-tag2').value=this.value;updateLivePreview()">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div>
                ...
                <input class="input-field" name="brand_custom_font" value="${d(s.brand_custom_font||"")}" placeholder="e.g. Space Grotesk">
              </div>
            </div>
            <div id="font-preview" class="p-3 rounded-xl bg-gray-900 border border-blue-500/10">
              <p id="font-sample" class="text-sm text-white font-bold" style="font-family:'${d(s.brand_font||"Inter")}',sans-serif">The quick brown fox jumps — 0123456789 · Weverse Online Shop</p>
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div><label class="lbl">Website URL</label><input class="input-field" name="brand_website_url" value="${d(s.brand_website_url||s.production_url||"https://weverseonlineshop.com")}" placeholder="https://…"></div>
              <div><label class="lbl">Support Email</label><input type="email" class="input-field" name="brand_email" value="${d(s.brand_email||s.contact_email||"")}" placeholder="support@…"></div>
              <div><label class="lbl">Phone / WhatsApp</label><input class="input-field" name="brand_phone" value="${d(s.brand_phone||s.contact_phone||"")}" placeholder="+1 234…"></div>
              <div><label class="lbl">Business Address</label><input class="input-field" name="brand_address" value="${d(s.brand_address||s.contact_address||"")}" placeholder="City, Country"></div>
            </div>
          </div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Ci(t,a)).join("")}
    ...
    </div>`,mt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(pt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[pt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const s=window._manualPaymentAccounts[e];s&&(s[t]=a,t==="currency"&&(s.currencyName=a),mt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const s=_e.find(i=>i.code===t);a.country_code=t,a.country=s?.name||"",a.flag=s?.flag||It(t),mt(),renderManualPaymentAccountsEditor()};async function Ye(){const e=document.getElementById("content");e&&(e.innerHTML=ce());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),s={...Oa()||{},...t||{}};window._manualPaymentAccounts=Ua(s).map(i=>({...i})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <h2 class="text-xl font-black text-white">Payment Settings</h2>
          <div class="flex items-center gap-2 flex-wrap">
            ${s.payment_gateway?`<span class="badge bg-emerald-500/10 text-emerald-400 border-emerald-500/20">Active: ${d(s.payment_gateway)}</span>`:'<span class="badge bg-amber-500/10 text-amber-400 border-amber-500/20">Not configured</span>'}
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${d(qa(s))}</textarea>
              </div>
              <div>
                <label class="lbl">ATM Transfer Instructions (optional, shown separately)</label>
                <textarea class="input-field" name="atm_transfer_instructions" rows="3" placeholder="Optional ATM-specific instructions.">${d(s.atm_transfer_instructions||"")}</textarea>
              </div>
          ...
          <div class="glass-soft border border-amber-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div class="form-grid form-grid-2">
                ...
                <div><label class="lbl">Redirect URL (after payment)</label><input class="input-field" name="flutterwave_redirect_url" value="${d(s.flutterwave_redirect_url||"")}" placeholder="${window.location.origin}/payment.html"></div>
              </div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(f=>`<button onclick="catalogSetCategory('${f.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${P.category===f.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${d(f.name)}</button>`).join("")}
    </div>`,l=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${d(P.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl border ${g?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${d(f.property_id)} · ${d(f.subcategory||f.category||"")} · ${Ft(f.price,"USD")}</p>
            </div>
            ${R(!g)}
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${r?`${c.length} match`:`${i.toLocaleString()} items in ${d(s?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){P.category=e,P.page=0,P.query="",ne()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");P.query=e?e.value:"",P.page=0,ne()};window.catalogPage=function(e){const t=Pt(P.category),a=t?t.count:0,s=P.query.trim()?1:Math.max(1,Math.ceil(a/le));P.page=Math.max(0,Math.min(s-1,P.page+e)),ne()};window.catalogToggle=async function(e){const t=!Et().includes(e),a=await Va(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),ne()};window.catalogResetHidden=async function(){await Ka(),u("All hidden catalog listings restored"),ne()};async function $t(){window.lucide&&lucide.createIcons(),Ot(),await bs(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$t):$t();window.aiChatHistory=[];window.aiProductType="product";async function Ti(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),Ut();const s=document.getElementById("ai-prompt");s&&(s.value=""),u("AI is analyzing...");try{let i=null;a&&(i=await fileToDataUrl(a));const r={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:i,catalog_context:await Bi()},o=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(r)})).json();o.success&&o.product?(openListingReviewCard(o.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(o.error||"AI generation failed")}catch(i){u("Error: "+i.message),console.error("[AI] Generate product error:",i)}}async function Bi(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&Ti()});
