import{D as A,l as y,b as x}from"./promo-backgrounds-CbMN9Ppv.js";import{c as q,W as H,D as B,l as O,a as j,g as P,p as D,e as u,m as b,b as w}from"./promo-pool-CYc7PDs_.js";import{D as g,l as v,g as S}from"./site-content-CE5bY4Y7.js";const M="support@weverseonlineshop.com",F="weverse_brand_v1";function o(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function G(){try{const e=JSON.parse(localStorage.getItem(F)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function U(){const e=G(),t=e.brand_name||e.site_name||q;return`
