import{supabase as T}from"./supabase-client-D1iyov-x.js";import{g as U,d as K}from"./localization-CwZlVC1D.js";import{f as O,l as X,a as _,b as Z}from"./showroom-data-BQC62Qm8.js";import{g as Q}from"./auth-C_Eb0opg.js";import{c as ee,a as te,b as le,d as q,r as ie,e as re}from"./payment-settings-Bwg0v98q.js";import"./native-bridge-MbplFvoR.js";import"./live-stream-mode-B-NuA9nR.js";import"./customer-ai-widget-ktHDNJ0t.js";import"./brand-_M2LrXmp.js";import"./preload-helper-CLcXU_4U.js";const H="/fallback.svg";let P=null,k=[],B="",S="";const ae=[{name:"PayPal",icon:"wallet",color:"text-blue-400"},{name:"Stripe",icon:"credit-card",color:"text-violet-400"},{name:"Flutterwave",icon:"zap",color:"text-orange-400"},{name:"Paystack",icon:"layers",color:"text-cyan-400"},{name:"Apple Pay",icon:"smartphone",color:"text-gray-300"},{name:"Google Pay",icon:"smartphone",color:"text-green-400"},{name:"Visa",icon:"credit-card",color:"text-blue-500"},{name:"Mastercard",icon:"credit-card",color:"text-red-500"},{name:"American Express",icon:"credit-card",color:"text-blue-300"},{name:"Discover",icon:"credit-card",color:"text-orange-500"},{name:"Verve",icon:"credit-card",color:"text-green-500"},{name:"Bitcoin (BTC)",icon:"bitcoin",color:"text-yellow-500"},{name:"Ethereum (ETH)",icon:"bitcoin",color:"text-indigo-400"},{name:"USDT",icon:"bitcoin",color:"text-green-400"}],L=[{id:"placed",label:"Order Placed",icon:"shopping-bag",color:"text-blue-400",bg:"bg-blue-500/15"},{id:"submitted",label:"Payment Submitted",icon:"upload",color:"text-cyan-400",bg:"bg-cyan-500/15"},{id:"verification",label:"Pending Verification",icon:"loader",color:"text-amber-400",bg:"bg-amber-500/15"},{id:"approved",label:"Approved",icon:"check-circle",color:"text-emerald-400",bg:"bg-emerald-500/15"},{id:"processing",label:"Processing",icon:"package",color:"text-blue-400",bg:"bg-blue-500/15"},{id:"shipped",label:"Shipped",icon:"truck",color:"text-indigo-400",bg:"bg-indigo-500/15"},{id:"delivered",label:"Delivered",icon:"package-check",color:"text-emerald-400",bg:"bg-emerald-500/15"}];function oe(){return new URLSearchParams(window.location.search).get("id")}function se(){return localStorage.getItem("kco_country")||"US"}function ne(){const e=Date.now().toString(36).toUpperCase().slice(-6),l=Math.random().toString(36).toUpperCase().slice(2,6);return`KCO-${e}${l}`}function R(e,l){const t=()=>{const a=document.createElement("textarea");a.value=e,a.style.position="fixed",a.style.opacity="0",document.body.appendChild(a),a.select();try{document.execCommand("copy")}catch{}document.body.removeChild(a)};if(navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).catch(()=>t()):t(),l){const a=l.innerHTML;l.innerHTML='<i data-lucide="check" class="w-3.5 h-3.5 text-emerald-400"></i>',window.lucide&&lucide.createIcons(),setTimeout(()=>{l.innerHTML=a,window.lucide&&lucide.createIcons()},1500)}z("Copied Successfully.")}function z(e){let l=document.getElementById("payment-toast");l||(l=document.createElement("div"),l.id="payment-toast",l.className="fixed bottom-5 right-5 z-[100] transform translate-y-20 opacity-0 bg-gray-900 border border-blue-500/30 text-white px-5 py-3 rounded-xl shadow-xl text-xs flex items-center gap-2 font-medium transition-all duration-300",l.innerHTML='<i data-lucide="info" class="w-4 h-4 text-blue-400"></i><span id="payment-toast-msg">Action</span>',document.body.appendChild(l)),l.querySelector("#payment-toast-msg").textContent=e,l.classList.remove("translate-y-20","opacity-0"),clearTimeout(l._t),l._t=setTimeout(()=>l.classList.add("translate-y-20","opacity-0"),3e3),window.lucide&&lucide.createIcons()}function G(e,l){const t=ie(k,e,l);return{...t,fallbackNotice:t.isFallback?re(t.account,e,l,B):null}}function de(){const e=document.getElementById("particles");if(e)for(let l=0;l<14;l++){const t=document.createElement("div"),a=Math.random()*3+1;t.className="particle",t.style.width=a+"px",t.style.height=a+"px",t.style.left=Math.random()*100+"%",t.style.bottom="-10px",t.style.background=Math.random()>.5?"rgba(59,130,246,.4)":"rgba(251,191,36,.3)",t.style.animationDuration=Math.random()*20+15+"s",t.style.animationDelay=Math.random()*20+"s",e.appendChild(t)}}de();function ce(e,l,t){const a=_(e);return`
    <div class="glass border border-blue-500/20 rounded-2xl p-5 mb-5 slide-up">
      ...
      <div class="flex gap-4">
        ...
        <div class="flex-1 min-w-0">
          ...
          ${t&&e.city?`<p class="text-gray-400 text-xs mt-0.5">${Z(e.country_code)} ${e.city}, ${e.country}</p>`:""}
  ...
  `}function ue(e,l,t){const a=q(k),o=t?U(t):null;return`
    <div class="glass border border-blue-500/20 rounded-2xl p-5 mb-5 slide-up">
  ...
  `}function V(e){const l=L.findIndex(t=>t.id===e);return`
    <div class="glass border border-blue-500/20 rounded-2xl p-5 mb-5 slide-up">
      ...
      <div class="relative">
        ...
        <div class="space-y-4">
          ${L.map((t,a)=>{const o=a<=l,i=a===l;return`
  ...
  `}function me(e,l,t,a,o){const i=o?`
  ...
  `}function xe(e,l,t,a){const o=_(l);return`
  ...
  `}async function fe(){const e=document.getElementById("payment-content"),t=new URLSearchParams(window.location.search).get("guest")==="1",a=t?null:await Q();if(!a&&!t){window.location.href="/";return}const o=oe();let i=O(o);if(i||(await X(),i=O(o)),!i){e.innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>';return}_(i);const n=i.listing_type==="property",h=i.images?.[0]||H;let u=se();if(a&&!t){const{data:E}=await T.from("profiles").select("country_code").eq("user_id",a.id).maybeSingle();E?.country_code&&(u=E.country_code,localStorage.setItem("kco_country",u))}const $=U(u),C=$?$.name:u,p=K(u),g=new URLSearchParams(window.location.search).get("order")||ne(),w=i.price;P=await ee(),k=te(P),B=le(P),S=p||"";let f=S||"USD";q(k).includes(f)||(f="USD");const v=G(u,S||"");e.innerHTML=`
    <div class="fade-in">
      ...
      <div id="currency-selector-container">${ue(f,C,u)}</div>

      <div id="bank-account-container">${v.isFallback?J(v.fallbackNotice):A(v.account,null,B)}</div>

      <div id="upload-form-container">${me(g,i,w,f,t)}</div>
