import{supabase as A}from"./supabase-client-7_ZWSEp6.js";import{b as W,c as _,e as q}from"./localization-B2rzni8q.js";const U="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),C=`${U}/functions/v1/ai-customer-assistant`,H="sb_publishable_X_6kXsJwApi7v7HwoC1xtA_igns4Rxa",N=window.self!==window.top||/\/admin(\-ai)?\.html$/i.test(window.location.pathname);let n={open:!1,history:[],sending:!1,voiceEnabled:localStorage.getItem("kco_voice")==="1",voiceAccent:localStorage.getItem("kco_voice_accent")||"US",welcomed:!1,proactiveShown:{},sessionId:null,attachments:[],recording:!1,mediaRecorder:null,mediaChunks:[],recordTimer:null,recordSeconds:0};function y(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function V(t){let e=y(t);return e=e.replace(/`([^`]+)`/g,"<code>$1</code>"),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/^\- (.+)$/gm,"<li>$1</li>"),e=e.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),e=e.replace(/(<li>.*<\/li>\n?)+/g,a=>`<ul>${a}</ul>`),e=e.replace(/\n\n/g,"</p><p>"),e=e.replace(/\n/g,"<br>"),e=`<p>${e}</p>`,e=e.replace(/<ul><br>/g,"<ul>").replace(/<br><\/ul>/g,"</ul>"),e}function g(){return W()||localStorage.getItem("kco_language")||"en"}function T(){const t=window.location.pathname;return t.includes("checkout")?"checkout":t.includes("payment")?"payment":t.includes("auth")?"sign-in":t.includes("account")?"account":t.includes("details")?"product-details":t.includes("contact")?"contact":t.includes("help")?"help":t.includes("about")?"about":"home"}function P(){try{return JSON.parse(localStorage.getItem("kco_cart")||"[]").map(e=>({title:e.title||e.name,price:e.price,quantity:e.quantity||1}))}catch{return[]}}function k(t){if(n.voiceEnabled&&"speechSynthesis"in window)try{window.speechSynthesis.cancel();const e=new SpeechSynthesisUtterance(t.replace(/[*#`]/g,"")),a=g(),o=_(a);a==="en"?e.lang=n.voiceAccent==="UK"?"en-GB":"en-US":e.lang=o.lang,e.rate=o.rate,e.pitch=o.pitch;const i=q(a==="en"?(n.voiceAccent==="UK"?"en-GB":"en-US").slice(0,2):a);i&&(e.voice=i),window.speechSynthesis.speak(e)}catch{}}function z(){"speechSynthesis"in window&&window.speechSynthesis.cancel()}function D(){if(document.getElementById("kco-ai-styles"))return;const t=document.createElement("style");t.id="kco-ai-styles",t.textContent=`
  ...
  `,document.body.appendChild(e),document.getElementById("kco-ai-close").onclick=()=>d(!1),document.getElementById("kco-ai-minimize").onclick=()=>d(!1),document.getElementById("kco-ai-clear").onclick=te,document.getElementById("kco-ai-voice-toggle").onclick=Y,document.getElementById("kco-ai-voice-accent").onclick=G,document.getElementById("kco-ai-send").onclick=p,document.getElementById("kco-ai-attach").onclick=()=>document.getElementById("kco-ai-file").click(),document.getElementById("kco-ai-file").onchange=X,document.getElementById("kco-ai-mic").onclick=Q,document.getElementById("kco-ai-rec-cancel").onclick=ee;const a=document.getElementById("kco-ai-input");a.addEventListener("keydown",o=>{o.key==="Enter"&&!o.shiftKey&&(o.preventDefault(),p())}),a.addEventListener("input",()=>{a.style.height="auto",a.style.height=Math.min(a.scrollHeight,96)+"px"}),document.querySelectorAll(".kco-ai-quick-btn").forEach(o=>{o.onclick=()=>{a.value=o.dataset.q,p()}}),$(),window.lucide&&lucide.createIcons()}function d(t){const e=document.getElementById("kco-ai-panel"),a=document.getElementById("kco-ai-fab");n.open=t!==void 0?t:e.classList.contains("hidden-panel"),n.open?(e.classList.remove("hidden-panel"),a.style.display="none",window.innerWidth<640&&(document.body.style.overflow="hidden"),n.welcomed||(M(),n.welcomed=!0),setTimeout(()=>document.getElementById("kco-ai-input")?.focus(),300)):(e.classList.add("hidden-panel"),a.style.display="flex",z(),f(),document.body.style.overflow="")}function Y(){n.voiceEnabled=!n.voiceEnabled,localStorage.setItem("kco_voice",n.voiceEnabled?"1":"0"),n.voiceEnabled||z(),$(),n.voiceEnabled&&k("Voice assistance is now on.")}function G(){n.voiceAccent=n.voiceAccent==="US"?"UK":"US",localStorage.setItem("kco_voice_accent",n.voiceAccent);const t=document.getElementById("kco-ai-voice-accent");t&&(t.textContent=n.voiceAccent);const e=n.voiceAccent==="UK"?"Voice accent switched to British English.":"Voice accent switched to American English.";k(e)}function $(){const t=document.getElementById("kco-ai-voice-toggle");if(!t)return;const e=n.voiceEnabled?"volume-2":"volume-x";t.title=n.voiceEnabled?"Voice is ON — click to mute":"Voice is OFF — click to enable",t.innerHTML=`<i data-lucide="${e}" class="w-4 h-4"></i>`,window.lucide&&lucide.createIcons()}function x(t){const e=Math.floor(t/60),a=String(Math.floor(t%60)).padStart(2,"0");return`${e}:${a}`}function b(){const t=document.getElementById("kco-ai-attachments");t&&(t.innerHTML=n.attachments.map((e,a)=>e.type==="image"?`<div class="kco-attach-chip relative shrink-0 w-16 h-16 rounded-lg overflow-hidden border border-blue-500/30 bg-slate-800">
  ...
  `,a.appendChild(i),window.lucide&&lucide.createIcons(),O(),o||k(t.content)}function M(){const t=g(),e={en:`Welcome to Weverse Online Shop!
