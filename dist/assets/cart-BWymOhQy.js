import{l as m,c as u,f as y}from"./supabase-client-B8Zer4_H.js";import"./localization-AsxqESWL.js";import{getTruckById as x}from"./truck-data-CzXo-K4j.js";import{getMotorhomeById as f}from"./motorhome-data-DP5-LZ58.js";import{getCarById as h}from"./car-data-BE0Va4cl.js";import{getPhoneById as b}from"./phone-data-D3PvG27c.js";import{PRODUCT_LISTINGS as w}from"./products-data-BCTfNkyx.js";import{PRODUCT_EXTRA_LISTINGS as v}from"./products-extra-Bi3LiLiD.js";import{getCurrentUser as k,setRedirectAfterAuth as C}from"./auth-DujkjOJW.js";import{r as d,s as $,e as o,a as _,c as I}from"./cart-DNy8CJA3.js";import"./native-bridge-BQIcsfrW.js";import"./localization-bootstrap-D4-7lTdd.js";import"./ai-chat-DPCt6OGL.js";const c="/fallback.svg";function T(t){return w.find(r=>r.id===t||r.property_id===t)||v.find(r=>r.id===t||r.property_id===t)}function L(t){return y(t)||x(t)||f(t)||h(t)||b(t)||T(t)}function n(t,r){return`${(parseFloat(t)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${r}`}function S(t){const r=n(t.price,t.currency||"USD"),a=parseFloat(t.real_price);return Number.isFinite(a)&&a>0&&a>parseFloat(t.price)?`<span class="price-strike line-through text-gray-400 mr-1 text-xs">${n(a,t.currency||"USD")}</span><span class="text-amber-600 font-bold">${r}</span>`:`<span class="text-amber-600 font-bold">${r}</span>`}function p(t){const r=document.getElementById("toast-msg"),a=document.getElementById("toast");!r||!a||(r.textContent=t,a.classList.remove("translate-y-20","opacity-0"),a.classList.add("translate-y-0","opacity-100"),clearTimeout(window.__cartToastT),window.__cartToastT=setTimeout(()=>{a.classList.add("translate-y-20","opacity-0"),a.classList.remove("translate-y-0","opacity-100")},2e3))}function l(){return`
