import"./modulepreload-polyfill-B5Qt9EMX.js";import{U as m,I as u,b as x}from"./supabase-client-DvCmNkpI-BBtcpOs0-BZOrCGI3.js";import"./localization-bootstrap-BhglmvwT-CYE5uVRZ-79PKz_iD.js";import{g as y,b,P as h,a as f}from"./motorhome-data-CupbOvk0--c7gbSNU--c7gbSNU.js";import{e as w,i as v}from"./phone-data-Of7KtnOV-OoM3wJJD-CBoK22ow.js";import{getCurrentUser as k,setRedirectAfterAuth as $}from"./auth-iMacRl0l-DlcadYa5-BymIp3xQ.js";import{c as d,d as C,u as o,y as _,h as P}from"./cart-DNy8CJA3-Oz5JpZDi-B2DS8jkg.js";import"./native-bridge-z1PkSgfH-CV6U1YtG-ChDVXCvk.js";import"./app-promo-banner-DtT4efqP.js";import"./ai-chat-U-IZQEoO-DrOtSYGJ-46xX6vbQ.js";/* empty css                                       */import"./showroom-data-CddgSZPd.js";import"./promo-backgrounds-NxlbOFU-.js";import"./site-content-BryTgIB_.js";const l="/fallback.svg";function S(t){return h.find(e=>e.id===t||e.property_id===t)||f.find(e=>e.id===t||e.property_id===t)}function j(t){return x(t)||y(t)||b(t)||w(t)||v(t)||S(t)}function i(t,e){return`${(parseFloat(t)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${e}`}function T(t){const e=i(t.price,t.currency||"USD"),r=parseFloat(t.real_price);return Number.isFinite(r)&&r>0&&r>parseFloat(t.price)?`<span class="price-strike line-through text-gray-400 mr-1 text-xs">${i(r,t.currency||"USD")}</span><span class="text-amber-600 font-bold">${e}</span>`:`<span class="text-amber-600 font-bold">${e}</span>`}function p(t){const e=document.getElementById("toast-msg"),r=document.getElementById("toast");!e||!r||(e.textContent=t,r.classList.remove("translate-y-20","opacity-0"),r.classList.add("translate-y-0","opacity-100"),clearTimeout(window.__cartToastT),window.__cartToastT=setTimeout(()=>{r.classList.add("translate-y-20","opacity-0"),r.classList.remove("translate-y-0","opacity-100")},2e3))}function c(){return`
