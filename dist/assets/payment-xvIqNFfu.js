...
import{_ as R}from"./preload-helper-CS1eXPs2.js";import{g as q,d as K}from"./localization-BxEYj6qp.js";import{P as Z,a as Q,l as ee,f as F,g as te,b as le,e as T,h as re}from"./motorhome-data-D5TLnRFZ.js";import{g as ae,a as ie}from"./phone-data-B_9Z2FG_.js";import{getCurrentUser as oe}from"./auth-C8sthrmE.js";import{supabase as L}from"./supabase-client-nvpjTmO6.js";import{c as se,a as ne,b as de,d as H,r as ce,e as ue}from"./payment-settings-QNRNEoP1.js";import"./native-bridge-DjUVSZMf.js";import"./localization-bootstrap-BLa9M0cs.js";import"./brand-Ch4-wKat.js";const z="/fallback.svg",pe=[...Z,...Q];function be(e){return pe.find(t=>t.property_id===e)||null}let P=null,k=[],$="",S="";const me=[{name:"PayPal",icon:"wallet",color:"text-blue-600"},{name:"Stripe",icon:"credit-card",color:"text-violet-600"},{name:"Flutterwave",icon:"zap",color:"text-blue-600"},{name:"Paystack",icon:"layers",color:"text-cyan-600"},{name:"Apple Pay",icon:"smartphone",color:"text-gray-700"},{name:"Google Pay",icon:"smartphone",color:"text-green-600"},{name:"Visa",icon:"credit-card",color:"text-blue-500"},{name:"Mastercard",icon:"credit-card",color:"text-red-500"},{name:"American Express",icon:"credit-card",color:"text-blue-700"},{name:"Discover",icon:"credit-card",color:"text-blue-500"},{name:"Verve",icon:"credit-card",color:"text-green-500"},{name:"Bitcoin (BTC)",icon:"bitcoin",color:"text-yellow-500"},{name:"Ethereum (ETH)",icon:"bitcoin",color:"text-indigo-600"},{name:"USDT",icon:"bitcoin",color:"text-green-600"}],_=[{id:"placed",label:"Order Placed",icon:"shopping-bag",color:"text-blue-600",bg:"bg-blue-50"},{id:"submitted",label:"Payment Submitted",icon:"upload",color:"text-cyan-600",bg:"bg-cyan-50"},{id:"verification",label:"Pending Verification",icon:"loader",color:"text-amber-600",bg:"bg-amber-50"},{id:"approved",label:"Approved",icon:"check-circle",color:"text-emerald-600",bg:"bg-emerald-50"},{id:"processing",label:"Processing",icon:"package",color:"text-blue-600",bg:"bg-blue-50"},{id:"shipped",label:"Shipped",icon:"truck",color:"text-indigo-600",bg:"bg-indigo-50"},{id:"delivered",label:"Delivered",icon:"package-check",color:"text-emerald-600",bg:"bg-emerald-50"}];function ge(){return new URLSearchParams(window.location.search).get("id")}function xe(){return localStorage.getItem("kco_country")||"US"}function fe(){const e=Date.now().toString(36).toUpperCase().slice(-6),t=Math.random().toString(36).toUpperCase().slice(2,6);return`W-${e}${t}`}function U(e,t){const l=()=>{const i=document.createElement("textarea");i.value=e,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select();try{document.execCommand("copy")}catch{}document.body.removeChild(i)};if(navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).catch(()=>l()):l(),t){const i=t.innerHTML;t.innerHTML='<i data-lucide="check" class="w-3.5 h-3.5 text-emerald-600"></i>',window.lucide&&lucide.createIcons(),setTimeout(()=>{t.innerHTML=i,window.lucide&&lucide.createIcons()},1500)}G("Copied Successfully.")}function G(e){let t=document.getElementById("payment-toast");t||(t=document.createElement("div"),t.id="payment-toast",t.className="fixed bottom-5 right-5 z-[100] transform translate-y-20 opacity-0 bg-gray-900 border border-blue-500/30 text-white px-5 py-3 rounded-xl shadow-xl text-xs flex items-center gap-2 font-medium transition-all duration-300",t.innerHTML='<i data-lucide="info" class="w-4 h-4 text-blue-600"></i><span id="payment-toast-msg">Action</span>',document.body.appendChild(t)),t.querySelector("#payment-toast-msg").textContent=e,t.classList.remove("translate-y-20","opacity-0"),clearTimeout(t._t),t._t=setTimeout(()=>t.classList.add("translate-y-20","opacity-0"),3e3),window.lucide&&lucide.createIcons()}function J(e,t){const l=ce(k,e,t);return{...l,fallbackNotice:l.isFallback?ue(l.account,e,t,$):null}}function ye(){const e=document.getElementById("particles");if(e)for(let t=0;t<14;t++){const l=document.createElement("div"),i=Math.random()*3+1;l.className="particle",l.style.width=i+"px",l.style.height=i+"px",l.style.left=Math.random()*100+"%",l.style.bottom="-10px",l.style.background=Math.random()>.5?"rgba(59,130,246,.4)":"rgba(251,191,36,.3)",l.style.animationDuration=Math.random()*20+15+"s",l.style.animationDelay=Math.random()*20+"s",e.appendChild(l)}}ye();function ve(e,t,l){const i=T(e);return`
  ...
  `}function he(e,t,l){const i=H(k),o=l?q(l):null;return`
    <div class="glass border border-blue-200 rounded-2xl p-5 mb-5 slide-up">
  ...
  `}function W(e){const t=_.findIndex(l=>l.id===e);return`
    <div class="glass border border-blue-200 rounded-2xl p-5 mb-5 slide-up">
  ...
  `}function Ie(e,t,l,i,o){const r=o?`
  ...
  `}function Be(e,t,l,i){const o=T(t);return`
  ...
  `}async function $e(){const e=document.getElementById("payment-content"),l=new URLSearchParams(window.location.search).get("guest")==="1",i=l?null:await oe();if(!i&&!l){window.location.href="/";return}const o=ge();await ee();let r=F(o)||te(o)||le(o)||ae(o)||ie(o)||be(o);if(!r){const[{generateListingById:w},{loadHiddenCatalogIds:a}]=await Promise.all([R(()=>import("./catalog-D644z4ks.js"),__vite__mapDeps([0,1,2])),R(()=>import("./catalog-hidden-store-BJoPnRIT.js"),__vite__mapDeps([1,2]))]);await a(),r=w(o)}if(r||(r=F(o)),!r){e.innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>';return}T(r);const n=r.listing_type==="property",v=r.images?.[0]||z;let u=xe();if(i&&!l){const{data:w}=await L.from("profiles").select("country_code").eq("user_id",i.id).maybeSingle();w?.country_code&&(u=w.country_code,localStorage.setItem("kco_country",u))}const I=q(u),C=I?I.name:u,p=K(u),f=new URLSearchParams(window.location.search).get("order")||fe(),h=r.price;P=await se(),k=ne(P),$=de(P),S=p||"";let x=S||"USD";H(k).includes(x)||(x="USD");const y=J(u,S||"");e.innerHTML=`
    <div class="fade-in">
      ...
      <div id="currency-selector-container">${he(x,C,u)}</div>

      <div id="bank-account-container">${y.isFallback?V(y.fallbackNotice):A(y.account,null,$)}</div>

      <div id="upload-form-container">${Ie(f,r,h,x,l)}</div>
