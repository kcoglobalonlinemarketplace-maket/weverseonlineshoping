import"./preload-helper-CS1eXPs2.js";import{a as La,g as Ma,C as we,A as Ra}from"./localization-D4_JxzDG.js";import{supabase as p}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as Da,upsertLocalShowroomListing as je,getLocalShowroomListingById as $t,listLocalShowroomListings as St}from"./local-showroom-store-JrQn_yOW.js";import{g as At,s as ja,l as Fa,a as Ua,b as Oa}from"./payment-settings-BRDm6ubq.js";import{S as j}from"./showroom-data-BT2ougk1.js";import{getCatalogCategory as It,getCatalogCategories as qa,generateProduct as yt}from"./catalog-BzyCL9ZE.js";import{getHiddenCatalogIds as Pt,saveCatalogHidden as Na,resetHiddenCatalogIds as Ha,loadHiddenCatalogIds as Ga}from"./catalog-hidden-store-BJoPnRIT.js";const F=1,J=5e6,za=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Wa=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Et=[...za,...Wa];function Ye(e){return La[e]||"USD"}function Ct(e,t){return Et.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Va(e,t){const a=Math.max(F,Math.min(J,Number(e)||F));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Ka(e,t,a,i,s){const r=Va(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${s}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Tt({templateId:e,listingType:t,category:a,countryCode:i,currency:s,price:r}){const n=Et.find(h=>h.id===e&&h.listingType===t);if(!n)return null;const o=Ma(i)||we[0],d=s||Ye(o.code),c=[o.name].filter(Boolean).join(", "),m={category:n.category||a||(t==="property"?"Real Estate":"Other"),subcategory:n.subcategory||n.label,title:t==="property"?`${n.label} in ${o.name}`:n.label,description:Ka(n,o,d,r,c),currency:d,features:[...n.features],highlights:[...n.highlights||[]],seo_keywords:[...new Set([n.category,n.subcategory,n.label,...t==="property"?[o.name]:[],...n.keywords||[]].filter(Boolean))],requiredImageCount:n.requiredImageCount||0};return t==="property"?{...m,country:o.name,country_code:o.code,product_location:o.name,property_type:n.propertyType||n.label,bedrooms:n.bedrooms??null,bathrooms:n.bathrooms??null,building_size:n.buildingSize||"",land_size:n.landSize||"",furnished:n.furnished||""}:{...m,brand:n.brand||"",model:n.model||"",color:n.color||"",size:n.size||"",condition:n.condition||"New"}}const Bt="weverseonlineshop@gmail.com",Lt="kco_ai_ad_override_fallback_v1",Mt="Weverse Online Shop",Rt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Ja="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),Qa=`${Ja}/functions/v1/ai-admin-assistant`,Ya=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Xa={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Dt=[...Ra].sort();let k={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function jt(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function N(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function W(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function Xe(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Za=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function Q(e){const t={};if(!e||typeof e!="object")return t;for(const a of Za)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",r[t]||"info"),s.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function R(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function z(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function M(e,t,a,i,s=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-2xl p-4">
  ...
  </div>`}function de(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function ae(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${l(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${l(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function Ft(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=Ya.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=Xa[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ft(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=de()),window.lucide&&lucide.createIcons(),({dashboard:fi,products:C,properties:Se,catalog:oe,orders:ra,customers:qi,reviews:rt,messages:oa,coupons:Ae,ads:se,notifications:Hi,ai:ei,n8n:ii,"ai-settings":ca,"ai-marketing":Ce,"homepage-branding":Be,content:ys,seo:xs,email:ws,analytics:vs,security:Te,activity:_s,brand:Le,"payment-settings":Qe,backup:ks,settings:$s,publish:Me,"general-ai":ti}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=ae("construction","Coming Soon",`${t} is being built.`))}))()};async function ei(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
      ...
      </div>`,window.aiChatHistory=[],Ut(),ai(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${l(t.message)}</div>`)}}function Ut(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function ai(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function ii(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Z="kco_admin_remember",Ze="kco_login_attempts",Fe=5,si=15*60*1e3;function T(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function ri(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function _e(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function ce(e){return String(e||"").trim().toLowerCase()}function oi(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");e?.email&&!ce(e.email)&&localStorage.removeItem(Z)}catch{localStorage.removeItem(Z)}}function ni(){try{const e=JSON.parse(localStorage.getItem(Z)||"{}");return ce(e?.email)}catch{return""}}function et(){oi();const e=ni(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Bt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function li(){return`${window.location.origin}/admin.html`}function X(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),_e(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function E(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Ot(){try{return JSON.parse(localStorage.getItem(Ze)||'{"count":0}')}catch{return{count:0}}}function qt(){const e=Ot();return e.count=(e.count||0)+1,e.count>=Fe&&(e.lockedUntil=Date.now()+si),localStorage.setItem(Ze,JSON.stringify(e)),e}function Nt(){localStorage.removeItem(Ze)}function Ht(){const e=Ot();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Nt(),null):Math.ceil(t/6e4)}async function q(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await di(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function di(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Gt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:ce(e.email)===Bt}async function ci(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){be(),hi();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await Gt(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),s=await p.auth.mfa.getAuthenticatorAssuranceLevel(),r=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&r!=="aal2"){k.user=t.user,be(),X("2fa"),tt();return}k.user=t.user,ke();return}ui()}function be(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function ui(){be(),X("login"),et(),zt(),Wt(),tt(),pi();const e=Ht();e&&(T(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function pi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function zt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",mi),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>X("forgot")))}async function mi(e){e.preventDefault();const t=Ht();if(t){T(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=ce(a?.value);if(!i){T("Enter your admin email address."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;E("login-btn",!0),_e();const{data:n,error:o}=await p.auth.signInWithPassword({email:i,password:s});if(o||!n.user){const b=String(o?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){T("Authentication is temporarily unavailable due to configuration. Please contact support."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){T("Network error while signing in. Check your connection and try again."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){T("Your admin email is not confirmed yet. Open your verification email and confirm first."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=qt(),g=Fe-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${Fe} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;T(v),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await q(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Gt(n.user)){await p.auth.signOut(),T(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await q(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(Z,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Z),Nt(),k.user=n.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),X("2fa"),tt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await q(n.user.id,"login_success"),E("login-btn",!1),ke()}function tt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",vt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&vt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,X("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",gi))}async function vt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){T("Enter the 6-digit code from your authenticator app.");return}E("verify-2fa-btn",!0),_e();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){T("No 2FA factor found. Please re-login."),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await p.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:r}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(r)throw r;await q(k.user.id,"login_2fa_success"),E("verify-2fa-btn",!1),ke()}catch(t){qt(),T(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function gi(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){T("Enter a backup recovery code.");return}E("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){T("No backup codes found."),E("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){T("Backup code not found or already used."),E("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",k.user.id),await q(k.user.id,"login_backup_code_used"),ke()}catch(t){T(t.message),E("verify-backup-btn",!1,"Use Backup Code")}}function Wt(){document.getElementById("back-to-login")?.addEventListener("click",()=>X("login")),document.getElementById("send-reset-btn")?.addEventListener("click",bi)}async function bi(){const e=document.getElementById("reset-email"),t=ce(e?.value);if(!t){T("Enter your admin email address to receive a reset link.");return}E("send-reset-btn",!0),_e();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:li()});if(E("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){T(a.message);return}ri("Reset link sent! Check your inbox and open it from this device to continue.")}function hi(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function ke(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&k.user&&(t.textContent=k.user.email||"Admin"),et(),navigate("dashboard")}window.adminSignOut=async function(){k.user&&await q(k.user.id,"logout"),await p.auth.signOut(),k.user=null,be(),X("login"),et(),zt(),Wt()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(k.user&&await q(k.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),k.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function fi(){const e=document.getElementById("content");try{const[t,a,i,s]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),r=t.data||[],n=a.data||[],o=n.filter(w=>["approved","payment_approved","delivered"].includes(w.status)).reduce((w,G)=>w+(parseFloat(G.amount)||0),0),d=n.filter(w=>["pending","pending_verification","processing"].includes(w.status)).length,c=r.filter(w=>w.listing_type!=="property").length,m=r.filter(w=>w.listing_type==="property").length,h=r.filter(w=>w.listing_type!=="property"&&w.is_active).length,b=i.count||0,f=s.count||0,g=(s.data||[]).filter(w=>!w.is_approved).length,v=new Date,H=n.filter(w=>{const G=new Date(w.created_at);return G.getMonth()===v.getMonth()&&G.getFullYear()===v.getFullYear()}).filter(w=>["approved","payment_approved","delivered"].includes(w.status)).reduce((w,G)=>w+(parseFloat(G.amount)||0),0),V=n.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${wi()}, Admin</h2>
      ...
      </div>`,window.lucide&&lucide.createIcons(),Jt(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}async function C(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,s=[];for(const o of a?[]:t||[])o&&o.property_id&&!i.has(o.property_id)&&(i.add(o.property_id),s.push(o));for(const o of St().filter(d=>d.listing_type!=="property"))o&&o.property_id&&!i.has(o.property_id)&&(i.add(o.property_id),s.push(o));if(Array.isArray(j))for(const o of j.filter(d=>d.listing_type!=="property"&&d.property_id))i.has(o.property_id)||(i.add(o.property_id),s.push(o));s.sort((o,d)=>new Date(d.created_at||0)-new Date(o.created_at||0));const r=[...new Set(s.map(o=>o.category).filter(Boolean))].sort((o,d)=>o.localeCompare(d)),n=[...new Set(s.flatMap(o=>Array.isArray(o.tags)?o.tags:[]).filter(Boolean))].sort((o,d)=>o.localeCompare(d));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${M("Published",s.filter(o=>!!o.is_active).length,"badge-check","emerald")}
          ${M("Draft / Hidden",s.filter(o=>!o.is_active).length,"file-clock","amber")}
          ${M("Featured",s.filter(o=>!!o.is_featured).length,"sparkles","violet")}
          ${M("Inventory Units",s.reduce((o,d)=>o+(parseInt(d.stock_quantity,10)||0),0),"boxes","blue")}
          ${M("Avg Price",`$${Math.round(s.reduce((o,d)=>o+(parseFloat(d.price)||0),0)/Math.max(s.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(r.length?r:Qt).map(o=>`<option value="${l(o)}" ${(window._productFilters.category||"")===o?"selected":""}>${l(o)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=s,Vt(s),filterProducts(),updateBulkBar(),ha(),wa(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function Y(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ue(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function yi(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function at(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Oe(e){return parseInt(e.views??e.view_count??0,10)||0}function qe(e){return parseInt(e.sales??e.sales_count??0,10)||0}function it(e){return e.sku||e.property_id||"N/A"}function vi(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ue(e),i=at(e),s=window._productSelection?.has(e.property_id),r=R(i==="archived"?"inactive":i==="active"?"active":"inactive"),n=N(e.created_at),o=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${o?"featured":"standard"}" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-2xl p-3.5 flex flex-col gap-3 transition hover:border-blue-400/35">
    <div class="flex items-start gap-3">
      ...
      <div class="relative w-20 h-20 rounded-xl overflow-hidden border border-blue-500/20 shrink-0 bg-[#0b1124]">
        ...
        ${o?'<span class="absolute top-1 left-1 text-[9px] font-black px-1.5 py-0.5 rounded bg-amber-400 text-[#111827]">Featured</span>':""}
      </div>
      <div class="min-w-0 flex-1">
        <h3 class="text-sm font-black text-white leading-snug line-clamp-2">${l(e.title||"Untitled Product")}</h3>
        <p class="text-[10px] text-gray-500 font-mono mt-0.5">SKU: ${l(it(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2 text-[11px]">
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Price</span><p class="text-emerald-300 font-black">$${Y(e.price).toLocaleString()}</p></div>
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Discount</span><p class="text-amber-300 font-bold">${l(yi(e))}</p></div>
      ...
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Views</span><p class="text-blue-300 font-bold">${Oe(e).toLocaleString()}</p></div>
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Sales</span><p class="text-cyan-300 font-bold">${qe(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1">${a.slice(0,6).map(h=>`<span class="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${l(h)}</span>`).join("")}</div>`:'<div class="text-[10px] text-gray-500">No tags</div>'}
  </article>`}function xi(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,r)=>i(s.created_at)-i(r.created_at)):t==="price-high"?a.sort((s,r)=>Y(r.price)-Y(s.price)):t==="price-low"?a.sort((s,r)=>Y(s.price)-Y(r.price)):t==="sales-high"?a.sort((s,r)=>qe(r)-qe(s)):t==="views-high"?a.sort((s,r)=>Oe(r)-Oe(s)):a.sort((s,r)=>i(r.created_at)-i(s.created_at)),a}function Vt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");t&&(t.innerHTML=e.map(vi).join(""),i&&(i.textContent=String(e.length)),a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons())}function Kt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",r=at(i),n=window._productSelection?.has(i.property_id),o=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${l(it(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="flex gap-1">
              ...
              <button onclick="${o}" class="btn-press p-1.5 ${i.is_active?"text-amber-400 hover:bg-amber-500/10":"text-emerald-400 hover:bg-emerald-500/10"} rounded-lg transition" title="${d}"><i data-lucide="${i.is_active?"eye-off":"eye"}" class="w-3.5 h-3.5"></i></button>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return u("Product not found","error");B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              <div class="sm:col-span-2"><label class="lbl">Catalog Template</label><select class="input-field" name="catalog_template_id" id="pf-catalog_template_id" onchange="applyProductCatalogTemplate('${l(e)}')"><option value="">Choose a template...</option>${i.map(r=>`<option value="${r.id}">${l(r.label)} - ${l(r.subcategory||r.category)}</option>`).join("")}</select></div>
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Xt(s)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-3 glass-soft border border-blue-500/15 rounded-xl">
              ...
              <p class="text-[11px] text-gray-500 mt-1">Allowed price range is ${F} to ${J} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),ta(),aa(),Zt("pf-price"),Ge(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Ge(e,"pricing")),ji(e,t.property_id||""),window._pfEscapeHandler=r=>{r.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),z(),C()};const $i=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Si=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Ai=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Ii=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Pi=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Ei(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?$i:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Si:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Ai:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Ii:Pi}function O(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function ye(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&O(t)}function Ci(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(O("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",i=[...t.querySelectorAll('input[name="images"]')].map(s=>s.value).filter(s=>s&&!String(s).startsWith("blob:"));if(!i.length){e||O("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",ye(!0,"AI is analyzing your images…");try{const s=await S.analyzeImages(i,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!s){O("AI analysis unavailable — add a Gemini, Groq, or OpenRouter API key in AI Settings (or install Ollama locally).","warn");return}Ti(s,a),O("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(s){O("AI analysis failed: "+(s.message||s),"error"),e||u("AI analysis failed: "+(s.message||s),"error")}finally{t.dataset.aiBusy="0",ye(!1)}};function Ti(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const i=(d,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c))},s=(d,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};i("title",e.title),i("description",e.description),i("subcategory",e.subcategory),i("brand",e.brand),i("model",e.model),i("color",e.color),i("size",e.size),i("material",e.material),i("storage",e.storage),i("ram",e.ram),i("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||i("condition",e.condition),s("features_text",e.features),s("highlights_text",e.highlights),s("seo_keywords_text",e.seo_keywords);const r=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(d=>{r[d]!=null&&String(r[d]).trim()!==""&&i(d,r[d])}),Array.isArray(r.safety_features)&&s("safety_features",r.safety_features);const n=e.category?String(e.category).trim():"",o=document.getElementById("pf-ai-detected");o&&n&&n.toLowerCase()!==String(t||"").toLowerCase()&&(o.classList.remove("hidden"),o.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
    ...
    </div>`),window.lucide&&lucide.createIcons(),We()}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[s,r]of i.entries())s==="images"?(a.images=a.images||[],r&&!String(r).startsWith("blob:")&&a.images.push(String(r))):s==="tags"?(a.tags=a.tags||[],a.tags.push(r)):a[s]=r;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),i=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),r=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!r||r==="/fallback.svg"){O("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const n=Ei(t),o=Math.min(i,n.length);e.dataset.aiBusy="1";const d=document.getElementById("pf-ai-generated");d&&(d.innerHTML="");let c=0;try{for(let m=0;m<o;m++){ye(!0,`Generating ${m+1}/${o} — ${n[m]}…`);try{const h=await S.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${n[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,r,1);if(h&&h[0]){const b=await Li(h[0]);b&&(Bi(b),c+=1)}}catch(h){O(`Stopped at ${m}/${o}: ${h.message||h}`,"error");break}}c?(O(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):O("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",ye(!1)}};function Bi(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,i=document.createElement("div");i.innerHTML=ue(e,a),t.appendChild(i.firstElementChild),ie(),me();const s=document.getElementById("pf-ai-generated");if(s){const r=document.createElement("div");r.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",r.innerHTML=`<img src="${l(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,s.appendChild(r)}}async function Li(e){try{const a=await(await fetch(e)).blob(),i=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),s=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`;return await pe(new File([a],s,{type:a.type}))}catch{return e}}function ue(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function ta(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Mi(t.dataTransfer.files)}))}function aa(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>ie()})}window.handleImageUpload=async function(e){await ia(e.target.files)};async function Mi(e){await ia(e)}async function ia(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await pe(a);if(i){const s=t.children.length,r=document.createElement("div");r.innerHTML=ue(i,s),t.appendChild(r.firstElementChild),ie()}}me(),window.lucide&&lucide.createIcons(),Ci()}}async function pe(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(s)return URL.createObjectURL(e);const{data:r}=p.storage.from("product-images").getPublicUrl(i);return r.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),ie(),me()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const s=await pe(i);if(!s)return;const n=[...a.querySelectorAll(".img-thumb")][e];if(!n)return;const o=n.querySelector("img");o&&(o.src=s),ie(),me(),u("Image replaced. Save changes to apply.","info")};function ie(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const s=a.querySelector("img");if(!s)return;const r=document.createElement("input");r.type="hidden",r.name="images",r.id=`img-url-${i}`,r.value=s.src,t.appendChild(r),a.dataset.index=i;const n=a.querySelector(".rm");n&&n.setAttribute("onclick",`removeImage(${i})`);const o=a.querySelector(".rp");o&&o.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function me(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function sa(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Ri(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,s]of t.entries())i==="images"?s&&!String(s).startsWith("blob:")&&a.images.push(String(s)):i==="tags"?a.tags.push(String(s)):a.fields[i]=String(s);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Di(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([s,r])=>{const n=e.querySelector(`[name="${s}"]`);n&&(n.type==="checkbox"?n.checked=r==="on"||r===!0:n.value=r==null?"":String(r))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(s=>{s.checked=i.includes(s.value)}),Array.isArray(t.images)){const s=document.getElementById("image-preview");s&&(s.innerHTML=t.images.map((r,n)=>ue(r,n)).join(""),ie(),me())}return!0}function We(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,n=r===""||r==null?"Unlimited":r,o=k.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(h=>h.value),c=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",r=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,n=e.dataset.category||"Product",o=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};function ji(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=sa(e,t),s=document.getElementById("product-autosave-note");try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);Di(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const r=()=>{try{localStorage.setItem(i,JSON.stringify(Ri(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}We()};let n;const o=()=>{clearTimeout(n),n=setTimeout(r,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",o),d.addEventListener("change",o)}),We()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),r=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const n=new FormData(i),o={};for(const[b,f]of n.entries())b==="images"?(o.images=o.images||[],f&&!String(f).startsWith("blob:")&&o.images.push(String(f))):b==="tags"?(o.tags=o.tags||[],o.tags.push(f)):o[b]=f;o.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",o.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=n.get("action")==="draft",c=b=>He(b),m=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],g={};for(const v of f){const $=b[v];g[v]=$!=null&&String($).trim()!==""?$:null}if(b.safety_features){const v=c(b.safety_features);g.safety_features=v.length?v:null}return g};let h;if(a){let b=Q((window._productsData||[]).find(L=>L.property_id===a));if(!b){const{data:L}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=L?Q(L):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(L,Re)=>{const Ta=L===""||L==null?"":L,Ba=Re===""||Re==null?"":Re;return String(Ta).trim()===String(Ba).trim()},g={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(L=>{f(o[L],b[L])||(g[L]=o[L]==null||o[L]===""?null:o[L])});const v=o.price===""||o.price==null?null:parseFloat(o.price);f(v,b.price)||(g.price=v==null?b.price:Math.max(F,Math.min(J,v)));const $=o.stock_quantity===""||o.stock_quantity==null?null:parseInt(o.stock_quantity,10);f($,b.stock_quantity)||(g.stock_quantity=Number.isFinite($)?$:null);const H=c(o.features_text);f(H.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(g.features=H);const V=o.tags||[];f(V.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(g.tags=V);const w=c(o.highlights_text);f(w.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(g.highlights=w);const G=c(o.seo_keywords_text);f(G.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(g.seo_keywords=G);const mt=o.images||[];f(mt.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(g.images=mt);const gt=o.is_featured==="on";!!b.is_featured!==gt&&(g.is_featured=gt);const bt=d?!1:o.is_active==="on";!!b.is_active!==bt&&(g.is_active=bt);const Ca=m(o),ht={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Ca};if(JSON.stringify(ht)!==JSON.stringify(b.specifications||{})&&(g.specifications=ht),Object.keys(g).length===0){u("No changes detected — nothing was saved.","info"),s&&(s.disabled=!1,s.textContent=r);return}const ft={...b,...g,property_id:a,updated_at:new Date().toISOString()};if({error:h}=await p.from("showroom_listings").upsert(ft,{onConflict:"property_id"}),h&&Ne(h,()=>je(ft),"Product update")){s&&(s.disabled=!1,s.textContent=r);return}u(d?"Draft saved!":`Product updated — ${Object.keys(g).length} change(s) saved.`)}else{const b=parseInt(o.required_image_count||"0",10)||(st.includes(t)?24:0);if(ea(b,o.images||[],"This listing"),!o.title||!o.title.trim())throw new Error("A product title is required.");if(o.price===""||o.price==null||!isFinite(parseFloat(o.price)))throw new Error("A price is required.");if(!o.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:o.subcategory||null,title:o.title.trim(),description:o.description||"",price:Math.max(F,Math.min(J,parseFloat(o.price)||0)),currency:o.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:o.is_active==="on",is_featured:o.is_featured==="on",brand:o.brand||null,color:o.color||null,size:o.size||null,condition:o.condition||null,warranty:o.warranty||null,availability_status:o.availability_status||"In Stock",stock_quantity:o.stock_quantity?parseInt(o.stock_quantity):null,images:o.images||[],features:c(o.features_text).length?c(o.features_text):o.tags||[],tags:o.tags||[],highlights:c(o.highlights_text),seo_keywords:c(o.seo_keywords_text),is_ai_generated:!!o.catalog_template_id,ai_generated_fields:o.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(o)},g=Xe();if(f.property_id=g,{error:h}=await p.from("showroom_listings").insert(f),h&&Ne(h,()=>je({...f,property_id:f.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=r);return}u(d?"Draft saved!":"Product published!")}try{localStorage.removeItem(sa(t,a))}catch{}closeProductFormModal()}catch(n){u("Error: "+n.message,"error"),s&&(s.disabled=!1,s.textContent=r)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=$t(e)),i||(i=(Array.isArray(j)?j.find(s=>s.property_id===e):null)||null),!i)return u("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=Q((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return D(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),C()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:r,updated_at:n,...o}=a,d=Xe();await p.from("showroom_listings").insert({...o,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),C())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),C())};const Fi=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Se(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?St().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(j)){const s=new Set(i.map(n=>n.property_id)),r=j.filter(n=>n.listing_type==="property"&&n.property_id&&!s.has(n.property_id));r.length&&(i=i.concat(r))}i.sort((s,r)=>new Date(r.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Ct("property","Real Estate"),i=e.country_code||"US",s=e.currency||Ye(i);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Fi.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    </div>`),ta(),aa(),Zt("ppf-price"),window.syncPropertyCountry=function(){xt("ppf")},xt("ppf"),ze("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>ze("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),r=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),n=t?0:parseInt(i.required_image_count||"24",10)||24;ea(n,s,"This property");const o={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(F,Math.min(J,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:r,images:s,highlights:He(i.highlights_text),seo_keywords:He(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){o.property_id=t;const c=Q((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:d}=await p.from("showroom_listings").upsert({...c,...o},{onConflict:"property_id"}))}else o.property_id=Xe(),{error:d}=await p.from("showroom_listings").insert(o);d&&Ne(d,()=>je({...o,property_id:t||o.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),z(),Se())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=$t(e)),i||(i=(Array.isArray(j)?j.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Ui=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function ra(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(r=>Oi(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Oi(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
      ...
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",jt(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",W(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Ui.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),z(),ra()};async function qi(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${l(i.order_number)}</p><p class="text-[10px] text-gray-500">${W(i.created_at)}</p></div>
    ...
    </div>`)};async function rt(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?ae("star","No Reviews","Customer reviews will appear here."):a.map(s=>Ni(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Ni(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),rt()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),rt())};async function oa(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),oa()};async function Ae(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:s}=await p.from("coupons").insert(i);if(s){u(s.message,"error");return}u("Coupon created!"),z(),Ae()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Ae()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Ae())};async function Hi(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const na=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Gi=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let ge=null;function zi(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function Wi(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${l(e.link_target||"")}</span>`}function Vi(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function la(){if(ge)return ge;const e=[],t=new Set,a=[],i=r=>{if(!r||!r.property_id)return;e.push({id:r.property_id,title:r.title||r.property_id});const n=r.category||"";n&&!t.has(n)&&(t.add(n),a.push(n))};try{j.forEach(i)}catch{}try{const{data:r,error:n}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!n&&r&&r.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(r=>{t.has(r)||(t.add(r),a.push(r))}),ge={products:e,categories:a,sections:Gi},ge}async function Ki(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),s=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:r}=await p.storage.from("advertisements").upload(s,e,{contentType:e.type,upsert:!1});if(r)return u("Upload failed: "+r.message,"error"),null;const{data:n}=p.storage.from("advertisements").getPublicUrl(s);return{url:n.publicUrl,isVideo:i}}catch{return u("Upload failed","error"),null}}function ve(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),s=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),s&&(s.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const i=await Ki(t);if(!i){e.value="";return}ve(i.url,i.isVideo);const s=document.getElementById("ad-media-url");s&&(s.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);ve(t,a)};function ot(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let s="";t==="product"?s='<option value="">Select a product…</option>'+e.products.map(r=>`<option value="${l(r.id)}" ${String(a)===String(r.id)?"selected":""}>${l(r.id)} — ${l((r.title||"").slice(0,60))}</option>`).join(""):t==="category"?s='<option value="">Select a category…</option>'+e.categories.map(r=>`<option value="${l(r)}" ${a===r?"selected":""}>${l(r)}</option>`).join(""):t==="section"&&(s='<option value="">Select a section…</option>'+e.sections.map(r=>`<option value="${l(r.id)}" ${a===r.id?"selected":""}>${l(r.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${s}</select>`}function da(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";ot(e,a,"")};window.showAddAdModal=async function(){const e=await la();window._adLinkCache=e,B(da(null)),ot(e,"none","")};window.showEditAdModal=async function(e){const t=await la();window._adLinkCache=t;const{data:a}=await p.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}B(da(a)),a.image_url?ve(a.image_url,!1):a.video_url&&ve(a.video_url,!0),ot(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",s={title:a.title,description:a.description||"",ad_label:na.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!s.image_url&&!s.video_url){u("Add an image or video for the ad","error");return}const r=e.target.querySelector('button[type="submit"]');r&&(r.disabled=!0);try{if(i){const{error:n}=await p.from("promotions").update(s).eq("id",i);if(n)throw n;u("Ad updated!")}else{const{error:n}=await p.from("promotions").insert(s);if(n)throw n;u("Ad created!")}}catch(n){u(n.message||"Save failed","error"),r&&(r.disabled=!1);return}z(),se()};window.togglePromo=async function(e,t){const{error:a}=await p.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),se()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await p.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const s=a||[],r=s.findIndex(c=>c.id===e),n=r+t;if(r<0||n<0||n>=s.length){u("Already at the edge","info");return}const o=s[r],d=s[n];await p.from("promotions").update({sort_order:d.sort_order}).eq("id",o.id),await p.from("promotions").update({sort_order:o.sort_order}).eq("id",d.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}se()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await p.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(s=>{const r=/\/object\/public\/advertisements\/(.+)$/.exec(s);return r?decodeURIComponent(r[1]):null}).filter(Boolean);if(i.length)try{await p.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await p.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}se()}};async function se(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        ...
        </div>`};const{data:a}=await p.from("ai_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.active_provider||"gemini",r=ee.slice(0,10),n=ee.slice(10);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const ua=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function Qi(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function pa(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const i of t)i in e&&(a[i]=e[i]);return a}function le(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const r=t.slice(i,s+1);try{return JSON.parse(r)}catch{return null}}function _t(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=Qi(e);if(!a)try{const{data:i}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();i&&(a=i)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},A()};function A(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",i=e.busy===!0,r=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    ...
    </div>`).join(""),m=e.suggestions?Xi():"",h=Yi();B(`
    ...
    </div>`);const b=document.getElementById("product-ai-input");b&&(b.value=e.instruction||"",b.addEventListener("input",()=>{y&&(y.instruction=b.value)}),b.addEventListener("keydown",f=>{f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),runProductAiInstruction())})),window.lucide&&lucide.createIcons(),ma()}function ma(){const e=document.getElementById("product-ai-chat-scroll");e&&requestAnimationFrame(()=>{e.scrollTo({top:e.scrollHeight,behavior:"smooth"})})}window.productAiChatAttach=function(){document.getElementById("product-ai-chat-image")?.click()};window.productAiChatImagePicked=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await ga(i);s&&(y.chatImages.push(s),a+=1)}e.value="",a&&u(`${a} photo(s) attached. Send any message and the AI will look at them right away.`,"info"),A()};window.productAiRemoveChatImage=function(e){y&&(y.chatImages.splice(e,1),A())};function ga(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>t(String(a.result||"")),a.onerror=()=>t(""),a.readAsDataURL(e)})}function Yi(){const e=y;if(!e)return"";const t=Array.isArray(e.product.images)?e.product.images:[],a=[...t,...e.addedImages],i={};t.forEach(n=>{i[n]=(i[n]||0)+1});const s=Object.keys(i).filter(n=>i[n]>1),r=a.map((n,o)=>{const d=o<t.length,c=d&&s.includes(n);return`
    ...
    </div>`}function Xi(){const e=y;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){y&&(y.instruction=e)};window.productAiQuickAction=function(e){const t=ua.find(a=>a.key===e);!t||!y||(y.instruction=t.prompt,y.quickLabel=t.label,y.quickMode=t.mode||"edit",runProductAiInstruction())};window.productAiToggleApproved=function(e,t){y&&(t?y.approved.add(e):y.approved.delete(e),A())};window.productAiApproveAll=function(){if(!(!y||!y.suggestions)){for(const e of Object.keys(y.suggestions))y.approved.add(e);y.removedImages.size&&y.approved.add("images_to_remove"),A()}};window.productAiToggleRemoveImage=function(e){if(!y)return;const t=Array.isArray(y.product.images)?y.product.images:[],i=[...t,...y.addedImages][e];i&&(e<t.length?y.removedImages.has(i)?y.removedImages.delete(i):y.removedImages.add(i):y.addedImages=y.addedImages.filter(s=>s!==i),A())};window.productAiDetectDuplicates=async function(){if(!y)return;const e=y,t=Array.isArray(e.product.images)?e.product.images:[],a={};t.forEach(s=>{a[s]=(a[s]||0)+1});const i=t.filter((s,r)=>!(a[s]>1&&t.indexOf(s)!==r));if(i.length===t.length){u("No duplicate images found.","info");return}await re(i,`Removed ${t.length-i.length} duplicate image(s) from the card.`)};window.productAiUploadImages=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=y,a=[...e.files];t.busy=!0,A();const s=[...Array.isArray(t.product.images)?t.product.images:[]];let r=0;for(const n of a){if(!n.type.startsWith("image/"))continue;const o=await pe(n);o&&(s.push(o),r+=1)}if(e.value="",t.busy=!1,r){await re(s,`${r} image(s) uploaded to the card.`);return}u("Upload failed.","error"),A()};function Zi(e,t){const a=String(e).toLowerCase();if(/\b(generate|create|make|draw|produce|imagine)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner)\b/.test(a)||/\b(change|swap|replace|edit|remove)\b[\s\S]*\b(background|color|colour)\b/.test(a))return"gen";if(/\bshowroom\b/.test(a)||/\bcompare\b[\s\S]*\b(showroom|product|other|card)\b/.test(a)||/\bscan\b[\s\S]*\b(showroom|product|card|listing|shop|match)\b/.test(a)||/\bmatch(es|ing)?\b/.test(a))return"scan";const i=/\b(rewrite|rephrase|update|fix|improve|optimize|change|make|rename|retitle|set|clean up|cleanup|remove|delete|add)\b/,s=/\b(title|description|price|stock|category|subcategory|brand|name|images?|features|tags|highlights|seo)\b/;return i.test(a)&&s.test(a)?"edit":t?"vision":"chat"}function es(){const e=y;return(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content)}window.runProductAiInstruction=async function(){const e=y;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i&&!s)return;const r=t||"Improve this product listing professionally.",n=a||t||(s?"Look at these photos and tell me what you see.":"Improve this product listing professionally."),o=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.messages.push({role:"user",content:n,images:o}),e.busy=!0,A();const d=i||Zi(r,s);try{d==="gen"?await ba(r,o):d==="scan"?await rs():d==="edit"?await ts(r,o):d==="vision"?await is(r,o):await as(r),ma()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`AI error: ${c.message}`,"error")}finally{e.busy=!1,A()}};async function ts(e,t){const a=y,i=os(a,e);let s="";if(t&&t.length){const o=await S._callEdge({action:"vision",images:t.slice(0,4),prompt:i,max_tokens:4096});if(s=o&&o.text?String(o.text):"",!s)throw new Error(o&&o.error||"The AI could not read the attached photos.")}else s=(await S.prompt(i,{maxTokens:4e3,onProviderSwitch:()=>{}})).text;const r=le(s);if(!r)throw new Error("The AI did not return valid JSON suggestions.");a.suggestions=r,a.approved=new Set(Object.keys(r)),a.approved.add("images_to_remove");const n=(r.summary||"Changes are ready for this product.").trim();a.messages.push({role:"assistant",content:`${n}

✅ Changes are ready below. Tick what you want, then press Save.`}),u("Suggestions ready — review and approve before saving.","info")}async function as(e){const t=y,a=es(),i=await S._callEdge({action:"chat",message:e,history:a,max_tokens:1200});if(i&&i.response){t.messages.push({role:"assistant",content:String(i.response)});return}throw new Error(i&&i.error||"The AI did not respond.")}async function is(e,t){const a=y,i=`${e}

If you recognize the product in these photos, say yes and identify exactly what it is, give a typical price range for it, and offer to generate more product photos for this listing. Be friendly and helpful.`,s=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1200}),r=s&&s.text?String(s.text):"";if(!r)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:r})}async function ss(){let e=Array.isArray(window._productsData)?window._productsData:[];if(!e.length)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").limit(500);!a&&Array.isArray(t)&&(e=t)}catch{}return(e||[]).filter(t=>t&&t.property_id!==y.pid)}async function rs(){const e=y,t=await ss(),a=JSON.stringify(pa(e.product),null,2),i=t.slice(0,15).map(m=>({title:m.title,category:m.category,subcategory:m.subcategory,price:m.price,currency:m.currency,brand:m.brand,images:Array.isArray(m.images)?m.images.length:0,listing_type:m.listing_type})),s=`You are the AI product manager for the product ${e.pid} in the Weverse Online Shop showroom.
THIS PRODUCT (JSON):
${a}
...
- Respond with valid JSON only.`,r=await S._callEdge({action:"chat",message:s,history:[],max_tokens:3e3}),n=r&&r.response?String(r.response):"";if(!n)throw new Error(r&&r.error||"The showroom scan returned nothing.");const o=le(n),d=Array.isArray(o&&o.mismatches)?o.mismatches:[],c=Array.isArray(o&&o.matches)?o.matches:[];if(o&&(d.length||c.length||o.summary)){const m={};d.forEach(b=>{b&&b.field&&b.suggested_value!==void 0&&b.suggested_value!==null&&(m[b.field]=b.suggested_value)});const h=["Showroom scan complete:"];c.length&&h.push(...c.map(b=>`✅ ${b}`)),d.length&&h.push(...d.map(b=>`⚠️ ${b.field}: ${b.issue}`)),d.length||h.push("✅ Everything matches the other products in this showroom."),d.length?(m.summary=o.summary||`${d.length} issue(s) found with the showroom.`,e.suggestions=m,e.approved=new Set(Object.keys(m)),e.approved.add("images_to_remove"),h.push("Fixes are ready below. Tick what you want, then press Save.")):e.suggestions=null,e.messages.push({role:"assistant",content:h.join(`
`)}),u("Showroom scan complete.","info");return}e.messages.push({role:"assistant",content:n||"Showroom scan complete."})}async function ba(e,t){const a=y,i=a.product,s=`${e}

(Generate a clean, professional product photo for "${String(i.title||"").trim()||"this product"}" in the Weverse Online Shop.)`;let r=null;t&&t.length?r=t[0]:Array.isArray(i.images)&&i.images[0]&&(r=await S._fetchImageAsDataUrl(i.images[0]));const n=await S._callEdge({action:"generate_images",prompt:s,reference_url:r,count:2});if(n&&Array.isArray(n.images)&&n.images.length){a.generatedImages=n.images,a.lastGenPrompt=e,a.lastGenReference=r,a.messages.push({role:"assistant",content:"Here are your generated images. Tap one to add it to the card, or Regenerate for new variations.",generated:n.images,provider:`${n.provider||"AI"}/${n.model||""}`});return}throw new Error(n&&n.error||"Image generation returned nothing.")}async function Ie(e){try{const t=await fetch(e).then(i=>i.blob());if(!t||!t.size)return null;const a=new File([t],`ai-${Date.now()}.png`,{type:t.type||"image/png"});return await pe(a)}catch{return null}}window.productAiUseGeneratedImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Ie(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[];await re([...s,i],"Generated image added to the card.")};window.productAiReplaceMainImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Ie(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[],r=s.length?[i,...s.slice(1)]:[i];await re(r,"Old main image replaced with the generated one.")};window.productAiUseAllGeneratedImages=async function(){const e=y;if(!e||e.busy||!Array.isArray(e.generatedImages)||!e.generatedImages.length)return;e.busy=!0,A();const a=[...Array.isArray(e.product.images)?e.product.images:[]];let i=0;for(const s of e.generatedImages){const r=await Ie(s);r&&(a.push(r),i+=1)}if(e.busy=!1,i){e.generatedImages=[],await re(a,`${i} generated image(s) added to the card.`);return}u("Upload failed.","error"),A()};window.productAiRemoveImageNow=async function(e){const t=y;if(!t||t.busy)return;const a=Array.isArray(t.product.images)?t.product.images:[];e<0||e>=a.length||await re(a.filter((i,s)=>s!==e),"Image removed from the card.")};async function re(e,t){const a=y;if(!a)return;a.busy=!0,A();const i=Q({...a.product,images:e,property_id:a.pid,updated_at:new Date().toISOString()});try{const{error:s}=await p.from("showroom_listings").upsert(i,{onConflict:"property_id"});if(s)throw s;a.product.images=e,a.removedImages.clear(),u(t,"success"),a.from==="properties"?Se():C()}catch(s){s&&D(s)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration.","error"):u(`Save failed: ${s&&s.message||"unknown error"}`,"error")}finally{a.busy=!1,A()}}window.productAiRegenerateImage=async function(){const e=y;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,A();try{await ba(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,A()}}};function os(e,t){const a=e.product;return`You are the AI product manager assistant for the Weverse Online Shop admin dashboard, working on ONE product.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(o=>o!=="images_to_remove"),a={};if(e.suggestions)for(const o of e.approved)o!=="images_to_remove"&&o in e.suggestions&&e.suggestions[o]!==void 0&&(a[o]=e.suggestions[o]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const i=Array.isArray(e.product.images)?e.product.images:[],s=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(o=>s.add(o));const r=[...i.filter(o=>!s.has(o)),...e.addedImages],n=Q({...e.product,...a,images:r,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,A();try{const{error:o}=await p.from("showroom_listings").upsert(n,{onConflict:"property_id"});if(o)throw o;u("Changes saved to Supabase.","success");const d=e.from;y=null,z(),d==="properties"?Se():C()}catch(o){e.busy=!1,o&&D(o)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${o&&o.message||"unknown error"}`,"error"),A()}};let x=null;const nt=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Scan this photo and publish it in the matching section of my showroom — show me a preview first so I can approve it."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function ns(){const e=x;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content):[]}function ls(e,t){const a=String(e||"").toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":t?a?"vision":"execute":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":"execute"}function ds(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function ha(){return x||(x={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Upload a photo and tell me what you want: I'll scan it and list the brand, model, year and real details, generate a matching image, or publish it to the showroom (I'll always show you a preview and ask if it's good before publishing). I always scan your showroom first so trucks go where the trucks are, cars where the cars are, homes where the homes are — I never guess or make new sections unless you ask me to. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null,pendingPublish:null},x)}window.openGeneralAi=async function(){ha(),I()};function cs(e){if(!e)return"";const t=(Number(e.price)||0)>0?`$${Number(e.price).toLocaleString()}`:"",a=Array.isArray(e.images)?e.images.slice(0,3):[],i=Array.isArray(e.features)?e.features.slice(0,8):[],s=[e.brand,e.model,e.year,e.property_type].filter(Boolean);return`
    <div class="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4">
      ...
      ${s.length?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${s.map(r=>l(String(r))).join(" · ")}${t?` · ${t}`:""}</p>`:t?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${t}</p>`:""}
      <p class="text-[11px] text-gray-300 mt-2 leading-relaxed whitespace-pre-wrap break-words">${l(e.description||"")}</p>
      ${i.length?`<div class="flex flex-wrap gap-1.5 mt-3">${i.map(r=>`<span class="px-2 py-1 rounded-lg bg-white/5 border border-white/10 text-[9px] text-gray-200">${l(String(r))}</span>`).join("")}</div>`:""}
    ...
    </div>`}function fa(e){return e?e.role==="user"?`
    <div class="flex justify-end">
      <div class="max-w-[85%] bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-3xl rounded-tr-md px-5 py-3.5 text-[1.02rem] leading-relaxed whitespace-pre-wrap break-words shadow-lg shadow-blue-600/20">
    ...
    <div class="flex gap-3 items-start">
      ...
      <div class="glass border border-sky-500/20 rounded-3xl rounded-tl-md px-5 py-3.5 min-w-0 max-w-[85%]">
        ...
        ${e.previewDraft?cs(e.previewDraft):""}
    ...
    </div>`}function va(){const e=x;return!e||!e.pendingPlan?"":`
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${l(ds(e.pendingPlan))}</p>
    ...
    </div>`}function xa(){const e=x;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,i)=>`
    ...
    </div>`).join(""):""}function I(){document.getElementById("general-ai-embed-scroll")&&wa(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&us(),Pe()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function us(){const e=x;if(!e)return;const t=e.busy===!0,i=(Array.isArray(e.messages)?e.messages:[]).map(c=>fa(c)).join(""),s=t?ya():"",r=nt.map(c=>`
    ...
    </div>`);const d=document.getElementById("general-ai-input");d&&(d.value=e.instruction||"",d.addEventListener("input",()=>{x&&(x.instruction=d.value)}),d.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Pe()}function wa(){const e=x,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,i=Array.isArray(e.messages)?e.messages:[],s=nt.map(d=>`
    ...
    ${a?ya():""}
    ${va()}
  `;const r=document.getElementById("general-ai-embed-thumbs");r&&(r.innerHTML=xa());const n=document.getElementById("general-ai-embed-send-btn");n&&(n.classList.toggle("opacity-40",a),n.classList.toggle("pointer-events-none",a));const o=document.getElementById("general-ai-embed-input");o&&(o.value=e.instruction||"",o.dataset.gaiBound||(o.dataset.gaiBound="1",o.addEventListener("input",()=>{x&&(x.instruction=o.value)}),o.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),runGeneralAiInstruction())}))),window.lucide&&lucide.createIcons(),Pe()}function Pe(){const e=["general-ai-chat-scroll","general-ai-embed-scroll"];requestAnimationFrame(()=>{for(const t of e){const a=document.getElementById(t);a&&a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}})}window.generalAiChatAttach=function(){document.getElementById("general-ai-chat-image")?.click()};window.generalAiChatImagePicked=async function(e){if(!x||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await ga(i);s&&(x.chatImages.push(s),a+=1)}if(e.value="",a){u(`${a} photo(s) attached. Now type what you want me to do with it (e.g. "scan this and list everything about it", "generate an image exactly like this", or "publish this to the showroom").`,"info");const i=document.getElementById("general-ai-embed-input")||document.getElementById("general-ai-input");i&&i.focus()}I()};window.generalAiRemoveChatImage=function(e){x&&(x.chatImages.splice(e,1),I())};window.generalAiQuickAction=function(e){const t=nt.find(a=>a.key===e);!t||!x||(x.instruction=t.prompt,x.quickLabel=t.label,x.quickMode=t.mode,runGeneralAiInstruction())};window.runGeneralAiInstruction=async function(){const e=x;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i)return;const r=t||"",n=a||t||(s?"Photo attached — please scan it and list everything you can identify about it.":r),o=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.pendingPlan=null,e.messages.push({role:"user",content:n,images:o}),e.busy=!0,I();const d=i||ls(r,s);try{d==="publish"?await _a(r,o):d==="gen"?await ka(r,o):d==="monitor"?await ps():d==="vision"?await ms(r,o):await gs(r,o),Pe()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`General AI error: ${c.message}`,"error")}finally{e.busy=!1,I()}};async function _a(e,t){const a=x,i=await S._callEdge({action:"general_publish",message:e,images:t.slice(0,4),max_tokens:2048});if(!i||i.success!==!0)throw new Error(i&&i.error||"Could not prepare the product card.");if(i.pending&&i.draft){a.pendingPublish={draft:i.draft,instruction:e},a.messages.push({role:"assistant",content:String(i.response||"Here is the card I prepared. Is it good?"),previewDraft:i.preview||i.draft,images:(i.images||[]).slice(0,2)}),I();return}a.messages.push({role:"assistant",content:String(i.response||"Published."),images:(i.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Ee()}window.generalAiConfirmPublish=async function(){const e=x;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=e.pendingPublish.draft;e.pendingPublish=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_publish",mode:"publish",draft:t});if(!a||a.success!==!0)throw new Error(a&&a.error||"Could not publish the product.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||"Published to the showroom.")}`,images:(a.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Ee()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPublish=function(){x&&(x.pendingPublish=null,x.messages.push({role:"assistant",content:"Cancelled — nothing was published."}),I())};window.generalAiOpenPublishFix=function(){const e=document.getElementById("general-ai-publish-fix-box");e&&e.classList.remove("hidden")};window.generalAiRevisePublish=async function(){const e=x;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=document.getElementById("general-ai-publish-fix-input"),a=t?String(t.value||"").trim():"",i=e.pendingPublish.draft,s=e.pendingPublish.instruction||"";e.pendingPublish=null,e.busy=!0,I();try{const r=await S._callEdge({action:"general_publish",mode:"preview",message:s,draft:i,feedback:a||"Make this card more professional and match the showroom style."});if(!r||r.success!==!0)throw new Error(r&&r.error||"Could not revise the card.");if(!r.pending||!r.draft)throw new Error("The AI could not produce a revised card.");e.pendingPublish={draft:r.draft,instruction:s},e.messages.push({role:"assistant",content:String(r.response||"Here is the revised card. Is it good now?"),previewDraft:r.preview||r.draft,images:(r.images||[]).slice(0,2)}),I()}catch(r){e.messages.push({role:"assistant",content:`⚠️ ${r.message}`})}finally{e.busy=!1,I()}};async function ka(e,t){const a=x;let i=null;t&&t.length&&(i=t[0]);const s=i?"The attached image is your SUBJECT — study it carefully and reproduce the SAME thing: the same type of object, subject, brand, model, look, colors, style and background. Keep the identical subject; only improve quality and lighting for a professional look. Do NOT change the subject and do NOT draw a person, woman, man, or face unless the attached image actually shows one. You must match what is in the reference photo.":`Generate a beautiful, high-quality image based on this request: "${e}". Follow the request exactly. If it asks for a specific object, product, vehicle, or scene, draw exactly that — never swap in a different subject, a person, or a random image.`,r=await S._callEdge({action:"generate_images",prompt:`${e}

${s}`,reference_url:i,count:2});if(!r||!Array.isArray(r.images)||!r.images.length)throw new Error(r&&r.error||"Image generation returned nothing.");a.generatedImages=r.images,a.lastGenPrompt=e,a.lastGenReference=i,a.messages.push({role:"assistant",content:"Here are your images — generated to match your reference photo. Tap one to save it to your showroom product images.",generated:r.images,provider:`${r.provider||"AI"}/${r.model||""}`})}async function ps(){const e=x,t=await S._callEdge({action:"general_monitor",max_tokens:3e3});if(!t||t.success!==!0||!t.report)throw new Error(t&&t.error||"Could not scan the showroom.");const a=t.report||{},i=["Showroom scan complete:"];(Array.isArray(a.good)?a.good:[]).forEach(s=>i.push(`✅ ${s}`)),(Array.isArray(a.issues)?a.issues:[]).forEach(s=>i.push(`⚠️ ${s.property_id} (${s.severity||"low"}): ${s.issue}`)),(Array.isArray(a.suggestions)?a.suggestions:[]).forEach(s=>i.push(`💡 ${s}`)),Array.isArray(a.issues)&&a.issues.length||i.push("Everything looks good."),e.messages.push({role:"assistant",content:i.join(`
`)})}async function ms(e,t){const a=x,i=`${e}
...
- Keep it a clean, readable list. You manage the whole showroom, so stay professional and factual.`,s=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1500}),r=s&&s.text?String(s.text):"";if(!r)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:r,provider:s.provider?`${s.provider}/${s.model}`:""})}async function gs(e,t){const a=x,i=ns(),s=await S._callEdge({action:"general_execute",message:e,images:(t||[]).slice(0,4),history:i,max_tokens:1200});if(!s||s.success!==!0)throw new Error(s&&s.error||"Could not handle that request.");if(s.needs_confirmation){a.pendingPlan=s.plan||null,a.messages.push({role:"assistant",content:String(s.response||"I found something I can fix.")});return}a.messages.push({role:"assistant",content:String(s.response||s.reply||"Done.")}),s.plan&&s.plan.action!=="chat"&&s.plan.action!=="monitor"&&Ee()}window.generalAiConfirmPlan=async function(){const e=x;if(!e||!e.pendingPlan||e.busy)return;const t=e.pendingPlan;e.pendingPlan=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_execute",confirm_plan:t,confirmed:!0});if(!a||a.success!==!0)throw new Error(a&&a.error||"The action failed.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||a.reply||"Done.")}`}),Ee()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPlan=function(){x&&(x.pendingPlan=null,x.messages.push({role:"assistant",content:"Cancelled — nothing was changed."}),I())};window.generalAiUseGeneratedImage=async function(e){const t=x;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,I();const i=await Ie(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),I();return}u("Image saved to showroom storage. Use it on any card or ask the AI to attach it.","success"),I()};window.generalAiPublishGeneratedImage=async function(e){const t=x;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];a&&(t.instruction="Publish this generated image in the matching section of my showroom.",t.messages.push({role:"user",content:"Publish this generated image in the matching section of my showroom.",images:[a]}),t.chatImages=[],t.generatedImages=[],await _a("Publish this generated image in the matching section of my showroom.",[a]))};window.generalAiRegenerateImage=async function(){const e=x;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,I();try{await ka(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,I()}}};async function Ee(){try{await C()}catch{}}const lt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],bs=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function dt(e){return Array.isArray(e)?e:[]}function $a(e=[]){const t=new Map(dt(e).map(a=>[a.id,a]));return lt.map(a=>{const i=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!i.enabled,apiKey:i.apiKey||"",model:i.model||"",baseUrl:i.baseUrl||""}})}async function Sa(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function ct(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...dt(t?.ai_ad_generation_history)].slice(0,120);await Sa({ai_ad_generation_history:a})}async function Aa(e){try{const{data:i,error:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(s)throw s;let r;if(i?.id?{error:r}=await p.from("site_settings").update(e).eq("id",i.id):{error:r}=await p.from("site_settings").insert(e),r)throw r;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:i}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let s;if(i?.id?{error:s}=await p.from("public_live_state").update(a).eq("id",i.id):{error:s}=await p.from("public_live_state").insert(a),!s)return}catch{}try{localStorage.setItem(Lt,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function hs(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function fs(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=hs(e.description),i=a?.startsAt||e.started_at||null,s=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:i,ai_ad_ends_at:s,ai_ad_duration_seconds:s&&i?Math.max(5,Math.round((new Date(s).getTime()-new Date(i).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(Lt),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function Ce(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),fs()]),i=t||{},s=a||{},r=$a(i.ai_ad_video_providers),n=dt(i.ai_ad_generation_history).sort((d,c)=>new Date(c.created_at||0).getTime()-new Date(d.created_at||0).getTime()).slice(0,12),o=!!s.ai_ad_enabled&&!!s.ai_ad_video_url&&(!s.ai_ad_ends_at||new Date(s.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <form id="ai-ad-generator-form" onsubmit="activateAiAdvertisement(event)" class="glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <select id="ai-ad-goal" class="input-field text-xs" name="goal">
                ${bs.map(d=>`<option value="${l(d)}">${l(d)}</option>`).join("")}
              </select>
            </div>
            <div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <input id="ai-ad-video-url" type="url" class="input-field text-xs" name="video_url" placeholder="https://...mp4" value="${l(o&&s.ai_ad_video_url||"")}" required>
            </div>
            <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`}}window.saveAiAdProviders=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());try{const{data:i}=await p.from("ai_settings").select("ai_ad_video_providers").limit(1).maybeSingle(),s=$a(i?.ai_ad_video_providers),r=new Map(s.map(o=>[o.id,o])),n=lt.map(o=>{const d=o.id,c=r.get(d)||{},m=String(a[`provider_${d}_api_key`]||"").trim();return{id:d,name:o.name,enabled:t.get(`provider_${d}_enabled`)==="on",apiKey:m||c.apiKey||"",model:String(a[`provider_${d}_model`]||"").trim(),baseUrl:String(a[`provider_${d}_base_url`]||"").trim()}});await Sa({ai_ad_video_providers:n}),u("AI advertisement provider settings saved.","success"),Ce()}catch(i){u("Failed to save providers: "+i.message,"error")}};window.generateAiAdScript=async function(){const e=document.getElementById("ai-ad-brief")?.value?.trim(),t=document.getElementById("ai-ad-goal")?.value||"Product launch",a=document.getElementById("ai-ad-provider"),i=document.getElementById("ai-ad-script");if(!e){u("Enter campaign brief first.","error");return}if(i){i.value="Generating script...";try{const s=["Create a short video advertisement script for an ecommerce marketplace.",`Goal: ${t}`,`Brief: ${e}`,"Return only plain text in this exact structure:","Headline:","Voiceover:","On-screen text:","CTA:"].join(`
`),r=await S.prompt(s,{onProviderSwitch:n=>{i.value=`Generating with ${n}...`}});i.value=r.text||"",await ct({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:r.provider,provider_id:a?.value||"",status:"script_generated",script:r.text||"",video_url:null}),u(`Script generated with ${r.provider}.`,"success")}catch(s){i.value="",u("Script generation failed: "+s.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),i=String(t.get("provider_id")||""),s=lt.find(b=>b.id===i)?.name||i,r=String(t.get("brief")||"").trim(),n=String(t.get("script")||"").trim(),o=String(t.get("video_url")||"").trim(),d=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),h=new Date(c+d*1e3).toISOString();if(!o){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:o,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:d,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:i,ai_ad_starts_at:m,ai_ad_ends_at:h,ai_ad_updated_at:new Date().toISOString()};await Aa(b),await ct({created_at:m,goal:a,brief:r,provider_name:s,provider_id:i,status:"active",script:n,video_url:o,ends_at:h}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Ce()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Aa({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await ct({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Ce()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function ys(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveContent=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),{error:i}=await p.from("site_settings").upsert({id:1,...a});if(i){u(i.message,"error");return}u("Content settings saved!")};async function vs(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),s=t.data||[],r=s.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,m)=>c+(parseFloat(m.amount)||0),0),n=s.length>0?(s.filter(c=>c.status!=="cancelled").length/s.length*100).toFixed(1):0,o={};(a.data||[]).forEach(c=>{o[c.category]=(o[c.category]||0)+1});const d=Object.entries(o).sort((c,m)=>m[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Jt(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function xs(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Ia(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Pa(e.map(t=>t.code)),Te()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await q(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Te()}catch(e){u(e.message,"error")}};async function _s(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function ks(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),u("Orders exported!")};async function $s(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,s]of t.entries())a[i]=s;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await p.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function Be(){const e=document.getElementById("content");e&&(e.innerHTML=de());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",s=a.homepage_banner_alt||"Homepage header banner",r=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Le(){const e=document.getElementById("content");e&&(e.innerHTML=de());try{let t=function(o,d,c,m="",h="blue"){const b=!!(c&&c.trim());return`
        ...
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.brand_name||i.site_name||Mt,r=i.brand_slogan||i.site_tagline||Rt,n=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="rounded-xl overflow-hidden border border-blue-500/10">
            <div id="preview-header" class="flex items-center gap-3 px-4 py-3" style="background:#0f172a">
              <div id="preview-logo-wrap" class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 overflow-hidden" style="background:var(--preview-primary,#f97316)">
                ${n?`<img src="${l(n)}" alt="${l(s)}" class="w-full h-full object-contain p-1">`:'<i data-lucide="globe" class="w-4 h-4 text-white"></i>'}
              </div>
              <div>
    ...
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${Dt.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Ss(t,a)).join("")}
    ...
    </div>`,pt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ut()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ut()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),pt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=we.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||At(t),pt(),renderManualPaymentAccountsEditor()};async function Qe(){const e=document.getElementById("content");e&&(e.innerHTML=de());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Fa()||{},...t||{}};window._manualPaymentAccounts=Ua(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(Oa(i))}</textarea>
              </div>
              <div>
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(i)if(r){const f=Math.min(s,8e3);for(let g=0;g<f&&c.length<ne;g++){const v=yt(i.slug,g);if(!v)continue;`${v.property_id} ${v.title} ${v.subcategory||""} ${v.category||""}`.toLowerCase().includes(r)&&c.push(v)}}else{const f=P.page*ne,g=Math.min(f+ne,s);for(let v=f;v<g;v++){const $=yt(i.slug,v);$&&c.push($)}}const m=c.length?c.map(f=>{const g=t.has(f.property_id),v=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${g?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${l(f.property_id)} · ${l(f.subcategory||f.category||"")} · ${jt(f.price,"USD")}</p>
            </div>
            ${R(!g)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',h=r?1:Math.max(1,Math.ceil(s/ne)),b=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${r?`${c.length} match`:`${s.toLocaleString()} items in ${l(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){P.category=e,P.page=0,P.query="",oe()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");P.query=e?e.value:"",P.page=0,oe()};window.catalogPage=function(e){const t=It(P.category),a=t?t.count:0,i=P.query.trim()?1:Math.max(1,Math.ceil(a/ne));P.page=Math.max(0,Math.min(i-1,P.page+e)),oe()};window.catalogToggle=async function(e){const t=!Pt().includes(e),a=await Na(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),oe()};window.catalogResetHidden=async function(){await Ha(),u("All hidden catalog listings restored"),oe()};async function kt(){window.lucide&&lucide.createIcons(),Ft(),await ci(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",kt):kt();window.aiChatHistory=[];window.aiProductType="product";async function As(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),Ut();const i=document.getElementById("ai-prompt");i&&(i.value=""),u("AI is analyzing...");try{let s=null;a&&(s=await fileToDataUrl(a));const r={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:s,catalog_context:await Is()},o=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(r)})).json();o.success&&o.product?(openListingReviewCard(o.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(o.error||"AI generation failed")}catch(s){u("Error: "+s.message),console.error("[AI] Generate product error:",s)}}async function Is(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&As()});
