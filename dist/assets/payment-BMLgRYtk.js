...
`),p=r.amountLabel||"",I=r.orderNumber||"";return`
  ...
  `}function Pe(e,l,t,r){const o=T(L(l.price,r),r);return`
  ...
  `}async function _e(){const e=document.getElementById("payment-content"),t=new URLSearchParams(window.location.search).get("guest")==="1",r=t?null:await ce();if(!r&&!t){window.location.href="/";return}const o=he();let i=await ae(o)||H(o)||oe(o)||se(o)||ne(o)||de(o)||ve(o);if(!i){const[{generateListingById:C},{loadHiddenCatalogIds:N}]=await Promise.all([D(()=>import("./catalog-CscHt5xx.js"),__vite__mapDeps([0,1,2])),D(()=>import("./catalog-hidden-store-Br-Df_3h.js"),__vite__mapDeps([1,2]))]);await N(),i=C(o)}if(i||(i=H(o)),!i){e.innerHTML=`
