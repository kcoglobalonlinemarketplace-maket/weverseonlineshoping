import{s as p,S as X,i as Kt,D as Ha}from"./supabase-client-CDm4AUL7.js";import{a as Ga,g as za,C as we,A as Va}from"./localization-DX01d7wE.js";import{patchLocalShowroomListing as Wa,getLocalShowroomListingById as St,removeLocalShowroomListing as Ka,upsertLocalShowroomListing as lt,listLocalShowroomListings as ze}from"./local-showroom-store-mzP0nSoS.js";import{g as Yt,s as Ya,l as Ja,a as Qa,b as Xa}from"./payment-settings-D1U7UCXe.js";import{P as Jt,a as Qt,T as Xt,M as Zt}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as Za}from"./catalog-DrlEcUAC.js";import{i as ei}from"./app-promo-banner-BXjUoacu.js";import{M as ti,n as ai,a as ii}from"./categories-BEuiwWw5.js";import{saveCatalogHidden as ea,loadHiddenCatalogIds as $t,getHiddenCatalogIds as Ve,resetHiddenCatalogIds as oi}from"./catalog-hidden-store-CoFqTKlU.js";const N=1,W=5e6,ri=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],ni=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],ta=[...ri,...ni];function Pt(e){return Ga[e]||"USD"}function aa(e,t){return ta.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function si(e,t){const a=Math.max(N,Math.min(W,Number(e)||N));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function li(e,t,a,i,o){const r=si(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function ia({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:r}){const n=ta.find(h=>h.id===e&&h.listingType===t);if(!n)return null;const l=za(i)||we[0],c=o||Pt(l.code),d=[l.name].filter(Boolean).join(", "),m={category:n.category||a||(t==="property"?"Real Estate":"Other"),subcategory:n.subcategory||n.label,title:t==="property"?`${n.label} in ${l.name}`:n.label,description:li(n,l,c,r,d),currency:c,features:[...n.features],highlights:[...n.highlights||[]],seo_keywords:[...new Set([n.category,n.subcategory,n.label,...t==="property"?[l.name]:[],...n.keywords||[]].filter(Boolean))],requiredImageCount:n.requiredImageCount||0};return t==="property"?{...m,country:l.name,country_code:l.code,product_location:l.name,property_type:n.propertyType||n.label,bedrooms:n.bedrooms??null,bathrooms:n.bathrooms??null,building_size:n.buildingSize||"",land_size:n.landSize||"",furnished:n.furnished||""}:{...m,brand:n.brand||"",model:n.model||"",color:n.color||"",size:n.size||"",condition:n.condition||"New"}}const oa="weverseonlineshop@gmail.com",ra="Weverse Online Shop",na="GLOBAL SHOPPING • WORLDWIDE DELIVERY",di="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ci=`${di}/functions/v1/ai-admin-assistant`,ui=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],pi={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},sa=[...Va].sort();let E={user:null,section:"dashboard"};function s(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function la(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function Z(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function de(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function We(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const mi=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents"];function he(e){const t={};if(!e||typeof e!="object")return t;for(const a of mi)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),o=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",r[t]||"info"),o.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function z(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",s(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function ee(){document.getElementById("modal-container").innerHTML=""}function H(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function q(e,t,a,i,o=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function _e(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function ce(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${s(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${s(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function da(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=ui.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){E.section=e;const t=pi[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),da(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=_e()),window.lucide&&lucide.createIcons(),({dashboard:Ii,products:R,properties:Xe,catalog:Pe,orders:Ea,customers:ao,reviews:Me,messages:Ia,coupons:Ze,ads:$e,notifications:ro,ai:bi,"ai-settings":La,"homepage-branding":at,"promo-bg":Te,content:mo,"content-settings":Ra,seo:wo,email:_o,analytics:xo,security:tt,activity:ko,brand:it,"payment-settings":kt,backup:So,settings:$o,publish:ot}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=ce("construction","Coming Soon",`${t} is being built.`))}))()};async function bi(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const fe="kco_admin_remember",Et="kco_login_attempts",dt=5,gi=15*60*1e3;function U(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function yi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ke(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Le(e){return String(e||"").trim().toLowerCase()}function fi(){try{const e=JSON.parse(localStorage.getItem(fe)||"{}");e?.email&&!Le(e.email)&&localStorage.removeItem(fe)}catch{localStorage.removeItem(fe)}}function hi(){try{const e=JSON.parse(localStorage.getItem(fe)||"{}");return Le(e?.email)}catch{return""}}function It(){fi();const e=hi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||oa,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function vi(){return`${window.location.origin}/admin.html`}function pe(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ke(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function F(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function ca(){try{return JSON.parse(localStorage.getItem(Et)||'{"count":0}')}catch{return{count:0}}}function ua(){const e=ca();return e.count=(e.count||0)+1,e.count>=dt&&(e.lockedUntil=Date.now()+gi),localStorage.setItem(Et,JSON.stringify(e)),e}function pa(){localStorage.removeItem(Et)}function ma(){const e=ca();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(pa(),null):Math.ceil(t/6e4)}async function ie(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await xi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function xi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function ba(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Le(e.email)===oa}async function wi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Ue(),Ei();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await ba(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),o=await p.auth.mfa.getAuthenticatorAssuranceLevel(),r=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&r!=="aal2"){E.user=t.user,Ue(),pe("2fa"),At();return}E.user=t.user,Ye();return}_i()}function Ue(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function _i(){Ue(),pe("login"),It(),ga(),ya(),At(),ki();const e=ma();e&&(U(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function ki(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function ga(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Si),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>pe("forgot")))}async function Si(e){e.preventDefault();const t=ma();if(t){U(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Le(a?.value);if(!i){U("Enter your admin email address."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;F("login-btn",!0),Ke();const{data:n,error:l}=await p.auth.signInWithPassword({email:i,password:o});if(l||!n.user){const g=String(l?.message||"").toLowerCase();if(g.includes("missing supabase credentials")||g.includes("authentication service is unavailable")){U("Authentication is temporarily unavailable due to configuration. Please contact support."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("failed to fetch")||g.includes("network request failed")){U("Network error while signing in. Check your connection and try again."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("email not confirmed")){U("Your admin email is not confirmed yet. Open your verification email and confirm first."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=ua(),b=dt-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${dt} failed attempts.`:`Invalid email or password. ${b>0?b+" attempt"+(b!==1?"s":"")+" remaining.":""}`;U(v),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await ie(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await ba(n.user)){await p.auth.signOut(),U(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ie(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(fe,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(fe),pa(),E.user=n.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),pe("2fa"),At(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ie(n.user.id,"login_success"),F("login-btn",!1),Ye()}function At(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Ot));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&Ot()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),E.user=null,pe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",$i))}async function Ot(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){U("Enter the 6-digit code from your authenticator app.");return}F("verify-2fa-btn",!0),Ke();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){U("No 2FA factor found. Please re-login."),F("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await p.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:r}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(r)throw r;await ie(E.user.id,"login_2fa_success"),F("verify-2fa-btn",!1),Ye()}catch(t){ua(),U(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),F("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function $i(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){U("Enter a backup recovery code.");return}F("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",E.user.id).maybeSingle();if(!t?.backup_codes?.length){U("No backup codes found."),F("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){U("Backup code not found or already used."),F("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",E.user.id),await ie(E.user.id,"login_backup_code_used"),Ye()}catch(t){U(t.message),F("verify-backup-btn",!1,"Use Backup Code")}}function ya(){document.getElementById("back-to-login")?.addEventListener("click",()=>pe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Pi)}async function Pi(){const e=document.getElementById("reset-email"),t=Le(e?.value);if(!t){U("Enter your admin email address to receive a reset link.");return}F("send-reset-btn",!0),Ke();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:vi()});if(F("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){U(a.message);return}yi("Reset link sent! Check your inbox and open it from this device to continue.")}function Ei(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function Ye(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&E.user&&(t.textContent=E.user.email||"Admin"),It(),navigate("dashboard")}window.adminSignOut=async function(){E.user&&await ie(E.user.id,"logout"),await p.auth.signOut(),E.user=null,Ue(),pe("login"),It(),ga(),ya()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(E.user&&await ie(E.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),E.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Ii(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),r=t.data||[],n=a.data||[],l=n.filter(y=>["approved","payment_approved","delivered"].includes(y.status)).reduce((y,_)=>y+(parseFloat(_.amount)||0),0),c=n.filter(y=>["pending","pending_verification","processing"].includes(y.status)).length,d=r.filter(y=>y.listing_type!=="property").length,m=r.filter(y=>y.listing_type==="property").length,h=r.filter(y=>y.listing_type!=="property"&&y.is_active).length,g=i.count||0,f=o.count||0,b=(o.data||[]).filter(y=>!y.is_approved).length,v=new Date,x=n.filter(y=>{const _=new Date(y.created_at);return _.getMonth()===v.getMonth()&&_.getFullYear()===v.getFullYear()}).filter(y=>["approved","payment_approved","delivered"].includes(y.status)).reduce((y,_)=>y+(parseFloat(_.amount)||0),0),w=n.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${q("Total Revenue",`$${l.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${x.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${q("Total Orders",n.length,"shopping-bag","blue",`${c} pending`)}
          ${q("Customers",g,"users","violet")}
          ${q("Products",d,"package","amber",`${h} active`)}
          ${q("Properties",m,"home","blue")}
          ${q("Reviews",f,"star","blue",`${b} pending`)}
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${w.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':w.map(y=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    <p class="text-xs font-bold text-white truncate">${s(y.order_number||y.id?.slice(0,8))}</p>
                    <p class="text-[10px] text-gray-500">${de(y.created_at)}</p>
                  </div>
                  <div class="flex items-center gap-2 shrink-0 ml-2">
                    <span class="text-xs font-bold text-emerald-400">$${parseFloat(y.amount||0).toLocaleString("en-US",{maximumFractionDigits:0})}</span>
                    ${z(y.status)}
                  </div>
                </div>`).join("")}
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
            ${[{icon:"plus-circle",label:"Add Product",fn:"navigate('products')"},{icon:"home",label:"Add Property",fn:"navigate('properties')"},{icon:"shopping-bag",label:"View Orders",fn:"navigate('orders')"},{icon:"star",label:"Reviews",fn:"navigate('reviews')"},{icon:"ticket",label:"Coupons",fn:"navigate('coupons')"},{icon:"settings",label:"Settings",fn:"navigate('settings')"}].map(y=>`
              <button onclick="${y.fn}" class="btn-press flex flex-col items-center gap-2 p-3 glass-soft border border-blue-500/15 rounded-xl hover:border-blue-500/30 transition">
                <i data-lucide="${y.icon}" class="w-5 h-5 text-blue-400"></i>
                <span class="text-[11px] font-bold text-gray-300">${y.label}</span>
              </button>`).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons(),va(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}async function R(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,o=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));for(const d of ze().filter(m=>m.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));if(Array.isArray(X))for(const d of X.filter(m=>m.listing_type!=="property"&&m.property_id))i.has(d.property_id)||(i.add(d.property_id),o.push(d));const r=[...Jt,...Qt,...Xt,...Zt];for(const d of r)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));o.sort((d,m)=>new Date(m.created_at||0)-new Date(d.created_at||0));try{await $t()}catch{}const n=new Set(Ve());if(n.size)for(let d=o.length-1;d>=0;d--)o[d]&&o[d].property_id&&n.has(o[d].property_id)&&o.splice(d,1);const l=[...new Set(o.map(d=>d.category).filter(Boolean))].sort((d,m)=>d.localeCompare(m)),c=[...new Set(o.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,m)=>d.localeCompare(m));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ${q("Total Products",o.length,"package","blue")}
          ${q("Published",o.filter(d=>!!d.is_active).length,"badge-check","emerald")}
          ${q("Draft / Hidden",o.filter(d=>!d.is_active).length,"file-clock","amber")}
          ${q("Featured",o.filter(d=>!!d.is_featured).length,"sparkles","violet")}
          ${q("Inventory Units",o.reduce((d,m)=>d+(parseInt(m.stock_quantity,10)||0),0),"boxes","blue")}
          ${q("Avg Price",`$${Math.round(o.reduce((d,m)=>d+(parseFloat(m.price)||0),0)/Math.max(o.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(l.length?l:se).map(d=>`<option value="${s(d)}" ${(window._productFilters.category||"")===d?"selected":""}>${s(d)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
          ...
          <div id="products-empty" class="hidden">${ce("package-search","No matching products","Try different filters or add a new product.",'<button onclick="showAddProductStep1()" class="btn-press bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2 rounded-xl">Add Product</button>')}</div>
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,fa(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}function re(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function ct(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ai(e){const t=re(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Ci(e){const t=re(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function Ct(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function ut(e){return parseInt(e.views??e.view_count??0,10)||0}function pt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Tt(e){return e.sku||e.property_id||"N/A"}function Ti(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=ct(e),i=Ct(e),o=window._productSelection?.has(e.property_id),r=z(i==="archived"?"inactive":i==="active"?"active":"inactive"),n=Z(e.created_at),l=!!e.is_featured,c=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${s(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${s(Tt(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${pt(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(h=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${s(h)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Li(e,t){const a=[...e],i=o=>new Date(o||0).getTime()||0;return t==="oldest"?a.sort((o,r)=>i(o.created_at)-i(r.created_at)):t==="price-high"?a.sort((o,r)=>re(r.price)-re(o.price)):t==="price-low"?a.sort((o,r)=>re(o.price)-re(r.price)):t==="sales-high"?a.sort((o,r)=>pt(r)-pt(o)):t==="views-high"?a.sort((o,r)=>ut(r)-ut(o)):a.sort((o,r)=>i(r.created_at)-i(o.created_at)),a}function fa(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const o=window._productsCardLimit||60,r=e.slice(0,o);t.innerHTML=r.map(Ti).join(""),i&&(i.textContent=String(e.length));const n=document.getElementById("products-more");if(n){const l=e.length-r.length;l>0?n.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:n.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function ha(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const o=i.images&&i.images[0]?i.images[0]:"/fallback.svg",r=Ct(i),n=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,c=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${s(Tt(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const d=re(i.price),m=parseFloat(i.real_price);return Number.isFinite(m)&&m>0&&m>d?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${m.toLocaleString()}</span><span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`})()}
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${i.stock_quantity!=null?s(i.stock_quantity):"Unlimited"}</span></td>
          <td>${z(r==="archived"?"inactive":r==="active"?"active":"inactive")}</td>
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${z(a.is_active?"active":"inactive")}${a.is_featured?'<span class="badge bg-amber-500/15 text-amber-200 border-amber-500/30">Featured</span>':""}</div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(o=>o.property_id===e)||t.data;if(!a)return u("Product not found","error");const i=Array.isArray(a.images)?a.images:[];H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Lt(),Bt(),Se(),me(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb img")].map(m=>m.getAttribute("src")).filter(m=>m&&!String(m).startsWith("blob:")),o={title:a.get("title")||"Untitled Product",price:Math.max(N,Math.min(W,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},r=String(a.get("real_price")||"").trim(),n=r===""?null:parseFloat(r);if(n!=null&&!Number.isFinite(n)){u("Real Price must be a number.","error");return}const l=he((window._productsData||[]).find(m=>m.property_id===t)),c=l.specifications&&typeof l.specifications=="object"?l.specifications:{};o.specifications={...c,real_price:n!=null&&n>0?Math.round(n):null};const{error:d}=await p.from("showroom_listings").upsert({...l,...o,property_id:t},{onConflict:"property_id"});if(d){if(Y(d)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),ee(),R();return}Wa(t,o),u("Quick edit saved locally","info")}else u(o.is_active?"Saved & published — your showroom shows it now":"Quick edit saved (draft)");ee(),R()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||St(e),{error:a}=await p.from("showroom_listings").delete().eq("property_id",e);if(a&&!Y(a))return u("Delete failed: "+a.message,"error");Ka(e);try{const i=await ea(e,!0);i&&i.error&&Y(i.error)?u("⚠️ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Product deleted")}catch{u("Product deleted")}t&&t.listing_type==="property"?Xe():R()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return Y(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),R()};window.openProductMoreActions=function(e){H(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${s(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${s(e)}')">${_a(o)}</select></div>
            </div>
    ...
    </div>`),Lt(),Bt(),gt("pf-price"),gt("pf-real_price"),yt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>yt(e,"pricing")),Ui(e,t.property_id||""),window._pfEscapeHandler=r=>{r.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),ee(),R()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,r]of i.entries())o==="images"?(a.images=a.images||[],r&&!String(r).startsWith("blob:")&&a.images.push(String(r))):o==="tags"?(a.tags=a.tags||[],a.tags.push(r)):a[o]=r;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function ke(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image (main photo)":"Image "+(t+1)}">
  ...
  </div>`}function Lt(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Fi(t.dataTransfer.files)}))}function Bt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Se()})}window.handleImageUpload=async function(e){await ka(e.target.files)};async function Fi(e){await ka(e)}async function ka(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await Mt(a);if(i){const o=t.children.length,r=document.createElement("div");r.innerHTML=ke(i,o),t.appendChild(r.firstElementChild),Se()}}Be(),me(),window.lucide&&lucide.createIcons()}}async function Mt(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:o}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(o)return URL.createObjectURL(e);const{data:r}=p.storage.from("product-images").getPublicUrl(i);return r.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Se(),Be(),me()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const o=await Mt(i);if(!o)return;const n=[...a.querySelectorAll(".img-thumb")][e];if(!n)return;const l=n.querySelector("img");l&&(l.src=o),Se(),Be(),me(),u("Image replaced. Save changes to apply.","info")};function Se(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.querySelector("img");if(!o)return;const r=document.createElement("input");r.type="hidden",r.name="images",r.id=`img-url-${i}`,r.value=o.src,t.appendChild(r),a.dataset.index=i;const n=a.querySelector(".rm");n&&n.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const c=a.querySelector(".rp-input");c&&(c.id=`rp-input-${i}`,c.onchange=()=>replaceImage(i,c))}))}function Be(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function me(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length;t.textContent=a?`${a} image${a>1?"s":""} — you can save and publish anytime`:"No images yet — you can still save and publish anytime",t.className="text-sm mt-1 font-bold text-gray-400"}function Ce(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Di(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Ni(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,r])=>{const n=e.querySelector(`[name="${o}"]`);n&&(n.type==="checkbox"?n.checked=r==="on"||r===!0:n.value=r==null?"":String(r))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.map((r,n)=>ke(r,n)).join(""),Se(),Be(),me())}return!0}function ht(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,n=t.querySelector('[name="stock_quantity"]')?.value,l=n===""||n==null?"Unlimited":n,c=E.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(g=>g.value),m=document.querySelectorAll("#image-preview .img-thumb").length,h=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${z(d?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${s(l)}</span></div>
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=j[e];if(!t)return;const a=Rt(t,ue),i=Qe(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(J==="s1-scan-status"||J==="scanner-scan-status")&&(ee(),le=[]),Ji(t,a);return}const r=i.category||t.category||"Other";if(J==="s1-scan-status"||J==="scanner-scan-status"){try{localStorage.removeItem(Ce(r,""))}catch{}le=[];let n=t.property_id?ve[t.property_id]:null;n&&n.specifications&&typeof n.specifications=="object"&&(n={...n,...n.specifications}),showAddProductStep2(r,n?{...n,images:a}:{images:a}),await Ht(t,a,r)}else{const n=document.getElementById("product-form"),l=n&&n.dataset.category||"";if(r!==l){try{localStorage.removeItem(Ce(r,""))}catch{}switchProductFormCategory(r);const c=document.getElementById(J);c&&(c.classList.remove("hidden"),c.classList.add("text-blue-300"),c.textContent=`Category changed to ${r} — finishing the scan…`),window.lucide&&lucide.createIcons()}await Ht(t,a,r)}};window.scanReviewEdit=function(e){const t=j[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=Qe(t.category),r=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",n=se.map(l=>`<option value="${s(l)}" ${l===r?"selected":""}>${s(l)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=j[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,o=document.getElementById(`sr-model-${e}`)?.value,r=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),o&&(t.model=o),r&&(t.category=r),scanReviewRender()};window.scanReviewRemove=function(e){j.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(J);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled — nothing was changed.")};window.scanReviewContinueAll=async function(){const e=document.getElementById(J),t=(d,m)=>{e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400","text-gray-100"),m&&e.classList.add(m),e.innerHTML=d,window.lucide&&lucide.createIcons())};if(!j.length)return;const a=document.getElementById("btn-scan-continue-all");a&&(a.disabled=!0,a.textContent="Saving everything…");const i=j.length;let o=0,r=0,n=0;const l=[];for(let d=0;d<i;d++){const m=j[d];if(!m)continue;const h=Qe(m.category);if(m.listing_type==="property"||h&&h.listing_type==="property"){l.push(d);continue}const f=h.category||m.category||"Other",b=Rt(m,ue);t(`<p class="flex items-center gap-2"><i data-lucide="loader" class="w-4 h-4 animate-spin text-blue-300"></i> Completing ${d+1} of ${i}: <b>${s(m.detected_name||"product")}</b>…</p>`,"text-blue-300");try{let v={},k=null;try{v=await B.completeProductSpecs(b,m,{category:f,maxImages:K.maxImages})||{}}catch{}try{k=await B.estimateProductPrice(b,m,v,{category:f,maxImages:K.maxImages})}catch{}const x=v||{},w=m.property_id&&ve[m.property_id]||null,y=w?w.specifications&&typeof w.specifications=="object"?{...w,...w.specifications}:w:null,_=[m.year||x.year,m.brand||x.brand,m.model||x.model].filter(Boolean).join(" ")||m.detected_name||"Product",M=k?Number(k.estimated_price??k.price??k.estimate):NaN;let A=Number.isFinite(M)&&M>0?M:y?Number(y.price):NaN;(!Number.isFinite(A)||A<=0)&&(A=N),A=Math.max(N,Math.min(W,A));const V={};for(const S of["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","type","size","age_range","skin_type","dimensions","author","publisher","language","format","pages","edition","quantity","pet_type","lens","sensor","megapixels","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"]){const T=x[S]??m[S];T!=null&&String(T).trim()!==""&&(V[S]=T)}const ge={...y&&y.specifications&&typeof y.specifications=="object"?y.specifications:{},...V},D={listing_type:"product",category:f,subcategory:y?.subcategory||null,title:y&&y.title?y.title:_,description:x.description||y&&y.description||"",price:A,currency:y&&y.currency||"USD",country:y&&y.country||"",country_code:y&&y.country_code||"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:!0,is_featured:!!(y&&y.is_featured),brand:m.brand||x.brand||y&&y.brand||null,color:x.color||y&&y.color||null,size:x.size||y&&y.size||null,condition:y&&y.condition||null,warranty:y&&y.warranty||null,availability_status:y&&y.availability_status||"In Stock",stock_quantity:y&&y.stock_quantity?parseInt(y.stock_quantity):null,images:b.length?b:y&&y.images||[],features:Array.isArray(x.features)&&x.features.length?x.features:y&&y.features||[],tags:Array.isArray(x.tags)&&x.tags.length?x.tags:y&&y.tags||[],highlights:Array.isArray(x.highlights)&&x.highlights.length?x.highlights:y&&y.highlights||[],seo_keywords:Array.isArray(x.seo_keywords)&&x.seo_keywords.length?x.seo_keywords:y&&y.seo_keywords||[],is_ai_generated:!0,ai_generated_fields:["title","description","specifications","price"],specifications:ge,updated_at:new Date().toISOString()};if(y&&y.property_id){D.property_id=y.property_id;const{error:S}=await p.from("showroom_listings").upsert(D,{onConflict:"property_id"});if(S)throw S;r++}else{D.property_id=We();const{error:S}=await p.from("showroom_listings").insert(D);if(S)throw S;o++}}catch(v){n++,t(`<p class="text-amber-300">Could not save "${s(m.detected_name||"product")}": ${s(String(v?.message||v))} — continuing with the rest…</p>`,"text-amber-300")}}j=j.filter((d,m)=>l.includes(m));const c=`${r} updated, ${o} new${n?`, ${n} failed`:""}`;if(!j.length)ve={},ue=[],t(`<div class="space-y-1">
    ...
    </div>`,"text-emerald-300"),u(`All done — ${c} saved & published.`,"success");else{scanReviewRender();const d=document.getElementById(J);if(d){const m=document.createElement("p");m.className="text-xs font-bold text-emerald-300",m.textContent=`Saved & published: ${c}. Property cards below still need Continue.`,d.prepend(m)}u(`Saved ${c}.`,n?"info":"success")}R()};function Sa(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,o=[],r=$=>Array.isArray($)?$.join(", "):String($??"").trim(),n=($,I)=>{if(I==null||r([I])==="")return;const G=document.querySelector(`#property-form [name="${$}"]`);G&&(G.value=String(I),o.push($))},l=t.property_type||a.property_type;if(l){const $=Ki(l);$&&n("property_type",$)}n("title",a.title||t.detected_name),n("description",a.description),n("subcategory",t.subcategory||a.subcategory);const c=t.bedrooms??a.bedrooms;c!=null&&c!==""&&n("bedrooms",parseInt(c,10)||c);const d=t.bathrooms??a.bathrooms;d!=null&&d!==""&&n("bathrooms",parseInt(d,10)||d),n("building_size",t.building_size||a.building_size),n("land_size",t.land_size||a.land_size);const m=t.parking_spaces??a.parking_spaces;m!=null&&m!==""&&n("parking_spaces",parseInt(m,10)||m);const h=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(h)?n("furnished","Furnished"):/unfurnished|no|empty/.test(h)&&n("furnished","Unfurnished");const g=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(g)?n("listing_status","rent"):/sale|buy|purchase/.test(g)&&n("listing_status","sale");const f=t.area||a.area;f&&!(t.town||a.town)&&n("town",f),n("town",t.town||a.town),n("city",t.city||a.city),n("state",t.state||a.state);const b=t.country||a.country;if(n("country",b),b){const $=(we||[]).find(I=>String(I.name||"").toLowerCase()===String(b).toLowerCase()||String(I.code||"").toLowerCase()===String(b).toLowerCase());if($&&$.code){const I=document.querySelector('#property-form [name="country_code"]');I&&(I.value=$.code,o.push("country_code"))}}const v=t.address||a.address;n("product_location",v||[f||t.town||a.town,t.city||a.city,t.state||a.state,b].filter(Boolean).join(", ")),n("address",t.address||a.address),n("zip_code",t.zip_code||a.zip_code);const k=Number(t.latitude??a.latitude),x=Number(t.longitude??a.longitude);Number.isFinite(k)&&k>=-90&&k<=90&&k!==0&&n("latitude",String(k)),Number.isFinite(x)&&x>=-180&&x<=180&&x!==0&&n("longitude",String(x)),n("features_text",r(a.features)),n("highlights_text",r(t.highlights||a.highlights)),n("seo_keywords_text",r(a.seo_keywords));const w=t.half_bathrooms??a.half_bathrooms;w!=null&&w!==""&&n("half_bathrooms",parseInt(w,10)||w);const y=t.floors??a.floors;y!=null&&y!==""&&n("floors",parseInt(y,10)||y),n("garage",t.garage||a.garage);const _=t.year_built??a.year_built;_!=null&&_!==""&&n("year_built",parseInt(_,10)||_);const M=t.year_renovated??a.year_renovated;M!=null&&M!==""&&n("year_renovated",parseInt(M,10)||M);const A=t.condition||a.condition,V=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(A){const $=String(A).toLowerCase(),I=V.find(G=>$.includes(G.toLowerCase())||G.toLowerCase().includes($));I&&n("condition",I)}n("interior_features_text",r(a.interior_features)),n("exterior_features_text",r(a.exterior_features)),n("home_systems_text",r(a.home_systems));const ge=r(t.landmarks||a.landmarks);ge&&n("landmarks_text",ge);const D=a.floor_plan;if(D&&typeof D=="object"){D.image&&n("floor_plan_image",D.image),D.levels&&n("floor_plan_levels",D.levels),D.total_area&&n("floor_plan_total_area",D.total_area);const $=Array.isArray(D.rooms)?D.rooms.map(I=>{const G=String(I).match(/^(.*?):\s*(.*)$/);return G?`${G[1].trim()}: ${G[2].trim()}`:String(I)}):[];$.length&&n("floor_plan_rooms",$.join(", "))}const S=a.nearby_area;S&&typeof S=="object"&&(Array.isArray(S.schools)&&S.schools.length&&n("nearby_schools_text",S.schools.join(", ")),Array.isArray(S.hospitals)&&S.hospitals.length&&n("nearby_hospitals_text",S.hospitals.join(", ")),Array.isArray(S.shopping)&&S.shopping.length&&n("nearby_shopping_text",S.shopping.join(", ")),Array.isArray(S.transportation)&&S.transportation.length&&n("nearby_transportation_text",S.transportation.join(", ")),Array.isArray(S.distances)&&S.distances.length&&n("nearby_distances_text",S.distances.join(", ")));const T=Array.isArray(a.legal_info)?a.legal_info.join(", "):r(a.legal_info);T&&n("legal_info_text",T),a.inspection_info&&n("inspection_info",a.inspection_info),a.risk_notes&&n("risk_notes",a.risk_notes);const ye=document.querySelector('#property-form [name="verification_status"]');ye&&(ye.value="Not verified",o.push("verification_status"));const rt=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map($=>String($))),nt=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);rt.forEach($=>{if(nt.has($))return;const I=document.querySelector(`#property-form [name="${$}"]`);if(!(!I||I.type==="checkbox"||I.type==="radio"||I.type==="number")&&String(I.value||"").trim()===""){if(I.tagName==="SELECT"&&![...I.options].some(G=>G.value==="Not specified")){const G=document.createElement("option");G.value="Not specified",G.textContent="Not specified",I.appendChild(G)}I.value="Not specified",o.push(`${$} (Not specified)`)}});const Oa=Number.isFinite(Number(N))?Number(N):0,qa=Number.isFinite(Number(W))?Number(W):999999999,jt=$=>Math.max(Oa,Math.min(qa,Math.round($))),Ee=i?Number(i.estimated_price):NaN,Fe=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(Ee)&&Ee>0){const $=document.querySelector('#property-form [name="real_price"]');$&&($.value=String(jt(Ee)),o.push("real_price"));const I=Number.isFinite(Fe)&&Fe>0&&Fe<Ee?Fe:Ee;n("price",String(jt(I)))}return typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:o}}async function Ht(e,t,a){const i=document.getElementById("scan-ai-status"),o=(r,n)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),n&&i.classList.add(n),i.innerHTML=r)};try{o("Completing the standard specifications for that product…","text-blue-300");const r=await B.completeProductSpecs(t,e,{category:a||"",maxImages:K.maxImages});let n=null;o("Estimating a fair current market price…","text-blue-300");try{n=await B.estimateProductPrice(t,e,r||{},{category:a||"",maxImages:K.maxImages})}catch{}const l=Wi({identification:e,specs:r,price:n}),c=[e.year,e.brand,e.model].filter(Boolean).join(" ")||e.detected_name||"the product";let d=`${s(c)} — ${l.filled.length} field${l.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;e.year_estimated&&(d+=" Confirm the model year before saving."),o(d,"text-emerald-300"),u(`Review ${c}, then press SAVE / UPDATE.`,"success")}catch(r){const n=String(r?.message||r),l=/key|api|configured|settings|vision/i.test(n);o(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${n}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){u("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",r=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await B.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){r("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),r("Detecting every distinct product in your images…","text-blue-300");let n;try{n=await B.detectProducts(i,{category:e.dataset.category||"",maxImages:Math.min(i.length,K.maxImages)})}catch(c){const d=String(c?.message||c),m=/key|api|configured|settings|vision/i.test(d);r(m?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=n&&n.identified!==!1&&Array.isArray(n.products)&&n.products.length?n.products:[];if(!l.length){r(n&&n.reason?`Could not identify any product: ${s(n.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}j=l,ue=i,ve={},J="scan-ai-status",scanReviewRender(),u(`${l.length} distinct product${l.length>1?"s":""} detected — review each one, then continue.`,"info")};function Ji(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((n,l)=>ke(n,l)).join(""),i.innerHTML=t.map((n,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${s(n)}">`).join(""),Be(),me());const o=document.getElementById("scan-ai-prop-status"),r=(n,l)=>{o&&(o.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&o.classList.add(l),o.innerHTML=n)};r("Completing the standard specifications for this property…","text-blue-300"),B.completeProductSpecs(t,e,{category:"Real Estate",maxImages:K.maxImages}).then(n=>B.estimateProductPrice(t,e,n||{},{category:"Real Estate",maxImages:K.maxImages}).then(l=>{const c=Sa({identification:e,specs:n,price:l});r(`${s(e.detected_name||"Property")} — ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}).catch(()=>r("Price estimate skipped — review the details and set a price manually.","text-amber-300"))).catch(n=>{const l=/key|api|configured|settings|vision/i.test(String(n?.message||n));r(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(n?.message||n)}`,"text-red-400"),u("AI scan failed.","error")})}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){u("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one property image before scanning.","error");return}const o=t?t.innerHTML:"",r=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await B.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){r("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),r("Identifying this property from your images…","text-blue-300");let n;try{n=await B.identifyProduct(i,{category:"Real Estate",maxImages:K.maxImages})}catch(c){const d=String(c?.message||c),m=/key|api|configured|settings|vision/i.test(d);r(m?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}if(!n||n.identified===!1){r(n&&n.reason?`Could not identify the property: ${s(n.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),u("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=await new Promise(c=>{Oe=g=>{Oe=null,c(g)};const d=document.getElementById("scan-ai-prop-status");if(!d){c({choice:"continue"});return}if(!window._propFormDirty){c({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const m=n.confidence||"medium",h={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[m]||"text-amber-400 border-amber-500/20";d.innerHTML=`
      <div class="rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in">
        ...
        <p class="text-[11px] text-gray-400">
          ...
          <span class="ml-1 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold border ${h}">${s(m).toUpperCase()} confidence</span>
        </p>
        <div class="flex flex-wrap gap-2">
      ...
      </div>`});if(!l||l.choice==="cancel"){r("Scan cancelled — nothing was changed.","text-gray-400"),u("Scan cancelled.","info");return}try{r("Completing the standard specifications for this property…","text-blue-300");const c=await B.completeProductSpecs(i,n,{category:"Real Estate",maxImages:K.maxImages});let d=null;r("Estimating a fair market value…","text-blue-300");try{d=await B.estimateProductPrice(i,n,c||{},{category:"Real Estate",maxImages:K.maxImages})}catch{}const m=Sa({identification:n,specs:c,price:d});r(`${s(n.detected_name||"Property")} — ${m.filled.length} field${m.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success")}catch(c){const d=String(c?.message||c),m=/key|api|configured|settings|vision/i.test(d);r(m?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let le=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await Mt(a);i&&le.push(i)}catch{}$a(),e.target.value=""}};window.removeStep1Image=function(e){le.splice(e,1),$a()};function $a(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=le.map((a,i)=>`
    ...
    </div>`).join("");const t=document.getElementById("btn-s1-scan");t&&(t.disabled=le.length===0,t.style.opacity=le.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=le.slice();if(!e.length){u("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-s1-scan"),a=document.getElementById("s1-scan-status"),i=t?t.innerHTML:"",o=(l,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=l)};try{const l=await B.getConfig();if(!String(l.gemini_key||l.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o("Detecting every distinct product in your images…","text-blue-300");let r;try{r=await B.detectProducts(e,{category:"",maxImages:Math.min(e.length,K.maxImages)})}catch(l){const c=/key|api|configured|settings|vision/i.test(String(l?.message||l));o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);const n=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];if(!n.length){o(r&&r.reason?`Could not identify any product: ${s(r.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}j=n,ue=e,ve={},J="s1-scan-status",scanReviewRender(),u(`${n.length} distinct product${n.length>1?"s":""} detected — review each one, then continue.`,"info")};let ve={};async function Pa(){const e=new Set,t=[],a=i=>{!i||!i.property_id||i.listing_type==="property"||e.has(i.property_id)||!Array.isArray(i.images)||!i.images.length||(e.add(i.property_id),t.push(i))};try{const{data:i,error:o}=await p.from("showroom_listings").select("*").neq("listing_type","property");(o?[]:i||[]).forEach(a)}catch{}return ze().forEach(a),t}window.openGeneralAiScanner=async function(){const e=await Pa();H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons()};function Gt(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await Gt(Pa(),15e3)}catch{e=[]}if(!e.length){u("No products with photos are in the Product Manager yet — add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",o=(b,v)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),v&&a.classList.add(v),a.innerHTML=b)};try{const b=await B.getConfig();if(!String(b.gemini_key||b.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o(`Detecting and completing ${e.length} product${e.length===1?"":"s"}…`,"text-blue-300");const r=[],n=[],l={};let c=0,d=0,m=0;const h=e.length,g=new Set;let f=0;window.__scanDupContinue=function(){const b=window.__scanDupResolve;window.__scanDupResolve=null;const v=document.getElementById("btn-scan-dup-continue");v&&(v.disabled=!0),b&&b()};for(const b of e){m++,o(`Scanning ${m} of ${h}: ${s(b?.title||b?.property_id||"product")}…`,"text-blue-300");const v=(b.images||[]).slice(0,K.maxImages);if(!v.length)continue;const k=v.map(_=>String(_||"").trim()).filter(Boolean),x=k.length>0&&k.every(_=>g.has(_));for(const _ of k)g.add(_);if(x){f++,o(`Duplicate images skipped for "${s(b?.title||b?.property_id||"product")}" — continuing with the remaining products…`,"text-blue-300");continue}const w=r.length;r.push(...v);const y=v.map((_,M)=>w+M);try{const _=await Gt(B.detectProducts(v,{category:b.category||"",maxImages:Math.min(v.length,K.maxImages)}),12e4),M=_&&_.identified!==!1&&Array.isArray(_.products)?_.products:[];if(!M.length)continue;c++,l[b.property_id]=b;for(const A of M)n.push({...A,property_id:b.property_id,image_indices:Array.isArray(A.image_indices)&&A.image_indices.length?A.image_indices.map(V=>y[Number(V)]).filter(V=>V!==void 0):y,detected_name:A.detected_name||b.title||b.property_id,category:A.category||b.category||"Other",listing_type:A.listing_type||b.listing_type||"product"})}catch{d++}}if(t&&(t.disabled=!1,t.innerHTML=i),!n.length){o(d?`The scan could not read any product (${d} scan${d>1?"s":""} failed or timed out${f?`; ${f} duplicate product${f>1?"s":""} skipped`:""}). Make sure your products have clear photos and that your free Gemini key is active in AI Settings, then try again.`:`No product could be identified from the photos on your existing products${f?` (${f} duplicate product${f>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),u("No products could be scanned.","error");return}j=n,ue=r,ve=l,J="scanner-scan-status",scanReviewRender(),u(`Scan complete — ${c} product${c>1?"s":""} scanned${f?`, ${f} duplicate product${f>1?"s":""} skipped`:""}. Press "Continue with ALL" to save & publish everything at once.`,"success")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),r=a?"One-Click Publish Changes":"One-Click Publish Product";o&&(o.disabled=!0,o.textContent="Saving…");try{const n=new FormData(i),l={};for(const[g,f]of n.entries())g==="images"?(l.images=l.images||[],f&&!String(f).startsWith("blob:")&&l.images.push(String(f))):g==="tags"?(l.tags=l.tags||[],l.tags.push(f)):l[g]=f;l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const c=n.get("action")==="draft",d=g=>bt(g),m=g=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],b={};for(const v of f){const k=g[v];if(v==="real_price"){const x=k!=null&&String(k).trim()!==""?parseFloat(k):null;b[v]=x!=null&&Number.isFinite(x)&&x>0?Math.round(x):null;continue}b[v]=k!=null&&String(k).trim()!==""?k:null}if(g.safety_features){const v=d(g.safety_features);b.safety_features=v.length?v:null}return b};let h;if(a){let g=he((window._productsData||[]).find(T=>T.property_id===a));if(!g){const{data:T}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();g=T?he(T):null}if(!g)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(T,ye)=>{const rt=T===""||T==null?"":T,nt=ye===""||ye==null?"":ye;return String(rt).trim()===String(nt).trim()},b={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(T=>{f(l[T],g[T])||(b[T]=l[T]==null||l[T]===""?null:l[T])});const v=l.price===""||l.price==null?null:parseFloat(l.price);f(v,g.price)||(b.price=v==null?g.price:Math.max(N,Math.min(W,v)));const k=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);f(k,g.stock_quantity)||(b.stock_quantity=Number.isFinite(k)?k:null);const x=d(l.features_text);f(x.join("||"),(Array.isArray(g.features)?g.features:[]).join("||"))||(b.features=x);const w=l.tags||[];f(w.join("||"),(Array.isArray(g.tags)?g.tags:[]).join("||"))||(b.tags=w);const y=d(l.highlights_text);f(y.join("||"),(Array.isArray(g.highlights)?g.highlights:[]).join("||"))||(b.highlights=y);const _=d(l.seo_keywords_text);f(_.join("||"),(Array.isArray(g.seo_keywords)?g.seo_keywords:[]).join("||"))||(b.seo_keywords=_);const M=l.images||[];f(M.join("||"),(Array.isArray(g.images)?g.images:[]).join("||"))||(b.images=M);const A=l.is_featured==="on";!!g.is_featured!==A&&(b.is_featured=A);const V=c?!1:l.is_active==="on";!!g.is_active!==V&&(b.is_active=V);const ge=m(l),D={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},...ge};if(JSON.stringify(D)!==JSON.stringify(g.specifications||{})&&(b.specifications=D),Object.keys(b).length===0){u("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Ce(t,a))}catch{}o&&(o.disabled=!1,o.textContent=r);return}const S={...g,...b,property_id:a,updated_at:new Date().toISOString()};if({error:h}=await p.from("showroom_listings").upsert(S,{onConflict:"property_id"}),h&&mt(h,()=>lt(S),"Product update")){o&&(o.disabled=!1,o.textContent=r),ee(),R();return}u(c?"Draft saved!":`Published Successfully — your product is updated and live in your showroom (${Object.keys(b).length} change${Object.keys(b).length>1?"s":""}).`)}else{if(!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!l.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(N,Math.min(W,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:c?!1:l.is_active==="on",is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:d(l.features_text).length?d(l.features_text):l.tags||[],tags:l.tags||[],highlights:d(l.highlights_text),seo_keywords:d(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(l)},b=We();if(f.property_id=b,{error:h}=await p.from("showroom_listings").insert(f),h&&mt(h,()=>lt({...f,property_id:f.property_id}),"Product publish")){o&&(o.disabled=!1,o.textContent=r),ee(),R();return}u(c?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}try{localStorage.removeItem(Ce(t,a))}catch{}closeProductFormModal(),R()}catch(n){u("Error: "+n.message,"error"),o&&(o.disabled=!1,o.textContent=r)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=St(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return u("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=he((window._productsData||[]).find(o=>o.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return Y(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:r,updated_at:n,...l}=a,c=We();await p.from("showroom_listings").insert({...l,property_id:c,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),R())};const vt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Xe(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?ze().filter(r=>r.listing_type==="property"):t||[];if(Array.isArray(X)){const r=new Set(i.map(l=>l.property_id)),n=X.filter(l=>l.listing_type==="property"&&l.property_id&&!r.has(l.property_id));n.length&&(i=i.concat(n))}i.sort((r,n)=>new Date(n.created_at||0)-new Date(r.created_at||0));try{await $t()}catch{}const o=new Set(Ve());i=i.filter(r=>!(r&&r.property_id&&o.has(r.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(r=>`<tr>
                    ...
                    <td>${z(r.listing_status||"sale")} ${z(r.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=aa("property","Real Estate"),i=e.country_code||"US",o=e.currency||Pt(i);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${wa(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${_a(o)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${vt.map(n=>`<option value="${n}" ${e.property_type===n?"selected":""}>${n}</option>`).join("")}
            </select></div>
    ...
    </div>`),Lt(),Bt(),gt("ppf-price"),window._propFormDirty=!!t;const r=document.getElementById("property-form");if(r){const n=()=>{window._propFormDirty=!0};r.addEventListener("input",n),r.addEventListener("change",n)}window.syncPropertyCountry=function(){qt("ppf")},qt("ppf"),ft("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>ft("pricing")),Zi()};let Q=null,Ne=null,zt=null;function Qi(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function oe(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Ae(e,t,{reverse:a=!1}={}){if(!Q||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Ne?Ne.setLatLng(i):Ne=L.marker(i,{draggable:!0}).addTo(Q),Q.setView(i,Math.max(Q.getZoom(),13));const o=document.querySelector('#property-form [name="latitude"]'),r=document.querySelector('#property-form [name="longitude"]');o&&(o.value=String(Number(e.toFixed(6)))),r&&(r.value=String(Number(t.toFixed(6)))),a&&Xi(e,t);const n=document.getElementById("btn-open-google-map");n&&(n.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Ie(){const e=Qi();if(!e){oe("Enter a location (address, area, city, state, country), then press Locate from fields.");return}oe("Searching location…");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Ae(parseFloat(a[0].lat),parseFloat(a[0].lon)),oe("Located: "+a[0].display_name)):oe("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{oe("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Xi(e,t){const a=document.querySelector("#property-form");if(a)try{const o=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),r=o&&o.address||{},n=(f,b)=>{if(!b)return;const v=a.querySelector(`[name="${f}"]`);return v&&!String(v.value||"").trim()?(v.value=b,!0):!1},l=[r.road||"",r.house_number||""].filter(Boolean).join(" "),c=r.suburb||r.neighbourhood||r.quarter||r.district||r.borough||"",d=r.town||r.village||r.municipality||r.city_district||"",m=r.city||r.county||"",h=r.state||r.region||"",g=r.country||"";if(n("product_location",l||c||d),n("town",c||d),n("city",m),n("state",h),g){n("country",g);const f=a.querySelector('[name="country_code"]');if(f){const b=(we||[]).find(v=>String(v.name||"").toLowerCase()===String(g).toLowerCase());b&&b.code&&!f.value&&(f.value=b.code)}}oe("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(o.display_name?" — "+o.display_name:""))}catch{oe("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!Q)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Ae(e,t),oe("Map updated from coordinates.")):Ie()};function Zi(){const e=document.getElementById("property-map-preview");if(!e||!window.L){oe("Map unavailable right now — your location fields still save normally.");return}Q&&(Q.remove(),Q=null,Ne=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);Q=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(Q),Q.on("click",o=>Ae(o.latlng.lat,o.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Ie),["product_location","town","city","state","country","latitude","longitude"].forEach(o=>{const r=document.querySelector(`#property-form [name="${o}"]`);r&&(r.addEventListener("input",()=>{if(o==="latitude"||o==="longitude"){const n=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(n)&&Number.isFinite(l)&&(n||l)&&Ae(n,l);return}clearTimeout(zt),zt=setTimeout(Ie,900)}),r.addEventListener("change",()=>{o!=="latitude"&&o!=="longitude"&&Ie()}))}),i?Ae(t,a):Ie()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(o=>{const r=parseFloat(o.latitude),n=parseFloat(o.longitude),l=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");return!(Number.isFinite(r)&&Number.isFinite(n)&&(r!==0||n!==0))&&!!l});if(!t.length){u("All properties already have map coordinates.","success");return}u(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}…`,"success");let a=0,i=0;for(const o of t){const r=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");try{const l=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(r))).json();if(l&&l[0]){const c={latitude:parseFloat(l[0].lat),longitude:parseFloat(l[0].lon)},{error:d}=await p.from("showroom_listings").update(c).eq("property_id",o.property_id);d?i++:(Object.assign(o,c),a++)}else i++}catch{i++}await new Promise(n=>setTimeout(n,1100))}u(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),Xe()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(g=>g&&!g.startsWith("blob:")),r=(i.features_text||"").split(",").map(g=>g.trim()).filter(Boolean),n=i.real_price===""||i.real_price==null?null:Math.max(N,Math.min(W,parseFloat(i.real_price)||0)),l=g=>(g||"").split(",").map(f=>f.trim()).filter(Boolean),c=g=>g===""||g==null||!isFinite(parseInt(g,10))?null:parseInt(g,10),d=l(i.floor_plan_rooms).map(g=>{const f=String(g).match(/^(.*?):\s*(.*)$/);return f?{name:f[1].trim(),dimensions:f[2].trim()}:{name:g,dimensions:""}}),m={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(N,Math.min(W,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:n,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:c(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:c(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:c(i.year_built),year_renovated:c(i.year_renovated),landmarks:l(i.landmarks_text),interior_features:l(i.interior_features_text),exterior_features:l(i.exterior_features_text),home_systems:l(i.home_systems_text),legal_info:l(i.legal_info_text).map(g=>{const f=String(g).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return f?{label:f[1].trim(),value:f[2].trim(),source:f[3]}:{label:g,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:d,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:l(i.nearby_schools_text),hospitals:l(i.nearby_hospitals_text),shopping:l(i.nearby_shopping_text),transportation:l(i.nearby_transportation_text),distances:l(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:l(i.documents_text),features:r,images:o,highlights:bt(i.highlights_text),seo_keywords:bt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let h;if(t){m.property_id=t;const g=he((window._propertiesData||[]).find(f=>f.property_id===t)||(window._productsData||[]).find(f=>f.property_id===t));m.specifications={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},real_price:n},{error:h}=await p.from("showroom_listings").upsert({...g,...m},{onConflict:"property_id"})}else m.property_id=We(),m.specifications={real_price:n},{error:h}=await p.from("showroom_listings").insert(m);h&&mt(h,()=>lt({...m,property_id:t||m.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),ee(),Xe())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=St(e)),i||(i=(Array.isArray(X)?X.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const eo=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Ea(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(r=>to(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",la(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",de(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${s(i)||"—"}</p></div>`).join("")}
          </div>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),ee(),Ea()};async function ao(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await p.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${s(i.order_number)}</p><p class="text-[10px] text-gray-500">${de(i.created_at)}</p></div>
            <div class="flex items-center gap-2">${z(i.status)}<span class="text-xs font-bold text-emerald-400">$${parseFloat(i.amount).toLocaleString()}</span></div>
          </div>`).join("")}
      </div>
    </div>`)};async function Me(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:o}=await p.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),r=o||[],n=r.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?ce("star","No Reviews","Customer reviews will appear here."):a.map(l=>oo(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${r.length===0?ce("message-square","No Feedback Yet","Site feedback will appear here."):r.map(l=>io(l)).join("")}
          </div>
        </div>
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await p.from("site_feedback").update({is_approved:!0}).eq("id",e);t?u(t.message,"error"):u("Feedback approved — it now shows on every page."),Me()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await p.from("site_feedback").delete().eq("id",e);t?u(t.message,"error"):u("Feedback deleted."),Me()};function oo(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),Me()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),Me())};async function Ia(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?ce("message-circle","No Messages","Customer support messages will appear here."):a.map(i=>`
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${de(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),Ia()};async function Ze(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td>${z(i.is_active?"active":"inactive")}</td>
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await p.from("coupons").insert(i);if(o){u(o.message,"error");return}u("Coupon created!"),ee(),Ze()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Ze()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Ze())};async function ro(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?ce("bell","No Notifications","System notifications will appear here."):a.map(i=>`
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${Aa.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";Ft(e,a,"")};window.showAddAdModal=async function(){const e=await Ca();window._adLinkCache=e,H(Ta(null)),Ft(e,"none","")};window.showEditAdModal=async function(e){const t=await Ca();window._adLinkCache=t;const{data:a}=await p.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}H(Ta(a)),a.image_url?qe(a.image_url,!1):a.video_url&&qe(a.video_url,!0),Ft(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",o={title:a.title,description:a.description||"",ad_label:Aa.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!o.image_url&&!o.video_url){u("Add an image or video for the ad","error");return}const r=e.target.querySelector('button[type="submit"]');r&&(r.disabled=!0);try{if(i){const{error:n}=await p.from("promotions").update(o).eq("id",i);if(n)throw n;u("Ad updated!")}else{const{error:n}=await p.from("promotions").insert(o);if(n)throw n;u("Ad created!")}}catch(n){u(n.message||"Save failed","error"),r&&(r.disabled=!1);return}ee(),$e()};window.togglePromo=async function(e,t){const{error:a}=await p.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),$e()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await p.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const o=a||[],r=o.findIndex(d=>d.id===e),n=r+t;if(r<0||n<0||n>=o.length){u("Already at the edge","info");return}const l=o[r],c=o[n];await p.from("promotions").update({sort_order:c.sort_order}).eq("id",l.id),await p.from("promotions").update({sort_order:l.sort_order}).eq("id",c.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}$e()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await p.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(o=>{const r=/\/object\/public\/advertisements\/(.+)$/.exec(o);return r?decodeURIComponent(r[1]):null}).filter(Boolean);if(i.length)try{await p.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await p.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}$e()}};async function $e(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.renderAds=$e;const et=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],ae={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function La(){const e=document.getElementById("content");try{let t=function(r){const n=o===r.id,l=i[r.kf],c=i[r.mf]||r.dm;return`
        <div class="glass-soft border ${n?ae.border[r.color]+" "+ae.bg[r.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${r.id}">
          <div class="flex items-start justify-between gap-2">
            <div class="flex items-center gap-2.5 min-w-0">
              <div class="w-8 h-8 ${ae.bg[r.color]} rounded-lg flex items-center justify-center shrink-0">
                <i data-lucide="${r.icon}" class="w-4 h-4 ${ae.text[r.color]}"></i>
              </div>
              <div class="min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  <h3 class="text-xs font-black text-white">${s(r.name)}</h3>
                  <span class="text-[8px] font-black uppercase px-1.5 py-0.5 rounded-full ${ae.badge[r.color]}">${r.tag}</span>
                </div>
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${n?ae.text[r.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${r.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${ae.text[r.color]} hover:underline flex items-center gap-0.5">
      ...
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${et.map(t).join("")}</div>
          </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.highlightAI=function(e){et.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?ae.border[t.color]+" "+ae.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const o=a.querySelector("input[type=radio] + span");o&&(o.className=`text-[9px] font-bold ${i?ae.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};et.forEach(o=>{a[o.mf]&&(i[o.mf]=a[o.mf]);const r=(a[o.kf]||"").trim();r&&!r.startsWith("••••")&&r!==""&&(i[o.kf]=r)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key);try{const{data:o}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let r;if(o?.id?{error:r}=await p.from("ai_settings").update(i).eq("id",o.id):{error:r}=await p.from("ai_settings").insert(i),r){u("Save failed: "+r.message,"error"),console.error("[AI Save]",r);return}await B.reload(),u("✅ AI settings saved!","success"),setTimeout(()=>La(),600)}catch(o){u("Unexpected error: "+o.message,"error"),console.error("[AI Save]",o)}};const B={_cfg:null,async reload(){const{data:e,error:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async chat(e,{maxTokens:t=2e3}={}){const a=await this.getConfig();if(!String(a.gemini_key||"").trim())throw new Error("No AI provider configured. Go to AI Settings and add your Gemini API key.");const i=e[e.length-1],o={action:"chat",message:String(i?.content||"").trim(),history:e.slice(0,-1).map(n=>({role:n.role,content:String(n.content||"")})),provider_override:"gemini",max_tokens:t},r=await this._callEdge(o);if(r&&r.response)return{text:r.response,provider:"Google Gemini",model:r.model||a.gemini_model};throw new Error(String(r?.error||"Gemini is unavailable."))},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return et.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is — the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
- category: best match from this list — ${se.join(", ")}. For properties set category to "Real Estate".
...
`).trim();if(!m)continue;const h=st(m);if(h)return{...h,_aiProvider:"Gemini (browser)",_aiModel:r}}catch{}return null}};function po(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const o=i.indexOf(",");t(o>=0?i.slice(o+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=B;window.showAiStatusModal=async function(){const e=await B.getStatus(),t=e.filter(a=>a.hasKey);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function st(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),o=t.lastIndexOf("}");if(i===-1||o===-1||o<=i)return null;const r=t.slice(i,o+1);try{return JSON.parse(r)}catch{return null}}async function mo(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([p.from("site_settings").select("*").limit(1).maybeSingle(),bo()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),r=a.length?`
        <div class="mt-4">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),u("Cleared. Save to apply.","info"),Ra()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),u(`Uploading ${a.name}…`,"info");try{const{data:{session:i}}=await p.auth.getSession();if(!i){u("Sign in to upload media","error");return}const o=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),r=`content/${t}-${Date.now()}.${o}`,{error:n}=await p.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!1});if(n){u("Upload failed: "+n.message,"error");return}const{data:l}=p.storage.from("product-images").getPublicUrl(r),c=l.publicUrl,d=document.getElementById("val-"+t),m=document.getElementById("url-"+t);d&&(d.value=c),m&&(m.value=c);const h=document.getElementById("slot-"+t);if(h){const g=Dt.flatMap(f=>f.fields||[]).find(f=>f.key===t);g&&(h.outerHTML=Ba(g,c))}u("✓ Uploaded — save to apply","success")}catch{u("Upload failed","error")}}};const go=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function te(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Re(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(te()))}function be(){Re();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=Ma(te()),window.lucide&&lucide.createIcons())}function yo(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim();return`
    <div>
    ...
    </div>`}function Ma(e){return(e||[]).map((t,a)=>{const i=String(t&&t.buttonText||"SHOP NOW"),o=go.map(r=>`<button type="button" onclick="heroVideoPreset(${a},'${r}')" class="px-2.5 py-1 rounded-full text-[9px] font-black ${i===r?"bg-indigo-600 text-white":"bg-white/5 text-gray-400"} border ${i===r?"border-indigo-500":"border-white/10"} transition">${r}</button>`).join("");return`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&ho(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=te();i[e]&&(i[e][t]=a,Re())};window.heroVideoPreset=function(e,t){const a=te();a[e]&&(a[e].buttonText=t,be())};window.heroVideoToggle=function(e){const t=te();t[e]&&(t[e].enabled=t[e].enabled===!1,be())};window.heroVideoMove=function(e,t){const a=te(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],be())};window.heroVideoDelete=function(e){const t=te();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),be())};window.heroVideoRemoveMedia=function(e,t){const a=te();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),be())};window.addHeroVideoSlide=function(){te().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),be(),u("New slide added — upload a video and press Save to show it.","info")};async function fo(e,t){try{const{data:{session:a}}=await p.auth.getSession(),i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,"");if(!a)return URL.createObjectURL(e);const o=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:r}=await p.storage.from("product-images").upload(o,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(r)return URL.createObjectURL(e);const{data:n}=p.storage.from("product-images").getPublicUrl(o);return n&&n.publicUrl||URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}async function ho(e,t,a){const i=te();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){u("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){u("Please choose an image for the poster.","error");return}const o=await fo(a,t);t==="video"?i[e].video=o:i[e].poster=o,be(),u("✓ "+(t==="video"?"Video":"Poster")+" uploaded — press Save to apply","success")}function vo(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Re(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
    ...
    </div>`}window.heroVideoSavePublish=async function(e){const t=te().filter(o=>o&&(o.video||o.poster||o.title||o.subtitle));if(!t.length){u("Add at least one video slide before publishing.","error");return}const a=t.filter(o=>o.video);if(!a.length){u("Please upload a video in at least one slide first.","error");return}const i=e?e.innerHTML:"";e&&(e.disabled=!0,e.innerHTML="⏳ Publishing…");try{Re();const{data:o}=await p.from("site_settings").select("id").limit(1).maybeSingle();let r;if(o?.id?{error:r}=await p.from("site_settings").update({hero_video_slides:t}).eq("id",o.id):{error:r}=await p.from("site_settings").insert({id:1,hero_video_slides:t}),r)throw new Error(r.message);Kt(),u("✓ Hero video banner published! "+a.length+(a.length===1?" video is":" videos are")+" now live on your homepage.","success")}catch(o){u(o.message||"Could not publish the hero banner. Please try again.","error")}finally{e&&(e.disabled=!1,e.innerHTML=i,window.lucide&&lucide.createIcons())}};async function Ra(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a={...Ha,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
              ...
              ${i.key==="hero_videos"?vo(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(o=>`
                  <div class="${o.type==="textarea"||o.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${o.type==="textarea"?`<textarea id="cs-${o.key}" name="${o.key}" rows="3" class="input-field w-full" placeholder="Enter the current wording…">${s(a[o.key]||"")}</textarea>`:o.type==="media"?Ba(o,a[o.key]||""):o.type==="checkbox"?"":`<input id="cs-${o.key}" type="text" name="${o.key}" value="${s(a[o.key]||"")}" class="input-field w-full" placeholder="Enter the current wording…">`}
      ...
      </div>`,Re(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[o,r]of t.entries())a[o]=r;for(const o of Dt)if(o.fields)for(const r of o.fields)r.type==="checkbox"&&!(r.key in a)?a[r.key]=!1:r.type==="checkbox"&&(a[r.key]=!0);let i=[];try{const o=t.get("hero_video_slides");if(String(o||"").trim()){const r=JSON.parse(o);Array.isArray(r)&&(i=r)}}catch{i=[]}a.hero_video_slides=i;try{const{data:o}=await p.from("site_settings").select("id").limit(1).maybeSingle();let r;if(o?.id?{error:r}=await p.from("site_settings").update(a).eq("id",o.id):{error:r}=await p.from("site_settings").insert({id:1,...a}),r)throw new Error(r.message);Kt(),u("Content updated — the banners now use your new words and uploads.","success")}catch(o){u(o.message||"Could not save content. Please try again.","error")}};async function xo(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],r=o.filter(d=>["approved","payment_approved","delivered"].includes(d.status)).reduce((d,m)=>d+(parseFloat(m.amount)||0),0),n=o.length>0?(o.filter(d=>d.status!=="cancelled").length/o.length*100).toFixed(1):0,l={};(a.data||[]).forEach(d=>{l[d.category]=(l[d.category]||0)+1});const c=Object.entries(l).sort((d,m)=>m[1]-d[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${q("Total Revenue",`$${r.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${q("Total Orders",o.length,"shopping-bag","blue")}
          ${q("Customers",i.count||0,"users","violet")}
          ${q("Conversion Rate",n+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
      ...
      </div>`,window.lucide&&lucide.createIcons(),va(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function wo(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${c} · Enrolled: ${Z(r.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${o.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':o.map(d=>{const m=["login_success","login_2fa_success"].includes(d.event_type),h=["login_failed","login_denied","login_backup_code_used"].includes(d.event_type),g=m?"text-emerald-400":h?"text-red-400":"text-gray-300",f={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[d.event_type]||d.event_type;return`<tr>
                      ...
                      <td><span class="text-xs text-gray-500">${de(d.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,document.getElementById("new-pw")?.addEventListener("input",d=>{const m=d.target.value,h=[{label:"8+ characters",ok:m.length>=8},{label:"Uppercase letter",ok:/[A-Z]/.test(m)},{label:"Number",ok:/[0-9]/.test(m)},{label:"Special character",ok:/[^a-zA-Z0-9]/.test(m)}];document.getElementById("pw-strength").innerHTML=h.map(g=>`<div class="flex items-center gap-1.5 text-[10px] ${g.ok?"text-emerald-400":"text-gray-600"}">
          <i data-lucide="${g.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${g.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(a!==i){u("Passwords do not match","error");return}if(a.length<8){u("Password must be at least 8 characters","error");return}const{error:o}=await p.auth.signInWithPassword({email:E.user.email,password:t});if(o){u("Current password is incorrect","error");return}const{error:r}=await p.auth.updateUser({password:a});if(r){u(r.message,"error");return}await ie(E.user.id,"password_changed"),u("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${de(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${s(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${de(a.created_at)}</p></div>
...
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),u("Orders exported!")};async function $o(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await p.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function at(){const e=document.getElementById("content");e&&(e.innerHTML=_e());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",r=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function it(){const e=document.getElementById("content");e&&(e.innerHTML=_e());try{let t=function(l,c,d,m="",h="blue"){const g=!!(d&&d.trim());return`
        <div class="glass-soft border border-${h}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${g?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
               ...
               </div>`:`<div class="w-full h-24 rounded-xl border-2 border-dashed border-${h}-500/25 hover:border-${h}-500/50 flex flex-col items-center justify-center gap-2 cursor-pointer transition" onclick="triggerImgUpload('${c}')">
          ...
          <div class="flex gap-2">
            ...
            <button type="button" onclick="document.getElementById('url-${c}').classList.toggle('hidden')" class="text-[10px] text-${h}-400 hover:text-${h}-300 transition shrink-0">${g?"Edit URL":"Paste URL"}</button>
          </div>
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||ra,r=i.brand_slogan||i.site_tagline||na,n=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}function Po(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",o=t[a]||"",r=t[i]||"",n=!!(o&&o.trim()),l=!!(r&&r.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function Vt(e,t,a,i,o){const r=o==="image",n=r?"blue":"violet",l=r?"image-plus":"video",c=r?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function Na(){const e={};for(const t of Ge)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=Na();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),Te(t),u("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const r=(a.name.split(".").pop()||"bin").toLowerCase(),n=`promo/${t}-${Date.now()}.${r}`,{error:l}=await p.storage.from("product-images").upload(n,a,{contentType:a.type,upsert:!0});let c;if(l)c=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:g}=p.storage.from("product-images").getPublicUrl(n);c=g.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const d=document.getElementById("val-"+t),m=document.getElementById("url-"+t);d&&(d.value=c),m&&(m.value=c,m.classList.remove("hidden"));const h=Na();Te(h)}catch(r){o&&(o.textContent=`Upload failed: ${r.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const r of Ge)t[r.key+"_bg_image"]=document.getElementById("val-"+r.key+"_bg_image")?.value||"",t[r.key+"_bg_video"]=document.getElementById("val-"+r.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await p.from("site_settings").update(t).eq("id",i.id):{error:o}=await p.from("site_settings").insert(t),ei(),o?(u("Publish failed — the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),Te(t)):(u("Promo & backgrounds published across all pages.","success"),setTimeout(()=>Te(),500))};window._manualPaymentAccounts=[];function Nt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Yt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function Ut(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Eo(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        ...
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${wa(a)}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[Nt()]),e.innerHTML=`
    <div class="space-y-4">
    ...
    </div>`,Ut(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Nt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Nt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),Ut())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=we.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Yt(t),Ut(),renderManualPaymentAccountsEditor()};async function kt(){const e=document.getElementById("content");e&&(e.innerHTML=_e());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Ja()||{},...t||{}};window._manualPaymentAccounts=Qa(i).map(o=>({...o})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o={},r=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,c]of Object.entries(i))r.includes(l)?c&&!c.startsWith("•")&&c.trim()!==""&&(o[l]=c.trim()):o[l]=c;const{error:n}=await p.from("site_settings").upsert({id:1,...o});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),n){u(n.message,"error");return}u("Deploy & payment settings saved!"),ot()};async function Ua(e="deploy"){const{data:t}=await p.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return u("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function ne(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:o,error:r}=await p.from("deployment_history").insert({version:a,status:e,triggered_by_email:E.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:o,error:r}}function xe(e,t,a,i){if(!e)return;e.disabled=t;const o=e.querySelector("p.text-xs.font-black");o&&(o.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");xe(t,!0,"Deploying…","Deploy Now");try{const a=await Ua("deploy");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await ne("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Deployment queued from admin UI"});const r=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await ne("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted deployment request"}),setTimeout(()=>ot(),400);else{const n=`Webhook returned error: ${r.status}`;u(n,"error"),await ne("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:n})}}catch(a){u("Deploy failed: "+a.message,"error"),await ne("failed",{mode:"deploy",errorMessage:a.message})}finally{xe(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");xe(t,!0,"Rebuilding…","Rebuild Site");try{const a=await Ua("rebuild");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await ne("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Rebuild requested from admin UI"});const r=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🔄 Rebuild triggered successfully."),await ne("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted rebuild request"}),setTimeout(()=>ot(),400);else{const n=`Rebuild webhook error: ${r.status}`;u(n,"error"),await ne("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:n})}}catch(a){u("Rebuild failed: "+a.message,"error"),await ne("failed",{mode:"rebuild",errorMessage:a.message})}finally{xe(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");xe(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){u("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){u("Publish failed: "+a.message,"error")}finally{xe(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:i,error:o}=await p.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(o)return Y(o)?u("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load listings to reindex: "+o.message,"error");const r=i||[];if(!r.length){u("No listings to reindex.");return}let n=0,l=0,c=!1;const d=40;for(let m=0;m<r.length;m+=d){const h=r.slice(m,m+d),{error:g}=await p.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",h.map(f=>f.id));g?(Y(g)&&(c=!0),l+=h.length):n+=h.length,t&&(t.textContent=`Reindexing… ${Math.min(m+d,r.length)}/${r.length}`)}if(c){u(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${n}/${r.length} done)`,"error");return}u(`Search index rebuilt for ${n} listing${n!==1?"s":""}${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){u("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(X)||!X.length){u("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:i,error:o}=await p.from("showroom_listings").select("property_id");if(o)return Y(o)?u("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load existing listings: "+o.message,"error");const r=new Set((i||[]).map(h=>h.property_id)),n=X.filter(h=>h&&h.property_id&&!r.has(h.property_id));if(!n.length){u("Showroom already in sync — no new listings to add.");return}let l=0,c=0,d=!1;const m=20;for(let h=0;h<n.length;h+=m){const g=n.slice(h,h+m).map(b=>({property_id:b.property_id,listing_type:b.listing_type||"product",category:b.category||null,subcategory:b.subcategory||null,title:b.title||"Untitled Listing",description:b.description||"",price:parseFloat(b.price)||0,currency:b.currency||"USD",country:b.country||"",country_code:b.country_code||"",state:b.state||"",city:b.city||"",town:b.town||"",product_location:b.product_location||"",latitude:b.latitude??null,longitude:b.longitude??null,property_type:b.property_type||null,listing_status:b.listing_status||"sale",bedrooms:b.bedrooms??null,bathrooms:b.bathrooms??null,building_size:b.building_size||"",land_size:b.land_size||"",parking_spaces:b.parking_spaces??null,furnished:b.furnished||"",features:Array.isArray(b.features)?b.features:[],tags:Array.isArray(b.tags)?b.tags:[],highlights:Array.isArray(b.highlights)?b.highlights:[],seo_keywords:Array.isArray(b.seo_keywords)?b.seo_keywords:[],images:Array.isArray(b.images)?b.images:[],brand:b.brand||null,color:b.color||null,size:b.size||null,condition:b.condition||null,warranty:b.warranty||null,availability_status:b.availability_status||"In Stock",stock_quantity:b.stock_quantity!=null?parseInt(b.stock_quantity,10):null,is_active:b.is_active!==!1,is_featured:!!b.is_featured,is_ai_generated:!!b.is_ai_generated,ai_generated_fields:Array.isArray(b.ai_generated_fields)?b.ai_generated_fields:[],specifications:b.specifications||{},created_at:b.created_at||new Date().toISOString()})),{error:f}=await p.from("showroom_listings").insert(g);f?(Y(f)&&(d=!0),c+=g.length):l+=g.length,t&&(t.textContent=`Syncing… ${Math.min(h+m,n.length)}/${n.length}`)}if(d){u(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${l}/${n.length} added)`,"error");return}u(`Showroom synced: ${l} new listing${l!==1?"s":""} added to the database${c?` (${c} failed)`:""}.`,c?"error":"success")}catch(i){u("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){u("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();u(`✓ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?u("Repository not found. Check username and repo name.","error"):u("GitHub API error: "+a.status,"error")}catch{u("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ja=30,O={category:null,page:0,query:""};async function Pe(){const e=document.getElementById("content");if(!e)return;await $t();const t=new Set(Ve()),a=Za();O.category||(O.category=a[0]?.slug||null);const i=0,o=O.query.trim().toLowerCase(),r=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(g=>`<button onclick="catalogSetCategory('${g.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${O.category===g.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${s(g.name)}</button>`).join("")}
    </div>`,l=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${s(O.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl border ${f?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${s(g.property_id)} · ${s(g.subcategory||g.category||"")} · ${la(g.price,"USD")}</p>
            </div>
            ${z(!f)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',m=o?1:Math.max(1,Math.ceil(i/ja)),h=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${o?`${c.length} match`:`${i.toLocaleString()} items in ${s("")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
        <button onclick="catalogPage(-1)" ${O.page<=0?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Prev</button>
        <span class="text-xs text-gray-500">Page ${O.page+1} / ${m}</span>
        <button onclick="catalogPage(1)" ${O.page>=m-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${r}
      ...
      ${h}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){O.category=e,O.page=0,O.query="",Pe()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");O.query=e?e.value:"",O.page=0,Pe()};window.catalogPage=function(e){const a=O.query.trim()?1:Math.max(1,Math.ceil(0/ja));O.page=Math.max(0,Math.min(a-1,O.page+e)),Pe()};window.catalogToggle=async function(e){const t=!Ve().includes(e),a=await ea(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),Pe()};window.catalogResetHidden=async function(){await oi(),u("All hidden catalog listings restored"),Pe()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Wt(){window.lucide&&lucide.createIcons(),da(),await wi(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){E.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wt):Wt();
