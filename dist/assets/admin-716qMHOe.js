import{_ as si,s as b,a as ae,i as ca,D as li}from"./supabase-client-DvCmNkpI.js";import{a as di,g as ci,C as Ee,A as ui}from"./localization-CErl0dkC.js";import{patchLocalShowroomListing as pi,getLocalShowroomListingById as Tt,removeLocalShowroomListing as mi,upsertLocalShowroomListing as gt,listLocalShowroomListings as Qe}from"./local-showroom-store-mzP0nSoS.js";import{g as ua,s as gi,l as bi,a as yi,b as fi}from"./payment-settings-GaRYfsr3.js";import{P as pa,a as ma,T as ga,M as ba}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as hi}from"./catalog-qysuyAKK.js";import{i as vi}from"./app-promo-banner-VTpzwpvR.js";import{M as xi,n as wi,a as _i}from"./categories-BEuiwWw5.js";import{saveCatalogHidden as ya,loadHiddenCatalogIds as Lt,getHiddenCatalogIds as Xe,resetHiddenCatalogIds as ki}from"./catalog-hidden-store-BAMgfUuU.js";const U=1,Q=5e6,Si=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],$i=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],fa=[...Si,...$i];function Bt(e){return di[e]||"USD"}function ha(e,t){return fa.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Ei(e,t){const a=Math.max(U,Math.min(Q,Number(e)||U));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Pi(e,t,a,i,n){const o=Ei(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function va({templateId:e,listingType:t,category:a,countryCode:i,currency:n,price:o}){const r=fa.find(m=>m.id===e&&m.listingType===t);if(!r)return null;const s=ci(i)||Ee[0],u=n||Bt(s.code),d=[s.name].filter(Boolean).join(", "),c={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${s.name}`:r.label,description:Pi(r,s,u,o,d),currency:u,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[s.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...c,country:s.name,country_code:s.code,product_location:s.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...c,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}let pt=null;async function Ai(){return pt||(pt=si(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),pt}function Ii(e,t){return e.toDataURL("image/jpeg",t)}async function Ci(e,t){const a=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,t/Math.max(a.width,a.height))),n=e.getViewport({scale:i}),o=document.createElement("canvas");o.width=Math.max(1,Math.round(n.width)),o.height=Math.max(1,Math.round(n.height));const r=o.getContext("2d",{alpha:!1});return r.fillStyle="#ffffff",r.fillRect(0,0,o.width,o.height),await e.render({canvasContext:r,viewport:n}).promise,Ii(o,.78)}async function Ti(e,{maxDim:t=1300,maxPages:a=0,onProgress:i=()=>{}}={}){const o=await(await Ai()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,r=o.numPages,s=a>0?Math.min(r,a):r,u=[];try{for(let d=1;d<=s;d++){i(d,s);const c=await o.getPage(d);u.push(await Ci(c,t))}}finally{try{await o.destroy()}catch{}}return u}function Ze(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const xa="weverseonlineshop@gmail.com",wa="Weverse Online Shop",_a="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",Li="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),Bi=`${Li}/functions/v1/ai-admin-assistant`,Mi=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Ni={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},ka=[...ui].sort();let C={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Sa(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function ie(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function be(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function et(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Ri=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents"];function ke(e){const t={};if(!e||typeof e!="object")return t;for(const a of Ri)a in e&&(t[a]=e[a]);return t}function p(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),n=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",o[t]||"info"),n.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function X(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"â€”"];return`<span class="badge ${a}">${i}</span>`}function ne(){document.getElementById("modal-container").innerHTML=""}function Y(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function K(e,t,a,i,n=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){C.section=e;const t=Ni[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),$a(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Pe()),window.lucide&&lucide.createIcons(),({dashboard:Qi,products:O,properties:ot,catalog:Ce,orders:za,customers:Pn,reviews:De,messages:Wa,coupons:rt,ads:Ie,notifications:Cn,ai:Fi,"ai-settings":Qa,"homepage-branding":dt,"promo-bg":Ne,content:Fn,"content-settings":ei,seo:Vn,email:zn,analytics:Gn,security:lt,activity:Wn,brand:ct,"payment-settings":Ct,backup:Kn,settings:Yn,publish:ut}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=ye("construction","Coming Soon",`${t} is being built.`))}))()};async function Fi(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const _e="kco_admin_remember",Mt="kco_login_attempts",bt=5,Di=15*60*1e3;function V(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Ui(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function tt(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Re(e){return String(e||"").trim().toLowerCase()}function Oi(){try{const e=JSON.parse(localStorage.getItem(_e)||"{}");e?.email&&!Re(e.email)&&localStorage.removeItem(_e)}catch{localStorage.removeItem(_e)}}function ji(){try{const e=JSON.parse(localStorage.getItem(_e)||"{}");return Re(e?.email)}catch{return""}}function Nt(){Oi();const e=ji(),t=document.getElementById("login-email");t&&(t.value=e||t.value||xa,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function qi(){return`${window.location.origin}/admin.html`}function he(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),tt(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function q(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Ea(){try{return JSON.parse(localStorage.getItem(Mt)||'{"count":0}')}catch{return{count:0}}}function Pa(){const e=Ea();return e.count=(e.count||0)+1,e.count>=bt&&(e.lockedUntil=Date.now()+Di),localStorage.setItem(Mt,JSON.stringify(e)),e}function Aa(){localStorage.removeItem(Mt)}function Ia(){const e=Ea();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Aa(),null):Math.ceil(t/6e4)}async function le(e,t,a={}){try{await b.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Hi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Hi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Ca(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await b.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Re(e.email)===xa}async function Gi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Ge(),Ji();return}const{data:{session:t}}=await b.auth.getSession();if(t?.user&&await Ca(t.user)){const{data:{currentUser:i}}=await b.auth.getUser(),n=await b.auth.mfa.getAuthenticatorAssuranceLevel(),o=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&o!=="aal2"){C.user=t.user,Ge(),he("2fa"),Rt();return}C.user=t.user,at();return}Vi()}function Ge(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Vi(){Ge(),he("login"),Nt(),Ta(),La(),Rt(),zi();const e=Ia();e&&(V(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function zi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Ta(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Wi),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>he("forgot")))}async function Wi(e){e.preventDefault();const t=Ia();if(t){V(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Re(a?.value);if(!i){V("Enter your admin email address."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;q("login-btn",!0),tt();const{data:r,error:s}=await b.auth.signInWithPassword({email:i,password:n});if(s||!r.user){const f=String(s?.message||"").toLowerCase();if(f.includes("missing supabase credentials")||f.includes("authentication service is unavailable")){V("Authentication is temporarily unavailable due to configuration. Please contact support."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("failed to fetch")||f.includes("network request failed")){V("Network error while signing in. Check your connection and try again."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("email not confirmed")){V("Your admin email is not confirmed yet. Open your verification email and confirm first."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const y=Pa(),g=bt-y.count,h=y.lockedUntil?`Account locked for 15 minutes after ${bt} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;V(h),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await le(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Ca(r.user)){await b.auth.signOut(),V(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await le(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(_e,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(_e),Aa(),C.user=r.user,(await b.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),he("2fa"),Rt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await le(r.user.id,"login_success"),q("login-btn",!1),at()}function Rt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Zt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&Zt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await b.auth.signOut(),C.user=null,he("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Ki))}async function Zt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){V("Enter the 6-digit code from your authenticator app.");return}q("verify-2fa-btn",!0),tt();try{const{data:t}=await b.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){V("No 2FA factor found. Please re-login."),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await b.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:o}=await b.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await le(C.user.id,"login_2fa_success"),q("verify-2fa-btn",!1),at()}catch(t){Pa(),V(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Ki(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){V("Enter a backup recovery code.");return}q("verify-backup-btn",!0);try{const{data:t}=await b.from("admin_2fa").select("backup_codes").eq("user_id",C.user.id).maybeSingle();if(!t?.backup_codes?.length){V("No backup codes found."),q("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){V("Backup code not found or already used."),q("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await b.from("admin_2fa").update({backup_codes:i}).eq("user_id",C.user.id),await le(C.user.id,"login_backup_code_used"),at()}catch(t){V(t.message),q("verify-backup-btn",!1,"Use Backup Code")}}function La(){document.getElementById("back-to-login")?.addEventListener("click",()=>he("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Yi)}async function Yi(){const e=document.getElementById("reset-email"),t=Re(e?.value);if(!t){V("Enter your admin email address to receive a reset link.");return}q("send-reset-btn",!0),tt();const{error:a}=await b.auth.resetPasswordForEmail(t,{redirectTo:qi()});if(q("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){V(a.message);return}Ui("Reset link sent! Check your inbox and open it from this device to continue.")}function Ji(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await b.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}p("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function at(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&C.user&&(t.textContent=C.user.email||"Admin"),Nt(),navigate("dashboard")}window.adminSignOut=async function(){C.user&&await le(C.user.id,"logout"),await b.auth.signOut(),C.user=null,Ge(),he("login"),Nt(),Ta(),La()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(C.user&&await le(C.user.id,"logout_all_devices"),await b.auth.signOut({scope:"global"}),C.user=null,p("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Qi(){const e=document.getElementById("content");try{const[t,a,i,n]=await Promise.all([b.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),b.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),b.from("profiles").select("user_id,created_at",{count:"exact"}),b.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=t.data||[],r=a.data||[],s=r.filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,w)=>x+(parseFloat(w.amount)||0),0),u=r.filter(x=>["pending","pending_verification","processing"].includes(x.status)).length,d=o.filter(x=>x.listing_type!=="property").length,c=o.filter(x=>x.listing_type==="property").length,m=o.filter(x=>x.listing_type!=="property"&&x.is_active).length,f=i.count||0,y=n.count||0,g=(n.data||[]).filter(x=>!x.is_approved).length,h=new Date,_=r.filter(x=>{const w=new Date(x.created_at);return w.getMonth()===h.getMonth()&&w.getFullYear()===h.getFullYear()}).filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,w)=>x+(parseFloat(w.amount)||0),0),S=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${an()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${K("Total Revenue",`$${s.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${_.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${K("Total Orders",r.length,"shopping-bag","blue",`${u} pending`)}
          ${K("Customers",f,"users","violet")}
          ${K("Products",d,"package","amber",`${m} active`)}
          ${K("Properties",c,"home","blue")}
          ${K("Reviews",y,"star","blue",`${g} pending`)}
        </div>
            ...
            ${S.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':S.map(x=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${be(x.created_at)}</p>
                  </div>
      ...
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${K("Inventory Units",n.reduce((d,c)=>d+(parseInt(c.stock_quantity,10)||0),0),"boxes","blue")}
          ${K("Avg Price",`$${Math.round(n.reduce((d,c)=>d+(parseFloat(c.price)||0),0)/Math.max(n.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,Ba(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function ce(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function yt(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Xi(e){const t=ce(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Zi(e){const t=ce(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function Ft(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function ft(e){return parseInt(e.views??e.view_count??0,10)||0}function ht(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Dt(e){return e.sku||e.property_id||"N/A"}function en(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=yt(e),i=Ft(e),n=window._productSelection?.has(e.property_id),o=X(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=ie(e.created_at),s=!!e.is_featured,u=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",c=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${s?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${l(Xi(e))}</p></div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!a)return p("Product not found","error");const i=Array.isArray(a.images)?a.images:[];Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Ut(),Ot(),Ae(),xe(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb")].map(c=>c.dataset.url||(c.querySelector("img")?c.querySelector("img").getAttribute("src"):"")).filter(c=>c&&!String(c).startsWith("blob:")),n={title:a.get("title")||"Untitled Product",price:Math.max(U,Math.min(Q,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},o=String(a.get("real_price")||"").trim(),r=o===""?null:parseFloat(o);if(r!=null&&!Number.isFinite(r)){p("Real Price must be a number.","error");return}const s=ke((window._productsData||[]).find(c=>c.property_id===t)),u=s.specifications&&typeof s.specifications=="object"?s.specifications:{};n.specifications={...u,real_price:r!=null&&r>0?Math.round(r):null};const{error:d}=await b.from("showroom_listings").upsert({...s,...n,property_id:t},{onConflict:"property_id"});if(d){if(Z(d)){p("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),ne(),O();return}pi(t,n),p("Quick edit saved locally","info")}else p(n.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");ne(),O()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),p("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||Tt(e),{error:a}=await b.from("showroom_listings").delete().eq("property_id",e);if(a&&!Z(a))return p("Delete failed: "+a.message,"error");mi(e);try{const i=await ya(e,!0);i&&i.error&&Z(i.error)?p("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Product deleted")}catch{p("Product deleted")}t&&t.listing_type==="property"?ot():O()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await b.from("showroom_listings").delete().neq("property_id","__none__");if(t)return Z(t)?p("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}p("All products deleted. The manager now shows your showroom catalog."),O()};window.openProductMoreActions=function(e){Y(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Da(n)}</select></div>
            </div>
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,s=e.dataset.category||"Product",u=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`)};function dn(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Me(e,t),n=document.getElementById("product-autosave-note");if(!t)try{const u=localStorage.getItem(i);if(u){const d=JSON.parse(u);ln(a,d)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(sn(a))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}St()};let r;const s=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(u=>{u.addEventListener("input",s),u.addEventListener("change",s)}),St(),xe()}const cn=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],un=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],pn=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],mn=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],gn=["FWD","RWD","AWD","4WD"],mt=["title","description","brand","model","model_year","color","condition","subcategory","engine","transmission","fuel_type","drive_type","horsepower","mileage","seating_capacity","doors","body_type","safety_features","storage","ram","processor","display","graphics","os","material","size","gender","platform","voltage","type","dimensions","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","country_code","latitude","longitude","listing_status","interior_features","exterior_features","home_systems","author","publisher","language","format","isbn","pages","edition","quantity","age_range","skin_type","ingredients","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","warranty","availability_status"],ze=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function ta(e){const t=e.id?`label[for="${e.id}"]`:null,a=t?document.querySelector(t):null;if(a)return a.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function bn(e){const t=typeof e=="string"?document.querySelector(e):e;if(!t)return[];const a=new Set,i=[];return t.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const o=String(n.name||"");if(!o||o==="images"||a.has(o)||["hidden","file","submit","button"].includes(n.type))return;if(a.add(o),n.type==="checkbox"){const s=[...t.querySelectorAll(`input[name="${o}"]`)];i.push({key:o,label:ta(n),type:"checkbox-group",options:s.map(u=>u.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const r=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:o,label:ta(n),type:r,options:n.tagName==="SELECT"?[...n.options].map(s=>s.value).filter(Boolean):null,required:!!n.required})}),i}function yn(e){return!e||!e.length?"":`
...
`)}
`}const Oa=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function aa(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(c=>String(c)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(c=>String(c)):[]),o=[],r=[],s=c=>{if(c==null)return"";Array.isArray(c)&&(c=c.filter(f=>f!=null&&String(f).trim()!=="").join(", "));let m=String(c).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},u=c=>{const m=s(c).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),f=parseFloat(m);return Number.isFinite(f)?f:NaN};for(const c of e||[]){if(ze.has(c.key))continue;const m={key:c.key,label:c.label,status:"empty-ok",value:null,note:""};if(c.type==="checkbox-group"){const g=Array.isArray(a[c.key])?a[c.key].map(s).filter(Boolean):[],h=c.options&&c.options.length?g.filter(k=>c.options.includes(k)):g;h.length?(a[c.key]=h,m.status="filled",m.value=h.join(", ")):(delete a[c.key],g.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",r.push(`${c.label}: invalid selection ignored`))),o.push(m);continue}if(!(a[c.key]!=null&&s(a[c.key])!=="")){m.status=n.has(c.key)?"missing":"empty-ok",o.push(m);continue}if(Oa.test(s(a[c.key]))){delete a[c.key],n.add(c.key),m.status="missing",m.note="document/AI said the value is unavailable",o.push(m);continue}if(c.type==="number"){const g=s(a[c.key]),h=u(a[c.key]);if(!Number.isFinite(h)){delete a[c.key],n.add(c.key),m.status="flagged",m.note=`"${g}" is not a valid number`,r.push(`${c.label}: not a valid number`),o.push(m);continue}if(/year/.test(c.key)&&(h<1800||h>new Date().getFullYear()+2)){delete a[c.key],n.add(c.key),m.status="flagged",m.note=`${h} is outside the plausible range`,r.push(`${c.label}: implausible value ${h}`),o.push(m);continue}a[c.key]=h,m.status="filled",m.value=String(h),i.has(c.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m);continue}if(c.type==="select"&&c.options&&c.options.length){const g=ja({options:c.options.map(h=>({value:h}))},s(a[c.key]));if(g==null){m.status="flagged",m.note=`"${s(a[c.key])}" does not match any option â€” left empty`,r.push(`${c.label}: no matching option`),delete a[c.key],n.add(c.key),o.push(m);continue}a[c.key]=g,m.status="filled",m.value=g,g!==s(t?.[c.key])&&(m.note="matched to the closest option"),o.push(m);continue}let y=s(a[c.key]);c.type!=="textarea"&&c.type!=="text-long"&&y.length>120&&!["title"].includes(c.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",r.push(`${c.label}: suspiciously long value`)),a[c.key]=y,m.status="filled",m.value=y.length>48?y.slice(0,48)+"â€¦":y,i.has(c.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m)}if(e&&e.length){const c=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(m=>{c.has(m)||delete a[m]})}a.missing_fields=o.filter(c=>c.status==="missing").map(c=>c.key),a.estimated=o.filter(c=>c.status==="estimated").map(c=>c.key);const d={total:o.length,filled:o.filter(c=>c.status==="filled").length,estimated:o.filter(c=>c.status==="estimated").length,flagged:o.filter(c=>c.status==="flagged").length,missing:o.filter(c=>c.status==="missing").length};return{specs:a,checklist:o,flags:r,summary:d}}function qt(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[o.status]||""}</span><span><b>${l(o.label)}</b> <span class="text-gray-600">(${l(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${l(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${l(o.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){const e=document.getElementById(ee);if(e){if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!z.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed â€” nothing was changed.";return}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
      ...
      ${z.map((t,a)=>xn(t,a)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=z[e];if(!t)return;const a=Ht(t,fe),i=nt(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(ee==="s1-scan-status"||ee==="scanner-scan-status")&&(ne(),me=[]),wn(t,a);return}const o=i.category||t.category||"Other";if(ee==="s1-scan-status"||ee==="scanner-scan-status"){try{localStorage.removeItem(Me(o,""))}catch{}me=[];let r=t.property_id?Se[t.property_id]:null;r&&r.specifications&&typeof r.specifications=="object"&&(r={...r,...r.specifications}),showAddProductStep2(o,r?{...r,images:a}:{images:a}),await na(t,a,o)}else{const r=document.getElementById("product-form"),s=r&&r.dataset.category||"";if(o!==s){try{localStorage.removeItem(Me(o,""))}catch{}switchProductFormCategory(o);const u=document.getElementById(ee);u&&(u.classList.remove("hidden"),u.classList.add("text-blue-300"),u.textContent=`Category changed to ${o} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await na(t,a,o)}};window.scanReviewEdit=function(e){const t=z[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=nt(t.category),o=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",r=pe.map(s=>`<option value="${l(s)}" ${s===o?"selected":""}>${l(s)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=z[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,n=document.getElementById(`sr-model-${e}`)?.value,o=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),n&&(t.model=n),o&&(t.category=o),scanReviewRender()};window.scanReviewRemove=function(e){z.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(ee);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled â€” nothing was changed.")};window.scanReviewContinueAll=async function(){const e=document.getElementById(ee),t=(d,c)=>{e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400","text-gray-100"),c&&e.classList.add(c),e.innerHTML=d,window.lucide&&lucide.createIcons())};if(!z.length)return;const a=document.getElementById("btn-scan-continue-all");a&&(a.disabled=!0,a.textContent="Saving everythingâ€¦");const i=z.length;let n=0,o=0,r=0;const s=[];for(let d=0;d<i;d++){const c=z[d];if(!c)continue;const m=nt(c.category);if(c.listing_type==="property"||m&&m.listing_type==="property"){s.push(d);continue}const y=m.category||c.category||"Other",g=Ht(c,fe);t(`<p class="flex items-center gap-2"><i data-lucide="loader" class="w-4 h-4 animate-spin text-blue-300"></i> Completing ${d+1} of ${i}: <b>${l(c.detected_name||"product")}</b>â€¦</p>`,"text-blue-300");try{const h=await D.completeSpecsAndPrice(g,c,{category:y,maxImages:ge.maxImages}).catch(()=>null);let k=h&&h.specs||{},_=h?h.price:null;try{const B=await D.verifyExtraction(g,c,k,[],{maxImages:ge.maxImages});if(B&&B.corrections&&typeof B.corrections=="object"){for(const[G,$]of Object.entries(B.corrections))$==null||String(Array.isArray($)?$.join(", "):$).trim()===""||mt.includes(G)&&(k[G]=$);for(const[G,$]of Array.isArray(B.wrong_mapping)?B.wrong_mapping:[])mt.includes($)&&k[G]!=null&&(k[$]==null||String(k[$]).trim()==="")&&(k[$]=k[G],delete k[G])}}catch{}const S={};for(const[B,G]of Object.entries(k)){if(!mt.includes(B)||ze.has(B))continue;const $=Array.isArray(G)?G.map(re=>String(re??"").replace(/\s+/g," ").trim()).filter(Boolean):String(G??"").replace(/\s+/g," ").trim();if(!(!$.length||(Array.isArray($)?$.join(" "):$).match(Oa))){if(/^(model_)?year/.test(B)){const re=parseInt($,10);if(!Number.isFinite(re)||re<1800||re>new Date().getFullYear()+2)continue}S[B]=$}}k=S;const x=k||{},w=c.property_id&&Se[c.property_id]||null,v=w?w.specifications&&typeof w.specifications=="object"?{...w,...w.specifications}:w:null,N=[c.year||x.year,c.brand||x.brand,c.model||x.model].filter(Boolean).join(" ")||c.detected_name||"Product",j=_?Number(_.estimated_price??_.price??_.estimate):NaN;let H=Number.isFinite(j)&&j>0?j:v?Number(v.price):NaN;(!Number.isFinite(H)||H<=0)&&(H=U),H=Math.max(U,Math.min(Q,H));const F=new Set(["title","description","brand","color","size","condition","warranty","availability_status"]),E={};for(const[B,G]of Object.entries({...Object.fromEntries($t.filter($=>$!=="year_estimated"&&$!=="listing_status").map($=>[$,c[$]??null])),...x})){if(F.has(B)||ze.has(B))continue;const $=Array.isArray(G)?G.filter(re=>re!=null&&String(re).trim()!==""):G;$==null||typeof $=="string"&&!$.trim()||(E[B]=$)}const T={...v&&v.specifications&&typeof v.specifications=="object"?v.specifications:{},...E},P={listing_type:"product",category:y,subcategory:v?.subcategory||x.subcategory||null,title:x.title||v&&v.title||N,description:x.description||v&&v.description||"",price:H,currency:v&&v.currency||"USD",country:v&&v.country||"",country_code:v&&v.country_code||"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:!0,is_featured:!!(v&&v.is_featured),brand:c.brand||x.brand||v&&v.brand||null,color:x.color||v&&v.color||null,size:x.size||v&&v.size||null,condition:v&&v.condition||null,warranty:v&&v.warranty||null,availability_status:v&&v.availability_status||"In Stock",stock_quantity:v&&v.stock_quantity?parseInt(v.stock_quantity):null,images:g.length?g:v&&v.images||[],features:Array.isArray(x.features)&&x.features.length?x.features:v&&v.features||[],tags:Array.isArray(x.tags)&&x.tags.length?x.tags:v&&v.tags||[],highlights:Array.isArray(x.highlights)&&x.highlights.length?x.highlights:v&&v.highlights||[],seo_keywords:Array.isArray(x.seo_keywords)&&x.seo_keywords.length?x.seo_keywords:v&&v.seo_keywords||[],is_ai_generated:!0,ai_generated_fields:["title","description","specifications","price"],specifications:T,updated_at:new Date().toISOString()};if(v&&v.property_id){P.property_id=v.property_id;const{error:B}=await b.from("showroom_listings").upsert(P,{onConflict:"property_id"});if(B)throw B;o++}else{P.property_id=et();const{error:B}=await b.from("showroom_listings").insert(P);if(B)throw B;n++}}catch(h){r++,t(`<p class="text-amber-300">Could not save "${l(c.detected_name||"product")}": ${l(String(h?.message||h))} â€” continuing with the restâ€¦</p>`,"text-amber-300")}}z=z.filter((d,c)=>s.includes(c));const u=`${o} updated, ${n} new${r?`, ${r} failed`:""}`;if(!z.length)Se={},fe=[],t(`<div class="space-y-1">
    ...
    </div>`,"text-emerald-300"),p(`All done â€” ${u} saved & published.`,"success");else{scanReviewRender();const d=document.getElementById(ee);if(d){const c=document.createElement("p");c.className="text-xs font-bold text-emerald-300",c.textContent=`Saved & published: ${u}. Property cards below still need Continue.`,d.prepend(c)}p(`Saved ${u}.`,r?"info":"success")}O()};function Ha(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,n=[],o=A=>Array.isArray(A)?A.join(", "):String(A??"").trim(),r=(A,M)=>{if(M==null||o([M])==="")return;const J=document.querySelector(`#property-form [name="${A}"]`);J&&(J.value=String(M),n.push(A))},s=t.property_type||a.property_type;if(s){const A=vn(s);A&&r("property_type",A)}r("title",a.title||t.detected_name),r("description",a.description),r("subcategory",t.subcategory||a.subcategory);const u=t.bedrooms??a.bedrooms;u!=null&&u!==""&&r("bedrooms",parseInt(u,10)||u);const d=t.bathrooms??a.bathrooms;d!=null&&d!==""&&r("bathrooms",parseInt(d,10)||d),r("building_size",t.building_size||a.building_size),r("land_size",t.land_size||a.land_size);const c=t.parking_spaces??a.parking_spaces;c!=null&&c!==""&&r("parking_spaces",parseInt(c,10)||c);const m=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(m)?r("furnished","Furnished"):/unfurnished|no|empty/.test(m)&&r("furnished","Unfurnished");const f=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(f)?r("listing_status","rent"):/sale|buy|purchase/.test(f)&&r("listing_status","sale");const y=t.area||a.area;y&&!(t.town||a.town)&&r("town",y),r("town",t.town||a.town),r("city",t.city||a.city),r("state",t.state||a.state);const g=t.country||a.country;if(r("country",g),g){const A=(Ee||[]).find(M=>String(M.name||"").toLowerCase()===String(g).toLowerCase()||String(M.code||"").toLowerCase()===String(g).toLowerCase());if(A&&A.code){const M=document.querySelector('#property-form [name="country_code"]');M&&(M.value=A.code,n.push("country_code"))}}const h=t.address||a.address;r("product_location",h||[y||t.town||a.town,t.city||a.city,t.state||a.state,g].filter(Boolean).join(", ")),r("address",t.address||a.address),r("zip_code",t.zip_code||a.zip_code);const k=Number(t.latitude??a.latitude),_=Number(t.longitude??a.longitude);Number.isFinite(k)&&k>=-90&&k<=90&&k!==0&&r("latitude",String(k)),Number.isFinite(_)&&_>=-180&&_<=180&&_!==0&&r("longitude",String(_)),r("features_text",o(a.features)),r("highlights_text",o(t.highlights||a.highlights)),r("seo_keywords_text",o(a.seo_keywords));const S=t.half_bathrooms??a.half_bathrooms;S!=null&&S!==""&&r("half_bathrooms",parseInt(S,10)||S);const x=t.floors??a.floors;x!=null&&x!==""&&r("floors",parseInt(x,10)||x),r("garage",t.garage||a.garage);const w=t.year_built??a.year_built;w!=null&&w!==""&&r("year_built",parseInt(w,10)||w);const v=t.year_renovated??a.year_renovated;v!=null&&v!==""&&r("year_renovated",parseInt(v,10)||v);const N=t.condition||a.condition,j=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(N){const A=String(N).toLowerCase(),M=j.find(J=>A.includes(J.toLowerCase())||J.toLowerCase().includes(A));M&&r("condition",M)}r("interior_features_text",o(a.interior_features)),r("exterior_features_text",o(a.exterior_features)),r("home_systems_text",o(a.home_systems));const H=o(t.landmarks||a.landmarks);H&&r("landmarks_text",H);const F=a.floor_plan;if(F&&typeof F=="object"){F.image&&r("floor_plan_image",F.image),F.levels&&r("floor_plan_levels",F.levels),F.total_area&&r("floor_plan_total_area",F.total_area);const A=Array.isArray(F.rooms)?F.rooms.map(M=>{const J=String(M).match(/^(.*?):\s*(.*)$/);return J?`${J[1].trim()}: ${J[2].trim()}`:String(M)}):[];A.length&&r("floor_plan_rooms",A.join(", "))}const E=a.nearby_area;E&&typeof E=="object"&&(Array.isArray(E.schools)&&E.schools.length&&r("nearby_schools_text",E.schools.join(", ")),Array.isArray(E.hospitals)&&E.hospitals.length&&r("nearby_hospitals_text",E.hospitals.join(", ")),Array.isArray(E.shopping)&&E.shopping.length&&r("nearby_shopping_text",E.shopping.join(", ")),Array.isArray(E.transportation)&&E.transportation.length&&r("nearby_transportation_text",E.transportation.join(", ")),Array.isArray(E.distances)&&E.distances.length&&r("nearby_distances_text",E.distances.join(", ")));const T=Array.isArray(a.legal_info)?a.legal_info.join(", "):o(a.legal_info);T&&r("legal_info_text",T),a.inspection_info&&r("inspection_info",a.inspection_info),a.risk_notes&&r("risk_notes",a.risk_notes);const P=document.querySelector('#property-form [name="verification_status"]');P&&(P.value="Not verified",n.push("verification_status"));const B=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map(A=>String(A))),G=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);B.forEach(A=>{if(G.has(A))return;const M=document.querySelector(`#property-form [name="${A}"]`);if(!(!M||M.type==="checkbox"||M.type==="radio"||M.type==="number")&&String(M.value||"").trim()===""){if(M.tagName==="SELECT"&&![...M.options].some(J=>J.value==="Not specified")){const J=document.createElement("option");J.value="Not specified",J.textContent="Not specified",M.appendChild(J)}M.value="Not specified",n.push(`${A} (Not specified)`)}});const $=Number.isFinite(Number(U))?Number(U):0,re=Number.isFinite(Number(Q))?Number(Q):999999999,Jt=A=>Math.max($,Math.min(re,Math.round(A))),Te=i?Number(i.estimated_price):NaN,Oe=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(Te)&&Te>0){const A=document.querySelector('#property-form [name="real_price"]');A&&(A.value=String(Jt(Te)),n.push("real_price"));const M=Number.isFinite(Oe)&&Oe>0&&Oe<Te?Oe:Te;r("price",String(Jt(M)))}const Qt=String(a.title||t.detected_name||"Property").trim()||"Property",ri=a.description||`${Qt} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,Xt=qa("#property-form",{titleFallback:Qt,descriptionFallback:ri});return Xt&&n.push(`${Xt} auto-completed (Not specified / safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:n}}const $t=["brand","model","year","year_estimated","body_type","color","condition","subcategory","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","latitude","longitude","listing_status"];function Gt(){return Date.now()<(typeof D<"u"&&D._geminiQuotaUntil||0)?'<p class="text-[11px] text-amber-300 mt-1">⚠ Your Gemini key hit its FREE rate limit during this scan — parts were completed from saved details only. Wait ~1 minute and scan again for full AI reading.</p>':""}async function Vt({imageUrls:e,identification:t,category:a,formSelector:i}){const n=bn(i),o=yn(n),r=await D.completeSpecsAndPrice(e,t,{category:a||"",maxImages:ge.maxImages,fieldsSchema:o}),s=r?r.price:null,u=r&&r.specs||{};let d={};for(const g of $t)t&&t[g]!=null&&t[g]!==""&&(d[g]=t[g]);d={...d,...u};let c=aa(n,d),m=!1;const f=`${r&&r.specs&&r.specs._aiProvider||""} ${r&&r.specs&&r.specs._aiModel||""}`;if(!/pollinations|free ai/i.test(f))try{const g=await D.verifyExtraction(e,t,c.specs,n,{maxImages:ge.maxImages});if(g){const h=g.corrections&&typeof g.corrections=="object"?g.corrections:{},k=Object.keys(h);if(k.length){const _={...c.specs};for(const[S,x]of Object.entries(h))n.some(w=>w.key===S)&&(x==null||String(Array.isArray(x)?x.join(", "):x).trim()===""||(_[S]=x));for(const[S,x]of Array.isArray(g.wrong_mapping)?g.wrong_mapping:[])_[S]!=null&&(_[x]==null||String(_[x]).trim()==="")&&(_[x]=_[S],delete _[S]);c=aa(n,_),t={...t};for(const S of k)$t.includes(S)&&c.specs[S]!=null&&(t[S]=c.specs[S])}m=!0,c.verificationNotes=Array.isArray(g.notes)?g.notes.slice(0,4):[]}}catch{}return{specs:c.specs,price:s,checklist:c.checklist,summary:c.summary,verified:m,verificationNotes:c.verificationNotes||[],identification:t}}async function na(e,t,a){const i=document.getElementById("scan-ai-status"),n=(o,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=o)};try{n("Reading every image/page, completing all specifications and pricesâ€¦","text-blue-300");let o=e;const r=await Vt({imageUrls:t,identification:o,category:a,formSelector:"#product-form"});o=r.identification||o;const s=hn({identification:o,specs:r.specs,price:r.price}),u=[o.year,o.brand,o.model].filter(Boolean).join(" ")||o.detected_name||"the product";let d=`${l(u)} â€” ${s.filled.length} field${s.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;o.year_estimated&&(d+=" Confirm the model year before saving."),d+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>',r.summary.flagged&&(d+=`<p class="text-[11px] text-red-300 mt-1">${r.summary.flagged} value${r.summary.flagged>1?"s need":" needs"} your attention below.</p>`),d+=Gt(),d+=qt(r.checklist,r.summary),n(d,"text-emerald-300"),p(`Review ${u}, then press SAVE / UPDATE.`,"success")}catch(o){const r=String(o?.message||o),s=/key|api|configured|settings|vision/i.test(r);n(s?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),p("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){p("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(u=>u.value).filter(Boolean);if(!i.length){p("Upload at least one product image before scanning.","error");return}const n=t?t.innerHTML:"",o=(u,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=u)};try{const u=await D.getConfig();String(u.gemini_key||u.gemini_api_key||"").trim()||o("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),o("Detecting every distinct product in your imagesâ€¦","text-blue-300");let r;try{r=await D.detectProducts(i,{category:e.dataset.category||"",maxImages:ge.maxImages})}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),p("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);let s=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];s.length||(s=[{detected_name:"Product from your photos",category:e.dataset.category||"Other",listing_type:"product",confidence:"low",image_indices:i.map((u,d)=>d)}],o("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),z=s,fe=i,Se={},ee="scan-ai-status",scanReviewRender(),p(`${s.length} distinct product${s.length>1?"s":""} detected â€” review each one, then continue.`,"info")};function wn(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((r,s)=>ve(r,s)).join(""),i.innerHTML=t.map((r,s)=>`<input type="hidden" name="images" id="img-url-${s}" value="${l(r)}">`).join(""),Fe(),xe());const n=document.getElementById("scan-ai-prop-status"),o=(r,s)=>{n&&(n.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),s&&n.classList.add(s),n.innerHTML=r)};o("Reading every page, completing property details and valueâ€¦","text-blue-300"),(async()=>{try{const r=await Vt({imageUrls:t,identification:e,category:"Real Estate",formSelector:"#property-form"}),s=r.identification||e,u=Ha({identification:s,specs:r.specs,price:r.price});let d;r.price?d=`${l(s.detected_name||"Property")} â€” ${u.filled.length} field${u.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`:d=`${l(s.detected_name||"Property")} â€” ${u.filled.length} fields ready. Price estimate skipped â€” set the price manually, then press Publish Property.`,d+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>',d+=Gt(),d+=qt(r.checklist,r.summary),o(d,r.price?"text-emerald-300":"text-amber-300"),p("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}catch(r){const s=/key|api|configured|settings|vision/i.test(String(r?.message||r));o(s?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),p("AI scan failed.","error")}})()}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){p("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(u=>u.value).filter(Boolean);if(!i.length){p("Upload at least one property image before scanning.","error");return}const n=t?t.innerHTML:"",o=(u,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=u)};try{const u=await D.getConfig();String(u.gemini_key||u.gemini_api_key||"").trim()||o("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),o("Identifying this property from your imagesâ€¦","text-blue-300");let r;try{r=await D.identifyProduct(i,{category:"Real Estate",maxImages:ge.maxImages})}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),p("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}if(!r||r.identified===!1){o(r&&r.reason?`Could not identify the property: ${l(r.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),p("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);const s=await new Promise(u=>{We=f=>{We=null,u(f)};const d=document.getElementById("scan-ai-prop-status");if(!d){u({choice:"continue"});return}if(!window._propFormDirty){u({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const c=r.confidence||"medium",m={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[c]||"text-amber-400 border-amber-500/20";d.innerHTML=`
      ...
      </div>`});if(!s||s.choice==="cancel"){o("Scan cancelled â€” nothing was changed.","text-gray-400"),p("Scan cancelled.","info");return}try{o("Reading every page, completing property details and market valueâ€¦","text-blue-300");const u=await Vt({imageUrls:i,identification:r,category:"Real Estate",formSelector:"#property-form"}),d=u.identification||r,c=Ha({identification:d,specs:u.specs,price:u.price});let m=`${l(d.detected_name||"Property")} â€” ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`;m+=u.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>',m+=Gt(),m+=qt(u.checklist,u.summary),o(m,"text-emerald-300"),p("Review the property details, then press Publish Property.","success")}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),p("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let me=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await jt(a);i&&me.push(i)}catch{}Ga(),e.target.value=""}};window.removeStep1Image=function(e){me.splice(e,1),Ga()};function Ga(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=me.map((a,i)=>`
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`),window.lucide&&lucide.createIcons()};function oa(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await oa(Va(),15e3)}catch{e=[]}if(!e.length){p("No products with photos are in the Product Manager yet â€” add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",n=(w,v)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),v&&a.classList.add(v),a.innerHTML=w)};try{const w=await D.getConfig();String(w.gemini_key||w.gemini_api_key||"").trim()||n("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),n(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300");const o=[],r=[],s={};let u=0;const d=e.length,c=new Set;let m=0,f=0;window.__scanDupContinue=function(){const w=window.__scanDupResolve;window.__scanDupResolve=null;const v=document.getElementById("btn-scan-dup-continue");v&&(v.disabled=!0),w&&w()};const y=2,g=12e4;let h=0,k=0;const _=async w=>{const v=(w.images||[]).filter(Boolean);if(!v.length)return;const N=v.map(T=>String(T||"").trim()).filter(Boolean),j=N.length>0&&N.every(T=>c.has(T));for(const T of N)c.add(T);if(j){m++;return}const H=o.length;o.push(...v);const F=v.map((T,P)=>H+P);let E=[];try{const T=await oa(D.detectProducts(v,{category:w.category||"",maxImages:ge.maxImages}),g);E=T&&T.identified!==!1&&Array.isArray(T.products)?T.products:[]}catch{}E.length||(E=[{detected_name:w.title||w.property_id||"Product",category:w.category||"Other",listing_type:w.listing_type||"product",brand:w.brand||null,model:w.specifications&&w.specifications.model||w.model||null,confidence:"medium"}],f++),u++,s[w.property_id]=w;for(const T of E)r.push({...T,property_id:w.property_id,image_indices:Array.isArray(T.image_indices)&&T.image_indices.length?T.image_indices.map(P=>F[Number(P)]).filter(P=>P!==void 0):F,detected_name:T.detected_name||w.title||w.property_id,category:T.category||w.category||"Other",listing_type:T.listing_type||w.listing_type||"product"})},S=async()=>{for(;h<e.length;){const w=e[h++];n(`Scanning ${k+1} of ${d} product${d===1?"":"s"} (fast parallel mode)â€¦`,"text-blue-300"),await _(w),k++,k<d&&n(`Scanned ${k} of ${d} â€” continuingâ€¦`,"text-blue-300")}};if(await Promise.all(Array.from({length:Math.min(y,Math.max(1,e.length))},S)),t&&(t.disabled=!1,t.innerHTML=i),!r.length){n(`No product could be identified from the photos on your existing products${m?` (${m} duplicate product${m>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),p("No products could be scanned.","error");return}z=r,fe=o,Se=s,ee="scanner-scan-status",scanReviewRender();const x=Date.now()<(D._geminiQuotaUntil||0);p(`Scan complete â€” ${u} product${u>1?"s":""} scanned${m?`, ${m} duplicate product${m>1?"s":""} skipped`:""}${f?`, ${f} completed from saved details (AI could not read the photo â€” review ${f>1?"those":"it"} and edit as needed)`:""}${x?". Your Gemini key hit its FREE rate limit during the scan â€” wait about 1 minute, then continue for full AI reading.":""}. Press "Continue with ALL" to save & publish everything at once.`,"success")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";n&&(n.disabled=!0,n.textContent="Savingâ€¦");try{const r=new FormData(i),s={};let u=0;for(const[y,g]of r.entries())if(y==="images"){s.images=s.images||[];const h=String(g);g&&!h.startsWith("blob:")?s.images.push(h):h.startsWith("blob:")&&u++}else y==="tags"?(s.tags=s.tags||[],s.tags.push(g)):s[y]=g;if(u&&!(s.images||[]).length){n&&(n.disabled=!1,n.textContent=o),p("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}s.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",s.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",c=y=>xt(y),m=y=>{const g=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],h={};for(const k of g){const _=y[k];if(k==="real_price"){const S=_!=null&&String(_).trim()!==""?parseFloat(_):null;h[k]=S!=null&&Number.isFinite(S)&&S>0?Math.round(S):null;continue}h[k]=_!=null&&String(_).trim()!==""?_:null}if(y.safety_features){const k=c(y.safety_features);h.safety_features=k.length?k:null}return h};let f;if(a){let y=ke((window._productsData||[]).find(P=>P.property_id===a));if(!y){const{data:P}=await b.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();y=P?ke(P):null}if(!y)throw new Error("Could not load the current product. Refresh the page and try again.");const g=(P,B)=>{const G=P===""||P==null?"":P,$=B===""||B==null?"":B;return String(G).trim()===String($).trim()},h={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(P=>{g(s[P],y[P])||(h[P]=s[P]==null||s[P]===""?null:s[P])});const k=s.price===""||s.price==null?null:parseFloat(s.price);g(k,y.price)||(h.price=k==null?y.price:Math.max(U,Math.min(Q,k)));const _=s.stock_quantity===""||s.stock_quantity==null?null:parseInt(s.stock_quantity,10);g(_,y.stock_quantity)||(h.stock_quantity=Number.isFinite(_)?_:null);const S=c(s.features_text);g(S.join("||"),(Array.isArray(y.features)?y.features:[]).join("||"))||(h.features=S);const x=s.tags||[];g(x.join("||"),(Array.isArray(y.tags)?y.tags:[]).join("||"))||(h.tags=x);const w=c(s.highlights_text);g(w.join("||"),(Array.isArray(y.highlights)?y.highlights:[]).join("||"))||(h.highlights=w);const v=c(s.seo_keywords_text);g(v.join("||"),(Array.isArray(y.seo_keywords)?y.seo_keywords:[]).join("||"))||(h.seo_keywords=v);const N=s.images||[];g(N.join("||"),(Array.isArray(y.images)?y.images:[]).join("||"))||(h.images=N);const j=s.is_featured==="on";!!y.is_featured!==j&&(h.is_featured=j);const H=d?!1:s.is_active==="on";!!y.is_active!==H&&(h.is_active=H);const F=m(s),E={...y.specifications&&typeof y.specifications=="object"?y.specifications:{},...F};if(JSON.stringify(E)!==JSON.stringify(y.specifications||{})&&(h.specifications=E),Object.keys(h).length===0){p("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(Me(t,a))}catch{}n&&(n.disabled=!1,n.textContent=o);return}const T={...y,...h,property_id:a,updated_at:new Date().toISOString()};if({error:f}=await b.from("showroom_listings").upsert(T,{onConflict:"property_id"}),f&&vt(f,()=>gt(T),"Product update")){n&&(n.disabled=!1,n.textContent=o),ne(),O();return}p(d?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(h).length} change${Object.keys(h).length>1?"s":""}).`)}else{if(!s.title||!s.title.trim())throw new Error("A product title is required.");if(s.price===""||s.price==null||!isFinite(parseFloat(s.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!s.condition)throw new Error("Please choose the product condition.");const g={listing_type:"product",category:t,subcategory:s.subcategory||null,title:s.title.trim(),description:s.description||"",price:Math.max(U,Math.min(Q,parseFloat(s.price)||0)),currency:s.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:s.is_active==="on",is_featured:s.is_featured==="on",brand:s.brand||null,color:s.color||null,size:s.size||null,condition:s.condition||null,warranty:s.warranty||null,availability_status:s.availability_status||"In Stock",stock_quantity:s.stock_quantity?parseInt(s.stock_quantity):null,images:s.images||[],features:c(s.features_text).length?c(s.features_text):s.tags||[],tags:s.tags||[],highlights:c(s.highlights_text),seo_keywords:c(s.seo_keywords_text),is_ai_generated:!!s.catalog_template_id,ai_generated_fields:s.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(s)},h=et();if(g.property_id=h,{error:f}=await b.from("showroom_listings").insert(g),f&&vt(f,()=>gt({...g,property_id:g.property_id}),"Product publish")){n&&(n.disabled=!1,n.textContent=o),ne(),O();return}p(d?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}try{localStorage.removeItem(Me(t,a))}catch{}closeProductFormModal(),O()}catch(r){p("Error: "+r.message,"error"),n&&(n.disabled=!1,n.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Tt(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=ke((window._productsData||[]).find(n=>n.property_id===e)),{error:i}=await b.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return Z(i)?p(`âš ï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):p(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");p(t?"Product published":"Product unpublished"),O()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:o,updated_at:r,...s}=a,u=et();await b.from("showroom_listings").insert({...s,property_id:u,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),O())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await b.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),O())};const Et=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function ot(){const e=document.getElementById("content");try{const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Qe().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(ae)){const o=new Set(i.map(s=>s.property_id)),r=ae.filter(s=>s.listing_type==="property"&&s.property_id&&!o.has(s.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await Lt()}catch{}const n=new Set(Xe());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=ha("property","Real Estate"),i=e.country_code||"US",n=e.currency||Bt(i);Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${Da(n)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Et.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    </div>`),Ut(),Ot(),wt("ppf-price"),window._propFormDirty=!!t;const o=document.getElementById("property-form");if(o){const r=()=>{window._propFormDirty=!0};o.addEventListener("input",r),o.addEventListener("change",r)}window.syncPropertyCountry=function(){ea("ppf")},ea("ppf"),kt("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>kt("pricing")),Sn()};let te=null,He=null,ra=null;function _n(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function de(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Be(e,t,{reverse:a=!1}={}){if(!te||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];He?He.setLatLng(i):He=L.marker(i,{draggable:!0}).addTo(te),te.setView(i,Math.max(te.getZoom(),13));const n=document.querySelector('#property-form [name="latitude"]'),o=document.querySelector('#property-form [name="longitude"]');n&&(n.value=String(Number(e.toFixed(6)))),o&&(o.value=String(Number(t.toFixed(6)))),a&&kn(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Le(){const e=_n();if(!e){de("Enter a location (address, area, city, state, country), then press Locate from fields.");return}de("Searching locationâ€¦");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Be(parseFloat(a[0].lat),parseFloat(a[0].lon)),de("Located: "+a[0].display_name)):de("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{de("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function kn(e,t){const a=document.querySelector("#property-form");if(a)try{const n=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),o=n&&n.address||{},r=(y,g)=>{if(!g)return;const h=a.querySelector(`[name="${y}"]`);return h&&!String(h.value||"").trim()?(h.value=g,!0):!1},s=[o.road||"",o.house_number||""].filter(Boolean).join(" "),u=o.suburb||o.neighbourhood||o.quarter||o.district||o.borough||"",d=o.town||o.village||o.municipality||o.city_district||"",c=o.city||o.county||"",m=o.state||o.region||"",f=o.country||"";if(r("product_location",s||u||d),r("town",u||d),r("city",c),r("state",m),f){r("country",f);const y=a.querySelector('[name="country_code"]');if(y){const g=(Ee||[]).find(h=>String(h.name||"").toLowerCase()===String(f).toLowerCase());g&&g.code&&!y.value&&(y.value=g.code)}}de("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(n.display_name?" â€” "+n.display_name:""))}catch{de("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!te)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Be(e,t),de("Map updated from coordinates.")):Le()};function Sn(){const e=document.getElementById("property-map-preview");if(!e||!window.L){de("Map unavailable right now â€” your location fields still save normally.");return}te&&(te.remove(),te=null,He=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);te=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(te),te.on("click",n=>Be(n.latlng.lat,n.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Le),["product_location","town","city","state","country","latitude","longitude"].forEach(n=>{const o=document.querySelector(`#property-form [name="${n}"]`);o&&(o.addEventListener("input",()=>{if(n==="latitude"||n==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),s=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(s)&&(r||s)&&Be(r,s);return}clearTimeout(ra),ra=setTimeout(Le,900)}),o.addEventListener("change",()=>{n!=="latitude"&&n!=="longitude"&&Le()}))}),i?Be(t,a):Le()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(n=>{const o=parseFloat(n.latitude),r=parseFloat(n.longitude),s=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");return!(Number.isFinite(o)&&Number.isFinite(r)&&(o!==0||r!==0))&&!!s});if(!t.length){p("All properties already have map coordinates.","success");return}p(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}â€¦`,"success");let a=0,i=0;for(const n of t){const o=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");try{const s=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(o))).json();if(s&&s[0]){const u={latitude:parseFloat(s[0].lat),longitude:parseFloat(s[0].lon)},{error:d}=await b.from("showroom_listings").update(u).eq("property_id",n.property_id);d?i++:(Object.assign(n,u),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}p(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),ot()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n=a.getAll("images").filter(f=>f&&!f.startsWith("blob:")),o=(i.features_text||"").split(",").map(f=>f.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(U,Math.min(Q,parseFloat(i.real_price)||0)),s=f=>(f||"").split(",").map(y=>y.trim()).filter(Boolean),u=f=>f===""||f==null||!isFinite(parseInt(f,10))?null:parseInt(f,10),d=s(i.floor_plan_rooms).map(f=>{const y=String(f).match(/^(.*?):\s*(.*)$/);return y?{name:y[1].trim(),dimensions:y[2].trim()}:{name:f,dimensions:""}}),c={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(U,Math.min(Q,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:u(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:u(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:u(i.year_built),year_renovated:u(i.year_renovated),landmarks:s(i.landmarks_text),interior_features:s(i.interior_features_text),exterior_features:s(i.exterior_features_text),home_systems:s(i.home_systems_text),legal_info:s(i.legal_info_text).map(f=>{const y=String(f).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return y?{label:y[1].trim(),value:y[2].trim(),source:y[3]}:{label:f,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:d,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:s(i.nearby_schools_text),hospitals:s(i.nearby_hospitals_text),shopping:s(i.nearby_shopping_text),transportation:s(i.nearby_transportation_text),distances:s(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:s(i.documents_text),features:o,images:n,highlights:xt(i.highlights_text),seo_keywords:xt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let m;if(t){c.property_id=t;const f=ke((window._propertiesData||[]).find(y=>y.property_id===t)||(window._productsData||[]).find(y=>y.property_id===t));c.specifications={...f.specifications&&typeof f.specifications=="object"?f.specifications:{},real_price:r},{error:m}=await b.from("showroom_listings").upsert({...f,...c},{onConflict:"property_id"})}else c.property_id=et(),c.specifications={real_price:r},{error:m}=await b.from("showroom_listings").insert(c);m&&vt(m,()=>gt({...c,property_id:t||c.property_id}),t?"Property update":"Property publish")||(p(t?"Property updated!":"Property published!"),ne(),ot())};window.editProperty=async function(e){const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Tt(e)),i||(i=(Array.isArray(ae)?ae.find(n=>n.property_id===e):null)||null),i&&showAddPropertyModal(i)};const $n=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function za(){const e=document.getElementById("content");try{const{data:t}=await b.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let n="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>En(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function En(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Sa(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",be(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(i)||"â€”"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${$n.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await b.from("payment_receipts").update({status:t}).eq("id",e);if(a){p(a.message,"error");return}p("Order status updated"),ne(),za()};async function Pn(){const e=document.getElementById("content");try{const{data:t}=await b.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await b.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};async function De(){const e=document.getElementById("content");try{const{data:t}=await b.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length,{data:n}=await b.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),o=n||[],r=o.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?ye("star","No Reviews","Customer reviews will appear here."):a.map(s=>In(s)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${o.length===0?ye("message-square","No Feedback Yet","Site feedback will appear here."):o.map(s=>An(s)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function An(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await b.from("site_feedback").update({is_approved:!0}).eq("id",e);t?p(t.message,"error"):p("Feedback approved â€” it now shows on every page."),De()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await b.from("site_feedback").delete().eq("id",e);t?p(t.message,"error"):p("Feedback deleted."),De()};function In(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await b.from("support_messages").update({is_read:!0}).eq("id",e),p("Marked as read"),Wa()};async function rt(){const e=document.getElementById("content");try{const{data:t}=await b.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddCouponModal=function(){Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:n}=await b.from("coupons").insert(i);if(n){p(n.message,"error");return}p("Coupon created!"),ne(),rt()};window.toggleCoupon=async function(e,t){await b.from("coupons").update({is_active:t}).eq("id",e),p(t?"Coupon activated":"Coupon deactivated"),rt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await b.from("coupons").delete().eq("id",e),p("Coupon deleted"),rt())};async function Cn(){const e=document.getElementById("content");try{const{data:t}=await b.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const Ka=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Tn=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let je=null;function Ln(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function Bn(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${l(e.link_target||"")}</span>`}function Mn(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Ya(){if(je)return je;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const r=o.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{ae.forEach(i)}catch{}try{const{data:o,error:r}=await b.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),je={products:e,categories:a,sections:Tn},je}async function Nn(e){try{const{data:{session:t}}=await b.auth.getSession();if(!t)return p("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),n=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await b.storage.from("advertisements").upload(n,e,{contentType:e.type,upsert:!1});if(o)return p("Upload failed: "+o.message,"error"),null;const{data:r}=b.storage.from("advertisements").getPublicUrl(n);return{url:r.publicUrl,isVideo:i}}catch{return p("Upload failed","error"),null}}function Ke(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),n=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),n&&(n.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){p("Choose an image or video file","error");return}const i=await Nn(t);if(!i){e.value="";return}Ke(i.url,i.isVideo);const n=document.getElementById("ad-media-url");n&&(n.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);Ke(t,a)};function zt(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let n="";t==="product"?n='<option value="">Select a productâ€¦</option>'+e.products.map(o=>`<option value="${l(o.id)}" ${String(a)===String(o.id)?"selected":""}>${l(o.id)} â€” ${l((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?n='<option value="">Select a categoryâ€¦</option>'+e.categories.map(o=>`<option value="${l(o)}" ${a===o?"selected":""}>${l(o)}</option>`).join(""):t==="section"&&(n='<option value="">Select a sectionâ€¦</option>'+e.sections.map(o=>`<option value="${l(o.id)}" ${a===o.id?"selected":""}>${l(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${n}</select>`}function Ja(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.renderAds=Ie;const st=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],se={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Qa(){const e=document.getElementById("content");try{let t=function(o){const r=n===o.id,s=i[o.kf],u=i[o.mf]||o.dm;return`
...
${a.text}`}catch(a){t.textContent=`âŒ ${a.message}`}};function qe(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),n=t.lastIndexOf("}");if(i===-1||n===-1||n<=i)return null;const o=t.slice(i,n+1);try{return JSON.parse(o)}catch{return null}}async function Fn(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([b.from("site_settings").select("*").limit(1).maybeSingle(),Dn()]),i=t||{},n=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),o=a.length?`
        <div class="mt-4">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),p("Cleared. Save to apply.","info"),ei()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),p(`Uploading ${a.name}â€¦`,"info");try{const{data:{session:i}}=await b.auth.getSession();if(!i){p("Sign in to upload media","error");return}const n=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),o=`content/${t}-${Date.now()}.${n}`,{error:r}=await b.storage.from("product-images").upload(o,a,{contentType:a.type,upsert:!1});if(r){p("Upload failed: "+r.message,"error");return}const{data:s}=b.storage.from("product-images").getPublicUrl(o),u=s.publicUrl,d=document.getElementById("val-"+t),c=document.getElementById("url-"+t);d&&(d.value=u),c&&(c.value=u);const m=document.getElementById("slot-"+t);if(m){const f=Wt.flatMap(y=>y.fields||[]).find(y=>y.key===t);f&&(m.outerHTML=Xa(f,u))}p("âœ“ Uploaded â€” save to apply","success")}catch{p("Upload failed","error")}}};const Un=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function oe(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Ue(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(oe()))}function we(){Ue();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=Za(oe()),window.lucide&&lucide.createIcons())}function On(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),n=a&&sa(a)||i&&sa(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}function Za(e){return(e||[]).map((t,a)=>{const i=String(t&&t.buttonText||"SHOP NOW"),n=Un.map(o=>`<button type="button" onclick="heroVideoPreset(${a},'${o}')" class="px-2.5 py-1 rounded-full text-[9px] font-black ${i===o?"bg-indigo-600 text-white":"bg-white/5 text-gray-400"} border ${i===o?"border-indigo-500":"border-white/10"} transition">${o}</button>`).join("");return`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&qn(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=oe();i[e]&&(i[e][t]=a,Ue())};window.heroVideoPreset=function(e,t){const a=oe();a[e]&&(a[e].buttonText=t,we())};window.heroVideoToggle=function(e){const t=oe();t[e]&&(t[e].enabled=t[e].enabled===!1,we())};window.heroVideoMove=function(e,t){const a=oe(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],we())};window.heroVideoDelete=function(e){const t=oe();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),we())};window.heroVideoRemoveMedia=function(e,t){const a=oe();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),we())};window.addHeroVideoSlide=function(){oe().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),we(),p("New slide added â€” upload a video and press Save to show it.","info")};async function jn(e,t){try{const{data:{session:a}}=await b.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:o}=await b.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(o)return{url:URL.createObjectURL(e),persisted:!1,error:o.message};const{data:r}=b.storage.from("product-images").getPublicUrl(n),s=r&&r.publicUrl;return s?{url:s,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function sa(e){return/^blob:/i.test(String(e||""))}async function qn(e,t,a){const i=oe();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){p("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){p("Please choose an image for the poster.","error");return}p("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await jn(a,t);t==="video"?i[e].video=n.url:i[e].poster=n.url,we(),n.persisted?p("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):p("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function Hn(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Ue(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${Wt.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?Hn(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
                  <div class="${n.type==="textarea"||n.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${n.type==="textarea"?`<textarea id="cs-${n.key}" name="${n.key}" rows="3" class="input-field w-full" placeholder="Enter the current wordingâ€¦">${l(a[n.key]||"")}</textarea>`:n.type==="media"?Xa(n,a[n.key]||""):n.type==="checkbox"?"":`<input id="cs-${n.key}" type="text" name="${n.key}" value="${l(a[n.key]||"")}" class="input-field w-full" placeholder="Enter the current wordingâ€¦">`}
      ...
      </div>`,window.lucide&&lucide.createIcons(),Na(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Vn(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${s?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${s?`Backup codes available: ${u} Â· Enrolled: ${ie(o.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <i data-lucide="${f.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${f.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(a!==i){p("Passwords do not match","error");return}if(a.length<8){p("Password must be at least 8 characters","error");return}const{error:n}=await b.auth.signInWithPassword({email:C.user.email,password:t});if(n){p("Current password is incorrect","error");return}const{error:o}=await b.auth.updateUser({password:a});if(o){p(o.message,"error");return}await le(C.user.id,"password_changed"),p("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){Y(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=ti(10);await b.from("admin_2fa").update({backup_codes:e}).eq("user_id",C.user.id),p("New backup codes generated"),ai(e.map(t=>t.code)),lt()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await b.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await b.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await b.from("admin_2fa").update({enabled:!1}).eq("user_id",C.user.id),await le(C.user.id,"2fa_disabled"),p("2FA has been disabled"),lt()}catch(e){p(e.message,"error")}};async function Wn(){const e=document.getElementById("content");try{const{data:t}=await b.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Kn(){const e=document.getElementById("content");try{const{data:t}=await b.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.exportProducts=async function(){const{data:e}=await b.from("showroom_listings").select("*"),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download=`kco-products-${new Date().toISOString().slice(0,10)}.json`,a.click(),p("Products exported!")};window.exportOrders=async function(){const{data:e}=await b.from("payment_receipts").select("*").order("created_at",{ascending:!1});if(!e||!e.length){p("No orders to export","info");return}const t=Object.keys(e[0]).join(","),a=e.map(o=>Object.values(o).map(r=>`"${String(r||"").replace(/"/g,'""')}"`).join(",")).join(`
`),i=new Blob([t+`
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),p("Orders exported!")};async function Yn(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function ct(){const e=document.getElementById("content");e&&(e.innerHTML=Pe());try{let t=function(s,u,d,c="",m="blue"){const f=!!(d&&d.trim());return`
        ...
        </div>`};const{data:a}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},n=i.brand_name||i.site_name||wa,o=i.brand_slogan||i.site_tagline||_a,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${l(a.message)}</div>`)}}function Jn(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",n=t[a]||"",o=t[i]||"",r=!!(n&&n.trim()),s=!!(o&&o.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function la(e,t,a,i,n){const o=n==="image",r=o?"blue":"violet",s=o?"image-plus":"video",u=o?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${ka.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Qn(t,a)).join("")}
    ...
    </div>`,Yt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Kt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Kt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),Yt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=Ee.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||ua(t),Yt(),renderManualPaymentAccountsEditor()};async function Ct(){const e=document.getElementById("content");e&&(e.innerHTML=Pe());try{const{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i={...bi()||{},...t||{}};window._manualPaymentAccounts=yi(i).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(fi(i))}</textarea>
              </div>
              <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(f=>`<button onclick="catalogSetCategory('${f.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${W.category===f.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${l(f.name)}</button>`).join("")}
    </div>`,s=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategoryâ€¦" value="${l(W.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl border ${y?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${l(f.property_id)} Â· ${l(f.subcategory||f.category||"")} Â· ${Sa(f.price,"USD")}</p>
            </div>
            ${X(!y)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',c=n?1:Math.max(1,Math.ceil(i/oi)),m=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-500">Page ${W.page+1} / ${c}</span>
        <button onclick="catalogPage(1)" ${W.page>=c-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${o}
      ...
      ${m}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){W.category=e,W.page=0,W.query="",Ce()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");W.query=e?e.value:"",W.page=0,Ce()};window.catalogPage=function(e){const a=W.query.trim()?1:Math.max(1,Math.ceil(0/oi));W.page=Math.max(0,Math.min(a-1,W.page+e)),Ce()};window.catalogToggle=async function(e){const t=!Xe().includes(e),a=await ya(e,t);p(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),Ce()};window.catalogResetHidden=async function(){await ki(),p("All hidden catalog listings restored"),Ce()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function da(){window.lucide&&lucide.createIcons(),$a(),await Gi(),b.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){C.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",da):da();
