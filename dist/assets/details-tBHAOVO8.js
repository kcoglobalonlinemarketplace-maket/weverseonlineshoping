...
import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as ve}from"./preload-helper-CLcXU_4U.js";import{P as Oe,a as We,S as Fe,T as Tt,M as xa,c as ge,d as X,h as wr,l as wt,e as wa,f as va,j as qt,k as vt,m as z,n as qe,D as ka,o as ye,p as Be,q as _a,t as ot,u as Ft,v as Vt,w as vr,x as kr}from"./promo-backgrounds-Cv2azssI.js";import{c as _r}from"./categories-BEuiwWw5.js";import{supabase as v,isSupabaseConfigured as Sr,ANON_KEY as $r,SUPABASE_URL as Cr}from"./supabase-client-nvpjTmO6.js";import{g as Ve,D as De,l as kt}from"./site-content-DqnRA8M3.js";/* empty css                                       */const Er="https://weverseonlineshop.com";function Bt(){try{if(window.Capacitor?.isNativePlatform?.())return Er}catch{}return window.location.origin}async function O(){const{data:{session:e}}=await v.auth.getSession();return e?.user||null}async function Lr(){if(!await O())return!1;const{data:t}=await v.rpc("is_current_user_admin");return!!t}async function Ir(e,t){const a=`${Bt()}/auth.html`;return v.auth.signUp({email:e,password:t,options:{emailRedirectTo:a}})}async function Ar(e,t){return v.auth.signInWithPassword({email:e,password:t})}async function Mr(){return v.auth.signOut()}async function Tr(e){return v.auth.resetPasswordForEmail(e,{redirectTo:`${Bt()}/auth.html?reset=1`})}async function qr(e){return v.auth.updateUser({password:e})}async function Br(e){return v.auth.resend({type:"signup",email:e})}function Rr(e){return v.auth.onAuthStateChange((t,a)=>{e(a?.user||null)})}function jr(){return sessionStorage.getItem("kco_auth_redirect")||null}function le(e){sessionStorage.setItem("kco_auth_redirect",e)}function Hr(){sessionStorage.removeItem("kco_auth_redirect")}async function Pr(e,t){if(!Sr)return{ok:!1,error:"Supabase credentials are missing."};const a=`${Cr}/functions/v1/send-auth-email`;try{const{data:{session:r}}=await v.auth.getSession(),s=r?.access_token||$r,o=await fetch(a,{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({type:e,...t})});let n={};try{n=await o.json()}catch{n={}}return{ok:o.ok&&!n.error,error:n.error}}catch(r){return{ok:!1,error:String(r)}}}const Nr=Object.freeze(Object.defineProperty({__proto__:null,appOrigin:Bt,clearRedirectAfterAuth:Hr,getCurrentUser:O,getRedirectAfterAuth:jr,isAdmin:Lr,onAuthChange:Rr,resendVerification:Br,resetPassword:Tr,sendAuthEmail:Pr,setRedirectAfterAuth:le,signIn:Ar,signOut:Mr,signUp:Ir,updateUserPassword:qr},Symbol.toStringTag,{value:"Module"})),Sa=[];function Dt(e){return Sa.find(t=>t.property_id===e)||null}const $a=[];function Or(e){return $a.find(t=>t.property_id===e)||null}const Wr=[];let nt=null;function Ca(){return nt||(nt=ve(()=>Promise.resolve().then(()=>Nr),void 0)),nt}async function Rt(){return(await Ca()).getCurrentUser()}async function Fr(e){return(await Ca()).setRedirectAfterAuth(e)}const Ea="kco_cart";function La(){try{const e=JSON.parse(localStorage.getItem(Ea)||"[]");if(!Array.isArray(e))return[];const t=[];for(const a of e)typeof a=="string"?t.push({id:a,qty:1}):a&&typeof a=="object"&&a.id&&t.push({id:a.id,qty:Math.max(1,parseInt(a.qty,10)||1)});return t}catch{return[]}}function Vr(e){try{localStorage.setItem(Ea,JSON.stringify(e))}catch{}Dr()}function Dr(){window.dispatchEvent(new CustomEvent("kco-cart-changed",{detail:{count:Ur()}}))}function Ur(){return La().reduce((e,t)=>e+t.qty,0)}function Ia(e,t=1){if(!e)return;const a=La(),r=a.find(s=>s.id===e);r?r.qty=Math.min(99,r.qty+t):a.push({id:e,qty:t}),Vr(a)}const oe="Weverse Online Shop",Aa="/fallback.svg",Gr="https://weverseonlineshop.com/brand-logo.jpeg";function Ma(e){return e?/^(https?:|data:)/i.test(e)?e:(window.location.origin||"")+e:""}function zr(e){const t=e?.price,a=Number(t&&typeof t=="object"?t.price:t)||0,r=e?.currency||"USD";let s;try{s=a.toLocaleString("en-US",{style:"currency",currency:r,maximumFractionDigits:0})}catch{s="$"+a.toLocaleString("en-US")}return e?.price_period&&(s+="/"+e.price_period),s}function Yr(e){const t=e?.property_id||e?.id;return`${window.location.origin}/details.html?id=${encodeURIComponent(t)}`}function Ta(e){const t=String(e?.title||"").trim()||oe,a=zr(e),r=Yr(e),s=Ma(e?.images?.[0]||Aa),o=a?`${t} — ${a}`:t,n=a?`${t}
${a}
${r}`:`${t}
${r}`;return{title:t,price:a,url:r,image:s,text:o,caption:n}}function it(e){let t=document.getElementById("share-toast");t||(t=document.createElement("div"),t.id="share-toast",t.className="fixed bottom-24 left-1/2 z-[400] bg-gray-900 text-white text-sm font-semibold px-4 py-2.5 rounded-xl shadow-xl transition-all duration-300 pointer-events-none whitespace-nowrap",t.style.opacity="0",t.style.transform="translate(-50%, 10px)",document.body.appendChild(t)),t.textContent=e,t.style.opacity="1",t.style.transform="translate(-50%, 0)",clearTimeout(t._timer),t._timer=setTimeout(()=>{t.style.opacity="0",t.style.transform="translate(-50%, 10px)"},2600)}function Ut(e,t){try{const a=document.createElement("textarea");a.value=e,a.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(a),a.focus(),a.select(),document.execCommand("copy"),a.remove(),t()}catch{t()}}function lt(e){return new Promise(t=>{const a=()=>t(!0);navigator.clipboard?.writeText?navigator.clipboard.writeText(e).then(a).catch(()=>Ut(e,a)):Ut(e,a)})}function ct(e){window.open(e,"_blank","noopener,noreferrer")}const te={whatsapp:'<svg viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.79 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C22 6.45 17.5 2 12.04 2zm5.8 14.32c-.25.7-1.44 1.35-2 1.4-.52.05-1.19.24-3.97-.83-3.33-1.31-5.45-4.7-5.61-4.92-.16-.22-1.34-1.79-1.34-3.41 0-1.62.85-2.41 1.15-2.74.3-.33.65-.41.87-.41.22 0 .43 0 .62.01.2.01.46-.07.72.55.27.63.92 2.16 1 2.31.08.15.13.33.03.53-.1.2-.15.32-.3.5-.15.18-.32.4-.45.53-.15.15-.31.31-.13.61.18.3.79 1.31 1.7 2.12 1.17 1.04 2.15 1.36 2.46 1.51.31.15.49.13.67-.08.18-.2.77-.9.98-1.21.2-.31.41-.25.69-.15.28.1 1.79.84 2.1 1 .31.15.51.23.58.35.08.13.08.73-.17 1.42z"/></svg>',facebook:'<svg viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.09 10.13 24v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.8-4.7 4.54-4.7 1.31 0 2.68.24 2.68.24v2.97h-1.5c-1.5 0-1.96.93-1.96 1.89v2.26h3.32l-.53 3.49h-2.8V24C19.61 23.09 24 18.1 24 12.07z"/></svg>',x:'<svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6"><path d="M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.41l-5.8-7.58-6.64 7.58H.47l8.6-9.83L0 1.15h7.59l5.24 6.93 6.07-6.93zm-1.29 19.5h2.04L6.49 3.24H4.3l13.31 17.41z"/></svg>',tiktok:'<svg viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.9 2.9 0 0 1-2.89 2.62 2.9 2.9 0 0 1-2.9-2.9 2.9 2.9 0 0 1 3.53-2.84V9.94a6.35 6.35 0 0 0-3.53 1.06 6.36 6.36 0 0 0-2.9 5.37 6.36 6.36 0 0 0 6.35 6.36c3.5 0 6.36-2.86 6.36-6.36V7.87a8.24 8.24 0 0 0 4.77 1.52V6.26a4.83 4.83 0 0 1-.5.03 4.87 4.87 0 0 1-1.12.4z"/></svg>',link:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',more:'<svg viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7"><circle cx="12" cy="12" r="2.2"/><circle cx="5" cy="12" r="2.2"/><circle cx="19" cy="12" r="2.2"/></svg>'},Kr=[{key:"whatsapp",label:"WhatsApp",color:"#25D366",icon:te.whatsapp},{key:"facebook",label:"Facebook",color:"#1877F2",icon:te.facebook},{key:"x",label:"X",color:"#000000",icon:te.x},{key:"tiktok",label:"TikTok",color:"#111111",icon:te.tiktok},{key:"copy",label:"Copy Link",color:"#64748B",icon:te.link},{key:"more",label:"More",color:"#334155",icon:te.more}];function Zr(e){return`<button type="button" class="group flex flex-col items-center gap-2" data-share-action="${e.key}">
  ...
  </button>`}function Jr(){const e=document.createElement("div");return e.id="share-sheet",e.className="fixed inset-0 z-[350] hidden",e.innerHTML=`
    <style>
    ...
    <div class="absolute bottom-0 left-0 right-0 max-w-lg mx-auto bg-white rounded-t-3xl shadow-2xl overflow-hidden animate-share-sheet">
      ...
      <div class="p-5 space-y-5">
        <div class="flex items-center gap-4 bg-gray-50 border border-gray-100 rounded-2xl p-3">
          <img id="share-product-img" class="w-20 h-20 rounded-xl object-cover border border-gray-200 shrink-0" alt="Product" onerror="this.onerror=null;this.src='${Aa}'">
          <div class="min-w-0">
    ...
    </div>`,document.body.appendChild(e),e}function Gt(){const e=document.getElementById("share-sheet");e&&e.classList.add("hidden"),document.body.style.overflow=""}function qa(e){let t=document.getElementById("share-sheet");t||(t=Jr()),t.querySelector("#share-product-title").textContent=e.title,t.querySelector("#share-product-price").textContent=e.price||"",t.querySelector("#share-product-img").src=e.image,t.querySelector("#share-platforms").innerHTML=Kr.map(Zr).join(""),t.classList.remove("hidden"),document.body.style.overflow="hidden",t.querySelectorAll("[data-share-close]").forEach(a=>a.addEventListener("click",Gt)),t.querySelectorAll("[data-share-action]").forEach(a=>a.addEventListener("click",()=>{Gt(),Xr(a.dataset.shareAction,e)}))}async function Xr(e,t){switch(e){case"whatsapp":ct(`https://api.whatsapp.com/send?text=${encodeURIComponent(t.caption)}`);break;case"facebook":ct(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(t.url)}&quote=${encodeURIComponent(t.text)}`);break;case"x":ct(`https://twitter.com/intent/tweet?text=${encodeURIComponent(t.text)}&url=${encodeURIComponent(t.url)}`);break;case"tiktok":if(navigator.share)try{await navigator.share({title:t.title,text:t.caption,url:t.url})}catch{}else await lt(t.caption),it("TikTok caption copied — paste to share");break;case"copy":await lt(t.url),it("Link copied to clipboard");break;case"more":if(navigator.share)try{await navigator.share({title:t.title,text:t.text,url:t.url})}catch{}else await lt(t.url),it("Link copied to clipboard");break}}function Q(e){e&&qa(Ta(e))}function Qr(){const e=window.location.origin;qa({title:oe,price:"",url:e,image:Ma(Gr),text:`Check out ${oe} — a trusted global marketplace for premium products with worldwide delivery.`,caption:`${oe} — premium products, secure payments, worldwide delivery.
${e}`})}function es(e){if(!e)return;const t=Ta(e),a=`${t.title}${t.price?` — ${t.price}`:""} — available at ${oe}.`,r=(s,o,n)=>{let i=document.head.querySelector(`meta[${s}="${o}"]`);i||(i=document.createElement("meta"),i.setAttribute(s,o),document.head.appendChild(i)),i.setAttribute("content",n)};r("property","og:title",t.title),r("property","og:description",a),r("property","og:image",t.image),r("property","og:url",t.url),r("property","og:type","product"),r("name","twitter:title",t.title),r("name","twitter:description",a),r("name","twitter:image",t.image),document.title=`${t.title} | ${oe}`}function ts(e){Q(e)}typeof window<"u"&&(window.openShareSheet=Q,window.openWebsiteShareSheet=Qr,window.shareProduct=ts);function as(e,t,a,r={}){if(!e||!Number.isFinite(t)||!Number.isFinite(a))return;const s=r.width||e.width||600,o=r.height||e.height||160,n=Math.max(3,Math.min(18,r.zoom||13));window.devicePixelRatio&&r.highDpi!==!1?(e.width=s*2,e.height=o*2):(e.width=s,e.height=o);const i=e.getContext("2d");i.setTransform(1,0,0,1,0,0),window.devicePixelRatio&&r.highDpi!==!1&&i.scale(2,2),i.fillStyle="#e5e7eb",i.fillRect(0,0,s,o);const l=256,c=Math.pow(2,n),d=l*c,u=t*Math.PI/180,p=(a+180)/360*d,y=(1-Math.log(Math.tan(u)+1/Math.cos(u))/Math.PI)/2*d,g=Math.floor((p-s/2)/l),h=Math.floor((y-o/2)/l),x=Math.floor((p+s/2)/l),_=Math.floor((y+o/2)/l);let C=0;const E=()=>{const I=s/2,b=o/2;i.save(),i.shadowColor="rgba(0,0,0,.4)",i.shadowBlur=6,i.shadowOffsetY=2,i.fillStyle="#ef4444",i.beginPath(),i.arc(I,b,9,0,Math.PI*2),i.fill(),i.restore(),i.fillStyle="#ffffff",i.beginPath(),i.arc(I,b,3.5,0,Math.PI*2),i.fill()};for(let I=g;I<=x;I++)for(let b=h;b<=_;b++){if(b<0||b>=c)continue;const P=(I%c+c)%c,A=new Image;A.crossOrigin="anonymous",A.decoding="async",A.src=`https://tile.openstreetmap.org/${n}/${P}/${b}.png`;const Y=Math.round(I*l-(p-s/2)),ee=Math.round(b*l-(y-o/2));C++,A.onload=()=>{try{i.drawImage(A,Y,ee,l,l)}catch{}C--,C===0&&E()},A.onerror=()=>{C--,C===0&&E()}}C===0&&E()}function Ba(e){const t=e.querySelectorAll("[data-static-map]");if(!t.length)return;const a=s=>{const o=parseFloat(s.dataset.lat),n=parseFloat(s.dataset.lng);!Number.isFinite(o)||!Number.isFinite(n)||as(s,o,n,{width:s.clientWidth||600,height:s.clientHeight||160,zoom:13})},r="IntersectionObserver"in window?new IntersectionObserver(s=>{s.forEach(o=>{o.isIntersecting&&(a(o.target),r.unobserve(o.target))})},{rootMargin:"200px"}):null;t.forEach(s=>{r?r.observe(s):a(s)})}const jt="/fallback.svg";function rs(e){return!e||typeof e!="string"||e.startsWith("blob:")||e.startsWith("data:")?!1:/\.(mp4|webm|mov|avi|mkv)(\?|#|$)/i.test(e)}function Re(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const Ra="kco_showroom_view_mode";let ie="grid";function ss(){try{return localStorage.getItem(Ra)==="line"?"line":"grid"}catch{return"grid"}}ie=ss();const ja=()=>ie==="line";function os(e){ie=e==="line"?"line":e==="feed"?"feed":"grid";try{localStorage.setItem(Ra,ie)}catch{}document.querySelectorAll("[data-showroom-grid]").forEach(t=>{delete t.dataset.initialized,delete t.dataset.prerendered,t.innerHTML=""}),Te(),window.lucide&&lucide.createIcons(),Ha()}function Ha(){const e=document.getElementById("view-mode-picker");e&&e.querySelectorAll("[data-view-mode]").forEach(t=>{const a=t.dataset.viewMode===ie;t.classList.toggle("view-mode-active",a),t.setAttribute("aria-checked",a?"true":"false")})}function ns(){const e=document.getElementById("view-mode-picker");e&&(e.querySelectorAll("[data-view-mode]").forEach(t=>{t.addEventListener("click",()=>os(t.dataset.viewMode))}),Ha())}function zt(e,t){const a=e.querySelector(".hscroll");a&&a.scrollBy({left:t*260*3,behavior:"smooth"})}const ne=[...Oe,...We];function Pa(e){return e&&(X().find(a=>a.property_id===e.property_id)||e)}const is=["W10000","W10475","W11084","W11086","W11090"].map(e=>Fe.find(t=>t.property_id===e)||We.find(t=>t.property_id===e)).filter(Boolean),ls=["W10379","W10382","W10383","W10422","W10425","W10449","W10468","W10600","W10994","W11001","W11002","W11022","W11023","W11028","W11030","W11033","W11034","W11037","W11040","W11049","W11054","W11055","W11062","W11065","W11094","W11107"].map(e=>We.find(t=>t.property_id===e)).filter(Boolean),Ue=e=>ne.filter(t=>(t.category||"New Arrivals")===e),Ht=/\b(washer|washing|laundry|launder|dryer)\b/i,Na=ne.filter(e=>Ht.test(e.title||"")),Oa=new Set(Na.map(e=>e.property_id||e.id)),Yt=new Set,Ge=e=>e.filter(t=>{const a=t.property_id||t.id;return!a||Oa.has(a)||Yt.has(a)?!1:(Yt.add(a),!0)}),cs=Ge([...is,...Ue("Houses & Real Estate")]),ds=Ge([...ls,...Ue("Cars & Vehicles")]),us=Ge([...Tt,...Ue("Trucks")]),ps=Ge([...xa,...Ue("Motorhomes")]),D=["Houses & Real Estate","Cars & Vehicles","Trucks","Motorhomes","Kitchen & Appliances","Home Appliances & Cleaning","Jewelry","Watches","Fashion & Shoes","Babies & Kids","Electronics","Tools & Hardware","Beauty & Personal Care","Home Decor & Storage","New Arrivals"],Wa={"Houses & Real Estate":"home","Cars & Vehicles":"car-front",Trucks:"truck",Motorhomes:"bus","Kitchen & Appliances":"chef-hat","Home Appliances & Cleaning":"washing-machine",Jewelry:"gem",Watches:"watch","Fashion & Shoes":"shirt","Babies & Kids":"baby",Electronics:"smartphone","Tools & Hardware":"wrench","Beauty & Personal Care":"sparkles","Home Decor & Storage":"lamp","New Arrivals":"package"};function Fa(e){return String(e).toLowerCase().replace(/[^a-z0-9]+/g,"-")}function ms(e){const t=new Map;for(const r of e){const s=r.category||"New Arrivals";t.has(s)||t.set(s,[]),t.get(s).push(r.property_id||r.id)}return[...t.keys()].sort((r,s)=>{const o=D.indexOf(r),n=D.indexOf(s);return(o===-1?D.length:o)-(n===-1?D.length:n)}).map(r=>({id:`products-${Fa(r)}`,label:r,icon:Wa[r]||"package",productCategory:r})).filter(r=>(t.get(r.productCategory)||[]).length)}const hs=ms(ne.filter(e=>{const t=e.category||"New Arrivals",a=e.property_id||e.id;return!["Houses & Real Estate","Cars & Vehicles","Trucks","Motorhomes"].includes(t)&&!Oa.has(a)}));function fs(){const e=X()||[],t=new Map;for(const r of e){const s=r.category||"New Arrivals",o=r.property_id||r.id;o&&(["Houses & Real Estate","Real Estate","Cars","Cars & Vehicles","Trucks","Motorhomes"].includes(s)||Ht.test(r.title||"")||(t.has(s)||t.set(s,[]),t.get(s).push(o)))}return[...t.keys()].sort((r,s)=>{const o=D.indexOf(r),n=D.indexOf(s);return(o===-1?D.length:o)-(n===-1?D.length:n)}).map(r=>({id:`products-${Fa(r)}`,label:r,icon:Wa[r]||"package",productCategory:r})).filter(r=>(t.get(r.productCategory)||[]).length)}const Va="kco_wishlist_ids";let W=new Set,Kt=!1;function bs(){if(Kt)return;Kt=!0;const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e)}function gs(){try{W=new Set(JSON.parse(localStorage.getItem(Va)||"[]"))}catch{W=new Set}}function ys(){try{localStorage.setItem(Va,JSON.stringify([...W]))}catch{}}async function xs(){try{if(!await Rt())return;const{supabase:t}=await ve(async()=>{const{supabase:r}=await import("./supabase-client-nvpjTmO6.js");return{supabase:r}},[]),{data:a}=await t.from("wishlist").select("listing_id, property_id");a&&a.forEach(r=>{r.listing_id?W.add(r.listing_id):r.property_id&&W.add(r.property_id)})}catch{}}function Da(e){return W.has(e.id||e.property_id)}function ws(e,t){e&&(e.classList.toggle("saved",t),e.classList.toggle("text-red-400",t),e.classList.toggle("bg-red-500/20",t),e.classList.toggle("border",t),e.classList.toggle("border-red-500/40",t),e.setAttribute("aria-label",t?"Remove from wishlist":"Add to wishlist"),e.title=t?"Remove from wishlist":"Add to wishlist",e.innerHTML=`<i data-lucide="heart" class="w-4 h-4 ${t?"fill-red-500 text-red-500":""}"></i>`,e.classList.remove("wish-pop"),e.offsetWidth,e.classList.add("wish-pop"),window.lucide&&lucide.createIcons())}async function vs(e,t){const a=e.id||e.property_id,s=!W.has(a);s?W.add(a):W.delete(a),ys(),ws(t,s);const o=await Rt();if(!o){me(s?"Saved to wishlist ♥":"Removed from wishlist"),s&&setTimeout(()=>me("Sign in to sync your wishlist across devices"),1400);return}try{const{supabase:n}=await ve(async()=>{const{supabase:l}=await import("./supabase-client-nvpjTmO6.js");return{supabase:l}},[]),{data:i}=await n.from("wishlist").select("id").eq("listing_id",a).eq("user_id",o.id).maybeSingle();s&&!i?await n.from("wishlist").insert({user_id:o.id,listing_id:a,property_id:e.property_id}):!s&&i&&await n.from("wishlist").delete().eq("id",i.id),me(s?"Added to wishlist ♥":"Removed from wishlist")}catch{me("Wishlist action failed")}}const xe=[{id:"local-houses",label:"Local Houses & Real Estate",icon:"home",subtitle:"Homes for sale or rent — scroll down to see them all, two at a time.",rows:[{id:"new-houses",label:"Houses",icon:"home",newHouses:!0}]},{id:"modern-luxury",label:"Modern Homes & Luxury Properties",icon:"building-2",subtitle:"Contemporary villas, mansions, and new-build family homes.",rows:[{id:"new-homes",label:"New Homes",icon:"home",ids:["W10018","W10019","W10020","W10021","W10022","W10023","W10024","W10025","W10026","W10027"]},{id:"modern-homes",label:"Modern Homes",icon:"building-2",ids:["W10006","W10009"]},{id:"mansion-homes",label:"Mansions",icon:"landmark",ids:["W10007"]},{id:"farm-house",label:"Farm Houses",icon:"wheat",ids:["W10010"]}]},{id:"commercial-land",label:"Commercial Properties & Land",icon:"briefcase",subtitle:"Retail buildings, hotels, and investment-grade commercial real estate.",rows:[{id:"commercial",label:"Commercial Buildings",icon:"store",ids:["W10011"]},{id:"hotels",label:"Hotels & Hospitality",icon:"bed-double",ids:["W10013"]}]},{id:"cars",label:"Cars",icon:"car-front",subtitle:"Brand new car arrivals — bright, shiny and ready to drive home. Scroll to see them all.",rows:[{id:"all-cars",label:"New Cars",icon:"car-front",allCars:!0}]},{id:"washing-machines",label:"Washing Machines",icon:"washing-machine",subtitle:"Every washer, dryer and laundry item, gathered in one long scroll.",rows:[{id:"all-washing-machines",label:"Washing Machines",icon:"washing-machine",allWashingMachines:!0}]},{id:"trucks-buses",label:"Trucks",icon:"truck",subtitle:"Heavy-duty trucks and commercial transport vehicles.",rows:[{id:"all-trucks",label:"All Trucks",icon:"truck",allTrucks:!0}]},{id:"motorhomes-boats",label:"Motorhomes",icon:"bus",subtitle:"Luxury motorhomes and RVs for travel and adventure — scroll down to see them all.",rows:[{id:"all-motorhomes",label:"All Motorhomes",icon:"bus",allMotorhomes:!0}]},{id:"products",label:"Products",icon:"package",subtitle:"Premium shop products — jewelry, watches, fashion and more.",rows:hs}],ks={"affordable-homes":"real-estate","apartment-homes":"real-estate","cape-cod":"real-estate","beach-houses":"real-estate","new-homes":"real-estate","modern-homes":"real-estate","mansion-homes":"real-estate","farm-house":"real-estate",commercial:"real-estate",hotels:"real-estate","all-cars":"cars","all-trucks":"trucks","all-motorhomes":"motorhomes"};function _s(e,t){return ks[e.id]?[]:[]}function Ua(e){qt(e);const t=e.listing_type==="property",a=e.listing_type==="pet",r=e.listing_type==="vehicle"&&e.category==="Trucks",s=e.listing_type==="vehicle"&&e.category==="Motorhomes",o=e.listing_type==="vehicle"&&e.category==="Cars",n=e.id||e.property_id,i=e.images?.[0]||jt,l=rs(i),c=r?vt(e):z(e),d=e.listing_type==="product"?"New":t||a?"For Sale":"",p=(e.rating_count||0)>0&&Number(e.rating)||0,y=e.review_count||e.rating_count||0;let g="";if(t){const b=qe(e.country_code),P=[e.city,e.state].filter(Boolean);g=`<div class="flex items-center gap-1 text-gray-400 text-xs mb-1.5"><i data-lucide="map" class="w-3.5 h-3.5 shrink-0"></i><span>${b} ${P.join(", ")||e.country}</span></div>`}else a&&(g=`<div class="flex items-center gap-1 text-gray-400 text-xs mb-1.5"><i data-lucide="paw-print" class="w-3.5 h-3.5 shrink-0"></i><span>${qe(e.country_code)} ${e.country}</span></div>`);let h="";if(t){const b=[];e.bedrooms!=null&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="bed-double" class="w-3.5 h-3.5"></i>${e.bedrooms}</span>`),e.bathrooms!=null&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="bath" class="w-3.5 h-3.5"></i>${e.bathrooms}</span>`),e.land_size&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="ruler" class="w-3.5 h-3.5"></i>${e.land_size}</span>`),e.year_built&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="calendar" class="w-3.5 h-3.5"></i>${e.year_built}</span>`),e.condition&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="badge-check" class="w-3.5 h-3.5"></i>${e.condition}</span>`),b.length&&(h=`<div class="flex items-center gap-2 text-gray-400 text-xs mb-2">${b.join("")}</div>`)}else if(r||s||o){const b=[];b.push(`<span class="flex items-center gap-0.5"><i data-lucide="calendar" class="w-3.5 h-3.5"></i>${e.model_year}</span>`),b.push(`<span class="flex items-center gap-0.5"><i data-lucide="gauge" class="w-3.5 h-3.5"></i>${e.mileage}</span>`),s&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="moon" class="w-3.5 h-3.5"></i>Sleeps ${e.sleeping_capacity}</span>`),o&&b.push(`<span class="flex items-center gap-0.5"><i data-lucide="fuel" class="w-3.5 h-3.5"></i>${e.fuel_type}</span>`),b.length&&(h=`<div class="flex items-center gap-2 text-gray-400 text-xs mb-2">${b.join("")}</div>`)}let x="";p>0&&(x=`<a href="/details.html?id=${e.property_id}" class="flex items-center gap-0.5 text-xs no-underline hover:opacity-80 transition" title="View ratings & reviews"><i data-lucide="star" class="w-4 h-4 fill-amber-400 text-amber-400"></i><span class="text-gray-800 font-semibold">${p.toFixed(1)}</span><span class="text-gray-500">(${y})</span></a>`);let _="",C="",E=parseFloat(e.real_price);if((!Number.isFinite(E)||E<=0)&&(E=parseFloat(e.compare_at_price??e.original_price)),Number.isFinite(E)&&E>0&&E>parseFloat(e.price)){const b=Math.round((1-parseFloat(e.price)/E)*100),P=A=>r?vt({...e,price:A}):z({...e,price:A});_=`<span class="absolute bottom-2 left-2 bg-red-500 text-white text-[10px] font-black px-2 py-1 rounded-full shadow-md shadow-red-500/30">-${b}%</span>`,C=`<span class="text-xs text-gray-400 price-strike line-through">${P(E)}</span>`}let I="";return t&&e.latitude&&e.longitude&&(I=`
      <div class="relative mt-2.5 h-20 rounded-lg overflow-hidden border border-gray-200 bg-gray-100">
        <canvas data-static-map data-lat="${Re(e.latitude)}" data-lng="${Re(e.longitude)}" class="w-full h-full block"></canvas>
      ...
      </div>`),{isProperty:t,isPet:a,isTruck:r,isMotorhome:s,isCar:o,listingId:n,cover:i,isCoverVideo:l,price:c,statusBadge:d,locationHtml:g,specsHtml:h,ratingStars:x,mapPreviewHtml:I,discountBadge:_,originalPriceHtml:C}}function _t(e){e=Pa(e);const t=Ua(e),a=document.createElement("div");a.className="showroom-card group relative bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-blue-400 hover:shadow-lg hover:shadow-blue-100 transition-all duration-300 flex flex-col cursor-pointer",a.dataset.id=t.listingId;const r=Da(e);return a.innerHTML=`
    <div class="relative aspect-[6/5] overflow-hidden bg-gray-100">
      ${t.isCoverVideo?`<video src="${Re(t.cover)}" muted loop autoplay playsinline preload="metadata" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" onerror="this.style.display='none'"></video>
           <div class="absolute inset-0 flex items-center justify-center pointer-events-none"><div class="w-11 h-11 rounded-full bg-white/80 flex items-center justify-center shadow-lg"><svg class="w-5 h-5 text-gray-800 ml-0.5" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></div></div>`:`<img src="${t.cover}" alt="${e.title}" loading="lazy" decoding="async"
             ...
             onerror="this.onerror=null;this.src='${jt}'">`}
  ...
  `,je(a,e),Ba(a),a}function Ss(e){e=Pa(e);const t=Ua(e),a=document.createElement("div");a.className="showroom-card showroom-feed-card group relative bg-white border border-gray-200 rounded-2xl overflow-hidden hover:border-blue-400 hover:shadow-xl hover:shadow-blue-100 transition-all duration-300 flex flex-col sm:flex-row cursor-pointer",a.dataset.id=t.listingId;const r=Da(e);return a.innerHTML=`
    <div class="relative shrink-0 sm:w-[42%] lg:w-[38%] xl:w-[34%] aspect-[7/5] sm:aspect-auto sm:min-h-[300px] overflow-hidden bg-gray-100">
      ${t.isCoverVideo?`<video src="${Re(t.cover)}" muted loop autoplay playsinline preload="metadata" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" onerror="this.style.display='none'"></video>
           <div class="absolute inset-0 flex items-center justify-center pointer-events-none"><div class="w-11 h-11 rounded-full bg-white/80 flex items-center justify-center shadow-lg"><svg class="w-5 h-5 text-gray-800 ml-0.5" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></div></div>`:`<img src="${t.cover}" alt="${e.title}" loading="lazy" decoding="async"
  ...
  `,je(a,e),Ba(a),a}function je(e,t){e.addEventListener("click",a=>{a.target.closest("button")||(window.location.href=`/details.html?id=${t.property_id}`)}),e.querySelector(".buy-btn").addEventListener("click",a=>{a.stopPropagation(),$s(t)}),e.querySelector(".wishlist-btn").addEventListener("click",a=>{a.stopPropagation(),vs(t,a.currentTarget)}),e.querySelector(".share-btn").addEventListener("click",a=>{a.stopPropagation(),Es(t)}),e.querySelector(".cart-btn")?.addEventListener("click",a=>{a.stopPropagation(),Cs(t)}),e.querySelector(".details-btn")?.addEventListener("click",a=>{a.stopPropagation(),window.location.href=`/details.html?id=${t.property_id}`})}async function $s(e){await Rt()?window.location.href=`/checkout.html?id=${e.property_id}`:(Fr(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}function Cs(e){const t=e.property_id||e.id;Ia(t,1),me("Added to cart")}function Es(e){Q(e)}function me(e){let t=document.getElementById("card-toast");t||(t=document.createElement("div"),t.id="card-toast",t.className="fixed bottom-5 right-5 z-[200] bg-gray-900 border border-blue-500/30 text-white px-4 py-2.5 rounded-xl shadow-xl text-xs font-medium transition-all duration-300 pointer-events-none",t.style.transform="translateY(20px)",t.style.opacity="0",document.body.appendChild(t)),t.textContent=e,t.style.transform="translateY(0)",t.style.opacity="1",clearTimeout(t._timer),t._timer=setTimeout(()=>{t.style.transform="translateY(20px)",t.style.opacity="0"},2500)}function Ls(e){const t=X()||[];return e.allTrucks?t.filter(a=>a.category==="Trucks"):e.allMotorhomes?t.filter(a=>a.category==="Motorhomes"):e.allCars?t.filter(a=>a.category==="Cars"||a.category==="Cars & Vehicles"):e.newHouses?t.filter(a=>a.listing_type==="property"||a.category==="Houses & Real Estate"||a.category==="Real Estate"):e.allWashingMachines?t.filter(a=>Ht.test(a.title||"")):e.productCategory?t.filter(a=>(a.category||"New Arrivals")===e.productCategory):e.allProducts?t:e.ids?wa(e.ids):[]}function ke(e){let t;e.allTrucks?t=us:e.allMotorhomes?t=ps:e.allCars?t=ds:e.newHouses?t=cs:e.allWashingMachines?t=Na:e.productCategory?t=ne.filter(o=>(o.category||"New Arrivals")===e.productCategory):e.allProducts?t=e.productRange?ne.slice(e.productRange[0],e.productRange[1]):ne:t=wa(e.ids);const a=Ls(e),r=new Set(t.map(o=>o.property_id||o.id));for(const o of a){const n=o.property_id||o.id;!n||r.has(n)||(r.add(n),t=[...t,o])}let s=[];return!e.allTrucks&&!e.allMotorhomes&&!e.allCars&&!e.newHouses&&!e.allProducts&&!e.productCategory&&!e.allWashingMachines&&(s=_s(e,t.map(o=>o.property_id))),s.length>0&&(t=[...t,...s]),t.filter(o=>o&&!va(o.property_id))}function Is(e){const t=ke(e),a=t.length>0,r=ie==="grid"||e.layout==="grid",s=ja()&&!r,o=document.createElement("div");o.className="showroom-row relative",o.dataset.rowId=e.id,r&&(o.dataset.layout="grid"),s&&(o.dataset.layout="line"),o.innerHTML=`
  ...
  `;const n=o.querySelector(r?".grid":s?".hscroll":".showroom-feed");if(a){const i=document.createDocumentFragment();t.forEach(l=>{try{i.appendChild(r||s?_t(l):Ss(l))}catch{}}),n.appendChild(i)}else n.innerHTML=`<div class="flex items-center justify-center w-full py-6">
    ...
    </div>`;return o.querySelector(".scroll-left")?.addEventListener("click",()=>zt(o,-1)),o.querySelector(".scroll-right")?.addEventListener("click",()=>zt(o,1)),o}function Zt(e,t,a){const r=document.createElement("div");return r.className="showroom-section space-y-3",(a&&a>0?e.rows.slice(0,a):e.rows).filter(o=>(ke(o)||[]).length>0).forEach(o=>{try{r.appendChild(Is(o))}catch{}}),r}const As=new Set(["local-houses","modern-luxury","commercial-land"]),Ms=new Set(["cars","trucks-buses"]);function Jt(e){return e.rows.some(t=>(ke(t)||[]).length>0)}function Ts(e){const t=document.querySelector(`[data-showroom-grid="${e}"]`);if(!t||t.dataset.initialized)return;t.dataset.initialized="true";const a=t.dataset.prerendered==="true";delete t.dataset.prerendered,a||(t.innerHTML=""),a&&t.querySelectorAll(".showroom-row[data-row-id]").forEach(i=>{const l=Ga(i.dataset.rowId);(!l||(ke(l)||[]).length===0)&&i.remove()});const r=new Set;a&&t.querySelectorAll(".showroom-row[data-row-id]").forEach(i=>r.add(i.dataset.rowId));const s=i=>r.has(i),o=xe,n="blue";if(e==="real-estate"){const i=new Map(o.map(l=>[l.id,l]));for(const l of["local-houses","cars","washing-machines","trucks-buses","motorhomes-boats","products"]){const c=i.get(l);if(!c)continue;if(!c.rows.some(u=>s(u.id))&&Jt(c)){const u=As.has(l)||Ms.has(l);try{t.appendChild(Zt(c,n,u?1:void 0))}catch{}}}}else o.forEach(i=>{if(Jt(i))try{t.appendChild(Zt(i,n))}catch{}});window.lucide&&lucide.createIcons(),qs(t)}function Ga(e){for(const t of xe)for(const a of t.rows)if(a.id===e)return a;return null}function qs(e){e.querySelectorAll(".showroom-row[data-prerendered]").forEach(t=>{const a=Ga(t.dataset.rowId);if(!a)return;const r=ke(a),s=t.querySelector(".showroom-feed, .grid");s&&s.querySelectorAll(".showroom-card").forEach(o=>{const n=o.dataset.id,i=r.find(l=>(l.id||l.property_id)===n);i?je(o,i):n&&je(o,{id:n,property_id:n,title:n})}),delete t.dataset.prerendered})}function Te(){const e=document.querySelectorAll("[data-showroom-grid]");ja()&&e.forEach(t=>{delete t.dataset.prerendered,t.innerHTML=""}),e.forEach((t,a)=>{const r=t.dataset.showroomGrid,s=()=>Ts(r);a===0?s():window.requestIdleCallback?requestIdleCallback(s,{timeout:2e3}):setTimeout(s,0)})}function Bs(){return xe.flatMap(e=>e.rows.map(t=>({section:e,row:t})))}function Rs(e,t){const a=e.id||"";return a==="local-houses"||a==="modern-luxury"?["houses"]:a==="commercial-land"?["land"]:a==="cars"?["cars"]:a==="trucks-buses"?["trucks"]:a==="motorhomes-boats"?["rv & camper accessories"]:a==="washing-machines"?["home appliances"]:_r(t.label)}function za(e,t,a){const r=String(e||"").toLowerCase();return r==="all"||!r||Rs(t,a).includes(r)?!0:String(a.label||"").toLowerCase()===r||String(t.label||"").toLowerCase()===r}function Ya(e,t){const a=Bs();let r=!1;a.forEach(({section:o,row:n})=>{const i=e.querySelector(`[data-row-id="${n.id}"]`);if(!i)return;const l=t(o,n);i.style.display=l?"":"none",l&&(r=!0)}),e.querySelectorAll(".showroom-section").forEach(o=>{const n=o.querySelectorAll('.showroom-row:not([style*="display: none"])');o.style.display=n.length>0?"":"none"});const s=e.querySelector("[data-category-empty]");r?s&&s.remove():s||(e.insertAdjacentHTML("beforeend",'<div data-category-empty class="category-empty flex flex-col items-center justify-center text-center py-16 px-4"><span class="w-14 h-14 rounded-2xl bg-gray-100 border border-gray-200 flex items-center justify-center mb-4"><i data-lucide="package-open" class="w-7 h-7 text-gray-400"></i></span><p class="text-sm font-bold text-gray-700">No products available in this category yet</p><p class="text-xs text-gray-500 mt-1">Check back soon — new items are added regularly.</p></div>'),window.lucide&&window.lucide.createIcons())}function js(e){const t=document.querySelector('[data-showroom-grid="real-estate"]');t&&(Ya(t,(a,r)=>za(e,a,r)),t.scrollIntoView({behavior:"smooth",block:"start"}))}function Hs(){document.querySelectorAll("[data-showroom-grid]").forEach(t=>{t.querySelectorAll(".showroom-row, .showroom-section").forEach(r=>{r.style.display=""});const a=t.querySelector("[data-category-empty]");a&&a.remove()})}const Ps={fashion:["women","men","kids","fashion","beauty","jewel","watch","shoe","handbag","apparel","dress","baby"],electronics:["electronic","phone","computer","laptop","gaming","camera","software","digital","tv","audio","appliance"],realestate:["real estate","houses","homes","apartment","villa","mansion","land","commercial","hotel","condominium","property","beach house","farm house","estate"],home:["home","furniture","kitchen","garden","decor","pool","spa","cleaning","laundry","bedroom","bathroom"],vehicles:["car","motorcycle","truck","bicycle","marine","boating","rv","camper","auto","vehicle"],sports:["sport","fitness","camping","hiking","outdoor","gym","athletic","bike"],everyday:["food","grocer","pet","book","toy","office","health","medical","music","instrument","art","craft","service","travel","luggage","religious","flower","gift","party","wedding","costume","coin","funeral","packaging","safety","security","industrial","business","educational","collectible","fireplace","pharmacy"]};async function Ka(){const e=new Map,t=(c,d,u=1)=>{if(!c)return;let p=String(c).trim();const y={"Cars & Vehicles":"Cars","Houses & Real Estate":"Houses","Real Estate":"Houses"};y[p]&&(p=y[p]),e.has(p)||e.set(p,{name:p,count:0,subs:new Set});const g=e.get(p);g.count+=u,d&&g.subs.add(String(d).trim())};[...Fe,...X()].forEach(c=>t(c.category,c.subcategory)),Tt.forEach(c=>t(c.category,c.subcategory)),Oe.forEach(c=>t(c.category,c.subcategory)),We.forEach(c=>t(c.category,c.subcategory));const a=new Set((X()||[]).map(c=>String(c.category||"").trim()).filter(Boolean));e.forEach((c,d)=>{a.has(d)||(c.count||0)>0||e.delete(d)});const r={fashion:{label:"Fashion",icon:"shopping-bag",color:"pink"},electronics:{label:"Electronics",icon:"smartphone",color:"blue"},home:{label:"Home",icon:"home",color:"emerald"},vehicles:{label:"Vehicles",icon:"car-front",color:"red"},realestate:{label:"Real Estate",icon:"building-2",color:"slate"},sports:{label:"Sports",icon:"dumbbell",color:"lime"},everyday:{label:"Everyday",icon:"shopping-basket",color:"amber"}},o=["fashion","electronics","home","vehicles","realestate","sports","everyday"].map(c=>({id:c,...r[c],categories:[]})),n={id:"more",label:"More",icon:"grid",color:"gray",categories:[]},i=["fashion","electronics","realestate","home","vehicles","sports","everyday"];e.forEach((c,d)=>{const u=d.toLowerCase(),p=i.find(g=>Ps[g].some(h=>u.includes(h)));(o.find(g=>g.id===p)||n).categories.push(c)});const l=o.map(c=>(c.categories.sort((d,u)=>u.count-d.count),c)).filter(c=>c.categories.length);return n.categories.length&&l.push(n),l}async function Ns(e){const t=await Ka();let a=[];t.forEach(r=>{r.id===e&&(a=r.categories.map(s=>s.name))}),Za(a.length?a:[e])}function Za(e){const t=document.querySelector('[data-showroom-grid="real-estate"]');if(!t)return;const a=(e||[]).map(r=>String(r).toLowerCase()).filter(Boolean);Ya(t,(r,s)=>a.length===0?!0:a.some(o=>za(o,r,s)))}let Xt=!1;const Qt={"Real Estate":{section:"local-houses",row:"affordable-homes"},Apartments:{section:"local-houses",row:"apartment-homes"},Villas:{section:"modern-luxury",row:"modern-homes"},Mansions:{section:"modern-luxury",row:"mansion-homes"},"Beach Houses":{section:"local-houses",row:"beach-houses"},"Luxury Condominiums":{section:"modern-luxury",row:"modern-homes"},"Farm Houses":{section:"modern-luxury",row:"farm-house"},"Commercial Buildings":{section:"commercial-land",row:"commercial"},Hotels:{section:"commercial-land",row:"hotels"},Cars:{section:"cars",row:"all-cars"},Motorhomes:{section:"motorhomes-boats",row:"all-motorhomes"},Trucks:{section:"trucks-buses",row:"all-trucks"}},ea=[{keywords:["car","vehicle","auto","sedan","suv"],target:{section:"cars",row:"all-cars"}},{keywords:["truck","pickup","lorry"],target:{section:"trucks-buses",row:"all-trucks"}},{keywords:["motorhome","camper","rv"],target:{section:"motorhomes-boats",row:"all-motorhomes"}},{keywords:["apartment","condo","flat"],target:{section:"local-houses",row:"apartment-homes"}},{keywords:["villa","luxury home"],target:{section:"modern-luxury",row:"modern-homes"}},{keywords:["mansion","estate"],target:{section:"modern-luxury",row:"mansion-homes"}},{keywords:["beach","coastal"],target:{section:"local-houses",row:"beach-houses"}},{keywords:["farm"],target:{section:"modern-luxury",row:"farm-house"}},{keywords:["commercial","retail","store"],target:{section:"commercial-land",row:"commercial"}},{keywords:["hotel","hospitality"],target:{section:"commercial-land",row:"hotels"}}];function Os(e,t){if(!e)return null;const a=Qt[e];if(a)return a;const r=e.toLowerCase();for(const[s,o]of Object.entries(Qt))if(s.toLowerCase()===r)return o;for(const{keywords:s,target:o}of ea)if(s.some(n=>r.includes(n)))return o;if(t){const s=t.toLowerCase();for(const{keywords:o,target:n}of ea)if(o.some(i=>s.includes(i)))return n}return null}async function ta(){gs(),bs(),ns(),wr(),Te();const e=Promise.all([ge(),wt()]).catch(()=>{});try{await e,await xs();const t=X(),a=new Set(Fe.map(s=>s.property_id)),r=t.filter(s=>!a.has(s.property_id));if(r.length>0&&!Xt){Xt=!0;for(const o of r){const n=Os(o.category,o.subcategory);if(!n)continue;const i=xe.find(c=>c.id===n.section);if(!i)continue;const l=i.rows.find(c=>c.id===n.row);l&&(l.ids||(l.ids=[]),l.ids.includes(o.property_id)||l.ids.push(o.property_id))}const s=xe.find(o=>o.id==="products");if(s){const o=fs();o.length&&(s.rows=o)}}}catch{}document.querySelectorAll("[data-showroom-grid]").forEach(t=>{delete t.dataset.initialized,delete t.dataset.prerendered,t.innerHTML=""});try{Te()}catch{document.querySelectorAll("[data-showroom-grid]").forEach(t=>{delete t.dataset.initialized,delete t.dataset.prerendered,t.children.length===0&&(t.innerHTML="")}),Te()}window.dispatchEvent(new CustomEvent("showroom-categories-ready"))}window._filterShowroomByCategory=js;window._clearShowroomFilter=Hs;window._filterShowroomByDepartment=Ns;window._filterShowroomByCategories=Za;window._getShowroomCategoryInventory=Ka;ge().catch(()=>{});document.querySelector("[data-showroom-grid]")&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>ta()):ta());const Ws="/verified-badge.svg",ze="Weverse Online Shop",Fs="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Vs="/w-logo.svg",Ds=(e="weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")=>`<svg viewBox="0 0 24 24" class="${e}" aria-label="Verified" role="img" data-weverse-badge="true"><circle cx="12" cy="12" r="11" fill="#3b82f6"/><path d="M10.8 15.6 7.4 12.2l1.5-1.5 1.9 1.9 3.9-3.9 1.5 1.5-5.4 5.4z" fill="#fff"/></svg>`,Ja=(e="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8")=>`  <svg viewBox="0 0 24 24" class="${e}" fill="none" aria-hidden="true"><path d="M3 5l4.5 14L12 8l4.5 11L21 5" stroke="#ffffff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/></svg>`,St="weverse_brand_v1";(function(){if(document.getElementById("wv-brand-blue"))return;const t=document.createElement("style");t.id="wv-brand-blue",t.textContent=".brand-name{background:linear-gradient(135deg,#3b82f6,#2563eb)!important;-webkit-background-clip:text!important;background-clip:text!important;-webkit-text-fill-color:transparent!important;color:#2563eb!important}",(document.head||document.documentElement).appendChild(t)})();const Us="weverse_brand_override_v1",Gs=5*60*1e3;async function Pt(){try{const e=JSON.parse(localStorage.getItem(Us)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(St)||"{}");if(e.ts&&Date.now()-e.ts<Gs&&e.data)return e.data}catch{}try{const e=await Ve(),{data:t}=await e.from("site_settings").select("brand_name,brand_slogan,brand_logo,brand_badge,brand_favicon,brand_mobile_logo,brand_header_logo,brand_footer_logo,brand_primary_color,brand_secondary_color,brand_tagline_color1,brand_tagline_color2,brand_font,brand_custom_font,brand_website_url,brand_email,site_name,site_tagline,homepage_banner_image,homepage_banner_alt").limit(1).maybeSingle(),a=t||{};return localStorage.setItem(St,JSON.stringify({ts:Date.now(),data:a})),a}catch{return{}}}function Nt(e){if(!e)return;const t=e.brand_name||e.site_name||ze,a=e.brand_slogan||e.site_tagline||Fs,r=e.brand_logo||e.brand_header_logo||Vs,s=e.brand_badge||Ws,o=e.brand_favicon||"",n=e.brand_custom_font||e.brand_font||"",i=e.brand_primary_color||"",l=e.brand_secondary_color||"",c=e.brand_tagline_color1||"",d=e.brand_tagline_color2||"";if(zs(e.homepage_banner_image||"",e.homepage_banner_alt||"Homepage header banner"),(c||d)&&(document.querySelectorAll(".brand-tagline-1").forEach(u=>{c&&(u.style.color=c)}),document.querySelectorAll(".brand-tagline-2").forEach(u=>{d&&(u.style.color=d)})),document.title&&!document.title.startsWith(t)&&(document.title=document.title.replace(/^[^|]+\|/,t+" |").replace(/^[^–]+–/,t+" – ")),o){let u=document.querySelector("link[rel~='icon']");u||(u=document.createElement("link"),u.rel="icon",document.head.appendChild(u)),u.href=o}if(i||l||n){const u=n?`'${n}'`:null,p=document.getElementById("brand-css-vars")||(()=>{const y=document.createElement("style");return y.id="brand-css-vars",document.head.appendChild(y),y})();if(p.textContent=`:root {
      ${i?`--brand-primary: ${i};`:""}
      ${l?`--brand-secondary: ${l};`:""}
      ${u?`--brand-font: ${u}, system-ui, sans-serif;`:""}
    }`,n){const y="brand-gf-link";if(!document.getElementById(y)){const g=document.createElement("link");g.id=y,g.rel="stylesheet",g.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(n)}:wght@400;600;700;900&display=swap`,document.head.appendChild(g)}}}document.querySelectorAll("[data-brand]").forEach(u=>{const p=u.dataset.brand;p==="name"&&(u.textContent=t,!u.querySelector("[data-weverse-badge]")&&!u.parentElement?.querySelector("[data-weverse-badge]")&&u.appendChild(Object.assign(document.createElement("span"),{className:"inline-flex items-center ml-1 align-middle",innerHTML:Ds("weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")}))),p==="slogan"&&(u.textContent=a),p==="logo"&&(u.src=r,u.alt=t,u.style.display=""),p==="badge"&&(u.src=s,u.alt="Verified",u.style.display=""),p==="tagline"&&(u.textContent=a),p==="footer-logo"&&(e.brand_footer_logo?(u.src=e.brand_footer_logo,u.alt=t):(u.src=r,u.alt=t)),p==="mobile-logo"&&(e.brand_mobile_logo?(u.src=e.brand_mobile_logo,u.alt=t):(u.src=r,u.alt=t))}),document.querySelectorAll('img[data-brand="logo"]').forEach(u=>{const y=u.closest(".text-center")?.querySelector('h1[data-brand="name"]');y&&(y.style.display="none")}),Ys(t,a,r,s),Ks(t,a,r),He()}function zs(e,t){const a=document.getElementById("homepage-banner-shell"),r=document.getElementById("homepage-banner-image");if(!(!a||!r)){if(!e){r.removeAttribute("src"),r.alt=t,a.classList.add("hidden");return}r.alt=t,r.onload=()=>He(),r.onerror=()=>{a.classList.add("hidden"),He()},r.src!==e&&(r.src=e),a.classList.remove("hidden")}}function He(){const e=document.getElementById("site-header"),t=document.getElementById("site-categories-nav"),a=document.querySelector("main");if(!e||!t||!a)return;const r=Math.ceil(e.getBoundingClientRect().height||e.offsetHeight||0),s=Math.ceil(t.getBoundingClientRect().height||t.offsetHeight||0);t.style.top=`${r}px`;const o=window.innerWidth<640?20:12;a.style.paddingTop=`${r+s+o}px`}function Ys(e,t,a,r,s){document.querySelectorAll('header a[href="/"], header a[href="./"], header a[href="index.html"], .brand-link, #brand-link').forEach(n=>{Xa(n,e,t),n.querySelectorAll('img.brand-logo, img[data-brand="logo"]').forEach(i=>{i.src=a,i.alt=e})}),document.querySelectorAll("header span").forEach(n=>{if(n.classList.contains("brand-tagline-1")||n.classList.contains("brand-tagline-2"))return;const i=n.textContent.trim();(i==="Weverse Online Shop"||i==="KCO Global Online Marketplace"||n.classList.contains("brand-name"))&&(n.textContent=e),(i==="Your Trusted Global Shop"||i.includes("Globally")||i.includes("Worldwide")||n.classList.contains("brand-slogan"))&&(n.textContent=t)}),document.querySelectorAll('[data-brand="badge"], .brand-badge, #brand-badge').forEach(n=>{n.tagName==="IMG"&&(n.src=r,n.alt="Verified",n.style.display="")}),document.querySelectorAll('header a[href="/"] .relative.shrink-0, header a .relative.w-7').forEach(n=>{if(!n.querySelector("img.injected-logo")){const i=document.createElement("img");i.src=a,i.alt=e,i.className="injected-logo w-8 h-8 sm:w-9 sm:h-9 object-contain rounded-lg",i.onerror=()=>i.style.display="none",n.style.display="flex",n.style.alignItems="center",n.innerHTML="",n.appendChild(i)}})}function Ks(e,t,a){document.querySelectorAll("footer").forEach(r=>{Xa(r,e,t),r.querySelectorAll("img.brand-logo, img[data-brand], .footer-logo img").forEach(s=>{s.src=a,s.alt=e})})}function Xa(e,t,a){const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT),s=[];let o;for(;o=r.nextNode();){const n=o.textContent.trim();(n==="Weverse Online Shop"||n==="KCO Global Online Marketplace")&&s.push({node:o,value:t}),(n==="Your Trusted Global Shop"||n==="Global Shopping • Worldwide Delivery")&&s.push({node:o,value:a})}s.forEach(({node:n,value:i})=>{n.textContent=n.textContent.replace(n.textContent.trim(),i)})}Pt().then(Nt);window.addEventListener("load",()=>Pt().then(Nt));window.addEventListener("resize",()=>He());window.addEventListener("storage",e=>{e.key===St&&Pt().then(Nt)});function Ee(e){let t=2166136261;for(let a=0;a<e.length;a++)t^=e.charCodeAt(a),t=Math.imul(t,16777619);return t>>>0}function Zs(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let a=Math.imul(t^t>>>15,1|t);return a=a+Math.imul(a^a>>>7,61|a)^a,((a^a>>>14)>>>0)/4294967296}}const dt=["James","Emma","Liam","Olivia","Noah","Ava","Ethan","Sophia","Lucas","Mia","Daniel","Isabella","Matthew","Charlotte","Samuel","Amelia","Gabriel","Harper","Nathan","Evelyn","Caleb","Abigail","Adrian","Ella","Owen","Grace","Leo","Chloe","Julian","Nora","Mason","Aria","Elijah","Layla","Isaac","Zoe","Hunter","Scarlett","Christian","Lily","Aaron","Hannah","Dylan","Savannah","Andrew","Ruby","David","Elena","Ryan","Nina","Marcus","Priya","Kwame","Fatima","Andre","Yuki","Tomas","Ingrid","Mateo","Sofia","Omar","Zara","Felix","Amara","Jonas","Leila","Victor","Mila","Diego","Iris","Hugo","Camila","Adam","Freya","Oscar","Amina","Peter","Naomi","Elias","Lucia","Ray","Talia","Marco","Sienna","Joshua","Anya","Kofi","Petra"],Le=["Anderson","Baker","Carter","Diaz","Evans","Foster","Garcia","Harris","Ingram","Johnson","Kelly","Lewis","Miller","Nelson","Ortiz","Parker","Quinn","Reed","Sanders","Turner","Underwood","Vaughn","Walker","Young","Zimmerman","Brooks","Coleman","Dunn","Fisher","Grant","Hayes","Jordan","Knight","Lopez","Morgan","Nguyen","Okafor","Peterson","Romano","Silva","Thompson","Umeh","Volkov","Wang","Xu","Yates","Zhou","Bennett","Chukwu","Doyle","Eze","Ferreira","Gonzalez","Hansen","Ivanov","Jansen","Kumar","Larsen","Moreau","Novak","Osei","Patel","Quintero","Rossi","Schmidt","Tavares","Ueda","Vasquez","Weber","Xavier","Yamamoto","Ziegler","Adeyemi","Barlow","Costa","Diop","Eriksen","Fontaine","Gomez","Holmes","Ikram","Juma","Karlsson","Lawson","Mensah","Nilsson"],aa=[{city:"Austin",country:"United States"},{city:"New York",country:"United States"},{city:"Seattle",country:"United States"},{city:"Los Angeles",country:"United States"},{city:"Chicago",country:"United States"},{city:"Boston",country:"United States"},{city:"San Diego",country:"United States"},{city:"Denver",country:"United States"},{city:"Miami",country:"United States"},{city:"Portland",country:"United States"},{city:"Toronto",country:"Canada"},{city:"Vancouver",country:"Canada"},{city:"Montreal",country:"Canada"},{city:"Calgary",country:"Canada"},{city:"Ottawa",country:"Canada"},{city:"London",country:"United Kingdom"},{city:"Manchester",country:"United Kingdom"},{city:"Birmingham",country:"United Kingdom"},{city:"Edinburgh",country:"United Kingdom"},{city:"Glasgow",country:"United Kingdom"},{city:"Bristol",country:"United Kingdom"},{city:"Liverpool",country:"United Kingdom"},{city:"Dublin",country:"Ireland"},{city:"Cork",country:"Ireland"},{city:"Paris",country:"France"},{city:"Lyon",country:"France"},{city:"Marseille",country:"France"},{city:"Berlin",country:"Germany"},{city:"Munich",country:"Germany"},{city:"Hamburg",country:"Germany"},{city:"Frankfurt",country:"Germany"},{city:"Amsterdam",country:"Netherlands"},{city:"Rotterdam",country:"Netherlands"},{city:"Brussels",country:"Belgium"},{city:"Antwerp",country:"Belgium"},{city:"Zurich",country:"Switzerland"},{city:"Geneva",country:"Switzerland"},{city:"Vienna",country:"Austria"},{city:"Rome",country:"Italy"},{city:"Milan",country:"Italy"},{city:"Florence",country:"Italy"},{city:"Madrid",country:"Spain"},{city:"Barcelona",country:"Spain"},{city:"Valencia",country:"Spain"},{city:"Lisbon",country:"Portugal"},{city:"Porto",country:"Portugal"},{city:"Stockholm",country:"Sweden"},{city:"Gothenburg",country:"Sweden"},{city:"Oslo",country:"Norway"},{city:"Copenhagen",country:"Denmark"},{city:"Helsinki",country:"Finland"},{city:"Reykjavik",country:"Iceland"},{city:"Warsaw",country:"Poland"},{city:"Krakow",country:"Poland"},{city:"Prague",country:"Czech Republic"},{city:"Athens",country:"Greece"},{city:"Sydney",country:"Australia"},{city:"Melbourne",country:"Australia"},{city:"Brisbane",country:"Australia"},{city:"Perth",country:"Australia"},{city:"Adelaide",country:"Australia"},{city:"Auckland",country:"New Zealand"},{city:"Wellington",country:"New Zealand"},{city:"Christchurch",country:"New Zealand"},{city:"Singapore",country:"Singapore"},{city:"Tokyo",country:"Japan"},{city:"Osaka",country:"Japan"},{city:"Kyoto",country:"Japan"},{city:"Seoul",country:"South Korea"},{city:"Busan",country:"South Korea"},{city:"Dubai",country:"United Arab Emirates"},{city:"Abu Dhabi",country:"United Arab Emirates"},{city:"Doha",country:"Qatar"},{city:"Tel Aviv",country:"Israel"},{city:"Taipei",country:"Taiwan"},{city:"Hong Kong",country:"Hong Kong"}],Ie=["just ordered from this shop and it was so easy fr","first time buying here and honestly impressed ngl","checked out in like 2 minutes, easiest thing ever","was a little skeptical at first but it all worked out","placed my order from my phone, super smooth","i've ordered here a few times and it never lets me down","took a chance on this store and zero regrets","signing up and ordering took no time at all","everything from picking to paying was really simple","first international order and it went perfectly 🙏","lowkey wasn't expecting much but it was great","order went through instantly, no drama","the site is so easy to use, even i managed it lol","been shopping online for years, this one stands out","quick and painless, just how online shopping should be","had a tiny doubt before ordering but it was fine","the whole process felt very professional","just what i needed, no stress, no hassle","my cousin recommended this shop and he was right","ordered without overthinking and it paid off"],F=["shipping was mad fast, arrived way earlier than expected","my package came in perfect condition 🔥","the delivery guy was super nice and careful","got updates the entire time, no guessing","tracking was accurate and it showed up on time","packaging was really solid, nothing was damaged","they answered my question in like 10 minutes","customer service was actually helpful, rare these days","everything arrived exactly as described","the parcel was wrapped so well, impressive","it showed up a day early, which was a nice surprise","payment was secure and confirmation came right away","kept me posted at every single step","dispatching was quick, shipped the same day","the item looked even better in person","my order was handled with so much care","they were super responsive whenever i messaged","the tracking link actually worked the whole way","delivery was on schedule, not a minute late","everything came neatly packed and in one piece","no issues at all, straight to my door","they followed up after delivery which i thought was nice","the whole team was polite and professional","my doubts disappeared once the package arrived","quality was clear as soon as i opened the box","support replied quickly even though it was late","well organized from start to finish","came when they said it would, no surprises","fast dispatch and smooth handling of my order","the notifications kept me calm the whole time lol","everything i ordered was in the box, nothing missing","the courier called before arriving, so professional","shipped in sturdy packaging, survived the trip perfectly","i could track it the whole way, very reassuring","they processed my order in record time","came in perfect shape and very well protected","every update they sent was accurate and clear","exactly the delivery experience you hope for","returns and support were straightforward too","very clean, well managed order, i was impressed"],ut=["100% ordering again fr","would recommend this shop to anyone","already told my friends about it","this is my new go to place now","can't recommend them enough","definitely coming back, no question","so glad i found this store","will 100% be back 💯","no complaints at all honestly","totally worth it, trust me","10/10 experience, easy","this shop is legit, trust","loyal customer for life now","five stars from me, easy","a real hidden gem honestly","can't wait for my next order"],ra={vehicle:["my vehicle was delivered safe and sound, kept me updated the whole trip","the listing was exact and delivery was arranged super smoothly"],property:["the listing was spot on and they walked me through the whole process","all the paperwork was handled clean, very easy from start to finish"],phone:["the phone matched the photos exactly and shipped out quick","they double checked everything before sending, packaging was solid"],pet:["they handled everything so carefully, i felt reassured the whole way","all the paperwork was sorted out and the process was really easy"],product:["the item was exactly like the photos, arrived in great shape","order was processed fast and the packaging was really solid"]},sa=["🔥","✨","😍","🙌","💯","😭","❤️","👍","🎯","👌","✅","⚡","📦","🙏"],Qa=[{year:2018,w:3},{year:2019,w:7},{year:2020,w:11},{year:2021,w:13},{year:2022,w:15},{year:2023,w:16},{year:2024,w:15},{year:2025,w:12},{year:2026,w:8}],Js=Qa.reduce((e,t)=>e+t.w,0);function Xs(e){let t=e()*Js;for(const a of Qa){if(t<a.w)return a.year;t-=a.w}return 2024}function pt(e,t,a,r){return(e+t*a)%r}function Qs(e,t={}){const a=String(e.property_id||e.id||"");if(!a)return{reviews:[],breakdown:{5:0,4:0,3:0,2:0,1:0},total:0,computedRating:0};const r=Ee(a),s=187+r%660,n=Math.min(5,Math.max(1,Number(e.rating)||0))||4.5;let i=Math.max(.3,Math.min(.9,n/5)),l=1-i,c=.07,d=.04,u=.03;const p=1/(i+l+c+d+u);i*=p,l*=p,c*=p,d*=p,u*=p;const y=[i,l,c,d,u],g=e.listing_type==="vehicle"?"vehicle":e.listing_type==="property"?"property":e.listing_type==="pet"?"pet":String(e.category||"").toLowerCase().includes("phone")?"phone":"product",h=ra[g]||ra.product,x=[],_=dt.length*Le.length,C=Ie.length*F.length*F.length*ut.length,E=457,I=811;for(let w=0;w<s;w++){const R=Zs(Ee(a+"::"+w));let ce=R(),f=5,S=0;for(let Ce=5;Ce>=1;Ce--)if(S+=y[5-Ce],ce<=S){f=Ce;break}const K=pt(r,w,E,_),M=dt[Math.floor(K/Le.length)%dt.length],Z=Le[K%Le.length],T=`${M} ${Z}`;let $=pt(r,w,I,C);const Se=Ie[$%Ie.length];$=Math.floor($/Ie.length);const st=F[$%F.length];$=Math.floor($/F.length);const $e=F[$%F.length];$=Math.floor($/F.length);const dr=ut[$%ut.length];let de=`${Se} ${st}`;w%3===0&&h.length&&(de+=` ${h[w%h.length]}`),w%2===0&&(de+=` ${$e}`),de+=` ${dr}`,w%3===2&&(de+=` ${sa[(r+w*13)%sa.length]}`);const ur=aa[pt(r,w,337,aa.length)],pr=Date.now(),Wt=Xs(R),mr=Wt===2018?10+Math.floor(R()*3):1+Math.floor(R()*12),hr=1+Math.floor(R()*28),fr=Date.UTC(Wt,mr-1,hr),br=new Date(Math.min(fr,pr)).toISOString(),gr=`@${M.toLowerCase()}${Z.toLowerCase()}`,yr=2+Ee(a+"::likes::"+w)%380,xr=w%7===0?1+Ee(a+"::rep::"+w)%4:0;x.push({name:T,handle:gr,location:ur.country,date:br,rating:f,text:de,likes:yr,replies:xr,verified:!1,seeded:!0})}x.sort((w,R)=>w.date<R.date?1:-1);const b={5:0,4:0,3:0,2:0,1:0};let P=0;for(let w=5;w>=1;w--)b[w]=Math.round(s*y[5-w]),P+=b[w];const A=s-P;A!==0&&(b[A>0?5:1]+=A);let Y=0;for(let w=5;w>=1;w--)Y+=w*b[w];const ee=Y/s;return{reviews:x,breakdown:b,total:s,computedRating:ee}}let ue="pending",ae=null;const $t=e=>`kco_review_likes_${e}`,Ct=e=>`kco_review_comments_${e}`;function Pe(e){try{return JSON.parse(localStorage.getItem(e)||"null")}catch{return null}}function er(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}}async function Et(){try{ae||(ae=await O()||null)}catch{ae=null}if(ae&&ae.id)return"u:"+ae.id;try{let e=localStorage.getItem("kco_anon_id");return e||(e="anon-"+Math.random().toString(36).slice(2)+Date.now().toString(36),localStorage.setItem("kco_anon_id",e)),e}catch{return"anon-"+Math.random().toString(36).slice(2)+Date.now().toString(36)}}async function Ot(){if(ue!=="pending")return ue;try{const{error:e}=await v.from("review_likes").select("id").limit(1),{error:t}=await v.from("review_comments").select("id").limit(1);ue=e||t?"local":"server"}catch{ue="local"}return ue}async function tr(e){const t=new Map,a=new Set,r=new Map,s=String(e||"");try{if(await Ot()==="server"){const[{data:o},{data:n}]=await Promise.all([v.from("review_likes").select("review_key, liker_id").eq("property_id",s),v.from("review_comments").select("*").eq("property_id",s).order("created_at",{ascending:!0})]),i=await Et();for(const l of o||[])t.set(l.review_key,(t.get(l.review_key)||0)+1),l.liker_id===i&&a.add(l.review_key);for(const l of n||[]){const c=r.get(l.review_key)||[];c.push({id:l.id,author:l.author,body:l.body,created_at:l.created_at}),r.set(l.review_key,c)}}else{const o=Pe($t(s))||{},n=await Et();for(const[l,c]of Object.entries(o)){const d=Array.isArray(c)?c:[];t.set(l,d.length),d.includes(n)&&a.add(l)}const i=Pe(Ct(s))||{};for(const[l,c]of Object.entries(i))Array.isArray(c)&&r.set(l,c)}}catch{}return{likes:t,liked:a,comments:r}}async function eo(e,t){const a=String(e||""),r=!1;try{const s=await Et();if(await Ot()==="server"){const{data:l}=await v.from("review_likes").select("id").eq("review_key",t).eq("liker_id",s).limit(1);if(l&&l.length){const{error:d}=await v.from("review_likes").delete().eq("review_key",t).eq("liker_id",s);return{liked:d?r:!1}}const{error:c}=await v.from("review_likes").insert({property_id:a,review_key:t,liker_id:s});return{liked:!c}}const o=Pe($t(a))||{},n=Array.isArray(o[t])?o[t]:[],i=n.indexOf(s);return i>=0?n.splice(i,1):n.push(s),o[t]=n,er($t(a),o),{liked:i<0}}catch{return{liked:r}}}async function to(e,t,a,r){const s=String(e||""),o=String(r||"").trim().slice(0,1e3),n=String(a).trim().slice(0,40)||"Guest";if(!o)return null;try{if(await Ot()==="server"){const{data:d,error:u}=await v.from("review_comments").insert({property_id:s,review_key:t,author:n,body:o}).select("id, author, body, created_at").single();if(!u&&d)return d}}catch{}const i={id:"c_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,8),author:n,body:o,created_at:new Date().toISOString()},l=Pe(Ct(s))||{},c=Array.isArray(l[t])?l[t]:[];return c.push(i),l[t]=c,er(Ct(s),l),i}const mt="support@weverseonlineshop.com",ao="weverse_brand_v1";function q(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ar(){try{const e=JSON.parse(localStorage.getItem(ao)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function ro(){const e=ar(),t=e.brand_name||e.site_name||ze;return`
    ...
    </section>`}const oa=[{id:"trust-shipping",icon:"package",tone:"blue",title:"Shipping & Delivery",body:`
    ...
    </div>`}function no(){const e=oa.slice(0,6),t=oa.slice(6),a=r=>r.map(oo).join("");return`
    ...
    </section>`}const io=[{name:"Amina K.",country:"Nigeria",text:"My order arrived ahead of schedule and the quality was exactly as described. I shop here without any doubt.",verified:!0},{name:"Sarah & James",country:"United States",text:"Ordered for our whole family — tracking updates made it feel safe and reliable from checkout to delivery.",verified:!0},{name:"Priya S.",country:"India",text:"The customer support team answered my questions in minutes. Genuinely trustworthy shopping experience.",verified:!0}];function lo(e){return[1,2,3,4,5].map(t=>`<i data-lucide="star" class="w-3.5 h-3.5 ${t<=e?"fill-amber-400 text-amber-400":"text-slate-500"}"></i>`).join("")}function Lt(e){const t=String(e.name||"Verified shopper").trim()||"Verified shopper",a=(t.charAt(0)||"V").toUpperCase(),r=[e.country||"",e.verified?"Verified buyer":"",e.date||""].filter(Boolean).join(" · ");return`
    <div class="bg-white/[.07] border border-white/10 rounded-2xl p-4 backdrop-blur flex flex-col">
      <div class="flex items-center gap-1 mb-2.5">${lo(e.rating||5)}</div>
      ...
      <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 pt-14 sm:pt-20 pb-8 sm:pb-10">
        ...
        <div class="text-center max-w-3xl mx-auto">
          <div class="mx-auto w-16 h-16 rounded-2xl bg-white/[.07] border border-white/10 flex items-center justify-center overflow-hidden backdrop-blur">
            ...
            <span style="display:none">${Ja("w-9 h-9")}</span>
          </div>
        ...
        <div class="mt-12 max-w-4xl mx-auto rounded-3xl border border-white/10 bg-white/[.05] backdrop-blur-md p-6 sm:p-8">
          <div class="flex flex-col lg:flex-row items-center gap-6 justify-between text-center lg:text-left">
            ...
            <div class="flex flex-col sm:flex-row gap-3 shrink-0">
              <a href="mailto:${q(mt)}" class="btn-press inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-sm px-6 py-3.5 rounded-2xl shadow-xl shadow-blue-900/30 hover:scale-[1.03] active:scale-[.98] transition">
          ...
          <div class="mt-6 pt-5 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-3 text-center text-[11px] text-slate-400">
            <span class="inline-flex items-center justify-center gap-1.5"><i data-lucide="mail" class="w-3.5 h-3.5 text-cyan-300"></i> ${q(mt)}</span>
    ...
    </section>`}function po(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-acc]");if(!a)return;const r=a.dataset.acc,s=e.querySelector(`[data-acc-body="${r}"]`),o=e.querySelector(`[data-acc-icon="${r}"]`);if(!s)return;s.dataset.open==="1"?(s.style.maxHeight="0px",s.style.opacity="0",s.dataset.open="0",o.classList.remove("rotate-180"),a.setAttribute("aria-expanded","false")):(s.style.maxHeight=s.scrollHeight+"px",s.style.opacity="1",s.dataset.open="1",o.classList.add("rotate-180"),a.setAttribute("aria-expanded","true"))})}function la(e){const t=document.querySelectorAll("[data-bg-slot]");t.length&&t.forEach(a=>{const r=a.dataset.bgSlot;r==="trust_promo"?a.innerHTML=Be(e.trust_promo_bg_image,e.trust_promo_bg_video):r==="reviews"&&(a.innerHTML=Be(e.reviews_bg_image,e.reviews_bg_video))})}function mo(e){const t=e.querySelector("#fb-stars");t&&t.addEventListener("click",s=>{const o=s.target.closest(".fb-star");if(!o)return;const n=parseInt(o.dataset.star,10),i=e.querySelector("#fb-rating");i&&(i.value=String(n)),t.querySelectorAll(".fb-star").forEach((l,c)=>{const d=l.querySelector("i, svg");d&&(c<n?(d.classList.add("fill-amber-400","text-amber-400"),d.classList.remove("text-slate-500")):(d.classList.remove("fill-amber-400","text-amber-400"),d.classList.add("text-slate-500")))})});const a=e.querySelector("#fb-form");a&&a.addEventListener("submit",s=>{s.preventDefault(),ho(a)});const r=e.querySelector("[data-feedback-backtop]");r&&r.addEventListener("click",()=>{const s=e.querySelector('[data-acc="trust-reviews-more"]');s&&s.click();const o=document.getElementById("customer-feedback");o&&o.scrollIntoView({behavior:"smooth",block:"start"})})}function ht(e,t,a){const r=e.closest("#customer-feedback")?.querySelector("#fb-msg");r&&(r.textContent=t,r.classList.remove("hidden","text-emerald-300","text-amber-300"),a&&r.classList.add(a))}async function ho(e){const a=(e.querySelector("#fb-text")?.value||"").trim();if(!a){ht(e,"Please write your feedback first.","text-amber-300");return}const r=e.querySelector("[type=submit]"),s=r.innerHTML;if(r.disabled=!0,r.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Sending…',window.lucide)try{lucide.createIcons()}catch{}try{const o=await Ve();let n=null;try{n=(await o.auth.getUser()).data?.user?.id||null}catch{}const{error:i}=await o.from("site_feedback").insert({user_id:n,name:e.querySelector("#fb-name")?.value.trim()||"Anonymous shopper",email:e.querySelector("#fb-email")?.value.trim()||"",rating:parseInt(e.querySelector("#fb-rating")?.value||"5",10),feedback:a,is_approved:!1});if(i)throw new Error(i.message);ht(e,"✓ Thank you! Your feedback has been sent.","text-emerald-300"),e.reset();const l=e.closest("#customer-feedback")?.querySelector("#fb-stars");l&&l.querySelectorAll(".fb-star").forEach(c=>{const d=c.querySelector("i, svg");d&&(d.classList.remove("fill-amber-400","text-amber-400"),d.classList.add("text-slate-500"))})}catch{ht(e,"Could not send your feedback right now. Please try again later.","text-amber-300")}if(r.disabled=!1,r.innerHTML=s,window.lucide)try{lucide.createIcons()}catch{}}async function fo(e){const t=e?.querySelector("#fb-more-list");if(t)try{const a=await Ve(),{data:r,error:s}=await a.from("site_feedback").select("name,rating,feedback,created_at").eq("is_approved",!0).order("created_at",{ascending:!1}).limit(30);if(s||!r||!r.length)return;const o=r.map(n=>Lt({name:n.name||"Verified shopper",text:n.feedback||"",rating:n.rating||5,verified:!0,country:"Verified customer",date:n.created_at?new Date(n.created_at).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):""})).join("");t.innerHTML=o+t.innerHTML}catch{}}function bo(){if(document.getElementById("trust-info-style"))return;const e=document.createElement("style");e.id="trust-info-style",e.textContent=`
    .trust-acc-body{overflow:hidden;max-height:0;opacity:0;transition:max-height .38s cubic-bezier(.2,.8,.2,1),opacity .28s ease}
    .trust-acc-body[data-open="1"]{opacity:1}`,document.head.appendChild(e)}async function ca(){if(document.body&&document.body.dataset.homepage==="true")return;const e=document.getElementById("trust-info-area");if(!e)return;bo();let t={...De};try{t=await kt()}catch{}if(e.innerHTML=[ro(),so(),no(),uo(),ia(t)].join(""),window.lucide)try{lucide.createIcons()}catch{}po(e),mo(e),fo(e);let a={...ka};try{a=await ye()}catch{}la(a),window.addEventListener("promo-backgrounds-updated",()=>{ye().then(la).catch(()=>{})}),window.addEventListener("site-content-updated",()=>{kt().then(r=>{const s=e.querySelector("#site-closing-section");if(s&&(s.outerHTML=ia(r)),window.lucide)try{lucide.createIcons()}catch{}}).catch(()=>{})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ca):ca();const go="/fallback.svg";function j(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function rr(e){return Array.isArray(e.images)?e.images.filter(Boolean):typeof e.images=="string"?[e.images]:[]}function It(e){return rr(e)[0]||go}function yo(e){const t=parseFloat(e.real_price),a=parseFloat(e.price);return!(t>0)||!(a>0)||t<=a?null:{real:t,price:a,pct:Math.round((1-a/t)*100)}}function At(e){const t=yo(e),a=z(e),r=t?z({price:t.real,currency:e.currency,price_period:e.price_period}):"",s=t?`<span class="text-gray-400 line-through">${r}</span> `:"",o=t?`<span class="inline-block bg-red-500 text-white text-[10px] font-black px-1.5 py-0.5 rounded-full">-${t.pct}%</span>`:"";return`${s}<span class="font-black">${a}</span> ${o}`}let re=[],ft=!1;function xo(e){const t=new Set,a=[];for(const r of e){if(!r)continue;const s=r.property_id||r.id;!s||t.has(s)||(t.add(s),a.push(r))}return a}async function wo(){if(ft&&re.length)return re;try{let e=[];try{await ge(),e=X()||[]}catch{}let t=xo([...e,..._a()||[]]);t=t.map(a=>{try{return qt({...a})}catch{return a}});try{const{isCatalogListingHidden:a}=await ve(async()=>{const{isCatalogListingHidden:r}=await import("./promo-backgrounds-Cv2azssI.js").then(s=>s.z);return{isCatalogListingHidden:r}},__vite__mapDeps([0,1,2]));t=t.filter(r=>{const s=r.property_id||r.id;if(!s)return!1;try{return!a(s)}catch{return!0}})}catch{}return re=t.filter(a=>rr(a).length>0&&(a.title||a.name)),ft=!0,re}catch{return ft=!0,re}}function vo(){return re}const da="kco_promo_settings_v1",Ne={app_banner_enabled:!0,app_play_store_url:"",app_banner_headline:"Discover More with the Weverse Online Shop App",live_promo_enabled:!0,live_promo_interval_seconds:60,live_promo_first_delay_seconds:12,live_promo_product_ids:[],live_promo_use_owned_only:!1};async function ko(){try{const t=JSON.parse(localStorage.getItem(da)||"{}");if(t.ts&&Date.now()-t.ts<60*1e3&&t.data)return{...Ne,...t.data}}catch{}const e={...Ne};try{const t=await Ve(),{data:a,error:r}=await t.from("site_settings").select("app_banner_enabled,app_play_store_url,app_banner_headline,live_promo_enabled,live_promo_interval_seconds,live_promo_first_delay_seconds,live_promo_product_ids,live_promo_use_owned_only").limit(1).maybeSingle();if(!r&&a){typeof a.app_banner_enabled=="boolean"&&(e.app_banner_enabled=a.app_banner_enabled),typeof a.app_play_store_url=="string"&&(e.app_play_store_url=a.app_play_store_url.trim()),typeof a.app_banner_headline=="string"&&a.app_banner_headline.trim()&&(e.app_banner_headline=a.app_banner_headline.trim()),typeof a.live_promo_enabled=="boolean"&&(e.live_promo_enabled=a.live_promo_enabled);const s=parseInt(a.live_promo_interval_seconds,10);s>0&&(e.live_promo_interval_seconds=s);const o=parseInt(a.live_promo_first_delay_seconds,10);o>=0&&(e.live_promo_first_delay_seconds=o),Array.isArray(a.live_promo_product_ids)&&(e.live_promo_product_ids=a.live_promo_product_ids.filter(Boolean)),typeof a.live_promo_use_owned_only=="boolean"&&(e.live_promo_use_owned_only=a.live_promo_use_owned_only)}}catch{}try{localStorage.setItem(da,JSON.stringify({ts:Date.now(),data:e}))}catch{}return e}function _o(e,t,a=12){const r=t&&Array.isArray(t.live_promo_product_ids)&&t.live_promo_product_ids.length?new Set(t.live_promo_product_ids):null;let s=r?e.filter(o=>r.has(o.property_id||o.id)):e.slice();return s.length||(s=e.slice()),s.slice(0,a)}const So=()=>document.getElementById("app-promo-banner"),Mt="/fallback.svg";function $o(){return`
  ...
  <svg viewBox="0 0 560 720" class="w-full h-full block" aria-hidden="true">
  ...
  </svg>`}function Eo(e){const t=e[0],a=e[1],r=(s,o)=>{const n=j(It(s)),i=j((s.title||s.name||"").slice(0,34));return`
      <a href="/details.html?id=${encodeURIComponent(s.property_id||s.id)}"
        ...
        <div class="aspect-square bg-gray-100 overflow-hidden">
          <img src="${n}" alt="${i}" loading="lazy" decoding="async"
               class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${Mt}'">
        </div>
        <div class="p-2">
    ...
    </div>`}function Io(e,t,a){const r=_o(t,e,12),s=(e.app_play_store_url||"").trim(),o={...De,...a||{}},n=(o.app_banner_title||e.app_banner_headline||Ne.app_banner_headline).trim(),i=o.app_banner_description,l=o.app_banner_button_text,c=o.app_banner_secondary_text,d=s?`<a href="${j(s)}" target="_blank" rel="noopener" class="inline-flex items-center gap-2.5 bg-white text-blue-900 font-black text-sm px-6 py-3.5 rounded-2xl shadow-xl shadow-blue-900/30 hover:scale-[1.03] active:scale-[.98] transition">
    ...
    <section class="relative overflow-hidden bg-[#060c1c] text-white">
      ...
      <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-14 lg:py-16">
        <div class="grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-6 items-center">
          ...
          <div class="max-w-xl lg:pr-6">
            ...
            <div class="flex flex-wrap items-center gap-3.5 mt-8">
              ...
              <a href="/#showroom-directory" class="inline-flex items-center gap-2 text-sm font-bold text-cyan-200 hover:text-white transition">
                ${j(c)} <i data-lucide="arrow-right" class="w-4 h-4"></i>
              </a>
            </div>
          ...
          <div class="relative mx-auto w-full max-w-[300px] sm:max-w-[360px] lg:max-w-[440px]">
            <div class="absolute inset-0 woman-back" aria-hidden="true">${$o()}</div>
            <div class="absolute inset-0 hands-front pointer-events-none" aria-hidden="true">${Co()}</div>
    ...
    </section>`}let Ae=null;function Ao(e){Ae&&(clearInterval(Ae),Ae=null);const t=document.getElementById("promo-phone-screen"),a=document.getElementById("promo-phone-grid");if(!t||!a||!e.length)return;const r=e.slice();let s=0;const o=()=>{if(!a||!r.length)return;const n=r[s%r.length],i=r[(s+1)%r.length],l=j(It(n)),c=j(It(i)),d=j((n.title||n.name||"").slice(0,34)),u=j((i.title||i.name||"").slice(0,34));if(a.innerHTML=`
      <a href="/details.html?id=${encodeURIComponent(n.property_id||n.id)}" class="block bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition active:scale-[.98]">
        <div class="aspect-square bg-gray-100 overflow-hidden"><img src="${l}" alt="${d}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${Mt}'"></div>
      ...
      <a href="/details.html?id=${encodeURIComponent(i.property_id||i.id)}" class="block bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition active:scale-[.98]">
        <div class="aspect-square bg-gray-100 overflow-hidden"><img src="${c}" alt="${u}" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='${Mt}'"></div>
      ...
      </a>`,window.lucide)try{lucide.createIcons()}catch{}};o(),Ae=setInterval(()=>{s+=2,o()},4500)}async function ua(){if(document.body&&document.body.dataset.homepage==="true")return;const e=So();if(!e)return;let t={...Ne};try{t=await ko()}catch{}if(t.app_banner_enabled===!1)return;let a=[];try{await wo(),a=vo()||[]}catch{}const r=a.length?a:[{property_id:"browse",title:"Browse the full Weverse Online Shop",price:0,currency:"USD",images:["/fallback.svg"]}];let s={...ka};try{s=await ye()}catch{}const o=i=>{const l=e.querySelector('[data-bg-slot="app_banner"]');l&&(l.innerHTML=Be(i.app_banner_bg_image,i.app_banner_bg_video))};async function n(){let i={...De};try{i=await kt()}catch{}if(e.innerHTML=Io(t,r,i),window.lucide)try{lucide.createIcons()}catch{}Ao(r),window.dispatchEvent(new CustomEvent("app-promo-banner-ready")),o(s)}await n(),o(s),window.addEventListener("site-content-updated",()=>{n().catch(()=>{})}),window.addEventListener("promo-backgrounds-updated",()=>{ye().then(i=>{s=i,o(i)}).catch(()=>{})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ua):ua();const H="/fallback.svg";let G={likes:new Map,liked:new Set,comments:new Map},U=null,be="",he=[],fe=!1,we="";function Mo(e){let t=2166136261;for(let a=0;a<e.length;a++)t^=e.charCodeAt(a),t=Math.imul(t,16777619);return(t>>>0).toString(36)}function Ye(e){return Array.isArray(e)&&e.length>0?e:[H]}function V(e){return!e||typeof e!="string"||e.startsWith("blob:")||e.startsWith("data:")?!1:/\.(mp4|webm|mov|avi|mkv)(\?|#|$)/i.test(e)}function To(e,t="w-4 h-4"){const a=Math.round(Number(e)||0);return[1,2,3,4,5].map(r=>`<i data-lucide="star" class="${t} ${r<=a?"fill-amber-400 text-amber-400 drop-shadow-[0_1px_4px_rgba(0,0,0,.25)]":"text-gray-300"}"></i>`).join("")}function Ke(e,t,a="blue"){const r={blue:"bg-blue-50 text-blue-600",amber:"bg-amber-50 text-amber-600",emerald:"bg-emerald-50 text-emerald-600",violet:"bg-violet-50 text-violet-600",rose:"bg-rose-50 text-rose-600"};return`
    ...
    </div>`}function Me(e,t,a,r="blue"){return!a||!a.length?"":`
    <div class="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 mb-6 shadow-sm">
      ${Ke(t,e,r)}
      ${sr(a)}
    </div>`}function sr(e){return!e||!e.length?"":`<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">${e.map(qo).join("")}</div>`}function Ze(e){return!e||!e.length?"":`
    <div class="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 mb-6 shadow-sm">
      ${Ke("list-checks","Features & Amenities","emerald")}
      ${or(e)}
    </div>`}function or(e){return!e||!e.length?"":`<div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
        ${e.map(t=>`
      ...
      </div>`}function Bo(e){return!e||!e.length?"":`
    <div class="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 mb-6 shadow-sm">
      ${Ke("star","Highlights","amber")}
      ${nr(e)}
      ...
      </div>`}function bt(e,t="emerald"){if(!e||!e.length)return"";const a={emerald:"bg-emerald-100 text-emerald-600",amber:"bg-amber-100 text-amber-600",blue:"bg-blue-100 text-blue-600",violet:"bg-violet-100 text-violet-600",rose:"bg-rose-100 text-rose-600"}[t]||"bg-emerald-100 text-emerald-600";return`<div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
    ${e.map(r=>`
      <div class="flex items-center gap-2.5 bg-gray-50 border border-gray-100 rounded-xl px-3.5 py-2.5">
  ...
  </div>`}function Ro(e){const t=e.floor_plan&&typeof e.floor_plan=="object"?e.floor_plan:{},a=Array.isArray(t.rooms)?t.rooms:[];if(!(t.image||t.levels||t.total_area||a.length))return"";const s=a.length?`
    ...
    <div class="space-y-3">
      ...
      ${s}
    </div>`}function jo(e){const t=Array.isArray(e.legal_info)?e.legal_info:[],a=e.risk_notes;if(!t.length&&!a)return"";const r={"Seller provided":"bg-amber-50 text-amber-700 border-amber-200",Documented:"bg-blue-50 text-blue-700 border-blue-200","Not verified":"bg-gray-50 text-gray-600 border-gray-200"};return`
    ...
    </div>`}function Ho(e){const t=e.nearby_area&&typeof e.nearby_area=="object"?e.nearby_area:{},a=[{icon:"school",label:"Schools",items:t.schools},{icon:"cross",label:"Hospitals & Clinics",items:t.hospitals},{icon:"shopping-cart",label:"Shopping & Markets",items:t.shopping},{icon:"bus",label:"Transportation",items:t.transportation}].filter(s=>Array.isArray(s.items)&&s.items.length),r=Array.isArray(t.distances)?t.distances:[];return!a.length&&!r.length?"":`
    <div class="space-y-3">
      ${a.map(s=>`
        <div>
    ...
    </div>`}function Po(e){const t=e.verification_status||"Not verified",a={Verified:"bg-emerald-50 text-emerald-700 border-emerald-200","Pending verification":"bg-amber-50 text-amber-700 border-amber-200","Not verified":"bg-gray-50 text-gray-600 border-gray-200"}[t]||"bg-gray-50 text-gray-600 border-gray-200",r=Array.isArray(e.documents)?e.documents:[],s=[{icon:"shield-check",label:"Verification",value:t,badge:a},e.verification_date?{icon:"calendar-check",label:"Verification Date",value:e.verification_date}:null,e.inspection_info?{icon:"clipboard-check",label:"Inspection",value:e.inspection_info}:null].filter(Boolean);return`
    <div class="space-y-3">
    ...
    </div>`}window.toggleAccordion=e=>{const t=document.querySelector(`[data-acc-body="${e}"]`),a=document.querySelector(`[data-acc-icon="${e}"]`);!t||!a||(t.classList.toggle("hidden"),a.classList.toggle("rotate-180"))};function Oo(){return`
    ...
    </div>`}function Je(e,t,a,r,s,o=""){const n=e.listing_type==="property",i=`
    ...
    <button type="button" class="review-like-btn btn-press inline-flex items-center gap-1.5 text-xs font-bold transition ${y?"text-rose-500":"text-gray-500 hover:text-rose-500"}" data-key="${d}">
      <i data-lucide="heart" class="w-4 h-4 ${y?"fill-rose-500 text-rose-500":""}"></i> ${pa(p)}
    </button>`,_=`
    <button type="button" class="review-reply-toggle btn-press inline-flex items-center gap-1.5 text-xs font-bold transition ${U===d?"text-blue-600":"text-gray-500 hover:text-blue-500"}" data-key="${d}">
      <i data-lucide="message-circle" class="w-4 h-4"></i> ${h>0?`${pa(h)} replies`:"Reply"}
    </button>`;let C="";U===d&&(C=`
      <div class="review-reply-box mt-3 rounded-xl border border-gray-200 bg-gray-50/80 p-3 space-y-2">
        <input type="text" class="review-reply-name w-full rounded-lg border border-gray-300 px-3 py-2 text-sm" placeholder="Your name (optional)" maxlength="40" value="${m(be||"")}">
      ...
      </div>`);const E=g.length?`<div class="mt-2.5 space-y-2.5">${g.map(Do).join("")}</div>`:"";return`
    ...
    </div>`}function Qe(e){const t=encodeURIComponent(window.location.pathname+window.location.search);return`
          ...
          <div id="review-form-wrapper">
            ...
            <div id="review-guest-box" class="hidden space-y-3">
              ...
              <div id="review-guest-msg" class="hidden rounded-xl border border-amber-200 bg-amber-50 px-4 py-3.5 space-y-2.5">
                ...
                <p class="text-xs text-amber-700 leading-relaxed">Only customers with a ${ze} account can post reviews — this keeps our reviews real and verified. It takes less than a minute, and once you're signed in you can rate the product, write your review and even add a photo.</p>
    ...
    </div>`}function Go(e,t,a){const r=Math.max(1,a);return`
    ...
    </div>`}function zo(){return new URLSearchParams(window.location.search).get("id")}const se=[...Oe];function ma(e){return se.find(t=>t.property_id===e)||null}let gt=null;function Yo(){return gt||(gt=ve(()=>import("./promo-backgrounds-Cv2azssI.js").then(e=>e.y),__vite__mapDeps([0,1,2])).then(e=>{const t=e.PRODUCT_EXTRA_LISTINGS||[];for(const a of t)se.some(r=>r.property_id===a.property_id)||se.push(a);return se}).catch(()=>se)),gt}function Ko(e){const t=document.getElementById("details-content"),a=vt(e),s=Ye(e.images).map((d,u)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${u===0?"active border-blue-500":"border-gray-200"} shrink-0" data-img="${m(d)}">
      <img src="${m(d)}" alt="View ${u+1}" loading="lazy" class="w-20 h-16 object-cover" onerror="this.onerror=null;this.src='${H}'">
    </button>`).join(""),o=["Front View","Rear View","Left Side","Right Side","Interior Dashboard","Driver Seat","Cargo Area / Truck Bed","Engine","Wheels / Tires","Additional View"],n=[{icon:"building-2",label:"Brand",value:e.brand},{icon:"car",label:"Model",value:e.model},{icon:"calendar",label:"Model Year",value:e.model_year},{icon:"badge-check",label:"Condition",value:e.condition},{icon:"gauge",label:"Mileage",value:e.mileage},{icon:"cog",label:"Transmission",value:e.transmission},{icon:"fuel",label:"Fuel Type",value:e.fuel_type},{icon:"zap",label:"Engine",value:e.engine},{icon:"truck",label:"Drive Type",value:e.drive_type},{icon:"palette",label:"Colour",value:e.color},{icon:"package",label:"Payload Capacity",value:e.payload_capacity},{icon:"link",label:"Towing Capacity",value:e.towing_capacity},{icon:"barcode",label:"VIN",value:e.vin},{icon:"tag",label:"Stock Number",value:e.stock_number}].filter(d=>d.value!=null&&d.value!==""&&d.value!=="N/A");Ze(e.features);const i=Qe();t.innerHTML=`
    <div class="fade-in">
      <!-- Breadcrumb -->
  ...
  `;const l=document.getElementById("hero-image"),c=document.getElementById("gallery-label");t.querySelectorAll(".gallery-thumb").forEach((d,u)=>{d.addEventListener("click",()=>{t.querySelectorAll(".gallery-thumb").forEach(p=>p.classList.remove("active","border-blue-500")),t.querySelectorAll(".gallery-thumb").forEach(p=>p.classList.add("border-gray-200")),d.classList.add("active","border-blue-500"),d.classList.remove("border-gray-200"),l.src=d.dataset.img,c.textContent=o[u]||`View ${u+1}`})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await O()?window.location.href=`/checkout.html?id=${e.property_id}`:(le(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",()=>{Q(e)}),at(e),rt(e),_e(e),Xe(),window.lucide&&lucide.createIcons()}function Jo(e){const t=document.getElementById("details-content"),a=z(e),s=Ye(e.images).map((d,u)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${u===0?"active border-blue-500":"border-gray-200"} shrink-0" data-img="${m(d)}">
      <img src="${m(d)}" alt="View ${u+1}" loading="lazy" class="w-20 h-16 object-cover" onerror="this.onerror=null;this.src='${H}'">
    </button>`).join(""),o=["Front View","Rear View","Left Side","Right Side","Interior Dashboard","Driver Seat","Cabin / Interior","Wheels / Tires","Additional View"],n=[{icon:"building-2",label:"Brand",value:e.brand},{icon:"car",label:"Model",value:e.model},{icon:"calendar",label:"Model Year",value:e.model_year},{icon:"badge-check",label:"Condition",value:e.condition},{icon:"gauge",label:"Mileage",value:e.mileage},{icon:"cog",label:"Transmission",value:e.transmission},{icon:"fuel",label:"Fuel Type",value:e.fuel_type},{icon:"zap",label:"Engine",value:e.engine},{icon:"truck",label:"Drive Type",value:e.drive_type},{icon:"palette",label:"Colour",value:e.color},{icon:"barcode",label:"VIN",value:e.vin},{icon:"tag",label:"Stock Number",value:e.stock_number}].filter(d=>d.value!=null&&d.value!==""&&d.value!=="N/A");Ze(e.features);const i=Qe();t.innerHTML=`
    <div class="fade-in">
      <!-- Breadcrumb -->
      <div class="flex items-center gap-2 text-xs text-gray-500 mb-4">
        <a href="/" class="hover:text-blue-500 transition">Home</a>
  ...
  `;const l=document.getElementById("hero-image"),c=document.getElementById("gallery-label");t.querySelectorAll(".gallery-thumb").forEach((d,u)=>{d.addEventListener("click",()=>{t.querySelectorAll(".gallery-thumb").forEach(p=>p.classList.remove("active","border-blue-500")),t.querySelectorAll(".gallery-thumb").forEach(p=>p.classList.add("border-gray-200")),d.classList.add("active","border-blue-500"),d.classList.remove("border-gray-200"),l.src=d.dataset.img,c.textContent=o[u]||`View ${u+1}`})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await O()?window.location.href=`/checkout.html?id=${e.property_id}`:(le(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",()=>{Q(e)}),at(e),rt(e),_e(e),Xe(),window.lucide&&lucide.createIcons()}function Xo(e){const t=e.listing_type==="property",a=t?"Share Property":"Share",r=`/contact.html?listing=${encodeURIComponent(e.property_id||"")}`,s=t?'<a href="#listing-map" class="flex items-center justify-center gap-2 bg-gray-100 hover:bg-blue-100 hover:text-blue-600 text-gray-700 font-bold py-3 rounded-xl transition text-sm"><i data-lucide="map-pin" class="w-5 h-5"></i> View Map</a>':"",o=t?`
  ...
  `}function et(e){const t=e.listing_type==="property",a=`/contact.html?listing=${encodeURIComponent(e.property_id||"")}`;return`
    <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-5 sm:p-6 shadow-sm">
      ...
      <div id="recommended-section" class="hidden mb-6">
        ...
        <div class="rel-grid flex gap-3 sm:gap-4 overflow-x-auto scrollbar-none pb-1 snap-x snap-mandatory"></div>
      </div>`}function Qo(e){const t=new Map,a=r=>(r||[]).forEach(s=>{s&&s.property_id&&t.set(s.property_id,s)});return a(Fe),a(Tt),a(xa),a(Sa),a($a),a(Wr),a(Oe),a(se),a(_a()),kr(e.category||e.subcategory),[...t.values()].filter(r=>r.property_id!==e.property_id)}function en(e,t){let a=0;const r=c=>String(c||"").trim().toLowerCase();e.listing_type&&e.listing_type===t.listing_type&&(a+=40),e.category&&r(e.category)===r(t.category)&&(a+=30),e.subcategory&&r(e.subcategory)===r(t.subcategory)&&(a+=20),e.brand&&r(e.brand)===r(t.brand)&&(a+=15),e.breed&&r(e.breed)===r(t.breed)&&(a+=15),e.model&&r(e.model)===r(t.model)&&(a+=10),e.property_type&&r(e.property_type)===r(t.property_type)&&(a+=15);const s=parseFloat(e.price)||0,o=parseFloat(t.price)||0;if(s>0&&o>0){const c=Math.min(s,o)/Math.max(s,o);c>=.8?a+=10:c>=.6?a+=6:c>=.4&&(a+=3)}e.country_code&&e.country_code===t.country_code&&(a+=5);const n=new Set(r(e.title).split(/[^a-z0-9]+/).filter(c=>c.length>2)),i=new Set(r(t.title).split(/[^a-z0-9]+/).filter(c=>c.length>2));let l=0;return n.forEach(c=>{i.has(c)&&l++}),a+=Math.min(l*2,10),a}function yt(e,t){const a=document.getElementById(e);if(!a)return;const r=a.querySelector(".rel-grid");if(!r)return;if(!t.length){a.classList.add("hidden");return}a.classList.remove("hidden"),r.innerHTML="";const s=document.createDocumentFragment();t.slice(0,10).forEach(o=>{const n=document.createElement("div");n.className="shrink-0 w-[260px] sm:w-[320px] snap-start";const i=_t(o);i.style.width="100%",n.appendChild(i),s.appendChild(n)}),r.appendChild(s),window.lucide&&lucide.createIcons()}function at(e){const t=Qo(e),a=t.map(l=>({item:l,score:en(e,l)})).sort((l,c)=>c.score-l.score||(c.item.rating||0)-(l.item.rating||0)),r=a.filter(l=>l.score>=35).map(l=>l.item),s=new Set(r.map(l=>l.property_id)),o=a.filter(l=>l.score>=15&&l.score<35&&!s.has(l.item.property_id)).map(l=>l.item),n=[...t].filter(l=>!s.has(l.property_id)).sort((l,c)=>(c.rating||0)-(l.rating||0)).slice(0,10),i=a.filter(l=>!s.has(l.item.property_id)).map(l=>l.item);yt("similar-section",r.length?r:i.slice(0,10)),yt("related-section",o.length?o:i.slice(0,10)),yt("recommended-section",n.length?n:i.slice(0,10))}function tn(e){const t=document.getElementById("details-content"),a=e.listing_type==="property",r=z(e),s=qe(e.country_code),o=e.listing_type==="product"?"Product ID":a?"Property ID":"Listing ID";let n="",i="",l=parseFloat(e.real_price);if((!Number.isFinite(l)||l<=0)&&(l=parseFloat(e.compare_at_price??e.original_price)),Number.isFinite(l)&&l>0&&l>parseFloat(e.price)){const f=Math.round((1-parseFloat(e.price)/l)*100);n=`<span class="text-lg text-gray-400 price-strike line-through font-medium">${z({...e,price:l})}</span>`,i=`<span class="inline-flex items-center gap-1 text-xs font-black text-white bg-red-500 px-2 py-1 rounded-full">-${f}% OFF</span>`}const c=e.availability_status||(e.listing_type==="product"?"In Stock":"Available"),d=Ye(e.images),u=[e.video,e.video_url].find(f=>f&&typeof f=="string"&&V(f)),p=[...d];u&&!p.includes(u)&&p.unshift(u);const y=p.findIndex(f=>V(f)),g=p.findIndex(f=>!V(f)),h=g>=0?g:y>=0?y:0,x=p[h],_=V(x),C=g>=0?p[g]:"",E=p.map((f,S)=>{const M=V(f)?`<video src="${m(f)}" muted preload="auto" playsinline class="w-20 h-16 object-cover"></video>
         <div class="absolute inset-0 flex items-center justify-center"><div class="w-5 h-5 rounded-full bg-white/80 flex items-center justify-center"><svg class="w-2.5 h-2.5 text-gray-800 ml-px" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></div></div>`:`<img src="${m(f)}" alt="View ${S+1}" loading="lazy" class="w-20 h-16 object-cover" onerror="this.onerror=null;this.src='${H}'">`;return`<button class="gallery-thumb relative rounded-lg overflow-hidden border-2 ${S===h?"active border-blue-500":"border-gray-200"} shrink-0" data-img="${m(f)}">
      ${M}
    </button>`}).join("");let I="";if(a){const f=[{icon:"globe",label:"Country",value:`${s} ${e.country}`},{icon:"map-pin",label:"State / Province",value:e.state},{icon:"building",label:"City",value:e.city},{icon:"navigation",label:"Town / Local Area",value:e.town}].filter(S=>S.value);I=`
      <div class="mt-4">
        ${Ke("map-pin","Location","rose")}
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ${f.map(S=>`
            <div class="flex items-center gap-3 bg-gray-50 border border-gray-100 rounded-xl p-3">
              <div class="p-2.5 bg-white border border-gray-100 rounded-lg"><i data-lucide="${S.icon}" class="w-4 h-4 text-blue-500"></i></div>
              <div><div class="text-gray-500 text-xs">${S.label}</div><div class="text-gray-900 font-bold text-[15px]">${S.value}</div></div>
            </div>
          `).join("")}
        </div>
        <div id="listing-map" class="mt-4 rounded-xl overflow-hidden border border-gray-200" style="height:280px"></div>
      </div>`}let b=[];a?(b=[{icon:"bed-double",label:"Bedrooms",value:e.bedrooms},{icon:"bath",label:"Bathrooms",value:e.bathrooms},{icon:"droplets",label:"Half Bathrooms",value:e.half_bathrooms},{icon:"building",label:"Building / Living Size",value:e.building_size},{icon:"ruler",label:"Land / Lot Size",value:e.land_size},{icon:"layers",label:"Floors / Levels",value:e.floors},{icon:"car-front",label:"Parking Spaces",value:e.parking_spaces},{icon:"warehouse",label:"Garage",value:e.garage},{icon:"home",label:"Property Type",value:e.property_type},{icon:"sofa",label:"Furnished",value:e.furnished},{icon:"badge-check",label:"Condition",value:e.condition},{icon:"calendar",label:"Year Built",value:e.year_built},{icon:"paintbrush",label:"Year Renovated",value:e.year_renovated},{icon:"mail",label:"ZIP / Postal Code",value:e.zip_code},{icon:"tag",label:"Status",value:e.listing_status==="rent"?"For Rent":"For Sale"}].filter(f=>f.value!=null&&f.value!==""),Me("Property Information","home",b)):e.category==="Motorhomes"?(b=[{icon:"factory",label:"Brand",value:e.brand},{icon:"car",label:"Model",value:e.model},{icon:"calendar",label:"Year",value:e.model_year},{icon:"badge-check",label:"Condition",value:e.condition},{icon:"gauge",label:"Mileage",value:e.mileage},{icon:"cog",label:"Transmission",value:e.transmission},{icon:"fuel",label:"Fuel Type",value:e.fuel_type},{icon:"zap",label:"Engine",value:e.engine},{icon:"bus",label:"Type",value:e.property_type},{icon:"moon",label:"Sleeping Capacity",value:e.sleeping_capacity},{icon:"users",label:"Seating Capacity",value:e.seating_capacity},{icon:"shower-head",label:"Bathroom",value:e.bathroom},{icon:"utensils",label:"Kitchen",value:e.kitchen},{icon:"droplet",label:"Water Tank",value:e.water_tank}].filter(f=>f.value!=null&&f.value!==""),Me("Vehicle Information","bus",b,"violet")):e.listing_type==="product"?(b=[{icon:"factory",label:"Brand",value:e.brand},{icon:"tag",label:"Subcategory",value:e.subcategory},{icon:"palette",label:"Colour",value:e.color},{icon:"ruler",label:"Size",value:e.size},{icon:"layers",label:"Material",value:e.material},{icon:"badge-check",label:"Condition",value:e.condition||"New"},{icon:"shield-check",label:"Warranty",value:e.warranty},{icon:"package-check",label:"Availability",value:e.availability_status}].filter(f=>f.value!=null&&f.value!==""),Me("Product Information","package",b)):e.listing_type==="pet"&&(b=[{icon:"paw-print",label:"Breed",value:e.breed},{icon:"calendar",label:"Age",value:e.age},{icon:"users",label:"Gender",value:e.gender},{icon:"palette",label:"Colour",value:e.color},{icon:"scale",label:"Weight",value:e.size},{icon:"globe",label:"Origin",value:`${qe(e.country_code)} ${e.country}`},{icon:"badge-check",label:"Health",value:e.condition}].filter(f=>f.value!=null&&f.value!==""),Me("Pet Information","paw-print",b,"amber")),Ze(e.features),Bo(e.highlights);const P=Qe();t.innerHTML=`
    <div class="fade-in">
      <div class="flex items-center gap-2 text-xs text-gray-500 mb-4">
        <a href="/" class="hover:text-blue-500 transition">Home</a>
        <i data-lucide="chevron-right" class="w-3 h-3"></i>
      ...
      <div id="hero-wrap" class="relative aspect-[16/10] rounded-2xl overflow-hidden bg-gray-50 mb-3 cursor-zoom-in group" role="button" tabindex="0" aria-label="Open image gallery">
        ${_?`<video id="hero-image" src="${m(x)}" ${C?`poster="${m(C)}"`:""} autoplay muted loop preload="metadata" playsinline controls class="w-full h-full object-cover" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"></video>
      ...
      <div id="listing-details">
        ${Je(e,b,e.features,e.highlights,I,No(e))}
      </div>
  ...
  `,document.getElementById("hero-image");const A=document.getElementById("hero-wrap");if(A){const f=()=>an(e,p);A.addEventListener("click",f),A.addEventListener("keydown",S=>{(S.key==="Enter"||S.key===" ")&&(S.preventDefault(),f())})}t.querySelectorAll(".gallery-thumb").forEach(f=>{f.addEventListener("click",()=>{t.querySelectorAll(".gallery-thumb").forEach(k=>k.classList.remove("active","border-blue-500")),t.querySelectorAll(".gallery-thumb").forEach(k=>k.classList.add("border-gray-200")),f.classList.add("active","border-blue-500"),f.classList.remove("border-gray-200");const S=f.dataset.img,K=V(S),M=document.getElementById("hero-wrap");if(!M)return;const Z=M.querySelector(".hero-video-overlay");Z&&Z.remove();const T=document.getElementById("hero-image");if(K)if(T&&T.tagName==="VIDEO")T.src=S;else{const k=document.createElement("video");k.id="hero-image",k.src=S,k.muted=!0,k.loop=!0,k.autoplay=!0,k.preload="metadata",k.playsInline=!0,k.controls=!0,C&&(k.poster=C),k.className="w-full h-full object-cover",M.insertBefore(k,M.firstChild),T&&T.remove&&T.remove();const $=document.createElement("div");$.className="hero-video-overlay absolute inset-0 flex items-center justify-center pointer-events-none",$.innerHTML='<div class="w-14 h-14 rounded-full bg-white/80 flex items-center justify-center shadow-lg"><svg class="w-7 h-7 text-gray-800 ml-0.5" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></div>',M.insertBefore($,M.firstChild?.nextSibling)}else if(T&&T.tagName==="IMG")T.src=S;else{const k=document.createElement("img");k.id="hero-image",k.src=S,k.alt=e.title,k.className="w-full h-full object-cover",k.onerror=function(){this.onerror=null,this.src=H},M.insertBefore(k,M.firstChild),T&&T.remove&&T.remove()}})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await O()?window.location.href=`/checkout.html?id=${e.property_id}`:(le(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",()=>{Q(e)});const Y=document.getElementById("request-viewing-btn");Y&&Y.addEventListener("click",()=>ha(e,"viewing"));const ee=document.getElementById("request-info-btn");ee&&ee.addEventListener("click",()=>ha(e,"info"));const w=document.getElementById("view-details-btn");w&&w.addEventListener("click",()=>{const f=document.getElementById("listing-details");f&&f.scrollIntoView({behavior:"smooth",block:"start"})});const R=document.getElementById("add-cart-btn");R&&R.addEventListener("click",()=>{Ia(e.property_id,1),R.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Added to Cart',window.lucide&&lucide.createIcons(),setTimeout(()=>{R.innerHTML='<i data-lucide="shopping-cart" class="w-5 h-5"></i> Add to Cart',window.lucide&&lucide.createIcons()},2e3)}),sn(e),rt(e),_e(e),cn(e),Xe(),window.lucide&&lucide.createIcons(),e.property_id,e.title,parseFloat(e.price),e.currency;const ce=document.getElementById("listing-map");if(ce&&window.L){const f=parseFloat(e.latitude)||null,S=parseFloat(e.longitude)||null,K=[e.product_location,e.town,e.city,e.state,e.country].filter(Boolean).join(", ")||e.title,M=[e.product_location,e.town,e.city,e.state,e.country].filter(Boolean).join(", "),Z="https://www.google.com/maps/search/?api=1&query="+encodeURIComponent(M||e.title),T=($,Se,st)=>{const $e=L.map(ce).setView([$,Se],st);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo($e),L.marker([$,Se]).addTo($e).bindPopup(`<strong>${m(e.title)}</strong><br>${m(K)}`).openPopup()},k=()=>{ce.innerHTML=`<div class="w-full h-full flex flex-col items-center justify-center gap-2 bg-gray-50 text-center p-4">
        ...
        <a href="${Z}" target="_blank" rel="noopener" class="text-xs font-bold text-blue-600 hover:underline">Open location in Google Maps</a>
      </div>`,window.lucide&&lucide.createIcons()};f&&S?T(f,S,13):M?fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(M)).then($=>$.json()).then($=>{$&&$[0]?T(parseFloat($[0].lat),parseFloat($[0].lon),12):k()}).catch(k):k()}}function an(e,t){const a=(Array.isArray(t)&&t.length?t:[e.images?.[0]||H]).filter(Boolean);if(!a.length)return;let r=0;const s=document.createElement("div");s.id="gallery-lightbox",s.className="fixed inset-0 z-[500] bg-black/95 flex flex-col",s.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(s),document.body.style.overflow="hidden";const o=s.querySelector("#lb-media-container"),n=s.querySelector("#lb-count"),i=s.querySelector("#lb-thumbs");let l=null;const c=()=>{o.classList.add("lb-fade"),setTimeout(()=>{const h=a[r];if(V(h))o.innerHTML=`<video src="${m(h)}" controls playsinline preload="auto" class="lb-media max-w-full max-h-[70vh] object-contain rounded-lg"></video>`;else{const x=document.createElement("img");x.src=h,x.alt="Gallery",x.draggable=!1,x.className="lb-media max-w-full max-h-[70vh] object-contain",x.onerror=function(){this.onerror=null,this.src=H},o.innerHTML="",o.appendChild(x)}o.classList.remove("lb-fade"),n.textContent=`${r+1} / ${a.length}`,i.innerHTML=a.map((x,_)=>{const E=V(x)?'<div class="w-full h-full flex items-center justify-center bg-gray-800"><svg class="w-3 h-3 text-white ml-px" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg></div>':`<img src="${m(x)}" class="w-full h-full object-cover" onerror="this.style.display='none'">`;return`<button type="button" data-i="${_}" class="relative w-12 h-9 rounded-lg overflow-hidden border-2 ${_===r?"border-blue-500":"border-transparent"}" aria-label="Item ${_+1}">${E}</button>`}).join(""),i.querySelectorAll("[data-i]").forEach(x=>x.addEventListener("click",()=>{r=parseInt(x.dataset.i,10),c()}))},90)},d=()=>{r=(r-1+a.length)%a.length,c()},u=()=>{r=(r+1)%a.length,c()},p=()=>{s.remove(),document.body.style.overflow="",document.removeEventListener("keydown",y)},y=h=>{h.key==="Escape"?p():h.key==="ArrowLeft"?d():h.key==="ArrowRight"&&u()};s.querySelector("#lb-close").addEventListener("click",p),s.querySelector("#lb-prev").addEventListener("click",d),s.querySelector("#lb-next").addEventListener("click",u);const g=s.querySelector("#lb-viewport");g.addEventListener("touchstart",h=>{l=h.touches[0].clientX},{passive:!0}),g.addEventListener("touchend",h=>{if(l==null)return;const x=h.changedTouches[0].clientX-l;Math.abs(x)>40&&(x<0?u():d()),l=null},{passive:!0}),g.addEventListener("click",h=>{h.target===g&&p()}),document.addEventListener("keydown",y),c()}function ha(e,t){const a=t==="viewing",r=e.property_id||e.id||"",s=document.createElement("div");s.id="property-request-modal",s.className="fixed inset-0 z-[450] flex items-end sm:items-center justify-center p-0 sm:p-4",s.innerHTML=`
    <style>
  ...
  `,document.body.appendChild(s),document.body.style.overflow="hidden",O().then(n=>{if(n){const i=s.querySelector("#prq-name"),l=s.querySelector("#prq-email"),c=n.user_metadata||{};c?.full_name&&i&&!i.value&&(i.value=c.full_name),n.email&&l&&!l.value&&(l.value=n.email)}});const o=()=>{s.remove(),document.body.style.overflow=""};s.querySelectorAll("[data-req-close]").forEach(n=>n.addEventListener("click",o)),s.addEventListener("submit",async n=>{n.preventDefault();const i=s.querySelector("#prq-submit"),l=s.querySelector("#prq-status"),c=s.querySelector("#prq-name").value.trim(),d=s.querySelector("#prq-email").value.trim(),u=s.querySelector("#prq-phone")?.value.trim()||"",p=s.querySelector("#prq-date")?.value||"",y=s.querySelector("#prq-message").value.trim();i.disabled=!0,i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i> Sending...',window.lucide&&lucide.createIcons();try{let g=null;try{g=(await v.auth.getUser()).data?.user?.id||null}catch{}const h=a?"Request Viewing":"Request More Information",x=[r&&`Property: ${r}`,u&&`Phone: ${u}`,p&&`Preferred date: ${p}`,y].filter(Boolean).join(" | "),{error:_}=await v.from("site_feedback").insert({user_id:g,name:c,email:d,rating:5,feedback:`${h} (${e.title}): ${x}`,is_approved:!1});if(_)throw new Error(_.message);try{await fetch("https://wttnvwpoqmbxryivcerf.supabase.co/functions/v1/send-auth-email",{method:"POST",headers:{Authorization:"Bearer sb_publishable_X_6kXsJwApi7v7HwoC1xtA_igns4Rxa","Content-Type":"application/json"},body:JSON.stringify({type:"contact_form",name:c,email:d,subject:`${h} — ${e.title}`,message:x})})}catch{}l.className="text-center text-sm py-3 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200",l.textContent=a?"Viewing request sent! We'll confirm your appointment within 24 hours.":"Request sent! We'll get back to you within 24 hours.",l.classList.remove("hidden"),setTimeout(o,1800)}catch{l.className="text-center text-sm py-3 rounded-xl bg-red-50 text-red-600 border border-red-200",l.textContent="Failed to send. Please email support@weverseonlineshop.com directly.",l.classList.remove("hidden"),i.disabled=!1,i.innerHTML=a?"Request Viewing":"Send Request",window.lucide&&lucide.createIcons()}})}let pe=0,fa=!1;function rn(){if(fa)return;fa=!0;const e=document.createElement("style");e.textContent="@keyframes kcoWishPop{0%{transform:scale(1)}35%{transform:scale(1.45)}60%{transform:scale(.86)}100%{transform:scale(1)}}",document.head.appendChild(e)}function xt(e,t){if(!e)return;rn(),e.innerHTML=`<i data-lucide="heart" class="w-5 h-5 ${t?"fill-red-500 text-red-500":""}"></i>`,e.classList.toggle("bg-red-50",t),e.classList.toggle("border",t),e.classList.toggle("border-red-200",t);const a=e.querySelector("span");a&&(a.textContent=t?"Saved to Wishlist":"Add to Wishlist"),window.lucide&&lucide.createIcons();const r=e.querySelector("i");r&&(r.style.animation="none",r.offsetWidth,r.style.animation="kcoWishPop .5s cubic-bezier(.34,1.56,.64,1)",setTimeout(()=>{r&&(r.style.animation="")},550))}async function sn(e){const t=document.getElementById("wishlist-btn");if(!t)return;const a=await O();if(!a){t.addEventListener("click",()=>{le(window.location.pathname+window.location.search),window.location.href=`/auth.html?redirect=${encodeURIComponent(window.location.pathname+window.location.search)}`});return}const{data:r,error:s}=await v.from("wishlist").select("id").eq("user_id",a.id).eq("listing_id",e.id).maybeSingle();if(s){console.error("Wishlist check failed:",s.message);return}r&&xt(t,!0),t.addEventListener("click",async()=>{const{data:o,error:n}=await v.from("wishlist").select("id").eq("user_id",a.id).eq("listing_id",e.id).maybeSingle();if(n){console.error("Wishlist toggle failed:",n.message);return}if(o){const{error:i}=await v.from("wishlist").delete().eq("id",o.id);if(i){console.error("Wishlist delete failed:",i.message);return}xt(t,!1)}else{const{error:i}=await v.from("wishlist").insert({user_id:a.id,listing_id:e.id});if(i){console.error("Wishlist insert failed:",i.message);return}xt(t,!0)}})}async function rt(e){const t=document.getElementById("review-form");if(!t)return;const a=await O();if(!a){t.classList.add("hidden");const l=document.getElementById("review-guest-box"),c=document.getElementById("review-guest-btn"),d=document.getElementById("review-guest-msg");l&&l.classList.remove("hidden"),c&&d&&c.addEventListener("click",()=>{d.classList.remove("hidden"),c.innerHTML='<i data-lucide="lock" class="w-4 h-4"></i> Sign in to write a review',window.lucide&&window.lucide.createIcons()});return}t.classList.remove("hidden");const r=document.getElementById("review-guest-box");r&&r.classList.add("hidden"),document.querySelectorAll(".star-btn").forEach(l=>{l.addEventListener("click",()=>{pe=parseInt(l.dataset.rating,10),document.querySelectorAll(".star-btn").forEach((c,d)=>{const u=c.querySelector("i, svg");u&&(d<pe?(u.classList.add("fill-amber-400","text-amber-400"),u.classList.remove("text-gray-300")):(u.classList.remove("fill-amber-400","text-amber-400"),u.classList.add("text-gray-300")))})})});const s=document.getElementById("review-photo-input"),o=document.getElementById("review-photo-preview");let n=null;s&&s.addEventListener("change",()=>{if(n=s.files&&s.files[0],!!o&&(o.innerHTML="",n)){const l=URL.createObjectURL(n);o.innerHTML=`<span class="inline-flex items-center gap-1.5 text-xs font-bold text-blue-600 bg-blue-50 border border-blue-200 rounded-lg px-2.5 py-1"><img src="${l}" alt="" class="w-5 h-5 rounded object-cover">${m(n.name)}</span>`}});const i=document.getElementById("review-submit-msg");t.addEventListener("submit",async l=>{l.preventDefault();const c=document.getElementById("review-text").value.trim();if(!pe){alert("Please select a rating.");return}if(!c){alert("Please write a review.");return}const d=t.querySelector('button[type="submit"]'),u=d.innerHTML;d.disabled=!0,d.innerHTML='<span class="inline-block animate-spin">⏳</span> Submitting…';let p=null;if(n){const g=(n.name.split(".").pop()||"jpg").toLowerCase().replace(/[^a-z0-9]/g,"")||"jpg",h=`${a.id}/${Date.now()}_${String(Math.random()).slice(2)}.${g}`,{error:x}=await v.storage.from("review-photos").upload(h,n,{contentType:n.type||"image/jpeg",cacheControl:"3600",upsert:!1});if(x){d.disabled=!1,d.innerHTML=u,alert("Could not upload photo: "+x.message);return}const{data:_}=v.storage.from("review-photos").getPublicUrl(h);p=_?.publicUrl||null}const{error:y}=await v.from("product_reviews").insert({listing_id:e.id||null,property_id:e.property_id||e.id||"",user_id:a.id,rating:pe,comment:c,review_photo:p,is_approved:!0});if(d.disabled=!1,d.innerHTML=u,y){alert("Error: "+y.message);return}document.getElementById("review-text").value="",pe=0,n=null,s&&(s.value=""),o&&(o.innerHTML=""),document.querySelectorAll(".star-btn").forEach(g=>{const h=g.querySelector("i, svg");h&&(h.classList.remove("fill-amber-400","text-amber-400"),h.classList.add("text-gray-300"))}),i&&(i.classList.remove("hidden"),setTimeout(()=>{i&&i.classList.add("hidden")},4e3)),_e(e)})}async function _e(e){lr();const t=document.getElementById("reviews-list"),a=document.getElementById("reviews-summary"),r=document.getElementById("reviews-breakdown");if(!t)return;const s=Qs(e),o={5:s.breakdown[5]||0,4:s.breakdown[4]||0,3:s.breakdown[3]||0,2:s.breakdown[2]||0,1:s.breakdown[1]||0};let n=Math.max(Number(s.total)||0,s.reviews.length);const i=[],l=e.property_id||e.id||"";if(l){const{data:h,error:x}=await v.from("product_reviews").select("*, profiles(full_name)").eq("property_id",l).eq("is_approved",!0).order("created_at",{ascending:!1});if(!x&&h)for(const _ of h){i.push({..._,name:_.profiles?.full_name||"Anonymous",verified:_.is_verified_purchase});const C=Math.min(5,Math.max(1,Math.round(Number(_.rating)||0)));o[C]++,n++}}let c=0;for(let h=5;h>=1;h--)c+=h*o[h];const u=(n?c/n:0)||Number(e.rating)||0,p=n,y=`
    <div class="flex flex-wrap items-center gap-x-6 gap-y-4">
      <div class="flex items-center gap-4 shrink-0">
        ...
        <div class="shrink-0">
          <div class="flex gap-1">${To(u,"w-5 h-5 sm:w-6 sm:h-6")}</div>
    ...
    </div>`;a&&(a.innerHTML=y),r&&(r.innerHTML=Go(e,o,p));const g=[...i,...s.reviews];if(!g.length){t.innerHTML='<p class="text-gray-400 text-sm py-2">No reviews yet. Be the first to review this product!</p>',window.lucide&&lucide.createIcons();return}he=g.map(h=>(h.id?h._key="db-"+h.id:h._key="seed-"+Mo(String(l)+"||"+(h.date||"")+"||"+(h.text||"")),h)),we=l;try{be=localStorage.getItem("kco_reply_name")||""}catch{}if(l)try{G=await tr(l)}catch{G={likes:new Map,liked:new Set,comments:new Map}}else G={likes:new Map,liked:new Set,comments:new Map};U=null,fe=!1,nn(t),J()}async function lr(){const e=document.querySelector('[data-bg-slot="reviews"]');if(e)try{const t=await ye();e.innerHTML=Be(t.reviews_bg_image,t.reviews_bg_video)}catch{}}document.addEventListener("promo-backgrounds-updated",()=>{try{lr()}catch{}});function J(){const e=document.getElementById("reviews-list");if(!e||!he.length)return;const t=fe?he:he.slice(0,3);if(e.innerHTML=t.map(Uo).join(""),window.lucide&&lucide.createIcons(),fe)ln(e,()=>{fe=!1,J()});else if(he.length>t.length){const a=document.createElement("div");a.className="mt-4 flex justify-center",a.innerHTML=`
      ...
      </button>`,e.appendChild(a),window.lucide&&lucide.createIcons(),a.querySelector(".view-all-reviews-btn").addEventListener("click",()=>{fe=!0,J()})}}async function ba(){if(we)try{G=await tr(we)}catch{G={likes:new Map,liked:new Set,comments:new Map}}}function on(){if(!U)return;const e=document.querySelector(".review-reply-box textarea.review-reply-body");e&&setTimeout(()=>{try{e.focus()}catch{}},60)}function nn(e){!e||e.dataset.riBound==="1"||(e.dataset.riBound="1",e.addEventListener("click",async t=>{const a=t.target.closest(".review-like-btn");if(a){if(t.preventDefault(),!a.dataset.key)return;try{await eo(we,a.dataset.key)}catch{}await ba(),J();return}const r=t.target.closest(".review-reply-toggle");if(r){t.preventDefault(),U=U===r.dataset.key?null:r.dataset.key,J(),on();return}if(t.target.closest(".review-reply-cancel")){t.preventDefault(),U=null,J();return}const o=t.target.closest(".review-reply-post");if(o){t.preventDefault();const n=t.target.closest(".review-reply-box");if(!n)return;const i=n.querySelector(".review-reply-name"),l=n.querySelector(".review-reply-body"),c=(i&&i.value||"").trim(),d=(l&&l.value||"").trim();if(!d){l&&l.focus();return}be=c||be;try{await to(we,o.dataset.key,c||"Guest",d)}catch{}try{localStorage.setItem("kco_reply_name",be)}catch{}U=null,await ba(),J()}}))}function ln(e,t){if(!e)return;const a=document.getElementById("reviews-back-top");a&&a.remove();const r=document.createElement("button");r.type="button",r.id="reviews-back-top",r.setAttribute("aria-label","Back to product page"),r.className="btn-press fixed z-[90] bottom-4 right-4 sm:bottom-6 sm:right-6 inline-flex items-center gap-2 bg-slate-900/90 hover:bg-slate-800 text-white font-bold pl-3 pr-5 py-3 rounded-full text-xs shadow-xl shadow-slate-950/50 border border-white/10 backdrop-blur transition active:scale-95",r.innerHTML=`
    ...
    </a>`}).join("")}function m(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function dn(){const e=zo();if(!e){document.getElementById("details-content").innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>';return}const t=()=>{document.getElementById("details-content").innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>'},a=()=>Ft(e)||Vt(e)||Dt(e)||Or(e)||ma(e)||ot(e)||vr(),r=i=>{if(qt(i),document.title=`${i.title} | Weverse Online Shop`,es(i),i===Ft(e))Ko(i);else if(i===Vt(e))Zo(i);else if(i===Dt(e))Jo(i);else{tn(i);try{at(i)}catch{}}},s=a();if(s){r(s),ge().then(()=>{wt().then(()=>{if(va(e)){t();return}const i=ot(e);if(i&&i.property_id===e)try{r(i)}catch{}})});return}await ge();const o=ot(e);if(o){r(o);return}await Yo();const n=ma(e);if(n){r(n);return}await wt();{t();return}}const ga=document.getElementById("details-content"),un=ga?ga.innerHTML:"";let ya=!1;function cr(e){if(e)try{console.error("[details] init failed:",e&&(e.stack||e.message||e))}catch{}if(!ya){ya=!0;try{const t=document.getElementById("details-content");if(!t||t.innerHTML!==un||t.querySelector(".fade-in, #reviews-section"))return;t.innerHTML='<div class="text-center py-20 text-gray-500">We couldn’t load this listing right now. Please check your connection and try again.</div>'}catch{}}}window.setTimeout(cr,12e3);dn().catch(cr);
