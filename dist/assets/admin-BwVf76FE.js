            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select class="input-field text-xs" name="car_scanner_model">
                  ${["gemini-2.5-flash","gemini-2.5-flash-lite","gemini-2.0-flash","gemini-2.0-flash-lite"].map(r=>`<option value="${r}" ${(i.car_scanner_model||"gemini-2.5-flash")===r?"selected":""}>${r}</option>`).join("")}
                </select>
              </div>
            </div>
