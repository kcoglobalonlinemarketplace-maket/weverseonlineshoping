import"./modulepreload-polyfill-B5Qt9EMX.js";import{S as Q,_ as gi}from"./showroom-data-C8s3txE5.js";import{supabase as c}from"./supabase-client-DSkAnHxH.js";import{a as yi,g as fi,C as je}from"./country-data-BXM8T1RS.js";import{A as hi}from"./localization-CBo_e9qC.js";import{patchLocalShowroomListing as Pt,getLocalShowroomListingById as ke,removeLocalShowroomListing as vi,upsertLocalShowroomListing as ze,listLocalShowroomListings as Nt}from"./local-showroom-store-mzP0nSoS.js";import{g as Ot,s as xi,l as wi,a as _i}from"./payment-settings-BZM-gsG8.js";import{P as fa,a as ha,T as va,M as xa}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as ki}from"./catalog-pfF1HJ-x.js";import{i as $i}from"./promo-backgrounds-C4TNWBGI.js";import{i as wa,D as Si}from"./site-content-slMvSP6y.js";import{M as Pi,a as Ei}from"./categories-72WACZm8.js";import{saveCatalogHidden as _a,loadHiddenCatalogIds as Ht,getHiddenCatalogIds as Ze,resetHiddenCatalogIds as Ai}from"./catalog-hidden-store-Ci-G2dxV.js";/* empty css                                       */const V=1,J=5e6,Ci=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Ii=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],ka=[...Ci,...Ii];function Vt(e){return yi[e]||"USD"}function $a(e,t){return ka.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Ti(e,t){const a=Math.max(V,Math.min(J,Number(e)||V));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Bi(e,t,a,i,o){const s=Ti(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${s}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${s}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${s}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${s}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${s}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${s}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${s}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${s}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${s}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${s}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Sa({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:s}){const r=ka.find(g=>g.id===e&&g.listingType===t);if(!r)return null;const n=fi(i)||je[0],d=o||Vt(n.code),u=[n.name].filter(Boolean).join(", "),b={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${n.name}`:r.label,description:Bi(r,n,d,s,u),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[n.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...b,country:n.name,country_code:n.code,product_location:n.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...b,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}function Pa(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const Gt="".replace(/\/$/,""),Et=[{id:"overview",label:"Overview",icon:"layout-dashboard"},{id:"accounts",label:"Connected Accounts",icon:"link-2"},{id:"auto",label:"Automatic Posting",icon:"bot"},{id:"manual",label:"Manual Posting",icon:"pen-line"},{id:"schedule",label:"Posting Schedule",icon:"calendar-clock"},{id:"queue",label:"Content Queue",icon:"list-checks"},{id:"published",label:"Published Posts",icon:"check-circle-2"},{id:"failed",label:"Failed Posts",icon:"alert-triangle"},{id:"logs",label:"Post Logs",icon:"scroll-text"},{id:"platforms",label:"Platform Settings",icon:"settings-2"},{id:"apistatus",label:"API Connection Status",icon:"server"}];let Ve="overview";function y(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function w(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg");if(!a||!i){alert(e);return}i.textContent=e;const o=a.querySelector("i[data-lucide]"),s={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",s[t]||"info"),o.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3200)}function Li(){return'<div class="flex items-center justify-center py-28"><div class="flex items-center gap-3 text-gray-400 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function te(e,t="inbox"){return`<div class="flex flex-col items-center justify-center py-16 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${t}" class="w-8 h-8 text-blue-400"></i></div><p class="text-sm text-gray-500 max-w-xs">${y(e)}</p></div>`}function U(){if(window.lucide)try{lucide.createIcons()}catch{}}function se(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function Ea(){const{data:e}=await c.auth.getSession();return e?.session?.access_token||""}async function de(e,t={}){const i={authorization:`Bearer ${await Ea()}`,"content-type":"application/json",...t.headers||{}},o=await fetch(`${Gt}${e}`,{...t,headers:i});let s={};try{s=await o.json()}catch{s={}}if(!o.ok)throw Object.assign(new Error(s?.error||`Request failed (HTTP ${o.status})`),{status:o.status,code:s.code});return s}async function Mi(e){const t=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),a=`uploads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${t}`,{error:i}=await c.storage.from("social-posts").upload(a,e,{contentType:e.type,upsert:!1,cacheControl:"3600"});if(i)throw i;const{data:o}=c.storage.from("social-posts").getPublicUrl(a),s=(e.type||"").startsWith("video/")||/\.(mp4|webm|mov|m4v)$/i.test(e.name);return{url:o.publicUrl,type:s?"video":"image"}}const G={tiktok:{label:"TikTok",icon:"music-2",tone:"text-white"},telegram:{label:"Telegram",icon:"send",tone:"text-sky-400"},facebook:{label:"Facebook Pages",icon:"thumbs-up",tone:"text-blue-400"},instagram:{label:"Instagram",icon:"camera",tone:"text-pink-400"},youtube:{label:"YouTube",icon:"youtube",tone:"text-red-400"},x:{label:"X (Twitter)",icon:"twitter",tone:"text-gray-300"},pinterest:{label:"Pinterest",icon:"pinterest",tone:"text-red-500"},linkedin:{label:"LinkedIn",icon:"linkedin",tone:"text-sky-500"},whatsapp:{label:"WhatsApp Channels",icon:"message-circle",tone:"text-emerald-400"}};function ae(e){return G[e]?.icon||"share-2"}function q(e){return G[e]?.label||e}function Di(e){const t={connected:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disconnected:"bg-gray-500/15 text-gray-300 border-gray-500/30",error:"bg-red-500/15 text-red-300 border-red-500/30",revoked:"bg-red-500/15 text-red-300 border-red-500/30",requires_approval:"bg-amber-500/15 text-amber-300 border-amber-500/30",expired:"bg-amber-500/15 text-amber-300 border-amber-500/30",not_connected:"bg-gray-500/10 text-gray-400 border-gray-500/20",draft:"bg-gray-500/15 text-gray-300 border-gray-500/30",scheduled:"bg-amber-500/15 text-amber-300 border-amber-500/30",queued:"bg-sky-500/15 text-sky-300 border-sky-500/30",publishing:"bg-violet-500/15 text-violet-300 border-violet-500/30",published:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",failed:"bg-red-500/15 text-red-300 border-red-500/30",cancelled:"bg-gray-500/10 text-gray-400 border-gray-500/20",paused:"bg-amber-500/15 text-amber-300 border-amber-500/30",enabled:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disabled:"bg-gray-500/15 text-gray-400 border-gray-500/25"};return t[e]||t.not_connected}function we(e){return`<span class="badge ${Di(e)}">${y(e.replace(/_/g," "))}</span>`}function At(e="overview"){Ve=Et.find(a=>a.id===e)?e:"overview";const t=document.getElementById("content");t.innerHTML=`
    <div class="space-y-4 fade-in">
      ...
      <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-thin">
        ${Et.map(a=>`<button onclick="window.socialNav('${a.id}')" class="tab-btn ${Ve===a.id?"active":""}">${a.label}</button>`).join("")}
      </div>
      <div id="social-body"></div>
    </div>`,U(),et(Ve)}window.socialNav=async function(e){Ve=e,document.querySelectorAll("#content .tab-btn").forEach((t,a)=>t.classList.toggle("active",Et[a]?.id===e)),await et(e)};async function et(e){const t=document.getElementById("social-body");if(!t)return;t.innerHTML=Li(),U(),await({overview:la,accounts:Re,auto:qe,manual:Ia,schedule:Oi,queue:Wt,published:Vi,failed:Wi,logs:Ki,platforms:at,apistatus:eo}[e]||la)(t)}async function be(){return await de("/api/social/status")}let Aa=null;async function la(e){try{const t=await be();Aa=t;const a=t.settings||{},i=await c.from("social_automation_rules").select("*").order("created_at",{ascending:!1}),o=await c.from("social_posts").select("*").order("created_at",{ascending:!1}).limit(300),r=(o.data||[]).filter(b=>b.status==="scheduled"||b.status==="queued"&&b.created_at).sort((b,g)=>new Date(b.scheduled_for||b.created_at)-new Date(g.scheduled_for||g.created_at))[0]||null,n=(o.data||[]).reduce((b,g)=>(b[g.status]=(b[g.status]||0)+1,b),{}),d=(t.accounts||[]).filter(b=>b.status==="connected"),u=!!(i.data||[]).some(b=>b.approval_mode==="manual"||b.enabled&&a.require_approval);e.innerHTML=`
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3 lg:col-span-2">
          ...
          ${(t.platforms||[]).map(b=>`
            <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/5 rounded-xl">
              <div class="w-9 h-9 rounded-xl bg-blue-500/10 flex items-center justify-center shrink-0"><i data-lucide="${ae(b.id)}" class="w-4 h-4 ${G[b.id]?.tone||"text-gray-300"}"></i></div>
              <div class="min-w-0 flex-1">
                <p class="text-xs font-bold text-white">${q(b.id)}</p>
                <p class="text-[11px] text-gray-500 truncate">${b.connected?b.accountName||"connected":b.configured?b.requiresApproval?"Requires approval":"Not connected":"API not configured"}</p>
              </div>
              <div class="flex items-center gap-2">
                ${b.configured?b.connected?we("connected"):b.requiresApproval?'<span class="badge bg-amber-500/15 text-amber-300 border-amber-500/30">approval</span>':we("not_connected"):'<span class="badge bg-amber-500/15 text-amber-300 border-amber-500/30">setup needed</span>'}
        ...
        <div class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${r?`
              ...
              <p class="text-sm text-white font-bold mb-2">${q(r.platform)}${r.caption?" · "+y(r.caption.slice(0,60)):""}</p>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            <div class="grid grid-cols-2 gap-2">
              ${[{icon:"bot",label:"Automatic Posting",fn:"window.socialNav('auto')"},{icon:"pen-line",label:"Manual Posting",fn:"window.socialNav('manual')"},{icon:"list-checks",label:"Content Queue",fn:"window.socialNav('queue')"},{icon:"settings-2",label:"Platform Settings",fn:"window.socialNav('platforms')"}].map(b=>`<button onclick="${b.fn}" class="btn-press p-3 bg-white/[.03] border border-white/10 rounded-xl text-left hover:border-blue-500/40 transition"><i data-lucide="${b.icon}" class="w-4 h-4 text-blue-400 mb-1.5 inline-block"></i><p class="text-[11px] font-bold text-white">${b.label}</p></button>`).join("")}
            </div>
          </div>
        </div>
      </div>`,U(),e.querySelectorAll("#social-body")}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">Could not load overview: ${y(t.message)}</div>`}}function re(e,t,a,i){return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    <p class="text-xs text-gray-500 uppercase tracking-wide mt-1 font-bold">${y(a)}</p>
      ...
      <div class="space-y-3">
        ...
        <div id="acct-grid" class="grid md:grid-cols-2 xl:grid-cols-3 gap-3">
          ${i.map(s=>ji(s,o.find(r=>r.platform===s.id))).join("")}
        </div>
      </div>`,U()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${y(t.message)}</div>`}}window.socialAccountsFilter=function(){const e=document.getElementById("acct-filter")?.value||"";document.querySelectorAll("#acct-grid > [data-platform]").forEach(t=>{t.style.display=!e||t.dataset.platform===e?"":"none"})};window.socialRefresh=()=>{Re(document.getElementById("social-body"))};function ji(e,t){const a=t?.status==="connected";return`
    <div data-platform="${e.id}" class="glass-soft border ${a?"border-emerald-500/25":"border-blue-500/15"} rounded-2xl p-4 space-y-3">
    ...
    </div>`}window.socialConnect=async function(e){try{const a=((await be()).platforms||[]).find(i=>i.id===e);if(!a?.configured){w("API credentials are not configured server-side.","error");return}if(a.usesOAuth){window.location.href=`${Gt}/api/social/oauth/start?platform=${encodeURIComponent(e)}`;return}await de("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"connect",platform:e})}),w(`${q(e)} connected.`),Re(document.getElementById("social-body"))}catch(t){w(t.message,"error")}};window.socialValidate=async function(e){try{const t=await de("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"validate",account_id:e})});w(t.note||"Connection is valid."),Re(document.getElementById("social-body"))}catch(t){w(t.message,"error")}};window.socialDisconnect=async function(e,t){if(confirm(`Disconnect your ${q(t)} account? Tokens will be wiped from the server.`))try{await de("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"disconnect",account_id:e})}),w(`${q(t)} disconnected.`),Re(document.getElementById("social-body"))}catch(a){w(a.message,"error")}};window.socialReconnect=async function(e){window.socialConnect(e)};window.socialRunScheduler=async function(){try{const e=await Ea(),t=localStorage.getItem("kco_cron_secret")||"",a=await fetch(`${Gt}/api/social/scheduler`,{method:"POST",headers:{"content-type":"application/json",...t?{"x-cron-secret":t}:{}},body:JSON.stringify({})}),i=await a.json().catch(()=>({}));if(!a.ok){w(i?.error||"Scheduler requires the admin secret (set SCHEDULER_CRON_SECRET).","error");return}w(`Scheduler tick complete · ${i.published??0} published · ${i.scheduledEnqueued??0} enqueued`),et("overview")}catch(e){w(e.message,"error")}};let Te=[],Ri={products:[],content:[],promos:[]};async function qe(e){try{const a=(await be()).settings||{};Te=(await c.from("social_automation_rules").select("*").order("created_at",{ascending:!1})).data||[];const o=`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
        ...
        <div class="grid sm:grid-cols-2 gap-3">
          ${_t("Master switch","When ON, the server picks content and posts automatically to connected accounts.","auto_posting_enabled",a.auto_posting_enabled,"window.socialToggleGlobal('auto_posting_enabled')")}
          ${_t("Pause all automation","Temporarily stops ALL automatic and scheduled publishing. Resume anytime.","automation_paused",a.automation_paused,"window.socialToggleGlobal('automation_paused')")}
          ${_t("Approve posts before publishing","Auto-generated posts stay in the Content Queue as drafts until you approve them.","require_approval",a.require_approval,"window.socialToggleGlobal('require_approval')")}
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
        ...
        ${Te.length?Te.map(qi).join(""):te("No automation rules yet. Create one to automatically publish products, promotions or news on a schedule.","bot")}
      </div>`;e.innerHTML=`${o}<div class="grid gap-4">${s}</div>`,U()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${y(t.message)}</div>`}}function _t(e,t,a,i,o){return`<div class="p-3 rounded-xl bg-white/[.03] border border-white/10 flex items-center justify-between gap-3">
  ...
  </div>`}window.socialToggleGlobal=async function(e){try{const t=Aa?.settings||{},a={...t,[e]:!t[e]},{error:i}=await c.from("social_settings").upsert({id:1,...a});if(i)throw i;w(e==="automation_paused"?a[e]?"Automation paused.":"Automation resumed.":"Saved."),qe(document.getElementById("social-body"))}catch(t){w(t.message,"error")}};function qi(e){const t=e.enabled&&!e.paused?"enabled":e.paused?"paused":"disabled",a={products:"New products (auto-pick new arrivals)",selected_products:"Selected products",promotions:"Promotions",content_items:"News / articles (Content Items)"},i={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},o=e.next_run_at?`Next run ${se(e.next_run_at)}`:"First run pending";return`
    <div data-rule="${e.id}" class="p-4 rounded-2xl bg-white/[.03] border border-white/10 space-y-3">
      <div class="flex items-start justify-between gap-2 flex-wrap">
        <div class="min-w-0">
          ...
          <p class="text-[11px] text-gray-500 mt-0.5">${y(a[e.content_type]||e.content_type)} · ${y((e.platforms||[]).map(q).join(", "))}</p>
        </div>
        <div class="flex items-center gap-2">${we(t)} <span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${y(Ca(e))}</span></div>
      </div>
      ...
      <div class="space-y-4 text-left max-h-[70vh] overflow-y-auto pr-1 scrollbar-thin">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div><label class="lbl">Platforms</label><select id="rule-platforms" class="input-field" style="min-height:80px" multiple>
            ${G?Object.keys(G).filter(o=>o!=="whatsapp").map(o=>`<option value="${o}" ${(t.platforms||[]).includes(o)?"selected":""}>${y(q(o))}</option>`).join(""):""}
...
{{link}}`,hashtags:document.getElementById("rule-hashtags").value.trim(),include_price:document.getElementById("rule-price").checked,include_link:document.getElementById("rule-link").checked,next_run_at:new Date().toISOString()};e?await c.from("social_automation_rules").update(n).eq("id",e):await c.from("social_automation_rules").insert(n),document.querySelector(".modal-overlay")?.remove(),w("Rule saved. Enable it when ready."),qe(document.getElementById("social-body"))}catch(t){w(t.message,"error")}};let v={sourceType:"product",sourceId:"",caption:"",hashtags:"",platform:"",media:[],linkUrl:"",allowDuplicate:!1};async function Ia(e){try{const t=await be(),a=(t.platforms||[]).filter(d=>d.connected&&d.enabled),i=(t.accounts||[]).filter(d=>d.status==="connected"),{data:o}=await c.from("showroom_listings").select("property_id,title,category,price,currency,images,video_url,listing_type").eq("is_active",!0).limit(600),{data:s}=await c.from("promotions").select("id,title,image_url,video_url").eq("is_active",!0).limit(50),{data:r}=await c.from("social_content_items").select("*").order("created_at",{ascending:!1}).limit(50),{data:n}=await c.from("social_posts").select("*").eq("status","draft").order("created_at",{ascending:!1}).limit(40);v.platform=v.platform||a[0]?.id||"",v.sourceType=v.sourceType||(n?.length?"draft":"product"),e.innerHTML=`
      <div class="grid lg:grid-cols-3 gap-4">
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div><label class="lbl">Source</label>
            <select id="mp-source" onchange="window.socialManualSource()" class="input-field">
              <option value="product" ${v.sourceType==="product"?"selected":""}>Marketplace product</option>
              <option value="promo" ${v.sourceType==="promo"?"selected":""}>Promotion</option>
              <option value="content" ${v.sourceType==="content"?"selected":""}>News / article (Content Item)</option>
              <option value="text" ${v.sourceType==="text"?"selected":""}>Custom text / announcement</option>
              <option value="draft" ${v.sourceType==="draft"?"selected":""}>Saved draft</option>
            </select>
          </div>

          <div id="mp-source-picker">${Fi(v.sourceType,o,s,r,n)}</div>

          <div><label class="lbl">Caption</label><textarea id="mp-caption" class="input-field" placeholder="Write your post caption…">${y(v.caption)}</textarea></div>
          <div><label class="lbl">Hashtags</label><input id="mp-hashtags" class="input-field" value="${y(v.hashtags)}" placeholder="#newarrival #marketplace"></div>
          <div><label class="lbl">Link (optional)</label><input id="mp-link" class="input-field" value="${y(v.linkUrl)}" placeholder="https://…"></div>

          <div>
            <label class="lbl">Media</label>
            <div id="mp-media" class="space-y-2">${v.media.length?v.media.map((d,u)=>Ta(d,u)).join(""):'<p class="text-[11px] text-gray-500">Media auto-fills from the source. Add extra image/video below.</p>'}</div>
        ...
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div id="mp-platforms" class="space-y-2">
            ${a.length?a.map(d=>`
              <label class="flex items-center gap-3 p-3 rounded-xl bg-white/[.03] border ${v.platform===d.id?"border-blue-500/50":"border-white/10"} cursor-pointer transition" onclick="window.socialManualPlatform('${d.id}')">
                <input type="radio" name="mp-p" class="accent-blue-600" ${v.platform===d.id?"checked":""}>
                <i data-lucide="${ae(d.id)}" class="w-4 h-4 ${G[d.id]?.tone||""}"></i>
                <span class="text-xs font-bold text-white flex-1">${y(q(d.id))}</span>
        ...
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div id="mp-preview" class="border border-white/10 rounded-2xl overflow-hidden bg-black/30">
            ${Ba(v.media,v.caption,v.hashtags,v.platform)}
          </div>
          <label class="flex items-center gap-2 text-xs text-gray-300 mt-3"><input type="checkbox" id="mp-dup" ${v.allowDuplicate?"checked":""} style="accent-color:#2563eb"> Allow duplicate (bypass duplicate-post protection)</label>
      ...
      </div>`,U()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${y(t.message)}</div>`}}function Fi(e,t,a,i,o){return e==="product"?`<div class="grid grid-cols-2 gap-2 max-h-44 overflow-y-auto scrollbar-thin border border-white/10 rounded-xl p-2 bg-white/[.02]">
      ...
      ${(o||[]).map(s=>`<button onclick="window.socialLoadDraft('${y(s.id)}')" class="btn-press w-full text-left p-2.5 rounded-lg text-[11px] text-gray-300 hover:bg-blue-500/10 transition border border-white/5"><b>${y(q(s.platform))}</b> · ${y((s.caption||"").slice(0,40))}</button>`).join("")||'<p class="text-xs text-gray-500 p-2">No drafts.</p>'}
    </div>`:`<p class="text-[11px] text-gray-500">Write a custom announcement — remember to comply with each platform's rules.</p>`}window.socialManualSource=function(){v.sourceType=document.getElementById("mp-source").value,v.caption="",v.linkUrl="",v.media=[],Ia(document.getElementById("social-body"))};window.socialPickProduct=function(e,t){c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle().then(({data:a})=>{if(!a)return;v.sourceId=e,v.linkUrl=`${window.location.origin}/product/${encodeURIComponent(e)}`;const i=Array.isArray(a.images)?a.images.filter(r=>/^https?:\/\//i.test(r)).slice(0,6).map(r=>({url:r,type:"image"})):[];a.video_url&&/^https?:\/\//i.test(a.video_url)&&i.push({url:a.video_url,type:"video"}),v.media=i;const o=a.currency||"USD",s=a.price!=null?`${Number(a.price).toLocaleString("en-US")} ${o}`:"";v.caption=`${a.title}
${s?`${s}
`:""}${v.linkUrl}`,document.getElementById("mp-caption").value=v.caption,document.getElementById("mp-link").value=v.linkUrl,me(),ce(),document.querySelectorAll("#mp-source-picker button").forEach(r=>{r.classList.remove("bg-blue-500/10","text-white","border-blue-500/30"),r.classList.add("border-transparent")}),t&&(t.classList.add("bg-blue-500/10","text-white","border-blue-500/30"),t.classList.remove("border-transparent"))})};window.socialPickPromo=function(e,t){c.from("promotions").select("*").eq("id",e).maybeSingle().then(({data:a})=>{a&&(v.sourceType="promo",v.sourceId=e,v.media=[],a.image_url&&/^https?:\/\//i.test(a.image_url)&&v.media.push({url:a.image_url,type:"image"}),a.video_url&&/^https?:\/\//i.test(a.video_url)&&v.media.push({url:a.video_url,type:"video"}),v.caption=a.title||"Special offer",document.getElementById("mp-caption").value=v.caption,me(),ce())})};window.socialPickContent=function(e,t){c.from("social_content_items").select("*").eq("id",e).maybeSingle().then(({data:a})=>{a&&(v.sourceType="content",v.sourceId=e,v.media=[],a.image_url&&/^https?:\/\//i.test(a.image_url)&&v.media.push({url:a.image_url,type:"image"}),a.video_url&&/^https?:\/\//i.test(a.video_url)&&v.media.push({url:a.video_url,type:"video"}),v.caption=`${a.title}
${a.body||""}`.trim(),v.linkUrl=a.link_url||"",document.getElementById("mp-caption").value=v.caption,document.getElementById("mp-link").value=v.linkUrl,me(),ce())})};window.socialLoadDraft=async function(e){const{data:t}=await c.from("social_posts").select("*").eq("id",e).maybeSingle();t&&(window.socialNav("manual"),setTimeout(()=>{v={sourceType:"text",sourceId:t.id,caption:t.caption||"",hashtags:(t.hashtags||"").replace(/#/g,""),platform:t.platform,media:Array.isArray(t.media)?t.media:[],linkUrl:t.metadata?.link_url||"",allowDuplicate:!0},document.getElementById("mp-caption").value=v.caption,document.getElementById("mp-hashtags").value=v.hashtags,document.getElementById("mp-link").value=v.linkUrl,me(),ce()},200))};window.socialManualPlatform=function(e){v.platform=e,document.querySelectorAll("#mp-platforms label").forEach((a,i,o)=>{a.classList.toggle("border-blue-500/50",a.querySelector(".accent-blue-600")?.value===e)}),document.querySelectorAll("#mp-platforms label").forEach(a=>a.classList.remove("border-blue-500/50"));const t=Array.from(document.querySelectorAll("#mp-platforms label")).find(a=>a.textContent.includes(q(e)));t&&t.classList.add("border-blue-500/50"),ce()};window.socialAddMediaUrl=function(){const e=document.getElementById("mp-media-url").value.trim();if(!e)return;const t=/\.(mp4|webm|mov|m4v)(\?|$)/i.test(e)?"video":"image";v.media.push({url:e,type:t}),document.getElementById("mp-media-url").value="",me(),ce()};window.socialAddMediaFile=async function(e){const t=e.target.files?.[0];if(t){try{w("Uploading media…","info");const a=await Mi(t);v.media.push(a),me(),ce(),w("Media added.")}catch(a){w(a.message,"error")}e.target.value=""}};function Ta(e,t){return`<div class="flex items-center gap-2 p-2 rounded-lg bg-white/[.03] border border-white/10">
  ...
  </div>`}window.socialRemoveMedia=function(e){v.media.splice(e,1),me(),ce()};function me(){const e=document.getElementById("mp-media");e&&(e.innerHTML=v.media.length?v.media.map(Ta).join(""):'<p class="text-[11px] text-gray-500">No media. Add an image or video URL, or upload a file.</p>'),U()}function Ba(e,t,a,i){const o=e?.[0],s=[t,a?a.split(/[ ,]+/).map(r=>"#"+r.replace(/^#/,"")).join(" "):""].filter(Boolean).join(`
`);return`
    <div class="p-4 space-y-3">
      <div class="flex items-center gap-2">
        ...
        <p class="text-[11px] font-bold text-gray-300">${y(q(i)||"Select a platform")}</p>
      </div>
    ...
    </div>`}function ce(){v.caption=document.getElementById("mp-caption")?.value??v.caption,v.hashtags=document.getElementById("mp-hashtags")?.value??v.hashtags;const e=document.getElementById("mp-preview");e&&(e.innerHTML=Ba(v.media,v.caption,v.hashtags,v.platform)),U()}function Ui(){v.caption=document.getElementById("mp-caption")?.value||"",v.hashtags=document.getElementById("mp-hashtags")?.value||"",v.linkUrl=document.getElementById("mp-link")?.value||"",v.allowDuplicate=document.getElementById("mp-dup")?.checked||!1;const e=v.hashtags.split(/[\s,]+/).filter(Boolean).map(t=>t.replace(/^#/,"")).filter(Boolean);return{platform:v.platform,caption:v.caption,hashtags:e,media:v.media,linkUrl:v.linkUrl,contentType:v.sourceType==="draft"?"manual":v.sourceType,sourceType:Ni(v.sourceType),sourceId:v.sourceId,allowDuplicate:v.allowDuplicate}}function Ni(e){return e==="promo"?"promotions":e==="content"?"social_content_item":e==="product"?"showroom_listing":null}window.socialManualGo=async function(e){const t=Ui();if(!t.platform)return w("Select a platform first.","error");if(!t.caption.trim()&&t.sourceType==="text")return w("Write a caption.","error");if(t.sourceType==="showroom_listing"&&!t.sourceId)return w("Pick a product first.","error");if(v.sourceType==="draft"&&v.sourceId)try{await de("/api/social/posts",{method:"POST",body:JSON.stringify({action:"trigger",post_id:v.sourceId})}),w("Draft published."),window.socialNav("published");return}catch(a){return w(a.message,"error")}if(e==="schedule"){const a=document.getElementById("mp-when")?.value;if(!a)return w("Choose a date and time to schedule.","error");t.mode="schedule",t.scheduledFor=new Date(a).toISOString()}else e==="draft"?t.mode="draft":t.mode="publish_now";try{const a=document.getElementById("social-body")?.querySelector("button");a&&(a.disabled=!0);const i=await de("/api/social/publish",{method:"POST",body:JSON.stringify(t)});w(i.message||"Done."),v.media=[],window.socialNav(e==="publish_now"?"published":e==="schedule"?"schedule":"queue")}catch(a){w(a.message,"error")}};async function Oi(e){try{const[t,a]=await Promise.all([c.from("social_automation_rules").select("*").eq("enabled",!0).order("next_run_at"),c.from("social_posts").select("*").eq("status","scheduled").order("scheduled_for")]),i=t.data||[],o=a.data||[];e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          ${i.length?i.map(s=>`
            <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
              ...
              <div class="flex-1 min-w-0"><p class="text-xs font-bold text-white truncate">${y(s.name)}</p><p class="text-[11px] text-gray-500">${y((s.platforms||[]).map(q).join(", "))} · ${y(Ca(s))}</p></div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          ${o.length?o.map(s=>`
            <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
              ...
              <div class="flex-1 min-w-0"><p class="text-xs font-bold text-white truncate">${q(s.platform)}${s.caption?" · "+y(s.caption.slice(0,70)):""}</p><p class="text-[11px] text-gray-500">Scheduled ${se(s.scheduled_for)}</p></div>
              <div class="flex gap-2">
    ...
    <div class="space-y-4">
      ${["publishing","queued","draft"].map(o=>`
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          ...
          ${i[o].length?i[o].map(s=>Hi(s)).join(""):'<p class="text-[11px] text-gray-600 py-2">Empty.</p>'}
        </div>`).join("")}
    </div>`,U()}function Hi(e){const t=e.status==="draft";return`
    <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
      <i data-lucide="${ae(e.platform)}" class="w-4 h-4 ${G[e.platform]?.tone||""} shrink-0"></i>
      <div class="flex-1 min-w-0">
        <p class="text-xs font-bold text-white truncate">${q(e.platform)}${e.caption?" · "+y(e.caption.slice(0,60)):""}</p>
    ...
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      ...
      ${a.length?`<div class="space-y-2">${a.map(Gi).join("")}</div>`:te("No published posts yet. Post manually or enable automation.","check-circle-2")}
    </div>`,U()}function Gi(e){const t=(e.media||[])[0];return`
    <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
      ...
      <div class="flex-1 min-w-0">
        <p class="text-xs font-bold text-white truncate">${q(e.platform)} · ${e.auto_generated?"automatic":"manual"}${e.content_type!=="manual"?" · "+y(e.content_type):""}</p>
    ...
    </div>`}async function Wi(e){const{data:t}=await c.from("social_posts").select("*").eq("status","failed").order("updated_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
    <div class="glass-soft border border-red-500/20 rounded-2xl p-5 space-y-3">
      ...
      ${a.length?a.map(zi).join(""):te("No failed posts.","check-circle-2")}
    </div>`,U()}function zi(e){const t=e.next_retry_at;return`
    <div class="p-3 rounded-xl bg-red-500/[.04] border border-red-500/20 space-y-2">
      <div class="flex items-center gap-3">
        <i data-lucide="${ae(e.platform)}" class="w-4 h-4 ${G[e.platform]?.tone||""} shrink-0"></i>
        <div class="flex-1 min-w-0">
          <p class="text-xs font-bold text-white truncate">${q(e.platform)} · attempt ${e.retry_count||0}${e.max_retries?" / "+e.max_retries:""}</p>
          <p class="text-[11px] text-gray-500 truncate">${y(e.caption||"(no caption)")}</p>
        </div>
        <div class="flex gap-2 flex-wrap justify-end">
    ...
    </div>`}async function Ki(e){const[t,a]=await Promise.all([c.from("social_post_logs").select("*").order("created_at",{ascending:!1}).limit(300),c.from("social_posts").select("id,caption,platform")]),i=t.data||[],o=new Map((a.data||[]).map(r=>[r.id,r])),s={info:"text-sky-300",warn:"text-amber-300",error:"text-red-300"};e.innerHTML=`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      ...
      <div class="space-y-1.5 max-h-[65vh] overflow-y-auto scrollbar-thin">${i.map(r=>{const n=o.get(r.post_id);return`<div class="p-2.5 rounded-xl bg-white/[.02] border border-white/5 flex items-start gap-3">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[10px] text-gray-600">${se(r.created_at)}${n?" · "+y(q(n.platform))+(n.caption?" · "+y(n.caption.slice(0,50)):""):""}</p>
          </div>
        </div>`}).join("")||te("No logs yet.","scroll-text")}</div>
    </div>`,U()}let tt=[];async function at(e){try{const t=await be(),{data:a}=await c.from("social_platform_settings").select("*").order("platform");tt=a||[];const{data:i}=await c.from("social_content_items").select("*").order("created_at",{ascending:!1});e.innerHTML=`
      ${Qi()}
      <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
        ${(t.platforms||[]).map(o=>Ji(o)).join("")}
      </div>
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3 mt-4">
        ...
        ${(i||[]).length?(i||[]).map(Yi).join(""):te('Add news/article items to make them available for the automatic publisher (content type "News / articles").',"newspaper")}
      </div>`,U()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${y(t.message)}</div>`}}function Yi(e){return`<div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
    ...
    </div></div>`,document.getElementById("modal-container").appendChild(e),U()};window.socialSaveContentItem=async function(){const e=document.getElementById("ci-title").value.trim();if(!e)return w("Title is required.","error");const{error:t}=await c.from("social_content_items").insert({title:e,body:document.getElementById("ci-body").value,image_url:document.getElementById("ci-image").value.trim(),video_url:document.getElementById("ci-video").value.trim(),link_url:document.getElementById("ci-link").value.trim(),is_active:!0});if(t)return w(t.message,"error");document.querySelector(".modal-overlay")?.remove(),w("Content item saved."),at(document.getElementById("social-body"))};window.socialToggleContentItem=async function(e){const{data:t}=await c.from("social_content_items").select("is_active").eq("id",e).maybeSingle();if(!t)return w("Item not found.","error");const{error:a}=await c.from("social_content_items").update({is_active:!t.is_active}).eq("id",e);if(a)return w(a.message,"error");w("Updated."),at(document.getElementById("social-body"))};window.socialDeleteContentItem=async function(e){confirm("Delete this content item?")&&(await c.from("social_content_items").delete().eq("id",e),w("Deleted."),at(document.getElementById("social-body")))};function Qi(){return`
    ...
    </div>`}function Ji(e){const t=tt.find(i=>i.platform===e.id)||{},a=t.config||{};return e.account,`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
    ...
    </div>`}function Xi(e,t,a){const i=[];if(e==="tiktok"&&i.push(`<div><label class="lbl">Post privacy</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="tiktok_privacy_level">
    ...
    </select></div>`),i.length?`<div class="grid grid-cols-2 gap-2">${i.join("")}</div>`:""}window.socialTogglePlatform=async function(e,t){await Zi(e,{enabled:t})};async function Zi(e,t){const a=tt.find(o=>o.platform===e),{error:i}=await c.from("social_platform_settings").upsert({id:a?.id,platform:e,...t,updated_at:new Date().toISOString()},{onConflict:"platform"});if(i){w(i.message,"error");return}w(`${q(e)} ${t.enabled!==void 0?t.enabled?"enabled":"disabled":"saved"}.`)}window.socialSavePlatform=async function(e){const t=Array.from(document.querySelectorAll(`[onchange="window.socialSavePlatform('${e}')"]`)),a={};for(const s of t){const r=s.dataset.f;r&&(a[r]=s.value)}const i=tt.find(s=>s.platform===e),{error:o}=await c.from("social_platform_settings").upsert({id:i?.id,platform:e,config:{...i?.config||{},...a},updated_at:new Date().toISOString()},{onConflict:"platform"});if(o){w(o.message,"error");return}w(`${q(e)} settings saved.`)};window.socialCopy=function(e){const t=e.dataset.text||"";navigator.clipboard?.writeText(t).then(()=>w("Copied.")).catch(()=>w("Copy failed.","error"))};async function eo(e){try{const t=await be(),a=t.serverConfigured||{};e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          ...
          <div class="grid sm:grid-cols-3 gap-2">
            ${kt("Supabase service keys",a.supabase,"Needed for scheduler + token storage")}
            ${kt("Token encryption key",a.tokenEncryption,"SOCIAL_TOKEN_ENC_KEY (AES-256-GCM)")}
            ${kt("Scheduler secret",a.schedulerSecret,"SCHEDULER_CRON_SECRET for the 15-min cron")}
          </div>
        </div>
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
      ...
      </div>`,U()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${y(t.message)}</div>`}}function kt(e,t,a){return`<div class="p-3 rounded-xl bg-white/[.03] border border-white/10">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){P.section=e;const t=io[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ra(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Se()),window.lucide&&lucide.createIcons(),({dashboard:vo,products:M,properties:gt,catalog:Ce,orders:Zt,customers:Vo,reviews:Ue,messages:ei,coupons:yt,ads:Ae,notifications:zo,"homepage-branding":ht,"promo-bg":De,content:Zo,"content-settings":ri,seo:ls,email:ns,analytics:rs,security:ft,activity:ds,brand:vt,"payment-settings":Ut,backup:cs,settings:us,publish:wt,social:()=>At("overview"),"social-settings":()=>At("platforms")}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=pe("construction","Coming Soon",`${t} is being built.`))}))()};window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const _e="kco_admin_remember",Kt="kco_login_attempts",Ct=5,so=15*60*1e3;function F(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function ro(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ot(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Fe(e){return String(e||"").trim().toLowerCase()}function lo(){try{const e=JSON.parse(localStorage.getItem(_e)||"{}");e?.email&&!Fe(e.email)&&localStorage.removeItem(_e)}catch{localStorage.removeItem(_e)}}function no(){try{const e=JSON.parse(localStorage.getItem(_e)||"{}");return Fe(e?.email)}catch{return""}}function Yt(){lo();const e=no(),t=document.getElementById("login-email");t&&(t.value=e||t.value||La,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function co(){return`${window.location.origin}/admin.html`}function ge(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ot(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function R(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function qa(){try{return JSON.parse(localStorage.getItem(Kt)||'{"count":0}')}catch{return{count:0}}}function Fa(){const e=qa();return e.count=(e.count||0)+1,e.count>=Ct&&(e.lockedUntil=Date.now()+so),localStorage.setItem(Kt,JSON.stringify(e)),e}function Ua(){localStorage.removeItem(Kt)}function Na(){const e=qa();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Ua(),null):Math.ceil(t/6e4)}async function ee(e,t,a={}){try{await c.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await uo(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function uo(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Oa(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await c.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Fe(e.email)===La}async function po(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Ke(),ho();return}const{data:{session:t}}=await c.auth.getSession();if(t?.user&&await Oa(t.user)){const{data:{currentUser:i}}=await c.auth.getUser(),o=await c.auth.mfa.getAuthenticatorAssuranceLevel(),s=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&s!=="aal2"){P.user=t.user,Ke(),ge("2fa"),Qt();return}P.user=t.user,st();return}bo()}function Ke(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function bo(){Ke(),ge("login"),Yt(),Ha(),Va(),Qt(),mo();const e=Na();e&&(F(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function mo(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Ha(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",go),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ge("forgot")))}async function go(e){e.preventDefault();const t=Na();if(t){F(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Fe(a?.value);if(!i){F("Enter your admin email address."),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,s=document.getElementById("remember-me")?.checked;R("login-btn",!0),ot();const{data:r,error:n}=await c.auth.signInWithPassword({email:i,password:o});if(n||!r.user){const x=String(n?.message||"").toLowerCase();if(x.includes("missing supabase credentials")||x.includes("authentication service is unavailable")){F("Authentication is temporarily unavailable due to configuration. Please contact support."),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(x.includes("failed to fetch")||x.includes("network request failed")){F("Network error while signing in. Check your connection and try again."),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(x.includes("email not confirmed")){F("Your admin email is not confirmed yet. Open your verification email and confirm first."),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Fa(),m=Ct-f.count,h=f.lockedUntil?`Account locked for 15 minutes after ${Ct} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;F(h),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await ee(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Oa(r.user)){await c.auth.signOut(),F(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ee(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(s?localStorage.setItem(_e,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(_e),Ua(),P.user=r.user,(await c.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){R("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ge("2fa"),Qt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ee(r.user.id,"login_success"),R("login-btn",!1),st()}function Qt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",na));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&na()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await c.auth.signOut(),P.user=null,ge("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",yo))}async function na(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){F("Enter the 6-digit code from your authenticator app.");return}R("verify-2fa-btn",!0),ot();try{const{data:t}=await c.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){F("No 2FA factor found. Please re-login."),R("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await c.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:s}=await c.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(s)throw s;await ee(P.user.id,"login_2fa_success"),R("verify-2fa-btn",!1),st()}catch(t){Fa(),F(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),R("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function yo(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){F("Enter a backup recovery code.");return}R("verify-backup-btn",!0);try{const{data:t}=await c.from("admin_2fa").select("backup_codes").eq("user_id",P.user.id).maybeSingle();if(!t?.backup_codes?.length){F("No backup codes found."),R("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){F("Backup code not found or already used."),R("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await c.from("admin_2fa").update({backup_codes:i}).eq("user_id",P.user.id),await ee(P.user.id,"login_backup_code_used"),st()}catch(t){F(t.message),R("verify-backup-btn",!1,"Use Backup Code")}}function Va(){document.getElementById("back-to-login")?.addEventListener("click",()=>ge("login")),document.getElementById("send-reset-btn")?.addEventListener("click",fo)}async function fo(){const e=document.getElementById("reset-email"),t=Fe(e?.value);if(!t){F("Enter your admin email address to receive a reset link.");return}R("send-reset-btn",!0),ot();const{error:a}=await c.auth.resetPasswordForEmail(t,{redirectTo:co()});if(R("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){F(a.message);return}ro("Reset link sent! Check your inbox and open it from this device to continue.")}function ho(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await c.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}p("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function st(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&P.user&&(t.textContent=P.user.email||"Admin"),Yt();const a=(window.location.hash||"").replace(/^#/,"");a==="social"||a==="social-settings"?navigate(a):navigate("dashboard")}window.adminSignOut=async function(){P.user&&await ee(P.user.id,"logout"),await c.auth.signOut(),P.user=null,Ke(),ge("login"),Yt(),Ha(),Va()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(P.user&&await ee(P.user.id,"logout_all_devices"),await c.auth.signOut({scope:"global"}),P.user=null,p("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function vo(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([c.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),c.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),c.from("profiles").select("user_id,created_at",{count:"exact"}),c.from("product_reviews").select("id,is_approved",{count:"exact"})]),s=t.data||[],r=a.data||[],n=r.filter(_=>["approved","payment_approved","delivered"].includes(_.status)).reduce((_,k)=>_+(parseFloat(k.amount)||0),0),d=r.filter(_=>["pending","pending_verification","processing"].includes(_.status)).length,u=s.filter(_=>_.listing_type!=="property").length,b=s.filter(_=>_.listing_type==="property").length,g=s.filter(_=>_.listing_type!=="property"&&_.is_active).length,x=i.count||0,f=o.count||0,m=(o.data||[]).filter(_=>!_.is_approved).length,h=new Date,E=r.filter(_=>{const k=new Date(_.created_at);return k.getMonth()===h.getMonth()&&k.getFullYear()===h.getFullYear()}).filter(_=>["approved","payment_approved","delivered"].includes(_.status)).reduce((_,k)=>_+(parseFloat(k.amount)||0),0),A=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${Eo()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${D("Total Revenue",`$${n.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${E.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${D("Total Orders",r.length,"shopping-bag","blue",`${d} pending`)}
          ${D("Customers",x,"users","violet")}
          ${D("Products",u,"package","amber",`${g} active`)}
          ${D("Properties",b,"home","blue")}
          ${D("Reviews",f,"star","blue",`${m} pending`)}
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${A.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':A.map(_=>`
      ...
      </div>`,window.lucide&&lucide.createIcons(),Ya(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}async function M(){const e=document.getElementById("content");try{const{data:t,error:a}=await c.from("showroom_listings").select("*").order("created_at",{ascending:!1}),i=new Set,o=[];for(const u of a?[]:t||[])u&&u.property_id&&!i.has(u.property_id)&&(i.add(u.property_id),o.push(u));for(const u of Nt())u&&u.property_id&&!i.has(u.property_id)&&(i.add(u.property_id),o.push(u));if(Array.isArray(Q))for(const u of Q.filter(b=>b.property_id))i.has(u.property_id)||(i.add(u.property_id),o.push(u));const s=[...fa,...ha,...va,...xa];for(const u of s)u&&u.property_id&&!i.has(u.property_id)&&(i.add(u.property_id),o.push(u));o.sort((u,b)=>new Date(b.created_at||0)-new Date(u.created_at||0));try{await Ht()}catch{}const r=new Set(Ze());if(r.size)for(let u=o.length-1;u>=0;u--)o[u]&&o[u].property_id&&r.has(o[u].property_id)&&o.splice(u,1);for(let u=o.length-1;u>=0;u--){const b=o[u],g=Number(b&&b.price);Number.isFinite(g)&&g>=1&&g<=100&&o.splice(u,1)}const n=[...new Set(o.map(u=>u.category).filter(Boolean))].sort((u,b)=>u.localeCompare(b)),d=[...new Set(o.flatMap(u=>Array.isArray(u.tags)?u.tags:[]).filter(Boolean))].sort((u,b)=>u.localeCompare(b));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ${D("Total Products",o.length,"package","blue")}
          ${D("Published",o.filter(u=>!!u.is_active).length,"badge-check","emerald")}
          ${D("Draft / Hidden",o.filter(u=>!u.is_active).length,"file-clock","amber")}
          ${D("Featured",o.filter(u=>!!u.is_featured).length,"sparkles","violet")}
          ${D("Inventory Units",o.reduce((u,b)=>u+(parseInt(b.stock_quantity,10)||0),0),"boxes","blue")}
          ${D("Avg Price",`$${Math.round(o.reduce((u,b)=>u+(parseFloat(b.price)||0),0)/Math.max(o.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-2.5">
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(n.length?n:Qa).map(u=>`<option value="${l(u)}" ${(window._productFilters.category||"")===u?"selected":""}>${l(u)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,Wa(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function le(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Me(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function xo(e){const t=le(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function wo(e){const t=le(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function rt(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function It(e){return parseInt(e.views??e.view_count??0,10)||0}function Tt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function lt(e){return e.sku||e.property_id||"N/A"}function nt(e){const a=(Array.isArray(e&&e.images)?e.images:[]).find(o=>typeof o=="string"&&C(o));if(a)return a;const i=e&&(e.video||e.video_url);return typeof i=="string"&&C(i)?i:""}function dt(e,t){return e?`<video src="${l(e)}" class="${t}" muted playsinline preload="metadata"></video>`:""}function ye(e,t){return`<div class="${e} flex items-center justify-center text-gray-600"><i data-lucide="video-off" class="w-6 h-6"></i></div>`}function ct(e){if(!e)return"";const t=[e.video,e.video_url].find(i=>typeof i=="string"&&C(i));return t||(Array.isArray(e.images)?e.images:[]).find(i=>typeof i=="string"&&C(i))||""}function _o(e){const t=ct(e);return t?/^https?:\/\//i.test(t)||t.startsWith("data:")||t.startsWith("blob:")?t:new URL(t,window.location.origin).href:""}const $t=new Set;window.scanProductVideo=async function(e){if($t.has(e))return;const t=(window._productsData||[]).find(s=>s.property_id===e)||(await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle()).data;if(!t)return p("Product not found","error");const a=_o(t);if(!a)return p("This product has no video to scan.","error");const{data:{session:i}}=await c.auth.getSession(),o=i?.access_token||"";if(!o)return p("Please sign in first.","error");$t.add(e),j(`
      ...
      <div class="modal-box">
        ...
        <div class="flex flex-col items-center justify-center py-12 text-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">${l(t.title||"")}</p>
            <p class="text-xs text-gray-600 mt-2">Watching motion + listening to audio. This usually takes 20–90 seconds.</p>
          </div>
        </div>
      </div>
    </div>`),window.lucide&&lucide.createIcons();try{const s=`${to}/functions/v1/video-scanner`,r=Date.now(),n=await fetch(s,{method:"POST",headers:{Authorization:`Bearer ${o}`,"Content-Type":"application/json"},body:JSON.stringify({action:"scan_url",url:a,listing_id:e,question:""})}),d=await n.json().catch(()=>({}));if(!n.ok)throw new Error(d.error||`Scanner failed (${n.status})`);const u=d.result||{},b=((Date.now()-r)/1e3).toFixed(1),g={...t,ai_video_scan:u},x=(window._productsData||[]).findIndex(f=>f.property_id===e);x>=0&&(window._productsData[x]=g),M(),j(ko(g,b,!!d.saved)),window.lucide&&lucide.createIcons(),d.saved||p("Analysis complete — re-run to save to product","info")}catch(s){j(`
      <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
        <div class="modal-box">
          <div class="flex items-center justify-between mb-4">
          ...
          <div class="rounded-2xl bg-red-500/10 border border-red-500/20 p-4 text-sm text-red-200">${l(s.message)}</div>
          ...
          <div class="mt-5 flex gap-2">
            <button onclick="closeModal();scanProductVideo('${e}')" class="btn-press flex-1 py-3 rounded-2xl bg-violet-600 hover:bg-violet-500 text-white text-sm font-bold">Try Again</button>
            <button onclick="closeModal()" class="btn-press px-4 py-3 rounded-2xl bg-white/10 text-gray-200 text-sm font-bold">Close</button>
          </div>
        </div>
      </div>`),window.lucide&&lucide.createIcons()}finally{$t.delete(e)}};function ko(e,t,a){const i=e?.ai_video_scan||{},o=i.status==="ok",s=Math.round(i.confidence||0),r=o?'<span class="badge bg-emerald-500/10 text-emerald-300 border-emerald-500/20">Verified</span>':`<span class="badge bg-amber-500/10 text-amber-300 border-amber-500/20">${l(i.status==="error"?"Error":"Needs Review")}</span>`,n=Array.isArray(i.observations)?i.observations:[],d=Array.isArray(i.sections)?i.sections:[],u=Array.isArray(i.warnings)?i.warnings:[];return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="grid grid-cols-3 gap-2 mb-4 text-center">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-3"><p class="text-2xl font-black text-emerald-300">${s}%</p><p class="text-[10px] text-gray-500 uppercase tracking-wide font-bold">Confidence</p></div>
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-3"><p class="text-2xl font-black text-blue-300">${l(i.label||"—")}</p><p class="text-[10px] text-gray-500 uppercase tracking-wide font-bold">Detected</p></div>
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-3"><p class="text-2xl font-black text-gray-200">${l(t)}s</p><p class="text-[10px] text-gray-500 uppercase tracking-wide font-bold">Scan Time</p></div>
        </div>
        <div class="mb-4">${r}${a?'<span class="badge bg-violet-500/10 text-violet-300 border-violet-500/20">Saved to Product</span>':'<span class="badge bg-gray-500/10 text-gray-400 border-gray-500/20">Not Saved Yet</span>'}</div>
        <div class="space-y-4 max-h-[48vh] overflow-y-auto pr-1">
          <div class="rounded-2xl bg-white/5 border border-white/10 p-4">
            ...
            <p class="text-sm text-gray-200 leading-relaxed">${l(i.overall_analysis||"No summary.")}</p>
          </div>
          ${i.reason_if_cannot_determine?`<div class="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-4 text-sm text-amber-200">${l(i.reason_if_cannot_determine)}</div>`:""}
          ${n.length?`<div class="rounded-2xl bg-white/5 border border-white/10 p-4"><p class="text-xs text-gray-400 uppercase tracking-wide font-bold mb-2">Timeline (${n.length})</p><div class="space-y-1.5">${n.map(b=>`<div class="flex gap-2 text-sm"><span class="text-violet-300 font-mono text-xs mt-0.5 shrink-0">${l(b.time||"")}</span><span class="text-gray-300">${l(b.note||"")}</span></div>`).join("")}</div></div>`:""}
          ${d.length?`<div class="rounded-2xl bg-white/5 border border-white/10 p-4"><p class="text-xs text-gray-400 uppercase tracking-wide font-bold mb-2">Sections (${d.length})</p><div class="space-y-2">${d.map(b=>`<div><p class="text-sm font-bold text-white">${l(b.time||"")} · ${l(b.title||"")}</p><p class="text-sm text-gray-400">${l(b.description||"")}</p></div>`).join("")}</div></div>`:""}
          ${i.audio_notes?`<div class="rounded-2xl bg-white/5 border border-white/10 p-4"><p class="text-xs text-gray-400 uppercase tracking-wide font-bold mb-1">Audio</p><p class="text-sm text-gray-300">${l(i.audio_notes)}</p></div>`:""}
          ${u.length?`<div class="rounded-2xl bg-red-500/10 border border-red-500/20 p-4"><p class="text-xs text-gray-400 uppercase tracking-wide font-bold mb-1">Warnings</p><ul class="list-disc list-inside text-sm text-red-200 space-y-1">${u.map(b=>`<li>${l(b)}</li>`).join("")}</ul></div>`:""}
        </div>
        <div class="mt-5 flex gap-2">
          <button onclick="closeModal();editProduct('${e.property_id}')" class="btn-press flex-1 py-3 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold">Edit Product</button>
          <button onclick="closeModal()" class="btn-press px-4 py-3 rounded-2xl bg-white/10 text-gray-200 text-sm font-bold">Close</button>
        </div>
      </div>
    </div>`}function $o(e){const t=nt(e),a=Me(e),i=rt(e),o=window._productSelection?.has(e.property_id),s=O(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=X(e.created_at),n=!!e.is_featured,d=(Array.isArray(e.images)?e.images:[]).filter(C).length,u=d>0||!!ct(e),b=e.ai_video_scan&&e.ai_video_scan.status?e.ai_video_scan:null,g=t?dt(t,"w-full h-full object-cover"):ye("w-full h-full"),x=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,f=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${n?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="relative w-24 h-24 rounded-2xl overflow-hidden border border-blue-500/20 shrink-0 bg-[#0b1124]">
        ${g}${n?'<span class="absolute top-1.5 left-1.5 text-[10px] font-black px-2 py-0.5 rounded-lg bg-amber-400 text-[#111827]">Featured</span>':""}
      </div>
      <div class="min-w-0 flex-1">
        ...
        <div class="mt-2 flex items-center gap-2 flex-wrap">
          ${s}
          ${b?`<span class="badge bg-violet-500/15 text-violet-200 border-violet-500/30" title="AI scanned: ${l(b.label||"")}">AI Scanned · ${Math.round(b.confidence||0)}%</span>`:""}
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${l(xo(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${Tt(e).toLocaleString()}</p></div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mt-auto">
      ...
      ${u?`<button onclick="event.stopPropagation();scanProductVideo('${e.property_id}')" class="btn-press px-4 py-3.5 rounded-2xl text-sm font-bold bg-violet-500/15 text-violet-200 hover:bg-violet-500/25 transition">${b?"Re-scan Video":"Scan Video with AI"}</button>`:""}
      ...
      <button onclick="event.stopPropagation();${x}" class="btn-press px-4 py-3.5 rounded-2xl text-sm font-bold ${m} transition">${f}</button>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(h=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${l(h)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Ga(e,t){const a=[...e],i=o=>new Date(o||0).getTime()||0;return t==="oldest"?a.sort((o,s)=>i(o.created_at)-i(s.created_at)):t==="price-high"?a.sort((o,s)=>le(s.price)-le(o.price)):t==="price-low"?a.sort((o,s)=>le(o.price)-le(s.price)):t==="sales-high"?a.sort((o,s)=>Tt(s)-Tt(o)):t==="views-high"?a.sort((o,s)=>It(s)-It(o)):a.sort((o,s)=>i(s.created_at)-i(o.created_at)),a}function Wa(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const o=window._productsCardLimit||60,s=e.slice(0,o);t.innerHTML=s.map($o).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const n=e.length-s.length;n>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,n)} more (${n} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function za(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const o=nt(i),s=o?dt(o,"w-9 h-9 rounded-lg object-cover border border-blue-500/20 shrink-0"):ye("w-9 h-9 rounded-lg border border-blue-500/20 shrink-0"),r=rt(i),n=window._productSelection?.has(i.property_id),d=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,u=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
          ...
          <td>
            <div class="flex items-center gap-1.5">
              <span class="text-xs text-gray-300">${l(i.category||"Uncategorized")}</span>
              ${i.ai_video_scan&&i.ai_video_scan.status?`<span class="badge bg-violet-500/15 text-violet-200 border-violet-500/30 text-[9px] !px-1.5 !py-0.5" title="AI scanned: ${l(i.ai_video_scan.label||"")}">AI · ${Math.round(i.ai_video_scan.confidence||0)}%</span>`:""}
            </div>
          </td>
          <td>
            <div class="text-xs">
              ${(()=>{const b=le(i.price),g=parseFloat(i.real_price);return Number.isFinite(g)&&g>0&&g>b?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${g.toLocaleString()}</span><span class="font-bold text-emerald-400">$${b.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${b.toLocaleString()}</span>`})()}
            </div>
          </td>
          ...
          <td>
            <div class="flex gap-1">
              ...
              ${ct(i)?`<button onclick="scanProductVideo('${i.property_id}')" class="btn-press p-1.5 text-violet-400 hover:bg-violet-500/10 rounded-lg transition" title="Scan Video with AI"><i data-lucide="scan-line" class="w-3.5 h-3.5"></i></button>`:""}
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="space-y-2">
            ${(()=>{const i=(a.images||[]).filter(C).slice(0,8),o=i[0]||"",s=o?`<video src="${l(o)}" class="w-full h-64 object-cover rounded-xl border border-blue-500/20" muted playsinline preload="metadata"></video>`:ye("w-full h-64 rounded-xl border border-blue-500/20"),r=i.map((n,d)=>d===0?`<video src="${l(n)}" class="w-12 h-12 rounded-lg object-cover border border-blue-500/20 ring-2 ring-blue-400" muted playsinline preload="metadata"></video>`:`<video src="${l(n)}" class="w-12 h-12 rounded-lg object-cover border border-blue-500/20" muted playsinline preload="metadata"></video>`).join("");return`${s}<div class="flex flex-wrap gap-2">${r}</div>`})()}
          </div>
          <div class="space-y-2">
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(o=>o.property_id===e)||t.data;if(!a)return p("Product not found","error");const i=(Array.isArray(a.images)?a.images:[]).filter(C);j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),pt(),bt(),Pe(),Ee(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb")].map(b=>b.dataset.url||(b.querySelector("video")?b.querySelector("video").getAttribute("src"):"")).filter(b=>b&&!String(b).startsWith("blob:")&&C(b)),o={title:a.get("title")||"Untitled Product",price:Math.max(V,Math.min(J,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},s=String(a.get("real_price")||"").trim(),r=s===""?null:parseFloat(s);if(r!=null&&!Number.isFinite(r)){p("Real Price must be a number.","error");return}const n=oe((window._productsData||[]).find(b=>b.property_id===t)),d=n.specifications&&typeof n.specifications=="object"?n.specifications:{};o.specifications={...d,real_price:r!=null&&r>0?Math.round(r):null};const{error:u}=await c.from("showroom_listings").upsert({...n,...o,property_id:t},{onConflict:"property_id"});if(u){if(W(u)){p("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),z(),M();return}Pt(t,o),p("Quick edit saved locally","info")}else p(o.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");z(),M()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/product/${encodeURIComponent(e)}`,a=(window._productsData||[]).find(d=>d.property_id===e)||(window._propertiesData||[]).find(d=>d.property_id===e)||ke(e),i=a&&String(a.title||"").trim()||"Product on Weverse Online Shop",o=a&&Number(a.price||0)>0?`${i} — ${Po(a)}
${t}`:`${i}
${t}`,r=await(async()=>{try{if(navigator.clipboard?.writeText)return await navigator.clipboard.writeText(t),!0}catch{}try{const d=document.createElement("textarea");return d.value=t,d.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(d),d.focus(),d.select(),document.execCommand("copy"),d.remove(),!0}catch{return!1}})();let n=!1;if(navigator.share)try{await navigator.share({title:i,text:o,url:t}),n=!0}catch{}n||p(r?"Product link copied to clipboard":"Product link: "+t)};function Po(e){const t=Number(e&&typeof e.price=="object"?e.price.price:e&&e.price)||0,a=e&&e.currency||"USD";let i;try{i=t.toLocaleString("en-US",{style:"currency",currency:a,maximumFractionDigits:0})}catch{i="$"+t.toLocaleString("en-US")}return e&&e.price_period&&(i+="/"+e.price_period),i}window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||ke(e),{error:a}=await c.from("showroom_listings").delete().eq("property_id",e);if(a&&!W(a))return p("Delete failed: "+a.message,"error");vi(e);try{const i=await _a(e,!0);i&&i.error&&W(i.error)?p("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Product deleted")}catch{p("Product deleted")}t&&t.listing_type==="property"?gt():M()};window.openProductMoreActions=function(e){j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
      ...
      <div class="modal-box wide">
        <div class="flex items-center justify-between gap-3 mb-6">
          ...
          <div class="flex items-center gap-2 shrink-0">
            ${a&&ct(t)?`<button type="button" onclick="scanProductVideo('${l(t.property_id)}')" class="btn-press px-4 py-2.5 rounded-xl text-sm font-bold bg-violet-600/70 hover:bg-violet-500 text-white transition flex items-center gap-1.5"><i data-lucide="scan-line" class="w-4 h-4"></i> Scan Video with AI</button>`:""}
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Xa(o)}</select></div>
            </div>
...
<input type="file" id="img-upload" class="hidden" multiple accept="video/mp4,video/webm,video/*" onclick="event.stopPropagation()" onchange="handleImageUpload(event)">
            ...
            <div id="image-preview" class="flex flex-wrap gap-2.5 mt-3">
              ${(t.images||[]).filter(C).map((s,r)=>fe(s,r)).join("")}
            </div>
            ...
            <div id="image-url-inputs">
              ${(t.images||[]).filter(C).map((s,r)=>`<input type="hidden" name="images" id="img-url-${r}" value="${l(s)}">`).join("")}
            </div>
          </div>
    ...
    </div>`),pt(),bt(),Lt("pf-price"),Lt("pf-real_price"),Mt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Mt(e,"pricing")),jo(e,t.property_id||""),window._pfEscapeHandler=s=>{s.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),window._productPublishInFlight=!1,z(),M()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,s]of i.entries())o==="images"?(a.images=a.images||[],s&&!String(s).startsWith("blob:")&&a.images.push(String(s))):o==="tags"?(a.tags=a.tags||[],a.tags.push(s)):a[o]=s;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function fe(e,t){const a=Pa(e),i=C(e);let o;return a?o='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-300 select-none"><span class="text-2xl leading-none">📄</span><span class="text-[10px] font-bold mt-1">PDF</span></div>':i?o=`<video src="${l(e)}" muted loop preload="metadata" playsinline class="w-full h-full object-cover" onerror="this.style.display='none'"></video>
  ...
  </div>`}function pt(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Io(t.dataTransfer.files)}))}function bt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Pe()})}window.handleImageUpload=async function(e){await Xt(e.target.files)};async function Io(e){await Xt(e)}async function To(e,t,a){const i=new Array(e.length);let o=0;const s=Array.from({length:Math.min(Math.max(t,1),e.length)},async()=>{for(;o<e.length;){const r=o++;try{i[r]=await a(e[r],r)}catch{i[r]=null}}});return await Promise.all(s),i}function Bo(e,t,a,i,o=9e4){return new Promise(s=>{let r=!1;const n=setTimeout(()=>{r||(r=!0,s({error:{message:`Upload timed out after ${Math.round(o/1e3)}s — the network is too slow for this file size.`}}))},o);c.storage.from(e).upload(t,a,i).then(d=>{r||(r=!0,clearTimeout(n),s(d))})})}async function ua(e,t=1920,a=.82){const i=URL.createObjectURL(e);try{const o=new Image;await new Promise((g,x)=>{o.onload=g,o.onerror=x,o.src=i});const s=Math.min(1,t/Math.max(o.width,o.height)),r=Math.max(1,Math.round(o.width*s)),n=Math.max(1,Math.round(o.height*s)),d=document.createElement("canvas");d.width=r,d.height=n,d.getContext("2d").drawImage(o,0,0,r,n);const u=await new Promise(g=>d.toBlob(g,"image/jpeg",a));if(!u||!u.size)return null;const b=(e.name||"photo.jpg").replace(/\.[^.]+$/i,"")+".jpg";return new File([u],b,{type:"image/jpeg"})}catch{return null}finally{URL.revokeObjectURL(i)}}async function Xt(e){const t=document.getElementById("image-preview");if(!t)return;const a=[];for(const o of e){if(!Le(o)){p("Images are removed - the Admin accepts videos only. Drop a product video instead.","error");continue}if(o.size>100*1024*1024){p("Video must be under 100 MB.","error");continue}a.push(o)}if(!a.length)return;const i=a.map(()=>{const o=document.createElement("div");return o.className="img-thumb uploading",o.style.cssText="min-width:90px;min-height:80px;",o.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',t.appendChild(o),o});await To(a,3,async(o,s)=>{const r=i[s],n=await Za(o);setTimeout(()=>{if(!(!r||!r.isConnected)){if(r.remove(),n){const d=document.createElement("div");d.innerHTML=fe(n,s);const u=d.firstElementChild,b=r.nextSibling;b?t.insertBefore(u,b):t.appendChild(u)}else p(`Failed to upload ${Le(o)?"video":"image"}. Try a smaller file.`,"error");Pe(),mt(),Ee(),window.lucide&&lucide.createIcons()}},0)})}async function Za(e){try{const{data:{session:t}}=await c.auth.getSession(),a=String(e.type||"").startsWith("image/"),i=Le(e);let o=e;if(a&&e.size>250*1024){const d=await ua(e);d&&d.size&&(o=d)}const s=o.type==="image/jpeg"?"jpg":(e.name||"photo.jpg").split(".").pop()||"jpg",r=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`,n=i?3e5:9e4;for(let d=0;d<2;d++){const u=`${r}${d?"-"+Math.random().toString(36).slice(2,7):""}.${s}`,{error:b}=await Bo("product-images",u,o,{contentType:o.type||e.type,upsert:!1},n);if(b)console.warn("product-images upload failed (attempt "+(d+1)+"):",b.message||b);else{const{data:g}=c.storage.from("product-images").getPublicUrl(u);if(g&&g.publicUrl)return g.publicUrl}}if(i)return null;try{const d=await ua(o,1200,.72);if(d&&d.size){const u=new FileReader,b=await new Promise(g=>{u.onload=()=>g(u.result),u.onerror=()=>g(null),u.readAsDataURL(d)});if(b)return b}}catch{}return URL.createObjectURL(e)}catch{return Le(e)?null:URL.createObjectURL(e)}}async function Lo(){if(!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform()))return null;try{const{Camera:e,MediaTypeSelection:t}=await gi(async()=>{const{Camera:o,MediaTypeSelection:s}=await import("@capacitor/camera");return{Camera:o,MediaTypeSelection:s}},[]),{results:a}=await e.chooseFromGallery({mediaType:t.All,allowMultipleSelection:!0,includeMetadata:!0}),i=[];for(const o of a||[])if(o.webPath)try{const s=o.type===1,r=(o.metadata&&o.metadata.format||(s?"mp4":"jpg")).toLowerCase().replace(/^jpeg$/,"jpg"),n=await fetch(o.webPath).then(d=>d.blob());i.push(new File([n],`gallery-${Date.now()}-${Math.random().toString(36).slice(2)}.${r}`,{type:n.type||(s?"video/mp4":"image/jpeg")}))}catch{}return i}catch(e){return console.warn("Native gallery picker unavailable:",e),null}}window.pickMediaForForm=async function(e){if(!!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())){document.getElementById(e)?.click();return}const a=await Lo();!a||!a.length||await Xt(a)};window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Pe(),mt(),Ee()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0],o=i.type==="application/pdf"||Pa(i.name),s=Le(i);if(!i.type.startsWith("image/")&&!o&&!s){p("Please choose an image, video, or PDF file.","error");return}if(s&&i.size>100*1024*1024){p("Video must be under 100 MB.","error");return}const r=await Za(i);if(!r)return;const d=[...a.querySelectorAll(".img-thumb")][e];d&&(d.outerHTML=fe(r,e),Pe(),mt(),Ee(),p(o?"Document replaced. Save to apply.":s?"Video replaced. Save to apply.":"Image replaced. Save to apply.","info"))};function Pe(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.dataset.url||(a.querySelector("img")?a.querySelector("img").src:"");if(!o)return;const s=document.createElement("input");s.type="hidden",s.name="images",s.id=`img-url-${i}`,s.value=o,t.appendChild(s),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const n=a.querySelector(".rp");n&&n.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function mt(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0);const i=C(t.dataset.url);t.title=a===0?"Cover (main)":(i?"Video ":"Image ")+(a+1)})}function Ee(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=[...e.querySelectorAll(".img-thumb")],i=a.length,o=a.filter(r=>C(r.dataset.url)).length,s=i-o;if(i===0)t.textContent="No media yet — you can still save and publish anytime";else{const r=[];s>0&&r.push(`${s} image${s>1?"s":""}`),o>0&&r.push(`${o} video${o>1?"s":""}`),t.textContent=`${r.join(" + ")} — you can save and publish anytime`}t.className="text-sm mt-1 font-bold text-gray-400"}function jt(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Mo(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Do(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,s])=>{const r=e.querySelector(`[name="${o}"]`);r&&(r.type==="checkbox"?r.checked=s==="on"||s===!0:r.value=s==null?"":String(s))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.filter(C).map((s,r)=>fe(s,r)).join(""),Pe(),mt(),Ee())}return!0}function pa(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,s=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,n=r===""||r==null?"Unlimited":r,d=P.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",u=[...t.querySelectorAll('input[name="tags"]:checked')].map(x=>x.value),b=document.querySelectorAll("#image-preview .img-thumb").length,g=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
      ...
      <div><span class="text-gray-500">Media</span><p class="text-white font-semibold">${b}</p></div>
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview video")?.getAttribute("src")||"",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",o=e.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,n=e.dataset.category||"Product",d=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",u=e.querySelector('[name="is_active"]')?.checked;j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`)};function jo(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=jt(e,t),o=document.getElementById("product-autosave-note");if(!t)try{const d=localStorage.getItem(i);if(d){const u=JSON.parse(d);Do(a,u)&&o&&(o.textContent="Autosave restored from your last session.",o.classList.remove("hidden"))}}catch{}const s=()=>{try{localStorage.setItem(i,JSON.stringify(Mo(a))),o&&(o.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,o.classList.remove("hidden"))}catch{}pa()};let r;const n=()=>{clearTimeout(r),r=setTimeout(s,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",n),d.addEventListener("change",n)}),pa(),Ee()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),s=a?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,o&&(o.disabled=!0,o.style.opacity="0.75",o.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const n=document.createElement("style");n.id="_pubspin-style",n.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(n)}}catch{}const r=()=>{window._productPublishInFlight=!1,o&&(o.disabled=!1,o.style.opacity="",o.textContent=s)};try{const n=new FormData(i),d={};let u=0;for(const[f,m]of n.entries())if(f==="images"){d.images=d.images||[];const h=String(m);m&&!h.startsWith("blob:")&&C(h)?d.images.push(h):h.startsWith("blob:")&&u++}else f==="tags"?(d.tags=d.tags||[],d.tags.push(m)):d[f]=m;if(u&&!(d.images||[]).length){r(),p("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}d.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",d.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const b=n.get("action")==="draft",g=f=>Bt(f),x=f=>{const m=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],h={};for(const B of m){const E=f[B];if(B==="real_price"){const A=E!=null&&String(E).trim()!==""?parseFloat(E):null;h[B]=A!=null&&Number.isFinite(A)&&A>0?Math.round(A):null;continue}h[B]=E!=null&&String(E).trim()!==""?E:null}if(f.safety_features){const B=g(f.safety_features);h.safety_features=B.length?B:null}return h};if(a){let f=null;try{const{data:I}=await c.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();I&&(f=oe(I))}catch{}if(f||(f=oe((window._productsData||[]).find(I=>I.property_id===a))),f||(f=oe(ke?ke(a):null)),!f)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const m=(I,K)=>{const bi=I===""||I==null?"":I,mi=K===""||K==null?"":K;return String(bi).trim()===String(mi).trim()},h={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(I=>{m(d[I],f[I])||(h[I]=d[I]==null||d[I]===""?null:d[I])});const B=d.price===""||d.price==null?null:parseFloat(d.price);m(B,f.price)||(h.price=B==null?f.price:Math.max(V,Math.min(J,B)));const E=d.stock_quantity===""||d.stock_quantity==null?null:parseInt(d.stock_quantity,10);m(E,f.stock_quantity)||(h.stock_quantity=Number.isFinite(E)?E:null);const A=g(d.features_text);m(A.join("||"),(Array.isArray(f.features)?f.features:[]).join("||"))||(h.features=A);const _=d.tags||[];m(_.join("||"),(Array.isArray(f.tags)?f.tags:[]).join("||"))||(h.tags=_);const k=g(d.highlights_text);m(k.join("||"),(Array.isArray(f.highlights)?f.highlights:[]).join("||"))||(h.highlights=k);const ve=g(d.seo_keywords_text);m(ve.join("||"),(Array.isArray(f.seo_keywords)?f.seo_keywords:[]).join("||"))||(h.seo_keywords=ve);const $=d.images||[];m($.join("||"),(Array.isArray(f.images)?f.images:[]).join("||"))||(h.images=$);const H=$.find(I=>typeof I=="string"&&C(I))||null;m(H,f.video_url)||(h.video_url=H);const xe=d.is_featured==="on";!!f.is_featured!==xe&&(h.is_featured=xe);const oa=b?!1:d.is_active==="on";!!f.is_active!==oa&&(h.is_active=oa);const pi=x(d),sa={...f.specifications&&typeof f.specifications=="object"?f.specifications:{},...pi};if(JSON.stringify(sa)!==JSON.stringify(f.specifications||{})&&(h.specifications=sa),Object.keys(h).length===0){p("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(jt(t,a))}catch{}p("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),M();return}const Oe={...f,...h,property_id:a,updated_at:new Date().toISOString()};delete Oe.id;const ra=await da(Oe);if(ra.error){r();const I=St(ra.error,b?"Draft save":"Product publish");p(I,"error");try{let K=i.querySelector(".__publish-error-banner");K||(K=document.createElement("div"),K.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(K)),K.textContent=I}catch{}return}try{ze(Oe)}catch{}try{const I=(window._productsData||[]).findIndex(K=>K.property_id===a);I>=0&&(window._productsData[I]=Oe)}catch{}p(b?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(h).length} change${Object.keys(h).length>1?"s":""}).`)}else{if(!d.title||!d.title.trim())throw new Error("A product title is required.");if(d.price===""||d.price==null||!isFinite(parseFloat(d.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!d.condition)throw new Error("Please choose the product condition.");const m={listing_type:"product",category:t,subcategory:d.subcategory||null,title:d.title.trim(),description:d.description||"",price:Math.max(V,Math.min(J,parseFloat(d.price)||0)),currency:d.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:b?!1:d.is_active==="on",is_featured:d.is_featured==="on",brand:d.brand||null,color:d.color||null,size:d.size||null,condition:d.condition||null,warranty:d.warranty||null,availability_status:d.availability_status||"In Stock",stock_quantity:d.stock_quantity?parseInt(d.stock_quantity):null,images:d.images||[],video_url:(d.images||[]).find(E=>typeof E=="string"&&C(E))||null,features:g(d.features_text).length?g(d.features_text):d.tags||[],tags:d.tags||[],highlights:g(d.highlights_text),seo_keywords:g(d.seo_keywords_text),is_ai_generated:!!d.catalog_template_id,ai_generated_fields:d.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:x(d)},h=it();m.property_id=h;const B=await da(m);if(B.error){r();const E=St(B.error,"Product publish");p(E,"error");try{let A=i.querySelector(".__publish-error-banner");A||(A=document.createElement("div"),A.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(A)),A.textContent=E}catch{}return}try{ze({...m,property_id:m.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...m})}catch{}p(b?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}r();try{localStorage.removeItem(jt(t,a))}catch{}closeProductFormModal(),M()}catch(n){const d=n&&n.message&&!/failed to fetch|networkerror/i.test(String(n.message))?n.message:St(n,"Product publish");r(),p(d,"error")}};window.editProduct=async function(e){const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=ke(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){let a=null;try{const{data:o}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();o&&(a=oe(o))}catch{}if(a||(a=oe((window._productsData||[]).find(o=>o.property_id===e))),!a||!a.property_id){Pt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),M();return}delete a.id,a.property_id=e,a.is_active=t,a.availability_status=t?"In Stock":"Out of Stock";const{error:i}=await c.from("showroom_listings").upsert(a,{onConflict:"property_id"});if(i){if(W(i))return p(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Pt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),M();return}p(t?"Product published":"Product unpublished"),M()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:s,updated_at:r,...n}=a,d=it();await c.from("showroom_listings").insert({...n,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),M())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await c.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),M())};const Ro=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function gt(){const e=document.getElementById("content");try{const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Nt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(Q)){const s=new Set(i.map(n=>n.property_id)),r=Q.filter(n=>n.listing_type==="property"&&n.property_id&&!s.has(n.property_id));r.length&&(i=i.concat(r))}i.sort((s,r)=>new Date(r.created_at||0)-new Date(s.created_at||0));try{await Ht()}catch{}const o=new Set(Ze());i=i.filter(s=>!(s&&s.property_id&&o.has(s.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=$a("property","Real Estate"),i=e.country_code||"US",o=e.currency||Vt(i);j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${Xa(o)}</select></div>
            </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
                ${Ro.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
              </select></div>
          ...
          <div>
            ...
            <div id="image-preview" class="flex flex-wrap gap-2 mt-3">
              ${(e.images||[]).filter(C).map((r,n)=>fe(r,n)).join("")}
            </div>
            <div id="image-url-inputs">
    ...
    </div>`),pt(),bt(),Lt("ppf-price"),window._propFormDirty=!!t;const s=document.getElementById("property-form");if(s){const r=()=>{window._propFormDirty=!0};s.addEventListener("input",r),s.addEventListener("change",r)}window.syncPropertyCountry=function(){ca("ppf")},ca("ppf"),Dt("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Dt("pricing")),Uo()};let Y=null,Ge=null,ba=null;function qo(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function ie(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Be(e,t,{reverse:a=!1}={}){if(!Y||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Ge?Ge.setLatLng(i):Ge=L.marker(i,{draggable:!0}).addTo(Y),Y.setView(i,Math.max(Y.getZoom(),13));const o=document.querySelector('#property-form [name="latitude"]'),s=document.querySelector('#property-form [name="longitude"]');o&&(o.value=String(Number(e.toFixed(6)))),s&&(s.value=String(Number(t.toFixed(6)))),a&&Fo(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Ie(){const e=qo();if(!e){ie("Enter a location (address, area, city, state, country), then press Locate from fields.");return}ie("Searching locationâ€¦");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Be(parseFloat(a[0].lat),parseFloat(a[0].lon)),ie("Located: "+a[0].display_name)):ie("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{ie("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Fo(e,t){const a=document.querySelector("#property-form");if(a)try{const o=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),s=o&&o.address||{},r=(f,m)=>{if(!m)return;const h=a.querySelector(`[name="${f}"]`);return h&&!String(h.value||"").trim()?(h.value=m,!0):!1},n=[s.road||"",s.house_number||""].filter(Boolean).join(" "),d=s.suburb||s.neighbourhood||s.quarter||s.district||s.borough||"",u=s.town||s.village||s.municipality||s.city_district||"",b=s.city||s.county||"",g=s.state||s.region||"",x=s.country||"";if(r("product_location",n||d||u),r("town",d||u),r("city",b),r("state",g),x){r("country",x);const f=a.querySelector('[name="country_code"]');if(f){const m=(je||[]).find(h=>String(h.name||"").toLowerCase()===String(x).toLowerCase());m&&m.code&&!f.value&&(f.value=m.code)}}ie("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(o.display_name?" â€” "+o.display_name:""))}catch{ie("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!Y)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Be(e,t),ie("Map updated from coordinates.")):Ie()};function Uo(){const e=document.getElementById("property-map-preview");if(!e||!window.L){ie("Map unavailable right now â€” your location fields still save normally.");return}Y&&(Y.remove(),Y=null,Ge=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);Y=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(Y),Y.on("click",o=>Be(o.latlng.lat,o.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Ie),["product_location","town","city","state","country","latitude","longitude"].forEach(o=>{const s=document.querySelector(`#property-form [name="${o}"]`);s&&(s.addEventListener("input",()=>{if(o==="latitude"||o==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),n=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(n)&&(r||n)&&Be(r,n);return}clearTimeout(ba),ba=setTimeout(Ie,900)}),s.addEventListener("change",()=>{o!=="latitude"&&o!=="longitude"&&Ie()}))}),i?Be(t,a):Ie()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(o=>{const s=parseFloat(o.latitude),r=parseFloat(o.longitude),n=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");return!(Number.isFinite(s)&&Number.isFinite(r)&&(s!==0||r!==0))&&!!n});if(!t.length){p("All properties already have map coordinates.","success");return}p(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}â€¦`,"success");let a=0,i=0;for(const o of t){const s=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");try{const n=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(s))).json();if(n&&n[0]){const d={latitude:parseFloat(n[0].lat),longitude:parseFloat(n[0].lon)},{error:u}=await c.from("showroom_listings").update(d).eq("property_id",o.property_id);u?i++:(Object.assign(o,d),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}p(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),gt()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(m=>m&&!m.startsWith("blob:")&&C(m)),s=(i.features_text||"").split(",").map(m=>m.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(V,Math.min(J,parseFloat(i.real_price)||0)),n=m=>(m||"").split(",").map(h=>h.trim()).filter(Boolean),d=m=>m===""||m==null||!isFinite(parseInt(m,10))?null:parseInt(m,10),u=n(i.floor_plan_rooms).map(m=>{const h=String(m).match(/^(.*?):\s*(.*)$/);return h?{name:h[1].trim(),dimensions:h[2].trim()}:{name:m,dimensions:""}}),b={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(V,Math.min(J,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:d(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:d(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:d(i.year_built),year_renovated:d(i.year_renovated),landmarks:n(i.landmarks_text),interior_features:n(i.interior_features_text),exterior_features:n(i.exterior_features_text),home_systems:n(i.home_systems_text),legal_info:n(i.legal_info_text).map(m=>{const h=String(m).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return h?{label:h[1].trim(),value:h[2].trim(),source:h[3]}:{label:m,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:u,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:n(i.nearby_schools_text),hospitals:n(i.nearby_hospitals_text),shopping:n(i.nearby_shopping_text),transportation:n(i.nearby_transportation_text),distances:n(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:n(i.documents_text),features:s,images:o,video_url:(o||[]).find(m=>typeof m=="string"&&C(m))||null,video:(o||[]).find(m=>typeof m=="string"&&C(m))||null,highlights:Bt(i.highlights_text),seo_keywords:Bt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"},g={neighborhood:i.neighborhood||"",living_areas:i.living_areas||"",kitchens:d(i.kitchens),balconies:d(i.balconies),garden:i.garden||"",pool:i.pool||"",security:i.security||"",utilities:i.utilities||"",construction_type:i.construction_type||"",construction_status:i.construction_status||"",ownership_type:i.ownership_type||"",contact_name:i.contact_name||"",contact_phone:i.contact_phone||"",contact_email:i.contact_email||""},x={};for(const[m,h]of Object.entries({...g,real_price:r}))h!=null&&String(h).trim()!==""&&(x[m]=h);let f;if(t){b.property_id=t;const m=oe((window._propertiesData||[]).find(h=>h.property_id===t)||(window._productsData||[]).find(h=>h.property_id===t));b.specifications={...m.specifications&&typeof m.specifications=="object"?m.specifications:{},...x},{error:f}=await c.from("showroom_listings").upsert({...m,...b},{onConflict:"property_id"})}else b.property_id=it(),b.specifications={...x},{error:f}=await c.from("showroom_listings").insert(b);f&&Ka(f,()=>ze({...b,property_id:t||b.property_id}),t?"Property update":"Property publish")||(p(t?"Property updated!":"Property published!"),z(),gt())};const We={Car:"Cars",Truck:"Trucks",Bus:"Buses","Motorhome / RV":"Motorhomes",Motorcycle:"Motorcycles","Boat / Marine":"Marine & Boating"},No=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Bus","Motorhome","Motorcycle","Yacht","Jet Ski","Other"];window.showAddVehicleModal=function(e={}){const t=!!e.property_id,a=Object.keys(We).find(n=>We[n]===e.category)||"Car",i=e.specifications&&typeof e.specifications=="object"?e.specifications:{},o=(n,d)=>e[n]??i[n]??d,s=(n,d="")=>Array.isArray(n)?n.join(", "):n??d;j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="vehicle-form" onsubmit="saveVehicle(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Body Type</label><select class="input-field" name="body_type">${["",...No].map(n=>`<option value="${n}" ${o("body_type","")===n?"selected":""}>${n||"General"}</option>`).join("")}</select></div>
          ...
          <div class="glass-soft border border-blue-500/20 rounded-2xl p-4 space-y-3">
            ...
            <div>
              ...
              <div id="image-preview" class="flex flex-wrap gap-2 mt-3">
                ${(e.images||[]).filter(C).map((n,d)=>fe(n,d)).join("")}
              </div>
              <div id="image-url-inputs">
                ${(e.images||[]).filter(C).map((n,d)=>`<input type="hidden" name="images" id="img-url-${d}" value="${l(n)}">`).join("")}
              </div>
            </div>
    ...
    </div>`),pt(),bt(),window._vehFormDirty=!!t;const r=document.getElementById("vehicle-form");if(r){const n=()=>{window._vehFormDirty=!0};r.addEventListener("input",n),r.addEventListener("change",n)}window.lucide&&lucide.createIcons()};window.saveVehicle=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=[...a.getAll("images")].filter(k=>k&&!String(k).startsWith("blob:")&&C(k)).concat(String(i.images_text||"").split(/\r?\n/).map(k=>k.trim()).filter(C)),s=[...new Set(o)],r=(i.features_text||"").split(",").map(k=>k.trim()).filter(Boolean),n=(i.safety_features||"").split(",").map(k=>k.trim()).filter(Boolean),d=(i.driver_assistance||"").split(",").map(k=>k.trim()).filter(Boolean),u=(i.technology||"").split(",").map(k=>k.trim()).filter(Boolean),b=(i.interior||"").split(",").map(k=>k.trim()).filter(Boolean),g=i.real_price===""||i.real_price==null?null:Math.max(V,Math.min(J,parseFloat(i.real_price)||0)),x=We[i.vehicle_type]||"Cars",f=String(i.model_year||"").trim(),m=String(i.make||"").trim(),h=String(i.model||"").trim(),B=[f,m,h].filter(Boolean).join(" ")||String(i.title||"").trim(),E={make:m,model:h,model_year:f,body_type:i.body_type||null,trim:i.trim||"",mileage:i.mileage||"",engine:i.engine||"",horsepower:i.horsepower||"",transmission:i.transmission||null,drive_type:i.drive_type||null,fuel_type:i.fuel_type||null,fuel_economy:i.fuel_economy||"",towing_capacity:i.towing_capacity||"",seating_capacity:i.seating_capacity||null,sleeping_capacity:x==="Motorhomes"&&i.seating_capacity||null,doors:i.doors||null,safety_features:n,driver_assistance:d,technology:u,interior:b,wheels_tires:i.wheels_tires||"",dimensions:i.dimensions||"",cargo_capacity:i.cargo_capacity||"",ownership_history:i.ownership_history||"",service_history:i.service_history||"",accident_history:i.accident_history||"",previous_owners:i.previous_owners||"",registration_status:i.registration_status||null,inspection_status:i.inspection_status||null,color:i.color||"",vin:i.vin||"",warranty:i.warranty||"",condition:i.condition||"",location:i.location||"",seller_name:i.seller_name||"",seller_phone:i.seller_phone||"",seller_email:i.seller_email||"",product_location:i.location||""};for(const k of Object.keys(E))E[k]==null&&delete E[k];const A={listing_type:"vehicle",category:x,subcategory:i.body_type||i.vehicle_type||null,title:String(i.title||"").trim()||B,description:i.description||"",price:Math.max(V,Math.min(J,parseFloat(i.price)||0)),currency:"USD",real_price:g,images:s,features:r,brand:m||null,color:i.color||null,condition:i.condition||null,warranty:i.warranty||null,stock_quantity:parseInt(i.stock_quantity,10)||1,is_active:i.is_active==="on",is_featured:!1,specifications:{...E,real_price:g}};let _;if(t){A.property_id=t;const k=oe((window._productsData||[]).find(ve=>ve.property_id===t));A.specifications={...k.specifications&&typeof k.specifications=="object"?k.specifications:{},...E,real_price:g},{error:_}=await c.from("showroom_listings").upsert({...k||{},...A},{onConflict:"property_id"})}else A.property_id=it(),{error:_}=await c.from("showroom_listings").insert(A);_&&Ka(_,()=>ze({...A,property_id:t||A.property_id}),t?"Vehicle update":"Vehicle publish")||(p(t?"Vehicle updated!":"Vehicle published! It now appears in the Cars & Trucks row."),z(),M())};window.editProperty=async function(e){const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=ke(e)),i||(i=(Array.isArray(Q)?Q.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Oo=["pending_verification","payment_received","payment_approved","documentation_pending","refund_processing","processing","shipped","in_transit","out_for_delivery","delivered","order_completed","cancelled","rejected"];async function Zt(){const e=document.getElementById("content");try{const{data:t}=await c.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending Verification","Paid","Documentation","Processing","Shipped","Delivered","Rejected"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(s=>Ho(s)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Ho(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Oo.map(i=>`<option value="${i}" ${t.status===i?"selected":""}>${i.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`),t.receipt_file_path)try{const{data:i,error:o}=await c.storage.from("payment-receipts").createSignedUrl(t.receipt_file_path,3600),s=!o&&i?.signedUrl?i.signedUrl:null,r=document.querySelector('[data-receipt-iframe="true"]'),n=document.querySelector('[data-receipt-view="true"]');r&&s&&(r.src=s),n&&s&&(n.href=s),n&&!s&&n.remove()}catch{}};window.saveOrderAdminNotes=async function(e){const t=document.getElementById("order-admin-notes")?.value,{error:a}=await c.from("payment_receipts").update({admin_notes:t||null,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(a){p(a.message,"error");return}p("Notes saved")};window.quickOrderAction=async function(e,t){const{error:a}=await c.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(a){p(a.message,"error");return}p("Order updated to "+t.replace(/_/g," ")),z(),Zt()};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await c.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(a){p(a.message,"error");return}p("Order status updated"),z(),Zt()};async function Vo(){const e=document.getElementById("content");try{const{data:t}=await c.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await c.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?pe("star","No Reviews","Customer reviews will appear here."):a.map(n=>Wo(n)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${s.length===0?pe("message-square","No Feedback Yet","Site feedback will appear here."):s.map(n=>Go(n)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Go(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await c.from("site_feedback").update({is_approved:!0}).eq("id",e);t?p(t.message,"error"):p("Feedback approved â€” it now shows on every page."),Ue()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await c.from("site_feedback").delete().eq("id",e);t?p(t.message,"error"):p("Feedback deleted."),Ue()};function Wo(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await c.from("support_messages").update({is_read:!0}).eq("id",e),p("Marked as read"),ei()};async function yt(){const e=document.getElementById("content");try{const{data:t}=await c.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddCouponModal=function(){j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await c.from("coupons").insert(i);if(o){p(o.message,"error");return}p("Coupon created!"),z(),yt()};window.toggleCoupon=async function(e,t){await c.from("coupons").update({is_active:t}).eq("id",e),p(t?"Coupon activated":"Coupon deactivated"),yt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await c.from("coupons").delete().eq("id",e),p("Coupon deleted"),yt())};async function zo(){const e=document.getElementById("content");try{const{data:t}=await c.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const ti=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Ko=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let He=null;function Yo(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function Qo(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${l(e.link_target||"")}</span>`}function Jo(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function ai(){if(He)return He;const e=[],t=new Set,a=[],i=s=>{if(!s||!s.property_id)return;e.push({id:s.property_id,title:s.title||s.property_id});const r=s.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{Q.forEach(i)}catch{}try{const{data:s,error:r}=await c.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&s&&s.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(s=>{t.has(s)||(t.add(s),a.push(s))}),He={products:e,categories:a,sections:Ko},He}async function Xo(e){try{const{data:{session:t}}=await c.auth.getSession();if(!t)return p("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),o=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:s}=await c.storage.from("advertisements").upload(o,e,{contentType:e.type,upsert:!1});if(s)return p("Upload failed: "+s.message,"error"),null;const{data:r}=c.storage.from("advertisements").getPublicUrl(o);return{url:r.publicUrl,isVideo:i}}catch{return p("Upload failed","error"),null}}function Qe(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),o=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),o&&(o.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){p("Choose an image or video file","error");return}const i=await Xo(t);if(!i){e.value="";return}Qe(i.url,i.isVideo);const o=document.getElementById("ad-media-url");o&&(o.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);Qe(t,a)};function ea(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let o="";t==="product"?o='<option value="">Select a productâ€¦</option>'+e.products.map(s=>`<option value="${l(s.id)}" ${String(a)===String(s.id)?"selected":""}>${l(s.id)} â€” ${l((s.title||"").slice(0,60))}</option>`).join(""):t==="category"?o='<option value="">Select a categoryâ€¦</option>'+e.categories.map(s=>`<option value="${l(s)}" ${a===s?"selected":""}>${l(s)}</option>`).join(""):t==="section"&&(o='<option value="">Select a sectionâ€¦</option>'+e.sections.map(s=>`<option value="${l(s.id)}" ${a===s.id?"selected":""}>${l(s.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${o}</select>`}function ii(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";ea(e,a,"")};window.showAddAdModal=async function(){const e=await ai();window._adLinkCache=e,j(ii(null)),ea(e,"none","")};window.showEditAdModal=async function(e){const t=await ai();window._adLinkCache=t;const{data:a}=await c.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){p("Ad not found","error");return}j(ii(a)),a.image_url?Qe(a.image_url,!1):a.video_url&&Qe(a.video_url,!0),ea(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",o={title:a.title,description:a.description||"",ad_label:ti.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!o.image_url&&!o.video_url){p("Add an image or video for the ad","error");return}const s=e.target.querySelector('button[type="submit"]');s&&(s.disabled=!0);try{if(i){const{error:r}=await c.from("promotions").update(o).eq("id",i);if(r)throw r;p("Ad updated!")}else{const{error:r}=await c.from("promotions").insert(o);if(r)throw r;p("Ad created!")}}catch(r){p(r.message||"Save failed","error"),s&&(s.disabled=!1);return}z(),Ae()};window.togglePromo=async function(e,t){const{error:a}=await c.from("promotions").update({is_active:t}).eq("id",e);if(a){p(a.message,"error");return}p(t?"Ad activated":"Ad deactivated"),Ae()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await c.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const o=a||[],s=o.findIndex(u=>u.id===e),r=s+t;if(s<0||r<0||r>=o.length){p("Already at the edge","info");return}const n=o[s],d=o[r];await c.from("promotions").update({sort_order:d.sort_order}).eq("id",n.id),await c.from("promotions").update({sort_order:n.sort_order}).eq("id",d.id),p("Order updated")}catch(a){p(a.message||"Reorder failed","error")}Ae()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await c.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(o=>{const s=/\/object\/public\/advertisements\/(.+)$/.exec(o);return s?decodeURIComponent(s[1]):null}).filter(Boolean);if(i.length)try{await c.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await c.from("promotions").delete().eq("id",e);if(a)throw a;p("Ad deleted")}catch(t){p(t.message||"Delete failed","error")}Ae()}};async function Ae(){const e=document.getElementById("content");try{const{data:t}=await c.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.renderAds=Ae;async function Zo(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([c.from("site_settings").select("*").limit(1).maybeSingle(),es()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),s=a.length?`
        <div class="mt-4">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),p("Cleared. Save to apply.","info"),ri()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),p(`Uploading ${a.name}â€¦`,"info");try{const{data:{session:i}}=await c.auth.getSession();if(!i){p("Sign in to upload media","error");return}const o=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),s=`content/${t}-${Date.now()}.${o}`,{error:r}=await c.storage.from("product-images").upload(s,a,{contentType:a.type,upsert:!1});if(r){p("Upload failed: "+r.message,"error");return}const{data:n}=c.storage.from("product-images").getPublicUrl(s),d=n.publicUrl,u=document.getElementById("val-"+t),b=document.getElementById("url-"+t);u&&(u.value=d),b&&(b.value=d);const g=document.getElementById("slot-"+t);if(g){const x=ta.flatMap(f=>f.fields||[]).find(f=>f.key===t);x&&(g.outerHTML=oi(x,d))}p("âœ“ Uploaded â€” save to apply","success")}catch{p("Upload failed","error")}}};const ts=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function Z(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Ne(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(Z()))}function he(){Ne();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=si(Z()),window.lucide&&lucide.createIcons())}function as(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),o=a&&ma(a)||i&&ma(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&os(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=Z();i[e]&&(i[e][t]=a,Ne())};window.heroVideoPreset=function(e,t){const a=Z();a[e]&&(a[e].buttonText=t,he())};window.heroVideoToggle=function(e){const t=Z();t[e]&&(t[e].enabled=t[e].enabled===!1,he())};window.heroVideoMove=function(e,t){const a=Z(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],he())};window.heroVideoDelete=function(e){const t=Z();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),he())};window.heroVideoRemoveMedia=function(e,t){const a=Z();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),he())};window.addHeroVideoSlide=function(){Z().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),he(),p("New slide added â€” upload a video and press Save to show it.","info")};async function is(e,t){try{const{data:{session:a}}=await c.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),o=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:s}=await c.storage.from("product-images").upload(o,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(s)return{url:URL.createObjectURL(e),persisted:!1,error:s.message};const{data:r}=c.storage.from("product-images").getPublicUrl(o),n=r&&r.publicUrl;return n?{url:n,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function ma(e){return/^blob:/i.test(String(e||""))}async function os(e,t,a){const i=Z();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){p("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){p("Please choose an image for the poster.","error");return}p("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const o=await is(a,t);t==="video"?i[e].video=o.url:i[e].poster=o.url,he(),o.persisted?p("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):p("âš  UPLOAD FAILED: "+(o.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function ss(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Ne(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${ta.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?ss(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(o=>`
                  <div class="${o.type==="textarea"||o.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${o.type==="textarea"?`<textarea id="cs-${o.key}" name="${o.key}" rows="3" class="input-field w-full" placeholder="Enter the current wordingâ€¦">${l(a[o.key]||"")}</textarea>`:o.type==="media"?oi(o,a[o.key]||""):o.type==="checkbox"?"":`<input id="cs-${o.key}" type="text" name="${o.key}" value="${l(a[o.key]||"")}" class="input-field w-full" placeholder="Enter the current wordingâ€¦">`}
      ...
      </div>`,Ne(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[o,s]of t.entries())a[o]=s;for(const o of ta)if(o.fields)for(const s of o.fields)s.type==="checkbox"&&!(s.key in a)?a[s.key]=!1:s.type==="checkbox"&&(a[s.key]=!0);let i=[];try{const o=t.get("hero_video_slides");if(String(o||"").trim()){const s=JSON.parse(o);Array.isArray(s)&&(i=s)}}catch{i=[]}a.hero_video_slides=i;try{const{data:o}=await c.from("site_settings").select("id").limit(1).maybeSingle();let s;if(o?.id?{error:s}=await c.from("site_settings").update(a).eq("id",o.id):{error:s}=await c.from("site_settings").insert({id:crypto.randomUUID(),...a}),s)throw new Error(s.message);wa(),p("Content updated â€” the banners now use your new words and uploads.","success")}catch(o){p(o.message||"Could not save content. Please try again.","error")}};async function rs(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([c.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),c.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),c.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],s=o.filter($=>["approved","payment_approved","delivered"].includes($.status)).reduce(($,H)=>$+(parseFloat(H.amount)||0),0),r=o.length>0?(o.filter($=>$.status!=="cancelled").length/o.length*100).toFixed(1):0,n={};(a.data||[]).forEach($=>{n[$.category]=(n[$.category]||0)+1});const d=Object.entries(n).sort(($,H)=>H[1]-$[1]).slice(0,8),u=$=>new Date($.getTime()-$.getTimezoneOffset()*6e4).toISOString().slice(0,10),b=u(new Date),g=u(new Date(Date.now()-6*864e5)),{data:x,error:f}=await c.from("visitor_analytics").select("visit_date,page_views,device_type").order("visit_date",{ascending:!1}).limit(1e3),m=x||[],h=$=>$.reduce((H,xe)=>H+(parseInt(xe.page_views,10)||1),0),B=h(m.filter($=>$.visit_date===b)),E=h(m.filter($=>$.visit_date>=g)),A=h(m),_=m.length>0?Math.round(m.filter($=>$.device_type==="mobile").length/m.length*100):0,k=[];for(let $=13;$>=0;$--){const H=u(new Date(Date.now()-$*864e5));k.push({d:H,n:h(m.filter(xe=>xe.visit_date===H))})}const ve=Math.max(1,...k.map($=>$.n));e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${D("Total Revenue",`$${s.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${D("Total Orders",o.length,"shopping-bag","blue")}
          ${D("Customers",i.count||0,"users","violet")}
          ${D("Conversion Rate",r+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${D("Visits Today",B,"eye","blue")}
          ${D("Visits (7 Days)",E,"users","violet")}
          ${D("Total Visits",A,"globe","amber")}
          ${D("Mobile Share",_+"%","smartphone","emerald")}
        </div>
        ${f?`<p class="text-xs text-red-400">${l(f.message)}</p>`:""}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Ya(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function ls(){const e=document.getElementById("content"),{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    <div class="space-y-5 fade-in">
      ...
      </div>`,document.getElementById("new-pw")?.addEventListener("input",u=>{const b=u.target.value,g=[{label:"8+ characters",ok:b.length>=8},{label:"Uppercase letter",ok:/[A-Z]/.test(b)},{label:"Number",ok:/[0-9]/.test(b)},{label:"Special character",ok:/[^a-zA-Z0-9]/.test(b)}];document.getElementById("pw-strength").innerHTML=g.map(x=>`<div class="flex items-center gap-1.5 text-[10px] ${x.ok?"text-emerald-400":"text-gray-600"}">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=li(10);await c.from("admin_2fa").update({backup_codes:e}).eq("user_id",P.user.id),p("New backup codes generated"),ni(e.map(t=>t.code)),ft()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await c.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await c.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await c.from("admin_2fa").update({enabled:!1}).eq("user_id",P.user.id),await ee(P.user.id,"2fa_disabled"),p("2FA has been disabled"),ft()}catch(e){p(e.message,"error")}};async function ds(){const e=document.getElementById("content");try{const{data:t}=await c.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function cs(){const e=document.getElementById("content");try{const{data:t}=await c.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),p("Orders exported!")};async function us(){const e=document.getElementById("content"),{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await c.from("site_settings").upsert({id:1,...a}),p("Settings saved!")};async function ht(){const e=document.getElementById("content");e&&(e.innerHTML=Se());try{const{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",s=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function vt(){const e=document.getElementById("content");e&&(e.innerHTML=Se());try{let t=function(n,d,u,b="",g="blue"){const x=!!(u&&u.trim());return`
        <div class="glass-soft border border-${g}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${b?`<p class="text-[10px] text-gray-500">${l(b)}</p>`:""}
        ...
        </div>`};const{data:a}=await c.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||Ma,s=i.brand_slogan||i.site_tagline||Da,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${l(a.message)}</div>`)}}function ps(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",o=t[a]||"",s=t[i]||"",r=!!(o&&o.trim()),n=!!(s&&s.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
      <div class="flex items-center justify-between flex-wrap gap-2">
        <div class="flex items-center gap-3">
    ...
    </div>`}function ga(e,t,a,i,o){const s=o==="image",r=s?"blue":"violet",n=s?"image-plus":"video",d=s?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function di(){const e={};for(const t of Xe)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=di();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),De(t),p("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}â€¦`);try{const s=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${s}`,{error:n}=await c.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let d;if(n)d=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${n.message})`);else{const{data:x}=c.storage.from("product-images").getPublicUrl(r);d=x.publicUrl,o&&(o.textContent=`âœ“ ${a.name} uploaded`)}const u=document.getElementById("val-"+t),b=document.getElementById("url-"+t);u&&(u.value=d),b&&(b.value=d,b.classList.remove("hidden"));const g=di();De(g)}catch(s){o&&(o.textContent=`Upload failed: ${s.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const s of Xe)t[s.key+"_bg_image"]=document.getElementById("val-"+s.key+"_bg_image")?.value||"",t[s.key+"_bg_video"]=document.getElementById("val-"+s.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:i}=await c.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await c.from("site_settings").update(t).eq("id",i.id):{error:o}=await c.from("site_settings").insert(t),$i(),o?(p("Publish failed â€” the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),De(t)):(p("Promo & backgrounds published across all pages.","success"),setTimeout(()=>De(),500))};window._manualPaymentAccounts=[];function aa(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Ot("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function ia(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function bs(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${zt.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[aa()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>bs(t,a)).join("")}
    ...
    </div>`,ia(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(aa()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[aa()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ia())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=je.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Ot(t),ia(),renderManualPaymentAccountsEditor()};window._bankAccounts=[];async function ms(){try{const{data:e,error:t}=await c.from("bank_accounts").select("*").order("sort_order",{ascending:!0}).order("currency",{ascending:!0});if(t)return p(t.message,"error"),[];window._bankAccounts=e||[]}catch{window._bankAccounts=[]}return window._bankAccounts}async function xt(){const e=document.getElementById("bank-accounts-manager");e&&(e.innerHTML='<div class="flex items-center justify-center py-6 text-blue-300 text-sm"><i data-lucide="loader-2" class="w-4 h-4 animate-spin mr-2"></i> Loading accounts…</div>',window.lucide&&lucide.createIcons(),await ms(),e.innerHTML=`
    <div class="space-y-3">
      <div class="flex items-center justify-between">
      ...
      <div class="space-y-2">
        ${window._bankAccounts.length===0?'<div class="p-4 glass-soft border border-blue-500/10 rounded-xl text-xs text-gray-400">No receiving accounts yet — add your first one.</div>':window._bankAccounts.map(t=>`
          <div class="flex items-center gap-3 p-3 glass-soft border ${t.is_active!==!1?"border-blue-500/20":"border-red-500/20 opacity-60"} rounded-xl">
            <span class="text-xl">${t.flag||Ot(t.country_code||(t.currency==="EUR"?"EU":"US"))}</span>
            <div class="flex-1 min-w-0">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="form-grid form-grid-2 space-y-3">
          ...
          <div><label class="lbl">Currency *</label><select class="input-field" id="ba-currency" onchange="document.getElementById('ba-currency_name').value=this.value">${zt.map(o=>`<option value="${o}" ${a.currency===o?"selected":""}>${o}</option>`).join("")}</select></div>
          ${i("Beneficiary / Account Name *","beneficiary","Full legal name on the account")}
          ${i("Bank Name *","bank_name","e.g. Citibank")}
          ${i("Country","country")}
          <div class="flex items-end"><div class="flex-1"><label class="lbl">Country Code</label><select class="input-field" id="ba-country_code">${Jt(l(a.country_code||"US"))}</select></div></div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(_i(i))}</textarea>
              </div>
              <div>
    ...
    </div>`;let d=[];const u=d.length?d.map(x=>{const f=t.has(x.property_id),m=nt(x);return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${f?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ${m?dt(m,"w-12 h-12 rounded-lg object-cover bg-gray-800 shrink-0"):ye("w-12 h-12 rounded-lg bg-gray-800 shrink-0")}
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold text-white truncate">${l(x.title)}</p>
              <p class="text-[11px] text-gray-500 truncate">${l(x.property_id)} Â· ${l(x.subcategory||x.category||"")} Â· ${ja(x.price,"USD")}</p>
            </div>
            ${O(!f)}
            <button onclick="catalogToggle('${l(x.property_id)}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${f?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30 hover:bg-emerald-500/25":"bg-amber-500/10 text-amber-300 border-amber-500/30 hover:bg-amber-500/20"}">
              ${f?"Show":"Hide"}
            </button>
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',b=o?1:Math.max(1,Math.ceil(i/ui)),g=`
    <div class="flex flex-wrap items-center justify-between gap-3">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${g}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){N.category=e,N.page=0,N.query="",Ce()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");N.query=e?e.value:"",N.page=0,Ce()};window.catalogPage=function(e){const a=N.query.trim()?1:Math.max(1,Math.ceil(0/ui));N.page=Math.max(0,Math.min(a-1,N.page+e)),Ce()};window.catalogToggle=async function(e){const t=!Ze().includes(e),a=await _a(e,t);p(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),Ce()};window.catalogResetHidden=async function(){await Ai(),p("All hidden catalog listings restored"),Ce()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function ya(){window.lucide&&lucide.createIcons(),Ra(),await po(),c.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){P.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ya):ya();
