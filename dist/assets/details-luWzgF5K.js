import{supabase as v}from"./supabase-client-7_ZWSEp6.js";import"./localization-B9NwdMmb.js";import{S as j,l as q,f as A,a as C,b as R}from"./showroom-data-DQuiOO-D.js";import{g as H,f as F}from"./truck-data-CXeZJZHb.js";import{g as $,f as _}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode-CrZyCKRp.js";import"./customer-ai-widget-DjG380vt.js";import"./brand-BE-xoT4U.js";import"./preload-helper-CLcXU_4U.js";const y="/fallback.svg";function S(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function T(e){return Array.isArray(e)&&e.length>0?e:[y]}function P(){return new URLSearchParams(window.location.search).get("id")}function D(e){const a=document.getElementById("details-content"),o=F(e),n=T(e.images).map((l,m)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${m===0?"active border-orange-500":"border-gray-800"} shrink-0" data-img="${r(l)}">
