import{S as M,i as ra,a as na,D as la}from"./scroll-progress-Hgfzz0FV.js";import{a as da,g as ca,C as be,A as ua}from"./localization-BwnLBrky.js";import{supabase as c}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as pa,upsertLocalShowroomListing as Ee,getLocalShowroomListingById as mt,listLocalShowroomListings as He}from"./local-showroom-store-JrQn_yOW.js";import{g as bt,s as ma,l as ba,a as ga,b as ya}from"./payment-settings-BMupBtVE.js";import{PRODUCT_LISTINGS as gt}from"./products-data-CGLFLAJM.js";import{PRODUCT_EXTRA_LISTINGS as yt}from"./products-extra-DecCj9NU.js";import{TRUCK_LISTINGS as ft}from"./truck-data-DnyLExat.js";import{MOTORHOME_LISTINGS as ht}from"./motorhome-data-SSjGu6g8.js";import{getCatalogCategory as vt,getCatalogCategories as fa,generateProduct as lt}from"./catalog-ukThMZ88.js";import{getHiddenCatalogIds as xt,saveCatalogHidden as ha,resetHiddenCatalogIds as va,loadHiddenCatalogIds as xa}from"./catalog-hidden-store-Cc-A47vR.js";const B=1,N=5e6,wa=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],_a=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],wt=[...wa,..._a];function Ge(e){return da[e]||"USD"}function _t(e,t){return wt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ka(e,t){const a=Math.max(B,Math.min(N,Number(e)||B));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function $a(e,t,a,i,o){const s=ka(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${s}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${s}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${s}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${s}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${s}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${s}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${s}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${s}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${s}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${s}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function kt({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:s}){const r=wt.find(y=>y.id===e&&y.listingType===t);if(!r)return null;const l=ca(i)||be[0],d=o||Ge(l.code),u=[l.name].filter(Boolean).join(", "),b={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${l.name}`:r.label,description:$a(r,l,d,s,u),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...b,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...b,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const $t="weverseonlineshop@gmail.com",St="Weverse Online Shop",Pt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Sa="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),Pa=`${Sa}/functions/v1/ai-admin-assistant`,Ea=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Aa={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Et=[...ua].sort();let w={user:null,section:"dashboard"};function n(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function At(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function D(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function W(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function We(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Ia=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function J(e){const t={};if(!e||typeof e!="object")return t;for(const a of Ia)a in e&&(t[a]=e[a]);return t}function p(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),o=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const s={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",s[t]||"info"),o.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function C(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",n(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function G(){document.getElementById("modal-container").innerHTML=""}function T(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function A(e,t,a,i,o=""){const s={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function Q(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function V(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${n(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${n(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function It(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=Ea.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){w.section=e;const t=Aa[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),It(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Q()),window.lucide&&lucide.createIcons(),({dashboard:Ga,products:P,properties:zt,catalog:ae,orders:Vt,customers:bi,reviews:ne,messages:Kt,coupons:ve,ads:te,notifications:fi,ai:Ca,"ai-settings":Qt,"homepage-branding":_e,"promo-bg":oe,content:$i,"content-settings":Ei,seo:Ii,email:Ci,analytics:Ai,security:we,activity:Ti,brand:ke,"payment-settings":qe,backup:Bi,settings:Li,publish:$e}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=V("construction","Coming Soon",`${t} is being built.`))}))()};async function Ca(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Y="kco_admin_remember",ze="kco_login_attempts",Ae=5,Ta=15*60*1e3;function S(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Ba(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ge(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function se(e){return String(e||"").trim().toLowerCase()}function La(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");e?.email&&!se(e.email)&&localStorage.removeItem(Y)}catch{localStorage.removeItem(Y)}}function Ma(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");return se(e?.email)}catch{return""}}function Ve(){La();const e=Ma(),t=document.getElementById("login-email");t&&(t.value=e||t.value||$t,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function Da(){return`${window.location.origin}/admin.html`}function K(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ge(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function $(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Ct(){try{return JSON.parse(localStorage.getItem(ze)||'{"count":0}')}catch{return{count:0}}}function Tt(){const e=Ct();return e.count=(e.count||0)+1,e.count>=Ae&&(e.lockedUntil=Date.now()+Ta),localStorage.setItem(ze,JSON.stringify(e)),e}function Bt(){localStorage.removeItem(ze)}function Lt(){const e=Ct();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Bt(),null):Math.ceil(t/6e4)}async function U(e,t,a={}){try{await c.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Ra(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Ra(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Mt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await c.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:se(e.email)===$t}async function Fa(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){de(),Ha();return}const{data:{session:t}}=await c.auth.getSession();if(t?.user&&await Mt(t.user)){const{data:{currentUser:i}}=await c.auth.getUser(),o=await c.auth.mfa.getAuthenticatorAssuranceLevel(),s=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&s!=="aal2"){w.user=t.user,de(),K("2fa"),Ke();return}w.user=t.user,ye();return}Ua()}function de(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Ua(){de(),K("login"),Ve(),Dt(),Rt(),Ke(),Na();const e=Lt();e&&(S(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Na(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Dt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",ja),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>K("forgot")))}async function ja(e){e.preventDefault();const t=Lt();if(t){S(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=se(a?.value);if(!i){S("Enter your admin email address."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,s=document.getElementById("remember-me")?.checked;$("login-btn",!0),ge();const{data:r,error:l}=await c.auth.signInWithPassword({email:i,password:o});if(l||!r.user){const g=String(l?.message||"").toLowerCase();if(g.includes("missing supabase credentials")||g.includes("authentication service is unavailable")){S("Authentication is temporarily unavailable due to configuration. Please contact support."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("failed to fetch")||g.includes("network request failed")){S("Network error while signing in. Check your connection and try again."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("email not confirmed")){S("Your admin email is not confirmed yet. Open your verification email and confirm first."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Tt(),m=Ae-f.count,h=f.lockedUntil?`Account locked for 15 minutes after ${Ae} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;S(h),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await U(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Mt(r.user)){await c.auth.signOut(),S(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await U(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(s?localStorage.setItem(Y,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Y),Bt(),w.user=r.user,(await c.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),K("2fa"),Ke(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await U(r.user.id,"login_success"),$("login-btn",!1),ye()}function Ke(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",dt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&dt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await c.auth.signOut(),w.user=null,K("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Oa))}async function dt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){S("Enter the 6-digit code from your authenticator app.");return}$("verify-2fa-btn",!0),ge();try{const{data:t}=await c.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){S("No 2FA factor found. Please re-login."),$("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await c.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:s}=await c.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(s)throw s;await U(w.user.id,"login_2fa_success"),$("verify-2fa-btn",!1),ye()}catch(t){Tt(),S(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),$("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Oa(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){S("Enter a backup recovery code.");return}$("verify-backup-btn",!0);try{const{data:t}=await c.from("admin_2fa").select("backup_codes").eq("user_id",w.user.id).maybeSingle();if(!t?.backup_codes?.length){S("No backup codes found."),$("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){S("Backup code not found or already used."),$("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await c.from("admin_2fa").update({backup_codes:i}).eq("user_id",w.user.id),await U(w.user.id,"login_backup_code_used"),ye()}catch(t){S(t.message),$("verify-backup-btn",!1,"Use Backup Code")}}function Rt(){document.getElementById("back-to-login")?.addEventListener("click",()=>K("login")),document.getElementById("send-reset-btn")?.addEventListener("click",qa)}async function qa(){const e=document.getElementById("reset-email"),t=se(e?.value);if(!t){S("Enter your admin email address to receive a reset link.");return}$("send-reset-btn",!0),ge();const{error:a}=await c.auth.resetPasswordForEmail(t,{redirectTo:Da()});if($("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){S(a.message);return}Ba("Reset link sent! Check your inbox and open it from this device to continue.")}function Ha(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await c.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}p("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function ye(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&w.user&&(t.textContent=w.user.email||"Admin"),Ve(),navigate("dashboard")}window.adminSignOut=async function(){w.user&&await U(w.user.id,"logout"),await c.auth.signOut(),w.user=null,de(),K("login"),Ve(),Dt(),Rt()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(w.user&&await U(w.user.id,"logout_all_devices"),await c.auth.signOut({scope:"global"}),w.user=null,p("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Ga(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([c.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),c.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),c.from("profiles").select("user_id,created_at",{count:"exact"}),c.from("product_reviews").select("id,is_approved",{count:"exact"})]),s=t.data||[],r=a.data||[],l=r.filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,j)=>v+(parseFloat(j.amount)||0),0),d=r.filter(v=>["pending","pending_verification","processing"].includes(v.status)).length,u=s.filter(v=>v.listing_type!=="property").length,b=s.filter(v=>v.listing_type==="property").length,y=s.filter(v=>v.listing_type!=="property"&&v.is_active).length,g=i.count||0,f=o.count||0,m=(o.data||[]).filter(v=>!v.is_approved).length,h=new Date,I=r.filter(v=>{const j=new Date(v.created_at);return j.getMonth()===h.getMonth()&&j.getFullYear()===h.getFullYear()}).filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,j)=>v+(parseFloat(j.amount)||0),0),R=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${Ya()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${A("Total Revenue",`$${l.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${I.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${A("Total Orders",r.length,"shopping-bag","blue",`${d} pending`)}
          ${A("Customers",g,"users","violet")}
          ${A("Products",u,"package","amber",`${y} active`)}
          ${A("Properties",b,"home","blue")}
          ${A("Reviews",f,"star","blue",`${m} pending`)}
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${R.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':R.map(v=>`
      ...
      </div>`,window.lucide&&lucide.createIcons(),Nt(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${n(t.message)}</div>`)}}async function P(){const e=document.getElementById("content");try{const{data:t,error:a}=await c.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,o=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));for(const d of He().filter(u=>u.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));if(Array.isArray(M))for(const d of M.filter(u=>u.listing_type!=="property"&&u.property_id))i.has(d.property_id)||(i.add(d.property_id),o.push(d));const s=[...gt,...yt,...ft,...ht];for(const d of s)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));o.sort((d,u)=>new Date(u.created_at||0)-new Date(d.created_at||0));const r=[...new Set(o.map(d=>d.category).filter(Boolean))].sort((d,u)=>d.localeCompare(u)),l=[...new Set(o.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,u)=>d.localeCompare(u));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ${A("Total Products",o.length,"package","blue")}
          ${A("Published",o.filter(d=>!!d.is_active).length,"badge-check","emerald")}
          ${A("Draft / Hidden",o.filter(d=>!d.is_active).length,"file-clock","amber")}
          ${A("Featured",o.filter(d=>!!d.is_featured).length,"sparkles","violet")}
          ${A("Inventory Units",o.reduce((d,u)=>d+(parseInt(u.stock_quantity,10)||0),0),"boxes","blue")}
          ${A("Avg Price",`$${Math.round(o.reduce((d,u)=>d+(parseFloat(u.price)||0),0)/Math.max(o.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(r.length?r:jt).map(d=>`<option value="${n(d)}" ${(window._productFilters.category||"")===d?"selected":""}>${n(d)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
          ...
          <div id="products-empty" class="hidden">${V("package-search","No matching products","Try different filters or add a new product.",'<button onclick="showAddProductStep1()" class="btn-press bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2 rounded-xl">Add Product</button>')}</div>
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,Ft(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${n(t.message)}</div>`)}}function O(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ie(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Wa(e){const t=O(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function za(e){const t=O(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function Ye(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Ce(e){return parseInt(e.views??e.view_count??0,10)||0}function Te(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Je(e){return e.sku||e.property_id||"N/A"}function Va(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ie(e),i=Ye(e),o=window._productSelection?.has(e.property_id),s=C(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=D(e.created_at),l=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,u=e.is_active?"Unpublish":"Publish",b=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${n(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${n(Je(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${n(Wa(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${Ce(e).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${Te(e).toLocaleString()}</p></div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mt-auto">
      ...
      <button onclick="event.stopPropagation();${d}" class="btn-press px-4 py-3.5 rounded-2xl text-sm font-bold ${b} transition">${u}</button>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(y=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${n(y)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Ka(e,t){const a=[...e],i=o=>new Date(o||0).getTime()||0;return t==="oldest"?a.sort((o,s)=>i(o.created_at)-i(s.created_at)):t==="price-high"?a.sort((o,s)=>O(s.price)-O(o.price)):t==="price-low"?a.sort((o,s)=>O(o.price)-O(s.price)):t==="sales-high"?a.sort((o,s)=>Te(s)-Te(o)):t==="views-high"?a.sort((o,s)=>Ce(s)-Ce(o)):a.sort((o,s)=>i(s.created_at)-i(o.created_at)),a}function Ft(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const o=window._productsCardLimit||60,s=e.slice(0,o);t.innerHTML=s.map(Va).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const l=e.length-s.length;l>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Ut(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const o=i.images&&i.images[0]?i.images[0]:"/fallback.svg",s=Ye(i),r=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const u=O(i.price),b=parseFloat(i.real_price);return Number.isFinite(b)&&b>0&&b>u?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${b.toLocaleString()}</span><span class="font-bold text-emerald-400">$${u.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${u.toLocaleString()}</span>`})()}
            </div>
          </td>
          ...
          <td><span class="text-xs text-gray-500">${D(i.created_at)}</span></td>
          <td>
        ...
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),i=document.getElementById("view-card-btn"),o=document.getElementById("view-table-btn"),s=document.getElementById("products-empty"),r=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&Ut(r)),i&&i.classList.toggle("active",e!=="table"),o&&o.classList.toggle("active",e==="table"),s&&s.classList.toggle("hidden",r.length>0)};window.filterProducts=function(e){const t=window._productFilters||{};t.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),t.category=document.getElementById("prod-cat-filter")?.value||"",t.tag=document.getElementById("prod-tag-filter")?.value||"",t.status=document.getElementById("prod-status-filter")?.value||"",t.featured=document.getElementById("prod-featured-filter")?.value||"",t.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=t;const a=(window._productsData||[]).filter(o=>{const s=[o.title,o.brand,o.category,Je(o),Ie(o).join(" "),o.description].join(" ").toLowerCase();return!(t.search&&!s.includes(t.search)||t.category&&(o.category||"")!==t.category||t.tag&&!Ie(o).includes(t.tag)||t.status&&Ye(o)!==t.status||t.featured&&t.featured==="featured"!=!!o.is_featured)}),i=Ka(a,t.sort);e||(window._productsCardLimit=60),Ft(i),window._productView==="table"&&Ut(i)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const i=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(i):window._productSelection.delete(i)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function fe(){return window._productSelection?[...window._productSelection]:[]}function L(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function Be(e,t,a){return e&&L(e)?(p(`⚠️ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),p(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=fe();if(!t.length)return;const a=await Promise.all(t.map(s=>{const r=J((window._productsData||[]).find(l=>l.property_id===s));return c.from("showroom_listings").upsert({...r,property_id:s,is_active:e},{onConflict:"property_id"})}));if(a.some(s=>s.error&&L(s.error))){p(`⚠️ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,P();return}const o=a.filter(s=>s.error).length;p(`${t.length-o}/${t.length} products ${e?"published":"unpublished"}${o?` (${o} failed: ${a.find(s=>s.error)?.error?.message||"error"})`:""}`,o?"error":"success"),window._productSelection=new Set,P()};window.bulkDuplicateProducts=async function(){const e=fe();if(e.length){for(const t of e)await duplicateProduct(t,!0);p(`${e.length} products duplicated`),window._productSelection=new Set,P()}};window.bulkArchive=async function(){const e=fe();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(o=>c.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",o)));if(t.some(o=>o.error&&L(o.error))){p("⚠️ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,P();return}const i=t.filter(o=>o.error).length;p(`${e.length-i}/${e.length} products archived${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,P()};window.bulkDeleteProducts=async function(){const e=fe();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(o=>c.from("showroom_listings").delete().eq("property_id",o)));if(t.some(o=>o.error&&L(o.error))){p("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,P();return}const i=t.filter(o=>o.error).length;p(`${e.length-i}/${e.length} products deleted${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,P()};window.previewProduct=async function(e){const t=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return p("Product not found","error");T(`
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(o=>o.property_id===e)||t.data;if(!a)return p("Product not found","error");const i=Array.isArray(a.images)?a.images:[];T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Qe(),Ze(),Z(),ee(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb img")].map(b=>b.getAttribute("src")).filter(b=>b&&!String(b).startsWith("blob:")),o={title:a.get("title")||"Untitled Product",price:Math.max(B,Math.min(N,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},s=String(a.get("real_price")||"").trim(),r=s===""?null:parseFloat(s);if(r!=null&&!Number.isFinite(r)){p("Real Price must be a number.","error");return}const l=J((window._productsData||[]).find(b=>b.property_id===t)),d=l.specifications&&typeof l.specifications=="object"?l.specifications:{};o.specifications={...d,real_price:r!=null&&r>0?Math.round(r):null};const{error:u}=await c.from("showroom_listings").upsert({...l,...o,property_id:t},{onConflict:"property_id"});if(u){if(L(u)){p("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),G(),P();return}pa(t,o),p("Quick edit saved locally","info")}else p(o.is_active?"Saved & published — your showroom shows it now":"Quick edit saved (draft)");G(),P()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),p("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await c.from("showroom_listings").delete().eq("property_id",e);if(t)return L(t)?p("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Delete failed: "+t.message,"error");p("Product deleted"),P()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?

This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await c.from("showroom_listings").delete().neq("property_id","__none__");if(t)return L(t)?p("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}p("All products deleted. The manager now shows your showroom catalog."),P()};window.openProductMoreActions=function(e){T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Qe(),Ze(),Me("pf-price"),Me("pf-real_price"),De(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>De(e,"pricing")),ti(e,t.property_id||""),window._pfEscapeHandler=s=>{s.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),G(),P()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,s]of i.entries())o==="images"?(a.images=a.images||[],s&&!String(s).startsWith("blob:")&&a.images.push(String(s))):o==="tags"?(a.tags=a.tags||[],a.tags.push(s)):a[o]=s;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function re(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function Qe(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Qa(t.dataTransfer.files)}))}function Ze(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Z()})}window.handleImageUpload=async function(e){await Gt(e.target.files)};async function Qa(e){await Gt(e)}async function Gt(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await Wt(a);if(i){const o=t.children.length,s=document.createElement("div");s.innerHTML=re(i,o),t.appendChild(s.firstElementChild),Z()}}he(),ee(),window.lucide&&lucide.createIcons()}}async function Wt(e){try{const{data:{session:t}}=await c.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:o}=await c.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(o)return URL.createObjectURL(e);const{data:s}=c.storage.from("product-images").getPublicUrl(i);return s.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Z(),he(),ee()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){p("Please choose an image file.","error");return}const o=await Wt(i);if(!o)return;const r=[...a.querySelectorAll(".img-thumb")][e];if(!r)return;const l=r.querySelector("img");l&&(l.src=o),Z(),he(),ee(),p("Image replaced. Save changes to apply.","info")};function Z(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.querySelector("img");if(!o)return;const s=document.createElement("input");s.type="hidden",s.name="images",s.id=`img-url-${i}`,s.value=o.src,t.appendChild(s),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function he(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ee(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,i=a>=24;t.textContent=i?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(i?"text-emerald-300":"text-gray-400");const o=document.querySelector('#product-form [name="is_active"]');i&&o&&!o.checked&&(o.checked=!0)}function Fe(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Za(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function ei(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,s])=>{const r=e.querySelector(`[name="${o}"]`);r&&(r.type==="checkbox"?r.checked=s==="on"||s===!0:r.value=s==null?"":String(s))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.map((s,r)=>re(s,r)).join(""),Z(),he(),ee())}return!0}function Ue(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,s=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,d=w.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",u=[...t.querySelectorAll('input[name="tags"]:checked')].map(g=>g.value),b=document.querySelectorAll("#image-preview .img-thumb").length,y=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    ...
    <div class="mt-2 text-gray-400">Tags: ${u.length?n(u.join(", ")):"No tags selected"}</div>
    ${d?`<div class="text-gray-500 mt-1">Category: ${n(d)}</div>`:""}
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",o=e.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,l=e.dataset.category||"Product",d=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",u=e.querySelector('[name="is_active"]')?.checked;T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${C(u?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${n(l)}</span></div>
    ...
    </div>`)};function ti(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Fe(e,t),o=document.getElementById("product-autosave-note");if(!t)try{const d=localStorage.getItem(i);if(d){const u=JSON.parse(d);ei(a,u)&&o&&(o.textContent="Autosave restored from your last session.",o.classList.remove("hidden"))}}catch{}const s=()=>{try{localStorage.setItem(i,JSON.stringify(Za(a))),o&&(o.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,o.classList.remove("hidden"))}catch{}Ue()};let r;const l=()=>{clearTimeout(r),r=setTimeout(s,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",l),d.addEventListener("change",l)}),Ue(),ee()}const ai=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],ii=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],oi=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],si=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],ri=["FWD","RWD","AWD","4WD"],ni={activeProvider:"gemini",maxImages:5,PROVIDERS:{gemini:{label:"Google Gemini (Free Tier)",scan:async(e,t)=>{const a=typeof t.onProgress=="function"?t.onProgress:()=>{};a(1,"Identifying the exact product from your images…");const i=await H.identifyProduct(e,t);if(!i||i.identified===!1)return{identification:i,specs:null,price:null};a(2,"Completing the standard specifications for that product…");const o=await H.completeProductSpecs(e,i,t);a(3,"Estimating a fair current market price…");let s=null;try{s=await H.estimateProductPrice(e,i,o,t)}catch{}return{identification:i,specs:o,price:s}}}},async scan(e,t){const a=this.PROVIDERS[this.activeProvider];if(!a)throw new Error(`Scanner provider "${this.activeProvider}" is not configured.`);return a.scan((e||[]).slice(0,this.maxImages),t)}};function li(e,t){const a=[...e.options||[]].map(r=>r.value).filter(Boolean);if(a.includes(String(t)))return String(t);const i={petrol:"Gasoline",gas:"Gasoline",gasoline:"Gasoline",unleaded:"Gasoline",ev:"Electric",electric:"Electric","fully electric":"Electric",hybrid:"Hybrid","hybrid electric":"Hybrid","plug-in hybrid":"Plug-in Hybrid",phev:"Plug-in Hybrid",auto:"Automatic",automatic:"Automatic","automatic transmission":"Automatic",manual:"Manual","manual transmission":"Manual",cvt:"CVT","continuously variable":"CVT","dual clutch":"Dual-Clutch",dct:"Dual-Clutch",fwd:"FWD","front-wheel drive":"FWD","front wheel drive":"FWD",rwd:"RWD","rear-wheel drive":"RWD","rear wheel drive":"RWD",awd:"AWD","all-wheel drive":"AWD","all wheel drive":"AWD","4wd":"4WD","four-wheel drive":"4WD","four wheel drive":"4WD","4x4":"4WD",sedan:"Sedan",saloon:"Sedan",suv:"SUV",hatchback:"Hatchback",coupe:"Coupe",coupé:"Coupe",convertible:"Convertible",wagon:"Wagon",estate:"Wagon",pickup:"Pickup","pick up":"Pickup",van:"Van",truck:"Truck","sports car":"Sports Car",motorcycle:"Motorcycle",yacht:"Yacht","like new":"Used - Like New","used - like new":"Used - Like New"},o=String(t).toLowerCase().trim();return i[o]?i[o]:a.find(r=>r.toLowerCase().includes(o)||o.includes(r.toLowerCase()))||null}function di(e){const t=[];return e.year&&t.push(e.year),e.brand&&t.push(e.brand),e.model&&t.push(e.model),!e.model&&e.body_type&&t.push(e.body_type),t.join(" ")||e.detected_name||""}function ci(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,o=[],s=m=>Array.isArray(m)?m.join(", "):String(m??"").trim(),r=(m,h,_)=>{if(h==null||s([h])==="")return;const I=document.querySelector(`#product-form [name="${m}"]`);if(!I)return;let R=String(h);if(_&&!_.includes(R)){const v=li(I,R);if(v===null)return;R=v}I.value=R,o.push(m)};r("brand",t.brand),r("model",t.model),r("color",t.color),r("condition",t.condition,ai),r("subcategory",t.subcategory),r("body_type",t.body_type||a.body_type,ii),r("model_year",t.year||a.model_year),r("title",a.title||di(t)),r("description",a.description),r("engine",a.engine),r("transmission",a.transmission,oi),r("fuel_type",a.fuel_type,si),r("drive_type",a.drive_type,ri),r("horsepower",a.horsepower),r("mileage",a.mileage),r("seating_capacity",a.seating_capacity),r("doors",a.doors),r("safety_features",s(a.safety_features)),r("storage",a.storage),r("ram",a.ram),r("processor",a.processor),r("display",a.display),r("graphics",a.graphics),r("os",a.os),r("material",a.material),r("size",a.size),r("gender",a.gender),r("platform",a.platform);const l=document.querySelector('#product-form [name="price"]'),d=document.querySelector('#product-form [name="real_price"]'),u=i?Number(i.estimated_price):NaN,b=i?Number(i.suggested_discount_price):NaN,y=Number.isFinite(Number(B))?Number(B):0,g=Number.isFinite(Number(N))?Number(N):999999999,f=m=>Math.max(y,Math.min(g,Math.round(m)));if(Number.isFinite(u)&&u>0){d&&(d.value=String(f(u)),o.push("real_price"));const m=Number.isFinite(b)&&b>0&&b<u?b:u;l&&(l.value=String(f(m)),o.push("price"))}return Ue(),{filled:o}}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){p("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(r=>r.value).filter(Boolean);if(!i.length){p("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",s=(r,l)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&a.classList.add(l),a.textContent=r)};try{const r=await H.getConfig();if(!String(r.gemini_key||r.gemini_api_key||"").trim()){s("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),p("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),s("Reading your uploaded images…","text-blue-300");try{const r=await ni.scan(i,{category:e.dataset.category||"",onProgress:(g,f)=>s(f,"text-blue-300")}),l=r?r.identification:null;if(!l||l.identified===!1){s(l&&l.reason?`Could not identify the product: ${n(l.reason)}`:"The product could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),p("The product could not be identified from the images.","error");return}const d=[l.year,l.brand,l.model].filter(Boolean).join(" ")||l.detected_name||"the product",b=ci(r).filled;let y=`${n(d)} — ${b.length} field${b.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;l.year_estimated&&(y+=" Confirm the model year before saving."),s(y,"text-emerald-300"),p(`Review ${d}, then press SAVE / UPDATE.`,"success")}catch(r){const l=String(r?.message||r),d=/key|api|configured|settings|vision/i.test(l);s(d?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${l}`,"text-red-400"),p("AI scan failed.","error")}finally{t&&(t.disabled=!1,t.innerHTML=o),window.lucide&&lucide.createIcons()}};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),s=a?"One-Click Publish Changes":"One-Click Publish Product";o&&(o.disabled=!0,o.textContent="Saving…");try{const r=new FormData(i),l={};for(const[g,f]of r.entries())g==="images"?(l.images=l.images||[],f&&!String(f).startsWith("blob:")&&l.images.push(String(f))):g==="tags"?(l.tags=l.tags||[],l.tags.push(f)):l[g]=f;l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",u=g=>Le(g),b=g=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price"],m={};for(const h of f){const _=g[h];if(h==="real_price"){const I=_!=null&&String(_).trim()!==""?parseFloat(_):null;m[h]=I!=null&&Number.isFinite(I)&&I>0?Math.round(I):null;continue}m[h]=_!=null&&String(_).trim()!==""?_:null}if(g.safety_features){const h=u(g.safety_features);m.safety_features=h.length?h:null}return m};let y;if(a){let g=J((window._productsData||[]).find(E=>E.property_id===a));if(!g){const{data:E}=await c.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();g=E?J(E):null}if(!g)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(E,Se)=>{const oa=E===""||E==null?"":E,sa=Se===""||Se==null?"":Se;return String(oa).trim()===String(sa).trim()},m={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(E=>{f(l[E],g[E])||(m[E]=l[E]==null||l[E]===""?null:l[E])});const h=l.price===""||l.price==null?null:parseFloat(l.price);f(h,g.price)||(m.price=h==null?g.price:Math.max(B,Math.min(N,h)));const _=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);f(_,g.stock_quantity)||(m.stock_quantity=Number.isFinite(_)?_:null);const I=u(l.features_text);f(I.join("||"),(Array.isArray(g.features)?g.features:[]).join("||"))||(m.features=I);const R=l.tags||[];f(R.join("||"),(Array.isArray(g.tags)?g.tags:[]).join("||"))||(m.tags=R);const v=u(l.highlights_text);f(v.join("||"),(Array.isArray(g.highlights)?g.highlights:[]).join("||"))||(m.highlights=v);const j=u(l.seo_keywords_text);f(j.join("||"),(Array.isArray(g.seo_keywords)?g.seo_keywords:[]).join("||"))||(m.seo_keywords=j);const it=l.images||[];f(it.join("||"),(Array.isArray(g.images)?g.images:[]).join("||"))||(m.images=it);const ot=l.is_featured==="on";!!g.is_featured!==ot&&(m.is_featured=ot);const st=d?!1:l.is_active==="on"||(l.images||[]).length>=24;!!g.is_active!==st&&(m.is_active=st);const ia=b(l),rt={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},...ia};if(JSON.stringify(rt)!==JSON.stringify(g.specifications||{})&&(m.specifications=rt),Object.keys(m).length===0){p("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Fe(t,a))}catch{}o&&(o.disabled=!1,o.textContent=s);return}const nt={...g,...m,property_id:a,updated_at:new Date().toISOString()};if({error:y}=await c.from("showroom_listings").upsert(nt,{onConflict:"property_id"}),y&&Be(y,()=>Ee(nt),"Product update")){o&&(o.disabled=!1,o.textContent=s);return}p(d?"Draft saved!":`Saved & published — your showroom shows it now (${Object.keys(m).length} change${Object.keys(m).length>1?"s":""}).`)}else{const g=parseInt(l.required_image_count||"0",10)||(Xe.includes(t)?24:0);if(Ht(g,l.images||[],"This listing"),!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!l.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(B,Math.min(N,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:l.is_active==="on"||(l.images||[]).length>=24,is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:u(l.features_text).length?u(l.features_text):l.tags||[],tags:l.tags||[],highlights:u(l.highlights_text),seo_keywords:u(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:b(l)},m=We();if(f.property_id=m,{error:y}=await c.from("showroom_listings").insert(f),y&&Be(y,()=>Ee({...f,property_id:f.property_id}),"Product publish")){o&&(o.disabled=!1,o.textContent=s);return}p(d?"Draft saved!":"Published! Your showroom shows this product now.")}try{localStorage.removeItem(Fe(t,a))}catch{}closeProductFormModal(),P()}catch(r){p("Error: "+r.message,"error"),o&&(o.disabled=!1,o.textContent=s)}};window.editProduct=async function(e){const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=mt(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=J((window._productsData||[]).find(o=>o.property_id===e)),{error:i}=await c.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return L(i)?p(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):p(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");p(t?"Product published":"Product unpublished"),P()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:s,updated_at:r,...l}=a,d=We();await c.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),P())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await c.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),P())};const ui=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function zt(){const e=document.getElementById("content");try{const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?He().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(M)){const o=new Set(i.map(r=>r.property_id)),s=M.filter(r=>r.listing_type==="property"&&r.property_id&&!o.has(r.property_id));s.length&&(i=i.concat(s))}i.sort((o,s)=>new Date(s.created_at||0)-new Date(o.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=_t("property","Real Estate"),i=e.country_code||"US",o=e.currency||Ge(i);T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${Ot(i)}</select></div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${ui.map(s=>`<option value="${s}" ${e.property_type===s?"selected":""}>${s}</option>`).join("")}
            </select></div>
    ...
    </div>`),Qe(),Ze(),Me("ppf-price"),window.syncPropertyCountry=function(){ct("ppf")},ct("ppf"),Re("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Re("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(u=>u&&!u.startsWith("blob:")),s=(i.features_text||"").split(",").map(u=>u.trim()).filter(Boolean),r=t?0:parseInt(i.required_image_count||"24",10)||24;Ht(r,o,"This property");const l={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(B,Math.min(N,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:s,images:o,highlights:Le(i.highlights_text),seo_keywords:Le(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){l.property_id=t;const u=J((window._propertiesData||[]).find(b=>b.property_id===t)||(window._productsData||[]).find(b=>b.property_id===t));({error:d}=await c.from("showroom_listings").upsert({...u,...l},{onConflict:"property_id"}))}else l.property_id=We(),{error:d}=await c.from("showroom_listings").insert(l);d&&Be(d,()=>Ee({...l,property_id:t||l.property_id}),t?"Property update":"Property publish")||(p(t?"Property updated!":"Property published!"),G(),zt())};window.editProperty=async function(e){const{data:t,error:a}=await c.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=mt(e)),i||(i=(Array.isArray(M)?M.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const pi=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Vt(){const e=document.getElementById("content");try{const{data:t}=await c.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(s=>mi(s)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}function mi(e){return`<tr class="order-row" data-status="${e.status}" data-search="${n(e.order_number)} ${n(e.full_name)} ${n(e.email)}">
    ...
    <td>${C(e.status)}</td>
    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${D(e.created_at)}</span></td>
    <td>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",At(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",W(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${n(i)||"—"}</p></div>`).join("")}
          </div>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await c.from("payment_receipts").update({status:t}).eq("id",e);if(a){p(a.message,"error");return}p("Order status updated"),G(),Vt()};async function bi(){const e=document.getElementById("content");try{const{data:t}=await c.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(i=>`<tr class="cust-row" data-search="${n(i.display_name)} ${n(i.user_id)}">
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${D(i.created_at)}</span></td>
                    <td>
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await c.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${D(t.created_at)} · ${n(t.country_code||"Unknown country")}</p>
          </div>
        </div>
    ...
    </div>`)};async function ne(){const e=document.getElementById("content");try{const{data:t}=await c.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:o}=await c.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),s=o||[],r=s.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?V("star","No Reviews","Customer reviews will appear here."):a.map(l=>yi(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${s.length===0?V("message-square","No Feedback Yet","Site feedback will appear here."):s.map(l=>gi(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}function gi(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"★":"☆").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1 flex-wrap">
          ...
          <span class="text-xs text-gray-500">${n(e.email||"no email")} · ${D(e.created_at)}</span>
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await c.from("site_feedback").update({is_approved:!0}).eq("id",e);t?p(t.message,"error"):p("Feedback approved — it now shows on every page."),ne()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await c.from("site_feedback").delete().eq("id",e);t?p(t.message,"error"):p("Feedback deleted."),ne()};function yi(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1">
          <span class="text-amber-400 font-bold text-sm">${t}</span>
          <span class="text-xs text-gray-500">${D(e.created_at)}</span>
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await c.from("product_reviews").update({is_approved:!0}).eq("id",e),p("Review approved"),ne()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await c.from("product_reviews").delete().eq("id",e),p("Review deleted"),ne())};async function Kt(){const e=document.getElementById("content");try{const{data:t}=await c.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?V("message-circle","No Messages","Customer support messages will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.markMsgRead=async function(e){await c.from("support_messages").update({is_read:!0}).eq("id",e),p("Marked as read"),Kt()};async function ve(){const e=document.getElementById("content");try{const{data:t}=await c.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${D(i.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await c.from("coupons").insert(i);if(o){p(o.message,"error");return}p("Coupon created!"),G(),ve()};window.toggleCoupon=async function(e,t){await c.from("coupons").update({is_active:t}).eq("id",e),p(t?"Coupon activated":"Coupon deactivated"),ve()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await c.from("coupons").delete().eq("id",e),p("Coupon deleted"),ve())};async function fi(){const e=document.getElementById("content");try{const{data:t}=await c.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?V("bell","No Notifications","System notifications will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}const Yt=["Featured","Sponsored","Featured Collection","Discover","Promotion"],hi=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let le=null;function vi(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${n(e)}</span>`}function xi(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${n(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${n(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${n(e.link_target||"")}</span>`}function wi(e){return e.video_url?`<video src="${n(e.video_url)}" ${e.poster_url?`poster="${n(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${n(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Jt(){if(le)return le;const e=[],t=new Set,a=[],i=s=>{if(!s||!s.property_id)return;e.push({id:s.property_id,title:s.title||s.property_id});const r=s.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{M.forEach(i)}catch{}try{const{data:s,error:r}=await c.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&s&&s.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(s=>{t.has(s)||(t.add(s),a.push(s))}),le={products:e,categories:a,sections:hi},le}async function _i(e){try{const{data:{session:t}}=await c.auth.getSession();if(!t)return p("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),o=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:s}=await c.storage.from("advertisements").upload(o,e,{contentType:e.type,upsert:!1});if(s)return p("Upload failed: "+s.message,"error"),null;const{data:r}=c.storage.from("advertisements").getPublicUrl(o);return{url:r.publicUrl,isVideo:i}}catch{return p("Upload failed","error"),null}}function ue(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),o=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),o&&(o.value=t?"":e),a.innerHTML=t?`<video src="${n(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${n(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){p("Choose an image or video file","error");return}const i=await _i(t);if(!i){e.value="";return}ue(i.url,i.isVideo);const o=document.getElementById("ad-media-url");o&&(o.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);ue(t,a)};function et(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let o="";t==="product"?o='<option value="">Select a product…</option>'+e.products.map(s=>`<option value="${n(s.id)}" ${String(a)===String(s.id)?"selected":""}>${n(s.id)} — ${n((s.title||"").slice(0,60))}</option>`).join(""):t==="category"?o='<option value="">Select a category…</option>'+e.categories.map(s=>`<option value="${n(s)}" ${a===s?"selected":""}>${n(s)}</option>`).join(""):t==="section"&&(o='<option value="">Select a section…</option>'+e.sections.map(s=>`<option value="${n(s.id)}" ${a===s.id?"selected":""}>${n(s.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${o}</select>`}function Xt(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${Yt.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";et(e,a,"")};window.showAddAdModal=async function(){const e=await Jt();window._adLinkCache=e,T(Xt(null)),et(e,"none","")};window.showEditAdModal=async function(e){const t=await Jt();window._adLinkCache=t;const{data:a}=await c.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){p("Ad not found","error");return}T(Xt(a)),a.image_url?ue(a.image_url,!1):a.video_url&&ue(a.video_url,!0),et(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",o={title:a.title,description:a.description||"",ad_label:Yt.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!o.image_url&&!o.video_url){p("Add an image or video for the ad","error");return}const s=e.target.querySelector('button[type="submit"]');s&&(s.disabled=!0);try{if(i){const{error:r}=await c.from("promotions").update(o).eq("id",i);if(r)throw r;p("Ad updated!")}else{const{error:r}=await c.from("promotions").insert(o);if(r)throw r;p("Ad created!")}}catch(r){p(r.message||"Save failed","error"),s&&(s.disabled=!1);return}G(),te()};window.togglePromo=async function(e,t){const{error:a}=await c.from("promotions").update({is_active:t}).eq("id",e);if(a){p(a.message,"error");return}p(t?"Ad activated":"Ad deactivated"),te()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await c.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const o=a||[],s=o.findIndex(u=>u.id===e),r=s+t;if(s<0||r<0||r>=o.length){p("Already at the edge","info");return}const l=o[s],d=o[r];await c.from("promotions").update({sort_order:d.sort_order}).eq("id",l.id),await c.from("promotions").update({sort_order:l.sort_order}).eq("id",d.id),p("Order updated")}catch(a){p(a.message||"Reorder failed","error")}te()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await c.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(o=>{const s=/\/object\/public\/advertisements\/(.+)$/.exec(o);return s?decodeURIComponent(s[1]):null}).filter(Boolean);if(i.length)try{await c.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await c.from("promotions").delete().eq("id",e);if(a)throw a;p("Ad deleted")}catch(t){p(t.message||"Delete failed","error")}te()}};async function te(){const e=document.getElementById("content");try{const{data:t}=await c.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    ${xi(i)}
                    <span class="text-[10px] text-gray-500">${D(i.start_date)}${i.start_date?" → ":""}${D(i.end_date)}</span>
                  </div>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.renderAds=te;const xe=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],F={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Qt(){const e=document.getElementById("content");try{let t=function(s){const r=o===s.id,l=i[s.kf],d=i[s.mf]||s.dm;return`
        <div class="glass-soft border ${r?F.border[s.color]+" "+F.bg[s.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${s.id}">
          <div class="flex items-start justify-between gap-2">
            <div class="flex items-center gap-2.5 min-w-0">
              <div class="w-8 h-8 ${F.bg[s.color]} rounded-lg flex items-center justify-center shrink-0">
                <i data-lucide="${s.icon}" class="w-4 h-4 ${F.text[s.color]}"></i>
              </div>
              <div class="min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  <h3 class="text-xs font-black text-white">${n(s.name)}</h3>
                  <span class="text-[8px] font-black uppercase px-1.5 py-0.5 rounded-full ${F.badge[s.color]}">${s.tag}</span>
                </div>
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${r?F.text[s.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${s.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${F.text[s.color]} hover:underline flex items-center gap-0.5">
          ...
          <div>
            ...
            <select class="input-field text-xs" name="${s.mf}">
              ${s.models.map(u=>`<option value="${u}" ${d===u?"selected":""}>${u}</option>`).join("")}
            </select>
          </div>
        </div>`};const{data:a}=await c.from("ai_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.active_provider||"gemini";e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${xe.map(t).join("")}</div>
          </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.highlightAI=function(e){xe.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?F.border[t.color]+" "+F.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const o=a.querySelector("input[type=radio] + span");o&&(o.className=`text-[9px] font-bold ${i?F.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};xe.forEach(o=>{a[o.mf]&&(i[o.mf]=a[o.mf]);const s=(a[o.kf]||"").trim();s&&!s.startsWith("••••")&&s!==""&&(i[o.kf]=s)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key);try{const{data:o}=await c.from("ai_settings").select("id").limit(1).maybeSingle();let s;if(o?.id?{error:s}=await c.from("ai_settings").update(i).eq("id",o.id):{error:s}=await c.from("ai_settings").insert(i),s){p("Save failed: "+s.message,"error"),console.error("[AI Save]",s);return}await H.reload(),p("✅ AI settings saved!","success"),setTimeout(()=>Qt(),600)}catch(o){p("Unexpected error: "+o.message,"error"),console.error("[AI Save]",o)}};const H={_cfg:null,async reload(){const{data:e,error:t}=await c.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async chat(e,{maxTokens:t=2e3}={}){const a=await this.getConfig();if(!String(a.gemini_key||"").trim())throw new Error("No AI provider configured. Go to AI Settings and add your Gemini API key.");const i=e[e.length-1],o={action:"chat",message:String(i?.content||"").trim(),history:e.slice(0,-1).map(r=>({role:r.role,content:String(r.content||"")})),provider_override:"gemini",max_tokens:t},s=await this._callEdge(o);if(s&&s.response)return{text:s.response,provider:"Google Gemini",model:s.model||a.gemini_model};throw new Error(String(s?.error||"Gemini is unavailable."))},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return xe.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is — the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function Pe(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),o=t.lastIndexOf("}");if(i===-1||o===-1||o<=i)return null;const s=t.slice(i,o+1);try{return JSON.parse(s)}catch{return null}}async function $i(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([c.from("site_settings").select("*").limit(1).maybeSingle(),Si()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),s=a.length?`
        <div class="mt-4">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function Si(){const e=new Set,t=[],a=i=>{for(const o of i||[]){const s=o&&(o.property_id||o.id);s&&!e.has(s)&&(e.add(s),t.push(o))}};try{const{data:i}=await c.from("showroom_listings").select("property_id,title,name,category,listing_type,images,is_active").order("created_at",{ascending:!1}).limit(500);a(i)}catch{}return a(He()),a(M),a(gt),a(yt),a(ft),a(ht),t.slice(0,250)}window.filterPromoPicker=function(e){const t=document.getElementById("promo-picker-list");if(!t)return;const a=(e||"").trim().toLowerCase();t.querySelectorAll("[data-promo-search]").forEach(i=>{i.style.display=!a||i.dataset.promoSearch.toLowerCase().includes(a)?"":"none"})};window.selectAllPromoPicks=function(){document.querySelectorAll('#promo-picker-list input[name="live_promo_product_ids"]').forEach(e=>{e.checked=!0})};window.clearAllPromoPicks=function(){document.querySelectorAll('#promo-picker-list input[name="live_promo_product_ids"]').forEach(e=>{e.checked=!1})};window.saveContent=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=Array.from(new Set(t.getAll("live_promo_product_ids").map(s=>String(s).trim()).filter(Boolean)));i.length?a.live_promo_product_ids=i:a.live_promo_product_ids=[];const{error:o}=await c.from("site_settings").upsert({id:1,...a});if(o){p(o.message,"error");return}p("Content settings saved!")};const Pi=[{key:"banner",title:"ANDROID APP BANNER",desc:"The mobile-app promotion banner shown at the bottom of every page. Editing these words never changes the banner design, phone image, logo or buttons.",accent:"from-cyan-400 to-blue-500",fields:[{key:"app_banner_title",label:"App Banner Title",type:"text"},{key:"app_banner_description",label:"App Banner Description",type:"textarea"},{key:"app_banner_button_text",label:"App Banner Button Text",type:"text"},{key:"app_banner_secondary_text",label:"App Banner Secondary Text",type:"text"}]},{key:"bottom",title:"BOTTOM / END-OF-PAGE SECTION",desc:"The final professional closing area of the website — thank-you message, customer support, footer links and copyright. The polished design stays; only these words change.",accent:"from-emerald-400 to-cyan-500",fields:[{key:"bottom_heading",label:"Bottom Section Heading",type:"text"},{key:"bottom_main_message",label:"Main Bottom Message",type:"textarea"},{key:"bottom_closing_message",label:"Closing Message",type:"text"},{key:"bottom_support_heading",label:"Customer Support Heading",type:"text"},{key:"bottom_support_description",label:"Customer Support Description",type:"textarea"},{key:"bottom_support_button_text",label:"Support Button Text",type:"text"},{key:"bottom_footer_text",label:"Footer Section Text",type:"text"},{key:"bottom_footer_closing",label:"Footer Closing Message",type:"text"},{key:"bottom_copyright",label:"Copyright Text (empty = automatic “© year Brand” line)",type:"text"}]}];async function Ei(){const e=document.getElementById("content");try{const{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a={...la,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;try{const{data:i}=await c.from("site_settings").select("id").limit(1).maybeSingle();let o;if(i?.id?{error:o}=await c.from("site_settings").update(a).eq("id",i.id):{error:o}=await c.from("site_settings").insert({id:1,...a}),o)throw new Error(o.message);ra(),p("Content updated — the banner and bottom section now use your new wording.","success")}catch(i){p(i.message||"Could not save content. Please try again.","error")}};async function Ai(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([c.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),c.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),c.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],s=o.filter(u=>["approved","payment_approved","delivered"].includes(u.status)).reduce((u,b)=>u+(parseFloat(b.amount)||0),0),r=o.length>0?(o.filter(u=>u.status!=="cancelled").length/o.length*100).toFixed(1):0,l={};(a.data||[]).forEach(u=>{l[u.category]=(l[u.category]||0)+1});const d=Object.entries(l).sort((u,b)=>b[1]-u[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${A("Total Revenue",`$${s.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${A("Total Orders",o.length,"shopping-bag","blue")}
          ${A("Customers",i.count||0,"users","violet")}
          ${A("Conversion Rate",r+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Nt(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function Ii(){const e=document.getElementById("content"),{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveEmailSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["email_order_placed","email_order_shipped","email_order_delivered","email_review_request"].forEach(i=>{i in a?a[i]=!0:a[i]=!1}),await c.from("site_settings").upsert({id:1,...a}),p("Email settings saved!")};async function we(){const e=document.getElementById("content");e&&(e.innerHTML=Q());try{const[t,a,i]=await Promise.all([c.from("admin_security_logs").select("*").order("created_at",{ascending:!1}).limit(50),c.from("admin_2fa").select("enabled,backup_codes,created_at").eq("user_id",w.user?.id).maybeSingle(),c.auth.mfa.listFactors()]),o=t.data||[],s=a.data||{},r=(i.data?.totp||[])[0],l=!!r&&r.status==="verified",d=(s.backup_codes||[]).filter(u=>!u.used).length;e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${d} · Enrolled: ${D(s.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${o.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':o.map(u=>{const b=["login_success","login_2fa_success"].includes(u.event_type),y=["login_failed","login_denied","login_backup_code_used"].includes(u.event_type),g=b?"text-emerald-400":y?"text-red-400":"text-gray-300",f={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[u.event_type]||u.event_type;return`<tr>
                      ...
                      <td><span class="text-xs text-gray-500">${W(u.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,document.getElementById("new-pw")?.addEventListener("input",u=>{const b=u.target.value,y=[{label:"8+ characters",ok:b.length>=8},{label:"Uppercase letter",ok:/[A-Z]/.test(b)},{label:"Number",ok:/[0-9]/.test(b)},{label:"Special character",ok:/[^a-zA-Z0-9]/.test(b)}];document.getElementById("pw-strength").innerHTML=y.map(g=>`<div class="flex items-center gap-1.5 text-[10px] ${g.ok?"text-emerald-400":"text-gray-600"}">
          <i data-lucide="${g.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${g.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(a!==i){p("Passwords do not match","error");return}if(a.length<8){p("Password must be at least 8 characters","error");return}const{error:o}=await c.auth.signInWithPassword({email:w.user.email,password:t});if(o){p("Current password is incorrect","error");return}const{error:s}=await c.auth.updateUser({password:a});if(s){p(s.message,"error");return}await U(w.user.id,"password_changed"),p("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){T(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Zt(10);await c.from("admin_2fa").update({backup_codes:e}).eq("user_id",w.user.id),p("New backup codes generated"),ea(e.map(t=>t.code)),we()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await c.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await c.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await c.from("admin_2fa").update({enabled:!1}).eq("user_id",w.user.id),await U(w.user.id,"2fa_disabled"),p("2FA has been disabled"),we()}catch(e){p(e.message,"error")}};async function Ti(){const e=document.getElementById("content");try{const{data:t}=await c.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function Bi(){const e=document.getElementById("content");try{const{data:t}=await c.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),p("Orders exported!")};async function Li(){const e=document.getElementById("content"),{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await c.from("site_settings").upsert({id:1,...a}),p("Settings saved!")};async function _e(){const e=document.getElementById("content");e&&(e.innerHTML=Q());try{const{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",s=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function ke(){const e=document.getElementById("content");e&&(e.innerHTML=Q());try{let t=function(l,d,u,b="",y="blue"){const g=!!(u&&u.trim());return`
        <div class="glass-soft border border-${y}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${g?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
                <img src="${n(u)}" alt="${n(l)}" class="max-h-20 max-w-full object-contain p-2" onerror="this.closest('div').innerHTML='<p class=&quot;text-xs text-gray-600 text-center&quot;>Image broken</p>'">
        ...
        </div>`};const{data:a}=await c.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||St,s=i.brand_slogan||i.site_tagline||Pt,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${n(a.message)}</div>`)}}function Mi(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",o=t[a]||"",s=t[i]||"",r=!!(o&&o.trim()),l=!!(s&&s.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function ta(){const e={};for(const t of me)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=ta();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),oe(t),p("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const s=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${s}`,{error:l}=await c.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let d;if(l)d=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:g}=c.storage.from("product-images").getPublicUrl(r);d=g.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const u=document.getElementById("val-"+t),b=document.getElementById("url-"+t);u&&(u.value=d),b&&(b.value=d,b.classList.remove("hidden"));const y=ta();oe(y)}catch(s){o&&(o.textContent=`Upload failed: ${s.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const s of me)t[s.key+"_bg_image"]=document.getElementById("val-"+s.key+"_bg_image")?.value||"",t[s.key+"_bg_video"]=document.getElementById("val-"+s.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await c.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await c.from("site_settings").update(t).eq("id",i.id):{error:o}=await c.from("site_settings").insert(t),na(),o?(p("Publish failed — the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),oe(t)):(p("Promo & backgrounds published across all pages.","success"),setTimeout(()=>oe(),500))};window._manualPaymentAccounts=[];function tt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:bt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function at(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Di(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        ...
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${Ot(a)}</select></div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Di(t,a)).join("")}
    ...
    </div>`,at(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(tt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[tt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),at())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=be.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||bt(t),at(),renderManualPaymentAccountsEditor()};async function qe(){const e=document.getElementById("content");e&&(e.innerHTML=Q());try{const{data:t}=await c.from("site_settings").select("*").limit(1).maybeSingle(),i={...ba()||{},...t||{}};window._manualPaymentAccounts=ga(i).map(o=>({...o})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let u=[];if(i)if(s){const f=Math.min(o,8e3);for(let m=0;m<f&&u.length<ie;m++){const h=lt(i.slug,m);if(!h)continue;`${h.property_id} ${h.title} ${h.subcategory||""} ${h.category||""}`.toLowerCase().includes(s)&&u.push(h)}}else{const f=k.page*ie,m=Math.min(f+ie,o);for(let h=f;h<m;h++){const _=lt(i.slug,h);_&&u.push(_)}}const b=u.length?u.map(f=>{const m=t.has(f.property_id),h=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${m?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${n(f.property_id)} · ${n(f.subcategory||f.category||"")} · ${At(f.price,"USD")}</p>
            </div>
            ${C(!m)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',y=s?1:Math.max(1,Math.ceil(o/ie)),g=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${s?`${u.length} match`:`${o.toLocaleString()} items in ${n(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${g}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){k.category=e,k.page=0,k.query="",ae()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");k.query=e?e.value:"",k.page=0,ae()};window.catalogPage=function(e){const t=vt(k.category),a=t?t.count:0,i=k.query.trim()?1:Math.max(1,Math.ceil(a/ie));k.page=Math.max(0,Math.min(i-1,k.page+e)),ae()};window.catalogToggle=async function(e){const t=!xt().includes(e),a=await ha(e,t);p(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),ae()};window.catalogResetHidden=async function(){await va(),p("All hidden catalog listings restored"),ae()};async function pt(){window.lucide&&lucide.createIcons(),It(),await Fa(),c.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){w.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pt):pt();
