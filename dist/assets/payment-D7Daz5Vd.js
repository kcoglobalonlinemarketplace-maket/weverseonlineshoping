...
`),p=r.amountLabel||"",I=r.orderNumber||"";return`
  ...
  `}function Be(e,l,t){const r=J(A),o=t?V(t):null;return`
    <div class="glass border border-blue-200 rounded-2xl p-5 mb-5 slide-up">
      ...
      <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
        ${r.map(i=>{const s=A.find(p=>p.currency===i);return`
  ...
  `}function Q(e){const l=R.findIndex(t=>t.id===e);return`
    <div class="glass border border-blue-200 rounded-2xl p-5 mb-5 slide-up">
      ...
      <div class="relative">
        ...
        <div class="space-y-4">
          ${R.map((t,r)=>{const o=r<=l,i=r===l;return`
  ...
  `}function Pe(e,l,t,r){const o=T(S(l.price,r),r);return`
  ...
  `}async function _e(){const e=document.getElementById("payment-content"),t=new URLSearchParams(window.location.search).get("guest")==="1",r=t?null:await ce();if(!r&&!t){window.location.href="/";return}const o=he();let i=await ae(o)||z(o)||oe(o)||se(o)||ne(o)||de(o)||ve(o);if(!i){const[{generateListingById:C},{loadHiddenCatalogIds:N}]=await Promise.all([D(()=>import("./catalog-Gzr5neLB.js"),__vite__mapDeps([0,1,2])),D(()=>import("./catalog-hidden-store-GylTxrT1.js"),__vite__mapDeps([1,2]))]);await N(),i=C(o)}if(i||(i=z(o)),!i){e.innerHTML=`
    ...
    <div class="fade-in">
      ...
      <div id="bank-account-container">${E.isFallback?Z(E.fallbackNotice):U(E.account,null,M,{amountLabel:T(P,f),orderNumber:$})}</div>

      <div id="upload-form-container">${Ee($,i,P,f,t,T(P,f))}</div>
