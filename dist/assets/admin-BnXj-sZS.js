import{S as G,i as $a,a as Pa,D as Ea}from"./scroll-progress-BB3Lskh5.js";import{a as Ia,g as Aa,C as pe,A as Ca}from"./localization-DfbOIilT.js";import{supabase as p}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as Ta,upsertLocalShowroomListing as Ve,getLocalShowroomListingById as Bt,listLocalShowroomListings as dt}from"./local-showroom-store-JrQn_yOW.js";import{g as Mt,s as La,l as Ba,a as Ma,b as Fa}from"./payment-settings-C3ovy1Lo.js";import{PRODUCT_LISTINGS as Ft}from"./products-data-CGLFLAJM.js";import{PRODUCT_EXTRA_LISTINGS as Dt}from"./products-extra-DecCj9NU.js";import{TRUCK_LISTINGS as Rt}from"./truck-data-DnyLExat.js";import{MOTORHOME_LISTINGS as Nt}from"./motorhome-data-SSjGu6g8.js";import{getCatalogCategory as Ut,getCatalogCategories as Da,generateProduct as Pt}from"./catalog-CDbNHtJ8.js";import{getHiddenCatalogIds as qt,saveCatalogHidden as Ra,resetHiddenCatalogIds as Na,loadHiddenCatalogIds as Ua}from"./catalog-hidden-store-C_88LjC_.js";const R=1,q=5e6,qa=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Oa=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Ot=[...qa,...Oa];function ct(e){return Ia[e]||"USD"}function jt(e,t){return Ot.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ja(e,t){const a=Math.max(R,Math.min(q,Number(e)||R));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Ha(e,t,a,i,o){const r=ja(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Ht({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:r}){const s=Ot.find(y=>y.id===e&&y.listingType===t);if(!s)return null;const l=Aa(i)||pe[0],d=o||ct(l.code),c=[l.name].filter(Boolean).join(", "),g={category:s.category||a||(t==="property"?"Real Estate":"Other"),subcategory:s.subcategory||s.label,title:t==="property"?`${s.label} in ${l.name}`:s.label,description:Ha(s,l,d,r,c),currency:d,features:[...s.features],highlights:[...s.highlights||[]],seo_keywords:[...new Set([s.category,s.subcategory,s.label,...t==="property"?[l.name]:[],...s.keywords||[]].filter(Boolean))],requiredImageCount:s.requiredImageCount||0};return t==="property"?{...g,country:l.name,country_code:l.code,product_location:l.name,property_type:s.propertyType||s.label,bedrooms:s.bedrooms??null,bathrooms:s.bathrooms??null,building_size:s.buildingSize||"",land_size:s.landSize||"",furnished:s.furnished||""}:{...g,brand:s.brand||"",model:s.model||"",color:s.color||"",size:s.size||"",condition:s.condition||"New"}}const Gt="weverseonlineshop@gmail.com",zt="Weverse Online Shop",Wt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",Ga="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),za=`${Ga}/functions/v1/ai-admin-assistant`,Wa=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Va={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Vt=[...Ca].sort();let _={user:null,section:"dashboard"};function n(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Kt(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function z(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function ie(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function ut(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Ka=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function ce(e){const t={};if(!e||typeof e!="object")return t;for(const a of Ka)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),o=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},s={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",r[t]||"info"),o.className=`w-4 h-4 shrink-0 ${s[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function N(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",n(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function X(){document.getElementById("modal-container").innerHTML=""}function U(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function D(e,t,a,i,o=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function me(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function re(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${n(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${n(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function Yt(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=Wa.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){_.section=e;const t=Va[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Yt(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=me()),window.lucide&&lucide.createIcons(),({dashboard:di,products:F,properties:_t,catalog:he,orders:ma,customers:Ri,reviews:Pe,messages:ga,coupons:Ue,ads:ye,notifications:qi,ai:Ya,"ai-settings":fa,"homepage-branding":je,"promo-bg":ke,content:Vi,"content-settings":Ji,seo:Xi,email:Zi,analytics:Qi,security:Oe,activity:eo,brand:He,"payment-settings":lt,backup:to,settings:ao,publish:Ge}[e]||(()=>{const s=document.getElementById("content");s&&(s.innerHTML=re("construction","Coming Soon",`${t} is being built.`))}))()};async function Ya(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const de="kco_admin_remember",pt="kco_login_attempts",Ke=5,Ja=15*60*1e3;function M(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Qa(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Fe(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Se(e){return String(e||"").trim().toLowerCase()}function Xa(){try{const e=JSON.parse(localStorage.getItem(de)||"{}");e?.email&&!Se(e.email)&&localStorage.removeItem(de)}catch{localStorage.removeItem(de)}}function Za(){try{const e=JSON.parse(localStorage.getItem(de)||"{}");return Se(e?.email)}catch{return""}}function mt(){Xa();const e=Za(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Gt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function ei(){return`${window.location.origin}/admin.html`}function se(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Fe(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function T(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Jt(){try{return JSON.parse(localStorage.getItem(pt)||'{"count":0}')}catch{return{count:0}}}function Qt(){const e=Jt();return e.count=(e.count||0)+1,e.count>=Ke&&(e.lockedUntil=Date.now()+Ja),localStorage.setItem(pt,JSON.stringify(e)),e}function Xt(){localStorage.removeItem(pt)}function Zt(){const e=Jt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Xt(),null):Math.ceil(t/6e4)}async function Y(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await ti(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function ti(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function ea(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Se(e.email)===Gt}async function ai(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Ae(),li();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await ea(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),o=await p.auth.mfa.getAuthenticatorAssuranceLevel(),r=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&r!=="aal2"){_.user=t.user,Ae(),se("2fa"),gt();return}_.user=t.user,De();return}ii()}function Ae(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function ii(){Ae(),se("login"),mt(),ta(),aa(),gt(),oi();const e=Zt();e&&(M(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function oi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function ta(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",ri),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>se("forgot")))}async function ri(e){e.preventDefault();const t=Zt();if(t){M(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Se(a?.value);if(!i){M("Enter your admin email address."),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;T("login-btn",!0),Fe();const{data:s,error:l}=await p.auth.signInWithPassword({email:i,password:o});if(l||!s.user){const b=String(l?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){M("Authentication is temporarily unavailable due to configuration. Please contact support."),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){M("Network error while signing in. Check your connection and try again."),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){M("Your admin email is not confirmed yet. Open your verification email and confirm first."),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const h=Qt(),m=Ke-h.count,f=h.lockedUntil?`Account locked for 15 minutes after ${Ke} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;M(f),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),s?.user&&await Y(s.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await ea(s.user)){await p.auth.signOut(),M(`Access denied for ${s.user.email}. This account is signed in but does not have administrator privileges.`),T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await Y(s.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(de,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(de),Xt(),_.user=s.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){T("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),se("2fa"),gt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await Y(s.user.id,"login_success"),T("login-btn",!1),De()}function gt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Et));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&Et()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),_.user=null,se("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",si))}async function Et(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){M("Enter the 6-digit code from your authenticator app.");return}T("verify-2fa-btn",!0),Fe();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){M("No 2FA factor found. Please re-login."),T("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await p.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:r}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(r)throw r;await Y(_.user.id,"login_2fa_success"),T("verify-2fa-btn",!1),De()}catch(t){Qt(),M(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),T("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function si(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){M("Enter a backup recovery code.");return}T("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",_.user.id).maybeSingle();if(!t?.backup_codes?.length){M("No backup codes found."),T("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){M("Backup code not found or already used."),T("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",_.user.id),await Y(_.user.id,"login_backup_code_used"),De()}catch(t){M(t.message),T("verify-backup-btn",!1,"Use Backup Code")}}function aa(){document.getElementById("back-to-login")?.addEventListener("click",()=>se("login")),document.getElementById("send-reset-btn")?.addEventListener("click",ni)}async function ni(){const e=document.getElementById("reset-email"),t=Se(e?.value);if(!t){M("Enter your admin email address to receive a reset link.");return}T("send-reset-btn",!0),Fe();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:ei()});if(T("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){M(a.message);return}Qa("Reset link sent! Check your inbox and open it from this device to continue.")}function li(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function De(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&_.user&&(t.textContent=_.user.email||"Admin"),mt(),navigate("dashboard")}window.adminSignOut=async function(){_.user&&await Y(_.user.id,"logout"),await p.auth.signOut(),_.user=null,Ae(),se("login"),mt(),ta(),aa()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(_.user&&await Y(_.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),_.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function di(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),r=t.data||[],s=a.data||[],l=s.filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,A)=>v+(parseFloat(A.amount)||0),0),d=s.filter(v=>["pending","pending_verification","processing"].includes(v.status)).length,c=r.filter(v=>v.listing_type!=="property").length,g=r.filter(v=>v.listing_type==="property").length,y=r.filter(v=>v.listing_type!=="property"&&v.is_active).length,b=i.count||0,h=o.count||0,m=(o.data||[]).filter(v=>!v.is_approved).length,f=new Date,I=s.filter(v=>{const A=new Date(v.created_at);return A.getMonth()===f.getMonth()&&A.getFullYear()===f.getFullYear()}).filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,A)=>v+(parseFloat(A.amount)||0),0),w=s.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${gi()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${D("Total Orders",s.length,"shopping-bag","blue",`${d} pending`)}
          ${D("Customers",b,"users","violet")}
          ${D("Products",c,"package","amber",`${y} active`)}
          ${D("Properties",g,"home","blue")}
            ...
            ${w.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':w.map(v=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${ie(v.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),ra(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${n(t.message)}</div>`)}}async function F(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,o=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));for(const d of dt().filter(c=>c.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));if(Array.isArray(G))for(const d of G.filter(c=>c.listing_type!=="property"&&c.property_id))i.has(d.property_id)||(i.add(d.property_id),o.push(d));const r=[...Ft,...Dt,...Rt,...Nt];for(const d of r)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));o.sort((d,c)=>new Date(c.created_at||0)-new Date(d.created_at||0));const s=[...new Set(o.map(d=>d.category).filter(Boolean))].sort((d,c)=>d.localeCompare(c)),l=[...new Set(o.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,c)=>d.localeCompare(c));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(s.length?s:we).map(d=>`<option value="${n(d)}" ${(window._productFilters.category||"")===d?"selected":""}>${n(d)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
          ...
          <div id="products-empty" class="hidden">${re("package-search","No matching products","Try different filters or add a new product.",'<button onclick="showAddProductStep1()" class="btn-press bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2 rounded-xl">Add Product</button>')}</div>
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,ia(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${n(t.message)}</div>`)}}function ee(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ye(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function ci(e){const t=ee(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function ui(e){const t=ee(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function bt(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Je(e){return parseInt(e.views??e.view_count??0,10)||0}function Qe(e){return parseInt(e.sales??e.sales_count??0,10)||0}function yt(e){return e.sku||e.property_id||"N/A"}function pi(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ye(e),i=bt(e),o=window._productSelection?.has(e.property_id),r=N(i==="archived"?"inactive":i==="active"?"active":"inactive"),s=z(e.created_at),l=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",g=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${n(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${n(yt(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${n(ci(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${Je(e).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${Qe(e).toLocaleString()}</p></div>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mt-auto">
      ...
      <button onclick="event.stopPropagation();${d}" class="btn-press px-4 py-3.5 rounded-2xl text-sm font-bold ${g} transition">${c}</button>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(y=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${n(y)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function mi(e,t){const a=[...e],i=o=>new Date(o||0).getTime()||0;return t==="oldest"?a.sort((o,r)=>i(o.created_at)-i(r.created_at)):t==="price-high"?a.sort((o,r)=>ee(r.price)-ee(o.price)):t==="price-low"?a.sort((o,r)=>ee(o.price)-ee(r.price)):t==="sales-high"?a.sort((o,r)=>Qe(r)-Qe(o)):t==="views-high"?a.sort((o,r)=>Je(r)-Je(o)):a.sort((o,r)=>i(r.created_at)-i(o.created_at)),a}function ia(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const o=window._productsCardLimit||60,r=e.slice(0,o);t.innerHTML=r.map(pi).join(""),i&&(i.textContent=String(e.length));const s=document.getElementById("products-more");if(s){const l=e.length-r.length;l>0?s.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:s.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function oa(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const o=i.images&&i.images[0]?i.images[0]:"/fallback.svg",r=bt(i),s=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${n(yt(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const c=ee(i.price),g=parseFloat(i.real_price);return Number.isFinite(g)&&g>0&&g>c?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${g.toLocaleString()}</span><span class="font-bold text-emerald-400">$${c.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${c.toLocaleString()}</span>`})()}
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${i.stock_quantity!=null?n(i.stock_quantity):"Unlimited"}</span></td>
          <td>${N(r==="archived"?"inactive":r==="active"?"active":"inactive")}</td>
        ...
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),i=document.getElementById("view-card-btn"),o=document.getElementById("view-table-btn"),r=document.getElementById("products-empty"),s=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&oa(s)),i&&i.classList.toggle("active",e!=="table"),o&&o.classList.toggle("active",e==="table"),r&&r.classList.toggle("hidden",s.length>0)};window.filterProducts=function(e){const t=window._productFilters||{};t.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),t.category=document.getElementById("prod-cat-filter")?.value||"",t.tag=document.getElementById("prod-tag-filter")?.value||"",t.status=document.getElementById("prod-status-filter")?.value||"",t.featured=document.getElementById("prod-featured-filter")?.value||"",t.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=t;const a=(window._productsData||[]).filter(o=>{const r=[o.title,o.brand,o.category,yt(o),Ye(o).join(" "),o.description].join(" ").toLowerCase();return!(t.search&&!r.includes(t.search)||t.category&&(o.category||"")!==t.category||t.tag&&!Ye(o).includes(t.tag)||t.status&&bt(o)!==t.status||t.featured&&t.featured==="featured"!=!!o.is_featured)}),i=mi(a,t.sort);e||(window._productsCardLimit=60),ia(i),window._productView==="table"&&oa(i)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const i=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(i):window._productSelection.delete(i)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function Re(){return window._productSelection?[...window._productSelection]:[]}function O(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function Xe(e,t,a){return e&&O(e)?(u(`⚠️ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),u(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=Re();if(!t.length)return;const a=await Promise.all(t.map(r=>{const s=ce((window._productsData||[]).find(l=>l.property_id===r));return p.from("showroom_listings").upsert({...s,property_id:r,is_active:e},{onConflict:"property_id"})}));if(a.some(r=>r.error&&O(r.error))){u(`⚠️ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,F();return}const o=a.filter(r=>r.error).length;u(`${t.length-o}/${t.length} products ${e?"published":"unpublished"}${o?` (${o} failed: ${a.find(r=>r.error)?.error?.message||"error"})`:""}`,o?"error":"success"),window._productSelection=new Set,F()};window.bulkDuplicateProducts=async function(){const e=Re();if(e.length){for(const t of e)await duplicateProduct(t,!0);u(`${e.length} products duplicated`),window._productSelection=new Set,F()}};window.bulkArchive=async function(){const e=Re();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(o=>p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",o)));if(t.some(o=>o.error&&O(o.error))){u("⚠️ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,F();return}const i=t.filter(o=>o.error).length;u(`${e.length-i}/${e.length} products archived${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,F()};window.bulkDeleteProducts=async function(){const e=Re();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(o=>p.from("showroom_listings").delete().eq("property_id",o)));if(t.some(o=>o.error&&O(o.error))){u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,F();return}const i=t.filter(o=>o.error).length;u(`${e.length-i}/${e.length} products deleted${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,F()};window.previewProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return u("Product not found","error");U(`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${N(a.is_active?"active":"inactive")}${a.is_featured?'<span class="badge bg-amber-500/15 text-amber-200 border-amber-500/30">Featured</span>':""}</div>
            <p class="text-xs text-gray-400">${n(a.description||"No description")}</p>
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${ee(a.price).toLocaleString()}</p></div>
    ...
    </div>`),ft(),vt(),be(),ne(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb img")].map(g=>g.getAttribute("src")).filter(g=>g&&!String(g).startsWith("blob:")),o={title:a.get("title")||"Untitled Product",price:Math.max(R,Math.min(q,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},r=String(a.get("real_price")||"").trim(),s=r===""?null:parseFloat(r);if(s!=null&&!Number.isFinite(s)){u("Real Price must be a number.","error");return}const l=ce((window._productsData||[]).find(g=>g.property_id===t)),d=l.specifications&&typeof l.specifications=="object"?l.specifications:{};o.specifications={...d,real_price:s!=null&&s>0?Math.round(s):null};const{error:c}=await p.from("showroom_listings").upsert({...l,...o,property_id:t},{onConflict:"property_id"});if(c){if(O(c)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),X(),F();return}Ta(t,o),u("Quick edit saved locally","info")}else u(o.is_active?"Saved & published — your showroom shows it now":"Quick edit saved (draft)");X(),F()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await p.from("showroom_listings").delete().eq("property_id",e);if(t)return O(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Delete failed: "+t.message,"error");u("Product deleted"),F()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return O(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),F()};window.openProductMoreActions=function(e){U(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${n(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${n(e)}')">${na(o)}</select></div>
            </div>
    ...
    </div>`),ft(),vt(),et("pf-price"),et("pf-real_price"),tt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>tt(e,"pricing")),xi(e,t.property_id||""),window._pfEscapeHandler=r=>{r.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),X(),F()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,r]of i.entries())o==="images"?(a.images=a.images||[],r&&!String(r).startsWith("blob:")&&a.images.push(String(r))):o==="tags"?(a.tags=a.tags||[],a.tags.push(r)):a[o]=r;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function ge(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function ft(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),hi(t.dataTransfer.files)}))}function vt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>be()})}window.handleImageUpload=async function(e){await da(e.target.files)};async function hi(e){await da(e)}async function da(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await xt(a);if(i){const o=t.children.length,r=document.createElement("div");r.innerHTML=ge(i,o),t.appendChild(r.firstElementChild),be()}}$e(),ne(),window.lucide&&lucide.createIcons()}}async function xt(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:o}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(o)return URL.createObjectURL(e);const{data:r}=p.storage.from("product-images").getPublicUrl(i);return r.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),be(),$e(),ne()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const o=await xt(i);if(!o)return;const s=[...a.querySelectorAll(".img-thumb")][e];if(!s)return;const l=s.querySelector("img");l&&(l.src=o),be(),$e(),ne(),u("Image replaced. Save changes to apply.","info")};function be(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.querySelector("img");if(!o)return;const r=document.createElement("input");r.type="hidden",r.name="images",r.id=`img-url-${i}`,r.value=o.src,t.appendChild(r),a.dataset.index=i;const s=a.querySelector(".rm");s&&s.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function $e(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ne(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,i=a>=24;t.textContent=i?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(i?"text-emerald-300":"text-gray-400");const o=document.querySelector('#product-form [name="is_active"]');i&&o&&!o.checked&&(o.checked=!0)}function _e(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function fi(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function vi(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,r])=>{const s=e.querySelector(`[name="${o}"]`);s&&(s.type==="checkbox"?s.checked=r==="on"||r===!0:s.value=r==null?"":String(r))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.map((r,s)=>ge(r,s)).join(""),be(),$e(),ne())}return!0}function it(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,s=t.querySelector('[name="stock_quantity"]')?.value,l=s===""||s==null?"Unlimited":s,d=_.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",c=[...t.querySelectorAll('input[name="tags"]:checked')].map(b=>b.value),g=document.querySelectorAll("#image-preview .img-thumb").length,y=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
      ...
      <div><span class="text-gray-500">Images</span><p class="text-white font-semibold">${g}</p></div>
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${N(c?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${n(l)}</span></div>
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){const e=document.getElementById(oe);if(e){if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!K.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed — nothing was changed.";return}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
      ...
      ${K.map((t,a)=>Ci(t,a)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=K[e];if(!t)return;const a=ca(t,Ne),i=wt(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){oe==="s1-scan-status"&&(X(),ae=[]),Ti(t,a);return}const r=i.category||t.category||"Other";if(oe==="s1-scan-status"){try{localStorage.removeItem(_e(r,""))}catch{}ae=[],showAddProductStep2(r,{images:a}),await At(t,a,r)}else{const s=document.getElementById("product-form"),l=s&&s.dataset.category||"";if(r!==l){try{localStorage.removeItem(_e(r,""))}catch{}switchProductFormCategory(r);const d=document.getElementById(oe);d&&(d.classList.remove("hidden"),d.classList.add("text-blue-300"),d.textContent=`Category changed to ${r} — finishing the scan…`),window.lucide&&lucide.createIcons()}await At(t,a,r)}};window.scanReviewEdit=function(e){const t=K[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=wt(t.category),r=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",s=we.map(l=>`<option value="${n(l)}" ${l===r?"selected":""}>${n(l)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=K[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,o=document.getElementById(`sr-model-${e}`)?.value,r=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),o&&(t.model=o),r&&(t.category=r),scanReviewRender()};window.scanReviewRemove=function(e){K.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(oe);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled — nothing was changed.")};function ua(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,o=[],r=k=>Array.isArray(k)?k.join(", "):String(k??"").trim(),s=(k,P)=>{if(P==null||r([P])==="")return;const $=document.querySelector(`#property-form [name="${k}"]`);$&&($.value=String(P),o.push(k))},l=t.property_type||a.property_type;if(l){const k=Ai(l);k&&s("property_type",k)}s("title",a.title||t.detected_name),s("description",a.description),s("subcategory",t.subcategory||a.subcategory);const d=t.bedrooms??a.bedrooms;d!=null&&d!==""&&s("bedrooms",parseInt(d,10)||d);const c=t.bathrooms??a.bathrooms;c!=null&&c!==""&&s("bathrooms",parseInt(c,10)||c),s("building_size",t.building_size||a.building_size),s("land_size",t.land_size||a.land_size);const g=t.parking_spaces??a.parking_spaces;g!=null&&g!==""&&s("parking_spaces",parseInt(g,10)||g);const y=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(y)?s("furnished","Furnished"):/unfurnished|no|empty/.test(y)&&s("furnished","Unfurnished");const b=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(b)?s("listing_status","rent"):/sale|buy|purchase/.test(b)&&s("listing_status","sale");const h=t.area||a.area;h&&!(t.town||a.town)&&s("town",h),s("town",t.town||a.town),s("city",t.city||a.city),s("state",t.state||a.state);const m=t.country||a.country;if(s("country",m),m){const k=(pe||[]).find(P=>String(P.name||"").toLowerCase()===String(m).toLowerCase()||String(P.code||"").toLowerCase()===String(m).toLowerCase());if(k&&k.code){const P=document.querySelector('#property-form [name="country_code"]');P&&(P.value=k.code,o.push("country_code"))}}const f=t.address||a.address;s("product_location",f||[h||t.town||a.town,t.city||a.city,t.state||a.state,m].filter(Boolean).join(", "));const S=Number(t.latitude??a.latitude),I=Number(t.longitude??a.longitude);Number.isFinite(S)&&S>=-90&&S<=90&&S!==0&&s("latitude",String(S)),Number.isFinite(I)&&I>=-180&&I<=180&&I!==0&&s("longitude",String(I)),s("features_text",r(a.features)),s("highlights_text",r(t.highlights||a.highlights)),s("seo_keywords_text",r(a.seo_keywords));const w=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map(k=>String(k))),v=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","latitude","longitude"]);w.forEach(k=>{if(v.has(k))return;const P=document.querySelector(`#property-form [name="${k}"]`);if(!(!P||P.type==="checkbox"||P.type==="radio"||P.type==="number")&&String(P.value||"").trim()===""){if(P.tagName==="SELECT"&&![...P.options].some($=>$.value==="Not specified")){const $=document.createElement("option");$.value="Not specified",$.textContent="Not specified",P.appendChild($)}P.value="Not specified",o.push(`${k} (Not specified)`)}});const A=Number.isFinite(Number(R))?Number(R):0,Z=Number.isFinite(Number(q))?Number(q):999999999,W=k=>Math.max(A,Math.min(Z,Math.round(k))),j=i?Number(i.estimated_price):NaN,le=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(j)&&j>0){const k=document.querySelector('#property-form [name="real_price"]');k&&(k.value=String(W(j)),o.push("real_price"));const P=Number.isFinite(le)&&le>0&&le<j?le:j;s("price",String(W(P)))}return typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:o}}async function At(e,t,a){const i=document.getElementById("scan-ai-status"),o=(r,s)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),s&&i.classList.add(s),i.innerHTML=r)};try{o("Completing the standard specifications for that product…","text-blue-300");const r=await B.completeProductSpecs(t,e,{category:a||"",maxImages:Q.maxImages});let s=null;o("Estimating a fair current market price…","text-blue-300");try{s=await B.estimateProductPrice(t,e,r||{},{category:a||"",maxImages:Q.maxImages})}catch{}const l=Ii({identification:e,specs:r,price:s}),d=[e.year,e.brand,e.model].filter(Boolean).join(" ")||e.detected_name||"the product";let c=`${n(d)} — ${l.filled.length} field${l.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;e.year_estimated&&(c+=" Confirm the model year before saving."),o(c,"text-emerald-300"),u(`Review ${d}, then press SAVE / UPDATE.`,"success")}catch(r){const s=String(r?.message||r),l=/key|api|configured|settings|vision/i.test(s);o(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${s}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){u("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(d=>d.value).filter(Boolean);if(!i.length){u("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",r=(d,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=d)};try{const d=await B.getConfig();if(!String(d.gemini_key||d.gemini_api_key||"").trim()){r("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),r("Detecting every distinct product in your images…","text-blue-300");let s;try{s=await B.detectProducts(i,{category:e.dataset.category||"",maxImages:Math.min(i.length,Q.maxImages)})}catch(d){const c=String(d?.message||d),g=/key|api|configured|settings|vision/i.test(c);r(g?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=s&&s.identified!==!1&&Array.isArray(s.products)&&s.products.length?s.products:[];if(!l.length){r(s&&s.reason?`Could not identify any product: ${n(s.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}K=l,Ne=i,oe="scan-ai-status",scanReviewRender(),u(`${l.length} distinct product${l.length>1?"s":""} detected — review each one, then continue.`,"info")};function Ti(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((s,l)=>ge(s,l)).join(""),i.innerHTML=t.map((s,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${n(s)}">`).join(""),$e(),ne());const o=document.getElementById("scan-ai-prop-status"),r=(s,l)=>{o&&(o.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&o.classList.add(l),o.innerHTML=s)};r("Completing the standard specifications for this property…","text-blue-300"),B.completeProductSpecs(t,e,{category:"Real Estate",maxImages:Q.maxImages}).then(s=>B.estimateProductPrice(t,e,s||{},{category:"Real Estate",maxImages:Q.maxImages}).then(l=>{const d=ua({identification:e,specs:s,price:l});r(`${n(e.detected_name||"Property")} — ${d.filled.length} field${d.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}).catch(()=>r("Price estimate skipped — review the details and set a price manually.","text-amber-300"))).catch(s=>{const l=/key|api|configured|settings|vision/i.test(String(s?.message||s));r(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(s?.message||s)}`,"text-red-400"),u("AI scan failed.","error")})}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){u("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(d=>d.value).filter(Boolean);if(!i.length){u("Upload at least one property image before scanning.","error");return}const o=t?t.innerHTML:"",r=(d,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=d)};try{const d=await B.getConfig();if(!String(d.gemini_key||d.gemini_api_key||"").trim()){r("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),r("Identifying this property from your images…","text-blue-300");let s;try{s=await B.identifyProduct(i,{category:"Real Estate",maxImages:Q.maxImages})}catch(d){const c=String(d?.message||d),g=/key|api|configured|settings|vision/i.test(c);r(g?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}if(!s||s.identified===!1){r(s&&s.reason?`Could not identify the property: ${n(s.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),u("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=await new Promise(d=>{Te=b=>{Te=null,d(b)};const c=document.getElementById("scan-ai-prop-status");if(!c){d({choice:"continue"});return}c.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const g=s.confidence||"medium",y={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[g]||"text-amber-400 border-amber-500/20";c.innerHTML=`
      <div class="rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in">
        ...
        <p class="text-[11px] text-gray-400">
          ...
          <span class="ml-1 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold border ${y}">${n(g).toUpperCase()} confidence</span>
        </p>
        <div class="flex flex-wrap gap-2">
      ...
      </div>`});if(!l||l.choice==="cancel"){r("Scan cancelled — nothing was changed.","text-gray-400"),u("Scan cancelled.","info");return}try{r("Completing the standard specifications for this property…","text-blue-300");const d=await B.completeProductSpecs(i,s,{category:"Real Estate",maxImages:Q.maxImages});let c=null;r("Estimating a fair market value…","text-blue-300");try{c=await B.estimateProductPrice(i,s,d||{},{category:"Real Estate",maxImages:Q.maxImages})}catch{}const g=ua({identification:s,specs:d,price:c});r(`${n(s.detected_name||"Property")} — ${g.filled.length} field${g.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success")}catch(d){const c=String(d?.message||d),g=/key|api|configured|settings|vision/i.test(c);r(g?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let ae=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await xt(a);i&&ae.push(i)}catch{}pa(),e.target.value=""}};window.removeStep1Image=function(e){ae.splice(e,1),pa()};function pa(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=ae.map((a,i)=>`
    <div class="img-thumb ${i===0?"cover-img":""}" data-index="${i}">
    ...
    </div>`).join("");const t=document.getElementById("btn-s1-scan");t&&(t.disabled=ae.length===0,t.style.opacity=ae.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=ae.slice();if(!e.length){u("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-s1-scan"),a=document.getElementById("s1-scan-status"),i=t?t.innerHTML:"",o=(l,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=l)};try{const l=await B.getConfig();if(!String(l.gemini_key||l.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o("Detecting every distinct product in your images…","text-blue-300");let r;try{r=await B.detectProducts(e,{category:"",maxImages:Math.min(e.length,Q.maxImages)})}catch(l){const d=/key|api|configured|settings|vision/i.test(String(l?.message||l));o(d?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);const s=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];if(!s.length){o(r&&r.reason?`Could not identify any product: ${n(r.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}K=s,Ne=e,oe="s1-scan-status",scanReviewRender(),u(`${s.length} distinct product${s.length>1?"s":""} detected — review each one, then continue.`,"info")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),r=a?"One-Click Publish Changes":"One-Click Publish Product";o&&(o.disabled=!0,o.textContent="Saving…");try{const s=new FormData(i),l={};for(const[b,h]of s.entries())b==="images"?(l.images=l.images||[],h&&!String(h).startsWith("blob:")&&l.images.push(String(h))):b==="tags"?(l.tags=l.tags||[],l.tags.push(h)):l[b]=h;l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=s.get("action")==="draft",c=b=>Ze(b),g=b=>{const h=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],m={};for(const f of h){const S=b[f];if(f==="real_price"){const I=S!=null&&String(S).trim()!==""?parseFloat(S):null;m[f]=I!=null&&Number.isFinite(I)&&I>0?Math.round(I):null;continue}m[f]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const f=c(b.safety_features);m.safety_features=f.length?f:null}return m};let y;if(a){let b=ce((window._productsData||[]).find($=>$.property_id===a));if(!b){const{data:$}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=$?ce($):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const h=($,ze)=>{const ka=$===""||$==null?"":$,Sa=ze===""||ze==null?"":ze;return String(ka).trim()===String(Sa).trim()},m={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach($=>{h(l[$],b[$])||(m[$]=l[$]==null||l[$]===""?null:l[$])});const f=l.price===""||l.price==null?null:parseFloat(l.price);h(f,b.price)||(m.price=f==null?b.price:Math.max(R,Math.min(q,f)));const S=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);h(S,b.stock_quantity)||(m.stock_quantity=Number.isFinite(S)?S:null);const I=c(l.features_text);h(I.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(m.features=I);const w=l.tags||[];h(w.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(m.tags=w);const v=c(l.highlights_text);h(v.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(m.highlights=v);const A=c(l.seo_keywords_text);h(A.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(m.seo_keywords=A);const Z=l.images||[];h(Z.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(m.images=Z);const W=l.is_featured==="on";!!b.is_featured!==W&&(m.is_featured=W);const j=d?!1:l.is_active==="on"||(l.images||[]).length>=24;!!b.is_active!==j&&(m.is_active=j);const le=g(l),k={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...le};if(JSON.stringify(k)!==JSON.stringify(b.specifications||{})&&(m.specifications=k),Object.keys(m).length===0){u("No changes detected — nothing was saved.","info");try{localStorage.removeItem(_e(t,a))}catch{}o&&(o.disabled=!1,o.textContent=r);return}const P={...b,...m,property_id:a,updated_at:new Date().toISOString()};if({error:y}=await p.from("showroom_listings").upsert(P,{onConflict:"property_id"}),y&&Xe(y,()=>Ve(P),"Product update")){o&&(o.disabled=!1,o.textContent=r);return}u(d?"Draft saved!":`Saved & published — your showroom shows it now (${Object.keys(m).length} change${Object.keys(m).length>1?"s":""}).`)}else{const b=parseInt(l.required_image_count||"0",10)||(ht.includes(t)?24:0);if(la(b,l.images||[],"This listing"),!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!l.condition)throw new Error("Please choose the product condition.");const m={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(R,Math.min(q,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:l.is_active==="on"||(l.images||[]).length>=24,is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:c(l.features_text).length?c(l.features_text):l.tags||[],tags:l.tags||[],highlights:c(l.highlights_text),seo_keywords:c(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:g(l)},f=ut();if(m.property_id=f,{error:y}=await p.from("showroom_listings").insert(m),y&&Xe(y,()=>Ve({...m,property_id:m.property_id}),"Product publish")){o&&(o.disabled=!1,o.textContent=r);return}u(d?"Draft saved!":"Published! Your showroom shows this product now.")}try{localStorage.removeItem(_e(t,a))}catch{}closeProductFormModal(),F()}catch(s){u("Error: "+s.message,"error"),o&&(o.disabled=!1,o.textContent=r)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Bt(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return u("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=ce((window._productsData||[]).find(o=>o.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return O(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),F()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:r,updated_at:s,...l}=a,d=ut();await p.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),F())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),F())};const ot=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function _t(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?dt().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(G)){const o=new Set(i.map(s=>s.property_id)),r=G.filter(s=>s.listing_type==="property"&&s.property_id&&!o.has(s.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(o=>`<tr>
                    ...
                    <td>${N(o.listing_status||"sale")} ${N(o.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=jt("property","Real Estate"),i=e.country_code||"US",o=e.currency||ct(i);U(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${sa(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${na(o)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${ot.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
          ...
          <div>
            ...
            <div id="image-preview" class="flex flex-wrap gap-2 mt-3">
              ${(e.images||[]).map((r,s)=>ge(r,s)).join("")}
            </div>
            <div id="image-url-inputs">
              ${(e.images||[]).map((r,s)=>`<input type="hidden" name="images" id="img-url-${s}" value="${n(r)}">`).join("")}
            </div>
          </div>
    ...
    </div>`),ft(),vt(),et("ppf-price"),window.syncPropertyCountry=function(){It("ppf")},It("ppf"),at("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>at("pricing")),Mi()};let H=null,Ie=null,Ct=null;function Li(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function J(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function xe(e,t,{reverse:a=!1}={}){if(!H||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Ie?Ie.setLatLng(i):Ie=L.marker(i,{draggable:!0}).addTo(H),H.setView(i,Math.max(H.getZoom(),13));const o=document.querySelector('#property-form [name="latitude"]'),r=document.querySelector('#property-form [name="longitude"]');o&&(o.value=String(Number(e.toFixed(6)))),r&&(r.value=String(Number(t.toFixed(6)))),a&&Bi(e,t);const s=document.getElementById("btn-open-google-map");s&&(s.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function fe(){const e=Li();if(!e){J("Enter a location (address, area, city, state, country), then press Locate from fields.");return}J("Searching location…");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(xe(parseFloat(a[0].lat),parseFloat(a[0].lon)),J("Located: "+a[0].display_name)):J("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{J("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Bi(e,t){const a=document.querySelector("#property-form");if(a)try{const o=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),r=o&&o.address||{},s=(h,m)=>{if(!m)return;const f=a.querySelector(`[name="${h}"]`);return f&&!String(f.value||"").trim()?(f.value=m,!0):!1},l=[r.road||"",r.house_number||""].filter(Boolean).join(" "),d=r.suburb||r.neighbourhood||r.quarter||r.district||r.borough||"",c=r.town||r.village||r.municipality||r.city_district||"",g=r.city||r.county||"",y=r.state||r.region||"",b=r.country||"";if(s("product_location",l||d||c),s("town",d||c),s("city",g),s("state",y),b){s("country",b);const h=a.querySelector('[name="country_code"]');if(h){const m=(pe||[]).find(f=>String(f.name||"").toLowerCase()===String(b).toLowerCase());m&&m.code&&!h.value&&(h.value=m.code)}}J("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(o.display_name?" — "+o.display_name:""))}catch{J("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!H)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(xe(e,t),J("Map updated from coordinates.")):fe()};function Mi(){const e=document.getElementById("property-map-preview");if(!e||!window.L){J("Map unavailable right now — your location fields still save normally.");return}H&&(H.remove(),H=null,Ie=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);H=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(H),H.on("click",o=>xe(o.latlng.lat,o.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",fe),["product_location","town","city","state","country","latitude","longitude"].forEach(o=>{const r=document.querySelector(`#property-form [name="${o}"]`);r&&(r.addEventListener("input",()=>{if(o==="latitude"||o==="longitude"){const s=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(s)&&Number.isFinite(l)&&(s||l)&&xe(s,l);return}clearTimeout(Ct),Ct=setTimeout(fe,900)}),r.addEventListener("change",()=>{o!=="latitude"&&o!=="longitude"&&fe()}))}),i?xe(t,a):fe()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(o=>{const r=parseFloat(o.latitude),s=parseFloat(o.longitude),l=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");return!(Number.isFinite(r)&&Number.isFinite(s)&&(r!==0||s!==0))&&!!l});if(!t.length){u("All properties already have map coordinates.","success");return}u(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}…`,"success");let a=0,i=0;for(const o of t){const r=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");try{const l=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(r))).json();if(l&&l[0]){const d={latitude:parseFloat(l[0].lat),longitude:parseFloat(l[0].lon)},{error:c}=await p.from("showroom_listings").update(d).eq("property_id",o.property_id);c?i++:(Object.assign(o,d),a++)}else i++}catch{i++}await new Promise(s=>setTimeout(s,1100))}u(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),_t()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(g=>g&&!g.startsWith("blob:")),r=(i.features_text||"").split(",").map(g=>g.trim()).filter(Boolean),s=t?0:parseInt(i.required_image_count||"24",10)||24;la(s,o,"This property");const l=i.real_price===""||i.real_price==null?null:Math.max(R,Math.min(q,parseFloat(i.real_price)||0)),d={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(R,Math.min(q,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:r,images:o,highlights:Ze(i.highlights_text),seo_keywords:Ze(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let c;if(t){d.property_id=t;const g=ce((window._propertiesData||[]).find(y=>y.property_id===t)||(window._productsData||[]).find(y=>y.property_id===t));d.specifications={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},real_price:l},{error:c}=await p.from("showroom_listings").upsert({...g,...d},{onConflict:"property_id"})}else d.property_id=ut(),d.specifications={real_price:l},{error:c}=await p.from("showroom_listings").insert(d);c&&Xe(c,()=>Ve({...d,property_id:t||d.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),X(),_t())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Bt(e)),i||(i=(Array.isArray(G)?G.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Fi=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function ma(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(r=>Di(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}function Di(e){return`<tr class="order-row" data-status="${e.status}" data-search="${n(e.order_number)} ${n(e.full_name)} ${n(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Kt(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",ie(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${n(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Fi.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),X(),ma()};async function Ri(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      <div class="modal-box">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${z(t.created_at)} · ${n(t.country_code||"Unknown country")}</p>
          </div>
        </div>
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${n(i.order_number)}</p><p class="text-[10px] text-gray-500">${ie(i.created_at)}</p></div>
            <div class="flex items-center gap-2">${N(i.status)}<span class="text-xs font-bold text-emerald-400">$${parseFloat(i.amount).toLocaleString()}</span></div>
          </div>`).join("")}
      </div>
    </div>`)};async function Pe(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:o}=await p.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),r=o||[],s=r.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?re("star","No Reviews","Customer reviews will appear here."):a.map(l=>Ui(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${r.length===0?re("message-square","No Feedback Yet","Site feedback will appear here."):r.map(l=>Ni(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}function Ni(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"★":"☆").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1 flex-wrap">
          ...
          <span class="text-xs text-gray-500">${n(e.email||"no email")} · ${z(e.created_at)}</span>
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await p.from("site_feedback").update({is_approved:!0}).eq("id",e);t?u(t.message,"error"):u("Feedback approved — it now shows on every page."),Pe()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await p.from("site_feedback").delete().eq("id",e);t?u(t.message,"error"):u("Feedback deleted."),Pe()};function Ui(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),Pe()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),Pe())};async function ga(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?re("message-circle","No Messages","Customer support messages will appear here."):a.map(i=>`
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${ie(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),ga()};async function Ue(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td>${N(i.is_active?"active":"inactive")}</td>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.showAddCouponModal=function(){U(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await p.from("coupons").insert(i);if(o){u(o.message,"error");return}u("Coupon created!"),X(),Ue()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Ue()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Ue())};async function qi(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?re("bell","No Notifications","System notifications will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}const ba=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Oi=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let Ee=null;function ji(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${n(e)}</span>`}function Hi(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${n(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${n(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${n(e.link_target||"")}</span>`}function Gi(e){return e.video_url?`<video src="${n(e.video_url)}" ${e.poster_url?`poster="${n(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${n(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function ya(){if(Ee)return Ee;const e=[],t=new Set,a=[],i=r=>{if(!r||!r.property_id)return;e.push({id:r.property_id,title:r.title||r.property_id});const s=r.category||"";s&&!t.has(s)&&(t.add(s),a.push(s))};try{G.forEach(i)}catch{}try{const{data:r,error:s}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!s&&r&&r.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(r=>{t.has(r)||(t.add(r),a.push(r))}),Ee={products:e,categories:a,sections:Oi},Ee}async function zi(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),o=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:r}=await p.storage.from("advertisements").upload(o,e,{contentType:e.type,upsert:!1});if(r)return u("Upload failed: "+r.message,"error"),null;const{data:s}=p.storage.from("advertisements").getPublicUrl(o);return{url:s.publicUrl,isVideo:i}}catch{return u("Upload failed","error"),null}}function Le(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),o=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),o&&(o.value=t?"":e),a.innerHTML=t?`<video src="${n(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${n(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const i=await zi(t);if(!i){e.value="";return}Le(i.url,i.isVideo);const o=document.getElementById("ad-media-url");o&&(o.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);Le(t,a)};function kt(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let o="";t==="product"?o='<option value="">Select a product…</option>'+e.products.map(r=>`<option value="${n(r.id)}" ${String(a)===String(r.id)?"selected":""}>${n(r.id)} — ${n((r.title||"").slice(0,60))}</option>`).join(""):t==="category"?o='<option value="">Select a category…</option>'+e.categories.map(r=>`<option value="${n(r)}" ${a===r?"selected":""}>${n(r)}</option>`).join(""):t==="section"&&(o='<option value="">Select a section…</option>'+e.sections.map(r=>`<option value="${n(r.id)}" ${a===r.id?"selected":""}>${n(r.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${o}</select>`}function ha(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${ba.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";kt(e,a,"")};window.showAddAdModal=async function(){const e=await ya();window._adLinkCache=e,U(ha(null)),kt(e,"none","")};window.showEditAdModal=async function(e){const t=await ya();window._adLinkCache=t;const{data:a}=await p.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}U(ha(a)),a.image_url?Le(a.image_url,!1):a.video_url&&Le(a.video_url,!0),kt(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",o={title:a.title,description:a.description||"",ad_label:ba.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!o.image_url&&!o.video_url){u("Add an image or video for the ad","error");return}const r=e.target.querySelector('button[type="submit"]');r&&(r.disabled=!0);try{if(i){const{error:s}=await p.from("promotions").update(o).eq("id",i);if(s)throw s;u("Ad updated!")}else{const{error:s}=await p.from("promotions").insert(o);if(s)throw s;u("Ad created!")}}catch(s){u(s.message||"Save failed","error"),r&&(r.disabled=!1);return}X(),ye()};window.togglePromo=async function(e,t){const{error:a}=await p.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),ye()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await p.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const o=a||[],r=o.findIndex(c=>c.id===e),s=r+t;if(r<0||s<0||s>=o.length){u("Already at the edge","info");return}const l=o[r],d=o[s];await p.from("promotions").update({sort_order:d.sort_order}).eq("id",l.id),await p.from("promotions").update({sort_order:l.sort_order}).eq("id",d.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}ye()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await p.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(o=>{const r=/\/object\/public\/advertisements\/(.+)$/.exec(o);return r?decodeURIComponent(r[1]):null}).filter(Boolean);if(i.length)try{await p.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await p.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}ye()}};async function ye(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.renderAds=ye;const qe=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],V={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function fa(){const e=document.getElementById("content");try{let t=function(r){const s=o===r.id,l=i[r.kf],d=i[r.mf]||r.dm;return`
        <div class="glass-soft border ${s?V.border[r.color]+" "+V.bg[r.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${r.id}">
          <div class="flex items-start justify-between gap-2">
            <div class="flex items-center gap-2.5 min-w-0">
              <div class="w-8 h-8 ${V.bg[r.color]} rounded-lg flex items-center justify-center shrink-0">
                <i data-lucide="${r.icon}" class="w-4 h-4 ${V.text[r.color]}"></i>
              </div>
              <div class="min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  <h3 class="text-xs font-black text-white">${n(r.name)}</h3>
                  <span class="text-[8px] font-black uppercase px-1.5 py-0.5 rounded-full ${V.badge[r.color]}">${r.tag}</span>
                </div>
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${s?V.text[r.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${r.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${V.text[r.color]} hover:underline flex items-center gap-0.5">
      ...
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${qe.map(t).join("")}</div>
          </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.highlightAI=function(e){qe.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?V.border[t.color]+" "+V.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const o=a.querySelector("input[type=radio] + span");o&&(o.className=`text-[9px] font-bold ${i?V.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};qe.forEach(o=>{a[o.mf]&&(i[o.mf]=a[o.mf]);const r=(a[o.kf]||"").trim();r&&!r.startsWith("••••")&&r!==""&&(i[o.kf]=r)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key);try{const{data:o}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let r;if(o?.id?{error:r}=await p.from("ai_settings").update(i).eq("id",o.id):{error:r}=await p.from("ai_settings").insert(i),r){u("Save failed: "+r.message,"error"),console.error("[AI Save]",r);return}await B.reload(),u("✅ AI settings saved!","success"),setTimeout(()=>fa(),600)}catch(o){u("Unexpected error: "+o.message,"error"),console.error("[AI Save]",o)}};const B={_cfg:null,async reload(){const{data:e,error:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async chat(e,{maxTokens:t=2e3}={}){const a=await this.getConfig();if(!String(a.gemini_key||"").trim())throw new Error("No AI provider configured. Go to AI Settings and add your Gemini API key.");const i=e[e.length-1],o={action:"chat",message:String(i?.content||"").trim(),history:e.slice(0,-1).map(s=>({role:s.role,content:String(s.content||"")})),provider_override:"gemini",max_tokens:t},r=await this._callEdge(o);if(r&&r.response)return{text:r.response,provider:"Google Gemini",model:r.model||a.gemini_model};throw new Error(String(r?.error||"Gemini is unavailable."))},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return qe.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is — the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
{ "identified": true, "listing_type": "product"|"vehicle"|"property", "brand": string|null, "model": string|null, "year": string|null, "year_estimated": boolean, "body_type": string|null, "color": string|null, "condition": string|null, "category": string|null, "subcategory": string|null, "property_type": string|null, "bedrooms": number|null, "bathrooms": number|null, "building_size": string|null, "land_size": string|null, "parking_spaces": number|null, "furnished": string|null, "area": string|null, "address": string|null, "town": string|null, "city": string|null, "state": string|null, "country": string|null, "latitude": number|null, "longitude": number|null, "listing_status": "sale"|"rent"|null, "confidence": "high"|"medium"|"low", "alternate_categories": string[], "detected_name": string }`,e,{maxImages:t.maxImages||5})},async detectProducts(e,t={}){return this._runVisionPrompt(`STAGE 0 — DETECT EVERY DISTINCT PRODUCT.
...
{ "identified": true, "products": [ { "image_indices": number[], "listing_type": "product"|"vehicle"|"property", "brand": string|null, "model": string|null, "year": string|null, "year_estimated": boolean, "body_type": string|null, "color": string|null, "condition": string|null, "category": string|null, "subcategory": string|null, "property_type": string|null, "bedrooms": number|null, "bathrooms": number|null, "building_size": string|null, "land_size": string|null, "parking_spaces": number|null, "furnished": string|null, "area": string|null, "address": string|null, "town": string|null, "city": string|null, "state": string|null, "country": string|null, "latitude": number|null, "longitude": number|null, "listing_status": "sale"|"rent"|null, "confidence": "high"|"medium"|"low", "detected_name": string } ] }`,e,{maxImages:t.maxImages||5})},async completeProductSpecs(e,t,a={}){const i=t||{},o=`STAGE 2 — COMPLETE THE STANDARD SPECIFICATIONS.
...
- property: ${String(o.property_type||r.property_type||"")}${r.bedrooms?` ${r.bedrooms} beds`:""}${r.bathrooms?` / ${r.bathrooms} baths`:""}${r.building_size?` / ${r.building_size}`:""}${r.city?` / ${r.city}`:""}
...
}`;return this._runVisionPrompt(s,e,{maxImages:i.maxImages||5})},async _callEdge(e){let t="";try{t=(await p.auth.getSession())?.data?.session?.access_token||""}catch{}return await(await fetch(za,{method:"POST",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}},body:JSON.stringify(e),signal:AbortSignal.timeout(12e4)})).json().catch(()=>({}))},async _fetchImageAsDataUrl(e,t=1200){try{const a=await fetch(e).then(i=>i.blob());return!a||!a.size?null:a.size<18e5?`data:${a.type||"image/jpeg"};base64,${await Wi(a)}`:await this._downscaleImage(a,t)}catch{return null}},async _downscaleImage(e,t){const a=URL.createObjectURL(e);try{const i=new Image;await new Promise((d,c)=>{i.onload=d,i.onerror=c,i.src=a});const o=Math.min(1,t/Math.max(i.width,i.height)),r=Math.max(1,Math.round(i.width*o)),s=Math.max(1,Math.round(i.height*o)),l=document.createElement("canvas");return l.width=r,l.height=s,l.getContext("2d").drawImage(i,0,0,r,s),l.toDataURL("image/jpeg",.82)}finally{URL.revokeObjectURL(a)}},async _tryBrowserGeminiVision(e,t){const a=await this.getConfig(),i=String(a.gemini_key||a.gemini_api_key||"").trim();if(!i)return null;const o=[a.gemini_vision_model||a.gemini_model,"gemini-2.5-flash","gemini-3-flash-preview","gemini-3.1-flash-lite-preview"].filter(Boolean);for(const r of o)try{const s=[{text:e}];for(const b of t){const h=String(b).match(/^data:([^;,]+)[;,]base64,(.+)$/s);h&&s.push({inlineData:{mimeType:h[1].trim(),data:h[2].trim()}})}if(s.length<2)return null;const l=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(r)}:generateContent?key=${encodeURIComponent(i)}`,d=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:s}],generationConfig:{temperature:.2,maxOutputTokens:4096}}),signal:AbortSignal.timeout(4e4)});if(!d.ok)continue;const g=((await d.json())?.candidates?.[0]?.content?.parts||[]).map(b=>b?.text||"").join(`
`).trim();if(!g)continue;const y=We(g);if(y)return{...y,_aiProvider:"Gemini (browser)",_aiModel:r}}catch{}return null}};function Wi(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const o=i.indexOf(",");t(o>=0?i.slice(o+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=B;window.showAiStatusModal=async function(){const e=await B.getStatus(),t=e.filter(a=>a.hasKey);U(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const t=document.getElementById("ai-test-output");t.classList.remove("hidden"),t.textContent="⏳ Asking Gemini…";try{const a=await B.prompt(e);t.textContent=`✓ [${a.provider} · ${a.model}]

${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function We(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),o=t.lastIndexOf("}");if(i===-1||o===-1||o<=i)return null;const r=t.slice(i,o+1);try{return JSON.parse(r)}catch{return null}}async function Vi(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([p.from("site_settings").select("*").limit(1).maybeSingle(),Ki()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),r=a.length?`
        <div class="mt-4">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;try{const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let o;if(i?.id?{error:o}=await p.from("site_settings").update(a).eq("id",i.id):{error:o}=await p.from("site_settings").insert({id:1,...a}),o)throw new Error(o.message);$a(),u("Content updated — the banner and bottom section now use your new wording.","success")}catch(i){u(i.message||"Could not save content. Please try again.","error")}};async function Qi(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],r=o.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,g)=>c+(parseFloat(g.amount)||0),0),s=o.length>0?(o.filter(c=>c.status!=="cancelled").length/o.length*100).toFixed(1):0,l={};(a.data||[]).forEach(c=>{l[c.category]=(l[c.category]||0)+1});const d=Object.entries(l).sort((c,g)=>g[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${D("Total Revenue",`$${r.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${D("Total Orders",o.length,"shopping-bag","blue")}
          ${D("Customers",i.count||0,"users","violet")}
          ${D("Conversion Rate",s+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${d.length===0?'<p class="text-xs text-gray-500 text-center py-8">No data</p>':d.map(([c,g])=>`
      ...
      </div>`,window.lucide&&lucide.createIcons(),ra(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function Xi(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${d} · Enrolled: ${z(r.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${o.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':o.map(c=>{const g=["login_success","login_2fa_success"].includes(c.event_type),y=["login_failed","login_denied","login_backup_code_used"].includes(c.event_type),b=g?"text-emerald-400":y?"text-red-400":"text-gray-300",h={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[c.event_type]||c.event_type;return`<tr>
                      ...
                      <td><span class="text-xs text-gray-500">${ie(c.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,document.getElementById("new-pw")?.addEventListener("input",c=>{const g=c.target.value,y=[{label:"8+ characters",ok:g.length>=8},{label:"Uppercase letter",ok:/[A-Z]/.test(g)},{label:"Number",ok:/[0-9]/.test(g)},{label:"Special character",ok:/[^a-zA-Z0-9]/.test(g)}];document.getElementById("pw-strength").innerHTML=y.map(b=>`<div class="flex items-center gap-1.5 text-[10px] ${b.ok?"text-emerald-400":"text-gray-600"}">
          <i data-lucide="${b.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${b.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(a!==i){u("Passwords do not match","error");return}if(a.length<8){u("Password must be at least 8 characters","error");return}const{error:o}=await p.auth.signInWithPassword({email:_.user.email,password:t});if(o){u("Current password is incorrect","error");return}const{error:r}=await p.auth.updateUser({password:a});if(r){u(r.message,"error");return}await Y(_.user.id,"password_changed"),u("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){U(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${ie(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function to(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${n(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${ie(a.created_at)}</p></div>
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),u("Orders exported!")};async function ao(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await p.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function je(){const e=document.getElementById("content");e&&(e.innerHTML=me());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",r=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}async function He(){const e=document.getElementById("content");e&&(e.innerHTML=me());try{let t=function(l,d,c,g="",y="blue"){const b=!!(c&&c.trim());return`
        <div class="glass-soft border border-${y}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${g?`<p class="text-[10px] text-gray-500">${n(g)}</p>`:""}
          ...
          <div class="flex gap-2">
            <input class="input-field text-xs flex-1 ${b?"":"hidden"}" id="url-${d}" value="${n(c||"")}" placeholder="Or paste image URL" oninput="document.getElementById('val-${d}').value=this.value;updateLivePreview()">
            <button type="button" onclick="document.getElementById('url-${d}').classList.toggle('hidden')" class="text-[10px] text-${y}-400 hover:text-${y}-300 transition shrink-0">${b?"Edit URL":"Paste URL"}</button>
          </div>
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||zt,r=i.brand_slogan||i.site_tagline||Wt,s=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${n(a.message)}</div>`)}}function io(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",o=t[a]||"",r=t[i]||"",s=!!(o&&o.trim()),l=!!(r&&r.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function Tt(e,t,a,i,o){const r=o==="image",s=r?"blue":"violet",l=r?"image-plus":"video",d=r?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function wa(){const e={};for(const t of Me)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=wa();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),ke(t),u("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const r=(a.name.split(".").pop()||"bin").toLowerCase(),s=`promo/${t}-${Date.now()}.${r}`,{error:l}=await p.storage.from("product-images").upload(s,a,{contentType:a.type,upsert:!0});let d;if(l)d=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:b}=p.storage.from("product-images").getPublicUrl(s);d=b.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const c=document.getElementById("val-"+t),g=document.getElementById("url-"+t);c&&(c.value=d),g&&(g.value=d,g.classList.remove("hidden"));const y=wa();ke(y)}catch(r){o&&(o.textContent=`Upload failed: ${r.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const r of Me)t[r.key+"_bg_image"]=document.getElementById("val-"+r.key+"_bg_image")?.value||"",t[r.key+"_bg_video"]=document.getElementById("val-"+r.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await p.from("site_settings").update(t).eq("id",i.id):{error:o}=await p.from("site_settings").insert(t),Pa(),o?(u("Publish failed — the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),ke(t)):(u("Promo & backgrounds published across all pages.","success"),setTimeout(()=>ke(),500))};window._manualPaymentAccounts=[];function St(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Mt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function $t(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function oo(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        ...
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${sa(a)}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[St()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>oo(t,a)).join("")}
    ...
    </div>`,$t(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(St()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[St()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),$t())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=pe.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Mt(t),$t(),renderManualPaymentAccountsEditor()};async function lt(){const e=document.getElementById("content");e&&(e.innerHTML=me());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Ba()||{},...t||{}};window._manualPaymentAccounts=Ma(i).map(o=>({...o})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${n(Fa(i))}</textarea>
              </div>
              <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${n(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o={},r=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,d]of Object.entries(i))r.includes(l)?d&&!d.startsWith("•")&&d.trim()!==""&&(o[l]=d.trim()):o[l]=d;const{error:s}=await p.from("site_settings").upsert({id:1,...o});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),s){u(s.message,"error");return}u("Deploy & payment settings saved!"),Ge()};async function _a(e="deploy"){const{data:t}=await p.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return u("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function te(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:o,error:r}=await p.from("deployment_history").insert({version:a,status:e,triggered_by_email:_.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:o,error:r}}function ue(e,t,a,i){if(!e)return;e.disabled=t;const o=e.querySelector("p.text-xs.font-black");o&&(o.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");ue(t,!0,"Deploying…","Deploy Now");try{const a=await _a("deploy");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await te("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Deployment queued from admin UI"});const r=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await te("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted deployment request"}),setTimeout(()=>Ge(),400);else{const s=`Webhook returned error: ${r.status}`;u(s,"error"),await te("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:s})}}catch(a){u("Deploy failed: "+a.message,"error"),await te("failed",{mode:"deploy",errorMessage:a.message})}finally{ue(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");ue(t,!0,"Rebuilding…","Rebuild Site");try{const a=await _a("rebuild");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await te("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Rebuild requested from admin UI"});const r=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(r.ok)u("🔄 Rebuild triggered successfully."),await te("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted rebuild request"}),setTimeout(()=>Ge(),400);else{const s=`Rebuild webhook error: ${r.status}`;u(s,"error"),await te("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:s})}}catch(a){u("Rebuild failed: "+a.message,"error"),await te("failed",{mode:"rebuild",errorMessage:a.message})}finally{ue(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");ue(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){u("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){u("Publish failed: "+a.message,"error")}finally{ue(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:i,error:o}=await p.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(o)return O(o)?u("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load listings to reindex: "+o.message,"error");const r=i||[];if(!r.length){u("No listings to reindex.");return}let s=0,l=0,d=!1;const c=40;for(let g=0;g<r.length;g+=c){const y=r.slice(g,g+c),{error:b}=await p.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",y.map(h=>h.id));b?(O(b)&&(d=!0),l+=y.length):s+=y.length,t&&(t.textContent=`Reindexing… ${Math.min(g+c,r.length)}/${r.length}`)}if(d){u(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${s}/${r.length} done)`,"error");return}u(`Search index rebuilt for ${s} listing${s!==1?"s":""}${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){u("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(G)||!G.length){u("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:i,error:o}=await p.from("showroom_listings").select("property_id");if(o)return O(o)?u("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load existing listings: "+o.message,"error");const r=new Set((i||[]).map(y=>y.property_id)),s=G.filter(y=>y&&y.property_id&&!r.has(y.property_id));if(!s.length){u("Showroom already in sync — no new listings to add.");return}let l=0,d=0,c=!1;const g=20;for(let y=0;y<s.length;y+=g){const b=s.slice(y,y+g).map(m=>({property_id:m.property_id,listing_type:m.listing_type||"product",category:m.category||null,subcategory:m.subcategory||null,title:m.title||"Untitled Listing",description:m.description||"",price:parseFloat(m.price)||0,currency:m.currency||"USD",country:m.country||"",country_code:m.country_code||"",state:m.state||"",city:m.city||"",town:m.town||"",product_location:m.product_location||"",latitude:m.latitude??null,longitude:m.longitude??null,property_type:m.property_type||null,listing_status:m.listing_status||"sale",bedrooms:m.bedrooms??null,bathrooms:m.bathrooms??null,building_size:m.building_size||"",land_size:m.land_size||"",parking_spaces:m.parking_spaces??null,furnished:m.furnished||"",features:Array.isArray(m.features)?m.features:[],tags:Array.isArray(m.tags)?m.tags:[],highlights:Array.isArray(m.highlights)?m.highlights:[],seo_keywords:Array.isArray(m.seo_keywords)?m.seo_keywords:[],images:Array.isArray(m.images)?m.images:[],brand:m.brand||null,color:m.color||null,size:m.size||null,condition:m.condition||null,warranty:m.warranty||null,availability_status:m.availability_status||"In Stock",stock_quantity:m.stock_quantity!=null?parseInt(m.stock_quantity,10):null,is_active:m.is_active!==!1,is_featured:!!m.is_featured,is_ai_generated:!!m.is_ai_generated,ai_generated_fields:Array.isArray(m.ai_generated_fields)?m.ai_generated_fields:[],specifications:m.specifications||{},created_at:m.created_at||new Date().toISOString()})),{error:h}=await p.from("showroom_listings").insert(b);h?(O(h)&&(c=!0),d+=b.length):l+=b.length,t&&(t.textContent=`Syncing… ${Math.min(y+g,s.length)}/${s.length}`)}if(c){u(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${l}/${s.length} added)`,"error");return}u(`Showroom synced: ${l} new listing${l!==1?"s":""} added to the database${d?` (${d} failed)`:""}.`,d?"error":"success")}catch(i){u("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){u("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();u(`✓ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?u("Repository not found. Check username and repo name.","error"):u("GitHub API error: "+a.status,"error")}catch{u("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ve=30,C={category:null,page:0,query:""};async function he(){const e=document.getElementById("content");if(!e)return;await Ua();const t=new Set(qt()),a=Da();C.category||(C.category=a[0]?.slug||null);const i=Ut(C.category),o=i?i.count:0,r=C.query.trim().toLowerCase(),s=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(h=>`<button onclick="catalogSetCategory('${h.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${C.category===h.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${n(h.name)}</button>`).join("")}
    </div>`,d=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${n(C.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(i)if(r){const h=Math.min(o,8e3);for(let m=0;m<h&&c.length<ve;m++){const f=Pt(i.slug,m);if(!f)continue;`${f.property_id} ${f.title} ${f.subcategory||""} ${f.category||""}`.toLowerCase().includes(r)&&c.push(f)}}else{const h=C.page*ve,m=Math.min(h+ve,o);for(let f=h;f<m;f++){const S=Pt(i.slug,f);S&&c.push(S)}}const g=c.length?c.map(h=>{const m=t.has(h.property_id),f=h.images&&h.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${m?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            <img src="${n(f)}" alt="" class="w-12 h-12 rounded-lg object-cover bg-gray-800 shrink-0" loading="lazy">
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold text-white truncate">${n(h.title)}</p>
              <p class="text-[11px] text-gray-500 truncate">${n(h.property_id)} · ${n(h.subcategory||h.category||"")} · ${Kt(h.price,"USD")}</p>
            </div>
            ${N(!m)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',y=r?1:Math.max(1,Math.ceil(o/ve)),b=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${r?`${c.length} match`:`${o.toLocaleString()} items in ${n(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
        <button onclick="catalogPage(-1)" ${C.page<=0?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Prev</button>
        <span class="text-xs text-gray-500">Page ${C.page+1} / ${y}</span>
        <button onclick="catalogPage(1)" ${C.page>=y-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${s}
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){C.category=e,C.page=0,C.query="",he()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");C.query=e?e.value:"",C.page=0,he()};window.catalogPage=function(e){const t=Ut(C.category),a=t?t.count:0,i=C.query.trim()?1:Math.max(1,Math.ceil(a/ve));C.page=Math.max(0,Math.min(i-1,C.page+e)),he()};window.catalogToggle=async function(e){const t=!qt().includes(e),a=await Ra(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),he()};window.catalogResetHidden=async function(){await Na(),u("All hidden catalog listings restored"),he()};async function Lt(){window.lucide&&lucide.createIcons(),Yt(),await ai(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){_.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Lt):Lt();
