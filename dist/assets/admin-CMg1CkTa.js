import{supabase as p}from"./supabase-client-7_ZWSEp6.js";import{a as Fa,g as Ua,C as $e,A as Oa}from"./localization-DIzE0wyu.js";import{patchLocalShowroomListing as qa,upsertLocalShowroomListing as je,getLocalShowroomListingById as Et,listLocalShowroomListings as Ct}from"./local-showroom-store-JrQn_yOW.js";import{L as Ye,s as Xe,a as Na,l as Ha,b as Ga,V as za}from"./live-control-store-DzHEnoMc.js";import{g as Lt,s as Va,l as Wa,a as Ka,b as Ja}from"./payment-settings-LqBp65aW.js";import{S as D}from"./showroom-data-DPO_EY_W.js";import{getCatalogCategory as Tt,getCatalogCategories as Qa,generateProduct as kt}from"./catalog-BPD_6M9e.js";import{getHiddenCatalogIds as Bt,saveCatalogHidden as Ya,resetHiddenCatalogIds as Xa,loadHiddenCatalogIds as Za}from"./catalog-hidden-store-DbF0xVeS.js";import"./preload-helper-CLcXU_4U.js";const F=1,Q=5e6,ei=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],ti=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Mt=[...ei,...ti];function Ze(e){return Fa[e]||"USD"}function Rt(e,t){return Mt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ai(e,t){const a=Math.max(F,Math.min(Q,Number(e)||F));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function ii(e,t,a,i,s){const o=ai(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${s}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Dt({templateId:e,listingType:t,category:a,countryCode:i,currency:s,price:o}){const r=Mt.find(h=>h.id===e&&h.listingType===t);if(!r)return null;const n=Ua(i)||$e[0],d=s||Ze(n.code),c=[n.name].filter(Boolean).join(", "),m={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${n.name}`:r.label,description:ii(r,n,d,o,c),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[n.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...m,country:n.name,country_code:n.code,product_location:n.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...m,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const jt="weverseonlineshop@gmail.com",Ft="kco_ai_ad_override_fallback_v1",Ut="Weverse Online Shop",Ot="GLOBAL SHOPPING • WORLDWIDE DELIVERY",si="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),oi=`${si}/functions/v1/ai-admin-assistant`,ri=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"},{id:"live-streaming",label:"Live Streaming",icon:"radio"},{id:"video-calls",label:"Video Calls",icon:"video"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],ni={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},qt=[...Oa].sort();let k={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Nt(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function G(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function U(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function et(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const li=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function X(e){const t={};if(!e||typeof e!="object")return t;for(const a of li)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",o[t]||"info"),s.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function C(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function W(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function $(e,t,a,i,s=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=ni[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ht(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Z()),window.lucide&&lucide.createIcons(),({dashboard:Ai,products:T,properties:nt,catalog:de,orders:ca,customers:Qi,reviews:lt,messages:ua,coupons:Pe,ads:re,notifications:Xi,"live-streaming":le,"video-calls":he,ai:di,n8n:pi,"ai-settings":ba,"ai-marketing":Ce,"homepage-branding":Te,content:Is,seo:Es,email:Cs,analytics:Ps,security:Le,activity:Ls,brand:Be,"payment-settings":Qe,backup:Ts,settings:Bs,publish:Me,"general-ai":ci}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=se("construction","Coming Soon",`${t} is being built.`))}))()};async function di(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
      ...
      </div>`,window.aiChatHistory=[],Gt(),ui(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${l(t.message)}</div>`)}}function Gt(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function ui(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function pi(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const te="kco_admin_remember",tt="kco_login_attempts",Fe=5,mi=15*60*1e3;function L(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function gi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Se(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function pe(e){return String(e||"").trim().toLowerCase()}function bi(){try{const e=JSON.parse(localStorage.getItem(te)||"{}");e?.email&&!pe(e.email)&&localStorage.removeItem(te)}catch{localStorage.removeItem(te)}}function hi(){try{const e=JSON.parse(localStorage.getItem(te)||"{}");return pe(e?.email)}catch{return""}}function at(){bi();const e=hi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||jt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function fi(){return`${window.location.origin}/admin.html`}function ee(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Se(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function P(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function zt(){try{return JSON.parse(localStorage.getItem(tt)||'{"count":0}')}catch{return{count:0}}}function Vt(){const e=zt();return e.count=(e.count||0)+1,e.count>=Fe&&(e.lockedUntil=Date.now()+mi),localStorage.setItem(tt,JSON.stringify(e)),e}function Wt(){localStorage.removeItem(tt)}function Kt(){const e=zt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Wt(),null):Math.ceil(t/6e4)}async function H(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await yi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function yi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Jt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:pe(e.email)===jt}async function vi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){ye(),Si();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await Jt(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),s=await p.auth.mfa.getAuthenticatorAssuranceLevel(),o=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&o!=="aal2"){k.user=t.user,ye(),ee("2fa"),it();return}k.user=t.user,Ae();return}xi()}function ye(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function xi(){ye(),ee("login"),at(),Qt(),Yt(),it(),wi();const e=Kt();e&&(L(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function wi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Qt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",_i),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ee("forgot")))}async function _i(e){e.preventDefault();const t=Kt();if(t){L(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=pe(a?.value);if(!i){L("Enter your admin email address."),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;P("login-btn",!0),Se();const{data:r,error:n}=await p.auth.signInWithPassword({email:i,password:s});if(n||!r.user){const b=String(n?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){L("Authentication is temporarily unavailable due to configuration. Please contact support."),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){L("Network error while signing in. Check your connection and try again."),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){L("Your admin email is not confirmed yet. Open your verification email and confirm first."),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Vt(),g=Fe-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${Fe} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;L(v),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await H(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Jt(r.user)){await p.auth.signOut(),L(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await H(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(te,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(te),Wt(),k.user=r.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){P("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ee("2fa"),it(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await H(r.user.id,"login_success"),P("login-btn",!1),Ae()}function it(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",$t));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&$t()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,ee("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",ki))}async function $t(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){L("Enter the 6-digit code from your authenticator app.");return}P("verify-2fa-btn",!0),Se();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){L("No 2FA factor found. Please re-login."),P("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await p.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:o}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await H(k.user.id,"login_2fa_success"),P("verify-2fa-btn",!1),Ae()}catch(t){Vt(),L(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),P("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function ki(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){L("Enter a backup recovery code.");return}P("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){L("No backup codes found."),P("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){L("Backup code not found or already used."),P("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",k.user.id),await H(k.user.id,"login_backup_code_used"),Ae()}catch(t){L(t.message),P("verify-backup-btn",!1,"Use Backup Code")}}function Yt(){document.getElementById("back-to-login")?.addEventListener("click",()=>ee("login")),document.getElementById("send-reset-btn")?.addEventListener("click",$i)}async function $i(){const e=document.getElementById("reset-email"),t=pe(e?.value);if(!t){L("Enter your admin email address to receive a reset link.");return}P("send-reset-btn",!0),Se();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:fi()});if(P("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){L(a.message);return}gi("Reset link sent! Check your inbox and open it from this device to continue.")}function Si(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
            ...
            ${K.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':K.map(w=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${U(w.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),ea(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}async function T(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1});let i=a?Ct().filter(r=>r.listing_type!=="property"):t||[];if(Array.isArray(D)){const r=new Set(i.map(d=>d.property_id)),n=D.filter(d=>d.listing_type!=="property"&&d.property_id&&!r.has(d.property_id));n.length&&(i=i.concat(n))}i.sort((r,n)=>new Date(n.created_at||0)-new Date(r.created_at||0));const s=[...new Set(i.map(r=>r.category).filter(Boolean))].sort((r,n)=>r.localeCompare(n)),o=[...new Set(i.flatMap(r=>Array.isArray(r.tags)?r.tags:[]).filter(Boolean))].sort((r,n)=>r.localeCompare(n));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(s.length?s:ta).map(r=>`<option value="${l(r)}" ${(window._productFilters.category||"")===r?"selected":""}>${l(r)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=i,Xt(i),filterProducts(),updateBulkBar(),wa(),Aa(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function Y(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ue(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ii(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function st(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Oe(e){return parseInt(e.views??e.view_count??0,10)||0}function qe(e){return parseInt(e.sales??e.sales_count??0,10)||0}function ot(e){return e.sku||e.property_id||"N/A"}function Pi(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ue(e),i=st(e),s=window._productSelection?.has(e.property_id),o=C(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=G(e.created_at),n=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${n?"featured":"standard"}" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-2xl p-3.5 flex flex-col gap-3 transition hover:border-blue-400/35">
    <div class="flex items-start gap-3">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-[10px] text-gray-500 font-mono mt-0.5">SKU: ${l(ot(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2 text-[11px]">
      ...
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Discount</span><p class="text-amber-300 font-bold">${l(Ii(e))}</p></div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1">${a.slice(0,6).map(h=>`<span class="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${l(h)}</span>`).join("")}</div>`:'<div class="text-[10px] text-gray-500">No tags</div>'}
  </article>`}function Ei(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,o)=>i(s.created_at)-i(o.created_at)):t==="price-high"?a.sort((s,o)=>Y(o.price)-Y(s.price)):t==="price-low"?a.sort((s,o)=>Y(s.price)-Y(o.price)):t==="sales-high"?a.sort((s,o)=>qe(o)-qe(s)):t==="views-high"?a.sort((s,o)=>Oe(o)-Oe(s)):a.sort((s,o)=>i(o.created_at)-i(s.created_at)),a}function Xt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");t&&(t.innerHTML=e.map(Pi).join(""),i&&(i.textContent=String(e.length)),a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons())}function Zt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=st(i),r=window._productSelection?.has(i.property_id),n=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${l(ot(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>${C(o==="archived"?"inactive":o==="active"?"active":"inactive")}</td>
    ...
    </div>`)};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i={title:a.get("title")||"Untitled Product",price:Math.max(F,Math.min(Q,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"},s=X((window._productsData||[]).find(r=>r.property_id===t)),{error:o}=await p.from("showroom_listings").upsert({...s,...i,property_id:t},{onConflict:"property_id"});if(o){if(j(o)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),W(),T();return}qa(t,i),u("Quick edit saved locally","info")}else u("Quick edit saved");W(),T()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await p.from("showroom_listings").delete().eq("property_id",e);if(t)return j(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Delete failed: "+t.message,"error");u("Product deleted"),T()};window.openProductMoreActions=function(e){B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${ia(s)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-3 glass-soft border border-blue-500/15 rounded-xl">
              ...
              <p class="text-[11px] text-gray-500 mt-1">Allowed price range is ${F} to ${Q} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),ra(),na(),sa("pf-price"),Ge(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Ge(e,"pricing")),Vi(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),W(),T()};const Bi=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Mi=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Ri=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Di=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],ji=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Fi(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Bi:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Mi:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Ri:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Di:ji}function N(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function we(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&N(t)}function Ui(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(N("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",i=[...t.querySelectorAll('input[name="images"]')].map(s=>s.value).filter(s=>s&&!String(s).startsWith("blob:"));if(!i.length){e||N("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",we(!0,"AI is analyzing your images…");try{const s=await A.analyzeImages(i,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!s){N("AI analysis unavailable — add a Gemini, Groq, or OpenRouter API key in AI Settings (or install Ollama locally).","warn");return}Oi(s,a),N("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(s){N("AI analysis failed: "+(s.message||s),"error"),e||u("AI analysis failed: "+(s.message||s),"error")}finally{t.dataset.aiBusy="0",we(!1)}};function Oi(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const i=(d,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c))},s=(d,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};i("title",e.title),i("description",e.description),i("subcategory",e.subcategory),i("brand",e.brand),i("model",e.model),i("color",e.color),i("size",e.size),i("material",e.material),i("storage",e.storage),i("ram",e.ram),i("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||i("condition",e.condition),s("features_text",e.features),s("highlights_text",e.highlights),s("seo_keywords_text",e.seo_keywords);const o=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(d=>{o[d]!=null&&String(o[d]).trim()!==""&&i(d,o[d])}),Array.isArray(o.safety_features)&&s("safety_features",o.safety_features);const r=e.category?String(e.category).trim():"",n=document.getElementById("pf-ai-detected");n&&r&&r.toLowerCase()!==String(t||"").toLowerCase()&&(n.classList.remove("hidden"),n.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
    ...
    </div>`),window.lucide&&lucide.createIcons(),Ve()}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[s,o]of i.entries())s==="images"?(a.images=a.images||[],o&&!String(o).startsWith("blob:")&&a.images.push(String(o))):s==="tags"?(a.tags=a.tags||[],a.tags.push(o)):a[s]=o;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),i=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),o=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!o||o==="/fallback.svg"){N("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const r=Fi(t),n=Math.min(i,r.length);e.dataset.aiBusy="1";const d=document.getElementById("pf-ai-generated");d&&(d.innerHTML="");let c=0;try{for(let m=0;m<n;m++){we(!0,`Generating ${m+1}/${n} — ${r[m]}…`);try{const h=await A.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${r[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,o,1);if(h&&h[0]){const b=await Ni(h[0]);b&&(qi(b),c+=1)}}catch(h){N(`Stopped at ${m}/${n}: ${h.message||h}`,"error");break}}c?(N(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):N("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",we(!1)}};function qi(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,i=document.createElement("div");i.innerHTML=me(e,a),t.appendChild(i.firstElementChild),oe(),be();const s=document.getElementById("pf-ai-generated");if(s){const o=document.createElement("div");o.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",o.innerHTML=`<img src="${l(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,s.appendChild(o)}}async function Ni(e){try{const a=await(await fetch(e)).blob(),i=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),s=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`;return await ge(new File([a],s,{type:a.type}))}catch{return e}}function me(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function ra(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Hi(t.dataTransfer.files)}))}function na(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>oe()})}window.handleImageUpload=async function(e){await la(e.target.files)};async function Hi(e){await la(e)}async function la(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await ge(a);if(i){const s=t.children.length,o=document.createElement("div");o.innerHTML=me(i,s),t.appendChild(o.firstElementChild),oe()}}be(),window.lucide&&lucide.createIcons(),Ui()}}async function ge(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(s)return URL.createObjectURL(e);const{data:o}=p.storage.from("product-images").getPublicUrl(i);return o.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),oe(),be()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const s=await ge(i);if(!s)return;const r=[...a.querySelectorAll(".img-thumb")][e];if(!r)return;const n=r.querySelector("img");n&&(n.src=s),oe(),be(),u("Image replaced. Save changes to apply.","info")};function oe(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const s=a.querySelector("img");if(!s)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=s.src,t.appendChild(o),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const n=a.querySelector(".rp");n&&n.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function be(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function da(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Gi(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,s]of t.entries())i==="images"?s&&!String(s).startsWith("blob:")&&a.images.push(String(s)):i==="tags"?a.tags.push(String(s)):a.fields[i]=String(s);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function zi(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([s,o])=>{const r=e.querySelector(`[name="${s}"]`);r&&(r.type==="checkbox"?r.checked=o==="on"||o===!0:r.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(s=>{s.checked=i.includes(s.value)}),Array.isArray(t.images)){const s=document.getElementById("image-preview");s&&(s.innerHTML=t.images.map((o,r)=>me(o,r)).join(""),oe(),be())}return!0}function Ve(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=t.querySelector('[name="stock_quantity"]')?.value,r=o===""||o==null?"Unlimited":o,n=k.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(h=>h.value),c=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=e.dataset.category||"Product",n=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${C(d?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${l(r)}</span></div>
    ...
    </div>`)};function Vi(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=da(e,t),s=document.getElementById("product-autosave-note");try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);zi(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(Gi(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}Ve()};let r;const n=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",n),d.addEventListener("change",n)}),Ve()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const r=new FormData(i),n={};for(const[b,f]of r.entries())b==="images"?(n.images=n.images||[],f&&!String(f).startsWith("blob:")&&n.images.push(String(f))):b==="tags"?(n.tags=n.tags||[],n.tags.push(f)):n[b]=f;n.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",n.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",c=b=>He(b),m=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],g={};for(const v of f){const S=b[v];g[v]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const v=c(b.safety_features);g.safety_features=v.length?v:null}return g};let h;if(a){let b=X((window._productsData||[]).find(M=>M.property_id===a));if(!b){const{data:M}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=M?X(M):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(M,Re)=>{const Da=M===""||M==null?"":M,ja=Re===""||Re==null?"":Re;return String(Da).trim()===String(ja).trim()},g={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(M=>{f(n[M],b[M])||(g[M]=n[M]==null||n[M]===""?null:n[M])});const v=n.price===""||n.price==null?null:parseFloat(n.price);f(v,b.price)||(g.price=v==null?b.price:Math.max(F,Math.min(Q,v)));const S=n.stock_quantity===""||n.stock_quantity==null?null:parseInt(n.stock_quantity,10);f(S,b.stock_quantity)||(g.stock_quantity=Number.isFinite(S)?S:null);const z=c(n.features_text);f(z.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(g.features=z);const K=n.tags||[];f(K.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(g.tags=K);const w=c(n.highlights_text);f(w.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(g.highlights=w);const V=c(n.seo_keywords_text);f(V.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(g.seo_keywords=V);const yt=n.images||[];f(yt.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(g.images=yt);const vt=n.is_featured==="on";!!b.is_featured!==vt&&(g.is_featured=vt);const xt=d?!1:n.is_active==="on";!!b.is_active!==xt&&(g.is_active=xt);const Ra=m(n),wt={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Ra};if(JSON.stringify(wt)!==JSON.stringify(b.specifications||{})&&(g.specifications=wt),Object.keys(g).length===0){u("No changes detected — nothing was saved.","info"),s&&(s.disabled=!1,s.textContent=o);return}const _t={...b,...g,property_id:a,updated_at:new Date().toISOString()};if({error:h}=await p.from("showroom_listings").upsert(_t,{onConflict:"property_id"}),h&&Ne(h,()=>je(_t),"Product update")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":`Product updated — ${Object.keys(g).length} change(s) saved.`)}else{const b=parseInt(n.required_image_count||"0",10)||(rt.includes(t)?24:0);if(oa(b,n.images||[],"This listing"),!n.title||!n.title.trim())throw new Error("A product title is required.");if(n.price===""||n.price==null||!isFinite(parseFloat(n.price)))throw new Error("A price is required.");if(!n.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:n.subcategory||null,title:n.title.trim(),description:n.description||"",price:Math.max(F,Math.min(Q,parseFloat(n.price)||0)),currency:n.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:n.is_active==="on",is_featured:n.is_featured==="on",brand:n.brand||null,color:n.color||null,size:n.size||null,condition:n.condition||null,warranty:n.warranty||null,availability_status:n.availability_status||"In Stock",stock_quantity:n.stock_quantity?parseInt(n.stock_quantity):null,images:n.images||[],features:c(n.features_text).length?c(n.features_text):n.tags||[],tags:n.tags||[],highlights:c(n.highlights_text),seo_keywords:c(n.seo_keywords_text),is_ai_generated:!!n.catalog_template_id,ai_generated_fields:n.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(n)},g=et();if(f.property_id=g,{error:h}=await p.from("showroom_listings").insert(f),h&&Ne(h,()=>je({...f,property_id:f.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":"Product published!")}try{localStorage.removeItem(da(t,a))}catch{}closeProductFormModal()}catch(r){u("Error: "+r.message,"error"),s&&(s.disabled=!1,s.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Et(e)),i||(i=(Array.isArray(D)?D.find(s=>s.property_id===e):null)||null),!i)return u("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=X((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return j(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),T()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:o,updated_at:r,...n}=a,d=et();await p.from("showroom_listings").insert({...n,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),T())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),T())};const Wi=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function nt(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Ct().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(D)){const s=new Set(i.map(r=>r.property_id)),o=D.filter(r=>r.listing_type==="property"&&r.property_id&&!s.has(r.property_id));o.length&&(i=i.concat(o))}i.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(s=>`<tr>
                    ...
                    <td>${C(s.listing_status||"sale")} ${C(s.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Rt("property","Real Estate"),i=e.country_code||"US",s=e.currency||Ze(i);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Wi.map(o=>`<option value="${o}" ${e.property_type===o?"selected":""}>${o}</option>`).join("")}
            </select></div>
    ...
    </div>`),ra(),na(),sa("ppf-price"),window.syncPropertyCountry=function(){St("ppf")},St("ppf"),ze("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>ze("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),o=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),r=t?0:parseInt(i.required_image_count||"24",10)||24;oa(r,s,"This property");const n={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(F,Math.min(Q,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:o,images:s,highlights:He(i.highlights_text),seo_keywords:He(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){n.property_id=t;const c=X((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:d}=await p.from("showroom_listings").upsert({...c,...n},{onConflict:"property_id"}))}else n.property_id=et(),{error:d}=await p.from("showroom_listings").insert(n);d&&Ne(d,()=>je({...n,property_id:t||n.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),W(),nt())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Et(e)),i||(i=(Array.isArray(D)?D.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Ki=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function ca(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>Ji(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Ji(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
      ...
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Nt(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",U(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Ki.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),W(),ca()};async function Qi(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${l(i.order_number)}</p><p class="text-[10px] text-gray-500">${U(i.created_at)}</p></div>
    ...
    </div>`)};async function lt(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?se("star","No Reviews","Customer reviews will appear here."):a.map(s=>Yi(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Yi(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),lt()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),lt())};async function ua(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${U(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),ua()};async function Pe(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:s}=await p.from("coupons").insert(i);if(s){u(s.message,"error");return}u("Coupon created!"),W(),Pe()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Pe()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Pe())};async function Xi(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const pa=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Zi=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let fe=null;function es(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function ts(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${l(e.link_target||"")}</span>`}function as(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function ma(){if(fe)return fe;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const r=o.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{D.forEach(i)}catch{}try{const{data:o,error:r}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),fe={products:e,categories:a,sections:Zi},fe}async function is(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),s=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await p.storage.from("advertisements").upload(s,e,{contentType:e.type,upsert:!1});if(o)return u("Upload failed: "+o.message,"error"),null;const{data:r}=p.storage.from("advertisements").getPublicUrl(s);return{url:r.publicUrl,isVideo:i}}catch{return u("Upload failed","error"),null}}function _e(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),s=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),s&&(s.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const i=await is(t);if(!i){e.value="";return}_e(i.url,i.isVideo);const s=document.getElementById("ad-media-url");s&&(s.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);_e(t,a)};function dt(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let s="";t==="product"?s='<option value="">Select a product…</option>'+e.products.map(o=>`<option value="${l(o.id)}" ${String(a)===String(o.id)?"selected":""}>${l(o.id)} — ${l((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?s='<option value="">Select a category…</option>'+e.categories.map(o=>`<option value="${l(o)}" ${a===o?"selected":""}>${l(o)}</option>`).join(""):t==="section"&&(s='<option value="">Select a section…</option>'+e.sections.map(o=>`<option value="${l(o.id)}" ${a===o.id?"selected":""}>${l(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${s}</select>`}function ga(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const ha=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function os(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function fa(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const i of t)i in e&&(a[i]=e[i]);return a}function ue(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const o=t.slice(i,s+1);try{return JSON.parse(o)}catch{return null}}function It(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=os(e);if(!a)try{const{data:i}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();i&&(a=i)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},E()};function E(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",i=e.busy===!0,o=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    ...
    </div>`).join(""),m=e.suggestions?ns():"",h=rs();B(`
    ...
    </div>`);const b=document.getElementById("product-ai-input");b&&(b.value=e.instruction||"",b.addEventListener("input",()=>{y&&(y.instruction=b.value)}),b.addEventListener("keydown",f=>{f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),runProductAiInstruction())})),window.lucide&&lucide.createIcons(),ya()}function ya(){const e=document.getElementById("product-ai-chat-scroll");e&&requestAnimationFrame(()=>{e.scrollTo({top:e.scrollHeight,behavior:"smooth"})})}window.productAiChatAttach=function(){document.getElementById("product-ai-chat-image")?.click()};window.productAiChatImagePicked=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await va(i);s&&(y.chatImages.push(s),a+=1)}e.value="",a&&u(`${a} photo(s) attached. Send any message and the AI will look at them right away.`,"info"),E()};window.productAiRemoveChatImage=function(e){y&&(y.chatImages.splice(e,1),E())};function va(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>t(String(a.result||"")),a.onerror=()=>t(""),a.readAsDataURL(e)})}function rs(){const e=y;if(!e)return"";const t=Array.isArray(e.product.images)?e.product.images:[],a=[...t,...e.addedImages],i={};t.forEach(r=>{i[r]=(i[r]||0)+1});const s=Object.keys(i).filter(r=>i[r]>1),o=a.map((r,n)=>{const d=n<t.length,c=d&&e.removedImages.has(r),m=d&&s.includes(r);return`
    ...
    </div>`}function ns(){const e=y;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){y&&(y.instruction=e)};window.productAiQuickAction=function(e){const t=ha.find(a=>a.key===e);!t||!y||(y.instruction=t.prompt,y.quickLabel=t.label,y.quickMode=t.mode||"edit",runProductAiInstruction())};window.productAiToggleApproved=function(e,t){y&&(t?y.approved.add(e):y.approved.delete(e),E())};window.productAiApproveAll=function(){if(!(!y||!y.suggestions)){for(const e of Object.keys(y.suggestions))y.approved.add(e);y.removedImages.size&&y.approved.add("images_to_remove"),E()}};window.productAiToggleRemoveImage=function(e){if(!y)return;const t=Array.isArray(y.product.images)?y.product.images:[],i=[...t,...y.addedImages][e];i&&(e<t.length?y.removedImages.has(i)?y.removedImages.delete(i):y.removedImages.add(i):y.addedImages=y.addedImages.filter(s=>s!==i),E())};window.productAiDetectDuplicates=function(){if(!y)return;const e=Array.isArray(y.product.images)?y.product.images:[],t={};e.forEach(s=>{t[s]=(t[s]||0)+1});let a=0;const i=new Set;for(const s of e)t[s]>1&&(i.has(s)?(y.removedImages.has(s)||(a+=1),y.removedImages.add(s)):i.add(s));a?(y.approved.add("images_to_remove"),u(`Marked ${a} duplicate image(s) for removal.`,"info")):u("No duplicate images found.","info"),E()};window.productAiUploadImages=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=[...e.files];let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await ge(i);s&&(y.addedImages.push(s),a+=1)}e.value="",a?u(`${a} image(s) uploaded and staged.`,"success"):u("Upload failed.","error"),E()};function ls(e,t){const a=String(e).toLowerCase();if(/\b(generate|create|make|draw|produce|imagine)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner)\b/.test(a)||/\b(change|swap|replace|edit|remove)\b[\s\S]*\b(background|color|colour)\b/.test(a))return"gen";if(/\bshowroom\b/.test(a)||/\bcompare\b[\s\S]*\b(showroom|product|other|card)\b/.test(a)||/\bscan\b[\s\S]*\b(showroom|product|card|listing|shop|match)\b/.test(a)||/\bmatch(es|ing)?\b/.test(a))return"scan";const i=/\b(rewrite|rephrase|update|fix|improve|optimize|change|make|rename|retitle|set|clean up|cleanup|remove|delete|add)\b/,s=/\b(title|description|price|stock|category|subcategory|brand|name|images?|features|tags|highlights|seo)\b/;return i.test(a)&&s.test(a)?"edit":t?"vision":"chat"}function ds(){const e=y;return(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content)}window.runProductAiInstruction=async function(){const e=y;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i&&!s)return;const o=t||"Improve this product listing professionally.",r=a||t||(s?"Look at these photos and tell me what you see.":"Improve this product listing professionally."),n=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.messages.push({role:"user",content:r,images:n}),e.busy=!0,E();const d=i||ls(o,s);try{d==="gen"?await xa(o,n):d==="scan"?await gs():d==="edit"?await cs(o,n):d==="vision"?await ps(o,n):await us(o),ya()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`AI error: ${c.message}`,"error")}finally{e.busy=!1,E()}};async function cs(e,t){const a=y,i=bs(a,e);let s="";if(t&&t.length){const n=await A._callEdge({action:"vision",images:t.slice(0,4),prompt:i,max_tokens:4096});if(s=n&&n.text?String(n.text):"",!s)throw new Error(n&&n.error||"The AI could not read the attached photos.")}else s=(await A.prompt(i,{maxTokens:4e3,onProviderSwitch:()=>{}})).text;const o=ue(s);if(!o)throw new Error("The AI did not return valid JSON suggestions.");a.suggestions=o,a.approved=new Set(Object.keys(o)),a.approved.add("images_to_remove");const r=(o.summary||"Changes are ready for this product.").trim();a.messages.push({role:"assistant",content:`${r}

✅ Changes are ready below. Tick what you want, then press Save.`}),u("Suggestions ready — review and approve before saving.","info")}async function us(e){const t=y,a=ds(),i=await A._callEdge({action:"chat",message:e,history:a,max_tokens:1200});if(i&&i.response){t.messages.push({role:"assistant",content:String(i.response)});return}throw new Error(i&&i.error||"The AI did not respond.")}async function ps(e,t){const a=y,i=`${e}

If you recognize the product in these photos, say yes and identify exactly what it is, give a typical price range for it, and offer to generate more product photos for this listing. Be friendly and helpful.`,s=await A._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1200}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o})}async function ms(){let e=Array.isArray(window._productsData)?window._productsData:[];if(!e.length)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").limit(500);!a&&Array.isArray(t)&&(e=t)}catch{}return(e||[]).filter(t=>t&&t.property_id!==y.pid)}async function gs(){const e=y,t=await ms(),a=JSON.stringify(fa(e.product),null,2),i=t.slice(0,15).map(m=>({title:m.title,category:m.category,subcategory:m.subcategory,price:m.price,currency:m.currency,brand:m.brand,images:Array.isArray(m.images)?m.images.length:0,listing_type:m.listing_type})),s=`You are the AI product manager for the product ${e.pid} in the Weverse Online Shop showroom.
THIS PRODUCT (JSON):
${a}
...
- Respond with valid JSON only.`,o=await A._callEdge({action:"chat",message:s,history:[],max_tokens:3e3}),r=o&&o.response?String(o.response):"";if(!r)throw new Error(o&&o.error||"The showroom scan returned nothing.");const n=ue(r),d=Array.isArray(n&&n.mismatches)?n.mismatches:[],c=Array.isArray(n&&n.matches)?n.matches:[];if(n&&(d.length||c.length||n.summary)){const m={};d.forEach(b=>{b&&b.field&&b.suggested_value!==void 0&&b.suggested_value!==null&&(m[b.field]=b.suggested_value)});const h=["Showroom scan complete:"];c.length&&h.push(...c.map(b=>`✅ ${b}`)),d.length&&h.push(...d.map(b=>`⚠️ ${b.field}: ${b.issue}`)),d.length||h.push("✅ Everything matches the other products in this showroom."),d.length?(m.summary=n.summary||`${d.length} issue(s) found with the showroom.`,e.suggestions=m,e.approved=new Set(Object.keys(m)),e.approved.add("images_to_remove"),h.push("Fixes are ready below. Tick what you want, then press Save.")):e.suggestions=null,e.messages.push({role:"assistant",content:h.join(`
`)}),u("Showroom scan complete.","info");return}e.messages.push({role:"assistant",content:r||"Showroom scan complete."})}async function xa(e,t){const a=y,i=a.product,s=`${e}

(Generate a clean, professional product photo for "${String(i.title||"").trim()||"this product"}" in the Weverse Online Shop.)`;let o=null;t&&t.length?o=t[0]:Array.isArray(i.images)&&i.images[0]&&(o=await A._fetchImageAsDataUrl(i.images[0]));const r=await A._callEdge({action:"generate_images",prompt:s,reference_url:o,count:2});if(r&&Array.isArray(r.images)&&r.images.length){a.generatedImages=r.images,a.lastGenPrompt=e,a.lastGenReference=o,a.messages.push({role:"assistant",content:"Here are your generated images. Tap one to add it to the card, or Regenerate for new variations.",generated:r.images,provider:`${r.provider||"AI"}/${r.model||""}`});return}throw new Error(r&&r.error||"Image generation returned nothing.")}async function ct(e){try{const t=await fetch(e).then(i=>i.blob());if(!t||!t.size)return null;const a=new File([t],`ai-${Date.now()}.png`,{type:t.type||"image/png"});return await ge(a)}catch{return null}}window.productAiUseGeneratedImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,E();const i=await ct(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),E();return}t.addedImages.push(i),u("Generated image staged. Press Save Approved to add it to the card.","success"),E()};window.productAiUseAllGeneratedImages=async function(){const e=y;if(!e||e.busy||!Array.isArray(e.generatedImages)||!e.generatedImages.length)return;e.busy=!0,E();let t=0;for(const a of e.generatedImages){const i=await ct(a);i&&(e.addedImages.push(i),t+=1)}e.busy=!1,u(t?`${t} image(s) staged. Press Save Approved to add them.`:"Upload failed.",t?"success":"error"),E()};window.productAiRegenerateImage=async function(){const e=y;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,E();try{await xa(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,E()}}};function bs(e,t){const a=e.product,i=JSON.stringify(fa(a),null,2);return`You are the AI product manager assistant for ONE product in the Weverse Online Shop admin dashboard.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(n=>n!=="images_to_remove"),a={};if(e.suggestions)for(const n of e.approved)n!=="images_to_remove"&&n in e.suggestions&&e.suggestions[n]!==void 0&&(a[n]=e.suggestions[n]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const i=Array.isArray(e.product.images)?e.product.images:[],s=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(n=>s.add(n));const o=[...i.filter(n=>!s.has(n)),...e.addedImages],r=X({...e.product,...a,images:o,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,E();try{const{error:n}=await p.from("showroom_listings").upsert(r,{onConflict:"property_id"});if(n)throw n;u("Changes saved to Supabase.","success");const d=e.from;y=null,W(),d==="properties"?nt():T()}catch(n){e.busy=!1,n&&j(n)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${n&&n.message||"unknown error"}`,"error"),E()}};let x=null;const ut=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Publish this photo as a product in my showroom, matched to the right section."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function hs(){const e=x;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content):[]}function fs(e,t){const a=String(e).toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":t?a?"vision":"publish":"execute"}function ys(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function wa(){return x||(x={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Just upload a photo of any item and I'll scan it, write the complete brand, model, year, rating and details (so your customers feel confident), check your showroom first, and publish it automatically — no need to type anything. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything in the showroom without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null},x)}window.openGeneralAi=async function(){wa(),R()};function _a(e){return e?e.role==="user"?`
    <div class="flex justify-end">
      <div class="max-w-[85%] bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-3xl rounded-tr-md px-5 py-3.5 text-[1.02rem] leading-relaxed whitespace-pre-wrap break-words shadow-lg shadow-blue-600/20">
          ...
          <div class="flex flex-wrap gap-2.5 mt-3">
            ${e.generated.map((t,a)=>`
              <div class="relative">
                ...
                <button onclick="generalAiUseGeneratedImage(${a})" class="absolute bottom-1.5 right-1.5 px-2 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black shadow transition">Use on card</button>
              </div>`).join("")}
          </div>
          <div class="flex items-center gap-2 mt-2.5">
    ...
    </div>`}function $a(){const e=x;return!e||!e.pendingPlan?"":`
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${l(ys(e.pendingPlan))}</p>
    ...
    </div>`}function Sa(){const e=x;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,i)=>`
    ...
    </div>`).join(""):""}function R(){document.getElementById("general-ai-embed-scroll")&&Aa(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&vs(),Ee()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function vs(){const e=x;if(!e)return;const t=e.busy===!0,i=(Array.isArray(e.messages)?e.messages:[]).map(c=>_a(c)).join(""),s=t?ka():"",o=ut.map(c=>`
    ...
    </div>`);const d=document.getElementById("general-ai-input");d&&(d.value=e.instruction||"",d.addEventListener("input",()=>{x&&(x.instruction=d.value,clearTimeout(x.autoSendTimer))}),d.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),clearTimeout(x.autoSendTimer),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Ee()}function Aa(){const e=x,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,i=Array.isArray(e.messages)?e.messages:[],s=ut.map(d=>`
    ...
    ${a?ka():""}
    ${$a()}
  `;const o=document.getElementById("general-ai-embed-thumbs");o&&(o.innerHTML=Sa());const r=document.getElementById("general-ai-embed-send-btn");r&&(r.classList.toggle("opacity-40",a),r.classList.toggle("pointer-events-none",a));const n=document.getElementById("general-ai-embed-input");n&&(n.value=e.instruction||"",n.dataset.gaiBound||(n.dataset.gaiBound="1",n.addEventListener("input",()=>{x&&(x.instruction=n.value,clearTimeout(x.autoSendTimer))}),n.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),clearTimeout(x.autoSendTimer),runGeneralAiInstruction())}))),window.lucide&&lucide.createIcons(),Ee()}function Ee(){const e=["general-ai-chat-scroll","general-ai-embed-scroll"];requestAnimationFrame(()=>{for(const t of e){const a=document.getElementById(t);a&&a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}})}window.generalAiChatAttach=function(){document.getElementById("general-ai-chat-image")?.click()};window.generalAiChatImagePicked=async function(e){if(!x||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await va(i);s&&(x.chatImages.push(s),a+=1)}if(e.value="",a){u(`${a} photo(s) attached — I'll scan it and publish it to your showroom automatically.`,"info");const i=x;clearTimeout(i.autoSendTimer),i.autoSendTimer=setTimeout(()=>{i.busy||(i.instruction||"").trim()||runGeneralAiInstruction()},600)}R()};window.generalAiRemoveChatImage=function(e){x&&(x.chatImages.splice(e,1),R())};window.generalAiQuickAction=function(e){const t=ut.find(a=>a.key===e);!t||!x||(x.instruction=t.prompt,x.quickLabel=t.label,x.quickMode=t.mode,runGeneralAiInstruction())};window.runGeneralAiInstruction=async function(){const e=x;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i&&!s)return;const o=t||"publish this photo to my showroom",r=a||t||(s?"Publish this photo to my showroom.":o),n=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.pendingPlan=null,e.messages.push({role:"user",content:r,images:n}),e.busy=!0,R();const d=i||fs(o,s);try{d==="publish"?await xs(o,n):d==="gen"?await Ia(o,n):d==="monitor"?await ws():d==="vision"?await _s(o,n):await ks(o,n),Ee()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`General AI error: ${c.message}`,"error")}finally{e.busy=!1,R()}};async function xs(e,t){const a=x,i=await A._callEdge({action:"general_publish",message:e,images:t.slice(0,4),max_tokens:2048});if(!i||i.success!==!0)throw new Error(i&&i.error||"Could not publish the product.");a.messages.push({role:"assistant",content:String(i.response||"Published."),images:(i.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),pt()}async function Ia(e,t){const a=x;let i=null;t&&t.length&&(i=t[0]);const s=await A._callEdge({action:"generate_images",prompt:`${e}

(Generate a beautiful, high-quality image. It can be any type of image — no restrictions.)`,reference_url:i,count:2});if(!s||!Array.isArray(s.images)||!s.images.length)throw new Error(s&&s.error||"Image generation returned nothing.");a.generatedImages=s.images,a.lastGenPrompt=e,a.lastGenReference=i,a.messages.push({role:"assistant",content:"Here are your images. Tap one to save it to your showroom product images.",generated:s.images,provider:`${s.provider||"AI"}/${s.model||""}`})}async function ws(){const e=x,t=await A._callEdge({action:"general_monitor",max_tokens:3e3});if(!t||t.success!==!0||!t.report)throw new Error(t&&t.error||"Could not scan the showroom.");const a=t.report||{},i=["Showroom scan complete:"];(Array.isArray(a.good)?a.good:[]).forEach(s=>i.push(`✅ ${s}`)),(Array.isArray(a.issues)?a.issues:[]).forEach(s=>i.push(`⚠️ ${s.property_id} (${s.severity||"low"}): ${s.issue}`)),(Array.isArray(a.suggestions)?a.suggestions:[]).forEach(s=>i.push(`💡 ${s}`)),Array.isArray(a.issues)&&a.issues.length||i.push("Everything looks good."),e.messages.push({role:"assistant",content:i.join(`
`)})}async function _s(e,t){const a=x,i=`${e}

Look at the photo(s). If you recognize the product, identify it and give a typical price range. You manage the whole showroom.`,s=await A._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1200}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o})}async function ks(e,t){const a=x,i=hs(),s=await A._callEdge({action:"general_execute",message:e,images:(t||[]).slice(0,4),history:i,max_tokens:1200});if(!s||s.success!==!0)throw new Error(s&&s.error||"Could not handle that request.");if(s.needs_confirmation){a.pendingPlan=s.plan||null,a.messages.push({role:"assistant",content:String(s.response||"I found something I can fix.")});return}a.messages.push({role:"assistant",content:String(s.response||s.reply||"Done.")}),s.plan&&s.plan.action!=="chat"&&s.plan.action!=="monitor"&&pt()}window.generalAiConfirmPlan=async function(){const e=x;if(!e||!e.pendingPlan||e.busy)return;const t=e.pendingPlan;e.pendingPlan=null,e.busy=!0,R();try{const a=await A._callEdge({action:"general_execute",confirm_plan:t,confirmed:!0});if(!a||a.success!==!0)throw new Error(a&&a.error||"The action failed.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||a.reply||"Done.")}`}),pt()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,R()}};window.generalAiCancelPlan=function(){x&&(x.pendingPlan=null,x.messages.push({role:"assistant",content:"Cancelled — nothing was changed."}),R())};window.generalAiUseGeneratedImage=async function(e){const t=x;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,R();const i=await ct(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),R();return}u("Image saved to showroom storage. Use it on any card or ask the AI to attach it.","success"),R()};window.generalAiRegenerateImage=async function(){const e=x;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,R();try{await Ia(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,R()}}};async function pt(){try{await T()}catch{}}const mt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],$s=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function gt(e){return Array.isArray(e)?e:[]}function Pa(e=[]){const t=new Map(gt(e).map(a=>[a.id,a]));return mt.map(a=>{const i=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!i.enabled,apiKey:i.apiKey||"",model:i.model||"",baseUrl:i.baseUrl||""}})}async function Ea(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function bt(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...gt(t?.ai_ad_generation_history)].slice(0,120);await Ea({ai_ad_generation_history:a})}async function Ca(e){try{const{data:i,error:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(s)throw s;let o;if(i?.id?{error:o}=await p.from("site_settings").update(e).eq("id",i.id):{error:o}=await p.from("site_settings").insert(e),o)throw o;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:i}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let s;if(i?.id?{error:s}=await p.from("public_live_state").update(a).eq("id",i.id):{error:s}=await p.from("public_live_state").insert(a),!s)return}catch{}try{localStorage.setItem(Ft,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function Ss(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function As(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=Ss(e.description),i=a?.startsAt||e.started_at||null,s=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:i,ai_ad_ends_at:s,ai_ad_duration_seconds:s&&i?Math.max(5,Math.round((new Date(s).getTime()-new Date(i).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(Ft),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function Ce(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),As()]),i=t||{},s=a||{},o=Pa(i.ai_ad_video_providers),r=gt(i.ai_ad_generation_history).sort((d,c)=>new Date(c.created_at||0).getTime()-new Date(d.created_at||0).getTime()).slice(0,12),n=!!s.ai_ad_enabled&&!!s.ai_ad_video_url&&(!s.ai_ad_ends_at||new Date(s.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
      <div class="space-y-6 fade-in">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <select id="ai-ad-goal" class="input-field text-xs" name="goal">
                ${$s.map(d=>`<option value="${l(d)}">${l(d)}</option>`).join("")}
              </select>
            </div>
            <div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${r.length===0?'<tr><td colspan="5" class="text-center text-gray-500 py-8">No AI ad jobs yet.</td></tr>':r.map(d=>`
                    <tr>
                      <td><span class="text-xs text-gray-400">${l(U(d.created_at))}</span></td>
...
`),o=await A.prompt(s,{onProviderSwitch:r=>{i.value=`Generating with ${r}...`}});i.value=o.text||"",await bt({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:o.provider,provider_id:a?.value||"",status:"script_generated",script:o.text||"",video_url:null}),u(`Script generated with ${o.provider}.`,"success")}catch(s){i.value="",u("Script generation failed: "+s.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),i=String(t.get("provider_id")||""),s=mt.find(b=>b.id===i)?.name||i,o=String(t.get("brief")||"").trim(),r=String(t.get("script")||"").trim(),n=String(t.get("video_url")||"").trim(),d=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),h=new Date(c+d*1e3).toISOString();if(!n){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:n,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:d,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:i,ai_ad_starts_at:m,ai_ad_ends_at:h,ai_ad_updated_at:new Date().toISOString()};await Ca(b),await bt({created_at:m,goal:a,brief:o,provider_name:s,provider_id:i,status:"active",script:r,video_url:n,ends_at:h}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Ce()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Ca({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await bt({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Ce()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function Is(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons(),ea(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Es(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${s.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':s.map(c=>{const m=["login_success","login_2fa_success"].includes(c.event_type),h=["login_failed","login_denied","login_backup_code_used"].includes(c.event_type),b=m?"text-emerald-400":h?"text-red-400":"text-gray-300",f={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[c.event_type]||c.event_type;return`<tr>
                      ...
                      <td><span class="text-xs text-gray-500">${U(c.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${U(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Ts(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${l(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${U(a.created_at)}</p></div>
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),u("Orders exported!")};async function Bs(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Be(){const e=document.getElementById("content");e&&(e.innerHTML=Z());try{let t=function(n,d,c,m="",h="blue"){const b=!!(c&&c.trim());return`
        ...
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.brand_name||i.site_name||Ut,o=i.brand_slogan||i.site_tagline||Ot,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Ms(t,a)).join("")}
    ...
    </div>`,ft(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ht()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ht()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ft())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=$e.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Lt(t),ft(),renderManualPaymentAccountsEditor()};async function Qe(){const e=document.getElementById("content");e&&(e.innerHTML=Z());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Wa()||{},...t||{}};window._manualPaymentAccounts=Ka(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(Ja(i))}</textarea>
              </div>
              <div>
    ...
    </div>`}function Ds(e){return e.length?e.map(t=>`
    <div class="glass-soft border border-blue-500/10 rounded-xl p-4 flex flex-col gap-3 lg:flex-row lg:items-center">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1"><span class="text-sm font-black text-white">${l(t.title)}</span>${C(t.status)}</div>
        <p class="text-[11px] text-gray-500">Platforms: ${l(t.selectedPlatforms.join(", ")||"None")} ${t.scheduledAt?`• Scheduled: ${l(U(t.scheduledAt))}`:""}</p>
    ...
    </div>`).join(""):'<p class="text-sm text-gray-500 text-center py-8">No live sessions created yet.</p>'}async function le(){const e=document.getElementById("content");e&&(e.innerHTML=Z()),await ne();const t=window._livePublicState||{},a=window._liveControlAdminState,i=a.streamingPlatforms.filter(r=>r.enabled).length,s=a.liveSessions,o=[...a.streamingPlatforms].sort((r,n)=>r.id==="tiktok-live"?-1:n.id==="tiktok-live"?1:0);e.innerHTML=`
    <div class="space-y-5 fade-in">
      <div class="flex flex-wrap items-center gap-3">
        <div class="flex-1">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${o.map(r=>Ma(r,Ye.find(n=>n.id===r.id),"streamingPlatforms")).join("")}
        </div>
      </div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}function js(e){return e.length?e.map(t=>`
    <div class="glass-soft border border-blue-500/10 rounded-xl p-4 flex flex-col gap-3 lg:flex-row lg:items-center">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1"><span class="text-sm font-black text-white">${l(t.title)}</span>${C(t.status)}</div>
        <p class="text-[11px] text-gray-500">Provider: ${l(t.providerId)} • Type: ${l(t.callType)}${t.scheduledAt?` • Scheduled: ${l(U(t.scheduledAt))}`:""}</p>
      </div>
      <div class="flex flex-wrap gap-2">
    ...
    </div>`).join(""):'<p class="text-sm text-gray-500 text-center py-8">No video call rooms created yet.</p>'}async function he(){const e=document.getElementById("content");e&&(e.innerHTML=Z()),await ne();const t=window._liveControlAdminState,a=t.videoCallProviders.filter(s=>s.enabled).length,i=t.videoCallRooms.filter(s=>s.status==="live").length;e.innerHTML=`
    <div class="space-y-5 fade-in">
      <div class="flex flex-wrap items-center gap-3">
        <div class="flex-1">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${t.videoCallProviders.map(s=>Ma(s,za.find(o=>o.id===s.id),"videoCallProviders")).join("")}
        </div>
      </div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.updateLivePlatformField=function(e,t,a,i){const o=(window._liveControlAdminState?.[e]||[]).find(r=>r.id===t);o&&Rs(o,a,i)};window.toggleLivePlatformEnabled=function(e,t,a){const s=(window._liveControlAdminState?.[e]||[]).find(o=>o.id===t);s&&(s.enabled=a)};async function O(e=!0){const{error:t}=await Na(window._liveControlAdminState);return t?(u("Saved locally. Run the live manager migration to persist provider settings.","info"),!1):(e&&u("Live manager settings saved"),!0)}window.saveLiveStreamingSettings=async function(){await O(!0)};window.saveVideoCallSettings=async function(){await O(!0)};window.createLiveSession=async function(e){await ne();const t=[...document.querySelectorAll("[data-live-platform-select]:checked")].map(i=>i.value),a={id:`session-${Date.now()}`,title:document.getElementById("live-session-title")?.value?.trim()||"Live Stream",headline:document.getElementById("live-session-headline")?.value?.trim()||"",description:document.getElementById("live-session-description")?.value?.trim()||"",embedUrl:document.getElementById("live-session-embed")?.value?.trim()||"",badgeText:document.getElementById("live-session-badge")?.value?.trim()||"LIVE NOW",status:e==="live"?"live":"scheduled",scheduledAt:document.getElementById("live-session-scheduled")?.value||"",startedAt:e==="live"?new Date().toISOString():"",selectedPlatforms:t,notifyVisitors:document.getElementById("live-notify-visitors")?.checked!==!1,showHomepageBadge:document.getElementById("live-show-badge")?.checked!==!1,showHomepageEmbed:!!document.getElementById("live-show-embed")?.checked,viewerCount:0,commentCount:0,streamStatus:e==="live"?"live":"scheduled"};window._liveControlAdminState.liveSessions.unshift(a),e==="live"&&(window._livePublicState={isLive:!0,badgeText:a.badgeText,headline:a.headline||a.title,description:a.description,platformLabels:a.selectedPlatforms.map(i=>Ye.find(s=>s.id===i)?.label||i),embedUrl:a.showHomepageEmbed?a.embedUrl:"",viewerCount:a.viewerCount,commentCount:a.commentCount,streamStatus:"live",sessionId:a.id,notifyVisitors:a.notifyVisitors,startedAt:a.startedAt,updatedAt:new Date().toISOString()},await Xe(window._livePublicState)),await O(!1),u(e==="live"?"Live stream started":"Live stream scheduled"),le()};window.startLiveSession=async function(e){await ne();const t=window._liveControlAdminState.liveSessions.find(a=>a.id===e);t&&(t.status="live",t.startedAt=new Date().toISOString(),t.streamStatus="live",window._livePublicState={isLive:!0,badgeText:t.badgeText||"LIVE NOW",headline:t.headline||t.title,description:t.description||"",platformLabels:t.selectedPlatforms.map(a=>Ye.find(i=>i.id===a)?.label||a),embedUrl:t.showHomepageEmbed?t.embedUrl:"",viewerCount:t.viewerCount||0,commentCount:t.commentCount||0,streamStatus:"live",sessionId:t.id,notifyVisitors:t.notifyVisitors!==!1,startedAt:t.startedAt,updatedAt:new Date().toISOString()},await Xe(window._livePublicState),await O(!1),u("Live session published"),le())};window.endLiveSession=async function(e){await ne();const t=window._liveControlAdminState.liveSessions.find(a=>a.id===e);t&&(t.status="ended",t.streamStatus="ended",t.endedAt=new Date().toISOString(),window._livePublicState?.sessionId===e?await window.clearPublicLiveState():(await O(!1),u("Live session ended"),le()))};window.removeLiveSession=async function(e){window._liveControlAdminState.liveSessions=window._liveControlAdminState.liveSessions.filter(t=>t.id!==e),window._livePublicState?.sessionId===e&&await window.clearPublicLiveState(),await O(!1),u("Live session deleted"),le()};window.clearPublicLiveState=async function(){window._livePublicState={isLive:!1,badgeText:"LIVE NOW",headline:"",description:"",platformLabels:[],embedUrl:"",viewerCount:0,commentCount:0,streamStatus:"offline",sessionId:"",notifyVisitors:!0,startedAt:"",updatedAt:new Date().toISOString()},await Xe(window._livePublicState),await O(!1),u("Public live state cleared"),le()};window.createVideoRoom=async function(e){await ne();const t={id:`room-${Date.now()}`,title:document.getElementById("video-room-title")?.value?.trim()||"Video Call Room",providerId:document.getElementById("video-room-provider")?.value||"zoom",callType:document.getElementById("video-room-type")?.value||"group",roomCode:document.getElementById("video-room-code")?.value?.trim()||"",hostUrl:document.getElementById("video-room-host")?.value?.trim()||"",joinUrl:document.getElementById("video-room-join")?.value?.trim()||"",embedUrl:document.getElementById("video-room-embed")?.value?.trim()||"",status:e==="live"?"live":"scheduled",scheduledAt:document.getElementById("video-room-scheduled")?.value||"",startedAt:e==="live"?new Date().toISOString():"",maxParticipants:parseInt(document.getElementById("video-room-max")?.value||"25",10)||25,waitingRoom:!!document.getElementById("video-waiting-room")?.checked,screenShare:!!document.getElementById("video-screen-share")?.checked,recording:!!document.getElementById("video-recording")?.checked,chatEnabled:!!document.getElementById("video-chat")?.checked,fileSharing:!!document.getElementById("video-file-share")?.checked,muteOnEntry:!!document.getElementById("video-mute-entry")?.checked,cameraControl:!!document.getElementById("video-camera-control")?.checked,removeParticipants:!!document.getElementById("video-remove-participants")?.checked,notes:document.getElementById("video-room-notes")?.value?.trim()||""};window._liveControlAdminState.videoCallRooms.unshift(t),await O(!1),e==="live"&&t.hostUrl&&window.open(t.hostUrl,"_blank","noopener"),u(e==="live"?"Video call started":"Video call scheduled"),he()};window.startVideoRoom=async function(e){const t=window._liveControlAdminState.videoCallRooms.find(a=>a.id===e);t&&(t.status="live",t.startedAt=new Date().toISOString(),await O(!1),t.hostUrl&&window.open(t.hostUrl,"_blank","noopener"),u("Video room started"),he())};window.endVideoRoom=async function(e){const t=window._liveControlAdminState.videoCallRooms.find(a=>a.id===e);t&&(t.status="ended",t.endedAt=new Date().toISOString(),await O(!1),u("Video room ended"),he())};window.removeVideoRoom=async function(e){window._liveControlAdminState.videoCallRooms=window._liveControlAdminState.videoCallRooms.filter(t=>t.id!==e),await O(!1),u("Video room deleted"),he()};const ce=30,I={category:null,page:0,query:""};async function de(){const e=document.getElementById("content");if(!e)return;await Za();const t=new Set(Bt()),a=Qa();I.category||(I.category=a[0]?.slug||null);const i=Tt(I.category),s=i?i.count:0,o=I.query.trim().toLowerCase(),r=`
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(f=>`<button onclick="catalogSetCategory('${f.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${I.category===f.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${l(f.name)}</button>`).join("")}
    </div>`,d=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${l(I.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(i)if(o){const f=Math.min(s,8e3);for(let g=0;g<f&&c.length<ce;g++){const v=kt(i.slug,g);if(!v)continue;`${v.property_id} ${v.title} ${v.subcategory||""} ${v.category||""}`.toLowerCase().includes(o)&&c.push(v)}}else{const f=I.page*ce,g=Math.min(f+ce,s);for(let v=f;v<g;v++){const S=kt(i.slug,v);S&&c.push(S)}}const m=c.length?c.map(f=>{const g=t.has(f.property_id),v=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${g?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${l(f.property_id)} · ${l(f.subcategory||f.category||"")} · ${Nt(f.price,"USD")}</p>
            </div>
            ${C(!g)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',h=o?1:Math.max(1,Math.ceil(s/ce)),b=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-500">Page ${I.page+1} / ${h}</span>
        <button onclick="catalogPage(1)" ${I.page>=h-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${r}
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){I.category=e,I.page=0,I.query="",de()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");I.query=e?e.value:"",I.page=0,de()};window.catalogPage=function(e){const t=Tt(I.category),a=t?t.count:0,i=I.query.trim()?1:Math.max(1,Math.ceil(a/ce));I.page=Math.max(0,Math.min(i-1,I.page+e)),de()};window.catalogToggle=async function(e){const t=!Bt().includes(e),a=await Ya(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),de()};window.catalogResetHidden=async function(){await Xa(),u("All hidden catalog listings restored"),de()};async function Pt(){window.lucide&&lucide.createIcons(),Ht(),await vi(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pt):Pt();window.aiChatHistory=[];window.aiProductType="product";async function Fs(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),Gt();const i=document.getElementById("ai-prompt");i&&(i.value=""),u("AI is analyzing...");try{let s=null;a&&(s=await fileToDataUrl(a));const o={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:s,catalog_context:await Us()},n=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(o)})).json();n.success&&n.product?(openListingReviewCard(n.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(n.error||"AI generation failed")}catch(s){u("Error: "+s.message),console.error("[AI] Generate product error:",s)}}async function Us(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&Fs()});
