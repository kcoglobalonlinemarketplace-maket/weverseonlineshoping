import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as qa,S as se}from"./showroom-data-B_6YqRLg.js";import{supabase as g}from"./supabase-client-nvpjTmO6.js";import{C as Gi,g as mt,a as je,A as Vi}from"./localization-m4gKtAlW.js";import{patchLocalShowroomListing as Vt,getLocalShowroomListingById as Re,removeLocalShowroomListing as at,upsertLocalShowroomListing as bt,listLocalShowroomListings as xt}from"./local-showroom-store-mzP0nSoS.js";import{P as Ha,a as Ga,T as Va,M as Wa}from"./motorhome-data-CupbOvk0.js";import{g as Wi}from"./catalog-CWML433J.js";import{i as zi}from"./promo-backgrounds-BZhAn4aI.js";import{i as za,D as Yi}from"./site-content-DxInYU0I.js";import{M as Ki,n as Ji,a as Qi}from"./categories-BEuiwWw5.js";import{l as Xi,v as Zi}from"./video-frames-mPOUp41n.js";import{saveCatalogHidden as qe,loadHiddenCatalogIds as la,getHiddenCatalogIds as _t,resetHiddenCatalogIds as en}from"./catalog-hidden-store-DROVVFIz.js";/* empty css                                       */const B=1,j=5e6,tn=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],an=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Ya=[...tn,...an];function da(e){return Gi[e]||"USD"}function Ka(e,t){return Ya.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function nn(e,t){const a=Math.max(B,Math.min(j,Number(e)||B));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function sn(e,t,a,i,n){const s=nn(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${s}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${s}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${s}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${s}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${s}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${s}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${s}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${s}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${s}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${s}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Ja({templateId:e,listingType:t,category:a,countryCode:i,currency:n,price:s}){const r=Ya.find(p=>p.id===e&&p.listingType===t);if(!r)return null;const l=mt(i)||je[0],o=n||da(l.code),c=[l.name].filter(Boolean).join(", "),u={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${l.name}`:r.label,description:sn(r,l,o,s,c),currency:o,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...u,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...u,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const Qa="kco_payment_settings_v1",rn=[{currency:"USD",currencyName:"United States Dollar",flag:"US",country:"United States",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"70589490002447647",accountType:"Checking",iban:"",swift:"CITIUS33",routing:"031100209",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"111 Wall Street, New York, NY 10043, USA"},{currency:"GBP",currencyName:"British Pound",flag:"GB",country:"United Kingdom",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"56468624",accountType:"",iban:"GB94CITI18500856468624",swift:"CITIGB2L",routing:"",sortCode:"185008",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Canada Square, Canary Wharf, London E14 5LB, United Kingdom"},{currency:"EUR",currencyName:"Euro",flag:"EU",country:"Eurozone",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"",accountType:"",iban:"IE70CITI99005171297018",swift:"CITIIE2X",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"1 North Wall Quay, IFSC, Dublin 1, Ireland"},{currency:"CAD",currencyName:"Canadian Dollar",flag:"CA",country:"Canada",bankName:"Citibank NA Canadian Branch",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"3001440544",accountType:"Checking",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"0328",transitNumber:"20012",bsbCode:"",address:"123 Front St. West, Toronto, ON M5J 2M3, Canada"},{currency:"AUD",currencyName:"Australian Dollar",flag:"AU",country:"Australia",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"10674571",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"248024",address:"2 Park Street, Sydney NSW 2000, Australia"},{currency:"SGD",currencyName:"Singapore Dollar",flag:"SG",country:"Singapore",bankName:"Citibank N.A. Singapore Branch",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"44990709533",accountType:"",iban:"",swift:"CITISGSG",routing:"",sortCode:"",bankCode:"7214",branchCode:"001",institutionNumber:"",transitNumber:"",bsbCode:"",address:"8 Marina View, #17-01 Asia Square Tower 1, Singapore 018960"},{currency:"JPY",currencyName:"Japanese Yen",flag:"JP",country:"Japan",bankName:"MUFG Bank Ltd.",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"4682719",accountType:"Savings / Futsu",iban:"",swift:"",routing:"",sortCode:"",bankCode:"0005",branchCode:"869",institutionNumber:"",transitNumber:"",bsbCode:"",address:"7-1 Marunouchi 2-Chome, Chiyoda-ku, Tokyo, Japan"},{currency:"MXN",currencyName:"Mexican Peso",flag:"MX",country:"Mexico",bankName:"Sistema de Transferencias y Pagos",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"646010504200345127",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"646",branchCode:"010",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Av. Insurgentes Sur 1425, Ciudad de México, México"},{currency:"IDR",currencyName:"Indonesian Rupiah",flag:"ID",country:"Indonesia",bankName:"Deutsche Bank AG Jakarta Branch",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"974400000904",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"0670304",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Jl. Imam Bonjol 80, Jakarta 10310, Indonesia"}];function ca(e){if(!e||e.length!==2)return"🏦";const t=e.toUpperCase().split("").map(a=>127462+a.charCodeAt(0)-65);try{return String.fromCodePoint(...t)}catch{return"🏦"}}function on(){try{const e=localStorage.getItem(Qa);return e?JSON.parse(e):null}catch{return null}}function ln(e){try{localStorage.setItem(Qa,JSON.stringify(e))}catch{}}function gt(e,t=0){const a=e.country_code||e.flag||(e.currency==="EUR"?"EU":"US"),i=e.country||mt(a)?.name||"",n=(e.currency||"USD").toUpperCase();return{id:e.id||`bank-${t+1}`,currency:n,currencyName:e.currencyName||e.currency_name||n,flag:e.flag&&e.flag.length>2?e.flag:ca(a),country:i,country_code:a,bankName:e.bankName||e.bank_name||"",transferType:e.transferType||e.transfer_type||"Bank Transfer",beneficiary:e.beneficiary||e.accountName||e.account_name||"",accountNumber:e.accountNumber||e.account_number||"",accountType:e.accountType||e.account_type||"",iban:e.iban||"",swift:e.swift||"",routing:e.routing||"",sortCode:e.sortCode||e.sort_code||"",bankCode:e.bankCode||e.bank_code||"",branchCode:e.branchCode||e.branch_code||"",institutionNumber:e.institutionNumber||e.institution_number||"",transitNumber:e.transitNumber||e.transit_number||"",bsbCode:e.bsbCode||e.bsb_code||"",address:e.address||""}}function dn(e=[]){return e.map((t,a)=>gt(t,a)).filter(t=>t.currency&&(t.accountNumber||t.iban||t.swift||t.routing||t.sortCode||t.bankCode||t.branchCode||t.institutionNumber||t.transitNumber||t.bsbCode))}function cn(e={}){const t=[];return(e.bank1_account_name||e.bank1_account_number||e.bank1_bank_name)&&t.push(gt({id:"bank-1",currency:e.bank1_currency||"USD",country:e.bank1_country||mt("US")?.name||"United States",country_code:e.bank1_country_code||"US",bank_name:e.bank1_bank_name,transfer_type:e.bank1_transfer_type,account_name:e.bank1_account_name,account_number:e.bank1_account_number,sort_code:e.bank1_sort_code},0)),(e.bank2_account_name||e.bank2_account_number||e.bank2_bank_name)&&t.push(gt({id:"bank-2",currency:e.bank2_currency||"USD",country:e.bank2_country||mt("US")?.name||"United States",country_code:e.bank2_country_code||"US",bank_name:e.bank2_bank_name,transfer_type:e.bank2_transfer_type,account_name:e.bank2_account_name,account_number:e.bank2_account_number,sort_code:e.bank2_sort_code},1)),t}function un(e={}){const t=dn(e.manual_payment_accounts||[]);if(t.length>0)return t;const a=cn(e);return a.length>0?a:rn.map((i,n)=>gt(i,n))}function pn(e={}){return e.manual_payment_instructions||"Transfer the exact order amount to the bank account shown below. After payment, upload your receipt for verification. Once your receipt is verified, your goods will be shipped immediately."}let qt=null;async function mn(){return qt||(qt=qa(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),qt}function bn(e,t){return e.toDataURL("image/jpeg",t)}async function gn(e,t){const a=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,t/Math.max(a.width,a.height))),n=e.getViewport({scale:i}),s=document.createElement("canvas");s.width=Math.max(1,Math.round(n.width)),s.height=Math.max(1,Math.round(n.height));const r=s.getContext("2d",{alpha:!1});return r.fillStyle="#ffffff",r.fillRect(0,0,s.width,s.height),await e.render({canvasContext:r,viewport:n}).promise,bn(s,.78)}async function yn(e,{maxDim:t=1300,maxPages:a=0,onProgress:i=()=>{}}={}){const s=await(await mn()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,r=s.numPages,l=a>0?Math.min(r,a):r,o=[];try{for(let c=1;c<=l;c++){i(c,l);const u=await s.getPage(c);o.push(await gn(u,t))}}finally{try{await s.destroy()}catch{}}return o}function it(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const Xa="weverseonlineshop@gmail.com",Za="Weverse Online Shop",ei="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",fn="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),hn=`${fn}/functions/v1/ai-admin-assistant`,vn=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],wn={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},ti=[...Vi].sort();let I={user:null,section:"dashboard"};function d(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function ai(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function re(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function ke(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function kt(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const xn=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents","language_info"];function ge(e){const t={};if(!e||typeof e!="object")return t;for(const a of xn)a in e&&(t[a]=e[a]);return t}function b(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),n=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const s={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",s[t]||"info"),n.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function Fe(e){return!e||typeof e!="string"||e.startsWith("blob:")||e.startsWith("data:")?!1:/\.(mp4|webm|mov|avi|mkv)(\?|#|$)/i.test(e)}function De(e){return e&&e.type&&e.type.startsWith("video/")}function K(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",d(e)||"â€”"];return`<span class="badge ${a}">${i}</span>`}function oe(){document.getElementById("modal-container").innerHTML=""}function D(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}window.closeModal=oe;window.openModal=D;function W(e,t,a,i,n=""){const s={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function He(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loadingâ€¦</div></div>'}function Ae(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${d(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${d(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function ii(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=vn.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){I.section=e;const t=wn[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),ii(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=He()),window.lucide&&lucide.createIcons(),({dashboard:Rn,products:P,properties:Mt,catalog:Ye,orders:Ci,customers:Cs,reviews:rt,messages:Ii,coupons:Nt,ads:ze,notifications:Ls,ai:_n,"ai-settings":Ni,"homepage-branding":Ft,"promo-bg":tt,content:Us,"content-settings":Fi,seo:zs,email:Ys,analytics:Ws,security:Rt,activity:Ks,brand:Dt,"payment-settings":oa,backup:Js,settings:Qs,publish:Ut}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=Ae("construction","Coming Soon",`${t} is being built.`))}))()};async function _n(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Me="kco_admin_remember",ua="kco_login_attempts",Wt=5,kn=15*60*1e3;function H(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Sn(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function St(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function nt(e){return String(e||"").trim().toLowerCase()}function $n(){try{const e=JSON.parse(localStorage.getItem(Me)||"{}");e?.email&&!nt(e.email)&&localStorage.removeItem(Me)}catch{localStorage.removeItem(Me)}}function Pn(){try{const e=JSON.parse(localStorage.getItem(Me)||"{}");return nt(e?.email)}catch{return""}}function pa(){$n();const e=Pn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Xa,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function En(){return`${window.location.origin}/admin.html`}function Ie(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),St(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function U(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function ni(){try{return JSON.parse(localStorage.getItem(ua)||'{"count":0}')}catch{return{count:0}}}function si(){const e=ni();return e.count=(e.count||0)+1,e.count>=Wt&&(e.lockedUntil=Date.now()+kn),localStorage.setItem(ua,JSON.stringify(e)),e}function ri(){localStorage.removeItem(ua)}function oi(){const e=ni();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(ri(),null):Math.ceil(t/6e4)}async function ce(e,t,a={}){try{await g.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await An(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function An(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function li(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await g.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:nt(e.email)===Xa}async function Cn(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){yt(),Bn();return}const{data:{session:t}}=await g.auth.getSession();if(t?.user&&await li(t.user)){const{data:{currentUser:i}}=await g.auth.getUser(),n=await g.auth.mfa.getAuthenticatorAssuranceLevel(),s=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&s!=="aal2"){I.user=t.user,yt(),Ie("2fa"),ma();return}I.user=t.user,$t();return}In()}function yt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function In(){yt(),Ie("login"),pa(),di(),ci(),ma(),Tn();const e=oi();e&&(H(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Tn(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function di(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Ln),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Ie("forgot")))}async function Ln(e){e.preventDefault();const t=oi();if(t){H(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=nt(a?.value);if(!i){H("Enter your admin email address."),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,s=document.getElementById("remember-me")?.checked;U("login-btn",!0),St();const{data:r,error:l}=await g.auth.signInWithPassword({email:i,password:n});if(l||!r.user){const h=String(l?.message||"").toLowerCase();if(h.includes("missing supabase credentials")||h.includes("authentication service is unavailable")){H("Authentication is temporarily unavailable due to configuration. Please contact support."),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("failed to fetch")||h.includes("network request failed")){H("Network error while signing in. Check your connection and try again."),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("email not confirmed")){H("Your admin email is not confirmed yet. Open your verification email and confirm first."),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=si(),m=Wt-f.count,y=f.lockedUntil?`Account locked for 15 minutes after ${Wt} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;H(y),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await ce(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await li(r.user)){await g.auth.signOut(),H(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ce(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(s?localStorage.setItem(Me,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Me),ri(),I.user=r.user,(await g.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){U("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Ie("2fa"),ma(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ce(r.user.id,"login_success"),U("login-btn",!1),$t()}function ma(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Aa));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&Aa()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await g.auth.signOut(),I.user=null,Ie("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Mn))}async function Aa(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){H("Enter the 6-digit code from your authenticator app.");return}U("verify-2fa-btn",!0),St();try{const{data:t}=await g.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){H("No 2FA factor found. Please re-login."),U("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await g.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:s}=await g.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(s)throw s;await ce(I.user.id,"login_2fa_success"),U("verify-2fa-btn",!1),$t()}catch(t){si(),H(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),U("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Mn(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){H("Enter a backup recovery code.");return}U("verify-backup-btn",!0);try{const{data:t}=await g.from("admin_2fa").select("backup_codes").eq("user_id",I.user.id).maybeSingle();if(!t?.backup_codes?.length){H("No backup codes found."),U("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){H("Backup code not found or already used."),U("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await g.from("admin_2fa").update({backup_codes:i}).eq("user_id",I.user.id),await ce(I.user.id,"login_backup_code_used"),$t()}catch(t){H(t.message),U("verify-backup-btn",!1,"Use Backup Code")}}function ci(){document.getElementById("back-to-login")?.addEventListener("click",()=>Ie("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Nn)}async function Nn(){const e=document.getElementById("reset-email"),t=nt(e?.value);if(!t){H("Enter your admin email address to receive a reset link.");return}U("send-reset-btn",!0),St();const{error:a}=await g.auth.resetPasswordForEmail(t,{redirectTo:En()});if(U("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){H(a.message);return}Sn("Reset link sent! Check your inbox and open it from this device to continue.")}function Bn(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await g.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}b("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function $t(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&I.user&&(t.textContent=I.user.email||"Admin"),pa(),navigate("dashboard")}window.adminSignOut=async function(){I.user&&await ce(I.user.id,"logout"),await g.auth.signOut(),I.user=null,yt(),Ie("login"),pa(),di(),ci()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(I.user&&await ce(I.user.id,"logout_all_devices"),await g.auth.signOut({scope:"global"}),I.user=null,b("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Rn(){const e=document.getElementById("content");try{const[t,a,i,n]=await Promise.all([g.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),g.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),g.from("profiles").select("user_id,created_at",{count:"exact"}),g.from("product_reviews").select("id,is_approved",{count:"exact"})]),s=t.data||[],r=a.data||[],l=r.filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,k)=>v+(parseFloat(k.amount)||0),0),o=r.filter(v=>["pending","pending_verification","processing"].includes(v.status)).length,c=s.filter(v=>v.listing_type!=="property").length,u=s.filter(v=>v.listing_type==="property").length,p=s.filter(v=>v.listing_type!=="property"&&v.is_active).length,h=i.count||0,f=n.count||0,m=(n.data||[]).filter(v=>!v.is_approved).length,y=new Date,_=r.filter(v=>{const k=new Date(v.created_at);return k.getMonth()===y.getMonth()&&k.getFullYear()===y.getFullYear()}).filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,k)=>v+(parseFloat(k.amount)||0),0),w=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${W("Reviews",f,"star","blue",`${m} pending`)}
        </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),gi(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${d(t.message)}</div>`)}}async function P(){const e=document.getElementById("content");try{const{data:t,error:a}=await g.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,n=[];for(const c of a?[]:t||[])c&&c.property_id&&!i.has(c.property_id)&&(i.add(c.property_id),n.push(c));for(const c of xt().filter(u=>u.listing_type!=="property"))c&&c.property_id&&!i.has(c.property_id)&&(i.add(c.property_id),n.push(c));if(Array.isArray(se))for(const c of se.filter(u=>u.listing_type!=="property"&&u.property_id))i.has(c.property_id)||(i.add(c.property_id),n.push(c));const s=[...Ha,...Ga,...Va,...Wa];for(const c of s)c&&c.property_id&&c.listing_type!=="property"&&!i.has(c.property_id)&&(i.add(c.property_id),n.push(c));n.sort((c,u)=>new Date(u.created_at||0)-new Date(c.created_at||0));try{await la()}catch{}const r=new Set(_t());if(r.size)for(let c=n.length-1;c>=0;c--)n[c]&&n[c].property_id&&r.has(n[c].property_id)&&n.splice(c,1);for(let c=n.length-1;c>=0;c--){const u=n[c],p=Number(u&&u.price);Number.isFinite(p)&&p>=1&&p<=100&&n.splice(c,1)}const l=[...new Set(n.map(c=>c.category).filter(Boolean))].sort((c,u)=>c.localeCompare(u)),o=[...new Set(n.flatMap(c=>Array.isArray(c.tags)?c.tags:[]).filter(Boolean))].sort((c,u)=>c.localeCompare(u));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
...
<div class="space-y-4">
  ...
  </article>`}function ui(e,t){const a=[...e],i=n=>new Date(n||0).getTime()||0;return t==="oldest"?a.sort((n,s)=>i(n.created_at)-i(s.created_at)):t==="price-high"?a.sort((n,s)=>we(s.price)-we(n.price)):t==="price-low"?a.sort((n,s)=>we(n.price)-we(s.price)):t==="sales-high"?a.sort((n,s)=>Yt(s)-Yt(n)):t==="views-high"?a.sort((n,s)=>zt(s)-zt(n)):a.sort((n,s)=>i(s.created_at)-i(n.created_at)),a}function pi(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const n=window._productsCardLimit||60,s=e.slice(0,n);t.innerHTML=s.map(Un).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const l=e.length-s.length;l>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function mi(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const n=i.images&&i.images[0]?i.images[0]:"/fallback.svg",s=Pt(i),r=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,o=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!a)return b("Product not found","error");const i=Array.isArray(a.images)?a.images:[];D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form onsubmit="saveQuickEditProduct(event,'${a.property_id}')" class="space-y-4">
          ...
          <div>
            ...
            <div id="image-preview" class="flex flex-wrap gap-2.5 mt-3">
              ${i.map((n,s)=>Se(n,s)).join("")}
            </div>
            <div id="image-url-inputs">${i.map((n,s)=>`<input type="hidden" name="images" id="img-url-${s}" value="${d(n)}">`).join("")}</div>
    ...
    </div>`),Ct(),It(),Ge(),Te(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb")].map(u=>u.dataset.url||(u.querySelector("img")?u.querySelector("img").getAttribute("src"):"")).filter(u=>u&&!String(u).startsWith("blob:")),n={title:a.get("title")||"Untitled Product",price:Math.max(B,Math.min(j,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},s=String(a.get("real_price")||"").trim(),r=s===""?null:parseFloat(s);if(r!=null&&!Number.isFinite(r)){b("Real Price must be a number.","error");return}const l=ge((window._productsData||[]).find(u=>u.property_id===t)),o=l.specifications&&typeof l.specifications=="object"?l.specifications:{};n.specifications={...o,real_price:r!=null&&r>0?Math.round(r):null};const{error:c}=await g.from("showroom_listings").upsert({...l,...n,property_id:t},{onConflict:"property_id"});if(c){if(J(c)){b("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),oe(),P();return}Vt(t,n),b("Quick edit saved locally","info")}else b(n.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");oe(),P()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`,a=(window._productsData||[]).find(o=>o.property_id===e)||(window._propertiesData||[]).find(o=>o.property_id===e)||Re(e),i=a&&String(a.title||"").trim()||"Product on Weverse Online Shop",n=a&&Number(a.price||0)>0?`${i} — ${On(a)}
${t}`:`${i}
${t}`,r=await(async()=>{try{if(navigator.clipboard?.writeText)return await navigator.clipboard.writeText(t),!0}catch{}try{const o=document.createElement("textarea");return o.value=t,o.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(o),o.focus(),o.select(),document.execCommand("copy"),o.remove(),!0}catch{return!1}})();let l=!1;if(navigator.share)try{await navigator.share({title:i,text:n,url:t}),l=!0}catch{}l||b(r?"Product link copied to clipboard":"Product link: "+t)};function On(e){const t=Number(e&&typeof e.price=="object"?e.price.price:e&&e.price)||0,a=e&&e.currency||"USD";let i;try{i=t.toLocaleString("en-US",{style:"currency",currency:a,maximumFractionDigits:0})}catch{i="$"+t.toLocaleString("en-US")}return e&&e.price_period&&(i+="/"+e.price_period),i}window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||Re(e),{error:a}=await g.from("showroom_listings").delete().eq("property_id",e);if(a&&!J(a))return b("Delete failed: "+a.message,"error");at(e);try{const i=await qe(e,!0);i&&i.error&&J(i.error)?b("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):b("Product deleted")}catch{b("Product deleted")}t&&t.listing_type==="property"?Mt():P()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?

This is permanent and cannot be undone. Your Real Estate row, Cars & Trucks row and built-in showroom catalog will stay.`))return;const t=new Set(["Cars","Cars & Vehicles","Trucks","Buses","Buses & Coaches","Motorhomes","Motorcycles","Marine & Boating","RV & Camper Accessories","Vehicles"]);let a=[];try{const{data:i,error:n}=await g.from("showroom_listings").select("property_id, listing_type, category").neq("property_id","__none__");if(n)return J(n)?b("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):b("Clear failed: "+n.message,"error");a=(i||[]).filter(s=>s.listing_type==="product"&&!t.has(s.category)).map(s=>s.property_id).filter(Boolean)}catch(i){return b("Clear failed: "+i.message,"error")}if(a.length)for(let i=0;i<a.length;i+=500){const{error:n}=await g.from("showroom_listings").delete().in("property_id",a.slice(i,i+500));if(n)return J(n)?b("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):b("Clear failed: "+n.message,"error")}try{const i=JSON.parse(localStorage.getItem("kco_local_showroom_listings_v1")||"[]"),n=(Array.isArray(i)?i:[]).filter(s=>s.listing_type&&s.listing_type!=="product"?!0:t.has(s.category));localStorage.setItem("kco_local_showroom_listings_v1",JSON.stringify(n))}catch{}b("All products deleted. Real Estate, Cars & Trucks and your showroom catalog stay."),P()};window.openProductMoreActions=function(e){D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${d(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div class="sm:col-span-2"><label class="lbl">Catalog Template</label><select class="input-field" name="catalog_template_id" id="pf-catalog_template_id" onchange="applyProductCatalogTemplate('${d(e)}')"><option value="">Choose a template...</option>${i.map(s=>`<option value="${s.id}">${d(s.label)} - ${d(s.subcategory||s.category)}</option>`).join("")}</select></div>
...
<input type="file" id="img-upload" class="hidden" multiple accept="image/*,video/mp4,video/webm,video/*,application/pdf" onclick="event.stopPropagation()" onchange="handleImageUpload(event)">
    ...
    </div>`),Ct(),It(),Jt("pf-price"),Jt("pf-real_price"),Qt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Qt(e,"pricing")),Jn(e,t.property_id||""),window._pfEscapeHandler=s=>{s.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),window._productPublishInFlight=!1,te=-1,oe(),P()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[n,s]of i.entries())n==="images"?(a.images=a.images||[],s&&!String(s).startsWith("blob:")&&a.images.push(String(s))):n==="tags"?(a.tags=a.tags||[],a.tags.push(s)):a[n]=s;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function Se(e,t){const a=it(e),i=Fe(e);let n;return a?n='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-300 select-none"><span class="text-2xl leading-none">📄</span><span class="text-[10px] font-bold mt-1">PDF</span></div>':i?n=`<video src="${d(e)}" muted loop preload="metadata" playsinline class="w-full h-full object-cover" onerror="this.style.display='none'"></video>
  ...
  </div>`}function Ct(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Gn(t.dataTransfer.files)}))}function It(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Ge()})}window.handleImageUpload=async function(e){await ba(e.target.files)};async function Gn(e){await ba(e)}async function vi(e,t,a){const i=new Array(e.length);let n=0;const s=Array.from({length:Math.min(Math.max(t,1),e.length)},async()=>{for(;n<e.length;){const r=n++;try{i[r]=await a(e[r],r)}catch{i[r]=null}}});return await Promise.all(s),i}function Vn(e,t,a,i,n=9e4){return new Promise(s=>{let r=!1;const l=setTimeout(()=>{r||(r=!0,s({error:{message:`Upload timed out after ${Math.round(n/1e3)}s — the network is too slow for this file size.`}}))},n);g.storage.from(e).upload(t,a,i).then(o=>{r||(r=!0,clearTimeout(l),s(o))})})}async function Wn(e,t=1920,a=.82){const i=URL.createObjectURL(e);try{const n=new Image;await new Promise((p,h)=>{n.onload=p,n.onerror=h,n.src=i});const s=Math.min(1,t/Math.max(n.width,n.height)),r=Math.max(1,Math.round(n.width*s)),l=Math.max(1,Math.round(n.height*s)),o=document.createElement("canvas");o.width=r,o.height=l,o.getContext("2d").drawImage(n,0,0,r,l);const c=await new Promise(p=>o.toBlob(p,"image/jpeg",a));if(!c||!c.size)return null;const u=(e.name||"photo.jpg").replace(/\.[^.]+$/i,"")+".jpg";return new File([c],u,{type:"image/jpeg"})}catch{return null}finally{URL.revokeObjectURL(i)}}async function ba(e){const t=document.getElementById("image-preview");if(!t)return;const a=[];for(const n of e){const s=n.type==="application/pdf"||it(n.name),r=De(n);if(!(!n.type.startsWith("image/")&&!s&&!r)){if(r&&n.size>100*1024*1024){b("Video must be under 100 MB.","error");continue}a.push(n)}}if(!a.length)return;const i=a.map(()=>{const n=document.createElement("div");return n.className="img-thumb uploading",n.style.cssText="min-width:90px;min-height:80px;",n.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',t.appendChild(n),n});await vi(a,3,async(n,s)=>{const r=i[s],l=await ga(n);setTimeout(()=>{if(!(!r||!r.isConnected)){if(r.remove(),l){const o=document.createElement("div");o.innerHTML=Se(l,s);const c=o.firstElementChild,u=r.nextSibling;u?t.insertBefore(c,u):t.appendChild(c)}else b(`Failed to upload ${De(n)?"video":"image"}. Try a smaller file.`,"error");Ge(),st(),Te(),window.lucide&&lucide.createIcons()}},0)})}async function ga(e){try{const{data:{session:t}}=await g.auth.getSession(),a=String(e.type||"").startsWith("image/"),i=De(e);let n=e;if(a&&e.size>250*1024){const o=await Wn(e);o&&o.size&&(n=o)}const s=n.type==="image/jpeg"?"jpg":(e.name||"photo.jpg").split(".").pop()||"jpg",r=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`,l=i?18e4:9e4;for(let o=0;o<2;o++){const c=`${r}${o?"-"+Math.random().toString(36).slice(2,7):""}.${s}`,{error:u}=await Vn("product-images",c,n,{contentType:n.type||e.type,upsert:!1},l);if(u)console.warn("product-images upload failed (attempt "+(o+1)+"):",u.message||u);else{const{data:p}=g.storage.from("product-images").getPublicUrl(c);if(p&&p.publicUrl)return p.publicUrl}}try{const o=await F._downscaleImage(n,1200);if(o)return o}catch{}return URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}async function zn(){if(!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform()))return null;try{const{Camera:e,MediaTypeSelection:t}=await qa(async()=>{const{Camera:n,MediaTypeSelection:s}=await import("@capacitor/camera");return{Camera:n,MediaTypeSelection:s}},[]),{results:a}=await e.chooseFromGallery({mediaType:t.All,allowMultipleSelection:!0,includeMetadata:!0}),i=[];for(const n of a||[])if(n.webPath)try{const s=n.type===1,r=(n.metadata&&n.metadata.format||(s?"mp4":"jpg")).toLowerCase().replace(/^jpeg$/,"jpg"),l=await fetch(n.webPath).then(o=>o.blob());i.push(new File([l],`gallery-${Date.now()}-${Math.random().toString(36).slice(2)}.${r}`,{type:l.type||(s?"video/mp4":"image/jpeg")}))}catch{}return i}catch(e){return console.warn("Native gallery picker unavailable:",e),null}}window.pickMediaForForm=async function(e){if(!!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())){document.getElementById(e)?.click();return}const a=await zn();!a||!a.length||(e==="s1-img-upload"?await handleStep1Files(a):await ba(a))};window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Ge(),st(),Te()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0],n=i.type==="application/pdf"||it(i.name),s=De(i);if(!i.type.startsWith("image/")&&!n&&!s){b("Please choose an image, video, or PDF file.","error");return}if(s&&i.size>100*1024*1024){b("Video must be under 100 MB.","error");return}const r=await ga(i);if(!r)return;const o=[...a.querySelectorAll(".img-thumb")][e];o&&(o.outerHTML=Se(r,e),Ge(),st(),Te(),b(n?"Document replaced. Save to apply.":s?"Video replaced. Save to apply.":"Image replaced. Save to apply.","info"))};function Ge(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const n=a.dataset.url||(a.querySelector("img")?a.querySelector("img").src:"");if(!n)return;const s=document.createElement("input");s.type="hidden",s.name="images",s.id=`img-url-${i}`,s.value=n,t.appendChild(s),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const o=a.querySelector(".rp-input");o&&(o.id=`rp-input-${i}`,o.onchange=()=>replaceImage(i,o))}))}function st(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0);const i=Fe(t.dataset.url);t.title=a===0?"Cover (main)":(i?"Video ":"Image ")+(a+1)})}function Te(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=[...e.querySelectorAll(".img-thumb")],i=a.length,n=a.filter(r=>Fe(r.dataset.url)).length,s=i-n;if(i===0)t.textContent="No media yet — you can still save and publish anytime";else{const r=[];s>0&&r.push(`${s} image${s>1?"s":""}`),n>0&&r.push(`${n} video${n>1?"s":""}`),t.textContent=`${r.join(" + ")} — you can save and publish anytime`}t.className="text-sm mt-1 font-bold text-gray-400"}function Ne(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Yn(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,n]of t.entries())i==="images"?n&&!String(n).startsWith("blob:")&&a.images.push(String(n)):i==="tags"?a.tags.push(String(n)):a.fields[i]=String(n);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Kn(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([n,s])=>{const r=e.querySelector(`[name="${n}"]`);r&&(r.type==="checkbox"?r.checked=s==="on"||s===!0:r.value=s==null?"":String(s))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(n=>{n.checked=i.includes(n.value)}),Array.isArray(t.images)){const n=document.getElementById("image-preview");n&&(n.innerHTML=t.images.map((s,r)=>Se(s,r)).join(""),Ge(),st(),Te())}return!0}function Zt(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",n=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,s=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,o=I.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",c=[...t.querySelectorAll('input[name="tags"]:checked')].map(h=>h.value),u=document.querySelectorAll("#image-preview .img-thumb").length,p=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,l=e.dataset.category||"Product",o=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",c=e.querySelector('[name="is_active"]')?.checked;D(`
    ...
    </div>`)};function Jn(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Ne(e,t),n=document.getElementById("product-autosave-note");if(!t)try{const o=localStorage.getItem(i);if(o){const c=JSON.parse(o);Kn(a,c)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const s=()=>{try{localStorage.setItem(i,JSON.stringify(Yn(a))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}Zt()};let r;const l=()=>{clearTimeout(r),r=setTimeout(s,500)};a.querySelectorAll("input, textarea, select").forEach(o=>{o.addEventListener("input",l),o.addEventListener("change",l)}),Zt(),Te()}const Qn=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],Xn=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],Zn=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],es=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],ts=["FWD","RWD","AWD","4WD"],wi=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function Ta(e){const t=e.id?`label[for="${e.id}"]`:null,a=t?document.querySelector(t):null;if(a)return a.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function as(e){const t=typeof e=="string"?document.querySelector(e):e;if(!t)return[];const a=new Set,i=[];return t.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const s=String(n.name||"");if(!s||s==="images"||a.has(s)||["hidden","file","submit","button"].includes(n.type))return;if(a.add(s),n.type==="checkbox"){const l=[...t.querySelectorAll(`input[name="${s}"]`)];i.push({key:s,label:Ta(n),type:"checkbox-group",options:l.map(o=>o.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const r=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:s,label:Ta(n),type:r,options:n.tagName==="SELECT"?[...n.options].map(l=>l.value).filter(Boolean):null,required:!!n.required})}),i}function is(e){return!e||!e.length?"":`
...
`)}
`}const ns=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function Gt(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(u=>String(u)):[]),s=[],r=[],l=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(h=>h!=null&&String(h).trim()!=="").join(", "));let p=String(u).replace(/\s+/g," ").trim();return p=p.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),p},o=u=>{const p=l(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),h=parseFloat(p);return Number.isFinite(h)?h:NaN};for(const u of e||[]){if(wi.has(u.key))continue;const p={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const m=Array.isArray(a[u.key])?a[u.key].map(l).filter(Boolean):[],y=u.options&&u.options.length?m.filter(x=>u.options.includes(x)):m;y.length?(a[u.key]=y,p.status="filled",p.value=y.join(", ")):(delete a[u.key],m.length&&(p.status="flagged",p.note="values not in the allowed badge list were dropped",r.push(`${u.label}: invalid selection ignored`))),s.push(p);continue}if(!(a[u.key]!=null&&l(a[u.key])!=="")){p.status=n.has(u.key)?"missing":"empty-ok",s.push(p);continue}if(ns.test(l(a[u.key]))){delete a[u.key],n.add(u.key),p.status="missing",p.note="document/AI said the value is unavailable",s.push(p);continue}if(u.type==="number"){const m=l(a[u.key]),y=o(a[u.key]);if(!Number.isFinite(y)){delete a[u.key],n.add(u.key),p.status="flagged",p.note=`"${m}" is not a valid number`,r.push(`${u.label}: not a valid number`),s.push(p);continue}if(/year/.test(u.key)&&(y<1800||y>new Date().getFullYear()+2)){delete a[u.key],n.add(u.key),p.status="flagged",p.note=`${y} is outside the plausible range`,r.push(`${u.label}: implausible value ${y}`),s.push(p);continue}a[u.key]=y,p.status="filled",p.value=String(y),i.has(u.key)&&(p.status="estimated",p.note="AI estimate â€” confirm"),s.push(p);continue}if(u.type==="select"&&u.options&&u.options.length){const m=xi({options:u.options.map(y=>({value:y}))},l(a[u.key]));if(m==null){p.status="flagged",p.note=`"${l(a[u.key])}" does not match any option â€” left empty`,r.push(`${u.label}: no matching option`),delete a[u.key],n.add(u.key),s.push(p);continue}a[u.key]=m,p.status="filled",p.value=m,m!==l(t?.[u.key])&&(p.note="matched to the closest option"),s.push(p);continue}let f=l(a[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&f.length>120&&!["title"].includes(u.key)&&(p.status="flagged",p.note="unusually long â€” check it landed in the right field",r.push(`${u.label}: suspiciously long value`)),a[u.key]=f,p.status="filled",p.value=f.length>48?f.slice(0,48)+"â€¦":f,i.has(u.key)&&(p.status="estimated",p.note="AI estimate â€” confirm"),s.push(p)}if(e&&e.length){const u=new Set([...e.map(p=>p.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(p=>{u.has(p)||delete a[p]})}a.missing_fields=s.filter(u=>u.status==="missing").map(u=>u.key),a.estimated=s.filter(u=>u.status==="estimated").map(u=>u.key);const c={total:s.length,filled:s.filter(u=>u.status==="filled").length,estimated:s.filter(u=>u.status==="estimated").length,flagged:s.filter(u=>u.status==="flagged").length,missing:s.filter(u=>u.status==="missing").length};return{specs:a,checklist:s,flags:r,summary:c}}function ya(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(s=>s.status!=="empty-ok").map(s=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[s.status]||""}</span><span><b>${d(s.label)}</b> <span class="text-gray-600">(${d(s.key)})</span>${s.value?` â€” <span class="text-gray-300">${d(String(s.value))}</span>`:""}${s.note?` <span class="text-gray-500">${d(s.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){if(ee==="scanner-scan-status"){scanStreamRender();return}const e=document.getElementById(ee);if(!e)return;if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!S.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed — nothing was changed.";return}const t={};for(const a of S){const i=O(a.brand),n=O(a.model),s=O(a.detected_name),r=i&&n?`${i}::${n}`:s||`${i}::${n}`;r&&(t[r]=(t[r]||0)+1)}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
      ...
      ${S.map((a,i)=>{const n=O(a.brand),s=O(a.model),r=O(a.detected_name),l=n&&s?`${n}::${s}`:r||`${n}::${s}`;return ha(a,i,l&&t[l]>1)}).join("")}
    </div>`,window.lucide&&lucide.createIcons()};window.scanReviewContinue=async function(e){const t=S[e];if(!t)return;te=e;const a=Tt(t,ye),i=Ve(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(ee==="s1-scan-status"||ee==="scanner-scan-status")&&(oe(),fe=[]),vs(t,a);return}const s=i.category||t.category||"Other";if(ee==="s1-scan-status"||ee==="scanner-scan-status"){try{localStorage.removeItem(Ne(s,""))}catch{}fe=[];let r=t.property_id?Ce[t.property_id]:null;r&&r.specifications&&typeof r.specifications=="object"&&(r={...r,...r.specifications}),showAddProductStep2(s,r?{...r,images:a}:{images:a}),await et(t,a,s)}else{const r=document.getElementById("product-form"),l=r&&r.dataset.category||"";if(s!==l){try{localStorage.removeItem(Ne(s,""))}catch{}switchProductFormCategory(s);const o=document.getElementById(ee);o&&(o.classList.remove("hidden"),o.classList.add("text-blue-300"),o.textContent=`Category changed to ${s} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await et(t,a,s)}};window.scanReviewEdit=function(e){const t=S[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=Ve(t.category),s=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",r=_e.map(l=>`<option value="${d(l)}" ${l===s?"selected":""}>${d(l)}</option>`).join("");a.innerHTML=`
    ...
    <div class="space-y-3">
      ...
      ${Z.map((a,i)=>{const n=Ve(a[0].category),s=n&&!n.listing_type&&(n.category||a[0].category)||"Other";return`
        <div class="rounded-xl border border-amber-500/25 bg-amber-500/8 p-3 space-y-2">
          <p class="text-[11px] font-bold text-amber-300 uppercase tracking-wide">Group ${i+1}: ${d(a[0].detected_name||"Unknown product")} (${s})</p>
          ${a.map((r,l)=>{const o=pe.indexOf(r);return`
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.dupReviewDelete=async function(e,t,a){const i=Z[e],n=i[t];if(!n)return;const s=n.property_id;if(!confirm(`Permanently delete "${n.detected_name||"this product"}" from the database and showroom?`))return;if(s)try{await g.from("showroom_listings").delete().eq("property_id",s),at(s);try{await qe(s,!0)}catch{}}catch{}i.splice(t,1),i.length<2&&Z.splice(e,1),ue=Z.filter(l=>l.length>1),pe.splice(a,1),Z=[];const r={};for(const l of pe){const o=O(l.brand),c=O(l.model),u=O(l.detected_name),p=o&&c?`${o}::${c}`:u||`${o}::${c}`;p&&(r[p]=r[p]||[]).push(l)}if(Z=Object.values(r).filter(l=>l.length>1),ue=Z,b(`${d(n.detected_name||"Product")} deleted`),!ue.length){dupReviewFinish();return}$i()};window.dupReviewDeleteGroup=async function(e){const t=Z[e];if(!t||!confirm(`Permanently delete ${t.length-1} duplicate listing${t.length-1>1?"s":""} in this group from the database and showroom?`))return;for(let i=t.length-1;i>=1;i--){const n=t[i],s=n.property_id;if(s)try{await g.from("showroom_listings").delete().eq("property_id",s),at(s);try{await qe(s,!0)}catch{}}catch{}const r=pe.indexOf(n);r>=0&&pe.splice(r,1)}b(`Deleted ${t.length-1} duplicate${t.length>2?"s":""} from group ${e+1}`),Z=[];const a={};for(const i of pe){const n=O(i.brand),s=O(i.model),r=O(i.detected_name),l=n&&s?`${n}::${s}`:r||`${n}::${s}`;l&&(a[l]=a[l]||[]).push(i)}if(Z=Object.values(a).filter(i=>i.length>1),ue=Z,!ue.length){dupReviewFinish();return}$i()};window.dupReviewDeleteAll=async function(){const e=ue.reduce((a,i)=>a+i.length-1,0);if(!confirm(`Permanently delete ALL ${e} duplicate listing${e!==1?"s":""} from the database and showroom? This cannot be undone.`))return;let t=0;for(const a of Z)for(let i=a.length-1;i>=1;i--){const n=a[i],s=n.property_id;if(s)try{await g.from("showroom_listings").delete().eq("property_id",s),at(s);try{await qe(s,!0)}catch{}}catch{}const r=pe.indexOf(n);r>=0&&pe.splice(r,1),t++}b(`Deleted ${t} duplicate listing${t!==1?"s":""}`),dupReviewFinish()};window.dupReviewFinish=function(){if(S=pe.slice(),Z=[],ue=[],pe=[],P(),S.length){const e=document.getElementById(ea);e&&(e.classList.remove("hidden","text-red-400","text-amber-300","text-blue-300","text-gray-400"),e.classList.add("text-gray-100"),e.innerHTML=`
        <div class="space-y-3">
          ...
          ${S.map((t,a)=>ha(t,a)).join("")}
        </div>`,window.lucide&&lucide.createIcons())}else{const e=document.getElementById(ea);e&&(e.classList.remove("hidden","text-blue-300","text-amber-300"),e.classList.add("text-gray-400"),e.textContent="All duplicates removed — nothing left to publish."),b("All duplicates removed.","info")}};function Pi(e,t={}){const a=e&&e.identification&&e.identification.identified!==!1?e.identification:{},i=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,s=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,r=[],l=M=>Array.isArray(M)?M.join(", "):String(M??"").trim(),o=(M,q)=>{if(q==null||l([q])==="")return;const me=document.querySelector(`#property-form [name="${M}"]`);me&&(me.value=String(q),r.push(M))},c=a.property_type||i.property_type;if(c){const M=os(c);M&&o("property_type",M)}s&&(o("title",i.title||a.detected_name),o("description",i.description)),o("subcategory",a.subcategory||i.subcategory);const u=a.bedrooms??i.bedrooms;u!=null&&u!==""&&o("bedrooms",parseInt(u,10)||u);const p=a.bathrooms??i.bathrooms;p!=null&&p!==""&&o("bathrooms",parseInt(p,10)||p),o("building_size",a.building_size||i.building_size),o("land_size",a.land_size||i.land_size);const h=a.parking_spaces??i.parking_spaces;h!=null&&h!==""&&o("parking_spaces",parseInt(h,10)||h);const f=String(a.furnished||i.furnished||"").toLowerCase();/furnished|yes/.test(f)?o("furnished","Furnished"):/unfurnished|no|empty/.test(f)&&o("furnished","Unfurnished");const m=String(a.listing_status||i.listing_status||"").toLowerCase();/rent|lease/.test(m)?o("listing_status","rent"):/sale|buy|purchase/.test(m)&&o("listing_status","sale");const y=a.area||i.area;y&&!(a.town||i.town)&&o("town",y),o("town",a.town||i.town),o("city",a.city||i.city),o("state",a.state||i.state);const x=a.country||i.country;if(o("country",x),x){const M=(je||[]).find(q=>String(q.name||"").toLowerCase()===String(x).toLowerCase()||String(q.code||"").toLowerCase()===String(x).toLowerCase());if(M&&M.code){const q=document.querySelector('#property-form [name="country_code"]');q&&(q.value=M.code,r.push("country_code"))}}const _=a.address||i.address;o("product_location",_||[y||a.town||i.town,a.city||i.city,a.state||i.state,x].filter(Boolean).join(", ")),o("address",a.address||i.address),o("zip_code",a.zip_code||i.zip_code);const w=Number(a.latitude??i.latitude),v=Number(a.longitude??i.longitude);Number.isFinite(w)&&w>=-90&&w<=90&&w!==0&&o("latitude",String(w)),Number.isFinite(v)&&v>=-180&&v<=180&&v!==0&&o("longitude",String(v)),o("features_text",l(i.features)),o("highlights_text",l(a.highlights||i.highlights)),o("seo_keywords_text",l(i.seo_keywords));const k=a.half_bathrooms??i.half_bathrooms;k!=null&&k!==""&&o("half_bathrooms",parseInt(k,10)||k);const $=a.floors??i.floors;$!=null&&$!==""&&o("floors",parseInt($,10)||$),o("garage",a.garage||i.garage);const A=a.year_built??i.year_built;A!=null&&A!==""&&o("year_built",parseInt(A,10)||A);const T=a.year_renovated??i.year_renovated;T!=null&&T!==""&&o("year_renovated",parseInt(T,10)||T);const Q=a.condition||i.condition,ae=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(Q){const M=String(Q).toLowerCase(),q=ae.find(me=>M.includes(me.toLowerCase())||me.toLowerCase().includes(M));q&&o("condition",q)}o("interior_features_text",l(i.interior_features)),o("exterior_features_text",l(i.exterior_features)),o("home_systems_text",l(i.home_systems));const ie=l(a.landmarks||i.landmarks);ie&&o("landmarks_text",ie);const X=i.floor_plan;if(X&&typeof X=="object"){X.image&&o("floor_plan_image",X.image),X.levels&&o("floor_plan_levels",X.levels),X.total_area&&o("floor_plan_total_area",X.total_area);const M=Array.isArray(X.rooms)?X.rooms.map(q=>{const me=String(q).match(/^(.*?):\s*(.*)$/);return me?`${me[1].trim()}: ${me[2].trim()}`:String(q)}):[];M.length&&o("floor_plan_rooms",M.join(", "))}const R=i.nearby_area;R&&typeof R=="object"&&(Array.isArray(R.schools)&&R.schools.length&&o("nearby_schools_text",R.schools.join(", ")),Array.isArray(R.hospitals)&&R.hospitals.length&&o("nearby_hospitals_text",R.hospitals.join(", ")),Array.isArray(R.shopping)&&R.shopping.length&&o("nearby_shopping_text",R.shopping.join(", ")),Array.isArray(R.transportation)&&R.transportation.length&&o("nearby_transportation_text",R.transportation.join(", ")),Array.isArray(R.distances)&&R.distances.length&&o("nearby_distances_text",R.distances.join(", ")));const $e=Array.isArray(i.legal_info)?i.legal_info.join(", "):l(i.legal_info);$e&&o("legal_info_text",$e),i.inspection_info&&o("inspection_info",i.inspection_info),i.risk_notes&&o("risk_notes",i.risk_notes),o("neighborhood",a.neighborhood||i.neighborhood||a.area),o("living_areas",l(i.living_areas));const Pe=a.kitchens??i.kitchens;Pe!=null&&Pe!==""&&o("kitchens",parseInt(Pe,10)||Pe);const E=a.balconies??i.balconies;E!=null&&E!==""&&o("balconies",parseInt(E,10)||E),o("garden",a.garden||i.garden),o("pool",a.pool||i.pool),o("security",l(i.security)),o("utilities",l(i.utilities)),o("construction_type",i.construction_type),o("construction_status",i.construction_status),o("ownership_type",i.ownership_type||a.ownership_type),o("contact_name",i.contact_name||a.contact_name),o("contact_phone",i.contact_phone||a.contact_phone),o("contact_email",i.contact_email||a.contact_email);const G=document.querySelector('#property-form [name="verification_status"]');s&&G&&(G.value="Not verified",r.push("verification_status"));const Ot=Number.isFinite(Number(B))?Number(B):0,jt=Number.isFinite(Number(j))?Number(j):999999999,$a=M=>Math.max(Ot,Math.min(jt,Math.round(M))),Ke=n?Number(n.estimated_price):NaN,lt=n?Number(n.suggested_discount_price):NaN;if(s&&Number.isFinite(Ke)&&Ke>0){const M=document.querySelector('#property-form [name="real_price"]');M&&(M.value=String($a(Ke)),r.push("real_price"));const q=Number.isFinite(lt)&&lt>0&&lt<Ke?lt:Ke;o("price",String($a(q)))}const Pa=String(i.title||a.detected_name||"Property").trim()||"Property",Hi=i.description||`${Pa} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,Ea=fa("#property-form",{titleFallback:Pa,descriptionFallback:Hi,visionUsed:s});return Ea&&r.push(`${Ea} auto-completed (safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),fs().catch(()=>{}),{filled:r}}const ds="Not provided - requires verification",Na={address:"Full street address - requires verification",zip_code:"Postal code - requires verification",neighborhood:"Neighborhood - requires verification",product_location:"Local area details - requires verification",garage:"Parking / garage details - requires verification",garden:"Outdoor space details - requires verification",pool:"Pool details - requires verification",security:"Security features - requires verification",utilities:"Utilities details - requires verification",living_areas:"Main living areas - requires verification",construction_type:"Construction material - requires verification",construction_status:"Construction status - requires verification",ownership_type:"Ownership type - requires verification",contact_name:"Listing agent name - requires verification",contact_phone:"Contact phone / WhatsApp - requires verification",contact_email:"Contact email - requires verification",inspection_info:"Inspection details - requires verification",verification_date:"",documents_text:""},cs=new Set(["is_active","property_id","id","documents_text","verification_date","floor_plan_image","landmarks_text","legal_info_text","risk_notes","highlights_text","seo_keywords_text"]);function Ba(e){return Number.isFinite(e)?e<1?`${Math.max(0,Math.round(e*1e3))} m`:`${e.toFixed(1)} km`:"dist. TBD"}async function us(e,t,a=4e3){const i=`
    [out:json][timeout:25];
    (
    ...
    out center tags;`;try{const n=await fetch("https://overpass-api.de/api/interpreter",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:"data="+encodeURIComponent(i)});return n.ok?await n.json()||{elements:[]}:{elements:[]}}catch{return{elements:[]}}}async function ps(e,t,a=4e3){try{const i=await fetch("https://overpass.kumi.systems/api/interpreter",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:"data="+encodeURIComponent(`
        [out:json][timeout:25];
        (
          nwr["amenity"="school"](around:${a},${e},${t});
        ...
        out center tags;`)});return i.ok?await i.json()||{elements:[]}:{elements:[]}}catch{return{elements:[]}}}function ms(e,t,a,i){const s=(a-e)*Math.PI/180,r=(i-t)*Math.PI/180,l=Math.sin(s/2)**2+Math.cos(e*Math.PI/180)*Math.cos(a*Math.PI/180)*Math.sin(r/2)**2;return 2*6371*Math.asin(Math.min(1,Math.sqrt(l)))}function bs(e){const t=e&&e.tags||{};return t.name||t["addr:street"]||t.brand||t.operator||t["ref:housenumber"]||"Nearby location"}async function gs(e,t){let a=await us(e,t);(!a.elements||!a.elements.length)&&(a=await ps(e,t));const i=a&&a.elements||[],n={schools:[],hospitals:[],shopping:[],transportation:[]},s=[];for(const r of i){const l=r.tags||{},o=r.lat??(r.center&&r.center.lat),c=r.lon??(r.center&&r.center.lon);if(!Number.isFinite(o)||!Number.isFinite(c))continue;const u=ms(e,t,o,c),p=String(bs(r)).trim()||"Nearby location",h=`${p} (${Ba(u)})`,f=`${p}: ${Ba(u)}`;if(l.amenity==="school"?(n.schools.push(h),s.push(f)):l.amenity&&/^(hospital|clinic|doctors)$/.test(l.amenity)?(n.hospitals.push(h),s.push(f)):l.shop&&/^(supermarket|mall|convenience|marketplace|department_store)$/.test(l.shop)?(n.shopping.push(h),s.push(f)):(n.transportation.push(h),s.push(f)),n.schools.length+n.hospitals.length+n.shopping.length+n.transportation.length>=14)break}for(const r of Object.keys(n))n[r]=n[r].slice(0,4);return{groups:n,distances:s.slice(0,10)}}function ys(e){if(!e)return 0;let t=0;return e.querySelectorAll("input, textarea, select").forEach(a=>{const i=String(a.name||"").trim();if(!i||_i.has(i)||cs.has(i))return;const n=String(a.type||"").toLowerCase();if(!["hidden","checkbox","radio","file","submit","button","image","password"].includes(n)&&!a.disabled&&String(a.value||"").trim()===""){if(n==="date"){a.value="";return}if(n==="select"){a.options&&a.options.length>2&&(a.value=a.options[0].value||""),t++;return}if(i==="description"){a.value="Full property details to be confirmed by the seller. Review and edit before publishing.",t++;return}if(n==="number"){a.value="0",t++;return}Na[i]!==""&&(a.value=Na[i]||ds,t++)}}),t}async function fs(){const e=document.getElementById("property-form");if(!e)return;const t=f=>String(e.querySelector(`[name="${f}"]`)?.value||"").trim(),a=(f,m)=>{if(m==null||String(m).trim()==="")return;const y=e.querySelector(`[name="${f}"]`);return y&&!String(y.value||"").trim()?(y.value=String(m),!0):!1},i=document.getElementById("scan-ai-prop-status"),n=f=>{i&&(i.classList.remove("hidden"),i.insertAdjacentHTML("beforeend",`<div class="mt-1 text-[11px] text-sky-300">${f}</div>`))};let s=parseFloat(t("latitude")),r=parseFloat(t("longitude")),l="";if(Number.isFinite(s)&&Number.isFinite(r)&&(s||r))await ia(s,r).catch(()=>{}),l="geocoded from AI coordinates";else{const f=[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ");if(f)try{const y=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&countrycodes=&q="+encodeURIComponent(f))).json();y&&y[0]&&(s=parseFloat(y[0].lat),r=parseFloat(y[0].lon),a("latitude",s.toFixed(6)),a("longitude",r.toFixed(6)),l=`mapped to ${y[0].display_name}`,await ia(s,r).catch(()=>{}))}catch{}}const o=parseFloat(t("latitude")),c=parseFloat(t("longitude"));typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm();let u="";if(Number.isFinite(o)&&Number.isFinite(c)&&(o||c)){const{groups:f,distances:m}=await gs(o,c),y=(_,w)=>{if(w&&w.length){const v=e.querySelector(`[name="${_}"]`);v&&!String(v.value||"").trim()&&(v.value=w.join(", "))}};y("nearby_schools_text",f.schools),y("nearby_hospitals_text",f.hospitals),y("nearby_shopping_text",f.shopping),y("nearby_transportation_text",f.transportation),y("nearby_distances_text",m);const x=f.schools.length+f.hospitals.length+f.shopping.length+f.transportation.length;x?u=`Located ${x} real nearby places on the live map.`:u="No schools/hospitals/stores found around this exact point yet - review or adjust the pin."}const p=ys(e);typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm();const h=[];l&&h.push(`📍 ${l}`),u&&h.push(`🗺 ${u}`),p&&h.push(`✅ ${p} blank field${p>1?"s":""} marked “Requires verification” so nothing is empty.`),h.length&&n(h.join(" &nbsp;•&nbsp; "))}const Ra=["brand","model","year","year_estimated","body_type","color","condition","subcategory","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","latitude","longitude","listing_status","neighborhood","living_areas","kitchens","balconies","garden","pool","security","utilities","construction_type","construction_status","ownership_type","contact_name","contact_phone","contact_email","trim","mileage","engine","horsepower","transmission","drive_type","fuel_type","fuel_economy","towing_capacity","seating_capacity","sleeping_capacity","doors","interior","safety_features","driver_assistance","technology","wheels_tires","dimensions","cargo_capacity","ownership_history","service_history","accident_history","previous_owners","registration_status","inspection_status","warranty","vin","location","seller_name","seller_phone","seller_email"];function va(){return Date.now()<(typeof F<"u"&&F._geminiQuotaUntil||0)?'<p class="text-[11px] text-amber-300 mt-1">⚠ Your Gemini key hit its FREE rate limit during this scan — parts were completed from saved details only. Wait ~1 minute and scan again for full AI reading.</p>':""}function We(){try{return localStorage.getItem("weverse_scan_verify")==="on"}catch{return!1}}function hs(e){try{localStorage.setItem("weverse_scan_verify",e?"on":"off")}catch{}}window.scanVerifyPassEnabled=We;window.setScanVerifyPass=hs;async function wa(e){F.beginScanSession();try{const t=await F.preflight(),a=t.gemini,i=t.groq;a&&a.ok&&i&&i.ok?e(`<span class="inline-flex items-center gap-1"><i data-lucide="check-circle-2" class="w-3.5 h-3.5 text-emerald-300"></i> AI ready — Gemini primary + Groq backup verified (${d(a.model||"")}).</span>`,"text-emerald-300"):a&&a.ok?e(`AI ready via Gemini${a.model?` (${d(a.model)})`:""}. Groq backup not available${i&&i.error?": "+d(i.error):"."} Scans continue on Gemini alone.`,"text-emerald-300"):i&&i.ok?e(`Gemini unavailable${a&&a.error?" ("+d(a.error)+")":""} — scans will run on the Groq backup only.`,"text-amber-300"):t.error?e(`AI service unreachable (${d(t.error)}) — results will be filled from saved details only, clearly marked.`,"text-red-400"):e("No working vision provider found. Add a Google Gemini key (primary) and optionally a Groq key (backup) in AI Settings.","text-red-400")}catch{e("AI preflight failed — continuing anyway.","text-amber-300")}}async function Lt({imageUrls:e,identification:t,category:a,formSelector:i,verify:n=We()}){const s=as(i),r=is(s),l=await F.completeSpecsAndPrice(e,t,{category:a||"",maxImages:Ue.maxImages,fieldsSchema:r}),o=l?l.price:null,c=l&&l.specs||{};let u={};for(const w of Ra)t&&t[w]!=null&&t[w]!==""&&(u[w]=t[w]);u={...u,...c};let p=Gt(s,u);const h=`${l&&l.specs&&l.specs._aiProvider||""} ${l&&l.specs&&l.specs._aiModel||""}`,f=!!l&&!/pollinations|free ai|\b(aiofields|fake)\b/i.test(h);let m=0;const y=ss(a,p.specs,t,s);if(f&&y&&Object.keys(y.specs).length){const w={...p.specs,...y.specs},v=new Set([...Array.isArray(p.specs.estimated)?p.specs.estimated:[],...y.estimated||[]]);w.estimated=[...v],p=Gt(s,w),m=(y.estimated||[]).length}let x=!1;const _=`${l&&l.specs&&l.specs._aiProvider||""} ${l&&l.specs&&l.specs._aiModel||""}`;if(n&&f)try{const w=await F.verifyExtraction(e,t,p.specs,s,{maxImages:Ue.maxImages});if(w){const v=w.corrections&&typeof w.corrections=="object"?w.corrections:{},k=Object.keys(v);if(k.length){const $={...p.specs};for(const[A,T]of Object.entries(v))s.some(Q=>Q.key===A)&&(T==null||String(Array.isArray(T)?T.join(", "):T).trim()===""||($[A]=T));for(const[A,T]of Array.isArray(w.wrong_mapping)?w.wrong_mapping:[])$[A]!=null&&($[T]==null||String($[T]).trim()==="")&&($[T]=$[A],delete $[A]);p=Gt(s,$),t={...t};for(const A of k)Ra.includes(A)&&p.specs[A]!=null&&(t[A]=p.specs[A])}x=!0,p.verificationNotes=Array.isArray(w.notes)?w.notes.slice(0,4):[]}}catch{}return{specs:p.specs,price:o,checklist:p.checklist,summary:p.summary,verified:x,verificationNotes:p.verificationNotes||[],identification:t,visionUsed:f,verifyRequested:!!n,providerLabel:_.trim()||"unknown",inferred:m}}async function et(e,t,a){const i=document.getElementById("scan-ai-status"),n=(s,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=s)};try{n("Scanning your photo into the formâ€¦","text-blue-300");let s=e;const r=await Lt({imageUrls:t,identification:s,category:a,formSelector:"#product-form",verify:z?We():!1});s=r.identification||s;const l=rs({identification:s,specs:r.specs,price:r.price,visionUsed:r.visionUsed}),o=[s.year,s.brand,s.model].filter(Boolean).join(" ")||s.detected_name||"the product";let c=`<span class="inline-flex items-center gap-1"><i data-lucide="check-circle-2" class="w-3.5 h-3.5 text-emerald-300"></i></span> ${d(o)} — ${l.filled.length} field${l.filled.length>1?"s":""} filled.`;r.visionUsed||(c+=' <span class="text-red-300">(Photo not read — values from saved details. Re-scan when the key is available.)</span>'),r.summary&&r.summary.flagged&&(c+=` Review ${r.summary.flagged} flagged value${r.summary.flagged>1?"s":""}.`),r.inferred&&(c+=` <span class="text-amber-300/80">(${r.inferred} values inferred from the model's real specs - review)</span>`),c+=z?" Publishing automatically now.":" Your uploaded photo stays attached. Press SAVE / UPDATE to publish.",n(c,"text-emerald-300"),b(z?`Filled for ${o} — publishing automatically.`:`Form filled for ${o} — review and press SAVE / UPDATE.`,"success")}catch(s){const r=String(s?.message||s),l=/key|api|configured|settings|vision/i.test(r);n(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),b("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){b("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(o=>o.value).filter(Boolean);if(!i.length){b("Upload at least one product image before scanning.","error");return}const n=t?t.innerHTML:"",s=(o,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=o)};try{F.beginScanSession()}catch{}s("Scanning your photo and filling the formâ€¦","text-blue-300"),t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),a&&a.classList.remove("hidden");let r;try{r=await F.detectProducts(i,{category:e.dataset.category||"",maxImages:Ue.maxImages})}catch(o){const c=String(o?.message||o),u=/key|api|configured|settings|vision/i.test(c);s(u?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),b("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}let l=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];l.length||(l=[{detected_name:"Product from your photos",category:e.dataset.category||"Other",listing_type:"product",confidence:"low",image_indices:i.map((o,c)=>c)}],s("Photo read partially — the form was filled with the best available details. Review, then press Publish.","text-amber-300"));try{await et(l[0],i,l[0].category||e.dataset.category||"Other")}finally{t&&(t.disabled=!1,t.innerHTML=n)}};function vs(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((r,l)=>Se(r,l)).join(""),i.innerHTML=t.map((r,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${d(r)}">`).join(""),st(),Te());const n=document.getElementById("scan-ai-prop-status"),s=(r,l)=>{n&&(n.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&n.classList.add(l),n.innerHTML=r)};s("Reading every page, completing property details and valueâ€¦","text-blue-300"),(async()=>{try{const r=await Lt({imageUrls:t,identification:e,category:"Real Estate",formSelector:"#property-form"}),l=r.identification||e,o=Pi({identification:l,specs:r.specs,price:r.price,visionUsed:r.visionUsed});let c;r.price?c=`${d(l.detected_name||"Property")} â€” ${o.filled.length} field${o.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`:c=`${d(l.detected_name||"Property")} â€” ${o.filled.length} fields ready. Price estimate skipped â€” set the price manually, then press Publish Property.`,r.visionUsed?r.verifyRequested&&(c+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>'):c+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photo was NOT read by AI (${d(r.providerLabel||"text fallback")}) — these values did NOT come from your images.</p>`,c+=r.inferred?` <span class="text-amber-300/80">(${r.inferred} values inferred from the model's real specs/type - review them)</span>`:"",c+=va(),c+=ya(r.checklist,r.summary),s(c,r.price?"text-emerald-300":"text-amber-300"),b("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}catch(r){const l=/key|api|configured|settings|vision/i.test(String(r?.message||r));s(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),b("AI scan failed.","error")}})()}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){b("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(l=>l.value).filter(Boolean);if(!i.length){b("Upload at least one property image before scanning.","error");return}const n=t?t.innerHTML:"",s=(l,o)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),o&&a.classList.add(o),a.innerHTML=l)};await wa(s),t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),s("Identifying this property from your imagesâ€¦","text-blue-300");let r;try{r=await F.identifyProduct(i,{category:"Real Estate",maxImages:Ue.maxImages})}catch(l){const o=String(l?.message||l),c=/key|api|configured|settings|vision/i.test(o);s(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${o}`,"text-red-400"),b("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}if(!r||r.identified===!1){s(r&&r.reason?`Could not identify the property: ${d(r.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),b("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);try{s("Reading every page, completing property details and market valueâ€¦","text-blue-300");const l=await Lt({imageUrls:i,identification:r,category:"Real Estate",formSelector:"#property-form"}),o=l.identification||r,c=Pi({identification:o,specs:l.specs,price:l.price,visionUsed:l.visionUsed});let u=`${d(o.detected_name||"Property")} â€” ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`;l.visionUsed?l.verifyRequested&&(u+=l.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>'):u+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photo was NOT read by AI (${d(l.providerLabel||"text fallback")}) — these values did NOT come from your images.</p>`,u+=l.inferred?` <span class="text-amber-300/80">(${l.inferred} values inferred from the model's real specs/type - review them)</span>`:"",u+=va(),u+=ya(l.checklist,l.summary),s(u,"text-emerald-300"),b("Review the property details, then press Publish Property.","success")}catch(l){const o=String(l?.message||l),c=/key|api|configured|settings|vision/i.test(o);s(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${o}`,"text-red-400"),b("AI scan failed.","error")}window.lucide&&lucide.createIcons()};function ws(e,t={}){const a=e&&e.identification&&e.identification.identified!==!1?e.identification:{},i=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,s=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,r=[],l=p=>Array.isArray(p)?p.join(", "):String(p??"").trim(),o=(p,h)=>{if(h==null||l(h)==="")return;const f=document.querySelector(`#vehicle-form [name="${p}"]`);if(f){if(f.tagName==="SELECT"){const y=l(h).toLowerCase(),x=[...f.options].filter(v=>v.value&&v.value.trim()!==""),_=/^not |no |none of|without /.test(y),w=x.find(v=>v.value.toLowerCase()===y)||(_?null:x.find(v=>v.value.toLowerCase().startsWith(y)))||x.find(v=>y.startsWith(v.value.toLowerCase()))||x.find(v=>v.value.toLowerCase().includes(y))||x.find(v=>y.includes(v.value.toLowerCase())&&v.value.length>1);w&&(f.value=w.value,r.push(p));return}f.value=Array.isArray(h)?h.join(", "):String(h),r.push(p)}};o("make",a.brand||i.brand||a.make||i.make),o("model",a.model||i.model),o("model_year",a.year||i.model_year||i.year),o("trim",i.trim),o("body_type",a.body_type||i.body_type),o("mileage",i.mileage),o("engine",i.engine),o("horsepower",i.horsepower),o("transmission",i.transmission),o("fuel_type",i.fuel_type),o("drive_type",i.drive_type),o("fuel_economy",i.fuel_economy),o("towing_capacity",i.towing_capacity),o("seating_capacity",i.seating_capacity),o("sleeping_capacity",i.sleeping_capacity),o("doors",i.doors),o("color",a.color||i.color),o("condition",a.condition||i.condition),o("vin",i.vin),o("warranty",i.warranty),o("location",i.location),o("seller_name",i.seller_name),o("seller_phone",i.seller_phone),o("seller_email",i.seller_email),o("safety_features",i.safety_features),o("driver_assistance",i.driver_assistance),o("technology",i.technology),o("interior",i.interior),o("wheels_tires",i.wheels_tires),o("dimensions",i.dimensions),o("cargo_capacity",i.cargo_capacity),o("ownership_history",i.ownership_history),o("service_history",i.service_history),o("accident_history",i.accident_history),o("previous_owners",i.previous_owners),o("registration_status",i.registration_status),o("inspection_status",i.inspection_status),o("features_text",i.features);const c=document.querySelector('#vehicle-form [name="title"]'),u=[i.model_year||a.year,a.brand||i.brand,a.model||i.model,a.body_type||i.body_type].filter(Boolean).join(" ")||String(i.title||a.detected_name||"Vehicle");if(s){c.value.trim()||(c.value=u,r.push("title")),o("title",i.title||a.detected_name||u);const p=document.querySelector('#vehicle-form [name="description"]');p.value.trim()||(p.value=i.description||`${u} — now available on Weverse Online Shop. Review the details below and edit anything before publishing.`,r.push("description"));const h=Number.isFinite(Number(B))?Number(B):0,f=Number.isFinite(Number(j))?Number(j):999999999,m=w=>Math.max(h,Math.min(f,Math.round(w))),y=n?Number(n.estimated_price):NaN,x=n?Number(n.suggested_discount_price):NaN;if(Number.isFinite(y)&&y>0){const w=document.querySelector('#vehicle-form [name="real_price"]');w&&(w.value=String(m(y)),r.push("real_price"));const v=Number.isFinite(x)&&x>0&&x<y?x:y,k=document.querySelector('#vehicle-form [name="price"]');k&&!Number(k.value)&&(k.value=String(m(v)),r.push("price"))}const _=fa("#vehicle-form",{titleFallback:u,descriptionFallback:i.description||`${u} — now available on Weverse Online Shop. Review the details below and edit anything before publishing.`,visionUsed:!0});_&&r.push(`${_} auto-filled (safe defaults)`)}return{filled:r}}window.scanVehicleWithAI=async function(){if(!document.getElementById("vehicle-form")){b("Open the vehicle form first.","error");return}const t=document.getElementById("btn-scan-ai-veh"),a=document.getElementById("scan-ai-veh-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(l=>l.value).filter(Boolean);if(!i.length){b("Upload at least one vehicle photo before scanning.","error");return}const n=t?t.innerHTML:"",s=(l,o)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),o&&a.classList.add(o),a.innerHTML=l)};await wa(s),t&&(t.disabled=!0,t.innerHTML="Scanning…"),s("Identifying this vehicle from your photos…","text-blue-300");let r;try{r=await F.identifyProduct(i,{category:"Cars & Trucks",maxImages:Ue.maxImages})}catch(l){const o=String(l?.message||l),c=/key|api|configured|settings|vision/i.test(o);s(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${o}`,"text-red-400"),b("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}if(!r||r.identified===!1){s(r&&r.reason?`The AI could not read this vehicle: ${d(r.reason)}`:"The vehicle could not be read from these images. Use clear photos that show the whole vehicle, badges, dashboard and wheels, then try again.","text-amber-300"),b("The vehicle could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);try{s("Reading every photo, completing the vehicle specs and market value…","text-blue-300");const l=await Lt({imageUrls:i,identification:r,category:"Cars & Trucks",formSelector:"#vehicle-form"}),o=l.identification||r,c=ws({identification:o,specs:l.specs,price:l.price,visionUsed:l.visionUsed});let u=`${d(o.detected_name||"Vehicle")} — ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Vehicle.`;l.visionUsed?l.verifyRequested&&(u+=l.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your photos.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>'):u+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photos were NOT read by AI (${d(l.providerLabel||"text fallback")}) — these values did NOT come from your images.</p>`,u+=l.inferred?` <span class="text-amber-300/80">(${l.inferred} values inferred from the model's real specs/type - review them)</span>`:"",u+=va(),u+=ya(l.checklist,l.summary),s(u,"text-emerald-300"),b("Review the vehicle details, then press Publish Vehicle.","success")}catch(l){const o=String(l?.message||l),c=/key|api|configured|settings|vision/i.test(o);s(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${o}`,"text-red-400"),b("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let fe=[];window.handleStep1Files=async function(e){const t=Array.from(e||[]).slice(0,24);if(!t.length)return;const a=document.getElementById("s1-image-preview"),i=[],n=[];for(const s of t){const r=s.type==="application/pdf"||it(s.name),l=De(s);if(!s.type.startsWith("image/")&&!r&&!l)continue;if(l&&s.size>100*1024*1024){b("Video must be under 100 MB.","error");continue}i.push(s);const o=document.createElement("div");o.className="img-thumb uploading",o.style.cssText="min-width:90px;min-height:80px;",o.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',a&&a.appendChild(o),n.push(o)}i.length&&(ta(),await vi(i,3,async(s,r)=>{const l=await ga(s),o=n[r];setTimeout(()=>{if(!(!o||!o.isConnected)){if(o.remove(),l){fe.push(l);const c=document.createElement("div");c.innerHTML=Ei(l,fe.length-1);const u=c.firstElementChild,p=o.nextSibling;p?a.insertBefore(u,p):a.appendChild(u)}else b(`Failed to upload ${De(s)?"video":"image"}. Try a smaller file.`,"error");ta(),window.lucide&&lucide.createIcons()}},0)}))};window.handleStep1ImageUpload=async function(e){await window.handleStep1Files(e.target.files||[]),e.target.value=""};window.removeStep1Image=function(e){fe.splice(e,1),xs()};function Ei(e,t){const i=Fe(e)?`<video src="${d(e)}" muted loop preload="metadata" playsinline class="w-full h-full object-cover"></video>
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function Qe(e,t){const a=Tt(e,ye),i=Ve(e.category),n=e.listing_type==="property"||i&&i.listing_type==="property",s=n?"Real Estate":i.category||e.category||"Other",r=ki,l=r-S.length;((c,u)=>{const p=document.getElementById("scanner-scan-status");p&&(p.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),p.classList.add(u),p.innerHTML=c)})(`Processing ${l+1} of ${r}: ${d(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){Y++,S.splice(t,1),S.length?Qe(S[0],0):window.returnToScanReviewAfterSave(-1);return}let c=e.property_id?Ce[e.property_id]:null;c&&c.specifications&&typeof c.specifications=="object"&&(c={...c,...c.specifications}),showAddProductStep2(s,c?{...c,images:a}:{images:a}),await new Promise(h=>setTimeout(h,250)),await et(e,a,s);const p=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");p?(te=t,p.click()):(Y++,closeProductFormModal(),S.splice(t,1),S.length?Qe(S[0],0):window.returnToScanReviewAfterSave(-1))}catch{Y++,closeProductFormModal(),S.splice(t,1),S.length?Qe(S[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(e=!1){ve=!!e;const t=await Ai();D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons(),window.scanGeneralWithAI()};function ks(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){if(Ee||z){b("A scan is already running - wait for it to finish before starting another.","info");return}let e=[];try{e=await ks(Ai(),15e3)}catch{e=[]}if(!e.length){b(ve?"No products are missing a price right now — every product already has one.":"No products with photos are in the Product Manager yet — add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status");t&&t.innerHTML;const i=(s,r)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),a.classList.add(r),a.innerHTML=s)};try{const s=await F.getConfig();String(s.gemini_key||s.gemini_api_key||"").trim()||i("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),i(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300"),z=!0,ki=e.length,he=0,Y=0,Ee=!1,S=[],ye=[],Ce={},ee="scanner-scan-status";let n=0;for(const s of e){const r=(s.images||[]).filter(Boolean),l=[];for(const o of r)ye.push(o),l.push(n),n++;Ce[s.property_id]=s,S.push({detected_name:s.title||s.property_id||"Product",category:s.category||"Other",listing_type:s.listing_type||"product",brand:s.brand||null,model:s.specifications&&s.specifications.model||s.model||null,confidence:"medium",property_id:s.property_id,image_indices:l})}Qe(S[0],0)};window.scanStreamRender=function(){const e=document.getElementById("scanner-scan-status");if(!e)return;e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),e.classList.add("text-gray-100");const t=Ee,a=Ma,i=Math.min(ls,Ma),n=Si,s=S.length,r={};for(const c of S){const u=O(c.brand),p=O(c.model),h=O(c.detected_name),f=u&&p?`${u}::${p}`:h||`${u}::${p}`;f&&(r[f]=(r[f]||0)+1)}let o=`<div class="space-y-3">${t?`<p class="text-xs font-bold text-white flex items-center gap-2"><i data-lucide="loader-2" class="w-4 h-4 animate-spin text-violet-400"></i> Scanning ${i} of ${a} — results appear below as each product is scanned.</p>`:`<p class="text-xs font-bold text-white flex items-center gap-2"><i data-lucide="list-checks" class="w-4 h-4 text-violet-400"></i> ${i} product${i===1?"":"s"} processed${n?`, ${n} published`:""}${Be?`, ${Be} error${Be>1?"s":""}`:""}.</p>`}`;s?(o+='<p class="text-[11px] text-gray-400">Each card below can be published with one click — press Publish Now and the scanner keeps working on the rest in the background.</p>',o+=S.map((c,u)=>{const p=O(c.brand),h=O(c.model),f=O(c.detected_name),m=p&&h?`${p}::${h}`:f||`${p}::${h}`;return ha(c,u,m&&r[m]>1,!0)}).join("")):t?o+='<p class="text-[11px] text-gray-500">Waiting for the first product to finish scanning …</p>':o+='<p class="text-[11px] text-gray-500">Nothing to scan yet.</p>',o+="</div>",e.innerHTML=o,window.lucide&&lucide.createIcons()};window.scanStreamPublish=async function(e){const t=S[e];if(!t)return;te=e;const a=Tt(t,ye),i=Ve(t.category),n=t.listing_type==="property"||i&&i.listing_type==="property",s=n?"Real Estate":i.category||t.category||"Other";try{if(n){Be++,S.splice(e,1),scanStreamRender();return}let r=t.property_id?Ce[t.property_id]:null;r&&r.specifications&&typeof r.specifications=="object"&&(r={...r,...r.specifications}),showAddProductStep2(s,r?{...r,images:a}:{images:a}),await new Promise(c=>setTimeout(c,250)),await et(t,a,s);const l=document.getElementById("product-form"),o=l?l.querySelector("[type=submit][name=action][value=publish]"):null;o?(te=e,o.click()):(Be++,closeProductFormModal(),S.splice(e,1),scanStreamRender())}catch(r){Be++,closeProductFormModal(),S.splice(e,1),scanStreamRender(),b("Could not publish this product: "+String(r&&r.message||r),"error")}};function ct(e){ee="scanner-scan-status",D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> ${ve?"AI Price Scanner":"General AI Scanner"}</h3>
    ...
    </div>`),scanStreamRender(),window.lucide&&lucide.createIcons()}window.openStreamReviewModal=ct;window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),s=a?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const l=document.createElement("style");l.id="_pubspin-style",l.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(l)}}catch{}const r=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=s)};try{const l=new FormData(i),o={};let c=0;for(const[m,y]of l.entries())if(m==="images"){o.images=o.images||[];const x=String(y);y&&!x.startsWith("blob:")?o.images.push(x):x.startsWith("blob:")&&c++}else m==="tags"?(o.tags=o.tags||[],o.tags.push(y)):o[m]=y;if(c&&!(o.images||[]).length){r(),b("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}o.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",o.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const u=l.get("action")==="draft",p=m=>Kt(m),h=m=>{const y=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],x={};for(const _ of y){const w=m[_];if(_==="real_price"){const v=w!=null&&String(w).trim()!==""?parseFloat(w):null;x[_]=v!=null&&Number.isFinite(v)&&v>0?Math.round(v):null;continue}x[_]=w!=null&&String(w).trim()!==""?w:null}if(m.safety_features){const _=p(m.safety_features);x.safety_features=_.length?_:null}return x};if(a){let m=null;try{const{data:E}=await g.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();E&&(m=ge(E))}catch{}if(m||(m=ge((window._productsData||[]).find(E=>E.property_id===a))),m||(m=ge(Re?Re(a):null)),!m)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const y=(E,G)=>{const Ot=E===""||E==null?"":E,jt=G===""||G==null?"":G;return String(Ot).trim()===String(jt).trim()},x={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(E=>{y(o[E],m[E])||(x[E]=o[E]==null||o[E]===""?null:o[E])});const _=o.price===""||o.price==null?null:parseFloat(o.price);y(_,m.price)||(x.price=_==null?m.price:Math.max(B,Math.min(j,_)));const w=o.stock_quantity===""||o.stock_quantity==null?null:parseInt(o.stock_quantity,10);y(w,m.stock_quantity)||(x.stock_quantity=Number.isFinite(w)?w:null);const v=p(o.features_text);y(v.join("||"),(Array.isArray(m.features)?m.features:[]).join("||"))||(x.features=v);const k=o.tags||[];y(k.join("||"),(Array.isArray(m.tags)?m.tags:[]).join("||"))||(x.tags=k);const $=p(o.highlights_text);y($.join("||"),(Array.isArray(m.highlights)?m.highlights:[]).join("||"))||(x.highlights=$);const A=p(o.seo_keywords_text);y(A.join("||"),(Array.isArray(m.seo_keywords)?m.seo_keywords:[]).join("||"))||(x.seo_keywords=A);const T=o.images||[];y(T.join("||"),(Array.isArray(m.images)?m.images:[]).join("||"))||(x.images=T);const Q=T.find(E=>typeof E=="string"&&Fe(E))||null;y(Q,m.video_url)||(x.video_url=Q);const ae=o.is_featured==="on";!!m.is_featured!==ae&&(x.is_featured=ae);const ie=u?!1:o.is_active==="on";!!m.is_active!==ie&&(x.is_active=ie);const X=h(o),R={...m.specifications&&typeof m.specifications=="object"?m.specifications:{},...X};if(JSON.stringify(R)!==JSON.stringify(m.specifications||{})&&(x.specifications=R),Object.keys(x).length===0){if(z){r();try{localStorage.removeItem(Ne(t,a))}catch{}const E=te;closeProductFormModal(),P(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(E)&&P();return}b("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(Ne(t,a))}catch{}b("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),P();return}const $e={...m,...x,property_id:a,updated_at:new Date().toISOString()};delete $e.id;const Pe=await Ca($e);if(Pe.error){if(z){Y++,r();const G=te;closeProductFormModal(),P(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(G)&&P();return}r();const E=Ht(Pe.error,u?"Draft save":"Product publish");b(E,"error");try{let G=i.querySelector(".__publish-error-banner");G||(G=document.createElement("div"),G.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(G)),G.textContent=E}catch{}return}try{bt($e)}catch{}try{const E=(window._productsData||[]).findIndex(G=>G.property_id===a);E>=0&&(window._productsData[E]=$e)}catch{}b(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(x).length} change${Object.keys(x).length>1?"s":""}).`)}else{if(!o.title||!o.title.trim())throw new Error("A product title is required.");if(o.price===""||o.price==null||!isFinite(parseFloat(o.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!o.condition)throw new Error("Please choose the product condition.");const y={listing_type:"product",category:t,subcategory:o.subcategory||null,title:o.title.trim(),description:o.description||"",price:Math.max(B,Math.min(j,parseFloat(o.price)||0)),currency:o.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:o.is_active==="on",is_featured:o.is_featured==="on",brand:o.brand||null,color:o.color||null,size:o.size||null,condition:o.condition||null,warranty:o.warranty||null,availability_status:o.availability_status||"In Stock",stock_quantity:o.stock_quantity?parseInt(o.stock_quantity):null,images:o.images||[],video_url:(o.images||[]).find(w=>typeof w=="string"&&Fe(w))||null,features:p(o.features_text).length?p(o.features_text):o.tags||[],tags:o.tags||[],highlights:p(o.highlights_text),seo_keywords:p(o.seo_keywords_text),is_ai_generated:!!o.catalog_template_id,ai_generated_fields:o.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:h(o)},x=kt();y.property_id=x;const _=await Ca(y);if(_.error){if(z){Y++,r();const v=te;closeProductFormModal(),P(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(v)&&P();return}r();const w=Ht(_.error,"Product publish");b(w,"error");try{let v=i.querySelector(".__publish-error-banner");v||(v=document.createElement("div"),v.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(v)),v.textContent=w}catch{}return}try{bt({...y,property_id:y.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...y})}catch{}b(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}z&&he++,r();try{localStorage.removeItem(Ne(t,a))}catch{}const f=te;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(f)){P();return}P()}catch(l){const o=l&&l.message&&!/failed to fetch|networkerror/i.test(String(l.message))?l.message:Ht(l,"Product publish");if(z&&Y++,r(),z){const c=te;closeProductFormModal(),P(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(c)&&P();return}b(o,"error")}};window.editProduct=async function(e){const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Re(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return b("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){let a=null;try{const{data:n}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(a=ge(n))}catch{}if(a||(a=ge((window._productsData||[]).find(n=>n.property_id===e))),!a||!a.property_id){Vt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),b(t?"Product published locally":"Product unpublished locally","info"),P();return}delete a.id,a.property_id=e,a.is_active=t,a.availability_status=t?"In Stock":"Out of Stock";const{error:i}=await g.from("showroom_listings").upsert(a,{onConflict:"property_id"});if(i){if(J(i))return b(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Vt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),b(t?"Product published locally":"Product unpublished locally","info"),P();return}b(t?"Product published":"Product unpublished"),P()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:s,updated_at:r,...l}=a,o=kt();await g.from("showroom_listings").insert({...l,property_id:o,title:a.title+" (Copy)",is_active:!1}),t||(b("Product duplicated"),P())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await g.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),b("Product archived"),P())};const aa=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Mt(){const e=document.getElementById("content");try{const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?xt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(se)){const s=new Set(i.map(l=>l.property_id)),r=se.filter(l=>l.listing_type==="property"&&l.property_id&&!s.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((s,r)=>new Date(r.created_at||0)-new Date(s.created_at||0));try{await la()}catch{}const n=new Set(_t());i=i.filter(s=>!(s&&s.property_id&&n.has(s.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
                ${aa.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
              </select></div>
    ...
    </div>`),Ct(),It(),Jt("ppf-price"),window._propFormDirty=!!t;const s=document.getElementById("property-form");if(s){const r=()=>{window._propFormDirty=!0};s.addEventListener("input",r),s.addEventListener("change",r)}window.syncPropertyCountry=function(){Ia("ppf")},Ia("ppf"),Xt("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Xt("pricing")),$s()};let ne=null,ut=null,Fa=null;function Ss(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function be(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Xe(e,t,{reverse:a=!1}={}){if(!ne||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];ut?ut.setLatLng(i):ut=L.marker(i,{draggable:!0}).addTo(ne),ne.setView(i,Math.max(ne.getZoom(),13));const n=document.querySelector('#property-form [name="latitude"]'),s=document.querySelector('#property-form [name="longitude"]');n&&(n.value=String(Number(e.toFixed(6)))),s&&(s.value=String(Number(t.toFixed(6)))),a&&ia(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Je(){const e=Ss();if(!e){be("Enter a location (address, area, city, state, country), then press Locate from fields.");return}be("Searching locationâ€¦");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Xe(parseFloat(a[0].lat),parseFloat(a[0].lon)),be("Located: "+a[0].display_name)):be("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{be("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function ia(e,t){const a=document.querySelector("#property-form");if(a)try{const n=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),s=n&&n.address||{},r=(f,m)=>{if(!m)return;const y=a.querySelector(`[name="${f}"]`);return y&&!String(y.value||"").trim()?(y.value=m,!0):!1},l=[s.road||"",s.house_number||""].filter(Boolean).join(" "),o=s.suburb||s.neighbourhood||s.quarter||s.district||s.borough||"",c=s.town||s.village||s.municipality||s.city_district||"",u=s.city||s.county||"",p=s.state||s.region||"",h=s.country||"";if(r("product_location",l||o||c),r("town",o||c),r("city",u),r("state",p),h){r("country",h);const f=a.querySelector('[name="country_code"]');if(f){const m=(je||[]).find(y=>String(y.name||"").toLowerCase()===String(h).toLowerCase());m&&m.code&&!f.value&&(f.value=m.code)}}be("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(n.display_name?" â€” "+n.display_name:""))}catch{be("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!ne)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Xe(e,t),be("Map updated from coordinates.")):Je()};function $s(){const e=document.getElementById("property-map-preview");if(!e||!window.L){be("Map unavailable right now â€” your location fields still save normally.");return}ne&&(ne.remove(),ne=null,ut=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);ne=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(ne),ne.on("click",n=>Xe(n.latlng.lat,n.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Je),["product_location","town","city","state","country","latitude","longitude"].forEach(n=>{const s=document.querySelector(`#property-form [name="${n}"]`);s&&(s.addEventListener("input",()=>{if(n==="latitude"||n==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(l)&&(r||l)&&Xe(r,l);return}clearTimeout(Fa),Fa=setTimeout(Je,900)}),s.addEventListener("change",()=>{n!=="latitude"&&n!=="longitude"&&Je()}))}),i?Xe(t,a):Je()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(n=>{const s=parseFloat(n.latitude),r=parseFloat(n.longitude),l=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");return!(Number.isFinite(s)&&Number.isFinite(r)&&(s!==0||r!==0))&&!!l});if(!t.length){b("All properties already have map coordinates.","success");return}b(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}â€¦`,"success");let a=0,i=0;for(const n of t){const s=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");try{const l=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(s))).json();if(l&&l[0]){const o={latitude:parseFloat(l[0].lat),longitude:parseFloat(l[0].lon)},{error:c}=await g.from("showroom_listings").update(o).eq("property_id",n.property_id);c?i++:(Object.assign(n,o),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}b(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),Mt()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n=a.getAll("images").filter(m=>m&&!m.startsWith("blob:")),s=(i.features_text||"").split(",").map(m=>m.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(B,Math.min(j,parseFloat(i.real_price)||0)),l=m=>(m||"").split(",").map(y=>y.trim()).filter(Boolean),o=m=>m===""||m==null||!isFinite(parseInt(m,10))?null:parseInt(m,10),c=l(i.floor_plan_rooms).map(m=>{const y=String(m).match(/^(.*?):\s*(.*)$/);return y?{name:y[1].trim(),dimensions:y[2].trim()}:{name:m,dimensions:""}}),u={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(B,Math.min(j,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:o(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:o(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:o(i.year_built),year_renovated:o(i.year_renovated),landmarks:l(i.landmarks_text),interior_features:l(i.interior_features_text),exterior_features:l(i.exterior_features_text),home_systems:l(i.home_systems_text),legal_info:l(i.legal_info_text).map(m=>{const y=String(m).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return y?{label:y[1].trim(),value:y[2].trim(),source:y[3]}:{label:m,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:c,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:l(i.nearby_schools_text),hospitals:l(i.nearby_hospitals_text),shopping:l(i.nearby_shopping_text),transportation:l(i.nearby_transportation_text),distances:l(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:l(i.documents_text),features:s,images:n,highlights:Kt(i.highlights_text),seo_keywords:Kt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"},p={neighborhood:i.neighborhood||"",living_areas:i.living_areas||"",kitchens:o(i.kitchens),balconies:o(i.balconies),garden:i.garden||"",pool:i.pool||"",security:i.security||"",utilities:i.utilities||"",construction_type:i.construction_type||"",construction_status:i.construction_status||"",ownership_type:i.ownership_type||"",contact_name:i.contact_name||"",contact_phone:i.contact_phone||"",contact_email:i.contact_email||""},h={};for(const[m,y]of Object.entries({...p,real_price:r}))y!=null&&String(y).trim()!==""&&(h[m]=y);let f;if(t){u.property_id=t;const m=ge((window._propertiesData||[]).find(y=>y.property_id===t)||(window._productsData||[]).find(y=>y.property_id===t));u.specifications={...m.specifications&&typeof m.specifications=="object"?m.specifications:{},...h},{error:f}=await g.from("showroom_listings").upsert({...m,...u},{onConflict:"property_id"})}else u.property_id=kt(),u.specifications={...h},{error:f}=await g.from("showroom_listings").insert(u);f&&bi(f,()=>bt({...u,property_id:t||u.property_id}),t?"Property update":"Property publish")||(b(t?"Property updated!":"Property published!"),oe(),Mt())};const pt={Car:"Cars",Truck:"Trucks",Bus:"Buses","Motorhome / RV":"Motorhomes",Motorcycle:"Motorcycles","Boat / Marine":"Marine & Boating"},Ps=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Bus","Motorhome","Motorcycle","Yacht","Jet Ski","Other"];window.showAddVehicleModal=function(e={}){const t=!!e.property_id,a=Object.keys(pt).find(l=>pt[l]===e.category)||"Car",i=e.specifications&&typeof e.specifications=="object"?e.specifications:{},n=(l,o)=>e[l]??i[l]??o,s=(l,o="")=>Array.isArray(l)?l.join(", "):l??o;D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="vehicle-form" onsubmit="saveVehicle(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              <div><label class="lbl">Vehicle Type *</label><select class="input-field" name="vehicle_type" required>${Object.keys(pt).map(l=>`<option value="${l}" ${a===l?"selected":""}>${l}</option>`).join("")}</select></div>
              <div><label class="lbl">Body Type</label><select class="input-field" name="body_type">${["",...Ps].map(l=>`<option value="${l}" ${n("body_type","")===l?"selected":""}>${l||"General"}</option>`).join("")}</select></div>
    ...
    </div>`),Ct(),It(),window._vehFormDirty=!!t;const r=document.getElementById("vehicle-form");if(r){const l=()=>{window._vehFormDirty=!0};r.addEventListener("input",l),r.addEventListener("change",l)}window.lucide&&lucide.createIcons()};window.saveVehicle=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n=[...a.getAll("images")].filter(Boolean).concat(String(i.images_text||"").split(/\r?\n/).map(k=>k.trim()).filter(Boolean)),s=[...new Set(n)],r=(i.features_text||"").split(",").map(k=>k.trim()).filter(Boolean),l=(i.safety_features||"").split(",").map(k=>k.trim()).filter(Boolean),o=(i.driver_assistance||"").split(",").map(k=>k.trim()).filter(Boolean),c=(i.technology||"").split(",").map(k=>k.trim()).filter(Boolean),u=(i.interior||"").split(",").map(k=>k.trim()).filter(Boolean),p=i.real_price===""||i.real_price==null?null:Math.max(B,Math.min(j,parseFloat(i.real_price)||0)),h=pt[i.vehicle_type]||"Cars",f=String(i.model_year||"").trim(),m=String(i.make||"").trim(),y=String(i.model||"").trim(),x=[f,m,y].filter(Boolean).join(" ")||String(i.title||"").trim(),_={make:m,model:y,model_year:f,body_type:i.body_type||null,trim:i.trim||"",mileage:i.mileage||"",engine:i.engine||"",horsepower:i.horsepower||"",transmission:i.transmission||null,drive_type:i.drive_type||null,fuel_type:i.fuel_type||null,fuel_economy:i.fuel_economy||"",towing_capacity:i.towing_capacity||"",seating_capacity:i.seating_capacity||null,sleeping_capacity:h==="Motorhomes"&&i.seating_capacity||null,doors:i.doors||null,safety_features:l,driver_assistance:o,technology:c,interior:u,wheels_tires:i.wheels_tires||"",dimensions:i.dimensions||"",cargo_capacity:i.cargo_capacity||"",ownership_history:i.ownership_history||"",service_history:i.service_history||"",accident_history:i.accident_history||"",previous_owners:i.previous_owners||"",registration_status:i.registration_status||null,inspection_status:i.inspection_status||null,color:i.color||"",vin:i.vin||"",warranty:i.warranty||"",condition:i.condition||"",location:i.location||"",seller_name:i.seller_name||"",seller_phone:i.seller_phone||"",seller_email:i.seller_email||"",product_location:i.location||""};for(const k of Object.keys(_))_[k]==null&&delete _[k];const w={listing_type:"vehicle",category:h,subcategory:i.body_type||i.vehicle_type||null,title:String(i.title||"").trim()||x,description:i.description||"",price:Math.max(B,Math.min(j,parseFloat(i.price)||0)),currency:"USD",real_price:p,images:s,features:r,brand:m||null,color:i.color||null,condition:i.condition||null,warranty:i.warranty||null,stock_quantity:parseInt(i.stock_quantity,10)||1,is_active:i.is_active==="on",is_featured:!1,specifications:{..._,real_price:p}};let v;if(t){w.property_id=t;const k=ge((window._productsData||[]).find($=>$.property_id===t));w.specifications={...k.specifications&&typeof k.specifications=="object"?k.specifications:{},..._,real_price:p},{error:v}=await g.from("showroom_listings").upsert({...k||{},...w},{onConflict:"property_id"})}else w.property_id=kt(),{error:v}=await g.from("showroom_listings").insert(w);v&&bi(v,()=>bt({...w,property_id:t||w.property_id}),t?"Vehicle update":"Vehicle publish")||(b(t?"Vehicle updated!":"Vehicle published! It now appears in the Cars & Trucks row."),oe(),P())};window.editProperty=async function(e){const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Re(e)),i||(i=(Array.isArray(se)?se.find(n=>n.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Es=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Ci(){const e=document.getElementById("content");try{const{data:t}=await g.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let n="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(s=>As(s)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function As(e){return`<tr class="order-row" data-status="${e.status}" data-search="${d(e.order_number)} ${d(e.full_name)} ${d(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",ai(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",ke(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${d(i)||"â€”"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Es.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await g.from("payment_receipts").update({status:t}).eq("id",e);if(a){b(a.message,"error");return}b("Order status updated"),oe(),Ci()};async function Cs(){const e=document.getElementById("content");try{const{data:t}=await g.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await g.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${d(i.order_number)}</p><p class="text-[10px] text-gray-500">${ke(i.created_at)}</p></div>
    ...
    </div>`)};async function rt(){const e=document.getElementById("content");try{const{data:t}=await g.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:n}=await g.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),s=n||[],r=s.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?Ae("star","No Reviews","Customer reviews will appear here."):a.map(l=>Ts(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${s.length===0?Ae("message-square","No Feedback Yet","Site feedback will appear here."):s.map(l=>Is(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function Is(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
    ...
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await g.from("product_reviews").update({is_approved:!0}).eq("id",e),b("Review approved"),rt()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await g.from("product_reviews").delete().eq("id",e),b("Review deleted"),rt())};async function Ii(){const e=document.getElementById("content");try{const{data:t}=await g.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.markMsgRead=async function(e){await g.from("support_messages").update({is_read:!0}).eq("id",e),b("Marked as read"),Ii()};async function Nt(){const e=document.getElementById("content");try{const{data:t}=await g.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:n}=await g.from("coupons").insert(i);if(n){b(n.message,"error");return}b("Coupon created!"),oe(),Nt()};window.toggleCoupon=async function(e,t){await g.from("coupons").update({is_active:t}).eq("id",e),b(t?"Coupon activated":"Coupon deactivated"),Nt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await g.from("coupons").delete().eq("id",e),b("Coupon deleted"),Nt())};async function Ls(){const e=document.getElementById("content");try{const{data:t}=await g.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}const Ti=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Ms=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let dt=null;function Ns(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${d(e)}</span>`}function Bs(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${d(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${d(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${d(e.link_target||"")}</span>`}function Rs(e){return e.video_url?`<video src="${d(e.video_url)}" ${e.poster_url?`poster="${d(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${d(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Li(){if(dt)return dt;const e=[],t=new Set,a=[],i=s=>{if(!s||!s.property_id)return;e.push({id:s.property_id,title:s.title||s.property_id});const r=s.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{se.forEach(i)}catch{}try{const{data:s,error:r}=await g.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&s&&s.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(s=>{t.has(s)||(t.add(s),a.push(s))}),dt={products:e,categories:a,sections:Ms},dt}async function Fs(e){try{const{data:{session:t}}=await g.auth.getSession();if(!t)return b("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),n=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:s}=await g.storage.from("advertisements").upload(n,e,{contentType:e.type,upsert:!1});if(s)return b("Upload failed: "+s.message,"error"),null;const{data:r}=g.storage.from("advertisements").getPublicUrl(n);return{url:r.publicUrl,isVideo:i}}catch{return b("Upload failed","error"),null}}function ht(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),n=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),n&&(n.value=t?"":e),a.innerHTML=t?`<video src="${d(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${d(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){b("Choose an image or video file","error");return}const i=await Fs(t);if(!i){e.value="";return}ht(i.url,i.isVideo);const n=document.getElementById("ad-media-url");n&&(n.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);ht(t,a)};function xa(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let n="";t==="product"?n='<option value="">Select a productâ€¦</option>'+e.products.map(s=>`<option value="${d(s.id)}" ${String(a)===String(s.id)?"selected":""}>${d(s.id)} â€” ${d((s.title||"").slice(0,60))}</option>`).join(""):t==="category"?n='<option value="">Select a categoryâ€¦</option>'+e.categories.map(s=>`<option value="${d(s)}" ${a===s?"selected":""}>${d(s)}</option>`).join(""):t==="section"&&(n='<option value="">Select a sectionâ€¦</option>'+e.sections.map(s=>`<option value="${d(s.id)}" ${a===s.id?"selected":""}>${d(s.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${n}</select>`}function Mi(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.renderAds=ze;const Bt=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],de={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Ni(){const e=document.getElementById("content");try{let t=function(s){const r=n===s.id,l=i[s.kf],o=i[s.mf]||s.dm;return`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.highlightAI=function(e){Bt.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?de.border[t.color]+" "+de.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const n=a.querySelector("input[type=radio] + span");n&&(n.className=`text-[9px] font-bold ${i?de.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};Bt.forEach(r=>{a[r.mf]&&(i[r.mf]=a[r.mf]);const l=(a[r.kf]||"").trim();l&&!l.startsWith("â€¢â€¢â€¢â€¢")&&l!==""&&(i[r.kf]=l)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key),a.groq_vision_model&&(i.groq_vision_model=a.groq_vision_model);const n=(a.groq_key||"").trim();n&&!/^[•\u2022]{4}/.test(n)&&(i.groq_key=n),i.customer_ai_enabled=a.customer_ai_enabled==="on",a.customer_model_override!==void 0&&(i.customer_model_override=a.customer_model_override.trim());const s=(a.openrouter_key||"").trim();s&&!/^[•\u2022]{4}/.test(s)&&(i.openrouter_key=s);try{const{data:r}=await g.from("ai_settings").select("id").limit(1).maybeSingle();let l;if(r?.id?{error:l}=await g.from("ai_settings").update(i).eq("id",r.id):{error:l}=await g.from("ai_settings").insert(i),l){b("Save failed: "+l.message,"error"),console.error("[AI Save]",l);return}await F.reload(),b("âœ… AI settings saved!","success"),setTimeout(()=>Ni(),600)}catch(r){b("Unexpected error: "+r.message,"error"),console.error("[AI Save]",r)}};const F={_cfg:null,async reload(){const{data:e,error:t}=await g.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async freeChat(e,{maxTokens:t=2e3,timeoutMs:a=6e4}={}){const i=await fetch("https://text.pollinations.ai/openai",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"openai",messages:e.map(r=>({role:r.role==="assistant"?"assistant":r.role==="system"?"system":"user",content:String(r.content||"").slice(0,12e3)})),max_tokens:t}),signal:AbortSignal.timeout(a)});if(!i.ok)throw new Error(`Free AI provider error (${i.status}).`);const n=await i.json(),s=String(n?.choices?.[0]?.message?.content||"").trim();if(!s)throw new Error("Free AI provider returned an empty reply.");return{text:s,provider:"Free AI (Pollinations)",model:String(n?.model||"openai-fast")}},async chat(e,{maxTokens:t=2e3}={}){const a=await this.getConfig();if(!String(a.gemini_key||"").trim())return this.freeChat(e,{maxTokens:t});const n=e[e.length-1],s={action:"chat",message:String(n?.content||"").trim(),history:e.slice(0,-1).map(r=>({role:r.role,content:String(r.content||"")})),provider_override:"gemini",max_tokens:t};try{const r=await this._callEdge(s);if(r&&r.response)return{text:r.response,provider:"Google Gemini",model:r.model||a.gemini_model};throw new Error(String(r?.error||"Gemini is unavailable."))}catch(r){try{const l=await this.freeChat(e,{maxTokens:t});return l.note="gemini-unavailable",l}catch{throw r}}},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return Bt.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is â€” the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
- Respond with valid JSON only.`,i=await this._collectScanImages((e||[]).slice(0,t.maxImages||3));if(!i.length)throw new Error("Could not read the uploaded images.");try{const n=await this._callEdge({action:"vision",images:i,prompt:a,max_tokens:4096});if(n&&n.success&&n.text){const s=Da(n.text);if(s)return n.provider&&this._noteProvider(n.provider),{...s,_aiProvider:n.provider==="groq"?"Groq vision (backup)":"Gemini vision",_aiModel:n.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(n&&n.error||"Vision service unavailable.")}catch(n){this._noteIssue("identify",`server vision: ${n&&n.message||n}`)}return null},async _runVisionPrompt(e,t,{maxImages:a=5,maxTokens:i=4096,mergeResults:n=null,onProgress:s=()=>{},stageLabel:r="vision"}={}){const l=Math.max(1,Number(a)||5),o=await this._collectScanImages(t,{onProgress:s});if(!o.length)throw new Error("Could not read the uploaded images.");const c=async p=>this._runSingleVisionCall(e,p,{maxTokens:i,stageLabel:r});let u;if(o.length<=l)u=await c(o);else{const p=[];for(let _=0;_<o.length;_+=l)p.push(o.slice(_,_+l));s(0,p.length);const h=3,f=new Array(p.length).fill(null);let m=0;const y=async()=>{for(;m<p.length;){const _=m++;f[_]=await c(p[_]).catch(()=>null),s(Math.min(m,p.length),p.length)}};await Promise.all(Array.from({length:Math.min(h,p.length)},y));const x=[];if(f.forEach((_,w)=>{_&&x.push({result:_,startIndex:w*l})}),!x.length)return null;u=n?n(x,{batchSize:l,totalImages:o.length}):x.reduce((_,w)=>this._mergeJsonResults(_,w.result),null)}return u||null},async _runSingleVisionCall(e,t,{maxTokens:a=4096,stageLabel:i="vision"}={}){if(!await this._waitForQuotaWindow(7e4,i))return null;try{const n=await this._paceGeminiCall(()=>this._callEdge({action:"vision",images:t,prompt:e,max_tokens:a},45e3));if(n&&n.success&&n.text){const s=Da(n.text);if(s)return n.provider&&this._noteProvider(n.provider),{...s,_aiProvider:n.provider==="groq"?"Groq vision (backup)":"Gemini vision",_aiModel:n.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(n&&n.error||"Vision service unavailable.")}catch(n){this._noteIssue(i,`vision: ${n&&n.message||n}`)}return null},_pdfPageCache:new Map,_videoFrameCache:new Map,async _collectScanImages(e,{onProgress:t=()=>{}}={}){const a=(Array.isArray(e)?e:[e]).map(s=>String(s||"")).filter(Boolean);if(!a.length)return[];const i=await Promise.all(a.map(async s=>{try{if(/^data:application\/pdf/.test(s)||it(s)){let o=this._pdfPageCache.get(s)||null;return o||(o=await yn(s,{maxDim:1300}).catch(()=>[]),o.length&&this._pdfPageCache.set(s,o)),o}let r=null;if(Xi(s))r=s;else if(s.startsWith("blob:"))try{const o=await fetch(s,{signal:AbortSignal.timeout(15e3)}).then(c=>c.blob());o&&o.type&&o.type.startsWith("video/")&&(r=o)}catch{}if(r){let o=this._videoFrameCache.get(s)||null;return o||(o=await Zi(r,{maxFrames:12,maxDim:1024}).catch(()=>[]),o.length&&this._videoFrameCache.set(s,o)),o}const l=await this._fetchImageAsDataUrl(s,1024);return l?[l]:[]}catch{return[]}})),n=[];for(const s of i)n.push(...s);return n},_mergeJsonResults(e,t){if(!e)return t?{...t}:null;if(!t)return e;const a={...e};for(const[i,n]of Object.entries(t))if(!i.startsWith("_")&&!(n==null||typeof n=="string"&&!n.trim())){if(!(i in a)||a[i]==null||a[i]===""){a[i]=n;continue}if(Array.isArray(a[i])||Array.isArray(n)){const s=[...Array.isArray(a[i])?a[i]:[a[i]],...Array.isArray(n)?n:[n]].map(r=>typeof r=="string"?r.trim():r).filter(r=>r!=null&&r!=="");a[i]=[...new Set(s)]}else typeof a[i]=="object"&&typeof n=="object"?a[i]={...a[i],...n}:(String(a[i]).trim(),String(n).trim())}return a},async identifyProduct(e,t={}){const a=`STAGE 1 â€” IDENTIFY THE EXACT PRODUCT.
...
}`;return this._runVisionPrompt(n,e,{maxImages:a.maxImages||5,stageLabel:"specs"})},async estimateProductPrice(e,t,a={},i={}){const n=t||{},s=a||{},r=`STAGE 3 â€” ESTIMATE THE REAL MARKET PRICE AND A PROMOTIONAL DISCOUNT PRICE.
...
${a.text}`}catch(a){t.textContent=`✖ ${a.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const a=(n,s,r,l)=>`
      ...
      <div class="min-w-0">
        ...
        <div class="mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-1.5 max-h-72 overflow-y-auto pr-1" id="promo-picker-list">
            ${a.map(r=>{const l=r.property_id||r.id,o=n.has(l)?"checked":"";return`<label class="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-xl px-3 py-2 cursor-pointer hover:border-blue-400/40 transition" data-promo-search="${d((r.title||r.name||"")+" "+(r.category||""))}">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),b("Cleared. Save to apply.","info"),Fi()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),b(`Uploading ${a.name}â€¦`,"info");try{const{data:{session:i}}=await g.auth.getSession();if(!i){b("Sign in to upload media","error");return}const n=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),s=`content/${t}-${Date.now()}.${n}`,{error:r}=await g.storage.from("product-images").upload(s,a,{contentType:a.type,upsert:!1});if(r){b("Upload failed: "+r.message,"error");return}const{data:l}=g.storage.from("product-images").getPublicUrl(s),o=l.publicUrl,c=document.getElementById("val-"+t),u=document.getElementById("url-"+t);c&&(c.value=o),u&&(u.value=o);const p=document.getElementById("slot-"+t);if(p){const h=_a.flatMap(f=>f.fields||[]).find(f=>f.key===t);h&&(p.outerHTML=Bi(h,o))}b("âœ“ Uploaded â€” save to apply","success")}catch{b("Upload failed","error")}}};const js=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function le(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function ot(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(le()))}function Le(){ot();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=Ri(le()),window.lucide&&lucide.createIcons())}function qs(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),n=a&&Ua(a)||i&&Ua(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&Gs(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=le();i[e]&&(i[e][t]=a,ot())};window.heroVideoPreset=function(e,t){const a=le();a[e]&&(a[e].buttonText=t,Le())};window.heroVideoToggle=function(e){const t=le();t[e]&&(t[e].enabled=t[e].enabled===!1,Le())};window.heroVideoMove=function(e,t){const a=le(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],Le())};window.heroVideoDelete=function(e){const t=le();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),Le())};window.heroVideoRemoveMedia=function(e,t){const a=le();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),Le())};window.addHeroVideoSlide=function(){le().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),Le(),b("New slide added â€” upload a video and press Save to show it.","info")};async function Hs(e,t){try{const{data:{session:a}}=await g.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:s}=await g.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(s)return{url:URL.createObjectURL(e),persisted:!1,error:s.message};const{data:r}=g.storage.from("product-images").getPublicUrl(n),l=r&&r.publicUrl;return l?{url:l,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function Ua(e){return/^blob:/i.test(String(e||""))}async function Gs(e,t,a){const i=le();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){b("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){b("Please choose an image for the poster.","error");return}b("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await Hs(a,t);t==="video"?i[e].video=n.url:i[e].poster=n.url,Le(),n.persisted?b("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):b("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function Vs(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,ot(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${_a.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?Vs(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
      ...
      </div>`,ot(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[n,s]of t.entries())a[n]=s;for(const n of _a)if(n.fields)for(const s of n.fields)s.type==="checkbox"&&!(s.key in a)?a[s.key]=!1:s.type==="checkbox"&&(a[s.key]=!0);let i=[];try{const n=t.get("hero_video_slides");if(String(n||"").trim()){const s=JSON.parse(n);Array.isArray(s)&&(i=s)}}catch{i=[]}a.hero_video_slides=i;try{const{data:n}=await g.from("site_settings").select("id").limit(1).maybeSingle();let s;if(n?.id?{error:s}=await g.from("site_settings").update(a).eq("id",n.id):{error:s}=await g.from("site_settings").insert({id:crypto.randomUUID(),...a}),s)throw new Error(s.message);za(),b("Content updated â€” the banners now use your new words and uploads.","success")}catch(n){b(n.message||"Could not save content. Please try again.","error")}};async function Ws(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([g.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),g.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),g.from("profiles").select("user_id,created_at",{count:"exact"})]),n=t.data||[],s=n.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,u)=>c+(parseFloat(u.amount)||0),0),r=n.length>0?(n.filter(c=>c.status!=="cancelled").length/n.length*100).toFixed(1):0,l={};(a.data||[]).forEach(c=>{l[c.category]=(l[c.category]||0)+1});const o=Object.entries(l).sort((c,u)=>u[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),gi(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function zs(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <i data-lucide="${h.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${h.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,a=document.getElementById("new-pw").value,i=document.getElementById("confirm-pw").value;if(a!==i){b("Passwords do not match","error");return}if(a.length<8){b("Password must be at least 8 characters","error");return}const{error:n}=await g.auth.signInWithPassword({email:I.user.email,password:t});if(n){b("Current password is incorrect","error");return}const{error:s}=await g.auth.updateUser({password:a});if(s){b(s.message,"error");return}await ce(I.user.id,"password_changed"),b("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){D(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Di(10);await g.from("admin_2fa").update({backup_codes:e}).eq("user_id",I.user.id),b("New backup codes generated"),Ui(e.map(t=>t.code)),Rt()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await g.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await g.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await g.from("admin_2fa").update({enabled:!1}).eq("user_id",I.user.id),await ce(I.user.id,"2fa_disabled"),b("2FA has been disabled"),Rt()}catch(e){b(e.message,"error")}};async function Ks(){const e=document.getElementById("content");try{const{data:t}=await g.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Js(){const e=document.getElementById("content");try{const{data:t}=await g.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${d(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${ke(a.created_at)}</p></div>
                ${K(a.status||"completed")}
              </div>`).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.exportProducts=async function(){const{data:e}=await g.from("showroom_listings").select("*"),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download=`kco-products-${new Date().toISOString().slice(0,10)}.json`,a.click(),b("Products exported!")};window.exportOrders=async function(){const{data:e}=await g.from("payment_receipts").select("*").order("created_at",{ascending:!1});if(!e||!e.length){b("No orders to export","info");return}const t=Object.keys(e[0]).join(","),a=e.map(s=>Object.values(s).map(r=>`"${String(r||"").replace(/"/g,'""')}"`).join(",")).join(`
`),i=new Blob([t+`
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),b("Orders exported!")};async function Qs(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,n]of t.entries())a[i]=n;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await g.from("site_settings").upsert({id:1,...a}),b("Settings saved!")};async function Ft(){const e=document.getElementById("content");e&&(e.innerHTML=He());try{const{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",n=a.homepage_banner_alt||"Homepage header banner",s=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Dt(){const e=document.getElementById("content");e&&(e.innerHTML=He());try{let t=function(l,o,c,u="",p="blue"){const h=!!(c&&c.trim());return`
        ...
        </div>`};const{data:a}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},n=i.brand_name||i.site_name||Za,s=i.brand_slogan||i.site_tagline||ei,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${d(a.message)}</div>`)}}function Xs(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",n=t[a]||"",s=t[i]||"",r=!!(n&&n.trim()),l=!!(s&&s.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function Oa(e,t,a,i,n){const s=n==="image",r=s?"blue":"violet",l=s?"image-plus":"video",o=s?"text-blue-400":"text-violet-400";return`
    <div>
      ...
      ${i?`<div class="relative group w-full h-28 rounded-xl overflow-hidden bg-gray-900 border border-${r}-500/15 flex items-center justify-center">
             ${s?`<img src="${d(a)}" class="w-full h-full object-cover" onerror="this.style.display='none'">`:`<video src="${d(a)}" class="w-full h-full object-cover" muted playsinline preload="metadata"></video>`}
             <div class="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-2">
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function Oi(){const e={};for(const t of wt)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=Oi();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),tt(t),b("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),n=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),n&&(n.textContent=`Uploading ${a.name}â€¦`);try{const s=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${s}`,{error:l}=await g.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let o;if(l)o=URL.createObjectURL(a),n&&(n.textContent=`Preview only (storage: ${l.message})`);else{const{data:h}=g.storage.from("product-images").getPublicUrl(r);o=h.publicUrl,n&&(n.textContent=`âœ“ ${a.name} uploaded`)}const c=document.getElementById("val-"+t),u=document.getElementById("url-"+t);c&&(c.value=o),u&&(u.value=o,u.classList.remove("hidden"));const p=Oi();tt(p)}catch(s){n&&(n.textContent=`Upload failed: ${s.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const s of wt)t[s.key+"_bg_image"]=document.getElementById("val-"+s.key+"_bg_image")?.value||"",t[s.key+"_bg_video"]=document.getElementById("val-"+s.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:i}=await g.from("site_settings").select("id").limit(1).maybeSingle();let n;i?.id?{error:n}=await g.from("site_settings").update(t).eq("id",i.id):{error:n}=await g.from("site_settings").insert(t),zi(),n?(b("Publish failed â€” the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),tt(t)):(b("Promo & backgrounds published across all pages.","success"),setTimeout(()=>tt(),500))};window._manualPaymentAccounts=[];function ka(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:ca("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function Sa(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Zs(e,t){const a=e.country_code||"US";return`
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Zs(t,a)).join("")}
    ...
    </div>`,Sa(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ka()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ka()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),Sa())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=je.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||ca(t),Sa(),renderManualPaymentAccountsEditor()};async function oa(){const e=document.getElementById("content");e&&(e.innerHTML=He());try{const{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i={...on()||{},...t||{}};window._manualPaymentAccounts=un(i).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Savingâ€¦");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n={},s=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,o]of Object.entries(i))s.includes(l)?o&&!o.startsWith("â€¢")&&o.trim()!==""&&(n[l]=o.trim()):n[l]=o;const{error:r}=await g.from("site_settings").upsert({id:1,...n});if(t&&(t.disabled=!1,t.innerHTML="ðŸ’¾ Save Deploy & Payment Settings"),r){b(r.message,"error");return}b("Deploy & payment settings saved!"),Ut()};async function ji(e="deploy"){const{data:t}=await g.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return b("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function xe(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:n,error:s}=await g.from("deployment_history").insert({version:a,status:e,triggered_by_email:I.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:n,error:s}}function Oe(e,t,a,i){if(!e)return;e.disabled=t;const n=e.querySelector("p.text-xs.font-black");n&&(n.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");Oe(t,!0,"Deployingâ€¦","Deploy Now");try{const a=await ji("deploy");if(!a.ok)return;const{settings:i,hookUrl:n}=a;await xe("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Deployment queued from admin UI"});const s=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(s.ok)b("ðŸš€ Deployment triggered! Your site will be live in ~2 minutes."),await xe("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted deployment request"}),setTimeout(()=>Ut(),400);else{const r=`Webhook returned error: ${s.status}`;b(r,"error"),await xe("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(a){b("Deploy failed: "+a.message,"error"),await xe("failed",{mode:"deploy",errorMessage:a.message})}finally{Oe(t,!1,"Deployingâ€¦","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");Oe(t,!0,"Rebuildingâ€¦","Rebuild Site");try{const a=await ji("rebuild");if(!a.ok)return;const{settings:i,hookUrl:n}=a;await xe("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Rebuild requested from admin UI"});const s=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(s.ok)b("ðŸ”„ Rebuild triggered successfully."),await xe("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted rebuild request"}),setTimeout(()=>Ut(),400);else{const r=`Rebuild webhook error: ${s.status}`;b(r,"error"),await xe("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(a){b("Rebuild failed: "+a.message,"error"),await xe("failed",{mode:"rebuild",errorMessage:a.message})}finally{Oe(t,!1,"Rebuildingâ€¦","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");Oe(t,!0,"Publishingâ€¦","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){b("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){b("Publish failed: "+a.message,"error")}finally{Oe(t,!1,"Publishingâ€¦","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexingâ€¦");try{const{data:i,error:n}=await g.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(n)return J(n)?b("âš ï¸ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):b("Could not load listings to reindex: "+n.message,"error");const s=i||[];if(!s.length){b("No listings to reindex.");return}let r=0,l=0,o=!1;const c=40;for(let u=0;u<s.length;u+=c){const p=s.slice(u,u+c),{error:h}=await g.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",p.map(f=>f.id));h?(J(h)&&(o=!0),l+=p.length):r+=p.length,t&&(t.textContent=`Reindexingâ€¦ ${Math.min(u+c,s.length)}/${s.length}`)}if(o){b(`âš ï¸ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${r}/${s.length} done)`,"error");return}b(`Search index rebuilt for ${r} listing${r!==1?"s":""}${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){b("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(se)||!se.length){b("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncingâ€¦");try{const{data:i,error:n}=await g.from("showroom_listings").select("property_id");if(n)return J(n)?b("âš ï¸ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):b("Could not load existing listings: "+n.message,"error");const s=new Set((i||[]).map(p=>p.property_id)),r=se.filter(p=>p&&p.property_id&&!s.has(p.property_id));if(!r.length){b("Showroom already in sync â€” no new listings to add.");return}let l=0,o=0,c=!1;const u=20;for(let p=0;p<r.length;p+=u){const h=r.slice(p,p+u).map(m=>({property_id:m.property_id,listing_type:m.listing_type||"product",category:m.category||null,subcategory:m.subcategory||null,title:m.title||"Untitled Listing",description:m.description||"",price:parseFloat(m.price)||0,currency:m.currency||"USD",country:m.country||"",country_code:m.country_code||"",state:m.state||"",city:m.city||"",town:m.town||"",product_location:m.product_location||"",latitude:m.latitude??null,longitude:m.longitude??null,property_type:m.property_type||null,listing_status:m.listing_status||"sale",bedrooms:m.bedrooms??null,bathrooms:m.bathrooms??null,building_size:m.building_size||"",land_size:m.land_size||"",parking_spaces:m.parking_spaces??null,furnished:m.furnished||"",features:Array.isArray(m.features)?m.features:[],tags:Array.isArray(m.tags)?m.tags:[],highlights:Array.isArray(m.highlights)?m.highlights:[],seo_keywords:Array.isArray(m.seo_keywords)?m.seo_keywords:[],images:Array.isArray(m.images)?m.images:[],brand:m.brand||null,color:m.color||null,size:m.size||null,condition:m.condition||null,warranty:m.warranty||null,availability_status:m.availability_status||"In Stock",stock_quantity:m.stock_quantity!=null?parseInt(m.stock_quantity,10):null,is_active:m.is_active!==!1,is_featured:!!m.is_featured,is_ai_generated:!!m.is_ai_generated,ai_generated_fields:Array.isArray(m.ai_generated_fields)?m.ai_generated_fields:[],specifications:m.specifications||{},created_at:m.created_at||new Date().toISOString()})),{error:f}=await g.from("showroom_listings").insert(h);f?(J(f)&&(c=!0),o+=h.length):l+=h.length,t&&(t.textContent=`Syncingâ€¦ ${Math.min(p+u,r.length)}/${r.length}`)}if(c){b(`âš ï¸ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${l}/${r.length} added)`,"error");return}b(`Showroom synced: ${l} new listing${l!==1?"s":""} added to the database${o?` (${o} failed)`:""}.`,o?"error":"success")}catch(i){b("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){b("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();b(`âœ“ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?b("Repository not found. Check username and repo name.","error"):b("GitHub API error: "+a.status,"error")}catch{b("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const qi=30,V={category:null,page:0,query:""};async function Ye(){const e=document.getElementById("content");if(!e)return;await la();const t=new Set(_t()),a=Wi();V.category||(V.category=a[0]?.slug||null);const i=0,n=V.query.trim().toLowerCase(),s=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let o=[];const c=o.length?o.map(h=>{const f=t.has(h.property_id),m=h.images&&h.images[0]||"/fallback.svg";return`
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',u=n?1:Math.max(1,Math.ceil(i/qi)),p=`
    <div class="flex flex-wrap items-center justify-between gap-3">
