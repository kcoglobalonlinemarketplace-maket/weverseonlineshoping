...
import{supabase as h}from"./supabase-client-7_ZWSEp6.js";import"./localization-CAyfku7W.js";import{_ as W}from"./preload-helper-CLcXU_4U.js";import{c as $,S as z,l as U,f as G,a as A,b as D,g as Y,P as K}from"./showroom-data-D-nP9j-R.js";import{getCatalogCategory as J,getCatalogSample as Q}from"./catalog-CESpPuFx.js";import{g as X,a as Z,b as ee,c as te,f as ae,T as re,M as oe,C as le,P as ie}from"./phone-data-CExU1cqD.js";import{r as se}from"./showroom-cards-Dwrrz3nx.js";import{g as w,f as I}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode-BnDQCrNW.js";import"./customer-ai-widget-Df_YFtgA.js";import"./brand-DYhAh01b.js";import"./catalog-hidden-store-DbF0xVeS.js";const v="/fallback.svg";function B(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function T(e){return Array.isArray(e)&&e.length>0?e:[v]}function ne(){return new URLSearchParams(window.location.search).get("id")}function ce(e){const t=document.getElementById("details-content"),a=ae(e),n=T(e.images).map((r,u)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${u===0?"active border-blue-500":"border-gray-200"} shrink-0" data-img="${s(r)}">
  ...
  `}function H(e){const t=e.listing_type==="property",a=`/contact.html?listing=${encodeURIComponent(e.property_id||"")}`;return`
    ...
    <div class="bg-gray-50 border border-gray-200 rounded-xl p-5 mb-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ${e.highlights.map(m=>`<div class="flex items-start gap-2 text-sm text-gray-700"><i data-lucide="sparkles" class="w-4 h-4 text-blue-500 mt-0.5"></i><span>${s(m)}</span></div>`).join("")}
      </div>
    </div>`:"",u=`
    <div class="flex items-center gap-4 mb-6">
      <div class="flex items-center gap-1.5">
