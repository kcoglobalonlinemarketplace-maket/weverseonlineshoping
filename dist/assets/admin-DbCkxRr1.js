import"./preload-helper-CS1eXPs2.js";import{a as Qt,g as Zt,C as be,A as ea}from"./localization-CpV5nFqY.js";import{supabase as u}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as ta,upsertLocalShowroomListing as Ae,getLocalShowroomListingById as lt,listLocalShowroomListings as dt}from"./local-showroom-store-JrQn_yOW.js";import{g as ct,s as aa,l as ia,a as sa,b as oa}from"./payment-settings-iw-xbNn1.js";import{S as D,P as ra,a as na,T as la,M as da}from"./motorhome-data-_WKsMac0.js";import{getCatalogCategory as ut,getCatalogCategories as ca,generateProduct as st}from"./catalog-BzyCL9ZE.js";import{getHiddenCatalogIds as pt,saveCatalogHidden as ua,resetHiddenCatalogIds as pa,loadHiddenCatalogIds as ma}from"./catalog-hidden-store-BJoPnRIT.js";const B=1,N=5e6,ba=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],ga=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],mt=[...ba,...ga];function qe(e){return Qt[e]||"USD"}function bt(e,t){return mt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ya(e,t){const a=Math.max(B,Math.min(N,Number(e)||B));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function fa(e,t,a,i,s){const o=ya(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${s}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function gt({templateId:e,listingType:t,category:a,countryCode:i,currency:s,price:o}){const n=mt.find(y=>y.id===e&&y.listingType===t);if(!n)return null;const l=Zt(i)||be[0],d=s||qe(l.code),c=[l.name].filter(Boolean).join(", "),g={category:n.category||a||(t==="property"?"Real Estate":"Other"),subcategory:n.subcategory||n.label,title:t==="property"?`${n.label} in ${l.name}`:n.label,description:fa(n,l,d,o,c),currency:d,features:[...n.features],highlights:[...n.highlights||[]],seo_keywords:[...new Set([n.category,n.subcategory,n.label,...t==="property"?[l.name]:[],...n.keywords||[]].filter(Boolean))],requiredImageCount:n.requiredImageCount||0};return t==="property"?{...g,country:l.name,country_code:l.code,product_location:l.name,property_type:n.propertyType||n.label,bedrooms:n.bedrooms??null,bathrooms:n.bathrooms??null,building_size:n.buildingSize||"",land_size:n.landSize||"",furnished:n.furnished||""}:{...g,brand:n.brand||"",model:n.model||"",color:n.color||"",size:n.size||"",condition:n.condition||"New"}}const yt="weverseonlineshop@gmail.com",ft="Weverse Online Shop",ht="GLOBAL SHOPPING • WORLDWIDE DELIVERY",ha="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),va=`${ha}/functions/v1/ai-admin-assistant`,xa=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],wa={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",ai:"AI Assistant","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},vt=[...ea].sort();let w={user:null,section:"dashboard"};function r(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function xt(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function F(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function H(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function He(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const _a=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function J(e){const t={};if(!e||typeof e!="object")return t;for(const a of _a)a in e&&(t[a]=e[a]);return t}function p(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",o[t]||"info"),s.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function I(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",r(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function q(){document.getElementById("modal-container").innerHTML=""}function C(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function E(e,t,a,i,s=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function se(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function Q(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${r(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${r(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function wt(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=xa.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){w.section=e;const t=wa[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),wt(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=se()),window.lucide&&lucide.createIcons(),({dashboard:Fa,products:S,properties:jt,catalog:ae,orders:Ot,customers:li,reviews:Qe,messages:Nt,coupons:ve,ads:te,notifications:ci,ai:ka,"ai-settings":Wt,"homepage-branding":_e,content:fi,seo:vi,email:xi,analytics:hi,security:we,activity:wi,brand:ke,"payment-settings":Ne,backup:_i,settings:ki,publish:$e}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=Q("construction","Coming Soon",`${t} is being built.`))}))()};async function ka(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Y="kco_admin_remember",Ge="kco_login_attempts",Ee=5,$a=15*60*1e3;function $(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Sa(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ge(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function oe(e){return String(e||"").trim().toLowerCase()}function Pa(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");e?.email&&!oe(e.email)&&localStorage.removeItem(Y)}catch{localStorage.removeItem(Y)}}function Aa(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");return oe(e?.email)}catch{return""}}function We(){Pa();const e=Aa(),t=document.getElementById("login-email");t&&(t.value=e||t.value||yt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function Ea(){return`${window.location.origin}/admin.html`}function K(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ge(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function k(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function _t(){try{return JSON.parse(localStorage.getItem(Ge)||'{"count":0}')}catch{return{count:0}}}function kt(){const e=_t();return e.count=(e.count||0)+1,e.count>=Ee&&(e.lockedUntil=Date.now()+$a),localStorage.setItem(Ge,JSON.stringify(e)),e}function $t(){localStorage.removeItem(Ge)}function St(){const e=_t();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?($t(),null):Math.ceil(t/6e4)}async function R(e,t,a={}){try{await u.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Ia(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Ia(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Pt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await u.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:oe(e.email)===yt}async function Ca(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){de(),Ra();return}const{data:{session:t}}=await u.auth.getSession();if(t?.user&&await Pt(t.user)){const{data:{currentUser:i}}=await u.auth.getUser(),s=await u.auth.mfa.getAuthenticatorAssuranceLevel(),o=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&o!=="aal2"){w.user=t.user,de(),K("2fa"),ze();return}w.user=t.user,ye();return}Ta()}function de(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Ta(){de(),K("login"),We(),At(),Et(),ze(),La();const e=St();e&&($(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function La(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function At(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Ba),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>K("forgot")))}async function Ba(e){e.preventDefault();const t=St();if(t){$(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=oe(a?.value);if(!i){$("Enter your admin email address."),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;k("login-btn",!0),ge();const{data:n,error:l}=await u.auth.signInWithPassword({email:i,password:s});if(l||!n.user){const b=String(l?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){$("Authentication is temporarily unavailable due to configuration. Please contact support."),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){$("Network error while signing in. Check your connection and try again."),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){$("Your admin email is not confirmed yet. Open your verification email and confirm first."),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=kt(),m=Ee-f.count,h=f.lockedUntil?`Account locked for 15 minutes after ${Ee} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;$(h),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await R(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Pt(n.user)){await u.auth.signOut(),$(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await R(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Y,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Y),$t(),w.user=n.user,(await u.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){k("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),K("2fa"),ze(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await R(n.user.id,"login_success"),k("login-btn",!1),ye()}function ze(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ot));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ot()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await u.auth.signOut(),w.user=null,K("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Ma))}async function ot(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){$("Enter the 6-digit code from your authenticator app.");return}k("verify-2fa-btn",!0),ge();try{const{data:t}=await u.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){$("No 2FA factor found. Please re-login."),k("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await u.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:o}=await u.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await R(w.user.id,"login_2fa_success"),k("verify-2fa-btn",!1),ye()}catch(t){kt(),$(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),k("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Ma(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){$("Enter a backup recovery code.");return}k("verify-backup-btn",!0);try{const{data:t}=await u.from("admin_2fa").select("backup_codes").eq("user_id",w.user.id).maybeSingle();if(!t?.backup_codes?.length){$("No backup codes found."),k("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){$("Backup code not found or already used."),k("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await u.from("admin_2fa").update({backup_codes:i}).eq("user_id",w.user.id),await R(w.user.id,"login_backup_code_used"),ye()}catch(t){$(t.message),k("verify-backup-btn",!1,"Use Backup Code")}}function Et(){document.getElementById("back-to-login")?.addEventListener("click",()=>K("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Da)}async function Da(){const e=document.getElementById("reset-email"),t=oe(e?.value);if(!t){$("Enter your admin email address to receive a reset link.");return}k("send-reset-btn",!0),ge();const{error:a}=await u.auth.resetPasswordForEmail(t,{redirectTo:Ea()});if(k("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){$(a.message);return}Sa("Reset link sent! Check your inbox and open it from this device to continue.")}function Ra(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await u.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}p("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function ye(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&w.user&&(t.textContent=w.user.email||"Admin"),We(),navigate("dashboard")}window.adminSignOut=async function(){w.user&&await R(w.user.id,"logout"),await u.auth.signOut(),w.user=null,de(),K("login"),We(),At(),Et()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(w.user&&await R(w.user.id,"logout_all_devices"),await u.auth.signOut({scope:"global"}),w.user=null,p("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Fa(){const e=document.getElementById("content");try{const[t,a,i,s]=await Promise.all([u.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),u.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),u.from("profiles").select("user_id,created_at",{count:"exact"}),u.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=t.data||[],n=a.data||[],l=n.filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,T)=>v+(parseFloat(T.amount)||0),0),d=n.filter(v=>["pending","pending_verification","processing"].includes(v.status)).length,c=o.filter(v=>v.listing_type!=="property").length,g=o.filter(v=>v.listing_type==="property").length,y=o.filter(v=>v.listing_type!=="property"&&v.is_active).length,b=i.count||0,f=s.count||0,m=(s.data||[]).filter(v=>!v.is_approved).length,h=new Date,U=n.filter(v=>{const T=new Date(v.created_at);return T.getMonth()===h.getMonth()&&T.getFullYear()===h.getFullYear()}).filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,T)=>v+(parseFloat(T.amount)||0),0),G=n.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${Na()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${E("Total Revenue",`$${l.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${U.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${E("Total Orders",n.length,"shopping-bag","blue",`${d} pending`)}
          ${E("Customers",b,"users","violet")}
          ${E("Products",c,"package","amber",`${y} active`)}
          ${E("Properties",g,"home","blue")}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${G.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':G.map(v=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${H(v.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),Tt(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${r(t.message)}</div>`)}}async function S(){const e=document.getElementById("content");try{const{data:t,error:a}=await u.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,s=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),s.push(d));for(const d of dt().filter(c=>c.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),s.push(d));if(Array.isArray(D))for(const d of D.filter(c=>c.listing_type!=="property"&&c.property_id))i.has(d.property_id)||(i.add(d.property_id),s.push(d));const o=[...ra,...na,...la,...da];for(const d of o)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),s.push(d));s.sort((d,c)=>new Date(c.created_at||0)-new Date(d.created_at||0));const n=[...new Set(s.map(d=>d.category).filter(Boolean))].sort((d,c)=>d.localeCompare(c)),l=[...new Set(s.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,c)=>d.localeCompare(c));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ${E("Total Products",s.length,"package","blue")}
          ${E("Published",s.filter(d=>!!d.is_active).length,"badge-check","emerald")}
          ${E("Draft / Hidden",s.filter(d=>!d.is_active).length,"file-clock","amber")}
          ${E("Featured",s.filter(d=>!!d.is_featured).length,"sparkles","violet")}
          ${E("Inventory Units",s.reduce((d,c)=>d+(parseInt(c.stock_quantity,10)||0),0),"boxes","blue")}
          ${E("Avg Price",`$${Math.round(s.reduce((d,c)=>d+(parseFloat(c.price)||0),0)/Math.max(s.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=s,window._productsCardLimit=60,It(s),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${r(t.message)}</div>`)}}function z(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ie(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ua(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function Ve(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Ce(e){return parseInt(e.views??e.view_count??0,10)||0}function Te(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Ke(e){return e.sku||e.property_id||"N/A"}function ja(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ie(e),i=Ve(e),s=window._productSelection?.has(e.property_id),o=I(i==="archived"?"inactive":i==="active"?"active":"inactive"),n=F(e.created_at),l=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",g=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${r(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${r(Ke(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Price</span><p class="text-emerald-300 font-black text-base">$${z(e.price).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${r(Ua(e))}</p></div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(y=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${r(y)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Oa(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,o)=>i(s.created_at)-i(o.created_at)):t==="price-high"?a.sort((s,o)=>z(o.price)-z(s.price)):t==="price-low"?a.sort((s,o)=>z(s.price)-z(o.price)):t==="sales-high"?a.sort((s,o)=>Te(o)-Te(s)):t==="views-high"?a.sort((s,o)=>Ce(o)-Ce(s)):a.sort((s,o)=>i(o.created_at)-i(s.created_at)),a}function It(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const s=window._productsCardLimit||60,o=e.slice(0,s);t.innerHTML=o.map(ja).join(""),i&&(i.textContent=String(e.length));const n=document.getElementById("products-more");if(n){const l=e.length-o.length;l>0?n.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:n.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Ct(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=Ve(i),n=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${r(Ke(i))}</p>
              </div>
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${r(i.category||"Uncategorized")}</span></td>
          <td><span class="text-xs font-bold text-emerald-400">$${z(i.price).toLocaleString()}</span></td>
          ...
          <td><span class="text-xs text-gray-500">${F(i.created_at)}</span></td>
          <td>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${z(a.price).toLocaleString()}</p></div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await u.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(s=>s.property_id===e)||t.data;if(!a)return p("Product not found","error");const i=Array.isArray(a.images)?a.images:[];C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Je(),Xe(),Z(),ee(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb img")].map(l=>l.getAttribute("src")).filter(l=>l&&!String(l).startsWith("blob:")),s={title:a.get("title")||"Untitled Product",price:Math.max(B,Math.min(N,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},o=J((window._productsData||[]).find(l=>l.property_id===t)),{error:n}=await u.from("showroom_listings").upsert({...o,...s,property_id:t},{onConflict:"property_id"});if(n){if(L(n)){p("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),q(),S();return}ta(t,s),p("Quick edit saved locally","info")}else p(s.is_active?"Saved & published — your showroom shows it now":"Quick edit saved (draft)");q(),S()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),p("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await u.from("showroom_listings").delete().eq("property_id",e);if(t)return L(t)?p("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Delete failed: "+t.message,"error");p("Product deleted"),S()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await u.from("showroom_listings").delete().neq("property_id","__none__");if(t)return L(t)?p("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):p("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}p("All products deleted. The manager now shows your showroom catalog."),S()};window.openProductMoreActions=function(e){C(`
    ...
    </div>`),Je(),Xe(),Dt("pf-price"),Me(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Me(e,"pricing")),Va(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),q(),S()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[s,o]of i.entries())s==="images"?(a.images=a.images||[],o&&!String(o).startsWith("blob:")&&a.images.push(String(o))):s==="tags"?(a.tags=a.tags||[],a.tags.push(o)):a[s]=o;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function re(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function Je(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Ga(t.dataTransfer.files)}))}function Xe(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Z()})}window.handleImageUpload=async function(e){await Ft(e.target.files)};async function Ga(e){await Ft(e)}async function Ft(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await Ut(a);if(i){const s=t.children.length,o=document.createElement("div");o.innerHTML=re(i,s),t.appendChild(o.firstElementChild),Z()}}he(),ee(),window.lucide&&lucide.createIcons()}}async function Ut(e){try{const{data:{session:t}}=await u.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await u.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(s)return URL.createObjectURL(e);const{data:o}=u.storage.from("product-images").getPublicUrl(i);return o.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Z(),he(),ee()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){p("Please choose an image file.","error");return}const s=await Ut(i);if(!s)return;const n=[...a.querySelectorAll(".img-thumb")][e];if(!n)return;const l=n.querySelector("img");l&&(l.src=s),Z(),he(),ee(),p("Image replaced. Save changes to apply.","info")};function Z(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const s=a.querySelector("img");if(!s)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=s.src,t.appendChild(o),a.dataset.index=i;const n=a.querySelector(".rm");n&&n.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function he(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ee(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,i=a>=24;t.textContent=i?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(i?"text-emerald-300":"text-gray-400");const s=document.querySelector('#product-form [name="is_active"]');i&&s&&!s.checked&&(s.checked=!0)}function Re(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Wa(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,s]of t.entries())i==="images"?s&&!String(s).startsWith("blob:")&&a.images.push(String(s)):i==="tags"?a.tags.push(String(s)):a.fields[i]=String(s);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function za(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([s,o])=>{const n=e.querySelector(`[name="${s}"]`);n&&(n.type==="checkbox"?n.checked=o==="on"||o===!0:n.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(s=>{s.checked=i.includes(s.value)}),Array.isArray(t.images)){const s=document.getElementById("image-preview");s&&(s.innerHTML=t.images.map((o,n)=>re(o,n)).join(""),Z(),he(),ee())}return!0}function Fe(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=t.querySelector('[name="stock_quantity"]')?.value,n=o===""||o==null?"Unlimited":o,l=w.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(y=>y.value),c=document.querySelectorAll("#image-preview .img-thumb").length,g=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,n=e.dataset.category||"Product",l=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};function Va(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Re(e,t),s=document.getElementById("product-autosave-note");if(!t)try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);za(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(Wa(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}Fe()};let n;const l=()=>{clearTimeout(n),n=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",l),d.addEventListener("change",l)}),Fe(),ee()}const Ka=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],Ya=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],Ja=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],Xa=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],Qa=["FWD","RWD","AWD","4WD"],Za={activeProvider:"gemini",maxImages:5,PROVIDERS:{gemini:{label:"Google Gemini (Free Tier)",scan:async(e,t)=>{const a=await V.identifyProduct(e,t);if(!a||a.identified===!1)return{identification:a,specs:null,sources:{}};const i=await V.completeProductSpecs(e,a,t);return{identification:a,specs:i,sources:ei(a,i)}}}},async scan(e,t){const a=this.PROVIDERS[this.activeProvider];if(!a)throw new Error(`Scanner provider "${this.activeProvider}" is not configured.`);return a.scan((e||[]).slice(0,this.maxImages),t)}};function ei(e,t){const a={},i=e||{},s=t||{},o=new Set(Array.isArray(s.estimated)?s.estimated:[]);for(const l of["brand","model","color","condition","body_type","subcategory"])i[l]!=null&&String(i[l]).trim()!==""&&(a[l]="image");i.year!=null&&String(i.year).trim()!==""&&(a.model_year=i.year_estimated?"est-image":"image");const n=["title","description","engine","transmission","fuel_type","drive_type","horsepower","mileage","seating_capacity","doors","body_type","model_year","safety_features","storage","ram","processor","display","graphics","os","material","size","gender","platform"];for(const l of n){const d=s[l];d!=null&&(Array.isArray(d)&&!d.length||String(d).trim()!==""&&(a[l]||(a[l]=o.has(l)?"est-spec":"spec")))}return a}function ti(e,t){const a=[...e.options||[]].map(n=>n.value).filter(Boolean);if(a.includes(String(t)))return String(t);const i={petrol:"Gasoline",gas:"Gasoline",gasoline:"Gasoline",unleaded:"Gasoline",ev:"Electric",electric:"Electric","fully electric":"Electric",hybrid:"Hybrid","hybrid electric":"Hybrid","plug-in hybrid":"Plug-in Hybrid",phev:"Plug-in Hybrid",auto:"Automatic",automatic:"Automatic","automatic transmission":"Automatic",manual:"Manual","manual transmission":"Manual",cvt:"CVT","continuously variable":"CVT","dual clutch":"Dual-Clutch",dct:"Dual-Clutch",fwd:"FWD","front-wheel drive":"FWD","front wheel drive":"FWD",rwd:"RWD","rear-wheel drive":"RWD","rear wheel drive":"RWD",awd:"AWD","all-wheel drive":"AWD","all wheel drive":"AWD","4wd":"4WD","four-wheel drive":"4WD","four wheel drive":"4WD","4x4":"4WD",sedan:"Sedan",saloon:"Sedan",suv:"SUV",hatchback:"Hatchback",coupe:"Coupe",coupé:"Coupe",convertible:"Convertible",wagon:"Wagon",estate:"Wagon",pickup:"Pickup","pick up":"Pickup",van:"Van",truck:"Truck","sports car":"Sports Car",motorcycle:"Motorcycle",yacht:"Yacht","like new":"Used - Like New","used - like new":"Used - Like New"},s=String(t).toLowerCase().trim();return i[s]?i[s]:a.find(n=>n.toLowerCase().includes(s)||s.includes(n.toLowerCase()))||null}function ai(e,t){const a=e.closest("div"),i=a&&a.querySelector(".lbl");if(!i)return;const s=document.createElement("span");s.className="scan-src ml-2 text-[9px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded align-middle";const o={image:["📷 image","bg-sky-500/15 text-sky-300 border border-sky-500/30"],"est-image":["≈ image (est.)","bg-amber-500/15 text-amber-300 border border-amber-500/30"],spec:["📚 spec lookup","bg-violet-500/15 text-violet-300 border border-violet-500/30"],"est-spec":["≈ spec (est.)","bg-amber-500/15 text-amber-300 border border-amber-500/30"]},[n,l]=o[t]||["AI","bg-gray-500/15 text-gray-300 border border-gray-500/30"];s.textContent=n,s.classList.add(...l.split(" ")),i.appendChild(s)}function ii(e){const t=[];return e.year&&t.push(e.year),e.brand&&t.push(e.brand),e.model&&t.push(e.model),!e.model&&e.body_type&&t.push(e.body_type),t.join(" ")||e.detected_name||""}function si(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.sources?e.sources:{},s=[];document.querySelectorAll("#product-form .scan-src").forEach(l=>l.remove());const o=l=>Array.isArray(l)?l.join(", "):String(l??"").trim(),n=(l,d,c,g)=>{if(d==null||o([d])==="")return;const y=document.querySelector(`#product-form [name="${l}"]`);if(!y)return;let b=String(d);if(c&&!c.includes(b)){const f=ti(y,b);if(f===null)return;b=f}y.value=b,s.push(l),ai(y,i[l]||g||"ai")};return n("brand",t.brand,null,"image"),n("model",t.model,null,"image"),n("color",t.color,null,"image"),n("condition",t.condition,Ka,"image"),n("subcategory",t.subcategory,null,"image"),n("body_type",t.body_type||a.body_type,Ya),n("model_year",t.year||a.model_year,null,t.year?"image":"spec"),n("title",a.title||ii(t),null,"spec"),n("description",a.description,null,"spec"),n("engine",a.engine,null,"spec"),n("transmission",a.transmission,Ja,"spec"),n("fuel_type",a.fuel_type,Xa,"spec"),n("drive_type",a.drive_type,Qa,"spec"),n("horsepower",a.horsepower,null,"spec"),n("mileage",a.mileage,null,"spec"),n("seating_capacity",a.seating_capacity,null,"spec"),n("doors",a.doors,null,"spec"),n("safety_features",o(a.safety_features),null,"spec"),n("storage",a.storage,null,"spec"),n("ram",a.ram,null,"spec"),n("processor",a.processor,null,"spec"),n("display",a.display,null,"spec"),n("graphics",a.graphics,null,"spec"),n("os",a.os,null,"spec"),n("material",a.material,null,"spec"),n("size",a.size,null,"spec"),n("gender",a.gender,null,"spec"),n("platform",a.platform,null,"spec"),Fe(),{filled:s,sources:i}}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){p("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=document.getElementById("scan-ai-report"),s=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(d=>d.value).filter(Boolean);if(!s.length){p("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",n=(d,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),c&&a.classList.add(c),a.textContent=d)},l=d=>{i&&(i.innerHTML=d||"",i.classList.toggle("hidden",!d))};try{const d=await V.getConfig();if(!String(d.gemini_key||d.gemini_api_key||"").trim()){n("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),p("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),l(""),n("Step 1/2 — Identifying the actual product from your images…","text-blue-300");try{const d=await Za.scan(s,{category:e.dataset.category||""}),c=d?d.identification:null;if(!c||c.identified===!1){n(c&&c.reason?`Could not identify the product: ${r(c.reason)}`:"The AI could not read these images. Make sure the photos clearly show the product, then try again.","text-amber-300"),p("AI could not identify the product in the images.","error");return}const g=[c.year,c.brand,c.model].filter(Boolean).join(" ")||c.detected_name||"identified product",y=si(d),b=y.filled,f=y.sources||{},m=W=>Object.entries(f).filter(([,j])=>j===W).map(([j])=>j),h=m("image"),P=m("est-image"),U=m("spec"),G=m("est-spec");let v=`Identified: ${r(g)} — filled ${b.length} field${b.length>1?"s":""}. Review & edit, then press SAVE / UPDATE.`;c.year_estimated&&(v+=" The model year is an AI estimate — please confirm it."),n(v,"text-emerald-300");const T=(W,j,ne)=>W.length?`<li><span class="font-bold ${ne}">${j}:</span> ${W.map(r).join(", ")}</li>`:"";l(`<div class="text-xs space-y-1 rounded-xl border border-white/10 bg-white/5 p-3">
      <p class="font-bold text-white">Scan report — where each value came from</p>
      <ul class="list-disc list-inside text-gray-300">
        ${T(h,"📷 From image","text-sky-300")}
        ${T(P,"≈ From image (estimated)","text-amber-300")}
        ${T(U,"📚 Spec lookup for "+r(g),"text-violet-300")}
        ${T(G,"≈ Spec lookup (estimated)","text-amber-300")}
        ${b.length===0?'<li class="text-amber-300">No fields could be filled — review the images and scan again.</li>':""}
      </ul>
    </div>`),p(b.length?`AI filled ${b.length} fields for ${g}. Review, then save.`:"AI scan finished.",b.length?"success":"info")}catch(d){const c=String(d?.message||d),g=/key|api|configured|settings|vision/i.test(c);n(g?"Gemini could not scan right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),p("AI scan failed.","error")}finally{t&&(t.disabled=!1,t.innerHTML=o),window.lucide&&lucide.createIcons()}};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const n=new FormData(i),l={};for(const[b,f]of n.entries())b==="images"?(l.images=l.images||[],f&&!String(f).startsWith("blob:")&&l.images.push(String(f))):b==="tags"?(l.tags=l.tags||[],l.tags.push(f)):l[b]=f;l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=n.get("action")==="draft",c=b=>Be(b),g=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors"],m={};for(const h of f){const P=b[h];m[h]=P!=null&&String(P).trim()!==""?P:null}if(b.safety_features){const h=c(b.safety_features);m.safety_features=h.length?h:null}return m};let y;if(a){let b=J((window._productsData||[]).find(A=>A.property_id===a));if(!b){const{data:A}=await u.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=A?J(A):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(A,Se)=>{const Jt=A===""||A==null?"":A,Xt=Se===""||Se==null?"":Se;return String(Jt).trim()===String(Xt).trim()},m={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type","seating_capacity","doors"].forEach(A=>{f(l[A],b[A])||(m[A]=l[A]==null||l[A]===""?null:l[A])});const h=l.price===""||l.price==null?null:parseFloat(l.price);f(h,b.price)||(m.price=h==null?b.price:Math.max(B,Math.min(N,h)));const P=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);f(P,b.stock_quantity)||(m.stock_quantity=Number.isFinite(P)?P:null);const U=c(l.features_text);f(U.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(m.features=U);const G=l.tags||[];f(G.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(m.tags=G);const v=c(l.highlights_text);f(v.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(m.highlights=v);const T=c(l.seo_keywords_text);f(T.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(m.seo_keywords=T);const W=l.images||[];f(W.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(m.images=W);const j=l.is_featured==="on";!!b.is_featured!==j&&(m.is_featured=j);const ne=d?!1:l.is_active==="on"||(l.images||[]).length>=24;!!b.is_active!==ne&&(m.is_active=ne);const Yt=g(l),at={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Yt};if(JSON.stringify(at)!==JSON.stringify(b.specifications||{})&&(m.specifications=at),Object.keys(m).length===0){p("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Re(t,a))}catch{}s&&(s.disabled=!1,s.textContent=o);return}const it={...b,...m,property_id:a,updated_at:new Date().toISOString()};if({error:y}=await u.from("showroom_listings").upsert(it,{onConflict:"property_id"}),y&&Le(y,()=>Ae(it),"Product update")){s&&(s.disabled=!1,s.textContent=o);return}p(d?"Draft saved!":`Saved & published — your showroom shows it now (${Object.keys(m).length} change${Object.keys(m).length>1?"s":""}).`)}else{const b=parseInt(l.required_image_count||"0",10)||(Ye.includes(t)?24:0);if(Rt(b,l.images||[],"This listing"),!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!l.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(B,Math.min(N,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:l.is_active==="on"||(l.images||[]).length>=24,is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:c(l.features_text).length?c(l.features_text):l.tags||[],tags:l.tags||[],highlights:c(l.highlights_text),seo_keywords:c(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:g(l)},m=He();if(f.property_id=m,{error:y}=await u.from("showroom_listings").insert(f),y&&Le(y,()=>Ae({...f,property_id:f.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=o);return}p(d?"Draft saved!":"Published! Your showroom shows this product now.")}try{localStorage.removeItem(Re(t,a))}catch{}closeProductFormModal(),S()}catch(n){p("Error: "+n.message,"error"),s&&(s.disabled=!1,s.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await u.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=lt(e)),i||(i=(window._productsData||[]).find(s=>s.property_id===e)||null),!i)return p("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=J((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await u.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return L(i)?p(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):p(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");p(t?"Product published":"Product unpublished"),S()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await u.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:o,updated_at:n,...l}=a,d=He();await u.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),S())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await u.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),S())};const oi=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function jt(){const e=document.getElementById("content");try{const{data:t,error:a}=await u.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?dt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(D)){const s=new Set(i.map(n=>n.property_id)),o=D.filter(n=>n.listing_type==="property"&&n.property_id&&!s.has(n.property_id));o.length&&(i=i.concat(o))}i.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=bt("property","Real Estate"),i=e.country_code||"US",s=e.currency||qe(i);C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${oi.map(o=>`<option value="${o}" ${e.property_type===o?"selected":""}>${o}</option>`).join("")}
            </select></div>
    ...
    </div>`),Je(),Xe(),Dt("ppf-price"),window.syncPropertyCountry=function(){rt("ppf")},rt("ppf"),De("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>De("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),o=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),n=t?0:parseInt(i.required_image_count||"24",10)||24;Rt(n,s,"This property");const l={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(B,Math.min(N,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:o,images:s,highlights:Be(i.highlights_text),seo_keywords:Be(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){l.property_id=t;const c=J((window._propertiesData||[]).find(g=>g.property_id===t)||(window._productsData||[]).find(g=>g.property_id===t));({error:d}=await u.from("showroom_listings").upsert({...c,...l},{onConflict:"property_id"}))}else l.property_id=He(),{error:d}=await u.from("showroom_listings").insert(l);d&&Le(d,()=>Ae({...l,property_id:t||l.property_id}),t?"Property update":"Property publish")||(p(t?"Property updated!":"Property published!"),q(),jt())};window.editProperty=async function(e){const{data:t,error:a}=await u.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=lt(e)),i||(i=(Array.isArray(D)?D.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const ri=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Ot(){const e=document.getElementById("content");try{const{data:t}=await u.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>ni(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}function ni(e){return`<tr class="order-row" data-status="${e.status}" data-search="${r(e.order_number)} ${r(e.full_name)} ${r(e.email)}">
    ...
    <td>${I(e.status)}</td>
    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${F(e.created_at)}</span></td>
    <td>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",xt(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",H(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${r(i)||"—"}</p></div>`).join("")}
          </div>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await u.from("payment_receipts").update({status:t}).eq("id",e);if(a){p(a.message,"error");return}p("Order status updated"),q(),Ot()};async function li(){const e=document.getElementById("content");try{const{data:t}=await u.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(i=>`<tr class="cust-row" data-search="${r(i.display_name)} ${r(i.user_id)}">
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${F(i.created_at)}</span></td>
                    <td>
      ...
      <div class="modal-box">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${F(t.created_at)} · ${r(t.country_code||"Unknown country")}</p>
          </div>
        </div>
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${r(i.order_number)}</p><p class="text-[10px] text-gray-500">${H(i.created_at)}</p></div>
    ...
    </div>`)};async function Qe(){const e=document.getElementById("content");try{const{data:t}=await u.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?Q("star","No Reviews","Customer reviews will appear here."):a.map(s=>di(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}function di(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1">
          <span class="text-amber-400 font-bold text-sm">${t}</span>
          <span class="text-xs text-gray-500">${F(e.created_at)}</span>
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${H(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.markMsgRead=async function(e){await u.from("support_messages").update({is_read:!0}).eq("id",e),p("Marked as read"),Nt()};async function ve(){const e=document.getElementById("content");try{const{data:t}=await u.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${F(i.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.showAddCouponModal=function(){C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:s}=await u.from("coupons").insert(i);if(s){p(s.message,"error");return}p("Coupon created!"),q(),ve()};window.toggleCoupon=async function(e,t){await u.from("coupons").update({is_active:t}).eq("id",e),p(t?"Coupon activated":"Coupon deactivated"),ve()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await u.from("coupons").delete().eq("id",e),p("Coupon deleted"),ve())};async function ci(){const e=document.getElementById("content");try{const{data:t}=await u.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}const qt=["Featured","Sponsored","Featured Collection","Discover","Promotion"],ui=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let le=null;function pi(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${r(e)}</span>`}function mi(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${r(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${r(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${r(e.link_target||"")}</span>`}function bi(e){return e.video_url?`<video src="${r(e.video_url)}" ${e.poster_url?`poster="${r(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${r(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Ht(){if(le)return le;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const n=o.category||"";n&&!t.has(n)&&(t.add(n),a.push(n))};try{D.forEach(i)}catch{}try{const{data:o,error:n}=await u.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!n&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),le={products:e,categories:a,sections:ui},le}async function gi(e){try{const{data:{session:t}}=await u.auth.getSession();if(!t)return p("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),s=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await u.storage.from("advertisements").upload(s,e,{contentType:e.type,upsert:!1});if(o)return p("Upload failed: "+o.message,"error"),null;const{data:n}=u.storage.from("advertisements").getPublicUrl(s);return{url:n.publicUrl,isVideo:i}}catch{return p("Upload failed","error"),null}}function pe(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),s=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),s&&(s.value=t?"":e),a.innerHTML=t?`<video src="${r(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${r(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){p("Choose an image or video file","error");return}const i=await gi(t);if(!i){e.value="";return}pe(i.url,i.isVideo);const s=document.getElementById("ad-media-url");s&&(s.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);pe(t,a)};function Ze(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let s="";t==="product"?s='<option value="">Select a product…</option>'+e.products.map(o=>`<option value="${r(o.id)}" ${String(a)===String(o.id)?"selected":""}>${r(o.id)} — ${r((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?s='<option value="">Select a category…</option>'+e.categories.map(o=>`<option value="${r(o)}" ${a===o?"selected":""}>${r(o)}</option>`).join(""):t==="section"&&(s='<option value="">Select a section…</option>'+e.sections.map(o=>`<option value="${r(o.id)}" ${a===o.id?"selected":""}>${r(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${s}</select>`}function Gt(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${qt.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";Ze(e,a,"")};window.showAddAdModal=async function(){const e=await Ht();window._adLinkCache=e,C(Gt(null)),Ze(e,"none","")};window.showEditAdModal=async function(e){const t=await Ht();window._adLinkCache=t;const{data:a}=await u.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){p("Ad not found","error");return}C(Gt(a)),a.image_url?pe(a.image_url,!1):a.video_url&&pe(a.video_url,!0),Ze(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",s={title:a.title,description:a.description||"",ad_label:qt.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!s.image_url&&!s.video_url){p("Add an image or video for the ad","error");return}const o=e.target.querySelector('button[type="submit"]');o&&(o.disabled=!0);try{if(i){const{error:n}=await u.from("promotions").update(s).eq("id",i);if(n)throw n;p("Ad updated!")}else{const{error:n}=await u.from("promotions").insert(s);if(n)throw n;p("Ad created!")}}catch(n){p(n.message||"Save failed","error"),o&&(o.disabled=!1);return}q(),te()};window.togglePromo=async function(e,t){const{error:a}=await u.from("promotions").update({is_active:t}).eq("id",e);if(a){p(a.message,"error");return}p(t?"Ad activated":"Ad deactivated"),te()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await u.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const s=a||[],o=s.findIndex(c=>c.id===e),n=o+t;if(o<0||n<0||n>=s.length){p("Already at the edge","info");return}const l=s[o],d=s[n];await u.from("promotions").update({sort_order:d.sort_order}).eq("id",l.id),await u.from("promotions").update({sort_order:l.sort_order}).eq("id",d.id),p("Order updated")}catch(a){p(a.message||"Reorder failed","error")}te()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await u.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(s=>{const o=/\/object\/public\/advertisements\/(.+)$/.exec(s);return o?decodeURIComponent(o[1]):null}).filter(Boolean);if(i.length)try{await u.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await u.from("promotions").delete().eq("id",e);if(a)throw a;p("Ad deleted")}catch(t){p(t.message||"Delete failed","error")}te()}};async function te(){const e=document.getElementById("content");try{const{data:t}=await u.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    ${mi(i)}
                    <span class="text-[10px] text-gray-500">${F(i.start_date)}${i.start_date?" → ":""}${F(i.end_date)}</span>
                  </div>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.renderAds=te;const xe=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],M={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Wt(){const e=document.getElementById("content");try{let t=function(o){const n=s===o.id,l=i[o.kf],d=i[o.mf]||o.dm;return`
        <div class="glass-soft border ${n?M.border[o.color]+" "+M.bg[o.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${o.id}">
          <div class="flex items-start justify-between gap-2">
            <div class="flex items-center gap-2.5 min-w-0">
              <div class="w-8 h-8 ${M.bg[o.color]} rounded-lg flex items-center justify-center shrink-0">
                <i data-lucide="${o.icon}" class="w-4 h-4 ${M.text[o.color]}"></i>
              </div>
              <div class="min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  <h3 class="text-xs font-black text-white">${r(o.name)}</h3>
                  <span class="text-[8px] font-black uppercase px-1.5 py-0.5 rounded-full ${M.badge[o.color]}">${o.tag}</span>
                </div>
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${n?M.text[o.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${o.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${M.text[o.color]} hover:underline flex items-center gap-0.5">
        ...
        </div>`};const{data:a}=await u.from("ai_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.active_provider||"gemini";e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.highlightAI=function(e){xe.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?M.border[t.color]+" "+M.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const s=a.querySelector("input[type=radio] + span");s&&(s.className=`text-[9px] font-bold ${i?M.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};xe.forEach(s=>{a[s.mf]&&(i[s.mf]=a[s.mf]);const o=(a[s.kf]||"").trim();o&&!o.startsWith("••••")&&o!==""&&(i[s.kf]=o)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key);try{const{data:s}=await u.from("ai_settings").select("id").limit(1).maybeSingle();let o;if(s?.id?{error:o}=await u.from("ai_settings").update(i).eq("id",s.id):{error:o}=await u.from("ai_settings").insert(i),o){p("Save failed: "+o.message,"error"),console.error("[AI Save]",o);return}await V.reload(),p("✅ AI settings saved!","success"),setTimeout(()=>Wt(),600)}catch(s){p("Unexpected error: "+s.message,"error"),console.error("[AI Save]",s)}};const V={_cfg:null,async reload(){const{data:e,error:t}=await u.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async chat(e,{maxTokens:t=2e3}={}){const a=await this.getConfig();if(!String(a.gemini_key||"").trim())throw new Error("No AI provider configured. Go to AI Settings and add your Gemini API key.");const i=e[e.length-1],s={action:"chat",message:String(i?.content||"").trim(),history:e.slice(0,-1).map(n=>({role:n.role,content:String(n.content||"")})),provider_override:"gemini",max_tokens:t},o=await this._callEdge(s);if(o&&o.response)return{text:o.response,provider:"Google Gemini",model:o.model||a.gemini_model};throw new Error(String(o?.error||"Gemini is unavailable."))},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return xe.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is — the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
- Respond with valid JSON only.`,i=[];for(const s of(e||[]).slice(0,t.maxImages||3)){const o=await this._fetchImageAsDataUrl(s,1024);o&&i.push(o)}if(!i.length)throw new Error("Could not read the uploaded images.");try{const s=await this._tryBrowserGeminiVision(a,i);if(s)return s}catch{}try{const s=await this._callEdge({action:"vision",images:i,prompt:a,max_tokens:4096});if(s&&s.success&&s.text){const o=Pe(s.text);if(o)return{...o,_aiProvider:s.provider,_aiModel:s.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(s&&s.error||"Vision service unavailable.")}catch{}return null},async _runVisionPrompt(e,t,{maxImages:a=3,maxTokens:i=4096}={}){const s=[];for(const o of(t||[]).slice(0,a)){const n=await this._fetchImageAsDataUrl(o,1024);n&&s.push(n)}if(!s.length)throw new Error("Could not read the uploaded images.");try{const o=await this._tryBrowserGeminiVision(e,s);if(o)return o}catch{}try{const o=await this._callEdge({action:"vision",images:s,prompt:e,max_tokens:i});if(o&&o.success&&o.text){const n=Pe(o.text);if(n)return{...n,_aiProvider:o.provider,_aiModel:o.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(o&&o.error||"Vision service unavailable.")}catch{}return null},async identifyProduct(e,t={}){return this._runVisionPrompt(`STAGE 1 — IDENTIFY THE EXACT PRODUCT.
...
`).trim();if(!g)continue;const y=Pe(g);if(y)return{...y,_aiProvider:"Gemini (browser)",_aiModel:o}}catch{}return null}};function yi(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const s=i.indexOf(",");t(s>=0?i.slice(s+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=V;window.showAiStatusModal=async function(){const e=await V.getStatus(),t=e.filter(a=>a.hasKey);C(`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const t=document.getElementById("ai-test-output");t.classList.remove("hidden"),t.textContent="⏳ Asking Gemini…";try{const a=await V.prompt(e);t.textContent=`✓ [${a.provider} · ${a.model}]

${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function Pe(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const o=t.slice(i,s+1);try{return JSON.parse(o)}catch{return null}}async function fi(){const e=document.getElementById("content");try{const{data:t}=await u.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.saveContent=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),{error:i}=await u.from("site_settings").upsert({id:1,...a});if(i){p(i.message,"error");return}p("Content settings saved!")};async function hi(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([u.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),u.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),u.from("profiles").select("user_id,created_at",{count:"exact"})]),s=t.data||[],o=s.filter(c=>["approved","payment_approved","delivered"].includes(c.status)).reduce((c,g)=>c+(parseFloat(g.amount)||0),0),n=s.length>0?(s.filter(c=>c.status!=="cancelled").length/s.length*100).toFixed(1):0,l={};(a.data||[]).forEach(c=>{l[c.category]=(l[c.category]||0)+1});const d=Object.entries(l).sort((c,g)=>g[1]-c[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${E("Total Revenue",`$${o.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${E("Total Orders",s.length,"shopping-bag","blue")}
          ${E("Customers",i.count||0,"users","violet")}
          ${E("Conversion Rate",n+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${d.length===0?'<p class="text-xs text-gray-500 text-center py-8">No data</p>':d.map(([c,g])=>`
              <div class="flex items-center gap-3 py-1.5">
                <span class="text-xs text-gray-300 flex-1 truncate">${r(c)}</span>
      ...
      </div>`,window.lucide&&lucide.createIcons(),Tt(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}async function vi(){const e=document.getElementById("content"),{data:t}=await u.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveEmailSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,s]of t.entries())a[i]=s;["email_order_placed","email_order_shipped","email_order_delivered","email_review_request"].forEach(i=>{i in a?a[i]=!0:a[i]=!1}),await u.from("site_settings").upsert({id:1,...a}),p("Email settings saved!")};async function we(){const e=document.getElementById("content");e&&(e.innerHTML=se());try{const[t,a,i]=await Promise.all([u.from("admin_security_logs").select("*").order("created_at",{ascending:!1}).limit(50),u.from("admin_2fa").select("enabled,backup_codes,created_at").eq("user_id",w.user?.id).maybeSingle(),u.auth.mfa.listFactors()]),s=t.data||[],o=a.data||{},n=(i.data?.totp||[])[0],l=!!n&&n.status==="verified",d=(o.backup_codes||[]).filter(c=>!c.used).length;e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${d} · Enrolled: ${F(o.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody>
                ${s.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':s.map(c=>{const g=["login_success","login_2fa_success"].includes(c.event_type),y=["login_failed","login_denied","login_backup_code_used"].includes(c.event_type),b=g?"text-emerald-400":y?"text-red-400":"text-gray-300",f={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[c.event_type]||c.event_type;return`<tr>
                      <td><span class="text-xs font-bold ${b}">${r(f)}</span></td>
                      <td><span class="text-xs font-mono text-gray-300">${r(c.ip_address||"—")}</span></td>
                      <td class="hidden sm:table-cell"><span class="text-xs text-gray-500 max-w-[160px] block truncate">${r((c.user_agent||"—").slice(0,50))}</span></td>
                      <td><span class="text-xs text-gray-500">${H(c.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
    ...
    </div>`),window.lucide&&lucide.createIcons();try{const{data:e,error:t}=await u.auth.mfa.enroll({factorType:"totp",friendlyName:"Weverse Admin"});if(t)throw t;const a=e.totp.qr_code,i=e.totp.secret,s=e.id;document.getElementById("2fa-setup-content").innerHTML=`
      <div class="space-y-5">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${H(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}async function _i(){const e=document.getElementById("content");try{const{data:t}=await u.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${r(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${H(a.created_at)}</p></div>
                ${I(a.status||"completed")}
              </div>`).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.exportProducts=async function(){const{data:e}=await u.from("showroom_listings").select("*"),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download=`kco-products-${new Date().toISOString().slice(0,10)}.json`,a.click(),p("Products exported!")};window.exportOrders=async function(){const{data:e}=await u.from("payment_receipts").select("*").order("created_at",{ascending:!1});if(!e||!e.length){p("No orders to export","info");return}const t=Object.keys(e[0]).join(","),a=e.map(o=>Object.values(o).map(n=>`"${String(n||"").replace(/"/g,'""')}"`).join(",")).join(`
`),i=new Blob([t+`
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),p("Orders exported!")};async function ki(){const e=document.getElementById("content"),{data:t}=await u.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,s]of t.entries())a[i]=s;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await u.from("site_settings").upsert({id:1,...a}),p("Settings saved!")};async function _e(){const e=document.getElementById("content");e&&(e.innerHTML=se());try{const{data:t}=await u.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",s=a.homepage_banner_alt||"Homepage header banner",o=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}async function ke(){const e=document.getElementById("content");e&&(e.innerHTML=se());try{let t=function(l,d,c,g="",y="blue"){const b=!!(c&&c.trim());return`
        <div class="glass-soft border border-${y}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${b?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
                <img src="${r(c)}" alt="${r(l)}" class="max-h-20 max-w-full object-contain p-2" onerror="this.closest('div').innerHTML='<p class=&quot;text-xs text-gray-600 text-center&quot;>Image broken</p>'">
          ...
          <input type="hidden" name="${d}" id="val-${d}" value="${r(c||"")}">
          <div class="flex gap-2">
            <input class="input-field text-xs flex-1 ${b?"":"hidden"}" id="url-${d}" value="${r(c||"")}" placeholder="Or paste image URL" oninput="document.getElementById('val-${d}').value=this.value;updateLivePreview()">
        ...
        </div>`};const{data:a}=await u.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.brand_name||i.site_name||ft,o=i.brand_slogan||i.site_tagline||ht,n=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[et()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>$i(t,a)).join("")}
    ...
    </div>`,tt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(et()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[et()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),tt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=be.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||ct(t),tt(),renderManualPaymentAccountsEditor()};async function Ne(){const e=document.getElementById("content");e&&(e.innerHTML=se());try{const{data:t}=await u.from("site_settings").select("*").limit(1).maybeSingle(),i={...ia()||{},...t||{}};window._manualPaymentAccounts=sa(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${r(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s={},o=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,d]of Object.entries(i))o.includes(l)?d&&!d.startsWith("•")&&d.trim()!==""&&(s[l]=d.trim()):s[l]=d;const{error:n}=await u.from("site_settings").upsert({id:1,...s});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),n){p(n.message,"error");return}p("Deploy & payment settings saved!"),$e()};async function Kt(e="deploy"){const{data:t}=await u.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return p("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function O(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:s,error:o}=await u.from("deployment_history").insert({version:a,status:e,triggered_by_email:w.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:s,error:o}}function X(e,t,a,i){if(!e)return;e.disabled=t;const s=e.querySelector("p.text-xs.font-black");s&&(s.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");X(t,!0,"Deploying…","Deploy Now");try{const a=await Kt("deploy");if(!a.ok)return;const{settings:i,hookUrl:s}=a;await O("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Deployment queued from admin UI"});const o=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)p("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await O("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Webhook accepted deployment request"}),setTimeout(()=>$e(),400);else{const n=`Webhook returned error: ${o.status}`;p(n,"error"),await O("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,errorMessage:n})}}catch(a){p("Deploy failed: "+a.message,"error"),await O("failed",{mode:"deploy",errorMessage:a.message})}finally{X(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");X(t,!0,"Rebuilding…","Rebuild Site");try{const a=await Kt("rebuild");if(!a.ok)return;const{settings:i,hookUrl:s}=a;await O("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Rebuild requested from admin UI"});const o=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)p("🔄 Rebuild triggered successfully."),await O("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Webhook accepted rebuild request"}),setTimeout(()=>$e(),400);else{const n=`Rebuild webhook error: ${o.status}`;p(n,"error"),await O("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,errorMessage:n})}}catch(a){p("Rebuild failed: "+a.message,"error"),await O("failed",{mode:"rebuild",errorMessage:a.message})}finally{X(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");X(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){p("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){p("Publish failed: "+a.message,"error")}finally{X(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:i,error:s}=await u.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(s)return L(s)?p("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):p("Could not load listings to reindex: "+s.message,"error");const o=i||[];if(!o.length){p("No listings to reindex.");return}let n=0,l=0,d=!1;const c=40;for(let g=0;g<o.length;g+=c){const y=o.slice(g,g+c),{error:b}=await u.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",y.map(f=>f.id));b?(L(b)&&(d=!0),l+=y.length):n+=y.length,t&&(t.textContent=`Reindexing… ${Math.min(g+c,o.length)}/${o.length}`)}if(d){p(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${n}/${o.length} done)`,"error");return}p(`Search index rebuilt for ${n} listing${n!==1?"s":""}${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){p("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(D)||!D.length){p("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:i,error:s}=await u.from("showroom_listings").select("property_id");if(s)return L(s)?p("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):p("Could not load existing listings: "+s.message,"error");const o=new Set((i||[]).map(y=>y.property_id)),n=D.filter(y=>y&&y.property_id&&!o.has(y.property_id));if(!n.length){p("Showroom already in sync — no new listings to add.");return}let l=0,d=0,c=!1;const g=20;for(let y=0;y<n.length;y+=g){const b=n.slice(y,y+g).map(m=>({property_id:m.property_id,listing_type:m.listing_type||"product",category:m.category||null,subcategory:m.subcategory||null,title:m.title||"Untitled Listing",description:m.description||"",price:parseFloat(m.price)||0,currency:m.currency||"USD",country:m.country||"",country_code:m.country_code||"",state:m.state||"",city:m.city||"",town:m.town||"",product_location:m.product_location||"",latitude:m.latitude??null,longitude:m.longitude??null,property_type:m.property_type||null,listing_status:m.listing_status||"sale",bedrooms:m.bedrooms??null,bathrooms:m.bathrooms??null,building_size:m.building_size||"",land_size:m.land_size||"",parking_spaces:m.parking_spaces??null,furnished:m.furnished||"",features:Array.isArray(m.features)?m.features:[],tags:Array.isArray(m.tags)?m.tags:[],highlights:Array.isArray(m.highlights)?m.highlights:[],seo_keywords:Array.isArray(m.seo_keywords)?m.seo_keywords:[],images:Array.isArray(m.images)?m.images:[],brand:m.brand||null,color:m.color||null,size:m.size||null,condition:m.condition||null,warranty:m.warranty||null,availability_status:m.availability_status||"In Stock",stock_quantity:m.stock_quantity!=null?parseInt(m.stock_quantity,10):null,is_active:m.is_active!==!1,is_featured:!!m.is_featured,is_ai_generated:!!m.is_ai_generated,ai_generated_fields:Array.isArray(m.ai_generated_fields)?m.ai_generated_fields:[],specifications:m.specifications||{},created_at:m.created_at||new Date().toISOString()})),{error:f}=await u.from("showroom_listings").insert(b);f?(L(f)&&(c=!0),d+=b.length):l+=b.length,t&&(t.textContent=`Syncing… ${Math.min(y+g,n.length)}/${n.length}`)}if(c){p(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${l}/${n.length} added)`,"error");return}p(`Showroom synced: ${l} new listing${l!==1?"s":""} added to the database${d?` (${d} failed)`:""}.`,d?"error":"success")}catch(i){p("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){p("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();p(`✓ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?p("Repository not found. Check username and repo name.","error"):p("GitHub API error: "+a.status,"error")}catch{p("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ie=30,_={category:null,page:0,query:""};async function ae(){const e=document.getElementById("content");if(!e)return;await ma();const t=new Set(pt()),a=ca();_.category||(_.category=a[0]?.slug||null);const i=ut(_.category),s=i?i.count:0,o=_.query.trim().toLowerCase(),n=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(i)if(o){const f=Math.min(s,8e3);for(let m=0;m<f&&c.length<ie;m++){const h=st(i.slug,m);if(!h)continue;`${h.property_id} ${h.title} ${h.subcategory||""} ${h.category||""}`.toLowerCase().includes(o)&&c.push(h)}}else{const f=_.page*ie,m=Math.min(f+ie,s);for(let h=f;h<m;h++){const P=st(i.slug,h);P&&c.push(P)}}const g=c.length?c.map(f=>{const m=t.has(f.property_id),h=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${m?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            ${I(!m)}
            <button onclick="catalogToggle('${r(f.property_id)}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${m?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30 hover:bg-emerald-500/25":"bg-amber-500/10 text-amber-300 border-amber-500/30 hover:bg-amber-500/20"}">
              ${m?"Show":"Hide"}
            </button>
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',y=o?1:Math.max(1,Math.ceil(s/ie)),b=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${o?`${c.length} match`:`${s.toLocaleString()} items in ${r(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){_.category=e,_.page=0,_.query="",ae()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");_.query=e?e.value:"",_.page=0,ae()};window.catalogPage=function(e){const t=ut(_.category),a=t?t.count:0,i=_.query.trim()?1:Math.max(1,Math.ceil(a/ie));_.page=Math.max(0,Math.min(i-1,_.page+e)),ae()};window.catalogToggle=async function(e){const t=!pt().includes(e),a=await ua(e,t);p(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),ae()};window.catalogResetHidden=async function(){await pa(),p("All hidden catalog listings restored"),ae()};async function nt(){window.lucide&&lucide.createIcons(),wt(),await Ca(),u.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){w.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",nt):nt();
