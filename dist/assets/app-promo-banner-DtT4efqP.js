const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/catalog-hidden-store-BQYmdyo6.js","assets/showroom-data-CddgSZPd.js"])))=>i.map(i=>d[i]);
import{D as Z,l as k,b as L}from"./promo-backgrounds-NxlbOFU-.js";import{g as x,D as C,l as M}from"./site-content-BryTgIB_.js";import{l as X,g as ee,i as te,c as ae,_ as re,f as j}from"./showroom-data-CddgSZPd.js";const ie="/verified-badge.svg",O="Weverse Online Shop",ne="GLOBAL SHOPPING • WORLDWIDE DELIVERY",se="/w-logo.svg",oe=(e="weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")=>`<svg viewBox="0 0 24 24" class="${e}" aria-label="Verified" role="img" data-weverse-badge="true"><circle cx="12" cy="12" r="11" fill="#3b82f6"/><path d="M10.8 15.6 7.4 12.2l1.5-1.5 1.9 1.9 3.9-3.9 1.5 1.5-5.4 5.4z" fill="#fff"/></svg>`,V=(e="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8")=>`  <svg viewBox="0 0 24 24" class="${e}" fill="none" aria-hidden="true"><path d="M3 5l4.5 14L12 8l4.5 11L21 5" stroke="#ffffff" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/></svg>`,A="weverse_brand_v1",le="#0a0a0a",de="#ffffff";(function(){if(document.getElementById("wv-brand-base"))return;const t=document.createElement("style");t.id="wv-brand-base",t.textContent=".brand-name{background:none!important;background-image:none!important;-webkit-background-clip:initial!important;background-clip:initial!important;-webkit-text-fill-color:#0a0a0a!important;color:#0a0a0a!important}",(document.head||document.documentElement).appendChild(t)})();function ce(e){const t=(e||"").toString().match(/rgba?\(([^)]+)\)/);if(!t)return null;const a=t[1].split(",").map(r=>parseFloat(r));return a.length<3?null:{r:a[0],g:a[1],b:a[2]}}function ue(e){const t=(e||"").toString().match(/rgba?\(([^)]+)\)/);if(!t)return 0;const a=t[1].split(",").map(r=>parseFloat(r));return a.length>=4?a[3]:1}function pe(e){const t=[];let a=e;for(;a;){let o;try{o=getComputedStyle(a)}catch{break}if(t.push(o),ue(o.backgroundColor)>.03)break;a=a.parentElement}const r=t.length?t[t.length-1].backgroundColor:"",i=ce(r);return i?(.2126*i.r+.7152*i.g+.0722*i.b)/255:1}function H(){document.querySelectorAll(".brand-name, .brand-tagline-1, .brand-tagline-2").forEach(e=>{const t=pe(e)<.5?de:le;e.style.setProperty("color",t,"important"),e.style.setProperty("-webkit-text-fill-color",t,"important"),e.style.background="none",e.style.webkitBackgroundClip="initial",e.style.backgroundClip="initial"})}const he="weverse_brand_override_v1",me=5*60*1e3;async function G(){try{const e=JSON.parse(localStorage.getItem(he)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(A)||"{}");if(e.ts&&Date.now()-e.ts<me&&e.data)return e.data}catch{}try{const e=await x(),{data:t}=await e.from("site_settings").select("brand_name,brand_slogan,brand_logo,brand_badge,brand_favicon,brand_mobile_logo,brand_header_logo,brand_footer_logo,brand_primary_color,brand_secondary_color,brand_tagline_color1,brand_tagline_color2,brand_font,brand_custom_font,brand_website_url,brand_email,site_name,site_tagline,homepage_banner_image,homepage_banner_alt").limit(1).maybeSingle(),a=t||{};return localStorage.setItem(A,JSON.stringify({ts:Date.now(),data:a})),a}catch{return{}}}function D(e){if(!e)return;const t=e.brand_name||e.site_name||O,a=e.brand_slogan||e.site_tagline||ne,r=e.brand_logo||e.brand_header_logo||se,i=e.brand_badge||ie,o=e.brand_favicon||"",n=e.brand_custom_font||e.brand_font||"",s=e.brand_primary_color||"",u=e.brand_secondary_color||"",m=e.brand_tagline_color1||"",d=e.brand_tagline_color2||"";if(fe(e.homepage_banner_image||"",e.homepage_banner_alt||"Homepage header banner"),(m||d)&&(document.querySelectorAll(".brand-tagline-1").forEach(l=>{m&&(l.style.color=m)}),document.querySelectorAll(".brand-tagline-2").forEach(l=>{d&&(l.style.color=d)})),document.title&&!document.title.startsWith(t)&&(document.title=document.title.replace(/^[^|]+\|/,t+" |").replace(/^[^–]+–/,t+" – ")),o){let l=document.querySelector("link[rel~='icon']");l||(l=document.createElement("link"),l.rel="icon",document.head.appendChild(l)),l.href=o}if(s||u||n){const l=n?`'${n}'`:null,f=document.getElementById("brand-css-vars")||(()=>{const y=document.createElement("style");return y.id="brand-css-vars",document.head.appendChild(y),y})();if(f.textContent=`:root {
      ${s?`--brand-primary: ${s};`:""}
      ${u?`--brand-secondary: ${u};`:""}
      ${l?`--brand-font: ${l}, system-ui, sans-serif;`:""}
    }`,n){const y="brand-gf-link";if(!document.getElementById(y)){const b=document.createElement("link");b.id=y,b.rel="stylesheet",b.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(n)}:wght@400;600;700;900&display=swap`,document.head.appendChild(b)}}}document.querySelectorAll("[data-brand]").forEach(l=>{const f=l.dataset.brand;f==="name"&&(l.textContent=t,!l.querySelector("[data-weverse-badge]")&&!l.parentElement?.querySelector("[data-weverse-badge]")&&l.appendChild(Object.assign(document.createElement("span"),{className:"inline-flex items-center ml-1 align-middle",innerHTML:oe("weverse-badge w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 shrink-0")}))),f==="slogan"&&(l.textContent=a),f==="logo"&&(l.src=r,l.alt=t,l.style.display=""),f==="badge"&&(l.src=i,l.alt="Verified",l.style.display=""),f==="tagline"&&(l.textContent=a),f==="footer-logo"&&(e.brand_footer_logo?(l.src=e.brand_footer_logo,l.alt=t):(l.src=r,l.alt=t)),f==="mobile-logo"&&(e.brand_mobile_logo?(l.src=e.brand_mobile_logo,l.alt=t):(l.src=r,l.alt=t))}),document.querySelectorAll('img[data-brand="logo"]').forEach(l=>{const y=l.closest(".text-center")?.querySelector('h1[data-brand="name"]');y&&(y.style.display="none")}),ye(t,a,r,i),ge(t,a,r),_(),H()}function fe(e,t){const a=document.getElementById("homepage-banner-shell"),r=document.getElementById("homepage-banner-image");if(!(!a||!r)){if(!e){r.removeAttribute("src"),r.alt=t,a.classList.add("hidden");return}r.alt=t,r.onload=()=>_(),r.onerror=()=>{a.classList.add("hidden"),_()},r.src!==e&&(r.src=e),a.classList.remove("hidden")}}function _(){const e=document.getElementById("site-header"),t=document.getElementById("site-categories-nav"),a=document.querySelector("main");if(!e||!t||!a)return;const r=Math.ceil(e.getBoundingClientRect().height||e.offsetHeight||0),i=Math.ceil(t.getBoundingClientRect().height||t.offsetHeight||0);t.style.top=`${r}px`;const o=window.innerWidth<640?20:12;a.style.paddingTop=`${r+i+o}px`}function ye(e,t,a,r,i){document.querySelectorAll('header a[href="/"], header a[href="./"], header a[href="index.html"], .brand-link, #brand-link').forEach(n=>{J(n,e,t),n.querySelectorAll('img.brand-logo, img[data-brand="logo"]').forEach(s=>{s.src=a,s.alt=e})}),document.querySelectorAll("header span").forEach(n=>{if(n.classList.contains("brand-tagline-1")||n.classList.contains("brand-tagline-2"))return;const s=n.textContent.trim();(s==="Weverse Online Shop"||s==="KCO Global Online Marketplace"||n.classList.contains("brand-name"))&&(n.textContent=e),(s==="Your Trusted Global Shop"||s.includes("Globally")||s.includes("Worldwide")||n.classList.contains("brand-slogan"))&&(n.textContent=t)}),document.querySelectorAll('[data-brand="badge"], .brand-badge, #brand-badge').forEach(n=>{n.tagName==="IMG"&&(n.src=r,n.alt="Verified",n.style.display="")}),document.querySelectorAll('header a[href="/"] .relative.shrink-0, header a .relative.w-7').forEach(n=>{if(!n.querySelector("img.injected-logo")){const s=document.createElement("img");s.src=a,s.alt=e,s.className="injected-logo w-8 h-8 sm:w-9 sm:h-9 object-contain rounded-lg",s.onerror=()=>s.style.display="none",n.style.display="flex",n.style.alignItems="center",n.innerHTML="",n.appendChild(s)}})}function ge(e,t,a){document.querySelectorAll("footer").forEach(r=>{J(r,e,t),r.querySelectorAll("img.brand-logo, img[data-brand], .footer-logo img").forEach(i=>{i.src=a,i.alt=e})})}function J(e,t,a){const r=document.createTreeWalker(e,NodeFilter.SHOW_TEXT),i=[];let o;for(;o=r.nextNode();){const n=o.textContent.trim();(n==="Weverse Online Shop"||n==="KCO Global Online Marketplace")&&i.push({node:o,value:t}),(n==="Your Trusted Global Shop"||n==="Global Shopping • Worldwide Delivery")&&i.push({node:o,value:a})}i.forEach(({node:n,value:s})=>{n.textContent=n.textContent.replace(n.textContent.trim(),s)})}G().then(D);window.addEventListener("load",()=>G().then(D));window.addEventListener("resize",()=>{_(),H()});window.addEventListener("storage",e=>{e.key===A&&G().then(D)});let xe=0;function Y(){H(),++xe<12&&setTimeout(Y,600)}Y();const E="support@weverseonlineshop.com",be="weverse_brand_v1";function c(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function z(){try{const e=JSON.parse(localStorage.getItem(be)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function ve(){const e=z(),t=e.brand_name||e.site_name||O;return`
    ...
    </section>`}const F=[{id:"trust-shipping",icon:"package",tone:"blue",title:"Shipping & Delivery",body:`
    ...
    </div>`}function _e(){const e=F.slice(0,6),t=F.slice(6),a=r=>r.map(ke).join("");return`
    ...
    </section>`}const Se=[{name:"Megan R.",country:"United States",text:"My order arrived ahead of schedule and the quality was exactly as described. I shop here without any doubt.",verified:!0},{name:"Sarah & James",country:"United Kingdom",text:"Ordered for our whole family and the tracking updates made it feel safe and reliable from checkout to delivery.",verified:!0},{name:"Oliver K.",country:"Germany",text:"The customer support team answered my questions in minutes. Genuinely trustworthy shopping experience.",verified:!0}];function Ce(e){return[1,2,3,4,5].map(t=>`<i data-lucide="star" class="w-3.5 h-3.5 ${t<=e?"fill-amber-400 text-amber-400":"text-slate-500"}"></i>`).join("")}function T(e){const t=String(e.name||"Verified shopper").trim()||"Verified shopper",a=(t.charAt(0)||"V").toUpperCase(),r=[e.country||"",e.verified?"Verified buyer":"",e.date||""].filter(Boolean).join(" · ");return`
    <div class="bg-white/[.07] border border-white/10 rounded-2xl p-4 backdrop-blur flex flex-col">
      <div class="flex items-center gap-1 mb-2.5">${Ce(e.rating||5)}</div>
      ...
      <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 pt-14 sm:pt-20 pb-8 sm:pb-10">
        ...
        <div class="text-center max-w-3xl mx-auto">
          <div class="mx-auto w-16 h-16 rounded-2xl bg-white/[.07] border border-white/10 flex items-center justify-center overflow-hidden backdrop-blur">
            ...
            <span style="display:none">${V("w-9 h-9")}</span>
          </div>
          <p class="mt-4 text-[10px] font-black uppercase tracking-[0.28em] text-white">${c(o)}</p>
    ...
    </section>`}function Le(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-acc]");if(!a)return;const r=a.dataset.acc,i=e.querySelector(`[data-acc-body="${r}"]`),o=e.querySelector(`[data-acc-icon="${r}"]`);if(!i)return;i.dataset.open==="1"?(i.style.maxHeight="0px",i.style.opacity="0",i.dataset.open="0",o.classList.remove("rotate-180"),a.setAttribute("aria-expanded","false")):(i.style.maxHeight=i.scrollHeight+"px",i.style.opacity="1",i.dataset.open="1",o.classList.add("rotate-180"),a.setAttribute("aria-expanded","true"))})}function P(e){const t=document.querySelectorAll("[data-bg-slot]");t.length&&t.forEach(a=>{const r=a.dataset.bgSlot;r==="trust_promo"?a.innerHTML=L(e.trust_promo_bg_image,e.trust_promo_bg_video):r==="reviews"&&(a.innerHTML=L(e.reviews_bg_image,e.reviews_bg_video))})}function Me(e){const t=e.querySelector("#fb-stars");t&&t.addEventListener("click",i=>{const o=i.target.closest(".fb-star");if(!o)return;const n=parseInt(o.dataset.star,10),s=e.querySelector("#fb-rating");s&&(s.value=String(n)),t.querySelectorAll(".fb-star").forEach((u,m)=>{const d=u.querySelector("i, svg");d&&(m<n?(d.classList.add("fill-amber-400","text-amber-400"),d.classList.remove("text-slate-500")):(d.classList.remove("fill-amber-400","text-amber-400"),d.classList.add("text-slate-500")))})});const a=e.querySelector("#fb-form");a&&a.addEventListener("submit",i=>{i.preventDefault(),Ae(a)});const r=e.querySelector("[data-feedback-backtop]");r&&r.addEventListener("click",()=>{const i=e.querySelector('[data-acc="trust-reviews-more"]');i&&i.click();const o=document.getElementById("customer-feedback");o&&o.scrollIntoView({behavior:"smooth",block:"start"})})}function v(e,t,a){const r=e.closest("#customer-feedback")?.querySelector("#fb-msg");r&&(r.textContent=t,r.classList.remove("hidden","text-emerald-300","text-amber-300"),a&&r.classList.add(a))}async function Ae(e){const a=(e.querySelector("#fb-text")?.value||"").trim();if(!a){v(e,"Please write your feedback first.","text-amber-300");return}const r=e.querySelector("[type=submit]"),i=r.innerHTML;if(r.disabled=!0,r.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Sending…',window.lucide)try{lucide.createIcons()}catch{}try{const o=await x();let n=null;try{n=(await o.auth.getUser()).data?.user?.id||null}catch{}if(!n){if(v(e,"Only account holders can submit feedback. Please sign in first.","text-amber-300"),r.disabled=!1,r.innerHTML=i,window.lucide)try{lucide.createIcons()}catch{}return}const{error:s}=await o.from("site_feedback").insert({user_id:n,name:e.querySelector("#fb-name")?.value.trim()||"Anonymous shopper",email:e.querySelector("#fb-email")?.value.trim()||"",rating:parseInt(e.querySelector("#fb-rating")?.value||"5",10),feedback:a,is_approved:!1});if(s)throw new Error(s.message);v(e,"✓ Thank you! Your feedback has been sent.","text-emerald-300"),e.reset();const u=e.closest("#customer-feedback")?.querySelector("#fb-stars");u&&u.querySelectorAll(".fb-star").forEach(m=>{const d=m.querySelector("i, svg");d&&(d.classList.remove("fill-amber-400","text-amber-400"),d.classList.add("text-slate-500"))})}catch{v(e,"Could not send your feedback right now. Please try again later.","text-amber-300")}if(r.disabled=!1,r.innerHTML=i,window.lucide)try{lucide.createIcons()}catch{}}async function Te(e){const t=e?.querySelector("#fb-more-list"),a=e?.querySelector("#fb-featured");if(!(!t&&!a))try{const r=await x(),{data:i,error:o}=await r.from("site_feedback").select("name,rating,feedback,created_at").eq("is_approved",!0).order("created_at",{ascending:!1}).limit(30);if(o||!i||!i.length)return;const n=i.map(s=>T({name:s.name||"Verified shopper",text:s.feedback||"",rating:s.rating||5,verified:!0,country:"Verified customer",date:s.created_at?new Date(s.created_at).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):""}));t&&(t.innerHTML=n.join("")+t.innerHTML),a&&n.length&&(a.innerHTML=n.slice(0,3).join(""))}catch{}}async function $e(e){const t=e?.querySelector("#fb-form-holder"),a=e?.querySelector("#fb-signin-zone");if(!t||!a)return;let r=null;try{r=(await(await x()).auth.getUser()).data?.user||null}catch{}if(r){a.classList.add("hidden"),t.classList.remove("hidden");const i=r.user_metadata||{},o=i.name||i.full_name||(r.email?r.email.split("@")[0]:""),n=e.querySelector("#fb-name"),s=e.querySelector("#fb-email");n&&!n.value&&o&&(n.value=o),s&&!s.value&&r.email&&(s.value=r.email)}else t.classList.add("hidden"),a.classList.remove("hidden")}function qe(){if(document.getElementById("trust-info-style"))return;const e=document.createElement("style");e.id="trust-info-style",e.textContent=`
    .trust-acc-body{overflow:hidden;max-height:0;opacity:0;transition:max-height .38s cubic-bezier(.2,.8,.2,1),opacity .28s ease}
    .trust-acc-body[data-open="1"]{opacity:1}`,document.head.appendChild(e)}async function U(){if(document.body&&document.body.dataset.homepage==="true")return;const e=document.getElementById("trust-info-area");if(!e)return;qe();let t={...C};try{t=await M()}catch{}if(e.innerHTML=[ve(),we(),_e(),Ie(),R(t)].join(""),window.lucide)try{lucide.createIcons()}catch{}Le(e),Me(e),$e(e),Te(e);let a={...Z};try{a=await k()}catch{}P(a),window.addEventListener("promo-backgrounds-updated",()=>{k().then(P).catch(()=>{})}),window.addEventListener("site-content-updated",()=>{M().then(r=>{const i=e.querySelector("#site-closing-section");if(i&&(i.outerHTML=R(r)),window.lucide)try{lucide.createIcons()}catch{}}).catch(()=>{})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",U):U();const Be="/fallback.svg";function h(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Q(e){return Array.isArray(e.images)?e.images.filter(Boolean):typeof e.images=="string"?[e.images]:[]}function $(e){return Q(e)[0]||Be}function Oe(e){const t=parseFloat(e.real_price),a=parseFloat(e.price);return!(t>0)||!(a>0)||t<=a?null:{real:t,price:a,pct:Math.round((1-a/t)*100)}}function q(e){const t=Oe(e),a=j(e),r=t?j({price:t.real,currency:e.currency,price_period:e.price_period}):"",i=t?`<span class="text-gray-400 line-through">${r}</span> `:"",o=t?`<span class="inline-block bg-red-500 text-white text-[10px] font-black px-1.5 py-0.5 rounded-full">-${t.pct}%</span>`:"";return`${i}<span class="font-black">${a}</span> ${o}`}let g=[],I=!1;function He(e){const t=new Set,a=[];for(const r of e){if(!r)continue;const i=r.property_id||r.id;!i||t.has(i)||(t.add(i),a.push(r))}return a}async function Ge(){if(I&&g.length)return g;try{let e=[];try{await X(),e=ee()||[]}catch{}let t=He([...e,...te()||[]]);t=t.map(a=>{try{return ae({...a})}catch{return a}});try{const{isCatalogListingHidden:a}=await re(async()=>{const{isCatalogListingHidden:r}=await import("./catalog-hidden-store-BQYmdyo6.js");return{isCatalogListingHidden:r}},__vite__mapDeps([0,1]));t=t.filter(r=>{const i=r.property_id||r.id;if(!i)return!1;try{return!a(i)}catch{return!0}})}catch{}return g=t.filter(a=>Q(a).length>0&&(a.title||a.name)),I=!0,g}catch{return I=!0,g}}function De(){return g}const K="kco_promo_settings_v1",S={app_banner_enabled:!0,app_play_store_url:"",app_banner_headline:"Discover More with the Weverse Online Shop App",live_promo_enabled:!0,live_promo_interval_seconds:60,live_promo_first_delay_seconds:12,live_promo_product_ids:[],live_promo_use_owned_only:!1};async function je(){try{const t=JSON.parse(localStorage.getItem(K)||"{}");if(t.ts&&Date.now()-t.ts<60*1e3&&t.data)return{...S,...t.data}}catch{}const e={...S};try{const t=await x(),{data:a,error:r}=await t.from("site_settings").select("app_banner_enabled,app_play_store_url,app_banner_headline,live_promo_enabled,live_promo_interval_seconds,live_promo_first_delay_seconds,live_promo_product_ids,live_promo_use_owned_only").limit(1).maybeSingle();if(!r&&a){typeof a.app_banner_enabled=="boolean"&&(e.app_banner_enabled=a.app_banner_enabled),typeof a.app_play_store_url=="string"&&(e.app_play_store_url=a.app_play_store_url.trim()),typeof a.app_banner_headline=="string"&&a.app_banner_headline.trim()&&(e.app_banner_headline=a.app_banner_headline.trim()),typeof a.live_promo_enabled=="boolean"&&(e.live_promo_enabled=a.live_promo_enabled);const i=parseInt(a.live_promo_interval_seconds,10);i>0&&(e.live_promo_interval_seconds=i);const o=parseInt(a.live_promo_first_delay_seconds,10);o>=0&&(e.live_promo_first_delay_seconds=o),Array.isArray(a.live_promo_product_ids)&&(e.live_promo_product_ids=a.live_promo_product_ids.filter(Boolean)),typeof a.live_promo_use_owned_only=="boolean"&&(e.live_promo_use_owned_only=a.live_promo_use_owned_only)}}catch{}try{localStorage.setItem(K,JSON.stringify({ts:Date.now(),data:e}))}catch{}return e}function Fe(e,t,a=12){const r=t&&Array.isArray(t.live_promo_product_ids)&&t.live_promo_product_ids.length?new Set(t.live_promo_product_ids):null;let i=r?e.filter(o=>r.has(o.property_id||o.id)):e.slice();return i.length||(i=e.slice()),i.slice(0,a)}const Ne=()=>document.getElementById("app-promo-banner"),B="/fallback.svg";function Re(){return`
  ...
  <svg viewBox="0 0 560 720" class="w-full h-full block" aria-hidden="true">
  ...
  </svg>`}function Ue(e){const t=e[0],a=e[1],r=(i,o)=>{const n=h($(i)),s=h((i.title||i.name||"").slice(0,34));return`
    ...
    <section class="relative overflow-hidden bg-[#060c1c] text-white">
      ...
      <div class="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-14 lg:py-16">
        <div class="grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-6 items-center">
          ...
          <div class="relative mx-auto w-full max-w-[300px] sm:max-w-[360px] lg:max-w-[440px]">
            <div class="absolute inset-0 woman-back" aria-hidden="true">${Re()}</div>
            ...
            <div class="relative flex justify-center pt-[30%] sm:pt-[27%] lg:pt-[26%]">
              <div class="scale-100 sm:scale-105 lg:scale-110">${Ke(r)}</div>
            </div>
          </div>
        </div>
      </div>
    </section>`}let w=null;function Ze(e){w&&(clearInterval(w),w=null);const t=document.getElementById("promo-phone-screen"),a=document.getElementById("promo-phone-grid");if(!t||!a||!e.length)return;const r=e.slice();let i=0;const o=()=>{if(!a||!r.length)return;const n=r[i%r.length],s=r[(i+1)%r.length],u=h($(n)),m=h($(s)),d=h((n.title||n.name||"").slice(0,34)),l=h((s.title||s.name||"").slice(0,34));if(a.innerHTML=`
      ...
      </a>`,window.lucide)try{lucide.createIcons()}catch{}};o(),w=setInterval(()=>{i+=2,o()},4500)}async function W(){if(document.body&&document.body.dataset.homepage==="true")return;const e=Ne();if(!e)return;let t={...S};try{t=await je()}catch{}if(t.app_banner_enabled===!1)return;let a=[];try{await Ge(),a=De()||[]}catch{}const r=a.length?a:[{property_id:"browse",title:"Browse the full Weverse Online Shop",price:0,currency:"USD",images:["/fallback.svg"]}];let i={...Z};try{i=await k()}catch{}const o=s=>{const u=e.querySelector('[data-bg-slot="app_banner"]');u&&(u.innerHTML=L(s.app_banner_bg_image,s.app_banner_bg_video))};async function n(){let s={...C};try{s=await M()}catch{}if(e.innerHTML=We(t,r,s),window.lucide)try{lucide.createIcons()}catch{}Ze(r),window.dispatchEvent(new CustomEvent("app-promo-banner-ready")),o(i)}await n(),o(i),window.addEventListener("site-content-updated",()=>{n().catch(()=>{})}),window.addEventListener("promo-backgrounds-updated",()=>{k().then(s=>{i=s,o(s)}).catch(()=>{})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",W):W();
