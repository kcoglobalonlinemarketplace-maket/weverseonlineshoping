        ...
        ${e.cartItems.map((t,s)=>`
            <div class="flex items-center gap-3 p-3 bg-blue-950/30 border border-blue-500/10 rounded-xl">
              ...
              <div class="flex items-center gap-2 shrink-0">
                <button onclick="changeQty(${s}, -1)" class="w-7 h-7 bg-blue-900/40 hover:bg-blue-500/20 border border-blue-500/20 rounded-lg text-gray-400 hover:text-white transition flex items-center justify-center"><i data-lucide="minus" class="w-3.5 h-3.5"></i></button>
                <span class="text-sm font-bold text-white w-6 text-center">${t.quantity}</span>
                <button onclick="changeQty(${s}, 1)" class="w-7 h-7 bg-blue-900/40 hover:bg-blue-500/20 border border-blue-500/20 rounded-lg text-gray-400 hover:text-white transition flex items-center justify-center"><i data-lucide="plus" class="w-3.5 h-3.5"></i></button>
              </div>
