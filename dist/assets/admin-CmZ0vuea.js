import{supabase as p}from"./supabase-client-7_ZWSEp6.js";import{a as Fa,g as Oa,C as Se,A as qa}from"./localization-BaJ5cMya.js";import{patchLocalShowroomListing as Na,upsertLocalShowroomListing as Oe,getLocalShowroomListingById as Ct,listLocalShowroomListings as Lt}from"./local-showroom-store-JrQn_yOW.js";import{L as et,s as tt,a as Ha,l as Ga,b as za,V as Va}from"./live-control-store-DzHEnoMc.js";import{g as Tt,s as Wa,l as Ka,a as Ja,b as Qa}from"./payment-settings-B9WiOiOl.js";import{S as j}from"./showroom-data-DPO_EY_W.js";import{getCatalogCategory as Bt,getCatalogCategories as Ya,generateProduct as $t}from"./catalog-BPD_6M9e.js";import{getHiddenCatalogIds as Mt,saveCatalogHidden as Xa,resetHiddenCatalogIds as Za,loadHiddenCatalogIds as ei}from"./catalog-hidden-store-DbF0xVeS.js";import"./preload-helper-CLcXU_4U.js";const U=1,Q=5e6,ti=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],ai=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Rt=[...ti,...ai];function at(e){return Fa[e]||"USD"}function Dt(e,t){return Rt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ii(e,t){const a=Math.max(U,Math.min(Q,Number(e)||U));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function si(e,t,a,i,s){const o=ii(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${s}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function jt({templateId:e,listingType:t,category:a,countryCode:i,currency:s,price:o}){const r=Rt.find(h=>h.id===e&&h.listingType===t);if(!r)return null;const n=Oa(i)||Se[0],d=s||at(n.code),c=[n.name].filter(Boolean).join(", "),m={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${n.name}`:r.label,description:si(r,n,d,o,c),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[n.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...m,country:n.name,country_code:n.code,product_location:n.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...m,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const Ut="weverseonlineshop@gmail.com",Ft="kco_ai_ad_override_fallback_v1",Ot="Weverse Online Shop",qt="GLOBAL SHOPPING • WORLDWIDE DELIVERY",oi="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ri=`${oi}/functions/v1/ai-admin-assistant`,ni=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"},{id:"live-streaming",label:"Live Streaming",icon:"radio"},{id:"video-calls",label:"Video Calls",icon:"video"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],li={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Nt=[...qa].sort();let k={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Ht(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function G(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function F(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function it(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const di=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function Y(e){const t={};if(!e||typeof e!="object")return t;for(const a of di)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",o[t]||"info"),s.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function C(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function W(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function $(e,t,a,i,s=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=li[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Gt(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Z()),window.lucide&&lucide.createIcons(),({dashboard:Ii,products:L,properties:Ee,catalog:ce,orders:ua,customers:Yi,reviews:ct,messages:pa,coupons:Ce,ads:re,notifications:Zi,"live-streaming":de,"video-calls":fe,ai:ci,n8n:mi,"ai-settings":ha,"ai-marketing":Be,"homepage-branding":Re,content:Ps,seo:Cs,email:Ls,analytics:Es,security:Me,activity:Ts,brand:De,"payment-settings":Ze,backup:Bs,settings:Ms,publish:je,"general-ai":ui}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=se("construction","Coming Soon",`${t} is being built.`))}))()};async function ci(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
      ...
      </div>`,window.aiChatHistory=[],zt(),pi(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${l(t.message)}</div>`)}}function zt(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function pi(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function mi(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const te="kco_admin_remember",st="kco_login_attempts",qe=5,gi=15*60*1e3;function T(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function bi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ae(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function me(e){return String(e||"").trim().toLowerCase()}function hi(){try{const e=JSON.parse(localStorage.getItem(te)||"{}");e?.email&&!me(e.email)&&localStorage.removeItem(te)}catch{localStorage.removeItem(te)}}function fi(){try{const e=JSON.parse(localStorage.getItem(te)||"{}");return me(e?.email)}catch{return""}}function ot(){hi();const e=fi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Ut,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function yi(){return`${window.location.origin}/admin.html`}function ee(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ae(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function E(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Vt(){try{return JSON.parse(localStorage.getItem(st)||'{"count":0}')}catch{return{count:0}}}function Wt(){const e=Vt();return e.count=(e.count||0)+1,e.count>=qe&&(e.lockedUntil=Date.now()+gi),localStorage.setItem(st,JSON.stringify(e)),e}function Kt(){localStorage.removeItem(st)}function Jt(){const e=Vt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Kt(),null):Math.ceil(t/6e4)}async function H(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await vi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function vi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Qt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:me(e.email)===Ut}async function xi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){ve(),Ai();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await Qt(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),s=await p.auth.mfa.getAuthenticatorAssuranceLevel(),o=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&o!=="aal2"){k.user=t.user,ve(),ee("2fa"),rt();return}k.user=t.user,Ie();return}wi()}function ve(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function wi(){ve(),ee("login"),ot(),Yt(),Xt(),rt(),_i();const e=Jt();e&&(T(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function _i(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Yt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",ki),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ee("forgot")))}async function ki(e){e.preventDefault();const t=Jt();if(t){T(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=me(a?.value);if(!i){T("Enter your admin email address."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;E("login-btn",!0),Ae();const{data:r,error:n}=await p.auth.signInWithPassword({email:i,password:s});if(n||!r.user){const b=String(n?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){T("Authentication is temporarily unavailable due to configuration. Please contact support."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){T("Network error while signing in. Check your connection and try again."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){T("Your admin email is not confirmed yet. Open your verification email and confirm first."),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Wt(),g=qe-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${qe} failed attempts.`:`Invalid email or password. ${g>0?g+" attempt"+(g!==1?"s":"")+" remaining.":""}`;T(v),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await H(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Qt(r.user)){await p.auth.signOut(),T(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await H(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(te,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(te),Kt(),k.user=r.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){E("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ee("2fa"),rt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await H(r.user.id,"login_success"),E("login-btn",!1),Ie()}function rt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",St));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&St()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,ee("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",$i))}async function St(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){T("Enter the 6-digit code from your authenticator app.");return}E("verify-2fa-btn",!0),Ae();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){T("No 2FA factor found. Please re-login."),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await p.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:o}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await H(k.user.id,"login_2fa_success"),E("verify-2fa-btn",!1),Ie()}catch(t){Wt(),T(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),E("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function $i(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){T("Enter a backup recovery code.");return}E("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){T("No backup codes found."),E("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){T("Backup code not found or already used."),E("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",k.user.id),await H(k.user.id,"login_backup_code_used"),Ie()}catch(t){T(t.message),E("verify-backup-btn",!1,"Use Backup Code")}}function Xt(){document.getElementById("back-to-login")?.addEventListener("click",()=>ee("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Si)}async function Si(){const e=document.getElementById("reset-email"),t=me(e?.value);if(!t){T("Enter your admin email address to receive a reset link.");return}E("send-reset-btn",!0),Ae();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:yi()});if(E("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){T(a.message);return}bi("Reset link sent! Check your inbox and open it from this device to continue.")}function Ai(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function Ie(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&k.user&&(t.textContent=k.user.email||"Admin"),ot(),navigate("dashboard")}window.adminSignOut=async function(){k.user&&await H(k.user.id,"logout"),await p.auth.signOut(),k.user=null,ve(),ee("login"),ot(),Yt(),Xt()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(k.user&&await H(k.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),k.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Ii(){const e=document.getElementById("content");try{const[t,a,i,s]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=t.data||[],r=a.data||[],n=r.filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,V)=>x+(parseFloat(V.amount)||0),0),d=r.filter(x=>["pending","pending_verification","processing"].includes(x.status)).length,c=o.filter(x=>x.listing_type!=="property").length,m=o.filter(x=>x.listing_type==="property").length,h=o.filter(x=>x.listing_type!=="property"&&x.is_active).length,b=i.count||0,f=s.count||0,g=(s.data||[]).filter(x=>!x.is_approved).length,v=new Date,z=r.filter(x=>{const V=new Date(x.created_at);return V.getMonth()===v.getMonth()&&V.getFullYear()===v.getFullYear()}).filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,V)=>x+(parseFloat(V.amount)||0),0),K=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${Li()}, Admin</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${K.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':K.map(x=>`
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=i,Zt(i),filterProducts(),updateBulkBar(),_a(),Ia(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function X(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ne(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Pi(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function nt(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function He(e){return parseInt(e.views??e.view_count??0,10)||0}function Ge(e){return parseInt(e.sales??e.sales_count??0,10)||0}function lt(e){return e.sku||e.property_id||"N/A"}function Ei(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ne(e),i=nt(e),s=window._productSelection?.has(e.property_id),o=C(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=G(e.created_at),n=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${n?"featured":"standard"}" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-2xl p-3.5 flex flex-col gap-3 transition hover:border-blue-400/35">
    <div class="flex items-start gap-3">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-[10px] text-gray-500 font-mono mt-0.5">SKU: ${l(lt(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2 text-[11px]">
      ...
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Discount</span><p class="text-amber-300 font-bold">${l(Pi(e))}</p></div>
      ...
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Views</span><p class="text-blue-300 font-bold">${He(e).toLocaleString()}</p></div>
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Sales</span><p class="text-cyan-300 font-bold">${Ge(e).toLocaleString()}</p></div>
    </div>
  ...
  </article>`}function Ci(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,o)=>i(s.created_at)-i(o.created_at)):t==="price-high"?a.sort((s,o)=>X(o.price)-X(s.price)):t==="price-low"?a.sort((s,o)=>X(s.price)-X(o.price)):t==="sales-high"?a.sort((s,o)=>Ge(o)-Ge(s)):t==="views-high"?a.sort((s,o)=>He(o)-He(s)):a.sort((s,o)=>i(o.created_at)-i(s.created_at)),a}function Zt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");t&&(t.innerHTML=e.map(Ei).join(""),i&&(i.textContent=String(e.length)),a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons())}function ea(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=nt(i),r=window._productSelection?.has(i.property_id),n=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
    ...
    </div>`),na(),la(),oa("pf-price"),We(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>We(e,"pricing")),Wi(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),W(),L()};const Mi=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Ri=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Di=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],ji=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Ui=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Fi(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Mi:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Ri:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Di:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?ji:Ui}function N(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function _e(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&N(t)}function Oi(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(N("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",i=[...t.querySelectorAll('input[name="images"]')].map(s=>s.value).filter(s=>s&&!String(s).startsWith("blob:"));if(!i.length){e||N("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",_e(!0,"AI is analyzing your images…");try{const s=await I.analyzeImages(i,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!s){N("AI analysis unavailable — add a Gemini, Groq, or OpenRouter API key in AI Settings (or install Ollama locally).","warn");return}qi(s,a),N("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(s){N("AI analysis failed: "+(s.message||s),"error"),e||u("AI analysis failed: "+(s.message||s),"error")}finally{t.dataset.aiBusy="0",_e(!1)}};function qi(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const i=(d,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c))},s=(d,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};i("title",e.title),i("description",e.description),i("subcategory",e.subcategory),i("brand",e.brand),i("model",e.model),i("color",e.color),i("size",e.size),i("material",e.material),i("storage",e.storage),i("ram",e.ram),i("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||i("condition",e.condition),s("features_text",e.features),s("highlights_text",e.highlights),s("seo_keywords_text",e.seo_keywords);const o=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(d=>{o[d]!=null&&String(o[d]).trim()!==""&&i(d,o[d])}),Array.isArray(o.safety_features)&&s("safety_features",o.safety_features);const r=e.category?String(e.category).trim():"",n=document.getElementById("pf-ai-detected");n&&r&&r.toLowerCase()!==String(t||"").toLowerCase()&&(n.classList.remove("hidden"),n.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=e.dataset.category||"Product",n=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};function Wi(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=ca(e,t),s=document.getElementById("product-autosave-note");try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);Vi(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(zi(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}Je()};let r;const n=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",n),d.addEventListener("change",n)}),Je()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const r=new FormData(i),n={};for(const[b,f]of r.entries())b==="images"?(n.images=n.images||[],f&&!String(f).startsWith("blob:")&&n.images.push(String(f))):b==="tags"?(n.tags=n.tags||[],n.tags.push(f)):n[b]=f;n.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",n.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",c=b=>Ve(b),m=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],g={};for(const v of f){const S=b[v];g[v]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const v=c(b.safety_features);g.safety_features=v.length?v:null}return g};let h;if(a){let b=Y((window._productsData||[]).find(M=>M.property_id===a));if(!b){const{data:M}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=M?Y(M):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(M,Ue)=>{const ja=M===""||M==null?"":M,Ua=Ue===""||Ue==null?"":Ue;return String(ja).trim()===String(Ua).trim()},g={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(M=>{f(n[M],b[M])||(g[M]=n[M]==null||n[M]===""?null:n[M])});const v=n.price===""||n.price==null?null:parseFloat(n.price);f(v,b.price)||(g.price=v==null?b.price:Math.max(U,Math.min(Q,v)));const S=n.stock_quantity===""||n.stock_quantity==null?null:parseInt(n.stock_quantity,10);f(S,b.stock_quantity)||(g.stock_quantity=Number.isFinite(S)?S:null);const z=c(n.features_text);f(z.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(g.features=z);const K=n.tags||[];f(K.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(g.tags=K);const x=c(n.highlights_text);f(x.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(g.highlights=x);const V=c(n.seo_keywords_text);f(V.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(g.seo_keywords=V);const vt=n.images||[];f(vt.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(g.images=vt);const xt=n.is_featured==="on";!!b.is_featured!==xt&&(g.is_featured=xt);const wt=d?!1:n.is_active==="on";!!b.is_active!==wt&&(g.is_active=wt);const Da=m(n),_t={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Da};if(JSON.stringify(_t)!==JSON.stringify(b.specifications||{})&&(g.specifications=_t),Object.keys(g).length===0){u("No changes detected — nothing was saved.","info"),s&&(s.disabled=!1,s.textContent=o);return}const kt={...b,...g,property_id:a,updated_at:new Date().toISOString()};if({error:h}=await p.from("showroom_listings").upsert(kt,{onConflict:"property_id"}),h&&ze(h,()=>Oe(kt),"Product update")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":`Product updated — ${Object.keys(g).length} change(s) saved.`)}else{const b=parseInt(n.required_image_count||"0",10)||(dt.includes(t)?24:0);if(ra(b,n.images||[],"This listing"),!n.title||!n.title.trim())throw new Error("A product title is required.");if(n.price===""||n.price==null||!isFinite(parseFloat(n.price)))throw new Error("A price is required.");if(!n.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:n.subcategory||null,title:n.title.trim(),description:n.description||"",price:Math.max(U,Math.min(Q,parseFloat(n.price)||0)),currency:n.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:n.is_active==="on",is_featured:n.is_featured==="on",brand:n.brand||null,color:n.color||null,size:n.size||null,condition:n.condition||null,warranty:n.warranty||null,availability_status:n.availability_status||"In Stock",stock_quantity:n.stock_quantity?parseInt(n.stock_quantity):null,images:n.images||[],features:c(n.features_text).length?c(n.features_text):n.tags||[],tags:n.tags||[],highlights:c(n.highlights_text),seo_keywords:c(n.seo_keywords_text),is_ai_generated:!!n.catalog_template_id,ai_generated_fields:n.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(n)},g=it();if(f.property_id=g,{error:h}=await p.from("showroom_listings").insert(f),h&&ze(h,()=>Oe({...f,property_id:f.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":"Product published!")}try{localStorage.removeItem(ca(t,a))}catch{}closeProductFormModal()}catch(r){u("Error: "+r.message,"error"),s&&(s.disabled=!1,s.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Ct(e)),i||(i=(Array.isArray(j)?j.find(s=>s.property_id===e):null)||null),!i)return u("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=Y((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return D(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),L()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:o,updated_at:r,...n}=a,d=it();await p.from("showroom_listings").insert({...n,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),L())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),L())};const Ki=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ee(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Lt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(j)){const s=new Set(i.map(r=>r.property_id)),o=j.filter(r=>r.listing_type==="property"&&r.property_id&&!s.has(r.property_id));o.length&&(i=i.concat(o))}i.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Dt("property","Real Estate"),i=e.country_code||"US",s=e.currency||at(i);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Ki.map(o=>`<option value="${o}" ${e.property_type===o?"selected":""}>${o}</option>`).join("")}
            </select></div>
    ...
    </div>`),na(),la(),oa("ppf-price"),window.syncPropertyCountry=function(){At("ppf")},At("ppf"),Ke("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Ke("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),o=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),r=t?0:parseInt(i.required_image_count||"24",10)||24;ra(r,s,"This property");const n={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(U,Math.min(Q,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:o,images:s,highlights:Ve(i.highlights_text),seo_keywords:Ve(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){n.property_id=t;const c=Y((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:d}=await p.from("showroom_listings").upsert({...c,...n},{onConflict:"property_id"}))}else n.property_id=it(),{error:d}=await p.from("showroom_listings").insert(n);d&&ze(d,()=>Oe({...n,property_id:t||n.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),W(),Ee())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Ct(e)),i||(i=(Array.isArray(j)?j.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Ji=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function ua(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),W(),ua()};async function Yi(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?se("star","No Reviews","Customer reviews will appear here."):a.map(s=>Xi(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Xi(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const fa=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function rs(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function ya(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const i of t)i in e&&(a[i]=e[i]);return a}function pe(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const o=t.slice(i,s+1);try{return JSON.parse(o)}catch{return null}}function Pt(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=rs(e);if(!a)try{const{data:i}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();i&&(a=i)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},A()};function A(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",i=e.busy===!0,o=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    ...
    </div>`).join(""),m=e.suggestions?ls():"",h=ns();B(`
    ...
    </div>`}function ls(){const e=y;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){y&&(y.instruction=e)};window.productAiQuickAction=function(e){const t=fa.find(a=>a.key===e);!t||!y||(y.instruction=t.prompt,y.quickLabel=t.label,y.quickMode=t.mode||"edit",runProductAiInstruction())};window.productAiToggleApproved=function(e,t){y&&(t?y.approved.add(e):y.approved.delete(e),A())};window.productAiApproveAll=function(){if(!(!y||!y.suggestions)){for(const e of Object.keys(y.suggestions))y.approved.add(e);y.removedImages.size&&y.approved.add("images_to_remove"),A()}};window.productAiToggleRemoveImage=function(e){if(!y)return;const t=Array.isArray(y.product.images)?y.product.images:[],i=[...t,...y.addedImages][e];i&&(e<t.length?y.removedImages.has(i)?y.removedImages.delete(i):y.removedImages.add(i):y.addedImages=y.addedImages.filter(s=>s!==i),A())};window.productAiDetectDuplicates=async function(){if(!y)return;const e=y,t=Array.isArray(e.product.images)?e.product.images:[],a={};t.forEach(s=>{a[s]=(a[s]||0)+1});const i=t.filter((s,o)=>!(a[s]>1&&t.indexOf(s)!==o));if(i.length===t.length){u("No duplicate images found.","info");return}await ne(i,`Removed ${t.length-i.length} duplicate image(s) from the card.`)};window.productAiUploadImages=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=y,a=[...e.files];t.busy=!0,A();const s=[...Array.isArray(t.product.images)?t.product.images:[]];let o=0;for(const r of a){if(!r.type.startsWith("image/"))continue;const n=await be(r);n&&(s.push(n),o+=1)}if(e.value="",t.busy=!1,o){await ne(s,`${o} image(s) uploaded to the card.`);return}u("Upload failed.","error"),A()};function ds(e,t){const a=String(e).toLowerCase();if(/\b(generate|create|make|draw|produce|imagine)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner)\b/.test(a)||/\b(change|swap|replace|edit|remove)\b[\s\S]*\b(background|color|colour)\b/.test(a))return"gen";if(/\bshowroom\b/.test(a)||/\bcompare\b[\s\S]*\b(showroom|product|other|card)\b/.test(a)||/\bscan\b[\s\S]*\b(showroom|product|card|listing|shop|match)\b/.test(a)||/\bmatch(es|ing)?\b/.test(a))return"scan";const i=/\b(rewrite|rephrase|update|fix|improve|optimize|change|make|rename|retitle|set|clean up|cleanup|remove|delete|add)\b/,s=/\b(title|description|price|stock|category|subcategory|brand|name|images?|features|tags|highlights|seo)\b/;return i.test(a)&&s.test(a)?"edit":t?"vision":"chat"}function cs(){const e=y;return(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content)}window.runProductAiInstruction=async function(){const e=y;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i&&!s)return;const o=t||"Improve this product listing professionally.",r=a||t||(s?"Look at these photos and tell me what you see.":"Improve this product listing professionally."),n=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.messages.push({role:"user",content:r,images:n}),e.busy=!0,A();const d=i||ds(o,s);try{d==="gen"?await wa(o,n):d==="scan"?await bs():d==="edit"?await us(o,n):d==="vision"?await ms(o,n):await ps(o),va()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`AI error: ${c.message}`,"error")}finally{e.busy=!1,A()}};async function us(e,t){const a=y,i=hs(a,e);let s="";if(t&&t.length){const n=await I._callEdge({action:"vision",images:t.slice(0,4),prompt:i,max_tokens:4096});if(s=n&&n.text?String(n.text):"",!s)throw new Error(n&&n.error||"The AI could not read the attached photos.")}else s=(await I.prompt(i,{maxTokens:4e3,onProviderSwitch:()=>{}})).text;const o=pe(s);if(!o)throw new Error("The AI did not return valid JSON suggestions.");a.suggestions=o,a.approved=new Set(Object.keys(o)),a.approved.add("images_to_remove");const r=(o.summary||"Changes are ready for this product.").trim();a.messages.push({role:"assistant",content:`${r}

✅ Changes are ready below. Tick what you want, then press Save.`}),u("Suggestions ready — review and approve before saving.","info")}async function ps(e){const t=y,a=cs(),i=await I._callEdge({action:"chat",message:e,history:a,max_tokens:1200});if(i&&i.response){t.messages.push({role:"assistant",content:String(i.response)});return}throw new Error(i&&i.error||"The AI did not respond.")}async function ms(e,t){const a=y,i=`${e}

If you recognize the product in these photos, say yes and identify exactly what it is, give a typical price range for it, and offer to generate more product photos for this listing. Be friendly and helpful.`,s=await I._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1200}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o})}async function gs(){let e=Array.isArray(window._productsData)?window._productsData:[];if(!e.length)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").limit(500);!a&&Array.isArray(t)&&(e=t)}catch{}return(e||[]).filter(t=>t&&t.property_id!==y.pid)}async function bs(){const e=y,t=await gs(),a=JSON.stringify(ya(e.product),null,2),i=t.slice(0,15).map(m=>({title:m.title,category:m.category,subcategory:m.subcategory,price:m.price,currency:m.currency,brand:m.brand,images:Array.isArray(m.images)?m.images.length:0,listing_type:m.listing_type})),s=`You are the AI product manager for the product ${e.pid} in the Weverse Online Shop showroom.
THIS PRODUCT (JSON):
${a}
...
- Respond with valid JSON only.`,o=await I._callEdge({action:"chat",message:s,history:[],max_tokens:3e3}),r=o&&o.response?String(o.response):"";if(!r)throw new Error(o&&o.error||"The showroom scan returned nothing.");const n=pe(r),d=Array.isArray(n&&n.mismatches)?n.mismatches:[],c=Array.isArray(n&&n.matches)?n.matches:[];if(n&&(d.length||c.length||n.summary)){const m={};d.forEach(b=>{b&&b.field&&b.suggested_value!==void 0&&b.suggested_value!==null&&(m[b.field]=b.suggested_value)});const h=["Showroom scan complete:"];c.length&&h.push(...c.map(b=>`✅ ${b}`)),d.length&&h.push(...d.map(b=>`⚠️ ${b.field}: ${b.issue}`)),d.length||h.push("✅ Everything matches the other products in this showroom."),d.length?(m.summary=n.summary||`${d.length} issue(s) found with the showroom.`,e.suggestions=m,e.approved=new Set(Object.keys(m)),e.approved.add("images_to_remove"),h.push("Fixes are ready below. Tick what you want, then press Save.")):e.suggestions=null,e.messages.push({role:"assistant",content:h.join(`
...
(Generate a clean, professional product photo for "${String(i.title||"").trim()||"this product"}" in the Weverse Online Shop.)`;let o=null;t&&t.length?o=t[0]:Array.isArray(i.images)&&i.images[0]&&(o=await I._fetchImageAsDataUrl(i.images[0]));const r=await I._callEdge({action:"generate_images",prompt:s,reference_url:o,count:2});if(r&&Array.isArray(r.images)&&r.images.length){a.generatedImages=r.images,a.lastGenPrompt=e,a.lastGenReference=o,a.messages.push({role:"assistant",content:"Here are your generated images. Tap one to add it to the card, or Regenerate for new variations.",generated:r.images,provider:`${r.provider||"AI"}/${r.model||""}`});return}throw new Error(r&&r.error||"Image generation returned nothing.")}async function Le(e){try{const t=await fetch(e).then(i=>i.blob());if(!t||!t.size)return null;const a=new File([t],`ai-${Date.now()}.png`,{type:t.type||"image/png"});return await be(a)}catch{return null}}window.productAiUseGeneratedImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Le(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[];await ne([...s,i],"Generated image added to the card.")};window.productAiReplaceMainImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Le(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[],o=s.length?[i,...s.slice(1)]:[i];await ne(o,"Old main image replaced with the generated one.")};window.productAiUseAllGeneratedImages=async function(){const e=y;if(!e||e.busy||!Array.isArray(e.generatedImages)||!e.generatedImages.length)return;e.busy=!0,A();const a=[...Array.isArray(e.product.images)?e.product.images:[]];let i=0;for(const s of e.generatedImages){const o=await Le(s);o&&(a.push(o),i+=1)}if(e.busy=!1,i){e.generatedImages=[],await ne(a,`${i} generated image(s) added to the card.`);return}u("Upload failed.","error"),A()};window.productAiRemoveImageNow=async function(e){const t=y;if(!t||t.busy)return;const a=Array.isArray(t.product.images)?t.product.images:[];e<0||e>=a.length||await ne(a.filter((i,s)=>s!==e),"Image removed from the card.")};async function ne(e,t){const a=y;if(!a)return;a.busy=!0,A();const i=Y({...a.product,images:e,property_id:a.pid,updated_at:new Date().toISOString()});try{const{error:s}=await p.from("showroom_listings").upsert(i,{onConflict:"property_id"});if(s)throw s;a.product.images=e,a.removedImages.clear(),u(t,"success"),a.from==="properties"?Ee():L()}catch(s){s&&D(s)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration.","error"):u(`Save failed: ${s&&s.message||"unknown error"}`,"error")}finally{a.busy=!1,A()}}window.productAiRegenerateImage=async function(){const e=y;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,A();try{await wa(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,A()}}};function hs(e,t){const a=e.product;return`You are the AI product manager assistant for the Weverse Online Shop admin dashboard, working on ONE product.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(n=>n!=="images_to_remove"),a={};if(e.suggestions)for(const n of e.approved)n!=="images_to_remove"&&n in e.suggestions&&e.suggestions[n]!==void 0&&(a[n]=e.suggestions[n]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const i=Array.isArray(e.product.images)?e.product.images:[],s=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(n=>s.add(n));const o=[...i.filter(n=>!s.has(n)),...e.addedImages],r=Y({...e.product,...a,images:o,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,A();try{const{error:n}=await p.from("showroom_listings").upsert(r,{onConflict:"property_id"});if(n)throw n;u("Changes saved to Supabase.","success");const d=e.from;y=null,W(),d==="properties"?Ee():L()}catch(n){e.busy=!1,n&&D(n)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${n&&n.message||"unknown error"}`,"error"),A()}};let w=null;const pt=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Publish this photo as a product in my showroom, matched to the right section."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function fs(){const e=w;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content):[]}function ys(e,t){const a=String(e||"").toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":t?a?"vision":"execute":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":"execute"}function vs(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function _a(){return w||(w={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Just upload a photo of any item and I'll scan it, write the complete brand, model, year, rating and details (so your customers feel confident), check your showroom first, and publish it automatically — no need to type anything. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything in the showroom without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null},w)}window.openGeneralAi=async function(){_a(),R()};function ka(e){return e?e.role==="user"?`
    <div class="flex justify-end">
      <div class="max-w-[85%] bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-3xl rounded-tr-md px-5 py-3.5 text-[1.02rem] leading-relaxed whitespace-pre-wrap break-words shadow-lg shadow-blue-600/20">
    ...
    </div>`}function Sa(){const e=w;return!e||!e.pendingPlan?"":`
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${l(vs(e.pendingPlan))}</p>
    ...
    </div>`}function Aa(){const e=w;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,i)=>`
    ...
    </div>`).join(""):""}function R(){document.getElementById("general-ai-embed-scroll")&&Ia(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&xs(),Te()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function xs(){const e=w;if(!e)return;const t=e.busy===!0,i=(Array.isArray(e.messages)?e.messages:[]).map(c=>ka(c)).join(""),s=t?$a():"",o=pt.map(c=>`
    ...
    </div>`);const d=document.getElementById("general-ai-input");d&&(d.value=e.instruction||"",d.addEventListener("input",()=>{w&&(w.instruction=d.value)}),d.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Te()}function Ia(){const e=w,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,i=Array.isArray(e.messages)?e.messages:[],s=pt.map(d=>`
    ...
    ${a?$a():""}
    ${Sa()}
  `;const o=document.getElementById("general-ai-embed-thumbs");o&&(o.innerHTML=Aa());const r=document.getElementById("general-ai-embed-send-btn");r&&(r.classList.toggle("opacity-40",a),r.classList.toggle("pointer-events-none",a));const n=document.getElementById("general-ai-embed-input");n&&(n.value=e.instruction||"",n.dataset.gaiBound||(n.dataset.gaiBound="1",n.addEventListener("input",()=>{w&&(w.instruction=n.value)}),n.addEventListener("keydown",d=>{d.key==="Enter"&&!d.shiftKey&&(d.preventDefault(),runGeneralAiInstruction())}))),window.lucide&&lucide.createIcons(),Te()}function Te(){const e=["general-ai-chat-scroll","general-ai-embed-scroll"];requestAnimationFrame(()=>{for(const t of e){const a=document.getElementById(t);a&&a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}})}window.generalAiChatAttach=function(){document.getElementById("general-ai-chat-image")?.click()};window.generalAiChatImagePicked=async function(e){if(!w||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await xa(i);s&&(w.chatImages.push(s),a+=1)}if(e.value="",a){u(`${a} photo(s) attached. Now type what you want me to do with it (e.g. "scan this and list everything about it", "generate an image exactly like this", or "publish this to the showroom").`,"info");const i=document.getElementById("general-ai-embed-input")||document.getElementById("general-ai-input");i&&i.focus()}R()};window.generalAiRemoveChatImage=function(e){w&&(w.chatImages.splice(e,1),R())};window.generalAiQuickAction=function(e){const t=pt.find(a=>a.key===e);!t||!w||(w.instruction=t.prompt,w.quickLabel=t.label,w.quickMode=t.mode,runGeneralAiInstruction())};window.runGeneralAiInstruction=async function(){const e=w;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i)return;const o=t||"",r=a||t||(s?"Photo attached — please scan it and list everything you can identify about it.":o),n=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.pendingPlan=null,e.messages.push({role:"user",content:r,images:n}),e.busy=!0,R();const d=i||ys(o,s);try{d==="publish"?await ws(o,n):d==="gen"?await Pa(o,n):d==="monitor"?await _s():d==="vision"?await ks(o,n):await $s(o,n),Te()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`General AI error: ${c.message}`,"error")}finally{e.busy=!1,R()}};async function ws(e,t){const a=w,i=await I._callEdge({action:"general_publish",message:e,images:t.slice(0,4),max_tokens:2048});if(!i||i.success!==!0)throw new Error(i&&i.error||"Could not publish the product.");a.messages.push({role:"assistant",content:String(i.response||"Published."),images:(i.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),mt()}async function Pa(e,t){const a=w;let i=null;t&&t.length&&(i=t[0]);const o=/\b(exact|exactly|same|matching|match|identical|copy|replicat|just like|like this|as the (image|photo|picture))\b/i.test(e)&&i?"Reproduce the attached reference photo as faithfully as possible — keep the same subject, look, colors, background, and details. Make it an exact, high-quality match.":"Generate a beautiful, high-quality image. It can be any type of image — no restrictions.",r=await I._callEdge({action:"generate_images",prompt:`${e}

${o}`,reference_url:i,count:2});if(!r||!Array.isArray(r.images)||!r.images.length)throw new Error(r&&r.error||"Image generation returned nothing.");a.generatedImages=r.images,a.lastGenPrompt=e,a.lastGenReference=i,a.messages.push({role:"assistant",content:"Here are your images. Tap one to save it to your showroom product images.",generated:r.images,provider:`${r.provider||"AI"}/${r.model||""}`})}async function _s(){const e=w,t=await I._callEdge({action:"general_monitor",max_tokens:3e3});if(!t||t.success!==!0||!t.report)throw new Error(t&&t.error||"Could not scan the showroom.");const a=t.report||{},i=["Showroom scan complete:"];(Array.isArray(a.good)?a.good:[]).forEach(s=>i.push(`✅ ${s}`)),(Array.isArray(a.issues)?a.issues:[]).forEach(s=>i.push(`⚠️ ${s.property_id} (${s.severity||"low"}): ${s.issue}`)),(Array.isArray(a.suggestions)?a.suggestions:[]).forEach(s=>i.push(`💡 ${s}`)),Array.isArray(a.issues)&&a.issues.length||i.push("Everything looks good."),e.messages.push({role:"assistant",content:i.join(`
`)})}async function ks(e,t){const a=w,i=`${e}
...
- Keep it a clean, readable list. You manage the whole showroom, so stay professional and factual.`,s=await I._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1500}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o,provider:s.provider?`${s.provider}/${s.model}`:""})}async function $s(e,t){const a=w,i=fs(),s=await I._callEdge({action:"general_execute",message:e,images:(t||[]).slice(0,4),history:i,max_tokens:1200});if(!s||s.success!==!0)throw new Error(s&&s.error||"Could not handle that request.");if(s.needs_confirmation){a.pendingPlan=s.plan||null,a.messages.push({role:"assistant",content:String(s.response||"I found something I can fix.")});return}a.messages.push({role:"assistant",content:String(s.response||s.reply||"Done.")}),s.plan&&s.plan.action!=="chat"&&s.plan.action!=="monitor"&&mt()}window.generalAiConfirmPlan=async function(){const e=w;if(!e||!e.pendingPlan||e.busy)return;const t=e.pendingPlan;e.pendingPlan=null,e.busy=!0,R();try{const a=await I._callEdge({action:"general_execute",confirm_plan:t,confirmed:!0});if(!a||a.success!==!0)throw new Error(a&&a.error||"The action failed.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||a.reply||"Done.")}`}),mt()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,R()}};window.generalAiCancelPlan=function(){w&&(w.pendingPlan=null,w.messages.push({role:"assistant",content:"Cancelled — nothing was changed."}),R())};window.generalAiUseGeneratedImage=async function(e){const t=w;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,R();const i=await Le(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),R();return}u("Image saved to showroom storage. Use it on any card or ask the AI to attach it.","success"),R()};window.generalAiRegenerateImage=async function(){const e=w;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,R();try{await Pa(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,R()}}};async function mt(){try{await L()}catch{}}const gt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],Ss=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function bt(e){return Array.isArray(e)?e:[]}function Ea(e=[]){const t=new Map(bt(e).map(a=>[a.id,a]));return gt.map(a=>{const i=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!i.enabled,apiKey:i.apiKey||"",model:i.model||"",baseUrl:i.baseUrl||""}})}async function Ca(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function ht(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...bt(t?.ai_ad_generation_history)].slice(0,120);await Ca({ai_ad_generation_history:a})}async function La(e){try{const{data:i,error:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(s)throw s;let o;if(i?.id?{error:o}=await p.from("site_settings").update(e).eq("id",i.id):{error:o}=await p.from("site_settings").insert(e),o)throw o;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:i}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let s;if(i?.id?{error:s}=await p.from("public_live_state").update(a).eq("id",i.id):{error:s}=await p.from("public_live_state").insert(a),!s)return}catch{}try{localStorage.setItem(Ft,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function As(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function Is(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=As(e.description),i=a?.startsAt||e.started_at||null,s=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:i,ai_ad_ends_at:s,ai_ad_duration_seconds:s&&i?Math.max(5,Math.round((new Date(s).getTime()-new Date(i).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(Ft),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function Be(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),Is()]),i=t||{},s=a||{},o=Ea(i.ai_ad_video_providers),r=bt(i.ai_ad_generation_history).sort((d,c)=>new Date(c.created_at||0).getTime()-new Date(d.created_at||0).getTime()).slice(0,12),n=!!s.ai_ad_enabled&&!!s.ai_ad_video_url&&(!s.ai_ad_ends_at||new Date(s.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
      <div class="space-y-6 fade-in">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <select id="ai-ad-goal" class="input-field text-xs" name="goal">
                ${Ss.map(d=>`<option value="${l(d)}">${l(d)}</option>`).join("")}
              </select>
            </div>
            <div>
...
`),o=await I.prompt(s,{onProviderSwitch:r=>{i.value=`Generating with ${r}...`}});i.value=o.text||"",await ht({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:o.provider,provider_id:a?.value||"",status:"script_generated",script:o.text||"",video_url:null}),u(`Script generated with ${o.provider}.`,"success")}catch(s){i.value="",u("Script generation failed: "+s.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),i=String(t.get("provider_id")||""),s=gt.find(b=>b.id===i)?.name||i,o=String(t.get("brief")||"").trim(),r=String(t.get("script")||"").trim(),n=String(t.get("video_url")||"").trim(),d=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),h=new Date(c+d*1e3).toISOString();if(!n){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:n,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:d,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:i,ai_ad_starts_at:m,ai_ad_ends_at:h,ai_ad_updated_at:new Date().toISOString()};await La(b),await ht({created_at:m,goal:a,brief:o,provider_name:s,provider_id:i,status:"active",script:r,video_url:n,ends_at:h}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Be()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await La({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await ht({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Be()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function Ps(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons(),ta(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Cs(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Ta(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Ba(e.map(t=>t.code)),Me()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await H(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Me()}catch(e){u(e.message,"error")}};async function Ts(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Bs(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),u("Orders exported!")};async function Ms(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function De(){const e=document.getElementById("content");e&&(e.innerHTML=Z());try{let t=function(n,d,c,m="",h="blue"){const b=!!(c&&c.trim());return`
    ...
    </div>`,yt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ft()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ft()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),yt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=Se.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Tt(t),yt(),renderManualPaymentAccountsEditor()};async function Ze(){const e=document.getElementById("content");e&&(e.innerHTML=Z());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Ka()||{},...t||{}};window._manualPaymentAccounts=Ja(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    </div>`}function js(e){return e.length?e.map(t=>`
    ...
    <div class="space-y-5 fade-in">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${o.map(r=>Ra(r,et.find(n=>n.id===r.id),"streamingPlatforms")).join("")}
        </div>
      </div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}function Us(e){return e.length?e.map(t=>`
    <div class="glass-soft border border-blue-500/10 rounded-xl p-4 flex flex-col gap-3 lg:flex-row lg:items-center">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1"><span class="text-sm font-black text-white">${l(t.title)}</span>${C(t.status)}</div>
    ...
    <div class="space-y-5 fade-in">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${t.videoCallProviders.map(s=>Ra(s,Va.find(o=>o.id===s.id),"videoCallProviders")).join("")}
        </div>
      </div>
    ...
    <div class="space-y-4 fade-in">
      ...
      ${b}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){P.category=e,P.page=0,P.query="",ce()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");P.query=e?e.value:"",P.page=0,ce()};window.catalogPage=function(e){const t=Bt(P.category),a=t?t.count:0,i=P.query.trim()?1:Math.max(1,Math.ceil(a/ue));P.page=Math.max(0,Math.min(i-1,P.page+e)),ce()};window.catalogToggle=async function(e){const t=!Mt().includes(e),a=await Xa(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),ce()};window.catalogResetHidden=async function(){await Za(),u("All hidden catalog listings restored"),ce()};async function Et(){window.lucide&&lucide.createIcons(),Gt(),await xi(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Et):Et();window.aiChatHistory=[];window.aiProductType="product";async function Fs(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),zt();const i=document.getElementById("ai-prompt");i&&(i.value=""),u("AI is analyzing...");try{let s=null;a&&(s=await fileToDataUrl(a));const o={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:s,catalog_context:await Os()},n=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(o)})).json();n.success&&n.product?(openListingReviewCard(n.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(n.error||"AI generation failed")}catch(s){u("Error: "+s.message),console.error("[AI] Generate product error:",s)}}async function Os(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&Fs()});
