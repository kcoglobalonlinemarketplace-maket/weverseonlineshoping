import{h as R,a as V,S as D,c as F,b as j,d as N,e as T}from"./showroom-data-DqHxX4e9.js";import{P as z,a as H,T as P,M as G,f as q}from"./motorhome-data-CupbOvk0.js";import{isCatalogListingHidden as y}from"./catalog-hidden-store-ikn3_XIs.js";const u=".showroom-card video, [data-showroom-grid] video, .kco-video-section video, .kco-video-el, .kco-hero-media video",U="#video-tour-modal video";function g(e){return!!(e&&e.matches&&e.matches(u)&&!e.closest(U))}function f(e){if(g(e)){if(e.setAttribute("muted",""),e.setAttribute("loop",""),e.setAttribute("autoplay",""),e.setAttribute("playsinline",""),e.setAttribute("webkit-playsinline",""),e.muted=!0,e.loop=!0,e.playsInline=!0,e.autoplay=!0,e.ended)try{e.currentTime=0}catch{}e.paused&&e.play().catch(()=>{})}}function v(e){!e||!e.querySelectorAll||e.querySelectorAll(u).forEach(f)}document.addEventListener("ended",e=>{const o=e.target;if(o&&o.tagName==="VIDEO"&&g(o)){try{o.currentTime=0}catch{}o.play().catch(()=>{})}},!0);const x="MutationObserver"in window?new MutationObserver(e=>{for(const o of e)for(const t of o.addedNodes)!t||t.nodeType!==1||(t.matches&&g(t)&&f(t),t.querySelectorAll&&t.querySelectorAll(u).forEach(f))}):null;function S(){v(document),x&&document.body&&x.observe(document.body,{childList:!0,subtree:!0}),setInterval(()=>v(document),2e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",S):S();const B="kco-hero-rows",_="/fallback.svg",W=new Set(["Cars","Cars & Vehicles","Trucks","Buses","Buses & Coaches","Motorhomes","Motorcycles","Marine & Boating","RV & Camper Accessories","Vehicles"]),m=new Set(["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","House","Homes","Duplex","Penthouse","Bungalow","Cottage","Chalet","Studio","Loft"]),K=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","House","Homes","Duplex","Penthouse","Bungalow","Cottage","Chalet","Studio","Loft"];function i(e,o){return e.specifications&&typeof e.specifications=="object"&&e.specifications[o]!=null?e.specifications[o]:e[o]}function $(e){return e.listing_type==="vehicle"||W.has(e.category)}function C(e){return!e||typeof e!="string"?!1:/^data:video\//i.test(e)?!0:e.startsWith("blob:")?!1:/\.(mp4|webm|mov|m4v|avi|mkv|ogv)(\?|#|$)/i.test(e)}function Y(e){const o=new Set,t=[];for(const r of e){if(!r)continue;const c=r.property_id||r.id;!c||o.has(c)||(o.add(c),t.push(r))}return t}function I(e){return Y(e).filter(o=>y&&y(o.property_id)?!1:o.property_id&&String(o.property_id).startsWith("W")?!0:o.is_active!==!1).sort((o,t)=>{const r=Number.isFinite(parseFloat(o.price))?parseFloat(o.price):0;return(Number.isFinite(parseFloat(t.price))?parseFloat(t.price):0)-r})}function X(e){const o=e.property_type||e.subcategory||e.category;if(o&&!l.has(o)){const t=String(o).toLowerCase();for(const r of K)if(t===r.toLowerCase()||t.includes(r.toLowerCase())){l.set(o,r);break}l.has(o)||l.set(o,String(o))}return o?l.get(o):"Homes"}const l=new Map;function ae(){const o=(T()||[]).filter(r=>r.listing_type==="property"||r.category==="Real Estate"||r.category==="Houses & Real Estate"||m.has(r.property_type)||m.has(r.subcategory)),t=[...z,...H,...D].filter(r=>r&&(r.category==="Houses & Real Estate"||r.category==="Real Estate"||m.has(r.property_type||r.subcategory)));return I([...o,...t])}function ie(){const o=(T()||[]).filter(r=>$(r)),t=[...P,...G,...z,...H].filter(r=>r&&$(r));return I([...o,...t])}function a(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function J(){if(document.getElementById("kco-hero-styles"))return;const e=document.createElement("style");e.id="kco-hero-styles",e.textContent=`
...
`,document.head.appendChild(e)}function ce(e,o,t){F(e);const r=t,c=e.images&&e.images[0]||_,b=Q(e.property_id||e.id),k=o==="vehicle"&&e.category==="Trucks"?q(e):j(e);let s="",p="";if(o==="house"){const A=N(e.country_code),w=[e.city,e.state].filter(Boolean).join(", ")||e.country||"";w&&(p=`<span class="kco-hero-loc"><i data-lucide="map-pin" class="w-3 h-3 shrink-0"></i>${a(A+" "+w)}</span>`);const d=[];i(e,"bedrooms")!=null&&d.push(`<span class="kco-hero-chip"><i data-lucide="bed-double" class="w-3.5 h-3.5"></i>${a(i(e,"bedrooms"))} Beds</span>`),i(e,"bathrooms")!=null&&d.push(`<span class="kco-hero-chip"><i data-lucide="bath" class="w-3.5 h-3.5"></i>${a(i(e,"bathrooms"))} Baths</span>`),e.land_size&&d.push(`<span class="kco-hero-chip"><i data-lucide="ruler" class="w-3.5 h-3.5"></i>${a(e.land_size)}</span>`),i(e,"building_size")&&d.push(`<span class="kco-hero-chip"><i data-lucide="building-2" class="w-3.5 h-3.5"></i>${a(i(e,"building_size"))}</span>`),i(e,"year_built")&&d.push(`<span class="kco-hero-chip"><i data-lucide="calendar" class="w-3.5 h-3.5"></i>${a(i(e,"year_built"))}</span>`);const M=X(e);return s=d.join(""),p||(p=""),`
      <a href="/product/${b}" class="${r}">
        <div class="kco-hero-media">
          ${C(c)?`<video src="${a(c)}" poster="${a((e.images||[]).find(O=>!C(O))||_)}" muted loop autoplay playsinline preload="metadata" class="kco-hero-media-video"></video><span class="kco-hero-video-badge"><i data-lucide="play" class="w-3 h-3"></i>Video Tour</span>`:`<img src="${a(c)}" alt="${a(e.title||"")}" loading="lazy">`}
          <span class="kco-hero-type"><i data-lucide="home" class="w-3 h-3"></i>${a(M)}</span>
          ${p}
        </div>
      ...
      <a href="/product/${b}" class="${r}">
        <div class="kco-hero-media">
          ...
          <span class="kco-hero-type"><i data-lucide="car-front" class="w-3 h-3"></i>${a(Z(e))}</span>
        </div>
        <div class="kco-hero-body">
      ...
      </a>`}function Q(e){return String(e??"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Z(e){const o=String(e.category||""),t={Cars:"Car","Cars & Vehicles":"Car",Trucks:"Truck",Buses:"Bus","Buses & Coaches":"Bus",Motorhomes:"Motorhome / RV",Motorcycles:"Motorcycle","Marine & Boating":"Boat / Marine"};return t[o]?t[o]:i(e,"body_type")||o||"Vehicle"}function h(){const e=document.getElementById(B);if(!e)return;J();const o=document.createDocumentFragment();e.replaceChildren(o),window.lucide&&lucide.createIcons()}let E=!1;function L(){E||(E=!0,document.getElementById(B)&&(R(),h(),V().then(()=>h()).catch(()=>{}),window.addEventListener("showroom-categories-ready",()=>h()),window.addEventListener("kco-db-refresh",()=>h())))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",L):L();export{ie as a,X as b,ce as c,ae as g,J as h,Z as v};
