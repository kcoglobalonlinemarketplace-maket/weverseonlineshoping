import{_ as li,s as b,a as ie,i as ua,D as di}from"./supabase-client-DvCmNkpI.js";import{a as ci,g as ui,C as Ee,A as pi}from"./localization-CErl0dkC.js";import{patchLocalShowroomListing as mi,getLocalShowroomListingById as Lt,removeLocalShowroomListing as gi,upsertLocalShowroomListing as bt,listLocalShowroomListings as Xe}from"./local-showroom-store-mzP0nSoS.js";import{g as pa,s as bi,l as yi,a as fi,b as hi}from"./payment-settings-GaRYfsr3.js";import{P as ma,a as ga,T as ba,M as ya}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as vi}from"./catalog-qysuyAKK.js";import{i as xi}from"./app-promo-banner-VTpzwpvR.js";import{M as wi,n as _i,a as ki}from"./categories-BEuiwWw5.js";import{saveCatalogHidden as fa,loadHiddenCatalogIds as Bt,getHiddenCatalogIds as Ze,resetHiddenCatalogIds as Si}from"./catalog-hidden-store-BAMgfUuU.js";const D=1,Q=5e6,$i=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Ei=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],ha=[...$i,...Ei];function Mt(e){return ci[e]||"USD"}function va(e,t){return ha.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function Pi(e,t){const a=Math.max(D,Math.min(Q,Number(e)||D));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Ai(e,t,a,i,n){const o=Pi(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function xa({templateId:e,listingType:t,category:a,countryCode:i,currency:n,price:o}){const r=ha.find(g=>g.id===e&&g.listingType===t);if(!r)return null;const s=ui(i)||Ee[0],u=n||Mt(s.code),d=[s.name].filter(Boolean).join(", "),c={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${s.name}`:r.label,description:Ai(r,s,u,o,d),currency:u,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[s.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...c,country:s.name,country_code:s.code,product_location:s.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...c,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}let mt=null;async function Ii(){return mt||(mt=li(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),mt}function Ci(e,t){return e.toDataURL("image/jpeg",t)}async function Ti(e,t){const a=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,t/Math.max(a.width,a.height))),n=e.getViewport({scale:i}),o=document.createElement("canvas");o.width=Math.max(1,Math.round(n.width)),o.height=Math.max(1,Math.round(n.height));const r=o.getContext("2d",{alpha:!1});return r.fillStyle="#ffffff",r.fillRect(0,0,o.width,o.height),await e.render({canvasContext:r,viewport:n}).promise,Ci(o,.78)}async function Li(e,{maxDim:t=1300,maxPages:a=0,onProgress:i=()=>{}}={}){const o=await(await Ii()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,r=o.numPages,s=a>0?Math.min(r,a):r,u=[];try{for(let d=1;d<=s;d++){i(d,s);const c=await o.getPage(d);u.push(await Ti(c,t))}}finally{try{await o.destroy()}catch{}}return u}function et(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const wa="weverseonlineshop@gmail.com",_a="Weverse Online Shop",ka="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",Bi="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),Mi=`${Bi}/functions/v1/ai-admin-assistant`,Ni=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Ri={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},Sa=[...pi].sort();let C={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function $a(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function ne(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function ye(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function tt(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Fi=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents"];function Se(e){const t={};if(!e||typeof e!="object")return t;for(const a of Fi)a in e&&(t[a]=e[a]);return t}function m(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),n=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",o[t]||"info"),n.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function X(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"â€”"];return`<span class="badge ${a}">${i}</span>`}function oe(){document.getElementById("modal-container").innerHTML=""}function z(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function Y(e,t,a,i,n=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function Pe(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loadingâ€¦</div></div>'}function fe(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${l(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${l(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function Ea(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=Ni.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){C.section=e;const t=Ri[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ea(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Pe()),window.lucide&&lucide.createIcons(),({dashboard:Xi,products:O,properties:rt,catalog:Ce,orders:Wa,customers:An,reviews:Ue,messages:Ka,coupons:st,ads:Ie,notifications:Tn,ai:Di,"ai-settings":Xa,"homepage-branding":ct,"promo-bg":Re,content:Dn,"content-settings":ti,seo:zn,email:Wn,analytics:Vn,security:dt,activity:Kn,brand:ut,"payment-settings":Tt,backup:Yn,settings:Jn,publish:pt}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=fe("construction","Coming Soon",`${t} is being built.`))}))()};async function Di(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const ke="kco_admin_remember",Nt="kco_login_attempts",yt=5,Ui=15*60*1e3;function V(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Oi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function at(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Fe(e){return String(e||"").trim().toLowerCase()}function ji(){try{const e=JSON.parse(localStorage.getItem(ke)||"{}");e?.email&&!Fe(e.email)&&localStorage.removeItem(ke)}catch{localStorage.removeItem(ke)}}function qi(){try{const e=JSON.parse(localStorage.getItem(ke)||"{}");return Fe(e?.email)}catch{return""}}function Rt(){ji();const e=qi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||wa,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function Hi(){return`${window.location.origin}/admin.html`}function ve(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),at(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function H(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Pa(){try{return JSON.parse(localStorage.getItem(Nt)||'{"count":0}')}catch{return{count:0}}}function Aa(){const e=Pa();return e.count=(e.count||0)+1,e.count>=yt&&(e.lockedUntil=Date.now()+Ui),localStorage.setItem(Nt,JSON.stringify(e)),e}function Ia(){localStorage.removeItem(Nt)}function Ca(){const e=Pa();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Ia(),null):Math.ceil(t/6e4)}async function le(e,t,a={}){try{await b.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Gi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Gi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Ta(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await b.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Fe(e.email)===wa}async function Vi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Ve(),Qi();return}const{data:{session:t}}=await b.auth.getSession();if(t?.user&&await Ta(t.user)){const{data:{currentUser:i}}=await b.auth.getUser(),n=await b.auth.mfa.getAuthenticatorAssuranceLevel(),o=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&o!=="aal2"){C.user=t.user,Ve(),ve("2fa"),Ft();return}C.user=t.user,it();return}zi()}function Ve(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function zi(){Ve(),ve("login"),Rt(),La(),Ba(),Ft(),Wi();const e=Ca();e&&(V(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Wi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function La(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Ki),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ve("forgot")))}async function Ki(e){e.preventDefault();const t=Ca();if(t){V(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Fe(a?.value);if(!i){V("Enter your admin email address."),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;H("login-btn",!0),at();const{data:r,error:s}=await b.auth.signInWithPassword({email:i,password:n});if(s||!r.user){const y=String(s?.message||"").toLowerCase();if(y.includes("missing supabase credentials")||y.includes("authentication service is unavailable")){V("Authentication is temporarily unavailable due to configuration. Please contact support."),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("failed to fetch")||y.includes("network request failed")){V("Network error while signing in. Check your connection and try again."),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("email not confirmed")){V("Your admin email is not confirmed yet. Open your verification email and confirm first."),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const v=Aa(),p=yt-v.count,f=v.lockedUntil?`Account locked for 15 minutes after ${yt} failed attempts.`:`Invalid email or password. ${p>0?p+" attempt"+(p!==1?"s":"")+" remaining.":""}`;V(f),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await le(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Ta(r.user)){await b.auth.signOut(),V(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await le(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(ke,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(ke),Ia(),C.user=r.user,(await b.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){H("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ve("2fa"),Ft(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await le(r.user.id,"login_success"),H("login-btn",!1),it()}function Ft(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ea));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ea()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await b.auth.signOut(),C.user=null,ve("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Yi))}async function ea(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){V("Enter the 6-digit code from your authenticator app.");return}H("verify-2fa-btn",!0),at();try{const{data:t}=await b.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){V("No 2FA factor found. Please re-login."),H("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await b.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:o}=await b.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await le(C.user.id,"login_2fa_success"),H("verify-2fa-btn",!1),it()}catch(t){Aa(),V(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),H("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Yi(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){V("Enter a backup recovery code.");return}H("verify-backup-btn",!0);try{const{data:t}=await b.from("admin_2fa").select("backup_codes").eq("user_id",C.user.id).maybeSingle();if(!t?.backup_codes?.length){V("No backup codes found."),H("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){V("Backup code not found or already used."),H("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await b.from("admin_2fa").update({backup_codes:i}).eq("user_id",C.user.id),await le(C.user.id,"login_backup_code_used"),it()}catch(t){V(t.message),H("verify-backup-btn",!1,"Use Backup Code")}}function Ba(){document.getElementById("back-to-login")?.addEventListener("click",()=>ve("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Ji)}async function Ji(){const e=document.getElementById("reset-email"),t=Fe(e?.value);if(!t){V("Enter your admin email address to receive a reset link.");return}H("send-reset-btn",!0),at();const{error:a}=await b.auth.resetPasswordForEmail(t,{redirectTo:Hi()});if(H("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){V(a.message);return}Oi("Reset link sent! Check your inbox and open it from this device to continue.")}function Qi(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await b.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}m("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function it(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&C.user&&(t.textContent=C.user.email||"Admin"),Rt(),navigate("dashboard")}window.adminSignOut=async function(){C.user&&await le(C.user.id,"logout"),await b.auth.signOut(),C.user=null,Ve(),ve("login"),Rt(),La(),Ba()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(C.user&&await le(C.user.id,"logout_all_devices"),await b.auth.signOut({scope:"global"}),C.user=null,m("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Xi(){const e=document.getElementById("content");try{const[t,a,i,n]=await Promise.all([b.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),b.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),b.from("profiles").select("user_id,created_at",{count:"exact"}),b.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=t.data||[],r=a.data||[],s=r.filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,k)=>x+(parseFloat(k.amount)||0),0),u=r.filter(x=>["pending","pending_verification","processing"].includes(x.status)).length,d=o.filter(x=>x.listing_type!=="property").length,c=o.filter(x=>x.listing_type==="property").length,g=o.filter(x=>x.listing_type!=="property"&&x.is_active).length,y=i.count||0,v=n.count||0,p=(n.data||[]).filter(x=>!x.is_approved).length,f=new Date,_=r.filter(x=>{const k=new Date(x.created_at);return k.getMonth()===f.getMonth()&&k.getFullYear()===f.getFullYear()}).filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,k)=>x+(parseFloat(k.amount)||0),0),S=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-black text-white">Good ${nn()}, Admin</h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${Y("Total Revenue",`$${s.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${_.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${Y("Total Orders",r.length,"shopping-bag","blue",`${u} pending`)}
          ${Y("Customers",y,"users","violet")}
          ${Y("Products",d,"package","amber",`${g} active`)}
          ${Y("Properties",c,"home","blue")}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${S.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':S.map(x=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${ye(x.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),Ra(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}async function O(){const e=document.getElementById("content");try{const{data:t,error:a}=await b.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,n=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),n.push(d));for(const d of Xe().filter(c=>c.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),n.push(d));if(Array.isArray(ie))for(const d of ie.filter(c=>c.listing_type!=="property"&&c.property_id))i.has(d.property_id)||(i.add(d.property_id),n.push(d));const o=[...ma,...ga,...ba,...ya];for(const d of o)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),n.push(d));n.sort((d,c)=>new Date(c.created_at||0)-new Date(d.created_at||0));try{await Bt()}catch{}const r=new Set(Ze());if(r.size)for(let d=n.length-1;d>=0;d--)n[d]&&n[d].property_id&&r.has(n[d].property_id)&&n.splice(d,1);const s=[...new Set(n.map(d=>d.category).filter(Boolean))].sort((d,c)=>d.localeCompare(c)),u=[...new Set(n.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,c)=>d.localeCompare(c));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${Y("Inventory Units",n.reduce((d,c)=>d+(parseInt(c.stock_quantity,10)||0),0),"boxes","blue")}
          ${Y("Avg Price",`$${Math.round(n.reduce((d,c)=>d+(parseFloat(c.price)||0),0)/Math.max(n.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(s.length?s:pe).map(d=>`<option value="${l(d)}" ${(window._productFilters.category||"")===d?"selected":""}>${l(d)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
          ...
          <div id="products-empty" class="hidden">${fe("package-search","No matching products","Try different filters or add a new product.",'<button onclick="showAddProductStep1()" class="btn-press bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2 rounded-xl">Add Product</button>')}</div>
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,Ma(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function ce(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function ft(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Zi(e){const t=ce(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function en(e){const t=ce(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function Dt(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function ht(e){return parseInt(e.views??e.view_count??0,10)||0}function vt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Ut(e){return e.sku||e.property_id||"N/A"}function tn(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=ft(e),i=Dt(e),n=window._productSelection?.has(e.property_id),o=X(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=ne(e.created_at),s=!!e.is_featured,u=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",c=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${s?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${l(Ut(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${l(Zi(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${ht(e).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${vt(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(g=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${l(g)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function an(e,t){const a=[...e],i=n=>new Date(n||0).getTime()||0;return t==="oldest"?a.sort((n,o)=>i(n.created_at)-i(o.created_at)):t==="price-high"?a.sort((n,o)=>ce(o.price)-ce(n.price)):t==="price-low"?a.sort((n,o)=>ce(n.price)-ce(o.price)):t==="sales-high"?a.sort((n,o)=>vt(o)-vt(n)):t==="views-high"?a.sort((n,o)=>ht(o)-ht(n)):a.sort((n,o)=>i(o.created_at)-i(n.created_at)),a}function Ma(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const n=window._productsCardLimit||60,o=e.slice(0,n);t.innerHTML=o.map(tn).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const s=e.length-o.length;s>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,s)} more (${s} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Na(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const n=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=Dt(i),r=window._productSelection?.has(i.property_id),s=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,u=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${l(Ut(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="flex gap-1">
              ...
              <button onclick="${s}" class="btn-press p-1.5 ${i.is_active?"text-amber-400 hover:bg-amber-500/10":"text-emerald-400 hover:bg-emerald-500/10"} rounded-lg transition" title="${u}"><i data-lucide="${i.is_active?"eye-off":"eye"}" class="w-3.5 h-3.5"></i></button>
        ...
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),i=document.getElementById("view-card-btn"),n=document.getElementById("view-table-btn"),o=document.getElementById("products-empty"),r=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&Na(r)),i&&i.classList.toggle("active",e!=="table"),n&&n.classList.toggle("active",e==="table"),o&&o.classList.toggle("hidden",r.length>0)};window.filterProducts=function(e){const t=window._productFilters||{};t.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),t.category=document.getElementById("prod-cat-filter")?.value||"",t.tag=document.getElementById("prod-tag-filter")?.value||"",t.status=document.getElementById("prod-status-filter")?.value||"",t.featured=document.getElementById("prod-featured-filter")?.value||"",t.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=t;const a=(window._productsData||[]).filter(n=>{const o=[n.title,n.brand,n.category,Ut(n),ft(n).join(" "),n.description].join(" ").toLowerCase();return!(t.search&&!o.includes(t.search)||t.category&&(n.category||"")!==t.category||t.tag&&!ft(n).includes(t.tag)||t.status&&Dt(n)!==t.status||t.featured&&t.featured==="featured"!=!!n.is_featured)}),i=an(a,t.sort);e||(window._productsCardLimit=60),Ma(i),window._productView==="table"&&Na(i)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const i=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(i):window._productSelection.delete(i)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function nt(){return window._productSelection?[...window._productSelection]:[]}function ee(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function xt(e,t,a){return e&&ee(e)?(m(`âš ï¸ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),m(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=nt();if(!t.length)return;const a=await Promise.all(t.map(o=>{const r=Se((window._productsData||[]).find(s=>s.property_id===o));return b.from("showroom_listings").upsert({...r,property_id:o,is_active:e},{onConflict:"property_id"})}));if(a.some(o=>o.error&&ee(o.error))){m(`âš ï¸ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,O();return}const n=a.filter(o=>o.error).length;m(`${t.length-n}/${t.length} products ${e?"published":"unpublished"}${n?` (${n} failed: ${a.find(o=>o.error)?.error?.message||"error"})`:""}`,n?"error":"success"),window._productSelection=new Set,O()};window.bulkDuplicateProducts=async function(){const e=nt();if(e.length){for(const t of e)await duplicateProduct(t,!0);m(`${e.length} products duplicated`),window._productSelection=new Set,O()}};window.bulkArchive=async function(){const e=nt();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(n=>b.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",n)));if(t.some(n=>n.error&&ee(n.error))){m("âš ï¸ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,O();return}const i=t.filter(n=>n.error).length;m(`${e.length-i}/${e.length} products archived${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,O()};window.bulkDeleteProducts=async function(){const e=nt();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(n=>b.from("showroom_listings").delete().eq("property_id",n)));if(t.some(n=>n.error&&ee(n.error))){m("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,O();return}const i=t.filter(n=>n.error).length;m(`${e.length-i}/${e.length} products deleted${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,O()};window.previewProduct=async function(e){const t=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return m("Product not found","error");z(`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${X(a.is_active?"active":"inactive")}${a.is_featured?'<span class="badge bg-amber-500/15 text-amber-200 border-amber-500/30">Featured</span>':""}</div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!a)return m("Product not found","error");const i=Array.isArray(a.images)?a.images:[];z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),Ot(),jt(),Ae(),we(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb")].map(c=>c.dataset.url||(c.querySelector("img")?c.querySelector("img").getAttribute("src"):"")).filter(c=>c&&!String(c).startsWith("blob:")),n={title:a.get("title")||"Untitled Product",price:Math.max(D,Math.min(Q,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},o=String(a.get("real_price")||"").trim(),r=o===""?null:parseFloat(o);if(r!=null&&!Number.isFinite(r)){m("Real Price must be a number.","error");return}const s=Se((window._productsData||[]).find(c=>c.property_id===t)),u=s.specifications&&typeof s.specifications=="object"?s.specifications:{};n.specifications={...u,real_price:r!=null&&r>0?Math.round(r):null};const{error:d}=await b.from("showroom_listings").upsert({...s,...n,property_id:t},{onConflict:"property_id"});if(d){if(ee(d)){m("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),oe(),O();return}mi(t,n),m("Quick edit saved locally","info")}else m(n.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");oe(),O()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),m("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||Lt(e),{error:a}=await b.from("showroom_listings").delete().eq("property_id",e);if(a&&!ee(a))return m("Delete failed: "+a.message,"error");gi(e);try{const i=await fa(e,!0);i&&i.error&&ee(i.error)?m("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):m("Product deleted")}catch{m("Product deleted")}t&&t.listing_type==="property"?rt():O()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?

This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await b.from("showroom_listings").delete().neq("property_id","__none__");if(t)return ee(t)?m("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):m("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}m("All products deleted. The manager now shows your showroom catalog."),O()};window.openProductMoreActions=function(e){z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Ua(n)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-4 glass-soft border border-blue-500/15 rounded-2xl">
              ...
              <p class="text-sm text-gray-500 mt-1">Allowed price range is ${D} to ${Q} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),Ot(),jt(),_t("pf-price"),_t("pf-real_price"),kt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>kt(e,"pricing")),cn(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),Ne=-1,oe(),O()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[n,o]of i.entries())n==="images"?(a.images=a.images||[],o&&!String(o).startsWith("blob:")&&a.images.push(String(o))):n==="tags"?(a.tags=a.tags||[],a.tags.push(o)):a[n]=o;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function xe(e,t){const i=et(e)?'<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-300 select-none"><span class="text-2xl leading-none">📄</span><span class="text-[10px] font-bold mt-1">PDF</span></div>':`<img src="${l(e)}" onerror="this.src='/fallback.svg'">`;return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" data-url="${l(e)}" title="${t===0?"Cover Image (main photo)":"Image "+(t+1)}">
    ${i}
  ...
  </div>`}function Ot(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),sn(t.dataTransfer.files)}))}function jt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Ae()})}window.handleImageUpload=async function(e){await Oa(e.target.files)};async function sn(e){await Oa(e)}async function Oa(e){const t=document.getElementById("image-preview");if(t){for(const a of e){const i=a.type==="application/pdf"||et(a.name);if(!a.type.startsWith("image/")&&!i)continue;const n=await qt(a);if(n){const o=t.children.length,r=document.createElement("div");r.innerHTML=xe(n,o),t.appendChild(r.firstElementChild),Ae()}}De(),we(),window.lucide&&lucide.createIcons()}}async function qt(e){try{const{data:{session:t}}=await b.auth.getSession(),a=(e.name||"photo.jpg").split(".").pop()||"jpg",i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`;for(let n=0;n<2;n++){const o=`${i}${n?"-"+Math.random().toString(36).slice(2,7):""}.${a}`,{error:r}=await b.storage.from("product-images").upload(o,e,{contentType:e.type,upsert:!1});if(r)console.warn("product-images upload failed (attempt "+(n+1)+"):",r.message||r);else{const{data:s}=b.storage.from("product-images").getPublicUrl(o);if(s&&s.publicUrl)return s.publicUrl}}try{const n=await F._downscaleImage(e,1200);if(n)return n}catch{}return URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Ae(),De(),we()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0],n=i.type==="application/pdf"||et(i.name);if(!i.type.startsWith("image/")&&!n){m("Please choose an image or PDF file.","error");return}const o=await qt(i);if(!o)return;const s=[...a.querySelectorAll(".img-thumb")][e];s&&(s.outerHTML=xe(o,e),Ae(),De(),we(),m(n?"Document replaced. Save changes to apply.":"Image replaced. Save changes to apply.","info"))};function Ae(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const n=a.dataset.url||(a.querySelector("img")?a.querySelector("img").src:"");if(!n)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=n,t.appendChild(o),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const s=a.querySelector(".rp");s&&s.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const u=a.querySelector(".rp-input");u&&(u.id=`rp-input-${i}`,u.onchange=()=>replaceImage(i,u))}))}function De(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function we(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length;t.textContent=a?`${a} image${a>1?"s":""} â€” you can save and publish anytime`:"No images yet â€” you can still save and publish anytime",t.className="text-sm mt-1 font-bold text-gray-400"}function Me(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function ln(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,n]of t.entries())i==="images"?n&&!String(n).startsWith("blob:")&&a.images.push(String(n)):i==="tags"?a.tags.push(String(n)):a.fields[i]=String(n);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function dn(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([n,o])=>{const r=e.querySelector(`[name="${n}"]`);r&&(r.type==="checkbox"?r.checked=o==="on"||o===!0:r.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(n=>{n.checked=i.includes(n.value)}),Array.isArray(t.images)){const n=document.getElementById("image-preview");n&&(n.innerHTML=t.images.map((o,r)=>xe(o,r)).join(""),Ae(),De(),we())}return!0}function $t(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",n=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,s=r===""||r==null?"Unlimited":r,u=C.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(y=>y.value),c=document.querySelectorAll("#image-preview .img-thumb").length,g=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,s=e.dataset.category||"Product",u=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${X(d?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${l(s)}</span></div>
    ...
    </div>`)};function cn(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Me(e,t),n=document.getElementById("product-autosave-note");if(!t)try{const u=localStorage.getItem(i);if(u){const d=JSON.parse(u);dn(a,d)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(ln(a))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}$t()};let r;const s=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(u=>{u.addEventListener("input",s),u.addEventListener("change",s)}),$t(),we()}const un=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],pn=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],mn=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],gn=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],bn=["FWD","RWD","AWD","4WD"],gt=["title","description","brand","model","model_year","color","condition","subcategory","engine","transmission","fuel_type","drive_type","horsepower","mileage","seating_capacity","doors","body_type","safety_features","storage","ram","processor","display","graphics","os","material","size","gender","platform","voltage","type","dimensions","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","country_code","latitude","longitude","listing_status","interior_features","exterior_features","home_systems","author","publisher","language","format","isbn","pages","edition","quantity","age_range","skin_type","ingredients","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","warranty","availability_status"],We=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function aa(e){const t=e.id?`label[for="${e.id}"]`:null,a=t?document.querySelector(t):null;if(a)return a.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function yn(e){const t=typeof e=="string"?document.querySelector(e):e;if(!t)return[];const a=new Set,i=[];return t.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const o=String(n.name||"");if(!o||o==="images"||a.has(o)||["hidden","file","submit","button"].includes(n.type))return;if(a.add(o),n.type==="checkbox"){const s=[...t.querySelectorAll(`input[name="${o}"]`)];i.push({key:o,label:aa(n),type:"checkbox-group",options:s.map(u=>u.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const r=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:o,label:aa(n),type:r,options:n.tagName==="SELECT"?[...n.options].map(s=>s.value).filter(Boolean):null,required:!!n.required})}),i}function fn(e){return!e||!e.length?"":`
THE COMPLETE LIST OF FORM FIELDS (every single one MUST be accounted for):
${e.filter(a=>!We.has(a.key)).map(a=>{let i=a.type;return a.type==="select"&&a.options&&a.options.length<=24?i+=` [options: ${a.options.join(" | ")}]`:a.type==="checkbox-group"&&a.options&&a.options.length?i+=` [multi-select: ${a.options.join(" | ")}]`:a.type==="number"?i="number":a.type==="textarea"&&(i="long text"),`- "${a.key}" (${a.label}) — ${i}`}).join(`
`)}
`}const ja=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function ia(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(c=>String(c)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(c=>String(c)):[]),o=[],r=[],s=c=>{if(c==null)return"";Array.isArray(c)&&(c=c.filter(y=>y!=null&&String(y).trim()!=="").join(", "));let g=String(c).replace(/\s+/g," ").trim();return g=g.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),g},u=c=>{const g=s(c).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),y=parseFloat(g);return Number.isFinite(y)?y:NaN};for(const c of e||[]){if(We.has(c.key))continue;const g={key:c.key,label:c.label,status:"empty-ok",value:null,note:""};if(c.type==="checkbox-group"){const p=Array.isArray(a[c.key])?a[c.key].map(s).filter(Boolean):[],f=c.options&&c.options.length?p.filter(w=>c.options.includes(w)):p;f.length?(a[c.key]=f,g.status="filled",g.value=f.join(", ")):(delete a[c.key],p.length&&(g.status="flagged",g.note="values not in the allowed badge list were dropped",r.push(`${c.label}: invalid selection ignored`))),o.push(g);continue}if(!(a[c.key]!=null&&s(a[c.key])!=="")){g.status=n.has(c.key)?"missing":"empty-ok",o.push(g);continue}if(ja.test(s(a[c.key]))){delete a[c.key],n.add(c.key),g.status="missing",g.note="document/AI said the value is unavailable",o.push(g);continue}if(c.type==="number"){const p=s(a[c.key]),f=u(a[c.key]);if(!Number.isFinite(f)){delete a[c.key],n.add(c.key),g.status="flagged",g.note=`"${p}" is not a valid number`,r.push(`${c.label}: not a valid number`),o.push(g);continue}if(/year/.test(c.key)&&(f<1800||f>new Date().getFullYear()+2)){delete a[c.key],n.add(c.key),g.status="flagged",g.note=`${f} is outside the plausible range`,r.push(`${c.label}: implausible value ${f}`),o.push(g);continue}a[c.key]=f,g.status="filled",g.value=String(f),i.has(c.key)&&(g.status="estimated",g.note="AI estimate â€” confirm"),o.push(g);continue}if(c.type==="select"&&c.options&&c.options.length){const p=qa({options:c.options.map(f=>({value:f}))},s(a[c.key]));if(p==null){g.status="flagged",g.note=`"${s(a[c.key])}" does not match any option â€” left empty`,r.push(`${c.label}: no matching option`),delete a[c.key],n.add(c.key),o.push(g);continue}a[c.key]=p,g.status="filled",g.value=p,p!==s(t?.[c.key])&&(g.note="matched to the closest option"),o.push(g);continue}let v=s(a[c.key]);c.type!=="textarea"&&c.type!=="text-long"&&v.length>120&&!["title"].includes(c.key)&&(g.status="flagged",g.note="unusually long â€” check it landed in the right field",r.push(`${c.label}: suspiciously long value`)),a[c.key]=v,g.status="filled",g.value=v.length>48?v.slice(0,48)+"â€¦":v,i.has(c.key)&&(g.status="estimated",g.note="AI estimate â€” confirm"),o.push(g)}if(e&&e.length){const c=new Set([...e.map(g=>g.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(g=>{c.has(g)||delete a[g]})}a.missing_fields=o.filter(c=>c.status==="missing").map(c=>c.key),a.estimated=o.filter(c=>c.status==="estimated").map(c=>c.key);const d={total:o.length,filled:o.filter(c=>c.status==="filled").length,estimated:o.filter(c=>c.status==="estimated").length,flagged:o.filter(c=>c.status==="flagged").length,missing:o.filter(c=>c.status==="missing").length};return{specs:a,checklist:o,flags:r,summary:d}}function Ht(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[o.status]||""}</span><span><b>${l(o.label)}</b> <span class="text-gray-600">(${l(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${l(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${l(o.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    <div class="flex items-center justify-between gap-2 flex-wrap">
      ...
      <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold border ${r}">${l(o).toUpperCase()}</span>
    </div>
    <div class="flex items-center gap-2 flex-wrap">
      ${s.map(u=>`<img src="${l(u)}" class="w-10 h-10 rounded-lg object-cover border border-violet-500/20" onerror="this.src='/fallback.svg'">`).join("")}
  ...
  </div>`}window.scanReviewRender=function(){const e=document.getElementById(Z);if(e){if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!U.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed â€” nothing was changed.";return}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
        <p class="text-xs font-bold text-white flex items-center gap-2"><i data-lucide="list-checks" class="w-4 h-4 text-violet-400"></i> ${U.length} distinct product${U.length>1?"s":""} detected</p>
      ...
      ${U.map((t,a)=>wn(t,a)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=U[e];if(!t)return;Ne=e;const a=Gt(t,be),i=ot(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(Z==="s1-scan-status"||Z==="scanner-scan-status")&&(oe(),me=[]),_n(t,a);return}const o=i.category||t.category||"Other";if(Z==="s1-scan-status"||Z==="scanner-scan-status"){try{localStorage.removeItem(Me(o,""))}catch{}me=[];let r=t.property_id?he[t.property_id]:null;r&&r.specifications&&typeof r.specifications=="object"&&(r={...r,...r.specifications}),showAddProductStep2(o,r?{...r,images:a}:{images:a}),await oa(t,a,o)}else{const r=document.getElementById("product-form"),s=r&&r.dataset.category||"";if(o!==s){try{localStorage.removeItem(Me(o,""))}catch{}switchProductFormCategory(o);const u=document.getElementById(Z);u&&(u.classList.remove("hidden"),u.classList.add("text-blue-300"),u.textContent=`Category changed to ${o} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await oa(t,a,o)}};window.scanReviewEdit=function(e){const t=U[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=ot(t.category),o=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",r=pe.map(s=>`<option value="${l(s)}" ${s===o?"selected":""}>${l(s)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=U[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,n=document.getElementById(`sr-model-${e}`)?.value,o=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),n&&(t.model=n),o&&(t.category=o),scanReviewRender()};window.scanReviewRemove=function(e){U.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(Z);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled â€” nothing was changed.")};window.scanReviewContinueAll=async function(){const e=document.getElementById(Z),t=(d,c)=>{e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400","text-gray-100"),c&&e.classList.add(c),e.innerHTML=d,window.lucide&&lucide.createIcons())};if(!U.length)return;const a=document.getElementById("btn-scan-continue-all");a&&(a.disabled=!0,a.textContent="Saving everythingâ€¦");const i=U.length;let n=0,o=0,r=0;const s=[];for(let d=0;d<i;d++){const c=U[d];if(!c)continue;const g=ot(c.category);if(c.listing_type==="property"||g&&g.listing_type==="property"){s.push(d);continue}const v=g.category||c.category||"Other",p=Gt(c,be);t(`<p class="flex items-center gap-2"><i data-lucide="loader" class="w-4 h-4 animate-spin text-blue-300"></i> Completing ${d+1} of ${i}: <b>${l(c.detected_name||"product")}</b>â€¦</p>`,"text-blue-300");try{const f=await F.completeSpecsAndPrice(p,c,{category:v,maxImages:ge.maxImages}).catch(()=>null);let w=f&&f.specs||{},_=f?f.price:null;try{const $=await F.verifyExtraction(p,c,w,[],{maxImages:ge.maxImages});if($&&$.corrections&&typeof $.corrections=="object"){for(const[j,E]of Object.entries($.corrections))E==null||String(Array.isArray(E)?E.join(", "):E).trim()===""||gt.includes(j)&&(w[j]=E);for(const[j,E]of Array.isArray($.wrong_mapping)?$.wrong_mapping:[])gt.includes(E)&&w[j]!=null&&(w[E]==null||String(w[E]).trim()==="")&&(w[E]=w[j],delete w[j])}}catch{}const S={};for(const[$,j]of Object.entries(w)){if(!gt.includes($)||We.has($))continue;const E=Array.isArray(j)?j.map(te=>String(te??"").replace(/\s+/g," ").trim()).filter(Boolean):String(j??"").replace(/\s+/g," ").trim();if(!(!E.length||(Array.isArray(E)?E.join(" "):E).match(ja))){if(/^(model_)?year/.test($)){const te=parseInt(E,10);if(!Number.isFinite(te)||te<1800||te>new Date().getFullYear()+2)continue}S[$]=E}}w=S;const x=w||{},k=c.property_id&&he[c.property_id]||null,h=k?k.specifications&&typeof k.specifications=="object"?{...k,...k.specifications}:k:null,M=[c.year||x.year,c.brand||x.brand,c.model||x.model].filter(Boolean).join(" ")||c.detected_name||"Product",q=_?Number(_.estimated_price??_.price??_.estimate):NaN;let G=Number.isFinite(q)&&q>0?q:h?Number(h.price):NaN;(!Number.isFinite(G)||G<=0)&&(G=D),G=Math.max(D,Math.min(Q,G));const R=new Set(["title","description","brand","color","size","condition","warranty","availability_status"]),P={};for(const[$,j]of Object.entries({...Object.fromEntries(Et.filter(E=>E!=="year_estimated"&&E!=="listing_status").map(E=>[E,c[E]??null])),...x})){if(R.has($)||We.has($))continue;const E=Array.isArray(j)?j.filter(te=>te!=null&&String(te).trim()!==""):j;E==null||typeof E=="string"&&!E.trim()||(P[$]=E)}const T={...h&&h.specifications&&typeof h.specifications=="object"?h.specifications:{},...P},W={listing_type:"product",category:v,subcategory:h?.subcategory||x.subcategory||null,title:x.title||h&&h.title||M,description:x.description||h&&h.description||"",price:G,currency:h&&h.currency||"USD",country:h&&h.country||"",country_code:h&&h.country_code||"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:!0,is_featured:!!(h&&h.is_featured),brand:c.brand||x.brand||h&&h.brand||null,color:x.color||h&&h.color||null,size:x.size||h&&h.size||null,condition:h&&h.condition||null,warranty:h&&h.warranty||null,availability_status:h&&h.availability_status||"In Stock",stock_quantity:h&&h.stock_quantity?parseInt(h.stock_quantity):null,images:p.length?p:h&&h.images||[],features:Array.isArray(x.features)&&x.features.length?x.features:h&&h.features||[],tags:Array.isArray(x.tags)&&x.tags.length?x.tags:h&&h.tags||[],highlights:Array.isArray(x.highlights)&&x.highlights.length?x.highlights:h&&h.highlights||[],seo_keywords:Array.isArray(x.seo_keywords)&&x.seo_keywords.length?x.seo_keywords:h&&h.seo_keywords||[],is_ai_generated:!0,ai_generated_fields:["title","description","specifications","price"],specifications:T,updated_at:new Date().toISOString()};if(h&&h.property_id){W.property_id=h.property_id;const{error:$}=await b.from("showroom_listings").upsert(W,{onConflict:"property_id"});if($)throw $;o++}else{W.property_id=tt();const{error:$}=await b.from("showroom_listings").insert(W);if($)throw $;n++}}catch(f){r++,t(`<p class="text-amber-300">Could not save "${l(c.detected_name||"product")}": ${l(String(f?.message||f))} â€” continuing with the restâ€¦</p>`,"text-amber-300")}}U=U.filter((d,c)=>s.includes(c));const u=`${o} updated, ${n} new${r?`, ${r} failed`:""}`;if(!U.length)he={},be=[],t(`<div class="space-y-1">
    ...
    </div>`,"text-emerald-300"),m(`All done â€” ${u} saved & published.`,"success");else{scanReviewRender();const d=document.getElementById(Z);if(d){const c=document.createElement("p");c.className="text-xs font-bold text-emerald-300",c.textContent=`Saved & published: ${u}. Property cards below still need Continue.`,d.prepend(c)}m(`Saved ${u}.`,r?"info":"success")}O()};function Ga(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,n=[],o=A=>Array.isArray(A)?A.join(", "):String(A??"").trim(),r=(A,B)=>{if(B==null||o([B])==="")return;const J=document.querySelector(`#property-form [name="${A}"]`);J&&(J.value=String(B),n.push(A))},s=t.property_type||a.property_type;if(s){const A=xn(s);A&&r("property_type",A)}r("title",a.title||t.detected_name),r("description",a.description),r("subcategory",t.subcategory||a.subcategory);const u=t.bedrooms??a.bedrooms;u!=null&&u!==""&&r("bedrooms",parseInt(u,10)||u);const d=t.bathrooms??a.bathrooms;d!=null&&d!==""&&r("bathrooms",parseInt(d,10)||d),r("building_size",t.building_size||a.building_size),r("land_size",t.land_size||a.land_size);const c=t.parking_spaces??a.parking_spaces;c!=null&&c!==""&&r("parking_spaces",parseInt(c,10)||c);const g=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(g)?r("furnished","Furnished"):/unfurnished|no|empty/.test(g)&&r("furnished","Unfurnished");const y=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(y)?r("listing_status","rent"):/sale|buy|purchase/.test(y)&&r("listing_status","sale");const v=t.area||a.area;v&&!(t.town||a.town)&&r("town",v),r("town",t.town||a.town),r("city",t.city||a.city),r("state",t.state||a.state);const p=t.country||a.country;if(r("country",p),p){const A=(Ee||[]).find(B=>String(B.name||"").toLowerCase()===String(p).toLowerCase()||String(B.code||"").toLowerCase()===String(p).toLowerCase());if(A&&A.code){const B=document.querySelector('#property-form [name="country_code"]');B&&(B.value=A.code,n.push("country_code"))}}const f=t.address||a.address;r("product_location",f||[v||t.town||a.town,t.city||a.city,t.state||a.state,p].filter(Boolean).join(", ")),r("address",t.address||a.address),r("zip_code",t.zip_code||a.zip_code);const w=Number(t.latitude??a.latitude),_=Number(t.longitude??a.longitude);Number.isFinite(w)&&w>=-90&&w<=90&&w!==0&&r("latitude",String(w)),Number.isFinite(_)&&_>=-180&&_<=180&&_!==0&&r("longitude",String(_)),r("features_text",o(a.features)),r("highlights_text",o(t.highlights||a.highlights)),r("seo_keywords_text",o(a.seo_keywords));const S=t.half_bathrooms??a.half_bathrooms;S!=null&&S!==""&&r("half_bathrooms",parseInt(S,10)||S);const x=t.floors??a.floors;x!=null&&x!==""&&r("floors",parseInt(x,10)||x),r("garage",t.garage||a.garage);const k=t.year_built??a.year_built;k!=null&&k!==""&&r("year_built",parseInt(k,10)||k);const h=t.year_renovated??a.year_renovated;h!=null&&h!==""&&r("year_renovated",parseInt(h,10)||h);const M=t.condition||a.condition,q=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(M){const A=String(M).toLowerCase(),B=q.find(J=>A.includes(J.toLowerCase())||J.toLowerCase().includes(A));B&&r("condition",B)}r("interior_features_text",o(a.interior_features)),r("exterior_features_text",o(a.exterior_features)),r("home_systems_text",o(a.home_systems));const G=o(t.landmarks||a.landmarks);G&&r("landmarks_text",G);const R=a.floor_plan;if(R&&typeof R=="object"){R.image&&r("floor_plan_image",R.image),R.levels&&r("floor_plan_levels",R.levels),R.total_area&&r("floor_plan_total_area",R.total_area);const A=Array.isArray(R.rooms)?R.rooms.map(B=>{const J=String(B).match(/^(.*?):\s*(.*)$/);return J?`${J[1].trim()}: ${J[2].trim()}`:String(B)}):[];A.length&&r("floor_plan_rooms",A.join(", "))}const P=a.nearby_area;P&&typeof P=="object"&&(Array.isArray(P.schools)&&P.schools.length&&r("nearby_schools_text",P.schools.join(", ")),Array.isArray(P.hospitals)&&P.hospitals.length&&r("nearby_hospitals_text",P.hospitals.join(", ")),Array.isArray(P.shopping)&&P.shopping.length&&r("nearby_shopping_text",P.shopping.join(", ")),Array.isArray(P.transportation)&&P.transportation.length&&r("nearby_transportation_text",P.transportation.join(", ")),Array.isArray(P.distances)&&P.distances.length&&r("nearby_distances_text",P.distances.join(", ")));const T=Array.isArray(a.legal_info)?a.legal_info.join(", "):o(a.legal_info);T&&r("legal_info_text",T),a.inspection_info&&r("inspection_info",a.inspection_info),a.risk_notes&&r("risk_notes",a.risk_notes);const W=document.querySelector('#property-form [name="verification_status"]');W&&(W.value="Not verified",n.push("verification_status"));const $=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map(A=>String(A))),j=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);$.forEach(A=>{if(j.has(A))return;const B=document.querySelector(`#property-form [name="${A}"]`);if(!(!B||B.type==="checkbox"||B.type==="radio"||B.type==="number")&&String(B.value||"").trim()===""){if(B.tagName==="SELECT"&&![...B.options].some(J=>J.value==="Not specified")){const J=document.createElement("option");J.value="Not specified",J.textContent="Not specified",B.appendChild(J)}B.value="Not specified",n.push(`${A} (Not specified)`)}});const E=Number.isFinite(Number(D))?Number(D):0,te=Number.isFinite(Number(Q))?Number(Q):999999999,Qt=A=>Math.max(E,Math.min(te,Math.round(A))),Te=i?Number(i.estimated_price):NaN,je=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(Te)&&Te>0){const A=document.querySelector('#property-form [name="real_price"]');A&&(A.value=String(Qt(Te)),n.push("real_price"));const B=Number.isFinite(je)&&je>0&&je<Te?je:Te;r("price",String(Qt(B)))}const Xt=String(a.title||t.detected_name||"Property").trim()||"Property",si=a.description||`${Xt} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,Zt=Ha("#property-form",{titleFallback:Xt,descriptionFallback:si});return Zt&&n.push(`${Zt} auto-completed (Not specified / safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:n}}const Et=["brand","model","year","year_estimated","body_type","color","condition","subcategory","property_type","bedrooms","bathrooms","half_bathrooms","building_size","land_size","floors","garage","parking_spaces","furnished","year_built","year_renovated","area","address","zip_code","landmarks","town","city","state","country","latitude","longitude","listing_status"];function Vt(){return Date.now()<(typeof F<"u"&&F._geminiQuotaUntil||0)?'<p class="text-[11px] text-amber-300 mt-1">⚠ Your Gemini key hit its FREE rate limit during this scan — parts were completed from saved details only. Wait ~1 minute and scan again for full AI reading.</p>':""}async function zt({imageUrls:e,identification:t,category:a,formSelector:i}){const n=yn(i),o=fn(n),r=await F.completeSpecsAndPrice(e,t,{category:a||"",maxImages:ge.maxImages,fieldsSchema:o}),s=r?r.price:null,u=r&&r.specs||{};let d={};for(const p of Et)t&&t[p]!=null&&t[p]!==""&&(d[p]=t[p]);d={...d,...u};let c=ia(n,d),g=!1;const y=`${r&&r.specs&&r.specs._aiProvider||""} ${r&&r.specs&&r.specs._aiModel||""}`;if(!/pollinations|free ai/i.test(y))try{const p=await F.verifyExtraction(e,t,c.specs,n,{maxImages:ge.maxImages});if(p){const f=p.corrections&&typeof p.corrections=="object"?p.corrections:{},w=Object.keys(f);if(w.length){const _={...c.specs};for(const[S,x]of Object.entries(f))n.some(k=>k.key===S)&&(x==null||String(Array.isArray(x)?x.join(", "):x).trim()===""||(_[S]=x));for(const[S,x]of Array.isArray(p.wrong_mapping)?p.wrong_mapping:[])_[S]!=null&&(_[x]==null||String(_[x]).trim()==="")&&(_[x]=_[S],delete _[S]);c=ia(n,_),t={...t};for(const S of w)Et.includes(S)&&c.specs[S]!=null&&(t[S]=c.specs[S])}g=!0,c.verificationNotes=Array.isArray(p.notes)?p.notes.slice(0,4):[]}}catch{}return{specs:c.specs,price:s,checklist:c.checklist,summary:c.summary,verified:g,verificationNotes:c.verificationNotes||[],identification:t}}async function oa(e,t,a){const i=document.getElementById("scan-ai-status"),n=(o,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=o)};try{n("Reading every image/page, completing all specifications and pricesâ€¦","text-blue-300");let o=e;const r=await zt({imageUrls:t,identification:o,category:a,formSelector:"#product-form"});o=r.identification||o;const s=vn({identification:o,specs:r.specs,price:r.price}),u=[o.year,o.brand,o.model].filter(Boolean).join(" ")||o.detected_name||"the product";let d=`${l(u)} â€” ${s.filled.length} field${s.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;o.year_estimated&&(d+=" Confirm the model year before saving."),d+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>',r.summary.flagged&&(d+=`<p class="text-[11px] text-red-300 mt-1">${r.summary.flagged} value${r.summary.flagged>1?"s need":" needs"} your attention below.</p>`),d+=Vt(),d+=Ht(r.checklist,r.summary),n(d,"text-emerald-300"),m(`Review ${u}, then press SAVE / UPDATE.`,"success")}catch(o){const r=String(o?.message||o),s=/key|api|configured|settings|vision/i.test(r);n(s?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),m("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){m("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(u=>u.value).filter(Boolean);if(!i.length){m("Upload at least one product image before scanning.","error");return}const n=t?t.innerHTML:"",o=(u,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=u)};try{const u=await F.getConfig();String(u.gemini_key||u.gemini_api_key||"").trim()||o("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),o("Detecting every distinct product in your imagesâ€¦","text-blue-300");let r;try{r=await F.detectProducts(i,{category:e.dataset.category||"",maxImages:ge.maxImages})}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),m("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);let s=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];s.length||(s=[{detected_name:"Product from your photos",category:e.dataset.category||"Other",listing_type:"product",confidence:"low",image_indices:i.map((u,d)=>d)}],o("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),U=s,be=i,he={},Z="scan-ai-status",scanReviewRender(),m(`${s.length} distinct product${s.length>1?"s":""} detected â€” review each one, then continue.`,"info")};function _n(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((r,s)=>xe(r,s)).join(""),i.innerHTML=t.map((r,s)=>`<input type="hidden" name="images" id="img-url-${s}" value="${l(r)}">`).join(""),De(),we());const n=document.getElementById("scan-ai-prop-status"),o=(r,s)=>{n&&(n.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),s&&n.classList.add(s),n.innerHTML=r)};o("Reading every page, completing property details and valueâ€¦","text-blue-300"),(async()=>{try{const r=await zt({imageUrls:t,identification:e,category:"Real Estate",formSelector:"#property-form"}),s=r.identification||e,u=Ga({identification:s,specs:r.specs,price:r.price});let d;r.price?d=`${l(s.detected_name||"Property")} â€” ${u.filled.length} field${u.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`:d=`${l(s.detected_name||"Property")} â€” ${u.filled.length} fields ready. Price estimate skipped â€” set the price manually, then press Publish Property.`,d+=r.verified?'<p class="text-[11px] text-gray-400 mt-1">✓ Second-pass verification completed — every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run — values come from the first pass.</p>',d+=Vt(),d+=Ht(r.checklist,r.summary),o(d,r.price?"text-emerald-300":"text-amber-300"),m("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}catch(r){const s=/key|api|configured|settings|vision/i.test(String(r?.message||r));o(s?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),m("AI scan failed.","error")}})()}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){m("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(u=>u.value).filter(Boolean);if(!i.length){m("Upload at least one property image before scanning.","error");return}const n=t?t.innerHTML:"",o=(u,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=u)};try{const u=await F.getConfig();String(u.gemini_key||u.gemini_api_key||"").trim()||o("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),o("Identifying this property from your imagesâ€¦","text-blue-300");let r;try{r=await F.identifyProduct(i,{category:"Real Estate",maxImages:ge.maxImages})}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),m("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}if(!r||r.identified===!1){o(r&&r.reason?`Could not identify the property: ${l(r.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),m("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=n);return}t&&(t.disabled=!1,t.innerHTML=n);const s=await new Promise(u=>{Ke=y=>{Ke=null,u(y)};const d=document.getElementById("scan-ai-prop-status");if(!d){u({choice:"continue"});return}if(!window._propFormDirty){u({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const c=r.confidence||"medium",g={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[c]||"text-amber-400 border-amber-500/20";d.innerHTML=`
      <div class="rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in">
        ...
        <p class="text-[11px] text-gray-400">
          ...
          <span class="ml-1 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold border ${g}">${l(c).toUpperCase()} confidence</span>
        </p>
        <div class="flex flex-wrap gap-2">
      ...
      </div>`});if(!s||s.choice==="cancel"){o("Scan cancelled â€” nothing was changed.","text-gray-400"),m("Scan cancelled.","info");return}try{o("Reading every page, completing property details and market valueâ€¦","text-blue-300");const u=await zt({imageUrls:i,identification:r,category:"Real Estate",formSelector:"#property-form"}),d=u.identification||r,c=Ga({identification:d,specs:u.specs,price:u.price});let g=`${l(d.detected_name||"Property")} â€” ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`;g+=u.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>',g+=Vt(),g+=Ht(u.checklist,u.summary),o(g,"text-emerald-300"),m("Review the property details, then press Publish Property.","success")}catch(u){const d=String(u?.message||u),c=/key|api|configured|settings|vision/i.test(d);o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),m("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let me=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await qt(a);i&&me.push(i)}catch{}Va(),e.target.value=""}};window.removeStep1Image=function(e){me.splice(e,1),Va()};function Va(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=me.map((a,i)=>`
    ...
    </div>`).join("");const t=document.getElementById("btn-s1-scan");t&&(t.disabled=me.length===0,t.style.opacity=me.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=me.slice();if(!e.length){m("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-s1-scan"),a=document.getElementById("s1-scan-status"),i=t?t.innerHTML:"",n=(s,u)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),u&&a.classList.add(u),a.innerHTML=s)};try{const s=await F.getConfig();String(s.gemini_key||s.gemini_api_key||"").trim()||n("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),n("Detecting every distinct product in your imagesâ€¦","text-blue-300");let o;try{o=await F.detectProducts(e,{category:"",maxImages:ge.maxImages})}catch(s){const u=/key|api|configured|settings|vision/i.test(String(s?.message||s));n(u?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(s?.message||s)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);let r=o&&o.identified!==!1&&Array.isArray(o.products)&&o.products.length?o.products:[];r.length||(r=[{detected_name:"Product from your photos",category:"Other",listing_type:"product",confidence:"low",image_indices:e.map((s,u)=>u)}],n("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),U=r,be=e,he={},Z="s1-scan-status",scanReviewRender(),m(`${r.length} distinct product${r.length>1?"s":""} detected â€” review each one, then continue.`,"info")};let he={};async function za(){const e=new Set,t=[],a=i=>{!i||!i.property_id||i.listing_type==="property"||e.has(i.property_id)||!Array.isArray(i.images)||!i.images.length||(e.add(i.property_id),t.push(i))};try{const{data:i,error:n}=await b.from("showroom_listings").select("*").neq("listing_type","property");(n?[]:i||[]).forEach(a)}catch{}return Xe().forEach(a),t}window.returnToScanReviewAfterSave=function(e=Ne){return Ne=-1,U.length?(Number.isInteger(e)&&e>=0&&e<U.length&&U.splice(e,1),U.length?(Z="scanner-scan-status",z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0):(be=[],he={},!1)):!1};window.openGeneralAiScanner=async function(){const e=await za();z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> General AI Scanner</h3>
    ...
    </div>`),window.lucide&&lucide.createIcons()};function ra(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await ra(za(),15e3)}catch{e=[]}if(!e.length){m("No products with photos are in the Product Manager yet â€” add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",n=(k,h)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),h&&a.classList.add(h),a.innerHTML=k)};try{const k=await F.getConfig();String(k.gemini_key||k.gemini_api_key||"").trim()||n("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),n(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300");const o=[],r=[],s={};let u=0;const d=e.length,c=new Set;let g=0,y=0;window.__scanDupContinue=function(){const k=window.__scanDupResolve;window.__scanDupResolve=null;const h=document.getElementById("btn-scan-dup-continue");h&&(h.disabled=!0),k&&k()};const v=2,p=12e4;let f=0,w=0;const _=async k=>{const h=(k.images||[]).filter(Boolean);if(!h.length)return;const M=h.map(T=>String(T||"").trim()).filter(Boolean),q=M.length>0&&M.every(T=>c.has(T));for(const T of M)c.add(T);if(q){g++;return}const G=o.length;o.push(...h);const R=h.map((T,W)=>G+W);let P=[];try{const T=await ra(F.detectProducts(h,{category:k.category||"",maxImages:ge.maxImages}),p);P=T&&T.identified!==!1&&Array.isArray(T.products)?T.products:[]}catch{}P.length||(P=[{detected_name:k.title||k.property_id||"Product",category:k.category||"Other",listing_type:k.listing_type||"product",brand:k.brand||null,model:k.specifications&&k.specifications.model||k.model||null,confidence:"medium"}],y++),u++,s[k.property_id]=k;for(const T of P)r.push({...T,property_id:k.property_id,image_indices:Array.isArray(T.image_indices)&&T.image_indices.length?T.image_indices.map(W=>R[Number(W)]).filter(W=>W!==void 0):R,detected_name:T.detected_name||k.title||k.property_id,category:T.category||k.category||"Other",listing_type:T.listing_type||k.listing_type||"product"})},S=async()=>{for(;f<e.length;){const k=e[f++];n(`Scanning ${w+1} of ${d} product${d===1?"":"s"} (fast parallel mode)â€¦`,"text-blue-300"),await _(k),w++,w<d&&n(`Scanned ${w} of ${d} â€” continuingâ€¦`,"text-blue-300")}};if(await Promise.all(Array.from({length:Math.min(v,Math.max(1,e.length))},S)),t&&(t.disabled=!1,t.innerHTML=i),!r.length){n(`No product could be identified from the photos on your existing products${g?` (${g} duplicate product${g>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),m("No products could be scanned.","error");return}U=r,be=o,he=s,Z="scanner-scan-status",scanReviewRender();const x=Date.now()<(F._geminiQuotaUntil||0);m(`Scan complete â€” ${u} product${u>1?"s":""} scanned${g?`, ${g} duplicate product${g>1?"s":""} skipped`:""}${y?`, ${y} completed from saved details (AI could not read the photo â€” review ${y>1?"those":"it"} and edit as needed)`:""}${x?". Your Gemini key hit its FREE rate limit during the scan â€” wait about 1 minute, then continue for full AI reading.":""}. Press "Continue with ALL" to save & publish everything at once.`,"success")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";n&&(n.disabled=!0,n.textContent="Savingâ€¦");try{const r=new FormData(i),s={};let u=0;for(const[p,f]of r.entries())if(p==="images"){s.images=s.images||[];const w=String(f);f&&!w.startsWith("blob:")?s.images.push(w):w.startsWith("blob:")&&u++}else p==="tags"?(s.tags=s.tags||[],s.tags.push(f)):s[p]=f;if(u&&!(s.images||[]).length){n&&(n.disabled=!1,n.textContent=o),m("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}s.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",s.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",c=p=>wt(p),g=p=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],w={};for(const _ of f){const S=p[_];if(_==="real_price"){const x=S!=null&&String(S).trim()!==""?parseFloat(S):null;w[_]=x!=null&&Number.isFinite(x)&&x>0?Math.round(x):null;continue}w[_]=S!=null&&String(S).trim()!==""?S:null}if(p.safety_features){const _=c(p.safety_features);w.safety_features=_.length?_:null}return w};let y;if(a){let p=Se((window._productsData||[]).find($=>$.property_id===a));if(!p){const{data:$}=await b.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();p=$?Se($):null}if(!p)throw new Error("Could not load the current product. Refresh the page and try again.");const f=($,j)=>{const E=$===""||$==null?"":$,te=j===""||j==null?"":j;return String(E).trim()===String(te).trim()},w={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach($=>{f(s[$],p[$])||(w[$]=s[$]==null||s[$]===""?null:s[$])});const _=s.price===""||s.price==null?null:parseFloat(s.price);f(_,p.price)||(w.price=_==null?p.price:Math.max(D,Math.min(Q,_)));const S=s.stock_quantity===""||s.stock_quantity==null?null:parseInt(s.stock_quantity,10);f(S,p.stock_quantity)||(w.stock_quantity=Number.isFinite(S)?S:null);const x=c(s.features_text);f(x.join("||"),(Array.isArray(p.features)?p.features:[]).join("||"))||(w.features=x);const k=s.tags||[];f(k.join("||"),(Array.isArray(p.tags)?p.tags:[]).join("||"))||(w.tags=k);const h=c(s.highlights_text);f(h.join("||"),(Array.isArray(p.highlights)?p.highlights:[]).join("||"))||(w.highlights=h);const M=c(s.seo_keywords_text);f(M.join("||"),(Array.isArray(p.seo_keywords)?p.seo_keywords:[]).join("||"))||(w.seo_keywords=M);const q=s.images||[];f(q.join("||"),(Array.isArray(p.images)?p.images:[]).join("||"))||(w.images=q);const G=s.is_featured==="on";!!p.is_featured!==G&&(w.is_featured=G);const R=d?!1:s.is_active==="on";!!p.is_active!==R&&(w.is_active=R);const P=g(s),T={...p.specifications&&typeof p.specifications=="object"?p.specifications:{},...P};if(JSON.stringify(T)!==JSON.stringify(p.specifications||{})&&(w.specifications=T),Object.keys(w).length===0){m("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(Me(t,a))}catch{}n&&(n.disabled=!1,n.textContent=o);return}const W={...p,...w,property_id:a,updated_at:new Date().toISOString()};if({error:y}=await b.from("showroom_listings").upsert(W,{onConflict:"property_id"}),y&&xt(y,()=>bt(W),"Product update")){n&&(n.disabled=!1,n.textContent=o),oe(),O();return}m(d?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(w).length} change${Object.keys(w).length>1?"s":""}).`)}else{if(!s.title||!s.title.trim())throw new Error("A product title is required.");if(s.price===""||s.price==null||!isFinite(parseFloat(s.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!s.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:s.subcategory||null,title:s.title.trim(),description:s.description||"",price:Math.max(D,Math.min(Q,parseFloat(s.price)||0)),currency:s.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:s.is_active==="on",is_featured:s.is_featured==="on",brand:s.brand||null,color:s.color||null,size:s.size||null,condition:s.condition||null,warranty:s.warranty||null,availability_status:s.availability_status||"In Stock",stock_quantity:s.stock_quantity?parseInt(s.stock_quantity):null,images:s.images||[],features:c(s.features_text).length?c(s.features_text):s.tags||[],tags:s.tags||[],highlights:c(s.highlights_text),seo_keywords:c(s.seo_keywords_text),is_ai_generated:!!s.catalog_template_id,ai_generated_fields:s.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:g(s)},w=tt();if(f.property_id=w,{error:y}=await b.from("showroom_listings").insert(f),y&&xt(y,()=>bt({...f,property_id:f.property_id}),"Product publish")){n&&(n.disabled=!1,n.textContent=o),oe(),O();return}m(d?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}try{localStorage.removeItem(Me(t,a))}catch{}const v=Ne;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(v)){O();return}O()}catch(r){m("Error: "+r.message,"error"),n&&(n.disabled=!1,n.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Lt(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return m("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=Se((window._productsData||[]).find(n=>n.property_id===e)),{error:i}=await b.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return ee(i)?m(`âš ï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):m(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");m(t?"Product published":"Product unpublished"),O()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:o,updated_at:r,...s}=a,u=tt();await b.from("showroom_listings").insert({...s,property_id:u,title:a.title+" (Copy)",is_active:!1}),t||(m("Product duplicated"),O())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await b.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),m("Product archived"),O())};const Pt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function rt(){const e=document.getElementById("content");try{const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Xe().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(ie)){const o=new Set(i.map(s=>s.property_id)),r=ie.filter(s=>s.listing_type==="property"&&s.property_id&&!o.has(s.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await Bt()}catch{}const n=new Set(Ze());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=va("property","Real Estate"),i=e.country_code||"US",n=e.currency||Mt(i);z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${Da(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${Ua(n)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Pt.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    </div>`),Ot(),jt(),_t("ppf-price"),window._propFormDirty=!!t;const o=document.getElementById("property-form");if(o){const r=()=>{window._propFormDirty=!0};o.addEventListener("input",r),o.addEventListener("change",r)}window.syncPropertyCountry=function(){ta("ppf")},ta("ppf"),St("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>St("pricing")),$n()};let ae=null,Ge=null,sa=null;function kn(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function de(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Be(e,t,{reverse:a=!1}={}){if(!ae||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Ge?Ge.setLatLng(i):Ge=L.marker(i,{draggable:!0}).addTo(ae),ae.setView(i,Math.max(ae.getZoom(),13));const n=document.querySelector('#property-form [name="latitude"]'),o=document.querySelector('#property-form [name="longitude"]');n&&(n.value=String(Number(e.toFixed(6)))),o&&(o.value=String(Number(t.toFixed(6)))),a&&Sn(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Le(){const e=kn();if(!e){de("Enter a location (address, area, city, state, country), then press Locate from fields.");return}de("Searching locationâ€¦");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Be(parseFloat(a[0].lat),parseFloat(a[0].lon)),de("Located: "+a[0].display_name)):de("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{de("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Sn(e,t){const a=document.querySelector("#property-form");if(a)try{const n=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),o=n&&n.address||{},r=(v,p)=>{if(!p)return;const f=a.querySelector(`[name="${v}"]`);return f&&!String(f.value||"").trim()?(f.value=p,!0):!1},s=[o.road||"",o.house_number||""].filter(Boolean).join(" "),u=o.suburb||o.neighbourhood||o.quarter||o.district||o.borough||"",d=o.town||o.village||o.municipality||o.city_district||"",c=o.city||o.county||"",g=o.state||o.region||"",y=o.country||"";if(r("product_location",s||u||d),r("town",u||d),r("city",c),r("state",g),y){r("country",y);const v=a.querySelector('[name="country_code"]');if(v){const p=(Ee||[]).find(f=>String(f.name||"").toLowerCase()===String(y).toLowerCase());p&&p.code&&!v.value&&(v.value=p.code)}}de("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(n.display_name?" â€” "+n.display_name:""))}catch{de("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!ae)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Be(e,t),de("Map updated from coordinates.")):Le()};function $n(){const e=document.getElementById("property-map-preview");if(!e||!window.L){de("Map unavailable right now â€” your location fields still save normally.");return}ae&&(ae.remove(),ae=null,Ge=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);ae=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(ae),ae.on("click",n=>Be(n.latlng.lat,n.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Le),["product_location","town","city","state","country","latitude","longitude"].forEach(n=>{const o=document.querySelector(`#property-form [name="${n}"]`);o&&(o.addEventListener("input",()=>{if(n==="latitude"||n==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),s=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(s)&&(r||s)&&Be(r,s);return}clearTimeout(sa),sa=setTimeout(Le,900)}),o.addEventListener("change",()=>{n!=="latitude"&&n!=="longitude"&&Le()}))}),i?Be(t,a):Le()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(n=>{const o=parseFloat(n.latitude),r=parseFloat(n.longitude),s=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");return!(Number.isFinite(o)&&Number.isFinite(r)&&(o!==0||r!==0))&&!!s});if(!t.length){m("All properties already have map coordinates.","success");return}m(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}â€¦`,"success");let a=0,i=0;for(const n of t){const o=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");try{const s=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(o))).json();if(s&&s[0]){const u={latitude:parseFloat(s[0].lat),longitude:parseFloat(s[0].lon)},{error:d}=await b.from("showroom_listings").update(u).eq("property_id",n.property_id);d?i++:(Object.assign(n,u),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}m(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),rt()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n=a.getAll("images").filter(y=>y&&!y.startsWith("blob:")),o=(i.features_text||"").split(",").map(y=>y.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(D,Math.min(Q,parseFloat(i.real_price)||0)),s=y=>(y||"").split(",").map(v=>v.trim()).filter(Boolean),u=y=>y===""||y==null||!isFinite(parseInt(y,10))?null:parseInt(y,10),d=s(i.floor_plan_rooms).map(y=>{const v=String(y).match(/^(.*?):\s*(.*)$/);return v?{name:v[1].trim(),dimensions:v[2].trim()}:{name:y,dimensions:""}}),c={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(D,Math.min(Q,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:u(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:u(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:u(i.year_built),year_renovated:u(i.year_renovated),landmarks:s(i.landmarks_text),interior_features:s(i.interior_features_text),exterior_features:s(i.exterior_features_text),home_systems:s(i.home_systems_text),legal_info:s(i.legal_info_text).map(y=>{const v=String(y).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return v?{label:v[1].trim(),value:v[2].trim(),source:v[3]}:{label:y,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:d,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:s(i.nearby_schools_text),hospitals:s(i.nearby_hospitals_text),shopping:s(i.nearby_shopping_text),transportation:s(i.nearby_transportation_text),distances:s(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:s(i.documents_text),features:o,images:n,highlights:wt(i.highlights_text),seo_keywords:wt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let g;if(t){c.property_id=t;const y=Se((window._propertiesData||[]).find(v=>v.property_id===t)||(window._productsData||[]).find(v=>v.property_id===t));c.specifications={...y.specifications&&typeof y.specifications=="object"?y.specifications:{},real_price:r},{error:g}=await b.from("showroom_listings").upsert({...y,...c},{onConflict:"property_id"})}else c.property_id=tt(),c.specifications={real_price:r},{error:g}=await b.from("showroom_listings").insert(c);g&&xt(g,()=>bt({...c,property_id:t||c.property_id}),t?"Property update":"Property publish")||(m(t?"Property updated!":"Property published!"),oe(),rt())};window.editProperty=async function(e){const{data:t,error:a}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Lt(e)),i||(i=(Array.isArray(ie)?ie.find(n=>n.property_id===e):null)||null),i&&showAddPropertyModal(i)};const En=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Wa(){const e=document.getElementById("content");try{const{data:t}=await b.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let n="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>Pn(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function Pn(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",$a(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",ye(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(i)||"â€”"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${En.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await b.from("payment_receipts").update({status:t}).eq("id",e);if(a){m(a.message,"error");return}m("Order status updated"),oe(),Wa()};async function An(){const e=document.getElementById("content");try{const{data:t}=await b.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await b.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);z(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${l(i.order_number)}</p><p class="text-[10px] text-gray-500">${ye(i.created_at)}</p></div>
    ...
    </div>`)};async function Ue(){const e=document.getElementById("content");try{const{data:t}=await b.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length,{data:n}=await b.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),o=n||[],r=o.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?fe("star","No Reviews","Customer reviews will appear here."):a.map(s=>Cn(s)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${o.length===0?fe("message-square","No Feedback Yet","Site feedback will appear here."):o.map(s=>In(s)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function In(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await b.from("site_feedback").update({is_approved:!0}).eq("id",e);t?m(t.message,"error"):m("Feedback approved â€” it now shows on every page."),Ue()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await b.from("site_feedback").delete().eq("id",e);t?m(t.message,"error"):m("Feedback deleted."),Ue()};function Cn(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await b.from("product_reviews").update({is_approved:!0}).eq("id",e),m("Review approved"),Ue()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await b.from("product_reviews").delete().eq("id",e),m("Review deleted"),Ue())};async function Ka(){const e=document.getElementById("content");try{const{data:t}=await b.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?fe("message-circle","No Messages","Customer support messages will appear here."):a.map(i=>`
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${ye(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await b.from("support_messages").update({is_read:!0}).eq("id",e),m("Marked as read"),Ka()};async function st(){const e=document.getElementById("content");try{const{data:t}=await b.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:n}=await b.from("coupons").insert(i);if(n){m(n.message,"error");return}m("Coupon created!"),oe(),st()};window.toggleCoupon=async function(e,t){await b.from("coupons").update({is_active:t}).eq("id",e),m(t?"Coupon activated":"Coupon deactivated"),st()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await b.from("coupons").delete().eq("id",e),m("Coupon deleted"),st())};async function Tn(){const e=document.getElementById("content");try{const{data:t}=await b.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?fe("bell","No Notifications","System notifications will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}const Ya=["Featured","Sponsored","Featured Collection","Discover","Promotion"],Ln=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let qe=null;function Bn(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${l(e)}</span>`}function Mn(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${l(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${l(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${l(e.link_target||"")}</span>`}function Nn(e){return e.video_url?`<video src="${l(e.video_url)}" ${e.poster_url?`poster="${l(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${l(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Ja(){if(qe)return qe;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const r=o.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{ie.forEach(i)}catch{}try{const{data:o,error:r}=await b.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),qe={products:e,categories:a,sections:Ln},qe}async function Rn(e){try{const{data:{session:t}}=await b.auth.getSession();if(!t)return m("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),n=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await b.storage.from("advertisements").upload(n,e,{contentType:e.type,upsert:!1});if(o)return m("Upload failed: "+o.message,"error"),null;const{data:r}=b.storage.from("advertisements").getPublicUrl(n);return{url:r.publicUrl,isVideo:i}}catch{return m("Upload failed","error"),null}}function Ye(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),n=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),n&&(n.value=t?"":e),a.innerHTML=t?`<video src="${l(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${l(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){m("Choose an image or video file","error");return}const i=await Rn(t);if(!i){e.value="";return}Ye(i.url,i.isVideo);const n=document.getElementById("ad-media-url");n&&(n.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);Ye(t,a)};function Wt(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let n="";t==="product"?n='<option value="">Select a productâ€¦</option>'+e.products.map(o=>`<option value="${l(o.id)}" ${String(a)===String(o.id)?"selected":""}>${l(o.id)} â€” ${l((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?n='<option value="">Select a categoryâ€¦</option>'+e.categories.map(o=>`<option value="${l(o)}" ${a===o?"selected":""}>${l(o)}</option>`).join(""):t==="section"&&(n='<option value="">Select a sectionâ€¦</option>'+e.sections.map(o=>`<option value="${l(o.id)}" ${a===o.id?"selected":""}>${l(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${n}</select>`}function Qa(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${Ya.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";Wt(e,a,"")};window.showAddAdModal=async function(){const e=await Ja();window._adLinkCache=e,z(Qa(null)),Wt(e,"none","")};window.showEditAdModal=async function(e){const t=await Ja();window._adLinkCache=t;const{data:a}=await b.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){m("Ad not found","error");return}z(Qa(a)),a.image_url?Ye(a.image_url,!1):a.video_url&&Ye(a.video_url,!0),Wt(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",n={title:a.title,description:a.description||"",ad_label:Ya.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!n.image_url&&!n.video_url){m("Add an image or video for the ad","error");return}const o=e.target.querySelector('button[type="submit"]');o&&(o.disabled=!0);try{if(i){const{error:r}=await b.from("promotions").update(n).eq("id",i);if(r)throw r;m("Ad updated!")}else{const{error:r}=await b.from("promotions").insert(n);if(r)throw r;m("Ad created!")}}catch(r){m(r.message||"Save failed","error"),o&&(o.disabled=!1);return}oe(),Ie()};window.togglePromo=async function(e,t){const{error:a}=await b.from("promotions").update({is_active:t}).eq("id",e);if(a){m(a.message,"error");return}m(t?"Ad activated":"Ad deactivated"),Ie()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await b.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const n=a||[],o=n.findIndex(d=>d.id===e),r=o+t;if(o<0||r<0||r>=n.length){m("Already at the edge","info");return}const s=n[o],u=n[r];await b.from("promotions").update({sort_order:u.sort_order}).eq("id",s.id),await b.from("promotions").update({sort_order:s.sort_order}).eq("id",u.id),m("Order updated")}catch(a){m(a.message||"Reorder failed","error")}Ie()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await b.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(n=>{const o=/\/object\/public\/advertisements\/(.+)$/.exec(n);return o?decodeURIComponent(o[1]):null}).filter(Boolean);if(i.length)try{await b.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await b.from("promotions").delete().eq("id",e);if(a)throw a;m("Ad deleted")}catch(t){m(t.message||"Delete failed","error")}Ie()}};async function Ie(){const e=document.getElementById("content");try{const{data:t}=await b.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.renderAds=Ie;const lt=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],se={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Xa(){const e=document.getElementById("content");try{let t=function(o){const r=n===o.id,s=i[o.kf],u=i[o.mf]||o.dm;return`
      ...
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${lt.map(t).join("")}</div>
          </div>
...
- Respond with valid JSON only.`,i=(await Promise.all((e||[]).slice(0,t.maxImages||3).map(n=>this._fetchImageAsDataUrl(n,768)))).filter(Boolean);if(!i.length)throw new Error("Could not read the uploaded images.");try{const n=await this._tryBrowserGeminiVision(a,i);if(n)return n}catch{}try{const n=await this._callEdge({action:"vision",images:i,prompt:a,max_tokens:4096});if(n&&n.success&&n.text){const o=He(n.text);if(o)return{...o,_aiProvider:n.provider,_aiModel:n.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(n&&n.error||"Vision service unavailable.")}catch{}return null},async _runVisionPrompt(e,t,{maxImages:a=5,maxTokens:i=4096,allowTextFallback:n=!1,mergeResults:o=null,onProgress:r=()=>{}}={}){const s=Math.max(1,Number(a)||5),u=await this._collectScanImages(t,{onProgress:r});if(!u.length)throw new Error("Could not read the uploaded images.");const d=async g=>this._runSingleVisionCall(e,g,{maxTokens:i,allowTextFallback:n});let c;if(u.length<=s)c=await d(u);else{const g=[];for(let _=0;_<u.length;_+=s)g.push(u.slice(_,_+s));r(0,g.length);const y=3,v=new Array(g.length).fill(null);let p=0;const f=async()=>{for(;p<g.length;){const _=p++;v[_]=await d(g[_]).catch(()=>null),r(Math.min(p,g.length),g.length)}};await Promise.all(Array.from({length:Math.min(y,g.length)},f));const w=[];if(v.forEach((_,S)=>{_&&w.push({result:_,startIndex:S*s})}),!w.length)return null;c=o?o(w,{batchSize:s,totalImages:u.length}):w.reduce((_,S)=>this._mergeJsonResults(_,S.result),null)}return c||null},async _runSingleVisionCall(e,t,{maxTokens:a=4096,allowTextFallback:i=!1}={}){const n=Date.now()<(this._geminiQuotaUntil||0);if(!n)try{const o=await this._tryBrowserGeminiVision(e,t);if(o)return o}catch{}if(!n)try{const o=await this._callEdge({action:"vision",images:t,prompt:e,max_tokens:a},3e4);if(o&&o.success&&o.text){const r=He(o.text);if(r)return{...r,_aiProvider:o.provider,_aiModel:o.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(o&&o.error||"Vision service unavailable.")}catch{}if(i)try{const o=await this.freeChat([{role:"system",content:"You complete marketplace listing data. Always reply with ONE valid JSON object only â€” no markdown, no extra text."},{role:"user",content:e}],{maxTokens:3e3,timeoutMs:3e4}),r=He(o.text);if(r)return{...r,_aiProvider:o.provider,_aiModel:o.model}}catch{}return null},_pdfPageCache:new Map,async _collectScanImages(e,{onProgress:t=()=>{}}={}){const a=(Array.isArray(e)?e:[e]).map(o=>String(o||"")).filter(Boolean);if(!a.length)return[];const i=await Promise.all(a.map(async o=>{try{if(/^data:application\/pdf/.test(o)||et(o)){let s=this._pdfPageCache.get(o)||null;return s||(s=await Li(o,{maxDim:1300}).catch(()=>[]),s.length&&this._pdfPageCache.set(o,s)),s}const r=await this._fetchImageAsDataUrl(o,1024);return r?[r]:[]}catch{return[]}})),n=[];for(const o of i)n.push(...o);return n},_mergeJsonResults(e,t){if(!e)return t?{...t}:null;if(!t)return e;const a={...e};for(const[i,n]of Object.entries(t))if(!i.startsWith("_")&&!(n==null||typeof n=="string"&&!n.trim())){if(!(i in a)||a[i]==null||a[i]===""){a[i]=n;continue}if(Array.isArray(a[i])||Array.isArray(n)){const o=[...Array.isArray(a[i])?a[i]:[a[i]],...Array.isArray(n)?n:[n]].map(r=>typeof r=="string"?r.trim():r).filter(r=>r!=null&&r!=="");a[i]=[...new Set(o)]}else typeof a[i]=="object"&&typeof n=="object"?a[i]={...a[i],...n}:(String(a[i]).trim(),String(n).trim())}return a},async identifyProduct(e,t={}){const a=`STAGE 1 â€” IDENTIFY THE EXACT PRODUCT.
...
}`;return this._runVisionPrompt(n,e,{maxImages:a.maxImages||5,allowTextFallback:!0})},async estimateProductPrice(e,t,a={},i={}){const n=t||{},o=a||{},r=`STAGE 3 â€” ESTIMATE THE REAL MARKET PRICE AND A PROMOTIONAL DISCOUNT PRICE.
...
}`;return this._runVisionPrompt(r,e,{maxImages:i.maxImages||5,allowTextFallback:!0})},async completeSpecsAndPrice(e,t,a={}){const i=t||{},n=`STAGES 2+3 â€” COMPLETE THE SPECIFICATIONS AND ESTIMATE THE PRICE IN ONE STEP.
...
`).trim();if(!y)continue;const v=He(y);if(v)return{...v,_aiProvider:"Gemini (browser)",_aiModel:r}}catch{}return null}};function Fn(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const n=i.indexOf(",");t(n>=0?i.slice(n+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=F;window.showAiStatusModal=async function(){const e=await F.getStatus(),t=e.filter(a=>a.hasKey);z(`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const t=document.getElementById("ai-test-output");t.classList.remove("hidden"),t.textContent="â³ Asking Geminiâ€¦";try{const a=await F.prompt(e);t.textContent=`âœ“ [${a.provider} Â· ${a.model}]

${a.text}`}catch(a){t.textContent=`âŒ ${a.message}`}};function He(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),n=t.lastIndexOf("}");if(i===-1||n===-1||n<=i)return null;const o=t.slice(i,n+1);try{return JSON.parse(o)}catch{return null}}async function Dn(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([b.from("site_settings").select("*").limit(1).maybeSingle(),Un()]),i=t||{},n=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),o=a.length?`
        <div class="mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-1.5 max-h-72 overflow-y-auto pr-1" id="promo-picker-list">
            ${a.map(r=>{const s=r.property_id||r.id,u=n.has(s)?"checked":"";return`<label class="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-xl px-3 py-2 cursor-pointer hover:border-blue-400/40 transition" data-promo-search="${l((r.title||r.name||"")+" "+(r.category||""))}">
                <input type="checkbox" name="live_promo_product_ids" value="${l(s)}" ${u} class="accent-blue-500 w-4 h-4">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),m("Cleared. Save to apply.","info"),ti()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),m(`Uploading ${a.name}â€¦`,"info");try{const{data:{session:i}}=await b.auth.getSession();if(!i){m("Sign in to upload media","error");return}const n=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),o=`content/${t}-${Date.now()}.${n}`,{error:r}=await b.storage.from("product-images").upload(o,a,{contentType:a.type,upsert:!1});if(r){m("Upload failed: "+r.message,"error");return}const{data:s}=b.storage.from("product-images").getPublicUrl(o),u=s.publicUrl,d=document.getElementById("val-"+t),c=document.getElementById("url-"+t);d&&(d.value=u),c&&(c.value=u);const g=document.getElementById("slot-"+t);if(g){const y=Kt.flatMap(v=>v.fields||[]).find(v=>v.key===t);y&&(g.outerHTML=Za(y,u))}m("âœ“ Uploaded â€” save to apply","success")}catch{m("Upload failed","error")}}};const On=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function re(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Oe(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(re()))}function _e(){Oe();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=ei(re()),window.lucide&&lucide.createIcons())}function jn(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),n=a&&la(a)||i&&la(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}function ei(e){return(e||[]).map((t,a)=>{const i=String(t&&t.buttonText||"SHOP NOW"),n=On.map(o=>`<button type="button" onclick="heroVideoPreset(${a},'${o}')" class="px-2.5 py-1 rounded-full text-[9px] font-black ${i===o?"bg-indigo-600 text-white":"bg-white/5 text-gray-400"} border ${i===o?"border-indigo-500":"border-white/10"} transition">${o}</button>`).join("");return`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&Hn(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=re();i[e]&&(i[e][t]=a,Oe())};window.heroVideoPreset=function(e,t){const a=re();a[e]&&(a[e].buttonText=t,_e())};window.heroVideoToggle=function(e){const t=re();t[e]&&(t[e].enabled=t[e].enabled===!1,_e())};window.heroVideoMove=function(e,t){const a=re(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],_e())};window.heroVideoDelete=function(e){const t=re();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),_e())};window.heroVideoRemoveMedia=function(e,t){const a=re();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),_e())};window.addHeroVideoSlide=function(){re().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),_e(),m("New slide added â€” upload a video and press Save to show it.","info")};async function qn(e,t){try{const{data:{session:a}}=await b.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:o}=await b.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(o)return{url:URL.createObjectURL(e),persisted:!1,error:o.message};const{data:r}=b.storage.from("product-images").getPublicUrl(n),s=r&&r.publicUrl;return s?{url:s,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function la(e){return/^blob:/i.test(String(e||""))}async function Hn(e,t,a){const i=re();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){m("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){m("Please choose an image for the poster.","error");return}m("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await qn(a,t);t==="video"?i[e].video=n.url:i[e].poster=n.url,_e(),n.persisted?m("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):m("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function Gn(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Oe(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
    ...
    </div>`}window.heroVideoSavePublish=async function(e){const t=u=>/^blob:/i.test(String(u||"")),a=re().filter(u=>u&&(u.video||u.poster||u.title||u.subtitle));if(!a.length){m("Add at least one video slide before publishing.","error");return}a.forEach(u=>{u.poster&&t(u.poster)&&(u.poster="")});const i=a.filter(u=>u.video&&t(u.video)),n=a.filter(u=>u.video&&!t(u.video));if(i.length&&!n.length){m(`Upload FAILED for your video${i.length>1?"s":""} â€” temporary previews cannot go live. Re-upload a smaller MP4/WebM (under ~50 MB), then press this button again.`,"error");return}if(i.length&&!confirm(`${i.length} slide${i.length>1?"s":""} had a FAILED upload and will be LEFT OUT. Publish the remaining ${n.length} slide${n.length===1?"":"s"} now?`))return;const o=n,r=o.filter(u=>u.video);if(!o.length){m("Please upload a video in at least one slide first.","error");return}const s=e?e.innerHTML:"";e&&(e.disabled=!0,e.innerHTML="â³ Publishingâ€¦");try{Oe();const{data:u}=await b.from("site_settings").select("id").limit(1).maybeSingle();let d;if(u?.id?{error:d}=await b.from("site_settings").update({hero_video_slides:o}).eq("id",u.id):{error:d}=await b.from("site_settings").insert({id:1,hero_video_slides:o}),d)throw new Error(d.message);ua(),m("âœ“ Hero video banner published! "+r.length+(r.length===1?" video is":" videos are")+" now live on your homepage.","success")}catch(u){m(u.message||"Could not publish the hero banner. Please try again.","error")}finally{e&&(e.disabled=!1,e.innerHTML=s,window.lucide&&lucide.createIcons())}};async function ti(){const e=document.getElementById("content");try{const{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a={...di,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${Kt.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?Gn(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
                  <div class="${n.type==="textarea"||n.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${n.type==="textarea"?`<textarea id="cs-${n.key}" name="${n.key}" rows="3" class="input-field w-full" placeholder="Enter the current wordingâ€¦">${l(a[n.key]||"")}</textarea>`:n.type==="media"?Za(n,a[n.key]||""):n.type==="checkbox"?"":`<input id="cs-${n.key}" type="text" name="${n.key}" value="${l(a[n.key]||"")}" class="input-field w-full" placeholder="Enter the current wordingâ€¦">`}
      ...
      </div>`,Oe(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[n,o]of t.entries())a[n]=o;for(const n of Kt)if(n.fields)for(const o of n.fields)o.type==="checkbox"&&!(o.key in a)?a[o.key]=!1:o.type==="checkbox"&&(a[o.key]=!0);let i=[];try{const n=t.get("hero_video_slides");if(String(n||"").trim()){const o=JSON.parse(n);Array.isArray(o)&&(i=o)}}catch{i=[]}a.hero_video_slides=i;try{const{data:n}=await b.from("site_settings").select("id").limit(1).maybeSingle();let o;if(n?.id?{error:o}=await b.from("site_settings").update(a).eq("id",n.id):{error:o}=await b.from("site_settings").insert({id:1,...a}),o)throw new Error(o.message);ua(),m("Content updated â€” the banners now use your new words and uploads.","success")}catch(n){m(n.message||"Could not save content. Please try again.","error")}};async function Vn(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([b.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),b.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),b.from("profiles").select("user_id,created_at",{count:"exact"})]),n=t.data||[],o=n.filter(d=>["approved","payment_approved","delivered"].includes(d.status)).reduce((d,c)=>d+(parseFloat(c.amount)||0),0),r=n.length>0?(n.filter(d=>d.status!=="cancelled").length/n.length*100).toFixed(1):0,s={};(a.data||[]).forEach(d=>{s[d.category]=(s[d.category]||0)+1});const u=Object.entries(s).sort((d,c)=>c[1]-d[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${Y("Total Revenue",`$${o.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${Y("Total Orders",n.length,"shopping-bag","blue")}
          ${Y("Customers",i.count||0,"users","violet")}
          ${Y("Conversion Rate",r+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Ra(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function zn(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${s?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${s?`Backup codes available: ${u} Â· Enrolled: ${ne(o.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${ye(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Yn(){const e=document.getElementById("content");try{const{data:t}=await b.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${l(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${ye(a.created_at)}</p></div>
                ${X(a.status||"completed")}
              </div>`).join("")}
          </div>
        </div>
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),m("Orders exported!")};async function Jn(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function ut(){const e=document.getElementById("content");e&&(e.innerHTML=Pe());try{let t=function(s,u,d,c="",g="blue"){const y=!!(d&&d.trim());return`
        <div class="glass-soft border border-${g}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${y?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
               ...
               </div>`:`<div class="w-full h-24 rounded-xl border-2 border-dashed border-${g}-500/25 hover:border-${g}-500/50 flex flex-col items-center justify-center gap-2 cursor-pointer transition" onclick="triggerImgUpload('${u}')">
          ...
          <div class="flex gap-2">
            <input class="input-field text-xs flex-1 ${y?"":"hidden"}" id="url-${u}" value="${l(d||"")}" placeholder="Or paste image URL" oninput="document.getElementById('val-${u}').value=this.value;updateLivePreview()">
            <button type="button" onclick="document.getElementById('url-${u}').classList.toggle('hidden')" class="text-[10px] text-${g}-400 hover:text-${g}-300 transition shrink-0">${y?"Edit URL":"Paste URL"}</button>
          </div>
        </div>`};const{data:a}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},n=i.brand_name||i.site_name||_a,o=i.brand_slogan||i.site_tagline||ka,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.toggleLivePreview=function(){document.getElementById("live-preview-panel")?.classList.toggle("hidden"),updateLivePreview()};window.updateLivePreview=function(){const e=document.getElementById("live-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("inp-brand-name")?.value||_a,a=document.getElementById("inp-brand-slogan")?.value||ka,i=document.getElementById("ct-primary")?.value||"#f97316",n=document.getElementById("ct-secondary")?.value||"#3b82f6",o=document.getElementById("ct-tag1")?.value||"#22d3ee",r=document.getElementById("ct-tag2")?.value||"#a3e635",s=document.getElementById("val-brand_logo")?.value||DEFAULT_BRAND_LOGO,u=document.getElementById("val-brand_badge")?.value||"";["preview-name","preview-footer-name","preview-copy-name"].forEach(p=>{const f=document.getElementById(p);f&&(f.textContent=t)}),["preview-slogan","preview-footer-slogan"].forEach(p=>{const f=document.getElementById(p);f&&(f.textContent=a)});const d=document.getElementById("preview-slogan");if(d&&a){const p=a,f=p.indexOf(","),w=f>-1?p.slice(0,f+1):p,_=f>-1?p.slice(f+1):"";d.innerHTML=`<span style="color:${o};font-weight:800">${l(w)}</span><span style="color:${r};font-weight:700">${l(_)}</span>`}const c=document.getElementById("preview-btn");c&&(c.style.background=i);const g=e.querySelector('[style*="color:"]');g&&(g.style.color=n),["preview-logo-wrap","preview-footer-logo-wrap"].forEach(p=>{const f=document.getElementById(p);f&&(s?(f.innerHTML=`<img src="${s}" alt="${t}" class="w-full h-full object-contain p-1">`,f.style.background="transparent"):(f.innerHTML='<i data-lucide="globe" class="w-4 h-4 text-white"></i>',f.style.background=i,window.lucide&&lucide.createIcons()))});const y=document.getElementById("preview-badge-wrap"),v=document.getElementById("preview-badge");y&&v&&(u?(v.src=u,y.classList.remove("hidden")):y.classList.add("hidden"))};window.triggerImgUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearBrandImg=function(e){document.getElementById("val-"+e).value="";const t=document.getElementById("url-"+e);t&&(t.value=""),(e&&e.startsWith("homepage_")?ct:ut)()};window.clearHomepageBannerImg=function(){const e=document.getElementById("val-homepage_banner_image"),t=document.getElementById("url-homepage_banner_image"),a=document.getElementById("homepage_banner_alt");e&&(e.value=""),t&&(t.value=""),a&&(a.value=""),ct()};window.restoreHomepageBannerDefault=function(){window.clearHomepageBannerImg()};window.syncColor=function(e,t){const a=document.getElementById("color-"+e);a&&/^#[0-9a-fA-F]{6}$/.test(t)&&(a.value=t)};window.previewFont=function(e){const t=document.getElementById("font-sample");t&&(t.style.fontFamily=`'${e}', sans-serif`);const a="gf-preview";let i=document.getElementById(a);i||(i=document.createElement("link"),i.id=a,i.rel="stylesheet",document.head.appendChild(i)),i.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e)}:wght@400;700;900&display=swap`};const At="weverse_brand_v1",It="weverse_brand_override_v1";function Ct(){try{const e=JSON.parse(localStorage.getItem(It)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(At)||"null");if(e&&typeof e=="object")return e.data&&typeof e.data=="object"?e.data:e}catch{}return{}}function Je(e){const t={...Ct(),...e};try{localStorage.setItem(It,JSON.stringify(t))}catch{}try{localStorage.setItem(At,JSON.stringify({ts:Date.now(),data:t}))}catch{}return window.dispatchEvent(new StorageEvent("storage",{key:It})),window.dispatchEvent(new StorageEvent("storage",{key:At})),window.dispatchEvent(new CustomEvent("brand-updated",{detail:t})),t}window.handleBrandImgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=t&&t.startsWith("homepage_"),n=document.getElementById(i?"homepage-banner-status":"brand-upload-status"),o=document.getElementById(i?"homepage-banner-msg":"brand-upload-msg");n&&n.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}â€¦`);try{const r=a.name.split(".").pop(),s=`brand/${t}-${Date.now()}.${r}`,{error:u}=await b.storage.from("product-images").upload(s,a,{contentType:a.type,upsert:!0});let d;if(u)d=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${u.message})`);else{const{data:y}=b.storage.from("product-images").getPublicUrl(s);d=y.publicUrl,o&&(o.textContent=`âœ“ ${a.name} uploaded`)}const c=document.getElementById("val-"+t),g=document.getElementById("url-"+t);c&&(c.value=d),g&&(g.value=d,g.classList.remove("hidden")),i?updateHomepageBannerPreview():(updateLivePreview(),setTimeout(()=>ut(),1e3))}catch(r){o&&(o.textContent=`Upload failed: ${r.message}`)}setTimeout(()=>n?.classList.add("hidden"),4e3)};window.saveBrandSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[s,u]of t.entries())s.endsWith("_url")||(a[s]=u);a.brand_name&&(a.site_name=a.brand_name),a.brand_slogan&&(a.site_tagline=a.brand_slogan),a.brand_description&&(a.site_description=a.brand_description),a.brand_email&&(a.contact_email=a.brand_email),a.brand_phone&&(a.contact_phone=a.brand_phone),a.brand_address&&(a.contact_address=a.brand_address),a.brand_website_url&&(a.production_url=a.brand_website_url);const i=a.brand_custom_font||a.brand_font;i&&previewFont(i);const n=e.target.querySelector("[type=submit]");n&&(n.disabled=!0,n.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Savingâ€¦',window.lucide&&lucide.createIcons());const{data:o}=await b.from("site_settings").select("id").limit(1).maybeSingle();let r;o?.id?{error:r}=await b.from("site_settings").update(a).eq("id",o.id):{error:r}=await b.from("site_settings").insert(a),r?(Je(a),m("Brand saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(Je(a),m("âœ… Brand saved! All pages will now show your updated brand.","success")),setTimeout(()=>ut(),500)};window.toggleHomepageBannerPreview=function(){document.getElementById("homepage-banner-preview-panel")?.classList.toggle("hidden"),updateHomepageBannerPreview()};window.updateHomepageBannerPreview=function(){const e=document.getElementById("homepage-banner-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("val-homepage_banner_image")?.value||"",a=document.getElementById("homepage_banner_alt")?.value||"Homepage header banner",i=document.getElementById("homepage-banner-image"),n=document.getElementById("homepage-banner-preview-img");[i,n].forEach(r=>{r&&(t?(r.src=t,r.alt=a,r.classList.remove("hidden")):r.classList.add("hidden"))});const o=document.getElementById("homepage-banner-preview-note");o&&(o.textContent=t?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.")};window.saveHomepageBranding=async function(e){e.preventDefault();const t={homepage_banner_image:document.getElementById("url-homepage_banner_image")?.value||"",homepage_banner_alt:document.getElementById("homepage_banner_alt")?.value||"Homepage header banner"},a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:i}=await b.from("site_settings").select("id").limit(1).maybeSingle();let n;i?.id?{error:n}=await b.from("site_settings").update(t).eq("id",i.id):{error:n}=await b.from("site_settings").insert(t),n?(Je({...Ct(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),m("Homepage banner saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(Je({...Ct(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),m("Homepage banner published.","success")),setTimeout(()=>ct(),500)};const Qe=[{key:"trust_promo",label:"Promotional Hero (Trust & Info Area)",icon:"sparkles",desc:"The family-receives-orders section above the app banner. Show it as-is for the built-in design, or upload the real photo/video."},{key:"app_banner",label:"Weverse Mobile App Banner",icon:"smartphone",desc:"The dark app banner at the very bottom of every page."},{key:"reviews",label:"Customer Reviews & Trust",icon:"star",desc:"The customer reviews strip just below the accordions."}];async function Re(e){const t=document.getElementById("content");t&&(t.innerHTML=Pe());try{let a=e?{...e}:null;if(!a){const{data:i}=await b.from("site_settings").select("*").limit(1).maybeSingle(),n=i||{};a={};for(const o of Qe)a[o.key+"_bg_image"]=n[o.key+"_bg_image"]||"",a[o.key+"_bg_video"]=n[o.key+"_bg_video"]||""}t.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${l(a.message)}</div>`)}}function Qn(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",n=t[a]||"",o=t[i]||"",r=!!(n&&n.trim()),s=!!(o&&o.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}function da(e,t,a,i,n){const o=n==="image",r=o?"blue":"violet",s=o?"image-plus":"video",u=o?"text-blue-400":"text-violet-400";return`
    <div>
      <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wide mb-1.5 flex items-center gap-1.5"><i data-lucide="${s}" class="w-3 h-3 ${u}"></i>${n}</p>
      ${i?`<div class="relative group w-full h-28 rounded-xl overflow-hidden bg-gray-900 border border-${r}-500/15 flex items-center justify-center">
             ...
             <i data-lucide="${s}" class="w-6 h-6 ${u}"></i>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function ni(){const e={};for(const t of Qe)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=ni();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),Re(t),m("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),n=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),n&&(n.textContent=`Uploading ${a.name}â€¦`);try{const o=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${o}`,{error:s}=await b.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let u;if(s)u=URL.createObjectURL(a),n&&(n.textContent=`Preview only (storage: ${s.message})`);else{const{data:y}=b.storage.from("product-images").getPublicUrl(r);u=y.publicUrl,n&&(n.textContent=`âœ“ ${a.name} uploaded`)}const d=document.getElementById("val-"+t),c=document.getElementById("url-"+t);d&&(d.value=u),c&&(c.value=u,c.classList.remove("hidden"));const g=ni();Re(g)}catch(o){n&&(n.textContent=`Upload failed: ${o.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const o of Qe)t[o.key+"_bg_image"]=document.getElementById("val-"+o.key+"_bg_image")?.value||"",t[o.key+"_bg_video"]=document.getElementById("val-"+o.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:i}=await b.from("site_settings").select("id").limit(1).maybeSingle();let n;i?.id?{error:n}=await b.from("site_settings").update(t).eq("id",i.id):{error:n}=await b.from("site_settings").insert(t),xi(),n?(m("Publish failed â€” the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),Re(t)):(m("Promo & backgrounds published across all pages.","success"),setTimeout(()=>Re(),500))};window._manualPaymentAccounts=[];function Yt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:pa("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function Jt(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Xn(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${Sa.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${Da(a)}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[Yt()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Xn(t,a)).join("")}
    ...
    </div>`,Jt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Yt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Yt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),Jt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=Ee.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||pa(t),Jt(),renderManualPaymentAccountsEditor()};async function Tt(){const e=document.getElementById("content");e&&(e.innerHTML=Pe());try{const{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i={...yi()||{},...t||{}};window._manualPaymentAccounts=fi(i).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(hi(i))}</textarea>
              </div>
              <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Savingâ€¦");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),n={},o=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[s,u]of Object.entries(i))o.includes(s)?u&&!u.startsWith("â€¢")&&u.trim()!==""&&(n[s]=u.trim()):n[s]=u;const{error:r}=await b.from("site_settings").upsert({id:1,...n});if(t&&(t.disabled=!1,t.innerHTML="ðŸ’¾ Save Deploy & Payment Settings"),r){m(r.message,"error");return}m("Deploy & payment settings saved!"),pt()};async function oi(e="deploy"){const{data:t}=await b.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return m("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function ue(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:n,error:o}=await b.from("deployment_history").insert({version:a,status:e,triggered_by_email:C.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:n,error:o}}function $e(e,t,a,i){if(!e)return;e.disabled=t;const n=e.querySelector("p.text-xs.font-black");n&&(n.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");$e(t,!0,"Deployingâ€¦","Deploy Now");try{const a=await oi("deploy");if(!a.ok)return;const{settings:i,hookUrl:n}=a;await ue("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Deployment queued from admin UI"});const o=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)m("ðŸš€ Deployment triggered! Your site will be live in ~2 minutes."),await ue("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted deployment request"}),setTimeout(()=>pt(),400);else{const r=`Webhook returned error: ${o.status}`;m(r,"error"),await ue("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(a){m("Deploy failed: "+a.message,"error"),await ue("failed",{mode:"deploy",errorMessage:a.message})}finally{$e(t,!1,"Deployingâ€¦","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");$e(t,!0,"Rebuildingâ€¦","Rebuild Site");try{const a=await oi("rebuild");if(!a.ok)return;const{settings:i,hookUrl:n}=a;await ue("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Rebuild requested from admin UI"});const o=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)m("ðŸ”„ Rebuild triggered successfully."),await ue("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,message:"Webhook accepted rebuild request"}),setTimeout(()=>pt(),400);else{const r=`Rebuild webhook error: ${o.status}`;m(r,"error"),await ue("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:n,errorMessage:r})}}catch(a){m("Rebuild failed: "+a.message,"error"),await ue("failed",{mode:"rebuild",errorMessage:a.message})}finally{$e(t,!1,"Rebuildingâ€¦","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");$e(t,!0,"Publishingâ€¦","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){m("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){m("Publish failed: "+a.message,"error")}finally{$e(t,!1,"Publishingâ€¦","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexingâ€¦");try{const{data:i,error:n}=await b.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(n)return ee(n)?m("âš ï¸ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):m("Could not load listings to reindex: "+n.message,"error");const o=i||[];if(!o.length){m("No listings to reindex.");return}let r=0,s=0,u=!1;const d=40;for(let c=0;c<o.length;c+=d){const g=o.slice(c,c+d),{error:y}=await b.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",g.map(v=>v.id));y?(ee(y)&&(u=!0),s+=g.length):r+=g.length,t&&(t.textContent=`Reindexingâ€¦ ${Math.min(c+d,o.length)}/${o.length}`)}if(u){m(`âš ï¸ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${r}/${o.length} done)`,"error");return}m(`Search index rebuilt for ${r} listing${r!==1?"s":""}${s?` (${s} failed)`:""}.`,s?"error":"success")}catch(i){m("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(ie)||!ie.length){m("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncingâ€¦");try{const{data:i,error:n}=await b.from("showroom_listings").select("property_id");if(n)return ee(n)?m("âš ï¸ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):m("Could not load existing listings: "+n.message,"error");const o=new Set((i||[]).map(g=>g.property_id)),r=ie.filter(g=>g&&g.property_id&&!o.has(g.property_id));if(!r.length){m("Showroom already in sync â€” no new listings to add.");return}let s=0,u=0,d=!1;const c=20;for(let g=0;g<r.length;g+=c){const y=r.slice(g,g+c).map(p=>({property_id:p.property_id,listing_type:p.listing_type||"product",category:p.category||null,subcategory:p.subcategory||null,title:p.title||"Untitled Listing",description:p.description||"",price:parseFloat(p.price)||0,currency:p.currency||"USD",country:p.country||"",country_code:p.country_code||"",state:p.state||"",city:p.city||"",town:p.town||"",product_location:p.product_location||"",latitude:p.latitude??null,longitude:p.longitude??null,property_type:p.property_type||null,listing_status:p.listing_status||"sale",bedrooms:p.bedrooms??null,bathrooms:p.bathrooms??null,building_size:p.building_size||"",land_size:p.land_size||"",parking_spaces:p.parking_spaces??null,furnished:p.furnished||"",features:Array.isArray(p.features)?p.features:[],tags:Array.isArray(p.tags)?p.tags:[],highlights:Array.isArray(p.highlights)?p.highlights:[],seo_keywords:Array.isArray(p.seo_keywords)?p.seo_keywords:[],images:Array.isArray(p.images)?p.images:[],brand:p.brand||null,color:p.color||null,size:p.size||null,condition:p.condition||null,warranty:p.warranty||null,availability_status:p.availability_status||"In Stock",stock_quantity:p.stock_quantity!=null?parseInt(p.stock_quantity,10):null,is_active:p.is_active!==!1,is_featured:!!p.is_featured,is_ai_generated:!!p.is_ai_generated,ai_generated_fields:Array.isArray(p.ai_generated_fields)?p.ai_generated_fields:[],specifications:p.specifications||{},created_at:p.created_at||new Date().toISOString()})),{error:v}=await b.from("showroom_listings").insert(y);v?(ee(v)&&(d=!0),u+=y.length):s+=y.length,t&&(t.textContent=`Syncingâ€¦ ${Math.min(g+c,r.length)}/${r.length}`)}if(d){m(`âš ï¸ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${s}/${r.length} added)`,"error");return}m(`Showroom synced: ${s} new listing${s!==1?"s":""} added to the database${u?` (${u} failed)`:""}.`,u?"error":"success")}catch(i){m("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){m("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();m(`âœ“ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?m("Repository not found. Check username and repo name.","error"):m("GitHub API error: "+a.status,"error")}catch{m("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ri=30,K={category:null,page:0,query:""};async function Ce(){const e=document.getElementById("content");if(!e)return;await Bt();const t=new Set(Ze()),a=vi();K.category||(K.category=a[0]?.slug||null);const i=0,n=K.query.trim().toLowerCase(),o=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(y=>`<button onclick="catalogSetCategory('${y.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${K.category===y.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${l(y.name)}</button>`).join("")}
    </div>`,s=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategoryâ€¦" value="${l(K.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
    ...
    </div>`;let u=[];const d=u.length?u.map(y=>{const v=t.has(y.property_id),p=y.images&&y.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${v?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            <img src="${l(p)}" alt="" class="w-12 h-12 rounded-lg object-cover bg-gray-800 shrink-0" loading="lazy">
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold text-white truncate">${l(y.title)}</p>
              <p class="text-[11px] text-gray-500 truncate">${l(y.property_id)} Â· ${l(y.subcategory||y.category||"")} Â· ${$a(y.price,"USD")}</p>
            </div>
            ${X(!v)}
            <button onclick="catalogToggle('${l(y.property_id)}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${v?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30 hover:bg-emerald-500/25":"bg-amber-500/10 text-amber-300 border-amber-500/30 hover:bg-amber-500/20"}">
              ${v?"Show":"Hide"}
            </button>
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',c=n?1:Math.max(1,Math.ceil(i/ri)),g=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-500">Page ${K.page+1} / ${c}</span>
        <button onclick="catalogPage(1)" ${K.page>=c-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${o}
      ...
      ${g}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){K.category=e,K.page=0,K.query="",Ce()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");K.query=e?e.value:"",K.page=0,Ce()};window.catalogPage=function(e){const a=K.query.trim()?1:Math.max(1,Math.ceil(0/ri));K.page=Math.max(0,Math.min(a-1,K.page+e)),Ce()};window.catalogToggle=async function(e){const t=!Ze().includes(e),a=await fa(e,t);m(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),Ce()};window.catalogResetHidden=async function(){await Si(),m("All hidden catalog listings restored"),Ce()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function ca(){window.lucide&&lucide.createIcons(),Ea(),await Vi(),b.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){C.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ca):ca();
