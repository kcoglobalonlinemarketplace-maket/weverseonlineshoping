...
import{supabase as f}from"./supabase-client-7_ZWSEp6.js";import"./localization-Blqut32e.js";import{_ as W}from"./preload-helper-CLcXU_4U.js";import{c as $,S as z,l as U,f as G,a as A,b as D,g as Y,P as K}from"./showroom-data-D-nP9j-R.js";import{getCatalogCategory as J,getCatalogSample as Q}from"./catalog-CESpPuFx.js";import{g as X,a as Z,b as ee,c as te,f as ae,T as re,M as oe,C as le,P as ie}from"./phone-data-CPq8Rkux.js";import{r as se}from"./showroom-cards-DGhq0Leh.js";import{g as w,f as I}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode-duI7ESXz.js";import"./customer-ai-widget-EOK3s1m7.js";import"./brand-DYhAh01b.js";import"./catalog-hidden-store-DbF0xVeS.js";const v="/fallback.svg";function B(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function T(e){return Array.isArray(e)&&e.length>0?e:[v]}function ne(){return new URLSearchParams(window.location.search).get("id")}function ce(e){const t=document.getElementById("details-content"),a=ae(e),n=T(e.images).map((r,u)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${u===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${s(r)}">
