import{s as m,S as ee,i as Yt,D as Ha}from"./supabase-client-CDm4AUL7.js";import{a as Ga,g as za,C as _e,A as Va}from"./localization-DX01d7wE.js";import{patchLocalShowroomListing as Wa,getLocalShowroomListingById as $t,removeLocalShowroomListing as Ka,upsertLocalShowroomListing as dt,listLocalShowroomListings as Ve}from"./local-showroom-store-mzP0nSoS.js";import{g as Jt,s as Ya,l as Ja,a as Qa,b as Xa}from"./payment-settings-D1U7UCXe.js";import{P as Qt,a as Xt,T as Zt,M as ea}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as Za}from"./catalog-DrlEcUAC.js";import{i as ei}from"./app-promo-banner-BXjUoacu.js";import{M as ti,n as ai,a as ii}from"./categories-BEuiwWw5.js";import{saveCatalogHidden as ta,loadHiddenCatalogIds as Pt,getHiddenCatalogIds as We,resetHiddenCatalogIds as oi}from"./catalog-hidden-store-CoFqTKlU.js";const D=1,K=5e6,ni=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],ri=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],aa=[...ni,...ri];function Et(e){return Ga[e]||"USD"}function ia(e,t){return aa.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function si(e,t){const a=Math.max(D,Math.min(K,Number(e)||D));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function li(e,t,a,i,o){const n=si(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${n}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${n}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${n}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${n}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${n}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${n}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${n}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${n}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${n}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${n}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function oa({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:n}){const r=aa.find(h=>h.id===e&&h.listingType===t);if(!r)return null;const l=za(i)||_e[0],c=o||Et(l.code),d=[l.name].filter(Boolean).join(", "),p={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${l.name}`:r.label,description:li(r,l,c,n,d),currency:c,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...p,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...p,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const na="weverseonlineshop@gmail.com",ra="Weverse Online Shop",sa="GLOBAL SHOPPING • WORLDWIDE DELIVERY",di="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ci=`${di}/functions/v1/ai-admin-assistant`,ui=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],pi={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},la=[...Va].sort();let A={user:null,section:"dashboard"};function s(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function da(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function te(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function pe(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function Ke(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const mi=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents"];function ve(e){const t={};if(!e||typeof e!="object")return t;for(const a of mi)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),o=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const n={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",n[t]||"info"),o.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function V(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",s(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function ae(){document.getElementById("modal-container").innerHTML=""}function H(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function q(e,t,a,i,o=""){const n={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function ke(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function me(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${s(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${s(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function ca(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=ui.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){A.section=e;const t=pi[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),ca(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=ke()),window.lucide&&lucide.createIcons(),({dashboard:Ai,products:R,properties:Ze,catalog:Ee,orders:Aa,customers:ao,reviews:Re,messages:Ia,coupons:et,ads:Pe,notifications:no,ai:bi,"ai-settings":Ba,"homepage-branding":it,"promo-bg":Le,content:mo,"content-settings":Fa,seo:wo,email:_o,analytics:xo,security:at,activity:ko,brand:ot,"payment-settings":St,backup:So,settings:$o,publish:nt}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=me("construction","Coming Soon",`${t} is being built.`))}))()};async function bi(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const he="kco_admin_remember",At="kco_login_attempts",ct=5,gi=15*60*1e3;function N(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function yi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ye(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Be(e){return String(e||"").trim().toLowerCase()}function fi(){try{const e=JSON.parse(localStorage.getItem(he)||"{}");e?.email&&!Be(e.email)&&localStorage.removeItem(he)}catch{localStorage.removeItem(he)}}function hi(){try{const e=JSON.parse(localStorage.getItem(he)||"{}");return Be(e?.email)}catch{return""}}function It(){fi();const e=hi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||na,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function vi(){return`${window.location.origin}/admin.html`}function ge(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ye(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function F(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function ua(){try{return JSON.parse(localStorage.getItem(At)||'{"count":0}')}catch{return{count:0}}}function pa(){const e=ua();return e.count=(e.count||0)+1,e.count>=ct&&(e.lockedUntil=Date.now()+gi),localStorage.setItem(At,JSON.stringify(e)),e}function ma(){localStorage.removeItem(At)}function ba(){const e=ua();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(ma(),null):Math.ceil(t/6e4)}async function ne(e,t,a={}){try{await m.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await xi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function xi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function ga(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await m.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Be(e.email)===na}async function wi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){je(),Ei();return}const{data:{session:t}}=await m.auth.getSession();if(t?.user&&await ga(t.user)){const{data:{currentUser:i}}=await m.auth.getUser(),o=await m.auth.mfa.getAuthenticatorAssuranceLevel(),n=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&n!=="aal2"){A.user=t.user,je(),ge("2fa"),Ct();return}A.user=t.user,Je();return}_i()}function je(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function _i(){je(),ge("login"),It(),ya(),fa(),Ct(),ki();const e=ba();e&&(N(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function ki(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function ya(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Si),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ge("forgot")))}async function Si(e){e.preventDefault();const t=ba();if(t){N(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Be(a?.value);if(!i){N("Enter your admin email address."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,n=document.getElementById("remember-me")?.checked;F("login-btn",!0),Ye();const{data:r,error:l}=await m.auth.signInWithPassword({email:i,password:o});if(l||!r.user){const g=String(l?.message||"").toLowerCase();if(g.includes("missing supabase credentials")||g.includes("authentication service is unavailable")){N("Authentication is temporarily unavailable due to configuration. Please contact support."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("failed to fetch")||g.includes("network request failed")){N("Network error while signing in. Check your connection and try again."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("email not confirmed")){N("Your admin email is not confirmed yet. Open your verification email and confirm first."),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const y=pa(),b=ct-y.count,v=y.lockedUntil?`Account locked for 15 minutes after ${ct} failed attempts.`:`Invalid email or password. ${b>0?b+" attempt"+(b!==1?"s":"")+" remaining.":""}`;N(v),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await ne(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await ga(r.user)){await m.auth.signOut(),N(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ne(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(n?localStorage.setItem(he,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(he),ma(),A.user=r.user,(await m.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){F("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ge("2fa"),Ct(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ne(r.user.id,"login_success"),F("login-btn",!1),Je()}function Ct(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",qt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&qt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await m.auth.signOut(),A.user=null,ge("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",$i))}async function qt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){N("Enter the 6-digit code from your authenticator app.");return}F("verify-2fa-btn",!0),Ye();try{const{data:t}=await m.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){N("No 2FA factor found. Please re-login."),F("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await m.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:n}=await m.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(n)throw n;await ne(A.user.id,"login_2fa_success"),F("verify-2fa-btn",!1),Je()}catch(t){pa(),N(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),F("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function $i(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){N("Enter a backup recovery code.");return}F("verify-backup-btn",!0);try{const{data:t}=await m.from("admin_2fa").select("backup_codes").eq("user_id",A.user.id).maybeSingle();if(!t?.backup_codes?.length){N("No backup codes found."),F("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){N("Backup code not found or already used."),F("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await m.from("admin_2fa").update({backup_codes:i}).eq("user_id",A.user.id),await ne(A.user.id,"login_backup_code_used"),Je()}catch(t){N(t.message),F("verify-backup-btn",!1,"Use Backup Code")}}function fa(){document.getElementById("back-to-login")?.addEventListener("click",()=>ge("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Pi)}async function Pi(){const e=document.getElementById("reset-email"),t=Be(e?.value);if(!t){N("Enter your admin email address to receive a reset link.");return}F("send-reset-btn",!0),Ye();const{error:a}=await m.auth.resetPasswordForEmail(t,{redirectTo:vi()});if(F("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){N(a.message);return}yi("Reset link sent! Check your inbox and open it from this device to continue.")}function Ei(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await m.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function Je(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&A.user&&(t.textContent=A.user.email||"Admin"),It(),navigate("dashboard")}window.adminSignOut=async function(){A.user&&await ne(A.user.id,"logout"),await m.auth.signOut(),A.user=null,je(),ge("login"),It(),ya(),fa()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(A.user&&await ne(A.user.id,"logout_all_devices"),await m.auth.signOut({scope:"global"}),A.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Ai(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([m.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),m.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),m.from("profiles").select("user_id,created_at",{count:"exact"}),m.from("product_reviews").select("id,is_approved",{count:"exact"})]),n=t.data||[],r=a.data||[],l=r.filter(f=>["approved","payment_approved","delivered"].includes(f.status)).reduce((f,_)=>f+(parseFloat(_.amount)||0),0),c=r.filter(f=>["pending","pending_verification","processing"].includes(f.status)).length,d=n.filter(f=>f.listing_type!=="property").length,p=n.filter(f=>f.listing_type==="property").length,h=n.filter(f=>f.listing_type!=="property"&&f.is_active).length,g=i.count||0,y=o.count||0,b=(o.data||[]).filter(f=>!f.is_approved).length,v=new Date,I=r.filter(f=>{const _=new Date(f.created_at);return _.getMonth()===v.getMonth()&&_.getFullYear()===v.getFullYear()}).filter(f=>["approved","payment_approved","delivered"].includes(f.status)).reduce((f,_)=>f+(parseFloat(_.amount)||0),0),w=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${q("Total Revenue",`$${l.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${I.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${q("Total Orders",r.length,"shopping-bag","blue",`${c} pending`)}
          ${q("Customers",g,"users","violet")}
          ${q("Products",d,"package","amber",`${h} active`)}
          ${q("Properties",p,"home","blue")}
          ${q("Reviews",y,"star","blue",`${b} pending`)}
        </div>
            ...
            ${w.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':w.map(f=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${pe(f.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),xa(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}async function R(){const e=document.getElementById("content");try{const{data:t,error:a}=await m.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,o=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));for(const d of Ve().filter(p=>p.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));if(Array.isArray(ee))for(const d of ee.filter(p=>p.listing_type!=="property"&&p.property_id))i.has(d.property_id)||(i.add(d.property_id),o.push(d));const n=[...Qt,...Xt,...Zt,...ea];for(const d of n)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));o.sort((d,p)=>new Date(p.created_at||0)-new Date(d.created_at||0));try{await Pt()}catch{}const r=new Set(We());if(r.size)for(let d=o.length-1;d>=0;d--)o[d]&&o[d].property_id&&r.has(o[d].property_id)&&o.splice(d,1);const l=[...new Set(o.map(d=>d.category).filter(Boolean))].sort((d,p)=>d.localeCompare(p)),c=[...new Set(o.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,p)=>d.localeCompare(p));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${q("Inventory Units",o.reduce((d,p)=>d+(parseInt(p.stock_quantity,10)||0),0),"boxes","blue")}
          ${q("Avg Price",`$${Math.round(o.reduce((d,p)=>d+(parseFloat(p.price)||0),0)/Math.max(o.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(l.length?l:ce).map(d=>`<option value="${s(d)}" ${(window._productFilters.category||"")===d?"selected":""}>${s(d)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,ha(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}function le(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function ut(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ii(e){const t=le(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Ci(e){const t=le(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function Tt(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function pt(e){return parseInt(e.views??e.view_count??0,10)||0}function mt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Lt(e){return e.sku||e.property_id||"N/A"}function Ti(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=ut(e),i=Tt(e),o=window._productSelection?.has(e.property_id),n=V(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=te(e.created_at),l=!!e.is_featured,c=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",p=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${s(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${s(Lt(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${s(Ii(e))}</p></div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(h=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${s(h)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
          ...
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${s(Lt(i))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const d=le(i.price),p=parseFloat(i.real_price);return Number.isFinite(p)&&p>0&&p>d?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${p.toLocaleString()}</span><span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`})()}
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${i.stock_quantity!=null?s(i.stock_quantity):"Unlimited"}</span></td>
          <td>${V(n==="archived"?"inactive":n==="active"?"active":"inactive")}</td>
          <td><span class="text-xs text-gray-500">${te(i.created_at)}</span></td>
          <td>
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${V(a.is_active?"active":"inactive")}${a.is_featured?'<span class="badge bg-amber-500/15 text-amber-200 border-amber-500/30">Featured</span>':""}</div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(o=>o.property_id===e)||t.data;if(!a)return u("Product not found","error");const i=Array.isArray(a.images)?a.images:[];H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await m.from("showroom_listings").delete().neq("property_id","__none__");if(t)return Q(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),R()};window.openProductMoreActions=function(e){H(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${s(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${s(e)}')">${ka(o)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-4 glass-soft border border-blue-500/15 rounded-2xl">
              ...
              <p class="text-sm text-gray-500 mt-1">Allowed price range is ${D} to ${K} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),Bt(),Mt(),yt("pf-price"),yt("pf-real_price"),ft(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>ft(e,"pricing")),Ui(e,t.property_id||""),window._pfEscapeHandler=n=>{n.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),ae(),R()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,n]of i.entries())o==="images"?(a.images=a.images||[],n&&!String(n).startsWith("blob:")&&a.images.push(String(n))):o==="tags"?(a.tags=a.tags||[],a.tags.push(n)):a[o]=n;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function Se(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image (main photo)":"Image "+(t+1)}">
  ...
  </div>`}function Bt(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Fi(t.dataTransfer.files)}))}function Mt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>$e()})}window.handleImageUpload=async function(e){await Sa(e.target.files)};async function Fi(e){await Sa(e)}async function Sa(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await Rt(a);if(i){const o=t.children.length,n=document.createElement("div");n.innerHTML=Se(i,o),t.appendChild(n.firstElementChild),$e()}}Me(),ye(),window.lucide&&lucide.createIcons()}}async function Rt(e){try{const{data:{session:t}}=await m.auth.getSession(),a=(e.name||"photo.jpg").split(".").pop()||"jpg",i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`;for(let o=0;o<2;o++){const n=`${i}${o?"-"+Math.random().toString(36).slice(2,7):""}.${a}`,{error:r}=await m.storage.from("product-images").upload(n,e,{contentType:e.type,upsert:!1});if(r)console.warn("product-images upload failed (attempt "+(o+1)+"):",r.message||r);else{const{data:l}=m.storage.from("product-images").getPublicUrl(n);if(l&&l.publicUrl)return l.publicUrl}}try{const o=await T._downscaleImage(e,1200);if(o)return o}catch{}return URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),$e(),Me(),ye()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const o=await Rt(i);if(!o)return;const r=[...a.querySelectorAll(".img-thumb")][e];if(!r)return;const l=r.querySelector("img");l&&(l.src=o),$e(),Me(),ye(),u("Image replaced. Save changes to apply.","info")};function $e(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.querySelector("img");if(!o)return;const n=document.createElement("input");n.type="hidden",n.name="images",n.id=`img-url-${i}`,n.value=o.src,t.appendChild(n),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const c=a.querySelector(".rp-input");c&&(c.id=`rp-input-${i}`,c.onchange=()=>replaceImage(i,c))}))}function Me(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ye(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length;t.textContent=a?`${a} image${a>1?"s":""} — you can save and publish anytime`:"No images yet — you can still save and publish anytime",t.className="text-sm mt-1 font-bold text-gray-400"}function Te(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Di(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Ni(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,n])=>{const r=e.querySelector(`[name="${o}"]`);r&&(r.type==="checkbox"?r.checked=n==="on"||n===!0:r.value=n==null?"":String(n))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.map((n,r)=>Se(n,r)).join(""),$e(),Me(),ye())}return!0}function vt(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,n=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,c=A.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(g=>g.value),p=document.querySelectorAll("#image-preview .img-thumb").length,h=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${V(d?"active":"inactive")}<span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${s(l)}</span></div>
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){const e=document.getElementById(X);if(e){if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!U.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed — nothing was changed.";return}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
      ...
      ${U.map((t,a)=>Yi(t,a)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=U[e];if(!t)return;const a=Ft(t,be),i=Xe(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(X==="s1-scan-status"||X==="scanner-scan-status")&&(ae(),ue=[]),Ji(t,a);return}const n=i.category||t.category||"Other";if(X==="s1-scan-status"||X==="scanner-scan-status"){try{localStorage.removeItem(Te(n,""))}catch{}ue=[];let r=t.property_id?xe[t.property_id]:null;r&&r.specifications&&typeof r.specifications=="object"&&(r={...r,...r.specifications}),showAddProductStep2(n,r?{...r,images:a}:{images:a}),await Gt(t,a,n)}else{const r=document.getElementById("product-form"),l=r&&r.dataset.category||"";if(n!==l){try{localStorage.removeItem(Te(n,""))}catch{}switchProductFormCategory(n);const c=document.getElementById(X);c&&(c.classList.remove("hidden"),c.classList.add("text-blue-300"),c.textContent=`Category changed to ${n} — finishing the scan…`),window.lucide&&lucide.createIcons()}await Gt(t,a,n)}};window.scanReviewEdit=function(e){const t=U[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=Xe(t.category),n=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",r=ce.map(l=>`<option value="${s(l)}" ${l===n?"selected":""}>${s(l)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=U[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,o=document.getElementById(`sr-model-${e}`)?.value,n=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),o&&(t.model=o),n&&(t.category=n),scanReviewRender()};window.scanReviewRemove=function(e){U.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(X);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled — nothing was changed.")};window.scanReviewContinueAll=async function(){const e=document.getElementById(X),t=(d,p)=>{e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400","text-gray-100"),p&&e.classList.add(p),e.innerHTML=d,window.lucide&&lucide.createIcons())};if(!U.length)return;const a=document.getElementById("btn-scan-continue-all");a&&(a.disabled=!0,a.textContent="Saving everything…");const i=U.length;let o=0,n=0,r=0;const l=[];for(let d=0;d<i;d++){const p=U[d];if(!p)continue;const h=Xe(p.category);if(p.listing_type==="property"||h&&h.listing_type==="property"){l.push(d);continue}const y=h.category||p.category||"Other",b=Ft(p,be);t(`<p class="flex items-center gap-2"><i data-lucide="loader" class="w-4 h-4 animate-spin text-blue-300"></i> Completing ${d+1} of ${i}: <b>${s(p.detected_name||"product")}</b>…</p>`,"text-blue-300");try{const[v,S]=await Promise.all([T.completeProductSpecs(b,p,{category:y,maxImages:J.maxImages}).catch(()=>null),T.estimateProductPrice(b,p,{},{category:y,maxImages:J.maxImages}).catch(()=>null)]);let I=v||{},w=S;const f=I||{},_=p.property_id&&xe[p.property_id]||null,x=_?_.specifications&&typeof _.specifications=="object"?{..._,..._.specifications}:_:null,W=[p.year||f.year,p.brand||f.brand,p.model||f.model].filter(Boolean).join(" ")||p.detected_name||"Product",Y=w?Number(w.estimated_price??w.price??w.estimate):NaN;let G=Number.isFinite(Y)&&Y>0?Y:x?Number(x.price):NaN;(!Number.isFinite(G)||G<=0)&&(G=D),G=Math.max(D,Math.min(K,G));const M={};for(const E of["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","type","size","age_range","skin_type","dimensions","author","publisher","language","format","pages","edition","quantity","pet_type","lens","sensor","megapixels","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"]){const re=f[E]??p[E];re!=null&&String(re).trim()!==""&&(M[E]=re)}const k={...x&&x.specifications&&typeof x.specifications=="object"?x.specifications:{},...M},j={listing_type:"product",category:y,subcategory:x?.subcategory||null,title:x&&x.title?x.title:W,description:f.description||x&&x.description||"",price:G,currency:x&&x.currency||"USD",country:x&&x.country||"",country_code:x&&x.country_code||"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:!0,is_featured:!!(x&&x.is_featured),brand:p.brand||f.brand||x&&x.brand||null,color:f.color||x&&x.color||null,size:f.size||x&&x.size||null,condition:x&&x.condition||null,warranty:x&&x.warranty||null,availability_status:x&&x.availability_status||"In Stock",stock_quantity:x&&x.stock_quantity?parseInt(x.stock_quantity):null,images:b.length?b:x&&x.images||[],features:Array.isArray(f.features)&&f.features.length?f.features:x&&x.features||[],tags:Array.isArray(f.tags)&&f.tags.length?f.tags:x&&x.tags||[],highlights:Array.isArray(f.highlights)&&f.highlights.length?f.highlights:x&&x.highlights||[],seo_keywords:Array.isArray(f.seo_keywords)&&f.seo_keywords.length?f.seo_keywords:x&&x.seo_keywords||[],is_ai_generated:!0,ai_generated_fields:["title","description","specifications","price"],specifications:k,updated_at:new Date().toISOString()};if(x&&x.property_id){j.property_id=x.property_id;const{error:E}=await m.from("showroom_listings").upsert(j,{onConflict:"property_id"});if(E)throw E;n++}else{j.property_id=Ke();const{error:E}=await m.from("showroom_listings").insert(j);if(E)throw E;o++}}catch(v){r++,t(`<p class="text-amber-300">Could not save "${s(p.detected_name||"product")}": ${s(String(v?.message||v))} — continuing with the rest…</p>`,"text-amber-300")}}U=U.filter((d,p)=>l.includes(p));const c=`${n} updated, ${o} new${r?`, ${r} failed`:""}`;if(!U.length)xe={},be=[],t(`<div class="space-y-1">
    ...
    </div>`,"text-emerald-300"),u(`All done — ${c} saved & published.`,"success");else{scanReviewRender();const d=document.getElementById(X);if(d){const p=document.createElement("p");p.className="text-xs font-bold text-emerald-300",p.textContent=`Saved & published: ${c}. Property cards below still need Continue.`,d.prepend(p)}u(`Saved ${c}.`,r?"info":"success")}R()};function $a(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,o=[],n=$=>Array.isArray($)?$.join(", "):String($??"").trim(),r=($,C)=>{if(C==null||n([C])==="")return;const z=document.querySelector(`#property-form [name="${$}"]`);z&&(z.value=String(C),o.push($))},l=t.property_type||a.property_type;if(l){const $=Ki(l);$&&r("property_type",$)}r("title",a.title||t.detected_name),r("description",a.description),r("subcategory",t.subcategory||a.subcategory);const c=t.bedrooms??a.bedrooms;c!=null&&c!==""&&r("bedrooms",parseInt(c,10)||c);const d=t.bathrooms??a.bathrooms;d!=null&&d!==""&&r("bathrooms",parseInt(d,10)||d),r("building_size",t.building_size||a.building_size),r("land_size",t.land_size||a.land_size);const p=t.parking_spaces??a.parking_spaces;p!=null&&p!==""&&r("parking_spaces",parseInt(p,10)||p);const h=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(h)?r("furnished","Furnished"):/unfurnished|no|empty/.test(h)&&r("furnished","Unfurnished");const g=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(g)?r("listing_status","rent"):/sale|buy|purchase/.test(g)&&r("listing_status","sale");const y=t.area||a.area;y&&!(t.town||a.town)&&r("town",y),r("town",t.town||a.town),r("city",t.city||a.city),r("state",t.state||a.state);const b=t.country||a.country;if(r("country",b),b){const $=(_e||[]).find(C=>String(C.name||"").toLowerCase()===String(b).toLowerCase()||String(C.code||"").toLowerCase()===String(b).toLowerCase());if($&&$.code){const C=document.querySelector('#property-form [name="country_code"]');C&&(C.value=$.code,o.push("country_code"))}}const v=t.address||a.address;r("product_location",v||[y||t.town||a.town,t.city||a.city,t.state||a.state,b].filter(Boolean).join(", ")),r("address",t.address||a.address),r("zip_code",t.zip_code||a.zip_code);const S=Number(t.latitude??a.latitude),I=Number(t.longitude??a.longitude);Number.isFinite(S)&&S>=-90&&S<=90&&S!==0&&r("latitude",String(S)),Number.isFinite(I)&&I>=-180&&I<=180&&I!==0&&r("longitude",String(I)),r("features_text",n(a.features)),r("highlights_text",n(t.highlights||a.highlights)),r("seo_keywords_text",n(a.seo_keywords));const w=t.half_bathrooms??a.half_bathrooms;w!=null&&w!==""&&r("half_bathrooms",parseInt(w,10)||w);const f=t.floors??a.floors;f!=null&&f!==""&&r("floors",parseInt(f,10)||f),r("garage",t.garage||a.garage);const _=t.year_built??a.year_built;_!=null&&_!==""&&r("year_built",parseInt(_,10)||_);const x=t.year_renovated??a.year_renovated;x!=null&&x!==""&&r("year_renovated",parseInt(x,10)||x);const W=t.condition||a.condition,Y=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(W){const $=String(W).toLowerCase(),C=Y.find(z=>$.includes(z.toLowerCase())||z.toLowerCase().includes($));C&&r("condition",C)}r("interior_features_text",n(a.interior_features)),r("exterior_features_text",n(a.exterior_features)),r("home_systems_text",n(a.home_systems));const G=n(t.landmarks||a.landmarks);G&&r("landmarks_text",G);const M=a.floor_plan;if(M&&typeof M=="object"){M.image&&r("floor_plan_image",M.image),M.levels&&r("floor_plan_levels",M.levels),M.total_area&&r("floor_plan_total_area",M.total_area);const $=Array.isArray(M.rooms)?M.rooms.map(C=>{const z=String(C).match(/^(.*?):\s*(.*)$/);return z?`${z[1].trim()}: ${z[2].trim()}`:String(C)}):[];$.length&&r("floor_plan_rooms",$.join(", "))}const k=a.nearby_area;k&&typeof k=="object"&&(Array.isArray(k.schools)&&k.schools.length&&r("nearby_schools_text",k.schools.join(", ")),Array.isArray(k.hospitals)&&k.hospitals.length&&r("nearby_hospitals_text",k.hospitals.join(", ")),Array.isArray(k.shopping)&&k.shopping.length&&r("nearby_shopping_text",k.shopping.join(", ")),Array.isArray(k.transportation)&&k.transportation.length&&r("nearby_transportation_text",k.transportation.join(", ")),Array.isArray(k.distances)&&k.distances.length&&r("nearby_distances_text",k.distances.join(", ")));const j=Array.isArray(a.legal_info)?a.legal_info.join(", "):n(a.legal_info);j&&r("legal_info_text",j),a.inspection_info&&r("inspection_info",a.inspection_info),a.risk_notes&&r("risk_notes",a.risk_notes);const E=document.querySelector('#property-form [name="verification_status"]');E&&(E.value="Not verified",o.push("verification_status"));const re=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map($=>String($))),rt=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);re.forEach($=>{if(rt.has($))return;const C=document.querySelector(`#property-form [name="${$}"]`);if(!(!C||C.type==="checkbox"||C.type==="radio"||C.type==="number")&&String(C.value||"").trim()===""){if(C.tagName==="SELECT"&&![...C.options].some(z=>z.value==="Not specified")){const z=document.createElement("option");z.value="Not specified",z.textContent="Not specified",C.appendChild(z)}C.value="Not specified",o.push(`${$} (Not specified)`)}});const st=Number.isFinite(Number(D))?Number(D):0,qa=Number.isFinite(Number(K))?Number(K):999999999,Ot=$=>Math.max(st,Math.min(qa,Math.round($))),Ae=i?Number(i.estimated_price):NaN,De=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(Ae)&&Ae>0){const $=document.querySelector('#property-form [name="real_price"]');$&&($.value=String(Ot(Ae)),o.push("real_price"));const C=Number.isFinite(De)&&De>0&&De<Ae?De:Ae;r("price",String(Ot(C)))}return typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:o}}async function Gt(e,t,a){const i=document.getElementById("scan-ai-status"),o=(n,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=n)};try{o("Completing the standard specifications for that product…","text-blue-300");const n=await T.completeProductSpecs(t,e,{category:a||"",maxImages:J.maxImages});let r=null;o("Estimating a fair current market price…","text-blue-300");try{r=await T.estimateProductPrice(t,e,n||{},{category:a||"",maxImages:J.maxImages})}catch{}const l=Wi({identification:e,specs:n,price:r}),c=[e.year,e.brand,e.model].filter(Boolean).join(" ")||e.detected_name||"the product";let d=`${s(c)} — ${l.filled.length} field${l.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;e.year_estimated&&(d+=" Confirm the model year before saving."),o(d,"text-emerald-300"),u(`Review ${c}, then press SAVE / UPDATE.`,"success")}catch(n){const r=String(n?.message||n),l=/key|api|configured|settings|vision/i.test(r);o(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){u("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",n=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await T.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){n("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),n("Detecting every distinct product in your images…","text-blue-300");let r;try{r=await T.detectProducts(i,{category:e.dataset.category||"",maxImages:Math.min(i.length,J.maxImages)})}catch(c){const d=String(c?.message||c),p=/key|api|configured|settings|vision/i.test(d);n(p?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);let l=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];l.length||(l=[{detected_name:"Product from your photos",category:e.dataset.category||"Other",listing_type:"product",confidence:"low",image_indices:i.map((c,d)=>d)}],n("The AI could not confidently read these photos — a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),U=l,be=i,xe={},X="scan-ai-status",scanReviewRender(),u(`${l.length} distinct product${l.length>1?"s":""} detected — review each one, then continue.`,"info")};function Ji(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((r,l)=>Se(r,l)).join(""),i.innerHTML=t.map((r,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${s(r)}">`).join(""),Me(),ye());const o=document.getElementById("scan-ai-prop-status"),n=(r,l)=>{o&&(o.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&o.classList.add(l),o.innerHTML=r)};n("Completing the standard specifications for this property…","text-blue-300"),T.completeProductSpecs(t,e,{category:"Real Estate",maxImages:J.maxImages}).then(r=>T.estimateProductPrice(t,e,r||{},{category:"Real Estate",maxImages:J.maxImages}).then(l=>{const c=$a({identification:e,specs:r,price:l});n(`${s(e.detected_name||"Property")} — ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}).catch(()=>n("Price estimate skipped — review the details and set a price manually.","text-amber-300"))).catch(r=>{const l=/key|api|configured|settings|vision/i.test(String(r?.message||r));n(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),u("AI scan failed.","error")})}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){u("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one property image before scanning.","error");return}const o=t?t.innerHTML:"",n=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await T.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){n("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),n("Identifying this property from your images…","text-blue-300");let r;try{r=await T.identifyProduct(i,{category:"Real Estate",maxImages:J.maxImages})}catch(c){const d=String(c?.message||c),p=/key|api|configured|settings|vision/i.test(d);n(p?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}if(!r||r.identified===!1){n(r&&r.reason?`Could not identify the property: ${s(r.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),u("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=await new Promise(c=>{qe=g=>{qe=null,c(g)};const d=document.getElementById("scan-ai-prop-status");if(!d){c({choice:"continue"});return}if(!window._propFormDirty){c({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const p=r.confidence||"medium",h={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[p]||"text-amber-400 border-amber-500/20";d.innerHTML=`
      <div class="rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in">
        ...
        <p class="text-[11px] text-gray-400">
          ...
          <span class="ml-1 inline-block px-2 py-0.5 rounded-full text-[10px] font-bold border ${h}">${s(p).toUpperCase()} confidence</span>
        </p>
        <div class="flex flex-wrap gap-2">
      ...
      </div>`});if(!l||l.choice==="cancel"){n("Scan cancelled — nothing was changed.","text-gray-400"),u("Scan cancelled.","info");return}try{n("Completing the standard specifications for this property…","text-blue-300");const c=await T.completeProductSpecs(i,r,{category:"Real Estate",maxImages:J.maxImages});let d=null;n("Estimating a fair market value…","text-blue-300");try{d=await T.estimateProductPrice(i,r,c||{},{category:"Real Estate",maxImages:J.maxImages})}catch{}const p=$a({identification:r,specs:c,price:d});n(`${s(r.detected_name||"Property")} — ${p.filled.length} field${p.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success")}catch(c){const d=String(c?.message||c),p=/key|api|configured|settings|vision/i.test(d);n(p?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let ue=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await Rt(a);i&&ue.push(i)}catch{}Pa(),e.target.value=""}};window.removeStep1Image=function(e){ue.splice(e,1),Pa()};function Pa(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=ue.map((a,i)=>`
    ...
    </div>`).join("");const t=document.getElementById("btn-s1-scan");t&&(t.disabled=ue.length===0,t.style.opacity=ue.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=ue.slice();if(!e.length){u("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-s1-scan"),a=document.getElementById("s1-scan-status"),i=t?t.innerHTML:"",o=(l,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=l)};try{const l=await T.getConfig();if(!String(l.gemini_key||l.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o("Detecting every distinct product in your images…","text-blue-300");let n;try{n=await T.detectProducts(e,{category:"",maxImages:Math.min(e.length,J.maxImages)})}catch(l){const c=/key|api|configured|settings|vision/i.test(String(l?.message||l));o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);let r=n&&n.identified!==!1&&Array.isArray(n.products)&&n.products.length?n.products:[];r.length||(r=[{detected_name:"Product from your photos",category:"Other",listing_type:"product",confidence:"low",image_indices:e.map((l,c)=>c)}],o("The AI could not confidently read these photos — a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),U=r,be=e,xe={},X="s1-scan-status",scanReviewRender(),u(`${r.length} distinct product${r.length>1?"s":""} detected — review each one, then continue.`,"info")};let xe={};async function Ea(){const e=new Set,t=[],a=i=>{!i||!i.property_id||i.listing_type==="property"||e.has(i.property_id)||!Array.isArray(i.images)||!i.images.length||(e.add(i.property_id),t.push(i))};try{const{data:i,error:o}=await m.from("showroom_listings").select("*").neq("listing_type","property");(o?[]:i||[]).forEach(a)}catch{}return Ve().forEach(a),t}window.openGeneralAiScanner=async function(){const e=await Ea();H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons()};function zt(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await zt(Ea(),15e3)}catch{e=[]}if(!e.length){u("No products with photos are in the Product Manager yet — add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",o=(f,_)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),_&&a.classList.add(_),a.innerHTML=f)};try{const f=await T.getConfig();if(!String(f.gemini_key||f.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o(`Detecting and completing ${e.length} product${e.length===1?"":"s"}…`,"text-blue-300");const n=[],r=[],l={};let c=0;const d=e.length,p=new Set;let h=0,g=0;window.__scanDupContinue=function(){const f=window.__scanDupResolve;window.__scanDupResolve=null;const _=document.getElementById("btn-scan-dup-continue");_&&(_.disabled=!0),f&&f()};const y=3,b=45e3;let v=0,S=0;const I=async f=>{const _=(f.images||[]).slice(0,J.maxImages);if(!_.length)return;const x=_.map(k=>String(k||"").trim()).filter(Boolean),W=x.length>0&&x.every(k=>p.has(k));for(const k of x)p.add(k);if(W){h++;return}const Y=n.length;n.push(..._);const G=_.map((k,j)=>Y+j);let M=[];try{const k=await zt(T.detectProducts(_,{category:f.category||"",maxImages:Math.min(_.length,J.maxImages)}),b);M=k&&k.identified!==!1&&Array.isArray(k.products)?k.products:[]}catch{}M.length||(M=[{detected_name:f.title||f.property_id||"Product",category:f.category||"Other",listing_type:f.listing_type||"product",brand:f.brand||null,model:f.specifications&&f.specifications.model||f.model||null,confidence:"medium"}],g++),c++,l[f.property_id]=f;for(const k of M)r.push({...k,property_id:f.property_id,image_indices:Array.isArray(k.image_indices)&&k.image_indices.length?k.image_indices.map(j=>G[Number(j)]).filter(j=>j!==void 0):G,detected_name:k.detected_name||f.title||f.property_id,category:k.category||f.category||"Other",listing_type:k.listing_type||f.listing_type||"product"})},w=async()=>{for(;v<e.length;){const f=e[v++];o(`Scanning ${S+1} of ${d} product${d===1?"":"s"} (fast parallel mode)…`,"text-blue-300"),await I(f),S++,S<d&&o(`Scanned ${S} of ${d} — continuing…`,"text-blue-300")}};if(await Promise.all(Array.from({length:Math.min(y,Math.max(1,e.length))},w)),t&&(t.disabled=!1,t.innerHTML=i),!r.length){o(`No product could be identified from the photos on your existing products${h?` (${h} duplicate product${h>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),u("No products could be scanned.","error");return}U=r,be=n,xe=l,X="scanner-scan-status",scanReviewRender(),u(`Scan complete — ${c} product${c>1?"s":""} scanned${h?`, ${h} duplicate product${h>1?"s":""} skipped`:""}${g?`, ${g} completed from saved details (AI could not read the photo — review ${g>1?"those":"it"} and edit as needed)`:""}. Press "Continue with ALL" to save & publish everything at once.`,"success")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),n=a?"One-Click Publish Changes":"One-Click Publish Product";o&&(o.disabled=!0,o.textContent="Saving…");try{const r=new FormData(i),l={};let c=0;for(const[y,b]of r.entries())if(y==="images"){l.images=l.images||[];const v=String(b);b&&!v.startsWith("blob:")?l.images.push(v):v.startsWith("blob:")&&c++}else y==="tags"?(l.tags=l.tags||[],l.tags.push(b)):l[y]=b;if(c&&!(l.images||[]).length){o&&(o.disabled=!1,o.textContent=n),u("Your images were still uploading — please wait a moment and press Publish again (the photos were not saved with the product).","error");return}l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",p=y=>gt(y),h=y=>{const b=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],v={};for(const S of b){const I=y[S];if(S==="real_price"){const w=I!=null&&String(I).trim()!==""?parseFloat(I):null;v[S]=w!=null&&Number.isFinite(w)&&w>0?Math.round(w):null;continue}v[S]=I!=null&&String(I).trim()!==""?I:null}if(y.safety_features){const S=p(y.safety_features);v.safety_features=S.length?S:null}return v};let g;if(a){let y=ve((window._productsData||[]).find(E=>E.property_id===a));if(!y){const{data:E}=await m.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();y=E?ve(E):null}if(!y)throw new Error("Could not load the current product. Refresh the page and try again.");const b=(E,re)=>{const rt=E===""||E==null?"":E,st=re===""||re==null?"":re;return String(rt).trim()===String(st).trim()},v={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(E=>{b(l[E],y[E])||(v[E]=l[E]==null||l[E]===""?null:l[E])});const S=l.price===""||l.price==null?null:parseFloat(l.price);b(S,y.price)||(v.price=S==null?y.price:Math.max(D,Math.min(K,S)));const I=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);b(I,y.stock_quantity)||(v.stock_quantity=Number.isFinite(I)?I:null);const w=p(l.features_text);b(w.join("||"),(Array.isArray(y.features)?y.features:[]).join("||"))||(v.features=w);const f=l.tags||[];b(f.join("||"),(Array.isArray(y.tags)?y.tags:[]).join("||"))||(v.tags=f);const _=p(l.highlights_text);b(_.join("||"),(Array.isArray(y.highlights)?y.highlights:[]).join("||"))||(v.highlights=_);const x=p(l.seo_keywords_text);b(x.join("||"),(Array.isArray(y.seo_keywords)?y.seo_keywords:[]).join("||"))||(v.seo_keywords=x);const W=l.images||[];b(W.join("||"),(Array.isArray(y.images)?y.images:[]).join("||"))||(v.images=W);const Y=l.is_featured==="on";!!y.is_featured!==Y&&(v.is_featured=Y);const G=d?!1:l.is_active==="on";!!y.is_active!==G&&(v.is_active=G);const M=h(l),k={...y.specifications&&typeof y.specifications=="object"?y.specifications:{},...M};if(JSON.stringify(k)!==JSON.stringify(y.specifications||{})&&(v.specifications=k),Object.keys(v).length===0){u("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Te(t,a))}catch{}o&&(o.disabled=!1,o.textContent=n);return}const j={...y,...v,property_id:a,updated_at:new Date().toISOString()};if({error:g}=await m.from("showroom_listings").upsert(j,{onConflict:"property_id"}),g&&bt(g,()=>dt(j),"Product update")){o&&(o.disabled=!1,o.textContent=n),ae(),R();return}u(d?"Draft saved!":`Published Successfully — your product is updated and live in your showroom (${Object.keys(v).length} change${Object.keys(v).length>1?"s":""}).`)}else{if(!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!l.condition)throw new Error("Please choose the product condition.");const b={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(D,Math.min(K,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:l.is_active==="on",is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:p(l.features_text).length?p(l.features_text):l.tags||[],tags:l.tags||[],highlights:p(l.highlights_text),seo_keywords:p(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:h(l)},v=Ke();if(b.property_id=v,{error:g}=await m.from("showroom_listings").insert(b),g&&bt(g,()=>dt({...b,property_id:b.property_id}),"Product publish")){o&&(o.disabled=!1,o.textContent=n),ae(),R();return}u(d?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}try{localStorage.removeItem(Te(t,a))}catch{}closeProductFormModal(),R()}catch(r){u("Error: "+r.message,"error"),o&&(o.disabled=!1,o.textContent=n)}};window.editProduct=async function(e){const{data:t,error:a}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=$t(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return u("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=ve((window._productsData||[]).find(o=>o.property_id===e)),{error:i}=await m.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return Q(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:n,updated_at:r,...l}=a,c=Ke();await m.from("showroom_listings").insert({...l,property_id:c,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await m.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),R())};const xt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ze(){const e=document.getElementById("content");try{const{data:t,error:a}=await m.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Ve().filter(n=>n.listing_type==="property"):t||[];if(Array.isArray(ee)){const n=new Set(i.map(l=>l.property_id)),r=ee.filter(l=>l.listing_type==="property"&&l.property_id&&!n.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((n,r)=>new Date(r.created_at||0)-new Date(n.created_at||0));try{await Pt()}catch{}const o=new Set(We());i=i.filter(n=>!(n&&n.property_id&&o.has(n.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(n=>`<tr>
                    ...
                    <td>${V(n.listing_status||"sale")} ${V(n.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=ia("property","Real Estate"),i=e.country_code||"US",o=e.currency||Et(i);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${_a(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${ka(o)}</select></div>
            </div>
    ...
    </div>`),Bt(),Mt(),yt("ppf-price"),window._propFormDirty=!!t;const n=document.getElementById("property-form");if(n){const r=()=>{window._propFormDirty=!0};n.addEventListener("input",r),n.addEventListener("change",r)}window.syncPropertyCountry=function(){Ht("ppf")},Ht("ppf"),ht("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>ht("pricing")),Zi()};let Z=null,Ue=null,Vt=null;function Qi(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function se(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Ce(e,t,{reverse:a=!1}={}){if(!Z||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Ue?Ue.setLatLng(i):Ue=L.marker(i,{draggable:!0}).addTo(Z),Z.setView(i,Math.max(Z.getZoom(),13));const o=document.querySelector('#property-form [name="latitude"]'),n=document.querySelector('#property-form [name="longitude"]');o&&(o.value=String(Number(e.toFixed(6)))),n&&(n.value=String(Number(t.toFixed(6)))),a&&Xi(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Ie(){const e=Qi();if(!e){se("Enter a location (address, area, city, state, country), then press Locate from fields.");return}se("Searching location…");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Ce(parseFloat(a[0].lat),parseFloat(a[0].lon)),se("Located: "+a[0].display_name)):se("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{se("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Xi(e,t){const a=document.querySelector("#property-form");if(a)try{const o=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),n=o&&o.address||{},r=(y,b)=>{if(!b)return;const v=a.querySelector(`[name="${y}"]`);return v&&!String(v.value||"").trim()?(v.value=b,!0):!1},l=[n.road||"",n.house_number||""].filter(Boolean).join(" "),c=n.suburb||n.neighbourhood||n.quarter||n.district||n.borough||"",d=n.town||n.village||n.municipality||n.city_district||"",p=n.city||n.county||"",h=n.state||n.region||"",g=n.country||"";if(r("product_location",l||c||d),r("town",c||d),r("city",p),r("state",h),g){r("country",g);const y=a.querySelector('[name="country_code"]');if(y){const b=(_e||[]).find(v=>String(v.name||"").toLowerCase()===String(g).toLowerCase());b&&b.code&&!y.value&&(y.value=b.code)}}se("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(o.display_name?" — "+o.display_name:""))}catch{se("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!Z)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Ce(e,t),se("Map updated from coordinates.")):Ie()};function Zi(){const e=document.getElementById("property-map-preview");if(!e||!window.L){se("Map unavailable right now — your location fields still save normally.");return}Z&&(Z.remove(),Z=null,Ue=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);Z=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(Z),Z.on("click",o=>Ce(o.latlng.lat,o.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Ie),["product_location","town","city","state","country","latitude","longitude"].forEach(o=>{const n=document.querySelector(`#property-form [name="${o}"]`);n&&(n.addEventListener("input",()=>{if(o==="latitude"||o==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(l)&&(r||l)&&Ce(r,l);return}clearTimeout(Vt),Vt=setTimeout(Ie,900)}),n.addEventListener("change",()=>{o!=="latitude"&&o!=="longitude"&&Ie()}))}),i?Ce(t,a):Ie()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(o=>{const n=parseFloat(o.latitude),r=parseFloat(o.longitude),l=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");return!(Number.isFinite(n)&&Number.isFinite(r)&&(n!==0||r!==0))&&!!l});if(!t.length){u("All properties already have map coordinates.","success");return}u(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}…`,"success");let a=0,i=0;for(const o of t){const n=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");try{const l=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(n))).json();if(l&&l[0]){const c={latitude:parseFloat(l[0].lat),longitude:parseFloat(l[0].lon)},{error:d}=await m.from("showroom_listings").update(c).eq("property_id",o.property_id);d?i++:(Object.assign(o,c),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}u(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),Ze()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(g=>g&&!g.startsWith("blob:")),n=(i.features_text||"").split(",").map(g=>g.trim()).filter(Boolean),r=i.real_price===""||i.real_price==null?null:Math.max(D,Math.min(K,parseFloat(i.real_price)||0)),l=g=>(g||"").split(",").map(y=>y.trim()).filter(Boolean),c=g=>g===""||g==null||!isFinite(parseInt(g,10))?null:parseInt(g,10),d=l(i.floor_plan_rooms).map(g=>{const y=String(g).match(/^(.*?):\s*(.*)$/);return y?{name:y[1].trim(),dimensions:y[2].trim()}:{name:g,dimensions:""}}),p={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(D,Math.min(K,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:r,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:c(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:c(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:c(i.year_built),year_renovated:c(i.year_renovated),landmarks:l(i.landmarks_text),interior_features:l(i.interior_features_text),exterior_features:l(i.exterior_features_text),home_systems:l(i.home_systems_text),legal_info:l(i.legal_info_text).map(g=>{const y=String(g).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return y?{label:y[1].trim(),value:y[2].trim(),source:y[3]}:{label:g,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:d,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:l(i.nearby_schools_text),hospitals:l(i.nearby_hospitals_text),shopping:l(i.nearby_shopping_text),transportation:l(i.nearby_transportation_text),distances:l(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:l(i.documents_text),features:n,images:o,highlights:gt(i.highlights_text),seo_keywords:gt(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let h;if(t){p.property_id=t;const g=ve((window._propertiesData||[]).find(y=>y.property_id===t)||(window._productsData||[]).find(y=>y.property_id===t));p.specifications={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},real_price:r},{error:h}=await m.from("showroom_listings").upsert({...g,...p},{onConflict:"property_id"})}else p.property_id=Ke(),p.specifications={real_price:r},{error:h}=await m.from("showroom_listings").insert(p);h&&bt(h,()=>dt({...p,property_id:t||p.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),ae(),Ze())};window.editProperty=async function(e){const{data:t,error:a}=await m.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=$t(e)),i||(i=(Array.isArray(ee)?ee.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const eo=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Aa(){const e=document.getElementById("content");try{const{data:t}=await m.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    <td>${V(e.status)}</td>
    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${te(e.created_at)}</span></td>
    <td>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",da(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",pe(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${s(i)||"—"}</p></div>`).join("")}
          </div>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await m.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),ae(),Aa()};async function ao(){const e=document.getElementById("content");try{const{data:t}=await m.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(i=>`<tr class="cust-row" data-search="${s(i.display_name)} ${s(i.user_id)}">
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${te(i.created_at)}</span></td>
                    <td>
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await m.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${te(t.created_at)} · ${s(t.country_code||"Unknown country")}</p>
          </div>
        </div>
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${s(i.order_number)}</p><p class="text-[10px] text-gray-500">${pe(i.created_at)}</p></div>
            <div class="flex items-center gap-2">${V(i.status)}<span class="text-xs font-bold text-emerald-400">$${parseFloat(i.amount).toLocaleString()}</span></div>
          </div>`).join("")}
      </div>
    </div>`)};async function Re(){const e=document.getElementById("content");try{const{data:t}=await m.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:o}=await m.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),n=o||[],r=n.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?me("star","No Reviews","Customer reviews will appear here."):a.map(l=>oo(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${n.length===0?me("message-square","No Feedback Yet","Site feedback will appear here."):n.map(l=>io(l)).join("")}
          </div>
        </div>
    ...
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1 flex-wrap">
          ...
          <span class="text-xs text-gray-500">${s(e.email||"no email")} · ${te(e.created_at)}</span>
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await m.from("site_feedback").update({is_approved:!0}).eq("id",e);t?u(t.message,"error"):u("Feedback approved — it now shows on every page."),Re()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await m.from("site_feedback").delete().eq("id",e);t?u(t.message,"error"):u("Feedback deleted."),Re()};function oo(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1">
          <span class="text-amber-400 font-bold text-sm">${t}</span>
          <span class="text-xs text-gray-500">${te(e.created_at)}</span>
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${pe(i.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.markMsgRead=async function(e){await m.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),Ia()};async function et(){const e=document.getElementById("content");try{const{data:t}=await m.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td>${V(i.is_active?"active":"inactive")}</td>
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${te(i.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await m.from("coupons").insert(i);if(o){u(o.message,"error");return}u("Coupon created!"),ae(),et()};window.toggleCoupon=async function(e,t){await m.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),et()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await m.from("coupons").delete().eq("id",e),u("Coupon deleted"),et())};async function no(){const e=document.getElementById("content");try{const{data:t}=await m.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?me("bell","No Notifications","System notifications will appear here."):a.map(i=>`
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${Ca.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";Dt(e,a,"")};window.showAddAdModal=async function(){const e=await Ta();window._adLinkCache=e,H(La(null)),Dt(e,"none","")};window.showEditAdModal=async function(e){const t=await Ta();window._adLinkCache=t;const{data:a}=await m.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}H(La(a)),a.image_url?He(a.image_url,!1):a.video_url&&He(a.video_url,!0),Dt(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",o={title:a.title,description:a.description||"",ad_label:Ca.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!o.image_url&&!o.video_url){u("Add an image or video for the ad","error");return}const n=e.target.querySelector('button[type="submit"]');n&&(n.disabled=!0);try{if(i){const{error:r}=await m.from("promotions").update(o).eq("id",i);if(r)throw r;u("Ad updated!")}else{const{error:r}=await m.from("promotions").insert(o);if(r)throw r;u("Ad created!")}}catch(r){u(r.message||"Save failed","error"),n&&(n.disabled=!1);return}ae(),Pe()};window.togglePromo=async function(e,t){const{error:a}=await m.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),Pe()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await m.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const o=a||[],n=o.findIndex(d=>d.id===e),r=n+t;if(n<0||r<0||r>=o.length){u("Already at the edge","info");return}const l=o[n],c=o[r];await m.from("promotions").update({sort_order:c.sort_order}).eq("id",l.id),await m.from("promotions").update({sort_order:l.sort_order}).eq("id",c.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}Pe()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await m.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(o=>{const n=/\/object\/public\/advertisements\/(.+)$/.exec(o);return n?decodeURIComponent(n[1]):null}).filter(Boolean);if(i.length)try{await m.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await m.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}Pe()}};async function Pe(){const e=document.getElementById("content");try{const{data:t}=await m.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    ${lo(i)}
                    <span class="text-[10px] text-gray-500">${te(i.start_date)}${i.start_date?" → ":""}${te(i.end_date)}</span>
                  </div>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.renderAds=Pe;const tt=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],oe={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Ba(){const e=document.getElementById("content");try{let t=function(n){const r=o===n.id,l=i[n.kf],c=i[n.mf]||n.dm;return`
        <div class="glass-soft border ${r?oe.border[n.color]+" "+oe.bg[n.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${n.id}">
          <div class="flex items-start justify-between gap-2">
            <div class="flex items-center gap-2.5 min-w-0">
              <div class="w-8 h-8 ${oe.bg[n.color]} rounded-lg flex items-center justify-center shrink-0">
                <i data-lucide="${n.icon}" class="w-4 h-4 ${oe.text[n.color]}"></i>
              </div>
              <div class="min-w-0">
                <div class="flex items-center gap-1.5 flex-wrap">
                  <h3 class="text-xs font-black text-white">${s(n.name)}</h3>
                  <span class="text-[8px] font-black uppercase px-1.5 py-0.5 rounded-full ${oe.badge[n.color]}">${n.tag}</span>
                </div>
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${r?oe.text[n.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${n.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${oe.text[n.color]} hover:underline flex items-center gap-0.5">
...
- category (string): the best category from this list: ${ce.join(", ")}.
- subcategory (string)
...
- category (for products and vehicles): best match from this list: ${ce.join(", ")}. For property photos set category to "Real Estate".
...
- category: best match from this list — ${ce.join(", ")}. For properties set category to "Real Estate".
...
}`;return this._runVisionPrompt(r,e,{maxImages:i.maxImages||5})},async _callEdge(e){let t="";try{t=(await m.auth.getSession())?.data?.session?.access_token||""}catch{}return await(await fetch(ci,{method:"POST",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}},body:JSON.stringify(e),signal:AbortSignal.timeout(6e4)})).json().catch(()=>({}))},_imageCache:new Map,async _fetchImageAsDataUrl(e,t=1024){const a=String(e);if(this._imageCache.has(a))return this._imageCache.get(a);const i=(async()=>{try{const n=await fetch(e,{signal:AbortSignal.timeout(15e3)}).then(r=>r.blob());return!n||!n.size?null:n.size<4e5?`data:${n.type||"image/jpeg"};base64,${await po(n)}`:await this._downscaleImage(n,t)}catch{return null}})();this._imageCache.set(a,i);const o=await i;return o||this._imageCache.delete(a),o},async _downscaleImage(e,t){const a=URL.createObjectURL(e);try{const i=new Image;await new Promise((c,d)=>{i.onload=c,i.onerror=d,i.src=a});const o=Math.min(1,t/Math.max(i.width,i.height)),n=Math.max(1,Math.round(i.width*o)),r=Math.max(1,Math.round(i.height*o)),l=document.createElement("canvas");return l.width=n,l.height=r,l.getContext("2d").drawImage(i,0,0,n,r),l.toDataURL("image/jpeg",.78)}finally{URL.revokeObjectURL(a)}},async _tryBrowserGeminiVision(e,t){const a=await this.getConfig(),i=String(a.gemini_key||a.gemini_api_key||"").trim();if(!i)return null;const o=[a.gemini_vision_model||a.gemini_model,"gemini-2.5-flash","gemini-3-flash-preview","gemini-3.1-flash-lite-preview"].filter(Boolean);for(const n of o)try{const r=[{text:e}];for(const g of t){const y=String(g).match(/^data:([^;,]+)[;,]base64,(.+)$/s);y&&r.push({inlineData:{mimeType:y[1].trim(),data:y[2].trim()}})}if(r.length<2)return null;const l=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(n)}:generateContent?key=${encodeURIComponent(i)}`,c=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:r}],generationConfig:{temperature:.2,maxOutputTokens:4096}}),signal:AbortSignal.timeout(4e4)});if(!c.ok)continue;const p=((await c.json())?.candidates?.[0]?.content?.parts||[]).map(g=>g?.text||"").join(`
`).trim();if(!p)continue;const h=lt(p);if(h)return{...h,_aiProvider:"Gemini (browser)",_aiModel:n}}catch{}return null}};function po(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const o=i.indexOf(",");t(o>=0?i.slice(o+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=T;window.showAiStatusModal=async function(){const e=await T.getStatus(),t=e.filter(a=>a.hasKey);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const t=document.getElementById("ai-test-output");t.classList.remove("hidden"),t.textContent="⏳ Asking Gemini…";try{const a=await T.prompt(e);t.textContent=`✓ [${a.provider} · ${a.model}]

${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function lt(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),o=t.lastIndexOf("}");if(i===-1||o===-1||o<=i)return null;const n=t.slice(i,o+1);try{return JSON.parse(n)}catch{return null}}async function mo(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([m.from("site_settings").select("*").limit(1).maybeSingle(),bo()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),n=a.length?`
        <div class="mt-4">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),u("Cleared. Save to apply.","info"),Fa()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),u(`Uploading ${a.name}…`,"info");try{const{data:{session:i}}=await m.auth.getSession();if(!i){u("Sign in to upload media","error");return}const o=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),n=`content/${t}-${Date.now()}.${o}`,{error:r}=await m.storage.from("product-images").upload(n,a,{contentType:a.type,upsert:!1});if(r){u("Upload failed: "+r.message,"error");return}const{data:l}=m.storage.from("product-images").getPublicUrl(n),c=l.publicUrl,d=document.getElementById("val-"+t),p=document.getElementById("url-"+t);d&&(d.value=c),p&&(p.value=c);const h=document.getElementById("slot-"+t);if(h){const g=Nt.flatMap(y=>y.fields||[]).find(y=>y.key===t);g&&(h.outerHTML=Ma(g,c))}u("✓ Uploaded — save to apply","success")}catch{u("Upload failed","error")}}};const go=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function ie(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Fe(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(ie()))}function fe(){Fe();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=Ra(ie()),window.lucide&&lucide.createIcons())}function yo(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim();return`
    <div>
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&ho(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=ie();i[e]&&(i[e][t]=a,Fe())};window.heroVideoPreset=function(e,t){const a=ie();a[e]&&(a[e].buttonText=t,fe())};window.heroVideoToggle=function(e){const t=ie();t[e]&&(t[e].enabled=t[e].enabled===!1,fe())};window.heroVideoMove=function(e,t){const a=ie(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],fe())};window.heroVideoDelete=function(e){const t=ie();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),fe())};window.heroVideoRemoveMedia=function(e,t){const a=ie();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),fe())};window.addHeroVideoSlide=function(){ie().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),fe(),u("New slide added — upload a video and press Save to show it.","info")};async function fo(e,t){try{const{data:{session:a}}=await m.auth.getSession(),i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,"");if(!a)return URL.createObjectURL(e);const o=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:n}=await m.storage.from("product-images").upload(o,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(n)return URL.createObjectURL(e);const{data:r}=m.storage.from("product-images").getPublicUrl(o);return r&&r.publicUrl||URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}async function ho(e,t,a){const i=ie();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){u("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){u("Please choose an image for the poster.","error");return}const o=await fo(a,t);t==="video"?i[e].video=o:i[e].poster=o,fe(),u("✓ "+(t==="video"?"Video":"Poster")+" uploaded — press Save to apply","success")}function vo(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,Fe(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
    ...
    </div>`}window.heroVideoSavePublish=async function(e){const t=ie().filter(o=>o&&(o.video||o.poster||o.title||o.subtitle));if(!t.length){u("Add at least one video slide before publishing.","error");return}const a=t.filter(o=>o.video);if(!a.length){u("Please upload a video in at least one slide first.","error");return}const i=e?e.innerHTML:"";e&&(e.disabled=!0,e.innerHTML="⏳ Publishing…");try{Fe();const{data:o}=await m.from("site_settings").select("id").limit(1).maybeSingle();let n;if(o?.id?{error:n}=await m.from("site_settings").update({hero_video_slides:t}).eq("id",o.id):{error:n}=await m.from("site_settings").insert({id:1,hero_video_slides:t}),n)throw new Error(n.message);Yt(),u("✓ Hero video banner published! "+a.length+(a.length===1?" video is":" videos are")+" now live on your homepage.","success")}catch(o){u(o.message||"Could not publish the hero banner. Please try again.","error")}finally{e&&(e.disabled=!1,e.innerHTML=i,window.lucide&&lucide.createIcons())}};async function Fa(){const e=document.getElementById("content");try{const{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),a={...Ha,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
              ...
              ${i.key==="hero_videos"?vo(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(o=>`
                  <div class="${o.type==="textarea"||o.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${o.type==="textarea"?`<textarea id="cs-${o.key}" name="${o.key}" rows="3" class="input-field w-full" placeholder="Enter the current wording…">${s(a[o.key]||"")}</textarea>`:o.type==="media"?Ma(o,a[o.key]||""):o.type==="checkbox"?"":`<input id="cs-${o.key}" type="text" name="${o.key}" value="${s(a[o.key]||"")}" class="input-field w-full" placeholder="Enter the current wording…">`}
      ...
      </div>`,Fe(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[o,n]of t.entries())a[o]=n;for(const o of Nt)if(o.fields)for(const n of o.fields)n.type==="checkbox"&&!(n.key in a)?a[n.key]=!1:n.type==="checkbox"&&(a[n.key]=!0);let i=[];try{const o=t.get("hero_video_slides");if(String(o||"").trim()){const n=JSON.parse(o);Array.isArray(n)&&(i=n)}}catch{i=[]}a.hero_video_slides=i;try{const{data:o}=await m.from("site_settings").select("id").limit(1).maybeSingle();let n;if(o?.id?{error:n}=await m.from("site_settings").update(a).eq("id",o.id):{error:n}=await m.from("site_settings").insert({id:1,...a}),n)throw new Error(n.message);Yt(),u("Content updated — the banners now use your new words and uploads.","success")}catch(o){u(o.message||"Could not save content. Please try again.","error")}};async function xo(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([m.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),m.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),m.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],n=o.filter(d=>["approved","payment_approved","delivered"].includes(d.status)).reduce((d,p)=>d+(parseFloat(p.amount)||0),0),r=o.length>0?(o.filter(d=>d.status!=="cancelled").length/o.length*100).toFixed(1):0,l={};(a.data||[]).forEach(d=>{l[d.category]=(l[d.category]||0)+1});const c=Object.entries(l).sort((d,p)=>p[1]-d[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${q("Total Revenue",`$${n.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
          ${q("Total Orders",o.length,"shopping-bag","blue")}
          ${q("Customers",i.count||0,"users","violet")}
          ${q("Conversion Rate",r+"%","trending-up","amber")}
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
      ...
      </div>`,window.lucide&&lucide.createIcons(),xa(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function wo(){const e=document.getElementById("content"),{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${c} · Enrolled: ${te(n.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(a=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${pe(a.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function So(){const e=document.getElementById("content");try{const{data:t}=await m.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${s(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${pe(a.created_at)}</p></div>
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),u("Orders exported!")};async function $o(){const e=document.getElementById("content"),{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await m.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function it(){const e=document.getElementById("content");e&&(e.innerHTML=ke());try{const{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",n=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function ot(){const e=document.getElementById("content");e&&(e.innerHTML=ke());try{let t=function(l,c,d,p="",h="blue"){const g=!!(d&&d.trim());return`
        <div class="glass-soft border border-${h}-500/15 rounded-xl p-4 space-y-3">
          ...
          ${p?`<p class="text-[10px] text-gray-500">${s(p)}</p>`:""}
        ...
        </div>`};const{data:a}=await m.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||ra,n=i.brand_slogan||i.site_tagline||sa,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    </div>`}function Wt(e,t,a,i,o){const n=o==="image",r=n?"blue":"violet",l=n?"image-plus":"video",c=n?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function Ua(){const e={};for(const t of ze)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=Ua();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),Le(t),u("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const n=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${n}`,{error:l}=await m.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let c;if(l)c=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:g}=m.storage.from("product-images").getPublicUrl(r);c=g.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const d=document.getElementById("val-"+t),p=document.getElementById("url-"+t);d&&(d.value=c),p&&(p.value=c,p.classList.remove("hidden"));const h=Ua();Le(h)}catch(n){o&&(o.textContent=`Upload failed: ${n.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const n of ze)t[n.key+"_bg_image"]=document.getElementById("val-"+n.key+"_bg_image")?.value||"",t[n.key+"_bg_video"]=document.getElementById("val-"+n.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await m.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await m.from("site_settings").update(t).eq("id",i.id):{error:o}=await m.from("site_settings").insert(t),ei(),o?(u("Publish failed — the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),Le(t)):(u("Promo & backgrounds published across all pages.","success"),setTimeout(()=>Le(),500))};window._manualPaymentAccounts=[];function Ut(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Jt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function jt(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Eo(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${la.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${_a(a)}</select></div>
    ...
    <div class="space-y-4">
    ...
    </div>`,jt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Ut()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Ut()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),jt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=_e.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Jt(t),jt(),renderManualPaymentAccountsEditor()};async function St(){const e=document.getElementById("content");e&&(e.innerHTML=ke());try{const{data:t}=await m.from("site_settings").select("*").limit(1).maybeSingle(),i={...Ja()||{},...t||{}};window._manualPaymentAccounts=Qa(i).map(o=>({...o})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o={},n=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[l,c]of Object.entries(i))n.includes(l)?c&&!c.startsWith("•")&&c.trim()!==""&&(o[l]=c.trim()):o[l]=c;const{error:r}=await m.from("site_settings").upsert({id:1,...o});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),r){u(r.message,"error");return}u("Deploy & payment settings saved!"),nt()};async function ja(e="deploy"){const{data:t}=await m.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return u("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function de(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:o,error:n}=await m.from("deployment_history").insert({version:a,status:e,triggered_by_email:A.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:o,error:n}}function we(e,t,a,i){if(!e)return;e.disabled=t;const o=e.querySelector("p.text-xs.font-black");o&&(o.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");we(t,!0,"Deploying…","Deploy Now");try{const a=await ja("deploy");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await de("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Deployment queued from admin UI"});const n=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(n.ok)u("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await de("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted deployment request"}),setTimeout(()=>nt(),400);else{const r=`Webhook returned error: ${n.status}`;u(r,"error"),await de("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:r})}}catch(a){u("Deploy failed: "+a.message,"error"),await de("failed",{mode:"deploy",errorMessage:a.message})}finally{we(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");we(t,!0,"Rebuilding…","Rebuild Site");try{const a=await ja("rebuild");if(!a.ok)return;const{settings:i,hookUrl:o}=a;await de("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Rebuild requested from admin UI"});const n=await fetch(o,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(n.ok)u("🔄 Rebuild triggered successfully."),await de("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,message:"Webhook accepted rebuild request"}),setTimeout(()=>nt(),400);else{const r=`Rebuild webhook error: ${n.status}`;u(r,"error"),await de("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:o,errorMessage:r})}}catch(a){u("Rebuild failed: "+a.message,"error"),await de("failed",{mode:"rebuild",errorMessage:a.message})}finally{we(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");we(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){u("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){u("Publish failed: "+a.message,"error")}finally{we(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:i,error:o}=await m.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(o)return Q(o)?u("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load listings to reindex: "+o.message,"error");const n=i||[];if(!n.length){u("No listings to reindex.");return}let r=0,l=0,c=!1;const d=40;for(let p=0;p<n.length;p+=d){const h=n.slice(p,p+d),{error:g}=await m.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",h.map(y=>y.id));g?(Q(g)&&(c=!0),l+=h.length):r+=h.length,t&&(t.textContent=`Reindexing… ${Math.min(p+d,n.length)}/${n.length}`)}if(c){u(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${r}/${n.length} done)`,"error");return}u(`Search index rebuilt for ${r} listing${r!==1?"s":""}${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){u("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(ee)||!ee.length){u("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:i,error:o}=await m.from("showroom_listings").select("property_id");if(o)return Q(o)?u("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load existing listings: "+o.message,"error");const n=new Set((i||[]).map(h=>h.property_id)),r=ee.filter(h=>h&&h.property_id&&!n.has(h.property_id));if(!r.length){u("Showroom already in sync — no new listings to add.");return}let l=0,c=0,d=!1;const p=20;for(let h=0;h<r.length;h+=p){const g=r.slice(h,h+p).map(b=>({property_id:b.property_id,listing_type:b.listing_type||"product",category:b.category||null,subcategory:b.subcategory||null,title:b.title||"Untitled Listing",description:b.description||"",price:parseFloat(b.price)||0,currency:b.currency||"USD",country:b.country||"",country_code:b.country_code||"",state:b.state||"",city:b.city||"",town:b.town||"",product_location:b.product_location||"",latitude:b.latitude??null,longitude:b.longitude??null,property_type:b.property_type||null,listing_status:b.listing_status||"sale",bedrooms:b.bedrooms??null,bathrooms:b.bathrooms??null,building_size:b.building_size||"",land_size:b.land_size||"",parking_spaces:b.parking_spaces??null,furnished:b.furnished||"",features:Array.isArray(b.features)?b.features:[],tags:Array.isArray(b.tags)?b.tags:[],highlights:Array.isArray(b.highlights)?b.highlights:[],seo_keywords:Array.isArray(b.seo_keywords)?b.seo_keywords:[],images:Array.isArray(b.images)?b.images:[],brand:b.brand||null,color:b.color||null,size:b.size||null,condition:b.condition||null,warranty:b.warranty||null,availability_status:b.availability_status||"In Stock",stock_quantity:b.stock_quantity!=null?parseInt(b.stock_quantity,10):null,is_active:b.is_active!==!1,is_featured:!!b.is_featured,is_ai_generated:!!b.is_ai_generated,ai_generated_fields:Array.isArray(b.ai_generated_fields)?b.ai_generated_fields:[],specifications:b.specifications||{},created_at:b.created_at||new Date().toISOString()})),{error:y}=await m.from("showroom_listings").insert(g);y?(Q(y)&&(d=!0),c+=g.length):l+=g.length,t&&(t.textContent=`Syncing… ${Math.min(h+p,r.length)}/${r.length}`)}if(d){u(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${l}/${r.length} added)`,"error");return}u(`Showroom synced: ${l} new listing${l!==1?"s":""} added to the database${c?` (${c} failed)`:""}.`,c?"error":"success")}catch(i){u("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){u("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();u(`✓ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?u("Repository not found. Check username and repo name.","error"):u("GitHub API error: "+a.status,"error")}catch{u("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const Oa=30,O={category:null,page:0,query:""};async function Ee(){const e=document.getElementById("content");if(!e)return;await Pt();const t=new Set(We()),a=Za();O.category||(O.category=a[0]?.slug||null);const i=0,o=O.query.trim().toLowerCase(),n=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <div>
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];const d=c.length?c.map(g=>{const y=t.has(g.property_id),b=g.images&&g.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${y?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${s(g.property_id)} · ${s(g.subcategory||g.category||"")} · ${da(g.price,"USD")}</p>
            </div>
            ${V(!y)}
            <button onclick="catalogToggle('${s(g.property_id)}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${y?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30 hover:bg-emerald-500/25":"bg-amber-500/10 text-amber-300 border-amber-500/30 hover:bg-amber-500/20"}">
              ${y?"Show":"Hide"}
            </button>
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',p=o?1:Math.max(1,Math.ceil(i/Oa)),h=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-500">Page ${O.page+1} / ${p}</span>
        <button onclick="catalogPage(1)" ${O.page>=p-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${n}
      ...
      ${h}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){O.category=e,O.page=0,O.query="",Ee()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");O.query=e?e.value:"",O.page=0,Ee()};window.catalogPage=function(e){const a=O.query.trim()?1:Math.max(1,Math.ceil(0/Oa));O.page=Math.max(0,Math.min(a-1,O.page+e)),Ee()};window.catalogToggle=async function(e){const t=!We().includes(e),a=await ta(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),Ee()};window.catalogResetHidden=async function(){await oi(),u("All hidden catalog listings restored"),Ee()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Kt(){window.lucide&&lucide.createIcons(),ca(),await wi(),m.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){A.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Kt):Kt();
