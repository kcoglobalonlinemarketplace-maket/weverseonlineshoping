...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const je="kco_admin_remember",_a="kco_login_attempts",ia=5,Rn=15*60*1e3;function z(e){const t=document.getElementById("login-error"),i=document.getElementById("login-error-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Mn(e){const t=document.getElementById("login-success"),i=document.getElementById("login-success-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ft(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function mt(e){return String(e||"").trim().toLowerCase()}function Bn(){try{const e=JSON.parse(localStorage.getItem(je)||"{}");e?.email&&!mt(e.email)&&localStorage.removeItem(je)}catch{localStorage.removeItem(je)}}function Nn(){try{const e=JSON.parse(localStorage.getItem(je)||"{}");return mt(e?.email)}catch{return""}}function ka(){Bn();const e=Nn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||ui,t.removeAttribute("readonly"));const i=document.getElementById("reset-email");i&&(i.value=e||i.value||"",i.removeAttribute("readonly"))}function Fn(){return`${window.location.origin}/admin.html`}function Fe(e){const t=document.getElementById("login-header-title"),i=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ft(),e==="login"&&(t&&(t.textContent="Admin Access"),i&&i.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),i&&i.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),i&&i.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function O(e,t,i=""){const a=document.getElementById(e);a&&(a.disabled=t,t?a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':i&&(a.innerHTML=i),window.lucide&&lucide.createIcons())}function yi(){try{return JSON.parse(localStorage.getItem(_a)||'{"count":0}')}catch{return{count:0}}}function hi(){const e=yi();return e.count=(e.count||0)+1,e.count>=ia&&(e.lockedUntil=Date.now()+Rn),localStorage.setItem(_a,JSON.stringify(e)),e}function fi(){localStorage.removeItem(_a)}function vi(){const e=yi();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(fi(),null):Math.ceil(t/6e4)}async function ue(e,t,i={}){try{await y.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Dn(),user_agent:navigator.userAgent.slice(0,200),...i})}catch{}}async function Dn(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function wi(e){if(!e)return!1;let t=!1,i=!1;try{const{data:a}=await y.rpc("is_current_user_admin");t=!0,i=!!a}catch{t=!1}return t?i:mt(e.email)===ui}async function Un(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){$t(),Vn();return}const{data:{session:t}}=await y.auth.getSession();if(t?.user&&await wi(t.user)){const{data:{currentUser:a}}=await y.auth.getUser(),n=await y.auth.mfa.getAuthenticatorAssuranceLevel(),r=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&r!=="aal2"){T.user=t.user,$t(),Fe("2fa"),Sa();return}T.user=t.user,Dt();return}jn()}function $t(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function jn(){$t(),Fe("login"),ka(),xi(),_i(),Sa(),On();const e=vi();e&&(z(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function On(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function xi(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",qn),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Fe("forgot")))}async function qn(e){e.preventDefault();const t=vi();if(t){z(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const i=document.getElementById("login-email"),a=mt(i?.value);if(!a){z("Enter your admin email address."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;O("login-btn",!0),Ft();const{data:s,error:o}=await y.auth.signInWithPassword({email:a,password:n});if(o||!s.user){const h=String(o?.message||"").toLowerCase();if(h.includes("missing supabase credentials")||h.includes("authentication service is unavailable")){z("Authentication is temporarily unavailable due to configuration. Please contact support."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("failed to fetch")||h.includes("network request failed")){z("Network error while signing in. Check your connection and try again."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("email not confirmed")){z("Your admin email is not confirmed yet. Open your verification email and confirm first."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const v=hi(),p=ia-v.count,g=v.lockedUntil?`Account locked for 15 minutes after ${ia} failed attempts.`:`Invalid email or password. ${p>0?p+" attempt"+(p!==1?"s":"")+" remaining.":""}`;z(g),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),s?.user&&await ue(s.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await wi(s.user)){await y.auth.signOut(),z(`Access denied for ${s.user.email}. This account is signed in but does not have administrator privileges.`),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ue(s.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(je,JSON.stringify({email:a,ts:Date.now()})):localStorage.removeItem(je),fi(),T.user=s.user,(await y.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Fe("2fa"),Sa(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ue(s.user.id,"login_success"),O("login-btn",!1),Dt()}function Sa(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Ua));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",a=>{a.target.value=a.target.value.replace(/\D/g,"").slice(0,6),a.target.value.length===6&&Ua()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await y.auth.signOut(),T.user=null,Fe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const i=document.getElementById("verify-backup-btn");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",Hn))}async function Ua(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){z("Enter the 6-digit code from your authenticator app.");return}O("verify-2fa-btn",!0),Ft();try{const{data:t}=await y.auth.mfa.listFactors(),i=(t?.totp||[])[0];if(!i){z("No 2FA factor found. Please re-login."),O("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:a,error:n}=await y.auth.mfa.challenge({factorId:i.id});if(n)throw n;const{error:r}=await y.auth.mfa.verify({factorId:i.id,challengeId:a.id,code:e});if(r)throw r;await ue(T.user.id,"login_2fa_success"),O("verify-2fa-btn",!1),Dt()}catch(t){hi(),z(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),O("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Hn(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){z("Enter a backup recovery code.");return}O("verify-backup-btn",!0);try{const{data:t}=await y.from("admin_2fa").select("backup_codes").eq("user_id",T.user.id).maybeSingle();if(!t?.backup_codes?.length){z("No backup codes found."),O("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){z("Backup code not found or already used."),O("verify-backup-btn",!1,"Use Backup Code");return}const a=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await y.from("admin_2fa").update({backup_codes:a}).eq("user_id",T.user.id),await ue(T.user.id,"login_backup_code_used"),Dt()}catch(t){z(t.message),O("verify-backup-btn",!1,"Use Backup Code")}}function _i(){document.getElementById("back-to-login")?.addEventListener("click",()=>Fe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Gn)}async function Gn(){const e=document.getElementById("reset-email"),t=mt(e?.value);if(!t){z("Enter your admin email address to receive a reset link.");return}O("send-reset-btn",!0),Ft();const{error:i}=await y.auth.resetPasswordForEmail(t,{redirectTo:Fn()});if(O("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),i){z(i.message);return}Mn("Reset link sent! Check your inbox and open it from this device to continue.")}function Vn(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${Y("Products",d,"package","amber",`${m} active`)}
          ${Y("Properties",u,"home","blue")}
          ${Y("Reviews",v,"star","blue",`${p} pending`)}
        </div>
...
<div class="space-y-4">
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await y.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),i=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!i)return b("Product not found","error");const a=Array.isArray(i.images)?i.images:[];N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
...
<input type="file" id="img-upload" class="hidden" multiple accept="image/*,video/mp4,video/webm,video/*,application/pdf" onclick="event.stopPropagation()" onchange="handleImageUpload(event)">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-4 glass-soft border border-blue-500/15 rounded-2xl">
              ...
              <p class="text-sm text-gray-500 mt-1">Allowed price range is ${B} to ${G} in the selected currency.</p>
            </div>
          </div>
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",i=e.querySelector('[name="title"]')?.value||"Untitled Product",a=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",r=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,s=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,o=e.dataset.category||"Product",l=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-4">
...
`}const br=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function ta(e,t){const i={...t||{}},a=new Set(Array.isArray(i.estimated)?i.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(i.missing_fields)?i.missing_fields.map(u=>String(u)):[]),r=[],s=[],o=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(h=>h!=null&&String(h).trim()!=="").join(", "));let m=String(u).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},l=u=>{const m=o(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),h=parseFloat(m);return Number.isFinite(h)?h:NaN};for(const u of e||[]){if(Li.has(u.key))continue;const m={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const p=Array.isArray(i[u.key])?i[u.key].map(o).filter(Boolean):[],g=u.options&&u.options.length?p.filter(f=>u.options.includes(f)):p;g.length?(i[u.key]=g,m.status="filled",m.value=g.join(", ")):(delete i[u.key],p.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",s.push(`${u.label}: invalid selection ignored`))),r.push(m);continue}if(!(i[u.key]!=null&&o(i[u.key])!=="")){m.status=n.has(u.key)?"missing":"empty-ok",r.push(m);continue}if(br.test(o(i[u.key]))){delete i[u.key],n.add(u.key),m.status="missing",m.note="document/AI said the value is unavailable",r.push(m);continue}if(u.type==="number"){const p=o(i[u.key]),g=l(i[u.key]);if(!Number.isFinite(g)){delete i[u.key],n.add(u.key),m.status="flagged",m.note=`"${p}" is not a valid number`,s.push(`${u.label}: not a valid number`),r.push(m);continue}if(/year/.test(u.key)&&(g<1800||g>new Date().getFullYear()+2)){delete i[u.key],n.add(u.key),m.status="flagged",m.note=`${g} is outside the plausible range`,s.push(`${u.label}: implausible value ${g}`),r.push(m);continue}i[u.key]=g,m.status="filled",m.value=String(g),a.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),r.push(m);continue}if(u.type==="select"&&u.options&&u.options.length){const p=Ri({options:u.options.map(g=>({value:g}))},o(i[u.key]));if(p==null){m.status="flagged",m.note=`"${o(i[u.key])}" does not match any option â€” left empty`,s.push(`${u.label}: no matching option`),delete i[u.key],n.add(u.key),r.push(m);continue}i[u.key]=p,m.status="filled",m.value=p,p!==o(t?.[u.key])&&(m.note="matched to the closest option"),r.push(m);continue}let v=o(i[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&v.length>120&&!["title"].includes(u.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",s.push(`${u.label}: suspiciously long value`)),i[u.key]=v,m.status="filled",m.value=v.length>48?v.slice(0,48)+"â€¦":v,a.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),r.push(m)}if(e&&e.length){const u=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(i).forEach(m=>{u.has(m)||delete i[m]})}i.missing_fields=r.filter(u=>u.status==="missing").map(u=>u.key),i.estimated=r.filter(u=>u.status==="estimated").map(u=>u.key);const d={total:r.length,filled:r.filter(u=>u.status==="filled").length,estimated:r.filter(u=>u.status==="estimated").length,flagged:r.filter(u=>u.status==="flagged").length,missing:r.filter(u=>u.status==="missing").length};return{specs:i,checklist:r,flags:s,summary:d}}const Pt={activeProvider:"gemini",maxImages:4,PROVIDERS:{gemini:{label:"Google Gemini (Free Tier)",scan:async(e,t)=>{const i=typeof t.onProgress=="function"?t.onProgress:()=>{};i(1,"Identifying the exact product from your imagesâ€¦");const a=await V.identifyProduct(e,t);if(!a||a.identified===!1)return{identification:a,specs:null,price:null};i(2,"Completing specifications and estimating a fair market priceâ€¦");const n=await V.completeSpecsAndPrice(e,a,t).catch(()=>null);return{identification:a,specs:n?n.specs:null,price:n?n.price:null}}}},async scan(e,t){const i=this.PROVIDERS[this.activeProvider];if(!i)throw new Error(`Scanner provider "${this.activeProvider}" is not configured.`);return i.scan(e||[],t)}};function Ri(e,t){const i=[...e.options||[]].map(s=>s.value).filter(Boolean);if(i.includes(String(t)))return String(t);const a={petrol:"Gasoline",gas:"Gasoline",gasoline:"Gasoline",unleaded:"Gasoline",ev:"Electric",electric:"Electric","fully electric":"Electric",hybrid:"Hybrid","hybrid electric":"Hybrid","plug-in hybrid":"Plug-in Hybrid",phev:"Plug-in Hybrid",auto:"Automatic",automatic:"Automatic","automatic transmission":"Automatic",manual:"Manual","manual transmission":"Manual",cvt:"CVT","continuously variable":"CVT","dual clutch":"Dual-Clutch",dct:"Dual-Clutch",fwd:"FWD","front-wheel drive":"FWD","front wheel drive":"FWD",rwd:"RWD","rear-wheel drive":"RWD","rear wheel drive":"RWD",awd:"AWD","all-wheel drive":"AWD","all wheel drive":"AWD","4wd":"4WD","four-wheel drive":"4WD","four wheel drive":"4WD","4x4":"4WD",sedan:"Sedan",saloon:"Sedan",suv:"SUV",hatchback:"Hatchback",coupe:"Coupe","coupÃ©":"Coupe",convertible:"Convertible",wagon:"Wagon",estate:"Wagon",pickup:"Pickup","pick up":"Pickup",van:"Van",truck:"Truck","sports car":"Sports Car",motorcycle:"Motorcycle",yacht:"Yacht","like new":"Used - Like New","used - like new":"Used - Like New"},n=String(t).toLowerCase().trim();return a[n]?a[n]:i.find(s=>s.toLowerCase().includes(n)||n.includes(s.toLowerCase()))||null}function yr(e,t,i,a){const n={},r=[],s=new Map((a||[]).map(v=>[v.key,v])),o=v=>s.has(v),l=v=>t[v]==null||String(Array.isArray(t[v])?t[v].join(", "):t[v]).trim()==="",d=(v,p)=>{if(p==null||String(p).trim()==="")return;const g=s.get(v);!g||!l(v)||g.type==="select"&&g.options&&g.options.length&&!g.options.includes(p)||(n[v]=p,r.push(v))},u=i||{},m=/cars?|trucks?|vehicle|motor|marine/i.test(String(e||""))||u.listing_type==="vehicle"||!!u.body_type,h=/estate|propert|real|house|villa|home|land/i.test(String(e||""))||u.listing_type==="property"||!!u.property_type;if(m){const v=String(t.body_type||u.body_type||""),p=v.toLowerCase(),g=[t.engine,t.trim,t.mileage,t.fuel_economy,t.title,u.model,u.brand,v,t.wheels_tires].filter(Boolean).join(" ").toLowerCase(),f=parseInt(String(t.model_year||u.year||""),10);let _="";/plug[ -]?in|phev/.test(g)?_="Plug-in Hybrid":/hybrid|hev|mhev/.test(g)?_="Hybrid":/electric|tesla|\bbev\b|single[- ]?speed/.test(g)?_="Electric":/lpg|gpl|autogas|cng/.test(g)?_="LPG":/bio[- ]?diesel/.test(g)?_="Bio-diesel":/diesel|tdi|\bhdi\b|\bcrdi\b|\bcdti\b|\bd4d\b|\bdci\b|turbo[- ]?d/.test(g)?_="Diesel":(/gasoline|petrol|\bgas\b|unleaded/.test(g),_="Gasoline"),d("fuel_type",_);let x="";/manual|\bstick\b/.test(g)?x="Manual":/cvt|continuously/.test(g)?x="CVT":/dual[- ]?clutch|\bdct\b/.test(g)?x="Dual-Clutch":/semi[- ]?automatic|\bamt\b/.test(g)?x="Semi-Automatic":/automatic|\bauto\b|shift[- ]?tronic|torque[- ]?converter|\d[ -]?speed/.test(g)?x="Automatic":x=Number.isFinite(f)&&f<2014?"Manual":"Automatic",d("transmission",x);let w="";/4wd|\b4x4\b|four[- ]?wheel|quad/.test(g)?w="4WD":/awd|all[- ]?wheel/.test(g)?w="AWD":/rwd|rear[- ]?wheel/.test(g)?w="RWD":/fwd|front[- ]?wheel/.test(g)?w="FWD":/pickup|truck/.test(p)?w="4WD":/suv/.test(p)?w="AWD":/motorcycle/.test(p)?w="RWD":w="FWD",d("drive_type",w);const k={sedan:5,hatchback:5,coupe:4,convertible:4,wagon:5,suv:5,"sports car":2,"luxury sedan":5,pickup:5,truck:3,van:8,bus:20,motorhome:6,motorcycle:2,yacht:6,"jet ski":2},S={sedan:4,hatchback:5,coupe:2,convertible:2,wagon:5,suv:5,"sports car":2,"luxury sedan":4,pickup:4,truck:4,van:5,bus:2,motorhome:3,motorcycle:0,"jet ski":0};for(const[F,j]of[["seating_capacity",k],["doors",S]]){if(!o(F))continue;const re=Object.entries(j).find(([Z])=>p.includes(Z));re&&d(F,String(re[1]))}const A=String(t.vehicle_type||u.vehicle_type||"").toLowerCase();!v&&o("body_type")&&(/motorhome|rv/.test(A)?d("body_type","Motorhome"):/jet/.test(A)?d("body_type","Jet Ski"):/marine|boat|yacht/.test(A)?d("body_type","Yacht"):/bus/.test(A)?d("body_type","Bus"):/motorcycle/.test(A)?d("body_type","Motorcycle"):/truck/.test(A)&&d("body_type","Truck"));const $=String(t.condition||"").toLowerCase();!t.mileage&&/new/.test($)&&o("mileage")&&d("mileage","0 mi"),!t.condition&&o("condition")&&d("condition","Used - Good"),!t.previous_owners&&o("previous_owners")&&d("previous_owners",/new/.test($)?"None (new)":"1"),!t.registration_status&&o("registration_status")&&d("registration_status","Registered"),!t.inspection_status&&o("inspection_status")&&d("inspection_status","Not Inspected"),!t.warranty&&o("warranty")&&d("warranty","Manufacturer warranty - confirm remaining coverage with the seller")}if(h){const v=String(t.property_type||u.property_type||"").toLowerCase(),p=String(t.building_size||t.floor_plan_total_area||""),g=parseFloat(p.replace(/[^0-9.]/g,""));let f=null,_=null;if(Number.isFinite(g)&&g>100&&(f=Math.max(2,Math.min(6,Math.round(g/600))),_=Math.max(1,Math.min(4,f>4?3:f-1))),l("bedrooms")&&o("bedrooms")&&f&&d("bedrooms",String(f)),l("bathrooms")&&o("bathrooms")&&_&&d("bathrooms",String(_)),l("listing_status")&&o("listing_status")){const x=String(t.title||"")+" "+String(t.description||"");d("listing_status",/for rent|lease|\brent\b/.test(x.toLowerCase())?"rent":"sale")}if(l("furnished")&&o("furnished")&&d("furnished",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Unfurnished":"Furnished"),l("condition")&&o("condition")&&d("condition","Good"),l("floors")&&o("floors")){const x=/mansion|villa|townhouse/.test(v)?"2":/apartment|condo|single/.test(v)?"1":null;x&&d("floors",x)}l("kitchens")&&o("kitchens")&&d("kitchens","1"),l("parking_spaces")&&o("parking_spaces")&&/car|garage|parking/.test(String(t.garage||"").toLowerCase())&&d("parking_spaces","1"),l("property_type")&&o("property_type")&&d("property_type",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Land":"Single-Family Home")}return{specs:n,estimated:r}}function Ha(e){const t=[];return e.year&&t.push(e.year),e.brand&&t.push(e.brand),e.model&&t.push(e.model),!e.model&&e.body_type&&t.push(e.body_type),t.join(" ")||e.detected_name||""}const Aa=new Set(["images","tags","currency","catalog_template_id","country_code","listing_type","category","property_id","id","slug","user_id","latitude","longitude","cover_image","video_url"]);function Pa(e,{titleFallback:t="Product",descriptionFallback:i="",visionUsed:a=!0}={}){const n=document.querySelector(e);if(!n||!a)return 0;let r=0;return n.querySelectorAll("input, textarea, select").forEach(s=>{const o=String(s.name||"").trim();if(!o||Aa.has(o))return;const l=String(s.type||"").toLowerCase();if(!["hidden","checkbox","radio","file","submit","button","image","password"].includes(l)&&!s.disabled&&String(s.value||"").trim()===""){if(o==="price"||o==="real_price"){const d=Number.isFinite(Number(B))?Number(B):1;s.value=String(d),r++;return}if(o==="stock_quantity"){s.value="1",r++;return}if(o==="title"){s.value=t,r++;return}if(o==="description"){s.value=i||`${t} â€” full details to be confirmed by the seller. Review and edit everything before publishing.`,r++;return}if(l==="number"||l==="range"||l==="tel"){s.value="0",r++;return}}}),r}function hr(e,t={}){const i=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,r=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,s=[],o=S=>Array.isArray(S)?S.join(", "):String(S??"").trim(),l=(S,A,$)=>{if(A==null||o([A])==="")return;const F=document.querySelector(`#product-form [name="${S}"]`);if(!F)return;let j=String(A);if($&&!$.includes(j)){const re=Ri(F,j);if(re===null)return;j=re}F.value=j,s.push(S)};l("brand",i.brand),l("model",i.model),l("color",i.color),l("condition",i.condition,lr),l("subcategory",i.subcategory),l("body_type",i.body_type||a.body_type,cr),l("model_year",a.model_year||i.year),l("title",a.title||Ha(i)),l("description",a.description),l("engine",a.engine),l("transmission",a.transmission,dr),l("fuel_type",a.fuel_type,ur),l("drive_type",a.drive_type,pr),l("horsepower",a.horsepower),l("mileage",a.mileage),l("seating_capacity",a.seating_capacity),l("doors",a.doors),l("safety_features",o(a.safety_features)),l("storage",a.storage),l("ram",a.ram),l("processor",a.processor),l("display",a.display),l("graphics",a.graphics),l("os",a.os),l("material",a.material),l("size",a.size),l("gender",a.gender),l("platform",a.platform),l("type",a.type||i.type),l("age_range",a.age_range),l("skin_type",a.skin_type),l("ingredients",a.ingredients),l("dimensions",a.dimensions),l("author",a.author),l("publisher",a.publisher),l("language",a.language),l("format",a.format),l("isbn",a.isbn),l("pages",a.pages),l("edition",a.edition),l("quantity",a.quantity),l("pet_type",a.pet_type),l("lens",a.lens),l("sensor",a.sensor),l("megapixels",a.megapixels),l("video",a.video),l("license",a.license),l("version",a.version),l("duration",a.duration),l("followers",a.followers),l("engagement",a.engagement),l("niche",a.niche),l("usage",a.usage),l("shelf_life",a.shelf_life),l("assembly",a.assembly),l("weatherproof",a.weatherproof),l("warranty",a.warranty||i.warranty),l("availability_status",a.availability_status),l("features_text",o(a.features)),l("highlights_text",o(i.highlights||a.highlights)),l("seo_keywords_text",o(a.seo_keywords));const d=new Set((Array.isArray(a.tags)?a.tags:[]).map(S=>String(S).trim()));document.querySelectorAll('#product-form input[name="tags"]').forEach(S=>{d.has(S.value)&&(S.checked=!0,s.push("tags"))});const u=Number(a.stock_quantity);Number.isFinite(u)&&u>0&&l("stock_quantity",u);const m=document.querySelector('#product-form [name="price"]'),h=document.querySelector('#product-form [name="real_price"]'),v=n?Number(n.estimated_price):NaN,p=n?Number(n.suggested_discount_price):NaN,g=Number.isFinite(Number(B))?Number(B):0,f=Number.isFinite(Number(G))?Number(G):999999999,_=S=>Math.max(g,Math.min(f,Math.round(S)));if(Number.isFinite(v)&&v>0){h&&(h.value=String(_(v)),s.push("real_price"));const S=Number.isFinite(p)&&p>0&&p<v?p:v;m&&(m.value=String(_(S)),s.push("price"))}const x=Ha(i)||i.detected_name||"Product",w=a.description||`${x} for sale on Weverse Online Shop. Review the details below and edit anything before publishing.`,k=Pa("#product-form",{titleFallback:x,descriptionFallback:w,visionUsed:r});return k&&s.push(`${k} auto-completed (safe defaults)`),da(),{filled:s}}function Qe(e){const t=String(e||"").trim().toLowerCase(),i=ke.find(s=>s.toLowerCase()===t);if(i)return{category:i,listing_type:null};if(/(house|villa|apartment|condo|mansion|land|estate|real estate|property|building|bungalow|townhouse|ranch|farmhouse)/.test(t))return{category:null,listing_type:"property"};const a={bag:"Fashion",bags:"Fashion",handbag:"Fashion",handbags:"Fashion",backpack:"Fashion",backpacks:"Fashion",purse:"Fashion",wallet:"Fashion",wallets:"Fashion",luggage:"Travel & Luggage",sneaker:"Fashion",sneakers:"Fashion",shoe:"Fashion",shoes:"Fashion",boot:"Fashion",boots:"Fashion",footwear:"Fashion",sandal:"Fashion",sandals:"Fashion",heel:"Fashion",heels:"Fashion",phone:"Phones",smartphone:"Phones",smartphones:"Phones",iphone:"Phones","mobile phone":"Phones",laptop:"Computers",laptops:"Computers",computer:"Computers",notebook:"Computers",macbook:"Computers",pc:"Computers",desktop:"Computers",electronics:"Electronics",electronic:"Electronics",gadget:"Electronics",gadgets:"Electronics",tv:"Electronics",television:"Electronics",headphones:"Electronics",speaker:"Electronics",speakers:"Electronics",soundbar:"Electronics",tablet:"Electronics",earbuds:"Electronics",camera:"Cameras & Photography",cameras:"Cameras & Photography",dslr:"Cameras & Photography",drone:"Cameras & Photography",jewelry:"Jewelry",jewellery:"Jewelry",ring:"Jewelry",necklace:"Jewelry",earring:"Jewelry",earrings:"Jewelry",bracelet:"Jewelry",watch:"Watches & Accessories",watches:"Watches & Accessories",wristwatch:"Watches & Accessories","smart watch":"Watches & Accessories",clothing:"Fashion",clothes:"Fashion",fashion:"Fashion",shirt:"Fashion",shirts:"Fashion",dress:"Fashion",dresses:"Fashion",jacket:"Fashion",jackets:"Fashion",hoodie:"Fashion",jeans:"Fashion","t-shirt":"Fashion",tshirt:"Fashion",apparel:"Fashion","men's fashion":"Men","mens fashion":"Men","women's fashion":"Women","womens fashion":"Women",car:"Cars",cars:"Cars",vehicle:"Cars",vehicles:"Cars",automobile:"Cars",suv:"Cars",sedan:"Cars","luxury car":"Cars","luxury cars":"Cars",truck:"Trucks",trucks:"Trucks",trailer:"Trucks",bus:"Trucks",motorcycle:"Motorcycles",motorbike:"Motorcycles","motor bike":"Motorcycles",bicycle:"Bicycles",bicycles:"Bicycles",cycling:"Bicycles",bike:"Bicycles",motorhome:"RV & Camper Accessories",motorhomes:"RV & Camper Accessories",camper:"RV & Camper Accessories",rv:"RV & Camper Accessories",boat:"Marine & Boating",boats:"Marine & Boating",yacht:"Marine & Boating",jet:"Marine & Boating",beauty:"Beauty",skincare:"Beauty",cosmetics:"Beauty",makeup:"Beauty",perfume:"Beauty",kitchen:"Kitchen",appliance:"Home Appliances",appliances:"Home Appliances",blender:"Kitchen",kettle:"Kitchen",cookware:"Kitchen",vacuum:"Home Appliances",furniture:"Furniture",sofa:"Furniture",chair:"Furniture",chairs:"Furniture",table:"Furniture",tables:"Furniture",bed:"Furniture",mattress:"Furniture",desk:"Furniture",toy:"Toys & Hobbies",toys:"Toys & Hobbies",game:"Gaming",games:"Gaming",gaming:"Gaming",console:"Gaming",food:"Food & Groceries",groceries:"Food & Groceries",snack:"Food & Groceries",snacks:"Food & Groceries",beverage:"Food & Groceries",baby:"Baby",kids:"Kids",stroller:"Baby",health:"Health & Medical",medical:"Health & Medical",supplement:"Health & Medical",fitness:"Sports",sport:"Sports",sports:"Sports",gym:"Sports",dumbbell:"Sports",book:"Books",books:"Books",textbook:"Books",novel:"Books",stationery:"Office",office:"Office",printer:"Office",pen:"Office",pet:"Pets",pets:"Pets",dog:"Pets",cat:"Pets",musical:"Musical Instruments",guitar:"Musical Instruments",piano:"Musical Instruments",instrument:"Musical Instruments",drum:"Musical Instruments",software:"Software & Digital Products",digital:"Software & Digital Products",account:"Software & Digital Products",accounts:"Software & Digital Products",instagram:"Software & Digital Products",tiktok:"Software & Digital Products",camping:"Camping & Hiking",tent:"Camping & Hiking",hiking:"Camping & Hiking",flower:"Flowers & Gifts",flowers:"Flowers & Gifts",gift:"Flowers & Gifts",gifts:"Flowers & Gifts",wedding:"Wedding Supplies",party:"Party & Event Supplies",coin:"Coins & Bullion",coins:"Coins & Bullion",art:"Arts & Crafts",painting:"Arts & Crafts",craft:"Arts & Crafts"},n=a[t]||a[t.replace(/s$/,"")]||a[t.replace(/\s+/g," ")];if(n)return{category:n,listing_type:null};for(const s of ke)if(t.includes(s.toLowerCase())||t.length>2&&s.toLowerCase().includes(t))return{category:s,listing_type:null};return{category:hn(t)||"Other",listing_type:null}}function fr(e){const t=String(e||"").toLowerCase().trim();if(!t)return null;const i=ma.find(n=>n.toLowerCase()===t);return i||ma.find(n=>n.toLowerCase().includes(t)||t.includes(n.toLowerCase()))||null}window._resolveScanConfirm=function(e,t){};let E=[],fe=[],te="",ne=-1;const ua="scanner-scan-status";let J=!1,Mi=0,we=0,Q=0,Ce=!1,Ga=0,vr=0,Bi=0,qe=0;function Gt(e,t){const a=(Array.isArray(e.image_indices)?e.image_indices:[]).map(n=>t[n]).filter(Boolean);return a.length?a:t}function Ca(e,t,i,a){const n=Qe(e.category),r=e.listing_type==="property"||n&&n.listing_type==="property",s=r?"Real Estate":n.category||e.category||"Other",o=e.confidence||"medium",l={high:"bg-emerald-500/10 text-emerald-400 border-emerald-500/20",medium:"bg-amber-500/10 text-amber-400 border-amber-500/20",low:"bg-red-500/10 text-red-400 border-red-500/20"}[o]||"bg-amber-500/10 text-amber-400 border-amber-500/20",d=Gt(e,fe).slice(0,3);return`
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){if(te==="scanner-scan-status"){scanStreamRender();return}const e=document.getElementById(te);if(!e)return;if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!E.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed — nothing was changed.";return}const t={};for(const i of E){const a=q(i.brand),n=q(i.model),r=q(i.detected_name),s=a&&n?`${a}::${n}`:r||`${a}::${n}`;s&&(t[s]=(t[s]||0)+1)}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
    ...
    <div class="space-y-3">
      ...
      <div class="flex flex-wrap gap-2 pt-1">
        ...
        <div class="space-y-3">
          ...
          ${E.map((t,i)=>Ca(t,i)).join("")}
        </div>`,window.lucide&&lucide.createIcons())}else{const e=document.getElementById(ua);e&&(e.classList.remove("hidden","text-blue-300","text-amber-300"),e.classList.add("text-gray-400"),e.textContent="All duplicates removed — nothing left to publish."),b("All duplicates removed.","info")}};let it=null;async function Fi(){if(it)return it;let e={};try{const{data:n}=await y.from("site_settings").select("site_name,brand_name,contact_email,contact_phone,whatsapp_number").limit(1).maybeSingle();e=n||{}}catch{}const t=String(e.site_name||e.brand_name||"").trim(),i=String(e.contact_phone||e.whatsapp_number||"").trim(),a=String(e.contact_email||"").trim();return!t&&!i&&!a?it={name:"Company",phone:"",email:""}:it={name:t,phone:i,email:a},it}async function Di(e,t={}){const i=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,r=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,s=[],o=R=>Array.isArray(R)?R.join(", "):String(R??"").trim(),l=(R,W)=>{if(W==null||o([W])==="")return;const ge=document.querySelector(`#property-form [name="${R}"]`);ge&&(ge.value=String(W),s.push(R))},d=i.property_type||a.property_type;if(d){const R=fr(d);R&&l("property_type",R)}r&&(l("title",a.title||i.detected_name),l("description",a.description)),l("subcategory",i.subcategory||a.subcategory);const u=i.bedrooms??a.bedrooms;u!=null&&u!==""&&l("bedrooms",parseInt(u,10)||u);const m=i.bathrooms??a.bathrooms;m!=null&&m!==""&&l("bathrooms",parseInt(m,10)||m),l("building_size",i.building_size||a.building_size),l("land_size",i.land_size||a.land_size);const h=i.parking_spaces??a.parking_spaces;h!=null&&h!==""&&l("parking_spaces",parseInt(h,10)||h);const v=String(i.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(v)?l("furnished","Furnished"):/unfurnished|no|empty/.test(v)&&l("furnished","Unfurnished");const p=String(i.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(p)?l("listing_status","rent"):/sale|buy|purchase/.test(p)&&l("listing_status","sale");const g=i.area||a.area;g&&!(i.town||a.town)&&l("town",g),l("town",i.town||a.town),l("city",i.city||a.city),l("state",i.state||a.state);const f=i.country||a.country;if(l("country",f),f){const R=(he||[]).find(W=>String(W.name||"").toLowerCase()===String(f).toLowerCase()||String(W.code||"").toLowerCase()===String(f).toLowerCase());if(R&&R.code){const W=document.querySelector('#property-form [name="country_code"]');W&&(W.value=R.code,s.push("country_code"))}}const _=i.address||a.address;l("product_location",_||[g||i.town||a.town,i.city||a.city,i.state||a.state,f].filter(Boolean).join(", ")),l("address",i.address||a.address),l("zip_code",i.zip_code||a.zip_code);const x=Number(i.latitude??a.latitude),w=Number(i.longitude??a.longitude);Number.isFinite(x)&&x>=-90&&x<=90&&x!==0&&l("latitude",String(x)),Number.isFinite(w)&&w>=-180&&w<=180&&w!==0&&l("longitude",String(w)),l("features_text",o(a.features)),l("highlights_text",o(i.highlights||a.highlights)),l("seo_keywords_text",o(a.seo_keywords));const k=i.half_bathrooms??a.half_bathrooms;k!=null&&k!==""&&l("half_bathrooms",parseInt(k,10)||k);const S=i.floors??a.floors;S!=null&&S!==""&&l("floors",parseInt(S,10)||S),l("garage",i.garage||a.garage);const A=i.year_built??a.year_built;A!=null&&A!==""&&l("year_built",parseInt(A,10)||A);const $=i.year_renovated??a.year_renovated;$!=null&&$!==""&&l("year_renovated",parseInt($,10)||$);const F=i.condition||a.condition,j=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(F){const R=String(F).toLowerCase(),W=j.find(ge=>R.includes(ge.toLowerCase())||ge.toLowerCase().includes(R));W&&l("condition",W)}l("interior_features_text",o(a.interior_features)),l("exterior_features_text",o(a.exterior_features)),l("home_systems_text",o(a.home_systems));const re=o(i.landmarks||a.landmarks);re&&l("landmarks_text",re);const Z=a.floor_plan;if(Z&&typeof Z=="object"){Z.image&&l("floor_plan_image",Z.image),Z.levels&&l("floor_plan_levels",Z.levels),Z.total_area&&l("floor_plan_total_area",Z.total_area);const R=Array.isArray(Z.rooms)?Z.rooms.map(W=>{const ge=String(W).match(/^(.*?):\s*(.*)$/);return ge?`${ge[1].trim()}: ${ge[2].trim()}`:String(W)}):[];R.length&&l("floor_plan_rooms",R.join(", "))}const D=a.nearby_area;D&&typeof D=="object"&&(Array.isArray(D.schools)&&D.schools.length&&l("nearby_schools_text",D.schools.join(", ")),Array.isArray(D.hospitals)&&D.hospitals.length&&l("nearby_hospitals_text",D.hospitals.join(", ")),Array.isArray(D.shopping)&&D.shopping.length&&l("nearby_shopping_text",D.shopping.join(", ")),Array.isArray(D.transportation)&&D.transportation.length&&l("nearby_transportation_text",D.transportation.join(", ")),Array.isArray(D.distances)&&D.distances.length&&l("nearby_distances_text",D.distances.join(", ")));const Ae=Array.isArray(a.legal_info)?a.legal_info.join(", "):o(a.legal_info);Ae&&l("legal_info_text",Ae),a.inspection_info&&l("inspection_info",a.inspection_info),a.risk_notes&&l("risk_notes",a.risk_notes),l("neighborhood",i.neighborhood||a.neighborhood||i.area),l("living_areas",o(a.living_areas));const Pe=i.kitchens??a.kitchens;Pe!=null&&Pe!==""&&l("kitchens",parseInt(Pe,10)||Pe);const C=i.balconies??a.balconies;C!=null&&C!==""&&l("balconies",parseInt(C,10)||C),l("garden",i.garden||a.garden),l("pool",i.pool||a.pool),l("security",o(a.security)),l("utilities",o(a.utilities)),l("construction_type",a.construction_type),l("construction_status",a.construction_status),l("ownership_type",a.ownership_type||i.ownership_type);const U=await Fi();U.name&&l("contact_name",U.name),U.phone&&l("contact_phone",U.phone),U.email&&l("contact_email",U.email);const ft=document.querySelector('#property-form [name="verification_status"]');r&&ft&&(ft.value="Not verified",s.push("verification_status"));const Xt=Number.isFinite(Number(B))?Number(B):0,rn=Number.isFinite(Number(G))?Number(G):999999999,Na=R=>Math.max(Xt,Math.min(rn,Math.round(R))),at=n?Number(n.estimated_price):NaN,vt=n?Number(n.suggested_discount_price):NaN;if(r&&Number.isFinite(at)&&at>0){const R=document.querySelector('#property-form [name="real_price"]');R&&(R.value=String(Na(at)),s.push("real_price"));const W=Number.isFinite(vt)&&vt>0&&vt<at?vt:at;l("price",String(Na(W)))}const Fa=String(a.title||i.detected_name||"Property").trim()||"Property",sn=a.description||`${Fa} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,Da=Pa("#property-form",{titleFallback:Fa,descriptionFallback:sn,visionUsed:r});return Da&&s.push(`${Da} auto-completed (safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),Tr().catch(()=>{}),{filled:s}}const Ui="Not provided - requires verification",Va={address:"Full street address - requires verification",zip_code:"Postal code - requires verification",neighborhood:"Neighborhood - requires verification",product_location:"Local area details - requires verification",garage:"Parking / garage details - requires verification",garden:"Outdoor space details - requires verification",pool:"Pool details - requires verification",security:"Security features - requires verification",utilities:"Utilities details - requires verification",living_areas:"Main living areas - requires verification",construction_type:"Construction material - requires verification",construction_status:"Construction status - requires verification",ownership_type:"Ownership type - requires verification",contact_name:"",contact_phone:"",contact_email:"",inspection_info:"Inspection details - requires verification",verification_date:"",documents_text:""},wr=new Set(["is_active","property_id","id","documents_text","verification_date","floor_plan_image","landmarks_text","legal_info_text","risk_notes","highlights_text","seo_keywords_text"]);function Wa(e){return Number.isFinite(e)?e<1?`${Math.max(0,Math.round(e*1e3))} m`:`${e.toFixed(1)} km`:"dist. TBD"}async function xr(e,t,i=4e3){const a=Number.isFinite(Number(i))&&Number(i)>0?Number(i):4e3,n=`
    [out:json][timeout:25];
    (
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function rt(e,t){const i=Gt(e,fe),a=Qe(e.category),n=e.listing_type==="property"||a&&a.listing_type==="property",r=n?"Real Estate":a.category||e.category||"Other",s=Mi,o=s-E.length;((d,u)=>{const m=document.getElementById("scanner-scan-status");m&&(m.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),m.classList.add(u),m.innerHTML=d)})(`Processing ${o+1} of ${s}: ${c(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){Q++,E.splice(t,1),E.length?rt(E[0],0):window.returnToScanReviewAfterSave(-1);return}let d=e.property_id?Be[e.property_id]:null;d&&d.specifications&&typeof d.specifications=="object"&&(d={...d,...d.specifications}),showAddProductStep2(r,d?{...d,images:i}:{images:i}),await new Promise(h=>setTimeout(h,250)),await ct(e,i,r);const m=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");m?(ne=t,m.click()):(Q++,closeProductFormModal(),E.splice(t,1),E.length?rt(E[0],0):window.returnToScanReviewAfterSave(-1))}catch{Q++,closeProductFormModal(),E.splice(t,1),E.length?rt(E[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(){Ia=!0;const e=await Gi();N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> Scan Missing Prices</h3>
    ...
    </div>`),window.lucide&&lucide.createIcons(),window.scanGeneralWithAI()};function jr(e,t){const i=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(a=>setTimeout(()=>a(i),t))]).then(a=>{if(a===i)throw new Error("A scan step took too long and timed out.");return a})}window.scanGeneralWithAI=async function(){if(Ce||J){b("A scan is already running - wait for it to finish before starting another.","info");return}let e=[];try{e=await jr(Gi(),15e3)}catch{e=[]}if(!e.length){b(Ia?"No products are missing a price right now — every product already has one.":"No products with photos are in the Product Manager yet — add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),i=document.getElementById("scanner-scan-status");t&&t.innerHTML;const a=(r,s)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),i.classList.add(s),i.innerHTML=r)};try{const r=await V.getConfig();String(r.gemini_key||r.gemini_api_key||"").trim()||a("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),a(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300"),J=!0,Mi=e.length,we=0,Q=0,Ce=!1,E=[],fe=[],Be={},te="scanner-scan-status";let n=0;for(const r of e){const s=(r.images||[]).filter(Boolean),o=[];for(const l of s)fe.push(l),o.push(n),n++;Be[r.property_id]=r,E.push({detected_name:r.title||r.property_id||"Product",category:r.category||"Other",listing_type:r.listing_type||"product",brand:r.brand||null,model:r.specifications&&r.specifications.model||r.model||null,confidence:"medium",property_id:r.property_id,image_indices:o})}rt(E[0],0)};window.scanStreamRender=function(){const e=document.getElementById("scanner-scan-status");if(!e)return;e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),e.classList.add("text-gray-100");const t=Ce,i=Ga,a=Math.min(vr,Ga),n=Bi,r=E.length,s={};for(const d of E){const u=q(d.brand),m=q(d.model),h=q(d.detected_name),v=u&&m?`${u}::${m}`:h||`${u}::${m}`;v&&(s[v]=(s[v]||0)+1)}let l=`<div class="space-y-3">${t?`<p class="text-xs font-bold text-white flex items-center gap-2"><i data-lucide="loader-2" class="w-4 h-4 animate-spin text-violet-400"></i> Scanning ${a} of ${i} — results appear below as each product is scanned.</p>`:`<p class="text-xs font-bold text-white flex items-center gap-2"><i data-lucide="list-checks" class="w-4 h-4 text-violet-400"></i> ${a} product${a===1?"":"s"} processed${n?`, ${n} published`:""}${qe?`, ${qe} error${qe>1?"s":""}`:""}.</p>`}`;r?(l+='<p class="text-[11px] text-gray-400">Each card below can be published with one click — press Publish Now and the scanner keeps working on the rest in the background.</p>',l+=E.map((d,u)=>{const m=q(d.brand),h=q(d.model),v=q(d.detected_name),p=m&&h?`${m}::${h}`:v||`${m}::${h}`;return Ca(d,u,p&&s[p]>1,!0)}).join("")):t?l+='<p class="text-[11px] text-gray-500">Waiting for the first product to finish scanning …</p>':l+='<p class="text-[11px] text-gray-500">Nothing to scan yet.</p>',l+="</div>",e.innerHTML=l,window.lucide&&lucide.createIcons()};window.scanStreamPublish=async function(e){const t=E[e];if(!t)return;ne=e;const i=Gt(t,fe),a=Qe(t.category),n=t.listing_type==="property"||a&&a.listing_type==="property",r=n?"Real Estate":a.category||t.category||"Other";try{if(n){qe++,E.splice(e,1),scanStreamRender();return}let s=t.property_id?Be[t.property_id]:null;s&&s.specifications&&typeof s.specifications=="object"&&(s={...s,...s.specifications}),showAddProductStep2(r,s?{...s,images:i}:{images:i}),await new Promise(d=>setTimeout(d,250)),await ct(t,i,r);const o=document.getElementById("product-form"),l=o?o.querySelector("[type=submit][name=action][value=publish]"):null;l?(ne=e,l.click()):(qe++,closeProductFormModal(),E.splice(e,1),scanStreamRender())}catch(s){qe++,closeProductFormModal(),E.splice(e,1),scanStreamRender(),b("Could not publish this product: "+String(s&&s.message||s),"error")}};function xt(e){te="scanner-scan-status",N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> Scan Missing Prices</h3>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,i=ci("property","Real Estate"),a=e.country_code||"US",n=e.currency||Ge(a);N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      ...
      </div>`,window._customersData=i,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(i=>{i.style.display=!t||i.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(a=>a.user_id===e);if(!t)return;const{data:i}=await y.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    <div class="flex items-start justify-between gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.showAddCouponModal=function(){N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
