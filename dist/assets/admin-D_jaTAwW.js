...
{"title":"real product name, include the brand and model if you can read them","brand":"brand name read from the product or empty string","model":"model name read from the product or empty string","category":"best category from: Electronics, Phones, Computers & Laptops, Fashion, Shoes, Bags & Accessories, Watches, Cameras & Photography, Home & Kitchen, Toys & Games, Sports & Fitness, Cars, Luxury Cars, Other","description":"short honest 1-2 sentence description of what you actually see"}`;async function oi(e,t){try{const a=await ii();if(!a)return null;const i=[{type:"text",text:si},...(t||[]).slice(0,1).map(l=>({type:"image",image:l}))],s=await a([{role:"user",content:i}],{max_new_tokens:400,do_sample:!1,temperature:.2}),o=String(s?.[0]?.generated_text||"").trim();if(!o)return null;const n={_aiProvider:"Free local AI (browser)",_aiModel:"SmolVLM-256M-Instruct",_aiLowConfidence:!0},r=ai(o);return r?{...r,...n}:{description:o,...n}}catch{return null}}const jt="weverseonlineshop@gmail.com",Ft="kco_ai_ad_override_fallback_v1",Ot="Weverse Online Shop",Ut="GLOBAL SHOPPING • WORLDWIDE DELIVERY",ri="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),ni=`${ri}/functions/v1/ai-admin-assistant`,li=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"general-ai",label:"General AI",icon:"sparkles"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],di={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},qt=[...Fa].sort();let k={user:null,section:"dashboard"};function d(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Nt(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function N(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function W(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function tt(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const ci=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function Y(e){const t={};if(!e||typeof e!="object")return t;for(const a of ci)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},n={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",o[t]||"info"),s.className=`w-4 h-4 shrink-0 ${n[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function R(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",d(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function z(){document.getElementById("modal-container").innerHTML=""}function B(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function M(e,t,a,i,s=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function pe(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function oe(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${d(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${d(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function Ht(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=li.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=di[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ht(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=pe()),window.lucide&&lucide.createIcons(),({dashboard:Pi,products:P,properties:Ie,catalog:de,orders:na,customers:Xi,reviews:ct,messages:la,coupons:Pe,ads:ne,notifications:es,ai:ui,n8n:gi,"ai-settings":pa,"ai-marketing":Be,"homepage-branding":Me,content:Es,seo:Ts,email:Bs,analytics:Cs,security:Le,activity:Ls,brand:Re,"payment-settings":Ze,backup:Ms,settings:Rs,publish:De,"general-ai":pi}[e]||(()=>{const n=document.getElementById("content");n&&(n.innerHTML=oe("construction","Coming Soon",`${t} is being built.`))}))()};async function ui(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
      ...
      </div>`,window.aiChatHistory=[],Gt(),mi(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-purple-400 text-sm">Error: ${d(t.message)}</div>`)}}function Gt(){const e=document.getElementById("ai-chat-history");if(e){if(!window.aiChatHistory||window.aiChatHistory.length===0){e.innerHTML='<p class="text-gray-500 text-sm text-center py-8">Start by uploading an image or typing a command</p>';return}e.innerHTML=window.aiChatHistory.map((t,a)=>`
  ...
  `).join(""),window.lucide&&lucide.createIcons()}}function mi(){const e=document.getElementById("ai-total-products"),t=document.getElementById("ai-active-products"),a=document.getElementById("ai-issue-count");e&&(e.textContent="..."),t&&(t.textContent="..."),a&&(a.textContent="...")}async function gi(){const e=document.getElementById("content");e&&(e.innerHTML=`
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const ae="kco_admin_remember",at="kco_login_attempts",Ue=5,bi=15*60*1e3;function T(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function hi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function $e(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function me(e){return String(e||"").trim().toLowerCase()}function fi(){try{const e=JSON.parse(localStorage.getItem(ae)||"{}");e?.email&&!me(e.email)&&localStorage.removeItem(ae)}catch{localStorage.removeItem(ae)}}function yi(){try{const e=JSON.parse(localStorage.getItem(ae)||"{}");return me(e?.email)}catch{return""}}function it(){fi();const e=yi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||jt,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function vi(){return`${window.location.origin}/admin.html`}function X(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),$e(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function C(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function zt(){try{return JSON.parse(localStorage.getItem(at)||'{"count":0}')}catch{return{count:0}}}function Wt(){const e=zt();return e.count=(e.count||0)+1,e.count>=Ue&&(e.lockedUntil=Date.now()+bi),localStorage.setItem(at,JSON.stringify(e)),e}function Vt(){localStorage.removeItem(at)}function Kt(){const e=zt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Vt(),null):Math.ceil(t/6e4)}async function q(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await wi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function wi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Jt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:me(e.email)===jt}async function xi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){fe(),Ii();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await Jt(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),s=await p.auth.mfa.getAuthenticatorAssuranceLevel(),o=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&o!=="aal2"){k.user=t.user,fe(),X("2fa"),st();return}k.user=t.user,Se();return}_i()}function fe(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function _i(){fe(),X("login"),it(),Yt(),Qt(),st(),ki();const e=Kt();e&&(T(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function ki(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Yt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",$i),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>X("forgot")))}async function $i(e){e.preventDefault();const t=Kt();if(t){T(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=me(a?.value);if(!i){T("Enter your admin email address."),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;C("login-btn",!0),$e();const{data:n,error:r}=await p.auth.signInWithPassword({email:i,password:s});if(r||!n.user){const g=String(r?.message||"").toLowerCase();if(g.includes("missing supabase credentials")||g.includes("authentication service is unavailable")){T("Authentication is temporarily unavailable due to configuration. Please contact support."),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("failed to fetch")||g.includes("network request failed")){T("Network error while signing in. Check your connection and try again."),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(g.includes("email not confirmed")){T("Your admin email is not confirmed yet. Open your verification email and confirm first."),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const f=Wt(),h=Ue-f.count,v=f.lockedUntil?`Account locked for 15 minutes after ${Ue} failed attempts.`:`Invalid email or password. ${h>0?h+" attempt"+(h!==1?"s":"")+" remaining.":""}`;T(v),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),n?.user&&await q(n.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Jt(n.user)){await p.auth.signOut(),T(`Access denied for ${n.user.email}. This account is signed in but does not have administrator privileges.`),C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await q(n.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(ae,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(ae),Vt(),k.user=n.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){C("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),X("2fa"),st(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await q(n.user.id,"login_success"),C("login-btn",!1),Se()}function st(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",$t));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&$t()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,X("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",Si))}async function $t(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){T("Enter the 6-digit code from your authenticator app.");return}C("verify-2fa-btn",!0),$e();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){T("No 2FA factor found. Please re-login."),C("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await p.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:o}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await q(k.user.id,"login_2fa_success"),C("verify-2fa-btn",!1),Se()}catch(t){Wt(),T(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),C("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Si(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){T("Enter a backup recovery code.");return}C("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){T("No backup codes found."),C("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){T("Backup code not found or already used."),C("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",k.user.id),await q(k.user.id,"login_backup_code_used"),Se()}catch(t){T(t.message),C("verify-backup-btn",!1,"Use Backup Code")}}function Qt(){document.getElementById("back-to-login")?.addEventListener("click",()=>X("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Ai)}async function Ai(){const e=document.getElementById("reset-email"),t=me(e?.value);if(!t){T("Enter your admin email address to receive a reset link.");return}C("send-reset-btn",!0),$e();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:vi()});if(C("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){T(a.message);return}hi("Reset link sent! Check your inbox and open it from this device to continue.")}function Ii(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function Se(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&k.user&&(t.textContent=k.user.email||"Admin"),it(),navigate("dashboard")}window.adminSignOut=async function(){k.user&&await q(k.user.id,"logout"),await p.auth.signOut(),k.user=null,fe(),X("login"),it(),Yt(),Qt()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(k.user&&await q(k.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),k.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Pi(){const e=document.getElementById("content");try{const[t,a,i,s]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),o=t.data||[],n=a.data||[],r=n.filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,G)=>x+(parseFloat(G.amount)||0),0),l=n.filter(x=>["pending","pending_verification","processing"].includes(x.status)).length,c=o.filter(x=>x.listing_type!=="property").length,m=o.filter(x=>x.listing_type==="property").length,b=o.filter(x=>x.listing_type!=="property"&&x.is_active).length,g=i.count||0,f=s.count||0,h=(s.data||[]).filter(x=>!x.is_approved).length,v=new Date,H=n.filter(x=>{const G=new Date(x.created_at);return G.getMonth()===v.getMonth()&&G.getFullYear()===v.getFullYear()}).filter(x=>["approved","payment_approved","delivered"].includes(x.status)).reduce((x,G)=>x+(parseFloat(G.amount)||0),0),V=n.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${M("Total Revenue",`$${r.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${H.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${M("Total Orders",n.length,"shopping-bag","blue",`${l} pending`)}
          ${M("Customers",g,"users","violet")}
          ${M("Products",c,"package","amber",`${b} active`)}
          ${M("Properties",m,"home","blue")}
          ${M("Reviews",f,"star","blue",`${h} pending`)}
        </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),ea(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${d(t.message)}</div>`)}}async function P(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,s=[];for(const l of a?[]:t||[])l&&l.property_id&&!i.has(l.property_id)&&(i.add(l.property_id),s.push(l));for(const l of Ct().filter(c=>c.listing_type!=="property"))l&&l.property_id&&!i.has(l.property_id)&&(i.add(l.property_id),s.push(l));if(Array.isArray(U))for(const l of U.filter(c=>c.listing_type!=="property"&&c.property_id))i.has(l.property_id)||(i.add(l.property_id),s.push(l));const o=[...Ga,...za,...Wa,...Va];for(const l of o)l&&l.property_id&&l.listing_type!=="property"&&!i.has(l.property_id)&&(i.add(l.property_id),s.push(l));s.sort((l,c)=>new Date(c.created_at||0)-new Date(l.created_at||0));const n=[...new Set(s.map(l=>l.category).filter(Boolean))].sort((l,c)=>l.localeCompare(c)),r=[...new Set(s.flatMap(l=>Array.isArray(l.tags)?l.tags:[]).filter(Boolean))].sort((l,c)=>l.localeCompare(c));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(n.length?n:ta).map(l=>`<option value="${d(l)}" ${(window._productFilters.category||"")===l?"selected":""}>${d(l)}</option>`).join("")}
            </select>
            <select id="prod-tag-filter" class="input-field" onchange="filterProducts()">
              <option value="">All Tags</option>
              ${r.map(l=>`<option value="${d(l)}" ${(window._productFilters.tag||"")===l?"selected":""}>${d(l)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
          ...
          <div id="products-empty" class="hidden">${oe("package-search","No matching products","Try different filters or add a new product.",'<button onclick="showAddProductStep1()" class="btn-press bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2 rounded-xl">Add Product</button>')}</div>
      ...
      </div>`,window._productsData=s,window._productsCardLimit=60,Xt(s),filterProducts(),updateBulkBar(),ya(),ka(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${d(t.message)}</div>`)}}function Q(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function qe(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ei(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function ot(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Ne(e){return parseInt(e.views??e.view_count??0,10)||0}function He(e){return parseInt(e.sales??e.sales_count??0,10)||0}function rt(e){return e.sku||e.property_id||"N/A"}function Ci(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=qe(e),i=ot(e),s=window._productSelection?.has(e.property_id),o=R(i==="archived"?"inactive":i==="active"?"active":"inactive"),n=N(e.created_at),r=!!e.is_featured,l=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${d(e.category||"")}" data-status="${i}" data-featured="${r?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Price</span><p class="text-emerald-300 font-black text-base">$${Q(e.price).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${d(Ei(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${Ne(e).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${He(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(b=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${d(b)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Ti(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,o)=>i(s.created_at)-i(o.created_at)):t==="price-high"?a.sort((s,o)=>Q(o.price)-Q(s.price)):t==="price-low"?a.sort((s,o)=>Q(s.price)-Q(o.price)):t==="sales-high"?a.sort((s,o)=>He(o)-He(s)):t==="views-high"?a.sort((s,o)=>Ne(o)-Ne(s)):a.sort((s,o)=>i(o.created_at)-i(s.created_at)),a}function Xt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const s=window._productsCardLimit||60,o=e.slice(0,s);t.innerHTML=o.map(Ci).join(""),i&&(i.textContent=String(e.length));const n=document.getElementById("products-more");if(n){const r=e.length-o.length;r>0?n.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,r)} more (${r} left)</button>`:n.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Zt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=ot(i),n=window._productSelection?.has(i.property_id),r=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,l=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
          ...
          <td><span class="text-xs font-bold text-emerald-400">$${Q(i.price).toLocaleString()}</span></td>
        ...
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),i=document.getElementById("view-card-btn"),s=document.getElementById("view-table-btn"),o=document.getElementById("products-empty"),n=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&Zt(n)),i&&i.classList.toggle("active",e!=="table"),s&&s.classList.toggle("active",e==="table"),o&&o.classList.toggle("hidden",n.length>0)};window.filterProducts=function(e){const t=window._productFilters||{};t.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),t.category=document.getElementById("prod-cat-filter")?.value||"",t.tag=document.getElementById("prod-tag-filter")?.value||"",t.status=document.getElementById("prod-status-filter")?.value||"",t.featured=document.getElementById("prod-featured-filter")?.value||"",t.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=t;const a=(window._productsData||[]).filter(s=>{const o=[s.title,s.brand,s.category,rt(s),qe(s).join(" "),s.description].join(" ").toLowerCase();return!(t.search&&!o.includes(t.search)||t.category&&(s.category||"")!==t.category||t.tag&&!qe(s).includes(t.tag)||t.status&&ot(s)!==t.status||t.featured&&t.featured==="featured"!=!!s.is_featured)}),i=Ti(a,t.sort);e||(window._productsCardLimit=60),Xt(i),window._productView==="table"&&Zt(i)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const i=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(i):window._productSelection.delete(i)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function Ae(){return window._productSelection?[...window._productSelection]:[]}function D(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function Ge(e,t,a){return e&&D(e)?(u(`⚠️ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),u(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=Ae();if(!t.length)return;const a=await Promise.all(t.map(o=>{const n=Y((window._productsData||[]).find(r=>r.property_id===o));return p.from("showroom_listings").upsert({...n,property_id:o,is_active:e},{onConflict:"property_id"})}));if(a.some(o=>o.error&&D(o.error))){u(`⚠️ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,P();return}const s=a.filter(o=>o.error).length;u(`${t.length-s}/${t.length} products ${e?"published":"unpublished"}${s?` (${s} failed: ${a.find(o=>o.error)?.error?.message||"error"})`:""}`,s?"error":"success"),window._productSelection=new Set,P()};window.bulkDuplicateProducts=async function(){const e=Ae();if(e.length){for(const t of e)await duplicateProduct(t,!0);u(`${e.length} products duplicated`),window._productSelection=new Set,P()}};window.bulkArchive=async function(){const e=Ae();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(s=>p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",s)));if(t.some(s=>s.error&&D(s.error))){u("⚠️ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,P();return}const i=t.filter(s=>s.error).length;u(`${e.length-i}/${e.length} products archived${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,P()};window.bulkDeleteProducts=async function(){const e=Ae();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(s=>p.from("showroom_listings").delete().eq("property_id",s)));if(t.some(s=>s.error&&D(s.error))){u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,P();return}const i=t.filter(s=>s.error).length;u(`${e.length-i}/${e.length} products deleted${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,P()};window.previewProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return u("Product not found","error");B(`
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${Q(a.price).toLocaleString()}</p></div>
        ...
        <form onsubmit="saveQuickEditProduct(event,'${a.property_id}')" class="space-y-4">
          ...
          <div>
            ...
            <div id="image-preview" class="flex flex-wrap gap-2.5 mt-3">
              ${i.map((s,o)=>re(s,o)).join("")}
            </div>
            <div id="image-url-inputs">${i.map((s,o)=>`<input type="hidden" name="images" id="img-url-${o}" value="${d(s)}">`).join("")}</div>
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return D(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),P()};window.openProductMoreActions=function(e){B(`
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${d(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${d(e)}')">${ia(s)}</select></div>
            </div>
          ...
          <div class="space-y-3">
            ...
            <div id="image-url-inputs">
              ${(t.images||[]).map((o,n)=>`<input type="hidden" name="images" id="img-url-${n}" value="${d(o)}">`).join("")}
            </div>
          </div>
    ...
    </div>`),lt(),dt(),sa("pf-price"),We(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>We(e,"pricing")),Ki(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),z(),P()};const Ri=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Di=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],ji=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Fi=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Oi=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function Ui(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Ri:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Di:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?ji:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Fi:Oi}function O(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function we(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&O(t)}function qi(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>String(a.value||"").trim()!=="")&&(O("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",i=[...t.querySelectorAll('input[name="images"]')].map(s=>String(s.value||"").trim()).filter(Boolean);if(!i.length){e||O("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",we(!0,"AI is analyzing your images…");try{const s=await S.analyzeImages(i,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!s){O("I could not scan the image — no vision engine worked this time. My built-in free AI (runs in your browser, no API key, downloads once) normally handles this; if it failed here, try again or check the browser console. Adding a free Google Gemini key at aistudio.google.com/apikey in Admin → AI Settings gives the most accurate scans.","warn"),e||u("Could not scan the image this time. Try again — the free in-browser AI may need a moment to load. For best accuracy add a free Google Gemini key in AI Settings.","error");return}const o=Ni(s,a,!0),n=s._aiProvider?` (${s._aiProvider})`:"",r=s._aiLowConfidence?" My free in-browser AI is basic, so please double-check the brand/model before publishing.":"";O(`AI scanned your image${i.length>1?"s":""} and filled the form${n}. Review the fields, then press Publish.${r}`,"ok"),e||u(o?`AI analyzed your image${i.length>1?"s":""} and filled ${o} field(s).${r}`:"AI analyzed your images — no new fields to fill.","success")}catch(s){O("AI analysis failed: "+(s.message||s)+" — a vision-capable AI is needed (Gemini, Groq, OpenRouter, Hugging Face in AI Settings, or the free in-browser AI / local Ollama).","error"),e||u("AI analysis failed: "+(s.message||s),"error")}finally{t.dataset.aiBusy="0",we(!1)}};function Ni(e,t,a=!1){const i=document.getElementById("product-form");if(!i||!e)return 0;let s=0;const o=(b,g)=>{if(g==null||String(g).trim()==="")return;const f=i.querySelector(`[name="${b}"]`);f&&(a||!String(f.value||"").trim())&&(String(f.value||"").trim()!==String(g).trim()&&(s+=1),f.value=g)},n=(b,g)=>{if(!Array.isArray(g)||!g.length)return;const f=i.querySelector(`[name="${b}"]`);f&&(a||!String(f.value||"").trim())&&(String(f.value||"").trim()!==g.join(", ")&&(s+=1),f.value=g.join(", "))};o("title",e.title),o("description",e.description),o("subcategory",e.subcategory),o("brand",e.brand),o("model",e.model),o("color",e.color),o("size",e.size),o("material",e.material),o("storage",e.storage),o("ram",e.ram),o("processor",e.processor),o("display",e.display),o("graphics",e.graphics),o("os",e.os),o("type",e.type),o("gender",e.gender),o("movement",e.movement),o("case_material",e.case_material),o("water_resistance",e.water_resistance),o("voltage",e.voltage),o("gemstone",e.gemstone),o("platform",e.platform),(a||!String(i.querySelector('[name="condition"]')?.value||"").trim())&&o("condition",e.condition),n("features_text",e.features),n("highlights_text",e.highlights),n("seo_keywords_text",e.seo_keywords);const r=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type"].forEach(b=>{r[b]!=null&&String(r[b]).trim()!==""&&o(b,r[b])});const l=e.model_year||e.year||r.model_year||r.year||(e.specifications?e.specifications.year:null);l!=null&&String(l).trim()!==""&&o("model_year",l),Array.isArray(r.safety_features)&&n("safety_features",r.safety_features);const c=e.category?String(e.category).trim():"",m=document.getElementById("pf-ai-detected");return m&&c&&c.toLowerCase()!==String(t||"").toLowerCase()&&(m.classList.remove("hidden"),m.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
      <span class="text-[11px] text-amber-200">AI detected category: <b>${d(c)}</b></span>
      <button type="button" onclick="switchProductFormCategory('${d(c).replace(/'/g,"\\'")}')" class="btn-press px-2 py-1 rounded-lg text-[10px] font-bold bg-amber-500 text-[#111827] hover:bg-amber-400 transition">Switch category</button>
    ...
    </div>`),window.lucide&&lucide.createIcons(),Je(),s}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[s,o]of i.entries())s==="images"?(a.images=a.images||[],o&&!String(o).startsWith("blob:")&&a.images.push(String(o))):s==="tags"?(a.tags=a.tags||[],a.tags.push(o)):a[s]=o;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),i=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),o=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!o||o==="/fallback.svg"){O("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const n=Ui(t),r=Math.min(i,n.length);e.dataset.aiBusy="1";const l=document.getElementById("pf-ai-generated");l&&(l.innerHTML="");let c=0;try{for(let m=0;m<r;m++){we(!0,`Generating ${m+1}/${r} — ${n[m]}…`);try{const b=await S.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${n[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,o,1);if(b&&b[0]){const g=await Gi(b[0]);g&&(Hi(g),c+=1)}}catch(b){O(`Stopped at ${m}/${r}: ${b.message||b}`,"error");break}}c?(O(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):O("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",we(!1)}};function Hi(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,i=document.createElement("div");i.innerHTML=re(e,a),t.appendChild(i.firstElementChild),Z(),be(),ee();const s=document.getElementById("pf-ai-generated");if(s){const o=document.createElement("div");o.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",o.innerHTML=`<img src="${d(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,s.appendChild(o)}}async function Gi(e){try{const a=await(await fetch(e)).blob(),i=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),s=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`;return await ge(new File([a],s,{type:a.type}))}catch{return e}}function re(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function lt(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),zi(t.dataTransfer.files)}))}function dt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>Z()})}window.handleImageUpload=async function(e){await ra(e.target.files)};async function zi(e){await ra(e)}async function ra(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await ge(a);if(i){const s=t.children.length,o=document.createElement("div");o.innerHTML=re(i,s),t.appendChild(o.firstElementChild),Z()}}be(),ee(),window.lucide&&lucide.createIcons(),qi()}}async function ge(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(s)return URL.createObjectURL(e);const{data:o}=p.storage.from("product-images").getPublicUrl(i);return o.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),Z(),be(),ee()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const s=await ge(i);if(!s)return;const n=[...a.querySelectorAll(".img-thumb")][e];if(!n)return;const r=n.querySelector("img");r&&(r.src=s),Z(),be(),ee(),u("Image replaced. Save changes to apply.","info")};function Z(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const s=a.querySelector("img");if(!s)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=s.src,t.appendChild(o),a.dataset.index=i;const n=a.querySelector(".rm");n&&n.setAttribute("onclick",`removeImage(${i})`);const r=a.querySelector(".rp");r&&r.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const l=a.querySelector(".rp-input");l&&(l.id=`rp-input-${i}`,l.onchange=()=>replaceImage(i,l))}))}function be(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function ee(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,i=a>=24;t.textContent=i?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(i?"text-emerald-300":"text-gray-400");const s=document.querySelector('#product-form [name="is_active"]');i&&s&&!s.checked&&(s.checked=!0)}function Ke(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Wi(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,s]of t.entries())i==="images"?s&&!String(s).startsWith("blob:")&&a.images.push(String(s)):i==="tags"?a.tags.push(String(s)):a.fields[i]=String(s);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Vi(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([s,o])=>{const n=e.querySelector(`[name="${s}"]`);n&&(n.type==="checkbox"?n.checked=o==="on"||o===!0:n.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(s=>{s.checked=i.includes(s.value)}),Array.isArray(t.images)){const s=document.getElementById("image-preview");s&&(s.innerHTML=t.images.map((o,n)=>re(o,n)).join(""),Z(),be(),ee())}return!0}function Je(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=t.querySelector('[name="stock_quantity"]')?.value,n=o===""||o==null?"Unlimited":o,r=k.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",l=[...t.querySelectorAll('input[name="tags"]:checked')].map(b=>b.value),c=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,n=e.dataset.category||"Product",r=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",l=e.querySelector('[name="is_active"]')?.checked;B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};function Ki(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Ke(e,t),s=document.getElementById("product-autosave-note");if(!t)try{const l=localStorage.getItem(i);if(l){const c=JSON.parse(l);Vi(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(Wi(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}Je()};let n;const r=()=>{clearTimeout(n),n=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(l=>{l.addEventListener("input",r),l.addEventListener("change",r)}),Je(),ee()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const n=new FormData(i),r={};for(const[g,f]of n.entries())g==="images"?(r.images=r.images||[],f&&!String(f).startsWith("blob:")&&r.images.push(String(f))):g==="tags"?(r.tags=r.tags||[],r.tags.push(f)):r[g]=f;r.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",r.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const l=n.get("action")==="draft",c=g=>ze(g),m=g=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],h={};for(const v of f){const $=g[v];h[v]=$!=null&&String($).trim()!==""?$:null}if(g.safety_features){const v=c(g.safety_features);h.safety_features=v.length?v:null}return h};let b;if(a){let g=Y((window._productsData||[]).find(L=>L.property_id===a));if(!g){const{data:L}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();g=L?Y(L):null}if(!g)throw new Error("Could not load the current product. Refresh the page and try again.");const f=(L,je)=>{const La=L===""||L==null?"":L,Ma=je===""||je==null?"":je;return String(La).trim()===String(Ma).trim()},h={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(L=>{f(r[L],g[L])||(h[L]=r[L]==null||r[L]===""?null:r[L])});const v=r.price===""||r.price==null?null:parseFloat(r.price);f(v,g.price)||(h.price=v==null?g.price:Math.max(j,Math.min(J,v)));const $=r.stock_quantity===""||r.stock_quantity==null?null:parseInt(r.stock_quantity,10);f($,g.stock_quantity)||(h.stock_quantity=Number.isFinite($)?$:null);const H=c(r.features_text);f(H.join("||"),(Array.isArray(g.features)?g.features:[]).join("||"))||(h.features=H);const V=r.tags||[];f(V.join("||"),(Array.isArray(g.tags)?g.tags:[]).join("||"))||(h.tags=V);const x=c(r.highlights_text);f(x.join("||"),(Array.isArray(g.highlights)?g.highlights:[]).join("||"))||(h.highlights=x);const G=c(r.seo_keywords_text);f(G.join("||"),(Array.isArray(g.seo_keywords)?g.seo_keywords:[]).join("||"))||(h.seo_keywords=G);const yt=r.images||[];f(yt.join("||"),(Array.isArray(g.images)?g.images:[]).join("||"))||(h.images=yt);const vt=r.is_featured==="on";!!g.is_featured!==vt&&(h.is_featured=vt);const wt=l?!1:r.is_active==="on"||(r.images||[]).length>=24;!!g.is_active!==wt&&(h.is_active=wt);const Ba=m(r),xt={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},...Ba};if(JSON.stringify(xt)!==JSON.stringify(g.specifications||{})&&(h.specifications=xt),Object.keys(h).length===0){u("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Ke(t,a))}catch{}s&&(s.disabled=!1,s.textContent=o);return}const _t={...g,...h,property_id:a,updated_at:new Date().toISOString()};if({error:b}=await p.from("showroom_listings").upsert(_t,{onConflict:"property_id"}),b&&Ge(b,()=>Oe(_t),"Product update")){s&&(s.disabled=!1,s.textContent=o);return}u(l?"Draft saved!":`Saved & published — your showroom shows it now (${Object.keys(h).length} change${Object.keys(h).length>1?"s":""}).`)}else{const g=parseInt(r.required_image_count||"0",10)||(nt.includes(t)?24:0);if(oa(g,r.images||[],"This listing"),!r.title||!r.title.trim())throw new Error("A product title is required.");if(r.price===""||r.price==null||!isFinite(parseFloat(r.price)))throw new Error("A price is required.");if(!r.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:r.subcategory||null,title:r.title.trim(),description:r.description||"",price:Math.max(j,Math.min(J,parseFloat(r.price)||0)),currency:r.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:l?!1:r.is_active==="on"||(r.images||[]).length>=24,is_featured:r.is_featured==="on",brand:r.brand||null,color:r.color||null,size:r.size||null,condition:r.condition||null,warranty:r.warranty||null,availability_status:r.availability_status||"In Stock",stock_quantity:r.stock_quantity?parseInt(r.stock_quantity):null,images:r.images||[],features:c(r.features_text).length?c(r.features_text):r.tags||[],tags:r.tags||[],highlights:c(r.highlights_text),seo_keywords:c(r.seo_keywords_text),is_ai_generated:!!r.catalog_template_id,ai_generated_fields:r.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(r)},h=tt();if(f.property_id=h,{error:b}=await p.from("showroom_listings").insert(f),b&&Ge(b,()=>Oe({...f,property_id:f.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=o);return}u(l?"Draft saved!":"Published! Your showroom shows this product now.")}try{localStorage.removeItem(Ke(t,a))}catch{}closeProductFormModal(),P()}catch(n){u("Error: "+n.message,"error"),s&&(s.disabled=!1,s.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Et(e)),i||(i=(window._productsData||[]).find(s=>s.property_id===e)||null),!i)return u("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=Y((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return D(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),P()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:o,updated_at:n,...r}=a,l=tt();await p.from("showroom_listings").insert({...r,property_id:l,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),P())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),P())};const Ji=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ie(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?Ct().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(U)){const s=new Set(i.map(n=>n.property_id)),o=U.filter(n=>n.listing_type==="property"&&n.property_id&&!s.has(n.property_id));o.length&&(i=i.concat(o))}i.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Rt("property","Real Estate"),i=e.country_code||"US",s=e.currency||et(i);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${aa(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${ia(s)}</select></div>
            </div>
          ...
          <div>
            ...
            <div id="image-preview" class="flex flex-wrap gap-2 mt-3">
              ${(e.images||[]).map((o,n)=>re(o,n)).join("")}
            </div>
            <div id="image-url-inputs">
              ${(e.images||[]).map((o,n)=>`<input type="hidden" name="images" id="img-url-${n}" value="${d(o)}">`).join("")}
            </div>
          </div>
    ...
    </div>`),lt(),dt(),sa("ppf-price"),window.syncPropertyCountry=function(){St("ppf")},St("ppf"),Ve("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Ve("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),o=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),n=t?0:parseInt(i.required_image_count||"24",10)||24;oa(n,s,"This property");const r={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(j,Math.min(J,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:o,images:s,highlights:ze(i.highlights_text),seo_keywords:ze(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let l;if(t){r.property_id=t;const c=Y((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:l}=await p.from("showroom_listings").upsert({...c,...r},{onConflict:"property_id"}))}else r.property_id=tt(),{error:l}=await p.from("showroom_listings").insert(r);l&&Ge(l,()=>Oe({...r,property_id:t||r.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),z(),Ie())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=Et(e)),i||(i=(Array.isArray(U)?U.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Yi=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function na(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>Qi(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function Qi(e){return`<tr class="order-row" data-status="${e.status}" data-search="${d(e.order_number)} ${d(e.full_name)} ${d(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Nt(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",W(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${d(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Yi.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),z(),na()};async function Xi(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    </div>`)};async function ct(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?oe("star","No Reviews","Customer reviews will appear here."):a.map(s=>Zi(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}function Zi(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),ct()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),ct())};async function la(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Messages & Support</h2>
        <div class="space-y-3">
          ${a.length===0?oe("message-circle","No Messages","Customer support messages will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),la()};async function Pe(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:s}=await p.from("coupons").insert(i);if(s){u(s.message,"error");return}u("Coupon created!"),z(),Pe()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Pe()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Pe())};async function es(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${a.length===0?oe("bell","No Notifications","System notifications will appear here."):a.map(i=>`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}const da=["Featured","Sponsored","Featured Collection","Discover","Promotion"],ts=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let he=null;function as(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${d(e)}</span>`}function is(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${d(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${d(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${d(e.link_target||"")}</span>`}function ss(e){return e.video_url?`<video src="${d(e.video_url)}" ${e.poster_url?`poster="${d(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${d(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function ca(){if(he)return he;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const n=o.category||"";n&&!t.has(n)&&(t.add(n),a.push(n))};try{U.forEach(i)}catch{}try{const{data:o,error:n}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!n&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),he={products:e,categories:a,sections:ts},he}async function os(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),s=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await p.storage.from("advertisements").upload(s,e,{contentType:e.type,upsert:!1});if(o)return u("Upload failed: "+o.message,"error"),null;const{data:n}=p.storage.from("advertisements").getPublicUrl(s);return{url:n.publicUrl,isVideo:i}}catch{return u("Upload failed","error"),null}}function xe(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),s=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),s&&(s.value=t?"":e),a.innerHTML=t?`<video src="${d(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${d(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const i=await os(t);if(!i){e.value="";return}xe(i.url,i.isVideo);const s=document.getElementById("ad-media-url");s&&(s.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);xe(t,a)};function ut(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let s="";t==="product"?s='<option value="">Select a product…</option>'+e.products.map(o=>`<option value="${d(o.id)}" ${String(a)===String(o.id)?"selected":""}>${d(o.id)} — ${d((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?s='<option value="">Select a category…</option>'+e.categories.map(o=>`<option value="${d(o)}" ${a===o?"selected":""}>${d(o)}</option>`).join(""):t==="section"&&(s='<option value="">Select a section…</option>'+e.sections.map(o=>`<option value="${d(o.id)}" ${a===o.id?"selected":""}>${d(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${s}</select>`}function ua(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${da.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),a=t?t.value:"none";ut(e,a,"")};window.showAddAdModal=async function(){const e=await ca();window._adLinkCache=e,B(ua(null)),ut(e,"none","")};window.showEditAdModal=async function(e){const t=await ca();window._adLinkCache=t;const{data:a}=await p.from("promotions").select("*").eq("id",e).maybeSingle();if(!a){u("Ad not found","error");return}B(ua(a)),a.image_url?xe(a.image_url,!1):a.video_url&&xe(a.video_url,!0),ut(t,a.link_type||"none",a.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i=a.id||"",s={title:a.title,description:a.description||"",ad_label:da.includes(a.ad_label)?a.ad_label:"Featured",image_url:a.image_url||null,video_url:a.video_url||null,link_type:["none","product","category","section"].includes(a.link_type)?a.link_type:"none",link_target:a.link_target||null,start_date:a.start_date?new Date(a.start_date+"T00:00:00").toISOString():null,end_date:a.end_date?new Date(a.end_date+"T23:59:59").toISOString():null,is_active:a.is_active==="on",promo_type:"banner"};if(!s.image_url&&!s.video_url){u("Add an image or video for the ad","error");return}const o=e.target.querySelector('button[type="submit"]');o&&(o.disabled=!0);try{if(i){const{error:n}=await p.from("promotions").update(s).eq("id",i);if(n)throw n;u("Ad updated!")}else{const{error:n}=await p.from("promotions").insert(s);if(n)throw n;u("Ad created!")}}catch(n){u(n.message||"Save failed","error"),o&&(o.disabled=!1);return}z(),ne()};window.togglePromo=async function(e,t){const{error:a}=await p.from("promotions").update({is_active:t}).eq("id",e);if(a){u(a.message,"error");return}u(t?"Ad activated":"Ad deactivated"),ne()};window.moveAd=async function(e,t){try{const{data:a,error:i}=await p.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(i)throw i;const s=a||[],o=s.findIndex(c=>c.id===e),n=o+t;if(o<0||n<0||n>=s.length){u("Already at the edge","info");return}const r=s[o],l=s[n];await p.from("promotions").update({sort_order:l.sort_order}).eq("id",r.id),await p.from("promotions").update({sort_order:r.sort_order}).eq("id",l.id),u("Order updated")}catch(a){u(a.message||"Reorder failed","error")}ne()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await p.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const i=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(s=>{const o=/\/object\/public\/advertisements\/(.+)$/.exec(s);return o?decodeURIComponent(o[1]):null}).filter(Boolean);if(i.length)try{await p.storage.from("advertisements").remove(i)}catch{}}const{error:a}=await p.from("promotions").delete().eq("id",e);if(a)throw a;u("Ad deleted")}catch(t){u(t.message||"Delete failed","error")}ne()}};async function ne(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border ${l?F.border[r.color]+" "+F.bg[r.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${r.id}">
          <div class="flex items-start justify-between gap-2">
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${l?F.text[r.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <a href="${r.signup}" target="_blank" rel="noopener" class="text-[10px] font-bold ${F.text[r.color]} hover:underline flex items-center gap-0.5">
        ...
        </div>`};const{data:a}=await p.from("ai_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.active_provider||"gemini",o=ie.slice(0,10),n=ie.slice(10);e.innerHTML=`
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.highlightAI=function(e){ie.forEach(t=>{const a=document.getElementById("apc-"+t.id);if(!a)return;const i=t.id===e;a.className=`glass-soft border ${i?F.border[t.color]+" "+F.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const s=a.querySelector("input[type=radio] + span");s&&(s.className=`text-[9px] font-bold ${i?F.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={active_provider:a.active_provider||"gemini",customer_ai_enabled:a.customer_ai_enabled==="on",product_ai_enabled:a.product_ai_enabled==="on",ai_code_assist:a.ai_code_assist==="on",ai_moderation:a.ai_moderation==="on"};ie.forEach(s=>{a[s.mf]&&(i[s.mf]=a[s.mf]);const o=(a[s.kf]||"").trim();o&&!o.startsWith("••••")&&o!==""&&(i[s.kf]=o)}),i.gemini_key&&(i.gemini_api_key=i.gemini_key),i.openai_key&&(i.openai_api_key=i.openai_key);try{const{data:s}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let o;if(s?.id?{error:o}=await p.from("ai_settings").update(i).eq("id",s.id):{error:o}=await p.from("ai_settings").insert(i),o){u("Save failed: "+o.message,"error"),console.error("[AI Save]",o);return}await S.reload(),u("✅ AI settings saved! Keys are active and auto-switch is ON.","success"),setTimeout(()=>pa(),600)}catch(s){u("Unexpected error: "+s.message,"error"),console.error("[AI Save]",s)}};const Fe="kco_ai_cooldowns",rs=60*1e3,S={_cfg:null,async reload(){const{data:e,error:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const a=e||{};!a.openai_key&&a.openai_api_key&&(a.openai_key=a.openai_api_key),!a.gemini_key&&a.gemini_api_key&&(a.gemini_key=a.gemini_api_key),this._cfg=a},async getConfig(){return this._cfg||await this.reload(),this._cfg},async getOrderedProviders(){const e=await this.getConfig(),t=e.active_provider||"gemini",a=this._getCooldowns(),i=Date.now(),s=ie.filter(l=>e[l.kf]&&e[l.kf].trim()),o=s.filter(l=>l.id===t),n=s.filter(l=>l.id!==t);return[...o,...n].sort((l,c)=>{const m=(a[l.id]||0)>i?1:0,b=(a[c.id]||0)>i?1:0;return m-b})},_getCooldowns(){try{return JSON.parse(localStorage.getItem(Fe)||"{}")}catch{return{}}},_setCooldown(e){const t=this._getCooldowns();t[e]=Date.now()+rs,localStorage.setItem(Fe,JSON.stringify(t))},_clearCooldown(e){const t=this._getCooldowns();delete t[e],localStorage.setItem(Fe,JSON.stringify(t))},_buildRequest(e,t,a,i){const s=t[e.kf],o=t[e.mf]||e.dm;switch(e.id){case"gemini":{const n=`https://generativelanguage.googleapis.com/v1beta/models/${o}:generateContent?key=${s}`,r={contents:a.map(l=>({role:l.role==="assistant"?"model":"user",parts:[{text:l.content}]}))};return{url:n,method:"POST",headers:{"Content-Type":"application/json"},body:r,parse:l=>l.candidates?.[0]?.content?.parts?.[0]?.text||""}}case"groq":{const n="https://api.groq.com/openai/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"deepseek":{const n="https://api.deepseek.com/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"mistral":{const n="https://api.mistral.ai/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"cohere":{const n="https://api.cohere.com/v2/chat",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.message?.content?.[0]?.text||l.text||""}}case"huggingface":{const n=`https://api-inference.huggingface.co/models/${o}/v1/chat/completions`,r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"together":{const n="https://api.together.xyz/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"openrouter":{const n="https://openrouter.ai/api/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`,"HTTP-Referer":window.location.origin},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"cerebras":{const n="https://api.cerebras.ai/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"fireworks":{const n="https://api.fireworks.ai/inference/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"github":{const n="https://models.inference.ai.azure.com/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"cloudflare":{const[n,r]=(s||"").split("|"),l=`https://api.cloudflare.com/client/v4/accounts/${n}/ai/run/${o}`,c={messages:a};return{url:l,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r||s}`},body:c,parse:m=>m.result?.response||""}}case"sambanova":{const n="https://api.sambanova.ai/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"hyperbolic":{const n="https://api.hyperbolic.xyz/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"novita":{const n="https://api.novita.ai/v3/openai/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"perplexity":{const n="https://api.perplexity.ai/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"replicate":{const n="https://openai-compat.replicate.com/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"ai21":{const n="https://api.ai21.com/studio/v1/chat/completions",r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"lepton":{const n=`https://${o.replace(/[^a-z0-9-]/g,"")}.lepton.run/api/v1/chat/completions`,r={model:o,messages:a,max_tokens:i};return{url:n,method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:r,parse:l=>l.choices?.[0]?.message?.content||""}}case"ollama":return{url:`${(s||"http://localhost:11434").replace(/\/$/,"")}/api/chat`,method:"POST",headers:{"Content-Type":"application/json"},body:{model:o,messages:a,stream:!1},parse:c=>c.message?.content||""};default:return null}},async chat(e,{maxTokens:t=2e3,onProviderSwitch:a=null}={}){const i=await this.getOrderedProviders(),s=await this.getConfig(),o=this._getCooldowns(),n=Date.now();if(i.length===0)throw new Error("No AI providers configured. Go to AI Settings and add at least one API key.");let r=null;for(const l of i){if((o[l.id]||0)>n){const c=Math.ceil(((o[l.id]||0)-n)/1e3);console.log(`[AI] Skipping ${l.name} — rate limited for ${c}s more`);continue}if(l.id==="ollama"){const c=this._buildRequest(l,s,e,t);if(!c)continue;try{a&&a(l.name);const m=await fetch(c.url,{method:c.method,headers:c.headers,body:JSON.stringify(c.body),signal:AbortSignal.timeout(6e4)});if(m.status===429||m.status===503){this._setCooldown(l.id),console.warn(`[AI] ${l.name} rate limited (${m.status}), switching to next provider…`),r=new Error(`${l.name} rate limited`);continue}if(!m.ok){const f=await m.text().catch(()=>"");r=new Error(`${l.name} error ${m.status}: ${f.slice(0,100)}`),console.warn(`[AI] ${l.name} failed:`,r.message);continue}const b=await m.json(),g=c.parse(b);if(!g){r=new Error(`${l.name} returned empty response`);continue}return this._clearCooldown(l.id),console.log(`[AI] ✓ Response from ${l.name}`),{text:g,provider:l.name,model:s[l.mf]||l.dm}}catch(m){m.name==="TimeoutError"?(this._setCooldown(l.id),r=new Error(`${l.name} timed out`)):r=m,console.warn(`[AI] ${l.name} exception:`,m.message)}continue}try{a&&a(l.name);const c=e[e.length-1],m={action:"chat",message:String(c?.content||"").trim(),history:e.slice(0,-1).map(h=>({role:h.role,content:String(h.content||"")})),provider_override:l.id,max_tokens:t},b=await this._callEdge(m);if(b&&b.response)return this._clearCooldown(l.id),console.log(`[AI] ✓ Response from ${l.name} (via edge function)`),{text:b.response,provider:l.name,model:b.model||s[l.mf]||l.dm};const g=String(b?.error||"empty response"),f=g.toLowerCase();f.includes("429")||f.includes("rate limit")||f.includes("quota")?(this._setCooldown(l.id),console.warn(`[AI] ${l.name} rate limited (${g.slice(0,80)}), switching to next provider…`),r=new Error(`${l.name} rate limited`)):(r=new Error(`${l.name} error: ${g.slice(0,200)}`),console.warn(`[AI] ${l.name} failed:`,r.message))}catch(c){c.name==="TimeoutError"?(this._setCooldown(l.id),r=new Error(`${l.name} timed out`)):r=c,console.warn(`[AI] ${l.name} exception:`,c.message)}}throw new Error(r?.message||"All AI providers failed or are rate limited. Add more API keys in AI Settings.")},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig(),t=this._getCooldowns(),a=Date.now();return ie.map(i=>({id:i.id,name:i.name,color:i.color,hasKey:!!e[i.kf]?.trim(),isActive:e.active_provider===i.id,cooldownUntil:t[i.id]||0,isCoolingDown:(t[i.id]||0)>a,remainingSec:Math.max(0,Math.ceil(((t[i.id]||0)-a)/1e3))}))},async analyzeImages(e,t={}){const a=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is — the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
- Respond with valid JSON only.`,i=[];for(const s of(e||[]).slice(0,3)){const o=await this._fetchImageAsDataUrl(s,1024);o&&i.push(o)}if(!i.length)throw new Error("Could not read the uploaded images.");try{const s=await this._tryBrowserGeminiVision(a,i)||await this._tryBrowserOpenAIVision(a,i);if(s)return s}catch{}try{const s=await this._callEdge({action:"vision",images:i,prompt:a,max_tokens:4096});if(s&&s.success&&s.text){const o=te(s.text);if(o)return{...o,_aiProvider:s.provider,_aiModel:s.model};throw new Error("The AI returned no valid analysis for these images.")}throw new Error(s&&s.error||"Vision service unavailable.")}catch{}try{const s=await this._tryLocalOllamaVision(a,i);if(s)return s}catch{}try{const s=await this._tryBrowserLocalVision(a,i);if(s)return s}catch{}return null},async _callEdge(e){let t="";try{t=(await p.auth.getSession())?.data?.session?.access_token||""}catch{}return await(await fetch(ni,{method:"POST",headers:{"Content-Type":"application/json",...t?{Authorization:`Bearer ${t}`}:{}},body:JSON.stringify(e),signal:AbortSignal.timeout(12e4)})).json().catch(()=>({}))},async _fetchImageAsDataUrl(e,t=1200){try{const a=await fetch(e).then(i=>i.blob());return!a||!a.size?null:a.size<18e5?`data:${a.type||"image/jpeg"};base64,${await At(a)}`:await this._downscaleImage(a,t)}catch{return null}},async _downscaleImage(e,t){const a=URL.createObjectURL(e);try{const i=new Image;await new Promise((l,c)=>{i.onload=l,i.onerror=c,i.src=a});const s=Math.min(1,t/Math.max(i.width,i.height)),o=Math.max(1,Math.round(i.width*s)),n=Math.max(1,Math.round(i.height*s)),r=document.createElement("canvas");return r.width=o,r.height=n,r.getContext("2d").drawImage(i,0,0,o,n),r.toDataURL("image/jpeg",.82)}finally{URL.revokeObjectURL(a)}},async _tryLocalOllamaVision(e,t){const a=await this.getConfig(),i=String(a.ollama_url||"http://localhost:11434").replace(/\/$/,""),s=[a.ollama_model,"llava","llama3.2-vision","moondream"].filter(Boolean);for(const o of s)try{const n=await fetch(`${i}/api/generate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:o,prompt:e,images:t.map(m=>String(m).split(",")[1]||m),stream:!1,options:{temperature:.3,num_predict:4096}}),signal:AbortSignal.timeout(12e4)});if(!n.ok)continue;const r=await n.json(),l=String(r?.response||"").trim();if(!l)continue;const c=te(l);return c?{...c,_aiProvider:"Ollama (Local)",_aiModel:o}:{description:l,_aiProvider:"Ollama (Local)",_aiModel:o}}catch{}return null},async _tryBrowserGeminiVision(e,t){const a=await this.getConfig(),i=String(a.gemini_key||a.gemini_api_key||"").trim();if(!i)return null;const s=[a.gemini_vision_model||a.gemini_model,"gemini-2.5-flash","gemini-3-flash-preview","gemini-3.1-flash-lite-preview"].filter(Boolean);for(const o of s)try{const n=[{text:e}];for(const g of t.slice(0,3)){const f=String(g).match(/^data:([^;,]+)[;,]base64,(.+)$/s);f&&n.push({inlineData:{mimeType:f[1].trim(),data:f[2].trim()}})}if(n.length<2)return null;const r=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(o)}:generateContent?key=${encodeURIComponent(i)}`,l=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:n}],generationConfig:{temperature:.2,maxOutputTokens:4096}}),signal:AbortSignal.timeout(4e4)});if(!l.ok)continue;const m=((await l.json())?.candidates?.[0]?.content?.parts||[]).map(g=>g?.text||"").join(`
`).trim();if(!m)continue;const b=te(m);if(b)return{...b,_aiProvider:"Gemini (browser)",_aiModel:o}}catch{}return null},async _tryBrowserOpenAIVision(e,t){const a=await this.getConfig(),i=[{key:a.groq_key,model:a.groq_vision_model||a.groq_model||"llama-3.2-11b-vision-preview",endpoint:"https://api.groq.com/openai/v1/chat/completions",name:"Groq"},{key:a.openrouter_key,model:a.openrouter_vision_model||a.openrouter_model||"google/gemini-2.5-flash",endpoint:"https://openrouter.ai/api/v1/chat/completions",name:"OpenRouter"},{key:a.hf_key,model:a.hf_vision_model||a.hf_model||"Qwen/Qwen2.5-VL-72B-Instruct",endpoint:"https://router.huggingface.co/v1/chat/completions",name:"Hugging Face"},{key:a.openai_key||a.openai_api_key,model:a.openai_vision_model||a.openai_model||"gpt-4o-mini",endpoint:"https://api.openai.com/v1/chat/completions",name:"OpenAI"}],s=[{type:"text",text:e},...t.slice(0,3).map(o=>({type:"image_url",image_url:{url:o}}))];for(const o of i){const n=String(o.key||"").trim();if(n)try{const r={"Content-Type":"application/json",Authorization:`Bearer ${n}`};o.name==="OpenRouter"&&(r["HTTP-Referer"]=window.location.origin,r["X-Title"]="Weverse Admin AI");const l=await fetch(o.endpoint,{method:"POST",headers:r,body:JSON.stringify({model:o.model,messages:[{role:"user",content:s}],temperature:.2,max_tokens:4096}),signal:AbortSignal.timeout(4e4)});if(!l.ok)continue;const c=await l.json(),m=String(c?.choices?.[0]?.message?.content||"").trim();if(!m)continue;const b=te(m);if(b)return{...b,_aiProvider:`${o.name} (browser)`,_aiModel:o.model}}catch{}}return null},async _tryBrowserLocalVision(e,t){return oi(e,t)},async generateImages(e,t,a=1){let i=null;if(t)try{i=await this._fetchImageAsDataUrl(t)}catch{}try{const s=await this._callEdge({action:"generate_images",prompt:e,reference_url:i,count:a||1});if(s&&s.success&&Array.isArray(s.images)&&s.images.length)return s.images;throw new Error(s&&s.error||"Image generation service unavailable.")}catch(s){try{const o=await this._tryLocalComfyUI(e);if(o&&o.length)return o}catch{}try{const o=await this._tryLocalOllamaImage(e);if(o&&o.length)return o}catch{}throw new Error(`AI image generation failed: ${s.message||s}. Add a Google Gemini API key in AI Settings, or configure local ComfyUI/Ollama.`)}},async _tryLocalComfyUI(e){const t=await this.getConfig(),a=String(t.comfyui_workflow||"").trim();if(!a)return null;let i;try{i=JSON.parse(a)}catch{return null}const s=String(t.comfyui_url||"http://127.0.0.1:8188").replace(/\/$/,""),o=String(t.comfyui_input_node||"image");String(t.comfyui_output_node||"image");const n=i[o]||Object.values(i)[0];if(!n)return null;n.inputs={...n.inputs||{},text:e};const r=`web-${Date.now()}`,l=await fetch(`${s}/prompt`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:i,client_id:r}),signal:AbortSignal.timeout(6e4)});if(!l.ok)return null;const{prompt_id:c}=await l.json();if(!c)return null;const m=Date.now()+18e4;for(;Date.now()<m;){await new Promise(b=>setTimeout(b,1e3));try{const b=await fetch(`${s}/history/${c}`,{signal:AbortSignal.timeout(1e4)});if(!b.ok)continue;const f=(await b.json())[c];if(!f)continue;const v=Object.values(f.outputs||{}).flatMap($=>Array.isArray($.images)?$.images:[]);if(v.length)return Promise.all(v.slice(0,4).map(async $=>{const H=await fetch(`${s}/view?filename=${encodeURIComponent($.filename)}&subfolder=${encodeURIComponent($.subfolder||"")}&type=${encodeURIComponent($.type||"output")}`,{signal:AbortSignal.timeout(3e4)});if(!H.ok)return null;const V=await H.blob();return await At(V).then(x=>`data:${V.type||"image/png"};base64,${x}`)})).then($=>$.filter(Boolean))}catch{}}return null},async _tryLocalOllamaImage(e){const t=await this.getConfig(),a=String(t.ollama_url||"http://localhost:11434").replace(/\/$/,""),i=[t.ollama_image_model||t.ollama_model,"llava"].filter(Boolean);for(const s of i)try{const o=await fetch(`${a}/api/generate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:s,prompt:e,stream:!1,options:{num_predict:512}}),signal:AbortSignal.timeout(12e4)});if(!o.ok)continue;const n=await o.json(),r=String(n?.images?.[0]||"").trim();if(r)return[`data:image/png;base64,${r}`]}catch{}return null}};function At(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const s=i.indexOf(",");t(s>=0?i.slice(s+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=S;window.showAiStatusModal=async function(){const e=await S.getStatus(),t=e.filter(a=>a.hasKey);B(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let y=null;const ma=[{key:"rewrite",mode:"edit",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",mode:"edit",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",mode:"edit",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",mode:"edit",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",mode:"edit",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."},{key:"scan",mode:"scan",label:"Scan My Showroom",icon:"scan-search",prompt:"Scan the showroom and check this product against the other products so everything matches."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a new professional product image for this product."}];function ns(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function ga(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const i of t)i in e&&(a[i]=e[i]);return a}function te(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const o=t.slice(i,s+1);try{return JSON.parse(o)}catch{return null}}function It(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=ns(e);if(!a)try{const{data:i}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();i&&(a=i)}catch{}if(!a){u("Product not found.","error");return}y={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:"",quickMode:"",chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,messages:[{role:"assistant",welcome:!0,content:`I'm your AI product manager for ${e}. We can chat about anything — or I can work on this card for you: rewrite copy, fix the price or category, clean images, scan the showroom to make sure it matches the other products, generate brand-new images, and look at any photos you attach. What do you need?`}]},A()};function A(){const e=y;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg",i=e.busy===!0,o=(Array.isArray(e.messages)?e.messages:[]).map(f=>f.role==="user"?`
    <div class="flex justify-end">
      <div class="max-w-[85%] bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-3xl rounded-tr-md px-5 py-3.5 text-[1.02rem] leading-relaxed whitespace-pre-wrap break-words shadow-lg shadow-blue-600/20">
        ${f.images&&f.images.length?`<div class="flex flex-wrap gap-2 mb-2">${f.images.map(h=>`<img src="${d(h)}" class="w-16 h-16 rounded-xl object-cover border border-white/20">`).join("")}</div>`:""}
        ${d(f.content)}
      </div>
    </div>`:`
      ...
      <div class="glass border border-fuchsia-500/20 rounded-3xl rounded-tl-md px-5 py-3.5 min-w-0 max-w-[85%]">
        ...
        ${f.generated&&f.generated.length?`
          <div class="flex flex-wrap gap-2.5 mt-3">
            ${f.generated.map((h,v)=>`
              <div class="relative">
                <img src="${d(h)}" class="w-40 h-40 rounded-2xl object-cover border border-fuchsia-500/40 shadow-lg" onerror="this.src='/fallback.svg'">
    ...
    </button>`).join(""),c=(Array.isArray(e.chatImages)?e.chatImages:[]).map((f,h)=>`
    <div class="relative w-14 h-14 rounded-xl overflow-hidden border border-blue-500/40 shrink-0">
      ...
      <button onclick="productAiRemoveChatImage(${h})" class="absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full bg-red-500 text-white text-xs leading-none flex items-center justify-center shadow" title="Remove image">✕</button>
    </div>`).join(""),m=e.suggestions?ds():"",b=ls();B(`
    <div class="fixed inset-0 z-[100] bg-[#030712]/92 backdrop-blur-sm flex flex-col" onclick="if(event.target===this)closeModal()">
      <div class="max-w-4xl mx-auto w-full h-full flex flex-col">
        ...
        <div id="product-ai-chat-scroll" class="flex-1 min-h-0 overflow-y-auto scrollbar-thin px-3 sm:px-5 py-4">
          <div class="space-y-4">
            <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
              <div class="flex flex-wrap gap-1.5 mb-3">${r}</div>
              ${b}
            </div>
            ${o}
            ${n}
    ...
    </div>`);const g=document.getElementById("product-ai-input");g&&(g.value=e.instruction||"",g.addEventListener("input",()=>{y&&(y.instruction=g.value)}),g.addEventListener("keydown",f=>{f.key==="Enter"&&!f.shiftKey&&(f.preventDefault(),runProductAiInstruction())})),window.lucide&&lucide.createIcons(),ba()}function ba(){const e=document.getElementById("product-ai-chat-scroll");e&&requestAnimationFrame(()=>{e.scrollTo({top:e.scrollHeight,behavior:"smooth"})})}window.productAiChatAttach=function(){document.getElementById("product-ai-chat-image")?.click()};window.productAiChatImagePicked=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await ha(i);s&&(y.chatImages.push(s),a+=1)}e.value="",a&&u(`${a} photo(s) attached. Send any message and the AI will look at them right away.`,"info"),A()};window.productAiRemoveChatImage=function(e){y&&(y.chatImages.splice(e,1),A())};function ha(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>t(String(a.result||"")),a.onerror=()=>t(""),a.readAsDataURL(e)})}function ls(){const e=y;if(!e)return"";const t=Array.isArray(e.product.images)?e.product.images:[],a=[...t,...e.addedImages],i={};t.forEach(n=>{i[n]=(i[n]||0)+1});const s=Object.keys(i).filter(n=>i[n]>1),o=a.map((n,r)=>{const l=r<t.length,c=l&&s.includes(n);return`
      <div class="relative group w-20 h-20 rounded-lg overflow-hidden border ${c?"border-amber-400/70":"border-white/10"}">
        ...
        ${c?'<span class="absolute top-0.5 left-0.5 text-[8px] font-black px-1 rounded bg-amber-400 text-[#111827]">DUP</span>':r===0?'<span class="absolute top-0.5 left-0.5 text-[8px] font-black px-1 rounded bg-blue-500 text-white">MAIN</span>':""}
        ${l?`<button onclick="productAiRemoveImageNow(${r})" class="absolute top-0.5 right-0.5 w-5 h-5 rounded-full bg-black/70 hover:bg-red-600 text-white text-[10px] flex items-center justify-center" title="Remove this image from the card now">✕</button>`:""}
      </div>`}).join("");return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
      ...
      <div class="flex items-start gap-3 p-3 rounded-xl bg-white/5 border ${c?"border-emerald-500/25":"border-white/10"}">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-[11px] text-gray-500 line-through decoration-red-400/60 mt-0.5 break-words">${d(r)}</p>
          <p class="text-[11px] text-emerald-300 font-semibold mt-1 break-words">${d(l)}</p>
        </div>
      </div>`)}const i=Array.isArray(e.product.images)?e.product.images:[],s=Array.isArray(e.suggestions.images_to_remove)?e.suggestions.images_to_remove.filter(n=>i.includes(n)):[],o=[...new Set([...e.removedImages,...s])];if(o.length){const n=e.approved.has("images_to_remove")?"checked":"";t.push(`
      <div class="flex items-start gap-3 p-3 rounded-xl bg-white/5 border ${n?"border-emerald-500/25":"border-white/10"}">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex flex-wrap gap-1.5 mt-1.5">${o.slice(0,12).map(r=>`<img src="${d(r)}" class="w-10 h-10 rounded-md object-cover border border-red-500/40" onerror="this.src='/fallback.svg'">`).join("")}</div>
        </div>
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){y&&(y.instruction=e)};window.productAiQuickAction=function(e){const t=ma.find(a=>a.key===e);!t||!y||(y.instruction=t.prompt,y.quickLabel=t.label,y.quickMode=t.mode||"edit",runProductAiInstruction())};window.productAiToggleApproved=function(e,t){y&&(t?y.approved.add(e):y.approved.delete(e),A())};window.productAiApproveAll=function(){if(!(!y||!y.suggestions)){for(const e of Object.keys(y.suggestions))y.approved.add(e);y.removedImages.size&&y.approved.add("images_to_remove"),A()}};window.productAiToggleRemoveImage=function(e){if(!y)return;const t=Array.isArray(y.product.images)?y.product.images:[],i=[...t,...y.addedImages][e];i&&(e<t.length?y.removedImages.has(i)?y.removedImages.delete(i):y.removedImages.add(i):y.addedImages=y.addedImages.filter(s=>s!==i),A())};window.productAiDetectDuplicates=async function(){if(!y)return;const e=y,t=Array.isArray(e.product.images)?e.product.images:[],a={};t.forEach(s=>{a[s]=(a[s]||0)+1});const i=t.filter((s,o)=>!(a[s]>1&&t.indexOf(s)!==o));if(i.length===t.length){u("No duplicate images found.","info");return}await le(i,`Removed ${t.length-i.length} duplicate image(s) from the card.`)};window.productAiUploadImages=async function(e){if(!y||!e||!e.files||!e.files.length)return;const t=y,a=[...e.files];t.busy=!0,A();const s=[...Array.isArray(t.product.images)?t.product.images:[]];let o=0;for(const n of a){if(!n.type.startsWith("image/"))continue;const r=await ge(n);r&&(s.push(r),o+=1)}if(e.value="",t.busy=!1,o){await le(s,`${o} image(s) uploaded to the card.`);return}u("Upload failed.","error"),A()};function cs(e,t){const a=String(e).toLowerCase();if(/\b(generate|create|make|draw|produce|imagine)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner)\b/.test(a)||/\b(change|swap|replace|edit|remove)\b[\s\S]*\b(background|color|colour)\b/.test(a))return"gen";if(/\bshowroom\b/.test(a)||/\bcompare\b[\s\S]*\b(showroom|product|other|card)\b/.test(a)||/\bscan\b[\s\S]*\b(showroom|product|card|listing|shop|match)\b/.test(a)||/\bmatch(es|ing)?\b/.test(a))return"scan";const i=/\b(rewrite|rephrase|update|fix|improve|optimize|change|make|rename|retitle|set|clean up|cleanup|remove|delete|add)\b/,s=/\b(title|description|price|stock|category|subcategory|brand|name|images?|features|tags|highlights|seo)\b/;return i.test(a)&&s.test(a)?"edit":t?"vision":"chat"}function us(){const e=y;return(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content)}window.runProductAiInstruction=async function(){const e=y;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i&&!s)return;const o=t||"Improve this product listing professionally.",n=a||t||(s?"Look at these photos and tell me what you see.":"Improve this product listing professionally."),r=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.messages.push({role:"user",content:n,images:r}),e.busy=!0,A();const l=i||cs(o,s);try{l==="gen"?await fa(o,r):l==="scan"?await hs():l==="edit"?await ps(o,r):l==="vision"?await gs(o,r):await ms(o),ba()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`AI error: ${c.message}`,"error")}finally{e.busy=!1,A()}};async function ps(e,t){const a=y,i=fs(a,e);let s="";if(t&&t.length){const r=await S._callEdge({action:"vision",images:t.slice(0,4),prompt:i,max_tokens:4096});if(s=r&&r.text?String(r.text):"",!s)throw new Error(r&&r.error||"The AI could not read the attached photos.")}else s=(await S.prompt(i,{maxTokens:4e3,onProviderSwitch:()=>{}})).text;const o=te(s);if(!o)throw new Error("The AI did not return valid JSON suggestions.");a.suggestions=o,a.approved=new Set(Object.keys(o)),a.approved.add("images_to_remove");const n=(o.summary||"Changes are ready for this product.").trim();a.messages.push({role:"assistant",content:`${n}

✅ Changes are ready below. Tick what you want, then press Save.`}),u("Suggestions ready — review and approve before saving.","info")}async function ms(e){const t=y,a=us(),i=await S._callEdge({action:"chat",message:e,history:a,max_tokens:1200});if(i&&i.response){t.messages.push({role:"assistant",content:String(i.response)});return}throw new Error(i&&i.error||"The AI did not respond.")}async function gs(e,t){const a=y,i=`${e}

If you recognize the product in these photos, say yes and identify exactly what it is, give a typical price range for it, and offer to generate more product photos for this listing. Be friendly and helpful.`,s=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1200}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o})}async function bs(){let e=Array.isArray(window._productsData)?window._productsData:[];if(!e.length)try{const{data:t,error:a}=await p.from("showroom_listings").select("*").limit(500);!a&&Array.isArray(t)&&(e=t)}catch{}return(e||[]).filter(t=>t&&t.property_id!==y.pid)}async function hs(){const e=y,t=await bs(),a=JSON.stringify(ga(e.product),null,2),i=t.slice(0,15).map(m=>({title:m.title,category:m.category,subcategory:m.subcategory,price:m.price,currency:m.currency,brand:m.brand,images:Array.isArray(m.images)?m.images.length:0,listing_type:m.listing_type})),s=`You are the AI product manager for the product ${e.pid} in the Weverse Online Shop showroom.
THIS PRODUCT (JSON):
${a}
...
- Respond with valid JSON only.`,o=await S._callEdge({action:"chat",message:s,history:[],max_tokens:3e3}),n=o&&o.response?String(o.response):"";if(!n)throw new Error(o&&o.error||"The showroom scan returned nothing.");const r=te(n),l=Array.isArray(r&&r.mismatches)?r.mismatches:[],c=Array.isArray(r&&r.matches)?r.matches:[];if(r&&(l.length||c.length||r.summary)){const m={};l.forEach(g=>{g&&g.field&&g.suggested_value!==void 0&&g.suggested_value!==null&&(m[g.field]=g.suggested_value)});const b=["Showroom scan complete:"];c.length&&b.push(...c.map(g=>`✅ ${g}`)),l.length&&b.push(...l.map(g=>`⚠️ ${g.field}: ${g.issue}`)),l.length||b.push("✅ Everything matches the other products in this showroom."),l.length?(m.summary=r.summary||`${l.length} issue(s) found with the showroom.`,e.suggestions=m,e.approved=new Set(Object.keys(m)),e.approved.add("images_to_remove"),b.push("Fixes are ready below. Tick what you want, then press Save.")):e.suggestions=null,e.messages.push({role:"assistant",content:b.join(`
`)}),u("Showroom scan complete.","info");return}e.messages.push({role:"assistant",content:n||"Showroom scan complete."})}async function fa(e,t){const a=y,i=a.product,s=`${e}

(Generate a clean, professional product photo for "${String(i.title||"").trim()||"this product"}" in the Weverse Online Shop.)`;let o=null;t&&t.length?o=t[0]:Array.isArray(i.images)&&i.images[0]&&(o=await S._fetchImageAsDataUrl(i.images[0]));const n=await S._callEdge({action:"generate_images",prompt:s,reference_url:o,count:2});if(n&&Array.isArray(n.images)&&n.images.length){a.generatedImages=n.images,a.lastGenPrompt=e,a.lastGenReference=o,a.messages.push({role:"assistant",content:"Here are your generated images. Tap one to add it to the card, or Regenerate for new variations.",generated:n.images,provider:`${n.provider||"AI"}/${n.model||""}`});return}throw new Error(n&&n.error||"Image generation returned nothing.")}async function Ee(e){try{const t=await fetch(e).then(i=>i.blob());if(!t||!t.size)return null;const a=new File([t],`ai-${Date.now()}.png`,{type:t.type||"image/png"});return await ge(a)}catch{return null}}window.productAiUseGeneratedImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Ee(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[];await le([...s,i],"Generated image added to the card.")};window.productAiReplaceMainImage=async function(e){const t=y;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,A();const i=await Ee(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),A();return}const s=Array.isArray(t.product.images)?t.product.images:[],o=s.length?[i,...s.slice(1)]:[i];await le(o,"Old main image replaced with the generated one.")};window.productAiUseAllGeneratedImages=async function(){const e=y;if(!e||e.busy||!Array.isArray(e.generatedImages)||!e.generatedImages.length)return;e.busy=!0,A();const a=[...Array.isArray(e.product.images)?e.product.images:[]];let i=0;for(const s of e.generatedImages){const o=await Ee(s);o&&(a.push(o),i+=1)}if(e.busy=!1,i){e.generatedImages=[],await le(a,`${i} generated image(s) added to the card.`);return}u("Upload failed.","error"),A()};window.productAiRemoveImageNow=async function(e){const t=y;if(!t||t.busy)return;const a=Array.isArray(t.product.images)?t.product.images:[];e<0||e>=a.length||await le(a.filter((i,s)=>s!==e),"Image removed from the card.")};async function le(e,t){const a=y;if(!a)return;a.busy=!0,A();const i=Y({...a.product,images:e,property_id:a.pid,updated_at:new Date().toISOString()});try{const{error:s}=await p.from("showroom_listings").upsert(i,{onConflict:"property_id"});if(s)throw s;a.product.images=e,a.removedImages.clear(),u(t,"success"),a.from==="properties"?Ie():P()}catch(s){s&&D(s)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration.","error"):u(`Save failed: ${s&&s.message||"unknown error"}`,"error")}finally{a.busy=!1,A()}}window.productAiRegenerateImage=async function(){const e=y;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,A();try{await fa(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,A()}}};function fs(e,t){const a=e.product;return`You are the AI product manager assistant for the Weverse Online Shop admin dashboard, working on ONE product.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=y;if(!e||e.busy)return;const t=[...e.approved].some(r=>r!=="images_to_remove"),a={};if(e.suggestions)for(const r of e.approved)r!=="images_to_remove"&&r in e.suggestions&&e.suggestions[r]!==void 0&&(a[r]=e.suggestions[r]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const i=Array.isArray(e.product.images)?e.product.images:[],s=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(r=>s.add(r));const o=[...i.filter(r=>!s.has(r)),...e.addedImages],n=Y({...e.product,...a,images:o,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,A();try{const{error:r}=await p.from("showroom_listings").upsert(n,{onConflict:"property_id"});if(r)throw r;u("Changes saved to Supabase.","success");const l=e.from;y=null,z(),l==="properties"?Ie():P()}catch(r){e.busy=!1,r&&D(r)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${r&&r.message||"unknown error"}`,"error"),A()}};let w=null;const pt=[{key:"monitor",mode:"monitor",label:"Scan Showroom",icon:"scan-search",prompt:"Scan the whole showroom and tell me what is good and what is not good."},{key:"publish",mode:"publish",label:"Publish from Photo",icon:"image-up",prompt:"Scan this photo and publish it in the matching section of my showroom — show me a preview first so I can approve it."},{key:"gen",mode:"gen",label:"Generate an Image",icon:"wand-sparkles",prompt:"Generate a beautiful new image for me."},{key:"fix",mode:"fix",label:"Fix Everything",icon:"wrench",prompt:"Check the whole showroom and fix everything that is wrong so everything is proper."}];function ys(){const e=w;return e?(Array.isArray(e.messages)?e.messages:[]).slice(0,-1).filter(a=>!a.welcome).map(a=>{const i=a.images&&a.images.length?` [Sent ${a.images.length} photo(s)]`:"",s=`${a.content||""}${i}`.trim();return{role:a.role==="user"?"user":"assistant",content:s}}).filter(a=>a.content):[]}function vs(e,t){const a=String(e||"").toLowerCase();return/\bpublish\b/.test(a)||/\b(add|upload|put)\b[\s\S]*\b(showroom|store|site|listing|product|card|item)\b/.test(a)?"publish":/\b(generate|create|make|draw|produce|imagine|design)\b[\s\S]*\b(image|photo|picture|logo|thumbnail|background|banner|color|colour)\b/.test(a)?"gen":t?a?"vision":"execute":/\b(scan|monitor|health|good|bad|check)\b[\s\S]*\b(showroom|store|product|section|everything)\b/.test(a)||/\bshowroom\b/.test(a)?"monitor":"execute"}function ws(e){const t=e&&e.action,a=e&&e.params||{};switch(t){case"delete_duplicates":return`Delete duplicate products${a.category?` in the "${a.category}" section`:" in the whole showroom"}.`;case"delete_products":return`Delete ${(a.property_ids||[]).length} product(s).`;case"rename_category":return`Rename the section "${a.from}" to "${a.to}" everywhere.`;case"create_product":return`Create a new product: "${a.title}" in ${a.category||"General"}.`;case"regenerate_product":return`Generate a brand-new image and replace the current one on ${a.property_id}.`;default:return JSON.stringify(a||{})}}function ya(){return w||(w={busy:!1,messages:[{role:"assistant",welcome:!0,content:"I'm the General AI — I manage your WHOLE showroom, right here on top of the Product Manager. Upload a photo and tell me what you want: I'll scan it and list the brand, model, year and real details, generate a matching image, or publish it to the showroom (I'll always show you a preview and ask if it's good before publishing). I always scan your showroom first so trucks go where the trucks are, cars where the cars are, homes where the homes are — I never guess or make new sections unless you ask me to. I can also generate any image, chat friendly, learn from your corrections, monitor what's good and what's not, and fix everything without coding. Just tell me."}],chatImages:[],generatedImages:[],lastGenPrompt:"",lastGenReference:null,pendingPlan:null,pendingPublish:null},w)}window.openGeneralAi=async function(){ya(),I()};function xs(e){if(!e)return"";const t=(Number(e.price)||0)>0?`$${Number(e.price).toLocaleString()}`:"",a=Array.isArray(e.images)?e.images.slice(0,3):[],i=Array.isArray(e.features)?e.features.slice(0,8):[],s=[e.brand,e.model,e.year,e.property_type].filter(Boolean);return`
    <div class="mt-3 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4">
      ...
      ${a.length?`<div class="flex flex-wrap gap-2 mb-3">${a.map(o=>`<img src="${d(o)}" class="w-28 h-28 rounded-xl object-cover border border-emerald-500/40 shadow-lg" onerror="this.src='/fallback.svg'">`).join("")}</div>`:""}
      <p class="text-base font-black text-white leading-tight">${d(e.title||"New Product")}</p>
      ${s.length?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${s.map(o=>d(String(o))).join(" · ")}${t?` · ${t}`:""}</p>`:t?`<p class="text-[11px] font-bold text-emerald-300 mt-1">${t}</p>`:""}
      <p class="text-[11px] text-gray-300 mt-2 leading-relaxed whitespace-pre-wrap break-words">${d(e.description||"")}</p>
      ${i.length?`<div class="flex flex-wrap gap-1.5 mt-3">${i.map(o=>`<span class="px-2 py-1 rounded-lg bg-white/5 border border-white/10 text-[9px] text-gray-200">${d(String(o))}</span>`).join("")}</div>`:""}
    ...
    </div>`}function va(e){return e?e.role==="user"?`
    <div class="flex justify-end">
      <div class="max-w-[85%] bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-3xl rounded-tr-md px-5 py-3.5 text-[1.02rem] leading-relaxed whitespace-pre-wrap break-words shadow-lg shadow-blue-600/20">
    ...
    <div class="flex gap-3 items-start">
      ...
      <div class="glass border border-sky-500/20 rounded-3xl rounded-tl-md px-5 py-3.5 min-w-0 max-w-[85%]">
        ...
        ${e.previewDraft?xs(e.previewDraft):""}
    ...
    </div>`}function xa(){const e=w;return!e||!e.pendingPlan?"":`
    <div class="glass border border-amber-500/30 rounded-2xl p-4 bg-amber-500/5">
      ...
      <p class="text-[11px] text-gray-400 mt-1.5">${d(ws(e.pendingPlan))}</p>
    ...
    </div>`}function _a(){const e=w;return e?(Array.isArray(e.chatImages)?e.chatImages:[]).map((a,i)=>`
    ...
    </div>`).join(""):""}function I(){document.getElementById("general-ai-embed-scroll")&&ka(),(document.getElementById("modal-container")?.innerHTML||"").trim().length>0&&_s(),Ce()}window.generalAiEmbedAttach=function(){document.getElementById("general-ai-embed-image")?.click()};function _s(){const e=w;if(!e)return;const t=e.busy===!0,i=(Array.isArray(e.messages)?e.messages:[]).map(c=>va(c)).join(""),s=t?wa():"",o=pt.map(c=>`
    ...
    </div>`);const l=document.getElementById("general-ai-input");l&&(l.value=e.instruction||"",l.addEventListener("input",()=>{w&&(w.instruction=l.value)}),l.addEventListener("keydown",c=>{c.key==="Enter"&&!c.shiftKey&&(c.preventDefault(),runGeneralAiInstruction())})),window.lucide&&lucide.createIcons(),Ce()}function ka(){const e=w,t=document.getElementById("general-ai-embed-scroll");if(!e||!t)return;const a=e.busy===!0,i=Array.isArray(e.messages)?e.messages:[],s=pt.map(l=>`
    ...
    ${a?wa():""}
    ${xa()}
  `;const o=document.getElementById("general-ai-embed-thumbs");o&&(o.innerHTML=_a());const n=document.getElementById("general-ai-embed-send-btn");n&&(n.classList.toggle("opacity-40",a),n.classList.toggle("pointer-events-none",a));const r=document.getElementById("general-ai-embed-input");r&&(r.value=e.instruction||"",r.dataset.gaiBound||(r.dataset.gaiBound="1",r.addEventListener("input",()=>{w&&(w.instruction=r.value)}),r.addEventListener("keydown",l=>{l.key==="Enter"&&!l.shiftKey&&(l.preventDefault(),runGeneralAiInstruction())}))),window.lucide&&lucide.createIcons(),Ce()}function Ce(){const e=["general-ai-chat-scroll","general-ai-embed-scroll"];requestAnimationFrame(()=>{for(const t of e){const a=document.getElementById(t);a&&a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}})}window.generalAiChatAttach=function(){document.getElementById("general-ai-chat-image")?.click()};window.generalAiChatImagePicked=async function(e){if(!w||!e||!e.files||!e.files.length)return;const t=[...e.files].slice(0,4);let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await ha(i);s&&(w.chatImages.push(s),a+=1)}if(e.value="",a){u(`${a} photo(s) attached. Now type what you want me to do with it (e.g. "scan this and list everything about it", "generate an image exactly like this", or "publish this to the showroom").`,"info");const i=document.getElementById("general-ai-embed-input")||document.getElementById("general-ai-input");i&&i.focus()}I()};window.generalAiRemoveChatImage=function(e){w&&(w.chatImages.splice(e,1),I())};window.generalAiQuickAction=function(e){const t=pt.find(a=>a.key===e);!t||!w||(w.instruction=t.prompt,w.quickLabel=t.label,w.quickMode=t.mode,runGeneralAiInstruction())};window.runGeneralAiInstruction=async function(){const e=w;if(!e||e.busy)return;const t=(e.instruction||"").trim(),a=e.quickLabel||"";e.quickLabel="";const i=e.quickMode||"";e.quickMode="";const s=(e.chatImages||[]).length>0;if(!t&&!a&&!i)return;const o=t||"",n=a||t||(s?"Photo attached — please scan it and list everything you can identify about it.":o),r=[...e.chatImages||[]];e.chatImages=[],e.instruction="",e.pendingPlan=null,e.messages.push({role:"user",content:n,images:r}),e.busy=!0,I();const l=i||vs(o,s);try{l==="publish"?await $a(o,r):l==="gen"?await Sa(o,r):l==="monitor"?await ks():l==="vision"?await $s(o,r):await Ss(o,r),Ce()}catch(c){e.messages.push({role:"assistant",content:`⚠️ ${c.message}`}),u(`General AI error: ${c.message}`,"error")}finally{e.busy=!1,I()}};async function $a(e,t){const a=w,i=await S._callEdge({action:"general_publish",message:e,images:t.slice(0,4),max_tokens:2048});if(!i||i.success!==!0)throw new Error(i&&i.error||"Could not prepare the product card.");if(i.pending&&i.draft){a.pendingPublish={draft:i.draft,instruction:e},a.messages.push({role:"assistant",content:String(i.response||"Here is the card I prepared. Is it good?"),previewDraft:i.preview||i.draft,images:(i.images||[]).slice(0,2)}),I();return}a.messages.push({role:"assistant",content:String(i.response||"Published."),images:(i.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Te()}window.generalAiConfirmPublish=async function(){const e=w;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=e.pendingPublish.draft;e.pendingPublish=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_publish",mode:"publish",draft:t});if(!a||a.success!==!0)throw new Error(a&&a.error||"Could not publish the product.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||"Published to the showroom.")}`,images:(a.images||[]).slice(0,2)}),u("Product published to the showroom.","success"),Te()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPublish=function(){w&&(w.pendingPublish=null,w.messages.push({role:"assistant",content:"Cancelled — nothing was published."}),I())};window.generalAiOpenPublishFix=function(){const e=document.getElementById("general-ai-publish-fix-box");e&&e.classList.remove("hidden")};window.generalAiRevisePublish=async function(){const e=w;if(!e||e.busy||!e.pendingPublish||!e.pendingPublish.draft)return;const t=document.getElementById("general-ai-publish-fix-input"),a=t?String(t.value||"").trim():"",i=e.pendingPublish.draft,s=e.pendingPublish.instruction||"";e.pendingPublish=null,e.busy=!0,I();try{const o=await S._callEdge({action:"general_publish",mode:"preview",message:s,draft:i,feedback:a||"Make this card more professional and match the showroom style."});if(!o||o.success!==!0)throw new Error(o&&o.error||"Could not revise the card.");if(!o.pending||!o.draft)throw new Error("The AI could not produce a revised card.");e.pendingPublish={draft:o.draft,instruction:s},e.messages.push({role:"assistant",content:String(o.response||"Here is the revised card. Is it good now?"),previewDraft:o.preview||o.draft,images:(o.images||[]).slice(0,2)}),I()}catch(o){e.messages.push({role:"assistant",content:`⚠️ ${o.message}`})}finally{e.busy=!1,I()}};async function Sa(e,t){const a=w;let i=null;t&&t.length&&(i=t[0]);const s=i?"The attached image is your SUBJECT — study it carefully and reproduce the SAME thing: the same type of object, subject, brand, model, look, colors, style and background. Keep the identical subject; only improve quality and lighting for a professional look. Do NOT change the subject and do NOT draw a person, woman, man, or face unless the attached image actually shows one. You must match what is in the reference photo.":`Generate a beautiful, high-quality image based on this request: "${e}". Follow the request exactly. If it asks for a specific object, product, vehicle, or scene, draw exactly that — never swap in a different subject, a person, or a random image.`,o=await S._callEdge({action:"generate_images",prompt:`${e}

${s}`,reference_url:i,count:2});if(!o||!Array.isArray(o.images)||!o.images.length)throw new Error(o&&o.error||"Image generation returned nothing.");a.generatedImages=o.images,a.lastGenPrompt=e,a.lastGenReference=i,a.messages.push({role:"assistant",content:"Here are your images — generated to match your reference photo. Tap one to save it to your showroom product images.",generated:o.images,provider:`${o.provider||"AI"}/${o.model||""}`})}async function ks(){const e=w,t=await S._callEdge({action:"general_monitor",max_tokens:3e3});if(!t||t.success!==!0||!t.report)throw new Error(t&&t.error||"Could not scan the showroom.");const a=t.report||{},i=["Showroom scan complete:"];(Array.isArray(a.good)?a.good:[]).forEach(s=>i.push(`✅ ${s}`)),(Array.isArray(a.issues)?a.issues:[]).forEach(s=>i.push(`⚠️ ${s.property_id} (${s.severity||"low"}): ${s.issue}`)),(Array.isArray(a.suggestions)?a.suggestions:[]).forEach(s=>i.push(`💡 ${s}`)),Array.isArray(a.issues)&&a.issues.length||i.push("Everything looks good."),e.messages.push({role:"assistant",content:i.join(`
`)})}async function $s(e,t){const a=w,i=`${e}
...
- Keep it a clean, readable list. You manage the whole showroom, so stay professional and factual.`,s=await S._callEdge({action:"vision",images:(t||[]).slice(0,4),prompt:i,max_tokens:1500}),o=s&&s.text?String(s.text):"";if(!o)throw new Error(s&&s.error||"The AI could not read the attached photos.");a.messages.push({role:"assistant",content:o,provider:s.provider?`${s.provider}/${s.model}`:""})}async function Ss(e,t){const a=w,i=ys(),s=await S._callEdge({action:"general_execute",message:e,images:(t||[]).slice(0,4),history:i,max_tokens:1200});if(!s||s.success!==!0)throw new Error(s&&s.error||"Could not handle that request.");if(s.needs_confirmation){a.pendingPlan=s.plan||null,a.messages.push({role:"assistant",content:String(s.response||"I found something I can fix.")});return}a.messages.push({role:"assistant",content:String(s.response||s.reply||"Done.")}),s.plan&&s.plan.action!=="chat"&&s.plan.action!=="monitor"&&Te()}window.generalAiConfirmPlan=async function(){const e=w;if(!e||!e.pendingPlan||e.busy)return;const t=e.pendingPlan;e.pendingPlan=null,e.busy=!0,I();try{const a=await S._callEdge({action:"general_execute",confirm_plan:t,confirmed:!0});if(!a||a.success!==!0)throw new Error(a&&a.error||"The action failed.");e.messages.push({role:"assistant",content:`✅ ${String(a.response||a.reply||"Done.")}`}),Te()}catch(a){e.messages.push({role:"assistant",content:`⚠️ ${a.message}`})}finally{e.busy=!1,I()}};window.generalAiCancelPlan=function(){w&&(w.pendingPlan=null,w.messages.push({role:"assistant",content:"Cancelled — nothing was changed."}),I())};window.generalAiUseGeneratedImage=async function(e){const t=w;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];if(!a)return;t.busy=!0,I();const i=await Ee(a);if(t.busy=!1,!i){u("Could not upload the generated image.","error"),I();return}u("Image saved to showroom storage. Use it on any card or ask the AI to attach it.","success"),I()};window.generalAiPublishGeneratedImage=async function(e){const t=w;if(!t||t.busy||!Array.isArray(t.generatedImages))return;const a=t.generatedImages[e];a&&(t.instruction="Publish this generated image in the matching section of my showroom.",t.messages.push({role:"user",content:"Publish this generated image in the matching section of my showroom.",images:[a]}),t.chatImages=[],t.generatedImages=[],await $a("Publish this generated image in the matching section of my showroom.",[a]))};window.generalAiRegenerateImage=async function(){const e=w;if(!(!e||e.busy||!e.lastGenPrompt)){e.busy=!0,I();try{await Sa(e.lastGenPrompt,e.lastGenReference?[e.lastGenReference]:[])}catch(t){e.messages.push({role:"assistant",content:`⚠️ ${t.message}`})}finally{e.busy=!1,I()}}};async function Te(){try{await P()}catch{}}const mt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],As=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function gt(e){return Array.isArray(e)?e:[]}function Aa(e=[]){const t=new Map(gt(e).map(a=>[a.id,a]));return mt.map(a=>{const i=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!i.enabled,apiKey:i.apiKey||"",model:i.model||"",baseUrl:i.baseUrl||""}})}async function Ia(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function bt(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...gt(t?.ai_ad_generation_history)].slice(0,120);await Ia({ai_ad_generation_history:a})}async function Pa(e){try{const{data:i,error:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(s)throw s;let o;if(i?.id?{error:o}=await p.from("site_settings").update(e).eq("id",i.id):{error:o}=await p.from("site_settings").insert(e),o)throw o;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:i}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let s;if(i?.id?{error:s}=await p.from("public_live_state").update(a).eq("id",i.id):{error:s}=await p.from("public_live_state").insert(a),!s)return}catch{}try{localStorage.setItem(Ft,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function Is(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function Ps(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=Is(e.description),i=a?.startsAt||e.started_at||null,s=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:i,ai_ad_ends_at:s,ai_ad_duration_seconds:s&&i?Math.max(5,Math.round((new Date(s).getTime()-new Date(i).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(Ft),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function Be(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),Ps()]),i=t||{},s=a||{},o=Aa(i.ai_ad_video_providers),n=gt(i.ai_ad_generation_history).sort((l,c)=>new Date(c.created_at||0).getTime()-new Date(l.created_at||0).getTime()).slice(0,12),r=!!s.ai_ad_enabled&&!!s.ai_ad_video_url&&(!s.ai_ad_ends_at||new Date(s.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
        ...
        <form id="ai-ad-generator-form" onsubmit="activateAiAdvertisement(event)" class="glass-soft border border-violet-500/20 rounded-2xl p-5 space-y-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <input id="ai-ad-video-url" type="url" class="input-field text-xs" name="video_url" placeholder="https://...mp4" value="${d(r&&s.ai_ad_video_url||"")}" required>
            </div>
            <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`}}window.saveAiAdProviders=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());try{const{data:i}=await p.from("ai_settings").select("ai_ad_video_providers").limit(1).maybeSingle(),s=Aa(i?.ai_ad_video_providers),o=new Map(s.map(r=>[r.id,r])),n=mt.map(r=>{const l=r.id,c=o.get(l)||{},m=String(a[`provider_${l}_api_key`]||"").trim();return{id:l,name:r.name,enabled:t.get(`provider_${l}_enabled`)==="on",apiKey:m||c.apiKey||"",model:String(a[`provider_${l}_model`]||"").trim(),baseUrl:String(a[`provider_${l}_base_url`]||"").trim()}});await Ia({ai_ad_video_providers:n}),u("AI advertisement provider settings saved.","success"),Be()}catch(i){u("Failed to save providers: "+i.message,"error")}};window.generateAiAdScript=async function(){const e=document.getElementById("ai-ad-brief")?.value?.trim(),t=document.getElementById("ai-ad-goal")?.value||"Product launch",a=document.getElementById("ai-ad-provider"),i=document.getElementById("ai-ad-script");if(!e){u("Enter campaign brief first.","error");return}if(i){i.value="Generating script...";try{const s=["Create a short video advertisement script for an ecommerce marketplace.",`Goal: ${t}`,`Brief: ${e}`,"Return only plain text in this exact structure:","Headline:","Voiceover:","On-screen text:","CTA:"].join(`
`),o=await S.prompt(s,{onProviderSwitch:n=>{i.value=`Generating with ${n}...`}});i.value=o.text||"",await bt({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:o.provider,provider_id:a?.value||"",status:"script_generated",script:o.text||"",video_url:null}),u(`Script generated with ${o.provider}.`,"success")}catch(s){i.value="",u("Script generation failed: "+s.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),i=String(t.get("provider_id")||""),s=mt.find(g=>g.id===i)?.name||i,o=String(t.get("brief")||"").trim(),n=String(t.get("script")||"").trim(),r=String(t.get("video_url")||"").trim(),l=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),b=new Date(c+l*1e3).toISOString();if(!r){u("Video URL is required.","error");return}try{const g={ai_ad_enabled:!0,ai_ad_video_url:r,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:l,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:i,ai_ad_starts_at:m,ai_ad_ends_at:b,ai_ad_updated_at:new Date().toISOString()};await Pa(g),await bt({created_at:m,goal:a,brief:o,provider_name:s,provider_id:i,status:"active",script:n,video_url:r,ends_at:b}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),Be()}catch(g){u("Failed to activate AI advertisement: "+g.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Pa({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await bt({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),Be()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function Es(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),ea(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Ts(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${r?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${r?`Backup codes available: ${l} · Enrolled: ${N(o.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Ea(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Ca(e.map(t=>t.code)),Le()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await q(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Le()}catch(e){u(e.message,"error")}};async function Ls(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Ms(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),u("Orders exported!")};async function Rs(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}async function Re(){const e=document.getElementById("content");e&&(e.innerHTML=pe());try{let t=function(r,l,c,m="",b="blue"){const g=!!(c&&c.trim());return`
        <div class="glass-soft border border-${b}-500/15 rounded-xl p-4 space-y-3">
          <div class="flex items-center justify-between">
            <p class="text-xs font-black text-white">${d(r)}</p>
          ...
          ${g?`<div class="relative group w-full h-24 rounded-xl overflow-hidden bg-gray-900 border border-blue-500/10 flex items-center justify-center">
                <img src="${d(c)}" alt="${d(r)}" class="max-h-20 max-w-full object-contain p-2" onerror="this.closest('div').innerHTML='<p class=&quot;text-xs text-gray-600 text-center&quot;>Image broken</p>'">
               ...
               </div>`:`<div class="w-full h-24 rounded-xl border-2 border-dashed border-${b}-500/25 hover:border-${b}-500/50 flex flex-col items-center justify-center gap-2 cursor-pointer transition" onclick="triggerImgUpload('${l}')">
                <i data-lucide="image-plus" class="w-7 h-7 text-${b}-400"></i>
          ...
          <div class="flex gap-2">
            <input class="input-field text-xs flex-1 ${g?"":"hidden"}" id="url-${l}" value="${d(c||"")}" placeholder="Or paste image URL" oninput="document.getElementById('val-${l}').value=this.value;updateLivePreview()">
            <button type="button" onclick="document.getElementById('url-${l}').classList.toggle('hidden')" class="text-[10px] text-${b}-400 hover:text-${b}-300 transition shrink-0">${g?"Edit URL":"Paste URL"}</button>
          </div>
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},s=i.brand_name||i.site_name||Ot,o=i.brand_slogan||i.site_tagline||Ut,n=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2">
                ...
                <input class="input-field" name="brand_slogan" id="inp-brand-slogan" value="${d(o)}" placeholder="e.g. Global Shopping • Worldwide Delivery" oninput="updateLivePreview()">
              </div>
              <div class="sm:col-span-2">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.toggleLivePreview=function(){document.getElementById("live-preview-panel")?.classList.toggle("hidden"),updateLivePreview()};window.updateLivePreview=function(){const e=document.getElementById("live-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("inp-brand-name")?.value||Ot,a=document.getElementById("inp-brand-slogan")?.value||Ut,i=document.getElementById("ct-primary")?.value||"#f97316",s=document.getElementById("ct-secondary")?.value||"#3b82f6",o=document.getElementById("ct-tag1")?.value||"#22d3ee",n=document.getElementById("ct-tag2")?.value||"#a3e635",r=document.getElementById("val-brand_logo")?.value||DEFAULT_BRAND_LOGO,l=document.getElementById("val-brand_badge")?.value||"";["preview-name","preview-footer-name","preview-copy-name"].forEach(h=>{const v=document.getElementById(h);v&&(v.textContent=t)}),["preview-slogan","preview-footer-slogan"].forEach(h=>{const v=document.getElementById(h);v&&(v.textContent=a)});const c=document.getElementById("preview-slogan");if(c&&a){const h=a,v=h.indexOf(","),$=v>-1?h.slice(0,v+1):h,H=v>-1?h.slice(v+1):"";c.innerHTML=`<span style="color:${o};font-weight:800">${d($)}</span><span style="color:${n};font-weight:700">${d(H)}</span>`}const m=document.getElementById("preview-btn");m&&(m.style.background=i);const b=e.querySelector('[style*="color:"]');b&&(b.style.color=s),["preview-logo-wrap","preview-footer-logo-wrap"].forEach(h=>{const v=document.getElementById(h);v&&(r?(v.innerHTML=`<img src="${r}" alt="${t}" class="w-full h-full object-contain p-1">`,v.style.background="transparent"):(v.innerHTML='<i data-lucide="globe" class="w-4 h-4 text-white"></i>',v.style.background=i,window.lucide&&lucide.createIcons()))});const g=document.getElementById("preview-badge-wrap"),f=document.getElementById("preview-badge");g&&f&&(l?(f.src=l,g.classList.remove("hidden")):g.classList.add("hidden"))};window.triggerImgUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearBrandImg=function(e){document.getElementById("val-"+e).value="";const t=document.getElementById("url-"+e);t&&(t.value=""),(e&&e.startsWith("homepage_")?Me:Re)()};window.clearHomepageBannerImg=function(){const e=document.getElementById("val-homepage_banner_image"),t=document.getElementById("url-homepage_banner_image"),a=document.getElementById("homepage_banner_alt");e&&(e.value=""),t&&(t.value=""),a&&(a.value=""),Me()};window.restoreHomepageBannerDefault=function(){window.clearHomepageBannerImg()};window.syncColor=function(e,t){const a=document.getElementById("color-"+e);a&&/^#[0-9a-fA-F]{6}$/.test(t)&&(a.value=t)};window.previewFont=function(e){const t=document.getElementById("font-sample");t&&(t.style.fontFamily=`'${e}', sans-serif`);const a="gf-preview";let i=document.getElementById(a);i||(i=document.createElement("link"),i.id=a,i.rel="stylesheet",document.head.appendChild(i)),i.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e)}:wght@400;700;900&display=swap`};const Ye="weverse_brand_v1",Qe="weverse_brand_override_v1";function Xe(){try{const e=JSON.parse(localStorage.getItem(Qe)||"null");if(e&&typeof e=="object")return e}catch{}try{const e=JSON.parse(localStorage.getItem(Ye)||"null");if(e&&typeof e=="object")return e.data&&typeof e.data=="object"?e.data:e}catch{}return{}}function _e(e){const t={...Xe(),...e};try{localStorage.setItem(Qe,JSON.stringify(t))}catch{}try{localStorage.setItem(Ye,JSON.stringify({ts:Date.now(),data:t}))}catch{}return window.dispatchEvent(new StorageEvent("storage",{key:Qe})),window.dispatchEvent(new StorageEvent("storage",{key:Ye})),window.dispatchEvent(new CustomEvent("brand-updated",{detail:t})),t}window.handleBrandImgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=t&&t.startsWith("homepage_"),s=document.getElementById(i?"homepage-banner-status":"brand-upload-status"),o=document.getElementById(i?"homepage-banner-msg":"brand-upload-msg");s&&s.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const n=a.name.split(".").pop(),r=`brand/${t}-${Date.now()}.${n}`,{error:l}=await p.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let c;if(l)c=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:g}=p.storage.from("product-images").getPublicUrl(r);c=g.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const m=document.getElementById("val-"+t),b=document.getElementById("url-"+t);m&&(m.value=c),b&&(b.value=c,b.classList.remove("hidden")),i?updateHomepageBannerPreview():(updateLivePreview(),setTimeout(()=>Re(),1e3))}catch(n){o&&(o.textContent=`Upload failed: ${n.message}`)}setTimeout(()=>s?.classList.add("hidden"),4e3)};window.saveBrandSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[r,l]of t.entries())r.endsWith("_url")||(a[r]=l);a.brand_name&&(a.site_name=a.brand_name),a.brand_slogan&&(a.site_tagline=a.brand_slogan),a.brand_description&&(a.site_description=a.brand_description),a.brand_email&&(a.contact_email=a.brand_email),a.brand_phone&&(a.contact_phone=a.brand_phone),a.brand_address&&(a.contact_address=a.brand_address),a.brand_website_url&&(a.production_url=a.brand_website_url);const i=a.brand_custom_font||a.brand_font;i&&previewFont(i);const s=e.target.querySelector("[type=submit]");s&&(s.disabled=!0,s.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Saving…',window.lucide&&lucide.createIcons());const{data:o}=await p.from("site_settings").select("id").limit(1).maybeSingle();let n;o?.id?{error:n}=await p.from("site_settings").update(a).eq("id",o.id):{error:n}=await p.from("site_settings").insert(a),n?(_e(a),u("Brand saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(_e(a),u("✅ Brand saved! All pages will now show your updated brand.","success")),setTimeout(()=>Re(),500)};window.toggleHomepageBannerPreview=function(){document.getElementById("homepage-banner-preview-panel")?.classList.toggle("hidden"),updateHomepageBannerPreview()};window.updateHomepageBannerPreview=function(){const e=document.getElementById("homepage-banner-preview-panel");if(!e||e.classList.contains("hidden"))return;const t=document.getElementById("val-homepage_banner_image")?.value||"",a=document.getElementById("homepage_banner_alt")?.value||"Homepage header banner",i=document.getElementById("homepage-banner-image"),s=document.getElementById("homepage-banner-preview-img");[i,s].forEach(n=>{n&&(t?(n.src=t,n.alt=a,n.classList.remove("hidden")):n.classList.add("hidden"))});const o=document.getElementById("homepage-banner-preview-note");o&&(o.textContent=t?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.")};window.saveHomepageBranding=async function(e){e.preventDefault();const t={homepage_banner_image:document.getElementById("url-homepage_banner_image")?.value||"",homepage_banner_alt:document.getElementById("homepage_banner_alt")?.value||"Homepage header banner"},a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let s;i?.id?{error:s}=await p.from("site_settings").update(t).eq("id",i.id):{error:s}=await p.from("site_settings").insert(t),s?(_e({...Xe(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),u("Homepage banner saved locally because the live settings table rejected part of the update. The site now uses the override immediately.","success")):(_e({...Xe(),homepage_banner_image:t.homepage_banner_image,homepage_banner_alt:t.homepage_banner_alt}),u("Homepage banner published.","success")),setTimeout(()=>Me(),500)};window._manualPaymentAccounts=[];function ht(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Tt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function ft(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function Ds(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${qt.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${aa(a)}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[ht()]),e.innerHTML=`
    <div class="space-y-4">
    ...
    </div>`,ft(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ht()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ht()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ft())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=ke.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Tt(t),ft(),renderManualPaymentAccountsEditor()};async function Ze(){const e=document.getElementById("content");e&&(e.innerHTML=pe());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...qa()||{},...t||{}};window._manualPaymentAccounts=Na(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${d(Ha(i))}</textarea>
              </div>
              <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${d(t.message)}</div>`)}}window.saveDeploySettings=async function(e){e.preventDefault();const t=e.target?.querySelector("[type=submit]");t&&(t.disabled=!0,t.innerHTML="Saving…");const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s={},o=["github_token","payment_public_key","payment_secret_key","payment_webhook_secret"];for(const[r,l]of Object.entries(i))o.includes(r)?l&&!l.startsWith("•")&&l.trim()!==""&&(s[r]=l.trim()):s[r]=l;const{error:n}=await p.from("site_settings").upsert({id:1,...s});if(t&&(t.disabled=!1,t.innerHTML="💾 Save Deploy & Payment Settings"),n){u(n.message,"error");return}u("Deploy & payment settings saved!"),De()};async function Ta(e="deploy"){const{data:t}=await p.from("site_settings").select("deploy_webhook,production_url,github_repo").limit(1).maybeSingle();if(!t?.deploy_webhook)return u("No webhook URL set. Add your deploy webhook in the settings below.","info"),{ok:!1,reason:"missing_webhook"};let a=t.deploy_webhook;try{const i=new URL(a);e==="rebuild"&&i.searchParams.set("rebuild","1"),a=i.toString()}catch{e==="rebuild"&&(a+=(a.includes("?")?"&":"?")+"rebuild=1")}return{ok:!0,settings:t,hookUrl:a}}async function K(e,t={}){const a=t.version||new Date().toISOString(),i={source:"admin-dashboard",mode:t.mode||"deploy",production_url:t.productionUrl||null,github_repo:t.githubRepo||null,webhook:t.webhook||null,message:t.message||null},{data:s,error:o}=await p.from("deployment_history").insert({version:a,status:e,triggered_by_email:k.user?.email||null,metadata:i,error_message:t.errorMessage||null}).select("id").limit(1).maybeSingle();return{data:s,error:o}}function se(e,t,a,i){if(!e)return;e.disabled=t;const s=e.querySelector("p.text-xs.font-black");s&&(s.textContent=t?a:i)}window.triggerDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-deploy-btn]");se(t,!0,"Deploying…","Deploy Now");try{const a=await Ta("deploy");if(!a.ok)return;const{settings:i,hookUrl:s}=a;await K("preparing",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Deployment queued from admin UI"});const o=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"deploy",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)u("🚀 Deployment triggered! Your site will be live in ~2 minutes."),await K("deploying",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Webhook accepted deployment request"}),setTimeout(()=>De(),400);else{const n=`Webhook returned error: ${o.status}`;u(n,"error"),await K("failed",{mode:"deploy",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,errorMessage:n})}}catch(a){u("Deploy failed: "+a.message,"error"),await K("failed",{mode:"deploy",errorMessage:a.message})}finally{se(t,!1,"Deploying…","Deploy Now")}};window.triggerRebuild=async function(e){const t=e?.currentTarget||document.querySelector("[data-rebuild-btn]");se(t,!0,"Rebuilding…","Rebuild Site");try{const a=await Ta("rebuild");if(!a.ok)return;const{settings:i,hookUrl:s}=a;await K("building",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Rebuild requested from admin UI"});const o=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({trigger:"rebuild",source:"admin-dashboard",at:new Date().toISOString()})});if(o.ok)u("🔄 Rebuild triggered successfully."),await K("deploying",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,message:"Webhook accepted rebuild request"}),setTimeout(()=>De(),400);else{const n=`Rebuild webhook error: ${o.status}`;u(n,"error"),await K("failed",{mode:"rebuild",productionUrl:i.production_url,githubRepo:i.github_repo,webhook:s,errorMessage:n})}}catch(a){u("Rebuild failed: "+a.message,"error"),await K("failed",{mode:"rebuild",errorMessage:a.message})}finally{se(t,!1,"Rebuilding…","Rebuild Site")}};window.publishAndDeploy=async function(e){const t=e?.currentTarget||document.querySelector("[data-publish-easy-btn]");se(t,!0,"Publishing…","One-Click Publish");try{const a=document.getElementById("deploy-form");if(!a){u("Deploy form is not available. Reload and try again.","error");return}await window.saveDeploySettings({preventDefault(){},target:a}),await window.triggerDeploy()}catch(a){u("Publish failed: "+a.message,"error")}finally{se(t,!1,"Publishing…","One-Click Publish")}};window.reindexSearch=async function(){const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Reindexing…");try{const{data:i,error:s}=await p.from("showroom_listings").select("id, updated_at").order("updated_at",{ascending:!1});if(s)return D(s)?u("⚠️ Reindex blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load listings to reindex: "+s.message,"error");const o=i||[];if(!o.length){u("No listings to reindex.");return}let n=0,r=0,l=!1;const c=40;for(let m=0;m<o.length;m+=c){const b=o.slice(m,m+c),{error:g}=await p.from("showroom_listings").update({updated_at:new Date().toISOString()}).in("id",b.map(f=>f.id));g?(D(g)&&(l=!0),r+=b.length):n+=b.length,t&&(t.textContent=`Reindexing… ${Math.min(m+c,o.length)}/${o.length}`)}if(l){u(`⚠️ Reindex partially blocked: database admin role rejected some writes. Re-run the admin permission migration. (${n}/${o.length} done)`,"error");return}u(`Search index rebuilt for ${n} listing${n!==1?"s":""}${r?` (${r} failed)`:""}.`,r?"error":"success")}catch(i){u("Reindex failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.syncShowroomToDB=async function(){if(!Array.isArray(U)||!U.length){u("No static showroom listings found to sync.","info");return}const t=(document.querySelector("[data-publish-easy-btn]")||document.querySelector("[data-rebuild-btn]"))?.querySelector("p.text-xs.font-black"),a=t?.textContent||"";t&&(t.textContent="Syncing…");try{const{data:i,error:s}=await p.from("showroom_listings").select("property_id");if(s)return D(s)?u("⚠️ Sync blocked: database admin role rejected the read. Re-run the admin permission migration.","error"):u("Could not load existing listings: "+s.message,"error");const o=new Set((i||[]).map(b=>b.property_id)),n=U.filter(b=>b&&b.property_id&&!o.has(b.property_id));if(!n.length){u("Showroom already in sync — no new listings to add.");return}let r=0,l=0,c=!1;const m=20;for(let b=0;b<n.length;b+=m){const g=n.slice(b,b+m).map(h=>({property_id:h.property_id,listing_type:h.listing_type||"product",category:h.category||null,subcategory:h.subcategory||null,title:h.title||"Untitled Listing",description:h.description||"",price:parseFloat(h.price)||0,currency:h.currency||"USD",country:h.country||"",country_code:h.country_code||"",state:h.state||"",city:h.city||"",town:h.town||"",product_location:h.product_location||"",latitude:h.latitude??null,longitude:h.longitude??null,property_type:h.property_type||null,listing_status:h.listing_status||"sale",bedrooms:h.bedrooms??null,bathrooms:h.bathrooms??null,building_size:h.building_size||"",land_size:h.land_size||"",parking_spaces:h.parking_spaces??null,furnished:h.furnished||"",features:Array.isArray(h.features)?h.features:[],tags:Array.isArray(h.tags)?h.tags:[],highlights:Array.isArray(h.highlights)?h.highlights:[],seo_keywords:Array.isArray(h.seo_keywords)?h.seo_keywords:[],images:Array.isArray(h.images)?h.images:[],brand:h.brand||null,color:h.color||null,size:h.size||null,condition:h.condition||null,warranty:h.warranty||null,availability_status:h.availability_status||"In Stock",stock_quantity:h.stock_quantity!=null?parseInt(h.stock_quantity,10):null,is_active:h.is_active!==!1,is_featured:!!h.is_featured,is_ai_generated:!!h.is_ai_generated,ai_generated_fields:Array.isArray(h.ai_generated_fields)?h.ai_generated_fields:[],specifications:h.specifications||{},created_at:h.created_at||new Date().toISOString()})),{error:f}=await p.from("showroom_listings").insert(g);f?(D(f)&&(c=!0),l+=g.length):r+=g.length,t&&(t.textContent=`Syncing… ${Math.min(b+m,n.length)}/${n.length}`)}if(c){u(`⚠️ Sync partially blocked: database admin role rejected some inserts. Re-run the admin permission migration. (${r}/${n.length} added)`,"error");return}u(`Showroom synced: ${r} new listing${r!==1?"s":""} added to the database${l?` (${l} failed)`:""}.`,l?"error":"success")}catch(i){u("Sync failed: "+i.message,"error")}finally{t&&(t.textContent=a)}};window.testGitHubConnection=async function(){const e=document.querySelector("[name=github_username]")?.value?.trim(),t=document.querySelector("[name=github_repo]")?.value?.trim();if(!e||!t){u("Enter your GitHub username and repo name first","info");return}try{const a=await fetch(`https://api.github.com/repos/${e}/${t}`);if(a.ok){const i=await a.json();u(`✓ Connected: ${i.full_name} (${i.visibility})`)}else a.status===404?u("Repository not found. Check username and repo name.","error"):u("GitHub API error: "+a.status,"error")}catch{u("Could not reach GitHub API","error")}};window.deployToProduction=window.triggerDeploy;window.rebuildSite=window.triggerRebuild;const ue=30,E={category:null,page:0,query:""};async function de(){const e=document.getElementById("content");if(!e)return;await Qa();const t=new Set(Lt()),a=Ka();E.category||(E.category=a[0]?.slug||null);const i=Bt(E.category),s=i?i.count:0,o=E.query.trim().toLowerCase(),n=`
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let c=[];if(i)if(o){const f=Math.min(s,8e3);for(let h=0;h<f&&c.length<ue;h++){const v=kt(i.slug,h);if(!v)continue;`${v.property_id} ${v.title} ${v.subcategory||""} ${v.category||""}`.toLowerCase().includes(o)&&c.push(v)}}else{const f=E.page*ue,h=Math.min(f+ue,s);for(let v=f;v<h;v++){const $=kt(i.slug,v);$&&c.push($)}}const m=c.length?c.map(f=>{const h=t.has(f.property_id),v=f.images&&f.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${h?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${d(f.property_id)} · ${d(f.subcategory||f.category||"")} · ${Nt(f.price,"USD")}</p>
            </div>
            ${R(!h)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',b=o?1:Math.max(1,Math.ceil(s/ue)),g=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${o?`${c.length} match`:`${s.toLocaleString()} items in ${d(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-gray-500">Page ${E.page+1} / ${b}</span>
        <button onclick="catalogPage(1)" ${E.page>=b-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${n}
      ...
      ${g}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){E.category=e,E.page=0,E.query="",de()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");E.query=e?e.value:"",E.page=0,de()};window.catalogPage=function(e){const t=Bt(E.category),a=t?t.count:0,i=E.query.trim()?1:Math.max(1,Math.ceil(a/ue));E.page=Math.max(0,Math.min(i-1,E.page+e)),de()};window.catalogToggle=async function(e){const t=!Lt().includes(e),a=await Ja(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),de()};window.catalogResetHidden=async function(){await Ya(),u("All hidden catalog listings restored"),de()};async function Pt(){window.lucide&&lucide.createIcons(),Ht(),await xi(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pt):Pt();window.aiChatHistory=[];window.aiProductType="product";async function js(){const e=document.getElementById("ai-prompt")?.value?.trim(),t=document.getElementById("ai-product-type")?.value||"product",a=document.getElementById("ai-image-upload")?.files[0];if(!e&&!a){u("Please enter a prompt or upload an image");return}window.aiChatHistory.push({type:"user",sender:"You",content:e||"Uploaded image"}),Gt();const i=document.getElementById("ai-prompt");i&&(i.value=""),u("AI is analyzing...");try{let s=null;a&&(s=await fileToDataUrl(a));const o={action:"generate_product",prompt:e||"Create a product listing",product_type:t,image:s,catalog_context:await Fs()},r=await(await fetch(AI_FUNCTION_URL,{method:"POST",headers:await getAuthHeaders(),body:JSON.stringify(o)})).json();r.success&&r.product?(openListingReviewCard(r.product,{source:"ai_general"}),u("Product generated! Review before saving.")):u(r.error||"AI generation failed")}catch(s){u("Error: "+s.message),console.error("[AI] Generate product error:",s)}}async function Fs(){try{const{data:e}=await p.from("showroom_listings").select("*").neq("listing_type","property").limit(20);return e||[]}catch{return[]}}document.getElementById("ai-prompt")?.addEventListener("keypress",function(e){e.key==="Enter"&&js()});
