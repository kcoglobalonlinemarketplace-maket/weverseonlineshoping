import{l as g,c as y,f as x}from"./supabase-client-CEXxUHzJ.js";import"./localization-DfbOIilT.js";import{getTruckById as f}from"./truck-data-DnyLExat.js";import{getMotorhomeById as h}from"./motorhome-data-SSjGu6g8.js";import{getCarById as b}from"./car-data-BE0Va4cl.js";import{getPhoneById as w}from"./phone-data-D3PvG27c.js";import{PRODUCT_LISTINGS as v}from"./products-data-CGLFLAJM.js";import{PRODUCT_EXTRA_LISTINGS as k}from"./products-extra-DecCj9NU.js";import{getCurrentUser as C,setRedirectAfterAuth as $}from"./auth-Cv9dOud9.js";import{r as p,s as _,e as c,a as I,c as T}from"./cart-DNy8CJA3.js";import"./native-bridge-BYSTYFwA.js";import"./localization-bootstrap-BECdp8Fe.js";import"./ai-chat-CUcsvZ4O.js";const l="/fallback.svg";function L(t){return v.find(e=>e.id===t||e.property_id===t)||k.find(e=>e.id===t||e.property_id===t)}function S(t){return x(t)||f(t)||h(t)||b(t)||w(t)||L(t)}function i(t,e){return`${(parseFloat(t)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${e}`}function B(t){const e=i(t.price,t.currency||"USD"),r=parseFloat(t.real_price);return Number.isFinite(r)&&r>0&&r>parseFloat(t.price)?`<span class="price-strike line-through text-gray-400 mr-1 text-xs">${i(r,t.currency||"USD")}</span><span class="text-amber-600 font-bold">${e}</span>`:`<span class="text-amber-600 font-bold">${e}</span>`}function u(t){const e=document.getElementById("toast-msg"),r=document.getElementById("toast");!e||!r||(e.textContent=t,r.classList.remove("translate-y-20","opacity-0"),r.classList.add("translate-y-0","opacity-100"),clearTimeout(window.__cartToastT),window.__cartToastT=setTimeout(()=>{r.classList.add("translate-y-20","opacity-0"),r.classList.remove("translate-y-0","opacity-100")},2e3))}function d(){return`
