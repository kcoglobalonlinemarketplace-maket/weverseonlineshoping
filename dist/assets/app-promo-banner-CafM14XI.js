import{D as q,l as g,b as v}from"./promo-backgrounds-s1OvnE5F.js";import{d as H,W as G,D as B,l as j,a as F,g as P,p as D,e as p,c as w,b as k}from"./promo-pool-B4VHSULD.js";import{D as x,l as S,g as I}from"./site-content-C2JSbfu8.js";const b="support@weverseonlineshop.com",U="weverse_brand_v1";function o(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function O(){try{const e=JSON.parse(localStorage.getItem(U)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function R(){const e=O(),t=e.brand_name||e.site_name||H;return`
