...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Te="kco_admin_remember",Jt="kco_login_attempts",Tt=5,cn=15*60*1e3;function G(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function un(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function yt(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Ye(e){return String(e||"").trim().toLowerCase()}function pn(){try{const e=JSON.parse(localStorage.getItem(Te)||"{}");e?.email&&!Ye(e.email)&&localStorage.removeItem(Te)}catch{localStorage.removeItem(Te)}}function mn(){try{const e=JSON.parse(localStorage.getItem(Te)||"{}");return Ye(e?.email)}catch{return""}}function Qt(){pn();const e=mn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Da,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function gn(){return`${window.location.origin}/admin.html`}function Ee(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),yt(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function q(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Ga(){try{return JSON.parse(localStorage.getItem(Jt)||'{"count":0}')}catch{return{count:0}}}function Va(){const e=Ga();return e.count=(e.count||0)+1,e.count>=Tt&&(e.lockedUntil=Date.now()+cn),localStorage.setItem(Jt,JSON.stringify(e)),e}function za(){localStorage.removeItem(Jt)}function Wa(){const e=Ga();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(za(),null):Math.ceil(t/6e4)}async function de(e,t,a={}){try{await g.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await bn(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function bn(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Ka(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await g.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Ye(e.email)===Da}async function yn(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){rt(),_n();return}const{data:{session:t}}=await g.auth.getSession();if(t?.user&&await Ka(t.user)){const{data:{currentUser:i}}=await g.auth.getUser(),n=await g.auth.mfa.getAuthenticatorAssuranceLevel(),o=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&o!=="aal2"){I.user=t.user,rt(),Ee("2fa"),Xt();return}I.user=t.user,ft();return}fn()}function rt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function fn(){rt(),Ee("login"),Qt(),Ya(),Ja(),Xt(),hn();const e=Wa();e&&(G(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function hn(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Ya(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",vn),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Ee("forgot")))}async function vn(e){e.preventDefault();const t=Wa();if(t){G(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Ye(a?.value);if(!i){G("Enter your admin email address."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;q("login-btn",!0),yt();const{data:r,error:l}=await g.auth.signInWithPassword({email:i,password:n});if(l||!r.user){const y=String(l?.message||"").toLowerCase();if(y.includes("missing supabase credentials")||y.includes("authentication service is unavailable")){G("Authentication is temporarily unavailable due to configuration. Please contact support."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("failed to fetch")||y.includes("network request failed")){G("Network error while signing in. Check your connection and try again."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("email not confirmed")){G("Your admin email is not confirmed yet. Open your verification email and confirm first."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const h=Va(),b=Tt-h.count,f=h.lockedUntil?`Account locked for 15 minutes after ${Tt} failed attempts.`:`Invalid email or password. ${b>0?b+" attempt"+(b!==1?"s":"")+" remaining.":""}`;G(f),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await de(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Ka(r.user)){await g.auth.signOut(),G(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await de(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Te,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Te),za(),I.user=r.user,(await g.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Ee("2fa"),Xt(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await de(r.user.id,"login_success"),q("login-btn",!1),ft()}function Xt(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ga));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ga()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await g.auth.signOut(),I.user=null,Ee("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",wn))}async function ga(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){G("Enter the 6-digit code from your authenticator app.");return}q("verify-2fa-btn",!0),yt();try{const{data:t}=await g.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){G("No 2FA factor found. Please re-login."),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await g.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:o}=await g.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await de(I.user.id,"login_2fa_success"),q("verify-2fa-btn",!1),ft()}catch(t){Va(),G(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function wn(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){G("Enter a backup recovery code.");return}q("verify-backup-btn",!0);try{const{data:t}=await g.from("admin_2fa").select("backup_codes").eq("user_id",I.user.id).maybeSingle();if(!t?.backup_codes?.length){G("No backup codes found."),q("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){G("Backup code not found or already used."),q("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await g.from("admin_2fa").update({backup_codes:i}).eq("user_id",I.user.id),await de(I.user.id,"login_backup_code_used"),ft()}catch(t){G(t.message),q("verify-backup-btn",!1,"Use Backup Code")}}function Ja(){document.getElementById("back-to-login")?.addEventListener("click",()=>Ee("login")),document.getElementById("send-reset-btn")?.addEventListener("click",xn)}async function xn(){const e=document.getElementById("reset-email"),t=Ye(e?.value);if(!t){G("Enter your admin email address to receive a reset link.");return}q("send-reset-btn",!0),yt();const{error:a}=await g.auth.resetPasswordForEmail(t,{redirectTo:gn()});if(q("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){G(a.message);return}un("Reset link sent! Check your inbox and open it from this device to continue.")}function _n(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${Bt(e).toLocaleString()}</p></div>
    </div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!a)return p("Product not found","error");const i=Array.isArray(a.images)?a.images:[];H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${s(e)}','${a?t.property_id:""}')" class="space-y-6">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${s(e)}')">${ai(n)}</select></div>
            </div>
...
`}const Gn=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function ha(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(u=>String(u)):[]),o=[],r=[],l=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(y=>y!=null&&String(y).trim()!=="").join(", "));let m=String(u).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},d=u=>{const m=l(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),y=parseFloat(m);return Number.isFinite(y)?y:NaN};for(const u of e||[]){if(ii.has(u.key))continue;const m={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const b=Array.isArray(a[u.key])?a[u.key].map(l).filter(Boolean):[],f=u.options&&u.options.length?b.filter(w=>u.options.includes(w)):b;f.length?(a[u.key]=f,m.status="filled",m.value=f.join(", ")):(delete a[u.key],b.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",r.push(`${u.label}: invalid selection ignored`))),o.push(m);continue}if(!(a[u.key]!=null&&l(a[u.key])!=="")){m.status=n.has(u.key)?"missing":"empty-ok",o.push(m);continue}if(Gn.test(l(a[u.key]))){delete a[u.key],n.add(u.key),m.status="missing",m.note="document/AI said the value is unavailable",o.push(m);continue}if(u.type==="number"){const b=l(a[u.key]),f=d(a[u.key]);if(!Number.isFinite(f)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`"${b}" is not a valid number`,r.push(`${u.label}: not a valid number`),o.push(m);continue}if(/year/.test(u.key)&&(f<1800||f>new Date().getFullYear()+2)){delete a[u.key],n.add(u.key),m.status="flagged",m.note=`${f} is outside the plausible range`,r.push(`${u.label}: implausible value ${f}`),o.push(m);continue}a[u.key]=f,m.status="filled",m.value=String(f),i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m);continue}if(u.type==="select"&&u.options&&u.options.length){const b=oi({options:u.options.map(f=>({value:f}))},l(a[u.key]));if(b==null){m.status="flagged",m.note=`"${l(a[u.key])}" does not match any option â€” left empty`,r.push(`${u.label}: no matching option`),delete a[u.key],n.add(u.key),o.push(m);continue}a[u.key]=b,m.status="filled",m.value=b,b!==l(t?.[u.key])&&(m.note="matched to the closest option"),o.push(m);continue}let h=l(a[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&h.length>120&&!["title"].includes(u.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",r.push(`${u.label}: suspiciously long value`)),a[u.key]=h,m.status="filled",m.value=h.length>48?h.slice(0,48)+"â€¦":h,i.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),o.push(m)}if(e&&e.length){const u=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(m=>{u.has(m)||delete a[m]})}a.missing_fields=o.filter(u=>u.status==="missing").map(u=>u.key),a.estimated=o.filter(u=>u.status==="estimated").map(u=>u.key);const c={total:o.length,filled:o.filter(u=>u.status==="filled").length,estimated:o.filter(u=>u.status==="estimated").length,flagged:o.filter(u=>u.status==="flagged").length,missing:o.filter(u=>u.status==="missing").length};return{specs:a,checklist:o,flags:r,summary:c}}function ni(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[o.status]||""}</span><span><b>${s(o.label)}</b> <span class="text-gray-600">(${s(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${s(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${s(o.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function He(e,t){const a=oa(e,xe),i=Qe(e.category),n=e.listing_type==="property"||i&&i.listing_type==="property",o=n?"Real Estate":i.category||e.category||"Other",r=si,l=r-$.length;((c,u)=>{const m=document.getElementById("scanner-scan-status");m&&(m.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),m.classList.add(u),m.innerHTML=c)})(`Processing ${l+1} of ${r}: ${s(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){Z++,$.splice(t,1),$.length?He($[0],0):window.returnToScanReviewAfterSave(-1);return}let c=e.property_id?Ne[e.property_id]:null;c&&c.specifications&&typeof c.specifications=="object"&&(c={...c,...c.specifications}),showAddProductStep2(o,c?{...c,images:a}:{images:a}),await new Promise(y=>setTimeout(y,250)),await dt(e,a,o);const m=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");m?(Be=t,m.click()):(Z++,closeProductFormModal(),$.splice(t,1),$.length?He($[0],0):window.returnToScanReviewAfterSave(-1))}catch{Z++,closeProductFormModal(),$.splice(t,1),$.length?He($[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(){const e=await mi();H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> General AI Scanner</h3>
    ...
    </div>`),window.lucide&&lucide.createIcons()};function xa(e,t){const a=Symbol("ai-scan-timeout");return Promise.race([e,new Promise(i=>setTimeout(()=>i(a),t))]).then(i=>{if(i===a)throw new Error("A scan step took too long and timed out.");return i})}window.scanGeneralWithAI=async function(){let e=[];try{e=await xa(mi(),15e3)}catch{e=[]}if(!e.length){p("No products with photos are in the Product Manager yet â€” add a product first.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",n=(k,U)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),U&&a.classList.add(U),a.innerHTML=k)};try{const k=await F.getConfig();String(k.gemini_key||k.gemini_api_key||"").trim()||n("No Gemini key found â€” scanning anyway with the FREE built-in AI (no key needed). Products whose photos cannot be read will still be filled from their saved details. For the best photo recognition, add a FREE Gemini key in AI Settings (aistudio.google.com/apikey).","text-blue-300")}catch{}t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),n(`Detecting and completing ${e.length} product${e.length===1?"":"s"}â€¦`,"text-blue-300");const o=[],r=[],l={};let d=0,c=0;const u=e.length,m=new Set;let y=0,h=0;const b=2,f=12e4;let w=0,x=0;const S=async k=>{const U=(k.images||[]).filter(Boolean);if(!U.length)return;const N=U.map(_=>String(_||"").trim()).filter(Boolean),B=N.length>0&&N.every(_=>m.has(_));for(const _ of N)m.add(_);if(B){y++;return}const Ie=o.length;o.push(...U);const pe=U.map((_,j)=>Ie+j);let ee=[],me=null;try{const _=await xa(F.detectProducts(U,{category:k.category||"",maxImages:Me.maxImages}),f);ee=_&&_.identified!==!1&&Array.isArray(_.products)?_.products:[]}catch(_){me=_}ee.length||(me&&c++,ee=[{detected_name:k.title||k.property_id||"Product",category:k.category||"Other",listing_type:k.listing_type||"product",brand:k.brand||null,model:k.specifications&&k.specifications.model||k.model||null,confidence:"medium",_photoNotRead:!0,_fallbackReason:me?"scan-failed":"no-identification"}],h++),d++,l[k.property_id]=k;for(const _ of ee)r.push({..._,property_id:k.property_id,image_indices:Array.isArray(_.image_indices)&&_.image_indices.length?_.image_indices.map(j=>pe[Number(j)]).filter(j=>j!==void 0):pe,detected_name:_.detected_name||k.title||k.property_id,category:_.category||k.category||"Other",listing_type:_.listing_type||k.listing_type||"product"})},v=async()=>{for(;w<e.length;){const k=e[w++];n(`Scanning ${x+1} of ${u} product${u===1?"":"s"} (fast parallel mode)â€¦`,"text-blue-300"),await S(k),x++,x<u&&n(`Scanned ${x} of ${u} â€” continuingâ€¦`,"text-blue-300")}};if(await Promise.all(Array.from({length:Math.min(b,Math.max(1,e.length))},v)),t&&(t.disabled=!1,t.innerHTML=i),!r.length){n(c?`The scan could not read any product (${c} scan${c>1?"s":""} failed or timed out${y?`; ${y} duplicate product${y>1?"s":""} skipped`:""}). Make sure your products have clear photos and that your free Gemini key is active in AI Settings, then try again.`:`No product could be identified from the photos on your existing products${y?` (${y} duplicate product${y>1?"s":""} skipped)`:""}. Make sure each product has clear photos, then try again.`,"text-amber-300"),p("No products could be scanned.","error");return}$=r,xe=o,Ne=l,ae="scanner-scan-status",scanReviewRender();const P=F.sessionReport();Date.now()<(F._geminiQuotaUntil||0),P.issues.length&&P.issues[P.issues.length-1];const E=[`${d} product${d===1?"":"s"} processed`,y?`${y} duplicate${y>1?"s":""} skipped`:"",h?`${h} filled from saved details (photo NOT read)`:"",c?`${c} scan error${c>1?"s":""}`:"",P.providers.map(k=>`${k.count} by ${k.name}`).join(", ")].filter(Boolean),M=Kn(r);if(M.length){const k=M.reduce((U,N)=>U+N.length-1,0);J=M,ne=M,oe=r.slice(),n(`
    ...
    `,"text-amber-300"),p(`Found ${k} duplicate product${k>1?"s":""} — review before publishing`,"info"),ra();return}$=r,xe=o,Ne=l,ae="scanner-scan-status",be=!0,ge=0,Z=0,si=r.length,n(`
  ...
  `,"text-blue-300"),p(`Scan done — auto-publishing ${r.length} product${r.length>1?"s":""}â€¦`,"info"),He(r[0],0)};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const l=document.createElement("style");l.id="_pubspin-style",l.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(l)}}catch{}const r=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=o)};try{const l=new FormData(i),d={};let c=0;for(const[b,f]of l.entries())if(b==="images"){d.images=d.images||[];const w=String(f);f&&!w.startsWith("blob:")?d.images.push(w):w.startsWith("blob:")&&c++}else b==="tags"?(d.tags=d.tags||[],d.tags.push(f)):d[b]=f;if(c&&!(d.images||[]).length){r(),p("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}d.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",d.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const u=l.get("action")==="draft",m=b=>Nt(b),y=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],w={};for(const x of f){const S=b[x];if(x==="real_price"){const v=S!=null&&String(S).trim()!==""?parseFloat(S):null;w[x]=v!=null&&Number.isFinite(v)&&v>0?Math.round(v):null;continue}w[x]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const x=m(b.safety_features);w.safety_features=x.length?x:null}return w};if(a){let b=null;try{const{data:_}=await g.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();_&&(b=he(_))}catch{}if(b||(b=he((window._productsData||[]).find(_=>_.property_id===a))),b||(b=he(Ve?Ve(a):null)),!b)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const f=(_,j)=>{const et=_===""||_==null?"":_,ke=j===""||j==null?"":j;return String(et).trim()===String(ke).trim()},w={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(_=>{f(d[_],b[_])||(w[_]=d[_]==null||d[_]===""?null:d[_])});const x=d.price===""||d.price==null?null:parseFloat(d.price);f(x,b.price)||(w.price=x==null?b.price:Math.max(O,Math.min(Q,x)));const S=d.stock_quantity===""||d.stock_quantity==null?null:parseInt(d.stock_quantity,10);f(S,b.stock_quantity)||(w.stock_quantity=Number.isFinite(S)?S:null);const v=m(d.features_text);f(v.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(w.features=v);const P=d.tags||[];f(P.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(w.tags=P);const E=m(d.highlights_text);f(E.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(w.highlights=E);const M=m(d.seo_keywords_text);f(M.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(w.seo_keywords=M);const k=d.images||[];f(k.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(w.images=k);const U=k.find(_=>typeof _=="string"&&Le(_))||null;f(U,b.video_url)||(w.video_url=U);const N=d.is_featured==="on";!!b.is_featured!==N&&(w.is_featured=N);const B=u?!1:d.is_active==="on";!!b.is_active!==B&&(w.is_active=B);const Ie=y(d),pe={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Ie};if(JSON.stringify(pe)!==JSON.stringify(b.specifications||{})&&(w.specifications=pe),Object.keys(w).length===0){p("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(ze(t,a))}catch{}p("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),R();return}const ee={...b,...w,property_id:a,updated_at:new Date().toISOString()};delete ee.id;const me=await ba(ee);if(me.error){r();const _=At(me.error,u?"Draft save":"Product publish");p(_,"error");try{let j=i.querySelector(".__publish-error-banner");j||(j=document.createElement("div"),j.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(j)),j.textContent=_}catch{}return}try{It(ee)}catch{}try{const _=(window._productsData||[]).findIndex(j=>j.property_id===a);_>=0&&(window._productsData[_]=ee)}catch{}p(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(w).length} change${Object.keys(w).length>1?"s":""}).`)}else{if(!d.title||!d.title.trim())throw new Error("A product title is required.");if(d.price===""||d.price==null||!isFinite(parseFloat(d.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!d.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:d.subcategory||null,title:d.title.trim(),description:d.description||"",price:Math.max(O,Math.min(Q,parseFloat(d.price)||0)),currency:d.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:d.is_active==="on",is_featured:d.is_featured==="on",brand:d.brand||null,color:d.color||null,size:d.size||null,condition:d.condition||null,warranty:d.warranty||null,availability_status:d.availability_status||"In Stock",stock_quantity:d.stock_quantity?parseInt(d.stock_quantity):null,images:d.images||[],video_url:(d.images||[]).find(S=>typeof S=="string"&&Le(S))||null,features:m(d.features_text).length?m(d.features_text):d.tags||[],tags:d.tags||[],highlights:m(d.highlights_text),seo_keywords:m(d.seo_keywords_text),is_ai_generated:!!d.catalog_template_id,ai_generated_fields:d.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:y(d)},w=Yt();f.property_id=w;const x=await ba(f);if(x.error){r();const S=At(x.error,"Product publish");p(S,"error");try{let v=i.querySelector(".__publish-error-banner");v||(v=document.createElement("div"),v.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(v)),v.textContent=S}catch{}return}try{It({...f,property_id:f.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...f})}catch{}p(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}be&&ge++,r();try{localStorage.removeItem(ze(t,a))}catch{}const h=Be;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(h)){R();return}R()}catch(l){const d=l&&l.message&&!/failed to fetch|networkerror/i.test(String(l.message))?l.message:At(l,"Product publish");be&&Z++,r(),p(d,"error")}};window.editProduct=async function(e){const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=Ve(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return p("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){let a=null;try{const{data:n}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(a=he(n))}catch{}if(a||(a=he((window._productsData||[]).find(n=>n.property_id===e))),!a||!a.property_id){Ct(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),R();return}delete a.id,a.property_id=e,a.is_active=t,a.availability_status=t?"In Stock":"Out of Stock";const{error:i}=await g.from("showroom_listings").upsert(a,{onConflict:"property_id"});if(i){if(X(i))return p(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Ct(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),p(t?"Product published locally":"Product unpublished locally","info"),R();return}p(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:o,updated_at:r,...l}=a,d=Yt();await g.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(p("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await g.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),p("Product archived"),R())};const jt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function wt(){const e=document.getElementById("content");try{const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?mt().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(ie)){const o=new Set(i.map(l=>l.property_id)),r=ie.filter(l=>l.listing_type==="property"&&l.property_id&&!o.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await zt()}catch{}const n=new Set(gt());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Ba("property","Real Estate"),i=e.country_code||"US",n=e.currency||Wt(i);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${ti(i)}</select></div>
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${ai(n)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${jt.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await g.from("payment_receipts").update({status:t}).eq("id",e);if(a){p(a.message,"error");return}p("Order status updated"),ce(),gi()};async function ao(){const e=document.getElementById("content");try{const{data:t}=await g.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window._customersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(a=>{a.style.display=!t||a.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(i=>i.user_id===e);if(!t)return;const{data:a}=await g.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    <div class="flex items-start justify-between gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddCouponModal=function(){H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:n}=await g.from("coupons").insert(i);if(n){p(n.message,"error");return}p("Coupon created!"),ce(),xt()};window.toggleCoupon=async function(e,t){await g.from("coupons").update({is_active:t}).eq("id",e),p(t?"Coupon activated":"Coupon deactivated"),xt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await g.from("coupons").delete().eq("id",e),p("Coupon deleted"),xt())};async function oo(){const e=document.getElementById("content");try{const{data:t}=await g.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
...
${a.text}`}catch(a){t.textContent=`✖ ${a.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const a=(n,o,r,l)=>`
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),p("Cleared. Save to apply.","info"),_i()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),p(`Uploading ${a.name}â€¦`,"info");try{const{data:{session:i}}=await g.auth.getSession();if(!i){p("Sign in to upload media","error");return}const n=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),o=`content/${t}-${Date.now()}.${n}`,{error:r}=await g.storage.from("product-images").upload(o,a,{contentType:a.type,upsert:!1});if(r){p("Upload failed: "+r.message,"error");return}const{data:l}=g.storage.from("product-images").getPublicUrl(o),d=l.publicUrl,c=document.getElementById("val-"+t),u=document.getElementById("url-"+t);c&&(c.value=d),u&&(u.value=d);const m=document.getElementById("slot-"+t);if(m){const y=da.flatMap(h=>h.fields||[]).find(h=>h.key===t);y&&(m.outerHTML=wi(y,d))}p("âœ“ Uploaded â€” save to apply","success")}catch{p("Upload failed","error")}}};const bo=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function se(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Ze(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(se()))}function Ce(){Ze();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=xi(se()),window.lucide&&lucide.createIcons())}function yo(e,t){const a=String(e&&e.video||"").trim(),i=String(e&&e.poster||"").trim(),n=a&&Sa(a)||i&&Sa(i)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Za(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function xo(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),p("Orders exported!")};async function $o(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
        ...
        </div>`};const{data:a}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},n=i.brand_name||i.site_name||Fa,o=i.brand_slogan||i.site_tagline||Ua,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    </div>`}function $a(e,t,a,i,n){const o=n==="image",r=o?"blue":"violet",l=o?"image-plus":"video",d=o?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        ...
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${ti(a)}</select></div>
    ...
    </div>`,ua(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(ca()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[ca()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ua())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=$e.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Kt(t),ua(),renderManualPaymentAccountsEditor()};async function Vt(){const e=document.getElementById("content");e&&(e.innerHTML=Fe());try{const{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i={...Wi()||{},...t||{}};window._manualPaymentAccounts=Qi(i).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${m}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){V.category=e,V.page=0,V.query="",je()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");V.query=e?e.value:"",V.page=0,je()};window.catalogPage=function(e){const a=V.query.trim()?1:Math.max(1,Math.ceil(0/Pi));V.page=Math.max(0,Math.min(a-1,V.page+e)),je()};window.catalogToggle=async function(e){const t=!gt().includes(e),a=await De(e,t);p(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),je()};window.catalogResetHidden=async function(){await Ii(),p("All hidden catalog listings restored"),je()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Ea(){window.lucide&&lucide.createIcons(),Ha(),await yn(),g.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){I.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ea):Ea();
