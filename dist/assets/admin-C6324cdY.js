import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as ei,S as oe}from"./showroom-data-Dx7pQsXv.js";import{supabase as y}from"./supabase-client-nvpjTmO6.js";import{a as rn,g as sn,C as he}from"./country-data-BSZ5lE1h.js";import{A as on}from"./localization-DSfm6ZR4.js";import{patchLocalShowroomListing as aa,getLocalShowroomListingById as He,removeLocalShowroomListing as pt,upsertLocalShowroomListing as St,listLocalShowroomListings as Lt}from"./local-showroom-store-mzP0nSoS.js";import{g as fa,s as ln,l as cn,a as dn}from"./payment-settings-Ch-OCLEx.js";import{P as ti,a as ai,T as ii,M as ni}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as un}from"./catalog-BaQ2rKyX.js";import{i as pn}from"./promo-backgrounds-KEhHWHvl.js";import{i as ri,D as mn}from"./site-content-CQxtbv3j.js";import{M as gn,n as bn,a as yn}from"./categories-5zVhBEjq.js";import{l as Rt,v as Mt}from"./video-frames-CLODj3nU.js";import{saveCatalogHidden as Ke,loadHiddenCatalogIds as va,getHiddenCatalogIds as Bt,resetHiddenCatalogIds as hn}from"./catalog-hidden-store-CPivWtWH.js";/* empty css                                       */const B=1,G=5e6,fn=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],vn=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],si=[...fn,...vn];function Ge(e){return rn[e]||"USD"}function oi(e,t){return si.filter(i=>i.listingType!==e?!1:t?i.category===t:!0)}function wn(e,t){const i=Math.max(B,Math.min(G,Number(e)||B));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(i)}function xn(e,t,i,a,n){const r=wn(a,i);return e.descriptionType==="vehicle"?`${e.label} listed at ${r}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${r}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${r}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${r}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${r}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${r}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${r}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${r}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${r}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${r}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function li({templateId:e,listingType:t,category:i,countryCode:a,currency:n,price:r}){const s=si.find(m=>m.id===e&&m.listingType===t);if(!s)return null;const o=sn(a)||he[0],l=n||Ge(o.code),d=[o.name].filter(Boolean).join(", "),u={category:s.category||i||(t==="property"?"Real Estate":"Other"),subcategory:s.subcategory||s.label,title:t==="property"?`${s.label} in ${o.name}`:s.label,description:xn(s,o,l,r,d),currency:l,features:[...s.features],highlights:[...s.highlights||[]],seo_keywords:[...new Set([s.category,s.subcategory,s.label,...t==="property"?[o.name]:[],...s.keywords||[]].filter(Boolean))],requiredImageCount:s.requiredImageCount||0};return t==="property"?{...u,country:o.name,country_code:o.code,product_location:o.name,property_type:s.propertyType||s.label,bedrooms:s.bedrooms??null,bathrooms:s.bathrooms??null,building_size:s.buildingSize||"",land_size:s.landSize||"",furnished:s.furnished||""}:{...u,brand:s.brand||"",model:s.model||"",color:s.color||"",size:s.size||"",condition:s.condition||"New"}}let Zt=null;async function _n(){return Zt||(Zt=ei(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),Zt}function kn(e,t){return e.toDataURL("image/jpeg",t)}async function Sn(e,t){const i=e.getViewport({scale:1}),a=Math.min(3,Math.max(.5,t/Math.max(i.width,i.height))),n=e.getViewport({scale:a}),r=document.createElement("canvas");r.width=Math.max(1,Math.round(n.width)),r.height=Math.max(1,Math.round(n.height));const s=r.getContext("2d",{alpha:!1});return s.fillStyle="#ffffff",s.fillRect(0,0,r.width,r.height),await e.render({canvasContext:s,viewport:n}).promise,kn(r,.78)}async function wa(e,{maxDim:t=1300,maxPages:i=0,onProgress:a=()=>{}}={}){const r=await(await _n()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,s=r.numPages,o=i>0?Math.min(s,i):s,l=[];try{for(let d=1;d<=o;d++){a(d,o);const u=await r.getPage(d);l.push(await Sn(u,t))}}finally{try{await r.destroy()}catch{}}return l}function Ne(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const ci="weverseonlineshop@gmail.com",di="Weverse Online Shop",ui="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",$n="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),En=`${$n}/functions/v1/ai-admin-assistant`,An=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Pn={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},xa=[...on].sort();let T={user:null,section:"dashboard"};function c(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function pi(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function le(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function $e(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function Nt(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Cn=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents","language_info"];function ye(e){const t={};if(!e||typeof e!="object")return t;for(const i of Cn)i in e&&(t[i]=e[i]);return t}function b(e,t="success"){const i=document.getElementById("toast"),a=document.getElementById("toast-msg"),n=i.querySelector("i[data-lucide]");if(!i||!a)return;a.textContent=e;const r={success:"check-circle",error:"alert-circle",info:"info"},s={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",r[t]||"info"),n.className=`w-4 h-4 shrink-0 ${s[t]||"text-blue-400"}`),i.style.transform="translateY(0)",i.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(i._t),i._t=setTimeout(()=>{i.style.transform="translateY(20px)",i.style.opacity="0"},3e3)}function Se(e){return!e||typeof e!="string"?!1:/^data:video\//i.test(e)?!0:e.startsWith("blob:")?!1:/\.(mp4|webm|mov|m4v|avi|mkv|ogv)(\?|#|$)/i.test(e)}function Re(e){return e&&e.type&&e.type.startsWith("video/")}function X(e){const t={pending_verification:["bg-amber-400/20 text-amber-300 border-amber-400/30","Pending Verification"],approved:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Approved"],rejected:["bg-red-400/20 text-red-300 border-red-400/30","Payment Rejected"],payment_received:["bg-cyan-400/20 text-cyan-300 border-cyan-400/30","Payment Received"],payment_approved:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Payment Approved"],payment_verified:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Payment Verified"],paid:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Paid"],payment_failed:["bg-red-400/20 text-red-300 border-red-400/30","Payment Failed"],documentation_pending:["bg-amber-400/20 text-amber-300 border-amber-400/30","Documentation Pending"],refund_processing:["bg-orange-400/20 text-orange-300 border-orange-400/30","Refund Processing"],order_completed:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Order Completed"],order_placed:["bg-amber-400/20 text-amber-300 border-amber-400/30","Placed"],processing:["bg-indigo-400/20 text-indigo-300 border-indigo-400/30","Processing"],order_processing:["bg-indigo-400/20 text-indigo-300 border-indigo-400/30","Processing"],shipped:["bg-violet-400/20 text-violet-300 border-violet-400/30","Shipped"],order_shipped:["bg-violet-400/20 text-violet-300 border-violet-400/30","Shipped"],in_transit:["bg-violet-400/20 text-violet-300 border-violet-400/30","In Transit"],out_for_delivery:["bg-cyan-400/20 text-cyan-300 border-cyan-400/30","Out for Delivery"],delivered:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Delivered"],order_delivered:["bg-emerald-400/20 text-emerald-300 border-emerald-400/30","Delivered"],cancelled:["bg-red-400/20 text-red-300 border-red-400/30","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[i,a]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",c(e)||"â€”"];return`<span class="badge ${i}">${a}</span>`}function ae(){document.getElementById("modal-container").innerHTML=""}function N(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}window.closeModal=ae;window.openModal=N;function Y(e,t,i,a,n=""){const r={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){T.section=e;const t=Pn[e]||e,i=document.getElementById("page-title");i&&(i.textContent=t),mi(),closeSidebar();const a=document.getElementById("content");a&&(a.innerHTML=Ye()),window.lucide&&lucide.createIcons(),({dashboard:Gn,products:P,properties:Vt,catalog:tt,orders:Ta,customers:Hr,reviews:yt,messages:Hi,coupons:Wt,ads:Ze,notifications:Wr,ai:In,"ai-settings":zi,"homepage-branding":Yt,"promo-bg":ut,content:Zr,"content-settings":Ji,seo:os,email:ls,analytics:ss,security:Kt,activity:cs,brand:et,"payment-settings":ha,backup:ds,settings:us,publish:Qt}[e]||(()=>{const s=document.getElementById("content");s&&(s.innerHTML=Me("construction","Coming Soon",`${t} is being built.`))}))()};async function In(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const je="kco_admin_remember",_a="kco_login_attempts",ia=5,Tn=15*60*1e3;function z(e){const t=document.getElementById("login-error"),i=document.getElementById("login-error-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Ln(e){const t=document.getElementById("login-success"),i=document.getElementById("login-success-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ft(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function mt(e){return String(e||"").trim().toLowerCase()}function Rn(){try{const e=JSON.parse(localStorage.getItem(je)||"{}");e?.email&&!mt(e.email)&&localStorage.removeItem(je)}catch{localStorage.removeItem(je)}}function Mn(){try{const e=JSON.parse(localStorage.getItem(je)||"{}");return mt(e?.email)}catch{return""}}function ka(){Rn();const e=Mn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||ci,t.removeAttribute("readonly"));const i=document.getElementById("reset-email");i&&(i.value=e||i.value||"",i.removeAttribute("readonly"))}function Bn(){return`${window.location.origin}/admin.html`}function Fe(e){const t=document.getElementById("login-header-title"),i=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ft(),e==="login"&&(t&&(t.textContent="Admin Access"),i&&i.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),i&&i.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),i&&i.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function O(e,t,i=""){const a=document.getElementById(e);a&&(a.disabled=t,t?a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':i&&(a.innerHTML=i),window.lucide&&lucide.createIcons())}function gi(){try{return JSON.parse(localStorage.getItem(_a)||'{"count":0}')}catch{return{count:0}}}function bi(){const e=gi();return e.count=(e.count||0)+1,e.count>=ia&&(e.lockedUntil=Date.now()+Tn),localStorage.setItem(_a,JSON.stringify(e)),e}function yi(){localStorage.removeItem(_a)}function hi(){const e=gi();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(yi(),null):Math.ceil(t/6e4)}async function ue(e,t,i={}){try{await y.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Nn(),user_agent:navigator.userAgent.slice(0,200),...i})}catch{}}async function Nn(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function fi(e){if(!e)return!1;let t=!1,i=!1;try{const{data:a}=await y.rpc("is_current_user_admin");t=!0,i=!!a}catch{t=!1}return t?i:mt(e.email)===ci}async function Fn(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){$t(),Hn();return}const{data:{session:t}}=await y.auth.getSession();if(t?.user&&await fi(t.user)){const{data:{currentUser:a}}=await y.auth.getUser(),n=await y.auth.mfa.getAuthenticatorAssuranceLevel(),r=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&r!=="aal2"){T.user=t.user,$t(),Fe("2fa"),Sa();return}T.user=t.user,Dt();return}Dn()}function $t(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Dn(){$t(),Fe("login"),ka(),vi(),wi(),Sa(),Un();const e=hi();e&&(z(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Un(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function vi(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",jn),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Fe("forgot")))}async function jn(e){e.preventDefault();const t=hi();if(t){z(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const i=document.getElementById("login-email"),a=mt(i?.value);if(!a){z("Enter your admin email address."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,r=document.getElementById("remember-me")?.checked;O("login-btn",!0),Ft();const{data:s,error:o}=await y.auth.signInWithPassword({email:a,password:n});if(o||!s.user){const h=String(o?.message||"").toLowerCase();if(h.includes("missing supabase credentials")||h.includes("authentication service is unavailable")){z("Authentication is temporarily unavailable due to configuration. Please contact support."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("failed to fetch")||h.includes("network request failed")){z("Network error while signing in. Check your connection and try again."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(h.includes("email not confirmed")){z("Your admin email is not confirmed yet. Open your verification email and confirm first."),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const v=bi(),p=ia-v.count,g=v.lockedUntil?`Account locked for 15 minutes after ${ia} failed attempts.`:`Invalid email or password. ${p>0?p+" attempt"+(p!==1?"s":"")+" remaining.":""}`;z(g),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),s?.user&&await ue(s.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await fi(s.user)){await y.auth.signOut(),z(`Access denied for ${s.user.email}. This account is signed in but does not have administrator privileges.`),O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await ue(s.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(r?localStorage.setItem(je,JSON.stringify({email:a,ts:Date.now()})):localStorage.removeItem(je),yi(),T.user=s.user,(await y.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){O("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Fe("2fa"),Sa(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await ue(s.user.id,"login_success"),O("login-btn",!1),Dt()}function Sa(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",Ua));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",a=>{a.target.value=a.target.value.replace(/\D/g,"").slice(0,6),a.target.value.length===6&&Ua()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await y.auth.signOut(),T.user=null,Fe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const i=document.getElementById("verify-backup-btn");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",On))}async function Ua(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){z("Enter the 6-digit code from your authenticator app.");return}O("verify-2fa-btn",!0),Ft();try{const{data:t}=await y.auth.mfa.listFactors(),i=(t?.totp||[])[0];if(!i){z("No 2FA factor found. Please re-login."),O("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:a,error:n}=await y.auth.mfa.challenge({factorId:i.id});if(n)throw n;const{error:r}=await y.auth.mfa.verify({factorId:i.id,challengeId:a.id,code:e});if(r)throw r;await ue(T.user.id,"login_2fa_success"),O("verify-2fa-btn",!1),Dt()}catch(t){bi(),z(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),O("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function On(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){z("Enter a backup recovery code.");return}O("verify-backup-btn",!0);try{const{data:t}=await y.from("admin_2fa").select("backup_codes").eq("user_id",T.user.id).maybeSingle();if(!t?.backup_codes?.length){z("No backup codes found."),O("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){z("Backup code not found or already used."),O("verify-backup-btn",!1,"Use Backup Code");return}const a=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await y.from("admin_2fa").update({backup_codes:a}).eq("user_id",T.user.id),await ue(T.user.id,"login_backup_code_used"),Dt()}catch(t){z(t.message),O("verify-backup-btn",!1,"Use Backup Code")}}function wi(){document.getElementById("back-to-login")?.addEventListener("click",()=>Fe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",qn)}async function qn(){const e=document.getElementById("reset-email"),t=mt(e?.value);if(!t){z("Enter your admin email address to receive a reset link.");return}O("send-reset-btn",!0),Ft();const{error:i}=await y.auth.resetPasswordForEmail(t,{redirectTo:Bn()});if(O("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),i){z(i.message);return}Ln("Reset link sent! Check your inbox and open it from this device to continue.")}function Hn(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,_i(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${c(t.message)}</div>`)}}function xe(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function lt(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Vn(e){const t=xe(e.price),i=parseFloat(e.real_price);if(Number.isFinite(i)&&i>0&&i>t)return`${Math.round((1-t/i)*100)}% OFF`;const a=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(a)&&a>0?`${Math.round(a)}% OFF`:"No discount"}function Wn(e){const t=xe(e.price),i=parseFloat(e.real_price),a=`$${t.toLocaleString()}`;return Number.isFinite(i)&&i>0&&i>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${i.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:a}function Ut(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function na(e){return parseInt(e.views??e.view_count??0,10)||0}function ra(e){return parseInt(e.sales??e.sales_count??0,10)||0}function jt(e){return e.sku||e.property_id||"N/A"}function zn(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",i=lt(e),a=Ut(e),n=window._productSelection?.has(e.property_id),r=X(a==="archived"?"inactive":a==="active"?"active":"inactive"),s=le(e.created_at),o=!!e.is_featured,l=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",u=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${c(e.category||"")}" data-status="${a}" data-featured="${o?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${c(Vn(e))}</p></div>
...
${t}`,s=await(async()=>{try{if(navigator.clipboard?.writeText)return await navigator.clipboard.writeText(t),!0}catch{}try{const l=document.createElement("textarea");return l.value=t,l.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(l),l.focus(),l.select(),document.execCommand("copy"),l.remove(),!0}catch{return!1}})();let o=!1;if(navigator.share)try{await navigator.share({title:a,text:n,url:t}),o=!0}catch{}o||b(s?"Product link copied to clipboard":"Product link: "+t)};function Kn(e){const t=Number(e&&typeof e.price=="object"?e.price.price:e&&e.price)||0,i=e&&e.currency||"USD";let a;try{a=t.toLocaleString("en-US",{style:"currency",currency:i,maximumFractionDigits:0})}catch{a="$"+t.toLocaleString("en-US")}return e&&e.price_period&&(a+="/"+e.price_period),a}window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(a=>a.property_id===e)||(window._propertiesData||[]).find(a=>a.property_id===e)||He(e),{error:i}=await y.from("showroom_listings").delete().eq("property_id",e);if(i&&!ie(i))return b("Delete failed: "+i.message,"error");pt(e);try{const a=await Ke(e,!0);a&&a.error&&ie(a.error)?b("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):b("Product deleted")}catch{b("Product deleted")}t&&t.listing_type==="property"?Vt():P()};window.openProductMoreActions=function(e){N(`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.filterProductCategoryChoices=function(e){const t=String(e||"").trim().toLowerCase();document.querySelectorAll("#product-category-grid [data-category]").forEach(i=>{const a=!t||i.dataset.category.includes(t);i.classList.toggle("hidden",!a)})};window.showAddProductStep2=function(e,t={}){const i=!!t.property_id,a=oi("product",e),n=t.currency||"USD";N(`
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    <div class="space-y-3">
      ...
      <div class="flex flex-wrap gap-2 pt-1">
        ...
        </div>`,window.lucide&&lucide.createIcons())}else{const e=document.getElementById(ua);e&&(e.classList.remove("hidden","text-blue-300","text-amber-300"),e.classList.add("text-gray-400"),e.textContent="All duplicates removed — nothing left to publish."),b("All duplicates removed.","info")}};let it=null;async function Bi(){if(it)return it;let e={};try{const{data:n}=await y.from("site_settings").select("site_name,brand_name,contact_email,contact_phone,whatsapp_number").limit(1).maybeSingle();e=n||{}}catch{}const t=String(e.site_name||e.brand_name||"").trim(),i=String(e.contact_phone||e.whatsapp_number||"").trim(),a=String(e.contact_email||"").trim();return!t&&!i&&!a?it={name:"Company",phone:"",email:""}:it={name:t,phone:i,email:a},it}async function Ni(e,t={}){const i=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,r=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,s=[],o=R=>Array.isArray(R)?R.join(", "):String(R??"").trim(),l=(R,W)=>{if(W==null||o([W])==="")return;const ge=document.querySelector(`#property-form [name="${R}"]`);ge&&(ge.value=String(W),s.push(R))},d=i.property_type||a.property_type;if(d){const R=br(d);R&&l("property_type",R)}r&&(l("title",a.title||i.detected_name),l("description",a.description)),l("subcategory",i.subcategory||a.subcategory);const u=i.bedrooms??a.bedrooms;u!=null&&u!==""&&l("bedrooms",parseInt(u,10)||u);const m=i.bathrooms??a.bathrooms;m!=null&&m!==""&&l("bathrooms",parseInt(m,10)||m),l("building_size",i.building_size||a.building_size),l("land_size",i.land_size||a.land_size);const h=i.parking_spaces??a.parking_spaces;h!=null&&h!==""&&l("parking_spaces",parseInt(h,10)||h);const v=String(i.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(v)?l("furnished","Furnished"):/unfurnished|no|empty/.test(v)&&l("furnished","Unfurnished");const p=String(i.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(p)?l("listing_status","rent"):/sale|buy|purchase/.test(p)&&l("listing_status","sale");const g=i.area||a.area;g&&!(i.town||a.town)&&l("town",g),l("town",i.town||a.town),l("city",i.city||a.city),l("state",i.state||a.state);const f=i.country||a.country;if(l("country",f),f){const R=(he||[]).find(W=>String(W.name||"").toLowerCase()===String(f).toLowerCase()||String(W.code||"").toLowerCase()===String(f).toLowerCase());if(R&&R.code){const W=document.querySelector('#property-form [name="country_code"]');W&&(W.value=R.code,s.push("country_code"))}}const _=i.address||a.address;l("product_location",_||[g||i.town||a.town,i.city||a.city,i.state||a.state,f].filter(Boolean).join(", ")),l("address",i.address||a.address),l("zip_code",i.zip_code||a.zip_code);const x=Number(i.latitude??a.latitude),w=Number(i.longitude??a.longitude);Number.isFinite(x)&&x>=-90&&x<=90&&x!==0&&l("latitude",String(x)),Number.isFinite(w)&&w>=-180&&w<=180&&w!==0&&l("longitude",String(w)),l("features_text",o(a.features)),l("highlights_text",o(i.highlights||a.highlights)),l("seo_keywords_text",o(a.seo_keywords));const k=i.half_bathrooms??a.half_bathrooms;k!=null&&k!==""&&l("half_bathrooms",parseInt(k,10)||k);const S=i.floors??a.floors;S!=null&&S!==""&&l("floors",parseInt(S,10)||S),l("garage",i.garage||a.garage);const A=i.year_built??a.year_built;A!=null&&A!==""&&l("year_built",parseInt(A,10)||A);const $=i.year_renovated??a.year_renovated;$!=null&&$!==""&&l("year_renovated",parseInt($,10)||$);const F=i.condition||a.condition,j=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(F){const R=String(F).toLowerCase(),W=j.find(ge=>R.includes(ge.toLowerCase())||ge.toLowerCase().includes(R));W&&l("condition",W)}l("interior_features_text",o(a.interior_features)),l("exterior_features_text",o(a.exterior_features)),l("home_systems_text",o(a.home_systems));const re=o(i.landmarks||a.landmarks);re&&l("landmarks_text",re);const Z=a.floor_plan;if(Z&&typeof Z=="object"){Z.image&&l("floor_plan_image",Z.image),Z.levels&&l("floor_plan_levels",Z.levels),Z.total_area&&l("floor_plan_total_area",Z.total_area);const R=Array.isArray(Z.rooms)?Z.rooms.map(W=>{const ge=String(W).match(/^(.*?):\s*(.*)$/);return ge?`${ge[1].trim()}: ${ge[2].trim()}`:String(W)}):[];R.length&&l("floor_plan_rooms",R.join(", "))}const D=a.nearby_area;D&&typeof D=="object"&&(Array.isArray(D.schools)&&D.schools.length&&l("nearby_schools_text",D.schools.join(", ")),Array.isArray(D.hospitals)&&D.hospitals.length&&l("nearby_hospitals_text",D.hospitals.join(", ")),Array.isArray(D.shopping)&&D.shopping.length&&l("nearby_shopping_text",D.shopping.join(", ")),Array.isArray(D.transportation)&&D.transportation.length&&l("nearby_transportation_text",D.transportation.join(", ")),Array.isArray(D.distances)&&D.distances.length&&l("nearby_distances_text",D.distances.join(", ")));const Ae=Array.isArray(a.legal_info)?a.legal_info.join(", "):o(a.legal_info);Ae&&l("legal_info_text",Ae),a.inspection_info&&l("inspection_info",a.inspection_info),a.risk_notes&&l("risk_notes",a.risk_notes),l("neighborhood",i.neighborhood||a.neighborhood||i.area),l("living_areas",o(a.living_areas));const Pe=i.kitchens??a.kitchens;Pe!=null&&Pe!==""&&l("kitchens",parseInt(Pe,10)||Pe);const C=i.balconies??a.balconies;C!=null&&C!==""&&l("balconies",parseInt(C,10)||C),l("garden",i.garden||a.garden),l("pool",i.pool||a.pool),l("security",o(a.security)),l("utilities",o(a.utilities)),l("construction_type",a.construction_type),l("construction_status",a.construction_status),l("ownership_type",a.ownership_type||i.ownership_type);const U=await Bi();U.name&&l("contact_name",U.name),U.phone&&l("contact_phone",U.phone),U.email&&l("contact_email",U.email);const ft=document.querySelector('#property-form [name="verification_status"]');r&&ft&&(ft.value="Not verified",s.push("verification_status"));const Xt=Number.isFinite(Number(B))?Number(B):0,an=Number.isFinite(Number(G))?Number(G):999999999,Na=R=>Math.max(Xt,Math.min(an,Math.round(R))),at=n?Number(n.estimated_price):NaN,vt=n?Number(n.suggested_discount_price):NaN;if(r&&Number.isFinite(at)&&at>0){const R=document.querySelector('#property-form [name="real_price"]');R&&(R.value=String(Na(at)),s.push("real_price"));const W=Number.isFinite(vt)&&vt>0&&vt<at?vt:at;l("price",String(Na(W)))}const Fa=String(a.title||i.detected_name||"Property").trim()||"Property",nn=a.description||`${Fa} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,Da=Pa("#property-form",{titleFallback:Fa,descriptionFallback:nn,visionUsed:r});return Da&&s.push(`${Da} auto-completed (safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),Pr().catch(()=>{}),{filled:s}}const Fi="Not provided - requires verification",Va={address:"Full street address - requires verification",zip_code:"Postal code - requires verification",neighborhood:"Neighborhood - requires verification",product_location:"Local area details - requires verification",garage:"Parking / garage details - requires verification",garden:"Outdoor space details - requires verification",pool:"Pool details - requires verification",security:"Security features - requires verification",utilities:"Utilities details - requires verification",living_areas:"Main living areas - requires verification",construction_type:"Construction material - requires verification",construction_status:"Construction status - requires verification",ownership_type:"Ownership type - requires verification",contact_name:"",contact_phone:"",contact_email:"",inspection_info:"Inspection details - requires verification",verification_date:"",documents_text:""},hr=new Set(["is_active","property_id","id","documents_text","verification_date","floor_plan_image","landmarks_text","legal_info_text","risk_notes","highlights_text","seo_keywords_text"]);function Wa(e){return Number.isFinite(e)?e<1?`${Math.max(0,Math.round(e*1e3))} m`:`${e.toFixed(1)} km`:"dist. TBD"}async function fr(e,t,i=4e3){const a=Number.isFinite(Number(i))&&Number(i)>0?Number(i):4e3,n=`
    [out:json][timeout:25];
    (
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,i=oi("property","Real Estate"),a=e.country_code||"US",n=e.currency||Ge(a);N(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="vehicle-form" onsubmit="saveVehicle(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Body Type</label><select class="input-field" name="body_type">${["",...jr].map(o=>`<option value="${o}" ${n("body_type","")===o?"selected":""}>${o||"General"}</option>`).join("")}</select></div>
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${i.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':i.map(r=>qr(r)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=i,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function qr(e){return`<tr class="order-row" data-status="${e.status}" data-search="${c(e.order_number)} ${c(e.full_name)} ${c(e.email)}">
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Or.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`),t.receipt_file_path)try{const{data:a,error:n}=await y.storage.from("payment-receipts").createSignedUrl(t.receipt_file_path,3600),r=!n&&a?.signedUrl?a.signedUrl:null,s=document.querySelector('[data-receipt-iframe="true"]'),o=document.querySelector('[data-receipt-view="true"]');s&&r&&(s.src=r),o&&r&&(o.href=r),o&&!r&&o.remove()}catch{}};window.saveOrderAdminNotes=async function(e){const t=document.getElementById("order-admin-notes")?.value,{error:i}=await y.from("payment_receipts").update({admin_notes:t||null,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){b(i.message,"error");return}b("Notes saved")};window.quickOrderAction=async function(e,t){const{error:i}=await y.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){b(i.message,"error");return}b("Order updated to "+t.replace(/_/g," ")),ae(),Ta()};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:i}=await y.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){b(i.message,"error");return}b("Order status updated"),ae(),Ta()};async function Hr(){const e=document.getElementById("content");try{const{data:t}=await y.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${i.length===0?Me("star","No Reviews","Customer reviews will appear here."):i.map(o=>Vr(o)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${r.length===0?Me("message-square","No Feedback Yet","Site feedback will appear here."):r.map(o=>Gr(o)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function Gr(e){const t=Array.from({length:5},(i,a)=>a<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
    ...
    <div class="flex items-start justify-between gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.markMsgRead=async function(e){await y.from("support_messages").update({is_read:!0}).eq("id",e),b("Marked as read"),Hi()};async function Wt(){const e=document.getElementById("content");try{const{data:t}=await y.from("coupons").select("*").order("created_at",{ascending:!1}),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),i=Object.fromEntries(t.entries()),a={code:i.code.toUpperCase(),discount_type:i.discount_type,discount_value:parseFloat(i.discount_value),min_amount:i.min_amount?parseFloat(i.min_amount):null,usage_limit:i.usage_limit?parseInt(i.usage_limit):null,expires_at:i.expires_at||null,is_active:!0},{error:n}=await y.from("coupons").insert(a);if(n){b(n.message,"error");return}b("Coupon created!"),ae(),Wt()};window.toggleCoupon=async function(e,t){await y.from("coupons").update({is_active:t}).eq("id",e),b(t?"Coupon activated":"Coupon deactivated"),Wt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await y.from("coupons").delete().eq("id",e),b("Coupon deleted"),Wt())};async function Wr(){const e=document.getElementById("content");try{const{data:t}=await y.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
...
${i.text}`}catch(i){t.textContent=`✖ ${i.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const i=(n,r,s,o)=>`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const i=document.createElement("input");i.type="file",i.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",i.onchange=()=>{const a=i.files&&i.files[0];a&&ns(e,t,a)},i.click()};window.heroVideoField=function(e,t,i){const a=ce();a[e]&&(a[e][t]=i,ht())};window.heroVideoPreset=function(e,t){const i=ce();i[e]&&(i[e].buttonText=t,Ue())};window.heroVideoToggle=function(e){const t=ce();t[e]&&(t[e].enabled=t[e].enabled===!1,Ue())};window.heroVideoMove=function(e,t){const i=ce(),a=e+t;a<0||a>=i.length||([i[e],i[a]]=[i[a],i[e]],Ue())};window.heroVideoDelete=function(e){const t=ce();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),Ue())};window.heroVideoRemoveMedia=function(e,t){const i=ce();i[e]&&(t==="video"?i[e].video="":t==="poster"&&(i[e].poster=""),Ue())};window.addHeroVideoSlide=function(){ce().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),Ue(),b("New slide added â€” upload a video and press Save to show it.","info")};async function is(e,t){try{const{data:{session:i}}=await y.auth.getSession();if(!i)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const a=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:r}=await y.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(r)return{url:URL.createObjectURL(e),persisted:!1,error:r.message};const{data:s}=y.storage.from("product-images").getPublicUrl(n),o=s&&s.publicUrl;return o?{url:o,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(i){return{url:URL.createObjectURL(e),persisted:!1,error:String(i&&i.message||i)}}}function Qa(e){return/^blob:/i.test(String(e||""))}async function ns(e,t,i){const a=ce();if(!i||!a[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(i.type+" "+i.name)){b("Please choose an MP4 or WebM video file.","error");return}}else if(!i.type.startsWith("image/")){b("Please choose an image for the poster.","error");return}b("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await is(i,t);t==="video"?a[e].video=n.url:a[e].poster=n.url,Ue(),n.persisted?b("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):b("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function rs(e){const t=Array.isArray(e)?e.map(a=>({...a})):[];return window._heroVideoDraft=t,ht(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${Ra.map(a=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${a.key==="hero_videos"?rs(i.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${a.fields.map(n=>`
      ...
      </div>`,window.lucide&&lucide.createIcons(),$i(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}async function os(){const e=document.getElementById("content"),{data:t}=await y.from("site_settings").select("*").limit(1).maybeSingle(),i=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),i=document.createElement("a");i.href=URL.createObjectURL(t),i.download="kco-admin-backup-codes.txt",i.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Qi(10);await y.from("admin_2fa").update({backup_codes:e}).eq("user_id",T.user.id),b("New backup codes generated"),Xi(e.map(t=>t.code)),Kt()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await y.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:i}=await y.auth.mfa.unenroll({factorId:t.id});if(i)throw i}await y.from("admin_2fa").update({enabled:!1}).eq("user_id",T.user.id),await ue(T.user.id,"2fa_disabled"),b("2FA has been disabled"),Kt()}catch(e){b(e.message,"error")}};async function cs(){const e=document.getElementById("content");try{const{data:t}=await y.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}async function ds(){const e=document.getElementById("content");try{const{data:t}=await y.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),a=new Blob([t+`
`+i],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(a),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),b("Orders exported!")};async function us(){const e=document.getElementById("content"),{data:t}=await y.from("site_settings").select("*").limit(1).maybeSingle(),i=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
        ...
        </div>`};const{data:i}=await y.from("site_settings").select("*").limit(1).maybeSingle(),a=i||{},n=a.brand_name||a.site_name||di,r=a.brand_slogan||a.site_tagline||ui,s=a.brand_logo||a.brand_header_logo||"",o=a.ringtone_audio||a.ringtone_url||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(i){t&&(t.innerHTML=`<div class="p-6 text-red-400">${c(i.message)}</div>`)}}function ps(e,t){const i=e.key+"_bg_image",a=e.key+"_bg_video",n=t[i]||"",r=t[a]||"",s=!!(n&&n.trim()),o=!!(r&&r.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,i)=>ms(t,i)).join("")}
    ...
    </div>`,Ba(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Ma()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Ma()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,i){const a=window._manualPaymentAccounts[e];a&&(a[t]=i,t==="currency"&&(a.currencyName=i),Ba())};window.updateManualPaymentCountry=function(e,t){const i=window._manualPaymentAccounts[e];if(!i)return;const a=he.find(n=>n.code===t);i.country_code=t,i.country=a?.name||"",i.flag=a?.flag||fa(t),Ba(),renderManualPaymentAccountsEditor()};window._bankAccounts=[];async function gs(){try{const{data:e,error:t}=await y.from("bank_accounts").select("*").order("sort_order",{ascending:!0}).order("currency",{ascending:!0});if(t)return b(t.message,"error"),[];window._bankAccounts=e||[]}catch{window._bankAccounts=[]}return window._bankAccounts}async function Jt(){const e=document.getElementById("bank-accounts-manager");e&&(e.innerHTML='<div class="flex items-center justify-center py-6 text-blue-300 text-sm"><i data-lucide="loader-2" class="w-4 h-4 animate-spin mr-2"></i> Loading accounts…</div>',window.lucide&&lucide.createIcons(),await gs(),e.innerHTML=`
    <div class="space-y-3">
      <div class="flex items-center justify-between">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${c(dn(a))}</textarea>
              </div>
              <div>
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl border ${v?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${c(h.property_id)} Â· ${c(h.subcategory||h.category||"")} Â· ${pi(h.price,"USD")}</p>
            </div>
            ${X(!v)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',u=n?1:Math.max(1,Math.ceil(a/tn)),m=`
    <div class="flex flex-wrap items-center justify-between gap-3">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${m}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){K.category=e,K.page=0,K.query="",tt()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");K.query=e?e.value:"",K.page=0,tt()};window.catalogPage=function(e){const i=K.query.trim()?1:Math.max(1,Math.ceil(0/tn));K.page=Math.max(0,Math.min(i-1,K.page+e)),tt()};window.catalogToggle=async function(e){const t=!Bt().includes(e),i=await Ke(e,t);b(t?"Listing hidden from storefront":"Listing restored",i.ok?"success":"info"),tt()};window.catalogResetHidden=async function(){await hn(),b("All hidden catalog listings restored"),tt()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Za(){window.lucide&&lucide.createIcons(),mi(),await Fn(),y.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){T.user=null;const i=document.getElementById("login-screen");i&&(i.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Za):Za();
