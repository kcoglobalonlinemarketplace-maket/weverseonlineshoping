import{supabase as f}from"./supabase-client-D1iyov-x.js";import{b as w,c as O,e as I}from"./localization-CfMNUAGI.js";const k="https://wttnvwpoqmbxryivcerf.supabase.co/functions/v1/ai-customer-assistant",C="sb_publishable_X_6kXsJwApi7v7HwoC1xtA_igns4Rxa";let t={open:!1,history:[],sending:!1,voiceEnabled:localStorage.getItem("kco_voice")==="1",voiceAccent:localStorage.getItem("kco_voice_accent")||"US",welcomed:!1,proactiveShown:{},sessionId:null};function d(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}function E(e){let n=d(e);return n=n.replace(/`([^`]+)`/g,"<code>$1</code>"),n=n.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),n=n.replace(/^\- (.+)$/gm,"<li>$1</li>"),n=n.replace(/^\d+\. (.+)$/gm,"<li>$1</li>"),n=n.replace(/(<li>.*<\/li>\n?)+/g,a=>`<ul>${a}</ul>`),n=n.replace(/\n\n/g,"</p><p>"),n=n.replace(/\n/g,"<br>"),n=`<p>${n}</p>`,n=n.replace(/<ul><br>/g,"<ul>").replace(/<br><\/ul>/g,"</ul>"),n}function r(){return w()||localStorage.getItem("kco_language")||"en"}function S(){const e=window.location.pathname;return e.includes("checkout")?"checkout":e.includes("payment")?"payment":e.includes("auth")?"sign-in":e.includes("account")?"account":e.includes("details")?"product-details":e.includes("contact")?"contact":e.includes("help")?"help":e.includes("about")?"about":"home"}function M(){try{return JSON.parse(localStorage.getItem("kco_cart")||"[]").map(n=>({title:n.title||n.name,price:n.price,quantity:n.quantity||1}))}catch{return[]}}function u(e){if(t.voiceEnabled&&"speechSynthesis"in window)try{window.speechSynthesis.cancel();const n=new SpeechSynthesisUtterance(e.replace(/[*#`]/g,"")),a=r(),o=O(a);a==="en"?n.lang=t.voiceAccent==="UK"?"en-GB":"en-US":n.lang=o.lang,n.rate=o.rate,n.pitch=o.pitch;const i=I(a==="en"?(t.voiceAccent==="UK"?"en-GB":"en-US").slice(0,2):a);i&&(n.voice=i),window.speechSynthesis.speak(n)}catch{}}function y(){"speechSynthesis"in window&&window.speechSynthesis.cancel()}function B(){if(document.getElementById("kco-ai-styles"))return;const e=document.createElement("style");e.id="kco-ai-styles",e.textContent=`
  ...
  `,document.head.appendChild(e)}const p='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C7.58 2 4 5.58 4 10v4a3 3 0 0 0 3 3h1v-6H6v-1a6 6 0 0 1 12 0v1h-2v6h1a3 3 0 0 0 3-3v-4c0-4.42-3.58-8-8-8z" fill="#60a5fa"/><path d="M12 2C7.58 2 4 5.58 4 10v4a3 3 0 0 0 3 3h1v-6H6v-1a6 6 0 0 1 12 0v1h-2v6h1a3 3 0 0 0 3-3v-4c0-4.42-3.58-8-8-8z" stroke="#3b82f6" stroke-width="0.5"/></svg>',A='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.4 20.4l17.45-7.48a1 1 0 0 0 0-1.84L3.4 3.6a1 1 0 0 0-1.39 1.21L4 12l-1.99 7.19a1 1 0 0 0 1.39 1.21z" fill="white"/></svg>';function j(){B();const e=document.createElement("button");e.id="kco-ai-fab",e.setAttribute("aria-label","Customer Support"),e.className="fixed bottom-5 right-5 z-[60] flex items-center gap-2.5 px-5 py-3 rounded-xl text-white text-sm font-semibold shadow-lg transition-all hover:scale-105",e.style.background="#1e293b",e.style.border="1px solid rgba(255,255,255,0.12)",e.innerHTML=`
  ...
  `,a.appendChild(i),window.lucide&&lucide.createIcons(),x(),o||u(e.content)}function _(){const e=r(),n={en:`Welcome to KCO Global Online Marketplace!
...
Naweza kukusaidia vipi leo?`};s({role:"assistant",content:n[e]||n.en})}function G(){const e=document.getElementById("kco-ai-messages");if(!e)return;const n=document.createElement("div");n.id="kco-ai-typing",n.className="flex justify-start kco-ai-fade",n.innerHTML=`
