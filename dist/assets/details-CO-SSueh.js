...
import{supabase as f}from"./supabase-client-7_ZWSEp6.js";import"./localization-nQ48c_Cg.js";import{_ as W}from"./preload-helper-CLcXU_4U.js";import{c as $,S as z,l as O,f as U,a as E,b as F,P as G}from"./showroom-data-DaOtbE7A.js";import{g as Y,a as K,b as J,c as Q,f as X,T as Z,M as ee,C as te}from"./phone-data-B4y2Ws2K.js";import{g as w,f as _}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode-BNBNQJKC.js";import"./customer-ai-widget-DyAfCXiC.js";import"./brand-DYhAh01b.js";const h="/fallback.svg";function B(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function T(e){return Array.isArray(e)&&e.length>0?e:[h]}function ae(){return new URLSearchParams(window.location.search).get("id")}function re(e){const a=document.getElementById("details-content"),i=X(e),d=T(e.images).map((t,c)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${c===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${r(t)}">
  ...
  `;const g=document.getElementById("hero-image"),x=document.getElementById("gallery-label");a.querySelectorAll(".gallery-thumb").forEach((t,c)=>{t.addEventListener("click",()=>{a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.remove("active","border-blue-500")),a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.add("border-gray-800")),t.classList.add("active","border-blue-500"),t.classList.remove("border-gray-800"),g.src=t.dataset.img,x.textContent=s[c]||`View ${c+1}`})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await w()?window.location.href=`/checkout.html?id=${e.property_id}`:(_(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",async()=>{const t=window.location.href;try{if(navigator.share)await navigator.share({title:r(e.title),url:t});else{await navigator.clipboard.writeText(t);const c=document.getElementById("share-btn"),m=c.innerHTML;c.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Copied!',window.lucide&&lucide.createIcons(),setTimeout(()=>{c.innerHTML=m,window.lucide&&lucide.createIcons()},2e3)}}catch{}}),A(e),window.lucide&&lucide.createIcons()}function le(e){const a=document.getElementById("details-content"),i=E(e),d=T(e.images).map((t,c)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${c===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${r(t)}">
      <img src="${r(t)}" alt="View ${c+1}" loading="lazy" class="w-20 h-16 object-cover" onerror="this.onerror=null;this.src='${h}'">
  ...
  `;const g=document.getElementById("hero-image"),x=document.getElementById("gallery-label");a.querySelectorAll(".gallery-thumb").forEach((t,c)=>{t.addEventListener("click",()=>{a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.remove("active","border-blue-500")),a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.add("border-gray-800")),t.classList.add("active","border-blue-500"),t.classList.remove("border-gray-800"),g.src=t.dataset.img,x.textContent=s[c]||`View ${c+1}`})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await w()?window.location.href=`/checkout.html?id=${e.property_id}`:(_(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",async()=>{const t=window.location.href;try{if(navigator.share)await navigator.share({title:r(e.title),url:t});else{await navigator.clipboard.writeText(t);const c=document.getElementById("share-btn"),m=c.innerHTML;c.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Copied!',window.lucide&&lucide.createIcons(),setTimeout(()=>{c.innerHTML=m,window.lucide&&lucide.createIcons()},2e3)}}catch{}}),A(e,ee),window.lucide&&lucide.createIcons()}function ie(e){const a=document.getElementById("details-content"),i=E(e),d=T(e.images).map((t,c)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${c===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${r(t)}">
      <img src="${r(t)}" alt="View ${c+1}" loading="lazy" class="w-20 h-16 object-cover" onerror="this.onerror=null;this.src='${h}'">
  ...
  `;const g=document.getElementById("hero-image"),x=document.getElementById("gallery-label");a.querySelectorAll(".gallery-thumb").forEach((t,c)=>{t.addEventListener("click",()=>{a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.remove("active","border-blue-500")),a.querySelectorAll(".gallery-thumb").forEach(m=>m.classList.add("border-gray-800")),t.classList.add("active","border-blue-500"),t.classList.remove("border-gray-800"),g.src=t.dataset.img,x.textContent=s[c]||`View ${c+1}`})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await w()?window.location.href=`/checkout.html?id=${e.property_id}`:(_(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",async()=>{const t=window.location.href;try{if(navigator.share)await navigator.share({title:r(e.title),url:t});else{await navigator.clipboard.writeText(t);const c=document.getElementById("share-btn"),m=c.innerHTML;c.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Copied!',window.lucide&&lucide.createIcons(),setTimeout(()=>{c.innerHTML=m,window.lucide&&lucide.createIcons()},2e3)}}catch{}}),A(e,te),window.lucide&&lucide.createIcons()}function oe(e){const i=e.listing_type==="property"?"Share Property":"Share";return`
  ...
  `}function M(e){const a=e.listing_type==="property",i=`/contact.html?listing=${encodeURIComponent(e.property_id||"")}`;return`
    ...
    </div>`}function se(e){const a=e.images&&e.images[0]||"/fallback.svg";return`<a href="/details.html?id=${encodeURIComponent(e.property_id)}" class="block bg-gray-900/60 border border-gray-800 rounded-xl overflow-hidden hover:border-blue-500/30 transition group">
    ...
    </a>`}function j(e,a){const i=document.getElementById(e);if(!i)return;const u=i.querySelector(".rel-grid");if(u){if(!a.length){i.classList.add("hidden");return}i.classList.remove("hidden"),u.innerHTML=a.slice(0,4).map(se).join("")}}function A(e,a){let i;a?i=a.filter(o=>o.property_id!==e.property_id):e.listing_type==="pet"?i=G.filter(o=>o.property_id!==e.property_id):i=Z.filter(o=>o.property_id!==e.property_id);const u=i.filter(o=>o.category===e.category),d=i.filter(o=>o.breed&&o.breed===e.breed||o.brand&&o.brand===e.brand),s=[...i].sort((o,b)=>(b.rating||0)-(o.rating||0));j("similar-section",u.length?u:s.slice(0,4)),j("related-section",d.length?d:s.slice(0,4)),j("recommended-section",s)}function D(e){const a=document.getElementById("details-content"),i=e.listing_type==="property",u=E(e),d=F(e.country_code),s=e.listing_type==="product"?"Product ID":i?"Property ID":"Listing ID",b=T(e.images).map((n,l)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${l===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${r(n)}">
  ...
  `;const m=document.getElementById("hero-image");a.querySelectorAll(".gallery-thumb").forEach(n=>{n.addEventListener("click",()=>{a.querySelectorAll(".gallery-thumb").forEach(l=>l.classList.remove("active","border-blue-500")),a.querySelectorAll(".gallery-thumb").forEach(l=>l.classList.add("border-gray-800")),n.classList.add("active","border-blue-500"),n.classList.remove("border-gray-800"),m.src=n.dataset.img})}),document.getElementById("buy-now-btn").addEventListener("click",async()=>{await w()?window.location.href=`/checkout.html?id=${e.property_id}`:(_(`/checkout.html?id=${e.property_id}`),window.location.href=`/auth.html?redirect=${encodeURIComponent("/checkout.html?id="+e.property_id)}`)}),document.getElementById("share-btn").addEventListener("click",async()=>{const n=window.location.href;try{if(navigator.share)await navigator.share({title:r(e.title),url:n});else{await navigator.clipboard.writeText(n);const l=document.getElementById("share-btn"),S=l.innerHTML;l.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Copied!',window.lucide&&lucide.createIcons(),setTimeout(()=>{l.innerHTML=S,window.lucide&&lucide.createIcons()},2e3)}}catch{}});const R=document.getElementById("view-details-btn");R&&R.addEventListener("click",()=>{const n=document.getElementById("listing-details");n&&n.scrollIntoView({behavior:"smooth",block:"start"})});const I=document.getElementById("add-cart-btn");I&&I.addEventListener("click",()=>{let n=JSON.parse(localStorage.getItem("kco_cart")||"[]");n.includes(e.property_id)||(n.push(e.property_id),localStorage.setItem("kco_cart",JSON.stringify(n))),I.innerHTML='<i data-lucide="check" class="w-5 h-5"></i> Added to Cart',window.lucide&&lucide.createIcons(),setTimeout(()=>{I.innerHTML='<i data-lucide="shopping-cart" class="w-5 h-5"></i> Add to Cart',window.lucide&&lucide.createIcons()},2e3)}),ce(e),ne(e),N(e),ue(e),window.lucide&&lucide.createIcons(),e.property_id,e.title,parseFloat(e.price),e.currency;const y=document.getElementById("listing-map");if(y&&window.L){const n=parseFloat(e.latitude)||null,l=parseFloat(e.longitude)||null,S=[e.town,e.city,e.state,e.country].filter(Boolean).join(", ");if(n&&l){const v=L.map(y).setView([n,l],13);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(v),L.marker([n,l]).addTo(v).bindPopup(e.title)}else S?fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(S)).then(v=>v.json()).then(v=>{if(v&&v[0]){const P=parseFloat(v[0].lat),H=parseFloat(v[0].lon),q=L.map(y).setView([P,H],12);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(q),L.marker([P,H]).addTo(q).bindPopup(e.title)}else y.style.display="none"}).catch(()=>{y.style.display="none"}):y.style.display="none"}}let k=0,V=!1;function de(){if(V)return;V=!0;const e=document.createElement("style");e.textContent="@keyframes kcoWishPop{0%{transform:scale(1)}35%{transform:scale(1.45)}60%{transform:scale(.86)}100%{transform:scale(1)}}",document.head.appendChild(e)}function C(e,a){if(!e)return;de(),e.innerHTML=`<i data-lucide="heart" class="w-5 h-5 ${a?"fill-red-500 text-red-500":""}"></i>`,e.classList.toggle("bg-red-500/10",a),e.classList.toggle("border",a),e.classList.toggle("border-red-500/20",a);const i=e.querySelector("span");i&&(i.textContent=a?"Saved to Wishlist":"Add to Wishlist"),window.lucide&&lucide.createIcons();const u=e.querySelector("i");u&&(u.style.animation="none",u.offsetWidth,u.style.animation="kcoWishPop .5s cubic-bezier(.34,1.56,.64,1)",setTimeout(()=>{u&&(u.style.animation="")},550))}async function ce(e){const a=document.getElementById("wishlist-btn");if(!a)return;const i=await w();if(!i){a.addEventListener("click",()=>{_(window.location.pathname+window.location.search),window.location.href=`/auth.html?redirect=${encodeURIComponent(window.location.pathname+window.location.search)}`});return}const{data:u,error:d}=await f.from("wishlist").select("id").eq("user_id",i.id).eq("listing_id",e.id).maybeSingle();if(d){console.error("Wishlist check failed:",d.message);return}u&&C(a,!0),a.addEventListener("click",async()=>{const{data:s,error:o}=await f.from("wishlist").select("id").eq("user_id",i.id).eq("listing_id",e.id).maybeSingle();if(o){console.error("Wishlist toggle failed:",o.message);return}if(s){const{error:b}=await f.from("wishlist").delete().eq("id",s.id);if(b){console.error("Wishlist delete failed:",b.message);return}C(a,!1)}else{const{error:b}=await f.from("wishlist").insert({user_id:i.id,listing_id:e.id});if(b){console.error("Wishlist insert failed:",b.message);return}C(a,!0)}})}async function ne(e){const a=document.getElementById("review-form"),i=document.getElementById("review-login-msg"),u=await w();if(!u){a.classList.add("hidden"),i.classList.remove("hidden");return}document.querySelectorAll(".star-btn").forEach(d=>{d.addEventListener("click",()=>{k=parseInt(d.dataset.rating,10),document.querySelectorAll(".star-btn").forEach((s,o)=>{const b=s.querySelector("i");o<k?(b.classList.add("fill-blue-500","text-blue-500"),b.classList.remove("text-gray-600")):(b.classList.remove("fill-blue-500","text-blue-500"),b.classList.add("text-gray-600"))})})}),a.addEventListener("submit",async d=>{d.preventDefault();const s=document.getElementById("review-text").value.trim();if(!k){alert("Please select a rating.");return}if(!s){alert("Please write a review.");return}const{error:o}=await f.from("product_reviews").insert({listing_id:e.id,user_id:u.id,rating:k,review_text:s,is_approved:!1});if(o){alert("Error: "+o.message);return}document.getElementById("review-text").value="",k=0,document.querySelectorAll(".star-btn").forEach(b=>{const p=b.querySelector("i");p.classList.remove("fill-blue-500","text-blue-500"),p.classList.add("text-gray-600")}),alert("Review submitted! It will appear after admin approval."),N(e)})}async function N(e){const a=document.getElementById("reviews-list");if(!a||!e.id)return;const{data:i,error:u}=await f.from("product_reviews").select("*, profiles(full_name)").eq("listing_id",e.id).eq("is_approved",!0).order("created_at",{ascending:!1});if(u){a.innerHTML='<p class="text-gray-500 text-sm">Unable to load reviews.</p>';return}if(!i||i.length===0){a.innerHTML='<p class="text-gray-500 text-sm">No reviews yet. Be the first to review this product!</p>';return}a.innerHTML=i.map(d=>`
    ...
    </a>`}).join("")}function r(e){return String(e||"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}async function be(){const e=ae();if(!e){document.getElementById("details-content").innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>';return}const a=Y(e);if(a){$(a),document.title=`${a.title} | Weverse Online Shop`,re(a);return}const i=K(e);if(i){$(i),document.title=`${i.title} | Weverse Online Shop`,le(i);return}const u=J(e);if(u){$(u),document.title=`${u.title} | Weverse Online Shop`,ie(u);return}const d=Q(e);if(d){$(d),document.title=`${d.title} | Weverse Online Shop`,D(d);return}let s=z.find(o=>o.property_id===e);if(!s){const[{generateListingById:o},{loadHiddenCatalogIds:b}]=await Promise.all([W(()=>import("./catalog-CESpPuFx.js"),__vite__mapDeps([0,1,2])),W(()=>import("./catalog-hidden-store-DbF0xVeS.js"),__vite__mapDeps([1,2]))]);await b(),s=o(e)}if(s||(await O(),s=U(e)),!s){document.getElementById("details-content").innerHTML='<div class="text-center py-20 text-gray-500">Listing not found.</div>';return}$(s),document.title=`${s.title} | Weverse Online Shop`,D(s)}be();
