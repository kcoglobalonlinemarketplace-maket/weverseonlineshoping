...
import{supabase as v}from"./supabase-client-7_ZWSEp6.js";import"./localization-BgENzFMA.js";import{_ as A}from"./preload-helper-CLcXU_4U.js";import{S as W,l as F,f as D,a as R,b as z}from"./showroom-data-BoOhjLzR.js";import{g as V,f as U,T as N}from"./truck-data-CXeZJZHb.js";import{g as k,f as E}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode--LNNFeKP.js";import"./customer-ai-widget-CGt2w8Sc.js";import"./brand-DYhAh01b.js";const y="/fallback.svg";function P(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function q(e){return Array.isArray(e)&&e.length>0?e:[y]}function O(){return new URLSearchParams(window.location.search).get("id")}function G(e){const t=document.getElementById("details-content"),a=U(e),n=q(e.images).map((d,m)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${m===0?"active border-blue-500":"border-gray-800"} shrink-0" data-img="${l(d)}">
