import{s as p,S as K,D as qa,i as ja,a as Oa}from"./supabase-client-Crqgup_-.js";import{a as Ha,g as Ga,C as fe,A as za}from"./localization-BYpHq8Wx.js";import{patchLocalShowroomListing as Wa,getLocalShowroomListingById as xt,removeLocalShowroomListing as Va,upsertLocalShowroomListing as ot,listLocalShowroomListings as wt}from"./local-showroom-store-mzP0nSoS.js";import{g as Wt,s as Ka,l as Ya,a as Ja,b as Qa}from"./payment-settings-D0NB-G1r.js";import{PRODUCT_LISTINGS as Vt}from"./products-data-CGLFLAJM.js";import{PRODUCT_EXTRA_LISTINGS as Kt}from"./products-extra-DecCj9NU.js";import{TRUCK_LISTINGS as Yt}from"./truck-data-DnyLExat.js";import{MOTORHOME_LISTINGS as Jt}from"./motorhome-data-SSjGu6g8.js";import{getCatalogCategory as Qt,getCatalogCategories as Xa,generateProduct as Ut}from"./catalog-tnxi9f0-.js";import{M as Za,a as ei,n as ti}from"./categories-BEuiwWw5.js";import{saveCatalogHidden as Xt,loadHiddenCatalogIds as _t,getHiddenCatalogIds as He,resetHiddenCatalogIds as ai}from"./catalog-hidden-store-CaPr0Ta1.js";const N=1,H=5e6,ii=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],oi=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Zt=[...ii,...oi];function kt(e){return Ha[e]||"USD"}function ea(e,t){return Zt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function ni(e,t){const a=Math.max(N,Math.min(H,Number(e)||N));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function ri(e,t,a,i,o){const n=ni(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${n}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${o}. Offered at ${n}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${n}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${n}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${n}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${n}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${n}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${n}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${n}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${n}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function ta({templateId:e,listingType:t,category:a,countryCode:i,currency:o,price:n}){const r=Zt.find(f=>f.id===e&&f.listingType===t);if(!r)return null;const l=Ga(i)||fe[0],c=o||kt(l.code),d=[l.name].filter(Boolean).join(", "),b={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${l.name}`:r.label,description:ri(r,l,c,n,d),currency:c,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...b,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...b,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const aa="weverseonlineshop@gmail.com",ia="Weverse Online Shop",oa="GLOBAL SHOPPING • WORLDWIDE DELIVERY",si="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),li=`${si}/functions/v1/ai-admin-assistant`,di=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],ci={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},na=[...za].sort();let k={user:null,section:"dashboard"};function s(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function ra(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function Y(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function le(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function St(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const ui=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents"];function ge(e){const t={};if(!e||typeof e!="object")return t;for(const a of ui)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),o=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const n={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};o&&(o.setAttribute("data-lucide",n[t]||"info"),o.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function j(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",s(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function ie(){document.getElementById("modal-container").innerHTML=""}function U(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function D(e,t,a,i,o=""){const n={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
  ...
  </div>`}function he(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function ce(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${s(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${s(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function sa(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=di.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){k.section=e;const t=ci[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),sa(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=he()),window.lucide&&lucide.createIcons(),({dashboard:Pi,products:R,properties:Ke,catalog:_e,orders:Pa,customers:eo,reviews:Le,messages:Ea,coupons:Ye,ads:we,notifications:io,ai:pi,"ai-settings":Ta,"homepage-branding":Xe,"promo-bg":Ie,content:uo,"content-settings":Ba,seo:bo,email:go,analytics:mo,security:Qe,activity:yo,brand:Ze,"payment-settings":vt,backup:fo,settings:ho,publish:et}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=ce("construction","Coming Soon",`${t} is being built.`))}))()};async function pi(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const be="kco_admin_remember",$t="kco_login_attempts",nt=5,mi=15*60*1e3;function F(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function bi(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function Ge(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Ae(e){return String(e||"").trim().toLowerCase()}function gi(){try{const e=JSON.parse(localStorage.getItem(be)||"{}");e?.email&&!Ae(e.email)&&localStorage.removeItem(be)}catch{localStorage.removeItem(be)}}function yi(){try{const e=JSON.parse(localStorage.getItem(be)||"{}");return Ae(e?.email)}catch{return""}}function Pt(){gi();const e=yi(),t=document.getElementById("login-email");t&&(t.value=e||t.value||aa,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function fi(){return`${window.location.origin}/admin.html`}function ue(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),Ge(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function M(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function la(){try{return JSON.parse(localStorage.getItem($t)||'{"count":0}')}catch{return{count:0}}}function da(){const e=la();return e.count=(e.count||0)+1,e.count>=nt&&(e.lockedUntil=Date.now()+mi),localStorage.setItem($t,JSON.stringify(e)),e}function ca(){localStorage.removeItem($t)}function ua(){const e=la();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(ca(),null):Math.ceil(t/6e4)}async function Z(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await hi(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function hi(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function pa(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Ae(e.email)===aa}async function vi(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){De(),$i();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await pa(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),o=await p.auth.mfa.getAuthenticatorAssuranceLevel(),n=o.data?.currentLevel;if(o.data?.nextLevel==="aal2"&&n!=="aal2"){k.user=t.user,De(),ue("2fa"),Et();return}k.user=t.user,ze();return}xi()}function De(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function xi(){De(),ue("login"),Pt(),ma(),ba(),Et(),wi();const e=ua();e&&(F(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function wi(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function ma(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",_i),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>ue("forgot")))}async function _i(e){e.preventDefault();const t=ua();if(t){F(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Ae(a?.value);if(!i){F("Enter your admin email address."),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const o=document.getElementById("login-password").value,n=document.getElementById("remember-me")?.checked;M("login-btn",!0),Ge();const{data:r,error:l}=await p.auth.signInWithPassword({email:i,password:o});if(l||!r.user){const y=String(l?.message||"").toLowerCase();if(y.includes("missing supabase credentials")||y.includes("authentication service is unavailable")){F("Authentication is temporarily unavailable due to configuration. Please contact support."),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("failed to fetch")||y.includes("network request failed")){F("Network error while signing in. Check your connection and try again."),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("email not confirmed")){F("Your admin email is not confirmed yet. Open your verification email and confirm first."),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const g=da(),m=nt-g.count,h=g.lockedUntil?`Account locked for 15 minutes after ${nt} failed attempts.`:`Invalid email or password. ${m>0?m+" attempt"+(m!==1?"s":"")+" remaining.":""}`;F(h),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await Z(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await pa(r.user)){await p.auth.signOut(),F(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await Z(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(n?localStorage.setItem(be,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(be),ca(),k.user=r.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){M("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),ue("2fa"),Et(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await Z(r.user.id,"login_success"),M("login-btn",!1),ze()}function Et(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",qt));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&qt()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),k.user=null,ue("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const o=document.getElementById("backup-code");o&&o.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",ki))}async function qt(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){F("Enter the 6-digit code from your authenticator app.");return}M("verify-2fa-btn",!0),Ge();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){F("No 2FA factor found. Please re-login."),M("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:o}=await p.auth.mfa.challenge({factorId:a.id});if(o)throw o;const{error:n}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(n)throw n;await Z(k.user.id,"login_2fa_success"),M("verify-2fa-btn",!1),ze()}catch(t){da(),F(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),M("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function ki(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){F("Enter a backup recovery code.");return}M("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",k.user.id).maybeSingle();if(!t?.backup_codes?.length){F("No backup codes found."),M("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!o.used)){F("Backup code not found or already used."),M("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(o=>(o.code||o).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof o=="object"?o:{code:o},used:!0}:o);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",k.user.id),await Z(k.user.id,"login_backup_code_used"),ze()}catch(t){F(t.message),M("verify-backup-btn",!1,"Use Backup Code")}}function ba(){document.getElementById("back-to-login")?.addEventListener("click",()=>ue("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Si)}async function Si(){const e=document.getElementById("reset-email"),t=Ae(e?.value);if(!t){F("Enter your admin email address to receive a reset link.");return}M("send-reset-btn",!0),Ge();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:fi()});if(M("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){F(a.message);return}bi("Reset link sent! Check your inbox and open it from this device to continue.")}function $i(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.handlePasswordResetSubmit=async function(){const e=document.getElementById("new-pw-reset")?.value,t=document.getElementById("confirm-pw-reset")?.value,a=document.getElementById("reset-pw-error");if(e!==t){a&&(a.textContent="Passwords do not match.",a.classList.remove("hidden"));return}if((e||"").length<8){a&&(a.textContent="Password must be at least 8 characters.",a.classList.remove("hidden"));return}const{error:i}=await p.auth.updateUser({password:e});if(i){a&&(a.textContent=i.message,a.classList.remove("hidden"));return}u("Password updated! Please log in with your new password."),window.location.hash="",setTimeout(()=>window.location.reload(),1500)};function ze(){const e=document.getElementById("login-screen");e&&(e.style.display="none");const t=document.getElementById("admin-user-email");t&&k.user&&(t.textContent=k.user.email||"Admin"),Pt(),navigate("dashboard")}window.adminSignOut=async function(){k.user&&await Z(k.user.id,"logout"),await p.auth.signOut(),k.user=null,De(),ue("login"),Pt(),ma(),ba()};window.logoutAllDevices=async function(){confirm("This will sign you out on ALL devices. Continue?")&&(k.user&&await Z(k.user.id,"logout_all_devices"),await p.auth.signOut({scope:"global"}),k.user=null,u("Signed out from all devices."),setTimeout(()=>window.location.reload(),1200))};async function Pi(){const e=document.getElementById("content");try{const[t,a,i,o]=await Promise.all([p.from("showroom_listings").select("id,listing_type,is_active,price",{count:"exact"}),p.from("payment_receipts").select("id,order_number,amount,status,created_at",{count:"exact"}).order("created_at",{ascending:!1}).limit(200),p.from("profiles").select("user_id,created_at",{count:"exact"}),p.from("product_reviews").select("id,is_approved",{count:"exact"})]),n=t.data||[],r=a.data||[],l=r.filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,E)=>v+(parseFloat(E.amount)||0),0),c=r.filter(v=>["pending","pending_verification","processing"].includes(v.status)).length,d=n.filter(v=>v.listing_type!=="property").length,b=n.filter(v=>v.listing_type==="property").length,f=n.filter(v=>v.listing_type!=="property"&&v.is_active).length,y=i.count||0,g=o.count||0,m=(o.data||[]).filter(v=>!v.is_approved).length,h=new Date,A=r.filter(v=>{const E=new Date(v.created_at);return E.getMonth()===h.getMonth()&&E.getFullYear()===h.getFullYear()}).filter(v=>["approved","payment_approved","delivered"].includes(v.status)).reduce((v,E)=>v+(parseFloat(E.amount)||0),0),x=r.slice(0,6);e.innerHTML=`
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${D("Total Revenue",`$${l.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${A.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${D("Total Orders",r.length,"shopping-bag","blue",`${c} pending`)}
          ${D("Customers",y,"users","violet")}
          ${D("Products",d,"package","amber",`${f} active`)}
            ...
            ${x.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':x.map(v=>`
                <div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
                  <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-gray-500">${le(v.created_at)}</p>
                  </div>
      ...
      </div>`,window.lucide&&lucide.createIcons(),fa(r)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}async function R(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").neq("listing_type","property").order("created_at",{ascending:!1}),i=new Set,o=[];for(const d of a?[]:t||[])d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));for(const d of wt().filter(b=>b.listing_type!=="property"))d&&d.property_id&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));if(Array.isArray(K))for(const d of K.filter(b=>b.listing_type!=="property"&&b.property_id))i.has(d.property_id)||(i.add(d.property_id),o.push(d));const n=[...Vt,...Kt,...Yt,...Jt];for(const d of n)d&&d.property_id&&d.listing_type!=="property"&&!i.has(d.property_id)&&(i.add(d.property_id),o.push(d));o.sort((d,b)=>new Date(b.created_at||0)-new Date(d.created_at||0));try{await _t()}catch{}const r=new Set(He());if(r.size)for(let d=o.length-1;d>=0;d--)o[d]&&o[d].property_id&&r.has(o[d].property_id)&&o.splice(d,1);const l=[...new Set(o.map(d=>d.category).filter(Boolean))].sort((d,b)=>d.localeCompare(b)),c=[...new Set(o.flatMap(d=>Array.isArray(d.tags)?d.tags:[]).filter(Boolean))].sort((d,b)=>d.localeCompare(b));window._productFilters||(window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"}),window._productSelection||(window._productSelection=new Set),e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${D("Inventory Units",o.reduce((d,b)=>d+(parseInt(b.stock_quantity,10)||0),0),"boxes","blue")}
          ${D("Avg Price",`$${Math.round(o.reduce((d,b)=>d+(parseFloat(b.price)||0),0)/Math.max(o.length,1)).toLocaleString()}`,"dollar-sign","blue")}
        </div>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=o,window._productsCardLimit=60,ga(o),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}function oe(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function rt(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ei(e){const t=oe(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Ii(e){const t=oe(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function It(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function st(e){return parseInt(e.views??e.view_count??0,10)||0}function lt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function At(e){return e.sku||e.property_id||"N/A"}function Ai(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=rt(e),i=It(e),o=window._productSelection?.has(e.property_id),n=j(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=Y(e.created_at),l=!!e.is_featured,c=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",b=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${s(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${o?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${s(Ei(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${st(e).toLocaleString()}</p></div>
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Sales</span><p class="text-cyan-300 font-bold">${lt(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1.5">${a.slice(0,6).map(f=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${s(f)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function Ci(e,t){const a=[...e],i=o=>new Date(o||0).getTime()||0;return t==="oldest"?a.sort((o,n)=>i(o.created_at)-i(n.created_at)):t==="price-high"?a.sort((o,n)=>oe(n.price)-oe(o.price)):t==="price-low"?a.sort((o,n)=>oe(o.price)-oe(n.price)):t==="sales-high"?a.sort((o,n)=>lt(n)-lt(o)):t==="views-high"?a.sort((o,n)=>st(n)-st(o)):a.sort((o,n)=>i(n.created_at)-i(o.created_at)),a}function ga(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const o=window._productsCardLimit||60,n=e.slice(0,o);t.innerHTML=n.map(Ai).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const l=e.length-n.length;l>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function ya(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const o=i.images&&i.images[0]?i.images[0]:"/fallback.svg",n=It(i),r=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,c=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const d=oe(i.price),b=parseFloat(i.real_price);return Number.isFinite(b)&&b>0&&b>d?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${b.toLocaleString()}</span><span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`})()}
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${i.stock_quantity!=null?s(i.stock_quantity):"Unlimited"}</span></td>
          <td>${j(n==="archived"?"inactive":n==="active"?"active":"inactive")}</td>
          <td><span class="text-xs text-gray-500">${Y(i.created_at)}</span></td>
          <td>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${oe(a.price).toLocaleString()}</p></div>
    ...
    </div>`),Tt(),Lt(),xe(),pe(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=[...document.querySelectorAll("#image-preview .img-thumb img")].map(b=>b.getAttribute("src")).filter(b=>b&&!String(b).startsWith("blob:")),o={title:a.get("title")||"Untitled Product",price:Math.max(N,Math.min(H,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"||i.length>=24,images:i},n=String(a.get("real_price")||"").trim(),r=n===""?null:parseFloat(n);if(r!=null&&!Number.isFinite(r)){u("Real Price must be a number.","error");return}const l=ge((window._productsData||[]).find(b=>b.property_id===t)),c=l.specifications&&typeof l.specifications=="object"?l.specifications:{};o.specifications={...c,real_price:r!=null&&r>0?Math.round(r):null};const{error:d}=await p.from("showroom_listings").upsert({...l,...o,property_id:t},{onConflict:"property_id"});if(d){if(G(d)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),ie(),R();return}Wa(t,o),u("Quick edit saved locally","info")}else u(o.is_active?"Saved & published — your showroom shows it now":"Quick edit saved (draft)");ie(),R()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(i=>i.property_id===e)||(window._propertiesData||[]).find(i=>i.property_id===e)||xt(e),{error:a}=await p.from("showroom_listings").delete().eq("property_id",e);if(a&&!G(a))return u("Delete failed: "+a.message,"error");Va(e);try{const i=await Xt(e,!0);i&&i.error&&G(i.error)?u("⚠️ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Product deleted")}catch{u("Product deleted")}t&&t.listing_type==="property"?Ke():R()};window.clearAllProducts=async function(){const e=(window._productsData||[]).length;if(!confirm(`Delete ALL ${e} product(s) from the Product Manager and the database now?
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await p.from("showroom_listings").delete().neq("property_id","__none__");if(t)return G(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}u("All products deleted. The manager now shows your showroom catalog."),R()};window.openProductMoreActions=function(e){U(`
    ...
    </div>`),Tt(),Lt(),ut("pf-price"),ut("pf-real_price"),pt(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>pt(e,"pricing")),Di(e,t.property_id||""),window._pfEscapeHandler=n=>{n.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),ie(),R()};window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[o,n]of i.entries())o==="images"?(a.images=a.images||[],n&&!String(n).startsWith("blob:")&&a.images.push(String(n))):o==="tags"?(a.tags=a.tags||[],a.tags.push(n)):a[o]=n;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};function ve(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image (main photo)":"Image "+(t+1)}">
  ...
  </div>`}function Tt(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Mi(t.dataTransfer.files)}))}function Lt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>xe()})}window.handleImageUpload=async function(e){await wa(e.target.files)};async function Mi(e){await wa(e)}async function wa(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await Ve(a);if(i){const o=t.children.length,n=document.createElement("div");n.innerHTML=ve(i,o),t.appendChild(n.firstElementChild),xe()}}Ce(),pe(),window.lucide&&lucide.createIcons()}}async function Ve(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:o}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(o)return URL.createObjectURL(e);const{data:n}=p.storage.from("product-images").getPublicUrl(i);return n.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),xe(),Ce(),pe()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const o=await Ve(i);if(!o)return;const r=[...a.querySelectorAll(".img-thumb")][e];if(!r)return;const l=r.querySelector("img");l&&(l.src=o),xe(),Ce(),pe(),u("Image replaced. Save changes to apply.","info")};function xe(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const o=a.querySelector("img");if(!o)return;const n=document.createElement("input");n.type="hidden",n.name="images",n.id=`img-url-${i}`,n.value=o.src,t.appendChild(n),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const c=a.querySelector(".rp-input");c&&(c.id=`rp-input-${i}`,c.onchange=()=>replaceImage(i,c))}))}function Ce(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function pe(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=e.querySelectorAll(".img-thumb").length,i=a>=24;t.textContent=i?"✓ "+a+" / 24 images — this product will auto-publish on save":a+" / 24 images"+(a>=12?" — almost there, keep going for a full gallery":""),t.className="text-sm mt-1 font-bold "+(i?"text-emerald-300":"text-gray-400");const o=document.querySelector('#product-form [name="is_active"]');i&&o&&!o.checked&&(o.checked=!0)}function Ee(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Fi(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,o]of t.entries())i==="images"?o&&!String(o).startsWith("blob:")&&a.images.push(String(o)):i==="tags"?a.tags.push(String(o)):a.fields[i]=String(o);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Ri(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([o,n])=>{const r=e.querySelector(`[name="${o}"]`);r&&(r.type==="checkbox"?r.checked=n==="on"||n===!0:r.value=n==null?"":String(n))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(o=>{o.checked=i.includes(o.value)}),Array.isArray(t.images)){const o=document.getElementById("image-preview");o&&(o.innerHTML=t.images.map((n,r)=>ve(n,r)).join(""),xe(),Ce(),pe())}return!0}function bt(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,n=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,c=k.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(y=>y.value),b=document.querySelectorAll("#image-preview .img-thumb").length,f=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    <div class="space-y-3">
      ...
      ${V.map((t,a)=>Vi(t,a)).join("")}
    </div>`,window.lucide&&lucide.createIcons()}};window.scanReviewContinue=async function(e){const t=V[e];if(!t)return;const a=_a(t,Te),i=Bt(t.category);if(t.listing_type==="property"||i&&i.listing_type==="property"){(X==="s1-scan-status"||X==="scanner-scan-status")&&(ie(),se=[],ae=[]),Ki(t,a);return}const n=i.category||t.category||"Other";if(X==="s1-scan-status"||X==="scanner-scan-status"){try{localStorage.removeItem(Ee(n,""))}catch{}se=[],ae=[],showAddProductStep2(n,{images:a}),await Ot(t,a,n)}else{const r=document.getElementById("product-form"),l=r&&r.dataset.category||"";if(n!==l){try{localStorage.removeItem(Ee(n,""))}catch{}switchProductFormCategory(n);const c=document.getElementById(X);c&&(c.classList.remove("hidden"),c.classList.add("text-blue-300"),c.textContent=`Category changed to ${n} — finishing the scan…`),window.lucide&&lucide.createIcons()}await Ot(t,a,n)}};window.scanReviewEdit=function(e){const t=V[e];if(!t)return;const a=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!a)return;const i=Bt(t.category),n=t.listing_type==="property"||i&&i.listing_type==="property"?"Real Estate":i.category||t.category||"Other",r=re.map(l=>`<option value="${s(l)}" ${l===n?"selected":""}>${s(l)}</option>`).join("");a.innerHTML=`
    ...
    <div class="flex flex-wrap gap-2">
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=V[e];if(!t)return;const a=document.getElementById(`sr-name-${e}`)?.value,i=document.getElementById(`sr-brand-${e}`)?.value,o=document.getElementById(`sr-model-${e}`)?.value,n=document.getElementById(`sr-cat-${e}`)?.value;a&&(t.detected_name=a),i&&(t.brand=i),o&&(t.model=o),n&&(t.category=n),scanReviewRender()};window.scanReviewRemove=function(e){V.splice(e,1),scanReviewRender()};window.scanReviewCancel=function(){const e=document.getElementById(X);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled — nothing was changed.")};function ka(e){const t=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},i=e&&e.price?e.price:null,o=[],n=w=>Array.isArray(w)?w.join(", "):String(w??"").trim(),r=(w,S)=>{if(S==null||n([S])==="")return;const q=document.querySelector(`#property-form [name="${w}"]`);q&&(q.value=String(S),o.push(w))},l=t.property_type||a.property_type;if(l){const w=Wi(l);w&&r("property_type",w)}r("title",a.title||t.detected_name),r("description",a.description),r("subcategory",t.subcategory||a.subcategory);const c=t.bedrooms??a.bedrooms;c!=null&&c!==""&&r("bedrooms",parseInt(c,10)||c);const d=t.bathrooms??a.bathrooms;d!=null&&d!==""&&r("bathrooms",parseInt(d,10)||d),r("building_size",t.building_size||a.building_size),r("land_size",t.land_size||a.land_size);const b=t.parking_spaces??a.parking_spaces;b!=null&&b!==""&&r("parking_spaces",parseInt(b,10)||b);const f=String(t.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(f)?r("furnished","Furnished"):/unfurnished|no|empty/.test(f)&&r("furnished","Unfurnished");const y=String(t.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(y)?r("listing_status","rent"):/sale|buy|purchase/.test(y)&&r("listing_status","sale");const g=t.area||a.area;g&&!(t.town||a.town)&&r("town",g),r("town",t.town||a.town),r("city",t.city||a.city),r("state",t.state||a.state);const m=t.country||a.country;if(r("country",m),m){const w=(fe||[]).find(S=>String(S.name||"").toLowerCase()===String(m).toLowerCase()||String(S.code||"").toLowerCase()===String(m).toLowerCase());if(w&&w.code){const S=document.querySelector('#property-form [name="country_code"]');S&&(S.value=w.code,o.push("country_code"))}}const h=t.address||a.address;r("product_location",h||[g||t.town||a.town,t.city||a.city,t.state||a.state,m].filter(Boolean).join(", ")),r("address",t.address||a.address),r("zip_code",t.zip_code||a.zip_code);const $=Number(t.latitude??a.latitude),A=Number(t.longitude??a.longitude);Number.isFinite($)&&$>=-90&&$<=90&&$!==0&&r("latitude",String($)),Number.isFinite(A)&&A>=-180&&A<=180&&A!==0&&r("longitude",String(A)),r("features_text",n(a.features)),r("highlights_text",n(t.highlights||a.highlights)),r("seo_keywords_text",n(a.seo_keywords));const x=t.half_bathrooms??a.half_bathrooms;x!=null&&x!==""&&r("half_bathrooms",parseInt(x,10)||x);const v=t.floors??a.floors;v!=null&&v!==""&&r("floors",parseInt(v,10)||v),r("garage",t.garage||a.garage);const E=t.year_built??a.year_built;E!=null&&E!==""&&r("year_built",parseInt(E,10)||E);const z=t.year_renovated??a.year_renovated;z!=null&&z!==""&&r("year_renovated",parseInt(z,10)||z);const J=t.condition||a.condition,de=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(J){const w=String(J).toLowerCase(),S=de.find(q=>w.includes(q.toLowerCase())||q.toLowerCase().includes(w));S&&r("condition",S)}r("interior_features_text",n(a.interior_features)),r("exterior_features_text",n(a.exterior_features)),r("home_systems_text",n(a.home_systems));const Be=n(t.landmarks||a.landmarks);Be&&r("landmarks_text",Be);const O=a.floor_plan;if(O&&typeof O=="object"){O.image&&r("floor_plan_image",O.image),O.levels&&r("floor_plan_levels",O.levels),O.total_area&&r("floor_plan_total_area",O.total_area);const w=Array.isArray(O.rooms)?O.rooms.map(S=>{const q=String(S).match(/^(.*?):\s*(.*)$/);return q?`${q[1].trim()}: ${q[2].trim()}`:String(S)}):[];w.length&&r("floor_plan_rooms",w.join(", "))}const C=a.nearby_area;C&&typeof C=="object"&&(Array.isArray(C.schools)&&C.schools.length&&r("nearby_schools_text",C.schools.join(", ")),Array.isArray(C.hospitals)&&C.hospitals.length&&r("nearby_hospitals_text",C.hospitals.join(", ")),Array.isArray(C.shopping)&&C.shopping.length&&r("nearby_shopping_text",C.shopping.join(", ")),Array.isArray(C.transportation)&&C.transportation.length&&r("nearby_transportation_text",C.transportation.join(", ")),Array.isArray(C.distances)&&C.distances.length&&r("nearby_distances_text",C.distances.join(", ")));const T=Array.isArray(a.legal_info)?a.legal_info.join(", "):n(a.legal_info);T&&r("legal_info_text",T),a.inspection_info&&r("inspection_info",a.inspection_info),a.risk_notes&&r("risk_notes",a.risk_notes);const me=document.querySelector('#property-form [name="verification_status"]');me&&(me.value="Not verified",o.push("verification_status"));const tt=new Set((Array.isArray(a.missing_fields)?a.missing_fields:[]).map(w=>String(w))),at=new Set(["title","description","price","real_price","features","highlights","seo_keywords","country","country_code","state","city","town","product_location","area","address","zip_code","latitude","longitude","landmarks_text","interior_features_text","exterior_features_text","home_systems_text","floor_plan_image","floor_plan_levels","floor_plan_total_area","floor_plan_rooms","nearby_schools_text","nearby_hospitals_text","nearby_shopping_text","nearby_transportation_text","nearby_distances_text","legal_info_text","inspection_info","risk_notes","documents_text","verification_date","verification_status"]);tt.forEach(w=>{if(at.has(w))return;const S=document.querySelector(`#property-form [name="${w}"]`);if(!(!S||S.type==="checkbox"||S.type==="radio"||S.type==="number")&&String(S.value||"").trim()===""){if(S.tagName==="SELECT"&&![...S.options].some(q=>q.value==="Not specified")){const q=document.createElement("option");q.value="Not specified",q.textContent="Not specified",S.appendChild(q)}S.value="Not specified",o.push(`${w} (Not specified)`)}});const Na=Number.isFinite(Number(N))?Number(N):0,Ua=Number.isFinite(Number(H))?Number(H):999999999,Nt=w=>Math.max(Na,Math.min(Ua,Math.round(w))),ke=i?Number(i.estimated_price):NaN,Me=i?Number(i.suggested_discount_price):NaN;if(Number.isFinite(ke)&&ke>0){const w=document.querySelector('#property-form [name="real_price"]');w&&(w.value=String(Nt(ke)),o.push("real_price"));const S=Number.isFinite(Me)&&Me>0&&Me<ke?Me:ke;r("price",String(Nt(S)))}return typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),{filled:o}}async function Ot(e,t,a){const i=document.getElementById("scan-ai-status"),o=(n,r)=>{i&&(i.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),r&&i.classList.add(r),i.innerHTML=n)};try{o("Completing the standard specifications for that product…","text-blue-300");const n=await I.completeProductSpecs(t,e,{category:a||"",maxImages:ee.maxImages});let r=null;o("Estimating a fair current market price…","text-blue-300");try{r=await I.estimateProductPrice(t,e,n||{},{category:a||"",maxImages:ee.maxImages})}catch{}const l=zi({identification:e,specs:n,price:r}),c=[e.year,e.brand,e.model].filter(Boolean).join(" ")||e.detected_name||"the product";let d=`${s(c)} — ${l.filled.length} field${l.filled.length>1?"s":""} ready for you (including the detailed description and suggested Real + Discount prices). Review and edit everything, then press SAVE / UPDATE.`;e.year_estimated&&(d+=" Confirm the model year before saving."),o(d,"text-emerald-300"),u(`Review ${c}, then press SAVE / UPDATE.`,"success")}catch(n){const r=String(n?.message||n),l=/key|api|configured|settings|vision/i.test(r);o(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${r}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()}window.scanProductWithAI=async function(){const e=document.getElementById("product-form");if(!e){u("Open the product form first.","error");return}const t=document.getElementById("btn-scan-ai"),a=document.getElementById("scan-ai-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one product image before scanning.","error");return}const o=t?t.innerHTML:"",n=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await I.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){n("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),n("Detecting every distinct product in your images…","text-blue-300");let r;try{r=await I.detectProducts(i,{category:e.dataset.category||"",maxImages:Math.min(i.length,ee.maxImages)})}catch(c){const d=String(c?.message||c),b=/key|api|configured|settings|vision/i.test(d);n(b?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=r&&r.identified!==!1&&Array.isArray(r.products)&&r.products.length?r.products:[];if(!l.length){n(r&&r.reason?`Could not identify any product: ${s(r.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}V=l,Te=i,X="scan-ai-status",scanReviewRender(),u(`${l.length} distinct product${l.length>1?"s":""} detected — review each one, then continue.`,"info")};function Ki(e,t){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),showAddPropertyModal();const a=document.getElementById("image-preview"),i=document.getElementById("image-url-inputs");a&&i&&(a.innerHTML=t.map((r,l)=>ve(r,l)).join(""),i.innerHTML=t.map((r,l)=>`<input type="hidden" name="images" id="img-url-${l}" value="${s(r)}">`).join(""),Ce(),pe());const o=document.getElementById("scan-ai-prop-status"),n=(r,l)=>{o&&(o.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),l&&o.classList.add(l),o.innerHTML=r)};n("Completing the standard specifications for this property…","text-blue-300"),I.completeProductSpecs(t,e,{category:"Real Estate",maxImages:ee.maxImages}).then(r=>I.estimateProductPrice(t,e,r||{},{category:"Real Estate",maxImages:ee.maxImages}).then(l=>{const c=ka({identification:e,specs:r,price:l});n(`${s(e.detected_name||"Property")} — ${c.filled.length} field${c.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success"),window.lucide&&lucide.createIcons()}).catch(()=>n("Price estimate skipped — review the details and set a price manually.","text-amber-300"))).catch(r=>{const l=/key|api|configured|settings|vision/i.test(String(r?.message||r));n(l?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(r?.message||r)}`,"text-red-400"),u("AI scan failed.","error")})}window.scanPropertyWithAI=async function(){if(!document.getElementById("property-form")){u("Open the property form first.","error");return}const t=document.getElementById("btn-scan-ai-prop"),a=document.getElementById("scan-ai-prop-status"),i=[...document.querySelectorAll('#image-url-inputs [name="images"]')||[]].map(c=>c.value).filter(Boolean);if(!i.length){u("Upload at least one property image before scanning.","error");return}const o=t?t.innerHTML:"",n=(c,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=c)};try{const c=await I.getConfig();if(!String(c.gemini_key||c.gemini_api_key||"").trim()){n("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),n("Identifying this property from your images…","text-blue-300");let r;try{r=await I.identifyProduct(i,{category:"Real Estate",maxImages:ee.maxImages})}catch(c){const d=String(c?.message||c),b=/key|api|configured|settings|vision/i.test(d);n(b?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}if(!r||r.identified===!1){n(r&&r.reason?`Could not identify the property: ${s(r.reason)}`:"The property could not be read from these images. Make sure the photos clearly show it, then try again.","text-amber-300"),u("The property could not be identified from the images.","error"),t&&(t.disabled=!1,t.innerHTML=o);return}t&&(t.disabled=!1,t.innerHTML=o);const l=await new Promise(c=>{Ue=y=>{Ue=null,c(y)};const d=document.getElementById("scan-ai-prop-status");if(!d){c({choice:"continue"});return}if(!window._propFormDirty){c({choice:"continue"});return}d.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300");const b=r.confidence||"medium",f={high:"text-emerald-400 border-emerald-500/20",medium:"text-amber-400 border-amber-500/20",low:"text-red-400 border-red-500/20"}[b]||"text-amber-400 border-amber-500/20";d.innerHTML=`
      ...
      </div>`});if(!l||l.choice==="cancel"){n("Scan cancelled — nothing was changed.","text-gray-400"),u("Scan cancelled.","info");return}try{n("Completing the standard specifications for this property…","text-blue-300");const c=await I.completeProductSpecs(i,r,{category:"Real Estate",maxImages:ee.maxImages});let d=null;n("Estimating a fair market value…","text-blue-300");try{d=await I.estimateProductPrice(i,r,c||{},{category:"Real Estate",maxImages:ee.maxImages})}catch{}const b=ka({identification:r,specs:c,price:d});n(`${s(r.detected_name||"Property")} — ${b.filled.length} field${b.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`,"text-emerald-300"),u("Review the property details, then press Publish Property.","success")}catch(c){const d=String(c?.message||c),b=/key|api|configured|settings|vision/i.test(d);n(b?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${d}`,"text-red-400"),u("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let se=[];window.handleStep1ImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)try{const i=await Ve(a);i&&se.push(i)}catch{}Sa(),e.target.value=""}};window.removeStep1Image=function(e){se.splice(e,1),Sa()};function Sa(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=se.map((a,i)=>`
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.handleScannerImageUpload=async function(e){const t=Array.from(e.target.files||[]).slice(0,10);if(t.length){for(const a of t)if(a.type.startsWith("image/"))try{const i=await Ve(a);i&&ae.push(i)}catch{}$a(),e.target.value=""}};window.removeScannerImage=function(e){ae.splice(e,1),$a()};function $a(){const e=document.getElementById("scanner-image-preview");if(!e)return;e.innerHTML=ae.map((a,i)=>`
    <div class="img-thumb" data-index="${i}">
      <img src="${s(a)}" onerror="this.src='/fallback.svg'">
      <button class="rm" onclick="removeScannerImage(${i})" type="button">×</button>
    </div>`).join("");const t=document.getElementById("btn-scanner-scan");t&&(t.disabled=ae.length===0,t.style.opacity=ae.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanGeneralWithAI=async function(){const e=ae.slice();if(!e.length){u("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-scanner-scan"),a=document.getElementById("scanner-scan-status"),i=t?t.innerHTML:"",o=(l,c)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),c&&a.classList.add(c),a.innerHTML=l)};try{const l=await I.getConfig();if(!String(l.gemini_key||l.gemini_api_key||"").trim()){o("No Gemini key yet. Open AI Settings at the bottom of the Admin Home page, paste your FREE Gemini API key (aistudio.google.com/apikey — no credit card needed), then scan again.","text-amber-300"),u("Add your free Gemini key in AI Settings first.","error");return}}catch{}t&&(t.disabled=!0,t.innerHTML="Scanning…"),o("Detecting every distinct product in your images…","text-blue-300");let n;try{n=await I.detectProducts(e,{category:"",maxImages:Math.min(e.length,ee.maxImages)})}catch(l){const c=/key|api|configured|settings|vision/i.test(String(l?.message||l));o(c?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);const r=n&&n.identified!==!1&&Array.isArray(n.products)&&n.products.length?n.products:[];if(!r.length){o(n&&n.reason?`Could not identify any product: ${s(n.reason)}`:"No product could be read from these images. Make sure the photos clearly show the product(s), then try again.","text-amber-300"),u("No products could be identified from the images.","error");return}V=r,Te=e,X="scanner-scan-status",scanReviewRender(),u(`${r.length} distinct product${r.length>1?"s":""} detected — review each one, then continue.`,"info")};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,o=i.querySelector("[type=submit][name=action][value=publish]"),n=a?"One-Click Publish Changes":"One-Click Publish Product";o&&(o.disabled=!0,o.textContent="Saving…");try{const r=new FormData(i),l={};for(const[y,g]of r.entries())y==="images"?(l.images=l.images||[],g&&!String(g).startsWith("blob:")&&l.images.push(String(g))):y==="tags"?(l.tags=l.tags||[],l.tags.push(g)):l[y]=g;l.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const c=r.get("action")==="draft",d=y=>ct(y),b=y=>{const g=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],m={};for(const h of g){const $=y[h];if(h==="real_price"){const A=$!=null&&String($).trim()!==""?parseFloat($):null;m[h]=A!=null&&Number.isFinite(A)&&A>0?Math.round(A):null;continue}m[h]=$!=null&&String($).trim()!==""?$:null}if(y.safety_features){const h=d(y.safety_features);m.safety_features=h.length?h:null}return m};let f;if(a){let y=ge((window._productsData||[]).find(T=>T.property_id===a));if(!y){const{data:T}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();y=T?ge(T):null}if(!y)throw new Error("Could not load the current product. Refresh the page and try again.");const g=(T,me)=>{const tt=T===""||T==null?"":T,at=me===""||me==null?"":me;return String(tt).trim()===String(at).trim()},m={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(T=>{g(l[T],y[T])||(m[T]=l[T]==null||l[T]===""?null:l[T])});const h=l.price===""||l.price==null?null:parseFloat(l.price);g(h,y.price)||(m.price=h==null?y.price:Math.max(N,Math.min(H,h)));const $=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);g($,y.stock_quantity)||(m.stock_quantity=Number.isFinite($)?$:null);const A=d(l.features_text);g(A.join("||"),(Array.isArray(y.features)?y.features:[]).join("||"))||(m.features=A);const x=l.tags||[];g(x.join("||"),(Array.isArray(y.tags)?y.tags:[]).join("||"))||(m.tags=x);const v=d(l.highlights_text);g(v.join("||"),(Array.isArray(y.highlights)?y.highlights:[]).join("||"))||(m.highlights=v);const E=d(l.seo_keywords_text);g(E.join("||"),(Array.isArray(y.seo_keywords)?y.seo_keywords:[]).join("||"))||(m.seo_keywords=E);const z=l.images||[];g(z.join("||"),(Array.isArray(y.images)?y.images:[]).join("||"))||(m.images=z);const J=l.is_featured==="on";!!y.is_featured!==J&&(m.is_featured=J);const de=c?!1:l.is_active==="on"||(l.images||[]).length>=24;!!y.is_active!==de&&(m.is_active=de);const Be=b(l),O={...y.specifications&&typeof y.specifications=="object"?y.specifications:{},...Be};if(JSON.stringify(O)!==JSON.stringify(y.specifications||{})&&(m.specifications=O),Object.keys(m).length===0){u("No changes detected — nothing was saved.","info");try{localStorage.removeItem(Ee(t,a))}catch{}o&&(o.disabled=!1,o.textContent=n);return}const C={...y,...m,property_id:a,updated_at:new Date().toISOString()};if({error:f}=await p.from("showroom_listings").upsert(C,{onConflict:"property_id"}),f&&dt(f,()=>ot(C),"Product update")){o&&(o.disabled=!1,o.textContent=n);return}u(c?"Draft saved!":`Saved & published — your showroom shows it now (${Object.keys(m).length} change${Object.keys(m).length>1?"s":""}).`)}else{const y=parseInt(l.required_image_count||"0",10)||(Ct.includes(t)?24:0);if(xa(y,l.images||[],"This listing"),!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!l.condition)throw new Error("Please choose the product condition.");const m={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(N,Math.min(H,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:c?!1:l.is_active==="on"||(l.images||[]).length>=24,is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],features:d(l.features_text).length?d(l.features_text):l.tags||[],tags:l.tags||[],highlights:d(l.highlights_text),seo_keywords:d(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:b(l)},h=St();if(m.property_id=h,{error:f}=await p.from("showroom_listings").insert(m),f&&dt(f,()=>ot({...m,property_id:m.property_id}),"Product publish")){o&&(o.disabled=!1,o.textContent=n);return}u(c?"Draft saved!":"Published! Your showroom shows this product now.")}try{localStorage.removeItem(Ee(t,a))}catch{}closeProductFormModal(),R()}catch(r){u("Error: "+r.message,"error"),o&&(o.disabled=!1,o.textContent=n)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=xt(e)),i||(i=(window._productsData||[]).find(o=>o.property_id===e)||null),!i)return u("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=ge((window._productsData||[]).find(o=>o.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return G(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:o,created_at:n,updated_at:r,...l}=a,c=St();await p.from("showroom_listings").insert({...l,property_id:c,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),R())};const gt=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ke(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?wt().filter(n=>n.listing_type==="property"):t||[];if(Array.isArray(K)){const n=new Set(i.map(l=>l.property_id)),r=K.filter(l=>l.listing_type==="property"&&l.property_id&&!n.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((n,r)=>new Date(r.created_at||0)-new Date(n.created_at||0));try{await _t()}catch{}const o=new Set(He());i=i.filter(n=>!(n&&n.property_id&&o.has(n.property_id))),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="6" class="text-center text-gray-500 py-12">No properties yet.</td></tr>':i.map(n=>`<tr>
                    ...
                    <td>${j(n.listing_status||"sale")} ${j(n.is_active?"active":"inactive")}</td>
                    <td>
                      <div class="flex gap-1">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=ea("property","Real Estate"),i=e.country_code||"US",o=e.currency||kt(i);U(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),Tt(),Lt(),ut("ppf-price"),window._propFormDirty=!!t;const n=document.getElementById("property-form");if(n){const r=()=>{window._propFormDirty=!0};n.addEventListener("input",r),n.addEventListener("change",r)}window.syncPropertyCountry=function(){jt("ppf")},jt("ppf"),mt("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>mt("pricing")),Qi()};let W=null,Re=null,Ht=null;function Yi(){const e=document.querySelector("#property-form");if(!e)return"";const t=a=>(e.querySelector(`[name="${a}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function te(e,t){const a=document.getElementById("property-map-status");a&&(a.textContent=e,a.style.color=t?"#dc2626":"")}function Pe(e,t,{reverse:a=!1}={}){if(!W||!Number.isFinite(e)||!Number.isFinite(t))return;const i=[e,t];Re?Re.setLatLng(i):Re=L.marker(i,{draggable:!0}).addTo(W),W.setView(i,Math.max(W.getZoom(),13));const o=document.querySelector('#property-form [name="latitude"]'),n=document.querySelector('#property-form [name="longitude"]');o&&(o.value=String(Number(e.toFixed(6)))),n&&(n.value=String(Number(t.toFixed(6)))),a&&Ji(e,t);const r=document.getElementById("btn-open-google-map");r&&(r.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function Se(){const e=Yi();if(!e){te("Enter a location (address, area, city, state, country), then press Locate from fields.");return}te("Searching location…");try{const a=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();a&&a[0]?(Pe(parseFloat(a[0].lat),parseFloat(a[0].lon)),te("Located: "+a[0].display_name)):te("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{te("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Ji(e,t){const a=document.querySelector("#property-form");if(a)try{const o=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),n=o&&o.address||{},r=(g,m)=>{if(!m)return;const h=a.querySelector(`[name="${g}"]`);return h&&!String(h.value||"").trim()?(h.value=m,!0):!1},l=[n.road||"",n.house_number||""].filter(Boolean).join(" "),c=n.suburb||n.neighbourhood||n.quarter||n.district||n.borough||"",d=n.town||n.village||n.municipality||n.city_district||"",b=n.city||n.county||"",f=n.state||n.region||"",y=n.country||"";if(r("product_location",l||c||d),r("town",c||d),r("city",b),r("state",f),y){r("country",y);const g=a.querySelector('[name="country_code"]');if(g){const m=(fe||[]).find(h=>String(h.name||"").toLowerCase()===String(y).toLowerCase());m&&m.code&&!g.value&&(g.value=m.code)}}te("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(o.display_name?" — "+o.display_name:""))}catch{te("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!W)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(Pe(e,t),te("Map updated from coordinates.")):Se()};function Qi(){const e=document.getElementById("property-map-preview");if(!e||!window.L){te("Map unavailable right now — your location fields still save normally.");return}W&&(W.remove(),W=null,Re=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),a=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),i=Number.isFinite(t)&&Number.isFinite(a)&&(t||a);W=L.map(e,{scrollWheelZoom:!1}).setView(i?[t,a]:[20,0],i?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(W),W.on("click",o=>Pe(o.latlng.lat,o.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",Se),["product_location","town","city","state","country","latitude","longitude"].forEach(o=>{const n=document.querySelector(`#property-form [name="${o}"]`);n&&(n.addEventListener("input",()=>{if(o==="latitude"||o==="longitude"){const r=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),l=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(r)&&Number.isFinite(l)&&(r||l)&&Pe(r,l);return}clearTimeout(Ht),Ht=setTimeout(Se,900)}),n.addEventListener("change",()=>{o!=="latitude"&&o!=="longitude"&&Se()}))}),i?Pe(t,a):Se()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(o=>{const n=parseFloat(o.latitude),r=parseFloat(o.longitude),l=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");return!(Number.isFinite(n)&&Number.isFinite(r)&&(n!==0||r!==0))&&!!l});if(!t.length){u("All properties already have map coordinates.","success");return}u(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}…`,"success");let a=0,i=0;for(const o of t){const n=[o.product_location,o.town,o.city,o.state,o.country].filter(Boolean).join(", ");try{const l=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(n))).json();if(l&&l[0]){const c={latitude:parseFloat(l[0].lat),longitude:parseFloat(l[0].lon)},{error:d}=await p.from("showroom_listings").update(c).eq("property_id",o.property_id);d?i++:(Object.assign(o,c),a++)}else i++}catch{i++}await new Promise(r=>setTimeout(r,1100))}u(`Map fix done: ${a} updated, ${i} failed.`,i?"error":"success"),Ke()};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),o=a.getAll("images").filter(g=>g&&!g.startsWith("blob:")),n=(i.features_text||"").split(",").map(g=>g.trim()).filter(Boolean),r=t?0:parseInt(i.required_image_count||"24",10)||24;xa(r,o,"This property");const l=i.real_price===""||i.real_price==null?null:Math.max(N,Math.min(H,parseFloat(i.real_price)||0)),c=g=>(g||"").split(",").map(m=>m.trim()).filter(Boolean),d=g=>g===""||g==null||!isFinite(parseInt(g,10))?null:parseInt(g,10),b=c(i.floor_plan_rooms).map(g=>{const m=String(g).match(/^(.*?):\s*(.*)$/);return m?{name:m[1].trim(),dimensions:m[2].trim()}:{name:g,dimensions:""}}),f={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(N,Math.min(H,parseFloat(i.price)||0)),currency:i.currency||"USD",real_price:l,country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",address:i.address||"",zip_code:i.zip_code||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",condition:i.condition||null,bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,half_bathrooms:d(i.half_bathrooms),building_size:i.building_size||"",land_size:i.land_size||"",floors:d(i.floors),garage:i.garage||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",year_built:d(i.year_built),year_renovated:d(i.year_renovated),landmarks:c(i.landmarks_text),interior_features:c(i.interior_features_text),exterior_features:c(i.exterior_features_text),home_systems:c(i.home_systems_text),legal_info:c(i.legal_info_text).map(g=>{const m=String(g).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return m?{label:m[1].trim(),value:m[2].trim(),source:m[3]}:{label:g,value:"",source:"Not verified"}}),risk_notes:i.risk_notes||"",floor_plan:{image:i.floor_plan_image||"",rooms:b,levels:i.floor_plan_levels||"",total_area:i.floor_plan_total_area||""},nearby_area:{schools:c(i.nearby_schools_text),hospitals:c(i.nearby_hospitals_text),shopping:c(i.nearby_shopping_text),transportation:c(i.nearby_transportation_text),distances:c(i.nearby_distances_text)},verification_status:i.verification_status||"Not verified",verification_date:i.verification_date||"",inspection_info:i.inspection_info||"",documents:c(i.documents_text),features:n,images:o,highlights:ct(i.highlights_text),seo_keywords:ct(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let y;if(t){f.property_id=t;const g=ge((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));f.specifications={...g.specifications&&typeof g.specifications=="object"?g.specifications:{},real_price:l},{error:y}=await p.from("showroom_listings").upsert({...g,...f},{onConflict:"property_id"})}else f.property_id=St(),f.specifications={real_price:l},{error:y}=await p.from("showroom_listings").insert(f);y&&dt(y,()=>ot({...f,property_id:t||f.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),ie(),Ke())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=xt(e)),i||(i=(Array.isArray(K)?K.find(o=>o.property_id===e):null)||null),i&&showAddPropertyModal(i)};const Xi=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Pa(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let o="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(n=>Zi(n)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}function Zi(e){return`<tr class="order-row" data-status="${e.status}" data-search="${s(e.order_number)} ${s(e.full_name)} ${s(e.email)}">
    ...
    <td>${j(e.status)}</td>
    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${Y(e.created_at)}</span></td>
    <td>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",ra(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",le(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${s(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Xi.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),ie(),Pa()};async function eo(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
            ...
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${a.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':a.map(i=>`<tr class="cust-row" data-search="${s(i.display_name)} ${s(i.user_id)}">
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${Y(i.created_at)}</span></td>
                    <td>
      ...
      <div class="modal-box">
        ...
        <div class="flex items-center gap-4 mb-5 p-4 glass-soft border border-blue-500/15 rounded-xl">
          ...
          <div>
            ...
            <p class="text-xs text-gray-400 mt-0.5">Joined ${Y(t.created_at)} · ${s(t.country_code||"Unknown country")}</p>
          </div>
        </div>
        ...
        ${(a||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(a||[]).map(i=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${s(i.order_number)}</p><p class="text-[10px] text-gray-500">${le(i.created_at)}</p></div>
    ...
    </div>`)};async function Le(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(l=>!l.is_approved).length,{data:o}=await p.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),n=o||[],r=n.filter(l=>!l.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?ce("star","No Reviews","Customer reviews will appear here."):a.map(l=>ao(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${n.length===0?ce("message-square","No Feedback Yet","Site feedback will appear here."):n.map(l=>to(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}function to(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"★":"☆").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1 flex-wrap">
          ...
          <span class="text-xs text-gray-500">${s(e.email||"no email")} · ${Y(e.created_at)}</span>
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await p.from("site_feedback").update({is_approved:!0}).eq("id",e);t?u(t.message,"error"):u("Feedback approved — it now shows on every page."),Le()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await p.from("site_feedback").delete().eq("id",e);t?u(t.message,"error"):u("Feedback deleted."),Le()};function ao(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1">
          <span class="text-amber-400 font-bold text-sm">${t}</span>
          <span class="text-xs text-gray-500">${Y(e.created_at)}</span>
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),Le()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),Le())};async function Ea(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${le(i.created_at)}</span>
                    </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':a.map(i=>`<tr>
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${Y(i.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:o}=await p.from("coupons").insert(i);if(o){u(o.message,"error");return}u("Coupon created!"),ie(),Ye()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),Ye()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),Ye())};async function io(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}const Ia=["Featured","Sponsored","Featured Collection","Discover","Promotion"],oo=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let Fe=null;function no(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${s(e)}</span>`}function ro(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product · ${s(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category · ${s(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section · ${s(e.link_target||"")}</span>`}function so(e){return e.video_url?`<video src="${s(e.video_url)}" ${e.poster_url?`poster="${s(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${s(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function Aa(){if(Fe)return Fe;const e=[],t=new Set,a=[],i=n=>{if(!n||!n.property_id)return;e.push({id:n.property_id,title:n.title||n.property_id});const r=n.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{K.forEach(i)}catch{}try{const{data:n,error:r}=await p.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&n&&n.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(n=>{t.has(n)||(t.add(n),a.push(n))}),Fe={products:e,categories:a,sections:oo},Fe}async function lo(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return u("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),o=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:n}=await p.storage.from("advertisements").upload(o,e,{contentType:e.type,upsert:!1});if(n)return u("Upload failed: "+n.message,"error"),null;const{data:r}=p.storage.from("advertisements").getPublicUrl(o);return{url:r.publicUrl,isVideo:i}}catch{return u("Upload failed","error"),null}}function qe(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),o=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),o&&(o.value=t?"":e),a.innerHTML=t?`<video src="${s(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${s(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){u("Choose an image or video file","error");return}const i=await lo(t);if(!i){e.value="";return}qe(i.url,i.isVideo);const o=document.getElementById("ad-media-url");o&&(o.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);qe(t,a)};function Mt(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let o="";t==="product"?o='<option value="">Select a product…</option>'+e.products.map(n=>`<option value="${s(n.id)}" ${String(a)===String(n.id)?"selected":""}>${s(n.id)} — ${s((n.title||"").slice(0,60))}</option>`).join(""):t==="category"?o='<option value="">Select a category…</option>'+e.categories.map(n=>`<option value="${s(n)}" ${a===n?"selected":""}>${s(n)}</option>`).join(""):t==="section"&&(o='<option value="">Select a section…</option>'+e.sections.map(n=>`<option value="${s(n.id)}" ${a===n.id?"selected":""}>${s(n.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${o}</select>`}function Ca(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    ${ro(i)}
                    <span class="text-[10px] text-gray-500">${Y(i.start_date)}${i.start_date?" → ":""}${Y(i.end_date)}</span>
                  </div>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.renderAds=we;const Je=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSy…",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min · 1M tokens/day — Free forever"}],Q={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Ta(){const e=document.getElementById("content");try{let t=function(n){const r=o===n.id,l=i[n.kf],c=i[n.mf]||n.dm;return`
        <div class="glass-soft border ${r?Q.border[n.color]+" "+Q.bg[n.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard" id="apc-${n.id}">
          <div class="flex items-start justify-between gap-2">
            ...
            <label class="flex items-center gap-1 cursor-pointer shrink-0">
              ...
              <span class="text-[9px] font-bold ${r?Q.text[n.color]:"text-gray-600"}">USE</span>
            </label>
          </div>
...
${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};function it(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),o=t.lastIndexOf("}");if(i===-1||o===-1||o<=i)return null;const n=t.slice(i,o+1);try{return JSON.parse(n)}catch{return null}}async function uo(){const e=document.getElementById("content");try{const[{data:t},a]=await Promise.all([p.from("site_settings").select("*").limit(1).maybeSingle(),po()]),i=t||{},o=new Set(Array.isArray(i.live_promo_product_ids)?i.live_promo_product_ids:[]),n=a.length?`
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),a=document.getElementById("url-"+e);t&&(t.value=""),a&&(a.value=""),u("Cleared. Save to apply.","info"),Ba()};window.handleContentMediaUpload=async function(e,t){const a=e.target.files?.[0];if(a){a.type.startsWith("video/"),u(`Uploading ${a.name}…`,"info");try{const{data:{session:i}}=await p.auth.getSession();if(!i){u("Sign in to upload media","error");return}const o=(a.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),n=`content/${t}-${Date.now()}.${o}`,{error:r}=await p.storage.from("product-images").upload(n,a,{contentType:a.type,upsert:!1});if(r){u("Upload failed: "+r.message,"error");return}const{data:l}=p.storage.from("product-images").getPublicUrl(n),c=l.publicUrl,d=document.getElementById("val-"+t),b=document.getElementById("url-"+t);d&&(d.value=c),b&&(b.value=c);const f=document.getElementById("slot-"+t);if(f){const y=Ft.flatMap(g=>g.fields).find(g=>g.key===t);y&&(f.outerHTML=La(y,c))}u("✓ Uploaded — save to apply","success")}catch{u("Upload failed","error")}}};async function Ba(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a={...qa,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.saveContentSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;for(const i of Ft)for(const o of i.fields)o.type==="checkbox"&&!(o.key in a)?a[o.key]=!1:o.type==="checkbox"&&(a[o.key]=!0);try{const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let o;if(i?.id?{error:o}=await p.from("site_settings").update(a).eq("id",i.id):{error:o}=await p.from("site_settings").insert({id:1,...a}),o)throw new Error(o.message);ja(),u("Content updated — the banners now use your new words and uploads.","success")}catch(i){u(i.message||"Could not save content. Please try again.","error")}};async function mo(){const e=document.getElementById("content");try{const[t,a,i]=await Promise.all([p.from("payment_receipts").select("amount,currency,status,created_at").order("created_at",{ascending:!1}).limit(500),p.from("showroom_listings").select("id,listing_type,category,is_active",{count:"exact"}),p.from("profiles").select("user_id,created_at",{count:"exact"})]),o=t.data||[],n=o.filter(d=>["approved","payment_approved","delivered"].includes(d.status)).reduce((d,b)=>d+(parseFloat(b.amount)||0),0),r=o.length>0?(o.filter(d=>d.status!=="cancelled").length/o.length*100).toFixed(1):0,l={};(a.data||[]).forEach(d=>{l[d.category]=(l[d.category]||0)+1});const c=Object.entries(l).sort((d,b)=>b[1]-d[1]).slice(0,8);e.innerHTML=`
      <div class="space-y-6 fade-in">
        <h2 class="text-xl font-black text-white">Analytics</h2>
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ${D("Total Revenue",`$${n.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald")}
      ...
      </div>`,window.lucide&&lucide.createIcons(),fa(o)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function bo(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="p-4 rounded-xl border flex items-center gap-4 ${l?"bg-emerald-500/5 border-emerald-500/20":"bg-amber-500/5 border-amber-500/20"}">
          ...
          <div class="flex-1">
            ...
            <p class="text-xs text-gray-400 mt-0.5">${l?`Backup codes available: ${c} · Enrolled: ${Y(n.created_at)}`:"Enable 2FA to protect your admin account with an authenticator app."}</p>
          </div>
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${o.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No security events yet</td></tr>':o.map(d=>{const b=["login_success","login_2fa_success"].includes(d.event_type),f=["login_failed","login_denied","login_backup_code_used"].includes(d.event_type),y=b?"text-emerald-400":f?"text-red-400":"text-gray-300",g={login_success:"Login ✓",login_failed:"Failed Login ✗",login_denied:"Access Denied ✗",login_2fa_success:"2FA Verified ✓",login_backup_code_used:"Backup Code Used",logout:"Logged Out",logout_all_devices:"Logout All Devices"}[d.event_type]||d.event_type;return`<tr>
                      <td><span class="text-xs font-bold ${y}">${s(g)}</span></td>
                      ...
                      <td><span class="text-xs text-gray-500">${le(d.created_at)}</span></td>
                    </tr>`}).join("")}
              </tbody>
            </table>
          </div>
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=Ma(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",k.user.id),u("New backup codes generated"),Fa(e.map(t=>t.code)),Qe()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",k.user.id),await Z(k.user.id,"2fa_disabled"),u("2FA has been disabled"),Qe()}catch(e){u(e.message,"error")}};async function yo(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function fo(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(a=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${s(a.version||a.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${le(a.created_at)}</p></div>
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),o=document.createElement("a");o.href=URL.createObjectURL(i),o.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,o.click(),u("Orders exported!")};async function ho(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.saveSettings=async function(e){e.preventDefault();const t=new FormData(e.target),a={};for(const[i,o]of t.entries())a[i]=o;["maintenance_mode","reviews_enabled","wishlist_enabled","guest_checkout"].forEach(i=>{a[i]=i in a}),await p.from("site_settings").upsert({id:1,...a}),u("Settings saved!")};async function Xe(){const e=document.getElementById("content");e&&(e.innerHTML=he());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.homepage_banner_image||"",o=a.homepage_banner_alt||"Homepage header banner",n=i?"Uploaded banner will appear at the top of the homepage only.":"No homepage banner is set yet.";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function Ze(){const e=document.getElementById("content");e&&(e.innerHTML=he());try{let t=function(l,c,d,b="",f="blue"){const y=!!(d&&d.trim());return`
        <div class="glass-soft border border-${f}-500/15 rounded-xl p-4 space-y-3">
          ...
          <div class="flex gap-2">
            <input class="input-field text-xs flex-1 ${y?"":"hidden"}" id="url-${c}" value="${s(d||"")}" placeholder="Or paste image URL" oninput="document.getElementById('val-${c}').value=this.value;updateLivePreview()">
        ...
        </div>`};const{data:a}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},o=i.brand_name||i.site_name||ia,n=i.brand_slogan||i.site_tagline||oa,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}function vo(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",o=t[a]||"",n=t[i]||"",r=!!(o&&o.trim()),l=!!(n&&n.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function Ra(){const e={};for(const t of Oe)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=Ra();t[e]="";const a=document.getElementById("val-"+e),i=document.getElementById("url-"+e);a&&(a.value=""),i&&(i.value=""),Ie(t),u("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const a=e.target.files?.[0];if(!a)return;const i=document.getElementById("promo-bg-status"),o=document.getElementById("promo-bg-msg");i&&i.classList.remove("hidden"),o&&(o.textContent=`Uploading ${a.name}…`);try{const n=(a.name.split(".").pop()||"bin").toLowerCase(),r=`promo/${t}-${Date.now()}.${n}`,{error:l}=await p.storage.from("product-images").upload(r,a,{contentType:a.type,upsert:!0});let c;if(l)c=URL.createObjectURL(a),o&&(o.textContent=`Preview only (storage: ${l.message})`);else{const{data:y}=p.storage.from("product-images").getPublicUrl(r);c=y.publicUrl,o&&(o.textContent=`✓ ${a.name} uploaded`)}const d=document.getElementById("val-"+t),b=document.getElementById("url-"+t);d&&(d.value=c),b&&(b.value=c,b.classList.remove("hidden"));const f=Ra();Ie(f)}catch(n){o&&(o.textContent=`Upload failed: ${n.message}`)}setTimeout(()=>i?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const n of Oe)t[n.key+"_bg_image"]=document.getElementById("val-"+n.key+"_bg_image")?.value||"",t[n.key+"_bg_video"]=document.getElementById("val-"+n.key+"_bg_video")?.value||"";const a=e.target.querySelector("[type=submit]");a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishing…',window.lucide&&lucide.createIcons());const{data:i}=await p.from("site_settings").select("id").limit(1).maybeSingle();let o;i?.id?{error:o}=await p.from("site_settings").update(t).eq("id",i.id):{error:o}=await p.from("site_settings").insert(t),Oa(),o?(u("Publish failed — the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),Ie(t)):(u("Promo & backgrounds published across all pages.","success"),setTimeout(()=>Ie(),500))};window._manualPaymentAccounts=[];function Rt(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Wt("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function Dt(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function xo(e,t){const a=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${na.map(i=>`<option value="${i}" ${e.currency===i?"selected":""}>${i}</option>`).join("")}</select></div>
    ...
    </div>`}window.renderManualPaymentAccountsEditor=function(){const e=document.getElementById("manual-accounts-editor");e&&(window._manualPaymentAccounts?.length||(window._manualPaymentAccounts=[Rt()]),e.innerHTML=`
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>xo(t,a)).join("")}
    ...
    </div>`,Dt(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(Rt()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[Rt()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),Dt())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=fe.find(o=>o.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Wt(t),Dt(),renderManualPaymentAccountsEditor()};async function vt(){const e=document.getElementById("content");e&&(e.innerHTML=he());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...Ya()||{},...t||{}};window._manualPaymentAccounts=Ja(i).map(o=>({...o})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${s(Qa(i))}</textarea>
              </div>
              <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${a.map(g=>`<button onclick="catalogSetCategory('${g.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${B.category===g.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${s(g.name)}</button>`).join("")}
    </div>`,c=`
    <div class="flex flex-wrap items-center gap-2">
      <input id="catalog-search-input" class="input-field flex-1 min-w-[220px]" placeholder="Search title, id or subcategory…" value="${s(B.query)}" onkeyup="if (event.key === 'Enter') catalogSearch()">
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
    </div>`;let d=[];if(i)if(n){const g=Math.min(o,8e3);for(let m=0;m<g&&d.length<$e;m++){const h=Ut(i.slug,m);if(!h)continue;`${h.property_id} ${h.title} ${h.subcategory||""} ${h.category||""}`.toLowerCase().includes(n)&&d.push(h)}}else{const g=B.page*$e,m=Math.min(g+$e,o);for(let h=g;h<m;h++){const $=Ut(i.slug,h);$&&d.push($)}}const b=d.length?d.map(g=>{const m=t.has(g.property_id),h=g.images&&g.images[0]||"/fallback.svg";return`
          <div class="flex items-center gap-3 p-3 rounded-xl border ${m?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${s(g.property_id)} · ${s(g.subcategory||g.category||"")} · ${ra(g.price,"USD")}</p>
            </div>
            ${j(!m)}
            <button onclick="catalogToggle('${s(g.property_id)}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${m?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30 hover:bg-emerald-500/25":"bg-amber-500/10 text-amber-300 border-amber-500/30 hover:bg-amber-500/20"}">
              ${m?"Show":"Hide"}
            </button>
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',f=n?1:Math.max(1,Math.ceil(o/$e)),y=`
    <div class="flex flex-wrap items-center justify-between gap-3">
      <p class="text-xs text-gray-500">${n?`${d.length} match`:`${o.toLocaleString()} items in ${s(i?.name||"")}`} · ${t.size} hidden</p>
      <div class="flex items-center gap-2">
        <button onclick="catalogPage(-1)" ${B.page<=0?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Prev</button>
        <span class="text-xs text-gray-500">Page ${B.page+1} / ${f}</span>
        <button onclick="catalogPage(1)" ${B.page>=f-1?"disabled":""} class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold bg-white/5 text-gray-300 border border-white/10 hover:text-white disabled:opacity-40">Next</button>
      </div>
    </div>`;e.innerHTML=`
    <div class="space-y-4 fade-in">
      ${r}
      ...
      ${y}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){B.category=e,B.page=0,B.query="",_e()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");B.query=e?e.value:"",B.page=0,_e()};window.catalogPage=function(e){const t=Qt(B.category),a=t?t.count:0,i=B.query.trim()?1:Math.max(1,Math.ceil(a/$e));B.page=Math.max(0,Math.min(i-1,B.page+e)),_e()};window.catalogToggle=async function(e){const t=!He().includes(e),a=await Xt(e,t);u(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),_e()};window.catalogResetHidden=async function(){await ai(),u("All hidden catalog listings restored"),_e()};async function zt(){window.lucide&&lucide.createIcons(),sa(),await vi(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){k.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",zt):zt();
