import{supabase as p}from"./supabase-client-7_ZWSEp6.js";import{a as na,g as la,C as be,A as da}from"./localization-B588S1FD.js";import{patchLocalShowroomListing as ca,upsertLocalShowroomListing as Pe,getLocalShowroomListingById as ft,listLocalShowroomListings as yt}from"./local-showroom-store-JrQn_yOW.js";import{L as He,s as Ge,a as ua,l as pa,b as ma,V as ba}from"./live-control-store-DzHEnoMc.js";import{g as ht,s as ga,l as fa,a as ya,b as ha}from"./payment-settings-rLQhNf4R.js";import{S as T}from"./showroom-data-DQuiOO-D.js";import"./preload-helper-CLcXU_4U.js";const B=1,G=5e6,va=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],xa=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],vt=[...va,...xa];function ze(e){return na[e]||"USD"}function xt(e,t){return vt.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function wa(e,t){const a=Math.max(B,Math.min(G,Number(e)||B));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function _a(e,t,a,i,s){const o=wa(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${s}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function wt({templateId:e,listingType:t,category:a,countryCode:i,currency:s,price:o}){const r=vt.find(g=>g.id===e&&g.listingType===t);if(!r)return null;const n=la(i)||be[0],d=s||ze(n.code),c=[n.name].filter(Boolean).join(", "),m={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${n.name}`:r.label,description:_a(r,n,d,o,c),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[n.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...m,country:n.name,country_code:n.code,product_location:n.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...m,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const _t="weverseonlineshop@gmail.com",kt="kco_ai_ad_override_fallback_v1",St="Weverse Online Shop",$t="SHOP GLOBALLY, DELIVERED WORLDWIDE",ka=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"properties",label:"Properties",icon:"home"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"},{id:"live-streaming",label:"Live Streaming",icon:"radio"},{id:"video-calls",label:"Video Calls",icon:"video"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"n8n",label:"n8n Automation",icon:"workflow"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"ai-marketing",label:"AI Marketing Studio",icon:"sparkles"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],Sa={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager",n8n:"n8n Automation",ai:"AI Assistant","ai-marketing":"AI Marketing Studio","homepage-branding":"Homepage Branding",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},At=[...da].sort();let w={user:null,section:"dashboard"};function l(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function $a(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function j(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function M(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function Ve(){return"KCO-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const Aa=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","features_text","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at"];function W(e){const t={};if(!e||typeof e!="object")return t;for(const a of Aa)a in e&&(t[a]=e[a]);return t}function u(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),s=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};s&&(s.setAttribute("data-lucide",o[t]||"info"),s.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function I(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",l(e)||"—"];return`<span class="badge ${a}">${i}</span>`}function N(){document.getElementById("modal-container").innerHTML=""}function C(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}function k(e,t,a,i,s=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",orange:"bg-orange-500/10 text-orange-400 border-orange-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-2xl p-4">
  ...
  </div>`}function K(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function ee(e,t,a,i=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${l(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${l(a)}</p>${i?`<div class="mt-5">${i}</div>`:""}</div>`}function It(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=ka.map(t=>`
    <div>
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){w.section=e;const t=Sa[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),It(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=K()),window.lucide&&lucide.createIcons(),({dashboard:Na,products:E,properties:Ze,orders:Wt,customers:pi,reviews:et,messages:Kt,coupons:ve,ads:xe,notifications:bi,"live-streaming":ie,"video-calls":le,ai:Ia,n8n:Pa,"ai-settings":Jt,"ai-marketing":we,"homepage-branding":ke,content:$i,seo:Ii,email:Pi,analytics:Ai,security:_e,activity:Ei,brand:Se,"payment-settings":Ne,backup:Ci,settings:Li,publish:$e}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=ee("construction","Coming Soon",`${t} is being built.`))}))()};async function Ia(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}async function Pa(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Y="kco_admin_remember",We="kco_login_attempts",Ee=5,Ea=15*60*1e3;function A(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Ca(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ge(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function oe(e){return String(e||"").trim().toLowerCase()}function La(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");e?.email&&!oe(e.email)&&localStorage.removeItem(Y)}catch{localStorage.removeItem(Y)}}function Ta(){try{const e=JSON.parse(localStorage.getItem(Y)||"{}");return oe(e?.email)}catch{return""}}function Ke(){La();const e=Ta(),t=document.getElementById("login-email");t&&(t.value=e||t.value||_t,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function Ba(){return`${window.location.origin}/admin.html`}function J(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ge(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function $(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please wait…':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Pt(){try{return JSON.parse(localStorage.getItem(We)||'{"count":0}')}catch{return{count:0}}}function Et(){const e=Pt();return e.count=(e.count||0)+1,e.count>=Ee&&(e.lockedUntil=Date.now()+Ea),localStorage.setItem(We,JSON.stringify(e)),e}function Ct(){localStorage.removeItem(We)}function Lt(){const e=Pt();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Ct(),null):Math.ceil(t/6e4)}async function U(e,t,a={}){try{await p.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await Ma(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function Ma(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Tt(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await p.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:oe(e.email)===_t}async function Ra(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){de(),qa();return}const{data:{session:t}}=await p.auth.getSession();if(t?.user&&await Tt(t.user)){const{data:{currentUser:i}}=await p.auth.getUser(),s=await p.auth.mfa.getAuthenticatorAssuranceLevel(),o=s.data?.currentLevel;if(s.data?.nextLevel==="aal2"&&o!=="aal2"){w.user=t.user,de(),J("2fa"),Je();return}w.user=t.user,fe();return}Da()}function de(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Da(){de(),J("login"),Ke(),Bt(),Mt(),Je(),Fa();const e=Lt();e&&(A(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Fa(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Bt(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Ua),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>J("forgot")))}async function Ua(e){e.preventDefault();const t=Lt();if(t){A(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=oe(a?.value);if(!i){A("Enter your admin email address."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const s=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;$("login-btn",!0),ge();const{data:r,error:n}=await p.auth.signInWithPassword({email:i,password:s});if(n||!r.user){const b=String(n?.message||"").toLowerCase();if(b.includes("missing supabase credentials")||b.includes("authentication service is unavailable")){A("Authentication is temporarily unavailable due to configuration. Please contact support."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("failed to fetch")||b.includes("network request failed")){A("Network error while signing in. Check your connection and try again."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(b.includes("email not confirmed")){A("Your admin email is not confirmed yet. Open your verification email and confirm first."),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const y=Et(),f=Ee-y.count,_=y.lockedUntil?`Account locked for 15 minutes after ${Ee} failed attempts.`:`Invalid email or password. ${f>0?f+" attempt"+(f!==1?"s":"")+" remaining.":""}`;A(_),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await U(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Tt(r.user)){await p.auth.signOut(),A(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await U(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Y,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Y),Ct(),w.user=r.user,(await p.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){$("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),J("2fa"),Je(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await U(r.user.id,"login_success"),$("login-btn",!1),fe()}function Je(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ut));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ut()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await p.auth.signOut(),w.user=null,J("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const s=document.getElementById("backup-code");s&&s.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",ja))}async function ut(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){A("Enter the 6-digit code from your authenticator app.");return}$("verify-2fa-btn",!0),ge();try{const{data:t}=await p.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){A("No 2FA factor found. Please re-login."),$("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:s}=await p.auth.mfa.challenge({factorId:a.id});if(s)throw s;const{error:o}=await p.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await U(w.user.id,"login_2fa_success"),$("verify-2fa-btn",!1),fe()}catch(t){Et(),A(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),$("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function ja(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){A("Enter a backup recovery code.");return}$("verify-backup-btn",!0);try{const{data:t}=await p.from("admin_2fa").select("backup_codes").eq("user_id",w.user.id).maybeSingle();if(!t?.backup_codes?.length){A("No backup codes found."),$("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!s.used)){A("Backup code not found or already used."),$("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(s=>(s.code||s).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof s=="object"?s:{code:s},used:!0}:s);await p.from("admin_2fa").update({backup_codes:i}).eq("user_id",w.user.id),await U(w.user.id,"login_backup_code_used"),fe()}catch(t){A(t.message),$("verify-backup-btn",!1,"Use Backup Code")}}function Mt(){document.getElementById("back-to-login")?.addEventListener("click",()=>J("login")),document.getElementById("send-reset-btn")?.addEventListener("click",Oa)}async function Oa(){const e=document.getElementById("reset-email"),t=oe(e?.value);if(!t){A("Enter your admin email address to receive a reset link.");return}$("send-reset-btn",!0),ge();const{error:a}=await p.auth.resetPasswordForEmail(t,{redirectTo:Ba()});if($("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){A(a.message);return}Ca("Reset link sent! Check your inbox and open it from this device to continue.")}function qa(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3">
          ${k("Total Revenue",`$${n.toLocaleString("en-US",{maximumFractionDigits:0})}`,"dollar-sign","emerald",`$${Q.toLocaleString("en-US",{maximumFractionDigits:0})} this month`)}
          ${k("Total Orders",r.length,"shopping-bag","blue",`${d} pending`)}
          ${k("Customers",b,"users","violet")}
          ${k("Products",c,"package","amber",`${g} active`)}
          ${k("Properties",m,"home","blue")}
          ${k("Reviews",y,"star","orange",`${f} pending`)}
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5">
            ...
            ${se.length===0?'<p class="text-xs text-gray-500 text-center py-8">No orders yet</p>':se.map(v=>`
      ...
      <div class="space-y-5 fade-in">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
          ...
          ${k("Inventory Units",i.reduce((r,n)=>r+(parseInt(n.stock_quantity,10)||0),0),"boxes","orange")}
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-6 gap-2.5">
            ...
            <select id="prod-cat-filter" class="input-field" onchange="filterProducts()">
              ...
              ${(s.length?s:Ut).map(r=>`<option value="${l(r)}" ${(window._productFilters.category||"")===r?"selected":""}>${l(r)}</option>`).join("")}
            </select>
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=i,Rt(i),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${l(t.message)}</div>`)}}function V(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Ce(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Ha(e){const t=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(t)&&t>0?`${Math.round(t)}% OFF`:"No discount"}function Qe(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Le(e){return parseInt(e.views??e.view_count??0,10)||0}function Te(e){return parseInt(e.sales??e.sales_count??0,10)||0}function Ye(e){return e.sku||e.property_id||"N/A"}function Ga(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Ce(e),i=Qe(e),s=window._productSelection?.has(e.property_id),o=I(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=j(e.created_at),n=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",m=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${l(e.category||"")}" data-status="${i}" data-featured="${n?"featured":"standard"}" class="prod-card glass-soft border ${s?"border-blue-400/60":"border-blue-500/15"} rounded-2xl p-3.5 flex flex-col gap-3 transition hover:border-blue-400/35">
    <div class="flex items-start gap-3">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-[10px] text-gray-500 font-mono mt-0.5">SKU: ${l(Ye(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2 text-[11px]">
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Price</span><p class="text-emerald-300 font-black">$${V(e.price).toLocaleString()}</p></div>
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Discount</span><p class="text-amber-300 font-bold">${l(Ha(e))}</p></div>
      ...
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Views</span><p class="text-blue-300 font-bold">${Le(e).toLocaleString()}</p></div>
      <div class="rounded-lg bg-white/5 border border-white/10 px-2 py-1.5"><span class="text-gray-400">Sales</span><p class="text-cyan-300 font-bold">${Te(e).toLocaleString()}</p></div>
    </div>
    ...
    ${a.length?`<div class="flex flex-wrap gap-1">${a.slice(0,6).map(g=>`<span class="text-[10px] px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${l(g)}</span>`).join("")}</div>`:'<div class="text-[10px] text-gray-500">No tags</div>'}
  </article>`}function za(e,t){const a=[...e],i=s=>new Date(s||0).getTime()||0;return t==="oldest"?a.sort((s,o)=>i(s.created_at)-i(o.created_at)):t==="price-high"?a.sort((s,o)=>V(o.price)-V(s.price)):t==="price-low"?a.sort((s,o)=>V(s.price)-V(o.price)):t==="sales-high"?a.sort((s,o)=>Te(o)-Te(s)):t==="views-high"?a.sort((s,o)=>Le(o)-Le(s)):a.sort((s,o)=>i(o.created_at)-i(s.created_at)),a}function Rt(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");t&&(t.innerHTML=e.map(Ga).join(""),i&&(i.textContent=String(e.length)),a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons())}function Dt(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const s=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=Qe(i),r=window._productSelection?.has(i.property_id),n=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${l(Ye(i))}</p>
              </div>
            </div>
          </td>
          <td><span class="text-xs text-gray-300">${l(i.category||"Uncategorized")}</span></td>
          <td><span class="text-xs font-bold text-emerald-400">$${V(i.price).toLocaleString()}</span></td>
        ...
        </tr>`}).join(""),a&&(a.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),a=document.getElementById("products-table-wrap"),i=document.getElementById("view-card-btn"),s=document.getElementById("view-table-btn"),o=document.getElementById("products-empty"),r=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),a&&(a.classList.toggle("hidden",e!=="table"),e==="table"&&Dt(r)),i&&i.classList.toggle("active",e!=="table"),s&&s.classList.toggle("active",e==="table"),o&&o.classList.toggle("hidden",r.length>0)};window.filterProducts=function(){const e=window._productFilters||{};e.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),e.category=document.getElementById("prod-cat-filter")?.value||"",e.tag=document.getElementById("prod-tag-filter")?.value||"",e.status=document.getElementById("prod-status-filter")?.value||"",e.featured=document.getElementById("prod-featured-filter")?.value||"",e.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=e;const t=(window._productsData||[]).filter(i=>{const s=[i.title,i.brand,i.category,Ye(i),Ce(i).join(" "),i.description].join(" ").toLowerCase();return!(e.search&&!s.includes(e.search)||e.category&&(i.category||"")!==e.category||e.tag&&!Ce(i).includes(e.tag)||e.status&&Qe(i)!==e.status||e.featured&&e.featured==="featured"!=!!i.is_featured)}),a=za(t,e.sort);Rt(a),window._productView==="table"&&Dt(a)};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const a=document.getElementById(t);a&&(t==="prod-sort"?a.value="newest":a.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(a=>{a.checked=e.checked;const i=a.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(i):window._productSelection.delete(i)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),a=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),a&&(a.textContent=`${e} selected`)};function ye(){return window._productSelection?[...window._productSelection]:[]}function L(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")||t.includes("duplicate key")||t.includes("violates foreign key")}function Be(e,t,a){return e&&L(e)?(u(`⚠️ ${a} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),u(`${a} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}window.bulkToggleActive=async function(e){const t=ye();if(!t.length)return;const a=await Promise.all(t.map(o=>{const r=W((window._productsData||[]).find(n=>n.property_id===o));return p.from("showroom_listings").upsert({...r,property_id:o,is_active:e},{onConflict:"property_id"})}));if(a.some(o=>o.error&&L(o.error))){u(`⚠️ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,E();return}const s=a.filter(o=>o.error).length;u(`${t.length-s}/${t.length} products ${e?"published":"unpublished"}${s?` (${s} failed: ${a.find(o=>o.error)?.error?.message||"error"})`:""}`,s?"error":"success"),window._productSelection=new Set,E()};window.bulkDuplicateProducts=async function(){const e=ye();if(e.length){for(const t of e)await duplicateProduct(t,!0);u(`${e.length} products duplicated`),window._productSelection=new Set,E()}};window.bulkArchive=async function(){const e=ye();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(s=>p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",s)));if(t.some(s=>s.error&&L(s.error))){u("⚠️ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,E();return}const i=t.filter(s=>s.error).length;u(`${e.length-i}/${e.length} products archived${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,E()};window.bulkDeleteProducts=async function(){const e=ye();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(s=>p.from("showroom_listings").delete().eq("property_id",s)));if(t.some(s=>s.error&&L(s.error))){u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,E();return}const i=t.filter(s=>s.error).length;u(`${e.length-i}/${e.length} products deleted${i?` (${i} failed)`:""}`,i?"error":"success"),window._productSelection=new Set,E()};window.previewProduct=async function(e){const t=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),a=(window._productsData||[]).find(i=>i.property_id===e)||t.data;if(!a)return u("Product not found","error");C(`
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${V(a.price).toLocaleString()}</p></div>
    ...
    </div>`)};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const a=new FormData(e.target),i={title:a.get("title")||"Untitled Product",price:Math.max(B,Math.min(G,parseFloat(a.get("price"))||0)),stock_quantity:a.get("stock_quantity")===""?null:parseInt(a.get("stock_quantity"),10),availability_status:a.get("availability_status")||"In Stock",is_featured:a.get("is_featured")==="on",is_active:a.get("is_active")==="on"},s=W((window._productsData||[]).find(r=>r.property_id===t)),{error:o}=await p.from("showroom_listings").upsert({...s,...i,property_id:t},{onConflict:"property_id"});if(o){if(L(o)){u("⚠️ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),N(),E();return}ca(t,i),u("Quick edit saved locally","info")}else u("Quick edit saved");N(),E()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/details.html?id=${encodeURIComponent(e)}`;try{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t),u("Product link copied to clipboard");return}}catch{}window.prompt("Copy product link:",t)};window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const{error:t}=await p.from("showroom_listings").delete().eq("property_id",e);if(t)return L(t)?u("⚠️ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):u("Delete failed: "+t.message,"error");u("Product deleted"),E()};window.openProductMoreActions=function(e){C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
        ...
        <form id="product-form" onsubmit="saveProduct(event,'${l(e)}','${a?t.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div class="sm:col-span-2"><label class="lbl">Currency</label><select class="input-field" name="currency" id="pf-currency" onchange="applyProductCatalogTemplate('${l(e)}')">${Ot(s)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div class="p-3 glass-soft border border-blue-500/15 rounded-xl">
              ...
              <p class="text-[11px] text-gray-500 mt-1">Allowed price range is ${B} to ${G} in the selected currency.</p>
            </div>
          </div>
    ...
    </div>`),Ht(),Gt(),qt("pf-price"),Re(e,"pricing"),document.getElementById("pf-price")?.addEventListener("input",()=>Re(e,"pricing")),li(e,t.property_id||""),window._pfEscapeHandler=o=>{o.key==="Escape"&&closeProductFormModal()},document.addEventListener("keydown",window._pfEscapeHandler)};window.closeProductFormModal=function(){window._pfEscapeHandler&&(document.removeEventListener("keydown",window._pfEscapeHandler),window._pfEscapeHandler=null),clearTimeout(window._pfAiTimer),N(),E()};const Ja=["Front view","Rear view","Left side","Right side","Interior","Dashboard","Steering wheel","Engine","Wheels and tires","Seats","Trunk","Headlights","Taillights","Roof","Door panels","Mirrors","Suspension","Exhaust","Gear selector","Infotainment screen","Brake system","Close-up details","Lifestyle shot","Three-quarter front angle"],Qa=["Front elevation","Back view","Living room","Kitchen","Dining room","Bedroom","Bathroom","Balcony","Garage","Garden","Swimming pool","Floor plan","Map location","Street view","Neighborhood","Interior detail","Exterior detail","Backyard","Staircase","Hallway","Home office","Playroom","Utility room","Landscaping"],Ya=["Front view","Back view","Left side","Right side","Fabric close-up","Collar detail","Sleeves","Buttons","Zipper","Pocket detail","Brand label","Model wearing it","Folded view","Hanging view","Color variation","Size detail","Matching accessories","Stitching detail","Hem detail","Care label","Style 1","Style 2","Packaging","On model back"],Xa=["Front view","Back view","Left side","Right side","Camera module close-up","Display close-up","Ports","Buttons","Box contents","Charging cable","Screen close-up","Sim tray","Speaker grille","Bottom view","Top view","Angled front","Angled back","With protective case","Retail box","Accessories","Held in hand","Lifestyle shot","Spec sheet","Package contents"],Za=["Front view","Back view","Left side","Right side","Top view","Bottom view","Close-up detail 1","Close-up detail 2","Material texture","Packaging","In use","Lifestyle shot","Scale reference","Color detail","Brand label","Model angle 1","Model angle 2","Accessories","Box contents","Back detail","Angled view 1","Angled view 2","Detail stitching","Complete product"];function ei(e){const t=String(e||"").toLowerCase();return/(car|vehicle|boat|marine|motorcycle)/.test(t)?Ja:/(house|home|property|apartment|condo|villa|mansion|estate|land|real estate)/.test(t)?Qa:/(cloth|fashion|wear|shoe|bag|accessor)/.test(t)?Ya:/(phone|electronic|computer|laptop|tablet|camera|watch)/.test(t)?Xa:Za}function F(e,t="info"){const a=document.getElementById("pf-ai-status");a&&(a.textContent=e||"",a.className="text-[10px] mt-2 "+(t==="error"?"text-red-400":t==="ok"?"text-emerald-300":t==="warn"?"text-amber-300":"text-gray-500"))}function pe(e,t){const a=document.getElementById("pf-ai-badge");a&&a.classList.toggle("hidden",!e),t&&F(t)}function ti(){clearTimeout(window._pfAiTimer),window._pfAiTimer=setTimeout(()=>{const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;[...e.querySelectorAll('input[name="images"]')].some(a=>a.value&&!String(a.value).startsWith("blob:"))&&(F("AI detected new images — analyzing automatically…"),runProductImageAnalysis(!0))},900)}window.runProductImageAnalysis=async function(e=!1){const t=document.getElementById("product-form");if(!t||t.dataset.aiBusy==="1")return;const a=t.dataset.category||"",i=[...t.querySelectorAll('input[name="images"]')].map(s=>s.value).filter(s=>s&&!String(s).startsWith("blob:"));if(!i.length){e||F("Upload at least one image first, then AI can analyze it.","warn");return}t.dataset.aiBusy="1",pe(!0,"AI is analyzing your images…");try{const s=await z.analyzeImages(i,{category:a,existingTitle:t.querySelector('[name="title"]')?.value||""});if(!s){F("AI analysis unavailable — add a Google Gemini API key in AI Settings.","warn");return}ai(s,a),F("AI analysis complete. The fields were auto-filled — review them and save.","ok"),e||u("AI analyzed your images and filled the listing.","success")}catch(s){F("AI analysis failed: "+(s.message||s),"error"),e||u("AI analysis failed: "+(s.message||s),"error")}finally{t.dataset.aiBusy="0",pe(!1)}};function ai(e,t){const a=document.getElementById("product-form");if(!a||!e)return;const i=(d,c)=>{if(c==null||String(c).trim()==="")return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c))},s=(d,c)=>{if(!Array.isArray(c)||!c.length)return;const m=a.querySelector(`[name="${d}"]`);m&&(String(m.value||"").trim()||(m.value=c.join(", ")))};i("title",e.title),i("description",e.description),i("subcategory",e.subcategory),i("brand",e.brand),i("model",e.model),i("color",e.color),i("size",e.size),i("material",e.material),i("storage",e.storage),i("ram",e.ram),i("processor",e.processor),String(a.querySelector('[name="condition"]')?.value||"").trim()||i("condition",e.condition),s("features_text",e.features),s("highlights_text",e.highlights),s("seo_keywords_text",e.seo_keywords);const o=e.specifications||{};["engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"].forEach(d=>{o[d]!=null&&String(o[d]).trim()!==""&&i(d,o[d])}),Array.isArray(o.safety_features)&&s("safety_features",o.safety_features);const r=e.category?String(e.category).trim():"",n=document.getElementById("pf-ai-detected");n&&r&&r.toLowerCase()!==String(t||"").toLowerCase()&&(n.classList.remove("hidden"),n.innerHTML=`<div class="flex items-center gap-2 p-2 rounded-lg bg-amber-500/10 border border-amber-500/25">
    ...
    </div>`),window.lucide&&lucide.createIcons(),Fe()}window.switchProductFormCategory=function(e){const t=document.getElementById("product-form");if(!t)return;const a={},i=new FormData(t);for(const[s,o]of i.entries())s==="images"?(a.images=a.images||[],o&&!String(o).startsWith("blob:")&&a.images.push(String(o))):s==="tags"?(a.tags=a.tags||[],a.tags.push(o)):a[s]=o;a.is_featured=t.querySelector('[name="is_featured"]')?.checked||!1,a.is_active=t.querySelector('[name="is_active"]')?.checked||!1,a.property_id&&String(a.property_id).trim()?showAddProductStep2(e,a):showAddProductStep2(e,{images:a.images||[],...a})};window.expandProductGalleryAi=async function(){const e=document.getElementById("product-form");if(!e||e.dataset.aiBusy==="1")return;const t=e.dataset.category||"",a=document.getElementById("pf-ai-expand-count"),i=Math.min(24,Math.max(1,parseInt(a?.value||"24",10)||24)),o=[...e.querySelectorAll('input[name="images"]')].map(m=>m.value).filter(m=>m&&!String(m).startsWith("blob:"))[0]||document.querySelector("#image-preview img")?.src;if(!o||o==="/fallback.svg"){F("Upload at least one product image first, then AI can generate the full gallery.","warn");return}const r=ei(t),n=Math.min(i,r.length);e.dataset.aiBusy="1";const d=document.getElementById("pf-ai-generated");d&&(d.innerHTML="");let c=0;try{for(let m=0;m<n;m++){pe(!0,`Generating ${m+1}/${n} — ${r[m]}…`);try{const g=await z.generateImages(`Generate a single high-quality, photorealistic marketplace photo of this EXACT product from this angle/perspective: ${r[m]}. Keep the product identical in design, color, and branding. Clean background, sharp focus, professional e-commerce product photography.`,o,1);if(g&&g[0]){const b=await si(g[0]);b&&(ii(b),c+=1)}}catch(g){F(`Stopped at ${m}/${n}: ${g.message||g}`,"error");break}}c?(F(`Generated ${c} image${c>1?"s":""}. They are added to your gallery — save the product to keep them.`,"ok"),u(`${c} AI image(s) generated and added.`,"success")):F("No images could be generated. Check the Gemini API key / image-model access.","error")}finally{e.dataset.aiBusy="0",pe(!1)}};function ii(e){const t=document.getElementById("image-preview");if(!t)return;const a=t.children.length,i=document.createElement("div");i.innerHTML=re(e,a),t.appendChild(i.firstElementChild),te(),ne();const s=document.getElementById("pf-ai-generated");if(s){const o=document.createElement("div");o.className="w-14 h-14 rounded-lg overflow-hidden border border-fuchsia-500/30 relative",o.innerHTML=`<img src="${l(e)}" class="w-full h-full object-cover" onerror="this.src='/fallback.svg'"><span class="absolute bottom-0 inset-x-0 text-center text-[7px] font-black bg-fuchsia-600/80 text-white">AI</span>`,s.appendChild(o)}}async function si(e){try{const a=await(await fetch(e)).blob(),i=(a.type.split("/")[1]||"png").replace("jpeg","jpg"),s=`ai-${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`;return await he(new File([a],s,{type:a.type}))}catch{return e}}function re(e,t){return`<div class="img-thumb ${t===0?"cover-img":""}" data-index="${t}" title="${t===0?"Cover Image":"Image "+(t+1)}">
  ...
  </div>`}function Ht(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),oi(t.dataTransfer.files)}))}function Gt(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>te()})}window.handleImageUpload=async function(e){await zt(e.target.files)};async function oi(e){await zt(e)}async function zt(e){const t=document.getElementById("image-preview");if(t){for(const a of e){if(!a.type.startsWith("image/"))continue;const i=await he(a);if(i){const s=t.children.length,o=document.createElement("div");o.innerHTML=re(i,s),t.appendChild(o.firstElementChild),te()}}ne(),window.lucide&&lucide.createIcons(),ti()}}async function he(e){try{const{data:{session:t}}=await p.auth.getSession();if(!t)return URL.createObjectURL(e);const a=e.name.split(".").pop(),i=`products/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await p.storage.from("product-images").upload(i,e,{contentType:e.type,upsert:!1});if(s)return URL.createObjectURL(e);const{data:o}=p.storage.from("product-images").getPublicUrl(i);return o.publicUrl}catch{return URL.createObjectURL(e)}}window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),te(),ne()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0];if(!i.type.startsWith("image/")){u("Please choose an image file.","error");return}const s=await he(i);if(!s)return;const r=[...a.querySelectorAll(".img-thumb")][e];if(!r)return;const n=r.querySelector("img");n&&(n.src=s),te(),ne(),u("Image replaced. Save changes to apply.","info")};function te(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const s=a.querySelector("img");if(!s)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=s.src,t.appendChild(o),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const n=a.querySelector(".rp");n&&n.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function ne(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0),t.title=a===0?"Cover Image":`Image ${a+1}`})}function Vt(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function ri(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,s]of t.entries())i==="images"?s&&!String(s).startsWith("blob:")&&a.images.push(String(s)):i==="tags"?a.tags.push(String(s)):a.fields[i]=String(s);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function ni(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([s,o])=>{const r=e.querySelector(`[name="${s}"]`);r&&(r.type==="checkbox"?r.checked=o==="on"||o===!0:r.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(s=>{s.checked=i.includes(s.value)}),Array.isArray(t.images)){const s=document.getElementById("image-preview");s&&(s.innerHTML=t.images.map((o,r)=>re(o,r)).join(""),te(),ne())}return!0}function Fe(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",s=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=t.querySelector('[name="stock_quantity"]')?.value,r=o===""||o==null?"Unlimited":o,n=w.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(g=>g.value),c=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",s=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=e.dataset.category||"Product",n=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",d=e.querySelector('[name="is_active"]')?.checked;C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};function li(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Vt(e,t),s=document.getElementById("product-autosave-note");try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);ni(a,c)&&s&&(s.textContent="Autosave restored from your last session.",s.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(ri(a))),s&&(s.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,s.classList.remove("hidden"))}catch{}Fe()};let r;const n=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",n),d.addEventListener("change",n)}),Fe()}window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,s=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";s&&(s.disabled=!0,s.textContent="Saving…");try{const r=new FormData(i),n={};for(const[b,y]of r.entries())b==="images"?(n.images=n.images||[],y&&!String(y).startsWith("blob:")&&n.images.push(String(y))):b==="tags"?(n.tags=n.tags||[],n.tags.push(y)):n[b]=y;n.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",n.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const d=r.get("action")==="draft",c=b=>Me(b),m=b=>{const y=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year"],f={};for(const _ of y){const S=b[_];f[_]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const _=c(b.safety_features);f.safety_features=_.length?_:null}return f};let g;if(a){let b=W((window._productsData||[]).find(P=>P.property_id===a));if(!b){const{data:P}=await p.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();b=P?W(P):null}if(!b)throw new Error("Could not load the current product. Refresh the page and try again.");const y=(P,Ae)=>{const oa=P===""||P==null?"":P,ra=Ae===""||Ae==null?"":Ae;return String(oa).trim()===String(ra).trim()},f={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status","model_year","body_type","mileage","engine","horsepower","transmission","drive_type","fuel_type"].forEach(P=>{y(n[P],b[P])||(f[P]=n[P]==null||n[P]===""?null:n[P])});const _=n.price===""||n.price==null?null:parseFloat(n.price);y(_,b.price)||(f.price=_==null?b.price:Math.max(B,Math.min(G,_)));const S=n.stock_quantity===""||n.stock_quantity==null?null:parseInt(n.stock_quantity,10);y(S,b.stock_quantity)||(f.stock_quantity=Number.isFinite(S)?S:null);const Q=c(n.features_text);y(Q.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(f.features=Q);const se=n.tags||[];y(se.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(f.tags=se);const v=c(n.highlights_text);y(v.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(f.highlights=v);const q=c(n.seo_keywords_text);y(q.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(f.seo_keywords=q);const rt=n.images||[];y(rt.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(f.images=rt);const nt=n.is_featured==="on";!!b.is_featured!==nt&&(f.is_featured=nt);const lt=d?!1:n.is_active==="on";!!b.is_active!==lt&&(f.is_active=lt);const sa=m(n),dt={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...sa};if(JSON.stringify(dt)!==JSON.stringify(b.specifications||{})&&(f.specifications=dt),Object.keys(f).length===0){u("No changes detected — nothing was saved.","info"),s&&(s.disabled=!1,s.textContent=o);return}const ct={...b,...f,property_id:a,updated_at:new Date().toISOString()};if({error:g}=await p.from("showroom_listings").upsert(ct,{onConflict:"property_id"}),g&&Be(g,()=>Pe(ct),"Product update")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":`Product updated — ${Object.keys(f).length} change(s) saved.`)}else{const b=parseInt(n.required_image_count||"0",10)||(Xe.includes(t)?24:0);if(Nt(b,n.images||[],"This listing"),!n.title||!n.title.trim())throw new Error("A product title is required.");if(n.price===""||n.price==null||!isFinite(parseFloat(n.price)))throw new Error("A price is required.");if(!n.condition)throw new Error("Please choose the product condition.");const y={listing_type:"product",category:t,subcategory:n.subcategory||null,title:n.title.trim(),description:n.description||"",price:Math.max(B,Math.min(G,parseFloat(n.price)||0)),currency:n.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:d?!1:n.is_active==="on",is_featured:n.is_featured==="on",brand:n.brand||null,color:n.color||null,size:n.size||null,condition:n.condition||null,warranty:n.warranty||null,availability_status:n.availability_status||"In Stock",stock_quantity:n.stock_quantity?parseInt(n.stock_quantity):null,images:n.images||[],features:c(n.features_text).length?c(n.features_text):n.tags||[],tags:n.tags||[],highlights:c(n.highlights_text),seo_keywords:c(n.seo_keywords_text),is_ai_generated:!!n.catalog_template_id,ai_generated_fields:n.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:m(n)},f=Ve();if(y.property_id=f,{error:g}=await p.from("showroom_listings").insert(y),g&&Be(g,()=>Pe({...y,property_id:y.property_id}),"Product publish")){s&&(s.disabled=!1,s.textContent=o);return}u(d?"Draft saved!":"Product published!")}try{localStorage.removeItem(Vt(t,a))}catch{}closeProductFormModal()}catch(r){u("Error: "+r.message,"error"),s&&(s.disabled=!1,s.textContent=o)}};window.editProduct=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=ft(e)),i||(i=(Array.isArray(T)?T.find(s=>s.property_id===e):null)||null),!i)return u("Product not found","error");showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){const a=W((window._productsData||[]).find(s=>s.property_id===e)),{error:i}=await p.from("showroom_listings").upsert({...a,property_id:e,is_active:t,availability_status:t?"In Stock":"Out of Stock"},{onConflict:"property_id"});if(i)return L(i)?u(`⚠️ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error"):u(`${t?"Publish":"Unpublish"} failed: ${i.message}`,"error");u(t?"Product published":"Product unpublished"),E()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:s,created_at:o,updated_at:r,...n}=a,d=Ve();await p.from("showroom_listings").insert({...n,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(u("Product duplicated"),E())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await p.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),u("Product archived"),E())};const di=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function Ze(){const e=document.getElementById("content");try{const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?yt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(T)){const s=new Set(i.map(r=>r.property_id)),o=T.filter(r=>r.listing_type==="property"&&r.property_id&&!s.has(r.property_id));o.length&&(i=i.concat(o))}i.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0)),window._propertiesData=i,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=xt("property","Real Estate"),i=e.country_code||"US",s=e.currency||ze(i);C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div><label class="lbl">Currency</label><select class="input-field" name="currency" id="ppf-currency" onchange="applyPropertyCatalogTemplate()">${Ot(s)}</select></div>
            </div>
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${di.map(o=>`<option value="${o}" ${e.property_type===o?"selected":""}>${o}</option>`).join("")}
            </select></div>
    ...
    </div>`),Ht(),Gt(),qt("ppf-price"),window.syncPropertyCountry=function(){pt("ppf")},pt("ppf"),De("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>De("pricing"))};window.saveProperty=async function(e,t){e.preventDefault();const a=new FormData(e.target),i=Object.fromEntries(a.entries()),s=a.getAll("images").filter(c=>c&&!c.startsWith("blob:")),o=(i.features_text||"").split(",").map(c=>c.trim()).filter(Boolean),r=t?0:parseInt(i.required_image_count||"24",10)||24;Nt(r,s,"This property");const n={listing_type:"property",category:i.property_type||"Real Estate",subcategory:i.subcategory||null,title:i.title,description:i.description||"",price:Math.max(B,Math.min(G,parseFloat(i.price)||0)),currency:i.currency||"USD",country:i.country||"",country_code:(i.country_code||"").toUpperCase(),state:i.state||"",city:i.city||"",town:i.town||"",product_location:i.product_location||"",latitude:i.latitude?parseFloat(i.latitude):null,longitude:i.longitude?parseFloat(i.longitude):null,property_type:i.property_type||"",listing_status:i.listing_status||"sale",bedrooms:i.bedrooms?parseInt(i.bedrooms):null,bathrooms:i.bathrooms?parseInt(i.bathrooms):null,building_size:i.building_size||"",land_size:i.land_size||"",parking_spaces:i.parking_spaces?parseInt(i.parking_spaces):null,furnished:i.furnished||"",features:o,images:s,highlights:Me(i.highlights_text),seo_keywords:Me(i.seo_keywords_text),is_ai_generated:!!i.catalog_template_id,ai_generated_fields:i.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:i.is_active==="on"};let d;if(t){n.property_id=t;const c=W((window._propertiesData||[]).find(m=>m.property_id===t)||(window._productsData||[]).find(m=>m.property_id===t));({error:d}=await p.from("showroom_listings").upsert({...c,...n},{onConflict:"property_id"}))}else n.property_id=Ve(),{error:d}=await p.from("showroom_listings").insert(n);d&&Be(d,()=>Pe({...n,property_id:t||n.property_id}),t?"Property update":"Property publish")||(u(t?"Property updated!":"Property published!"),N(),Ze())};window.editProperty=async function(e){const{data:t,error:a}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;i||(i=ft(e)),i||(i=(Array.isArray(T)?T.find(s=>s.property_id===e):null)||null),i&&showAddPropertyModal(i)};const ci=["pending_verification","payment_received","payment_approved","processing","shipped","in_transit","out_for_delivery","delivered","cancelled","rejected"];async function Wt(){const e=document.getElementById("content");try{const{data:t}=await p.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),a=t||[],i=["All","Pending","Paid","Processing","Shipped","Delivered","Cancelled"];let s="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>ui(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function ui(e){return`<tr class="order-row" data-status="${e.status}" data-search="${l(e.order_number)} ${l(e.full_name)} ${l(e.email)}">
      ...
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",$a(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",M(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${l(i)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${ci.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await p.from("payment_receipts").update({status:t}).eq("id",e);if(a){u(a.message,"error");return}u("Order status updated"),N(),Wt()};async function pi(){const e=document.getElementById("content");try{const{data:t}=await p.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
    ...
    </div>`)};async function et(){const e=document.getElementById("content");try{const{data:t}=await p.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),a=t||[],i=a.filter(s=>!s.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="space-y-3" id="reviews-list">
          ${a.length===0?ee("star","No Reviews","Customer reviews will appear here."):a.map(s=>mi(s)).join("")}
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}function mi(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"★":"☆").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
  ...
  </div>`}window.filterReviewTab=function(e){["all","pending","approved"].forEach(t=>document.getElementById(`rtab-${t}`)?.classList.toggle("active",t===e)),document.querySelectorAll(".review-card").forEach(t=>{const a=e==="all"||e==="pending"&&t.dataset.approved==="false"||e==="approved"&&t.dataset.approved==="true";t.style.display=a?"":"none"})};window.approveReview=async function(e){await p.from("product_reviews").update({is_approved:!0}).eq("id",e),u("Review approved"),et()};window.deleteReview=async function(e){confirm("Delete this review permanently?")&&(await p.from("product_reviews").delete().eq("id",e),u("Review deleted"),et())};async function Kt(){const e=document.getElementById("content");try{const{data:t}=await p.from("support_messages").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.markMsgRead=async function(e){await p.from("support_messages").update({is_read:!0}).eq("id",e),u("Marked as read"),Kt()};async function ve(){const e=document.getElementById("content");try{const{data:t}=await p.from("coupons").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:s}=await p.from("coupons").insert(i);if(s){u(s.message,"error");return}u("Coupon created!"),N(),ve()};window.toggleCoupon=async function(e,t){await p.from("coupons").update({is_active:t}).eq("id",e),u(t?"Coupon activated":"Coupon deactivated"),ve()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await p.from("coupons").delete().eq("id",e),u("Coupon deleted"),ve())};async function bi(){const e=document.getElementById("content");try{const{data:t}=await p.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function xe(){const e=document.getElementById("content");try{const{data:t}=await p.from("promotions").select("*").order("created_at",{ascending:!1}),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="grid gap-3">
          ${a.length===0?ee("megaphone","No Promotions","Create banners and promotions to advertise products.",'<button onclick="showAddAdModal()" class="btn-press flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-4 py-2.5 rounded-xl transition"><i data-lucide="plus" class="w-4 h-4"></i> Add Promotion</button>'):a.map(i=>`
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ${i.image_url?`<img src="${l(i.image_url)}" class="w-20 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-20 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}
                <div class="flex-1 min-w-0">
                  <p class="text-sm font-black text-white">${l(i.title||i.name)}</p>
                  <p class="text-xs text-gray-400 mt-0.5">${l(i.description||"")}</p>
                  <div class="flex items-center gap-2 mt-1.5">${I(i.is_active?"active":"inactive")}<span class="text-[10px] text-gray-500">${j(i.start_date)} → ${j(i.end_date)}</span></div>
                </div>
                <div class="flex gap-1 shrink-0">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}window.showAddAdModal=function(){C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        </div>`};const{data:t}=await p.from("ai_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.active_provider||"gemini",s=X.slice(0,10),o=X.slice(10);e.innerHTML=`
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${s.map(r).join("")}</div>
          </div>
          ...
          <div class="glass-soft border border-violet-500/15 rounded-2xl p-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">${o.map(r).join("")}</div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
            ...
            ${[{key:"customer_ai_enabled",label:"Customer AI Chatbot",desc:"Customers can chat with AI on your website",val:a.customer_ai_enabled},{key:"product_ai_enabled",label:"AI Product Creation",desc:"AI auto-fills product descriptions",val:a.product_ai_enabled!==!1},{key:"ai_code_assist",label:"AI Code Assistant",desc:"AI helps build and edit your website code",val:a.ai_code_assist!==!1},{key:"ai_moderation",label:"AI Content Moderation",desc:"Auto-approve/reject customer reviews using AI",val:a.ai_moderation}].map(n=>`
...
Respond with valid JSON only.`;if(s)return this._geminiVision(s,a,e,r);if(o){const n=`

(No image access is configured. The product is currently categorized as "${t.category||"Unknown"}"${t.existingTitle?` and titled "${t.existingTitle}"`:""}. Base your content on that plus general knowledge of typical products in this category.)`,d=await this.chat([{role:"user",content:r+n}],{maxTokens:4e3});return Ue(d.text)}return null},async _geminiVision(e,t,a,i){const s=t[e.kf],o=t[e.mf]||"gemini-2.5-flash",r=[{text:i}];let n=0;for(const b of(a||[]).slice(0,4))try{const y=await fetch(b).then(_=>_.blob());if(!y||!y.size)continue;const f=await mt(y);f&&(r.push({inlineData:{mimeType:y.type||"image/jpeg",data:f}}),n+=1)}catch{}if(!n)throw new Error("Could not read the uploaded images.");const d=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(o)}:generateContent?key=${encodeURIComponent(s)}`,c=await fetch(d,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:r}],generationConfig:{temperature:.3,maxOutputTokens:4096}}),signal:AbortSignal.timeout(6e4)});if(!c.ok){const b=await c.text().catch(()=>"");throw new Error(`AI vision failed (${c.status}): ${b.slice(0,120)}`)}const g=((await c.json())?.candidates?.[0]?.content?.parts||[]).map(b=>b.text||"").join("").trim();if(!g)throw new Error("The AI returned no analysis.");return Ue(g)},async generateImages(e,t,a=1){const i=await this.getConfig(),o=(await this.getOrderedProviders()).find(c=>c.id==="gemini");if(!o)throw new Error("AI image generation needs a Google Gemini API key (AI Settings).");const r=i[o.kf],n=["gemini-2.5-flash-image","gemini-2.0-flash-preview-image-generation","gemini-2.5-flash-preview-image"];let d=null;for(const c of n)try{const m=[{text:e}];if(t)try{const _=await fetch(t).then(Q=>Q.blob()),S=await mt(_);S&&m.push({inlineData:{mimeType:_.type||"image/jpeg",data:S}})}catch{}const g=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(c)}:generateContent?key=${encodeURIComponent(r)}`,b=await fetch(g,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:m}],generationConfig:{responseModalities:["TEXT","IMAGE"],candidateCount:a||1,temperature:.45}}),signal:AbortSignal.timeout(12e4)});if(!b.ok){const _=await b.text().catch(()=>""),S=_.toLowerCase();if(S.includes("not found")||S.includes("model")||S.includes("unsupported")){d=new Error(`Image model ${c} unavailable on this key.`);continue}throw new Error(`AI image generation failed (${b.status}): ${_.slice(0,120)}`)}const y=await b.json(),f=[];for(const _ of y?.candidates||[])for(const S of _?.content?.parts||[])S?.inlineData?.data&&f.push(`data:${S.inlineData.mimeType||"image/png"};base64,${S.inlineData.data}`);if(f.length)return f;d=new Error("The AI returned no image.")}catch(m){d=m}throw d||new Error("AI image generation failed.")}};function mt(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>{const i=a.result;if(typeof i=="string"){const s=i.indexOf(",");t(s>=0?i.slice(s+1):i)}else t("")},a.onerror=()=>t(""),a.readAsDataURL(e)})}window.aiClient=z;window.showAiStatusModal=async function(){const e=await z.getStatus(),t=e.filter(a=>a.hasKey);C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.testAiCall=async function(){const e=document.getElementById("ai-test-input")?.value?.trim();if(!e)return;const t=document.getElementById("ai-test-output");t.classList.remove("hidden"),t.textContent="⏳ Trying providers…";try{const a=await z.prompt(e,{onProviderSwitch:i=>{t.textContent=`⚡ Using: ${i}…`}});t.textContent=`✓ [${a.provider} · ${a.model}]

${a.text}`}catch(a){t.textContent=`❌ ${a.message}`}};let h=null;const Qt=[{key:"rewrite",label:"Rewrite Title & Description",icon:"pen-line",prompt:"Rewrite the title and description to be more professional, compelling, and conversion-focused. Keep all product facts accurate. The title must be a real, professional product name that matches the item and its category — never a generic placeholder."},{key:"name",label:"Professional Name",icon:"badge-check",prompt:'Give this product a real, professional product name that accurately matches what it actually is and its category. Never use placeholder names like "AI Product", "AI Curated Product", or anything similar.'},{key:"price",label:"Optimize Price & Stock",icon:"dollar-sign",prompt:"Suggest a competitive, realistic price and an optimal stock quantity for this product based on the category and current data."},{key:"category",label:"Fix Category & Specs",icon:"tags",prompt:"Fix the category, subcategory, and specifications so they accurately describe this product. Use the category list if possible."},{key:"images",label:"Clean Up Duplicate/Bad Images",icon:"images",prompt:"Identify duplicate, broken, or low-quality images among the CURRENT images list only, and list their exact URLs in images_to_remove. Do not invent any image URLs."}];function fi(e){return[...window._productsData||[],...window._propertiesData||[]].find(a=>a.property_id===e)||null}function yi(e){const t=["property_id","listing_type","category","subcategory","title","description","price","currency","brand","color","size","condition","availability_status","stock_quantity","features","tags","highlights","seo_keywords","specifications","bedrooms","bathrooms","city","state","country","images"],a={};for(const i of t)i in e&&(a[i]=e[i]);return a}function Ue(e){if(!e)return null;let t=String(e).trim();const a=t.match(/```(?:json)?\s*([\s\S]*?)```/i);a&&(t=a[1].trim());const i=t.indexOf("{"),s=t.lastIndexOf("}");if(i===-1||s===-1||s<=i)return null;const o=t.slice(i,s+1);try{return JSON.parse(o)}catch{return null}}function bt(e){return Array.isArray(e)?e.length?e.join(" · "):"(empty)":e&&typeof e=="object"?JSON.stringify(e):e==null||e===""?"(empty)":String(e)}window.openProductAiAssistant=async function(e,t="products"){let a=fi(e);if(!a)try{const{data:i}=await p.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();i&&(a=i)}catch{}if(!a){u("Product not found.","error");return}h={pid:e,from:t==="properties"?"properties":"products",product:a,busy:!1,suggestions:null,approved:new Set,removedImages:new Set,addedImages:[],instruction:""},O()};function O(){const e=h;if(!e)return;const t=e.product,a=t.images&&t.images[0]?t.images[0]:"/fallback.svg";C(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`),window.lucide&&lucide.createIcons()}function hi(){const e=h;if(!e)return"";const t=Array.isArray(e.product.images)?e.product.images:[],a=[...t,...e.addedImages],i={};t.forEach(r=>{i[r]=(i[r]||0)+1});const s=Object.keys(i).filter(r=>i[r]>1),o=a.map((r,n)=>{const d=n<t.length,c=d&&e.removedImages.has(r),m=d&&s.includes(r);return`
    ...
    </div>`}function vi(){const e=h;return e?`
    <div class="glass-soft border border-fuchsia-500/20 rounded-2xl p-4">
      ...
      <div class="flex flex-wrap gap-1.5 mb-3">${Qt.map(a=>`
    ...
    </div>`:""}function xi(){const e=h;if(!e)return"";if(!e.suggestions)return`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-4">
    ...
    <div class="glass-soft border border-emerald-500/20 rounded-2xl p-4 space-y-2">
      ...
      </div>`}window.productAiSyncInput=function(e){h&&(h.instruction=e)};window.productAiQuickAction=function(e){const t=Qt.find(a=>a.key===e);!t||!h||(h.instruction=t.prompt,runProductAiInstruction())};window.productAiToggleApproved=function(e,t){h&&(t?h.approved.add(e):h.approved.delete(e),O())};window.productAiApproveAll=function(){if(!(!h||!h.suggestions)){for(const e of Object.keys(h.suggestions))h.approved.add(e);h.removedImages.size&&h.approved.add("images_to_remove"),O()}};window.productAiToggleRemoveImage=function(e){if(!h)return;const t=Array.isArray(h.product.images)?h.product.images:[],i=[...t,...h.addedImages][e];i&&(e<t.length?h.removedImages.has(i)?h.removedImages.delete(i):h.removedImages.add(i):h.addedImages=h.addedImages.filter(s=>s!==i),O())};window.productAiDetectDuplicates=function(){if(!h)return;const e=Array.isArray(h.product.images)?h.product.images:[],t={};e.forEach(s=>{t[s]=(t[s]||0)+1});let a=0;const i=new Set;for(const s of e)t[s]>1&&(i.has(s)?(h.removedImages.has(s)||(a+=1),h.removedImages.add(s)):i.add(s));a?(h.approved.add("images_to_remove"),u(`Marked ${a} duplicate image(s) for removal.`,"info")):u("No duplicate images found.","info"),O()};window.productAiUploadImages=async function(e){if(!h||!e||!e.files||!e.files.length)return;const t=[...e.files];let a=0;for(const i of t){if(!i.type.startsWith("image/"))continue;const s=await he(i);s&&(h.addedImages.push(s),a+=1)}e.value="",a?u(`${a} image(s) uploaded and staged.`,"success"):u("Upload failed.","error"),O()};window.runProductAiInstruction=async function(){const e=h;if(!e||e.busy)return;const t=(e.instruction||"").trim()||"Improve this product listing professionally.";e.busy=!0,O();const a=wi(e,t);try{const i=await z.prompt(a,{maxTokens:4e3,onProviderSwitch:o=>{}}),s=Ue(i.text);if(!s)throw new Error("The AI did not return valid JSON suggestions.");e.suggestions=s,e.approved=new Set(Object.keys(s)),e.approved.add("images_to_remove"),u("Suggestions ready — review and approve before saving.","info")}catch(i){u(`AI error: ${i.message}`,"error")}finally{e.busy=!1,O()}};function wi(e,t){const a=e.product,i=JSON.stringify(yi(a),null,2);return`You are the AI product manager assistant for ONE product in the Weverse Online Shop admin dashboard.
...
- Respond with valid JSON only.`}window.applyProductAiChanges=async function(){const e=h;if(!e||e.busy)return;const t=[...e.approved].some(n=>n!=="images_to_remove"),a={};if(e.suggestions)for(const n of e.approved)n!=="images_to_remove"&&n in e.suggestions&&e.suggestions[n]!==void 0&&(a[n]=e.suggestions[n]);if(!t&&!e.removedImages.size&&!e.addedImages.length){u("Approve at least one change before saving.","error");return}const i=Array.isArray(e.product.images)?e.product.images:[],s=new Set(e.removedImages);e.approved.has("images_to_remove")&&Array.isArray(e.suggestions?.images_to_remove)&&e.suggestions.images_to_remove.forEach(n=>s.add(n));const o=[...i.filter(n=>!s.has(n)),...e.addedImages],r=W({...e.product,...a,images:o,property_id:e.pid,updated_at:new Date().toISOString()});e.busy=!0,O();try{const{error:n}=await p.from("showroom_listings").upsert(r,{onConflict:"property_id"});if(n)throw n;u("Changes saved to Supabase.","success");const d=e.from;h=null,N(),d==="properties"?Ze():E()}catch(n){e.busy=!1,n&&L(n)?u("⚠️ Save blocked: database admin role is not active. Re-run the admin permission migration, or contact the owner.","error"):u(`Save failed: ${n&&n.message||"unknown error"}`,"error"),O()}};const tt=[{id:"flow",name:"Flow"},{id:"veo",name:"Veo"},{id:"luma",name:"Luma"},{id:"runway",name:"Runway"},{id:"pika",name:"Pika"},{id:"kling",name:"Kling"},{id:"hailuo",name:"Hailuo"},{id:"pixverse",name:"PixVerse"},{id:"hedra",name:"Hedra"},{id:"heygen",name:"HeyGen"},{id:"tavus",name:"Tavus"}],_i=["Product launch","Seasonal sale","Brand awareness","Lead generation","Live stream conversion","Retargeting"];function at(e){return Array.isArray(e)?e:[]}function Yt(e=[]){const t=new Map(at(e).map(a=>[a.id,a]));return tt.map(a=>{const i=t.get(a.id)||{};return{id:a.id,name:a.name,enabled:!!i.enabled,apiKey:i.apiKey||"",model:i.model||"",baseUrl:i.baseUrl||""}})}async function Xt(e){const{data:t}=await p.from("ai_settings").select("id").limit(1).maybeSingle();let a;if(t?.id?{error:a}=await p.from("ai_settings").update(e).eq("id",t.id):{error:a}=await p.from("ai_settings").insert(e),a)throw a}async function it(e){const{data:t}=await p.from("ai_settings").select("ai_ad_generation_history").limit(1).maybeSingle(),a=[e,...at(t?.ai_ad_generation_history)].slice(0,120);await Xt({ai_ad_generation_history:a})}async function Zt(e){try{const{data:i,error:s}=await p.from("site_settings").select("id").limit(1).maybeSingle();if(s)throw s;let o;if(i?.id?{error:o}=await p.from("site_settings").update(e).eq("id",i.id):{error:o}=await p.from("site_settings").insert(e),o)throw o;return}catch{}const t={mode:"ai_ad",startsAt:e.ai_ad_starts_at||null,endsAt:e.ai_ad_ends_at||null,ctaLabel:e.ai_ad_cta_label||"Shop Now",muted:e.ai_ad_muted!==!1},a={is_live:!!e.ai_ad_enabled,badge_text:e.ai_ad_badge||"AI Advertisement",headline:e.ai_ad_title||"",embed_url:e.ai_ad_video_url||"",description:`AI_AD_META:${JSON.stringify(t)}`,stream_status:e.ai_ad_enabled?"ai_ad":"offline",started_at:e.ai_ad_starts_at||null,updated_at:new Date().toISOString()};try{const{data:i}=await p.from("public_live_state").select("id").limit(1).maybeSingle();let s;if(i?.id?{error:s}=await p.from("public_live_state").update(a).eq("id",i.id):{error:s}=await p.from("public_live_state").insert(a),!s)return}catch{}try{localStorage.setItem(kt,JSON.stringify({ai_ad_enabled:!!e.ai_ad_enabled,ai_ad_video_url:e.ai_ad_video_url||"",ai_ad_badge:e.ai_ad_badge||"AI Advertisement",ai_ad_title:e.ai_ad_title||"",ai_ad_cta_label:e.ai_ad_cta_label||"Shop Now",ai_ad_muted:e.ai_ad_muted!==!1,ai_ad_starts_at:e.ai_ad_starts_at||null,ai_ad_ends_at:e.ai_ad_ends_at||null,ai_ad_duration_seconds:e.ai_ad_duration_seconds||30,ai_ad_updated_at:new Date().toISOString()}))}catch{}}function ki(e){if(!e||typeof e!="string"||!e.startsWith("AI_AD_META:"))return null;try{return JSON.parse(e.slice(11))}catch{return null}}async function Si(){try{const{data:e,error:t}=await p.from("site_settings").select("*").limit(1).maybeSingle();if(!t&&e)return e}catch{}try{const{data:e,error:t}=await p.from("public_live_state").select("*").limit(1).maybeSingle();if(t||!e)throw new Error("public_live_state unavailable");const a=ki(e.description),i=a?.startsAt||e.started_at||null,s=a?.endsAt||null;return{ai_ad_enabled:!!e.is_live&&e.stream_status==="ai_ad"&&!!e.embed_url,ai_ad_video_url:e.embed_url||"",ai_ad_badge:e.badge_text||"AI Advertisement",ai_ad_title:e.headline||"",ai_ad_cta_label:a?.ctaLabel||"Shop Now",ai_ad_muted:a?.muted!==!1,ai_ad_starts_at:i,ai_ad_ends_at:s,ai_ad_duration_seconds:s&&i?Math.max(5,Math.round((new Date(s).getTime()-new Date(i).getTime())/1e3)):30}}catch{try{const e=localStorage.getItem(kt),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}}async function we(){const e=document.getElementById("content");if(e)try{const[{data:t},a]=await Promise.all([p.from("ai_settings").select("*").limit(1).maybeSingle(),Si()]),i=t||{},s=a||{},o=Yt(i.ai_ad_video_providers),r=at(i.ai_ad_generation_history).sort((d,c)=>new Date(c.created_at||0).getTime()-new Date(d.created_at||0).getTime()).slice(0,12),n=!!s.ai_ad_enabled&&!!s.ai_ad_video_url&&(!s.ai_ad_ends_at||new Date(s.ai_ad_ends_at).getTime()>Date.now());e.innerHTML=`
      <div class="space-y-6 fade-in">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div>
              ...
              <select id="ai-ad-goal" class="input-field text-xs" name="goal">
                ${_i.map(d=>`<option value="${l(d)}">${l(d)}</option>`).join("")}
              </select>
            </div>
            <div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`}}window.saveAiAdProviders=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries());try{const{data:i}=await p.from("ai_settings").select("ai_ad_video_providers").limit(1).maybeSingle(),s=Yt(i?.ai_ad_video_providers),o=new Map(s.map(n=>[n.id,n])),r=tt.map(n=>{const d=n.id,c=o.get(d)||{},m=String(a[`provider_${d}_api_key`]||"").trim();return{id:d,name:n.name,enabled:t.get(`provider_${d}_enabled`)==="on",apiKey:m||c.apiKey||"",model:String(a[`provider_${d}_model`]||"").trim(),baseUrl:String(a[`provider_${d}_base_url`]||"").trim()}});await Xt({ai_ad_video_providers:r}),u("AI advertisement provider settings saved.","success"),we()}catch(i){u("Failed to save providers: "+i.message,"error")}};window.generateAiAdScript=async function(){const e=document.getElementById("ai-ad-brief")?.value?.trim(),t=document.getElementById("ai-ad-goal")?.value||"Product launch",a=document.getElementById("ai-ad-provider"),i=document.getElementById("ai-ad-script");if(!e){u("Enter campaign brief first.","error");return}if(i){i.value="Generating script...";try{const s=["Create a short video advertisement script for an ecommerce marketplace.",`Goal: ${t}`,`Brief: ${e}`,"Return only plain text in this exact structure:","Headline:","Voiceover:","On-screen text:","CTA:"].join(`
`),o=await z.prompt(s,{onProviderSwitch:r=>{i.value=`Generating with ${r}...`}});i.value=o.text||"",await it({created_at:new Date().toISOString(),goal:t,brief:e,provider_name:o.provider,provider_id:a?.value||"",status:"script_generated",script:o.text||"",video_url:null}),u(`Script generated with ${o.provider}.`,"success")}catch(s){i.value="",u("Script generation failed: "+s.message,"error")}}};window.activateAiAdvertisement=async function(e){e.preventDefault();const t=new FormData(e.target),a=String(t.get("goal")||"Product launch"),i=String(t.get("provider_id")||""),s=tt.find(b=>b.id===i)?.name||i,o=String(t.get("brief")||"").trim(),r=String(t.get("script")||"").trim(),n=String(t.get("video_url")||"").trim(),d=Math.max(5,Math.min(900,parseInt(String(t.get("duration_seconds")||"30"),10)||30)),c=Date.now(),m=new Date(c).toISOString(),g=new Date(c+d*1e3).toISOString();if(!n){u("Video URL is required.","error");return}try{const b={ai_ad_enabled:!0,ai_ad_video_url:n,ai_ad_badge:String(t.get("badge")||"AI Advertisement").trim()||"AI Advertisement",ai_ad_title:String(t.get("title")||"").trim(),ai_ad_cta_label:String(t.get("cta_label")||"Shop Now").trim()||"Shop Now",ai_ad_duration_seconds:d,ai_ad_muted:t.get("muted")==="on",ai_ad_provider_id:i,ai_ad_starts_at:m,ai_ad_ends_at:g,ai_ad_updated_at:new Date().toISOString()};await Zt(b),await it({created_at:m,goal:a,brief:o,provider_name:s,provider_id:i,status:"active",script:r,video_url:n,ends_at:g}),u("AI advertisement activated. Homepage will switch to AI video now.","success"),we()}catch(b){u("Failed to activate AI advertisement: "+b.message,"error")}};window.deactivateAiAdvertisement=async function(){try{await Zt({ai_ad_enabled:!1,ai_ad_updated_at:new Date().toISOString()}),await it({created_at:new Date().toISOString(),goal:"Manual stop",provider_name:"Admin",provider_id:"manual",status:"inactive",script:"",video_url:null}),u("AI advertisement stopped.","success"),we()}catch(e){u("Failed to stop AI advertisement: "+e.message,"error")}};async function $i(){const e=document.getElementById("content");try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
      <div class="space-y-6 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons(),Ft(s)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Ii(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=ea(10);await p.from("admin_2fa").update({backup_codes:e}).eq("user_id",w.user.id),u("New backup codes generated"),ta(e.map(t=>t.code)),_e()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await p.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await p.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await p.from("admin_2fa").update({enabled:!1}).eq("user_id",w.user.id),await U(w.user.id,"2fa_disabled"),u("2FA has been disabled"),_e()}catch(e){u(e.message,"error")}};async function Ei(){const e=document.getElementById("content");try{const{data:t}=await p.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Ci(){const e=document.getElementById("content");try{const{data:t}=await p.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),s=document.createElement("a");s.href=URL.createObjectURL(i),s.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,s.click(),u("Orders exported!")};async function Li(){const e=document.getElementById("content"),{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${l(t.message)}</div>`)}}async function Se(){const e=document.getElementById("content");e&&(e.innerHTML=K());try{let r=function(n,d,c,m="",g="blue"){const b=!!(c&&c.trim());return`
        ...
        </div>`};const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{},i=a.brand_name||a.site_name||St,s=a.brand_slogan||a.site_tagline||$t,o=a.brand_logo||a.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="rounded-xl overflow-hidden border border-blue-500/10">
            <div id="preview-header" class="flex items-center gap-3 px-4 py-3" style="background:#0f172a">
              <div id="preview-logo-wrap" class="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 overflow-hidden" style="background:var(--preview-primary,#f97316)">
                ${o?`<img src="${l(o)}" alt="${l(i)}" class="w-full h-full object-contain p-1">`:'<i data-lucide="globe" class="w-4 h-4 text-white"></i>'}
              </div>
              <div>
                <p id="preview-name" class="text-sm font-black text-white leading-none">${l(i)}</p>
                <p id="preview-slogan" class="text-[10px] text-orange-400 font-semibold mt-0.5">${l(s)}</p>
              </div>
              <div id="preview-badge-wrap" class="ml-auto ${a.brand_badge?"":"hidden"}">
                <img id="preview-badge" src="${l(a.brand_badge||"")}" alt="Verified" class="w-6 h-6 object-contain">
              </div>
            </div>
            <div class="px-4 py-2 border-t border-gray-800 text-[11px] text-gray-500" style="background:#070b16">
              <span id="preview-btn" style="background:${l(a.brand_primary_color||"#f97316")};color:#000;padding:4px 12px;border-radius:8px;font-weight:700;font-size:11px">Shop Now</span>
              <span class="ml-3" style="color:${l(a.brand_secondary_color||"#3b82f6")}">All Products →</span>
            </div>
          </div>
          <!-- Footer preview -->
        ...
        <form id="brand-form" onsubmit="saveBrandSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              ...
              <div>
                ...
                <input class="input-field" name="brand_short_name" value="${l(a.brand_short_name||"")}" placeholder="e.g. Weverse">
              </div>
              <div class="sm:col-span-2">
                <label class="lbl">Slogan / Tagline *</label>
                <input class="input-field" name="brand_slogan" id="inp-brand-slogan" value="${l(s)}" placeholder="e.g. Shop Globally, Delivered Worldwide" oninput="updateLivePreview()">
              </div>
              <div class="sm:col-span-2">
                <label class="lbl">Brand Description</label>
                <textarea class="input-field" name="brand_description" rows="2" placeholder="Short description…">${l(a.brand_description||"")}</textarea>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-primary" value="${l(a.brand_primary_color||"#f97316")}" oninput="document.getElementById('ct-primary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-primary" name="brand_primary_color" value="${l(a.brand_primary_color||"#f97316")}" placeholder="#f97316" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-primary').value=this.value;updateLivePreview()">
                </div>
              </div>
              <div>
                <label class="lbl">Secondary Color (links, highlights)</label>
                <div class="flex gap-2 items-center">
                  <input type="color" class="w-10 h-10 rounded-xl border border-blue-500/20 bg-transparent cursor-pointer shrink-0" id="cp-secondary" value="${l(a.brand_secondary_color||"#3b82f6")}" oninput="document.getElementById('ct-secondary').value=this.value;updateLivePreview()">
                  <input class="input-field flex-1 font-mono" id="ct-secondary" name="brand_secondary_color" value="${l(a.brand_secondary_color||"#3b82f6")}" placeholder="#3b82f6" oninput="if(/^#[0-9a-fA-F]{6}$/.test(this.value))document.getElementById('cp-secondary').value=this.value;updateLivePreview()">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-grid form-grid-2">
              <div>
                ...
                <select class="input-field" name="brand_font" id="brand-font-select" onchange="previewFont(this.value)">
                  ${["Inter","Poppins","Roboto","Montserrat","Nunito","Raleway","Lato","Open Sans","Outfit","Plus Jakarta Sans","DM Sans","Urbanist","Sora","Manrope","Work Sans","Space Grotesk"].map(n=>`<option value="${n}" ${(a.brand_font||"Inter")===n?"selected":""}>${n}</option>`).join("")}
                </select>
              </div>
              <div>
                <label class="lbl">Custom Google Font (overrides above)</label>
                <input class="input-field" name="brand_custom_font" value="${l(a.brand_custom_font||"")}" placeholder="e.g. Space Grotesk">
              </div>
            </div>
            <div id="font-preview" class="p-3 rounded-xl bg-gray-900 border border-blue-500/10">
              <p id="font-sample" class="text-sm text-white font-bold" style="font-family:'${l(a.brand_font||"Inter")}',sans-serif">The quick brown fox jumps — 0123456789 · Weverse Online Shop</p>
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="p-4 bg-blue-500/5 border border-blue-500/20 rounded-2xl space-y-3">
              ...
              ${r("Verification Badge Image","brand_badge",a.brand_badge,"Upload your blue checkmark or any verification badge. Recommended: 64×64px PNG with transparent background.","blue")}
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ${r("Brand Logo / Banner Image","brand_logo",o,"Upload your image here. This changes only the logo/banner image and keeps the other brand fields as they are.")}
              ${r("Favicon / Tab Icon","brand_favicon",a.brand_favicon,"Browser tab icon. 32×32 or 64×64px.")}
              ${r("Mobile Logo","brand_mobile_logo",a.brand_mobile_logo,"Smaller logo for phones. 120×40px.")}
              ${r("Header Logo","brand_header_logo",a.brand_header_logo,"Top navigation bar.")}
              ${r("Footer Logo","brand_footer_logo",a.brand_footer_logo,"Website footer.")}
              ${r("Login Page Logo","brand_login_logo",a.brand_login_logo,"Shown on auth/login page.")}
              ${r("Admin Dashboard Logo","brand_admin_logo",a.brand_admin_logo,"Admin sidebar header.")}
              ${r("OG / Social Image","brand_og_image",a.brand_og_image,"1200×630px — shown when sharing links.")}
            </div>
          </div>
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
            ...
            <div class="form-grid form-grid-2">
              <div><label class="lbl">Website URL</label><input class="input-field" name="brand_website_url" value="${l(a.brand_website_url||a.production_url||"https://weverseonlineshop.com")}" placeholder="https://…"></div>
              <div><label class="lbl">Support Email</label><input type="email" class="input-field" name="brand_email" value="${l(a.brand_email||a.contact_email||"")}" placeholder="support@…"></div>
              <div><label class="lbl">Phone / WhatsApp</label><input class="input-field" name="brand_phone" value="${l(a.brand_phone||a.contact_phone||"")}" placeholder="+1 234…"></div>
              <div><label class="lbl">Business Address</label><input class="input-field" name="brand_address" value="${l(a.brand_address||a.contact_address||"")}" placeholder="City, Country"></div>
            </div>
          </div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,a)=>Ti(t,a)).join("")}
    ...
    </div>`,ot(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(st()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[st()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ot())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=be.find(s=>s.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||ht(t),ot(),renderManualPaymentAccountsEditor()};async function Ne(){const e=document.getElementById("content");e&&(e.innerHTML=K());try{const{data:t}=await p.from("site_settings").select("*").limit(1).maybeSingle(),i={...fa()||{},...t||{}};window._manualPaymentAccounts=ya(i).map(s=>({...s})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${l(ha(i))}</textarea>
              </div>
              <div>
    ...
    </div>`}function Mi(e){return e.length?e.map(t=>`
    ...
    </div>`).join(""):'<p class="text-sm text-gray-500 text-center py-8">No live sessions created yet.</p>'}async function ie(){const e=document.getElementById("content");e&&(e.innerHTML=K()),await ae();const t=window._livePublicState||{},a=window._liveControlAdminState,i=a.streamingPlatforms.filter(r=>r.enabled).length,s=a.liveSessions,o=[...a.streamingPlatforms].sort((r,n)=>r.id==="tiktok-live"?-1:n.id==="tiktok-live"?1:0);e.innerHTML=`
    <div class="space-y-5 fade-in">
      <div class="flex flex-wrap items-center gap-3">
        <div class="flex-1">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${o.map(r=>ia(r,He.find(n=>n.id===r.id),"streamingPlatforms")).join("")}
        </div>
      </div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}function Ri(e){return e.length?e.map(t=>`
    <div class="glass-soft border border-blue-500/10 rounded-xl p-4 flex flex-col gap-3 lg:flex-row lg:items-center">
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 mb-1"><span class="text-sm font-black text-white">${l(t.title)}</span>${I(t.status)}</div>
    ...
    </div>`).join(""):'<p class="text-sm text-gray-500 text-center py-8">No video call rooms created yet.</p>'}async function le(){const e=document.getElementById("content");e&&(e.innerHTML=K()),await ae();const t=window._liveControlAdminState,a=t.videoCallProviders.filter(s=>s.enabled).length,i=t.videoCallRooms.filter(s=>s.status==="live").length;e.innerHTML=`
    <div class="space-y-5 fade-in">
      <div class="flex flex-wrap items-center gap-3">
        <div class="flex-1">
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
          ${t.videoCallProviders.map(s=>ia(s,ba.find(o=>o.id===s.id),"videoCallProviders")).join("")}
        </div>
      </div>
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.updateLivePlatformField=function(e,t,a,i){const o=(window._liveControlAdminState?.[e]||[]).find(r=>r.id===t);o&&Bi(o,a,i)};window.toggleLivePlatformEnabled=function(e,t,a){const s=(window._liveControlAdminState?.[e]||[]).find(o=>o.id===t);s&&(s.enabled=a)};async function R(e=!0){const{error:t}=await ua(window._liveControlAdminState);return t?(u("Saved locally. Run the live manager migration to persist provider settings.","info"),!1):(e&&u("Live manager settings saved"),!0)}window.saveLiveStreamingSettings=async function(){await R(!0)};window.saveVideoCallSettings=async function(){await R(!0)};window.createLiveSession=async function(e){await ae();const t=[...document.querySelectorAll("[data-live-platform-select]:checked")].map(i=>i.value),a={id:`session-${Date.now()}`,title:document.getElementById("live-session-title")?.value?.trim()||"Live Stream",headline:document.getElementById("live-session-headline")?.value?.trim()||"",description:document.getElementById("live-session-description")?.value?.trim()||"",embedUrl:document.getElementById("live-session-embed")?.value?.trim()||"",badgeText:document.getElementById("live-session-badge")?.value?.trim()||"LIVE NOW",status:e==="live"?"live":"scheduled",scheduledAt:document.getElementById("live-session-scheduled")?.value||"",startedAt:e==="live"?new Date().toISOString():"",selectedPlatforms:t,notifyVisitors:document.getElementById("live-notify-visitors")?.checked!==!1,showHomepageBadge:document.getElementById("live-show-badge")?.checked!==!1,showHomepageEmbed:!!document.getElementById("live-show-embed")?.checked,viewerCount:0,commentCount:0,streamStatus:e==="live"?"live":"scheduled"};window._liveControlAdminState.liveSessions.unshift(a),e==="live"&&(window._livePublicState={isLive:!0,badgeText:a.badgeText,headline:a.headline||a.title,description:a.description,platformLabels:a.selectedPlatforms.map(i=>He.find(s=>s.id===i)?.label||i),embedUrl:a.showHomepageEmbed?a.embedUrl:"",viewerCount:a.viewerCount,commentCount:a.commentCount,streamStatus:"live",sessionId:a.id,notifyVisitors:a.notifyVisitors,startedAt:a.startedAt,updatedAt:new Date().toISOString()},await Ge(window._livePublicState)),await R(!1),u(e==="live"?"Live stream started":"Live stream scheduled"),ie()};window.startLiveSession=async function(e){await ae();const t=window._liveControlAdminState.liveSessions.find(a=>a.id===e);t&&(t.status="live",t.startedAt=new Date().toISOString(),t.streamStatus="live",window._livePublicState={isLive:!0,badgeText:t.badgeText||"LIVE NOW",headline:t.headline||t.title,description:t.description||"",platformLabels:t.selectedPlatforms.map(a=>He.find(i=>i.id===a)?.label||a),embedUrl:t.showHomepageEmbed?t.embedUrl:"",viewerCount:t.viewerCount||0,commentCount:t.commentCount||0,streamStatus:"live",sessionId:t.id,notifyVisitors:t.notifyVisitors!==!1,startedAt:t.startedAt,updatedAt:new Date().toISOString()},await Ge(window._livePublicState),await R(!1),u("Live session published"),ie())};window.endLiveSession=async function(e){await ae();const t=window._liveControlAdminState.liveSessions.find(a=>a.id===e);t&&(t.status="ended",t.streamStatus="ended",t.endedAt=new Date().toISOString(),window._livePublicState?.sessionId===e?await window.clearPublicLiveState():(await R(!1),u("Live session ended"),ie()))};window.removeLiveSession=async function(e){window._liveControlAdminState.liveSessions=window._liveControlAdminState.liveSessions.filter(t=>t.id!==e),window._livePublicState?.sessionId===e&&await window.clearPublicLiveState(),await R(!1),u("Live session deleted"),ie()};window.clearPublicLiveState=async function(){window._livePublicState={isLive:!1,badgeText:"LIVE NOW",headline:"",description:"",platformLabels:[],embedUrl:"",viewerCount:0,commentCount:0,streamStatus:"offline",sessionId:"",notifyVisitors:!0,startedAt:"",updatedAt:new Date().toISOString()},await Ge(window._livePublicState),await R(!1),u("Public live state cleared"),ie()};window.createVideoRoom=async function(e){await ae();const t={id:`room-${Date.now()}`,title:document.getElementById("video-room-title")?.value?.trim()||"Video Call Room",providerId:document.getElementById("video-room-provider")?.value||"zoom",callType:document.getElementById("video-room-type")?.value||"group",roomCode:document.getElementById("video-room-code")?.value?.trim()||"",hostUrl:document.getElementById("video-room-host")?.value?.trim()||"",joinUrl:document.getElementById("video-room-join")?.value?.trim()||"",embedUrl:document.getElementById("video-room-embed")?.value?.trim()||"",status:e==="live"?"live":"scheduled",scheduledAt:document.getElementById("video-room-scheduled")?.value||"",startedAt:e==="live"?new Date().toISOString():"",maxParticipants:parseInt(document.getElementById("video-room-max")?.value||"25",10)||25,waitingRoom:!!document.getElementById("video-waiting-room")?.checked,screenShare:!!document.getElementById("video-screen-share")?.checked,recording:!!document.getElementById("video-recording")?.checked,chatEnabled:!!document.getElementById("video-chat")?.checked,fileSharing:!!document.getElementById("video-file-share")?.checked,muteOnEntry:!!document.getElementById("video-mute-entry")?.checked,cameraControl:!!document.getElementById("video-camera-control")?.checked,removeParticipants:!!document.getElementById("video-remove-participants")?.checked,notes:document.getElementById("video-room-notes")?.value?.trim()||""};window._liveControlAdminState.videoCallRooms.unshift(t),await R(!1),e==="live"&&t.hostUrl&&window.open(t.hostUrl,"_blank","noopener"),u(e==="live"?"Video call started":"Video call scheduled"),le()};window.startVideoRoom=async function(e){const t=window._liveControlAdminState.videoCallRooms.find(a=>a.id===e);t&&(t.status="live",t.startedAt=new Date().toISOString(),await R(!1),t.hostUrl&&window.open(t.hostUrl,"_blank","noopener"),u("Video room started"),le())};window.endVideoRoom=async function(e){const t=window._liveControlAdminState.videoCallRooms.find(a=>a.id===e);t&&(t.status="ended",t.endedAt=new Date().toISOString(),await R(!1),u("Video room ended"),le())};window.removeVideoRoom=async function(e){window._liveControlAdminState.videoCallRooms=window._liveControlAdminState.videoCallRooms.filter(t=>t.id!==e),await R(!1),u("Video room deleted"),le()};async function gt(){window.lucide&&lucide.createIcons(),It(),await Ra(),p.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){w.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",gt):gt();
