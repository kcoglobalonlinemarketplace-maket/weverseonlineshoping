...
import{supabase as v}from"./supabase-client-7_ZWSEp6.js";import"./localization-8OhyaMNw.js";import{_ as A}from"./preload-helper-CLcXU_4U.js";import{S as W,l as F,f as D,a as R,b as z}from"./showroom-data-BoOhjLzR.js";import{g as V,f as U,T as N}from"./truck-data-CXeZJZHb.js";import{g as $,f as E}from"./auth-D3ZJ7kZA.js";import"./live-stream-mode-DqP61U3f.js";import"./customer-ai-widget--xyiMVwf.js";import"./brand-DwHI4N9G.js";const y="/fallback.svg";function P(e){return typeof e=="number"&&!isNaN(e)?e.toFixed(1):"0.0"}function q(e){return Array.isArray(e)&&e.length>0?e:[y]}function O(){return new URLSearchParams(window.location.search).get("id")}function G(e){const t=document.getElementById("details-content"),a=U(e),n=q(e.images).map((d,g)=>`<button class="gallery-thumb rounded-lg overflow-hidden border-2 ${g===0?"active border-orange-500":"border-gray-800"} shrink-0" data-img="${l(d)}">
