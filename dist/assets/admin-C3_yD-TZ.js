import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as Ca}from"./preload-helper-CLcXU_4U.js";import{supabase as g}from"./supabase-client-nvpjTmO6.js";import{patchLocalShowroomListing as Tt,getLocalShowroomListingById as We,removeLocalShowroomListing as Je,upsertLocalShowroomListing as Lt,listLocalShowroomListings as yt}from"./local-showroom-store-mzP0nSoS.js";import{s as Ue,S as ie,l as Kt,g as ft,i as Ti,r as Li,P as Ia,a as Ta,T as La,M as Ma,b as Mi}from"./promo-backgrounds-BdKW_fjp.js";import{i as Na,D as Ni}from"./site-content-IdVPnjT2.js";import{M as Bi,n as Ri,a as Di}from"./categories-BEuiwWw5.js";import{l as Fi,v as Ui}from"./video-frames-mPOUp41n.js";/* empty css                                       */import"./supabase-lazy-Cjdrb32H.js";const Oi=["USD","GBP","EUR","CAD","AUD","SGD","JPY","MXN","IDR"],ji={US:"USD",GB:"GBP",AT:"EUR",BE:"EUR",HR:"EUR",CY:"EUR",EE:"EUR",FI:"EUR",FR:"EUR",DE:"EUR",GR:"EUR",IE:"EUR",IT:"EUR",LV:"EUR",LT:"EUR",LU:"EUR",MT:"EUR",NL:"EUR",PT:"EUR",SK:"EUR",SI:"EUR",ES:"EUR",CA:"CAD",AU:"AUD",SG:"SGD",JP:"JPY",MX:"MXN",ID:"IDR"},Ee=[{name:"United States",code:"US",dial:"1",flag:"🇺🇸"},{name:"United Kingdom",code:"GB",dial:"44",flag:"🇬🇧"},{name:"Canada",code:"CA",dial:"1",flag:"🇨🇦"},{name:"Australia",code:"AU",dial:"61",flag:"🇦🇺"},{name:"Singapore",code:"SG",dial:"65",flag:"🇸🇬"},{name:"Japan",code:"JP",dial:"81",flag:"🇯🇵"},{name:"Mexico",code:"MX",dial:"52",flag:"🇲🇽"},{name:"Indonesia",code:"ID",dial:"62",flag:"🇮🇩"},{name:"Germany",code:"DE",dial:"49",flag:"🇩🇪"},{name:"France",code:"FR",dial:"33",flag:"🇫🇷"},{name:"Italy",code:"IT",dial:"39",flag:"🇮🇹"},{name:"Spain",code:"ES",dial:"34",flag:"🇪🇸"},{name:"Netherlands",code:"NL",dial:"31",flag:"🇳🇱"},{name:"Belgium",code:"BE",dial:"32",flag:"🇧🇪"},{name:"Ireland",code:"IE",dial:"353",flag:"🇮🇪"},{name:"Portugal",code:"PT",dial:"351",flag:"🇵🇹"},{name:"Greece",code:"GR",dial:"30",flag:"🇬🇷"},{name:"Austria",code:"AT",dial:"43",flag:"🇦🇹"},{name:"Switzerland",code:"CH",dial:"41",flag:"🇨🇭"},{name:"Sweden",code:"SE",dial:"46",flag:"🇸🇪"},{name:"Norway",code:"NO",dial:"47",flag:"🇳🇴"},{name:"Denmark",code:"DK",dial:"45",flag:"🇩🇰"},{name:"Finland",code:"FI",dial:"358",flag:"🇫🇮"},{name:"Poland",code:"PL",dial:"48",flag:"🇵🇱"},{name:"Czech Republic",code:"CZ",dial:"420",flag:"🇨🇿"},{name:"Slovakia",code:"SK",dial:"421",flag:"🇸🇰"},{name:"Hungary",code:"HU",dial:"36",flag:"🇭🇺"},{name:"Romania",code:"RO",dial:"40",flag:"🇷🇴"},{name:"Bulgaria",code:"BG",dial:"359",flag:"🇧🇬"},{name:"Croatia",code:"HR",dial:"385",flag:"🇭🇷"},{name:"Slovenia",code:"SI",dial:"386",flag:"🇸🇮"},{name:"Slovakia",code:"SK",dial:"421",flag:"🇸🇰"},{name:"Lithuania",code:"LT",dial:"370",flag:"🇱🇹"},{name:"Latvia",code:"LV",dial:"371",flag:"🇱🇻"},{name:"Estonia",code:"EE",dial:"372",flag:"🇪🇪"},{name:"Luxembourg",code:"LU",dial:"352",flag:"🇱🇺"},{name:"Malta",code:"MT",dial:"356",flag:"🇲🇹"},{name:"Cyprus",code:"CY",dial:"357",flag:"🇨🇾"},{name:"Iceland",code:"IS",dial:"354",flag:"🇮🇸"},{name:"Russia",code:"RU",dial:"7",flag:"🇷🇺"},{name:"Ukraine",code:"UA",dial:"380",flag:"🇺🇦"},{name:"Belarus",code:"BY",dial:"375",flag:"🇧🇾"},{name:"Turkey",code:"TR",dial:"90",flag:"🇹🇷"},{name:"China",code:"CN",dial:"86",flag:"🇨🇳"},{name:"Hong Kong",code:"HK",dial:"852",flag:"🇭🇰"},{name:"Taiwan",code:"TW",dial:"886",flag:"🇹🇼"},{name:"South Korea",code:"KR",dial:"82",flag:"🇰🇷"},{name:"North Korea",code:"KP",dial:"850",flag:"🇰🇵"},{name:"India",code:"IN",dial:"91",flag:"🇮🇳"},{name:"Pakistan",code:"PK",dial:"92",flag:"🇵🇰"},{name:"Bangladesh",code:"BD",dial:"880",flag:"🇧🇩"},{name:"Sri Lanka",code:"LK",dial:"94",flag:"🇱🇰"},{name:"Nepal",code:"NP",dial:"977",flag:"🇳🇵"},{name:"Bhutan",code:"BT",dial:"975",flag:"🇧🇹"},{name:"Maldives",code:"MV",dial:"960",flag:"🇲🇻"},{name:"Thailand",code:"TH",dial:"66",flag:"🇹🇭"},{name:"Vietnam",code:"VN",dial:"84",flag:"🇻🇳"},{name:"Malaysia",code:"MY",dial:"60",flag:"🇲🇾"},{name:"Philippines",code:"PH",dial:"63",flag:"🇵🇭"},{name:"Cambodia",code:"KH",dial:"855",flag:"🇰🇭"},{name:"Laos",code:"LA",dial:"856",flag:"🇱🇦"},{name:"Myanmar",code:"MM",dial:"95",flag:"🇲🇲"},{name:"Brunei",code:"BN",dial:"673",flag:"🇧🇳"},{name:"Mongolia",code:"MN",dial:"976",flag:"🇲🇳"},{name:"Kazakhstan",code:"KZ",dial:"7",flag:"🇰🇿"},{name:"Uzbekistan",code:"UZ",dial:"998",flag:"🇺🇿"},{name:"Turkmenistan",code:"TM",dial:"993",flag:"🇹🇲"},{name:"Kyrgyzstan",code:"KG",dial:"996",flag:"🇰🇬"},{name:"Tajikistan",code:"TJ",dial:"992",flag:"🇹🇯"},{name:"Afghanistan",code:"AF",dial:"93",flag:"🇦🇫"},{name:"Iran",code:"IR",dial:"98",flag:"🇮🇷"},{name:"Iraq",code:"IQ",dial:"964",flag:"🇮🇶"},{name:"Saudi Arabia",code:"SA",dial:"966",flag:"🇸🇦"},{name:"United Arab Emirates",code:"AE",dial:"971",flag:"🇦🇪"},{name:"Qatar",code:"QA",dial:"974",flag:"🇶🇦"},{name:"Kuwait",code:"KW",dial:"965",flag:"🇰🇼"},{name:"Bahrain",code:"BH",dial:"973",flag:"🇧🇭"},{name:"Oman",code:"OM",dial:"968",flag:"🇴🇲"},{name:"Yemen",code:"YE",dial:"967",flag:"🇾🇪"},{name:"Jordan",code:"JO",dial:"962",flag:"🇯🇴"},{name:"Lebanon",code:"LB",dial:"961",flag:"🇱🇧"},{name:"Syria",code:"SY",dial:"963",flag:"🇸🇾"},{name:"Israel",code:"IL",dial:"972",flag:"🇮🇱"},{name:"Palestine",code:"PS",dial:"970",flag:"🇵🇸"},{name:"Georgia",code:"GE",dial:"995",flag:"🇬🇪"},{name:"Armenia",code:"AM",dial:"374",flag:"🇦🇲"},{name:"Azerbaijan",code:"AZ",dial:"994",flag:"🇦🇿"},{name:"Moldova",code:"MD",dial:"373",flag:"🇲🇩"},{name:"Serbia",code:"RS",dial:"381",flag:"🇷🇸"},{name:"Bosnia and Herzegovina",code:"BA",dial:"387",flag:"🇧🇦"},{name:"Montenegro",code:"ME",dial:"382",flag:"🇲🇪"},{name:"North Macedonia",code:"MK",dial:"389",flag:"🇲🇰"},{name:"Albania",code:"AL",dial:"355",flag:"🇦🇱"},{name:"Kosovo",code:"XK",dial:"383",flag:"🇽🇰"},{name:"Andorra",code:"AD",dial:"376",flag:"🇦🇩"},{name:"Monaco",code:"MC",dial:"377",flag:"🇲🇨"},{name:"Liechtenstein",code:"LI",dial:"423",flag:"🇱🇮"},{name:"San Marino",code:"SM",dial:"378",flag:"🇸🇲"},{name:"Vatican City",code:"VA",dial:"379",flag:"🇻🇦"},{name:"Gibraltar",code:"GI",dial:"350",flag:"🇬🇮"},{name:"Faroe Islands",code:"FO",dial:"298",flag:"🇫🇴"},{name:"Greenland",code:"GL",dial:"299",flag:"🇬🇱"},{name:"New Zealand",code:"NZ",dial:"64",flag:"🇳🇿"},{name:"Fiji",code:"FJ",dial:"679",flag:"🇫🇯"},{name:"Papua New Guinea",code:"PG",dial:"675",flag:"🇵🇬"},{name:"Solomon Islands",code:"SB",dial:"677",flag:"🇸🇧"},{name:"Vanuatu",code:"VU",dial:"678",flag:"🇻🇺"},{name:"Samoa",code:"WS",dial:"685",flag:"🇼🇸"},{name:"Tonga",code:"TO",dial:"676",flag:"🇹🇴"},{name:"Kiribati",code:"KI",dial:"686",flag:"🇰🇮"},{name:"Marshall Islands",code:"MH",dial:"692",flag:"🇲🇭"},{name:"Micronesia",code:"FM",dial:"691",flag:"🇫🇲"},{name:"Palau",code:"PW",dial:"680",flag:"🇵🇼"},{name:"Nauru",code:"NR",dial:"674",flag:"🇳🇷"},{name:"Tuvalu",code:"TV",dial:"688",flag:"🇹🇻"},{name:"Cook Islands",code:"CK",dial:"682",flag:"🇨🇰"},{name:"Niue",code:"NU",dial:"683",flag:"🇳🇺"},{name:"Egypt",code:"EG",dial:"20",flag:"🇪🇬"},{name:"Libya",code:"LY",dial:"218",flag:"🇱🇾"},{name:"Tunisia",code:"TN",dial:"216",flag:"🇹🇳"},{name:"Algeria",code:"DZ",dial:"213",flag:"🇩🇿"},{name:"Morocco",code:"MA",dial:"212",flag:"🇲🇦"},{name:"Western Sahara",code:"EH",dial:"212",flag:"🇪🇭"},{name:"Mauritania",code:"MR",dial:"222",flag:"🇲🇷"},{name:"Mali",code:"ML",dial:"223",flag:"🇲🇱"},{name:"Niger",code:"NE",dial:"227",flag:"🇳🇪"},{name:"Chad",code:"TD",dial:"235",flag:"🇹🇩"},{name:"Sudan",code:"SD",dial:"249",flag:"🇸🇩"},{name:"South Sudan",code:"SS",dial:"211",flag:"🇸🇸"},{name:"Eritrea",code:"ER",dial:"291",flag:"🇪🇷"},{name:"Djibouti",code:"DJ",dial:"253",flag:"🇩🇯"},{name:"Ethiopia",code:"ET",dial:"251",flag:"🇪🇹"},{name:"Somalia",code:"SO",dial:"252",flag:"🇸🇴"},{name:"Kenya",code:"KE",dial:"254",flag:"🇰🇪"},{name:"Uganda",code:"UG",dial:"256",flag:"🇺🇬"},{name:"Tanzania",code:"TZ",dial:"255",flag:"🇹🇿"},{name:"Rwanda",code:"RW",dial:"250",flag:"🇷🇼"},{name:"Burundi",code:"BI",dial:"257",flag:"🇧🇮"},{name:"Democratic Republic of the Congo",code:"CD",dial:"243",flag:"🇨🇩"},{name:"Republic of the Congo",code:"CG",dial:"242",flag:"🇨🇬"},{name:"Central African Republic",code:"CF",dial:"236",flag:"🇨🇫"},{name:"Cameroon",code:"CM",dial:"237",flag:"🇨🇲"},{name:"Gabon",code:"GA",dial:"241",flag:"🇬🇦"},{name:"Equatorial Guinea",code:"GQ",dial:"240",flag:"🇬🇶"},{name:"São Tomé and Príncipe",code:"ST",dial:"239",flag:"🇸🇹"},{name:"Nigeria",code:"NG",dial:"234",flag:"🇳🇬"},{name:"Benin",code:"BJ",dial:"229",flag:"🇧🇯"},{name:"Togo",code:"TG",dial:"228",flag:"🇹🇬"},{name:"Ghana",code:"GH",dial:"233",flag:"🇬🇭"},{name:"Ivory Coast",code:"CI",dial:"225",flag:"🇨🇮"},{name:"Burkina Faso",code:"BF",dial:"226",flag:"🇧🇫"},{name:"Liberia",code:"LR",dial:"231",flag:"🇱🇷"},{name:"Sierra Leone",code:"SL",dial:"232",flag:"🇸🇱"},{name:"Guinea",code:"GN",dial:"224",flag:"🇬🇳"},{name:"Guinea-Bissau",code:"GW",dial:"245",flag:"🇬🇼"},{name:"The Gambia",code:"GM",dial:"220",flag:"🇬🇲"},{name:"Senegal",code:"SN",dial:"221",flag:"🇸🇳"},{name:"Cape Verde",code:"CV",dial:"238",flag:"🇨🇻"},{name:"Angola",code:"AO",dial:"244",flag:"🇦🇴"},{name:"Zambia",code:"ZM",dial:"260",flag:"🇿🇲"},{name:"Zimbabwe",code:"ZW",dial:"263",flag:"🇿🇼"},{name:"Malawi",code:"MW",dial:"265",flag:"🇲🇼"},{name:"Mozambique",code:"MZ",dial:"258",flag:"🇲🇿"},{name:"Botswana",code:"BW",dial:"267",flag:"🇧🇼"},{name:"Namibia",code:"NA",dial:"264",flag:"🇳🇦"},{name:"South Africa",code:"ZA",dial:"27",flag:"🇿🇦"},{name:"Lesotho",code:"LS",dial:"266",flag:"🇱🇸"},{name:"Eswatini",code:"SZ",dial:"268",flag:"🇸🇿"},{name:"Madagascar",code:"MG",dial:"261",flag:"🇲🇬"},{name:"Mauritius",code:"MU",dial:"230",flag:"🇲🇺"},{name:"Comoros",code:"KM",dial:"269",flag:"🇰🇲"},{name:"Seychelles",code:"SC",dial:"248",flag:"🇸🇨"},{name:"Argentina",code:"AR",dial:"54",flag:"🇦🇷"},{name:"Brazil",code:"BR",dial:"55",flag:"🇧🇷"},{name:"Chile",code:"CL",dial:"56",flag:"🇨🇱"},{name:"Colombia",code:"CO",dial:"57",flag:"🇨🇴"},{name:"Peru",code:"PE",dial:"51",flag:"🇵🇪"},{name:"Venezuela",code:"VE",dial:"58",flag:"🇻🇪"},{name:"Bolivia",code:"BO",dial:"591",flag:"🇧🇴"},{name:"Paraguay",code:"PY",dial:"595",flag:"🇵🇾"},{name:"Uruguay",code:"UY",dial:"598",flag:"🇺🇾"},{name:"Ecuador",code:"EC",dial:"593",flag:"🇪🇨"},{name:"Guyana",code:"GY",dial:"592",flag:"🇬🇾"},{name:"Suriname",code:"SR",dial:"597",flag:"🇸🇷"},{name:"Costa Rica",code:"CR",dial:"506",flag:"🇨🇷"},{name:"Panama",code:"PA",dial:"507",flag:"🇵🇦"},{name:"Guatemala",code:"GT",dial:"502",flag:"🇬🇹"},{name:"Honduras",code:"HN",dial:"504",flag:"🇭🇳"},{name:"El Salvador",code:"SV",dial:"503",flag:"🇸🇻"},{name:"Nicaragua",code:"NI",dial:"505",flag:"🇳🇮"},{name:"Belize",code:"BZ",dial:"501",flag:"🇧🇿"},{name:"Cuba",code:"CU",dial:"53",flag:"🇨🇺"},{name:"Dominican Republic",code:"DO",dial:"1",flag:"🇩🇴"},{name:"Haiti",code:"HT",dial:"509",flag:"🇭🇹"},{name:"Jamaica",code:"JM",dial:"1",flag:"🇯🇲"},{name:"Bahamas",code:"BS",dial:"1",flag:"🇧🇸"},{name:"Barbados",code:"BB",dial:"1",flag:"🇧🇧"},{name:"Trinidad and Tobago",code:"TT",dial:"1",flag:"🇹🇹"},{name:"Grenada",code:"GD",dial:"1",flag:"🇬🇩"},{name:"Saint Lucia",code:"LC",dial:"1",flag:"🇱🇨"},{name:"Saint Vincent and the Grenadines",code:"VC",dial:"1",flag:"🇻🇨"},{name:"Antigua and Barbuda",code:"AG",dial:"1",flag:"🇦🇬"},{name:"Dominica",code:"DM",dial:"1",flag:"🇩🇲"},{name:"Saint Kitts and Nevis",code:"KN",dial:"1",flag:"🇰🇳"},{name:"Puerto Rico",code:"PR",dial:"1",flag:"🇵🇷"},{name:"Guam",code:"GU",dial:"1",flag:"🇬🇺"},{name:"United States Virgin Islands",code:"VI",dial:"1",flag:"🇻🇮"},{name:"Northern Mariana Islands",code:"MP",dial:"1",flag:"🇲🇵"},{name:"American Samoa",code:"AS",dial:"1",flag:"🇦🇸"},{name:"Bermuda",code:"BM",dial:"1",flag:"🇧🇲"},{name:"Cayman Islands",code:"KY",dial:"1",flag:"🇰🇾"},{name:"Turks and Caicos Islands",code:"TC",dial:"1",flag:"🇹🇨"},{name:"British Virgin Islands",code:"VG",dial:"1",flag:"🇻🇬"},{name:"Anguilla",code:"AI",dial:"1",flag:"🇦🇮"},{name:"Montserrat",code:"MS",dial:"1",flag:"🇲🇸"},{name:"Falkland Islands",code:"FK",dial:"500",flag:"🇫🇰"},{name:"Saint Helena",code:"SH",dial:"290",flag:"🇸🇭"},{name:"Tristan da Cunha",code:"TA",dial:"290",flag:"🇹🇦"},{name:"Aruba",code:"AW",dial:"297",flag:"🇦🇼"},{name:"Curaçao",code:"CW",dial:"599",flag:"🇨🇼"},{name:"Sint Maarten",code:"SX",dial:"1",flag:"🇸🇽"},{name:"Bonaire, Sint Eustatius and Saba",code:"BQ",dial:"599",flag:"🇧🇶"},{name:"New Caledonia",code:"NC",dial:"687",flag:"🇳🇨"},{name:"French Polynesia",code:"PF",dial:"689",flag:"🇵🇫"},{name:"Wallis and Futuna",code:"WF",dial:"681",flag:"🇼🇫"},{name:"French Guiana",code:"GF",dial:"594",flag:"🇬🇫"},{name:"Guadeloupe",code:"GP",dial:"590",flag:"🇬🇵"},{name:"Martinique",code:"MQ",dial:"596",flag:"🇲🇶"},{name:"Mayotte",code:"YT",dial:"262",flag:"🇾🇹"},{name:"Réunion",code:"RE",dial:"262",flag:"🇷🇪"},{name:"Saint Pierre and Miquelon",code:"PM",dial:"508",flag:"🇵🇲"},{name:"Saint Barthélemy",code:"BL",dial:"590",flag:"🇧🇱"},{name:"Saint Martin (French)",code:"MF",dial:"590",flag:"🇲🇫"},{name:"Christmas Island",code:"CX",dial:"61",flag:"🇨🇽"},{name:"Cocos (Keeling) Islands",code:"CC",dial:"61",flag:"🇨🇨"},{name:"Norfolk Island",code:"NF",dial:"672",flag:"🇳🇫"},{name:"Tokelau",code:"TK",dial:"690",flag:"🇹🇰"},{name:"Pitcairn Islands",code:"PN",dial:"64",flag:"🇵🇳"},{name:"Aland Islands",code:"AX",dial:"358",flag:"🇦🇽"},{name:"Svalbard and Jan Mayen",code:"SJ",dial:"47",flag:"🇸🇯"},{name:"Bouvet Island",code:"BV",dial:"47",flag:"🇧🇻"},{name:"Heard Island and McDonald Islands",code:"HM",dial:"672",flag:"🇭🇲"},{name:"South Georgia and the South Sandwich Islands",code:"GS",dial:"500",flag:"🇬🇸"},{name:"British Indian Ocean Territory",code:"IO",dial:"246",flag:"🇮🇴"},{name:"United States Minor Outlying Islands",code:"UM",dial:"1",flag:"🇺🇲"},{name:"Antarctica",code:"AQ",dial:"672",flag:"🇦🇶"}];function st(e){return Ee.find(t=>t.code===e)||null}const qi={USD:{symbol:"$",locale:"en-US"},GBP:{symbol:"£",locale:"en-GB"},EUR:{symbol:"€",locale:"de-DE"},CAD:{symbol:"C$",locale:"en-CA"},AUD:{symbol:"A$",locale:"en-AU"},SGD:{symbol:"S$",locale:"en-SG"},JPY:{symbol:"¥",locale:"ja-JP"},MXN:{symbol:"Mex$",locale:"es-MX"},IDR:{symbol:"Rp",locale:"id-ID"},CHF:{symbol:"CHF",locale:"de-CH"},CNY:{symbol:"¥",locale:"zh-CN"},INR:{symbol:"₹",locale:"hi-IN"},BRL:{symbol:"R$",locale:"pt-BR"},ZAR:{symbol:"R",locale:"en-ZA"},NGN:{symbol:"₦",locale:"en-NG"},AED:{symbol:"د.إ",locale:"ar-AE"},SAR:{symbol:"﷼",locale:"ar-SA"},RUB:{symbol:"₽",locale:"ru-RU"},TRY:{symbol:"₺",locale:"tr-TR"},KRW:{symbol:"₩",locale:"ko-KR"},THB:{symbol:"฿",locale:"th-TH"},PLN:{symbol:"zł",locale:"pl-PL"},SEK:{symbol:"kr",locale:"sv-SE"},NOK:{symbol:"kr",locale:"nb-NO"},DKK:{symbol:"kr",locale:"da-DK"},NZD:{symbol:"NZ$",locale:"en-NZ"},HKD:{symbol:"HK$",locale:"zh-HK"},TWD:{symbol:"NT$",locale:"zh-TW"},MYR:{symbol:"RM",locale:"ms-MY"},PHP:{symbol:"₱",locale:"en-PH"},VND:{symbol:"₫",locale:"vi-VN"},EGP:{symbol:"E£",locale:"ar-EG"},KES:{symbol:"KSh",locale:"sw-KE"},GHS:{symbol:"GH₵",locale:"en-GH"},ARS:{symbol:"$",locale:"es-AR"},CLP:{symbol:"$",locale:"es-CL"},COP:{symbol:"Col$",locale:"es-CO"},PEN:{symbol:"S/",locale:"es-PE"},UAH:{symbol:"₴",locale:"uk-UA"},ILS:{symbol:"₪",locale:"he-IL"},PKR:{symbol:"₨",locale:"ur-PK"},BDT:{symbol:"৳",locale:"bn-BD"},CZK:{symbol:"Kč",locale:"cs-CZ"},HUF:{symbol:"Ft",locale:"hu-HU"},RON:{symbol:"lei",locale:"ro-RO"},BGN:{symbol:"лв",locale:"bg-BG"},HRK:{symbol:"kn",locale:"hr-HR"},ISK:{symbol:"kr",locale:"is-IS"},JOD:{symbol:"JD",locale:"ar-JO"},QAR:{symbol:"﷼",locale:"ar-QA"},KWD:{symbol:"د.ك",locale:"ar-KW"},BHD:{symbol:"BD",locale:"ar-BH"},OMR:{symbol:"﷼",locale:"ar-OM"},MAD:{symbol:"د.م.",locale:"ar-MA"},DZD:{symbol:"د.ج",locale:"ar-DZ"},TND:{symbol:"د.ت",locale:"ar-TN"},LBP:{symbol:"ل.ل",locale:"ar-LB"},IQD:{symbol:"ع.د",locale:"ar-IQ"},LKR:{symbol:"Rs",locale:"si-LK"},NRS:{symbol:"रू",locale:"ne-NP"},UGX:{symbol:"USh",locale:"sw-UG"},TZS:{symbol:"TSh",locale:"sw-TZ"},ETB:{symbol:"Br",locale:"am-ET"},XOF:{symbol:"CFA",locale:"fr-SN"},XAF:{symbol:"FCFA",locale:"fr-CM"},GEL:{symbol:"₾",locale:"ka-GE"},AZN:{symbol:"₼",locale:"az-AZ"},AMD:{symbol:"֏",locale:"hy-AM"},BYN:{symbol:"Br",locale:"be-BY"},UZS:{symbol:"soʻm",locale:"uz-UZ"},KZT:{symbol:"₸",locale:"kk-KZ"},RSD:{symbol:"дин",locale:"sr-RS"},MKD:{symbol:"ден",locale:"mk-MK"},ALL:{symbol:"L",locale:"sq-AL"},BAM:{symbol:"KM",locale:"bs-BA"},VEF:{symbol:"Bs",locale:"es-VE"},BOB:{symbol:"Bs",locale:"es-BO"},PYG:{symbol:"₲",locale:"es-PY"},UYU:{symbol:"$U",locale:"es-UY"},DOP:{symbol:"RD$",locale:"es-DO"},GTQ:{symbol:"Q",locale:"es-GT"},HNL:{symbol:"L",locale:"es-HN"},NIO:{symbol:"C$",locale:"es-NI"},CRC:{symbol:"₡",locale:"es-CR"},PAB:{symbol:"B/.",locale:"es-PA"},GTQ2:{symbol:"Q",locale:"es-GT"}},Hi=[...new Set([...Oi,...Object.keys(qi)])],O=1,Q=5e6,Gi=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],Vi=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Ba=[...Gi,...Vi];function Yt(e){return ji[e]||"USD"}function Ra(e,t){return Ba.filter(a=>a.listingType!==e?!1:t?a.category===t:!0)}function zi(e,t){const a=Math.max(O,Math.min(Q,Number(e)||O));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(a)}function Wi(e,t,a,i,n){const o=zi(i,a);return e.descriptionType==="vehicle"?`${e.label} listed at ${o}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${o}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${o}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${o}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${o}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${o}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${o}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${o}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${o}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${o}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Da({templateId:e,listingType:t,category:a,countryCode:i,currency:n,price:o}){const r=Ba.find(p=>p.id===e&&p.listingType===t);if(!r)return null;const l=st(i)||Ee[0],d=n||Yt(l.code),c=[l.name].filter(Boolean).join(", "),u={category:r.category||a||(t==="property"?"Real Estate":"Other"),subcategory:r.subcategory||r.label,title:t==="property"?`${r.label} in ${l.name}`:r.label,description:Wi(r,l,d,o,c),currency:d,features:[...r.features],highlights:[...r.highlights||[]],seo_keywords:[...new Set([r.category,r.subcategory,r.label,...t==="property"?[l.name]:[],...r.keywords||[]].filter(Boolean))],requiredImageCount:r.requiredImageCount||0};return t==="property"?{...u,country:l.name,country_code:l.code,product_location:l.name,property_type:r.propertyType||r.label,bedrooms:r.bedrooms??null,bathrooms:r.bathrooms??null,building_size:r.buildingSize||"",land_size:r.landSize||"",furnished:r.furnished||""}:{...u,brand:r.brand||"",model:r.model||"",color:r.color||"",size:r.size||"",condition:r.condition||"New"}}const Fa="kco_payment_settings_v1",Ki=[{currency:"USD",currencyName:"United States Dollar",flag:"US",country:"United States",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"70589490002447647",accountType:"Checking",iban:"",swift:"CITIUS33",routing:"031100209",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"111 Wall Street, New York, NY 10043, USA"},{currency:"GBP",currencyName:"British Pound",flag:"GB",country:"United Kingdom",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"56468624",accountType:"",iban:"GB94CITI18500856468624",swift:"CITIGB2L",routing:"",sortCode:"185008",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Canada Square, Canary Wharf, London E14 5LB, United Kingdom"},{currency:"EUR",currencyName:"Euro",flag:"EU",country:"Eurozone",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"",accountType:"",iban:"IE70CITI99005171297018",swift:"CITIIE2X",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:"1 North Wall Quay, IFSC, Dublin 1, Ireland"},{currency:"CAD",currencyName:"Canadian Dollar",flag:"CA",country:"Canada",bankName:"Citibank NA Canadian Branch",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"3001440544",accountType:"Checking",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"0328",transitNumber:"20012",bsbCode:"",address:"123 Front St. West, Toronto, ON M5J 2M3, Canada"},{currency:"AUD",currencyName:"Australian Dollar",flag:"AU",country:"Australia",bankName:"Citibank",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"10674571",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"248024",address:"2 Park Street, Sydney NSW 2000, Australia"},{currency:"SGD",currencyName:"Singapore Dollar",flag:"SG",country:"Singapore",bankName:"Citibank N.A. Singapore Branch",transferType:"Local & International",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"44990709533",accountType:"",iban:"",swift:"CITISGSG",routing:"",sortCode:"",bankCode:"7214",branchCode:"001",institutionNumber:"",transitNumber:"",bsbCode:"",address:"8 Marina View, #17-01 Asia Square Tower 1, Singapore 018960"},{currency:"JPY",currencyName:"Japanese Yen",flag:"JP",country:"Japan",bankName:"MUFG Bank Ltd.",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"4682719",accountType:"Savings / Futsu",iban:"",swift:"",routing:"",sortCode:"",bankCode:"0005",branchCode:"869",institutionNumber:"",transitNumber:"",bsbCode:"",address:"7-1 Marunouchi 2-Chome, Chiyoda-ku, Tokyo, Japan"},{currency:"MXN",currencyName:"Mexican Peso",flag:"MX",country:"Mexico",bankName:"Sistema de Transferencias y Pagos",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"646010504200345127",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"646",branchCode:"010",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Av. Insurgentes Sur 1425, Ciudad de México, México"},{currency:"IDR",currencyName:"Indonesian Rupiah",flag:"ID",country:"Indonesia",bankName:"Deutsche Bank AG Jakarta Branch",transferType:"Local Transfer",beneficiary:"KENNETH CHIDERA ODENYI",accountNumber:"974400000904",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"0670304",institutionNumber:"",transitNumber:"",bsbCode:"",address:"Jl. Imam Bonjol 80, Jakarta 10310, Indonesia"}];function Jt(e){if(!e||e.length!==2)return"🏦";const t=e.toUpperCase().split("").map(a=>127462+a.charCodeAt(0)-65);try{return String.fromCodePoint(...t)}catch{return"🏦"}}function Yi(){try{const e=localStorage.getItem(Fa);return e?JSON.parse(e):null}catch{return null}}function Ji(e){try{localStorage.setItem(Fa,JSON.stringify(e))}catch{}}function lt(e,t=0){const a=e.country_code||e.flag||(e.currency==="EUR"?"EU":"US"),i=e.country||st(a)?.name||"",n=(e.currency||"USD").toUpperCase();return{id:e.id||`bank-${t+1}`,currency:n,currencyName:e.currencyName||e.currency_name||n,flag:e.flag&&e.flag.length>2?e.flag:Jt(a),country:i,country_code:a,bankName:e.bankName||e.bank_name||"",transferType:e.transferType||e.transfer_type||"Bank Transfer",beneficiary:e.beneficiary||e.accountName||e.account_name||"",accountNumber:e.accountNumber||e.account_number||"",accountType:e.accountType||e.account_type||"",iban:e.iban||"",swift:e.swift||"",routing:e.routing||"",sortCode:e.sortCode||e.sort_code||"",bankCode:e.bankCode||e.bank_code||"",branchCode:e.branchCode||e.branch_code||"",institutionNumber:e.institutionNumber||e.institution_number||"",transitNumber:e.transitNumber||e.transit_number||"",bsbCode:e.bsbCode||e.bsb_code||"",address:e.address||""}}function Qi(e=[]){return e.map((t,a)=>lt(t,a)).filter(t=>t.currency&&(t.accountNumber||t.iban||t.swift||t.routing||t.sortCode||t.bankCode||t.branchCode||t.institutionNumber||t.transitNumber||t.bsbCode))}function Xi(e={}){const t=[];return(e.bank1_account_name||e.bank1_account_number||e.bank1_bank_name)&&t.push(lt({id:"bank-1",currency:e.bank1_currency||"USD",country:e.bank1_country||st("US")?.name||"United States",country_code:e.bank1_country_code||"US",bank_name:e.bank1_bank_name,transfer_type:e.bank1_transfer_type,account_name:e.bank1_account_name,account_number:e.bank1_account_number,sort_code:e.bank1_sort_code},0)),(e.bank2_account_name||e.bank2_account_number||e.bank2_bank_name)&&t.push(lt({id:"bank-2",currency:e.bank2_currency||"USD",country:e.bank2_country||st("US")?.name||"United States",country_code:e.bank2_country_code||"US",bank_name:e.bank2_bank_name,transfer_type:e.bank2_transfer_type,account_name:e.bank2_account_name,account_number:e.bank2_account_number,sort_code:e.bank2_sort_code},1)),t}function Zi(e={}){const t=Qi(e.manual_payment_accounts||[]);if(t.length>0)return t;const a=Xi(e);return a.length>0?a:Ki.map((i,n)=>lt(i,n))}function en(e={}){return e.manual_payment_instructions||"Transfer the exact order amount to the bank account shown below. After payment, upload your receipt for verification. Once your receipt is verified, your goods will be shipped immediately."}let Ct=null;async function tn(){return Ct||(Ct=Ca(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),Ct}function an(e,t){return e.toDataURL("image/jpeg",t)}async function nn(e,t){const a=e.getViewport({scale:1}),i=Math.min(3,Math.max(.5,t/Math.max(a.width,a.height))),n=e.getViewport({scale:i}),o=document.createElement("canvas");o.width=Math.max(1,Math.round(n.width)),o.height=Math.max(1,Math.round(n.height));const r=o.getContext("2d",{alpha:!1});return r.fillStyle="#ffffff",r.fillRect(0,0,o.width,o.height),await e.render({canvasContext:r,viewport:n}).promise,an(o,.78)}async function on(e,{maxDim:t=1300,maxPages:a=0,onProgress:i=()=>{}}={}){const o=await(await tn()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,r=o.numPages,l=a>0?Math.min(r,a):r,d=[];try{for(let c=1;c<=l;c++){i(c,l);const u=await o.getPage(c);d.push(await nn(u,t))}}finally{try{await o.destroy()}catch{}}return d}function Qe(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const Ua="weverseonlineshop@gmail.com",Oa="Weverse Online Shop",ja="GLOBAL SHOPPING â€¢ WORLDWIDE DELIVERY",rn="https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,""),sn=`${rn}/functions/v1/ai-admin-assistant`,ln=[{group:"Main",items:[{id:"dashboard",label:"Dashboard",icon:"layout-dashboard"},{id:"products",label:"Products",icon:"package"},{id:"content-settings",label:"Content Settings",icon:"file-cog"},{id:"properties",label:"Properties",icon:"home"},{id:"catalog",label:"Catalog Manager",icon:"boxes"},{id:"orders",label:"Orders",icon:"shopping-bag"},{id:"customers",label:"Customers",icon:"users"},{id:"reviews",label:"Reviews",icon:"star"},{id:"messages",label:"Messages",icon:"message-circle"},{id:"coupons",label:"Coupons",icon:"ticket"},{id:"ads",label:"Advertisements",icon:"megaphone"},{id:"notifications",label:"Notifications",icon:"bell"}]},{group:"Configuration",items:[{id:"ai",label:"AI Assistant",icon:"sparkles"},{id:"payment-settings",label:"Payment Settings",icon:"credit-card"},{id:"ai-settings",label:"AI Settings",icon:"bot"},{id:"homepage-branding",label:"Homepage Branding",icon:"image"},{id:"promo-bg",label:"Promo & Backgrounds",icon:"image"},{id:"brand",label:"Brand Manager",icon:"palette"},{id:"content",label:"Content Manager",icon:"file-text"},{id:"seo",label:"SEO Manager",icon:"search"},{id:"email",label:"Email Settings",icon:"mail"},{id:"analytics",label:"Analytics",icon:"bar-chart-3"},{id:"security",label:"Security",icon:"shield"},{id:"activity",label:"Activity Logs",icon:"activity"},{id:"backup",label:"Backup & Restore",icon:"database"},{id:"settings",label:"Settings",icon:"settings"},{id:"publish",label:"Publish & Deploy",icon:"rocket"}]}],dn={dashboard:"Dashboard",products:"Products Manager",properties:"Properties Manager",catalog:"Catalog Manager",orders:"Orders Manager",customers:"Customers Manager",reviews:"Reviews Manager",messages:"Messages & Support",coupons:"Coupons Manager",ads:"Advertisement Manager","ai-settings":"AI Settings",content:"Content Manager","content-settings":"Content Settings",ai:"AI Assistant","homepage-branding":"Homepage Branding","promo-bg":"Promo & Backgrounds",brand:"Brand Manager","payment-settings":"Payment Settings",seo:"SEO Manager",email:"Email Settings",analytics:"Analytics",security:"Security",activity:"Activity Logs",backup:"Backup & Restore",settings:"Settings",publish:"Publish & Deploy"},qa=[...Hi].sort();let I={user:null,section:"dashboard"};function s(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function Ha(e,t="USD"){return`${(parseFloat(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} ${t}`}function re(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"â€”"}function ke(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"â€”"}function Qt(){return"W-"+String(Date.now()).slice(-6)+Math.floor(Math.random()*1e3).toString().padStart(3,"0")}const cn=["id","property_id","listing_type","category","subcategory","title","description","price","price_period","currency","country","country_code","state","city","town","product_location","latitude","longitude","bedrooms","bathrooms","building_size","land_size","parking_spaces","property_type","furnished","listing_status","images","features","tags","highlights","seo_keywords","specifications","brand","color","size","condition","warranty","shipping_info","delivery_estimate","weight","dimensions","storage_options","ram_options","color_options","availability_status","stock_quantity","sku","is_active","is_featured","is_ai_generated","ai_generated_fields","rating","rating_count","favorite_count","review_count","video","video_url","approval_status","published_at","created_at","updated_at","real_price","year_built","year_renovated","half_bathrooms","floors","garage","zip_code","address","landmarks","interior_features","exterior_features","home_systems","legal_info","risk_notes","floor_plan","nearby_area","verification_status","verification_date","inspection_info","documents","language_info"];function ve(e){const t={};if(!e||typeof e!="object")return t;for(const a of cn)a in e&&(t[a]=e[a]);return t}function m(e,t="success"){const a=document.getElementById("toast"),i=document.getElementById("toast-msg"),n=a.querySelector("i[data-lucide]");if(!a||!i)return;i.textContent=e;const o={success:"check-circle",error:"alert-circle",info:"info"},r={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",o[t]||"info"),n.className=`w-4 h-4 shrink-0 ${r[t]||"text-blue-400"}`),a.style.transform="translateY(0)",a.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(a._t),a._t=setTimeout(()=>{a.style.transform="translateY(20px)",a.style.opacity="0"},3e3)}function Me(e){return!e||typeof e!="string"||e.startsWith("blob:")||e.startsWith("data:")?!1:/\.(mp4|webm|mov|avi|mkv)(\?|#|$)/i.test(e)}function Ne(e){return e&&e.type&&e.type.startsWith("video/")}function Y(e){const t={pending_verification:["bg-amber-500/10 text-amber-400 border-amber-500/20","Pending"],approved:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Approved"],rejected:["bg-red-500/10 text-red-400 border-red-500/20","Rejected"],payment_approved:["bg-blue-500/10 text-blue-400 border-blue-500/20","Paid"],order_placed:["bg-amber-500/10 text-amber-400 border-amber-500/20","Placed"],processing:["bg-indigo-500/10 text-indigo-400 border-indigo-500/20","Processing"],shipped:["bg-violet-500/10 text-violet-400 border-violet-500/20","Shipped"],in_transit:["bg-violet-500/10 text-violet-400 border-violet-500/20","In Transit"],out_for_delivery:["bg-cyan-500/10 text-cyan-400 border-cyan-500/20","Out for Delivery"],delivered:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Delivered"],cancelled:["bg-red-500/10 text-red-400 border-red-500/20","Cancelled"],active:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],inactive:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"],sale:["bg-blue-500/10 text-blue-400 border-blue-500/20","For Sale"],rent:["bg-violet-500/10 text-violet-400 border-violet-500/20","For Rent"],true:["bg-emerald-500/10 text-emerald-400 border-emerald-500/20","Active"],false:["bg-gray-500/10 text-gray-400 border-gray-500/20","Inactive"]},[a,i]=t[String(e)]||["bg-gray-500/10 text-gray-400 border-gray-500/20",s(e)||"â€”"];return`<span class="badge ${a}">${i}</span>`}function ce(){document.getElementById("modal-container").innerHTML=""}function H(e){document.getElementById("modal-container").innerHTML=e,window.lucide&&lucide.createIcons()}window.closeModal=ce;window.openModal=H;function z(e,t,a,i,n=""){const o={blue:"bg-blue-500/10 text-blue-400 border-blue-500/15",amber:"bg-amber-500/10 text-amber-400 border-amber-500/15",emerald:"bg-emerald-500/10 text-emerald-400 border-emerald-500/15",red:"bg-red-500/10 text-red-400 border-red-500/15",violet:"bg-violet-500/10 text-violet-400 border-violet-500/15",blue:"bg-blue-500/10 text-blue-400 border-blue-500/15"};return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    ...
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){I.section=e;const t=dn[e]||e,a=document.getElementById("page-title");a&&(a.textContent=t),Ga(),closeSidebar();const i=document.getElementById("content");i&&(i.innerHTML=Oe()),window.lucide&&lucide.createIcons(),({dashboard:$n,products:R,properties:_t,catalog:He,orders:yi,customers:so,reviews:tt,messages:fi,coupons:kt,ads:qe,notifications:uo,ai:un,"ai-settings":xi,"homepage-branding":Et,"promo-bg":Ye,content:ho,"content-settings":Si,seo:Eo,email:Po,analytics:$o,security:$t,activity:Ao,brand:Pt,"payment-settings":Wt,backup:Co,settings:Io,publish:At}[e]||(()=>{const r=document.getElementById("content");r&&(r.innerHTML=$e("construction","Coming Soon",`${t} is being built.`))}))()};async function un(){const e=document.getElementById("content");e&&(e.innerHTML=`
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const Le="kco_admin_remember",Xt="kco_login_attempts",Mt=5,pn=15*60*1e3;function G(e){const t=document.getElementById("login-error"),a=document.getElementById("login-error-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function mn(e){const t=document.getElementById("login-success"),a=document.getElementById("login-success-text");!t||!a||(a.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function ht(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Xe(e){return String(e||"").trim().toLowerCase()}function gn(){try{const e=JSON.parse(localStorage.getItem(Le)||"{}");e?.email&&!Xe(e.email)&&localStorage.removeItem(Le)}catch{localStorage.removeItem(Le)}}function bn(){try{const e=JSON.parse(localStorage.getItem(Le)||"{}");return Xe(e?.email)}catch{return""}}function Zt(){gn();const e=bn(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Ua,t.removeAttribute("readonly"));const a=document.getElementById("reset-email");a&&(a.value=e||a.value||"",a.removeAttribute("readonly"))}function yn(){return`${window.location.origin}/admin.html`}function Pe(e){const t=document.getElementById("login-header-title"),a=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),ht(),e==="login"&&(t&&(t.textContent="Admin Access"),a&&a.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),a&&a.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),a&&a.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function q(e,t,a=""){const i=document.getElementById(e);i&&(i.disabled=t,t?i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':a&&(i.innerHTML=a),window.lucide&&lucide.createIcons())}function Va(){try{return JSON.parse(localStorage.getItem(Xt)||'{"count":0}')}catch{return{count:0}}}function za(){const e=Va();return e.count=(e.count||0)+1,e.count>=Mt&&(e.lockedUntil=Date.now()+pn),localStorage.setItem(Xt,JSON.stringify(e)),e}function Wa(){localStorage.removeItem(Xt)}function Ka(){const e=Va();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Wa(),null):Math.ceil(t/6e4)}async function de(e,t,a={}){try{await g.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await fn(),user_agent:navigator.userAgent.slice(0,200),...a})}catch{}}async function fn(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function Ya(e){if(!e)return!1;let t=!1,a=!1;try{const{data:i}=await g.rpc("is_current_user_admin");t=!0,a=!!i}catch{t=!1}return t?a:Xe(e.email)===Ua}async function hn(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){dt(),Sn();return}const{data:{session:t}}=await g.auth.getSession();if(t?.user&&await Ya(t.user)){const{data:{currentUser:i}}=await g.auth.getUser(),n=await g.auth.mfa.getAuthenticatorAssuranceLevel(),o=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&o!=="aal2"){I.user=t.user,dt(),Pe("2fa"),ea();return}I.user=t.user,vt();return}vn()}function dt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function vn(){dt(),Pe("login"),Zt(),Ja(),Qa(),ea(),wn();const e=Ka();e&&(G(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function wn(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function Ja(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",xn),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Pe("forgot")))}async function xn(e){e.preventDefault();const t=Ka();if(t){G(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const a=document.getElementById("login-email"),i=Xe(a?.value);if(!i){G("Enter your admin email address."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,o=document.getElementById("remember-me")?.checked;q("login-btn",!0),ht();const{data:r,error:l}=await g.auth.signInWithPassword({email:i,password:n});if(l||!r.user){const y=String(l?.message||"").toLowerCase();if(y.includes("missing supabase credentials")||y.includes("authentication service is unavailable")){G("Authentication is temporarily unavailable due to configuration. Please contact support."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("failed to fetch")||y.includes("network request failed")){G("Network error while signing in. Check your connection and try again."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(y.includes("email not confirmed")){G("Your admin email is not confirmed yet. Open your verification email and confirm first."),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const h=za(),b=Mt-h.count,f=h.lockedUntil?`Account locked for 15 minutes after ${Mt} failed attempts.`:`Invalid email or password. ${b>0?b+" attempt"+(b!==1?"s":"")+" remaining.":""}`;G(f),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),r?.user&&await de(r.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await Ya(r.user)){await g.auth.signOut(),G(`Access denied for ${r.user.email}. This account is signed in but does not have administrator privileges.`),q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await de(r.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(o?localStorage.setItem(Le,JSON.stringify({email:i,ts:Date.now()})):localStorage.removeItem(Le),Wa(),I.user=r.user,(await g.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){q("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Pe("2fa"),ea(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await de(r.user.id,"login_success"),q("login-btn",!1),vt()}function ea(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",ya));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{i.target.value=i.target.value.replace(/\D/g,"").slice(0,6),i.target.value.length===6&&ya()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await g.auth.signOut(),I.user=null,Pe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const a=document.getElementById("verify-backup-btn");a&&!a._bound&&(a._bound=!0,a.addEventListener("click",_n))}async function ya(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){G("Enter the 6-digit code from your authenticator app.");return}q("verify-2fa-btn",!0),ht();try{const{data:t}=await g.auth.mfa.listFactors(),a=(t?.totp||[])[0];if(!a){G("No 2FA factor found. Please re-login."),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:i,error:n}=await g.auth.mfa.challenge({factorId:a.id});if(n)throw n;const{error:o}=await g.auth.mfa.verify({factorId:a.id,challengeId:i.id,code:e});if(o)throw o;await de(I.user.id,"login_2fa_success"),q("verify-2fa-btn",!1),vt()}catch(t){za(),G(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),q("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function _n(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){G("Enter a backup recovery code.");return}q("verify-backup-btn",!0);try{const{data:t}=await g.from("admin_2fa").select("backup_codes").eq("user_id",I.user.id).maybeSingle();if(!t?.backup_codes?.length){G("No backup codes found."),q("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){G("Backup code not found or already used."),q("verify-backup-btn",!1,"Use Backup Code");return}const i=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await g.from("admin_2fa").update({backup_codes:i}).eq("user_id",I.user.id),await de(I.user.id,"login_backup_code_used"),vt()}catch(t){G(t.message),q("verify-backup-btn",!1,"Use Backup Code")}}function Qa(){document.getElementById("back-to-login")?.addEventListener("click",()=>Pe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",kn)}async function kn(){const e=document.getElementById("reset-email"),t=Xe(e?.value);if(!t){G("Enter your admin email address to receive a reset link.");return}q("send-reset-btn",!0),ht();const{error:a}=await g.auth.resetPasswordForEmail(t,{redirectTo:yn()});if(q("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),a){G(a.message);return}mn("Reset link sent! Check your inbox and open it from this device to continue.")}function Sn(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,Xa(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${s(t.message)}</div>`)}}function fe(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function Nt(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function En(e){const t=fe(e.price),a=parseFloat(e.real_price);if(Number.isFinite(a)&&a>0&&a>t)return`${Math.round((1-t/a)*100)}% OFF`;const i=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(i)&&i>0?`${Math.round(i)}% OFF`:"No discount"}function Pn(e){const t=fe(e.price),a=parseFloat(e.real_price),i=`$${t.toLocaleString()}`;return Number.isFinite(a)&&a>0&&a>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${a.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:i}function ta(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Bt(e){return parseInt(e.views??e.view_count??0,10)||0}function Rt(e){return parseInt(e.sales??e.sales_count??0,10)||0}function aa(e){return e.sku||e.property_id||"N/A"}function An(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",a=Nt(e),i=ta(e),n=window._productSelection?.has(e.property_id),o=Y(i==="archived"?"inactive":i==="active"?"active":"inactive"),r=re(e.created_at),l=!!e.is_featured,d=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,c=e.is_active?"Unpublish":"Publish",u=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${s(e.category||"")}" data-status="${i}" data-featured="${l?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    <div class="flex items-start gap-4">
      ...
      <div class="min-w-0 flex-1">
        ...
        <p class="text-xs text-gray-500 font-mono mt-1">SKU: ${s(aa(e))}</p>
    ...
    <div class="grid grid-cols-2 gap-2.5 text-sm">
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Discount</span><p class="text-amber-300 font-bold">${s(En(e))}</p></div>
      ...
      <div class="rounded-2xl bg-white/5 border border-white/10 px-3 py-2.5"><span class="text-gray-400 text-xs">Views</span><p class="text-blue-300 font-bold">${Bt(e).toLocaleString()}</p></div>
  ...
  </article>`}function Cn(e,t){const a=[...e],i=n=>new Date(n||0).getTime()||0;return t==="oldest"?a.sort((n,o)=>i(n.created_at)-i(o.created_at)):t==="price-high"?a.sort((n,o)=>fe(o.price)-fe(n.price)):t==="price-low"?a.sort((n,o)=>fe(n.price)-fe(o.price)):t==="sales-high"?a.sort((n,o)=>Rt(o)-Rt(n)):t==="views-high"?a.sort((n,o)=>Bt(o)-Bt(n)):a.sort((n,o)=>i(o.created_at)-i(n.created_at)),a}function Xa(e){const t=document.getElementById("products-grid"),a=document.getElementById("products-empty"),i=document.getElementById("products-result-count");if(!t)return;const n=window._productsCardLimit||60,o=e.slice(0,n);t.innerHTML=o.map(An).join(""),i&&(i.textContent=String(e.length));const r=document.getElementById("products-more");if(r){const l=e.length-o.length;l>0?r.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,l)} more (${l} left)</button>`:r.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}a&&a.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function Za(e){const t=document.getElementById("products-table-body"),a=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(i=>{const n=i.images&&i.images[0]?i.images[0]:"/fallback.svg",o=ta(i),r=window._productSelection?.has(i.property_id),l=i.is_active?`unpublishProduct('${i.property_id}')`:`publishProduct('${i.property_id}')`,d=i.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${i.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${i.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${s(aa(i))}</p>
              </div>
            </div>
          </td>
...
This is permanent and cannot be undone. Your built-in showroom catalog will stay.`))return;const{error:t}=await g.from("showroom_listings").delete().neq("property_id","__none__");if(t)return X(t)?m("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"):m("Clear failed: "+t.message,"error");try{localStorage.removeItem("kco_local_showroom_listings_v1")}catch{}m("All products deleted. The manager now shows your showroom catalog."),R()};window.openProductMoreActions=function(e){H(`
  ...
  </div>`}function ia(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),Nn(t.dataTransfer.files)}))}function na(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>je()})}window.handleImageUpload=async function(e){await oa(e.target.files)};async function Nn(e){await oa(e)}async function ni(e,t,a){const i=new Array(e.length);let n=0;const o=Array.from({length:Math.min(Math.max(t,1),e.length)},async()=>{for(;n<e.length;){const r=n++;try{i[r]=await a(e[r],r)}catch{i[r]=null}}});return await Promise.all(o),i}function Bn(e,t,a,i,n=9e4){return new Promise(o=>{let r=!1;const l=setTimeout(()=>{r||(r=!0,o({error:{message:`Upload timed out after ${Math.round(n/1e3)}s — the network is too slow for this file size.`}}))},n);g.storage.from(e).upload(t,a,i).then(d=>{r||(r=!0,clearTimeout(l),o(d))})})}async function Rn(e,t=1920,a=.82){const i=URL.createObjectURL(e);try{const n=new Image;await new Promise((p,y)=>{n.onload=p,n.onerror=y,n.src=i});const o=Math.min(1,t/Math.max(n.width,n.height)),r=Math.max(1,Math.round(n.width*o)),l=Math.max(1,Math.round(n.height*o)),d=document.createElement("canvas");d.width=r,d.height=l,d.getContext("2d").drawImage(n,0,0,r,l);const c=await new Promise(p=>d.toBlob(p,"image/jpeg",a));if(!c||!c.size)return null;const u=(e.name||"photo.jpg").replace(/\.[^.]+$/i,"")+".jpg";return new File([c],u,{type:"image/jpeg"})}catch{return null}finally{URL.revokeObjectURL(i)}}async function oa(e){const t=document.getElementById("image-preview");if(!t)return;const a=[];for(const n of e){const o=n.type==="application/pdf"||Qe(n.name),r=Ne(n);if(!(!n.type.startsWith("image/")&&!o&&!r)){if(r&&n.size>100*1024*1024){m("Video must be under 100 MB.","error");continue}a.push(n)}}if(!a.length)return;const i=a.map(()=>{const n=document.createElement("div");return n.className="img-thumb uploading",n.style.cssText="min-width:90px;min-height:80px;",n.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',t.appendChild(n),n});await ni(a,3,async(n,o)=>{const r=i[o],l=await ra(n);setTimeout(()=>{if(!(!r||!r.isConnected)){if(r.remove(),l){const d=document.createElement("div");d.innerHTML=Ae(l,o);const c=d.firstElementChild,u=r.nextSibling;u?t.insertBefore(c,u):t.appendChild(c)}else m(`Failed to upload ${Ne(n)?"video":"image"}. Try a smaller file.`,"error");je(),Ze(),Ce(),window.lucide&&lucide.createIcons()}},0)})}async function ra(e){try{const{data:{session:t}}=await g.auth.getSession(),a=String(e.type||"").startsWith("image/"),i=Ne(e);let n=e;if(a&&e.size>250*1024){const d=await Rn(e);d&&d.size&&(n=d)}const o=n.type==="image/jpeg"?"jpg":(e.name||"photo.jpg").split(".").pop()||"jpg",r=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`,l=i?18e4:9e4;for(let d=0;d<2;d++){const c=`${r}${d?"-"+Math.random().toString(36).slice(2,7):""}.${o}`,{error:u}=await Bn("product-images",c,n,{contentType:n.type||e.type,upsert:!1},l);if(u)console.warn("product-images upload failed (attempt "+(d+1)+"):",u.message||u);else{const{data:p}=g.storage.from("product-images").getPublicUrl(c);if(p&&p.publicUrl)return p.publicUrl}}try{const d=await F._downscaleImage(n,1200);if(d)return d}catch{}return URL.createObjectURL(e)}catch{return URL.createObjectURL(e)}}async function Dn(){if(!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform()))return null;try{const{Camera:e,MediaTypeSelection:t}=await Ca(async()=>{const{Camera:n,MediaTypeSelection:o}=await import("@capacitor/camera");return{Camera:n,MediaTypeSelection:o}},[]),{results:a}=await e.chooseFromGallery({mediaType:t.All,allowMultipleSelection:!0,includeMetadata:!0}),i=[];for(const n of a||[])if(n.webPath)try{const o=n.type===1,r=(n.metadata&&n.metadata.format||(o?"mp4":"jpg")).toLowerCase().replace(/^jpeg$/,"jpg"),l=await fetch(n.webPath).then(d=>d.blob());i.push(new File([l],`gallery-${Date.now()}-${Math.random().toString(36).slice(2)}.${r}`,{type:l.type||(o?"video/mp4":"image/jpeg")}))}catch{}return i}catch(e){return console.warn("Native gallery picker unavailable:",e),null}}window.pickMediaForForm=async function(e){const t=await Dn();if(t===null){document.getElementById(e)?.click();return}t.length&&(e==="s1-img-upload"?await handleStep1Files(t):await oa(t))};window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const a=[...t.children];a[e]&&a[e].remove(),je(),Ze(),Ce()};window.replaceImage=async function(e,t){const a=document.getElementById("image-preview");if(!a||!t||!t.files||!t.files[0])return;const i=t.files[0],n=i.type==="application/pdf"||Qe(i.name),o=Ne(i);if(!i.type.startsWith("image/")&&!n&&!o){m("Please choose an image, video, or PDF file.","error");return}if(o&&i.size>100*1024*1024){m("Video must be under 100 MB.","error");return}const r=await ra(i);if(!r)return;const d=[...a.querySelectorAll(".img-thumb")][e];d&&(d.outerHTML=Ae(r,e),je(),Ze(),Ce(),m(n?"Document replaced. Save to apply.":o?"Video replaced. Save to apply.":"Image replaced. Save to apply.","info"))};function je(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((a,i)=>{const n=a.dataset.url||(a.querySelector("img")?a.querySelector("img").src:"");if(!n)return;const o=document.createElement("input");o.type="hidden",o.name="images",o.id=`img-url-${i}`,o.value=n,t.appendChild(o),a.dataset.index=i;const r=a.querySelector(".rm");r&&r.setAttribute("onclick",`removeImage(${i})`);const l=a.querySelector(".rp");l&&l.setAttribute("onclick",`document.getElementById('rp-input-${i}').click()`);const d=a.querySelector(".rp-input");d&&(d.id=`rp-input-${i}`,d.onchange=()=>replaceImage(i,d))}))}function Ze(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,a)=>{t.classList.toggle("cover-img",a===0);const i=Me(t.dataset.url);t.title=a===0?"Cover (main)":(i?"Video ":"Image ")+(a+1)})}function Ce(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const a=[...e.querySelectorAll(".img-thumb")],i=a.length,n=a.filter(r=>Me(r.dataset.url)).length,o=i-n;if(i===0)t.textContent="No media yet — you can still save and publish anytime";else{const r=[];o>0&&r.push(`${o} image${o>1?"s":""}`),n>0&&r.push(`${n} video${n>1?"s":""}`),t.textContent=`${r.join(" + ")} — you can save and publish anytime`}t.className="text-sm mt-1 font-bold text-gray-400"}function Ke(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function Fn(e){const t=new FormData(e),a={images:[],tags:[],fields:{}};for(const[i,n]of t.entries())i==="images"?n&&!String(n).startsWith("blob:")&&a.images.push(String(n)):i==="tags"?a.tags.push(String(n)):a.fields[i]=String(n);return a.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",a.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",a}function Un(e,t){if(!t||typeof t!="object")return!1;const a=t.fields||{};Object.entries(a).forEach(([n,o])=>{const r=e.querySelector(`[name="${n}"]`);r&&(r.type==="checkbox"?r.checked=o==="on"||o===!0:r.value=o==null?"":String(o))});const i=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(n=>{n.checked=i.includes(n.value)}),Array.isArray(t.images)){const n=document.getElementById("image-preview");n&&(n.innerHTML=t.images.map((o,r)=>Ae(o,r)).join(""),je(),Ze(),Ce())}return!0}function jt(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const a=t.querySelector('[name="title"]')?.value||"Untitled Product",i=t.querySelector('[name="brand"]')?.value||"N/A",n=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,o=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,r=t.querySelector('[name="stock_quantity"]')?.value,l=r===""||r==null?"Unlimited":r,d=I.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",c=[...t.querySelectorAll('input[name="tags"]:checked')].map(y=>y.value),u=document.querySelectorAll("#image-preview .img-thumb").length,p=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
  ...
  `}window.previewProductDraft=function(){const e=document.getElementById("product-form");if(!e)return;const t=document.querySelector("#image-preview img")?.src||"/fallback.svg",a=e.querySelector('[name="title"]')?.value||"Untitled Product",i=e.querySelector('[name="description"]')?.value||"No description yet.",n=e.querySelector('[name="brand"]')?.value||"N/A",o=parseFloat(e.querySelector('[name="price"]')?.value||"0")||0,r=parseFloat(e.querySelector('[name="real_price"]')?.value||"0")||0,l=e.dataset.category||"Product",d=e.querySelector('[name="stock_quantity"]')?.value||"Unlimited",c=e.querySelector('[name="is_active"]')?.checked;H(`
    ...
    </div>`)};function On(e,t){const a=document.getElementById("product-form");if(!a)return;a.dataset.category=e;const i=Ke(e,t),n=document.getElementById("product-autosave-note");if(!t)try{const d=localStorage.getItem(i);if(d){const c=JSON.parse(d);Un(a,c)&&n&&(n.textContent="Autosave restored from your last session.",n.classList.remove("hidden"))}}catch{}const o=()=>{try{localStorage.setItem(i,JSON.stringify(Fn(a))),n&&(n.textContent=`Auto saved at ${new Date().toLocaleTimeString()}`,n.classList.remove("hidden"))}catch{}jt()};let r;const l=()=>{clearTimeout(r),r=setTimeout(o,500)};a.querySelectorAll("input, textarea, select").forEach(d=>{d.addEventListener("input",l),d.addEventListener("change",l)}),jt(),Ce()}const jn=["New","Refurbished","Used - Like New","Used - Good","Used - Fair"],qn=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Motorcycle","Yacht","Other"],Hn=["Automatic","Manual","CVT","Dual-Clutch","Semi-Automatic","Electric (Single Speed)"],Gn=["Gasoline","Diesel","Electric","Hybrid","Plug-in Hybrid","LPG","Bio-diesel"],Vn=["FWD","RWD","AWD","4WD"],oi=new Set(["price","real_price","stock_quantity","currency","images","tags","verification_status","is_featured","is_active","sku"]);function va(e){const t=e.id?`label[for="${e.id}"]`:null,a=t?document.querySelector(t):null;if(a)return a.textContent.replace(/\s+/g," ").trim().slice(0,60);const i=e.closest("div");if(i){const n=i.querySelector("label");if(n)return n.textContent.replace(/\s+/g," ").trim().slice(0,60)}return String(e.name||"").replace(/_/g," ")}function zn(e){const t=typeof e=="string"?document.querySelector(e):e;if(!t)return[];const a=new Set,i=[];return t.querySelectorAll("input[name], select[name], textarea[name]").forEach(n=>{const o=String(n.name||"");if(!o||o==="images"||a.has(o)||["hidden","file","submit","button"].includes(n.type))return;if(a.add(o),n.type==="checkbox"){const l=[...t.querySelectorAll(`input[name="${o}"]`)];i.push({key:o,label:va(n),type:"checkbox-group",options:l.map(d=>d.value).filter(Boolean),required:n.required});return}if(n.type==="radio")return;const r=n.tagName==="SELECT"?"select":n.tagName==="TEXTAREA"?"textarea":n.type==="number"?"number":"text";i.push({key:o,label:va(n),type:r,options:n.tagName==="SELECT"?[...n.options].map(l=>l.value).filter(Boolean):null,required:!!n.required})}),i}function Wn(e){return!e||!e.length?"":`
...
`}const Kn=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function wa(e,t){const a={...t||{}},i=new Set(Array.isArray(a.estimated)?a.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(a.missing_fields)?a.missing_fields.map(u=>String(u)):[]),o=[],r=[],l=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(y=>y!=null&&String(y).trim()!=="").join(", "));let p=String(u).replace(/\s+/g," ").trim();return p=p.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),p},d=u=>{const p=l(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),y=parseFloat(p);return Number.isFinite(y)?y:NaN};for(const u of e||[]){if(oi.has(u.key))continue;const p={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const b=Array.isArray(a[u.key])?a[u.key].map(l).filter(Boolean):[],f=u.options&&u.options.length?b.filter(w=>u.options.includes(w)):b;f.length?(a[u.key]=f,p.status="filled",p.value=f.join(", ")):(delete a[u.key],b.length&&(p.status="flagged",p.note="values not in the allowed badge list were dropped",r.push(`${u.label}: invalid selection ignored`))),o.push(p);continue}if(!(a[u.key]!=null&&l(a[u.key])!=="")){p.status=n.has(u.key)?"missing":"empty-ok",o.push(p);continue}if(Kn.test(l(a[u.key]))){delete a[u.key],n.add(u.key),p.status="missing",p.note="document/AI said the value is unavailable",o.push(p);continue}if(u.type==="number"){const b=l(a[u.key]),f=d(a[u.key]);if(!Number.isFinite(f)){delete a[u.key],n.add(u.key),p.status="flagged",p.note=`"${b}" is not a valid number`,r.push(`${u.label}: not a valid number`),o.push(p);continue}if(/year/.test(u.key)&&(f<1800||f>new Date().getFullYear()+2)){delete a[u.key],n.add(u.key),p.status="flagged",p.note=`${f} is outside the plausible range`,r.push(`${u.label}: implausible value ${f}`),o.push(p);continue}a[u.key]=f,p.status="filled",p.value=String(f),i.has(u.key)&&(p.status="estimated",p.note="AI estimate â€” confirm"),o.push(p);continue}if(u.type==="select"&&u.options&&u.options.length){const b=si({options:u.options.map(f=>({value:f}))},l(a[u.key]));if(b==null){p.status="flagged",p.note=`"${l(a[u.key])}" does not match any option â€” left empty`,r.push(`${u.label}: no matching option`),delete a[u.key],n.add(u.key),o.push(p);continue}a[u.key]=b,p.status="filled",p.value=b,b!==l(t?.[u.key])&&(p.note="matched to the closest option"),o.push(p);continue}let h=l(a[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&h.length>120&&!["title"].includes(u.key)&&(p.status="flagged",p.note="unusually long â€” check it landed in the right field",r.push(`${u.label}: suspiciously long value`)),a[u.key]=h,p.status="filled",p.value=h.length>48?h.slice(0,48)+"â€¦":h,i.has(u.key)&&(p.status="estimated",p.note="AI estimate â€” confirm"),o.push(p)}if(e&&e.length){const u=new Set([...e.map(p=>p.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(a).forEach(p=>{u.has(p)||delete a[p]})}a.missing_fields=o.filter(u=>u.status==="missing").map(u=>u.key),a.estimated=o.filter(u=>u.status==="estimated").map(u=>u.key);const c={total:o.length,filled:o.filter(u=>u.status==="filled").length,estimated:o.filter(u=>u.status==="estimated").length,flagged:o.filter(u=>u.status==="flagged").length,missing:o.filter(u=>u.status==="missing").length};return{specs:a,checklist:o,flags:r,summary:c}}function ri(e,t){if(!e||!e.length)return"";const a={filled:'<span class="text-emerald-400 font-bold">âœ“</span>',estimated:'<span class="text-blue-300 font-bold">â‰ˆ</span>',flagged:'<span class="text-red-400 font-bold">!</span>',missing:'<span class="text-gray-500">â€”</span>',"empty-ok":'<span class="text-gray-700">Â·</span>'},i=e.filter(o=>o.status!=="empty-ok").map(o=>`<li class="flex items-start gap-2"><span class="shrink-0 w-4">${a[o.status]||""}</span><span><b>${s(o.label)}</b> <span class="text-gray-600">(${s(o.key)})</span>${o.value?` â€” <span class="text-gray-300">${s(String(o.value))}</span>`:""}${o.note?` <span class="text-gray-500">${s(o.note)}</span>`:""}</span></li>`).join(""),n=t.total-t.filled-t.estimated-t.flagged-t.missing;return`<details class="mt-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-3">
  ...
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
    ...
    <div class="space-y-3">
      ...
      </div>`});if(!l||l.choice==="cancel"){o("Scan cancelled â€” nothing was changed.","text-gray-400"),m("Scan cancelled.","info");return}try{o("Reading every page, completing property details and market valueâ€¦","text-blue-300");const d=await da({imageUrls:i,identification:r,category:"Real Estate",formSelector:"#property-form"}),c=d.identification||r,u=ui({identification:c,specs:d.specs,price:d.price});let p=`${s(c.detected_name||"Property")} â€” ${u.filled.length} field${u.filled.length>1?"s":""} ready for you. Review and edit everything, then press Publish Property.`;d.visionUsed?d.verifyRequested&&(p+=d.verified?'<p class="text-[11px] text-gray-400 mt-1">âœ“ Second-pass verification completed â€” every value was re-checked against your document.</p>':'<p class="text-[11px] text-amber-300/80 mt-1">Second-pass verification could not run â€” values come from the first pass.</p>'):p+=`<p class="text-[11px] text-red-300 mt-1">⚠ Photo was NOT read by AI (${s(d.providerLabel||"text fallback")}) — these values did NOT come from your images.</p>`,p+=pi(),p+=ri(d.checklist,d.summary),o(p,"text-emerald-300"),m("Review the property details, then press Publish Property.","success")}catch(d){const c=String(d?.message||d),u=/key|api|configured|settings|vision/i.test(c);o(u?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${c}`,"text-red-400"),m("AI scan failed.","error")}window.lucide&&lucide.createIcons()};let xe=[];window.handleStep1Files=async function(e){const t=Array.from(e||[]).slice(0,24);if(!t.length)return;const a=document.getElementById("s1-image-preview"),i=[];for(const o of t){const r=o.type==="application/pdf"||Qe(o.name),l=Ne(o);if(!o.type.startsWith("image/")&&!r&&!l)continue;if(l&&o.size>100*1024*1024){m("Video must be under 100 MB.","error");continue}i.push(o);const d=document.createElement("div");d.className="img-thumb",d.style.cssText="min-width:90px;min-height:80px;",d.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',a&&a.appendChild(d)}if(!i.length)return;const n=[];await ni(i,3,async(o,r)=>{try{const l=await ra(o);n[r]=l}catch{n[r]=null}}),i.forEach((o,r)=>{n[r]?xe.push(n[r]):m(`Failed to upload ${Ne(o)?"video":"image"}. Try a smaller file.`,"error")}),gi()};window.handleStep1ImageUpload=async function(e){await window.handleStep1Files(e.target.files||[]),e.target.value=""};window.removeStep1Image=function(e){xe.splice(e,1),gi()};function gi(){const e=document.getElementById("s1-image-preview");if(!e)return;e.innerHTML=xe.map((a,i)=>{const o=Me(a)?`<video src="${s(a)}" muted loop preload="metadata" playsinline class="w-full h-full object-cover"></video>
    ...
    </div>`}).join("");const t=document.getElementById("btn-s1-scan");t&&(t.disabled=xe.length===0,t.style.opacity=xe.length?"":"0.5"),window.lucide&&lucide.createIcons()}window.scanFirstWithAI=async function(){const e=xe.slice();if(!e.length){m("Upload at least one product image before scanning.","error");return}const t=document.getElementById("btn-s1-scan"),a=document.getElementById("s1-scan-status"),i=t?t.innerHTML:"",n=(l,d)=>{a&&(a.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),d&&a.classList.add(d),a.innerHTML=l)};await mi(n),t&&(t.disabled=!0,t.innerHTML="Scanningâ€¦"),n("Detecting every distinct product in your imagesâ€¦","text-blue-300");let o;try{o=await F.detectProducts(e,{category:"",maxImages:Be.maxImages})}catch(l){const d=/key|api|configured|settings|vision/i.test(String(l?.message||l));n(d?"The scanner could not run right now. Confirm your free key is set in AI Settings, then try again.":`Scan failed: ${String(l?.message||l)}`,"text-red-400"),t&&(t.disabled=!1,t.innerHTML=i);return}t&&(t.disabled=!1,t.innerHTML=i);let r=o&&o.identified!==!1&&Array.isArray(o.products)&&o.products.length?o.products:[];r.length||(r=[{detected_name:"Product from your photos",category:"Other",listing_type:"product",confidence:"low",image_indices:e.map((l,d)=>d)}],n("The AI could not confidently read these photos â€” a card was created with all of them. Review, edit the details, then continue to save & publish.","text-amber-300")),$=r,_e=e,De={},ae="s1-scan-status",scanReviewRender(),m(`${r.length} distinct product${r.length>1?"s":""} detected â€” review each one, then continue.`,"info")};let De={},ye=!1;function to(e){const t=parseFloat(e&&e.price);return!Number.isFinite(t)||t<=0}async function bi(){const e=new Set,t=[],a=i=>{!i||!i.property_id||i.listing_type==="property"||e.has(i.property_id)||!Array.isArray(i.images)||!i.images.length||ye&&!to(i)||(e.add(i.property_id),t.push(i))};try{const{data:i,error:n}=await g.from("showroom_listings").select("*").neq("listing_type","property");(n?[]:i||[]).forEach(a)}catch{}return yt().forEach(a),t}window.returnToScanReviewAfterSave=function(e=Re){if(Re=-1,!$.length){if(be){be=!1;const t=document.getElementById("scanner-scan-status");t&&(t.classList.remove("hidden","text-red-400","text-amber-300","text-blue-300"),t.classList.add("text-emerald-300"),t.innerHTML=`<p class="font-bold">Auto-scan complete: ${ge} published, ${Z} error${Z!==1?"s":""}.</p>`),m(`Auto-scan complete: ${ge} published, ${Z} error${Z!==1?"s":""}.`,ge>0?"success":"info"),R()}return!1}if(Number.isInteger(e)&&e>=0&&e<$.length&&$.splice(e,1),!$.length){if(_e=[],De={},be){be=!1;const t=document.getElementById("scanner-scan-status");t&&(t.classList.remove("hidden","text-red-400","text-amber-300","text-blue-300"),t.classList.add("text-emerald-300"),t.innerHTML=`<p class="font-bold">Auto-scan complete: ${ge} published, ${Z} error${Z!==1?"s":""}.</p>`),m(`Auto-scan complete: ${ge} published, ${Z} error${Z!==1?"s":""}.`,ge>0?"success":"info"),R()}return!1}return be?(Ve($[0],0),!0):(ae="scanner-scan-status",H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function Ve(e,t){const a=sa(e,_e),i=et(e.category),n=e.listing_type==="property"||i&&i.listing_type==="property",o=n?"Real Estate":i.category||e.category||"Other",r=di,l=r-$.length;((c,u)=>{const p=document.getElementById("scanner-scan-status");p&&(p.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),p.classList.add(u),p.innerHTML=c)})(`Processing ${l+1} of ${r}: ${s(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){Z++,$.splice(t,1),$.length?Ve($[0],0):window.returnToScanReviewAfterSave(-1);return}let c=e.property_id?De[e.property_id]:null;c&&c.specifications&&typeof c.specifications=="object"&&(c={...c,...c.specifications}),showAddProductStep2(o,c?{...c,images:a}:{images:a}),await new Promise(y=>setTimeout(y,250)),await pt(e,a,o);const p=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");p?(Re=t,p.click()):(Z++,closeProductFormModal(),$.splice(t,1),$.length?Ve($[0],0):window.returnToScanReviewAfterSave(-1))}catch{Z++,closeProductFormModal(),$.splice(t,1),$.length?Ve($[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(e=!1){ye=!!e;const t=await bi();H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
  ...
  `,"text-blue-300"),m(`Scan done — auto-publishing ${r.length} product${r.length>1?"s":""}â€¦`,"info"),Ve(r[0],0)};window.saveProduct=async function(e,t,a){e.preventDefault();const i=e.target,n=i.querySelector("[type=submit][name=action][value=publish]"),o=a?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const l=document.createElement("style");l.id="_pubspin-style",l.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(l)}}catch{}const r=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=o)};try{const l=new FormData(i),d={};let c=0;for(const[b,f]of l.entries())if(b==="images"){d.images=d.images||[];const w=String(f);f&&!w.startsWith("blob:")?d.images.push(w):w.startsWith("blob:")&&c++}else b==="tags"?(d.tags=d.tags||[],d.tags.push(f)):d[b]=f;if(c&&!(d.images||[]).length){r(),m("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}d.is_featured=i.querySelector('[name="is_featured"]')?.checked?"on":"",d.is_active=i.querySelector('[name="is_active"]')?.checked?"on":"";const u=l.get("action")==="draft",p=b=>Dt(b),y=b=>{const f=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],w={};for(const x of f){const S=b[x];if(x==="real_price"){const v=S!=null&&String(S).trim()!==""?parseFloat(S):null;w[x]=v!=null&&Number.isFinite(v)&&v>0?Math.round(v):null;continue}w[x]=S!=null&&String(S).trim()!==""?S:null}if(b.safety_features){const x=p(b.safety_features);w.safety_features=x.length?x:null}return w};if(a){let b=null;try{const{data:_}=await g.from("showroom_listings").select("*").eq("property_id",a).maybeSingle();_&&(b=ve(_))}catch{}if(b||(b=ve((window._productsData||[]).find(_=>_.property_id===a))),b||(b=ve(We?We(a):null)),!b)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const f=(_,j)=>{const it=_===""||_==null?"":_,Se=j===""||j==null?"":j;return String(it).trim()===String(Se).trim()},w={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(_=>{f(d[_],b[_])||(w[_]=d[_]==null||d[_]===""?null:d[_])});const x=d.price===""||d.price==null?null:parseFloat(d.price);f(x,b.price)||(w.price=x==null?b.price:Math.max(O,Math.min(Q,x)));const S=d.stock_quantity===""||d.stock_quantity==null?null:parseInt(d.stock_quantity,10);f(S,b.stock_quantity)||(w.stock_quantity=Number.isFinite(S)?S:null);const v=p(d.features_text);f(v.join("||"),(Array.isArray(b.features)?b.features:[]).join("||"))||(w.features=v);const P=d.tags||[];f(P.join("||"),(Array.isArray(b.tags)?b.tags:[]).join("||"))||(w.tags=P);const E=p(d.highlights_text);f(E.join("||"),(Array.isArray(b.highlights)?b.highlights:[]).join("||"))||(w.highlights=E);const M=p(d.seo_keywords_text);f(M.join("||"),(Array.isArray(b.seo_keywords)?b.seo_keywords:[]).join("||"))||(w.seo_keywords=M);const k=d.images||[];f(k.join("||"),(Array.isArray(b.images)?b.images:[]).join("||"))||(w.images=k);const U=k.find(_=>typeof _=="string"&&Me(_))||null;f(U,b.video_url)||(w.video_url=U);const B=d.is_featured==="on";!!b.is_featured!==B&&(w.is_featured=B);const N=u?!1:d.is_active==="on";!!b.is_active!==N&&(w.is_active=N);const Te=y(d),pe={...b.specifications&&typeof b.specifications=="object"?b.specifications:{},...Te};if(JSON.stringify(pe)!==JSON.stringify(b.specifications||{})&&(w.specifications=pe),Object.keys(w).length===0){m("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(Ke(t,a))}catch{}m("No changes were needed — this product is already published with exactly these details.","info"),r(),closeProductFormModal(),R();return}const ee={...b,...w,property_id:a,updated_at:new Date().toISOString()};delete ee.id;const me=await fa(ee);if(me.error){r();const _=It(me.error,u?"Draft save":"Product publish");m(_,"error");try{let j=i.querySelector(".__publish-error-banner");j||(j=document.createElement("div"),j.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(j)),j.textContent=_}catch{}return}try{Lt(ee)}catch{}try{const _=(window._productsData||[]).findIndex(j=>j.property_id===a);_>=0&&(window._productsData[_]=ee)}catch{}m(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(w).length} change${Object.keys(w).length>1?"s":""}).`)}else{if(!d.title||!d.title.trim())throw new Error("A product title is required.");if(d.price===""||d.price==null||!isFinite(parseFloat(d.price)))throw new Error("A price is required.");if(!!i.querySelector('[name="condition"]')&&!d.condition)throw new Error("Please choose the product condition.");const f={listing_type:"product",category:t,subcategory:d.subcategory||null,title:d.title.trim(),description:d.description||"",price:Math.max(O,Math.min(Q,parseFloat(d.price)||0)),currency:d.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:d.is_active==="on",is_featured:d.is_featured==="on",brand:d.brand||null,color:d.color||null,size:d.size||null,condition:d.condition||null,warranty:d.warranty||null,availability_status:d.availability_status||"In Stock",stock_quantity:d.stock_quantity?parseInt(d.stock_quantity):null,images:d.images||[],video_url:(d.images||[]).find(S=>typeof S=="string"&&Me(S))||null,features:p(d.features_text).length?p(d.features_text):d.tags||[],tags:d.tags||[],highlights:p(d.highlights_text),seo_keywords:p(d.seo_keywords_text),is_ai_generated:!!d.catalog_template_id,ai_generated_fields:d.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:y(d)},w=Qt();f.property_id=w;const x=await fa(f);if(x.error){r();const S=It(x.error,"Product publish");m(S,"error");try{let v=i.querySelector(".__publish-error-banner");v||(v=document.createElement("div"),v.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",i.prepend(v)),v.textContent=S}catch{}return}try{Lt({...f,property_id:f.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...f})}catch{}m(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}be&&ge++,r();try{localStorage.removeItem(Ke(t,a))}catch{}const h=Re;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(h)){R();return}R()}catch(l){const d=l&&l.message&&!/failed to fetch|networkerror/i.test(String(l.message))?l.message:It(l,"Product publish");be&&Z++,r(),m(d,"error")}};window.editProduct=async function(e){const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let i=a?null:t;if(i||(i=We(e)),i||(i=(window._productsData||[]).find(n=>n.property_id===e)||null),!i)return m("Product not found","error");i.specifications&&typeof i.specifications=="object"&&(i={...i,...i.specifications}),showAddProductStep2(i.category||"Other",i)};window.toggleProductActive=async function(e,t){let a=null;try{const{data:n}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(a=ve(n))}catch{}if(a||(a=ve((window._productsData||[]).find(n=>n.property_id===e))),!a||!a.property_id){Tt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),m(t?"Product published locally":"Product unpublished locally","info"),R();return}delete a.id,a.property_id=e,a.is_active=t,a.availability_status=t?"In Stock":"Out of Stock";const{error:i}=await g.from("showroom_listings").upsert(a,{onConflict:"property_id"});if(i){if(X(i))return m(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Tt(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),m(t?"Product published locally":"Product unpublished locally","info"),R();return}m(t?"Product published":"Product unpublished"),R()};window.duplicateProduct=async function(e,t=!1){const{data:a}=await g.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!a)return;const{id:i,property_id:n,created_at:o,updated_at:r,...l}=a,d=Qt();await g.from("showroom_listings").insert({...l,property_id:d,title:a.title+" (Copy)",is_active:!1}),t||(m("Product duplicated"),R())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await g.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),m("Product archived"),R())};const Ht=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function _t(){const e=document.getElementById("content");try{const{data:t,error:a}=await g.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let i=a?yt().filter(o=>o.listing_type==="property"):t||[];if(Array.isArray(ie)){const o=new Set(i.map(l=>l.property_id)),r=ie.filter(l=>l.listing_type==="property"&&l.property_id&&!o.has(l.property_id));r.length&&(i=i.concat(r))}i.sort((o,r)=>new Date(r.created_at||0)-new Date(o.created_at||0));try{await Kt()}catch{}const n=new Set(ft());i=i.filter(o=>!(o&&o.property_id&&n.has(o.property_id))),window._propertiesData=i,e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,a=Ra("property","Real Estate"),i=e.country_code||"US",n=e.currency||Yt(i);H(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Property Type *</label><select class="input-field" name="property_type" required>
              ${Ht.map(r=>`<option value="${r}" ${e.property_type===r?"selected":""}>${r}</option>`).join("")}
            </select></div>
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${a.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':a.map(o=>ro(o)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=a,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}function ro(e){return`<tr class="order-row" data-status="${e.status}" data-search="${s(e.order_number)} ${s(e.full_name)} ${s(e.email)}">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",Ha(t.amount,t.currency)],["Product",t.listing_title||t.listing_id],["Date",ke(t.created_at)]].map(([a,i])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${s(i)||"â€”"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${oo.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`)};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:a}=await g.from("payment_receipts").update({status:t}).eq("id",e);if(a){m(a.message,"error");return}m("Order status updated"),ce(),yi()};async function so(){const e=document.getElementById("content");try{const{data:t}=await g.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      <div class="space-y-4 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${a.length===0?$e("star","No Reviews","Customer reviews will appear here."):a.map(l=>co(l)).join("")}
          </div>
        </div>
        ...
        <div class="glass-soft border border-emerald-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="feedback-list">
            ${o.length===0?$e("message-square","No Feedback Yet","Site feedback will appear here."):o.map(l=>lo(l)).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}function lo(e){const t=Array.from({length:5},(a,i)=>i<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await g.from("site_feedback").update({is_approved:!0}).eq("id",e);t?m(t.message,"error"):m("Feedback approved â€” it now shows on every page."),tt()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await g.from("site_feedback").delete().eq("id",e);t?m(t.message,"error"):m("Feedback deleted."),tt()};function co(e){const t=Array.from({length:5},(a,i)=>i<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),a=Object.fromEntries(t.entries()),i={code:a.code.toUpperCase(),discount_type:a.discount_type,discount_value:parseFloat(a.discount_value),min_amount:a.min_amount?parseFloat(a.min_amount):null,usage_limit:a.usage_limit?parseInt(a.usage_limit):null,expires_at:a.expires_at||null,is_active:!0},{error:n}=await g.from("coupons").insert(i);if(n){m(n.message,"error");return}m("Coupon created!"),ce(),kt()};window.toggleCoupon=async function(e,t){await g.from("coupons").update({is_active:t}).eq("id",e),m(t?"Coupon activated":"Coupon deactivated"),kt()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await g.from("coupons").delete().eq("id",e),m("Coupon deleted"),kt())};async function uo(){const e=document.getElementById("content");try{const{data:t}=await g.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),a=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}const hi=["Featured","Sponsored","Featured Collection","Discover","Promotion"],po=[{id:"real-estate",name:"Real Estate & Properties"},{id:"marketplace",name:"Marketplace Showroom"}];let ot=null;function mo(e){const t={Featured:"bg-blue-500/10 text-blue-300 border-blue-500/30",Sponsored:"bg-violet-500/10 text-violet-300 border-violet-500/30","Featured Collection":"bg-amber-500/10 text-amber-300 border-amber-500/30",Discover:"bg-emerald-500/10 text-emerald-300 border-emerald-500/30",Promotion:"bg-blue-500/10 text-blue-300 border-blue-500/30"};return`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${t[e]||t.Featured}">${s(e)}</span>`}function go(e){return!e||!e.link_type||e.link_type==="none"?'<span class="text-[10px] text-gray-500">No link</span>':e.link_type==="product"?`<span class="text-[10px] text-blue-300"><i data-lucide="package" class="w-3 h-3 inline mr-1"></i>Product Â· ${s(e.link_target||"")}</span>`:e.link_type==="category"?`<span class="text-[10px] text-emerald-300"><i data-lucide="tag" class="w-3 h-3 inline mr-1"></i>Category Â· ${s(e.link_target||"")}</span>`:`<span class="text-[10px] text-amber-300"><i data-lucide="layout-grid" class="w-3 h-3 inline mr-1"></i>Section Â· ${s(e.link_target||"")}</span>`}function bo(e){return e.video_url?`<video src="${s(e.video_url)}" ${e.poster_url?`poster="${s(e.poster_url)}"`:""} class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" muted preload="metadata"></video>`:e.image_url?`<img src="${s(e.image_url)}" class="w-24 h-14 rounded-lg object-cover border border-blue-500/20 shrink-0" onerror="this.remove()">`:'<div class="w-24 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center shrink-0"><i data-lucide="megaphone" class="w-6 h-6 text-blue-400"></i></div>'}async function vi(){if(ot)return ot;const e=[],t=new Set,a=[],i=o=>{if(!o||!o.property_id)return;e.push({id:o.property_id,title:o.title||o.property_id});const r=o.category||"";r&&!t.has(r)&&(t.add(r),a.push(r))};try{ie.forEach(i)}catch{}try{const{data:o,error:r}=await g.from("showroom_listings").select("property_id,title,category").order("created_at",{ascending:!1});!r&&o&&o.forEach(i)}catch{}return["Women","Men","Kids","Home","Sports","Jewellery","Electronics","Cars","Motorcycles","Phones","Computers","Furniture","Beauty","Fashion","Real Estate","Bicycles","Trucks","Land","Kitchen","Food","Pets","Books","Toys","Services"].forEach(o=>{t.has(o)||(t.add(o),a.push(o))}),ot={products:e,categories:a,sections:po},ot}async function yo(e){try{const{data:{session:t}}=await g.auth.getSession();if(!t)return m("Sign in to upload media","error"),null;const a=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=/^(mp4|webm|mov|m4v)$/.test(a)||e.type.startsWith("video/"),n=`ads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${a}`,{error:o}=await g.storage.from("advertisements").upload(n,e,{contentType:e.type,upsert:!1});if(o)return m("Upload failed: "+o.message,"error"),null;const{data:r}=g.storage.from("advertisements").getPublicUrl(n);return{url:r.publicUrl,isVideo:i}}catch{return m("Upload failed","error"),null}}function mt(e,t){const a=document.getElementById("ad-media-preview");if(!a)return;const i=document.getElementById("ad-hidden-video"),n=document.getElementById("ad-hidden-image");i&&(i.value=t?e:""),n&&(n.value=t?"":e),a.innerHTML=t?`<video src="${s(e)}" class="w-full h-40 object-cover rounded-xl" controls muted playsinline></video>`:`<img src="${s(e)}" class="w-full h-40 object-cover rounded-xl">`,window.lucide&&lucide.createIcons()}window.onAdMediaPicked=async function(e){const t=e.files&&e.files[0];if(!t)return;if(!(t.type.startsWith("image/")||t.type.startsWith("video/"))){m("Choose an image or video file","error");return}const i=await yo(t);if(!i){e.value="";return}mt(i.url,i.isVideo);const n=document.getElementById("ad-media-url");n&&(n.value=i.url)};window.onAdMediaUrl=function(e){const t=(e.value||"").trim();if(!t)return;const a=/\.(mp4|webm|mov|m4v)(\?.*)?$/i.test(t);mt(t,a)};function ca(e,t,a){const i=document.getElementById("ad-link-target-wrap");if(!i)return;if(!t||t==="none"){i.innerHTML='<p class="text-[10px] text-gray-500">This ad is informational and will not be clickable.</p>';return}let n="";t==="product"?n='<option value="">Select a productâ€¦</option>'+e.products.map(o=>`<option value="${s(o.id)}" ${String(a)===String(o.id)?"selected":""}>${s(o.id)} â€” ${s((o.title||"").slice(0,60))}</option>`).join(""):t==="category"?n='<option value="">Select a categoryâ€¦</option>'+e.categories.map(o=>`<option value="${s(o)}" ${a===o?"selected":""}>${s(o)}</option>`).join(""):t==="section"&&(n='<option value="">Select a sectionâ€¦</option>'+e.sections.map(o=>`<option value="${s(o.id)}" ${a===o.id?"selected":""}>${s(o.name)}</option>`).join("")),i.innerHTML=`<label class="lbl">Target</label><select class="input-field" name="link_target">${n}</select>`}function wi(e){return`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
          ...
          <div class="form-grid form-grid-2">
            ...
            <div><label class="lbl">Ad Label</label>
              <select class="input-field" name="ad_label">
                ${hi.map(t=>`<option value="${t}" ${e&&e.ad_label===t?"selected":""}>${t}</option>`).join("")}
              </select>
            </div>
          </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}window.renderAds=qe;const St=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],le={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function xi(){const e=document.getElementById("content");try{let t=function(o){const r=n===o.id,l=i[o.kf],d=i[o.mf]||o.dm;return`
...
${a.text}`}catch(a){t.textContent=`✖ ${a.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const a=(n,o,r,l)=>`
    ...
    </div>`}function ki(e){return(e||[]).map((t,a)=>{const i=String(t&&t.buttonText||"SHOP NOW"),n=wo.map(o=>`<button type="button" onclick="heroVideoPreset(${a},'${o}')" class="px-2.5 py-1 rounded-full text-[9px] font-black ${i===o?"bg-indigo-600 text-white":"bg-white/5 text-gray-400"} border ${i===o?"border-indigo-500":"border-white/10"} transition">${o}</button>`).join("");return`
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const a=document.createElement("input");a.type="file",a.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",a.onchange=()=>{const i=a.files&&a.files[0];i&&ko(e,t,i)},a.click()};window.heroVideoField=function(e,t,a){const i=se();i[e]&&(i[e][t]=a,at())};window.heroVideoPreset=function(e,t){const a=se();a[e]&&(a[e].buttonText=t,Ie())};window.heroVideoToggle=function(e){const t=se();t[e]&&(t[e].enabled=t[e].enabled===!1,Ie())};window.heroVideoMove=function(e,t){const a=se(),i=e+t;i<0||i>=a.length||([a[e],a[i]]=[a[i],a[e]],Ie())};window.heroVideoDelete=function(e){const t=se();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),Ie())};window.heroVideoRemoveMedia=function(e,t){const a=se();a[e]&&(t==="video"?a[e].video="":t==="poster"&&(a[e].poster=""),Ie())};window.addHeroVideoSlide=function(){se().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),Ie(),m("New slide added â€” upload a video and press Save to show it.","info")};async function _o(e,t){try{const{data:{session:a}}=await g.auth.getSession();if(!a)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const i=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${i}`,{error:o}=await g.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(o)return{url:URL.createObjectURL(e),persisted:!1,error:o.message};const{data:r}=g.storage.from("product-images").getPublicUrl(n),l=r&&r.publicUrl;return l?{url:l,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(a){return{url:URL.createObjectURL(e),persisted:!1,error:String(a&&a.message||a)}}}function Ea(e){return/^blob:/i.test(String(e||""))}async function ko(e,t,a){const i=se();if(!a||!i[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(a.type+" "+a.name)){m("Please choose an MP4 or WebM video file.","error");return}}else if(!a.type.startsWith("image/")){m("Please choose an image for the poster.","error");return}m("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await _o(a,t);t==="video"?i[e].video=n.url:i[e].poster=n.url,Ie(),n.persisted?m("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):m("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function So(e){const t=Array.isArray(e)?e.map(i=>({...i})):[];return window._heroVideoDraft=t,at(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${ua.map(i=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${i.key==="hero_videos"?So(a.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${i.fields.map(n=>`
                  <div class="${n.type==="textarea"||n.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${n.type==="textarea"?`<textarea id="cs-${n.key}" name="${n.key}" rows="3" class="input-field w-full" placeholder="Enter the current wordingâ€¦">${s(a[n.key]||"")}</textarea>`:n.type==="media"?_i(n,a[n.key]||""):n.type==="checkbox"?"":`<input id="cs-${n.key}" type="text" name="${n.key}" value="${s(a[n.key]||"")}" class="input-field w-full" placeholder="Enter the current wordingâ€¦">`}
      ...
      </div>`,window.lucide&&lucide.createIcons(),ei(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function Eo(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
...
Each code works once. Store securely.`],{type:"text/plain"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="kco-admin-backup-codes.txt",a.click()};window.regenerateBackupCodes=async function(){if(!confirm("This will invalidate ALL existing backup codes. Continue?"))return;const e=$i(10);await g.from("admin_2fa").update({backup_codes:e}).eq("user_id",I.user.id),m("New backup codes generated"),Ei(e.map(t=>t.code)),$t()};window.disable2FA=async function(){if(confirm("Disable two-factor authentication? Your account will be less secure."))try{const{data:e}=await g.auth.mfa.listFactors(),t=(e?.totp||[])[0];if(t){const{error:a}=await g.auth.mfa.unenroll({factorId:t.id});if(a)throw a}await g.from("admin_2fa").update({enabled:!1}).eq("user_id",I.user.id),await de(I.user.id,"2fa_disabled"),m("2FA has been disabled"),$t()}catch(e){m(e.message,"error")}};async function Ao(){const e=document.getElementById("content");try{const{data:t}=await g.from("admin_activity_logs").select("*").order("created_at",{ascending:!1}).limit(100);e.innerHTML=`
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${s(t.message)}</div>`)}}async function Co(){const e=document.getElementById("content");try{const{data:t}=await g.from("deployment_history").select("*").order("created_at",{ascending:!1}).limit(20);e.innerHTML=`
      <div class="space-y-5 fade-in">
...
`),i=new Blob([t+`
`+a],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(i),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),m("Orders exported!")};async function Io(){const e=document.getElementById("content"),{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),a=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
        ...
        </div>`};const{data:a}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i=a||{},n=i.brand_name||i.site_name||Oa,o=i.brand_slogan||i.site_tagline||ja,r=i.brand_logo||i.brand_header_logo||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(a){t&&(t.innerHTML=`<div class="p-6 text-red-400">${s(a.message)}</div>`)}}function To(e,t){const a=e.key+"_bg_image",i=e.key+"_bg_video",n=t[a]||"",o=t[i]||"",r=!!(n&&n.trim()),l=!!(o&&o.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
    ...
    </div>`,ma(),window.lucide&&lucide.createIcons())};window.addManualPaymentAccount=function(){window._manualPaymentAccounts.push(pa()),renderManualPaymentAccountsEditor()};window.removeManualPaymentAccount=function(e){window._manualPaymentAccounts.splice(e,1),window._manualPaymentAccounts.length||(window._manualPaymentAccounts=[pa()]),renderManualPaymentAccountsEditor()};window.updateManualPaymentAccount=function(e,t,a){const i=window._manualPaymentAccounts[e];i&&(i[t]=a,t==="currency"&&(i.currencyName=a),ma())};window.updateManualPaymentCountry=function(e,t){const a=window._manualPaymentAccounts[e];if(!a)return;const i=Ee.find(n=>n.code===t);a.country_code=t,a.country=i?.name||"",a.flag=i?.flag||Jt(t),ma(),renderManualPaymentAccountsEditor()};async function Wt(){const e=document.getElementById("content");e&&(e.innerHTML=Oe());try{const{data:t}=await g.from("site_settings").select("*").limit(1).maybeSingle(),i={...Yi()||{},...t||{}};window._manualPaymentAccounts=Zi(i).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${s(en(i))}</textarea>
              </div>
              <div>
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          <div class="flex items-center gap-3 p-3 rounded-xl border ${h?"border-red-500/25 bg-red-500/5":"border-white/10 bg-white/[0.02]"}">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] text-gray-500 truncate">${s(y.property_id)} Â· ${s(y.subcategory||y.category||"")} Â· ${Ha(y.price,"USD")}</p>
            </div>
            ${Y(!h)}
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',u=n?1:Math.max(1,Math.ceil(i/Ci)),p=`
    <div class="flex flex-wrap items-center justify-between gap-3">
    ...
    <div class="space-y-4 fade-in">
      ...
      ${p}
    </div>`,window.lucide&&lucide.createIcons()}window.catalogSetCategory=function(e){V.category=e,V.page=0,V.query="",He()};window.catalogSearch=function(){const e=document.getElementById("catalog-search-input");V.query=e?e.value:"",V.page=0,He()};window.catalogPage=function(e){const a=V.query.trim()?1:Math.max(1,Math.ceil(0/Ci));V.page=Math.max(0,Math.min(a-1,V.page+e)),He()};window.catalogToggle=async function(e){const t=!ft().includes(e),a=await Ue(e,t);m(t?"Listing hidden from storefront":"Listing restored",a.ok?"success":"info"),He()};window.catalogResetHidden=async function(){await Li(),m("All hidden catalog listings restored"),He()};(function(){if(!(!window.history||!window.history.pushState)){try{window.history.replaceState({adminGuard:1},document.title,window.location.href),window.history.pushState({adminGuard:2},document.title,window.location.href)}catch{return}window.addEventListener("popstate",function(t){t.state&&t.state.adminGuard===1&&window.location.replace("/")})}})();async function Aa(){window.lucide&&lucide.createIcons(),Ga(),await hn(),g.auth.onAuthStateChange((e,t)=>{if(e==="SIGNED_OUT"){I.user=null;const a=document.getElementById("login-screen");a&&(a.style.display="flex")}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Aa):Aa();
