import"./modulepreload-polyfill-B5Qt9EMX.js";import{_ as Ci,S as me}from"./showroom-data-A4bpNOne.js";import{supabase as b}from"./supabase-client-DSkAnHxH.js";import{a as On,g as Hn,C as $e}from"./country-data-BSZ5lE1h.js";import{A as Gn}from"./localization-DSfm6ZR4.js";import{patchLocalShowroomListing as Ea,getLocalShowroomListingById as nt,removeLocalShowroomListing as Pt,upsertLocalShowroomListing as Ht,listLocalShowroomListings as Qt}from"./local-showroom-store-mzP0nSoS.js";import{g as Ga,s as Vn,l as Wn,a as zn}from"./payment-settings-CY7Uu-Al.js";import{P as Ii,a as Ti,T as Li,M as Ri}from"./motorhome-data-CupbOvk0.js";import{getCatalogCategories as Kn}from"./catalog-CscHt5xx.js";import{i as Yn}from"./promo-backgrounds-0aFb_Jov.js";import{i as Mi,D as Jn}from"./site-content-C13tzFOn.js";import{M as Qn,n as Xn,a as Zn}from"./categories-DacF4t8X.js";import{l as Xt,v as Zt,a as Bi,b as Ni}from"./video-frames-q6gaiMMW.js";import{saveCatalogHidden as ct,loadHiddenCatalogIds as Va,getHiddenCatalogIds as ea,resetHiddenCatalogIds as es}from"./catalog-hidden-store-Br-Df_3h.js";/* empty css                                       */const U=1,Y=5e6,ts=[{id:"prod-smartphone",listingType:"product",category:"Phones",subcategory:"Smartphones",label:"Flagship Smartphone",brand:"Global Mobile",model:"X Pro",color:"Midnight Black",size:"6.7-inch",condition:"New",features:["5G connectivity","OLED display","Fast charging","Unlocked","Premium cameras"],highlights:["Retail-ready packaging","Strong search demand","Ideal for global shipping"],keywords:["smartphone","mobile phone","5g"],descriptionType:"phone"},{id:"prod-laptop",listingType:"product",category:"Computers & Laptops",subcategory:"Laptops",label:"Performance Laptop",brand:"NorthBridge",model:"Studio 14",color:"Silver",size:"14-inch",condition:"New",features:["Fast processor","SSD storage","Long battery life","Portable chassis","Business-ready design"],highlights:["Suitable for work and study","Premium margin band","Global audience appeal"],keywords:["laptop","notebook","computer"],descriptionType:"laptop"},{id:"prod-tv",listingType:"product",category:"Electronics",subcategory:"Smart TVs",label:"4K Smart TV",brand:"VistaHome",model:"UltraView",color:"Black",size:"65-inch",condition:"New",features:["4K panel","Streaming apps","HDR support","Voice control","Slim bezel"],highlights:["Living-room centerpiece","Popular premium electronics segment"],keywords:["tv","smart tv","home electronics"],descriptionType:"electronics"},{id:"prod-watch",listingType:"product",category:"Watches",subcategory:"Luxury Watches",label:"Luxury Wristwatch",brand:"Aurelius",model:"Chrono 8",color:"Gold / Black",size:"42mm",condition:"New",features:["Precision movement","Premium case","Gift-ready presentation","Water resistance","Collector appeal"],highlights:["High perceived value","Strong gifting category"],keywords:["watch","luxury watch","timepiece"],descriptionType:"luxury"},{id:"prod-jewelry",listingType:"product",category:"Jewelry",subcategory:"Fine Jewelry",label:"Fine Jewelry Set",brand:"Maison Valeur",model:"Signature Set",color:"Gold",size:"Adjustable",condition:"New",features:["Premium finish","Gift packaging","Occasion-ready","Elegant styling"],highlights:["High-value presentation","Wedding and celebration demand"],keywords:["jewelry","necklace","bracelet"],descriptionType:"luxury"},{id:"prod-handbag",listingType:"product",category:"Bags & Accessories",subcategory:"Designer Bags",label:"Designer Handbag",brand:"Rue Maison",model:"Carry All",color:"Tan",size:"Medium",condition:"New",features:["Structured silhouette","Premium hardware","Travel-friendly storage","Retail-ready finish"],highlights:["Fashion-forward listing","Broad international demand"],keywords:["handbag","designer bag","accessories"],descriptionType:"fashion"},{id:"prod-sneakers",listingType:"product",category:"Shoes",subcategory:"Premium Sneakers",label:"Premium Sneakers",brand:"RunNorth",model:"Air Flex",color:"White",size:"EU 42",condition:"New",features:["Comfort cushioning","Streetwear styling","Durable outsole","Daily wear ready"],highlights:["High-conversion category","Easy multi-country merchandising"],keywords:["sneakers","shoes","fashion"],descriptionType:"fashion"},{id:"prod-sofa",listingType:"product",category:"Furniture",subcategory:"Living Room",label:"Luxury Sofa Set",brand:"Grand Habitat",model:"Residence 3-Piece",color:"Sand Beige",size:"3-Piece Set",condition:"New",features:["Premium upholstery","Statement living-room piece","Comfort seating","Interior-ready styling"],highlights:["Large-ticket home category","Ideal for premium households"],keywords:["sofa","furniture","living room"],descriptionType:"home"},{id:"prod-generator",listingType:"product",category:"Home & Kitchen",subcategory:"Power Solutions",label:"Backup Power Generator",brand:"VoltWorks",model:"SilentMax",color:"Graphite",size:"7.5kVA",condition:"New",features:["Reliable backup power","Low-noise housing","Residential and business use","Heavy-duty build"],highlights:["Practical high-demand utility item","Useful in many markets"],keywords:["generator","power","backup power"],descriptionType:"industrial"},{id:"prod-drone",listingType:"product",category:"Cameras & Photography",subcategory:"Drones",label:"Pro Camera Drone",brand:"SkyFrame",model:"Aerial 4K",color:"Gray",size:"Foldable",condition:"New",features:["4K stabilized video","GPS return home","Portable folding frame","Creator-ready footage"],highlights:["Strong visual listing appeal","Premium creator equipment"],keywords:["drone","camera drone","aerial"],descriptionType:"electronics"},{id:"prod-grocery",listingType:"product",category:"Food & Groceries",subcategory:"Family Essentials",label:"Family Grocery Bundle",brand:"Market Select",model:"Household Pack",color:"Mixed",size:"Bulk Pack",condition:"New",features:["Everyday essentials","Bulk value","Family sized","Easy repeat orders"],highlights:["Fast-moving everyday goods","Useful across broad regions"],keywords:["groceries","food bundle","household essentials"],descriptionType:"daily"},{id:"prod-scale-house",listingType:"product",category:"Home & Kitchen",subcategory:"Model Houses",label:"Architectural Model House",brand:"Studio Form",model:"Estate Miniature",color:"Natural Wood",size:"1:50 Scale",condition:"New",features:["Collector display piece","Detailed craftsmanship","Interior decor appeal","Gift-ready packaging"],highlights:["Supports the model-house use case","Works for decor and collector audiences"],keywords:["model house","architectural model","collector decor"],descriptionType:"home"},{id:"veh-sedan",listingType:"product",category:"Cars",subcategory:"Sedans",label:"Executive Sedan",brand:"Summit Motors",model:"S Line",color:"Pearl White",size:"Mid-size",condition:"Used - Like New",features:["Comfortable cabin","Road-trip ready","Well-maintained presentation","Family and executive appeal"],highlights:["Vehicle posts support 24-image galleries","Map-ready listing"],keywords:["car","sedan","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-suv",listingType:"product",category:"Cars",subcategory:"SUVs",label:"Family SUV",brand:"Frontier Auto",model:"Terrain X",color:"Obsidian",size:"7-Seater",condition:"Used - Like New",features:["Spacious seating","Utility-focused cargo room","Suitable for families","Road and city versatility"],highlights:["High-demand automotive segment","Works well with showroom map"],keywords:["suv","family car","vehicle"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-luxury",listingType:"product",category:"Luxury Cars",subcategory:"Luxury Vehicles",label:"Luxury Performance Car",brand:"Regal Automotive",model:"Imperium GT",color:"Metallic Black",size:"Coupe",condition:"Used - Like New",features:["Prestige brand positioning","Performance styling","Collector-level appeal","Premium interior"],highlights:["Supports the requested high-ticket range","Designed for showroom-style luxury listings"],keywords:["luxury car","sports car","supercar"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-motorcycle",listingType:"product",category:"Motorcycles",subcategory:"Street Bikes",label:"Sport Motorcycle",brand:"Velocity Moto",model:"R 900",color:"Red",size:"900cc",condition:"Used - Like New",features:["Agile handling","Performance design","Lifestyle buyer appeal","Weekend-ready machine"],highlights:["Automotive category with image-rich display"],keywords:["motorcycle","bike","sport bike"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-commercial",listingType:"product",category:"Commercial Vehicles",subcategory:"Utility Vehicles",label:"Commercial Utility Vehicle",brand:"FleetCore",model:"CargoPro",color:"White",size:"Long wheelbase",condition:"Used - Good",features:["Business-ready load space","Fleet-friendly purchase","Service history presentation","Commercial utility"],highlights:["Suitable for business buyers","Map-ready logistics listing"],keywords:["commercial vehicle","cargo van","fleet"],requiredImageCount:24,descriptionType:"vehicle"},{id:"veh-boat",listingType:"product",category:"Boats & Marine",subcategory:"Leisure Boats",label:"Leisure Boat",brand:"BlueHarbor",model:"Coastline 28",color:"Navy / White",size:"28 ft",condition:"Used - Like New",features:["Marina-ready presentation","Leisure and charter appeal","Premium leisure category"],highlights:["Large-format gallery support","High-ticket recreational listing"],keywords:["boat","marine","yacht"],requiredImageCount:24,descriptionType:"vehicle"}],as=[{id:"prop-apartment",listingType:"property",category:"Real Estate",subcategory:"Apartments",label:"City Apartment",propertyType:"Apartment",bedrooms:2,bathrooms:2,buildingSize:"1,150 sqft",landSize:"",furnished:"Furnished",features:["Secure access","Modern kitchen","Prime urban access","Balcony or city views"],highlights:["Strong urban demand","Good for short and long stay buyers"],keywords:["apartment","real estate","city home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-condo",listingType:"property",category:"Real Estate",subcategory:"Condos",label:"Modern Condo",propertyType:"Condo",bedrooms:3,bathrooms:2,buildingSize:"1,450 sqft",landSize:"",furnished:"Furnished",features:["Managed building","Amenity access","Contemporary finish","Secure parking"],highlights:["Works across major global markets"],keywords:["condo","property","home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-townhouse",listingType:"property",category:"Real Estate",subcategory:"Townhouses",label:"Townhouse Residence",propertyType:"Townhouse",bedrooms:4,bathrooms:3,buildingSize:"2,000 sqft",landSize:"0.08 acres",furnished:"Unfurnished",features:["Multi-level layout","Family-ready plan","Private entry","Parking included"],highlights:["Popular residential ownership format"],keywords:["townhouse","residence","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-villa",listingType:"property",category:"Real Estate",subcategory:"Villas",label:"Private Villa",propertyType:"Villa",bedrooms:5,bathrooms:5,buildingSize:"4,800 sqft",landSize:"0.4 acres",furnished:"Furnished",features:["Private outdoor space","Premium architecture","Luxury entertaining zones","Prestige location potential"],highlights:["Premium property tier","Designed for international buyers"],keywords:["villa","luxury property","real estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-mansion",listingType:"property",category:"Real Estate",subcategory:"Mansions",label:"Luxury Mansion",propertyType:"Mansion",bedrooms:8,bathrooms:10,buildingSize:"12,000 sqft",landSize:"1.2 acres",furnished:"Furnished",features:["Grand entrance","High-end interior finishes","Staff or guest quarters","Statement curb appeal"],highlights:["Matches the mansion requirement directly","Supports high-ticket luxury listings"],keywords:["mansion","estate","luxury home"],requiredImageCount:24,descriptionType:"property"},{id:"prop-beach",listingType:"property",category:"Real Estate",subcategory:"Beach Houses",label:"Beachfront House",propertyType:"Beach House",bedrooms:4,bathrooms:4,buildingSize:"3,600 sqft",landSize:"0.25 acres",furnished:"Furnished",features:["Waterfront views","Outdoor leisure space","Vacation-rental appeal","Premium lifestyle positioning"],highlights:["Ideal for tourism and lifestyle markets"],keywords:["beach house","waterfront home","property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-farm",listingType:"property",category:"Real Estate",subcategory:"Farm Houses",label:"Farm House Estate",propertyType:"Farm House",bedrooms:4,bathrooms:3,buildingSize:"3,100 sqft",landSize:"5 acres",furnished:"Unfurnished",features:["Land-rich asset","Agricultural potential","Quiet residential use","Outbuilding opportunity"],highlights:["Suitable for rural and suburban regions"],keywords:["farm house","landed property","estate"],requiredImageCount:24,descriptionType:"property"},{id:"prop-commercial",listingType:"property",category:"Real Estate",subcategory:"Commercial Buildings",label:"Commercial Building",propertyType:"Commercial Building",bedrooms:0,bathrooms:4,buildingSize:"8,500 sqft",landSize:"0.35 acres",furnished:"Unfurnished",features:["Business district potential","Mixed-use flexibility","Visible frontage","Investor-ready asset class"],highlights:["Attractive for business buyers and investors"],keywords:["commercial building","office","investment property"],requiredImageCount:24,descriptionType:"property"},{id:"prop-hotel",listingType:"property",category:"Real Estate",subcategory:"Hotels",label:"Boutique Hotel",propertyType:"Hotel",bedrooms:18,bathrooms:20,buildingSize:"15,000 sqft",landSize:"0.75 acres",furnished:"Furnished",features:["Hospitality-ready layout","Guest-focused amenities","Tourism and corporate appeal","Revenue asset potential"],highlights:["Supports hospitality listings globally"],keywords:["hotel","hospitality","investment"],requiredImageCount:24,descriptionType:"property"},{id:"prop-land",listingType:"property",category:"Real Estate",subcategory:"Land",label:"Development Land",propertyType:"Land",bedrooms:0,bathrooms:0,buildingSize:"",landSize:"10 acres",furnished:"",features:["Development potential","Flexible use case","Long-term investment appeal","Location-led value"],highlights:["Useful for land banking and development"],keywords:["land","plot","development"],requiredImageCount:24,descriptionType:"property"}],Fi=[...ts,...as];function st(e){return On[e]||"USD"}function Di(e,t){return Fi.filter(i=>i.listingType!==e?!1:t?i.category===t:!0)}function is(e,t){const i=Math.max(U,Math.min(Y,Number(e)||U));return new Intl.NumberFormat("en-US",{style:"currency",currency:t,maximumFractionDigits:0}).format(i)}function ns(e,t,i,a,n){const s=is(a,i);return e.descriptionType==="vehicle"?`${e.label} listed at ${s}. This template is intended to present a complete automotive post with exterior, interior, condition, performance, and gallery details in a clean showroom-style format.`:e.descriptionType==="property"?`${e.label} located in ${n}. Offered at ${s}, this property template is designed for a complete real-estate presentation with map-ready location data, rich visual gallery coverage, and buyer-friendly highlights covering layout, lifestyle, and investment value.`:e.descriptionType==="phone"?`${e.label} listed at ${s}. The template focuses on a clean premium device presentation with brand, model, condition, core features, and strong online merchandising copy.`:e.descriptionType==="laptop"?`${e.label} listed at ${s}. Built for marketplace listings that need clear performance positioning, specification highlights, and an easy-to-scan description for students, professionals, and remote workers.`:e.descriptionType==="luxury"?`${e.label} listed at ${s}. This template supports high-value presentation with polished positioning, premium selling points, and a strong showroom-style description.`:e.descriptionType==="fashion"?`${e.label} listed at ${s}. This product template highlights styling, quality, and day-to-day appeal while keeping the listing easy to customize.`:e.descriptionType==="home"?`${e.label} listed at ${s}. The listing copy is structured for shoppers looking for quality presentation, reliable detail, and visual merchandising support.`:e.descriptionType==="industrial"?`${e.label} listed at ${s}. This template emphasizes practical use, dependable performance, and business or household value in a straightforward format.`:e.descriptionType==="daily"?`${e.label} listed at ${s}. The copy is designed for repeat-buy categories with clear value messaging and broad buyer appeal.`:`${e.label} listed at ${s}. This template generates a clean, marketable listing with ready-made highlights, keywords, and presentation details.`}function Ui({templateId:e,listingType:t,category:i,countryCode:a,currency:n,price:s}){const o=Fi.find(m=>m.id===e&&m.listingType===t);if(!o)return null;const r=Hn(a)||$e[0],l=n||st(r.code),d=[r.name].filter(Boolean).join(", "),u={category:o.category||i||(t==="property"?"Real Estate":"Other"),subcategory:o.subcategory||o.label,title:t==="property"?`${o.label} in ${r.name}`:o.label,description:ns(o,r,l,s,d),currency:l,features:[...o.features],highlights:[...o.highlights||[]],seo_keywords:[...new Set([o.category,o.subcategory,o.label,...t==="property"?[r.name]:[],...o.keywords||[]].filter(Boolean))],requiredImageCount:o.requiredImageCount||0};return t==="property"?{...u,country:r.name,country_code:r.code,product_location:r.name,property_type:o.propertyType||o.label,bedrooms:o.bedrooms??null,bathrooms:o.bathrooms??null,building_size:o.buildingSize||"",land_size:o.landSize||"",furnished:o.furnished||""}:{...u,brand:o.brand||"",model:o.model||"",color:o.color||"",size:o.size||"",condition:o.condition||"New"}}let xa=null;async function ss(){return xa||(xa=Ci(()=>import("./pdf-ksa_hnld.js"),[]).then(e=>{try{e.GlobalWorkerOptions.workerSrc=new URL("/assets/pdf.worker.min-yatZIOMy.mjs",import.meta.url).toString()}catch{}return e})),xa}function os(e,t){return e.toDataURL("image/jpeg",t)}async function rs(e,t){const i=e.getViewport({scale:1}),a=Math.min(3,Math.max(.5,t/Math.max(i.width,i.height))),n=e.getViewport({scale:a}),s=document.createElement("canvas");s.width=Math.max(1,Math.round(n.width)),s.height=Math.max(1,Math.round(n.height));const o=s.getContext("2d",{alpha:!1});return o.fillStyle="#ffffff",o.fillRect(0,0,s.width,s.height),await e.render({canvasContext:o,viewport:n}).promise,os(s,.78)}async function Wa(e,{maxDim:t=1300,maxPages:i=0,onProgress:a=()=>{}}={}){const s=await(await ss()).getDocument({url:e,useSystemFonts:!0,isEvalSupported:!1}).promise,o=s.numPages,r=i>0?Math.min(o,i):o,l=[];try{for(let d=1;d<=r;d++){a(d,r);const u=await s.getPage(d);l.push(await rs(u,t))}}finally{try{await s.destroy()}catch{}}return l}function Ke(e){const t=String(e||"").toLowerCase();return t.endsWith(".pdf")||t.includes(".pdf?")||t.includes(".pdf#")}const za="".replace(/\/$/,""),Aa=[{id:"overview",label:"Overview",icon:"layout-dashboard"},{id:"accounts",label:"Connected Accounts",icon:"link-2"},{id:"auto",label:"Automatic Posting",icon:"bot"},{id:"manual",label:"Manual Posting",icon:"pen-line"},{id:"schedule",label:"Posting Schedule",icon:"calendar-clock"},{id:"queue",label:"Content Queue",icon:"list-checks"},{id:"published",label:"Published Posts",icon:"check-circle-2"},{id:"failed",label:"Failed Posts",icon:"alert-triangle"},{id:"logs",label:"Post Logs",icon:"scroll-text"},{id:"platforms",label:"Platform Settings",icon:"settings-2"},{id:"apistatus",label:"API Connection Status",icon:"server"}];let Ut="overview";function k(e){if(e==null)return"";const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function C(e,t="success"){const i=document.getElementById("toast"),a=document.getElementById("toast-msg");if(!i||!a){alert(e);return}a.textContent=e;const n=i.querySelector("i[data-lucide]"),s={success:"check-circle",error:"alert-circle",info:"info"},o={success:"text-emerald-400",error:"text-red-400",info:"text-blue-400"};n&&(n.setAttribute("data-lucide",s[t]||"info"),n.className=`w-4 h-4 shrink-0 ${o[t]||"text-blue-400"}`),i.style.transform="translateY(0)",i.style.opacity="1",window.lucide&&lucide.createIcons(),clearTimeout(i._t),i._t=setTimeout(()=>{i.style.transform="translateY(20px)",i.style.opacity="0"},3200)}function ls(){return'<div class="flex items-center justify-center py-28"><div class="flex items-center gap-3 text-gray-400 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loading…</div></div>'}function we(e,t="inbox"){return`<div class="flex flex-col items-center justify-center py-16 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${t}" class="w-8 h-8 text-blue-400"></i></div><p class="text-sm text-gray-500 max-w-xs">${k(e)}</p></div>`}function Z(){if(window.lucide)try{lucide.createIcons()}catch{}}function Ee(e){return e?new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}async function ji(){const{data:e}=await b.auth.getSession();return e?.session?.access_token||""}async function Me(e,t={}){const a={authorization:`Bearer ${await ji()}`,"content-type":"application/json",...t.headers||{}},n=await fetch(`${za}${e}`,{...t,headers:a});let s={};try{s=await n.json()}catch{s={}}if(!n.ok)throw Object.assign(new Error(s?.error||`Request failed (HTTP ${n.status})`),{status:n.status,code:s.code});return s}async function cs(e){const t=(e.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),i=`uploads/${Date.now()}-${Math.random().toString(36).slice(2,8)}.${t}`,{error:a}=await b.storage.from("social-posts").upload(i,e,{contentType:e.type,upsert:!1,cacheControl:"3600"});if(a)throw a;const{data:n}=b.storage.from("social-posts").getPublicUrl(i),s=(e.type||"").startsWith("video/")||/\.(mp4|webm|mov|m4v)$/i.test(e.name);return{url:n.publicUrl,type:s?"video":"image"}}const re={tiktok:{label:"TikTok",icon:"music-2",tone:"text-white"},telegram:{label:"Telegram",icon:"send",tone:"text-sky-400"},facebook:{label:"Facebook Pages",icon:"thumbs-up",tone:"text-blue-400"},instagram:{label:"Instagram",icon:"camera",tone:"text-pink-400"},youtube:{label:"YouTube",icon:"youtube",tone:"text-red-400"},x:{label:"X (Twitter)",icon:"twitter",tone:"text-gray-300"},pinterest:{label:"Pinterest",icon:"pinterest",tone:"text-red-500"},linkedin:{label:"LinkedIn",icon:"linkedin",tone:"text-sky-500"},whatsapp:{label:"WhatsApp Channels",icon:"message-circle",tone:"text-emerald-400"}};function xe(e){return re[e]?.icon||"share-2"}function W(e){return re[e]?.label||e}function ds(e){const t={connected:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disconnected:"bg-gray-500/15 text-gray-300 border-gray-500/30",error:"bg-red-500/15 text-red-300 border-red-500/30",revoked:"bg-red-500/15 text-red-300 border-red-500/30",requires_approval:"bg-amber-500/15 text-amber-300 border-amber-500/30",expired:"bg-amber-500/15 text-amber-300 border-amber-500/30",not_connected:"bg-gray-500/10 text-gray-400 border-gray-500/20",draft:"bg-gray-500/15 text-gray-300 border-gray-500/30",scheduled:"bg-amber-500/15 text-amber-300 border-amber-500/30",queued:"bg-sky-500/15 text-sky-300 border-sky-500/30",publishing:"bg-violet-500/15 text-violet-300 border-violet-500/30",published:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",failed:"bg-red-500/15 text-red-300 border-red-500/30",cancelled:"bg-gray-500/10 text-gray-400 border-gray-500/20",paused:"bg-amber-500/15 text-amber-300 border-amber-500/30",enabled:"bg-emerald-500/15 text-emerald-300 border-emerald-500/30",disabled:"bg-gray-500/15 text-gray-400 border-gray-500/25"};return t[e]||t.not_connected}function et(e){return`<span class="badge ${ds(e)}">${k(e.replace(/_/g," "))}</span>`}function Pa(e="overview"){Ut=Aa.find(i=>i.id===e)?e:"overview";const t=document.getElementById("content");t.innerHTML=`
    <div class="space-y-4 fade-in">
      ...
      <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-thin">
        ${Aa.map(i=>`<button onclick="window.socialNav('${i.id}')" class="tab-btn ${Ut===i.id?"active":""}">${i.label}</button>`).join("")}
      </div>
      <div id="social-body"></div>
    </div>`,Z(),ta(Ut)}window.socialNav=async function(e){Ut=e,document.querySelectorAll("#content .tab-btn").forEach((t,i)=>t.classList.toggle("active",Aa[i]?.id===e)),await ta(e)};async function ta(e){const t=document.getElementById("social-body");if(!t)return;t.innerHTML=ls(),Z(),await({overview:mi,accounts:Ct,auto:It,manual:Hi,schedule:fs,queue:Ka,published:vs,failed:xs,logs:ks,platforms:ia,apistatus:Cs}[e]||mi)(t)}async function Ye(){return await Me("/api/social/status")}let qi=null;async function mi(e){try{const t=await Ye();qi=t;const i=t.settings||{},a=await b.from("social_automation_rules").select("*").order("created_at",{ascending:!1}),n=await b.from("social_posts").select("*").order("created_at",{ascending:!1}).limit(300),o=(n.data||[]).filter(u=>u.status==="scheduled"||u.status==="queued"&&u.created_at).sort((u,m)=>new Date(u.scheduled_for||u.created_at)-new Date(m.scheduled_for||m.created_at))[0]||null,r=(n.data||[]).reduce((u,m)=>(u[m.status]=(u[m.status]||0)+1,u),{}),l=(t.accounts||[]).filter(u=>u.status==="connected"),d=!!(a.data||[]).some(u=>u.approval_mode==="manual"||u.enabled&&i.require_approval);e.innerHTML=`
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        ${Ce("bot",i.auto_posting_enabled?"ON":"OFF","Automatic Posting",i.auto_posting_enabled?"text-emerald-300":"text-gray-300")}
        ${Ce("power",i.automation_paused?"Paused":"Running","Automation Status",i.automation_paused?"text-amber-300":"text-emerald-300")}
      ...
      </div>`,Z(),e.querySelectorAll("#social-body")}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">Could not load overview: ${k(t.message)}</div>`}}function Ce(e,t,i,a){return`<div class="stat-card glass-soft border border-blue-500/15 rounded-3xl p-5">
    <div class="flex items-center gap-3 mb-2"><i data-lucide="${e}" class="w-5 h-5 ${a}"></i></div>
    <p class="text-3xl font-black text-white">${k(t)}</p>
    <p class="text-xs text-gray-500 uppercase tracking-wide mt-1 font-bold">${k(i)}</p>
  </div>`}async function Ct(e){try{const t=await Me("/api/social/accounts"),a=(await Ye()).platforms||[],n=t.accounts||[];e.innerHTML=`
      <div class="space-y-3">
        <div class="flex items-center justify-between flex-wrap gap-2">
          ...
          <div class="flex gap-2">
            <select id="acct-filter" onchange="window.socialAccountsFilter()" class="input-field !w-44 !py-2 !px-3 !text-xs">
              ...
              ${a.map(s=>`<option value="${s.id}">${k(s.label)}</option>`).join("")}
            </select>
        ...
        <div id="acct-grid" class="grid md:grid-cols-2 xl:grid-cols-3 gap-3">
          ${a.map(s=>us(s,n.find(o=>o.platform===s.id))).join("")}
        </div>
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}window.socialAccountsFilter=function(){const e=document.getElementById("acct-filter")?.value||"";document.querySelectorAll("#acct-grid > [data-platform]").forEach(t=>{t.style.display=!e||t.dataset.platform===e?"":"none"})};window.socialRefresh=()=>{Ct(document.getElementById("social-body"))};function us(e,t){const i=t?.status==="connected";return`
    <div data-platform="${e.id}" class="glass-soft border ${i?"border-emerald-500/25":"border-blue-500/15"} rounded-2xl p-4 space-y-3">
      <div class="flex items-start justify-between gap-2">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            ...
            <p class="text-[11px] text-gray-500 truncate">${i?k(t.accountName||t.display_name||"Connected"):"Not connected"}</p>
          </div>
        </div>
        ${i?et("connected"):e.configured?et("not_connected"):'<span class="badge bg-amber-500/15 text-amber-300 border-amber-500/30">setup needed</span>'}
      </div>
    ...
    </div>`}window.socialConnect=async function(e){try{const i=((await Ye()).platforms||[]).find(a=>a.id===e);if(!i?.configured){C("API credentials are not configured server-side.","error");return}if(i.usesOAuth){window.location.href=`${za}/api/social/oauth/start?platform=${encodeURIComponent(e)}`;return}await Me("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"connect",platform:e})}),C(`${W(e)} connected.`),Ct(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};window.socialValidate=async function(e){try{const t=await Me("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"validate",account_id:e})});C(t.note||"Connection is valid."),Ct(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};window.socialDisconnect=async function(e,t){if(confirm(`Disconnect your ${W(t)} account? Tokens will be wiped from the server.`))try{await Me("/api/social/accounts",{method:"POST",body:JSON.stringify({action:"disconnect",account_id:e})}),C(`${W(t)} disconnected.`),Ct(document.getElementById("social-body"))}catch(i){C(i.message,"error")}};window.socialReconnect=async function(e){window.socialConnect(e)};window.socialRunScheduler=async function(){try{const e=await ji(),t=localStorage.getItem("kco_cron_secret")||"",i=await fetch(`${za}/api/social/scheduler`,{method:"POST",headers:{"content-type":"application/json",...t?{"x-cron-secret":t}:{}},body:JSON.stringify({})}),a=await i.json().catch(()=>({}));if(!i.ok){C(a?.error||"Scheduler requires the admin secret (set SCHEDULER_CRON_SECRET).","error");return}C(`Scheduler tick complete · ${a.published??0} published · ${a.scheduledEnqueued??0} enqueued`),ta("overview")}catch(e){C(e.message,"error")}};let wt=[],ps={products:[],content:[],promos:[]};async function It(e){try{const i=(await Ye()).settings||{};wt=(await b.from("social_automation_rules").select("*").order("created_at",{ascending:!1})).data||[];const n=`
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
        ...
        <div class="grid sm:grid-cols-2 gap-3">
          ${_a("Master switch","When ON, the server picks content and posts automatically to connected accounts.","auto_posting_enabled",i.auto_posting_enabled,"window.socialToggleGlobal('auto_posting_enabled')")}
          ${_a("Pause all automation","Temporarily stops ALL automatic and scheduled publishing. Resume anytime.","automation_paused",i.automation_paused,"window.socialToggleGlobal('automation_paused')")}
          ${_a("Approve posts before publishing","Auto-generated posts stay in the Content Queue as drafts until you approve them.","require_approval",i.require_approval,"window.socialToggleGlobal('require_approval')")}
      ...
      </div>`;e.innerHTML=`${n}<div class="grid gap-4">${s}</div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}function _a(e,t,i,a,n){return`<div class="p-3 rounded-xl bg-white/[.03] border border-white/10 flex items-center justify-between gap-3">
    <div><p class="text-xs font-bold text-white">${k(e)}</p><p class="text-[11px] text-gray-500">${k(t)}</p></div>
    <label class="toggle-switch"><input type="checkbox" ${a?"checked":""} onchange="${n}"><span class="toggle-slider"></span></label>
  </div>`}window.socialToggleGlobal=async function(e){try{const t=qi?.settings||{},i={...t,[e]:!t[e]},{error:a}=await b.from("social_settings").upsert({id:1,...i});if(a)throw a;C(e==="automation_paused"?i[e]?"Automation paused.":"Automation resumed.":"Saved."),It(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};function ms(e){const t=e.enabled&&!e.paused?"enabled":e.paused?"paused":"disabled",i={products:"New products (auto-pick new arrivals)",selected_products:"Selected products",promotions:"Promotions",content_items:"News / articles (Content Items)"},a={mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S",sun:"S"},n=e.next_run_at?`Next run ${Ee(e.next_run_at)}`:"First run pending";return`
    <div data-rule="${e.id}" class="p-4 rounded-2xl bg-white/[.03] border border-white/10 space-y-3">
      <div class="flex items-start justify-between gap-2 flex-wrap">
        <div class="min-w-0">
          ...
          <p class="text-[11px] text-gray-500 mt-0.5">${k(i[e.content_type]||e.content_type)} · ${k((e.platforms||[]).map(W).join(", "))}</p>
        </div>
      ...
      <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-500">
        ...
        <span>${k((e.schedule_days||[]).length?(e.schedule_days||[]).map(s=>a[s]||s).join(" "):"daily")} ${k(e.schedule_time||"")}</span>
      </div>
    ...
    </div>`}function Oi(e){const t=e.schedule_time||"";return e.schedule_type==="hourly"?"hourly":e.schedule_type==="interval"?`every ${e.interval_hours||24}h`:e.schedule_type==="weekly"?"weekly":e.schedule_type==="custom"?"custom":`daily ${t}`}window.socialToggleRule=async function(e){const t=wt.find(a=>a.id===e);if(!t)return;let i;t.paused?i={paused:!1,enabled:!0}:t.enabled?i={enabled:!1}:i={enabled:!0,paused:!1},await b.from("social_automation_rules").update(i).eq("id",e),C("Rule updated."),It(document.getElementById("social-body"))};window.socialDeleteRule=async function(e){confirm("Delete this automation rule?")&&(await b.from("social_automation_rules").delete().eq("id",e),C("Rule deleted."),It(document.getElementById("social-body")))};window.socialRuleForm=async function(e){let t=wt.find(n=>n.id===e);t||(t={id:"",name:"",enabled:!1,platforms:[],content_type:"products",selected_ids:[],schedule_type:"daily",schedule_time:"09:00",schedule_days:["mon","tue","wed","thu","fri","sat","sun"],interval_hours:24,max_posts_per_day:1,approval_mode:"auto",caption_template:`{{title}}
{{price}}
{{link}}`,include_price:!0,include_link:!0,hashtags:"",paused:!1});let i="";try{const{data:n}=await b.from("showroom_listings").select("property_id,title,listing_type,is_active").eq("is_active",!0).limit(400);ps.products=n||[],i=n.map(s=>`<div class="flex items-center gap-2 p-2 rounded-lg hover:bg-white/5"><label class="flex items-center gap-2 text-xs text-gray-300 flex-1"><input type="checkbox" class="rule-sel" value="${k(s.property_id)}" ${(t.selected_ids||[]).includes(s.property_id)?"checked":""}><span class="truncate">${k(s.title)} ${s.listing_type==="property"?'<span class="text-amber-300">(property)</span>':""}</span></label></div>`).join("")}catch{i=""}const a=document.createElement("div");a.className="modal-overlay",a.innerHTML=`
      ...
      <div class="space-y-4 text-left max-h-[70vh] overflow-y-auto pr-1 scrollbar-thin">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div id="rule-selected-wrap" class="md:col-span-2 hidden">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 max-h-48 overflow-y-auto scrollbar-thin border border-white/10 rounded-xl p-2 bg-white/[.02]">${i||'<p class="text-xs text-gray-500 p-2">No active products found.</p>'}</div>
          </div>
...
{{link}}`)}</textarea><p class="text-[10px] text-gray-500 mt-1">Variables: {{title}} {{price}} {{category}} {{brand}} {{site}} {{link}}</p></div>
    ...
    </div>`,document.getElementById("modal-container").appendChild(a),socialRuleSchedChange(),socialRuleContentChange(),Z()};window.socialRuleSchedChange=function(){const e=document.getElementById("rule-sched")?.value||"daily",t=document.getElementById("sched-days-wrap"),i=document.getElementById("sched-interval-wrap"),a=document.getElementById("sched-time-wrap");t.style.display=e==="weekly"?"block":"none",i.style.display=e==="interval"?"block":"none",a.style.display=e==="hourly"||e==="interval"||e==="custom"||e==="weekly"?"none":"block",e==="weekly"&&(t.style.display="block")};window.socialRuleContentChange=function(){const e=document.getElementById("rule-content")?.value||"products";document.getElementById("rule-selected-wrap").classList.toggle("hidden",e!=="selected_products")};window.socialSaveRule=async function(e){try{const t=Array.from(document.querySelectorAll("#rule-platforms option:checked")).map(l=>l.value),i=Array.from(document.querySelectorAll(".rule-day:checked")).map(l=>l.value),a=Array.from(document.querySelectorAll(".rule-sel:checked")).map(l=>l.value);if(!t.length)return C("Select at least one platform.","error");const n=document.getElementById("rule-sched").value;let s=document.getElementById("rule-time")?.value||"09:00",o=Number(document.getElementById("rule-interval")?.value)||24;const r={name:document.getElementById("rule-name").value.trim()||"Automation rule",enabled:!1,paused:!1,platforms:t,content_type:document.getElementById("rule-content").value,selected_ids:a,schedule_type:n,schedule_time:s,schedule_days:n==="weekly"?i:["mon","tue","wed","thu","fri","sat","sun"],interval_hours:o,max_posts_per_day:Number(document.getElementById("rule-max").value)||1,approval_mode:document.getElementById("rule-approval").value,caption_template:document.getElementById("rule-caption").value||`{{title}}
{{price}}
{{link}}`,hashtags:document.getElementById("rule-hashtags").value.trim(),include_price:document.getElementById("rule-price").checked,include_link:document.getElementById("rule-link").checked,next_run_at:new Date().toISOString()};e?await b.from("social_automation_rules").update(r).eq("id",e):await b.from("social_automation_rules").insert(r),document.querySelector(".modal-overlay")?.remove(),C("Rule saved. Enable it when ready."),It(document.getElementById("social-body"))}catch(t){C(t.message,"error")}};let S={sourceType:"product",sourceId:"",caption:"",hashtags:"",platform:"",media:[],linkUrl:"",allowDuplicate:!1};async function Hi(e){try{const t=await Ye(),i=(t.platforms||[]).filter(l=>l.connected&&l.enabled),a=(t.accounts||[]).filter(l=>l.status==="connected"),{data:n}=await b.from("showroom_listings").select("property_id,title,category,price,currency,images,video_url,listing_type").eq("is_active",!0).limit(600),{data:s}=await b.from("promotions").select("id,title,image_url,video_url").eq("is_active",!0).limit(50),{data:o}=await b.from("social_content_items").select("*").order("created_at",{ascending:!1}).limit(50),{data:r}=await b.from("social_posts").select("*").eq("status","draft").order("created_at",{ascending:!1}).limit(40);S.platform=S.platform||i[0]?.id||"",S.sourceType=S.sourceType||(r?.length?"draft":"product"),e.innerHTML=`
      <div class="grid lg:grid-cols-3 gap-4">
        <div class="lg:col-span-1 glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
          ...
          <div id="mp-source-picker">${gs(S.sourceType,n,s,o,r)}</div>
      ...
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}function gs(e,t,i,a,n){return e==="product"?`<div class="grid grid-cols-2 gap-2 max-h-44 overflow-y-auto scrollbar-thin border border-white/10 rounded-xl p-2 bg-white/[.02]">
      ...
      ${(i||[]).map(s=>`<button data-pid="${k(s.id)}" onclick="window.socialPickPromo('${k(s.id)}', this)" class="btn-press w-full text-left p-2.5 rounded-lg text-[11px] text-gray-300 hover:bg-blue-500/10 transition border border-white/5">${k(s.title||s.id)}</button>`).join("")||'<p class="text-xs text-gray-500 p-2">No active promotions.</p>'}
    ...
    </div>`:`<p class="text-[11px] text-gray-500">Write a custom announcement — remember to comply with each platform's rules.</p>`}window.socialManualSource=function(){S.sourceType=document.getElementById("mp-source").value,S.caption="",S.linkUrl="",S.media=[],Hi(document.getElementById("social-body"))};window.socialPickProduct=function(e,t){b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle().then(({data:i})=>{if(!i)return;S.sourceId=e,S.linkUrl=`${window.location.origin}/product/${encodeURIComponent(e)}`;const a=Array.isArray(i.images)?i.images.filter(o=>/^https?:\/\//i.test(o)).slice(0,6).map(o=>({url:o,type:"image"})):[];i.video_url&&/^https?:\/\//i.test(i.video_url)&&a.push({url:i.video_url,type:"video"}),S.media=a;const n=i.currency||"USD",s=i.price!=null?`${Number(i.price).toLocaleString("en-US")} ${n}`:"";S.caption=`${i.title}
${s?`${s}
`:""}${S.linkUrl}`,document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne(),document.querySelectorAll("#mp-source-picker button").forEach(o=>{o.classList.remove("bg-blue-500/10","text-white","border-blue-500/30"),o.classList.add("border-transparent")}),t&&(t.classList.add("bg-blue-500/10","text-white","border-blue-500/30"),t.classList.remove("border-transparent"))})};window.socialPickPromo=function(e,t){b.from("promotions").select("*").eq("id",e).maybeSingle().then(({data:i})=>{i&&(S.sourceType="promo",S.sourceId=e,S.media=[],i.image_url&&/^https?:\/\//i.test(i.image_url)&&S.media.push({url:i.image_url,type:"image"}),i.video_url&&/^https?:\/\//i.test(i.video_url)&&S.media.push({url:i.video_url,type:"video"}),S.caption=i.title||"Special offer",document.getElementById("mp-caption").value=S.caption,Je(),Ne())})};window.socialPickContent=function(e,t){b.from("social_content_items").select("*").eq("id",e).maybeSingle().then(({data:i})=>{i&&(S.sourceType="content",S.sourceId=e,S.media=[],i.image_url&&/^https?:\/\//i.test(i.image_url)&&S.media.push({url:i.image_url,type:"image"}),i.video_url&&/^https?:\/\//i.test(i.video_url)&&S.media.push({url:i.video_url,type:"video"}),S.caption=`${i.title}
${i.body||""}`.trim(),S.linkUrl=i.link_url||"",document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne())})};window.socialLoadDraft=async function(e){const{data:t}=await b.from("social_posts").select("*").eq("id",e).maybeSingle();t&&(window.socialNav("manual"),setTimeout(()=>{S={sourceType:"text",sourceId:t.id,caption:t.caption||"",hashtags:(t.hashtags||"").replace(/#/g,""),platform:t.platform,media:Array.isArray(t.media)?t.media:[],linkUrl:t.metadata?.link_url||"",allowDuplicate:!0},document.getElementById("mp-caption").value=S.caption,document.getElementById("mp-hashtags").value=S.hashtags,document.getElementById("mp-link").value=S.linkUrl,Je(),Ne()},200))};window.socialManualPlatform=function(e){S.platform=e,document.querySelectorAll("#mp-platforms label").forEach((i,a,n)=>{i.classList.toggle("border-blue-500/50",i.querySelector(".accent-blue-600")?.value===e)}),document.querySelectorAll("#mp-platforms label").forEach(i=>i.classList.remove("border-blue-500/50"));const t=Array.from(document.querySelectorAll("#mp-platforms label")).find(i=>i.textContent.includes(W(e)));t&&t.classList.add("border-blue-500/50"),Ne()};window.socialAddMediaUrl=function(){const e=document.getElementById("mp-media-url").value.trim();if(!e)return;const t=/\.(mp4|webm|mov|m4v)(\?|$)/i.test(e)?"video":"image";S.media.push({url:e,type:t}),document.getElementById("mp-media-url").value="",Je(),Ne()};window.socialAddMediaFile=async function(e){const t=e.target.files?.[0];if(t){try{C("Uploading media…","info");const i=await cs(t);S.media.push(i),Je(),Ne(),C("Media added.")}catch(i){C(i.message,"error")}e.target.value=""}};function Gi(e,t){return`<div class="flex items-center gap-2 p-2 rounded-lg bg-white/[.03] border border-white/10">
  ...
  </div>`}window.socialRemoveMedia=function(e){S.media.splice(e,1),Je(),Ne()};function Je(){const e=document.getElementById("mp-media");e&&(e.innerHTML=S.media.length?S.media.map(Gi).join(""):'<p class="text-[11px] text-gray-500">No media. Add an image or video URL, or upload a file.</p>'),Z()}function Vi(e,t,i,a){const n=e?.[0],s=[t,i?i.split(/[ ,]+/).map(o=>"#"+o.replace(/^#/,"")).join(" "):""].filter(Boolean).join(`
`);return`
    <div class="p-4 space-y-3">
      <div class="flex items-center gap-2">
        <div class="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center"><i data-lucide="${xe(a)}" class="w-4 h-4 text-blue-300"></i></div>
        <p class="text-[11px] font-bold text-gray-300">${k(W(a)||"Select a platform")}</p>
      </div>
    ...
    </div>`}function Ne(){S.caption=document.getElementById("mp-caption")?.value??S.caption,S.hashtags=document.getElementById("mp-hashtags")?.value??S.hashtags;const e=document.getElementById("mp-preview");e&&(e.innerHTML=Vi(S.media,S.caption,S.hashtags,S.platform)),Z()}function bs(){S.caption=document.getElementById("mp-caption")?.value||"",S.hashtags=document.getElementById("mp-hashtags")?.value||"",S.linkUrl=document.getElementById("mp-link")?.value||"",S.allowDuplicate=document.getElementById("mp-dup")?.checked||!1;const e=S.hashtags.split(/[\s,]+/).filter(Boolean).map(t=>t.replace(/^#/,"")).filter(Boolean);return{platform:S.platform,caption:S.caption,hashtags:e,media:S.media,linkUrl:S.linkUrl,contentType:S.sourceType==="draft"?"manual":S.sourceType,sourceType:ys(S.sourceType),sourceId:S.sourceId,allowDuplicate:S.allowDuplicate}}function ys(e){return e==="promo"?"promotions":e==="content"?"social_content_item":e==="product"?"showroom_listing":null}window.socialManualGo=async function(e){const t=bs();if(!t.platform)return C("Select a platform first.","error");if(!t.caption.trim()&&t.sourceType==="text")return C("Write a caption.","error");if(t.sourceType==="showroom_listing"&&!t.sourceId)return C("Pick a product first.","error");if(S.sourceType==="draft"&&S.sourceId)try{await Me("/api/social/posts",{method:"POST",body:JSON.stringify({action:"trigger",post_id:S.sourceId})}),C("Draft published."),window.socialNav("published");return}catch(i){return C(i.message,"error")}if(e==="schedule"){const i=document.getElementById("mp-when")?.value;if(!i)return C("Choose a date and time to schedule.","error");t.mode="schedule",t.scheduledFor=new Date(i).toISOString()}else e==="draft"?t.mode="draft":t.mode="publish_now";try{const i=document.getElementById("social-body")?.querySelector("button");i&&(i.disabled=!0);const a=await Me("/api/social/publish",{method:"POST",body:JSON.stringify(t)});C(a.message||"Done."),S.media=[],window.socialNav(e==="publish_now"?"published":e==="schedule"?"schedule":"queue")}catch(i){C(i.message,"error")}};async function fs(e){try{const[t,i]=await Promise.all([b.from("social_automation_rules").select("*").eq("enabled",!0).order("next_run_at"),b.from("social_posts").select("*").eq("status","scheduled").order("scheduled_for")]),a=t.data||[],n=i.data||[];e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      ...
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}async function Ka(e){const{data:t}=await b.from("social_posts").select("*").in("status",["draft","queued","publishing"]).order("created_at",{ascending:!0}),i=t||[],a={draft:i.filter(n=>n.status==="draft"),queued:i.filter(n=>n.status==="queued"),publishing:i.filter(n=>n.status==="publishing")};e.innerHTML=`
    <div class="space-y-4">
      ${["publishing","queued","draft"].map(n=>`
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          <div class="flex items-center justify-between">
            ...
            <span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${a[n].length}</span>
          </div>
          ${a[n].length?a[n].map(s=>hs(s)).join(""):'<p class="text-[11px] text-gray-600 py-2">Empty.</p>'}
        </div>`).join("")}
    ...
    </div>`}window.socialApprove=async function(e){const{error:t}=await b.from("social_posts").update({status:"queued",updated_at:new Date().toISOString()}).eq("id",e);if(t)return C(t.message,"error");C("Approved. It will publish on the next scheduler tick (or click Publish now)."),Ka(document.getElementById("social-body"))};window.socialPostAction=async function(e,t){try{if(t==="delete"&&!confirm("Delete this post record?"))return;await Me("/api/social/posts",{method:"POST",body:JSON.stringify({action:t,post_id:e})}),C({trigger:"Published!",retry:"Retried.",cancel:"Cancelled.",delete:"Deleted."}[t]||"Done.");const i=document.getElementById("social-body");i&&(t==="trigger"||t==="retry")?window.socialNav("published"):Ka(i)}catch(i){C(i.message,"error")}};async function vs(e){const{data:t}=await b.from("social_posts").select("*").eq("status","published").order("published_at",{ascending:!1}).limit(200),i=t||[];e.innerHTML=`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      <div class="flex items-center justify-between"><h3 class="text-sm font-black text-white"><i data-lucide="check-circle-2" class="w-4 h-4 text-emerald-400 inline mr-1.5"></i>Published Posts</h3><span class="badge bg-emerald-500/15 text-emerald-300 border-emerald-500/30">${i.length}</span></div>
      ${i.length?`<div class="space-y-2">${i.map(ws).join("")}</div>`:we("No published posts yet. Post manually or enable automation.","check-circle-2")}
    ...
    </div>`}async function xs(e){const{data:t}=await b.from("social_posts").select("*").eq("status","failed").order("updated_at",{ascending:!1}).limit(200),i=t||[];e.innerHTML=`
    <div class="glass-soft border border-red-500/20 rounded-2xl p-5 space-y-3">
      <div class="flex items-center justify-between"><h3 class="text-sm font-black text-white"><i data-lucide="alert-triangle" class="w-4 h-4 text-red-400 inline mr-1.5"></i>Failed Posts</h3><span class="badge bg-red-500/15 text-red-300 border-red-500/30">${i.length}</span></div>
      ${i.length?i.map(_s).join(""):we("No failed posts.","check-circle-2")}
    ...
    </div>`}async function ks(e){const[t,i]=await Promise.all([b.from("social_post_logs").select("*").order("created_at",{ascending:!1}).limit(300),b.from("social_posts").select("id,caption,platform")]),a=t.data||[],n=new Map((i.data||[]).map(o=>[o.id,o])),s={info:"text-sky-300",warn:"text-amber-300",error:"text-red-300"};e.innerHTML=`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3">
      <div class="flex items-center justify-between"><h3 class="text-sm font-black text-white"><i data-lucide="scroll-text" class="w-4 h-4 text-blue-400 inline mr-1.5"></i>Post Logs</h3><span class="badge bg-blue-500/10 text-blue-300 border-blue-500/20">${a.length}</span></div>
      <div class="space-y-1.5 max-h-[65vh] overflow-y-auto scrollbar-thin">${a.map(o=>{const r=n.get(o.post_id);return`<div class="p-2.5 rounded-xl bg-white/[.02] border border-white/5 flex items-start gap-3">
    ...
    </div>`,Z()}let aa=[];async function ia(e){try{const t=await Ye(),{data:i}=await b.from("social_platform_settings").select("*").order("platform");aa=i||[];const{data:a}=await b.from("social_content_items").select("*").order("created_at",{ascending:!1});e.innerHTML=`
      ${$s()}
      ...
      <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-3 mt-4">
        ...
        ${(a||[]).length?(a||[]).map(Ss).join(""):we('Add news/article items to make them available for the automatic publisher (content type "News / articles").',"newspaper")}
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}function Ss(e){return`<div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
    ...
    </div>`}function Es(e){const t=aa.find(a=>a.platform===e.id)||{},i=t.config||{};return e.account,`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
    ...
    </div>`}function As(e,t,i){const a=[];if(e==="tiktok"&&a.push(`<div><label class="lbl">Post privacy</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="tiktok_privacy_level">
    ...
    </select></div>`),e==="telegram"&&a.push(`<div class="col-span-2"><label class="lbl">Destination chat / channel (@id or numeric)</label><input class="input-field !text-xs !py-2" value="${k(t.telegram_chat_id||"")}" onchange="window.socialSavePlatform('${e}')" data-f="telegram_chat_id" placeholder="@yourchannel"></div>`),e==="whatsapp"&&a.push(`
      ...
      <div class="col-span-2"><label class="lbl">Channel id</label><input class="input-field !text-xs !py-2" value="${k(t.whatsapp_channel_id||"")}" onchange="window.socialSavePlatform('${e}')" data-f="whatsapp_channel_id"></div>`),e==="facebook"){const n=Array.isArray(i.account?.extra?.pages)?i.account.extra.pages:[];a.push(`<div class="col-span-2"><label class="lbl">Facebook Page to post to</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="facebook_page_id">
      <option value="">Select a page…</option>
      ${n.map(s=>`<option value="${k(s.id)}" ${t.facebook_page_id===s.id?"selected":""}>${k(s.name)}</option>`).join("")}
    </select>${n.length?"":'<p class="text-[10px] text-gray-500">Connect a Facebook account first.</p>'}</div>`)}if(e==="instagram"){const n=Array.isArray(i.account?.extra?.pages)?i.account.extra.pages:[];a.push(`<div class="col-span-2"><label class="lbl">Instagram account</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="instagram_ig_user_id">
    ...
    </select>${n.length?"":'<p class="text-[10px] text-gray-500">Connect an Instagram business account first.</p>'}</div>`)}return e==="pinterest"&&a.push(`<div class="col-span-2"><label class="lbl">Board id</label><input class="input-field !text-xs !py-2" value="${k(t.pinterest_board_id||"")}" onchange="window.socialSavePlatform('${e}')" data-f="pinterest_board_id" placeholder="Paste a board id from Pinterest"></div>`),e==="youtube"&&a.push(`<div><label class="lbl">Privacy</label><select class="input-field !text-xs !py-2" onchange="window.socialSavePlatform('${e}')" data-f="youtube_privacy">
    ...
    </select></div>`),a.length?`<div class="grid grid-cols-2 gap-2">${a.join("")}</div>`:""}window.socialTogglePlatform=async function(e,t){await Ps(e,{enabled:t})};async function Ps(e,t){const i=aa.find(n=>n.platform===e),{error:a}=await b.from("social_platform_settings").upsert({id:i?.id,platform:e,...t,updated_at:new Date().toISOString()},{onConflict:"platform"});if(a){C(a.message,"error");return}C(`${W(e)} ${t.enabled!==void 0?t.enabled?"enabled":"disabled":"saved"}.`)}window.socialSavePlatform=async function(e){const t=Array.from(document.querySelectorAll(`[onchange="window.socialSavePlatform('${e}')"]`)),i={};for(const s of t){const o=s.dataset.f;o&&(i[o]=s.value)}const a=aa.find(s=>s.platform===e),{error:n}=await b.from("social_platform_settings").upsert({id:a?.id,platform:e,config:{...a?.config||{},...i},updated_at:new Date().toISOString()},{onConflict:"platform"});if(n){C(n.message,"error");return}C(`${W(e)} settings saved.`)};window.socialCopy=function(e){const t=e.dataset.text||"";navigator.clipboard?.writeText(t).then(()=>C("Copied.")).catch(()=>C("Copy failed.","error"))};async function Cs(e){try{const t=await Ye(),i=t.serverConfigured||{};e.innerHTML=`
      <div class="space-y-4">
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          ...
          <div class="grid sm:grid-cols-3 gap-2">
            ${ka("Supabase service keys",i.supabase,"Needed for scheduler + token storage")}
            ${ka("Token encryption key",i.tokenEncryption,"SOCIAL_TOKEN_ENC_KEY (AES-256-GCM)")}
            ${ka("Scheduler secret",i.schedulerSecret,"SCHEDULER_CRON_SECRET for the 15-min cron")}
          </div>
        </div>
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
          ...
          <div class="grid md:grid-cols-2 gap-2">
            ${(t.platforms||[]).map(a=>`
              <div class="flex items-center gap-3 p-3 bg-white/[.03] border border-white/10 rounded-xl">
                <i data-lucide="${xe(a.id)}" class="w-4 h-4 ${re[a.id]?.tone||""} shrink-0"></i>
                <div class="flex-1 min-w-0">
                  <p class="text-xs font-bold text-white">${k(a.label)}</p>
                  <p class="text-[10px] text-gray-500 leading-relaxed">${k(a.requirements?.note||"")}</p>
                </div>
                <span class="badge ${a.configured?"bg-emerald-500/15 text-emerald-300 border-emerald-500/30":"bg-amber-500/15 text-amber-300 border-amber-500/30"}">${a.configured?"ready":"setup needed"}</span>
              </div>`).join("")}
          </div>
        </div>
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-2">
      ...
      </div>`,Z()}catch(t){e.innerHTML=`<div class="glass-soft border border-red-500/20 rounded-2xl p-5 text-sm text-red-300">${k(t.message)}</div>`}}function ka(e,t,i){return`<div class="p-3 rounded-xl bg-white/[.03] border border-white/10">
  ...
  </div>`}function dt(){return'<div class="flex items-center justify-center py-24"><div class="flex items-center gap-3 text-gray-500 text-sm"><i data-lucide="loader-2" class="w-5 h-5 animate-spin text-blue-400"></i> Loadingâ€¦</div></div>'}function We(e,t,i,a=""){return`<div class="flex flex-col items-center justify-center py-20 text-center"><div class="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4"><i data-lucide="${e}" class="w-8 h-8 text-blue-400"></i></div><h3 class="text-base font-black text-white mb-1">${c(t)}</h3><p class="text-sm text-gray-500 max-w-xs">${c(i)}</p>${a?`<div class="mt-5">${a}</div>`:""}</div>`}function Ji(){const e=document.getElementById("sidebar-nav");e&&(e.innerHTML=Ls.map(t=>`
    <div>
      <span class="section-label">${t.group}</span>
      ${t.items.map(i=>`
        <button class="nav-item ${B.section===i.id?"active":""} w-full flex items-center gap-2.5 px-3 py-2.5 text-sm font-semibold rounded-xl" onclick="navigate('${i.id}')">
          <i data-lucide="${i.icon}" class="w-4 h-4 shrink-0"></i>
          <span>${i.label}</span>
        </button>`).join("")}
    </div>`).join(""),window.lucide&&lucide.createIcons())}window.navigate=function(e){B.section=e;const t=Rs[e]||e,i=document.getElementById("page-title");i&&(i.textContent=t),Ji(),closeSidebar();const a=document.getElementById("content");a&&(a.innerHTML=dt()),window.lucide&&lucide.createIcons(),({dashboard:Ys,products:T,properties:ma,catalog:yt,orders:si,customers:Jo,reviews:Mt,messages:An,coupons:ga,ads:gt,notifications:Zo,ai:Bs,"ai-settings":Tn,"homepage-branding":fa,"promo-bg":At,content:or,"content-settings":Mn,seo:gr,email:br,analytics:mr,security:ya,activity:yr,brand:bt,"payment-settings":Ha,backup:fr,settings:hr,publish:va,social:()=>Pa("overview"),"social-settings":()=>Pa("platforms")}[e]||(()=>{const o=document.getElementById("content");o&&(o.innerHTML=We("construction","Coming Soon",`${t} is being built.`))}))()};async function Bs(){const e=document.getElementById("content");e&&(e.innerHTML=`
    <div class="space-y-4 fade-in">
      <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
...
<div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
    ...
    </div>`,window.lucide&&lucide.createIcons())}window.openSidebar=()=>{document.getElementById("sidebar").classList.add("open"),document.getElementById("sidebar-overlay").classList.remove("hidden")};window.closeSidebar=()=>{document.getElementById("sidebar").classList.remove("open"),document.getElementById("sidebar-overlay").classList.add("hidden")};document.getElementById("close-sidebar")?.addEventListener("click",closeSidebar);const tt="kco_admin_remember",Ja="kco_login_attempts",Ca=5,Ns=15*60*1e3;function X(e){const t=document.getElementById("login-error"),i=document.getElementById("login-error-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-success")?.classList.add("hidden"),window.lucide&&lucide.createIcons())}function Fs(e){const t=document.getElementById("login-success"),i=document.getElementById("login-success-text");!t||!i||(i.textContent=e,t.classList.remove("hidden"),document.getElementById("login-error")?.classList.add("hidden"))}function sa(){document.getElementById("login-error")?.classList.add("hidden"),document.getElementById("login-success")?.classList.add("hidden")}function Tt(e){return String(e||"").trim().toLowerCase()}function Ds(){try{const e=JSON.parse(localStorage.getItem(tt)||"{}");e?.email&&!Tt(e.email)&&localStorage.removeItem(tt)}catch{localStorage.removeItem(tt)}}function Us(){try{const e=JSON.parse(localStorage.getItem(tt)||"{}");return Tt(e?.email)}catch{return""}}function Qa(){Ds();const e=Us(),t=document.getElementById("login-email");t&&(t.value=e||t.value||Wi,t.removeAttribute("readonly"));const i=document.getElementById("reset-email");i&&(i.value=e||i.value||"",i.removeAttribute("readonly"))}function js(){return`${window.location.origin}/admin.html`}function Qe(e){const t=document.getElementById("login-header-title"),i=document.getElementById("login-header-icon");document.getElementById("login-form")?.classList.toggle("hidden",e!=="login"),document.getElementById("twofa-form")?.classList.toggle("hidden",e!=="2fa"),document.getElementById("forgot-form")?.classList.toggle("hidden",e!=="forgot"),sa(),e==="login"&&(t&&(t.textContent="Admin Access"),i&&i.setAttribute("data-lucide","shield-check")),e==="2fa"&&(t&&(t.textContent="Two-Factor Auth"),i&&i.setAttribute("data-lucide","smartphone")),e==="forgot"&&(t&&(t.textContent="Reset Password"),i&&i.setAttribute("data-lucide","mail")),window.lucide&&lucide.createIcons()}function V(e,t,i=""){const a=document.getElementById(e);a&&(a.disabled=t,t?a.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline-block mr-1"></i> Please waitâ€¦':i&&(a.innerHTML=i),window.lucide&&lucide.createIcons())}function Qi(){try{return JSON.parse(localStorage.getItem(Ja)||'{"count":0}')}catch{return{count:0}}}function Xi(){const e=Qi();return e.count=(e.count||0)+1,e.count>=Ca&&(e.lockedUntil=Date.now()+Ns),localStorage.setItem(Ja,JSON.stringify(e)),e}function Zi(){localStorage.removeItem(Ja)}function en(){const e=Qi();if(!e.lockedUntil)return null;const t=e.lockedUntil-Date.now();return t<=0?(Zi(),null):Math.ceil(t/6e4)}async function fe(e,t,i={}){try{await b.from("admin_security_logs").insert({user_id:e,event_type:t,ip_address:await qs(),user_agent:navigator.userAgent.slice(0,200),...i})}catch{}}async function qs(){try{return(await(await fetch("https://api64.ipify.org?format=json",{signal:AbortSignal.timeout(3e3)})).json()).ip||"unknown"}catch{return"unknown"}}async function tn(e){if(!e)return!1;let t=!1,i=!1;try{const{data:a}=await b.rpc("is_current_user_admin");t=!0,i=!!a}catch{t=!1}return t?i:Tt(e.email)===Wi}async function Os(){const e=window.location.hash;if(e.includes("type=recovery")||e.includes("access_token")){Gt(),Ks();return}const{data:{session:t}}=await b.auth.getSession();if(t?.user&&await tn(t.user)){const{data:{currentUser:a}}=await b.auth.getUser(),n=await b.auth.mfa.getAuthenticatorAssuranceLevel(),s=n.data?.currentLevel;if(n.data?.nextLevel==="aal2"&&s!=="aal2"){B.user=t.user,Gt(),Qe("2fa"),Xa();return}B.user=t.user,oa();return}Hs()}function Gt(){const e=document.getElementById("login-screen");e&&(e.style.display="flex")}function Hs(){Gt(),Qe("login"),Qa(),an(),nn(),Xa(),Gs();const e=en();e&&(X(`Too many failed attempts. Try again in ${e} minute${e>1?"s":""}.`),document.getElementById("login-btn").disabled=!0)}function Gs(){document.getElementById("toggle-pw")?.addEventListener("click",()=>{const e=document.getElementById("login-password"),t=document.querySelector("#toggle-pw i");e&&(e.type=e.type==="password"?"text":"password",t&&t.setAttribute("data-lucide",e.type==="password"?"eye":"eye-off"),window.lucide&&lucide.createIcons())})}function an(){const e=document.getElementById("login-form");!e||e._bound||(e._bound=!0,e.addEventListener("submit",Vs),document.getElementById("forgot-pw-btn")?.addEventListener("click",()=>Qe("forgot")))}async function Vs(e){e.preventDefault();const t=en();if(t){X(`Account locked. Try again in ${t} minute${t>1?"s":""}.`);return}const i=document.getElementById("login-email"),a=Tt(i?.value);if(!a){X("Enter your admin email address."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const n=document.getElementById("login-password").value,s=document.getElementById("remember-me")?.checked;V("login-btn",!0),sa();const{data:o,error:r}=await b.auth.signInWithPassword({email:a,password:n});if(r||!o.user){const f=String(r?.message||"").toLowerCase();if(f.includes("missing supabase credentials")||f.includes("authentication service is unavailable")){X("Authentication is temporarily unavailable due to configuration. Please contact support."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("failed to fetch")||f.includes("network request failed")){X("Network error while signing in. Check your connection and try again."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}if(f.includes("email not confirmed")){X("Your admin email is not confirmed yet. Open your verification email and confirm first."),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In');return}const v=Xi(),p=Ca-v.count,g=v.lockedUntil?`Account locked for 15 minutes after ${Ca} failed attempts.`:`Invalid email or password. ${p>0?p+" attempt"+(p!==1?"s":"")+" remaining.":""}`;X(g),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),o?.user&&await fe(o.user.id,"login_failed",{metadata:{reason:"wrong_password"}});return}if(!await tn(o.user)){await b.auth.signOut(),X(`Access denied for ${o.user.email}. This account is signed in but does not have administrator privileges.`),V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),await fe(o.user.id,"login_denied",{metadata:{reason:"not_admin"}});return}if(s?localStorage.setItem(tt,JSON.stringify({email:a,ts:Date.now()})):localStorage.removeItem(tt),Zi(),B.user=o.user,(await b.auth.mfa.getAuthenticatorAssuranceLevel()).data?.nextLevel==="aal2"){V("login-btn",!1,'<i data-lucide="log-in" class="w-4 h-4 inline mr-1"></i> Sign In'),Qe("2fa"),Xa(),setTimeout(()=>document.getElementById("totp-code")?.focus(),100);return}await fe(o.user.id,"login_success"),V("login-btn",!1),oa()}function Xa(){const e=document.getElementById("verify-2fa-btn");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",gi));const t=document.getElementById("totp-code");t&&!t._bound&&(t._bound=!0,t.addEventListener("input",a=>{a.target.value=a.target.value.replace(/\D/g,"").slice(0,6),a.target.value.length===6&&gi()})),document.getElementById("cancel-2fa-btn")?.addEventListener("click",async()=>{await b.auth.signOut(),B.user=null,Qe("login")}),document.getElementById("use-backup-btn")?.addEventListener("click",()=>{document.getElementById("backup-code-wrap")?.classList.toggle("hidden");const n=document.getElementById("backup-code");n&&n.focus()});const i=document.getElementById("verify-backup-btn");i&&!i._bound&&(i._bound=!0,i.addEventListener("click",Ws))}async function gi(){const e=document.getElementById("totp-code")?.value?.trim();if(!e||e.length!==6){X("Enter the 6-digit code from your authenticator app.");return}V("verify-2fa-btn",!0),sa();try{const{data:t}=await b.auth.mfa.listFactors(),i=(t?.totp||[])[0];if(!i){X("No 2FA factor found. Please re-login."),V("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In');return}const{data:a,error:n}=await b.auth.mfa.challenge({factorId:i.id});if(n)throw n;const{error:s}=await b.auth.mfa.verify({factorId:i.id,challengeId:a.id,code:e});if(s)throw s;await fe(B.user.id,"login_2fa_success"),V("verify-2fa-btn",!1),oa()}catch(t){Xi(),X(t.message?.includes("Invalid")?"Incorrect code. Check your authenticator and try again.":t.message),V("verify-2fa-btn",!1,'<i data-lucide="shield-check" class="w-4 h-4 inline mr-1"></i> Verify & Sign In'),document.getElementById("totp-code").value="",document.getElementById("totp-code").focus()}}async function Ws(){const e=document.getElementById("backup-code")?.value?.trim().toUpperCase().replace(/\s/g,"");if(!e){X("Enter a backup recovery code.");return}V("verify-backup-btn",!0);try{const{data:t}=await b.from("admin_2fa").select("backup_codes").eq("user_id",B.user.id).maybeSingle();if(!t?.backup_codes?.length){X("No backup codes found."),V("verify-backup-btn",!1,"Use Backup Code");return}if(!t.backup_codes.find(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")&&!n.used)){X("Backup code not found or already used."),V("verify-backup-btn",!1,"Use Backup Code");return}const a=t.backup_codes.map(n=>(n.code||n).toUpperCase().replace(/-/g,"")===e.replace(/-/g,"")?{...typeof n=="object"?n:{code:n},used:!0}:n);await b.from("admin_2fa").update({backup_codes:a}).eq("user_id",B.user.id),await fe(B.user.id,"login_backup_code_used"),oa()}catch(t){X(t.message),V("verify-backup-btn",!1,"Use Backup Code")}}function nn(){document.getElementById("back-to-login")?.addEventListener("click",()=>Qe("login")),document.getElementById("send-reset-btn")?.addEventListener("click",zs)}async function zs(){const e=document.getElementById("reset-email"),t=Tt(e?.value);if(!t){X("Enter your admin email address to receive a reset link.");return}V("send-reset-btn",!0),sa();const{error:i}=await b.auth.resetPasswordForEmail(t,{redirectTo:js()});if(V("send-reset-btn",!1,'<i data-lucide="mail" class="w-4 h-4 inline mr-1"></i> Send Reset Link'),i){X(i.message);return}Fs("Reset link sent! Check your inbox and open it from this device to continue.")}function Ks(){const e=document.getElementById("login-screen");if(!e)return;const t=e.querySelector(".login-card");t&&(t.innerHTML=`
...
<div class="space-y-4">
      ...
      </div>`,window._productsData=n,window._productsCardLimit=60,on(n),filterProducts(),updateBulkBar(),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400 text-sm">Error: ${c(t.message)}</div>`)}}function Te(e){const t=parseFloat(e);return Number.isFinite(t)?t:0}function St(e){return Array.isArray(e.tags)?e.tags.filter(Boolean):[]}function Js(e){const t=Te(e.price),i=parseFloat(e.real_price);if(Number.isFinite(i)&&i>0&&i>t)return`${Math.round((1-t/i)*100)}% OFF`;const a=parseFloat(e.discount_percent??e.discount??0);return Number.isFinite(a)&&a>0?`${Math.round(a)}% OFF`:"No discount"}function Qs(e){const t=Te(e.price),i=parseFloat(e.real_price),a=`$${t.toLocaleString()}`;return Number.isFinite(i)&&i>0&&i>t?`<span class="block text-xs text-gray-400 price-strike line-through">$${i.toLocaleString()}</span><span class="text-emerald-300 font-black">$${t.toLocaleString()}</span>`:a}function ra(e){return e.is_archived||e.availability_status==="Archived"?"archived":e.is_active?"active":"inactive"}function Ia(e){return parseInt(e.views??e.view_count??0,10)||0}function Ta(e){return parseInt(e.sales??e.sales_count??0,10)||0}function la(e){return e.sku||e.property_id||"N/A"}function Xs(e){const t=e.images&&e.images[0]?e.images[0]:"/fallback.svg",i=St(e),a=ra(e),n=window._productSelection?.has(e.property_id),s=ie(a==="archived"?"inactive":a==="active"?"active":"inactive"),o=ge(e.created_at),r=!!e.is_featured,l=e.is_active?`unpublishProduct('${e.property_id}')`:`publishProduct('${e.property_id}')`,d=e.is_active?"Unpublish":"Publish",u=e.is_active?"bg-amber-500/15 text-amber-200 hover:bg-amber-500/25":"bg-emerald-500/15 text-emerald-200 hover:bg-emerald-500/25";return`<article data-id="${e.property_id}" data-cat="${c(e.category||"")}" data-status="${a}" data-featured="${r?"featured":"standard"}" onclick="editProduct('${e.property_id}')" title="Tap anywhere to edit this product" class="prod-card glass-soft border ${n?"border-blue-400/60":"border-blue-500/15"} rounded-3xl p-5 flex flex-col gap-4 transition hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/10 cursor-pointer select-none active:scale-[.99]">
    ...
    ${i.length?`<div class="flex flex-wrap gap-1.5">${i.slice(0,6).map(m=>`<span class="text-xs px-2.5 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">${c(m)}</span>`).join("")}</div>`:'<div class="text-xs text-gray-500">No tags</div>'}
  </article>`}function sn(e,t){const i=[...e],a=n=>new Date(n||0).getTime()||0;return t==="oldest"?i.sort((n,s)=>a(n.created_at)-a(s.created_at)):t==="price-high"?i.sort((n,s)=>Te(s.price)-Te(n.price)):t==="price-low"?i.sort((n,s)=>Te(n.price)-Te(s.price)):t==="sales-high"?i.sort((n,s)=>Ta(s)-Ta(n)):t==="views-high"?i.sort((n,s)=>Ia(s)-Ia(n)):i.sort((n,s)=>a(s.created_at)-a(n.created_at)),i}function on(e){const t=document.getElementById("products-grid"),i=document.getElementById("products-empty"),a=document.getElementById("products-result-count");if(!t)return;const n=window._productsCardLimit||60,s=e.slice(0,n);t.innerHTML=s.map(Xs).join(""),a&&(a.textContent=String(e.length));const o=document.getElementById("products-more");if(o){const r=e.length-s.length;r>0?o.innerHTML=`<button onclick="loadMoreProducts()" class="btn-press px-8 py-4 rounded-2xl text-base font-black bg-blue-500/15 text-blue-200 hover:bg-blue-500/25 border border-blue-500/25 transition">Show ${Math.min(60,r)} more (${r} left)</button>`:o.innerHTML=e.length>60?'<span class="text-sm text-gray-500">All products shown</span>':""}i&&i.classList.toggle("hidden",e.length>0),updateBulkBar(),window.lucide&&lucide.createIcons()}window.loadMoreProducts=function(){window._productsCardLimit=(window._productsCardLimit||60)+60,filterProducts(!0)};function rn(e){const t=document.getElementById("products-table-body"),i=document.getElementById("products-result-count");t&&(t.innerHTML=e.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-10">No products found.</td></tr>':e.map(a=>{const n=a.images&&a.images[0]?a.images[0]:"/fallback.svg",s=ra(a),o=window._productSelection?.has(a.property_id),r=a.is_active?`unpublishProduct('${a.property_id}')`:`publishProduct('${a.property_id}')`,l=a.is_active?"Unpublish":"Publish";return`<tr class="prod-table-row" data-id="${a.property_id}" style="cursor:pointer">
          <td>
            <div class="flex items-center gap-2.5" onclick="editProduct('${a.property_id}')">
              ...
              <div class="min-w-0">
                ...
                <p class="text-[10px] font-mono text-gray-500">${c(la(a))}</p>
              </div>
            </div>
          </td>
          ...
          <td>
            <div class="text-xs">
              ${(()=>{const d=Te(a.price),u=parseFloat(a.real_price);return Number.isFinite(u)&&u>0&&u>d?`<span class="text-[10px] text-gray-500 price-strike line-through block">$${u.toLocaleString()}</span><span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`:`<span class="font-bold text-emerald-400">$${d.toLocaleString()}</span>`})()}
            </div>
          </td>
          ...
          <td><span class="text-xs text-gray-500">${ge(a.created_at)}</span></td>
          <td>
        ...
        </tr>`}).join(""),i&&(i.textContent=String(e.length)),window.lucide&&lucide.createIcons())}window.setProductView=function(e){window._productView=e==="table"?"table":"card";const t=document.getElementById("products-grid"),i=document.getElementById("products-table-wrap"),a=document.getElementById("view-card-btn"),n=document.getElementById("view-table-btn"),s=document.getElementById("products-empty"),o=window._productsData||[];t&&t.classList.toggle("hidden",e==="table"),i&&(i.classList.toggle("hidden",e!=="table"),e==="table"&&rn(o)),a&&a.classList.toggle("active",e!=="table"),n&&n.classList.toggle("active",e==="table"),s&&s.classList.toggle("hidden",o.length>0)};window.filterProducts=function(e){const t=window._productFilters||{};t.search=(document.getElementById("prod-search")?.value||"").trim().toLowerCase(),t.category=document.getElementById("prod-cat-filter")?.value||"",t.tag=document.getElementById("prod-tag-filter")?.value||"",t.status=document.getElementById("prod-status-filter")?.value||"",t.featured=document.getElementById("prod-featured-filter")?.value||"",t.sort=document.getElementById("prod-sort")?.value||"newest",window._productFilters=t;const i=(window._productsData||[]).filter(n=>{const s=[n.title,n.brand,n.category,la(n),St(n).join(" "),n.description].join(" ").toLowerCase();return!(t.search&&!s.includes(t.search)||t.category&&(n.category||"")!==t.category||t.tag&&!St(n).includes(t.tag)||t.status&&ra(n)!==t.status||t.featured&&t.featured==="featured"!=!!n.is_featured)}),a=sn(i,t.sort);e||(window._productsCardLimit=60),on(a),window._productView==="table"&&rn(a)};window.productSearchKeydown=function(e){if(e.key!=="Enter")return;const t=(document.getElementById("prod-search")?.value||"").trim().toLowerCase();if(!t)return;const i=window._productFilters||{},a=(window._productsData||[]).filter(s=>!(![s.title,s.brand,s.category,la(s),St(s).join(" "),s.description].join(" ").toLowerCase().includes(t)||i.category&&(s.category||"")!==i.category||i.tag&&!St(s).includes(i.tag)||i.status&&ra(s)!==i.status||i.featured&&i.featured==="featured"!=!!s.is_featured)),n=sn(a,i.sort||"newest")[0];n?editProduct(n.property_id):y("No product matched that search","error")};window.resetProductFilters=function(){window._productFilters={search:"",category:"",tag:"",status:"",featured:"",sort:"newest"},["prod-search","prod-cat-filter","prod-tag-filter","prod-status-filter","prod-featured-filter","prod-sort"].forEach(t=>{const i=document.getElementById(t);i&&(t==="prod-sort"?i.value="newest":i.value="")}),filterProducts()};window.toggleProductSelection=function(e,t){window._productSelection||(window._productSelection=new Set),t?window._productSelection.add(e):window._productSelection.delete(e),updateBulkBar()};window.toggleSelectAll=function(e,t){document.querySelectorAll("."+t).forEach(i=>{i.checked=e.checked;const a=i.value;window._productSelection||(window._productSelection=new Set),e.checked?window._productSelection.add(a):window._productSelection.delete(a)}),updateBulkBar()};window.toggleSelectAllProducts=function(e){document.querySelectorAll(".prod-check").forEach(t=>{t.checked=!!e,window._productSelection||(window._productSelection=new Set),e?window._productSelection.add(t.value):window._productSelection.delete(t.value)}),updateBulkBar()};window.updateBulkBar=function(){const e=window._productSelection?window._productSelection.size:0,t=document.getElementById("bulk-actions"),i=document.getElementById("bulk-count");t&&(t.classList.toggle("hidden",e===0),e>0&&t.classList.add("flex")),i&&(i.textContent=`${e} selected`)};function ca(){return window._productSelection?[...window._productSelection]:[]}function ce(e){const t=String(e?.message||e?.code||"").toLowerCase();return t.includes("row-level security")||t.includes("permission denied")||t.includes("permission denied for table")||t.includes("new row violates row-level security")||t.includes("not permitted")||t.includes("rls policy")}function ln(e,t,i){return e&&ce(e)?(y(`âš ï¸ ${i} blocked: Your account is signed in but the database admin role is not active. Re-run the admin permission migration, or contact the owner.`,"error"),!0):e?(t&&t(),y(`${i} saved locally (DB unavailable): ${e.message||"unknown error"}`,"info"),!0):!1}function Sa(e,t){if(!e)return`${t} failed for an unknown reason. Please try again.`;const i=String(e.message||""),a=e.code||"";return ce(e)?`${t} was BLOCKED: your account is signed in but the database admin role is not active. Re-run the admin permission migration (or contact the owner), then press Publish again.`:String(a)==="401"||/jwt|token|not authenticated|unauthorized|invalid api key/i.test(i)?`${t} failed: your sign-in session expired or is invalid. Please sign out and sign back in, then try again. Your changes are still in the form.`:String(a)==="23505"||/duplicate key|unique constraint/i.test(i)?`${t} failed: a duplicate-record conflict occurred in the database. Refresh the page and try again.`:String(a)==="23503"||/foreign key/i.test(i)?`${t} failed: the database rejected a reference (foreign key). Refresh the page, re-open the product and try again.`:String(a)==="42P01"||/column .* does not exist|relation .* does not exist/i.test(i)?`${t} failed: the database schema is out of date. Run the latest database migration, then try again.`:String(a)==="23502"||/null value in column .* violates/i.test(i)?`${t} failed: a required field was rejected by the database. Fill in every required field, then try again.`:/failed to fetch|networkerror|network request|fetch failed|load failed|offline|ERR_NAME|ERR_CONNECTION|timeout/i.test(i)?`${t} failed: no connection to the server. Check your internet connection and press Publish again. Your changes are still in the form.`:String(a)==="42501"||/permission denied|row-level security/i.test(i)?`${t} was BLOCKED by database permissions. Re-run the admin permission migration (or contact the owner), then try again.`:/rate limit|too many requests/i.test(i)?`${t} failed: too many requests were sent at once. Wait a few seconds and press Publish again.`:`${t} failed: ${i||"an unexpected database error occurred"}. Nothing was saved — your changes are still in the form, so you can press Publish again.`}function Zs(e){const t=String(e?.title||"").trim();if(!t)return"";const i=e?.price&&typeof e.price=="object"?e.price.price:e?.price,a=Number(i)||0,n=[e?.city,e?.state,e?.country].filter(Boolean).join(", ")||String(e?.product_location||"").trim(),s=String(e?.availability_status||"").trim()||"In Stock";let o=t;if(a>0)try{o+=` for ${a.toLocaleString("en-US",{style:"currency",currency:e?.currency||"USD",maximumFractionDigits:0})}`}catch{o+=` for $${a.toLocaleString("en-US")}`}o+=` — ${s}.`,n&&(o+=` Located in ${n}.`);const r=String(e?.description||"").replace(/<[^>]+>/g," ").replace(/\s+/g," ").trim();return r&&(o+=` ${r}`),o.length>235?o.slice(0,235).replace(/\s+\S*$/,"")+"…":o}async function bi(e){try{let{data:{session:a}}=await b.auth.getSession();if(!a){const{data:o}=await b.auth.getSession();a=o?.session}if(!a)return{error:new Error("Your sign-in session has expired. Please sign out and sign back in, then press Publish again.")};const{data:{user:n},error:s}=await b.auth.getUser();if(s||!n)return{error:new Error("Your sign-in session is invalid. Please sign out and sign back in, then press Publish again.")}}catch(a){return console.error("[safePublishShowroom] Auth check failed:",a),{error:new Error("Could not verify your sign-in status. Check your internet connection and try again.")}}String(e?.meta_description||"").trim()||(e.meta_description=Zs(e));const t={...e||{}};for(const a of["created_at","updated_at","published_at"]){const n=t[a];if(n==null||n===""){delete t[a];continue}if(typeof n=="string"){const s=new Date(n);t[a]=Number.isNaN(s.getTime())?new Date().toISOString():s.toISOString()}else n instanceof Date&&!Number.isNaN(n.getTime())?t[a]=n.toISOString():delete t[a]}const i={...e,...t,updated_at:new Date().toISOString()};if(i.property_id){const{error:a}=await b.from("showroom_listings").upsert(i,{onConflict:"property_id"});if(!a)return{error:null};console.warn("[safePublishShowroom] Direct upsert failed, trying RPC fallback:",a?.message||a)}else{const{error:a}=await b.from("showroom_listings").insert(i);if(!a)return{error:null};console.warn("[safePublishShowroom] Direct insert failed, trying RPC fallback:",a?.message||a)}try{const a={...i};delete a.id;const{data:n,error:s}=await b.rpc("publish_showroom_upsert",{p_data:[a]});return s?(console.error("[safePublishShowroom] RPC fallback also failed:",s),{error:new Error(`Database write failed: ${s.message||"unknown error"}. Your changes are preserved in the form — please try again.`)}):(console.log("[safePublishShowroom] RPC fallback succeeded, rows affected:",n),{error:null})}catch(a){return console.error("[safePublishShowroom] RPC exception:",a),{error:new Error(`Database write failed: ${a.message||"network error"}. Your changes are preserved in the form — please try again.`)}}}window.bulkToggleActive=async function(e){const t=ca();if(!t.length)return;const i=await Promise.all(t.map(s=>{const o=Se((window._productsData||[]).find(r=>r.property_id===s));return b.from("showroom_listings").upsert({...o,property_id:s,is_active:e},{onConflict:"property_id"})}));if(i.some(s=>s.error&&ce(s.error))){y(`âš ï¸ ${t.length} products NOT ${e?"published":"unpublished"}: database admin role blocked the write. Re-run the admin permission migration.`,"error"),window._productSelection=new Set,T();return}const n=i.filter(s=>s.error).length;y(`${t.length-n}/${t.length} products ${e?"published":"unpublished"}${n?` (${n} failed: ${i.find(s=>s.error)?.error?.message||"error"})`:""}`,n?"error":"success"),window._productSelection=new Set,T()};window.bulkDuplicateProducts=async function(){const e=ca();if(e.length){for(const t of e)await duplicateProduct(t,!0);y(`${e.length} products duplicated`),window._productSelection=new Set,T()}};window.bulkArchive=async function(){const e=ca();if(!e.length||!confirm(`Archive ${e.length} products? They will be hidden but not deleted.`))return;const t=await Promise.all(e.map(n=>b.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",n)));if(t.some(n=>n.error&&ce(n.error))){y("âš ï¸ Archive blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,T();return}const a=t.filter(n=>n.error).length;y(`${e.length-a}/${e.length} products archived${a?` (${a} failed)`:""}`,a?"error":"success"),window._productSelection=new Set,T()};window.bulkDeleteProducts=async function(){const e=ca();if(!e.length||!confirm(`Delete ${e.length} products permanently? This action cannot be undone.`))return;const t=await Promise.all(e.map(n=>b.from("showroom_listings").delete().eq("property_id",n)));if(t.some(n=>n.error&&ce(n.error))){y("âš ï¸ Delete blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),window._productSelection=new Set,T();return}const a=t.filter(n=>n.error).length;y(`${e.length-a}/${e.length} products deleted${a?` (${a} failed)`:""}`,a?"error":"success"),window._productSelection=new Set,T()};window.previewProduct=async function(e){const t=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),i=(window._productsData||[]).find(a=>a.property_id===e)||t.data;if(!i)return y("Product not found","error");j(`
      ...
      <div class="modal-box wide">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-2">${ie(i.is_active?"active":"inactive")}${i.is_featured?'<span class="badge bg-amber-500/15 text-amber-200 border-amber-500/30">Featured</span>':""}</div>
            <p class="text-xs text-gray-400">${c(i.description||"No description")}</p>
            <div class="grid grid-cols-2 gap-2 text-xs mt-2">
              <div class="glass-soft border border-blue-500/15 rounded-lg p-2"><span class="text-gray-500">Price</span><p class="text-emerald-300 font-black">$${Te(i.price).toLocaleString()}</p></div>
    ...
    </div>`)};window.quickEditProduct=async function(e){const t=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle(),i=(window._productsData||[]).find(n=>n.property_id===e)||t.data;if(!i)return y("Product not found","error");const a=Array.isArray(i.images)?i.images:[];j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),da(),ua(),ut(),Xe(),window.lucide&&lucide.createIcons()};window.saveQuickEditProduct=async function(e,t){e.preventDefault();const i=new FormData(e.target),a=[...document.querySelectorAll("#image-preview .img-thumb")].map(u=>u.dataset.url||(u.querySelector("img")?u.querySelector("img").getAttribute("src"):"")).filter(u=>u&&!String(u).startsWith("blob:")),n={title:i.get("title")||"Untitled Product",price:Math.max(U,Math.min(Y,parseFloat(i.get("price"))||0)),stock_quantity:i.get("stock_quantity")===""?null:parseInt(i.get("stock_quantity"),10),availability_status:i.get("availability_status")||"In Stock",is_featured:i.get("is_featured")==="on",is_active:i.get("is_active")==="on"||a.length>=24,images:a},s=String(i.get("real_price")||"").trim(),o=s===""?null:parseFloat(s);if(o!=null&&!Number.isFinite(o)){y("Real Price must be a number.","error");return}const r=Se((window._productsData||[]).find(u=>u.property_id===t)),l=r.specifications&&typeof r.specifications=="object"?r.specifications:{};n.specifications={...l,real_price:o!=null&&o>0?Math.round(o):null};const{error:d}=await b.from("showroom_listings").upsert({...r,...n,property_id:t},{onConflict:"property_id"});if(d){if(ce(d)){y("âš ï¸ Save blocked: database admin role rejected the write. Re-run the admin permission migration.","error"),le(),T();return}Ea(t,n),y("Quick edit saved locally","info")}else y(n.is_active?"Saved & published â€” your showroom shows it now":"Quick edit saved (draft)");le(),T()};window.publishProduct=function(e){return toggleProductActive(e,!0)};window.unpublishProduct=function(e){return toggleProductActive(e,!1)};window.shareProduct=async function(e){const t=`${window.location.origin}/product/${encodeURIComponent(e)}`,i=(window._productsData||[]).find(l=>l.property_id===e)||(window._propertiesData||[]).find(l=>l.property_id===e)||nt(e),a=i&&String(i.title||"").trim()||"Product on Weverse Online Shop",n=i&&Number(i.price||0)>0?`${a} — ${eo(i)}
${t}`:`${a}
${t}`,o=await(async()=>{try{if(navigator.clipboard?.writeText)return await navigator.clipboard.writeText(t),!0}catch{}try{const l=document.createElement("textarea");return l.value=t,l.style.cssText="position:fixed;opacity:0;pointer-events:none",document.body.appendChild(l),l.focus(),l.select(),document.execCommand("copy"),l.remove(),!0}catch{return!1}})();let r=!1;if(navigator.share)try{await navigator.share({title:a,text:n,url:t}),r=!0}catch{}r||y(o?"Product link copied to clipboard":"Product link: "+t)};function eo(e){const t=Number(e&&typeof e.price=="object"?e.price.price:e&&e.price)||0,i=e&&e.currency||"USD";let a;try{a=t.toLocaleString("en-US",{style:"currency",currency:i,maximumFractionDigits:0})}catch{a="$"+t.toLocaleString("en-US")}return e&&e.price_period&&(a+="/"+e.price_period),a}window.deleteProduct=async function(e){if(!confirm("Delete this product permanently? This action cannot be undone."))return;const t=(window._productsData||[]).find(a=>a.property_id===e)||(window._propertiesData||[]).find(a=>a.property_id===e)||nt(e),{error:i}=await b.from("showroom_listings").delete().eq("property_id",e);if(i&&!ce(i))return y("Delete failed: "+i.message,"error");Pt(e);try{const a=await ct(e,!0);a&&a.error&&ce(a.error)?y("âš ï¸ Deleted, but the site-wide hidden list could not be saved: database admin role rejected the write. Re-run the admin permission migration.","error"):y("Product deleted")}catch{y("Product deleted")}t&&t.listing_type==="property"?ma():T()};window.openProductMoreActions=function(e){j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-4">
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.filterProductCategoryChoices=function(e){const t=String(e||"").trim().toLowerCase();document.querySelectorAll("#product-category-grid [data-category]").forEach(i=>{const a=!t||i.dataset.category.includes(t);i.classList.toggle("hidden",!a)})};window.showAddProductStep2=function(e,t={}){const i=!!t.property_id,a=Di("product",e),n=t.currency||"USD";j(`
...
<input type="file" id="img-upload" class="hidden" multiple accept="image/*,video/mp4,video/webm,video/*,application/pdf" onclick="event.stopPropagation()" onchange="handleImageUpload(event)">
  ...
  </div>`}function da(){const e=document.getElementById("drop-zone");e&&(e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over"),no(t.dataTransfer.files)}))}function ua(){const e=document.getElementById("image-preview");!e||!window.Sortable||new Sortable(e,{animation:150,onEnd:()=>ut()})}window.handleImageUpload=async function(e){await Za(e.target.files)};async function no(e){await Za(e)}async function mn(e,t,i){const a=new Array(e.length);let n=0;const s=Array.from({length:Math.min(Math.max(t,1),e.length)},async()=>{for(;n<e.length;){const o=n++;try{a[o]=await i(e[o],o)}catch{a[o]=null}}});return await Promise.all(s),a}function so(e,t,i,a,n=9e4){return new Promise(s=>{let o=!1;const r=setTimeout(()=>{o||(o=!0,s({error:{message:`Upload timed out after ${Math.round(n/1e3)}s — the network is too slow for this file size.`}}))},n);b.storage.from(e).upload(t,i,a).then(l=>{o||(o=!0,clearTimeout(r),s(l))})})}async function oo(e,t=1920,i=.82){const a=URL.createObjectURL(e);try{const n=new Image;await new Promise((m,f)=>{n.onload=m,n.onerror=f,n.src=a});const s=Math.min(1,t/Math.max(n.width,n.height)),o=Math.max(1,Math.round(n.width*s)),r=Math.max(1,Math.round(n.height*s)),l=document.createElement("canvas");l.width=o,l.height=r,l.getContext("2d").drawImage(n,0,0,o,r);const d=await new Promise(m=>l.toBlob(m,"image/jpeg",i));if(!d||!d.size)return null;const u=(e.name||"photo.jpg").replace(/\.[^.]+$/i,"")+".jpg";return new File([d],u,{type:"image/jpeg"})}catch{return null}finally{URL.revokeObjectURL(a)}}async function Za(e){const t=document.getElementById("image-preview");if(!t)return;const i=[];for(const n of e){const s=n.type==="application/pdf"||Ke(n.name),o=Ve(n);if(!(!n.type.startsWith("image/")&&!s&&!o)){if(o&&n.size>100*1024*1024){y("Video must be under 100 MB.","error");continue}i.push(n)}}if(!i.length)return;const a=i.map(()=>{const n=document.createElement("div");return n.className="img-thumb uploading",n.style.cssText="min-width:90px;min-height:80px;",n.innerHTML='<div class="w-full h-full flex flex-col items-center justify-center bg-gray-800 text-gray-400"><div class="w-5 h-5 border-2 border-blue-400 border-t-transparent rounded-full animate-spin mb-1.5"></div><span class="text-[10px] font-bold">Uploading…</span></div>',t.appendChild(n),n});await mn(i,3,async(n,s)=>{const o=a[s],r=await ei(n);setTimeout(()=>{if(!(!o||!o.isConnected)){if(o.remove(),r){const l=document.createElement("div");l.innerHTML=De(r,s);const d=l.firstElementChild,u=o.nextSibling;u?t.insertBefore(d,u):t.appendChild(d)}else y(`Failed to upload ${Ve(n)?"video":"image"}. Try a smaller file.`,"error");ut(),Lt(),Xe(),window.lucide&&lucide.createIcons()}},0)})}async function ei(e){try{const{data:{session:t}}=await b.auth.getSession(),i=String(e.type||"").startsWith("image/"),a=Ve(e);let n=e;if(i&&e.size>250*1024){const l=await oo(e);l&&l.size&&(n=l)}const s=n.type==="image/jpeg"?"jpg":(e.name||"photo.jpg").split(".").pop()||"jpg",o=`products/${Date.now()}-${Math.random().toString(36).slice(2)}`,r=a?3e5:9e4;for(let l=0;l<2;l++){const d=`${o}${l?"-"+Math.random().toString(36).slice(2,7):""}.${s}`,{error:u}=await so("product-images",d,n,{contentType:n.type||e.type,upsert:!1},r);if(u)console.warn("product-images upload failed (attempt "+(l+1)+"):",u.message||u);else{const{data:m}=b.storage.from("product-images").getPublicUrl(d);if(m&&m.publicUrl)return m.publicUrl}}if(a)return null;try{const l=await J._downscaleImage(n,1200);if(l)return l}catch{}return URL.createObjectURL(e)}catch{return Ve(e)?null:URL.createObjectURL(e)}}async function ro(){if(!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform()))return null;try{const{Camera:e,MediaTypeSelection:t}=await Ci(async()=>{const{Camera:n,MediaTypeSelection:s}=await import("@capacitor/camera");return{Camera:n,MediaTypeSelection:s}},[]),{results:i}=await e.chooseFromGallery({mediaType:t.All,allowMultipleSelection:!0,includeMetadata:!0}),a=[];for(const n of i||[])if(n.webPath)try{const s=n.type===1,o=(n.metadata&&n.metadata.format||(s?"mp4":"jpg")).toLowerCase().replace(/^jpeg$/,"jpg"),r=await fetch(n.webPath).then(l=>l.blob());a.push(new File([r],`gallery-${Date.now()}-${Math.random().toString(36).slice(2)}.${o}`,{type:r.type||(s?"video/mp4":"image/jpeg")}))}catch{}return a}catch(e){return console.warn("Native gallery picker unavailable:",e),null}}window.pickMediaForForm=async function(e){if(!!!(window.Capacitor&&window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())){document.getElementById(e)?.click();return}const i=await ro();!i||!i.length||(e==="s1-img-upload"?await handleStep1Files(i):await Za(i))};window.removeImage=function(e){const t=document.getElementById("image-preview");if(!t)return;const i=[...t.children];i[e]&&i[e].remove(),ut(),Lt(),Xe()};window.replaceImage=async function(e,t){const i=document.getElementById("image-preview");if(!i||!t||!t.files||!t.files[0])return;const a=t.files[0],n=a.type==="application/pdf"||Ke(a.name),s=Ve(a);if(!a.type.startsWith("image/")&&!n&&!s){y("Please choose an image, video, or PDF file.","error");return}if(s&&a.size>100*1024*1024){y("Video must be under 100 MB.","error");return}const o=await ei(a);if(!o)return;const l=[...i.querySelectorAll(".img-thumb")][e];l&&(l.outerHTML=De(o,e),ut(),Lt(),Xe(),y(n?"Document replaced. Save to apply.":s?"Video replaced. Save to apply.":"Image replaced. Save to apply.","info"))};function ut(){const e=document.getElementById("image-preview"),t=document.getElementById("image-url-inputs");!e||!t||(t.innerHTML="",[...e.querySelectorAll(".img-thumb")].forEach((i,a)=>{const n=i.dataset.url||(i.querySelector("img")?i.querySelector("img").src:"");if(!n)return;const s=document.createElement("input");s.type="hidden",s.name="images",s.id=`img-url-${a}`,s.value=n,t.appendChild(s),i.dataset.index=a;const o=i.querySelector(".rm");o&&o.setAttribute("onclick",`removeImage(${a})`);const r=i.querySelector(".rp");r&&r.setAttribute("onclick",`document.getElementById('rp-input-${a}').click()`);const l=i.querySelector(".rp-input");l&&(l.id=`rp-input-${a}`,l.onchange=()=>replaceImage(a,l))}))}function Lt(){const e=document.getElementById("image-preview");e&&[...e.querySelectorAll(".img-thumb")].forEach((t,i)=>{t.classList.toggle("cover-img",i===0);const a=Be(t.dataset.url);t.title=i===0?"Cover (main)":(a?"Video ":"Image ")+(i+1)})}function Xe(){const e=document.getElementById("image-preview"),t=document.getElementById("gallery-counter");if(!e||!t)return;const i=[...e.querySelectorAll(".img-thumb")],a=i.length,n=i.filter(o=>Be(o.dataset.url)).length,s=a-n;if(a===0)t.textContent="No media yet — you can still save and publish anytime";else{const o=[];s>0&&o.push(`${s} image${s>1?"s":""}`),n>0&&o.push(`${n} video${n>1?"s":""}`),t.textContent=`${o.join(" + ")} — you can save and publish anytime`}t.className="text-sm mt-1 font-bold text-gray-400"}function at(e,t){return`kco_product_form_autosave_${e}_${t||"new"}`}function lo(e){const t=new FormData(e),i={images:[],tags:[],fields:{}};for(const[a,n]of t.entries())a==="images"?n&&!String(n).startsWith("blob:")&&i.images.push(String(n)):a==="tags"?i.tags.push(String(n)):i.fields[a]=String(n);return i.fields.is_featured=e.querySelector('[name="is_featured"]')?.checked?"on":"",i.fields.is_active=e.querySelector('[name="is_active"]')?.checked?"on":"",i}function co(e,t){if(!t||typeof t!="object")return!1;const i=t.fields||{};Object.entries(i).forEach(([n,s])=>{const o=e.querySelector(`[name="${n}"]`);o&&(o.type==="checkbox"?o.checked=s==="on"||s===!0:o.value=s==null?"":String(s))});const a=Array.isArray(t.tags)?t.tags:[];if(e.querySelectorAll('input[name="tags"]').forEach(n=>{n.checked=a.includes(n.value)}),Array.isArray(t.images)){const n=document.getElementById("image-preview");n&&(n.innerHTML=t.images.map((s,o)=>De(s,o)).join(""),ut(),Lt(),Xe())}return!0}function Na(){const e=document.getElementById("product-review-content"),t=document.getElementById("product-form");if(!e||!t)return;const i=t.querySelector('[name="title"]')?.value||"Untitled Product",a=t.querySelector('[name="brand"]')?.value||"N/A",n=parseFloat(t.querySelector('[name="price"]')?.value||"0")||0,s=parseFloat(t.querySelector('[name="real_price"]')?.value||"0")||0,o=t.querySelector('[name="stock_quantity"]')?.value,r=o===""||o==null?"Unlimited":o,l=B.section==="products"&&document.querySelector("#product-form")?.dataset?.category||"",d=[...t.querySelectorAll('input[name="tags"]:checked')].map(f=>f.value),u=document.querySelectorAll("#image-preview .img-thumb").length,m=t.querySelector('[name="is_active"]')?.checked;e.innerHTML=`
    <div class="grid grid-cols-2 gap-2">
...
`}const vo=/^(n\/?a|none|unknown|not (available|specified|found|visible|applicable)|null|undefined|-{1,}|no data)$/i;function $a(e,t){const i={...t||{}},a=new Set(Array.isArray(i.estimated)?i.estimated.map(u=>String(u)):[]),n=new Set(Array.isArray(i.missing_fields)?i.missing_fields.map(u=>String(u)):[]),s=[],o=[],r=u=>{if(u==null)return"";Array.isArray(u)&&(u=u.filter(f=>f!=null&&String(f).trim()!=="").join(", "));let m=String(u).replace(/\s+/g," ").trim();return m=m.replace(/^(answer|value|result|extracted)\s*[:\-]\s*/i,""),m},l=u=>{const m=r(u).replace(/[^0-9.,\-]/g,"").replace(/,(?=\d{3}\b)/g,"").replace(",","."),f=parseFloat(m);return Number.isFinite(f)?f:NaN};for(const u of e||[]){if(gn.has(u.key))continue;const m={key:u.key,label:u.label,status:"empty-ok",value:null,note:""};if(u.type==="checkbox-group"){const p=Array.isArray(i[u.key])?i[u.key].map(r).filter(Boolean):[],g=u.options&&u.options.length?p.filter(h=>u.options.includes(h)):p;g.length?(i[u.key]=g,m.status="filled",m.value=g.join(", ")):(delete i[u.key],p.length&&(m.status="flagged",m.note="values not in the allowed badge list were dropped",o.push(`${u.label}: invalid selection ignored`))),s.push(m);continue}if(!(i[u.key]!=null&&r(i[u.key])!=="")){m.status=n.has(u.key)?"missing":"empty-ok",s.push(m);continue}if(vo.test(r(i[u.key]))){delete i[u.key],n.add(u.key),m.status="missing",m.note="document/AI said the value is unavailable",s.push(m);continue}if(u.type==="number"){const p=r(i[u.key]),g=l(i[u.key]);if(!Number.isFinite(g)){delete i[u.key],n.add(u.key),m.status="flagged",m.note=`"${p}" is not a valid number`,o.push(`${u.label}: not a valid number`),s.push(m);continue}if(/year/.test(u.key)&&(g<1800||g>new Date().getFullYear()+2)){delete i[u.key],n.add(u.key),m.status="flagged",m.note=`${g} is outside the plausible range`,o.push(`${u.label}: implausible value ${g}`),s.push(m);continue}i[u.key]=g,m.status="filled",m.value=String(g),a.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),s.push(m);continue}if(u.type==="select"&&u.options&&u.options.length){const p=bn({options:u.options.map(g=>({value:g}))},r(i[u.key]));if(p==null){m.status="flagged",m.note=`"${r(i[u.key])}" does not match any option â€” left empty`,o.push(`${u.label}: no matching option`),delete i[u.key],n.add(u.key),s.push(m);continue}i[u.key]=p,m.status="filled",m.value=p,p!==r(t?.[u.key])&&(m.note="matched to the closest option"),s.push(m);continue}let v=r(i[u.key]);u.type!=="textarea"&&u.type!=="text-long"&&v.length>120&&!["title"].includes(u.key)&&(m.status="flagged",m.note="unusually long â€” check it landed in the right field",o.push(`${u.label}: suspiciously long value`)),i[u.key]=v,m.status="filled",m.value=v.length>48?v.slice(0,48)+"â€¦":v,a.has(u.key)&&(m.status="estimated",m.note="AI estimate â€” confirm"),s.push(m)}if(e&&e.length){const u=new Set([...e.map(m=>m.key),"estimated","missing_fields","features","highlights","seo_keywords"]);Object.keys(i).forEach(m=>{u.has(m)||delete i[m]})}i.missing_fields=s.filter(u=>u.status==="missing").map(u=>u.key),i.estimated=s.filter(u=>u.status==="estimated").map(u=>u.key);const d={total:s.length,filled:s.filter(u=>u.status==="filled").length,estimated:s.filter(u=>u.status==="estimated").length,flagged:s.filter(u=>u.status==="flagged").length,missing:s.filter(u=>u.status==="missing").length};return{specs:i,checklist:s,flags:o,summary:d}}const zt={activeProvider:"gemini",maxImages:4,PROVIDERS:{gemini:{label:"Google Gemini (Free Tier)",scan:async(e,t)=>{const i=typeof t.onProgress=="function"?t.onProgress:()=>{};i(1,"Identifying the exact product from your imagesâ€¦");const a=await J.identifyProduct(e,t);if(!a||a.identified===!1)return{identification:a,specs:null,price:null};i(2,"Completing specifications and estimating a fair market priceâ€¦");const n=await J.completeSpecsAndPrice(e,a,t).catch(()=>null);return{identification:a,specs:n?n.specs:null,price:n?n.price:null}}}},async scan(e,t){const i=this.PROVIDERS[this.activeProvider];if(!i)throw new Error(`Scanner provider "${this.activeProvider}" is not configured.`);return i.scan(e||[],t)}};function bn(e,t){const i=[...e.options||[]].map(o=>o.value).filter(Boolean);if(i.includes(String(t)))return String(t);const a={petrol:"Gasoline",gas:"Gasoline",gasoline:"Gasoline",unleaded:"Gasoline",ev:"Electric",electric:"Electric","fully electric":"Electric",hybrid:"Hybrid","hybrid electric":"Hybrid","plug-in hybrid":"Plug-in Hybrid",phev:"Plug-in Hybrid",auto:"Automatic",automatic:"Automatic","automatic transmission":"Automatic",manual:"Manual","manual transmission":"Manual",cvt:"CVT","continuously variable":"CVT","dual clutch":"Dual-Clutch",dct:"Dual-Clutch",fwd:"FWD","front-wheel drive":"FWD","front wheel drive":"FWD",rwd:"RWD","rear-wheel drive":"RWD","rear wheel drive":"RWD",awd:"AWD","all-wheel drive":"AWD","all wheel drive":"AWD","4wd":"4WD","four-wheel drive":"4WD","four wheel drive":"4WD","4x4":"4WD",sedan:"Sedan",saloon:"Sedan",suv:"SUV",hatchback:"Hatchback",coupe:"Coupe","coupÃ©":"Coupe",convertible:"Convertible",wagon:"Wagon",estate:"Wagon",pickup:"Pickup","pick up":"Pickup",van:"Van",truck:"Truck","sports car":"Sports Car",motorcycle:"Motorcycle",yacht:"Yacht","like new":"Used - Like New","used - like new":"Used - Like New"},n=String(t).toLowerCase().trim();return a[n]?a[n]:i.find(o=>o.toLowerCase().includes(n)||n.includes(o.toLowerCase()))||null}function wo(e,t,i,a){const n={},s=[],o=new Map((a||[]).map(v=>[v.key,v])),r=v=>o.has(v),l=v=>t[v]==null||String(Array.isArray(t[v])?t[v].join(", "):t[v]).trim()==="",d=(v,p)=>{if(p==null||String(p).trim()==="")return;const g=o.get(v);!g||!l(v)||g.type==="select"&&g.options&&g.options.length&&!g.options.includes(p)||(n[v]=p,s.push(v))},u=i||{},m=/cars?|trucks?|vehicle|motor|marine/i.test(String(e||""))||u.listing_type==="vehicle"||!!u.body_type,f=/estate|propert|real|house|villa|home|land/i.test(String(e||""))||u.listing_type==="property"||!!u.property_type;if(m){const v=String(t.body_type||u.body_type||""),p=v.toLowerCase(),g=[t.engine,t.trim,t.mileage,t.fuel_economy,t.title,u.model,u.brand,v,t.wheels_tires].filter(Boolean).join(" ").toLowerCase(),h=parseInt(String(t.model_year||u.year||""),10);let _="";/plug[ -]?in|phev/.test(g)?_="Plug-in Hybrid":/hybrid|hev|mhev/.test(g)?_="Hybrid":/electric|tesla|\bbev\b|single[- ]?speed/.test(g)?_="Electric":/lpg|gpl|autogas|cng/.test(g)?_="LPG":/bio[- ]?diesel/.test(g)?_="Bio-diesel":/diesel|tdi|\bhdi\b|\bcrdi\b|\bcdti\b|\bd4d\b|\bdci\b|turbo[- ]?d/.test(g)?_="Diesel":(/gasoline|petrol|\bgas\b|unleaded/.test(g),_="Gasoline"),d("fuel_type",_);let x="";/manual|\bstick\b/.test(g)?x="Manual":/cvt|continuously/.test(g)?x="CVT":/dual[- ]?clutch|\bdct\b/.test(g)?x="Dual-Clutch":/semi[- ]?automatic|\bamt\b/.test(g)?x="Semi-Automatic":/automatic|\bauto\b|shift[- ]?tronic|torque[- ]?converter|\d[ -]?speed/.test(g)?x="Automatic":x=Number.isFinite(h)&&h<2014?"Manual":"Automatic",d("transmission",x);let w="";/4wd|\b4x4\b|four[- ]?wheel|quad/.test(g)?w="4WD":/awd|all[- ]?wheel/.test(g)?w="AWD":/rwd|rear[- ]?wheel/.test(g)?w="RWD":/fwd|front[- ]?wheel/.test(g)?w="FWD":/pickup|truck/.test(p)?w="4WD":/suv/.test(p)?w="AWD":/motorcycle/.test(p)?w="RWD":w="FWD",d("drive_type",w);const E={sedan:5,hatchback:5,coupe:4,convertible:4,wagon:5,suv:5,"sports car":2,"luxury sedan":5,pickup:5,truck:3,van:8,bus:20,motorhome:6,motorcycle:2,yacht:6,"jet ski":2},P={sedan:4,hatchback:5,coupe:2,convertible:2,wagon:5,suv:5,"sports car":2,"luxury sedan":4,pickup:4,truck:4,van:5,bus:2,motorhome:3,motorcycle:0,"jet ski":0};for(const[N,G]of[["seating_capacity",E],["doors",P]]){if(!r(N))continue;const ue=Object.entries(G).find(([ne])=>p.includes(ne));ue&&d(N,String(ue[1]))}const $=String(t.vehicle_type||u.vehicle_type||"").toLowerCase();!v&&r("body_type")&&(/motorhome|rv/.test($)?d("body_type","Motorhome"):/jet/.test($)?d("body_type","Jet Ski"):/marine|boat|yacht/.test($)?d("body_type","Yacht"):/bus/.test($)?d("body_type","Bus"):/motorcycle/.test($)?d("body_type","Motorcycle"):/truck/.test($)&&d("body_type","Truck"));const A=String(t.condition||"").toLowerCase();!t.mileage&&/new/.test(A)&&r("mileage")&&d("mileage","0 mi"),!t.condition&&r("condition")&&d("condition","Used - Good"),!t.previous_owners&&r("previous_owners")&&d("previous_owners",/new/.test(A)?"None (new)":"1"),!t.registration_status&&r("registration_status")&&d("registration_status","Registered"),!t.inspection_status&&r("inspection_status")&&d("inspection_status","Not Inspected"),!t.warranty&&r("warranty")&&d("warranty","Manufacturer warranty - confirm remaining coverage with the seller")}if(f){const v=String(t.property_type||u.property_type||"").toLowerCase(),p=String(t.building_size||t.floor_plan_total_area||""),g=parseFloat(p.replace(/[^0-9.]/g,""));let h=null,_=null;if(Number.isFinite(g)&&g>100&&(h=Math.max(2,Math.min(6,Math.round(g/600))),_=Math.max(1,Math.min(4,h>4?3:h-1))),l("bedrooms")&&r("bedrooms")&&h&&d("bedrooms",String(h)),l("bathrooms")&&r("bathrooms")&&_&&d("bathrooms",String(_)),l("listing_status")&&r("listing_status")){const x=String(t.title||"")+" "+String(t.description||"");d("listing_status",/for rent|lease|\brent\b/.test(x.toLowerCase())?"rent":"sale")}if(l("furnished")&&r("furnished")&&d("furnished",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Unfurnished":"Furnished"),l("condition")&&r("condition")&&d("condition","Good"),l("floors")&&r("floors")){const x=/mansion|villa|townhouse/.test(v)?"2":/apartment|condo|single/.test(v)?"1":null;x&&d("floors",x)}l("kitchens")&&r("kitchens")&&d("kitchens","1"),l("parking_spaces")&&r("parking_spaces")&&/car|garage|parking/.test(String(t.garage||"").toLowerCase())&&d("parking_spaces","1"),l("property_type")&&r("property_type")&&d("property_type",/land|plot|acre/.test(v+" "+String(t.land_size||""))?"Land":"Single-Family Home")}return{specs:n,estimated:s}}function hi(e){const t=[];return e.year&&t.push(e.year),e.brand&&t.push(e.brand),e.model&&t.push(e.model),!e.model&&e.body_type&&t.push(e.body_type),t.join(" ")||e.detected_name||""}const ti=new Set(["images","tags","currency","catalog_template_id","country_code","listing_type","category","property_id","id","slug","user_id","latitude","longitude","cover_image","video_url"]);function ai(e,{titleFallback:t="Product",descriptionFallback:i="",visionUsed:a=!0}={}){const n=document.querySelector(e);if(!n||!a)return 0;let s=0;return n.querySelectorAll("input, textarea, select").forEach(o=>{const r=String(o.name||"").trim();if(!r||ti.has(r))return;const l=String(o.type||"").toLowerCase();if(!["hidden","checkbox","radio","file","submit","button","image","password"].includes(l)&&!o.disabled&&String(o.value||"").trim()===""){if(r==="price"||r==="real_price"){const d=Number.isFinite(Number(U))?Number(U):1;o.value=String(d),s++;return}if(r==="stock_quantity"){o.value="1",s++;return}if(r==="title"){o.value=t,s++;return}if(r==="description"){o.value=i||`${t} â€” full details to be confirmed by the seller. Review and edit everything before publishing.`,s++;return}if(l==="number"||l==="range"||l==="tel"){o.value="0",s++;return}}}),s}function xo(e,t={}){const i=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,s=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,o=[],r=P=>Array.isArray(P)?P.join(", "):String(P??"").trim(),l=(P,$,A)=>{if($==null||r([$])==="")return;const N=document.querySelector(`#product-form [name="${P}"]`);if(!N)return;let G=String($);if(A&&!A.includes(G)){const ue=bn(N,G);if(ue===null)return;G=ue}N.value=G,o.push(P)};l("brand",i.brand),l("model",i.model),l("color",i.color),l("condition",i.condition,po),l("subcategory",i.subcategory),l("body_type",i.body_type||a.body_type,mo),l("model_year",a.model_year||i.year),l("title",a.title||hi(i)),l("description",a.description),l("engine",a.engine),l("transmission",a.transmission,go),l("fuel_type",a.fuel_type,bo),l("drive_type",a.drive_type,yo),l("horsepower",a.horsepower),l("mileage",a.mileage),l("seating_capacity",a.seating_capacity),l("doors",a.doors),l("safety_features",r(a.safety_features)),l("storage",a.storage),l("ram",a.ram),l("processor",a.processor),l("display",a.display),l("graphics",a.graphics),l("os",a.os),l("material",a.material),l("size",a.size),l("gender",a.gender),l("platform",a.platform),l("type",a.type||i.type),l("age_range",a.age_range),l("skin_type",a.skin_type),l("ingredients",a.ingredients),l("dimensions",a.dimensions),l("author",a.author),l("publisher",a.publisher),l("language",a.language),l("format",a.format),l("isbn",a.isbn),l("pages",a.pages),l("edition",a.edition),l("quantity",a.quantity),l("pet_type",a.pet_type),l("lens",a.lens),l("sensor",a.sensor),l("megapixels",a.megapixels),l("video",a.video),l("license",a.license),l("version",a.version),l("duration",a.duration),l("followers",a.followers),l("engagement",a.engagement),l("niche",a.niche),l("usage",a.usage),l("shelf_life",a.shelf_life),l("assembly",a.assembly),l("weatherproof",a.weatherproof),l("warranty",a.warranty||i.warranty),l("availability_status",a.availability_status),l("features_text",r(a.features)),l("highlights_text",r(i.highlights||a.highlights)),l("seo_keywords_text",r(a.seo_keywords));const d=new Set((Array.isArray(a.tags)?a.tags:[]).map(P=>String(P).trim()));document.querySelectorAll('#product-form input[name="tags"]').forEach(P=>{d.has(P.value)&&(P.checked=!0,o.push("tags"))});const u=Number(a.stock_quantity);Number.isFinite(u)&&u>0&&l("stock_quantity",u);const m=document.querySelector('#product-form [name="price"]'),f=document.querySelector('#product-form [name="real_price"]'),v=n?Number(n.estimated_price):NaN,p=n?Number(n.suggested_discount_price):NaN,g=Number.isFinite(Number(U))?Number(U):0,h=Number.isFinite(Number(Y))?Number(Y):999999999,_=P=>Math.max(g,Math.min(h,Math.round(P)));if(Number.isFinite(v)&&v>0){f&&(f.value=String(_(v)),o.push("real_price"));const P=Number.isFinite(p)&&p>0&&p<v?p:v;m&&(m.value=String(_(P)),o.push("price"))}const x=hi(i)||i.detected_name||"Product",w=a.description||`${x} for sale on Weverse Online Shop. Review the details below and edit anything before publishing.`,E=ai("#product-form",{titleFallback:x,descriptionFallback:w,visionUsed:s});return E&&o.push(`${E} auto-completed (safe defaults)`),Na(),{filled:o}}function pt(e){const t=String(e||"").trim().toLowerCase(),i=Re.find(o=>o.toLowerCase()===t);if(i)return{category:i,listing_type:null};if(/(house|villa|apartment|condo|mansion|land|estate|real estate|property|building|bungalow|townhouse|ranch|farmhouse)/.test(t))return{category:null,listing_type:"property"};const a={bag:"Fashion",bags:"Fashion",handbag:"Fashion",handbags:"Fashion",backpack:"Fashion",backpacks:"Fashion",purse:"Fashion",wallet:"Fashion",wallets:"Fashion",luggage:"Travel & Luggage",sneaker:"Fashion",sneakers:"Fashion",shoe:"Fashion",shoes:"Fashion",boot:"Fashion",boots:"Fashion",footwear:"Fashion",sandal:"Fashion",sandals:"Fashion",heel:"Fashion",heels:"Fashion",phone:"Phones",smartphone:"Phones",smartphones:"Phones",iphone:"Phones","mobile phone":"Phones",laptop:"Computers",laptops:"Computers",computer:"Computers",notebook:"Computers",macbook:"Computers",pc:"Computers",desktop:"Computers",electronics:"Electronics",electronic:"Electronics",gadget:"Electronics",gadgets:"Electronics",tv:"Electronics",television:"Electronics",headphones:"Electronics",speaker:"Electronics",speakers:"Electronics",soundbar:"Electronics",tablet:"Electronics",earbuds:"Electronics",camera:"Cameras & Photography",cameras:"Cameras & Photography",dslr:"Cameras & Photography",drone:"Cameras & Photography",jewelry:"Jewelry",jewellery:"Jewelry",ring:"Jewelry",necklace:"Jewelry",earring:"Jewelry",earrings:"Jewelry",bracelet:"Jewelry",watch:"Watches & Accessories",watches:"Watches & Accessories",wristwatch:"Watches & Accessories","smart watch":"Watches & Accessories",clothing:"Fashion",clothes:"Fashion",fashion:"Fashion",shirt:"Fashion",shirts:"Fashion",dress:"Fashion",dresses:"Fashion",jacket:"Fashion",jackets:"Fashion",hoodie:"Fashion",jeans:"Fashion","t-shirt":"Fashion",tshirt:"Fashion",apparel:"Fashion","men's fashion":"Men","mens fashion":"Men","women's fashion":"Women","womens fashion":"Women",car:"Cars",cars:"Cars",vehicle:"Cars",vehicles:"Cars",automobile:"Cars",suv:"Cars",sedan:"Cars","luxury car":"Cars","luxury cars":"Cars",truck:"Trucks",trucks:"Trucks",trailer:"Trucks",bus:"Trucks",motorcycle:"Motorcycles",motorbike:"Motorcycles","motor bike":"Motorcycles",bicycle:"Bicycles",bicycles:"Bicycles",cycling:"Bicycles",bike:"Bicycles",motorhome:"RV & Camper Accessories",motorhomes:"RV & Camper Accessories",camper:"RV & Camper Accessories",rv:"RV & Camper Accessories",boat:"Marine & Boating",boats:"Marine & Boating",yacht:"Marine & Boating",jet:"Marine & Boating",beauty:"Beauty",skincare:"Beauty",cosmetics:"Beauty",makeup:"Beauty",perfume:"Beauty",kitchen:"Kitchen",appliance:"Home Appliances",appliances:"Home Appliances",blender:"Kitchen",kettle:"Kitchen",cookware:"Kitchen",vacuum:"Home Appliances",furniture:"Furniture",sofa:"Furniture",chair:"Furniture",chairs:"Furniture",table:"Furniture",tables:"Furniture",bed:"Furniture",mattress:"Furniture",desk:"Furniture",toy:"Toys & Hobbies",toys:"Toys & Hobbies",game:"Gaming",games:"Gaming",gaming:"Gaming",console:"Gaming",food:"Food & Groceries",groceries:"Food & Groceries",snack:"Food & Groceries",snacks:"Food & Groceries",beverage:"Food & Groceries",baby:"Baby",kids:"Kids",stroller:"Baby",health:"Health & Medical",medical:"Health & Medical",supplement:"Health & Medical",fitness:"Sports",sport:"Sports",sports:"Sports",gym:"Sports",dumbbell:"Sports",book:"Books",books:"Books",textbook:"Books",novel:"Books",stationery:"Office",office:"Office",printer:"Office",pen:"Office",pet:"Pets",pets:"Pets",dog:"Pets",cat:"Pets",musical:"Musical Instruments",guitar:"Musical Instruments",piano:"Musical Instruments",instrument:"Musical Instruments",drum:"Musical Instruments",software:"Software & Digital Products",digital:"Software & Digital Products",account:"Software & Digital Products",accounts:"Software & Digital Products",instagram:"Software & Digital Products",tiktok:"Software & Digital Products",camping:"Camping & Hiking",tent:"Camping & Hiking",hiking:"Camping & Hiking",flower:"Flowers & Gifts",flowers:"Flowers & Gifts",gift:"Flowers & Gifts",gifts:"Flowers & Gifts",wedding:"Wedding Supplies",party:"Party & Event Supplies",coin:"Coins & Bullion",coins:"Coins & Bullion",art:"Arts & Crafts",painting:"Arts & Crafts",craft:"Arts & Crafts"},n=a[t]||a[t.replace(/s$/,"")]||a[t.replace(/\s+/g," ")];if(n)return{category:n,listing_type:null};for(const o of Re)if(t.includes(o.toLowerCase())||t.length>2&&o.toLowerCase().includes(t))return{category:o,listing_type:null};return{category:Xn(t)||"Other",listing_type:null}}function _o(e){const t=String(e||"").toLowerCase().trim();if(!t)return null;const i=Ua.find(n=>n.toLowerCase()===t);return i||Ua.find(n=>n.toLowerCase().includes(t)||t.includes(n.toLowerCase()))||null}window._resolveScanConfirm=function(e,t){};let I=[],Ae=[],oe="",de=-1;const Fa="scanner-scan-status";let te=!1,yn=0,Ie=0,ae=0,qe=!1,vi=0,ko=0,fn=0,it=0;function pa(e,t){const a=(Array.isArray(e.image_indices)?e.image_indices:[]).map(n=>t[n]).filter(Boolean);return a.length?a:t}function ii(e,t,i,a){const n=pt(e.category),s=e.listing_type==="property"||n&&n.listing_type==="property",o=s?"Real Estate":n.category||e.category||"Other",r=e.confidence||"medium",l={high:"bg-emerald-500/10 text-emerald-400 border-emerald-500/20",medium:"bg-amber-500/10 text-amber-400 border-amber-500/20",low:"bg-red-500/10 text-red-400 border-red-500/20"}[r]||"bg-amber-500/10 text-amber-400 border-amber-500/20",d=pa(e,Ae).slice(0,3);return`
  <div class="scan-review-card rounded-xl border border-violet-500/30 bg-violet-500/10 p-3 space-y-2 fade-in" data-i="${t}">
  ...
  </div>`}window.scanReviewRender=function(){if(oe==="scanner-scan-status"){scanStreamRender();return}const e=document.getElementById(oe);if(!e)return;if(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),!I.length){e.classList.add("text-gray-400"),e.textContent="All detected products were removed — nothing was changed.";return}const t={};for(const i of I){const a=z(i.brand),n=z(i.model),s=z(i.detected_name),o=a&&n?`${a}::${n}`:s||`${a}::${n}`;o&&(t[o]=(t[o]||0)+1)}e.classList.add("text-gray-100"),e.innerHTML=`
    <div class="space-y-3">
      <div>
      ...
      ${I.map((i,a)=>{const n=z(i.brand),s=z(i.model),o=z(i.detected_name),r=n&&s?`${n}::${s}`:o||`${n}::${s}`;return ii(i,a,r&&t[r]>1)}).join("")}
    </div>`,window.lucide&&lucide.createIcons()};window.scanReviewContinue=async function(e){const t=I[e];if(!t)return;de=e;const i=pa(t,Ae),a=pt(t.category);if(t.listing_type==="property"||a&&a.listing_type==="property"){(oe==="s1-scan-status"||oe==="scanner-scan-status")&&(le(),Pe=[]),Uo(t,i);return}const s=a.category||t.category||"Other";if(oe==="s1-scan-status"||oe==="scanner-scan-status"){try{localStorage.removeItem(at(s,""))}catch{}Pe=[];let o=t.property_id?ze[t.property_id]:null;o&&o.specifications&&typeof o.specifications=="object"&&(o={...o,...o.specifications}),showAddProductStep2(s,o?{...o,images:i}:{images:i}),await $t(t,i,s)}else{const o=document.getElementById("product-form"),r=o&&o.dataset.category||"";if(s!==r){try{localStorage.removeItem(at(s,""))}catch{}switchProductFormCategory(s);const l=document.getElementById(oe);l&&(l.classList.remove("hidden"),l.classList.add("text-blue-300"),l.textContent=`Category changed to ${s} â€” finishing the scanâ€¦`),window.lucide&&lucide.createIcons()}await $t(t,i,s)}};window.scanReviewEdit=function(e){const t=I[e];if(!t)return;const i=document.querySelector(`.scan-review-card[data-i="${e}"]`);if(!i)return;const a=pt(t.category),s=t.listing_type==="property"||a&&a.listing_type==="property"?"Real Estate":a.category||t.category||"Other",o=Re.map(r=>`<option value="${c(r)}" ${r===s?"selected":""}>${c(r)}</option>`).join("");i.innerHTML=`
    ...
    </div>`};window.scanReviewApplyEdit=function(e){const t=I[e];if(!t)return;const i=document.getElementById(`sr-name-${e}`)?.value,a=document.getElementById(`sr-brand-${e}`)?.value,n=document.getElementById(`sr-model-${e}`)?.value,s=document.getElementById(`sr-cat-${e}`)?.value;i&&(t.detected_name=i),a&&(t.brand=a),n&&(t.model=n),s&&(t.category=s),scanReviewRender()};window.scanReviewRemove=function(e){I.splice(e,1),scanReviewRender()};window.scanReviewDelete=async function(e){const t=I[e];if(!t)return;const i=t.property_id;if(!i){I.splice(e,1),scanReviewRender();return}if(confirm(`Permanently delete "${t.detected_name||"this product"}" from the database and showroom?`)){try{await b.from("showroom_listings").delete().eq("property_id",i),Pt(i);try{await ct(i,!0)}catch{}}catch{}I.splice(e,1),scanReviewRender(),y(`${t.detected_name||"Product"} deleted`)}};window.scanReviewCancel=function(){const e=document.getElementById(oe);e&&(e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300"),e.classList.add("text-gray-400"),e.textContent="Scan cancelled — nothing was changed.")};function z(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]/g,"").trim()}let se=[],he=[],ve=[];function hn(){const e=document.getElementById(Fa);if(!e)return;e.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),e.classList.add("text-gray-100");const t=he.reduce((i,a)=>i+a.length-1,0);e.innerHTML=`
    <div class="space-y-3">
      ...
      ${se.map((i,a)=>{const n=pt(i[0].category),s=n&&!n.listing_type&&(n.category||i[0].category)||"Other";return`
        <div class="rounded-xl border border-amber-500/25 bg-amber-500/8 p-3 space-y-2">
          ...
          ${i.map((o,r)=>{const l=ve.indexOf(o);return`
    ...
    </div>`,window.lucide&&lucide.createIcons()}window.dupReviewDelete=async function(e,t,i){const a=se[e],n=a[t];if(!n)return;const s=n.property_id;if(!confirm(`Permanently delete "${n.detected_name||"this product"}" from the database and showroom?`))return;if(s)try{await b.from("showroom_listings").delete().eq("property_id",s),Pt(s);try{await ct(s,!0)}catch{}}catch{}a.splice(t,1),a.length<2&&se.splice(e,1),he=se.filter(r=>r.length>1),ve.splice(i,1),se=[];const o={};for(const r of ve){const l=z(r.brand),d=z(r.model),u=z(r.detected_name),m=l&&d?`${l}::${d}`:u||`${l}::${d}`;m&&(o[m]=o[m]||[]).push(r)}if(se=Object.values(o).filter(r=>r.length>1),he=se,y(`${c(n.detected_name||"Product")} deleted`),!he.length){dupReviewFinish();return}hn()};window.dupReviewDeleteGroup=async function(e){const t=se[e];if(!t||!confirm(`Permanently delete ${t.length-1} duplicate listing${t.length-1>1?"s":""} in this group from the database and showroom?`))return;for(let a=t.length-1;a>=1;a--){const n=t[a],s=n.property_id;if(s)try{await b.from("showroom_listings").delete().eq("property_id",s),Pt(s);try{await ct(s,!0)}catch{}}catch{}const o=ve.indexOf(n);o>=0&&ve.splice(o,1)}y(`Deleted ${t.length-1} duplicate${t.length>2?"s":""} from group ${e+1}`),se=[];const i={};for(const a of ve){const n=z(a.brand),s=z(a.model),o=z(a.detected_name),r=n&&s?`${n}::${s}`:o||`${n}::${s}`;r&&(i[r]=i[r]||[]).push(a)}if(se=Object.values(i).filter(a=>a.length>1),he=se,!he.length){dupReviewFinish();return}hn()};window.dupReviewDeleteAll=async function(){const e=he.reduce((i,a)=>i+a.length-1,0);if(!confirm(`Permanently delete ALL ${e} duplicate listing${e!==1?"s":""} from the database and showroom? This cannot be undone.`))return;let t=0;for(const i of se)for(let a=i.length-1;a>=1;a--){const n=i[a],s=n.property_id;if(s)try{await b.from("showroom_listings").delete().eq("property_id",s),Pt(s);try{await ct(s,!0)}catch{}}catch{}const o=ve.indexOf(n);o>=0&&ve.splice(o,1),t++}y(`Deleted ${t} duplicate listing${t!==1?"s":""}`),dupReviewFinish()};window.dupReviewFinish=function(){if(I=ve.slice(),se=[],he=[],ve=[],T(),I.length){const e=document.getElementById(Fa);e&&(e.classList.remove("hidden","text-red-400","text-amber-300","text-blue-300","text-gray-400"),e.classList.add("text-gray-100"),e.innerHTML=`
        <div class="space-y-3">
          ...
          ${I.map((t,i)=>ii(t,i)).join("")}
        </div>`,window.lucide&&lucide.createIcons())}else{const e=document.getElementById(Fa);e&&(e.classList.remove("hidden","text-blue-300","text-amber-300"),e.classList.add("text-gray-400"),e.textContent="All duplicates removed — nothing left to publish."),y("All duplicates removed.","info")}};let ht=null;async function vn(){if(ht)return ht;let e={};try{const{data:n}=await b.from("site_settings").select("site_name,brand_name,contact_email,contact_phone,whatsapp_number").limit(1).maybeSingle();e=n||{}}catch{}const t=String(e.site_name||e.brand_name||"").trim(),i=String(e.contact_phone||e.whatsapp_number||"").trim(),a=String(e.contact_email||"").trim();return!t&&!i&&!a?ht={name:"Company",phone:"",email:""}:ht={name:t,phone:i,email:a},ht}async function wn(e,t={}){const i=e&&e.identification&&e.identification.identified!==!1?e.identification:{},a=e&&e.specs?e.specs:{},n=e&&e.price?e.price:null,s=t&&t.visionUsed!==void 0?t.visionUsed:e&&e.visionUsed!==void 0?e.visionUsed:!0,o=[],r=F=>Array.isArray(F)?F.join(", "):String(F??"").trim(),l=(F,Q)=>{if(Q==null||r([Q])==="")return;const _e=document.querySelector(`#property-form [name="${F}"]`);_e&&(_e.value=String(Q),o.push(F))},d=i.property_type||a.property_type;if(d){const F=_o(d);F&&l("property_type",F)}s&&(l("title",a.title||i.detected_name),l("description",a.description)),l("subcategory",i.subcategory||a.subcategory);const u=i.bedrooms??a.bedrooms;u!=null&&u!==""&&l("bedrooms",parseInt(u,10)||u);const m=i.bathrooms??a.bathrooms;m!=null&&m!==""&&l("bathrooms",parseInt(m,10)||m),l("building_size",i.building_size||a.building_size),l("land_size",i.land_size||a.land_size);const f=i.parking_spaces??a.parking_spaces;f!=null&&f!==""&&l("parking_spaces",parseInt(f,10)||f);const v=String(i.furnished||a.furnished||"").toLowerCase();/furnished|yes/.test(v)?l("furnished","Furnished"):/unfurnished|no|empty/.test(v)&&l("furnished","Unfurnished");const p=String(i.listing_status||a.listing_status||"").toLowerCase();/rent|lease/.test(p)?l("listing_status","rent"):/sale|buy|purchase/.test(p)&&l("listing_status","sale");const g=i.area||a.area;g&&!(i.town||a.town)&&l("town",g),l("town",i.town||a.town),l("city",i.city||a.city),l("state",i.state||a.state);const h=i.country||a.country;if(l("country",h),h){const F=($e||[]).find(Q=>String(Q.name||"").toLowerCase()===String(h).toLowerCase()||String(Q.code||"").toLowerCase()===String(h).toLowerCase());if(F&&F.code){const Q=document.querySelector('#property-form [name="country_code"]');Q&&(Q.value=F.code,o.push("country_code"))}}const _=i.address||a.address;l("product_location",_||[g||i.town||a.town,i.city||a.city,i.state||a.state,h].filter(Boolean).join(", ")),l("address",i.address||a.address),l("zip_code",i.zip_code||a.zip_code);const x=Number(i.latitude??a.latitude),w=Number(i.longitude??a.longitude);Number.isFinite(x)&&x>=-90&&x<=90&&x!==0&&l("latitude",String(x)),Number.isFinite(w)&&w>=-180&&w<=180&&w!==0&&l("longitude",String(w)),l("features_text",r(a.features)),l("highlights_text",r(i.highlights||a.highlights)),l("seo_keywords_text",r(a.seo_keywords));const E=i.half_bathrooms??a.half_bathrooms;E!=null&&E!==""&&l("half_bathrooms",parseInt(E,10)||E);const P=i.floors??a.floors;P!=null&&P!==""&&l("floors",parseInt(P,10)||P),l("garage",i.garage||a.garage);const $=i.year_built??a.year_built;$!=null&&$!==""&&l("year_built",parseInt($,10)||$);const A=i.year_renovated??a.year_renovated;A!=null&&A!==""&&l("year_renovated",parseInt(A,10)||A);const N=i.condition||a.condition,G=["New Construction","Like New","Excellent","Good","Fair","Needs Renovation"];if(N){const F=String(N).toLowerCase(),Q=G.find(_e=>F.includes(_e.toLowerCase())||_e.toLowerCase().includes(F));Q&&l("condition",Q)}l("interior_features_text",r(a.interior_features)),l("exterior_features_text",r(a.exterior_features)),l("home_systems_text",r(a.home_systems));const ue=r(i.landmarks||a.landmarks);ue&&l("landmarks_text",ue);const ne=a.floor_plan;if(ne&&typeof ne=="object"){ne.image&&l("floor_plan_image",ne.image),ne.levels&&l("floor_plan_levels",ne.levels),ne.total_area&&l("floor_plan_total_area",ne.total_area);const F=Array.isArray(ne.rooms)?ne.rooms.map(Q=>{const _e=String(Q).match(/^(.*?):\s*(.*)$/);return _e?`${_e[1].trim()}: ${_e[2].trim()}`:String(Q)}):[];F.length&&l("floor_plan_rooms",F.join(", "))}const q=a.nearby_area;q&&typeof q=="object"&&(Array.isArray(q.schools)&&q.schools.length&&l("nearby_schools_text",q.schools.join(", ")),Array.isArray(q.hospitals)&&q.hospitals.length&&l("nearby_hospitals_text",q.hospitals.join(", ")),Array.isArray(q.shopping)&&q.shopping.length&&l("nearby_shopping_text",q.shopping.join(", ")),Array.isArray(q.transportation)&&q.transportation.length&&l("nearby_transportation_text",q.transportation.join(", ")),Array.isArray(q.distances)&&q.distances.length&&l("nearby_distances_text",q.distances.join(", ")));const Ue=Array.isArray(a.legal_info)?a.legal_info.join(", "):r(a.legal_info);Ue&&l("legal_info_text",Ue),a.inspection_info&&l("inspection_info",a.inspection_info),a.risk_notes&&l("risk_notes",a.risk_notes),l("neighborhood",i.neighborhood||a.neighborhood||i.area),l("living_areas",r(a.living_areas));const je=i.kitchens??a.kitchens;je!=null&&je!==""&&l("kitchens",parseInt(je,10)||je);const R=i.balconies??a.balconies;R!=null&&R!==""&&l("balconies",parseInt(R,10)||R),l("garden",i.garden||a.garden),l("pool",i.pool||a.pool),l("security",r(a.security)),l("utilities",r(a.utilities)),l("construction_type",a.construction_type),l("construction_status",a.construction_status),l("ownership_type",a.ownership_type||i.ownership_type);const O=await vn();O.name&&l("contact_name",O.name),O.phone&&l("contact_phone",O.phone),O.email&&l("contact_email",O.email);const Nt=document.querySelector('#property-form [name="verification_status"]');s&&Nt&&(Nt.value="Not verified",o.push("verification_status"));const wa=Number.isFinite(Number(U))?Number(U):0,jn=Number.isFinite(Number(Y))?Number(Y):999999999,di=F=>Math.max(wa,Math.min(jn,Math.round(F))),ft=n?Number(n.estimated_price):NaN,Ft=n?Number(n.suggested_discount_price):NaN;if(s&&Number.isFinite(ft)&&ft>0){const F=document.querySelector('#property-form [name="real_price"]');F&&(F.value=String(di(ft)),o.push("real_price"));const Q=Number.isFinite(Ft)&&Ft>0&&Ft<ft?Ft:ft;l("price",String(di(Q)))}const ui=String(a.title||i.detected_name||"Property").trim()||"Property",qn=a.description||`${ui} available on Weverse Online Shop. Review the details below and edit anything before publishing.`,pi=ai("#property-form",{titleFallback:ui,descriptionFallback:qn,visionUsed:s});return pi&&o.push(`${pi} auto-completed (safe defaults)`),typeof window.refreshPropertyMapFromForm=="function"&&window.refreshPropertyMapFromForm(),Bo().catch(()=>{}),{filled:o}}const xn="Not provided - requires verification",wi={address:"Full street address - requires verification",zip_code:"Postal code - requires verification",neighborhood:"Neighborhood - requires verification",product_location:"Local area details - requires verification",garage:"Parking / garage details - requires verification",garden:"Outdoor space details - requires verification",pool:"Pool details - requires verification",security:"Security features - requires verification",utilities:"Utilities details - requires verification",living_areas:"Main living areas - requires verification",construction_type:"Construction material - requires verification",construction_status:"Construction status - requires verification",ownership_type:"Ownership type - requires verification",contact_name:"",contact_phone:"",contact_email:"",inspection_info:"Inspection details - requires verification",verification_date:"",documents_text:""},So=new Set(["is_active","property_id","id","documents_text","verification_date","floor_plan_image","landmarks_text","legal_info_text","risk_notes","highlights_text","seo_keywords_text"]);function xi(e){return Number.isFinite(e)?e<1?`${Math.max(0,Math.round(e*1e3))} m`:`${e.toFixed(1)} km`:"dist. TBD"}async function $o(e,t,i=4e3){const a=Number.isFinite(Number(i))&&Number(i)>0?Number(i):4e3,n=`
    [out:json][timeout:25];
    (
    ...
    </div>`),scanReviewRender(),window.lucide&&lucide.createIcons(),!0)};async function xt(e,t){const i=pa(e,Ae),a=pt(e.category),n=e.listing_type==="property"||a&&a.listing_type==="property",s=n?"Real Estate":a.category||e.category||"Other",o=yn,r=o-I.length;((d,u)=>{const m=document.getElementById("scanner-scan-status");m&&(m.classList.remove("hidden","text-red-400","text-emerald-300","text-amber-300","text-blue-300","text-gray-400"),m.classList.add(u),m.innerHTML=d)})(`Processing ${r+1} of ${o}: ${c(e.detected_name||e.title||"product")}â€¦`,"text-blue-300");try{if(n){ae++,I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1);return}let d=e.property_id?ze[e.property_id]:null;d&&d.specifications&&typeof d.specifications=="object"&&(d={...d,...d.specifications}),showAddProductStep2(s,d?{...d,images:i}:{images:i}),await new Promise(f=>setTimeout(f,250)),await $t(e,i,s);const m=document.getElementById("product-form")?.querySelector("[type=submit][name=action][value=publish]");m?(de=t,m.click()):(ae++,closeProductFormModal(),I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1))}catch{ae++,closeProductFormModal(),I.splice(t,1),I.length?xt(I[0],0):window.returnToScanReviewAfterSave(-1)}}window.openGeneralAiScanner=async function(){ni=!0;const e=await En();j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
          <h3 class="text-base font-black text-white flex items-center gap-2"><i data-lucide="scan-search" class="w-5 h-5 text-violet-400"></i> Scan Missing Prices</h3>
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`),scanStreamRender(),window.lucide&&lucide.createIcons()}window.openStreamReviewModal=jt;window.saveProduct=async function(e,t,i){e.preventDefault();const a=e.target,n=a.querySelector("[type=submit][name=action][value=publish]"),s=i?"One-Click Publish Changes":"One-Click Publish Product";if(window._productPublishInFlight)return;window._productPublishInFlight=!0,n&&(n.disabled=!0,n.style.opacity="0.75",n.innerHTML='<span style="display:inline-block;width:14px;height:14px;border:2px solid rgba(255,255,255,.4);border-top-color:#fff;border-radius:50%;animation:_pubspin .7s linear infinite;vertical-align:-2px;margin-right:8px;"></span>Publishing…');try{if(!document.getElementById("_pubspin-style")){const r=document.createElement("style");r.id="_pubspin-style",r.textContent="@keyframes _pubspin{to{transform:rotate(360deg)}}",document.head.appendChild(r)}}catch{}const o=()=>{window._productPublishInFlight=!1,n&&(n.disabled=!1,n.style.opacity="",n.textContent=s)};try{const r=new FormData(a),l={};let d=0;for(const[p,g]of r.entries())if(p==="images"){l.images=l.images||[];const h=String(g);g&&!h.startsWith("blob:")?l.images.push(h):h.startsWith("blob:")&&d++}else p==="tags"?(l.tags=l.tags||[],l.tags.push(g)):l[p]=g;if(d&&!(l.images||[]).length){o(),y("Your images were still uploading â€” please wait a moment and press Publish again (the photos were not saved with the product).","error");return}l.is_featured=a.querySelector('[name="is_featured"]')?.checked?"on":"",l.is_active=a.querySelector('[name="is_active"]')?.checked?"on":"";const u=r.get("action")==="draft",m=p=>La(p),f=p=>{const g=["model","storage","ram","processor","display","material","gender","platform","voltage","engine","transmission","fuel_type","horsepower","mileage","drive_type","body_type","model_year","seating_capacity","doors","real_price","type","size","age_range","skin_type","ingredients","dimensions","author","publisher","language","format","isbn","pages","edition","quantity","pet_type","lens","sensor","megapixels","video","license","version","duration","followers","engagement","niche","usage","shelf_life","assembly","weatherproof","movement","case_material","water_resistance","gemstone","movement_type","warranty_period"],h={};for(const _ of g){const x=p[_];if(_==="real_price"){const w=x!=null&&String(x).trim()!==""?parseFloat(x):null;h[_]=w!=null&&Number.isFinite(w)&&w>0?Math.round(w):null;continue}h[_]=x!=null&&String(x).trim()!==""?x:null}if(p.safety_features){const _=m(p.safety_features);h.safety_features=_.length?_:null}return h};if(i){let p=null;try{const{data:R}=await b.from("showroom_listings").select("*").eq("property_id",i).maybeSingle();R&&(p=Se(R))}catch{}if(p||(p=Se((window._productsData||[]).find(R=>R.property_id===i))),p||(p=Se(nt?nt(i):null)),!p)throw new Error("Could not load the current product to compare your changes against. Refresh the page, re-open the product and try again.");const g=(R,O)=>{const Nt=R===""||R==null?"":R,wa=O===""||O==null?"":O;return String(Nt).trim()===String(wa).trim()},h={};["title","description","currency","subcategory","brand","color","size","condition","warranty","availability_status"].forEach(R=>{g(l[R],p[R])||(h[R]=l[R]==null||l[R]===""?null:l[R])});const _=l.price===""||l.price==null?null:parseFloat(l.price);g(_,p.price)||(h.price=_==null?p.price:Math.max(U,Math.min(Y,_)));const x=l.stock_quantity===""||l.stock_quantity==null?null:parseInt(l.stock_quantity,10);g(x,p.stock_quantity)||(h.stock_quantity=Number.isFinite(x)?x:null);const w=m(l.features_text);g(w.join("||"),(Array.isArray(p.features)?p.features:[]).join("||"))||(h.features=w);const E=l.tags||[];g(E.join("||"),(Array.isArray(p.tags)?p.tags:[]).join("||"))||(h.tags=E);const P=m(l.highlights_text);g(P.join("||"),(Array.isArray(p.highlights)?p.highlights:[]).join("||"))||(h.highlights=P);const $=m(l.seo_keywords_text);g($.join("||"),(Array.isArray(p.seo_keywords)?p.seo_keywords:[]).join("||"))||(h.seo_keywords=$);const A=l.images||[];g(A.join("||"),(Array.isArray(p.images)?p.images:[]).join("||"))||(h.images=A);const N=A.find(R=>typeof R=="string"&&Be(R))||null;g(N,p.video_url)||(h.video_url=N);const G=l.is_featured==="on";!!p.is_featured!==G&&(h.is_featured=G);const ue=u?!1:l.is_active==="on";!!p.is_active!==ue&&(h.is_active=ue);const ne=f(l),q={...p.specifications&&typeof p.specifications=="object"?p.specifications:{},...ne};if(JSON.stringify(q)!==JSON.stringify(p.specifications||{})&&(h.specifications=q),Object.keys(h).length===0){if(te){o();try{localStorage.removeItem(at(t,i))}catch{}const R=de;closeProductFormModal(),T(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(R)&&T();return}y("No changes detected â€” nothing was saved.","info");try{localStorage.removeItem(at(t,i))}catch{}y("No changes were needed — this product is already published with exactly these details.","info"),o(),closeProductFormModal(),T();return}const Ue={...p,...h,property_id:i,updated_at:new Date().toISOString()};delete Ue.id;const je=await bi(Ue);if(je.error){if(te){ae++,o();const O=de;closeProductFormModal(),T(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(O)&&T();return}o();const R=Sa(je.error,u?"Draft save":"Product publish");y(R,"error");try{let O=a.querySelector(".__publish-error-banner");O||(O=document.createElement("div"),O.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",a.prepend(O)),O.textContent=R}catch{}return}try{Ht(Ue)}catch{}try{const R=(window._productsData||[]).findIndex(O=>O.property_id===i);R>=0&&(window._productsData[R]=Ue)}catch{}y(u?"Draft saved!":`Published Successfully â€” your product is updated and live in your showroom (${Object.keys(h).length} change${Object.keys(h).length>1?"s":""}).`)}else{if(!l.title||!l.title.trim())throw new Error("A product title is required.");if(l.price===""||l.price==null||!isFinite(parseFloat(l.price)))throw new Error("A price is required.");if(!!a.querySelector('[name="condition"]')&&!l.condition)throw new Error("Please choose the product condition.");const g={listing_type:"product",category:t,subcategory:l.subcategory||null,title:l.title.trim(),description:l.description||"",price:Math.max(U,Math.min(Y,parseFloat(l.price)||0)),currency:l.currency||"USD",country:"",country_code:"",listing_status:"sale",state:"",city:"",product_location:"",latitude:null,longitude:null,is_active:u?!1:l.is_active==="on",is_featured:l.is_featured==="on",brand:l.brand||null,color:l.color||null,size:l.size||null,condition:l.condition||null,warranty:l.warranty||null,availability_status:l.availability_status||"In Stock",stock_quantity:l.stock_quantity?parseInt(l.stock_quantity):null,images:l.images||[],video_url:(l.images||[]).find(x=>typeof x=="string"&&Be(x))||null,features:m(l.features_text).length?m(l.features_text):l.tags||[],tags:l.tags||[],highlights:m(l.highlights_text),seo_keywords:m(l.seo_keywords_text),is_ai_generated:!!l.catalog_template_id,ai_generated_fields:l.catalog_template_id?["title","description","features","highlights","seo_keywords"]:[],specifications:f(l)},h=na();g.property_id=h;const _=await bi(g);if(_.error){if(te){ae++,o();const w=de;closeProductFormModal(),T(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(w)&&T();return}o();const x=Sa(_.error,"Product publish");y(x,"error");try{let w=a.querySelector(".__publish-error-banner");w||(w=document.createElement("div"),w.className="__publish-error-banner mb-3 p-3 rounded-xl border border-red-500/30 bg-red-500/10 text-red-300 text-sm font-medium",a.prepend(w)),w.textContent=x}catch{}return}try{Ht({...g,property_id:g.property_id})}catch{}try{(window._productsData=window._productsData||[]).unshift({...g})}catch{}y(u?"Draft saved!":"Published Successfully! Your product is now live in your showroom.")}te&&Ie++,o();try{localStorage.removeItem(at(t,i))}catch{}const v=de;if(closeProductFormModal(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(v)){T();return}T()}catch(r){const l=r&&r.message&&!/failed to fetch|networkerror/i.test(String(r.message))?r.message:Sa(r,"Product publish");if(te&&ae++,o(),te){const d=de;closeProductFormModal(),T(),typeof window.returnToScanReviewAfterSave=="function"&&window.returnToScanReviewAfterSave(d)&&T();return}y(l,"error")}};window.editProduct=async function(e){const{data:t,error:i}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let a=i?null:t;if(a||(a=nt(e)),a||(a=(window._productsData||[]).find(n=>n.property_id===e)||null),!a)return y("Product not found","error");a.specifications&&typeof a.specifications=="object"&&(a={...a,...a.specifications}),showAddProductStep2(a.category||"Other",a)};window.toggleProductActive=async function(e,t){let i=null;try{const{data:n}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();n&&(i=Se(n))}catch{}if(i||(i=Se((window._productsData||[]).find(n=>n.property_id===e))),!i||!i.property_id){Ea(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),y(t?"Product published locally":"Product unpublished locally","info"),T();return}delete i.id,i.property_id=e,i.is_active=t,i.availability_status=t?"In Stock":"Out of Stock";const{error:a}=await b.from("showroom_listings").upsert(i,{onConflict:"property_id"});if(a){if(ce(a))return y(`âšï¸ ${t?"Publish":"Unpublish"} blocked: database admin role rejected the write. Re-run the admin permission migration.`,"error");Ea(e,{is_active:t,availability_status:t?"In Stock":"Out of Stock"}),y(t?"Product published locally":"Product unpublished locally","info"),T();return}y(t?"Product published":"Product unpublished"),T()};window.duplicateProduct=async function(e,t=!1){const{data:i}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();if(!i)return;const{id:a,property_id:n,created_at:s,updated_at:o,...r}=i,l=na();await b.from("showroom_listings").insert({...r,property_id:l,title:i.title+" (Copy)",is_active:!1}),t||(y("Product duplicated"),T())};window.archiveProduct=async function(e){confirm("Archive this product? It will be hidden from the website but can be restored.")&&(await b.from("showroom_listings").update({is_active:!1,availability_status:"Archived"}).eq("property_id",e),y("Product archived"),T())};const Ua=["Single-Family Home","Apartment","Condo","Townhouse","Villa","Mansion","Beach House","Farm House","Commercial Building","Hotel","Land","Other"];async function ma(){const e=document.getElementById("content");try{const{data:t,error:i}=await b.from("showroom_listings").select("*").eq("listing_type","property").order("created_at",{ascending:!1});let a=i?Qt().filter(s=>s.listing_type==="property"):t||[];if(Array.isArray(me)){const s=new Set(a.map(r=>r.property_id)),o=me.filter(r=>r.listing_type==="property"&&r.property_id&&!s.has(r.property_id));o.length&&(a=a.concat(o))}a.sort((s,o)=>new Date(o.created_at||0)-new Date(s.created_at||0));try{await Va()}catch{}const n=new Set(ea());a=a.filter(s=>!(s&&s.property_id&&n.has(s.property_id))),window._propertiesData=a,e.innerHTML=`
      <div class="space-y-4 fade-in">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.showAddPropertyModal=function(e={}){const t=!!e.property_id,i=Di("property","Real Estate"),a=e.country_code||"US",n=e.currency||st(a);j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="property-form" onsubmit="saveProperty(event,'${t?e.property_id:""}')" class="space-y-4">
          <div class="glass-soft border border-blue-500/15 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              <div class="sm:col-span-2"><label class="lbl">Property Template</label><select class="input-field" name="catalog_template_id" id="ppf-catalog_template_id" onchange="applyPropertyCatalogTemplate()"><option value="">Choose a property template...</option>${i.map(o=>`<option value="${o.id}">${c(o.label)} - ${c(o.propertyType||o.subcategory)}</option>`).join("")}</select></div>
              <div><label class="lbl">Country</label><select class="input-field" name="country_code" id="ppf-country_code" onchange="syncPropertyCountry(); applyPropertyCatalogTemplate()">${Vt(a,{scannerExcluded:!t})}</select></div>
    ...
    </div>`),da(),ua(),Ra("ppf-price"),window._propFormDirty=!!t;const s=document.getElementById("property-form");if(s){const o=()=>{window._propFormDirty=!0};s.addEventListener("input",o),s.addEventListener("change",o)}window.syncPropertyCountry=function(){yi("ppf")},yi("ppf"),Ba("pricing"),document.getElementById("ppf-price")?.addEventListener("input",()=>Ba("pricing")),Wo()};let pe=null,qt=null,Si=null;function Vo(){const e=document.querySelector("#property-form");if(!e)return"";const t=i=>(e.querySelector(`[name="${i}"]`)?.value||"").trim();return[t("product_location"),t("town"),t("city"),t("state"),t("country")].filter(Boolean).join(", ")}function ke(e,t){const i=document.getElementById("property-map-status");i&&(i.textContent=e,i.style.color=t?"#dc2626":"")}function _t(e,t,{reverse:i=!1}={}){if(!pe||!Number.isFinite(e)||!Number.isFinite(t))return;const a=[e,t];qt?qt.setLatLng(a):qt=L.marker(a,{draggable:!0}).addTo(pe),pe.setView(a,Math.max(pe.getZoom(),13));const n=document.querySelector('#property-form [name="latitude"]'),s=document.querySelector('#property-form [name="longitude"]');n&&(n.value=String(Number(e.toFixed(6)))),s&&(s.value=String(Number(t.toFixed(6)))),i&&Ot(e,t);const o=document.getElementById("btn-open-google-map");o&&(o.href=`https://www.google.com/maps?q=${e.toFixed(6)},${t.toFixed(6)}`)}async function vt(){const e=Vo();if(!e){ke("Enter a location (address, area, city, state, country), then press Locate from fields.");return}ke("Searching locationâ€¦");try{const i=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(e))).json();i&&i[0]?(_t(parseFloat(i[0].lat),parseFloat(i[0].lon)),ke("Located: "+i[0].display_name)):ke("Could not find that location. Check the spelling or click the map to drop the pin.",!0)}catch{ke("Map lookup failed. You can still drop the pin by clicking the map.",!0)}}async function Ot(e,t){const i=document.querySelector("#property-form");if(i)try{const n=await(await fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=16`)).json(),s=n&&n.address||{},o=(v,p)=>{if(!p)return;const g=i.querySelector(`[name="${v}"]`);return g&&!String(g.value||"").trim()?(g.value=p,!0):!1},r=[s.road||"",s.house_number||""].filter(Boolean).join(" "),l=s.suburb||s.neighbourhood||s.quarter||s.district||s.borough||"",d=s.town||s.village||s.municipality||s.city_district||"",u=s.city||s.county||"",m=s.state||s.region||"",f=s.country||"";if(o("product_location",r||l||d),o("town",l||d),o("city",u),o("state",m),f){o("country",f);const v=i.querySelector('[name="country_code"]');if(v){const p=($e||[]).find(g=>String(g.name||"").toLowerCase()===String(f).toLowerCase());p&&p.code&&!v.value&&(v.value=p.code)}}ke("Pin set at "+e.toFixed(5)+", "+t.toFixed(5)+(n.display_name?" â€” "+n.display_name:""))}catch{ke("Pin set. Could not reverse-geocode the address.",!0)}}window.refreshPropertyMapFromForm=function(){if(!pe)return;const e=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),t=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(e)&&Number.isFinite(t)&&(e||t)?(_t(e,t),ke("Map updated from coordinates.")):vt()};function Wo(){const e=document.getElementById("property-map-preview");if(!e||!window.L){ke("Map unavailable right now â€” your location fields still save normally.");return}pe&&(pe.remove(),pe=null,qt=null);const t=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),i=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value),a=Number.isFinite(t)&&Number.isFinite(i)&&(t||i);pe=L.map(e,{scrollWheelZoom:!1}).setView(a?[t,i]:[20,0],a?13:2),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap contributors"}).addTo(pe),pe.on("click",n=>_t(n.latlng.lat,n.latlng.lng,{reverse:!0})),document.getElementById("btn-geocode-property")?.addEventListener("click",vt),["product_location","town","city","state","country","latitude","longitude"].forEach(n=>{const s=document.querySelector(`#property-form [name="${n}"]`);s&&(s.addEventListener("input",()=>{if(n==="latitude"||n==="longitude"){const o=parseFloat(document.querySelector('#property-form [name="latitude"]')?.value),r=parseFloat(document.querySelector('#property-form [name="longitude"]')?.value);Number.isFinite(o)&&Number.isFinite(r)&&(o||r)&&_t(o,r);return}clearTimeout(Si),Si=setTimeout(vt,900)}),s.addEventListener("change",()=>{n!=="latitude"&&n!=="longitude"&&vt()}))}),a?_t(t,i):vt()}window.fixPropertyMaps=async function(){const t=(window._propertiesData||[]).filter(n=>{const s=parseFloat(n.latitude),o=parseFloat(n.longitude),r=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");return!(Number.isFinite(s)&&Number.isFinite(o)&&(s!==0||o!==0))&&!!r});if(!t.length){y("All properties already have map coordinates.","success");return}y(`Fixing maps for ${t.length} propert${t.length>1?"ies":"y"}â€¦`,"success");let i=0,a=0;for(const n of t){const s=[n.product_location,n.town,n.city,n.state,n.country].filter(Boolean).join(", ");try{const r=await(await fetch("https://nominatim.openstreetmap.org/search?format=json&limit=1&q="+encodeURIComponent(s))).json();if(r&&r[0]){const l={latitude:parseFloat(r[0].lat),longitude:parseFloat(r[0].lon)},{error:d}=await b.from("showroom_listings").update(l).eq("property_id",n.property_id);d?a++:(Object.assign(n,l),i++)}else a++}catch{a++}await new Promise(o=>setTimeout(o,1100))}y(`Map fix done: ${i} updated, ${a} failed.`,a?"error":"success"),ma()};window.saveProperty=async function(e,t){e.preventDefault();const i=new FormData(e.target),a=Object.fromEntries(i.entries()),n=i.getAll("images").filter(p=>p&&!p.startsWith("blob:")),s=(a.features_text||"").split(",").map(p=>p.trim()).filter(Boolean),o=a.real_price===""||a.real_price==null?null:Math.max(U,Math.min(Y,parseFloat(a.real_price)||0)),r=p=>(p||"").split(",").map(g=>g.trim()).filter(Boolean),l=p=>p===""||p==null||!isFinite(parseInt(p,10))?null:parseInt(p,10),d=r(a.floor_plan_rooms).map(p=>{const g=String(p).match(/^(.*?):\s*(.*)$/);return g?{name:g[1].trim(),dimensions:g[2].trim()}:{name:p,dimensions:""}}),u={listing_type:"property",category:a.property_type||"Real Estate",subcategory:a.subcategory||null,title:a.title,description:a.description||"",price:Math.max(U,Math.min(Y,parseFloat(a.price)||0)),currency:a.currency||"USD",real_price:o,country:a.country||"",country_code:(a.country_code||"").toUpperCase(),state:a.state||"",city:a.city||"",town:a.town||"",address:a.address||"",zip_code:a.zip_code||"",product_location:a.product_location||"",latitude:a.latitude?parseFloat(a.latitude):null,longitude:a.longitude?parseFloat(a.longitude):null,property_type:a.property_type||"",listing_status:a.listing_status||"sale",condition:a.condition||null,bedrooms:a.bedrooms?parseInt(a.bedrooms):null,bathrooms:a.bathrooms?parseInt(a.bathrooms):null,half_bathrooms:l(a.half_bathrooms),building_size:a.building_size||"",land_size:a.land_size||"",floors:l(a.floors),garage:a.garage||"",parking_spaces:a.parking_spaces?parseInt(a.parking_spaces):null,furnished:a.furnished||"",year_built:l(a.year_built),year_renovated:l(a.year_renovated),landmarks:r(a.landmarks_text),interior_features:r(a.interior_features_text),exterior_features:r(a.exterior_features_text),home_systems:r(a.home_systems_text),legal_info:r(a.legal_info_text).map(p=>{const g=String(p).match(/^(.*?):\s*(.*?)\s*\((Seller provided|Not verified|Documented)\)\s*$/i);return g?{label:g[1].trim(),value:g[2].trim(),source:g[3]}:{label:p,value:"",source:"Not verified"}}),risk_notes:a.risk_notes||"",floor_plan:{image:a.floor_plan_image||"",rooms:d,levels:a.floor_plan_levels||"",total_area:a.floor_plan_total_area||""},nearby_area:{schools:r(a.nearby_schools_text),hospitals:r(a.nearby_hospitals_text),shopping:r(a.nearby_shopping_text),transportation:r(a.nearby_transportation_text),distances:r(a.nearby_distances_text)},verification_status:a.verification_status||"Not verified",verification_date:a.verification_date||"",inspection_info:a.inspection_info||"",documents:r(a.documents_text),features:s,images:n,video_url:(n||[]).find(p=>typeof p=="string"&&Be(p))||null,video:(n||[]).find(p=>typeof p=="string"&&Be(p))||null,highlights:La(a.highlights_text),seo_keywords:La(a.seo_keywords_text),is_ai_generated:!!a.catalog_template_id,ai_generated_fields:a.catalog_template_id?["title","description","features","highlights","seo_keywords","country","country_code","product_location"]:[],is_active:a.is_active==="on"},m={neighborhood:a.neighborhood||"",living_areas:a.living_areas||"",kitchens:l(a.kitchens),balconies:l(a.balconies),garden:a.garden||"",pool:a.pool||"",security:a.security||"",utilities:a.utilities||"",construction_type:a.construction_type||"",construction_status:a.construction_status||"",ownership_type:a.ownership_type||"",contact_name:a.contact_name||"",contact_phone:a.contact_phone||"",contact_email:a.contact_email||""},f={};for(const[p,g]of Object.entries({...m,real_price:o}))g!=null&&String(g).trim()!==""&&(f[p]=g);let v;if(t){u.property_id=t;const p=Se((window._propertiesData||[]).find(g=>g.property_id===t)||(window._productsData||[]).find(g=>g.property_id===t));u.specifications={...p.specifications&&typeof p.specifications=="object"?p.specifications:{},...f},{error:v}=await b.from("showroom_listings").upsert({...p,...u},{onConflict:"property_id"})}else u.property_id=na(),u.specifications={...f},{error:v}=await b.from("showroom_listings").insert(u);v&&ln(v,()=>Ht({...u,property_id:t||u.property_id}),t?"Property update":"Property publish")||(y(t?"Property updated!":"Property published!"),le(),ma())};const kt={Car:"Cars",Truck:"Trucks",Bus:"Buses","Motorhome / RV":"Motorhomes",Motorcycle:"Motorcycles","Boat / Marine":"Marine & Boating"},zo=["Sedan","SUV","Hatchback","Coupe","Convertible","Wagon","Pickup","Van","Truck","Sports Car","Luxury Sedan","Bus","Motorhome","Motorcycle","Yacht","Jet Ski","Other"];window.showAddVehicleModal=function(e={}){const t=!!e.property_id,i=Object.keys(kt).find(r=>kt[r]===e.category)||"Car",a=e.specifications&&typeof e.specifications=="object"?e.specifications:{},n=(r,l)=>e[r]??a[r]??l,s=(r,l="")=>Array.isArray(r)?r.join(", "):r??l;j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box wide">
        <div class="flex items-center justify-between mb-5">
        ...
        <form id="vehicle-form" onsubmit="saveVehicle(event,'${t?e.property_id:""}')" class="space-y-4">
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            <div class="form-grid form-grid-2">
              <div><label class="lbl">Vehicle Type *</label><select class="input-field" name="vehicle_type" required>${Object.keys(kt).map(r=>`<option value="${r}" ${i===r?"selected":""}>${r}</option>`).join("")}</select></div>
    ...
    </div>`),da(),ua(),window._vehFormDirty=!!t;const o=document.getElementById("vehicle-form");if(o){const r=()=>{window._vehFormDirty=!0};o.addEventListener("input",r),o.addEventListener("change",r)}window.lucide&&lucide.createIcons()};window.saveVehicle=async function(e,t){e.preventDefault();const i=new FormData(e.target),a=Object.fromEntries(i.entries()),n=[...i.getAll("images")].filter(Boolean).concat(String(a.images_text||"").split(/\r?\n/).map(E=>E.trim()).filter(Boolean)),s=[...new Set(n)],o=(a.features_text||"").split(",").map(E=>E.trim()).filter(Boolean),r=(a.safety_features||"").split(",").map(E=>E.trim()).filter(Boolean),l=(a.driver_assistance||"").split(",").map(E=>E.trim()).filter(Boolean),d=(a.technology||"").split(",").map(E=>E.trim()).filter(Boolean),u=(a.interior||"").split(",").map(E=>E.trim()).filter(Boolean),m=a.real_price===""||a.real_price==null?null:Math.max(U,Math.min(Y,parseFloat(a.real_price)||0)),f=kt[a.vehicle_type]||"Cars",v=String(a.model_year||"").trim(),p=String(a.make||"").trim(),g=String(a.model||"").trim(),h=[v,p,g].filter(Boolean).join(" ")||String(a.title||"").trim(),_={make:p,model:g,model_year:v,body_type:a.body_type||null,trim:a.trim||"",mileage:a.mileage||"",engine:a.engine||"",horsepower:a.horsepower||"",transmission:a.transmission||null,drive_type:a.drive_type||null,fuel_type:a.fuel_type||null,fuel_economy:a.fuel_economy||"",towing_capacity:a.towing_capacity||"",seating_capacity:a.seating_capacity||null,sleeping_capacity:f==="Motorhomes"&&a.seating_capacity||null,doors:a.doors||null,safety_features:r,driver_assistance:l,technology:d,interior:u,wheels_tires:a.wheels_tires||"",dimensions:a.dimensions||"",cargo_capacity:a.cargo_capacity||"",ownership_history:a.ownership_history||"",service_history:a.service_history||"",accident_history:a.accident_history||"",previous_owners:a.previous_owners||"",registration_status:a.registration_status||null,inspection_status:a.inspection_status||null,color:a.color||"",vin:a.vin||"",warranty:a.warranty||"",condition:a.condition||"",location:a.location||"",seller_name:a.seller_name||"",seller_phone:a.seller_phone||"",seller_email:a.seller_email||"",product_location:a.location||""};for(const E of Object.keys(_))_[E]==null&&delete _[E];const x={listing_type:"vehicle",category:f,subcategory:a.body_type||a.vehicle_type||null,title:String(a.title||"").trim()||h,description:a.description||"",price:Math.max(U,Math.min(Y,parseFloat(a.price)||0)),currency:"USD",real_price:m,images:s,features:o,brand:p||null,color:a.color||null,condition:a.condition||null,warranty:a.warranty||null,stock_quantity:parseInt(a.stock_quantity,10)||1,is_active:a.is_active==="on",is_featured:!1,specifications:{..._,real_price:m}};let w;if(t){x.property_id=t;const E=Se((window._productsData||[]).find(P=>P.property_id===t));x.specifications={...E.specifications&&typeof E.specifications=="object"?E.specifications:{},..._,real_price:m},{error:w}=await b.from("showroom_listings").upsert({...E||{},...x},{onConflict:"property_id"})}else x.property_id=na(),{error:w}=await b.from("showroom_listings").insert(x);w&&ln(w,()=>Ht({...x,property_id:t||x.property_id}),t?"Vehicle update":"Vehicle publish")||(y(t?"Vehicle updated!":"Vehicle published! It now appears in the Cars & Trucks row."),le(),T())};window.editProperty=async function(e){const{data:t,error:i}=await b.from("showroom_listings").select("*").eq("property_id",e).maybeSingle();let a=i?null:t;a||(a=nt(e)),a||(a=(Array.isArray(me)?me.find(n=>n.property_id===e):null)||null),a&&showAddPropertyModal(a)};const Ko=["pending_verification","payment_received","payment_approved","documentation_pending","refund_processing","processing","shipped","in_transit","out_for_delivery","delivered","order_completed","cancelled","rejected"];async function si(){const e=document.getElementById("content");try{const{data:t}=await b.from("payment_receipts").select("*").order("created_at",{ascending:!1}).limit(300),i=t||[],a=["All","Pending Verification","Paid","Documentation","Processing","Shipped","Delivered","Rejected"];let n="All";e.innerHTML=`
      <div class="space-y-4 fade-in">
          ...
          <div class="overflow-x-auto scrollbar-thin">
            <table class="w-full dt">
              ...
              <tbody id="orders-tbody">
                ${i.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No orders yet</td></tr>':i.map(s=>Yo(s)).join("")}
              </tbody>
            </table>
          </div>
        </div>
      </div>`,window._ordersData=i,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function Yo(e){return`<tr class="order-row" data-status="${e.status}" data-search="${c(e.order_number)} ${c(e.full_name)} ${c(e.email)}">
  ...
  </tr>`}window.filterOrders=function(e){document.querySelectorAll("#order-tabs .tab-btn").forEach(t=>t.classList.toggle("active",t.textContent===e)),document.querySelectorAll(".order-row").forEach(t=>{const i=t.dataset.status||"",a=e==="All"||e==="Pending Verification"&&["pending_verification","payment_received","order_placed","receipt_requested"].includes(i)||e==="Paid"&&["payment_approved","payment_verified","paid","approved"].includes(i)||e==="Documentation"&&["documentation_pending"].includes(i)||e==="Processing"&&["processing","order_processing"].includes(i)||e==="Shipped"&&["shipped","order_shipped","in_transit","out_for_delivery"].includes(i)||e==="Delivered"&&["delivered","order_delivered","order_completed"].includes(i)||e==="Rejected"&&["cancelled","rejected","refund_processing","payment_failed"].includes(i);t.style.display=a?"":"none"})};window.searchOrders=function(e){const t=e.toLowerCase();document.querySelectorAll(".order-row").forEach(i=>{i.style.display=!t||i.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewOrder=async function(e){const t=(window._ordersData||[]).find(a=>a.id===e);if(!t)return;let i="";if(t.receipt_file_path&&(i=`
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        ...
        <div class="space-y-3 text-sm">
          <div class="grid grid-cols-2 gap-3">
            ${[["Customer",t.full_name],["Email",t.email],["Phone",t.phone],["Amount",`${Yi(t.amount,t.currency||"USD")}`],["Product",t.listing_title||t.listing_id],["Date",Fe(t.created_at)],["Method",t.payment_method==="flutterwave"?"Card / ATM (Flutterwave)":"Manual Bank Transfer"],["Qty",t.quantity||1]].map(([a,n])=>`<div><p class="text-[10px] text-gray-500 uppercase font-bold mb-0.5">${a}</p><p class="text-xs text-white font-medium">${c(n)||"—"}</p></div>`).join("")}
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <select id="order-status-select" class="input-field flex-1">
                ${Ko.map(a=>`<option value="${a}" ${t.status===a?"selected":""}>${a.replace(/_/g," ")}</option>`).join("")}
              </select>
    ...
    </div>`),t.receipt_file_path)try{const{data:a,error:n}=await b.storage.from("payment-receipts").createSignedUrl(t.receipt_file_path,3600),s=!n&&a?.signedUrl?a.signedUrl:null,o=document.querySelector('[data-receipt-iframe="true"]'),r=document.querySelector('[data-receipt-view="true"]');o&&s&&(o.src=s),r&&s&&(r.href=s),r&&!s&&r.remove()}catch{}};window.saveOrderAdminNotes=async function(e){const t=document.getElementById("order-admin-notes")?.value,{error:i}=await b.from("payment_receipts").update({admin_notes:t||null,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){y(i.message,"error");return}y("Notes saved")};window.quickOrderAction=async function(e,t){const{error:i}=await b.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){y(i.message,"error");return}y("Order updated to "+t.replace(/_/g," ")),le(),si()};window.updateOrderStatus=async function(e){const t=document.getElementById("order-status-select")?.value;if(!t)return;const{error:i}=await b.from("payment_receipts").update({status:t,admin_reviewed_at:new Date().toISOString()}).eq("id",e);if(i){y(i.message,"error");return}y("Order status updated"),le(),si()};async function Jo(){const e=document.getElementById("content");try{const{data:t}=await b.from("profiles").select("*").order("created_at",{ascending:!1}).limit(200),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody id="customers-tbody">
                ${i.length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-12">No customers yet</td></tr>':i.map(a=>`<tr class="cust-row" data-search="${c(a.display_name)} ${c(a.user_id)}">
                    ...
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${ge(a.created_at)}</span></td>
                    <td>
      ...
      </div>`,window._customersData=i,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.searchCustomers=function(e){const t=e.toLowerCase();document.querySelectorAll(".cust-row").forEach(i=>{i.style.display=!t||i.dataset.search.toLowerCase().includes(t)?"":"none"})};window.viewCustomer=async function(e){const t=(window._customersData||[]).find(a=>a.user_id===e);if(!t)return;const{data:i}=await b.from("payment_receipts").select("order_number,amount,currency,status,created_at").eq("user_id",e).order("created_at",{ascending:!1}).limit(20);j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
        ...
        ${(i||[]).length===0?'<p class="text-xs text-gray-500 py-4 text-center">No orders yet</p>':(i||[]).map(a=>`<div class="flex items-center justify-between py-2 border-b border-blue-500/5 last:border-0">
            <div><p class="text-xs font-bold text-white font-mono">${c(a.order_number)}</p><p class="text-[10px] text-gray-500">${Fe(a.created_at)}</p></div>
            <div class="flex items-center gap-2">${ie(a.status)}<span class="text-xs font-bold text-emerald-400">$${parseFloat(a.amount).toLocaleString()}</span></div>
          </div>`).join("")}
      </div>
    </div>`)};async function Mt(){const e=document.getElementById("content");try{const{data:t}=await b.from("product_reviews").select("*, showroom_listings(title, property_id)").order("created_at",{ascending:!1}).limit(200),i=t||[],a=i.filter(r=>!r.is_approved).length,{data:n}=await b.from("site_feedback").select("*").order("created_at",{ascending:!1}).limit(200),s=n||[],o=s.filter(r=>!r.is_approved).length;e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
          ...
          <div class="space-y-3" id="reviews-list">
            ${i.length===0?We("star","No Reviews","Customer reviews will appear here."):i.map(r=>Xo(r)).join("")}
          </div>
        </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}function Qo(e){const t=Array.from({length:5},(i,a)=>a<(e.rating||5)?"â˜…":"â˜†").join("");return`<div class="glass-soft border ${e.is_approved?"border-emerald-500/15":"border-amber-500/20"} rounded-xl p-4" data-fb-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
  ...
  </div>`}window.approveFeedback=async function(e){const{error:t}=await b.from("site_feedback").update({is_approved:!0}).eq("id",e);t?y(t.message,"error"):y("Feedback approved â€” it now shows on every page."),Mt()};window.deleteFeedback=async function(e){if(!confirm("Delete this feedback permanently?"))return;const{error:t}=await b.from("site_feedback").delete().eq("id",e);t?y(t.message,"error"):y("Feedback deleted."),Mt()};function Xo(e){const t=Array.from({length:5},(i,a)=>a<e.rating?"â˜…":"â˜†").join("");return`<div class="review-card glass-soft border ${e.is_approved?"border-blue-500/15":"border-amber-500/20"} rounded-xl p-4" data-approved="${e.is_approved}">
    <div class="flex items-start justify-between gap-3">
      <div class="flex-1 min-w-0">
                ...
                <div class="flex items-start justify-between gap-3">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                      ...
                      <span class="text-[10px] text-gray-500 ml-auto">${Fe(a.created_at)}</span>
                    </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.markMsgRead=async function(e){await b.from("support_messages").update({is_read:!0}).eq("id",e),y("Marked as read"),An()};async function ga(){const e=document.getElementById("content");try{const{data:t}=await b.from("coupons").select("*").order("created_at",{ascending:!1}),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <div class="flex items-center gap-3">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${i.length===0?'<tr><td colspan="7" class="text-center text-gray-500 py-12">No coupons yet</td></tr>':i.map(a=>`<tr>
                    ...
                    <td>${ie(a.is_active?"active":"inactive")}</td>
                    <td class="hidden md:table-cell"><span class="text-xs text-gray-500">${ge(a.expires_at)}</span></td>
                    <td>
                      <div class="flex gap-1">
    ...
    </div>`)};window.saveCoupon=async function(e){e.preventDefault();const t=new FormData(e.target),i=Object.fromEntries(t.entries()),a={code:i.code.toUpperCase(),discount_type:i.discount_type,discount_value:parseFloat(i.discount_value),min_amount:i.min_amount?parseFloat(i.min_amount):null,usage_limit:i.usage_limit?parseInt(i.usage_limit):null,expires_at:i.expires_at||null,is_active:!0},{error:n}=await b.from("coupons").insert(a);if(n){y(n.message,"error");return}y("Coupon created!"),le(),ga()};window.toggleCoupon=async function(e,t){await b.from("coupons").update({is_active:t}).eq("id",e),y(t?"Coupon activated":"Coupon deactivated"),ga()};window.deleteCoupon=async function(e){confirm("Delete this coupon?")&&(await b.from("coupons").delete().eq("id",e),y("Coupon deleted"),ga())};async function Zo(){const e=document.getElementById("content");try{const{data:t}=await b.from("notification_log").select("*").order("created_at",{ascending:!1}).limit(100),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
        <h2 class="text-xl font-black text-white">Notifications</h2>
        <div class="space-y-2">
          ${i.length===0?We("bell","No Notifications","System notifications will appear here."):i.map(a=>`
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    ...
    </div>`}window.onAdLinkTypeChange=function(){const e=window._adLinkCache||{products:[],categories:[],sections:[]},t=document.querySelector('#ad-form select[name="link_type"]'),i=t?t.value:"none";oi(e,i,"")};window.showAddAdModal=async function(){const e=await Cn();window._adLinkCache=e,j(In(null)),oi(e,"none","")};window.showEditAdModal=async function(e){const t=await Cn();window._adLinkCache=t;const{data:i}=await b.from("promotions").select("*").eq("id",e).maybeSingle();if(!i){y("Ad not found","error");return}j(In(i)),i.image_url?Kt(i.image_url,!1):i.video_url&&Kt(i.video_url,!0),oi(t,i.link_type||"none",i.link_target||"")};window.saveAd=async function(e){e.preventDefault();const t=new FormData(e.target),i=Object.fromEntries(t.entries()),a=i.id||"",n={title:i.title,description:i.description||"",ad_label:Pn.includes(i.ad_label)?i.ad_label:"Featured",image_url:i.image_url||null,video_url:i.video_url||null,link_type:["none","product","category","section"].includes(i.link_type)?i.link_type:"none",link_target:i.link_target||null,start_date:i.start_date?new Date(i.start_date+"T00:00:00").toISOString():null,end_date:i.end_date?new Date(i.end_date+"T23:59:59").toISOString():null,is_active:i.is_active==="on",promo_type:"banner"};if(!n.image_url&&!n.video_url){y("Add an image or video for the ad","error");return}const s=e.target.querySelector('button[type="submit"]');s&&(s.disabled=!0);try{if(a){const{error:o}=await b.from("promotions").update(n).eq("id",a);if(o)throw o;y("Ad updated!")}else{const{error:o}=await b.from("promotions").insert(n);if(o)throw o;y("Ad created!")}}catch(o){y(o.message||"Save failed","error"),s&&(s.disabled=!1);return}le(),gt()};window.togglePromo=async function(e,t){const{error:i}=await b.from("promotions").update({is_active:t}).eq("id",e);if(i){y(i.message,"error");return}y(t?"Ad activated":"Ad deactivated"),gt()};window.moveAd=async function(e,t){try{const{data:i,error:a}=await b.from("promotions").select("id,sort_order").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});if(a)throw a;const n=i||[],s=n.findIndex(d=>d.id===e),o=s+t;if(s<0||o<0||o>=n.length){y("Already at the edge","info");return}const r=n[s],l=n[o];await b.from("promotions").update({sort_order:l.sort_order}).eq("id",r.id),await b.from("promotions").update({sort_order:r.sort_order}).eq("id",l.id),y("Order updated")}catch(i){y(i.message||"Reorder failed","error")}gt()};window.deletePromo=async function(e){if(confirm("Delete this ad? This cannot be undone.")){try{const{data:t}=await b.from("promotions").select("image_url,video_url,poster_url").eq("id",e).maybeSingle();if(t){const a=[t.image_url,t.video_url,t.poster_url].filter(Boolean).map(n=>{const s=/\/object\/public\/advertisements\/(.+)$/.exec(n);return s?decodeURIComponent(s[1]):null}).filter(Boolean);if(a.length)try{await b.storage.from("advertisements").remove(a)}catch{}}const{error:i}=await b.from("promotions").delete().eq("id",e);if(i)throw i;y("Ad deleted")}catch(t){y(t.message||"Delete failed","error")}gt()}};async function gt(){const e=document.getElementById("content");try{const{data:t}=await b.from("promotions").select("*").order("sort_order",{ascending:!0}).order("created_at",{ascending:!1}),i=t||[];e.innerHTML=`
      <div class="space-y-4 fade-in">
              ...
              <div class="glass-soft border border-blue-500/15 rounded-xl p-4 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    ${ar(a)}
                    <span class="text-[10px] text-gray-500">${ge(a.start_date)}${a.start_date?" â†’ ":""}${ge(a.end_date)}</span>
                  </div>
                </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.renderAds=gt;const ba=[{id:"gemini",name:"Google Gemini",tag:"FREE",color:"blue",icon:"sparkles",kf:"gemini_key",ph:"AIzaSyâ€¦",signup:"https://aistudio.google.com/apikey",models:["gemini-3-flash-preview","gemini-3.1-flash-lite-preview"],mf:"gemini_model",dm:"gemini-3-flash-preview",desc:"Google's best free AI. Great for coding, writing apps & websites.",free_tier:"15 req/min Â· 1M tokens/day â€” Free forever"}],ye={border:{blue:"border-blue-500/50"},bg:{blue:"bg-blue-500/8"},text:{blue:"text-blue-400"},badge:{blue:"bg-blue-500/15 text-blue-300"}};async function Tn(){const e=document.getElementById("content");try{let t=function(s){const o=n===s.id,r=a[s.kf],l=a[s.mf]||s.dm;return`
      ...
      <div class="space-y-5 fade-in">
        ...
        <form id="ai-form" onsubmit="saveAiSettings(event)" class="space-y-5">
          ...
          <div class="glass-soft border border-cyan-500/25 rounded-2xl p-4 space-y-3">
            ...
            ${a.car_scanner_key?'<p class="text-[10px] font-bold text-emerald-400 leading-relaxed">Dedicated car key saved - this scanner uses ONLY its own key. If Google ever deletes or disables that key, it automatically falls back to your main Gemini key so scans never stop.</p>':'<p class="text-[10px] font-bold text-amber-300 leading-relaxed">No dedicated car key saved yet - the Car Scanner is falling back to your main Gemini key until you add one above. Scans work now.</p>'}
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
              <div>
          ...
          <div class="glass-soft border border-violet-500/25 rounded-2xl p-4 space-y-3">
            ...
            ${a.re_scanner_key?'<p class="text-[10px] font-bold text-emerald-400 leading-relaxed">Dedicated Real Estate key saved - this scanner uses ONLY its own key. If Google ever deletes or disables that key, it automatically falls back to your main Gemini key so scans never stop.</p>':'<p class="text-[10px] font-bold text-amber-300 leading-relaxed">No dedicated Real Estate key saved yet - the Real Estate scanner is falling back to your main Gemini key until you add one above. Scans work now. Paste a dedicated key here to keep this scanner fully separate, as designed.</p>'}
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
              <div>
              ...
              <div>
                ...
                <select class="input-field text-xs" name="re_scanner_model">
                  ${["gemini-flash-latest","gemini-3.7-flash","gemini-3.6-flash"].map(s=>`<option value="${s}" ${(a.re_scanner_model||"gemini-flash-latest")===s?"selected":""}>${s}</option>`).join("")}
                </select>
              </div>
            </div>
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.highlightAI=function(e){ba.forEach(t=>{const i=document.getElementById("apc-"+t.id);if(!i)return;const a=t.id===e;i.className=`glass-soft border ${a?ye.border[t.color]+" "+ye.bg[t.color]:"border-blue-500/10"} rounded-2xl p-4 space-y-3 ai-pcard`;const n=i.querySelector("input[type=radio] + span");n&&(n.className=`text-[9px] font-bold ${a?ye.text[t.color]:"text-gray-600"}`)})};window.saveAiSettings=async function(e){e.preventDefault();const t=new FormData(e.target),i=Object.fromEntries(t.entries()),a={active_provider:i.active_provider||"gemini",product_ai_enabled:i.product_ai_enabled==="on",ai_code_assist:i.ai_code_assist==="on",ai_moderation:i.ai_moderation==="on"};ba.forEach(l=>{i[l.mf]&&(a[l.mf]=i[l.mf]);const d=(i[l.kf]||"").trim();d&&!d.startsWith("â€¢â€¢â€¢â€¢")&&d!==""&&(a[l.kf]=d)}),a.gemini_key&&(a.gemini_api_key=a.gemini_key),i.groq_vision_model&&(a.groq_vision_model=i.groq_vision_model);const n=(i.groq_key||"").trim();n&&!/^[•\u2022]{4}/.test(n)&&(a.groq_key=n),i.car_scanner_model&&(a.car_scanner_model=i.car_scanner_model);const s=(i.car_scanner_key||"").trim();s&&!/^[•\u2022]{4}/.test(s)&&(a.car_scanner_key=s),i.re_scanner_model&&(a.re_scanner_model=i.re_scanner_model);const o=(i.re_scanner_key||"").trim();o&&!/^[•\u2022]{4}/.test(o)&&(a.re_scanner_key=o),a.customer_ai_enabled=i.customer_ai_enabled==="on",i.customer_model_override!==void 0&&(a.customer_model_override=i.customer_model_override.trim());const r=(i.openrouter_key||"").trim();r&&!/^[•\u2022]{4}/.test(r)&&(a.openrouter_key=r);try{const{data:l}=await b.from("ai_settings").select("id").limit(1).maybeSingle();let d;if(l?.id?{error:d}=await b.from("ai_settings").update(a).eq("id",l.id):{error:d}=await b.from("ai_settings").insert(a),d){y("Save failed: "+d.message,"error"),console.error("[AI Save]",d);return}await J.reload(),y("âœ… AI settings saved!","success"),setTimeout(()=>Tn(),600)}catch(l){y("Unexpected error: "+l.message,"error"),console.error("[AI Save]",l)}};const J={_cfg:null,async reload(){const{data:e,error:t}=await b.from("ai_settings").select("*").limit(1).maybeSingle();if(t){console.warn("[aiClient] Could not load settings:",t.message),this._cfg={};return}const i=e||{};!i.gemini_key&&i.gemini_api_key&&(i.gemini_key=i.gemini_api_key),this._cfg=i},async getConfig(){return this._cfg||await this.reload(),this._cfg},async freeChat(e,{maxTokens:t=2e3,timeoutMs:i=6e4}={}){const a=await fetch("https://text.pollinations.ai/openai",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"openai",messages:e.map(o=>({role:o.role==="assistant"?"assistant":o.role==="system"?"system":"user",content:String(o.content||"").slice(0,12e3)})),max_tokens:t}),signal:AbortSignal.timeout(i)});if(!a.ok)throw new Error(`Free AI provider error (${a.status}).`);const n=await a.json(),s=String(n?.choices?.[0]?.message?.content||"").trim();if(!s)throw new Error("Free AI provider returned an empty reply.");return{text:s,provider:"Free AI (Pollinations)",model:String(n?.model||"openai-fast")}},async chat(e,{maxTokens:t=2e3}={}){const i=await this.getConfig();if(!String(i.gemini_key||"").trim())return this.freeChat(e,{maxTokens:t});const n=e[e.length-1],s={action:"chat",message:String(n?.content||"").trim(),history:e.slice(0,-1).map(o=>({role:o.role,content:String(o.content||"")})),provider_override:"gemini",max_tokens:t};try{const o=await this._callEdge(s);if(o&&o.response)return{text:o.response,provider:"Google Gemini",model:o.model||i.gemini_model};throw new Error(String(o?.error||"Gemini is unavailable."))}catch(o){try{const r=await this.freeChat(e,{maxTokens:t});return r.note="gemini-unavailable",r}catch{throw o}}},async prompt(e,t={}){return this.chat([{role:"user",content:e}],t)},async getStatus(){const e=await this.getConfig();return ba.map(t=>({id:t.id,name:t.name,color:t.color,hasKey:!!e[t.kf]?.trim(),isActive:e.active_provider===t.id,isCoolingDown:!1,remainingSec:0}))},async analyzeImages(e,t={}){const i=`You are the AI listing expert for the Weverse Online Shop marketplace. Look carefully at the uploaded product photo(s) and identify exactly what the product is â€” the REAL brand, model and year that actually appear in the photos, never a guessed one.
...
`),r=Object.entries(i||{}).filter(([,d])=>d!=null&&String(Array.isArray(d)?d.join(", "):d).trim()!=="").map(([d,u])=>`"${d}": ${JSON.stringify(Array.isArray(u)?u.join(", "):String(u).slice(0,160))}`).join(`,
...
${i.text}`}catch(i){t.textContent=`✖ ${i.message}`}};window.testScanProviders=async function(){const e=document.getElementById("provider-test-output"),t=document.getElementById("btn-test-providers");if(!e)return;e.classList.remove("hidden"),t.disabled=!0;const i=(n,s,o,r)=>`
    ...
    </div>`;e.innerHTML='<p class="text-[11px] text-gray-400">Testing providers…</p>';let a="";try{const n=await J.preflight(),s=n.gemini||{};a+=s.ok?i("✓","bg-emerald-400","Gemini (Product Scanner — primary)",`Working${s.model?" · "+s.model:""}`):i("✖","bg-red-500","Gemini (Product Scanner — primary)",s.error||n.error||"Not working");const o=n.groq||{};a+=o.ok?i("✓","bg-emerald-400","Groq (Product Scanner — backup)",`Working · ${o.model||"vision model found"}`):o.configured?i("✖","bg-red-500","Groq (Product Scanner — backup)",o.error||"Key saved but not usable"):i("—","bg-yellow-400","Groq (Product Scanner — backup)","Optional backup not configured (no key)")}catch(n){a+=i("✖","bg-red-500","Cloud providers (server test)",String(n&&n.message||n))}e.innerHTML=a,t.disabled=!1,window.lucide&&lucide.createIcons()};function rt(e){if(!e)return null;let t=String(e).trim();const i=t.match(/```(?:json)?\s*([\s\S]*?)```/i);i&&(t=i[1].trim());const a=t.indexOf("{"),n=t.lastIndexOf("}");if(a===-1||n===-1||n<=a)return null;const s=t.slice(a,n+1);try{return JSON.parse(s)}catch{return null}}async function or(){const e=document.getElementById("content");try{const[{data:t},i]=await Promise.all([b.from("site_settings").select("*").limit(1).maybeSingle(),rr()]),a=t||{},n=new Set(Array.isArray(a.live_promo_product_ids)?a.live_promo_product_ids:[]),s=i.length?`
        <div class="mt-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-1.5 max-h-72 overflow-y-auto pr-1" id="promo-picker-list">
            ${i.map(o=>{const r=o.property_id||o.id,l=n.has(r)?"checked":"";return`<label class="flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-xl px-3 py-2 cursor-pointer hover:border-blue-400/40 transition" data-promo-search="${c((o.title||o.name||"")+" "+(o.category||""))}">
    ...
    </div>`}window.triggerContentMediaUpload=function(e){document.getElementById("file-"+e)?.click()};window.clearContentMedia=function(e){const t=document.getElementById("val-"+e),i=document.getElementById("url-"+e);t&&(t.value=""),i&&(i.value=""),y("Cleared. Save to apply.","info"),Mn()};window.handleContentMediaUpload=async function(e,t){const i=e.target.files?.[0];if(i){i.type.startsWith("video/"),y(`Uploading ${i.name}â€¦`,"info");try{const{data:{session:a}}=await b.auth.getSession();if(!a){y("Sign in to upload media","error");return}const n=(i.name.split(".").pop()||"bin").toLowerCase().replace(/[^a-z0-9]/g,""),s=`content/${t}-${Date.now()}.${n}`,{error:o}=await b.storage.from("product-images").upload(s,i,{contentType:i.type,upsert:!1});if(o){y("Upload failed: "+o.message,"error");return}const{data:r}=b.storage.from("product-images").getPublicUrl(s),l=r.publicUrl,d=document.getElementById("val-"+t),u=document.getElementById("url-"+t);d&&(d.value=l),u&&(u.value=l);const m=document.getElementById("slot-"+t);if(m){const f=ri.flatMap(v=>v.fields||[]).find(v=>v.key===t);f&&(m.outerHTML=Ln(f,l))}y("âœ“ Uploaded â€” save to apply","success")}catch{y("Upload failed","error")}}};const lr=["SHOP NOW","EXPLORE DEALS","VIEW PRODUCTS","DISCOVER MORE","SEE OFFERS","SHOP THE LOOK"];window._heroVideoDraft=[];function be(){return Array.isArray(window._heroVideoDraft)||(window._heroVideoDraft=[]),window._heroVideoDraft}function Bt(){const e=document.getElementById("hs-json");e&&(e.value=JSON.stringify(be()))}function Ze(){Bt();const e=document.getElementById("hero-videos-manager");e&&(e.innerHTML=Rn(be()),window.lucide&&lucide.createIcons())}function cr(e,t){const i=String(e&&e.video||"").trim(),a=String(e&&e.poster||"").trim(),n=i&&Ei(i)||a&&Ei(a)?'<p class="mt-2 text-[11px] font-bold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-lg px-3 py-2">âš  Temporary preview only â€” the upload FAILED, this will NOT be saved. Re-upload a smaller MP4/WebM.</p>':"";return`
    <div>
    ...
    </div>`}).join("")}window.heroVideoUpload=function(e,t){const i=document.createElement("input");i.type="file",i.accept=t==="video"?"video/mp4,video/webm,.mp4,.webm":"image/*",i.onchange=()=>{const a=i.files&&i.files[0];a&&ur(e,t,a)},i.click()};window.heroVideoField=function(e,t,i){const a=be();a[e]&&(a[e][t]=i,Bt())};window.heroVideoPreset=function(e,t){const i=be();i[e]&&(i[e].buttonText=t,Ze())};window.heroVideoToggle=function(e){const t=be();t[e]&&(t[e].enabled=t[e].enabled===!1,Ze())};window.heroVideoMove=function(e,t){const i=be(),a=e+t;a<0||a>=i.length||([i[e],i[a]]=[i[a],i[e]],Ze())};window.heroVideoDelete=function(e){const t=be();e<0||e>=t.length||confirm("Delete this hero video slide?")&&(t.splice(e,1),Ze())};window.heroVideoRemoveMedia=function(e,t){const i=be();i[e]&&(t==="video"?i[e].video="":t==="poster"&&(i[e].poster=""),Ze())};window.addHeroVideoSlide=function(){be().push({id:"hv"+Date.now()+Math.floor(Math.random()*999),enabled:!0,video:"",poster:"",title:"",subtitle:"",buttonText:"SHOP NOW",buttonLink:"/#showroom-directory"}),Ze(),y("New slide added â€” upload a video and press Save to show it.","info")};async function dr(e,t){try{const{data:{session:i}}=await b.auth.getSession();if(!i)return{url:URL.createObjectURL(e),persisted:!1,error:"You are signed out â€” sign in again, then re-upload."};const a=(e.name.split(".").pop()||(t==="video"?"mp4":"jpg")).toLowerCase().replace(/[^a-z0-9]/g,""),n=`hero/${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.${a}`,{error:s}=await b.storage.from("product-images").upload(n,e,{contentType:e.type,cacheControl:"3600",upsert:!0});if(s)return{url:URL.createObjectURL(e),persisted:!1,error:s.message};const{data:o}=b.storage.from("product-images").getPublicUrl(n),r=o&&o.publicUrl;return r?{url:r,persisted:!0,error:null}:{url:URL.createObjectURL(e),persisted:!1,error:"Storage did not return a public URL."}}catch(i){return{url:URL.createObjectURL(e),persisted:!1,error:String(i&&i.message||i)}}}function Ei(e){return/^blob:/i.test(String(e||""))}async function ur(e,t,i){const a=be();if(!i||!a[e])return;if(t==="video"){if(!/video\/(mp4|webm)|\.(mp4|webm)$/i.test(i.type+" "+i.name)){y("Please choose an MP4 or WebM video file.","error");return}}else if(!i.type.startsWith("image/")){y("Please choose an image for the poster.","error");return}y("â³ Uploading "+(t==="video"?"video":"poster")+"â€¦","info");const n=await dr(i,t);t==="video"?a[e].video=n.url:a[e].poster=n.url,Ze(),n.persisted?y("âœ“ "+(t==="video"?"Video":"Poster")+" uploaded â€” press Save & Publish Hero Banner to go live.","success"):y("âš  UPLOAD FAILED: "+(n.error||"unknown reason")+" â€” this preview is TEMPORARY and will NOT be saved. Try a smaller MP4/WebM (keep videos under ~50 MB), then re-upload.","error")}function pr(e){const t=Array.isArray(e)?e.map(a=>({...a})):[];return window._heroVideoDraft=t,Bt(),`
    <div class="space-y-3">
    ...
    <div class="rounded-xl border-2 border-dashed border-indigo-500/30 bg-white/5 p-6 text-center">
    ...
    </div>`}window.heroVideoSavePublish=async function(e){const t=l=>/^blob:/i.test(String(l||"")),i=be().filter(l=>l&&(l.video||l.poster||l.title||l.subtitle));if(!i.length){y("Add at least one video slide before publishing.","error");return}i.forEach(l=>{l.poster&&t(l.poster)&&(l.poster="")});const a=i.filter(l=>l.video&&t(l.video)),n=i.filter(l=>l.video&&!t(l.video));if(a.length&&!n.length){y(`Upload FAILED for your video${a.length>1?"s":""} â€” temporary previews cannot go live. Re-upload a smaller MP4/WebM (under ~50 MB), then press this button again.`,"error");return}if(a.length&&!confirm(`${a.length} slide${a.length>1?"s":""} had a FAILED upload and will be LEFT OUT. Publish the remaining ${n.length} slide${n.length===1?"":"s"} now?`))return;const s=n,o=s.filter(l=>l.video);if(!s.length){y("Please upload a video in at least one slide first.","error");return}const r=e?e.innerHTML:"";e&&(e.disabled=!0,e.innerHTML="â³ Publishingâ€¦");try{Bt();const{data:l}=await b.from("site_settings").select("id").limit(1).maybeSingle();let d;if(l?.id?{error:d}=await b.from("site_settings").update({hero_video_slides:s}).eq("id",l.id):{error:d}=await b.from("site_settings").insert({id:crypto.randomUUID(),hero_video_slides:s}),d)throw new Error(d.message);Mi(),y("âœ“ Hero video banner published! "+o.length+(o.length===1?" video is":" videos are")+" now live on your homepage.","success")}catch(l){y(l.message||"Could not publish the hero banner. Please try again.","error")}finally{e&&(e.disabled=!1,e.innerHTML=r,window.lucide&&lucide.createIcons())}};async function Mn(){const e=document.getElementById("content");try{const{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i={...Jn,...t||{}};e.innerHTML=`
      <div class="space-y-6 fade-in">
        <div>
        ...
        <form id="content-settings-form" onsubmit="saveContentSettings(event)" class="space-y-5">
          ${ri.map(a=>`
            <div class="glass-soft border border-white/10 rounded-2xl p-5">
              ...
              ${a.key==="hero_videos"?pr(i.hero_video_slides||[]):`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ${a.fields.map(n=>`
                  <div class="${n.type==="textarea"||n.type==="media"?"sm:col-span-2":""}">
                    ...
                    ${n.type==="textarea"?`<textarea id="cs-${n.key}" name="${n.key}" rows="3" class="input-field w-full" placeholder="Enter the current wordingâ€¦">${c(i[n.key]||"")}</textarea>`:n.type==="media"?Ln(n,i[n.key]||""):n.type==="checkbox"?"":`<input id="cs-${n.key}" type="text" name="${n.key}" value="${c(i[n.key]||"")}" class="input-field w-full" placeholder="Enter the current wordingâ€¦">`}
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          ${H("Customers",a.count||0,"users","violet")}
      ...
      </div>`,window.lucide&&lucide.createIcons(),cn(n)}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}async function gr(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
    ...
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-6 fade-in">
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <i data-lucide="${f.ok?"check-circle":"circle"}" class="w-3 h-3"></i>${f.label}</div>`).join(""),window.lucide&&lucide.createIcons()}),window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.changePassword=async function(e){e.preventDefault();const t=document.getElementById("current-pw").value,i=document.getElementById("new-pw").value,a=document.getElementById("confirm-pw").value;if(i!==a){y("Passwords do not match","error");return}if(i.length<8){y("Password must be at least 8 characters","error");return}const{error:n}=await b.auth.signInWithPassword({email:B.user.email,password:t});if(n){y("Current password is incorrect","error");return}const{error:s}=await b.auth.updateUser({password:i});if(s){y(s.message,"error");return}await fe(B.user.id,"password_changed"),y("Password updated successfully!"),e.target.reset(),document.getElementById("pw-strength").innerHTML=""};window.setup2FAFlow=async function(){j(`
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box">
        <div class="flex items-center justify-between mb-5">
            ...
            <table class="w-full dt">
              ...
              <tbody>
                ${(t||[]).length===0?'<tr><td colspan="4" class="text-center text-gray-500 py-8">No activity yet</td></tr>':(t||[]).map(i=>`<tr>
                    ...
                    <td><span class="text-xs text-gray-500">${Fe(i.created_at)}</span></td>
                  </tr>`).join("")}
              </tbody>
            </table>
          </div>
        ...
        <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
          ...
          <div class="divide-y divide-blue-500/5">
            ${(t||[]).length===0?'<p class="text-xs text-gray-500 text-center py-8">No deployment history</p>':(t||[]).map(i=>`<div class="flex items-center gap-3 px-4 py-3">
                ...
                <div class="flex-1"><p class="text-xs font-bold text-white">${c(i.version||i.id?.slice(0,8))}</p><p class="text-[10px] text-gray-500">${Fe(i.created_at)}</p></div>
                ${ie(i.status||"completed")}
              </div>`).join("")}
          </div>
        </div>
      </div>`,window.lucide&&lucide.createIcons()}catch(t){e&&(e.innerHTML=`<div class="p-6 text-red-400">${c(t.message)}</div>`)}}window.exportProducts=async function(){const{data:e}=await b.from("showroom_listings").select("*"),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),i=document.createElement("a");i.href=URL.createObjectURL(t),i.download=`kco-products-${new Date().toISOString().slice(0,10)}.json`,i.click(),y("Products exported!")};window.exportOrders=async function(){const{data:e}=await b.from("payment_receipts").select("*").order("created_at",{ascending:!1});if(!e||!e.length){y("No orders to export","info");return}const t=Object.keys(e[0]).join(","),i=e.map(s=>Object.values(s).map(o=>`"${String(o||"").replace(/"/g,'""')}"`).join(",")).join(`
`),a=new Blob([t+`
`+i],{type:"text/csv"}),n=document.createElement("a");n.href=URL.createObjectURL(a),n.download=`kco-orders-${new Date().toISOString().slice(0,10)}.csv`,n.click(),y("Orders exported!")};async function hr(){const e=document.getElementById("content"),{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),i=t||{};e.innerHTML=`
    <div class="space-y-5 fade-in">
      ...
      <div class="space-y-5 fade-in">
        ...
        </div>`};const{data:i}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a=i||{},n=a.brand_name||a.site_name||zi,s=a.brand_slogan||a.site_tagline||Ki,o=a.brand_logo||a.brand_header_logo||"",r=a.ringtone_audio||a.ringtone_url||"";e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
      ...
      </div>`,window.lucide&&lucide.createIcons()}catch(i){t&&(t.innerHTML=`<div class="p-6 text-red-400">${c(i.message)}</div>`)}}function vr(e,t){const i=e.key+"_bg_image",a=e.key+"_bg_video",n=t[i]||"",s=t[a]||"",o=!!(n&&n.trim()),r=!!(s&&s.trim());return`
    <div class="glass-soft border border-blue-500/15 rounded-2xl p-5 space-y-4">
      <div class="flex items-center justify-between flex-wrap gap-2">
        <div class="flex items-center gap-3">
    ...
    </div>`}function Ai(e,t,i,a,n){const s=n==="image",o=s?"blue":"violet",r=s?"image-plus":"video",l=s?"text-blue-400":"text-violet-400";return`
    <div>
    ...
    </div>`}window.triggerPromoBgUpload=function(e){document.getElementById("file-"+e)?.click()};function Fn(){const e={};for(const t of Jt)e[t.key+"_bg_image"]=document.getElementById("val-"+t.key+"_bg_image")?.value||"",e[t.key+"_bg_video"]=document.getElementById("val-"+t.key+"_bg_video")?.value||"";return e}window.clearPromoBg=function(e){const t=Fn();t[e]="";const i=document.getElementById("val-"+e),a=document.getElementById("url-"+e);i&&(i.value=""),a&&(a.value=""),At(t),y("Cleared. Publish to apply.","info")};window.handlePromoBgUpload=async function(e,t){const i=e.target.files?.[0];if(!i)return;const a=document.getElementById("promo-bg-status"),n=document.getElementById("promo-bg-msg");a&&a.classList.remove("hidden"),n&&(n.textContent=`Uploading ${i.name}â€¦`);try{const s=(i.name.split(".").pop()||"bin").toLowerCase(),o=`promo/${t}-${Date.now()}.${s}`,{error:r}=await b.storage.from("product-images").upload(o,i,{contentType:i.type,upsert:!0});let l;if(r)l=URL.createObjectURL(i),n&&(n.textContent=`Preview only (storage: ${r.message})`);else{const{data:f}=b.storage.from("product-images").getPublicUrl(o);l=f.publicUrl,n&&(n.textContent=`âœ“ ${i.name} uploaded`)}const d=document.getElementById("val-"+t),u=document.getElementById("url-"+t);d&&(d.value=l),u&&(u.value=l,u.classList.remove("hidden"));const m=Fn();At(m)}catch(s){n&&(n.textContent=`Upload failed: ${s.message}`)}setTimeout(()=>a?.classList.add("hidden"),4e3)};window.savePromoBackgrounds=async function(e){e.preventDefault();const t={};for(const s of Jt)t[s.key+"_bg_image"]=document.getElementById("val-"+s.key+"_bg_image")?.value||"",t[s.key+"_bg_video"]=document.getElementById("val-"+s.key+"_bg_video")?.value||"";const i=e.target.querySelector("[type=submit]");i&&(i.disabled=!0,i.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-2"></i>Publishingâ€¦',window.lucide&&lucide.createIcons());const{data:a}=await b.from("site_settings").select("id").limit(1).maybeSingle();let n;a?.id?{error:n}=await b.from("site_settings").update(t).eq("id",a.id):{error:n}=await b.from("site_settings").insert(t),Yn(),n?(y("Publish failed â€” the settings table rejected the update. Make sure the new promo-background columns are migrated, then try again.","error"),At(t)):(y("Promo & backgrounds published across all pages.","success"),setTimeout(()=>At(),500))};window._manualPaymentAccounts=[];function li(e="USD"){return{id:`bank-${Date.now()}-${Math.random().toString(36).slice(2,6)}`,currency:e,currencyName:e,flag:Ga("US"),country:"United States",country_code:"US",bankName:"",transferType:"Local & International",beneficiary:"",accountNumber:"",accountType:"",iban:"",swift:"",routing:"",sortCode:"",bankCode:"",branchCode:"",institutionNumber:"",transitNumber:"",bsbCode:"",address:""}}function ci(){const e=document.getElementById("manual-payment-accounts-json");e&&(e.value=JSON.stringify(window._manualPaymentAccounts||[]))}function wr(e,t){const i=e.country_code||"US";return`
    <div class="p-4 glass-soft border border-blue-500/10 rounded-xl space-y-3">
      ...
      <div class="form-grid form-grid-2">
        <div><label class="lbl">Currency *</label><select class="input-field" onchange="updateManualPaymentAccount(${t}, 'currency', this.value)">${Ya.map(a=>`<option value="${a}" ${e.currency===a?"selected":""}>${a}</option>`).join("")}</select></div>
        <div><label class="lbl">Country *</label><select class="input-field" onchange="updateManualPaymentCountry(${t}, this.value)">${Vt(i)}</select></div>
    ...
    <div class="space-y-4">
      ${window._manualPaymentAccounts.map((t,i)=>wr(t,i)).join("")}
    ...
    <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
      <div class="modal-box max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div class="form-grid form-grid-2 space-y-3">
          ${a("Display Name","display_name","e.g. USD Receiving Account")}
          <div><label class="lbl">Currency *</label><select class="input-field" id="ba-currency" onchange="document.getElementById('ba-currency_name').value=this.value">${Ya.map(n=>`<option value="${n}" ${i.currency===n?"selected":""}>${n}</option>`).join("")}</select></div>
          ${a("Beneficiary / Account Name *","beneficiary","Full legal name on the account")}
          ${a("Bank Name *","bank_name","e.g. Citibank")}
          ${a("Country","country")}
          <div class="flex items-end"><div class="flex-1"><label class="lbl">Country Code</label><select class="input-field" id="ba-country_code">${Vt(c(i.country_code||"US"))}</select></div></div>
          <div class="flex items-end"><div class="flex-1"><label class="lbl">Active</label><div class="flex items-center gap-2 pt-2"><input type="checkbox" id="ba-is_active" class="accent-blue-500" ${i.is_active!==!1?"checked":""}><span class="text-xs text-gray-400">Visible at checkout</span></div></div></div>
          ${a("Account Number","account_number","mono")}
          ${a("Account Type","account_type","Checking, Savings…")}
          ${a("Transfer Type","transfer_type")}
          ${a("IBAN","iban","mono")}
          ${a("SWIFT / BIC","swift","mono")}
          ${a("Routing (ABA)","routing","mono")}
          ${a("Sort Code","sort_code","mono")}
          ${a("Bank Code","bank_code","mono")}
          ${a("Branch Code","branch_code","mono")}
          ${a("Institution Number","institution_number","mono")}
          ${a("Transit Number","transit_number","mono")}
          ${a("BSB Code","bsb_code","mono")}
          <div class="sm:col-span-2">${a("Bank Address","address")}</div>
        </div>
    ...
    </div>`),window.lucide&&lucide.createIcons()};window.saveBankAccount=async function(e){const t=n=>(document.getElementById("ba-"+n)||{}).value||"",i={display_name:t("display_name"),currency:(t("currency")||"USD").toUpperCase(),currency_name:t("currency_name")||t("currency"),flag:t("flag"),country:t("country"),country_code:t("country_code"),bank_name:t("bank_name"),transfer_type:t("transfer_type"),beneficiary:t("beneficiary"),account_number:t("account_number"),account_type:t("account_type"),iban:t("iban"),swift:t("swift"),routing:t("routing"),sort_code:t("sort_code"),bank_code:t("bank_code"),branch_code:t("branch_code"),institution_number:t("institution_number"),transit_number:t("transit_number"),bsb_code:t("bsb_code"),address:t("address"),is_active:!!(document.getElementById("ba-is_active")||{}).checked};if(!i.currency||!i.beneficiary||!i.bank_name){y("Currency, beneficiary and bank name are required.","error");return}const{error:a}=e?await b.from("bank_accounts").update(i).eq("id",e):await b.from("bank_accounts").insert(i);if(a){y(a.message,"error");return}le(),y("Receiving account saved"),ha()};window.toggleBankAccount=async function(e){const t=(window._bankAccounts||[]).find(a=>a.id===e);if(!t)return;const{error:i}=await b.from("bank_accounts").update({is_active:t.is_active===!1}).eq("id",e);if(i){y(i.message,"error");return}y(t.is_active!==!1?"Account deactivated — hidden from checkout.":"Account activated — visible at checkout."),ha()};window.deleteBankAccount=async function(e){if(!window.confirm("Delete this receiving account permanently?"))return;const{error:t}=await b.from("bank_accounts").delete().eq("id",e);if(t){y(t.message,"error");return}y("Receiving account deleted"),ha()};async function Ha(){const e=document.getElementById("content");e&&(e.innerHTML=dt());try{const{data:t}=await b.from("site_settings").select("*").limit(1).maybeSingle(),a={...Wn()||{},...t||{}};window._bankAccounts=(window._bankAccounts||[]).map(n=>({...n})),e.innerHTML=`
      <div class="space-y-5 fade-in">
        <div class="flex items-center justify-between flex-wrap gap-3">
          ...
          <div class="glass-soft border border-blue-500/15 rounded-2xl overflow-hidden">
            ...
            <div class="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea class="input-field" name="manual_payment_instructions" rows="4" placeholder="Explain how customers should pay and upload their receipt.">${c(zn(a))}</textarea>
              </div>
              <div>
    ...
    <div class="flex flex-wrap gap-2">
      ${i.map(f=>`<button onclick="catalogSetCategory('${f.slug}')" class="btn-press px-3 py-1.5 rounded-xl text-xs font-bold border transition ${ee.category===f.slug?"bg-blue-500/20 text-blue-200 border-blue-500/40":"bg-white/5 text-gray-400 border-white/10 hover:text-white"}">${c(f.name)}</button>`).join("")}
    </div>`,r=`
    <div class="flex flex-wrap items-center gap-2">
      ...
      <button onclick="catalogSearch()" class="btn-press px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-500 text-white transition">Search</button>
          ...
          </div>`}).join(""):'<div class="text-center py-16 text-gray-500 text-sm">No catalog items match.</div>',u=n?1:Math.max(1,Math.ceil(a/Un)),m=`
    <div class="flex flex-wrap items-center justify-between gap-3">
