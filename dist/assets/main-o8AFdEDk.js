const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/motorhome-data-D5TLnRFZ.js","assets/preload-helper-CS1eXPs2.js","assets/catalog-hidden-store-BJoPnRIT.js","assets/special-order-DmutUCpS.js","assets/brand-Ch4-wKat.js"])))=>i.map(i=>d[i]);
import{_ as x}from"./preload-helper-CS1eXPs2.js";import"./localization-BxEYj6qp.js";import{g as w}from"./brand-Ch4-wKat.js";import{f as Q,c as X,r as Z}from"./showroom-cards-CY4VQERd.js";import{l as ee,j as te,d as re,e as L}from"./motorhome-data-D5TLnRFZ.js";import{c as se}from"./payment-settings-QNRNEoP1.js";import"./native-bridge-DjUVSZMf.js";import"./localization-bootstrap-BLa9M0cs.js";import"./catalog-hidden-store-BJoPnRIT.js";import"./cart-DNy8CJA3.js";import"./supabase-client-nvpjTmO6.js";function T(){let e=localStorage.getItem("kco_search_session");return e||(e="sess_"+Date.now()+"_"+Math.random().toString(36).slice(2),localStorage.setItem("kco_search_session",e)),e}const ae=18e4,S=new Map;function N(e){const t=S.get(e);return t?Date.now()-t.ts>ae?(S.delete(e),null):(S.delete(e),S.set(e,t),t.data):null}function U(e,t){if(S.size>300){const r=S.keys().next().value;S.delete(r)}S.set(e,{data:t,ts:Date.now()})}const C=new Map;function q(e,t){if(C.has(e))return C.get(e);const r=t().finally(()=>C.delete(e));return C.set(e,r),r}const O={phone:["smartphone","mobile","cellphone"],laptop:["notebook","computer","macbook"],car:["vehicle","auto","sedan","suv"],house:["home","property","apartment","villa"],tv:["television","monitor"],headphones:["earphones","earbuds","headset"],shoes:["sneakers","footwear","boots"],watch:["smartwatch","timepiece"],bag:["handbag","purse","backpack"],camera:["dslr","mirrorless"],motorhome:["camper","rv","diesel pusher","class a","class b","class c"],truck:["pickup","lorry","semi"],suv:["crossover","jeep"],villa:["mansion","estate"],apartment:["condo","flat","studio"],furniture:["chair","table","sofa","desk"],jewellery:["jewelry","ring","necklace","bracelet"],fashion:["clothing","apparel","clothes"],electronics:["gadget","device","tech"],samsung:["galaxy"],apple:["iphone","macbook","ipad","airpods"],mercedes:["benz","amg"],bmw:["bimmer"],toyota:["camry","corolla","hilux"],honda:["civic","accord"]};function K(e){const t=e.toLowerCase().split(/\s+/).filter(Boolean),r=[...t];for(const s of t){const a=s.endsWith("s")?s.slice(0,-1):s;O[s]&&r.push(...O[s].slice(0,3)),O[a]&&a!==s&&r.push(...O[a].slice(0,2)),a!==s&&r.push(a)}return[...new Set(r)].join(" ")}let _=null,R=null;function ne(e){return[e.title||"",e.brand||"",e.category||"",e.subcategory||"",Array.isArray(e.features)?e.features.join(" "):"",Array.isArray(e.tags)?e.tags.join(" "):"",(e.description||"").slice(0,300)].join(" ").toLowerCase()}function B(){return _?Promise.resolve(_):R||(R=Promise.all([x(()=>import("./motorhome-data-D5TLnRFZ.js").then(e=>e.s),__vite__mapDeps([0,1])),x(()=>import("./motorhome-data-D5TLnRFZ.js").then(e=>e.p),__vite__mapDeps([0,1])),x(()=>import("./motorhome-data-D5TLnRFZ.js").then(e=>e.m),__vite__mapDeps([0,1])),x(()=>import("./motorhome-data-D5TLnRFZ.js").then(e=>e.t),__vite__mapDeps([0,1])),x(()=>import("./motorhome-data-D5TLnRFZ.js").then(e=>e.n),__vite__mapDeps([0,1]))]).then(([e,t,r,s,a])=>(_=[...e.SHOWROOM_LISTINGS||[],...t.PRODUCT_LISTINGS||[],...r.PRODUCT_EXTRA_LISTINGS||[],...s.TRUCK_LISTINGS||[],...a.MOTORHOME_LISTINGS||[]].filter(n=>n&&n.property_id).map(n=>({p:n,hay:ne(n)})),_)).catch(()=>(_=[],_)),R)}function oe(){B().catch(()=>{})}function G(e,t){return Promise.race([e,new Promise(r=>setTimeout(()=>r(null),t))])}function ie(e){const t=Array.isArray(e.images)?e.images:[];return{listing_id:e.property_id,property_id:e.property_id,title:e.title||"Untitled",brand:e.brand,description:e.description,category:e.category,subcategory:e.subcategory,images:t,thumbnail:t[0]||null,price:Number(e.price)||0,currency:e.currency||"USD",entity_type:e.listing_type||"product",is_special_order:!1}}function j(e,t){if(!_||_.length===0)return[];const r=e.trim().toLowerCase();if(!r)return[];const s=r.split(/\s+/).filter(Boolean),a=[];for(const{p:n,hay:c}of _){const o=(n.title||"").toLowerCase(),d=o.includes(r),h=c.includes(r),l=s.every(g=>o.includes(g)||c.includes(g)),i=s.some(g=>o.includes(g)||c.includes(g));let m=0;o===r&&(m+=200),o.startsWith(r)&&(m+=150),d&&(m+=100),h&&(m+=60),l?m+=50:i&&(m+=25),m>0&&a.push({s:m,r:ie(n)})}return a.sort((n,c)=>c.s-n.s),a.slice(0,t).map(n=>n.r)}async function ce(e,t=30,r){if(!e||e.trim().length<1)return{results:[],count:0,marketplaceCount:0,supplierCount:0};const s=e.trim(),a=`search:${s}:${t}`,n=N(a);return n?(r&&r(n.results,n),n):q(a,async()=>{const c=await w(),o=K(s);s.toLowerCase(),B().then(()=>{const u=j(s,t);u.length>0&&r&&r(u,{count:u.length,marketplaceCount:u.length,supplierCount:0})}).catch(()=>{});const{data:d,error:h}=await c.rpc("smart_search_quick",{p_query:o,p_limit:t});let l=[];!h&&d&&d.length>0&&(l=d),await B().catch(()=>{});const i=j(s,t),m=new Set(l.map(u=>u.property_id||u.listing_id));for(const u of i)m.has(u.property_id)||(m.add(u.property_id),l.push(u));r&&l.length>0&&r(l,{count:l.length,marketplaceCount:l.length,supplierCount:0});let g=[];if(l.length<t)try{const{data:u,error:A}=await c.rpc("search_supplier_catalogue",{p_query:s,p_limit:t-l.length});!A&&u&&u.length>0&&(g=u.map(y=>({listing_id:null,supplier_item_id:y.id,title:y.title,brand:y.brand,description:y.description,category:y.category,images:y.images,thumbnail:Array.isArray(y.images)&&y.images.length>0?y.images[0]:null,price:y.selling_price,currency:y.supplier_currency,entity_type:"special_order",available_quantity:y.available_quantity,estimated_delivery_days:y.estimated_delivery_days,shipping_cost:y.shipping_cost,supplier_name:y.supplier_name,is_special_order:!0})),r&&g.length>0&&r([...l,...g],{count:l.length+g.length,marketplaceCount:l.length,supplierCount:g.length}))}catch{}try{const u=T();c.rpc("record_search",{p_query:s,p_result_count:l.length+g.length,p_session_key:u}).then(()=>{},()=>{})}catch{}const f={results:[...l,...g],count:l.length+g.length,marketplaceCount:l.length,supplierCount:g.length,_final:!0};return U(a,f),le(s,t),f})}async function le(e,t){const r=await w(),s=e.toLowerCase().split(/\s+/).filter(Boolean);if(s.length<2)return;const a=new Set;for(const n of s)n.endsWith("s")?a.add(n.slice(0,-1)):a.add(n+"s");for(const n of a){const c=`search:${n}:${t}`;!N(c)&&!C.has(c)&&q(c,()=>r.rpc("smart_search_quick",{p_query:n,p_limit:t}).then(({data:o,error:d})=>{!d&&o&&U(c,o)}).catch(()=>{}))}}async function de(e,t=8){if(!e||e.trim().length<1)return[];const r=e.trim(),s=`sugg:${r}:${t}`,a=N(s);return a||q(s,async()=>{const n=await w(),c=K(r);await B().catch(()=>{});const o=j(r,t).map(i=>({id:i.property_id,title:i.title,category:i.category,price:i.price,currency:i.currency,entity_type:i.entity_type,thumbnail:i.thumbnail})),d=new Set(o.map(i=>i.id||i.title)),h=await G(n.rpc("smart_search_quick",{p_query:c,p_limit:t}),2e3);let l=[];if(h&&!h.error&&h.data&&h.data.length>0)l=h.data;else if(h&&h.error){const i=await G(n.rpc("smart_search_fuzzy",{p_query:r.toLowerCase(),p_limit:t}),1500);i&&i.data&&(l=i.data)}for(const i of l)!d.has(i.listing_id)&&!d.has(i.title)&&(d.add(i.listing_id),o.push({id:i.listing_id,title:i.title,category:i.category,price:i.price,currency:i.currency,entity_type:i.entity_type,thumbnail:i.thumbnail}));return U(s,o),o})}async function ue(e=5){const t=T();try{const s=await w(),{data:a,error:n}=await s.from("search_history").select("query, created_at").eq("session_key",t).order("created_at",{ascending:!1}).limit(e);if(!n&&a){const c=new Set;return a.filter(o=>c.has(o.query.toLowerCase())?!1:(c.add(o.query.toLowerCase()),!0))}}catch{}return JSON.parse(localStorage.getItem("kco_recent_searches")||"[]").map(s=>({query:s,created_at:null}))}async function pe(e){if(!e||e.trim().length<1)return;const t=e.trim(),r=T();try{(await w()).from("search_history").insert({session_key:r,query:t}).then(()=>{},()=>{})}catch{}const a=JSON.parse(localStorage.getItem("kco_recent_searches")||"[]").filter(n=>n.toLowerCase()!==t.toLowerCase());a.unshift(t),localStorage.setItem("kco_recent_searches",JSON.stringify(a.slice(0,10)))}async function he(){const e=T();try{await(await w()).from("search_history").delete().eq("session_key",e)}catch{}localStorage.removeItem("kco_recent_searches")}async function me(e=8){try{const t=await w(),{data:r,error:s}=await t.rpc("smart_search_trending",{p_limit:e});if(!s&&r)return r.map(a=>a.query)}catch{}return["Samsung Galaxy","iPhone","Mercedes","Real Estate","Laptop","Villa","Beach House","Motorhome"]}let b=null,D=!1;function ge(e,t){const r=window.SpeechRecognition||window.webkitSpeechRecognition;return r?D&&b?(b.stop(),{supported:!0}):(b=new r,b.continuous=!1,b.interimResults=!0,b.lang="en-US",b.onstart=()=>{D=!0,t?.(!0)},b.onresult=s=>{let a="";for(let n=0;n<s.results.length;n++)a+=s.results[n][0].transcript;e?.(a)},b.onerror=()=>{t?.(!1)},b.onend=()=>{D=!1,t?.(!1)},b.start(),{supported:!0}):{supported:!1}}function fe(){return D}window._smartSearch=ce;window._getLiveSuggestions=de;window._getRecentSearches=ue;window._saveRecentSearch=pe;window._clearRecentSearches=he;window._getTrendingSearches=me;window._toggleVoiceSearch=ge;window._isVoiceListening=fe;window._getSessionKey=T;window._filterShowroomByCategory=Q;window._clearShowroomFilter=X;oe();window.dispatchEvent(new CustomEvent("smart-search-ready"));const ye="id,title,description,image_url,video_url,poster_url,link_type,link_target,ad_label,start_date,end_date,is_active,sort_order,created_at",we=["Featured","Sponsored","Featured Collection","Discover","Promotion"];function be(e){if(!e.is_active)return!1;const t=Date.now();return!(e.start_date&&new Date(e.start_date).getTime()>t||e.end_date&&new Date(e.end_date).getTime()<t)}function ve(e){const t=(e.title||"").trim().toLowerCase(),r=(e.description||"").trim().toLowerCase(),s=["home","house","apartment","villa","cottage","condo","townhouse","bungalow"].some(d=>t.includes(d)||r.includes(d)),a=["truck","trucks","pickup","delivery","freight"].some(d=>t.includes(d)||r.includes(d)),n=["motorhome","motor home","rv","recreational vehicle","camper","campervan"].some(d=>t.includes(d)||r.includes(d)),c=["car","cars","vehicle","vehicles","sedan","suv","coupe","hatchback"].some(d=>t.includes(d)||r.includes(d)),o=!["kitchen","cooking","culinary"].some(d=>t.includes(d)||r.includes(d));return(s||a||n||c)&&o}function _e(e){if(!e||!be(e)||!ve(e))return null;const t=(e.image_url||"").trim()||null,r=null,s=(e.poster_url||"").trim()||null;if(!t)return null;const a=(e.title||"Marketplace Promotion").trim(),n=(e.description||"").trim(),c=we.includes(e.ad_label)?e.ad_label:"Featured",o=["product","category","section","none"].includes(e.link_type)?e.link_type:"none";return{adId:e.id,isAd:!0,isLive:!1,badge:c,title:a,desc:n,titles:{en:a},descs:{en:n},image:t,video:r,poster:s,linkType:o,linkTarget:(e.link_target||"").trim()||null,sortOrder:Number(e.sort_order)||0}}async function xe(){try{const e=await w(),{data:t,error:r}=await e.from("promotions").select(ye).eq("is_active",!0).order("sort_order",{ascending:!0}).order("created_at",{ascending:!1});return r||!t?[]:t.map(_e).filter(Boolean)}catch{return[]}}async function z(){const e=await xe();return window._ads=e,window.dispatchEvent(new CustomEvent("ads-updated",{detail:e})),e}async function ke(){try{return(await w()).channel("public:promotions:ads").on("postgres_changes",{event:"*",schema:"public",table:"promotions"},()=>{z()}).subscribe()}catch{return null}}window._loadAds=z;window._subscribeAds=ke;window._ads=[];const I="/fallback.svg",Se=()=>document.getElementById("homepage-bottom");function p(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $e(e){return Array.isArray(e.images)?e.images.filter(Boolean):typeof e.images=="string"?[e.images]:[]}function F(e){return $e(e)[0]||I}function $(e){const t=parseFloat(e.real_price),r=parseFloat(e.price);return!(t>0)||!(r>0)||t<=r?null:{real:t,price:r,pct:Math.round((1-r/t)*100)}}function v(e,t,r,s="blue"){const a=s==="amber";return`
    <div class="relative pt-2 pb-3">
      <div class="flex items-center gap-3.5">
        ...
        <div class="flex-1 min-w-0">
          <h3 class="text-xl sm:text-2xl font-black text-gray-900 tracking-tight leading-tight">
            <span class="bg-gradient-to-r ${a?"from-amber-100 via-white to-orange-200":"from-blue-200 via-white to-blue-300"} bg-clip-text text-transparent">${p(t)}</span>
          </h3>
          ${r?`<p class="text-gray-400 text-xs sm:text-[13px] leading-tight mt-1 truncate">${p(r)}</p>`:""}
        </div>
      </div>
    ...
    </div>`}function Ce(e){const t=e.filter(a=>$(a)),r=(t.length?t:e).slice(0,3);if(!r.length)return"";const s=r.map((a,n)=>{const c=F(a),o=$(a),d=a.title||a.name||"Featured product",h=o?`Save ${o.pct}% — was ${L({price:o.real,currency:a.currency,price_period:a.price_period})}`:a.category||"Featured product",l=["from-blue-700 via-blue-500 to-cyan-400","from-violet-700 via-purple-500 to-pink-400","from-emerald-700 via-teal-500 to-cyan-300"][n%3];return`
      <a href="/details.html?id=${encodeURIComponent(a.property_id)}"
        ...
        <div class="absolute inset-0 opacity-90">
          <img src="${p(c)}" alt="${p(d)}" loading="lazy" decoding="async"
        ...
        <div class="absolute bottom-0 inset-x-0 p-4 sm:p-5">
          ...
          <h4 class="font-black text-white text-lg sm:text-xl leading-tight line-clamp-2">${p(d)}</h4>
          <div class="flex items-center flex-wrap gap-2 mt-2">
            <span class="text-sm font-black text-white">${L(a)}</span>
            ${o?`<span class="text-xs text-white/70 line-through">${L({price:o.real,currency:a.currency,price_period:a.price_period})}</span>
            <span class="text-[10px] font-black bg-red-500 rounded-full px-2 py-0.5">-${o.pct}%</span>`:""}
          </div>
          <p class="text-[11px] text-white/70 mt-1 truncate">${p(h)}</p>
    ...
    </section>`:""}function Ie(e,t){const r=new Set,s=c=>{const o=c&&(c.property_id||c.id);return!o||r.has(o)?!1:(r.add(o),!0)};let a=t.filter(s);const n=e.filter(c=>(c.category||"").toLowerCase()==="new arrivals"&&s(c));return a=[...a,...n].slice(0,10),a.length||(a=e.filter(s).slice(0,10)),a.length?`
    <section class="showroom-section space-y-3" data-hb-rail="new-arrivals">
      ...
      <div class="flex gap-4 overflow-x-auto pb-3 snap-x snap-mandatory scroll-smooth no-scrollbar">
        ${a.map((c,o)=>`<div data-hb-card="${o}" class="w-[240px] sm:w-[260px] shrink-0 snap-start"></div>`).join("")}
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ${e.map((t,r)=>`
          <div class="relative bg-white border border-gray-200 rounded-2xl p-4">
            ...
            <h4 class="text-sm font-black text-gray-900">${p(t.title)}</h4>
            <p class="text-xs text-gray-500 mt-1 leading-relaxed">${p(t.desc)}</p>
          </div>`).join("")}
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ${t.map(r=>`
          <div class="bg-white border border-gray-200 rounded-2xl p-4">
            ...
            <h4 class="text-sm font-black text-gray-900">${p(r.title)}</h4>
            <p class="text-xs text-gray-500 mt-1 leading-relaxed">${p(r.desc)}</p>
          </div>`).join("")}
      </div>
      ${e&&e.payment_gateway?`<p class="text-[11px] text-gray-400 px-1">Payment gateway: ${p(e.payment_gateway)} · Mode: ${p(e.payment_mode||"test")}</p>`:""}
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ${t.map(a=>`
          <div class="flex items-start gap-3 bg-white border border-gray-200 rounded-2xl p-4">
            ...
            <div>
              <h4 class="text-sm font-black text-gray-900">${p(a.title)}</h4>
              <p class="text-xs text-gray-500 mt-1 leading-relaxed">${p(a.desc)}</p>
            </div>
          </div>`).join("")}
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ${e.map(t=>`
          <a href="${t.href}" class="group bg-white border border-gray-200 rounded-2xl p-4 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-100 transition">
            ...
            <h4 class="text-sm font-black text-gray-900">${p(t.title)}</h4>
            <p class="text-xs text-gray-500 mt-1 leading-relaxed">${p(t.desc)}</p>
            <span class="inline-flex items-center gap-1 text-xs font-bold text-blue-600 mt-3 group-hover:gap-2 transition-all">${p(t.cta)} <i data-lucide="arrow-right" class="w-3.5 h-3.5"></i></span>
          </a>`).join("")}
      </div>
    ...
    <section class="showroom-section space-y-3">
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-800 via-indigo-700 to-blue-600 text-white text-center py-10 sm:py-14 px-5">
        <div class="absolute inset-0 opacity-20">
          <img src="${p(s)}" alt="" loading="lazy" decoding="async"
        ...
        <div class="relative max-w-2xl mx-auto">
          ...
          <p class="text-sm sm:text-base text-white/85 mt-3 max-w-xl mx-auto">Genuine discounts on genuine items — ${p(r.title||"our top products")} and more. Don’t miss out.</p>
    ...
    </section>`}async function V(){const e=Se();if(!e)return;let t={};try{t=await se()}catch{}let r=[],s=[];try{await ee(),r=te()||[],s=re()||[],s.length||(s=r)}catch{}try{const{PRODUCT_LISTINGS:l}=await x(async()=>{const{PRODUCT_LISTINGS:f}=await import("./motorhome-data-D5TLnRFZ.js").then(u=>u.p);return{PRODUCT_LISTINGS:f}},__vite__mapDeps([0,1])),{PRODUCT_EXTRA_LISTINGS:i}=await x(async()=>{const{PRODUCT_EXTRA_LISTINGS:f}=await import("./motorhome-data-D5TLnRFZ.js").then(u=>u.m);return{PRODUCT_EXTRA_LISTINGS:f}},__vite__mapDeps([0,1])),m=[...l||[],...i||[]],g=new Set(s.map(f=>f.property_id||f.id));for(const f of m){const u=f.property_id||f.id;u&&!g.has(u)&&(g.add(u),s.push(f))}}catch{}try{const{isCatalogListingHidden:l}=await x(async()=>{const{isCatalogListingHidden:i}=await import("./catalog-hidden-store-BJoPnRIT.js");return{isCatalogListingHidden:i}},__vite__mapDeps([2,1]));s=s.filter(i=>{const m=i.property_id||i.id;if(!m)return!1;try{return!l(m)}catch{return!0}})}catch{}const a=[Ce(s),Le(s),Ie(s,r),Ee(),Te(t),Ae(t),Oe(),Re(),De(s),Be(s),Pe(s)].join("");if(!a.trim())return;e.innerHTML=a;const n=[{rail:"special-offers",items:s.filter(l=>$(l)).slice(0,10)},{rail:"more-products",items:s.slice(0,8)}],c=new Set,o=l=>{const i=l&&(l.property_id||l.id);return!i||c.has(i)?!1:(c.add(i),!0)},d=r.filter(o);let h=d;d.length?h=[...d,...s.filter(l=>(l.category||"").toLowerCase()==="new arrivals"&&o(l))].slice(0,10):h=s.filter(o).slice(0,10),n.push({rail:"new-arrivals",items:h});for(const{rail:l,items:i}of n){const m=e.querySelector(`[data-hb-rail="${l}"]`);if(!m||!i.length)continue;const g=m.querySelectorAll("[data-hb-card]");i.forEach((f,u)=>{const A=g[u];if(A)try{const y=Z(f);if(A.replaceChildren(y),window.lucide)try{lucide.createIcons()}catch{}}catch{}})}if(window.lucide)try{lucide.createIcons()}catch{}window.dispatchEvent&&window.dispatchEvent(new CustomEvent("homepage-bottom-ready"))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",V):V();let k=null,E=null;function P(e){const t=document.createElement("div");return t.textContent=e==null?"":String(e),t.innerHTML}async function J(e){if(!e)return null;const t=await w(),{data:r}=await t.from("profiles").select("display_name, first_name, last_name, avatar_url").eq("user_id",e.id).maybeSingle();return r}function M(e,t){return e?t?.display_name?t.display_name:t?.first_name||t?.last_name?`${t.first_name||""} ${t.last_name||""}`.trim():e.email.split("@")[0]:"Guest User"}function H(e,t){const r=document.getElementById("hdr-signin-btn"),s=document.getElementById("hdr-account-btn"),a=document.getElementById("hdr-account-label");r&&s&&(e?(r.classList.add("hidden"),s.classList.remove("hidden"),a&&(a.textContent=M(e,t))):(r.classList.remove("hidden"),s.classList.add("hidden")));const n=document.getElementById("nav-user-name"),c=document.getElementById("nav-user-sub"),o=document.getElementById("nav-signout-row"),d=document.getElementById("nav-signin-btn"),h=document.getElementById("nav-user-strip");e?(n&&(n.textContent=M(e,t)),c&&(c.textContent=e.email),o&&o.classList.remove("hidden"),d&&d.classList.add("hidden"),h&&h.classList.remove("hidden")):(n&&(n.textContent="Guest User"),c&&(c.textContent="Tap to sign in"),o&&o.classList.add("hidden"),d&&d.classList.remove("hidden"),h&&h.classList.add("hidden"));const l=document.getElementById("more-signout");l&&l.classList.toggle("hidden",!e);const i=document.getElementById("more-account-card");if(i)if(e){const m=M(e,t),g=(m.replace(/[^a-zA-Z0-9 ]/g,"").trim().split(/\s+/).slice(0,2).map(f=>f[0]||"").join("")||"?").toUpperCase();i.innerHTML=`
        ...
        </button>`;window.lucide&&lucide.createIcons()}async function Y(){const e=await w(),{data:{session:t}}=await e.auth.getSession();k=t?.user||null,E=k?await J(k):null,H(k,E)}async function Me(){await(await w()).auth.signOut(),k=null,E=null,H(null,null),window.location.href="/"}(async()=>(await w()).auth.onAuthStateChange((t,r)=>{(async()=>(k=r?.user||null,E=k?await J(k):null,H(k,E)))()}))();window.refreshNavUserState=Y;window.signOutUser=Me;Y();function W(){x(()=>import("./special-order-DmutUCpS.js"),__vite__mapDeps([3,4,1]))}window.addEventListener("load",()=>{typeof requestIdleCallback=="function"?requestIdleCallback(W,{timeout:3e3}):setTimeout(W,3e3)});
