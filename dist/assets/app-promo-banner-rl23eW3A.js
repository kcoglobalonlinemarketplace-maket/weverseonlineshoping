import{D as q,l as g,b}from"./promo-backgrounds-KEhHWHvl.js";import{d as H,W as B,D as G,l as j,a as P,g as F,p as D,e as u,c as w,b as v}from"./promo-pool-DsCgPoCX.js";import{D as x,l as k,g as M}from"./site-content-CQxtbv3j.js";const I="support@weverseonlineshop.com",U="weverse_brand_v1";function o(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function O(){try{const e=JSON.parse(localStorage.getItem(U)||"{}"),t=e.data&&typeof e.data=="object"?e.data:e;if(t&&typeof t=="object"&&(t.brand_name||t.site_name||t.brand_logo))return t}catch{}return{}}function R(){const e=O(),t=e.brand_name||e.site_name||H;return`
  ...
  <svg viewBox="0 0 560 720" class="w-full h-full block" aria-hidden="true">
    ...
    <div class="absolute inset-0 flex flex-col bg-[#f1f5f9] overflow-hidden" id="promo-phone-screen">
      ...
      <div class="flex gap-1.5 px-3 pt-2 overflow-hidden">
        ${["All","Cars","Phones","Fashion","Homes","Electronics"].map((i,n)=>`
