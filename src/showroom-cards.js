...
const MARKETPLACE_SECTIONS = [
  {
    ...
    rows: [
      ...
      { id: 'mp-appl-dryers', label: 'Dryers', icon: 'wind', ids: ['KCO-002014', 'KCO-003018'] },
      { id: 'mp-appl-ac', label: 'Air Conditioners', icon: 'snowflake', ids: ['KCO-003001', 'KCO-003002', 'KCO-003003'] },
      { id: 'mp-appl-fans', label: 'Fans', icon: 'fan', ids: ['KCO-003004', 'KCO-003005', 'KCO-003006'] },
      { id: 'mp-appl-vacuums', label: 'Vacuum Cleaners', icon: 'sparkles', ids: ['KCO-002005', 'KCO-002008'] },
      { id: 'mp-appl-dispensers', label: 'Water Dispensers', icon: 'glass-water', ids: ['KCO-003007', 'KCO-003008', 'KCO-003009'] },
      { id: 'mp-appl-heaters', label: 'Water Heaters', icon: 'flame', ids: ['KCO-003010', 'KCO-003011', 'KCO-003012'] },
      { id: 'mp-appl-irons', label: 'Irons', icon: 'zap', ids: ['KCO-003013', 'KCO-003014'] },
      { id: 'mp-appl-purifiers', label: 'Air Purifiers', icon: 'air-vent', ids: ['KCO-003015', 'KCO-003016', 'KCO-003017'] },
    ],
  },
