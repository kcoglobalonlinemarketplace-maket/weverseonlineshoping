...
export const PRODUCT_LISTINGS = [
  {
    ...
    brand: 'NYH Jewelry', condition: 'New', color: 'Gold',
    availability_status: 'In Stock', stock_quantity: 3, listing_status: 'sale',
    images: gallery('gold-diamond-ring.jpg', 'jewelry-valuable.jpg'),
    rating: 4.9, rating_count: 32, favorite_count: 21,
  ...
  },
  {
    ...
    brand: 'NYH Jewelry', condition: 'New', color: 'Gold',
    availability_status: 'In Stock', stock_quantity: 8, listing_status: 'sale',
    images: gallery('nyh-gold-bangle.jpg'),
    rating: 4.8, rating_count: 27, favorite_count: 15,
  ...
  },
  {
    ...
    brand: 'Rolex', condition: 'New', color: 'Silver / Gold',
    availability_status: 'In Stock', stock_quantity: 2, listing_status: 'sale',
    images: gallery('rolex-watch.jpg'),
    rating: 5.0, rating_count: 18, favorite_count: 26,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Gold',
    availability_status: 'In Stock', stock_quantity: 50, listing_status: 'sale',
    images: gallery('gold-iphone-case-1.jpg', 'gold-iphone-case-2.jpg', 'gold-iphone-case-3.jpg', 'gold-iphone-case-4.jpg', 'gold-iphone-case-5.jpg'),
    rating: 4.7, rating_count: 44, favorite_count: 30,
  ...
  },
  {
    ...
    brand: 'Goldgenie', condition: 'New', color: 'Gold',
    availability_status: 'In Stock', stock_quantity: 2, listing_status: 'sale',
    images: gallery('goldgenie-iphone-1.jpg', 'goldgenie-iphone-2.jpg'),
    rating: 4.9, rating_count: 15, favorite_count: 18,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 40, listing_status: 'sale',
    images: gallery('shoes.jpg'),
    rating: 4.6, rating_count: 25, favorite_count: 14,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Neutral',
    availability_status: 'In Stock', stock_quantity: 45, listing_status: 'sale',
    images: gallery('flats.jpg'),
    rating: 4.5, rating_count: 20, favorite_count: 11,
  ...
  },
  {
    ...
    brand: 'Paris', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 12, listing_status: 'sale',
    images: gallery('paris-brand.jpg'),
    rating: 4.4, rating_count: 12, favorite_count: 8,
  ...
  },
  {
    ...
    brand: 'Ayesha OOZO', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 15, listing_status: 'sale',
    images: gallery('ayesha-oozo.jpg'),
    rating: 4.3, rating_count: 9, favorite_count: 6,
  ...
  },
  {
    ...
    brand: 'KBKS', condition: 'New', color: 'Neutral',
    availability_status: 'In Stock', stock_quantity: 18, listing_status: 'sale',
    images: gallery('kbks.jpg'),
    rating: 4.2, rating_count: 8, favorite_count: 5,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 20, listing_status: 'sale',
    images: gallery('aesthetic.jpg'),
    rating: 4.5, rating_count: 14, favorite_count: 9,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 22, listing_status: 'sale',
    images: gallery('chase-up-value.jpg'),
    rating: 4.4, rating_count: 11, favorite_count: 7,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Black',
    availability_status: 'In Stock', stock_quantity: 16, listing_status: 'sale',
    images: gallery('faison-fashion.jpg'),
    rating: 4.6, rating_count: 13, favorite_count: 8,
  ...
  },
  {
    ...
    brand: 'Weverse', condition: 'New', color: 'Neutral',
    availability_status: 'In Stock', stock_quantity: 25, listing_status: 'sale',
    images: gallery('sunday.jpg'),
    rating: 4.5, rating_count: 10, favorite_count: 6,
    features: ['Relaxed Fit', 'Breathable Fabric', 'Quality Materials', 'Effortless Style'],
  },
];