import{s as o,S as G,A as X}from"./supabase-client-DvCmNkpI.js";import{C as N,g as S}from"./localization-XLaEvqbL.js";import{signOut as D,getCurrentUser as J}from"./auth-iMacRl0l.js";import"./native-bridge-z1PkSgfH.js";import"./localization-bootstrap-BhglmvwT.js";import"./app-promo-banner-VTpzwpvR.js";import"./ai-chat-U-IZQEoO.js";async function Q(){return!1}async function K(){return await Q(),null}const Z=`${"https://wttnvwpoqmbxryivcerf.supabase.co".replace(/\/$/,"")}/functions/v1/customer-ai-chat`,ee="sb_publishable_X_6kXsJwApi7v7HwoC1xtA_igns4Rxa";async function H(e){let t="";try{const a=await(await fetch(Z,{method:"POST",headers:{Authorization:`Bearer ${ee}`,"Content-Type":"application/json"},body:JSON.stringify({message:e,history:[]}),signal:AbortSignal.timeout(45e3)})).json();t=String(a?.response||"").trim()}catch{}if(!t||/daily message limit|technical hiccup|not quite ready|taking a short break/i.test(t))try{const r=await fetch("https://text.pollinations.ai/openai",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"openai",messages:[{role:"system",content:`You are Alex — the friendly customer support assistant for the Weverse Online Shop team. You are an automated assistant: if asked directly, say so honestly and warmly (for example: "I'm Alex, the shop's support assistant — happy to help!") and keep helping. Write like a real person: warm, casual-professional, contractions, short sentences. Help with products, orders, shipping, payments and returns. Never invent order details or tracking numbers.`},{role:"user",content:e}],max_tokens:500}),signal:AbortSignal.timeout(45e3)});r.ok&&(t=String((await r.json())?.choices?.[0]?.message?.content||"").trim())}catch{}return t}async function R(e){if(!e)return;let t=!1;try{const{error:r}=await o.from("support_messages").insert({user_id:s.user.id,subject:"Support",message:e,from_admin:!0,read:!1});t=!r}catch{}if(t){await I(),b("messages");const r=document.getElementById("msg-thread");r&&(r.scrollTop=r.scrollHeight)}else d(e)}const m="/fallback.svg",te=[{group:"Overview",items:[{id:"home",label:"Dashboard Home",icon:"layout-dashboard"},{id:"profile",label:"My Profile",icon:"user"},{id:"edit-profile",label:"Edit Profile",icon:"user-cog"},{id:"change-password",label:"Change Password",icon:"key-round"}]},{group:"Orders & Shopping",items:[{id:"orders",label:"My Orders",icon:"shopping-bag"},{id:"special-orders",label:"Special Orders",icon:"package-plus"},{id:"tracking",label:"Order Tracking",icon:"truck"},{id:"history",label:"Order History",icon:"history"},{id:"cart",label:"Shopping Cart",icon:"shopping-cart"},{id:"wishlist",label:"My Wishlist",icon:"heart"}]},{group:"Account",items:[{id:"notifications",label:"Notifications",icon:"bell"},{id:"messages",label:"Messages",icon:"mail"},{id:"payment-methods",label:"Payment Methods",icon:"credit-card"},{id:"payments",label:"Payment History",icon:"receipt"},{id:"addresses",label:"Shipping Addresses",icon:"map-pin"},{id:"receipts",label:"Download Receipts",icon:"download"}]},{group:"Support & Settings",items:[{id:"email-prefs",label:"Email Preferences",icon:"settings"},{id:"support",label:"Contact Us",icon:"headphones"},{id:"help",label:"Help Center",icon:"help-circle"},{id:"privacy",label:"Privacy & Security",icon:"shield-check"}]}],p=[{id:"order_placed",label:"Order Placed",icon:"shopping-bag",color:"text-blue-600",bg:"bg-blue-50"},{id:"payment_received",label:"Payment Received",icon:"credit-card",color:"text-cyan-600",bg:"bg-cyan-50"},{id:"pending_verification",label:"Pending Verification",icon:"shield-alert",color:"text-amber-600",bg:"bg-amber-50"},{id:"payment_approved",label:"Approved",icon:"check-circle",color:"text-emerald-600",bg:"bg-emerald-50"},{id:"order_processing",label:"Processing",icon:"package",color:"text-blue-600",bg:"bg-blue-50"},{id:"order_shipped",label:"Shipped",icon:"truck",color:"text-indigo-600",bg:"bg-indigo-50"},{id:"out_for_delivery",label:"Out for Delivery",icon:"bike",color:"text-blue-600",bg:"bg-blue-50"},{id:"order_delivered",label:"Delivered",icon:"package-check",color:"text-emerald-600",bg:"bg-emerald-50"}],re={approved:"payment_approved",submitted:"payment_received",placed:"order_placed"};function w(e){return re[e]||e}function ae(e){const t=p.findIndex(r=>r.id===w(e));return t>=0?t:0}function f(e){return e?new Date(e).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"}):"—"}function E(e){return e?new Date(e).toLocaleString("en-US",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"—"}function A(e){return(e||"?").slice(0,2).toUpperCase()}function n(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function d(e){const t=document.getElementById("toast");document.getElementById("toast-msg").textContent=e,t.classList.remove("translate-y-20","opacity-0"),clearTimeout(t._t),t._t=setTimeout(()=>t.classList.add("translate-y-20","opacity-0"),3e3),window.lucide&&lucide.createIcons()}function se(e){const t=()=>{const r=document.createElement("textarea");r.value=e,document.body.appendChild(r),r.select();try{document.execCommand("copy")}catch{}document.body.removeChild(r)};navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).catch(()=>t()):t(),d("Copied to clipboard.")}function $(e){const t=w(e),r=p.find(u=>u.id===t)||p[0],a={"text-blue-600":"bg-blue-50 text-blue-600 border-blue-200","text-cyan-600":"bg-cyan-50 text-cyan-600 border-cyan-200","text-amber-600":"bg-amber-50 text-amber-600 border-amber-200","text-emerald-600":"bg-emerald-50 text-emerald-600 border-emerald-200","text-indigo-600":"bg-indigo-50 text-indigo-600 border-indigo-200","text-blue-600":"bg-blue-50 text-blue-600 border-blue-200","text-red-600":"bg-red-50 text-red-600 border-red-200"},l=a[r.color]||a["text-blue-600"],i=e==="rejected"?"Rejected":r.label;return`<span class="inline-flex items-center gap-1 ${l} border text-[11px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wide">${i}</span>`}function q(e){e.addEventListener("click",function(t){if(this.disabled)return;const r=this.getBoundingClientRect(),a=document.createElement("span");a.className="ripple";const l=Math.max(r.width,r.height);a.style.width=a.style.height=l+"px",a.style.left=t.clientX-r.left-l/2+"px",a.style.top=t.clientY-r.top-l/2+"px",this.appendChild(a),setTimeout(()=>a.remove(),600)})}let s={user:null,profile:null,orders:[],events:{},notifications:[],addresses:[],emailPrefs:null,messages:[],paymentMethods:[],activeSection:"home"};function le(){const e=document.getElementById("particles");if(e)for(let t=0;t<12;t++){const r=document.createElement("div"),a=Math.random()*3+1;r.className="particle",r.style.width=r.style.height=a+"px",r.style.left=Math.random()*100+"%",r.style.bottom="-10px",r.style.background=Math.random()>.5?"rgba(59,130,246,.4)":"rgba(251,191,36,.3)",r.style.animationDuration=Math.random()*20+15+"s",r.style.animationDelay=Math.random()*20+"s",e.appendChild(r)}}le();async function ie(){if(document.getElementById("dashboard-root"),s.user=await J(),!s.user){window.location.href="/auth.html?redirect=/account.html";return}await U(),await oe(),await B(),await F(),await I(),await P(),await Y(),de(),W(),Oe(),b("home"),K().then(e=>{e&&console.log("Push notifications enabled")})}async function U(){const{data:e}=await o.from("profiles").select("*").eq("user_id",s.user.id).maybeSingle();s.profile=e}async function oe(){const{data:e}=await o.from("payment_receipts").select("*").eq("user_id",s.user.id).order("created_at",{ascending:!1});if(s.orders=e||[],s.orders.length){const t=s.orders.map(l=>l.order_number),{data:r}=await o.from("order_events").select("*").in("order_number",t).order("created_at",{ascending:!0});s.events={},(r||[]).forEach(l=>{(s.events[l.order_number]||=[]).push(l)});const{data:a}=await o.from("notification_log").select("*").in("order_number",t).order("created_at",{ascending:!1});s.notifications=a||[]}}async function B(){const{data:e}=await o.from("shipping_addresses").select("*").eq("user_id",s.user.id).order("created_at",{ascending:!1});s.addresses=e||[]}async function F(){const{data:e}=await o.from("email_preferences").select("*").eq("user_id",s.user.id).maybeSingle();s.emailPrefs=e}async function I(){const{data:e}=await o.from("support_messages").select("*").eq("user_id",s.user.id).order("created_at",{ascending:!1});s.messages=e||[]}async function P(){const{data:e}=await o.from("customer_payment_methods").select("*").eq("user_id",s.user.id).order("is_default",{ascending:!1}).order("created_at",{ascending:!1});s.paymentMethods=e||[]}async function Y(){const{data:e}=await o.from("wishlist").select("id, listing_id, showroom_listings(property_id, title, price, currency, images, listing_type, is_active, approval_status)").eq("user_id",s.user.id).order("created_at",{ascending:!1});s.wishlist=e||[]}function de(){const e=te.map(t=>`
  ...
  `).join("");document.getElementById("nav-menu").innerHTML=e,document.getElementById("mobile-nav-menu").innerHTML=e,document.querySelectorAll("[data-section]").forEach(t=>{t.addEventListener("click",()=>{const r=t.dataset.section;y(r)})}),window.lucide&&lucide.createIcons()}function y(e){s.activeSection=e,document.querySelectorAll("[data-section]").forEach(t=>{t.classList.toggle("active",t.dataset.section===e)}),b(e),j(),window.scrollTo({top:0,behavior:"smooth"})}function W(){const e=s.profile?.display_name||s.profile?.first_name||"Customer",t=s.user.email,r=s.profile?.avatar_url?`<img src="${s.profile.avatar_url}" class="w-full h-full object-cover" onerror="this.style.display='none'">`:A(t);["sidebar-avatar","mobile-avatar"].forEach(a=>{const l=document.getElementById(a);l&&(l.innerHTML=r)}),["sidebar-name","mobile-name"].forEach(a=>{const l=document.getElementById(a);l&&(l.textContent=e)}),["sidebar-email","mobile-email"].forEach(a=>{const l=document.getElementById(a);l&&(l.textContent=t)})}async function b(e){const t=document.getElementById("dashboard-root");let r="";switch(e){case"home":r=L();break;case"profile":r=ce();break;case"edit-profile":r=ue();break;case"change-password":r=pe();break;case"orders":r=be();break;case"special-orders":r=await me();break;case"tracking":r=ge();break;case"history":r=xe();break;case"cart":r=fe();break;case"wishlist":r=await je();break;case"notifications":r=ye();break;case"messages":r=he();break;case"payments":r=ve();break;case"payment-methods":r=we();break;case"addresses":r=ke();break;case"receipts":r=Se();break;case"email-prefs":r=Ee();break;case"support":r=Ie();break;case"help":r=Pe();break;case"privacy":r=Me();break;default:r=L()}t.innerHTML=`<div class="section active fade-in">${r}</div>`,window.lucide&&lucide.createIcons(),document.querySelectorAll(".btn-press").forEach(q),Ae(e)}function c(e,t){return`
    <div class="mb-6">
      <h1 class="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight">${e}</h1>
      ${t?`<p class="text-sm text-gray-500 mt-1">${t}</p>`:""}
    </div>
  `}function ne(){const e=s.orders.length,t=s.orders.filter(l=>["order_placed","payment_received","pending_verification","order_processing"].includes(w(l.status))).length,r=s.orders.filter(l=>w(l.status)==="order_delivered").length,a=s.orders.filter(l=>l.status==="rejected").length;return{total:e,pending:t,completed:r,cancelled:a}}function k(e,t,r,a){return`
  ...
  `}function L(){const e=ne(),t=s.profile?.display_name||s.profile?.first_name||"Customer",r=s.profile?.country_code?S(s.profile.country_code):null,a=s.orders.slice(0,4),l=s.notifications.slice(0,5);return`
  ...
  `}function ce(){const e=s.profile||{},t=e.country_code?S(e.country_code):null,r=e.avatar_url?`<img src="${e.avatar_url}" class="w-full h-full object-cover" onerror="this.style.display='none'">`:`<span class="text-2xl font-black">${A(s.user.email)}</span>`;return`
  ...
  `}function x(e,t){return`<div><p class="text-[10px] text-gray-500 uppercase tracking-wide mb-1">${e}</p><p class="text-sm text-gray-900">${t}</p></div>`}function ue(){const e=s.profile||{},t=e.country_code?S(e.country_code):null;return`
  ...
  `}let M=null;window.toggleOrder=e=>{M=M===e?null:e;const t=document.getElementById("orders-list");t&&(t.innerHTML=s.orders.map(r=>V(r,M)).join(""),window.lucide&&lucide.createIcons(),document.querySelectorAll(".btn-press").forEach(q))};async function me(){try{const{data:e,error:t}=await o.from("product_requests").select("*").eq("user_id",s.user.id).order("created_at",{ascending:!1});if(t)throw t;const r={pending_review:"bg-yellow-50 text-yellow-600 border-yellow-200",under_review:"bg-blue-50 text-blue-600 border-blue-200",approved:"bg-emerald-50 text-emerald-600 border-emerald-200",rejected:"bg-red-50 text-red-600 border-red-200",quoted:"bg-cyan-50 text-cyan-600 border-cyan-200",fulfilled:"bg-green-50 text-green-600 border-green-200",cancelled:"bg-gray-100 text-gray-600 border-gray-300"};if(!e||e.length===0)return`<div class="text-center py-16"><div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 mb-4"><i data-lucide="package-plus" class="w-8 h-8 text-gray-500"></i></div><h3 class="text-lg font-bold text-gray-900 mb-2">No Special Orders yet</h3><p class="text-sm text-gray-500 mb-5">When you can't find a product in our marketplace, you can request it as a Special Order and we'll source it for you.</p><a href="/" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white font-bold rounded-xl text-sm transition shadow-lg shadow-blue-500/30"><i data-lucide="search" class="w-4 h-4"></i> Search Products</a></div>`;let a='<div class="mb-4"><p class="text-sm text-gray-600">Track your special order requests and their status updates.</p></div><div class="space-y-3">';return e.forEach(l=>{const i=r[l.status]||r.pending_review,u=l.status.replace(/_/g," "),h=l.target_price?`${l.currency} ${Number(l.target_price).toLocaleString()}`:"—",T=l.quoted_price?`${l.quoted_currency} ${Number(l.quoted_price).toLocaleString()}`:null;a+=`<div class="glass border border-gray-200 rounded-xl p-4">
      ...
      </div>`}),a+="</div>",a}catch(e){return`<div class="text-red-600 text-sm p-4">Error loading special orders: ${n(e.message)}</div>`}}function ge(){const e=s.orders.filter(t=>!["order_delivered","rejected"].includes(w(t.status)));return`
  ...
  `}window.saveEmailPrefs=async()=>{const e={user_id:s.user.id};document.querySelectorAll("[data-pref]").forEach(t=>{e[t.dataset.pref]=t.checked}),s.emailPrefs?await o.from("email_preferences").update(e).eq("user_id",s.user.id):await o.from("email_preferences").insert(e),await F(),d("Email preferences saved.")};function Ie(){return`
  ...
  `}async function je(){const e=s.wishlist||[];return e.length?`
    <div class="space-y-4">
        ...
        ${e.map(t=>{const r=t.showroom_listings;if(!r)return"";const a=r.images&&r.images[0]||"/fallback.svg",l=typeof r.price=="number"?r.price:parseFloat(r.price||0);return`
            <div class="glass border border-blue-100 rounded-2xl overflow-hidden group">
              <div class="relative aspect-square overflow-hidden bg-gray-50">
                <a href="/details.html?id=${r.property_id}"><img src="${n(a)}" alt="${n(r.title)}" class="w-full h-full object-cover group-hover:scale-105 transition" loading="lazy" onerror="this.src='/fallback.svg'"></a>
  ...
  `:g("Your Wishlist","Save items you love to find them quickly later.","heart","Browse Products","window.location.href='/'")}window.removeFromWishlist=async e=>{try{await o.from("wishlist").delete().eq("id",e),d("Removed from wishlist."),await Y(),b("wishlist")}catch(t){d("Error: "+t.message)}};function g(e,t,r,a,l){return`
...
Reply to them directly, warmly and naturally, as the support agent.`);await R(i),l.disabled=!1,l.innerHTML='<i data-lucide="send" class="w-4 h-4"></i> Submit Request',window.lucide&&lucide.createIcons()}function Oe(){document.getElementById("btn-signout-desktop")?.addEventListener("click",O),document.getElementById("btn-signout-mobile")?.addEventListener("click",O),document.getElementById("btn-mobile-menu")?.addEventListener("click",De),document.getElementById("btn-mobile-close")?.addEventListener("click",j),document.getElementById("mobile-backdrop")?.addEventListener("click",j)}async function O(){window.confirm("Sign out of your account?")&&(await D(),window.location.href="/")}function Ne(){const e=document.createElement("div");e.className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[90] flex items-center justify-center p-4",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),window.lucide&&lucide.createIcons();const t=()=>e.remove();e.querySelector("#del-cancel").onclick=t,e.querySelector("#del-go").onclick=async()=>{const r=e.querySelector("#del-go");if(e.querySelector("#del-confirm").value.trim().toUpperCase()==="DELETE"){r.disabled=!0,r.innerHTML='<i data-lucide="loader-2" class="w-4 h-4 animate-spin inline mr-1"></i> Deleting...';try{const{data:{session:a}}=await o.auth.getSession(),l=await fetch(`${G}/functions/v1/delete-account`,{method:"POST",headers:{Authorization:`Bearer ${a?.access_token||X}`,"Content-Type":"application/json"},body:"{}",signal:AbortSignal.timeout(3e4)}),i=await l.json().catch(()=>({}));if(!l.ok)throw new Error(i.error||"Account deletion failed.");await D(),window.location.href="/"}catch(a){r.disabled=!1,r.textContent="Delete Forever",d(String(a.message||a))}}}}window.requestAccountDeletion=Ne;function De(){document.getElementById("mobile-drawer").classList.remove("hidden")}function j(){document.getElementById("mobile-drawer").classList.add("hidden")}window.navigateTo=y;window.copyToClipboard=se;window.contactSupport=e=>{const t=encodeURIComponent(`Order ${e} — Support Request`),r=encodeURIComponent(`Hello Weverse Online Shop Support,
