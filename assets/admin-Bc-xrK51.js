...
(function(){if(document.getElementById("wv-brand-blue"))return;var s=document.createElement("style");s.id="wv-brand-blue";s.textContent=".brand-name{background:none!important;background-image:none!important;-webkit-background-clip:initial!important;background-clip:initial!important;-webkit-text-fill-color:#0a0a0a!important;color:#0a0a0a!important}.brand-tagline-1,.brand-tagline-2{color:#0a0a0a!important;-webkit-text-fill-color:#0a0a0a!important}";(document.head||document.documentElement).appendChild(s)})();